...
#    ant_voltage=`old_configs '."bitmain-voltage"'`
    ...
    if [ "$ret"x == "null"x ];then
        ...
        old_ant_freq=`old_configs '."bitmain-freq"'`
        ant_freq=$ret
        if [ $old_ant_freq != $ret ];then
            reload=false
        fi
    fi
    ...
    if [ "$ret"x == "null"x ];then
        ...
        old_ant_voltage=`old_configs '."bitmain-voltage"'`
        ant_voltage=$ret
        if [ $old_ant_voltage != $ret ];then
            reload=false
        fi
    fi
    ...
    #     ant_ccdelay=`old_configs '."bitmain-ccdelay"'`
    # else
    #     old_ant_ccdelay=`old_configs '."bitmain-ccdelay"'`
    #     ant_ccdelay=$ret
    #     if [ $old_ant_ccdelay != $ret ];then
    #         reload=false
    #     fi
    # fi
    ...
    #     ant_pwth=`old_configs '."bitmain-pwth"'`
    # else
    #     old_ant_pwth=`old_configs '."bitmain-pwth"'`
    #     ant_pwth=$ret
    #     if [ $old_ant_pwth != $ret ];then
    #         reload=false
    #     fi
    # fi
