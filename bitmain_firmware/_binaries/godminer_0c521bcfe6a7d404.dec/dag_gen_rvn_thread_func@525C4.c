void __noreturn dag_gen_rvn_thread_func()
{
  ...
  while ( 1 )
  {
    do
    {
      ...
      while ( !*(_QWORD *)&dword_174308 );
    }
    while ( *(_QWORD *)&dword_174308 == *(_QWORD *)&dword_174310 );
    V_LOCK(dword_174308);
    ...
    zlog(
      ...
      60,
      v105);
    v95 = *(_QWORD *)&dword_174308;
    v2 = sub_12E944(dword_174308, dword_17430C, 3, 0);
    v3 = &s[7];
    v4 = &v104;
    ...
    if ( v96 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          "-origin_godminer-new/dhash_content/rvn/rvn_dhash_common.c",
          167,
          "dag_gen_rvn_thread_func",
          23,
          362,
          40,
          v105);
        v54 = sub_12E944(dword_174308, dword_17430C, 7500, 0);
        v55 = v50[1];
        ++v50;
        v56 = (__int64)qword_142E60[v54] >> 8;
        v57 = HIDWORD(qword_142E60[v54]) >> 8;
        ...
        v49 = zlog(
                ...
                "dminer-origin_godminer-new/dhash_content/rvn/rvn_dhash_common.c",
                167,
                "dag_gen_rvn_thread_func",
                23,
                368,
