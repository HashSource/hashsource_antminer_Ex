_DWORD *__fastcall _pipe_push(_DWORD *result, char *a2, size_t a3, _BYTE *a4)
{
  ...
  int v43; // [sp+24h] [bp-20h]
  _DWORD v44[6]; // [sp+2Ch] [bp-18h] BYREF
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v7 < (unsigned int)v8 )
        ...
        v16 = (char *)(v9 - v7);
      if ( v7 >= (unsigned int)v8 )
        v16 = &v8[(_DWORD)v16 - v35];
      v17 = v9 - v35 - v10;
      if ( v17 < (unsigned int)&v16[v4 - v10] )
      {
        ...
        if ( v7 >= (unsigned int)v8 )
          v27 = &v8[(_DWORD)v27 - v26];
        v43 = *v5;
        v41 = (unsigned int)&v27[v4 - *v5];
        v28 = sub_12DDE8(v41, v10);
        v29 = v43;
        if ( v17 < v41 )
        {
          v30 = v28 + 1;
      ...
      {
        v22 = a2;
        v21 = v12 - (_DWORD)&v8[v9 - v7 - v35 - v13];
        if ( v21 >= v4 )
          v21 = v4;
        v18 = v21;
      }
      ...
      {
        v18 = v12 - (_DWORD)&v8[-v7 - v13];
        v19 = v8;
        if ( v18 >= v4 )
          v18 = v4;
        if ( v9 - (unsigned int)v8 >= v18 )
          v20 = v18;
        else
          v20 = v9 - (_DWORD)v8;
        v8 += v20;
