int __fastcall membist0_rvn(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_92D44(a1, v30, 28, 1);
      sub_92D44(a1, v30, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v6 = ptr;
      v7 = sub_9305C(a1, (unsigned __int16)v30, 161, ptr);
      if ( v7 > 0 )
      {
        v8 = 3 * v7;
        v9 = &ptr[4 * v8];
...
LABEL_10:
      v11 = ptr;
      v12 = sub_9305C(a1, (unsigned __int16)v30, 162, ptr);
      if ( v12 > 0 )
      {
        v13 = 3 * v12;
        v14 = &ptr[4 * v13];
...
LABEL_16:
      v16 = ptr;
      v3 = sub_9305C(a1, (unsigned __int16)v30, 163, ptr);
      if ( v3 > 0 )
      {
        v3 *= 3;
        v17 = &ptr[4 * v3];
...
LABEL_22:
  ...
  while ( &s[5] != v19 );
  v26 = dev_ctrl(v25);
  (*(void (__fastcall **)(_DWORD))(v26 + 80))(*(_DWORD *)(a1 + 220));
  return 0;
}
