int __fastcall sub_29ACC(int a1, const char **a2)
{
  ...
  if ( a2 )
  {
    ...
    *((float *)&v17 + 1) = v67;
    ...
    v21 = sub_12E980(LODWORD(v15), HIDWORD(v15));
    ...
    if ( v23 )
      ...
      v24 = *((float *)&v17 + 1);
    v25 = sub_12E980(COERCE_UNSIGNED_INT64(v24 * v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v24 * v15 * 100.0)));
    v26 = COERCE_DOUBLE(sub_12E62C(v25, HIDWORD(v25)));
    v27 = v26 / 100.0;
    ...
    v31 = sub_12E980(COERCE_UNSIGNED_INT64(v19 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v19 * 100.0)));
    v32 = sub_12E62C(v31, HIDWORD(v31));
    v33 = json_real(v32);
    json_object_set_new(v14, "rate_avg", v33);
    v34 = sub_12E980(COERCE_UNSIGNED_INT64(v18 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v18 * 100.0)));
    v35 = sub_12E62C(v34, HIDWORD(v34));
    v36 = json_real(v35);
    json_object_set_new(v14, "rate_30m", v36);
    v37 = sub_12E980(COERCE_UNSIGNED_INT64(v63 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v63 * 100.0)));
    ...
    v41 = v60;
    if ( opt_algo == 9 )
      v41 = sub_12E944(v60, HIDWORD(v60), 1000, 0);
