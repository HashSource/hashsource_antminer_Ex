int __fastcall scanhash(int a1)
{
  ...
  v3 = snprintf(v2, 0x40u, "%.10s_%d", "scanhash", *(_DWORD *)(a1 + 220));
  V_LOCK(v3);
  v27 = 1;
  syscall(224);
  v4 = 0;
  ...
  v29 = 1;
  v6 = *(_DWORD *)(a1 + 816);
  v7 = calloc(1u, *(_DWORD *)(a1 + 792));
  v28 = 0;
  v8 = (char *)calloc(1u, *(_DWORD *)(a1 + 796));
  while ( 1 )
  {
    memset(s, 0, sizeof(s));
...
LABEL_5:
    ...
    v11 = *(unsigned __int8 *)(a1 + 844);
    if ( *(_BYTE *)(a1 + 844) )
      break;
    memset(v7, *(unsigned __int8 *)(a1 + 844), *(_DWORD *)(a1 + 792));
    v32 = v11;
    v33 = v11;
    v31 = v11;
    ...
    if ( v12 == 10 )
    {
      if ( !queue_enqueue(*(_DWORD *)(a1 + 824), s, v30 + 3) && v29 <= ++v28 )
      {
        V_LOCK(0);
    ...
    else if ( !v12 && *(_BYTE *)(a1 + 230) )
    {
      if ( !*(_BYTE *)(a1 + v33 + 496) && v31 && platform_check_repeat_nonce(a1, v32, v8) )
      {
        ++*(_QWORD *)(*(_DWORD *)(a1 + 424) + 48 * v32 + 32);
      }
      else
      {
        ...
        {
          v14 = v32;
          v15 = (_QWORD *)(*(_DWORD *)(a1 + 424) + 8 * v13 + 48 * v32);
          ++*v15;
          if ( v13 <= 1 )
          {
            v16 = *(_QWORD *)(a1 + 416) + 1LL;
            ++*(_DWORD *)(*(_DWORD *)(a1 + 448) + 4 * v14);
            v17 = v33;
            *(_QWORD *)(a1 + 416) = v16;
            ++*(_QWORD *)(a1 + 8 * v17 + 528);
            if ( !v13
              && !*(_BYTE *)(a1 + v17 + 496)
              && !queue_enqueue(*(_DWORD *)(*(_DWORD *)(a1 + 828) + 820), v7, 1)
              && v27 <= ++v4 )
            {
              V_LOCK(0);
