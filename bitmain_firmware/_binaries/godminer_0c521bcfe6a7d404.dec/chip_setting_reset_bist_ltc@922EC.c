int __fastcall chip_setting_reset_bist_ltc(int a1, int a2, int a3, int a4, int a5)
{
  ...
  if ( !a4 )
  {
    ...
    if ( !a2 )
      v8 = a5;
    LOBYTE(v29) = a2;
    LOBYTE(v10) = *(_BYTE *)(a1 + 308);
    if ( a2 )
    {
      BYTE1(v30) = *(_BYTE *)(a1 + 308);
      v8 = a5;
      goto LABEL_4;
    }
    goto LABEL_13;
...
LABEL_4:
    ...
    while ( 1 )
    {
      ...
      LOBYTE(v30) = v13;
      HIWORD(v30) = 0;
      v14 = (*(int (__fastcall **)(int, int *))(a1 + 244))(a1, &v27);
      if ( v14 )
        break;
      ++v13;
      usleep(0x3E8u);
