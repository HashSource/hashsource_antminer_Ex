int __fastcall sub_8E954(int a1)
{
  int v2; // r0
  int v3; // r0
  int v4; // r2
  ...
  v29 = 16711681;
  v28[0] = 1;
  v3 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 244))(a1, v28);
  if ( v3 < 0 )
  {
    V_LOCK(v3);
    v25 = -1;
  ...
  else
  {
    ...
    v7 = (*(int (__fastcall **)(int, _DWORD *, int, int *, int *, int, int, _DWORD, int, int, int, int, const char *, int))(a1 + 268))(
           a1,
           v28,
           v6,
           ptr,
