void *runtime_ctrl_zec_1746()
{
  ...
  LODWORD(v3[11]) = sub_A2BE8;
  v1 = v0;
  HIDWORD(v3[14]) = sub_A2C08;
  ...
  HIDWORD(v3[25]) = sub_A3620;
  HIDWORD(v3[24]) = sub_A47D4;
