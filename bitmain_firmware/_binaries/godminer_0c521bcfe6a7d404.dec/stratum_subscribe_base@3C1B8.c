int __fastcall stratum_subscribe_base(int a1, int a2)
{
  ...
  do
  {
    ...
    if ( !(*(int (__fastcall **)(int, void *))(a1 + 12))(a2, v10) )
    {
      ...
      v14 = 190;
      v15 = g_zc;
      LOWORD(v16) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroo"
                                      "t/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_base.c";
LABEL_11:
      HIWORD(v16) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tm"
                                  "p/release/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
      zlog(v15, v16, 155, "stratum_subscribe_base", 22, v14, 100, v41);
LABEL_12:
      if ( !v10 )
      {
        if ( !v5 )
          ...
          if ( v36 )
          {
            if ( strstr(v36, "nicehash") )
            {
              *(_DWORD *)(a2 + 1920) = 3;
              ...
              if ( v37 )
              {
                v20 = socket_full(*(_DWORD *)(a2 + 36), 30);
                if ( v20 )
                {
