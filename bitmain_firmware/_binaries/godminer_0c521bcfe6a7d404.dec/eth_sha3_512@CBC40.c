int __fastcall eth_sha3_512(int a1, unsigned int a2, int a3, unsigned int a4)
{
  ...
  {
    v145 = &unk_157E00;
    v146 = (unsigned __int8 *)&unk_157E1F;
  }
  else
  {
    v7 = 0;
    ...
    while ( 1 )
    {
      ...
      for ( i = 0; ; i = (unsigned int)v64 )
      {
        ...
        v32 = (unsigned __int8 *)&unk_157E08;
        v33 = 1;
        v34 = s[2];
        v35 = 10;
        v36 = s[3];
        v37 = (unsigned __int8 *)&unk_157E20;
        v38 = v146;
        while ( 1 )
        {
          v41 = -v33 & 0x3F;
  ...
  *((_BYTE *)s + v148) ^= 1u;
  ...
  for ( k = 0; ; k = v130[3] )
  {
    ...
    while ( 1 )
    {
      v90 = &v153[8 * (v88 - 5 * ((unsigned int)(((unsigned int)v88 * (unsigned __int64)v85) >> 32) >> 2))];
      v91 = *((_DWORD *)v90 - 60);
      v92 = *((_DWORD *)v90 - 59);
      v93 = &v153[8 * (v88 + 3 - 5 * ((unsigned int)(((unsigned int)(v88 + 3) * (unsigned __int64)v85) >> 32) >> 2))];
      v94 = v87;
      v95 = *((_DWORD *)v93 - 60);
      v96 = *((_DWORD *)v93 - 59);
      v97 = 2 * v91;
    ...
    v100 = (unsigned __int8 *)&unk_157E08;
    v139 = v85;
    v101 = 1;
    v102 = s[2];
    v103 = 10;
    v104 = s[3];
    v105 = (unsigned __int8 *)&unk_157E20;
    v106 = v146;
    while ( 1 )
    {
      v109 = -v101 & 0x3F;
