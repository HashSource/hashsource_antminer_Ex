bool __fastcall sub_3EC3C(int a1, int *a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r5
  _BOOL4 v7; // r4
  ...
  int v63; // r0
  int v64; // r0
  int v65; // [sp+14h] [bp-1038h]
  const char *v66; // [sp+18h] [bp-1034h]
  unsigned int v67; // [sp+18h] [bp-1034h]
  char *s; // [sp+1Ch] [bp-1030h]
  _BOOL4 v69; // [sp+20h] [bp-102Ch]
  pthread_mutex_t *mutex; // [sp+28h] [bp-1024h]
  void *ptr; // [sp+2Ch] [bp-1020h]
  char *ptra; // [sp+2Ch] [bp-1020h]
  size_t n; // [sp+30h] [bp-101Ch]
  size_t v74; // [sp+34h] [bp-1018h]
  size_t nmemb; // [sp+38h] [bp-1014h]
  int v76; // [sp+3Ch] [bp-1010h]
        ...
        if ( valid )
        {
          ...
          if ( valid )
          {
            ...
            if ( valid )
            {
              ...
              snprintf((char *)a2 + 356, 9u, "%s", v66);
              strcpy((char *)a2 + 1556, v66);
              v26 = a2[21];
              v27 = a2[81];
              v28 = n + a2[19];
              *((_BYTE *)a2 + 444) = v21;
              ...
              {
                v50 = 0;
                a2[82] = (int)realloc((void *)a2[82], 4 * v65);
                while ( 1 )
                {
                  v76 = 4 * v50;
                  if ( v65 <= v50 )
                  ...
                  *(_DWORD *)(v77 + 4 * v50) = v53;
                  if ( !v53 )
                  {
                    ...
                    v53 = (void *)zlog(
                                    ...
                                    "tmp/release/build/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                                    167,
                                    "stratum_notify_dcr",
                                    18,
                                    146,
                  ...
                  ++v50;
                  if ( !hex2bin(*(_DWORD *)(a2[82] + v76), v52, 32) )
                  {
                    v7 = 0;
                    V_LOCK(0);
              ...
              if ( v7 )
              {
                ...
                if ( hex2bin((int)v32, (unsigned __int8 *)v17, nmemb) )
                {
                    ...
                    if ( v7 )
                    {
                      ...
                      if ( !v45 )
                      {
                        ...
                        zlog(
                          ...
                          "e/build/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                          167,
                          "stratum_notify_dcr",
                          18,
                          197,
                      ...
                      memcpy((void *)a2[75], v33, n);
                      memcpy(a2 + 116, v32, nmemb);
                      memcpy((char *)a2 + nmemb + 464, v78, (size_t)ptra);
                      memcpy(&ptra[nmemb + (_DWORD)(a2 + 116)], v33, n);
                      memcpy(a2 + 152, (const void *)a2[20], a2[19]);
                      memcpy(a2 + 160, v43, v74);
                      *((_QWORD *)a2 + 57) = *a2;
                      pthread_mutex_unlock(mutex);
                      if ( !v31 )
                        goto LABEL_59;
                  ...
                  zlog(
                    ...
                    "d/godminer-origin_godminer-new/frontend/frontend_dcr/frontend_dcr.c",
                    167,
                    "stratum_notify_dcr",
                    18,
                    v62,
