      ...
      if ( total_pools > 0 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)v78 = 0;
          ...
          v58 = sub_12E62C(v57, HIDWORD(v57));
          v59 = json_real(v58);
          json_object_set_new(v30, "Difficulty Accepted", v59);
          v60 = sub_12E980(COERCE_UNSIGNED_INT64(*v52 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(*v52 * 100.0)));
          ...
          v67 = sub_12E62C(v66, HIDWORD(v66));
          v68 = json_real(v67);
          ...
          if ( v21 != 0.0 )
          {
            ...
            v20 = sub_12E62C(v22, HIDWORD(v22));
          }
          v23 = json_real(v20);
          ...
          if ( v26 != 0.0 )
          {
            ...
            v24 = sub_12E62C(v27, HIDWORD(v27));
          }
          v28 = json_real(v24);
