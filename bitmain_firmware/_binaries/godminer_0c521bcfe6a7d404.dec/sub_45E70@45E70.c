int __fastcall sub_45E70(int a1, int a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r0
  char *v7; // r9
...
LABEL_16:
      ...
      *(_DWORD *)(a2 + 1588) = v26;
      ...
      hex2bin((int)v26, (unsigned __int8 *)v44, v14 >> 1);
      hex2bin(a2 + 1488, (unsigned __int8 *)v10, v18 >> 1);
      v27[12] = v42;
      v28 = target_to_diff_rvn(a2 + 1488);
