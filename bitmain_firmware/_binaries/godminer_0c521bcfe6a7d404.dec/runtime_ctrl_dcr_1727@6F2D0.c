void *runtime_ctrl_dcr_1727()
{
  ...
  HIDWORD(v3[11]) = sub_6D770;
  LODWORD(v3[11]) = sub_6D88C;
  LODWORD(v3[12]) = sub_6BD20;
  LODWORD(v3[13]) = sub_6D4A0;
  HIDWORD(v3[13]) = sub_6D0C4;
  HIDWORD(v3[14]) = sub_6C808;
  LODWORD(v3[14]) = sub_6CCFC;
  LODWORD(v3[15]) = sub_6C464;
  ...
  HIDWORD(v3[24]) = sub_6E12C;
  HIDWORD(v3[23]) = set_frequency_dcr;
  LODWORD(v3[25]) = sub_6B240;
  LODWORD(v3[26]) = top_init_dcr;
  HIDWORD(v3[25]) = sub_6BD38;
