int __fastcall membist0(int a1)
{
  ...
  for ( i = 0; i != 5; ++i )
  {
    ...
    do
    {
      sub_6FD60(v8, v47, 12, 1);
      sub_6FD60(v8, v47, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v10 = sub_70000(v8, (unsigned __int16)v47, 161, ptr);
      v11 = v10;
      if ( v10 == 8
        || (V_LOCK(v10),
            V_INT((int)&v53, "chain"),
...
LABEL_11:
      memset(ptr, 0, 0x600u);
      v16 = sub_70000(v8, (unsigned __int16)v47, 162, ptr);
      v17 = v16;
      if ( v16 == 8
        || (V_LOCK(v16),
            V_INT((int)v56, "chain"),
...
LABEL_19:
      memset(ptr, 0, 0x600u);
      v4 = (void *)sub_70000(v8, (unsigned __int16)v47, 163, ptr);
      v22 = (int)v4;
      if ( v4 == (void *)8
        || (V_LOCK(v4),
            V_INT((int)&v59, "chain"),
