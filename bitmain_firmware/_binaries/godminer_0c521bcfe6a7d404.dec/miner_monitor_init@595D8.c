int __fastcall miner_monitor_init(int a1)
{
  ...
  add_new_task(dword_1756C8, sub_593B8, "ith_voltage_zec");
  v12 = add_new_task(dword_1756C8, sub_59A1C, 60000);
  dword_1756CC = new_task_timer(v12);
  add_new_task(dword_1756CC, sub_592F0, 5000);
  add_new_task(dword_1756CC, sub_59228, 1000);
