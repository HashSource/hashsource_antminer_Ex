int __fastcall sub_290D4(int a1, const char **a2)
{
  ...
  else
  {
    ...
    v21 = sub_12E980(LODWORD(v9), HIDWORD(v9));
    ...
    if ( v23 )
    {
      v123 = sub_12E980(COERCE_UNSIGNED_INT64(v15 * v9 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v15 * v9 * 100.0)));
      v124 = sub_12E62C(v123, HIDWORD(v123));
      v125 = json_real(v124);
      v29 = v20;
      json_object_set_new(v20, "rate_5s", v125);
      v126 = sub_12E980(COERCE_UNSIGNED_INT64(v19 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v19 * 100.0)));
      v28 = sub_12E62C(v126, HIDWORD(v126));
    }
    else
    {
      v24 = sub_12E980(COERCE_UNSIGNED_INT64(v16 * v9 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v16 * v9 * 100.0)));
      v25 = sub_12E62C(v24, HIDWORD(v24));
      v26 = json_real(v25);
      ...
      v28 = sub_12E62C(v27, HIDWORD(v27));
      v29 = v20;
    }
    v30 = json_real(v28);
    json_object_set_new(v29, "rate_avg", v30);
    v31 = sub_12E980(COERCE_UNSIGNED_INT64(v18 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v18 * 100.0)));
    v32 = sub_12E62C(v31, HIDWORD(v31));
    v33 = json_real(v32);
    json_object_set_new(v29, "rate_30m", v33);
    v34 = sub_12E980(COERCE_UNSIGNED_INT64(v137 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v137 * 100.0)));
    ...
    if ( v17 + total_diff1 )
    {
      v103 = COERCE_DOUBLE(((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E61C)(v17, HIDWORD(v17)));
      v104 = sub_12E61C(v47, HIDWORD(v47));
      v105 = sub_12E980(
               COERCE_UNSIGNED_INT64(v103 / v104 * 100.0 * 10000.0),
               HIDWORD(COERCE_UNSIGNED_INT64(v103 / v104 * 100.0 * 10000.0)));
      v46 = sub_12E62C(v105, HIDWORD(v105));
    }
    v48 = json_real(v46);
    ...
    if ( v136 > 0 )
    {
      ...
      while ( 1 )
      {
        ...
        v60 = sub_12E980(LODWORD(v59), HIDWORD(v59));
        v61 = sub_12E62C(v60, HIDWORD(v60));
        v62 = json_real(v61);
        json_object_set_new(v54, "rate_ideal", v62);
        v63 = sub_12E980(COERCE_UNSIGNED_INT64(v58 * v9 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v58 * v9 * 100.0)));
        v64 = sub_12E62C(v63, HIDWORD(v63));
        v65 = json_real(v64);
...
LABEL_36:
        ...
        v94 = *((_QWORD *)v51 + 10);
        if ( opt_algo == 9 )
          v94 = sub_12E944(v94, HIDWORD(v94), 1000, 0);
