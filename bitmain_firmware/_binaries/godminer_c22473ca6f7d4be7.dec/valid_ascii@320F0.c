int __fastcall valid_ascii(const char *a1)
{
  ...
  if ( !a1 )
  {
    ...
    LOWORD(v6) = 4048;
LABEL_9:
    HIWORD(v6) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/relea"
...
LABEL_8:
    v5 = g_zc;
    LOWORD(v6) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/r"
