void *frontend_runtime_ltc()
{
  ...
  dword_16628C = (int)sub_48664;
  dword_166290 = (int)sub_48700;
  dword_166294 = (int)sub_47BEC;
  dword_166288 = (int)sub_485B0;
  dword_166298 = (int)sub_4837C;
  dword_16629C = (int)stratum_subscribe_base;
  dword_1662A0 = (int)stratum_authorize_base;
  dword_1662A4 = (int)sub_47C24;
  dword_1662A8 = (int)sub_47920;
