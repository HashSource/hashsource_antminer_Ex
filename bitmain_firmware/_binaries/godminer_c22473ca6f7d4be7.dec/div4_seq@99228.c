int __fastcall div4_seq(int a1, int a2, int a3, int a4)
{
  ...
  sub_5D8A4(a1, a3, v12, -252706816);
  sub_5D8A4(a1, a3, v11, -65536);
  sub_5D8A4(a1, a3, v13, 61680);
  sub_5D8A4(a1, a3, v11, (int)&loc_FFFFC + 3);
  sub_5D8A4(a1, a3, v13, 251658240);
  sub_5D8A4(a1, a3, v11, -1048576);
  sub_5D8A4(a1, a3, v14, (int)&loc_F0F0C + 3);
  sub_5D8A4(a1, a3, v11, 0xFFFFFF);
  sub_5D8A4(a1, a3, v14, -268435456);
  sub_5D8A4(a1, a3, v11, -16777216);
  sub_5D8A4(a1, a3, v15, 15790320);
  sub_5D8A4(a1, a3, v11, 4095);
  sub_5D8A4(a1, a3, v16, 252641280);
  sub_5D8A4(a1, a3, v11, -4096);
  sub_5D8A4(a1, a3, v12, 3855);
