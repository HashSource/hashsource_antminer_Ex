            ...
            && strlen((const char *)v243) == 8 )
          {
            ...
            while ( v253 > v141 )
            {
              ...
              if ( !v203 || strlen(v203) != 64 )
              {
                ...
                LOWORD(v227) = 11324;
                HIWORD(v227) = (unsigned int)"tranonce_ckb" >> 16;
                zlog(*v226, v227, 163, "stratum_notify", 14, 235, 100, s);
                goto LABEL_47;
              }
              v205 = malloc(0x20u);
...
LABEL_59:
    LOWORD(v83) = 11324;
    HIWORD(v83) = (unsigned int)"tranonce_ckb" >> 16;
...
LABEL_47:
  ...
  if ( !strcasecmp(v8, v27) )
  {
    ...
    LOWORD(v70) = 11324;
    HIWORD(v70) = (unsigned int)"tranonce_ckb" >> 16;
  ...
  if ( !strcasecmp(v8, v29) )
  {
        ...
        else
        {
          ...
          *(_DWORD *)(a2 + 76) = v91;
          if ( !v91 )
          {
            ...
            LOWORD(v208) = 11324;
            HIWORD(v208) = (unsigned int)"tranonce_ckb" >> 16;
            zlog(*v207, v208, 163, "stratum_parse_extranonce", 24, 340, 100, s);
            pthread_mutex_unlock((pthread_mutex_t *)(a2 + 1752));
            goto LABEL_11;
          }
    ...
    LOWORD(v96) = 11324;
    HIWORD(v96) = (unsigned int)"tranonce_ckb" >> 16;
  ...
  else
  {
    ...
    if ( !strcasecmp(v8, v30) )
    {
      ...
      if ( !v104 )
      {
        ...
        LOWORD(v111) = 11324;
        HIWORD(v111) = (unsigned int)"tranonce_ckb" >> 16;
      ...
      else
      {
        ...
        if ( !strcasecmp(v8, v34) )
        {
          ...
          if ( v35 )
          {
            ...
            LOWORD(v39) = 11324;
            HIWORD(v39) = (unsigned int)"tranonce_ckb" >> 16;
        ...
        LOWORD(v187) = 11324;
        HIWORD(v187) = (unsigned int)"tranonce_ckb" >> 16;
        zlog(*v186, v187, 163, "stratum_handle_method_grin29", 28, 820, 80, s);
        if ( !v26 || *v26 == 7 )
          goto LABEL_10;
        v188 = json_object();
        v117 = v188;
        ...
        sub_3FD6C(v117, (_DWORD *)0x26, v194);
        v125 = json_dumps(v117, 0);
        v11 = stratum_send_line((int *)a2, v125);
        if ( v117 && v117[1] != -1 )
        {
...
LABEL_92:
    ...
    LOWORD(v115) = 11324;
    HIWORD(v115) = (unsigned int)"tranonce_ckb" >> 16;
