int __fastcall chip_setting_fuart_cfg_dcr(int a1, int a2)
{
  int v4; // r3
  int *v5; // r3
  int v6; // r0
...
LABEL_9:
  ...
  LOWORD(v5) = 32408;
  LOWORD(v7) = 32524;
  HIWORD(v5) = (unsigned int)"Setting_get_addr_DASH" >> 16;
  HIWORD(v7) = (unsigned int)"dash" >> 16;
  zlog(v6, v7, 159, v5, 26, 74, 60, v14);
