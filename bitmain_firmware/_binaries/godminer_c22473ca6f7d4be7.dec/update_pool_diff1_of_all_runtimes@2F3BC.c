__int64 *__fastcall update_pool_diff1_of_all_runtimes(int *a1)
{
  ...
  WORD2(v4) = 21504;
  LOWORD(result) = -14184;
  HIWORD(v4) = (unsigned int)&unk_1642D8 >> 16;
  HIWORD(result) = (unsigned int)&unk_16B698 >> 16;
  HIDWORD(v4) += 8 * v3;
  v10 = *(_DWORD *)result;
  ...
  *(_DWORD *)(HIDWORD(v4) + 132) = v7;
  ...
  v14 = a1[538];
  v15 = a1[539];
  *result = __PAIR64__(*((_DWORD *)result + 1), v10) + v13;
  a1[538] = v14 + v13;
  a1[539] = HIDWORD(v13) + __CFADD__(v14, (_DWORD)v13) + v15;
  return result;
}
