int __fastcall sub_5C5E4(int a1, char a2, int a3, __int16 a4, void *a5)
{
  bool v5; // zf
  int v6; // r6
  ...
  v19 = 0;
  V_LOCK();
  logfmt_raw(v27, 0x1000u, 0, "%s core_no %d", "ChipSetting_get_single_chip_core_status_ETH", v9);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  v23 = a4;
  v24 = v7;
  (*(void (__fastcall **)(int, _DWORD *, int, _DWORD *, int *, int, int, _DWORD))(a1 + 184))(
    a1,
    v20,
    v9,
    v12,
