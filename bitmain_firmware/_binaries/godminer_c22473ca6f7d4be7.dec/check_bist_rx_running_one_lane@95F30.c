int __fastcall check_bist_rx_running_one_lane(int a1, int a2, int a3, int a4)
{
  char *v8; // r1
  int v9; // r4
  _DWORD *v10; // r6
  ...
  zlog(*v10, v12, 154, "check_bist_rx_running_one_lane", 30, 8899, 60, v29);
  ...
  if ( back > 0 )
  {
    ...
    do
    {
      ...
      {
        V_LOCK();
        HIWORD(v14) = (unsigned int)&loc_12D594 >> 16;
      ...
      else
      {
        V_LOCK();
        LOWORD(v20) = -23208;
        HIWORD(v20) = (unsigned int)&unk_139888 >> 16;
      ...
      v11 += 8;
      zlog(v15, v18, 154, "check_bist_rx_running_one_lane", 30, v17, v16, v29);
    }
    while ( v11 != v23 );
  }
  return 0;
