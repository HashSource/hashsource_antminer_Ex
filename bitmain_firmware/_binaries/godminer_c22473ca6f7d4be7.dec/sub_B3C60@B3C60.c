int sub_B3C60()
{
  ...
  if ( dword_16C55C[0] || (dword_16C55C[0] = (int)calloc(1u, 0x54u)) != 0 )
  {
    v0 = dword_16C560;
    if ( dword_16C560 <= 0 )
      return 0;
  ...
  HIWORD(v8) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/release"
                             "/build/godminer-origin_master/backend/device/hal/eeprom/bitmain_eeprom.c" >> 16;
  zlog(v7, v8, 163, "_alloc_memory", 13, v6, 100, v17);
  v9 = (_DWORD *)dword_16C55C[0];
  if ( !dword_16C55C[0] )
    return -1;
  v11 = dword_16C560;
  if ( dword_16C560 > 0 )
