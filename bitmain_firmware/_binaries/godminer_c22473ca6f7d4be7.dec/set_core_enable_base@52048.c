int __fastcall set_core_enable_base(int result, int a2, __useconds_t a3)
{
  ...
  if ( *(_BYTE *)(a2 + 13) )
  {
    ...
    V_LOCK();
    LOWORD(v14) = 23072;
    HIWORD(v14) = (unsigned int)"f" >> 16;
    logfmt_raw(v17, 0x1000u, 0, v14, "set_core_enable_base", *(unsigned __int16 *)(a2 + 10), v4);
    V_UNLOCK();
    LOWORD(v15) = -14512;
    HIWORD(v15) = (unsigned int)&unk_16B55C >> 16;
    LOWORD(v16) = 22788;
    HIWORD(v16) = (unsigned int)"r_E9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/miner_util/miner_monitor/check_miner_status.c" >> 16;
