  ...
  if ( v24 > 0 )
  {
    ...
    do
    {
      ...
      v9 = snprintf(
             ...
             *(_DWORD *)v20,
             *(_DWORD *)(*(_DWORD *)v20 + 248),
             *(_DWORD *)(*(_DWORD *)v20 + 252),
             *(_DWORD *)(*(_DWORD *)v20 + 256),
             *(_DWORD *)(*(_DWORD *)v20 + 260),
             HIDWORD(v4));
      v10 = *(_DWORD *)v20;
      v11 = v4 + v9;
      v21 = *(_DWORD *)(*(_DWORD *)v20 + 196);
      if ( v21 > 0 )
      {
        v12 = 0;
        v19 = 0;
