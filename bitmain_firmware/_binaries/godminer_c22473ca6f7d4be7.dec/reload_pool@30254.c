int reload_pool()
{
  ...
  if ( newthread )
  {
    ...
    v1 = 785;
    v2 = g_zc;
    LOWORD(v3) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/r"
                                   "elease/build/godminer-origin_master/pool.c";
LABEL_5:
    HIWORD(v3) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/relea"
                               "se/build/godminer-origin_master/pool.c" >> 16;
    return zlog(v2, v3, 127, "reload_pool", 11, v1, 100, v4);
  }
  result = pthread_create(&newthread, 0, (void *(*)(void *))sub_2F560, 0);
  if ( result )
  {
    V_LOCK();
