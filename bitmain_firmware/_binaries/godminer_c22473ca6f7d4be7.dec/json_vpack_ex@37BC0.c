double *__fastcall json_vpack_ex(char *a1, int a2, _BYTE *a3, int *a4)
{
  ...
  if ( a3 && *a3 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( (_BYTE)v19 )
      {
        ...
        LOWORD(v12) = 6444;
        LOWORD(v13) = 5620;
        HIWORD(v12) = (unsigned int)&unk_130D58 >> 16;
        HIWORD(v13) = (unsigned int)"/system_info.c" >> 16;
        v8 = 0;
        sub_36388(v18, v13, 9, v12);
      }
    }
    return v8;
  }
  ...
  {
    LOWORD(v10) = 5620;
    HIWORD(v10) = (unsigned int)"/system_info.c" >> 16;
    jsonp_error_init(a1, v10);
    LOWORD(v11) = 6416;
    HIWORD(v11) = (unsigned int)&unk_130D3C >> 16;
