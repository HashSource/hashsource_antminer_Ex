int __fastcall SOC_28G_static_axlk_txdata_en(int a1, int a2, unsigned __int8 a3)
{
  ...
  logfmt_raw(v13, 0x1000u, 0, v12, v11[0], v11[1], v11[2], v11[3], v11[4], v11[5], v11[6], v12, v7, v6 + 2852);
  V_UNLOCK();
  LOWORD(v8) = -14512;
  HIWORD(v8) = (unsigned int)&unk_16B55C >> 16;
  LOWORD(v9) = -25512;
  HIWORD(v9) = (unsigned int)"one" >> 16;
  zlog(*v8, v9, 154, v6 + 2884, 29, 7689, 60, v13);
  sub_5C158(a1, a3, 144, 0x7FFFFFFF);
  sub_5C158(a1, a3, 145, -2147422207);
  sub_5C158(a1, a3, 144, 0x80000000);
  sub_5C158(a1, a3, 145, -2147422072);
  sub_5C158(a1, a3, 144, 0x7FFFFFFF);
  sub_5C158(a1, a3, 145, -2147422207);
  sub_5C158(a1, a3, 144, 0x80000000);
  sub_5C158(a1, a3, 145, -2147422047);
  sub_5C158(a1, a3, 144, 0x7FFFFFFF);
  sub_5C158(a1, a3, 145, -2147422207);
