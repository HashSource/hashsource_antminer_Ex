int bitmain_power_fw_version()
{
  ...
  if ( dword_16C644 || (v0 = sub_B70F4(), v0 >= 0) )
  {
    ...
    if ( sub_B6918(dword_16C640, (unsigned __int8 *)&v14, 6u, (unsigned __int8 *)&v16, 8u) )
    {
      ...
      zlog(*v12, v13, 166, "_bitmain_get_power_fw_version", 29, 206, 100, v20);
    }
    else
    {
  ...
  else
  {
    ...
    snprintf((char *)s, 0x800u, v2, "bitmain_power_fw_version");
    V_LOCK();
    logfmt_raw(v20, 0x1000u, 0, s);
    V_UNLOCK();
    LOWORD(v3) = -14512;
    ...
    zlog(*v3, v4, 166, "bitmain_power_fw_version", 24, 442, 100, v20);
  }
  return v0;
}
