int __fastcall i2c_init(const char *a1)
{
  ...
  if ( !platform_inited[0] )
  {
    ...
    LOWORD(v14) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/"
...
LABEL_21:
    ...
    zlog(v12, v14, 168, v13, 8, v11, 100, s);
    return v9;
  }
  ...
  if ( dword_16C6D8 )
  {
    v2 = (_DWORD *)dword_16C6DC;
  }
  else
  {
    v2 = new_c_map((int)sub_BB758, 0, 0);
    dword_16C6DC = (int)v2;
  }
...
LABEL_16:
    ...
    if ( !strcmp("power-api", a1) )
    {
      ...
      insert_c_map((int *)dword_16C6DC, &dword_16C6D8, 4u, s, 0x90u);
      v9 = dword_16C6D8;
      goto LABEL_14;
    }
    v7 = open64(a1);
