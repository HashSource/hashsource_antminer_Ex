bool __fastcall sub_3DE84(int a1, pthread_mutex_t *a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r5
  _BOOL4 v7; // r4
  ...
  int v51; // r1
  int v52; // lr
  signed int v53; // [sp+14h] [bp-1040h]
  ...
  if ( !v5 || *v5 != 1 )
    return 0;
  v53 = (signed int)json_array_size(v5);
  ...
  if ( valid_ascii(v10) && valid_hex(v12) && valid_hex(v14) && valid_hex(v17) && valid_hex(v19) && valid_hex(v54) )
  {
    ...
    if ( nusers && !strcmp(nusers, v10) )
    {
      V_LOCK();
      logfmt_raw(v66, 0x1000u, 0, "Stratum notify: new job's job_id doesnot change, %s, %s", a2[66].__nusers, v10);
      V_UNLOCK();
      zlog(
        g_zc,
    ...
    ptr = (void *)a2[66].__nusers;
    a2[66].__nusers = (unsigned int)_strdup(v10);
    if ( ptr )
      free(ptr);
