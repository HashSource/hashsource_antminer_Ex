int __fastcall main(int argc, const char **argv, const char **envp)
{
  ...
  v4 = lzo_pclock_open_default(&dword_2A630);
  v5 = *argv;
...
LABEL_11:
  ...
  v13 = &dword_2A200;
  dword_2A624 = 0x4000000;
  dword_2A628 = 0x40000;
  if ( argc <= 1 )
    sub_143D8(off_2A1D4, -1, 0);
  v14 = s;
  memset(s, 0, 0x38u);
  s[1] = off_2A1D4;
  s[8] = argc;
  ...
  while ( 1 )
  {
    v15 = lzo_getopt(s, &unk_181B8, &off_18068, 0);
    if ( v15 < 0 )
      break;
    if ( v15 == 100 )
      goto LABEL_66;
          ...
          else if ( v15 == 98 )
          {
            ...
            if ( s[3] )
            {
              if ( (unsigned int)*(unsigned __int8 *)s[3] - 48 > 9 )
                goto LABEL_34;
              dword_2A628 = strtol((const char *)s[3], 0, 10);
            }
          }
          else
          {
...
LABEL_66:
        ...
        else
        {
          ...
          if ( s[11] )
          {
            sub_14898(*(_DWORD *)(s[9] + 4 * s[5]) + s[11] - 1);
            s[11] = 0;
            ++s[5];
          }
          else
...
LABEL_307:
    ...
    else if ( v15 >= 520 )
    {
      ...
      else if ( v15 <= 520 )
      {
        if ( !s[3] || (unsigned int)*(unsigned __int8 *)s[3] - 48 > 9 )
          goto LABEL_34;
        dword_2A624 = strtol((const char *)s[3], 0, 10);
      }
      else if ( v15 == 522 )
      {
        if ( !s[3] || !*(_BYTE *)s[3] )
  ...
  v106 = s[5];
  if ( !dword_2A21C )
    sub_14140(default_method);
  if ( dword_2A21C > 1 && opt_read_from_stdin )
  {
    printf("%s: cannot use multiple methods and '-@'\n", (const char *)off_2A1D4);
    goto LABEL_34;
  }
  if ( !dword_2A628 || dword_2A628 > (unsigned int)dword_2A624 )
  ...
  if ( dword_2A21C > 0 )
  {
    ...
    do
    {
      ...
      while ( v21 != v23 )
      {
        if ( v24 == (char **)&unk_17DF0 || (v25 = v24[14], v24 += 14, !v25) )
        {
          if ( v19 )
            dword_2A6B0 = v20;
          _assert_fail(
            "c != NULL",
            "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/tmp/debug/build/lzo-2.10/l"
            "zotest/lzotest.c",
            0x7B2u,
            "main");
        }
    ...
    while ( dword_2A21C != v17 );
    if ( v19 )
      dword_2A6B0 = v20;
  }
  sub_13E7C(&dword_2A6AC, dword_2A6B0, 0);
  lzo_memset(dword_2A6AC, 0, dword_2A6B0);
  sub_13E7C(&dword_2A670, dword_2A628 + 256 + ((unsigned int)dword_2A628 >> 3), 16);
  if ( opt_use_asm_fast_decompressor )
    v28 = 3;
  else
    v28 = 0;
  sub_13E7C(&dword_2A690, dword_2A628 + v28, 16);
  if ( opt_dict )
  {
    ...
    if ( opt_dictionary_file )
    {
      ...
      if ( v96 )
      {
        dword_2A204 = fread((void *)dword_2A200, 1u, dword_2A214, v96);
        fclose(v97);
        dword_2A208 = lzo_adler32(1, dword_2A200, dword_2A204);
      }
      if ( !dword_2A204 )
      {
LABEL_278:
        dword_2A204 = 4096;
        if ( (unsigned int)dword_2A214 < 0x1000 )
          dword_2A204 = dword_2A214;
        lzo_memset(dword_2A200, 0, dword_2A204);
        v98 = 0;
        v99 = 0;
LABEL_281:
        v100 = v98 + 16;
        v101 = v98;
        while ( dword_2A204 > v98 )
        {
          ++v98;
          *(_BYTE *)(dword_2A200 + v101) = v99;
          if ( v100 == v98 )
          {
            if ( ++v99 != 256 )
              goto LABEL_281;
        ...
        if ( !v35 )
        {
          while ( fgets((char *)s, 511, (FILE *)stdin) )
          {
            ...
            if ( LOBYTE(s[0]) )
            {
              ...
              {
LABEL_183:
                v68 = sub_15A5C(v29, v61, v13[338], v13[339], 0, 0);
                if ( v68 != 2 )
                {
                  v35 = v68;
                  goto LABEL_140;
      ...
      else
      {
        ...
        do
        {
          ...
          while ( 1 )
          {
            v42 = (int)*v41++;
            ++v40;
            v43 = sub_15A5C(v29, v42, v13[338], v13[339], 0, 0);
            if ( v43 != 2 )
              break;
            if ( argc <= v40 )
              goto LABEL_138;
...
LABEL_205:
  ...
  while ( 1 )
  {
    v79 = *(_DWORD *)(v70 + 4);
    strcpy(v76, v75);
    v80 = sub_15A5C(v29, s, v79 * v107, v79 * v108, &v112, v113);
    if ( v80 )
    {
      v13 = v110;
      v35 = v80;
...
LABEL_121:
  ...
  if ( v37 && (opt_verbose > 0 && (unsigned int)v13[315] > 1 || v37 > 1) )
  {
    ...
    if ( !opt_pclock )
      v14 = v103;
    sub_142B0(v113);
    v86 = sub_16910(v13[317], v82);
    v87 = (double)(unsigned int)v13[318];
    v88 = v87 / (double)v82;
    v89 = sub_16910(v13[316], v82);
    if ( dbl_2A710 <= 0.00001 )
    {
      v90 = 0.0;
    }
    else
  ...
  if ( v13[345] || v13[7] > 1 && opt_verbose > 0 )
    printf("\n%s: execution time: %lu seconds\n", (const char *)off_2A1D4, v38 - v111);
  if ( v35 )
    printf("\n%s: exit code: %d\n", (const char *)off_2A1D4, v35);
  v13[268] = 0;
  v13[271] = 0;
  v13[272] = 0;
  v13[269] = -1;
