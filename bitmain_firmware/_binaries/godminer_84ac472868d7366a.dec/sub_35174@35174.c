unsigned int __fastcall sub_35174(_DWORD *a1, int a2)
{
  _DWORD *v2; // r7
  unsigned int v5; // r4
  bool v6; // cc
  ...
  if ( v5 != 34 )
  {
    ...
    if ( !v11 )
    {
      ...
      if ( v5 == 45 )
      {
        v31 = sub_3511C((int)a1, a2);
        if ( v31 == 48 )
        {
LABEL_60:
          v20 = sub_3511C((int)a1, a2);
          if ( v20 - 48 <= 9 )
          {
LABEL_61:
            sub_3515C(a1, v20);
...
LABEL_70:
            ...
            sub_34DBC(a2, a1, 15, "real number overflow");
            return a1[15];
          }
          v20 = sub_3511C((int)a1, a2);
...
LABEL_146:
            ...
            sub_34DBC(a2, a1, 8, v44, *(_DWORD *)arg);
            goto LABEL_57;
          }
          v47 = v36 - 55296;
          ...
          else
          {
            ...
            {
LABEL_153:
              sub_34DBC(a2, a1, 8, "invalid Unicode '\\u%04X'", v36);
              goto LABEL_57;
            }
            v38 = sub_34CB0((int)(i + 7));
            if ( v38 < 0 )
            {
              LOWORD(v44) = 5784;
              *(_DWORD *)arg = i + 6;
            ...
            {
              sub_34DBC(a2, a1, 8, "invalid Unicode '\\u%04X\\u%04X'", v37, v38);
              goto LABEL_57;
            }
...
LABEL_109:
    ...
    if ( v17 == -1 )
    {
      sub_34DBC(a2, a1, 6, "premature end of input");
      goto LABEL_57;
    }
    if ( v17 <= 0x1F )
      break;
    ...
    if ( v17 == 92 )
    {
      v18 = sub_3511C((int)a1, a2);
      if ( v18 == 117 )
      {
        v27 = 4;
        v17 = sub_3511C((int)a1, a2);
        while ( 1 )
        {
          v28 = v17 & 0xFFFFFFDF;
          v29 = v17 - 48;
...
LABEL_56:
        sub_34DBC(a2, a1, 8, "invalid escape");
        goto LABEL_57;
      }
      v19 = v18 == 92;
      if ( v18 != 92 )
  ...
  sub_3515C(a1, v17);
  if ( v17 == 10 )
    sub_34DBC(a2, a1, 8, "unexpected newline");
  else
    sub_34DBC(a2, a1, 8, "control character 0x%x", v17);
LABEL_57:
  jsonp_free(a1[16]);
  v8 = a1[15];
  a1[16] = 0;
