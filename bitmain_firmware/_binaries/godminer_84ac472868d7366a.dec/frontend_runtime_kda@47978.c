void *frontend_runtime_kda()
{
  ...
  dword_166224 = (int)sub_478BC;
  dword_166228 = (int)sub_47928;
  dword_16622C = (int)sub_474F8;
  dword_166220 = (int)sub_477DC;
  dword_166230 = (int)sub_47134;
  dword_166234 = (int)stratum_subscribe_base;
  dword_166238 = (int)stratum_authorize_base;
  dword_16623C = (int)sub_47530;
  dword_166240 = (int)sub_4722C;
