int __fastcall sub_484F4(int a1, int *a2, int a3)
{
  size_t v5; // r6
  int v6; // r6
  int v7; // r6
  ...
  if ( v5 )
  {
    if ( v5 >= 8 )
      ...
      v32 = v5;
    memcpy(*(void **)(a1 + 1160), &dword_166260, v32);
    ++*(_QWORD *)&dword_166260;
  }
  ...
  if ( v6 > 0 )
  {
    ...
    do
    {
      ...
      v50[7] = v13;
      v50[8] = v14;
      sha256((int)&v43, 0x40u);
      sha256((int)v41, 0x20u);
      v15 = a2[79];
      v43 = v33;
      v44 = v34;
      v45 = v35;
