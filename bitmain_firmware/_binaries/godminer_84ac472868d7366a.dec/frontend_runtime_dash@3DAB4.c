void *frontend_runtime_dash()
{
  ...
  dword_165F84 = (int)sub_3D9A0;
  dword_165F88 = (int)sub_3DA4C;
  dword_165F8C = (int)sub_3CAB0;
  dword_165F80 = (int)sub_3D8F0;
  dword_165F90 = (int)sub_3D6F4;
  dword_165F94 = (int)stratum_subscribe_base;
  dword_165F98 = (int)stratum_authorize_base;
  dword_165F9C = (int)sub_3CAE8;
  dword_165FA0 = (int)sub_3C78C;
