int __fastcall hs_header_pow(int a1)
{
  char *v1; // r2
  char *v2; // r12
  char *v3; // r1
  ...
  _BYTE v24[400]; // [sp+2F0h] [bp-190h] BYREF
  ...
  while ( v8 != &v18 );
  v14 = v21;
  hs_header_share_write(a1, (int *)&v14);
  hs_blake2b_update((int)v22, v21, 0x80u);
  hs_sha3_256_init(v24);
  hs_sha3_update(v24, v21, 128);
  hs_sha3_update(v24, &v15, 8);
