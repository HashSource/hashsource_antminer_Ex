int miner_monitor_init()
{
  ...
  add_new_task(dword_166894, sub_4E0A8, "beeper_off");
  add_new_task(dword_166894, sub_4DFE8, 10000);
  v4 = add_new_task(dword_166894, sub_4E6B4, 60000);
  dword_166898 = new_task_timer(v4);
  add_new_task(dword_166898, sub_4DF28, 5000);
  add_new_task(dword_166898, sub_4DE68, 1000);
