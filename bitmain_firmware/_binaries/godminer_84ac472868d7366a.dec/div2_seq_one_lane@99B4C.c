int __fastcall div2_seq_one_lane(int a1, int a2, unsigned __int8 a3, unsigned __int16 a4)
{
  ...
  sub_5D9EC(a1, a3, a4 | 0x8B, -859045888);
  sub_5D9EC(a1, a3, a4 | 1, -65536);
  sub_5D9EC(a1, a3, a4 | 0x8C, 52428);
  sub_5D9EC(a1, a3, a4 | 1, (int)&loc_FFFFC + 3);
  sub_5D9EC(a1, a3, a4 | 0x8C, -859832320);
  sub_5D9EC(a1, a3, a4 | 1, -1048576);
  sub_5D9EC(a1, a3, a4 | 0x8D, (int)&loc_CCCCC);
  sub_5D9EC(a1, a3, a4 | 1, 0xFFFFFF);
  sub_5D9EC(a1, a3, a4 | 0x8D, -872415232);
  sub_5D9EC(a1, a3, a4 | 1, -16777216);
  sub_5D9EC(a1, a3, a4 & 0xF000 | 0x8E, 13421772);
  sub_5D9EC(a1, a3, a4 | 1, 4095);
  sub_5D9EC(a1, a3, a4 & 0xF000 | 0x8A, -858996736);
  sub_5D9EC(a1, a3, a4 | 1, -4096);
  sub_5D9EC(a1, a3, a4 | 0x8B, 3276);
