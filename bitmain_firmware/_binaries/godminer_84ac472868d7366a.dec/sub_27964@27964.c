int __fastcall sub_27964(int a1, const char **a2)
{
  int v3; // r5
  ...
  {
    sub_25D6C();
    v17 = sub_12D6E0(LODWORD(v8), HIDWORD(v8));
  }
  else
  {
    v17 = 0;
  ...
  v19 = sub_12D6E0(COERCE_UNSIGNED_INT64(v14 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v14 * 100.0)));
  v20 = sub_12D38C(v19, HIDWORD(v19));
  v21 = json_real(LODWORD(v20));
  json_object_set_new(v132, "rate_5s", v21);
  v22 = sub_12D6E0(COERCE_UNSIGNED_INT64(v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v15 * 100.0)));
  v23 = sub_12D38C(v22, HIDWORD(v22));
  v24 = v23 / 100.0;
  ...
  if ( opt_algo == 5 )
    v16 = *(float *)&v24 * v16;
  v27 = sub_12D6E0(COERCE_UNSIGNED_INT64(v16 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v16 * 100.0)));
  v28 = sub_12D38C(v27, HIDWORD(v27));
  ...
  v32 = v31 * 100.0;
LABEL_14:
  v33 = sub_12D6E0(LODWORD(v32), HIDWORD(v32));
  v34 = sub_12D38C(v33, HIDWORD(v33));
  ...
  if ( v13 + total_diff1 )
  {
    v47 = sub_12D37C(v13, HIDWORD(v13), (int)v13 + (int)total_diff1);
    v49 = sub_12D37C(v46, HIDWORD(v46), v48);
    v50 = sub_12D6E0(
            COERCE_UNSIGNED_INT64(v47 / v49 * 100.0 * 10000.0),
            HIDWORD(COERCE_UNSIGNED_INT64(v47 / v49 * 100.0 * 10000.0)));
    v45 = sub_12D38C(v50, HIDWORD(v50));
  }
  ...
  if ( v138 > 0 )
  {
    ...
    while ( 1 )
    {
      ...
      v61 = sub_12D6E0(LODWORD(v60), HIDWORD(v60));
      v62 = sub_12D38C(v61, HIDWORD(v61));
      v63 = json_real(LODWORD(v62));
      json_object_set_new(v55, "rate_ideal", v63);
      v64 = sub_12D6E0(COERCE_UNSIGNED_INT64(v59 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v59 * v12 * 100.0)));
      v65 = sub_12D38C(v64, HIDWORD(v64));
