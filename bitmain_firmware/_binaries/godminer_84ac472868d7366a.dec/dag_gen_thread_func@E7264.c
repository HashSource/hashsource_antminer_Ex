void __noreturn dag_gen_thread_func()
{
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      v1 = epoch_number_eth;
      if ( dword_16C840 < epoch_number_eth )
        break;
      sleep(5u);
    }
    dword_16C840 = epoch_number_eth;
    V_LOCK();
    v28 = v1;
    v2 = 0;
    logfmt_raw(v39, 0x1000u, 0, "dag_gen_thread_func cur_epoch =%d,epoch=%d", dword_16C840, v28);
    V_UNLOCK();
    zlog(
      g_zc,
    ...
    v30 = qword_146568[dword_16C840];
    newthread = qword_142568[dword_16C840];
    v34 = HIDWORD(qword_146568[dword_16C840]);
    V_LOCK();
    ...
    V_LOCK();
    v6 = 0;
    logfmt_raw(v39, 0x1000u, 0, "epoch %d, cache size %lld, data size %lld", dword_16C840, v29, newthread, v30, v34);
    v7 = &v37;
    V_UNLOCK();
    zlog(
      g_zc,
