void *frontend_runtime_hns()
{
  ...
  dword_1661B8 = (int)sub_45C68;
  dword_1661BC = (int)sub_45608;
  dword_1661C0 = (int)sub_45628;
  dword_1661B4 = (int)sub_45D44;
  dword_1661C4 = (int)sub_455E4;
  dword_1661C8 = (int)stratum_subscribe_base;
  dword_1661CC = (int)stratum_authorize_base;
  dword_1661D0 = (int)sub_45EFC;
  dword_1661D4 = (int)sub_45928;
