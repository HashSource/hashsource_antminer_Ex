int __fastcall reset_mining_base(int a1)
{
  ...
  *(_QWORD *)(a1 + 256) = 0;
  *(_DWORD *)(a1 + 328) = 0;
  v5 = memset(*(void **)(a1 + 324), 0, v3 * v4);
  v6 = dev_ctrl((int)v5);
  (*(void (__fastcall **)(_DWORD))(v6 + 28))(*(_DWORD *)(a1 + 136));
  v7 = sleep(0xAu);
  v8 = dev_ctrl(v7);
  ...
  v9 = sleep(1u);
  v10 = dev_ctrl(v9);
  (*(void (__fastcall **)(char *))(v10 + 16))("able_bypass_mode");
  usleep(0x2710u);
  ...
  v13 = usleep(0x2710u);
  v14 = dev_ctrl(v13);
  v15 = (*(int (__fastcall **)(_DWORD))(v14 + 36))(*(_DWORD *)(a1 + 136));
  v16 = dev_ctrl(v15);
  (*(void (__fastcall **)(_DWORD))(v16 + 4))(*(_DWORD *)(a1 + 136));
