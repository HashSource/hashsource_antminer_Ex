int __fastcall serdes_initial_seq_1_by_vendor(int a1, int a2, unsigned __int8 a3, unsigned __int16 a4)
{
  ...
  zlog(
    ...
    60,
    v12);
  sub_5C2A0(a1, a3, 144, 252182532);
  sub_5C2A0(a1, a3, 145, -2147438529);
  sub_5C2A0(a1, a3, 144, 839027724);
  sub_5C2A0(a1, a3, 145, -2147438590);
  sub_5C2A0(a1, a3, 144, -1073676160);
  ...
  if ( v4 )
  {
    ...
    do
    {
      ...
      sub_5D9EC(a1, a3, v9 & 0xF000 | 0x6E, 17694978);
      sub_5D9EC(a1, a3, v9 & 0xF000 | 0x1D, 134283265);
      sub_5D9EC(a1, a3, v9 & 0xF000 | 0x2A, 504234034);
      sub_5D9EC(a1, a3, v9 & 0xF000 | 0x19, 267913217);
      sub_5D9EC(a1, a3, v9 & 0xF000 | 0x1A, -1610579952);
      sub_5D9EC(a1, a3, v9 & 0xF000 | 0x47, 338179136);
    }
    while ( v8 != v11 );
  }
  return 0;
