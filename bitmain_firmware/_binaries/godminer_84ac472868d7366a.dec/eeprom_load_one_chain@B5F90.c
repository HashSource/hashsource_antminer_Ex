int __fastcall eeprom_load_one_chain(unsigned int a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v5 )
    {
      v10 = snprintf(v16, 0x800u, "Read configuration fail for chain %d.\n", a1);
      V_LOCK(v10);
    ...
    if ( !eeprom_decode_fixture_info_0(s, v15) )
      break;
    v6 = snprintf(v16, 0x800u, "Data decode fail for chain %d.\n", a1);
    V_LOCK(v6);
  ...
  if ( !sub_B3F44((int)v15, v13) || !sub_B4E04((int)v15, (unsigned __int8 *)(v13 + 1), (unsigned __int8 *)(v13 + 55)) )
  {
LABEL_6:
    *(_BYTE *)(a2 + a1 + 64) = 0;
    v8 = snprintf(v16, 0x800u, "Data load fail for chain %d.\n", a1);
    V_LOCK(v8);
