int __fastcall serdes_apb_read_back(int a1, int a2, int a3, int a4, int a5)
{
  unsigned int v6; // r6
  int v7; // r10
  char *v8; // r7
  ...
  do
  {
    if ( a3 != 255 )
      LOWORD(v6) = a3;
    v10 = sub_5C50C(a1, (unsigned __int16)v6, 145, v8);
    if ( v10 > 0 )
    {
      v11 = 3 * v10;
      v12 = v8;
...
LABEL_12:
    v15 = sub_5C50C(a1, (unsigned __int16)v6, 146, v8);
    if ( v15 > 0 )
    {
      v16 = a5 + 8 * v7;
      v17 = v8;
