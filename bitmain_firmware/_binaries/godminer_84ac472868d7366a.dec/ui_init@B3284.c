int ui_init()
{
  ...
  v17 = gpio_reg_callback(v16, (int)sub_B2E88);
  v18 = hal_key_ipreport_addr(v17);
  gpio_reg_callback(v18, (int)sub_B2E88);
  ...
  dword_16C554 = 0;
  dword_16C558 = 0;
  dword_16C544 = new_c_map(sub_B2BF4, 0, 0);
  dword_16C528 = 1;
  pthread_create((pthread_t *)&dword_16C560, 0, (void *(*)(void *))sub_B2C04, 0);
  dword_16C55C = 1;
  return 0;
}
