void __fastcall sub_2F6A0(int a1)
{
  int v1; // r0
  pthread_t v2; // r0
  int v3; // r0
  ...
  {
    v52 = 1;
    pthread_cancel(dword_16CF24);
    dword_16CF24 = 0;
    v3 = usleep((__useconds_t)&stru_18698.st_size);
  }
  else
  {
    v52 = 0;
  ...
  if ( dword_165580 > 0 )
  {
    ...
    do
    {
      v8 = sub_2EA40();
      ++v7;
      sub_2E410((void **)(v8 + 8), (_BYTE *)(v8 + 24), v6);
      set_user(v6 + 256);
      v9 = v6 + 512;
      v6 += 768;
      v3 = set_pass(v9);
    }
    while ( dword_165580 > v7 );
  }
  if ( total_pools == v51 )
  {
    V_LOCK(v3);
  ...
  if ( v52 )
  {
    ...
    v41 = pthread_create((pthread_t *)&dword_16CF24, &attr, (void *(*)(void *))watchpool_thread, &dword_16CF20);
