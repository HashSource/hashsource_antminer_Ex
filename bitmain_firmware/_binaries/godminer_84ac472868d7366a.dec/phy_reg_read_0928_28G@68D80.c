int __fastcall phy_reg_read_0928_28G(int a1, int a2, _BYTE *a3, int a4)
{
  ...
  zlog(
    ...
    60,
    v16);
  sub_5D844(a1, a3, 61459);
  sub_5D844(a1, a3, 61460);
  sub_5D844(a1, a3, 61461);
  sub_5D844(a1, a3, 61462);
  sub_5D844(a1, a3, 61463);
  sub_5D844(a1, a3, 61462);
  sub_5D844(a1, a3, 61463);
  sub_5D844(a1, a3, 61463);
  ...
  if ( a4 )
  {
    ...
    {
      v9 = (_WORD)v8++ << 12;
      sub_5D844(a1, a3, v9 & 0xF000 | 0x6A);
    }
    ...
    {
      v11 = (_WORD)v10++ << 12;
      sub_5D844(a1, a3, v11 & 0xF000 | 0x98);
    }
    while ( v10 != v8 );
  }
  else
  ...
  if ( a4 )
  {
    ...
    {
      v13 = (_WORD)v12++ << 12;
      sub_5D844(a1, a3, v13 & 0xF000 | 0x46);
      sub_5D844(a1, a3, v13 | 0x4A);
      sub_5D844(a1, a3, v13 | 0x4A);
      sub_5D844(a1, a3, v13 | 0x4B);
      sub_5D844(a1, a3, v13 | 0x4B);
      sub_5D844(a1, a3, v13 & 0xF000 | 0x56);
      sub_5D844(a1, a3, v13 | 0x4B);
      sub_5D844(a1, a3, v13 & 0xF000 | 0x1A);
    }
