int task_check_miner_status()
{
  ...
  pthread_mutex_lock(&stru_1663C4);
  v156[0] = 0;
  v111 = (unsigned __int8)byte_1663C0 ^ 1;
...
LABEL_74:
    ...
    if ( v170[0] > 0 )
    {
      ...
      do
      {
        ...
        v51 = (*(int (**)(void))(v50 + 8))();
        v52 = dev_ctrl(v51);
        (*(void (__fastcall **)(_DWORD))(v52 + 28))(*(_DWORD *)(*v49 + 136));
      }
      while ( v47 < v170[0] );
    }
    v53 = power_off();
...
LABEL_82:
  ...
  v56 = pthread_mutex_unlock(&stru_1663C4);
