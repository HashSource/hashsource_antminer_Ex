int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_5C2A0(a1, v3, 12, 1);
    usleep(0x2710u);
    sub_5C2A0(a1, v3, 160, -2147483647);
    usleep((__useconds_t)&stru_18698.st_size);
    v4 = ptr;
    v5 = sub_5C50C(a1, (unsigned __int16)v3, 161, ptr);
    if ( v5 > 0 )
    {
      v6 = 3 * v5;
      v7 = &ptr[4 * v6];
...
LABEL_9:
    v9 = ptr;
    v10 = sub_5C50C(a1, (unsigned __int16)v3, 162, ptr);
    if ( v10 > 0 )
    {
      v11 = 3 * v10;
      v12 = &ptr[4 * v11];
...
LABEL_15:
  ...
  v21 = strlen(v33);
  v22 = sub_5C97C(v33, v21);
  v23 = dev_ctrl((int)v22);
  (*(void (__fastcall **)(_DWORD))(v23 + 72))(*(_DWORD *)(a1 + 136));
  unk_16B038 = v32[1];
  unk_16B03C = v32[2];
  unk_16B040 = v32[3];
  unk_16B044 = v32[4];
