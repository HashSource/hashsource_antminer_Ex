int __fastcall http_test_bm(int a1, char *a2, size_t a3)
{
  ...
  int v7; // r8
  int v8; // r0
  unsigned int theory_hashrate; // r3
  int v10; // r2
  int v12; // r0
  int v13; // r0
  char *v14; // r0
...
LABEL_10:
        ...
        break;
      default:
        theory_hashrate = (int)(98 * get_theory_hashrate()) / 100;
        break;
    }
    v10 = 1130;
    v7 = 0;
    ...
    if ( !v14 )
    {
      ...
      if ( v15 )
      {
        ...
        zlog(
          ...
          20,
          v31);
        v17 = get_theory_hashrate();
        sub_2D5C0(a2, a3, (int)(102 * v17) / 100);
      }
      else
      {
