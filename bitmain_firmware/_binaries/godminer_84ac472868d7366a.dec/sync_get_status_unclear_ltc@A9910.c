int __fastcall sync_get_status_unclear_ltc(int a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v6; // r5
  ...
  v19[0] = sub_12D6A4(a5, a6, 1000, 0);
  while ( v11 < a2 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 664), v20, 9, v19) == 110 )
      {
        v6 = 3;
        goto LABEL_13;
      }
