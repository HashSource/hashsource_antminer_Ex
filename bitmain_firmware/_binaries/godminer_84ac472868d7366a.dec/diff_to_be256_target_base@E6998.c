unsigned int __fastcall diff_to_be256_target_base(unsigned int *a1)
{
  ...
  else
  {
    ...
    v5 = bswap32(v3);
    v7 = 1.15790322e77 / v1 - sub_12D37C(v3, HIDWORD(v3), v6) * 6.27710174e57;
    v8 = sub_12D708(COERCE_UNSIGNED_INT64(v7 * 2.93873588e-39), HIDWORD(COERCE_UNSIGNED_INT64(v7 * 2.93873588e-39)));
    v9 = bswap32(HIDWORD(v8));
    v10 = bswap32(v8);
    v12 = v7 - sub_12D37C(v8, HIDWORD(v8), v11) * 3.40282367e38;
    v13 = sub_12D708(COERCE_UNSIGNED_INT64(v12 * 5.42101086e-20), HIDWORD(COERCE_UNSIGNED_INT64(v12 * 5.42101086e-20)));
    v14 = bswap32(HIDWORD(v13));
    v15 = bswap32(v13);
    v17 = sub_12D37C(v13, HIDWORD(v13), v16);
    v18 = sub_12D708(
