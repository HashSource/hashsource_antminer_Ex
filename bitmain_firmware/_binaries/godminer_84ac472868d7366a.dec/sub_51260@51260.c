int __fastcall sub_51260(int a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  v25[0] = sub_12D6A4(a5, a6, 1000, 0);
  while ( a2 > v10 )
  {
    while ( 1 )
    {
      v14 = queue_dequeue_for(*(_DWORD *)(a1 + 664), v26, 74, v25);
      if ( v14 == 110 )
      {
        v9 = 3;
        goto LABEL_10;
