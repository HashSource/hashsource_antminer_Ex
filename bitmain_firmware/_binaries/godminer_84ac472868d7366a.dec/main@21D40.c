int __fastcall main(int argc, const char **argv, const char **envp)
{
  ...
  while ( 1 )
  {
    v9 = getopt_long(argc, argv, "a:c:hp:Po:u:v:F", &off_12EBE4, 0);
    if ( v9 < 0 )
      break;
...
LABEL_32:
  ...
  signal(2, (__sighandler_t)sub_2B2A8);
  signal(3, (__sighandler_t)sub_2B2A8);
  signal(15, (__sighandler_t)sub_2B2A8);
  signal(11, (__sighandler_t)sub_2B2A8);
  signal(10, (__sighandler_t)sub_2B2A8);
  ...
  if ( !pools_active )
  {
    ...
    power_off(v131);
    if ( opt_api_remote && (dword_16CEF0 = 1, (v132 = sub_21D00((int)&dword_16CEF0, (void *(*)(void *))sub_2C0FC)) != 0) )
    {
      V_LOCK(v132);
  ...
  thr_info = 0;
  v136 = sub_21D00((int)&thr_info, (void *(*)(void *))work_generator_thread);
  if ( v136 )
  {
    V_LOCK(v136);
    v7 = 1;
  ...
  dword_16CEF0 = 1;
  v137 = sub_21D00((int)&dword_16CEF0, (void *(*)(void *))nonce_submit_thread);
  if ( v137 )
  {
    V_LOCK(v137);
    v7 = 1;
  ...
  dword_16CF20 = 2;
  v138 = sub_21D00((int)&dword_16CF20, (void *(*)(void *))watchpool_thread);
  v7 = v138;
  if ( v138 )
  {
    V_LOCK(v138);
  ...
  {
    dword_16CF50 = 3;
    v139 = sub_21D00((int)&dword_16CF50, (void *(*)(void *))sub_2C0FC);
    if ( v139 )
    {
      V_LOCK(v139);
      v7 = 1;
