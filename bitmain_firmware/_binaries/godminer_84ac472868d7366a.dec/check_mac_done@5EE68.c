int __fastcall check_mac_done(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    20,
    v53);
  sub_5C2A0(a1, v6, 149, 0);
  sub_5C2A0(a1, v6, 151, 0);
  sub_5C2A0(a1, v6, 153, 0);
  sub_5C2A0(a1, v6, 87, 255);
  sub_5C2A0(a1, v6, 159, 0);
  sub_5C2A0(a1, v6, 133, 805306367);
  if ( a4 )
  {
    if ( a4 == 1 )
    {
      sub_5C2A0(a1, a3, 134, 0xFFFFFFF);
      sub_5C2A0(a1, a3, 132, -2147483647);
    }
  }
  else
  {
    sub_5C2A0(a1, a3, 134, 0xFFFFFFF);
    sub_5C2A0(a1, a3, 132, 17);
  }
  sleep(8u);
...
LABEL_27:
        zlog(
          ...
          v53);
LABEL_28:
        v23 = sub_5C72C(a1, v28, v17, 135, v11);
        if ( v23 )
        {
          v24 = *v11 == 0;
          if ( *v11 )
...
LABEL_33:
        v25 = sub_5C72C(a1, v28, v17, 136, v11);
        if ( v25 && *v11 )
        {
          V_LOCK(v25);
          V_INT((int)v49, "chain");
        ...
        v26 = sub_5C72C(a1, v28, v17, 137, v11);
        if ( v26 )
        {
          v27 = *v11 == 0;
          if ( *v11 )
        ...
        v8 = sub_5C72C(a1, v28, v17, 138, v11);
        if ( v8 && *v11 )
        {
          V_LOCK(v8);
          V_INT((int)v51, "chain");
