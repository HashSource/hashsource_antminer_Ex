int __fastcall share_result(int a1, int a2, char *a3, double *a4)
{
  ...
  pthread_mutex_lock(&stru_194B8C);
  if ( a1 )
  {
    v17 = a4[226];
    ...
    *((_DWORD *)a4 + 404) = v21;
    *((_QWORD *)a4 + 203) = v22;
    pthread_mutex_unlock(&stru_194B8C);
    return 1;
  }
  else
  {
    ...
    *(_QWORD *)&total_rejected = __PAIR64__(v8, v11) + 1;
    ...
    else
    {
      ...
      v24 = 575;
      v25 = g_zc;
      LOWORD(v26) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroo"
                                      "t/tmp/release/build/godminer-origin_godminer-new/pool.c";
    }
    ...
    zlog(v25, v26, 137, "share_result", 12, v24, 80, v31);
    return 1;
  }
}
