_DWORD *__fastcall update_hashrate(int a1, int a2, _DWORD *a3)
{
  ...
  (*(void (__fastcall **)(int, __int64 *))(a1 + 132))(a1, &v45);
  (*(void (__fastcall **)(int, __int64 *))(a1 + 140))(a1, &v46);
  (*(void (__fastcall **)(int, double *, _BYTE *))(a1 + 136))(a1, &v47, v44);
  v6 = *(_DWORD *)(a1 + 240);
  v7 = v46;
  *(_QWORD *)(a2 + 48) = v45;
  *(_QWORD *)(a2 + 56) = v7;
  if ( v6 <= 16 )
  {
    ...
    if ( v9 >= 5.0 )
    {
      ...
      LODWORD(v43) = v24;
      v42 = *(_DWORD *)(a1 + 452);
      HIDWORD(v43) = v42 - (*((_DWORD *)&unk_1976A0 + 2 * v6 + 1) + !v23);
      ...
      else
      {
        ...
        v38 = COERCE_FLOAT(sub_144C10(v37));
        v25 = v38 * (float)(COERCE_FLOAT(sub_144C10(v43)) / v9);
      }
      V_LOCK();
      logfmt_raw(
        v56,
      ...
      zlog(
        ...
        20,
        v56);
      v26 = (_DWORD *)((char *)&unk_197728 + 2896 * v6);
      clock_gettime(1, (struct timespec *)&byte_197390[v8 + 16]);
      v27 = v26[723];
      v28 = (int *)((char *)&unk_1976A0 + 8 * v6);
      *v28 = v41;
      LODWORD(v29) = v26[722];
      v30 = v26[720] + 1;
      v28[1] = v42;
      HIDWORD(v29) = v27;
      *((float *)&unk_197728 + 724 * v6 + v26[720]) = v25;
      v31 = __PAIR64__(v27, v29) + 1;
      v26[720] = v30 % 720;
      v32 = v25 + (float)(COERCE_FLOAT(sub_144C10(v29)) * *(float *)(a2 + 44));
      *(float *)(a2 + 44) = v32 / COERCE_FLOAT(sub_144C10(v31));
      *((_QWORD *)v26 + 361) = v31;
    }
    sub_63BC8((int)v39);
    *(float *)(a2 + 32) = 5.0;
        ...
        *a3 |= 1u;
        ...
        if ( !v49 )
        {
          ...
          zlog(
            ...
            "er-origin_godminer-new/miner_util/miner_monitor/update_miner_status/update_hashrate.c",
            193,
            "update_hashrate",
            15,
            173,
