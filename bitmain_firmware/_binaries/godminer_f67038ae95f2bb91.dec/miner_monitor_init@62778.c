int __fastcall miner_monitor_init(int a1)
{
  ...
  add_new_task(dword_197370, 402976, 1000);
  add_new_task(dword_197370, 402776, (int)"ntState");
  add_new_task(dword_197370, 404412, 60000);
  dword_197374 = (int)new_task_timer();
  add_new_task(dword_197374, 402576, 5000);
  add_new_task(dword_197374, 402376, 1000);
  LOWORD(v12) = -1328;
