int __fastcall sub_A06E0(int *a1, int a2)
{
  int v2; // r4
  void *v5; // r0
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v43, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_LTC_1489", a2);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  if ( v33 > 0 )
  {
    v26 = "ChipSetting_get_addr_LTC_1489";
    v29 = 0;
    ...
    do
    {
      while ( 1 )
      {
        ...
        V_UNLOCK();
        zlog(g_zc, v27, 155, v26, 29, 64, 20, v43);
      ...
      V_UNLOCK();
      zlog(g_zc, v27, 155, v26, 29, 70, 20, v43);
    }
    while ( v33 > v2 );
LABEL_7:
    v2 = v29;
