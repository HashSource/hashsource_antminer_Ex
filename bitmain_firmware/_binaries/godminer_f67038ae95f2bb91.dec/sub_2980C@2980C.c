int __fastcall sub_2980C(_DWORD *a1, int a2)
{
  int v3; // r5
  _DWORD *v4; // r4
  char *v5; // r0
  ...
  *(_DWORD *)v144 = 0;
  ...
  {
    sub_2585C(a1, 1, 70, *(const char **)(a2 + 8));
    v136 = json_array();
    v4 = json_object();
    v5 = BUFX_strdup("2.12");
    ...
    if ( v138 > 0 )
    {
      ...
      else
      {
        ...
        do
        {
          ...
          v124 += 216;
          v25 = v138 <= v3;
          *((_DWORD *)v127 + 1) = *(_DWORD *)(*(_DWORD *)v126 + 248) + 1;
          v127 += 4;
        }
        while ( !v25 );
        v15 = v3;
    ...
    v19 = v10;
    format_hashrate_string(*(const char **)(*(_DWORD *)(v135 + 72) + 16), v149);
    format_hashrate_string(*(const char **)(*(_DWORD *)(v135 + 72) + 16), v150);
    format_hashrate_string(*(const char **)(*(_DWORD *)(v135 + 72) + 16), v151);
    format_hashrate_string(*(const char **)(*(_DWORD *)(v135 + 72) + 16), v152);
    v20 = v13;
    format_hashrate_double(*(const char **)(*(_DWORD *)(v135 + 72) + 16), &v142, v143);
    v21 = v159;
    ...
    if ( v25 )
    {
      sub_144A24((__int64)(v19 * v20 * 100.0));
      v129 = json_real();
      json_object_set_new(v16, "GHS 5s", v129);
    }
    else
    {
      sub_144A24((__int64)(v21 * v20 * 100.0));
      v26 = json_real();
      json_object_set_new(v16, "GHS 5s", v26);
      v24 = *(float *)&v20 * v24;
      v23 = *(float *)&v20 * v23;
    }
    sub_144A24((__int64)(v24 * 100.0));
    v27 = json_real();
    json_object_set_new(v16, "GHS av", v27);
    sub_144A24((__int64)(v23 * 100.0));
    v28 = json_real();
    json_object_set_new(v16, "rate_30m", v28);
    sub_144A24((__int64)(v142 * 100.0));
    v29 = json_real();
      ...
      if ( v138 > 0 )
      {
        ...
        if ( v138 > 0 )
        {
          ...
          do
          {
            ...
            sub_25D0C(*((_DWORD *)v68 - 52), *((_DWORD *)v68 - 47), v154);
          ...
          if ( v138 > 0 )
          {
            ...
            do
            {
              ...
              sub_25D0C(*((_DWORD *)v73 - 53), *((_DWORD *)v73 - 48), v154);
            ...
            if ( v138 > 0 )
            {
              ...
              do
              {
                ...
                sub_25D0C(*((_DWORD *)v78 - 52), *((_DWORD *)v78 - 47), v154);
...
LABEL_75:
    ...
    v102 = v97;
    if ( opt_algo == 9 )
      LODWORD(v102) = sub_144D3C(v97, 0x3E8u);
    ...
    if ( v138 > 0 )
    {
      ...
      if ( v138 > 0 )
      {
        ...
        do
        {
          ++v111;
          v108 += 216;
          format_hashrate_string(*(const char **)(*(_DWORD *)(v135 + 72) + 16), v153);
          v112 = *((_DWORD *)v107 + 1);
          v107 += 4;
