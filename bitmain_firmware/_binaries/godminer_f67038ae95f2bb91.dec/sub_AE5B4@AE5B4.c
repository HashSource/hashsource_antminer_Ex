int __fastcall sub_AE5B4(int a1, char a2, int a3, __int16 a4, void *a5)
{
  bool v5; // zf
  int v6; // r6
  ...
  HIWORD(v18) = a4;
  src = calloc(v8, 1u);
  (*(void (__fastcall **)(int, _DWORD *, int, _DWORD *, int *))(a1 + 300))(a1, v17, v10, src, &v16);
  V_LOCK();
  logfmt_raw(v22, 0x1000u, 0, "%s core_no %d response_num %d", "ChipSetting_get_single_chip_core_status_RVN", v10, v16);
  V_UNLOCK();
  zlog(
    g_zc,
