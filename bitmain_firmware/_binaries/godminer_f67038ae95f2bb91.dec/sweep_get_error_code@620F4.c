int __fastcall sweep_get_error_code(_DWORD *a1)
{
  ...
  {
    LOWORD(v26) = 29664;
    HIWORD(v26) = (unsigned int)"alid, url: \"%s\"" >> 16;
    set_json_info_by_errorcode_and_time(a1, v26, v29);
  }
  if ( v3 )
  {
    LOWORD(v25) = 30320;
    HIWORD(v25) = (unsigned int)"gpio" >> 16;
  ...
  for ( i = 0; i != 8; ++i )
  {
    ...
    HIWORD(v8) = (unsigned int)", url: \"%s\"" >> 16;
...
LABEL_11:
  ...
  for ( j = 0; j != 16; ++j )
  {
    ...
    HIWORD(v12) = (unsigned int)"is_adjustable_power: %s" >> 16;
...
LABEL_19:
  ...
  for ( m = 0; m != 16; ++m )
  {
    ...
    HIWORD(v18) = (unsigned int)"table_power: %s" >> 16;
...
LABEL_23:
  ...
  {
    LOWORD(v23) = 30328;
    HIWORD(v23) = (unsigned int)"get gpio failed" >> 16;
    set_json_info_by_errorcode_and_time(a1, v23, v31);
  }
  if ( v6 )
  {
    LOWORD(v22) = 30332;
    HIWORD(v22) = (unsigned int)"gpio failed" >> 16;
    set_json_info_by_errorcode_and_time(a1, v22, v32);
  }
  if ( v7 )
  {
    LOWORD(v20) = 30336;
    HIWORD(v20) = (unsigned int)" failed" >> 16;
