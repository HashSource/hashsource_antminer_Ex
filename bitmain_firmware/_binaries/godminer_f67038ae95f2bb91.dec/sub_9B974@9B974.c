int __fastcall sub_9B974(int a1, _DWORD *a2, _DWORD *a3, int a4)
{
  int v8; // r3
  ...
  logfmt_raw(
    ...
    "ChipSetting_read_sensor_temp_local_on_ctrlboard_KS5_2382",
    *(_DWORD *)(a1 + 248),
    a4);
  V_UNLOCK();
  zlog(
    ...
    v14);
  *a3 = 0;
  v10 = tsensor_read(*(_DWORD *)(a1 + 248), a4, 0, (int)v11, 2);
  if ( v10 == 2 )
  {
    v8 = v11[0];
    *a3 = 1;
  ...
  else
  {
    *a2 = -64;
    v10 = -1;
    V_LOCK();
    logfmt_raw(v14, 0x1000u, 0, "failed to read ctrlboard-temp for chain %d", *(_DWORD *)(a1 + 248));
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-ori"
