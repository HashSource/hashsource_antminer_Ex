int sub_3264C()
{
  ...
  if ( dword_194CAC > 0 )
  {
    ...
    do
    {
      v5 = sub_318BC();
      ++v4;
      sub_31280((void **)(v5 + 12), (_BYTE *)(v5 + 28), v3);
      set_user(v3 + 256);
      v6 = v3 + 512;
      v3 += 768;
      set_pass(v6);
    }
    while ( dword_194CAC > v4 );
  }
  if ( total_pools == v43 )
  {
    V_LOCK();
  ...
  zlog(
    ...
    v46);
  sleep(5u);
  v31 = (unsigned __int8)byte_194CA8;
  if ( byte_194CA8 )
  {
...
LABEL_57:
    ...
    v41 = pthread_create((pthread_t *)&dword_1B421C, &attr, (void *(*)(void *))watchpool_thread, &dword_1B4218);
