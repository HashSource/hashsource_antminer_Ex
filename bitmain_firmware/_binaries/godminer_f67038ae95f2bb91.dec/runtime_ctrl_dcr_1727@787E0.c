void *runtime_ctrl_dcr_1727()
{
  ...
  LODWORD(v2[11]) = sub_76E1C;
  HIDWORD(v2[11]) = sub_76D00;
  LODWORD(v2[13]) = sub_76A30;
  LODWORD(v2[12]) = sub_752B0;
  HIDWORD(v2[13]) = sub_76654;
  LODWORD(v2[14]) = sub_7628C;
  HIDWORD(v2[14]) = sub_75D98;
  LODWORD(v2[15]) = sub_759F4;
  ...
  LODWORD(v2[26]) = sub_747D0;
  HIDWORD(v2[25]) = sub_77BC8;
  HIDWORD(v2[26]) = sub_752C8;
  ...
  HIDWORD(v2[103]) = 280;
  BYTE4(v2[123]) = 15;
  v2[122] = 0x5F04419C000LL;
  v2[51] = qword_192804;
  v2[124] = 4774;
  v2[104] = 0x400000050LL;
  v2[105] = 0xB000000BALL;
  v0 = calloc(1u, 0x488u);
