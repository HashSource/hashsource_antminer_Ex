int __fastcall sub_C74E8(int a1, unsigned __int8 *a2, unsigned int a3, unsigned __int8 *a4, unsigned int a5)
{
  unsigned int v7; // r4
  unsigned int v8; // r3
  unsigned int v9; // r4
  ...
  while ( 1 )
  {
    ...
    do
    {
      ...
      iic_write_reg(a1, &v31, 1, (int)&a2[v8], 1);
      v8 = v7;
    }
    while ( v7 < a3 );
    LOBYTE(v9) = 0;
    ...
    do
    {
      ...
      iic_read_reg(a1, (int)&v31, 1, (int)&a4[v10], 1);
      v10 = v9;
    }
    while ( v9 < a5 );
