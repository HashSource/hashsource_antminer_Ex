int __fastcall hardware_init(int a1)
{
  ...
  if ( v62[0] > 0 )
  {
    ...
    do
    {
      v14 = *((_DWORD *)v13 + 1);
      v13 += 4;
      strcpy((char *)(v14 + 320), v4);
      *(_DWORD *)(*(_DWORD *)v13 + 328) = (unsigned __int16)__rev16(LOWORD(v61[0]));
      ...
      *(_DWORD *)(*(_DWORD *)v13 + 1000) = is_adjustable_power;
      ...
      v18 = *(_DWORD *)v13;
      *(_DWORD *)(v16 + 396) = chain_sensor_num;
      sensor_max_chip_temp = platform_get_sensor_max_chip_temp(v11);
      v20 = *(_DWORD *)v13;
      *(_DWORD *)(v18 + 400) = sensor_max_chip_temp;
      sensor_max_pcb_temp = platform_get_sensor_max_pcb_temp(v11);
      v22 = *(_DWORD *)v13;
      *(_DWORD *)(v20 + 404) = sensor_max_pcb_temp;
      sensor_min_pcb_temp = platform_get_sensor_min_pcb_temp(v11);
      v24 = *(_DWORD *)v13;
      *(_DWORD *)(v22 + 408) = sensor_min_pcb_temp;
      *(_DWORD *)(v24 + 412) = platform_get_sensor_max_uneffective_count(v11++);
    }
    while ( v11 < v62[0] );
  }
  free(v4);
  ...
  v27 = *(int (__fastcall **)(int))(dev_ctrl(is_pic_mcu_en) + 12);
...
LABEL_29:
  ...
  do
  {
    ...
    (*(void (__fastcall **)(_DWORD *))(v33 + 52))(v32);
  ...
  do
  {
    v34 = V_LOCK();
    v35 = dev_ctrl(v34);
    v36 = (*(int (__fastcall **)(int))(v35 + 60))(v29);
    ...
    v37 = zlog(
            ...
            v62);
    v38 = dev_ctrl(v37);
    v39 = ((__int64 (__fastcall *)(int))*(_DWORD *)(v38 + 60))(v29++);
  ...
  do
  {
    ...
    if ( eeprom_chain_load_state == -1 )
    {
      v51 = V_LOCK();
      v52 = dev_ctrl(v51);
      v53 = (*(int (__fastcall **)(int))(v52 + 60))(v41);
    ...
    else if ( !eeprom_chain_load_state )
    {
      ...
      v47 = V_LOCK();
      v48 = dev_ctrl(v47);
      v49 = (*(int (__fastcall **)(int))(v48 + 60))(v41);
  ...
  if ( v60 > 0 )
  {
    ...
    do
    {
      ...
      v56 = *((_DWORD *)v55 + 1);
      v55 += 4;
      logfmt_raw((char *)v62, 0x1000u, 0, "chain[%d] %s", v40, v56 + 320);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-o"
      ...
      V_LOCK();
      v59 = v40++;
      logfmt_raw((char *)v62, 0x1000u, 0, "chain[%d] %x", v59, *(_DWORD *)(*(_DWORD *)v55 + 328));
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-o"
