int __fastcall sub_C1CAC(int a1, int a2)
{
  int *v4; // r7
  int *v5; // r4
  int v6; // r6
...
LABEL_18:
      ...
      zlog(
        ...
        "rigin_godminer-new/backend/device/hal/platform/7020/7020_ui.c",
        173,
        "gpio_ctrl_ui",
        12,
        283,
  ...
  else
  {
    ...
    else if ( a2 == 2 )
    {
      ...
      {
        v6 = -1;
        if ( exists_c_map((int *)dword_1B3604, (int)&v8) )
        {
          ...
          zlog(
            ...
            "er-origin_godminer-new/backend/device/hal/platform/7020/7020_ui.c",
            173,
