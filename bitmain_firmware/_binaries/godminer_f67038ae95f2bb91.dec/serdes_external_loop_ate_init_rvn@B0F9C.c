int __fastcall serdes_external_loop_ate_init_rvn(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    60,
    v133);
  sub_AE8B8(a1, a3, 24642, a4 | 0x600);
  sub_AE340(a1, a3, 77, 0);
  sub_AE340(a1, a3, 78, -2144247741);
  sub_AE8B8(a1, a3, 24644, a4 << 7);
  sub_AE8B8(a1, a3, 24642, a4 | 0x700);
  ...
  zlog(
    ...
    60,
    v133);
  sub_AE8B8(a1, a3, 24644, (a4 << 7) | 0x8020);
  sub_AE8B8(a1, a3, 24644, (a4 << 7) | 0x8060);
  ...
  zlog(
    ...
    60,
    v133);
  sub_AE340(a1, a3, 77, 20971840);
  sub_AE340(a1, a3, 78, -2144251901);
  sub_AE340(a1, a3, 77, 88606024);
  sub_AE340(a1, a3, 78, -2144251901);
  V_LOCK();
