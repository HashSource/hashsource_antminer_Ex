...
LABEL_21:
              ...
              LOWORD(v18) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/"
...
LABEL_23:
    ...
    HIWORD(v18) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/"
                                "release/build/godminer-origin_godminer-new/common/general/http.c" >> 16;
    zlog(v15, v18, 152, v17, 19, v16, 20, v25);
    return 0;
  }
}
