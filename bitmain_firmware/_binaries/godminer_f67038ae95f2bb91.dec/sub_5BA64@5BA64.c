int __fastcall sub_5BA64(int a1, __int64 *a2)
{
  __int64 v2; // r2
  const char *v4; // r1
  __int64 *v6; // r3
  ...
  *(_DWORD *)&v24[87] = 0;
  V_LOCK();
  logfmt_raw((char *)v39, 0x1000u, 0, "start nonce: %08x", dword_195BE8);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
    "n_godminer-new/dhash_content/dcr/dcr_1727/dcr_1727_content.c",
    176,
    "push_work_dcr_1727",
    18,
    64,
  ...
  v12 = *(_BYTE *)v6;
  v13 = dword_195BE8 | (*(_DWORD *)(a1 + 240) << 22);
  *v7 = v12;
  v39[0] = v13;
  v24[70] = v13;
