...
LABEL_12:
  ...
  zlog(
    ...
    v54);
  V_LOCK();
  logfmt_raw(v54, 0x1000u, 0, "current_voltage_raw\t\t= %d", dword_195C2C);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
    ...
    v54);
  V_LOCK();
  logfmt_raw(v54, 0x1000u, 0, "working_voltage_raw\t\t= %d", dword_195C1C);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
    ...
    v54);
  V_LOCK();
  logfmt_raw(v54, 0x1000u, 0, "check_asic_voltage_enable\t= %d", (unsigned __int8)byte_195C20);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
    ...
    v54);
  V_LOCK();
  logfmt_raw(v54, 0x1000u, 0, "check_asic_voltage_raw\t= %d", dword_195C24);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
    ...
    if ( platform_is_pic_mcu_en() )
    {
      ...
      if ( device_num > 0 )
      {
        ...
        do
        {
          ...
          v20 = (*(int (__fastcall **)(int))(v19 + 60))(v18);
          read_feedback_voltage(v20);
          v21 = V_LOCK();
          v22 = dev_ctrl(v21);
          v23 = (*(int (__fastcall **)(int))(v22 + 60))(v18);
...
LABEL_43:
  ...
  {
    v24 = usleep((__useconds_t)&stru_186A0);
    if ( v53 > 0 )
    {
      for ( j = 0; j < v53; ++j )
      {
        v26 = dev_ctrl(v24);
        v24 = (*(int (__fastcall **)(int))(v26 + 48))(j);
      }
    }
    v27 = usleep((__useconds_t)&stru_186A0);
    if ( v53 > 0 )
    {
      for ( k = 0; k < v53; ++k )
      {
        v29 = dev_ctrl(v27);
        v27 = (*(int (__fastcall **)(int))(v29 + 52))(k);
      }
    }
    v30 = usleep((__useconds_t)&stru_186A0);
    if ( v53 > 0 )
    {
      for ( m = 0; m < v53; ++m )
      {
        v32 = dev_ctrl(v30);
        v30 = (*(int (__fastcall **)(int))(v32 + 48))(m);
      }
    }
    v33 = usleep((__useconds_t)&stru_186A0);
    if ( v53 > 0 )
    {
      for ( n = 0; n < v53; ++n )
      {
        v35 = dev_ctrl(v33);
        v33 = (*(int (__fastcall **)(int))(v35 + 52))(n);
      }
    }
    v36 = usleep((__useconds_t)&stru_186A0);
    if ( v53 > 0 )
    {
      do
      {
        v37 = dev_ctrl(v36);
        v36 = (*(int (__fastcall **)(int))(v37 + 48))(v9++);
      }
      while ( v53 > v9 );
    }
  }
