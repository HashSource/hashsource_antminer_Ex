    ...
    if ( result > 99 )
    {
      ...
      else
      {
        if ( result == 111 )
        {
          ...
          v15 = 259;
          v16 = g_zc;
          LOWORD(v17) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buil"
                                          "droot/tmp/release/build/godminer-origin_godminer-new/god-miner.c";
          goto LABEL_62;
        }
        if ( result == 112 )
        {
          ...
          LOWORD(v17) = 27592;
LABEL_62:
          HIWORD(v17) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroo"
                                      "t/tmp/release/build/godminer-origin_godminer-new/god-miner.c" >> 16;
          return zlog(v16, v17, 142, "parse_arg", 9, v15, v14, v27);
        }
      }
      goto LABEL_19;
    }
