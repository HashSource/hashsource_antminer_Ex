int __fastcall membist1_rvn(int a1)
{
  ...
  do
  {
    sub_A4084(a1, n, 28, 1);
    usleep(0x61A80u);
    sub_A4084(a1, n, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x1800u);
    v2 = sub_A4400(a1, (unsigned __int16)n, 161, ptr);
    if ( v2 == 8
      || (V_LOCK(),
...
LABEL_10:
    memset(ptr, 0, 0x1800u);
    v5 = sub_A4400(a1, (unsigned __int16)n, 162, ptr);
    if ( v5 == 8
      || (V_LOCK(),
...
LABEL_18:
  ...
  while ( &s[7] != v9 );
  v11 = sprintf(v32, "<mbist1> %ld", v8);
  v12 = dev_ctrl(v11);
  ((void (__fastcall *)(_DWORD))v12[24])(*(_DWORD *)(a1 + 240));
  unk_1B30E4 = s[0];
  unk_1B30E8 = s[1];
  unk_1B30EC = s[2];
  unk_1B30F0 = s[3];
