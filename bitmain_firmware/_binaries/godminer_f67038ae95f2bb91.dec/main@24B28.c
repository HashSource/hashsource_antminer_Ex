int __fastcall main(int argc, const char **argv, const char **envp)
{
  ...
  while ( 1 )
  {
    v14 = EVPX_EncryptInit_ex(argc, (int)argv, "a:c:hl:p:Po:u:v:F", (const char **)&off_1469CC, 0);
    if ( v14 < 0 )
      break;
  ...
  V_LOCK();
  logfmt_raw(s, 0x1000u, 0, "opt_algo %d, %s", opt_algo, off_146514[opt_algo]);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
  ...
  if ( !v12 )
  {
    ...
    logfmt_raw(
      ...
      "2.0.0_release_clean_master_e676fcafab203d5acd3ad333d36a58ce43741c8d_Mar 22 2024 15:04:41");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-ori"
