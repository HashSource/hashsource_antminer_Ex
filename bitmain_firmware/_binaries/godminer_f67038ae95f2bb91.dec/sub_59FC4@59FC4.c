int __fastcall sub_59FC4(int a1)
{
  int v2; // r4
  int v3; // r1
  ...
  if ( str2hex((int)&v6, v3, 8) != 4 )
  {
    ...
    zlog(
      ...
      "gin_godminer-new/dhash_content/rvn/rvn_2044/rvn_2044_content.c",
      176,
  ...
  qword_195B30 += v2;
  V_LOCK();
  logfmt_raw(v8, 0x1000u, 0, "start_nonce_rvn_high: %016llx", qword_195B30);
  V_UNLOCK();
  zlog(
    g_zc,
