        ...
        _DWORD *a4)
{
  ...
  __int64 v25; // r10
  _BYTE *v26; // r1
  char v27[92]; // [sp+1Ch] [bp-1100h] BYREF
  _BYTE v28[160]; // [sp+78h] [bp-10A4h] BYREF
  char v29[4100]; // [sp+118h] [bp-1004h] BYREF
      ...
      *(_BYTE *)(a2 + 1656) = 0;
      ...
      if ( v14 )
      {
        ...
        if ( !strcasecmp(v14, "mining.notify") )
        {
          ...
          {
            V_LOCK();
            logfmt_raw(v29, 0x1000u, 0, "block_num: %llu", v25);
            V_UNLOCK();
            zlog(
              g_zc,
              "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godm"
              "iner-origin_godminer-new/frontend/frontend_eth_2282/frontend_eth_2282.c",
              177,
              "pre_stratum_handle_method_eth_2282",
              34,
              1037,
...
LABEL_35:
      ...
      {
        V_LOCK();
        logfmt_raw(v29, 0x1000u, 0, "%s json id error!", "pre_stratum_handle_method_eth_2282");
        V_UNLOCK();
        v16 = 0;
        zlog(
          g_zc,
