int __fastcall sub_2BA14(_DWORD *a1, const char **a2)
{
  char *v4; // r6
  int v5; // r8
  ...
  if ( a2 )
  {
    ...
    *((float *)&v12 + 1) = v49;
    ...
    if ( v44 > 0 )
    {
      ...
      if ( v44 > 0 )
      {
        ...
        do
        {
          ...
          v41 = v44;
          v39 += 216;
          *(_DWORD *)&v4[4 * v38++] = *(_DWORD *)(*(_DWORD *)v37 + 248);
        }
        while ( v41 > v38 );
      }
    }
    ...
    if ( v17 )
      ...
      v18 = *((float *)&v12 + 1);
    LODWORD(v19) = sub_144A24((__int64)(v18 * v10 * 100.0));
    v20 = v19 / 100.0;
    v21 = json_real();
    ...
    if ( v31 && off_1923A4 )
    {
      ...
      do
      {
        ...
        ((void (__fastcall *)(_DWORD *, char **))v32[1])(v33, v32);
