int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  zlog(
    ...
    v44);
  v18 = malloc(0x1800u);
  sub_AE340(a1, a3, 86, 3670024);
  usleep(0x12Cu);
  sub_AE340(a1, a3, 85, 109905420);
  usleep(0x12Cu);
  sub_AE340(a1, a3, 101, -268374016);
  usleep(0x12Cu);
  ...
  zlog(
    ...
    20,
    v44);
  sub_AE340(a1, a3, 83, 16711935);
  if ( check_core_reg_with_expect_data_rvn(a1, a2, a3, 83, 0) )
  {
    V_LOCK();
    V_INT((int)v42, "chain", *(int *)(a1 + 248));
    logfmt_raw(
      v44,
      0x1000u,
      0,
  ...
  sub_AE340(a1, a3, 133, 255);
  usleep(0x64u);
  sub_AE340(a1, a3, 134, 255);
  usleep(0x64u);
  sub_AE340(a1, a3, 132, -2147483647);
  sleep(6u);
