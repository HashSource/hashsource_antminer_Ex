int __fastcall update_temperature(int a1, _DWORD *a2, int a3)
{
  ...
  int *v82; // [sp+94h] [bp-12A0h]
  int *v83; // [sp+98h] [bp-129Ch]
  char *v84; // [sp+9Ch] [bp-1298h]
  char *v85; // [sp+A0h] [bp-1294h]
  char *v86; // [sp+A4h] [bp-1290h]
  const char *v87; // [sp+A8h] [bp-128Ch]
  ...
  const char *v98; // [sp+D4h] [bp-1260h]
  int *v99; // [sp+D8h] [bp-125Ch]
...
LABEL_64:
  ...
  v99 = &g_temp_zc;
  s = "chain";
  v81 = "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-o"
  ...
  do
  {
    ...
    logfmt_raw(
      ...
      *v9,
      v9[1]);
    V_UNLOCK();
    zlog(*v83, v81, 196, "check_temperature", 17, 36, 20, v159);
    v53 = *v9;
    if ( *v9 == -64 )
    {
      v55 = 0;
...
LABEL_6:
    ...
    *v19 = v154[4];
    ...
    V_UNLOCK();
    zlog(*v83, v81, 196, "check_temperature", 17, 92, 20, v159);
    V_LOCK();
    V_INT((int)v136, s, *(int *)(a1 + 248));
    ...
    *v40 = v135[4];
    ...
    V_UNLOCK();
    zlog(*v99, v81, 196, "check_temperature", 17, 94, 40, v159);
  }
  while ( v97 != v9 );
  free(ptr);
  if ( v91 != v101 || v91 != v90 )
...
LABEL_33:
  ...
  if ( v91 )
  {
    ...
    v61 = v94;
    v89[5] = v95;
    dword_1A2C28[v59] = v61;
    dword_1A2C28[v59 + 16] = 0;
    goto LABEL_35;
  }
LABEL_59:
  v60 = v59;
  v69 = &dword_1A2C28[v59];
  v70 = v69[16] + 1;
  v65 = v69[16] - 1 < 0;
  v69[16] = v70;
...
LABEL_35:
  if ( v90 )
  {
    v62 = v89;
    v63 = v93;
    dword_1A2C28[v60 + 32] = 0;
    v62[4] = v63;
  }
  else
  {
    v73 = dword_1A2C28[v60 + 32] + 1;
    v65 = dword_1A2C28[v60 + 32] - 1 < 0;
    dword_1A2C28[v60 + 32] = v73;
  ...
  if ( *(_DWORD *)(a1 + 412) >= v92 )
  {
    dword_1A2C28[v60 + 48] = 0;
  }
  else
  {
    v64 = dword_1A2C28[v60 + 48] + 1;
    v65 = dword_1A2C28[v60 + 48] - 1 < 0;
    dword_1A2C28[v60 + 48] = v64;
  ...
  if ( v89[4] > *(_DWORD *)(a1 + 400) || dword_1A2C28[v59] > *(_DWORD *)(a1 + 404) )
  {
    v71 = dword_1A2C28[v60 + 64] + 1;
    v65 = dword_1A2C28[v60 + 64] - 1 < 0;
    dword_1A2C28[v60 + 64] = v71;
  ...
  {
    dword_1A2C28[v60 + 64] = 0;
  }
  if ( v89[5] <= *(_DWORD *)(a1 + 408) )
  {
    v66 = &dword_1A2C28[v60];
    v67 = v66[80] + 1;
    v65 = v66[80] - 1 < 0;
    v66[80] = v67;
