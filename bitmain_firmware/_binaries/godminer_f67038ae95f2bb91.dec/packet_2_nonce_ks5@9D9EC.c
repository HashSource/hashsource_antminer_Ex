      ...
      if ( v18 != -1 )
      {
        ...
        *a4 = 1;
        ...
        if ( v30 <= 0 )
        {
          ...
          v33 = 0;
LABEL_33:
          *(_QWORD *)&dword_1AB008[v41 + 20] = v33;
          return 0;
        }
        v31 = *(_DWORD *)(a1 + 456);
        v32 = 0;
        ...
        v40 = v34;
        v41 = 2 * v56;
        v42 = *(_QWORD *)&dword_1AB008[2 * v56 + 20];
        if ( v42 >= v33 )
        {
          LOWORD(v43) = -20264;
        }
        ...
        {
          LOWORD(v43) = (unsigned __int16)&unk_1AB0D8;
          if ( v33 - v42 <= 0x63 )
          {
            v44 = 0;
            HIWORD(v43) = (unsigned int)&unk_1AB0D8 >> 16;
            v45 = s;
            do
            {
              v47 = *(_QWORD *)v45;
              ...
              {
                close_one_chip_cores_ks5(a1, (unsigned __int8)v44);
                v39 = *(_DWORD *)(a1 + 240);
                v40 = *(_DWORD *)(a1 + 336);
              }
              ++v44;
