int __fastcall dram_pre_bist1_rvn(int a1, char a2)
{
  ...
  V_LOCK();
  logfmt_raw(v5, 0x1000u, 0, "%s...", "dram_pre_bist1_rvn");
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  sub_A40D8(a1, a2, 254, 6698008);
  sub_A40D8(a1, a2, 255, 6698009);
  sub_A40D8(a1, a2, 240, 769);
  usleep(0x249u);
  ...
  sub_A40D8(a1, a2, 240, 769);
  usleep(0x249u);
  sub_A40D8(a1, a2, 245, (int)&loc_42010);
  sub_A40D8(a1, a2, 246, 270336);
  sub_A40D8(a1, a2, 247, (int)&loc_42018);
