int task_check_miner_status()
{
  ...
  HIWORD(v3) = (unsigned int)" low" >> 16;
  HIWORD(v4) = (unsigned int)"od-miner.c" >> 16;
  v134 = v2;
  v150 = v3;
  s = v4;
  v117 = v0;
        ...
        if ( (v9 & 0x10) != 0 )
        {
          ...
          *((_DWORD *)v10 + 6) |= 0x10u;
          if ( !v12 )
          {
            LOWORD(v91) = 28560;
            LOWORD(v92) = -30580;
            HIWORD(v91) = (unsigned int)"get: %f, min %f, max %f" >> 16;
            v133 = v91;
            HIWORD(v92) = (unsigned int)"e failed" >> 16;
            v124 = v92;
            v127 = &g_zc;
            v128 = &v112;
            goto LABEL_115;
...
LABEL_78:
    ...
    LOWORD(v38) = 28644;
    HIWORD(v38) = (unsigned int)"task_check_miner_status" >> 16;
    V_STR(v174, s, v38);
    logfmt_raw(
      (char *)v189,
      0x1000u,
    ...
    V_UNLOCK();
    LOWORD(v39) = 28656;
    HIWORD(v39) = (unsigned int)"iner_status" >> 16;
    zlog(*v127, v39, 176, "check_temp", 10, 36, 100, v189);
    v142 = 0;
    v90 = v181 | 1;
    v138 = v182;
    v181 |= 1u;
...
LABEL_86:
      V_LOCK();
      v90 |= 2u;
      V_INT((int)v172, v134, *(int *)(*(_DWORD *)v5 + 248));
      LOWORD(v41) = 28836;
      HIWORD(v41) = (unsigned int)"check_miner_status.c" >> 16;
      V_STR(v171, s, v41);
      v42 = v171[1];
      v43 = v171[2];
      v44 = v171[3];
      ...
      *v45 = v171[4];
      ...
      V_UNLOCK();
      LOWORD(v49) = 28656;
      HIWORD(v49) = (unsigned int)"iner_status" >> 16;
      zlog(*v127, v49, 176, "check_temp", 10, 44, 100, v189);
      v181 = v90;
      v182 = v138;
      v9 = *((_DWORD *)v10 + 4);
      v143 = v9 & 4;
...
LABEL_88:
        ...
        v149 = v90 | 4;
        v51 = v138;
        V_INT((int)v169, v134, *(int *)(v50 + 248));
        LOWORD(v52) = 28852;
        HIWORD(v52) = (unsigned int)"us.c" >> 16;
        V_STR(v168, s, v52);
        v53 = v168[1];
        v54 = v168[2];
        v55 = v168[3];
        ...
        *v56 = v168[4];
        ...
        V_UNLOCK();
        LOWORD(v60) = 28656;
        HIWORD(v60) = (unsigned int)"iner_status" >> 16;
        zlog(*v127, v60, 176, "check_temp", 10, 52, 100, v189);
        v182 = v51;
        v181 = v149;
        v9 = *((_DWORD *)v10 + 4);
        v145 = v9 & 8;
      ...
      if ( (v9 & 8) != 0 )
      {
        ...
        *((_DWORD *)v10 + 6) |= 8u;
        if ( !v12 )
        {
          LOWORD(v93) = 28560;
          LOWORD(v94) = -30580;
          HIWORD(v93) = (unsigned int)"get: %f, min %f, max %f" >> 16;
          v133 = v93;
          HIWORD(v94) = (unsigned int)"e failed" >> 16;
          v124 = v94;
          v127 = &g_zc;
          v128 = &v112;
          goto LABEL_116;
...
LABEL_90:
      ...
      v61 = *(_DWORD *)v5;
      v138 = v149 | 8;
      V_INT((int)v166, v134, *(int *)(v61 + 248));
      LOWORD(v62) = 28868;
      HIWORD(v62) = (unsigned int)" high" >> 16;
      V_STR(v165, s, v62);
      v63 = v165[1];
      v64 = v165[2];
      v65 = v165[3];
      ...
      *v66 = v165[4];
      ...
      V_UNLOCK();
      LOWORD(v70) = 28656;
      HIWORD(v70) = (unsigned int)"iner_status" >> 16;
      zlog(*v127, v70, 176, "check_temp", 10, 60, 100, v189);
      v182 = v51;
      v181 = v138;
...
LABEL_92:
      V_LOCK();
      V_INT((int)v163, v134, *(int *)(*(_DWORD *)v5 + 248));
      V_STR(v162, s, v150);
      v71 = v162[1];
      v72 = v162[2];
      v73 = v162[3];
      ...
      *v74 = v162[4];
      ...
      V_UNLOCK();
      LOWORD(v78) = 28656;
      HIWORD(v78) = (unsigned int)"iner_status" >> 16;
      zlog(*v127, v78, 176, "check_temp", 10, 68, 100, v189);
      v182 = v51;
      v181 = v138 | 0x10;
    }
LABEL_18:
...
LABEL_24:
  ...
  if ( (*((_DWORD *)v15 + 8) & 4) != 0 && (*((_DWORD *)v15 + 10) |= 4u, v0) )
  {
    ...
    LOWORD(v95) = 28916;
    LOWORD(v96) = 27772;
    HIWORD(v95) = (unsigned int)"ive temp exceed limit" >> 16;
    HIWORD(v96) = (unsigned int)"od-miner.c" >> 16;
    LOWORD(v97) = -30580;
    V_STR(v177, v96, v95);
    HIWORD(v97) = (unsigned int)"e failed" >> 16;
    v118 = v0;
    logfmt_raw(
      (char *)v189,
      0x1000u,
    ...
    V_UNLOCK();
    LOWORD(v98) = 28656;
    HIWORD(v98) = (unsigned int)"iner_status" >> 16;
    zlog(g_zc, v98, 176, "check_fan_err", 13, 85, 100, v189);
  }
  else
  {
    v118 = 0;
  ...
  if ( v159 > 0 )
  {
    ...
    {
      v18 = *v16++;
      v0 = (unsigned __int8)(v0 & *(_BYTE *)(v18 + 254));
    }
    while ( v17 != v16 );
  }
  v19 = 0;
...
LABEL_45:
  ...
  {
    v107 = rand();
    sub_144704(v107, 0x78u);
    v109 = v108 + 60;
    V_LOCK();
    LOWORD(v110) = 28940;
    HIWORD(v110) = (unsigned int)"fan error exceed limit" >> 16;
    logfmt_raw((char *)v189, 0x1000u, 0, v110, v109);
    V_UNLOCK();
    LOWORD(v111) = 28656;
    HIWORD(v111) = (unsigned int)"iner_status" >> 16;
    zlog(g_zc, v111, 176, "check_lost_connection_to_pool", 29, 150, 80, v189);
    sleep(v109);
    exit(1);
  }
  v117 = (v115 & 0xA) != 0;
    ...
    else
    {
      ...
      *((_DWORD *)v123 + 16) = v28 + 1;
      if ( v28 == 60 * (v28 / 60) )
      {
        ...
        LOWORD(v103) = 29028;
        LOWORD(v104) = 27772;
        HIWORD(v103) = (unsigned int)"d restart mining(%d)!" >> 16;
        HIWORD(v104) = (unsigned int)"od-miner.c" >> 16;
        V_STR(&v181, v104, v103);
        LOWORD(v105) = 29040;
        HIWORD(v105) = (unsigned int)"ning(%d)!" >> 16;
        ...
        V_UNLOCK();
        LOWORD(v106) = 28656;
        HIWORD(v106) = (unsigned int)"iner_status" >> 16;
        zlog(g_zc, v106, 176, "check_lost_connection_to_pool", 29, 158, 100, v189);
      ...
      else
      {
        ...
        else
        {
          ...
          LOWORD(v99) = 29028;
          LOWORD(v100) = 27772;
          HIWORD(v99) = (unsigned int)"d restart mining(%d)!" >> 16;
          HIWORD(v100) = (unsigned int)"od-miner.c" >> 16;
          v117 = v0;
          V_STR(v179, v100, v99);
          v127 = (int *)v0;
          v101 = v120;
          ...
          V_UNLOCK();
          LOWORD(v102) = 28656;
          HIWORD(v102) = (unsigned int)"iner_status" >> 16;
          zlog(g_zc, v102, 176, "check_lost_connection_to_pool", 29, 169, 120, v189);
          v123[60] = 1;
        }
      }
    }
...
LABEL_106:
      ...
      if ( v189[0] > 0 )
      {
        ...
        do
        {
          ...
          v86 = (*(int (**)(void))(v85 + 20))();
          v87 = dev_ctrl(v86);
          (*(void (__fastcall **)(_DWORD))(v87 + 32))(*(_DWORD *)(*(_DWORD *)v84 + 240));
        }
        while ( v82 < v189[0] );
      }
      power_off();
      V_LOCK();
      LOWORD(v88) = 29124;
      HIWORD(v88) = (unsigned int)"0 minutes, poweroff." >> 16;
      ...
      V_UNLOCK();
      LOWORD(v89) = 28656;
      HIWORD(v89) = (unsigned int)"iner_status" >> 16;
      zlog(g_zc, v89, 176, "task_check_miner_status", 23, 332, 120, v189);
      if ( !v81 && !v123[12] )
        goto LABEL_121;
    }
    goto LABEL_60;
