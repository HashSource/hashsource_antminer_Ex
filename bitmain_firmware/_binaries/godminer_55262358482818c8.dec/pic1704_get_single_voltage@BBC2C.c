int __fastcall pic1704_get_single_voltage(char a1, _DWORD *a2)
{
  ...
  *(_DWORD *)&v19[3] = 0;
  v18 = 0;
  result = sub_BB11C(v20, 0, (int)&v17, v19);
  if ( result )
  {
    v5 = v19[2];
    v6 = v19[0];
    ...
    if ( v19[2] == 1 && v19[0] > 3u )
    {
      ...
      LOWORD(v12) = 16948;
      HIWORD(v12) = (unsigned int)"fter program chain[%d]!" >> 16;
      ...
      V_UNLOCK();
      LOWORD(v14) = 16368;
      HIWORD(v14) = (unsigned int)"close_pic" >> 16;
      zlog(g_zc, v14, 168, "check_pic_crc", 13, 400, 20, v23);
      if ( v2 == v13 )
      {
        LOWORD(v15) = 17020;
        HIWORD(v15) = (unsigned int)"buff1 = %d, buff2 = %d." >> 16;
        *a2 = (unsigned __int16)__rev16(*(unsigned __int16 *)&v19[3]);
        ...
        V_UNLOCK();
        LOWORD(v16) = 16368;
        HIWORD(v16) = (unsigned int)"close_pic" >> 16;
        zlog(g_zc, v16, 168, "pic1704_get_single_voltage", 26, 487, 20, v23);
        return 1;
      }
      v6 = v19[0];
      v5 = v19[2];
    ...
    V_UNLOCK();
    LOWORD(v9) = 16368;
    HIWORD(v9) = (unsigned int)"close_pic" >> 16;
    zlog(g_zc, v9, 168, "pic1704_get_single_voltage", 26, 483, 20, v23);
    return 1;
  }
  return result;
}
