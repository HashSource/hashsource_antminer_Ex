int __fastcall phy_external_bist(int a1, int a2, int a3, int a4)
{
  ...
  V_INT((int)v84, v8, *(int *)(a1 + 248));
  LOWORD(v9) = -17736;
  HIWORD(v9) = (unsigned int)&unk_16BAA0 >> 16;
  logfmt_raw(
    v117,
    0x1000u,
    0,
  ...
  zlog(g_zc, v10, 177, "phy_external_bist", 17, 2037, 60, v117);
  memset(s, 0, sizeof(s));
  ...
  if ( a4 )
  {
    ...
    HIWORD(v12) = (unsigned int)"08x" >> 16;
    ...
    do
    {
      ...
      zlog(v14, v16, 177, "phy_external_bist", 17, v15, 100, v117);
    }
    while ( v71 != v13 );
    v18 = v70;
    do
    {
      v19 = *++v18;
      sub_7FA3C(a1, v19, 133, 0xFFFF);
      sub_7FA3C(a1, *v18, 134, 1342177279);
    }
    while ( v13 != v18 );
    v82 = v18;
    LOWORD(v20) = 23936;
    sub_7F9F8(a1, 132, -2147483647);
    sleep(0xAu);
    LOWORD(v21) = -11408;
    ...
    do
    {
      ...
      V_INT((int)v90, v20, *(int *)(a1 + 248));
      HIWORD(v21) = (unsigned int)" pcs lock successed!" >> 16;
      logfmt_raw(
        v117,
        0x1000u,
        0,
...
LABEL_13:
    ...
    do
    {
      ...
      v73 = 0;
      v27 = *++v70;
      sub_7FA90(a1, v27, 132, ptr);
      LOWORD(v106[0]) = 17475;
      while ( 1 )
      {
        v28 = sub_7FA90(a1, *v70, v26, ptr);
        if ( v28 )
        {
          v29 = ptr;
          v30 = &ptr[12 * v28];
...
LABEL_45:
  ...
  LOWORD(v55) = 23936;
  LOWORD(v56) = -14704;
  HIWORD(v54) = (unsigned int)"2x reg %04x rdata %04x" >> 16;
  ...
  while ( 1 )
  {
    *(_QWORD *)&dword_1A2F10 += v52;
    *(_QWORD *)&dword_1A2F08 += v51;
    *(_QWORD *)&dword_1A2F18 += v53;
    V_LOCK();
    V_INT((int)v104, v78, *(int *)(a1 + 248));
    v66 = v57++;
    logfmt_raw(
      v117,
      0x1000u,
      ...
      v53);
    V_UNLOCK();
    zlog(g_zc, v80, 177, "phy_external_bist", 17, 2345, 60, v117);
    if ( v57 == 8 )
      break;
    v51 = s[v57];
    v52 = v115[v57];
  ...
  V_LOCK();
  LOWORD(v58) = 23936;
  HIWORD(v58) = (unsigned int)"p" >> 16;
  LOWORD(v59) = -11128;
  V_INT((int)v106, v58, *(int *)(a1 + 248));
  HIWORD(v59) = (unsigned int)"x%x, phy_unlock: 0x%x" >> 16;
  logfmt_raw(
    v117,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v60) = -14704;
  HIWORD(v60) = (unsigned int)" %s handshake failed!" >> 16;
  zlog(g_zc, v60, 177, "phy_external_bist", 17, 2348, 60, v117);
  V_LOCK();
  LOWORD(v61) = 23936;
  HIWORD(v61) = (unsigned int)"p" >> 16;
  V_INT((int)&v108, v61, *(int *)(a1 + 248));
  logfmt_raw(
    v117,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v62) = -14704;
  HIWORD(v62) = (unsigned int)" %s handshake failed!" >> 16;
  zlog(g_zc, v62, 177, "phy_external_bist", 17, 2349, 60, v117);
  V_LOCK();
  LOWORD(v63) = 23936;
  HIWORD(v63) = (unsigned int)"p" >> 16;
  V_INT((int)&v111, v63, *(int *)(a1 + 248));
  logfmt_raw(
    v117,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v64) = -14704;
  HIWORD(v64) = (unsigned int)" %s handshake failed!" >> 16;
  zlog(g_zc, v64, 177, "phy_external_bist", 17, 2350, 60, v117);
  dword_1A2EFC = 0;
  dword_1A2F00 = 0;
  dword_1A2F04 = 0;
