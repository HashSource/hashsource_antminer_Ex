int __fastcall setup_clk(int a1)
{
  ...
  V_INT((int)v8, v3, *(int *)(a1 + 248));
  LOWORD(v4) = -17388;
  HIWORD(v4) = (unsigned int)"addr %04x reg_data %08x" >> 16;
  logfmt_raw((char *)&v10, 0x1000u, 0, v9, v8[0], v8[1], v8[2], v8[3], v8[4], v8[5], v8[6], v9, v4, v2 + 1040);
  V_UNLOCK();
  LOWORD(v5) = -17724;
  HIWORD(v5) = (unsigned int)&unk_16BAAC >> 16;
  zlog(g_zc, v5, 174, v2 + 1052, 9, 271, 60, &v10);
  v12 = 2097153;
  v13 = 0;
  v11 = 0;
  v10 = 11;
  (*(void (__fastcall **)(int, int *))(a1 + 264))(a1, &v10);
