int __fastcall scanhash_1(int a1)
{
  ...
  zlog(g_zc, v5, 153, "scanhash_1", 10, 118, 40, v28);
  v22 = 1;
  prctl(15, v2);
  v21 = 0;
  v6 = *(_DWORD *)(a1 + 860);
  v7 = calloc(1u, *(_DWORD *)(a1 + 832));
  v8 = calloc(1u, *(_DWORD *)(a1 + 836));
LABEL_2:
  memset(s, 0, sizeof(s));
  ...
  if ( !*(_BYTE *)(a1 + 896) )
  {
    while ( 1 )
    {
      ...
      if ( s[1] == 85 )
      {
        ...
        v11 = (*(int (__fastcall **)(_DWORD))(a1 + 172))((unsigned __int8)s[2]);
        queue_dequeue(v6, &s[3], v11);
        v12 = v11 + 3;
        check_and_print_uart_debug_log(a1 + 1016, v12, (unsigned __int8 *)s, *(_DWORD *)(a1 + 248), v23);
        v13 = *(unsigned __int8 *)(a1 + 896);
        if ( *(_BYTE *)(a1 + 896) )
          break;
        ...
        if ( (*(int (__fastcall **)(int, char *, void *, char *, void *, int *, int *))(a1 + 68))(
               ...
               &v25,
               &v26) == 10
          && !queue_enqueue(*(_DWORD *)(a1 + 868), s, v12)
          && v22 <= ++v21 )
        {
          V_LOCK();
          logfmt_raw(
          ...
          V_UNLOCK();
          LOWORD(v15) = 27564;
          HIWORD(v15) = (unsigned int)algn_176B94 >> 16;
          zlog(g_zc, v15, 153, "scanhash_1", 10, 174, 40, v28);
          V_LOCK();
          v16 = v21;
          LOWORD(v17) = 28052;
          HIWORD(v17) = (unsigned int)"packet_queue is false" >> 16;
          v21 = 0;
          logfmt_raw(v28, 0x1000u, 0, v17, v16, v22);
          V_UNLOCK();
          LOWORD(v18) = 27564;
          HIWORD(v18) = (unsigned int)algn_176B94 >> 16;
          zlog(g_zc, v18, 153, "scanhash_1", 10, 175, 40, v28);
          v19 = 10 * v22;
          if ( 10 * v22 >= 0x989680 )
            v19 = 10000000;
          v22 = v19;
      ...
      v20 = *(_BYTE *)(a1 + 896);
      s[0] = s[1];
      check_and_print_uart_debug_log(a1 + 1016, 2, (unsigned __int8 *)s, v10, v20);
    }
  }
LABEL_5:
  *(_BYTE *)(a1 + 896) = 0;
