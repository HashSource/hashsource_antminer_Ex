int __fastcall membist1_rvn(int a1)
{
  ...
  zlog(g_zc, v4, 174, "membist1_rvn", 12, 894, 60, v49);
  memset(s, 0, sizeof(s));
  ...
  do
  {
    sub_A409C(a1, n, 28, 1);
    usleep(0x61A80u);
    sub_A409C(a1, n, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x1800u);
    v5 = sub_A4418(a1, (unsigned __int16)n, 161, ptr);
    if ( v5 == 8 )
      goto LABEL_4;
    V_LOCK();
    LOWORD(v6) = 23936;
    HIWORD(v6) = (unsigned int)"p" >> 16;
    V_INT((int)v35, v6, *(int *)(a1 + 248));
    logfmt_raw(
      v49,
      0x1000u,
      0,
    ...
    zlog(g_zc, v7, 174, "membist1_rvn", 12, 914, 100, v49);
    if ( v5 > 0 )
    {
LABEL_4:
      LOWORD(v8) = 23936;
      ...
      do
      {
        while ( (*v9 & 0x80) == 0 )
        {
          ...
          V_UNLOCK();
          LOWORD(v11) = 5292;
          HIWORD(v11) = (unsigned int)&unk_171494 >> 16;
          zlog(g_zc, v11, 174, "membist1_rvn", 12, 930, 100, v49);
          if ( v5 <= v10 )
            goto LABEL_10;
        }
        if ( (*v9 & 0xFFFFFF00) != 0 )
        {
          ...
          V_UNLOCK();
          LOWORD(v27) = 5292;
          HIWORD(v27) = (unsigned int)&unk_171494 >> 16;
          zlog(g_zc, v27, 174, "membist1_rvn", 12, 923, 100, v49);
...
LABEL_10:
    memset(ptr, 0, 0x1800u);
    v12 = sub_A4418(a1, (unsigned __int16)n, 162, ptr);
    if ( v12 == 8 )
      goto LABEL_12;
    V_LOCK();
    LOWORD(v13) = 23936;
    HIWORD(v13) = (unsigned int)"p" >> 16;
    V_INT((int)v41, v13, *(int *)(a1 + 248));
    LOWORD(v14) = 5752;
    HIWORD(v14) = (unsigned int)"membist err cnt failed!" >> 16;
    logfmt_raw(v49, 0x1000u, 0, v42, v41[0], v41[1], v41[2], v41[3], v41[4], v41[5], v41[6], v42, v14);
    V_UNLOCK();
    LOWORD(v15) = 5292;
    HIWORD(v15) = (unsigned int)&unk_171494 >> 16;
    zlog(g_zc, v15, 174, "membist1_rvn", 12, 938, 100, v49);
    if ( v12 > 0 )
    {
LABEL_12:
      LOWORD(v16) = 23936;
      ...
      do
      {
        while ( (*v17 & 0x80) == 0 )
        {
          ...
          V_UNLOCK();
          LOWORD(v19) = 5292;
          HIWORD(v19) = (unsigned int)&unk_171494 >> 16;
          zlog(g_zc, v19, 174, "membist1_rvn", 12, 954, 100, v49);
          if ( v12 <= v18 )
            goto LABEL_18;
        }
        if ( (*v17 & 0xFFFFFF00) != 0 )
        {
          ...
          V_UNLOCK();
          LOWORD(v28) = 5292;
          HIWORD(v28) = (unsigned int)&unk_171494 >> 16;
          zlog(g_zc, v28, 174, "membist1_rvn", 12, 947, 100, v49);
...
LABEL_18:
  ...
  while ( &s[7] != v21 );
  LOWORD(v23) = 5784;
  HIWORD(v23) = (unsigned int)"ist lost cnt failed!" >> 16;
  v24 = sprintf(v49, v23, v20);
  v25 = dev_ctrl(v24);
  ((void (__fastcall *)(_DWORD))v25[24])(*(_DWORD *)(a1 + 240));
  unk_1B30E4 = s[0];
  unk_1B30E8 = s[1];
  unk_1B30EC = s[2];
  unk_1B30F0 = s[3];
