int read_version_file()
{
  ...
  LOWORD(v0) = 28336;
  HIWORD(v0) = (unsigned int)"21 2024" >> 16;
  ...
  if ( v1 )
  {
    ...
    if ( v2 <= 0 )
    {
      ...
      V_UNLOCK();
      LOWORD(v18) = 27616;
      HIWORD(v18) = (unsigned int)"some chip working slow" >> 16;
      v5 = g_miner_type;
      zlog(g_zc, v18, 142, "read_version_file", 17, 443, 100, v20);
    }
    else
    {
      v3 = strchr(v19, 10);
      ...
      v9 = *((unsigned __int8 *)&dword_1949B0[20] + v8);
      if ( v9 == 10 )
      {
        *((_BYTE *)&dword_1949B0[20] + v8) = 0;
        v8 = strlen(g_miner_compiletime) - 1;
        v9 = *((unsigned __int8 *)&dword_1949B0[20] + v8);
      }
      if ( v9 == 13 )
      ...
      v11 = *((unsigned __int8 *)&dword_1949B0[36] + v10);
      if ( v11 == 10 )
      {
        *((_BYTE *)&dword_1949B0[36] + v10) = 0;
        v10 = strlen(g_miner_type) - 1;
        v11 = *((unsigned __int8 *)&dword_1949B0[36] + v10);
      }
      v12 = &g_zc;
  ...
  else
  {
    V_LOCK();
    LOWORD(v16) = 28340;
    HIWORD(v16) = (unsigned int)"024" >> 16;
    v12 = &g_zc;
    logfmt_raw(v20, 0x1000u, 0, v16, opt_version_path);
    V_UNLOCK();
    LOWORD(v17) = 27616;
    HIWORD(v17) = (unsigned int)"some chip working slow" >> 16;
    v5 = g_miner_type;
    zlog(g_zc, v17, 142, "read_version_file", 17, 438, 100, v20);
  }
  V_LOCK();
  LOWORD(v13) = 28412;
  HIWORD(v13) = (unsigned int)"ersion file %s error %d" >> 16;
  logfmt_raw(v20, 0x1000u, 0, v13, g_miner_compiletime, v5);
  V_UNLOCK();
  LOWORD(v14) = 27616;
  HIWORD(v14) = (unsigned int)"some chip working slow" >> 16;
  return zlog(*v12, v14, 142, "read_version_file", 17, 478, 60, v20);
}
