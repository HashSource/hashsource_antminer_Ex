int __fastcall work_2_packet_kas(int a1, int a2, _BYTE *a3, _DWORD *a4)
{
  ...
  {
    v42 = a2;
    dword_1A2F30[0] = (int)malloc(0x450u);
    v6 = *(_DWORD *)(a1 + 824);
    a2 = v42;
    if ( v6 )
      goto LABEL_3;
LABEL_12:
    V_LOCK();
    LOWORD(v39) = -5728;
    HIWORD(v39) = (unsigned int)"enth %08x" >> 16;
    logfmt_raw(v44, 0x1000u, v6, v39, "work_2_packet_kas");
    V_UNLOCK();
    LOWORD(v40) = -6092;
    HIWORD(v40) = (unsigned int)", expected freq: %.2f" >> 16;
    zlog(g_zc, v40, 174, "work_2_packet_kas", 17, 205, 0x14u, v44);
    return 3;
  }
  v6 = *(_DWORD *)(a1 + 824);
  if ( !v6 )
