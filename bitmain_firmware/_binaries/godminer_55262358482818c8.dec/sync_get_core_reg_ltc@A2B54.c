int __fastcall sync_get_core_reg_ltc(int a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  ...
  unsigned __int8 v40[2]; // [sp+3Ch] [bp-1010h] BYREF
  ...
  v7 = 0;
  send_command_packet(a1, v40, 0xBu);
  ...
  while ( a3 > v30 )
  {
    ...
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), v35, 9u, v34) == 110 )
      {
        v7 = 3;
        goto LABEL_16;
      }
      ...
      {
        V_LOCK();
        HIWORD(v22) = (unsigned int)"c" >> 16;
        logfmt_raw(v44, 0x1000u, 0, v22, v37);
        V_UNLOCK();
        LOWORD(v25) = -168;
        HIWORD(v25) = (unsigned int)"ltc" >> 16;
        HIWORD(v23) = (unsigned int)"runtime_ctrl_ltc() out" >> 16;
        zlog(g_zc, v25, 178, v23, 21, 370, 100, v44);
      }
      v24 = v39;
