int __fastcall check_nonce_hns(int a1, int a2)
{
  ...
  if ( v8 <= 0x23 )
  {
    V_LOCK();
    LOWORD(v22) = -7916;
    HIWORD(v22) = (unsigned int)" remote temp(%d, %d)" >> 16;
    logfmt_raw(v26, 0x1000u, 0, v22, v9, *(unsigned __int8 *)(a2 + 56), 36);
    V_UNLOCK();
    LOWORD(v23) = -8280;
    HIWORD(v23) = (unsigned int)"e_cycle_limit" >> 16;
    zlog(g_zc, v23, 174, "check_nonce_hns", 15, 668, 20, v26);
    return 2;
  }
  else
  {
...
LABEL_11:
        ...
        V_UNLOCK();
        LOWORD(v20) = -8280;
        HIWORD(v20) = (unsigned int)"e_cycle_limit" >> 16;
        zlog(g_zc, v20, 174, "check_nonce_hns", 15, 704, 20, v26);
        return 1;
      }
    }
    else if ( v5 > v8 )
    {
      V_LOCK();
      logfmt_raw(v26, 0x1000u, 0, "diff not match (%d!=%d) expected diff %d", v9, *(unsigned __int8 *)(a2 + 56), v5);
      V_UNLOCK();
      LOWORD(v21) = -8280;
      HIWORD(v21) = (unsigned int)"e_cycle_limit" >> 16;
      zlog(g_zc, v21, 174, "check_nonce_hns", 15, 673, 20, v26);
      return 3;
    }
    v11 = s;
