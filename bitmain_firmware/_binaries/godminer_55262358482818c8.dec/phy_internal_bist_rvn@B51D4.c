int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  zlog(g_zc, v10, 177, "phy_internal_bist_rvn", 21, 870, 20, v65);
  v37 = malloc(0x1800u);
  ...
  if ( check_core_reg_with_expect_data_rvn(a1, a2, a3, 83, 0) )
  {
    ...
    zlog(g_zc, v16, 177, "phy_handshake_rvn", 17, 827, 100, v65);
  }
  phy_pll_switch_rvn(a1, a2, a3, a4);
  sub_AE358(a1, a3, 98, -1426085121);
  usleep(0x64u);
  ...
  sub_AE358(a1, a3, 133, 255);
  usleep(0x64u);
  sub_AE358(a1, a3, 134, 255);
  usleep(0x64u);
  sub_AE358(a1, a3, 132, -2147483647);
  sleep(6u);
