int __fastcall check_bringup_temperature_base(int a1)
{
  ...
  if ( ptr )
  {
    ...
    HIWORD(v13) = (unsigned int)"tatus" >> 16;
    v49 = 0;
    v51 = 0;
    s = v12;
    v63 = v13;
...
LABEL_58:
                V_LOCK();
                LOWORD(v44) = -14504;
                HIWORD(v44) = (unsigned int)"sensor_addr %02x, J0:6" >> 16;
                logfmt_raw(v80, 0x1000u, 0, v44);
                V_UNLOCK();
                LOWORD(v45) = -14932;
                HIWORD(v45) = (unsigned int)"%d, set voltage to %d" >> 16;
                zlog(g_zc, v45, 169, "check_bringup_temperature_base", 30, 273, 100, v80);
                while ( 1 )
                  ;
              }
            }
...
LABEL_35:
              ...
              {
                V_LOCK();
                V_INT((int)v72, v58, *(int *)(*(_DWORD *)v28 + 248));
              ...
              {
                V_LOCK();
                V_INT((int)v74, v58, *(int *)(*(_DWORD *)v28 + 248));
            ...
            if ( v34 == 1 )
            {
              ...
              {
                V_LOCK();
                V_INT((int)v76, v58, *(int *)(*(_DWORD *)v28 + 248));
...
LABEL_53:
                ...
                zlog(v40, v42, 169, "check_bringup_temperature_base", 30, v41, 100, v80);
              }
            }
            ++v32;
            v31 += 6;
    ...
    while ( 1 )
    {
      ...
      if ( *v15 != -64 )
      {
        ...
        if ( !v18 )
        {
          ...
          *((_DWORD *)v19 - 128) = v17;
          V_LOCK();
          V_INT((int)v68, s, *(int *)(all_created_runtime[v16] + 248));
          LOWORD(v20) = -14564;
          HIWORD(v20) = (unsigned int)"num :%d" >> 16;
...
LABEL_23:
          ...
          zlog(v22, v23, 169, "check_bringup_temperature_base", 30, v21, 40, v80);
          goto LABEL_19;
        }
        if ( v18 == 1 )
        {
          ...
          *((_DWORD *)v43 - 64) = v17;
          V_LOCK();
          V_INT((int)v70, s, *(int *)(all_created_runtime[v16] + 248));
