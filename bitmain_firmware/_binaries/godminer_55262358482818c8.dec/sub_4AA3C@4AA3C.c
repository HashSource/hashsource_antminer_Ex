int __fastcall sub_4AA3C(int a1, int *a2)
{
  int v2; // r7
  double *v5; // r6
  void *v6; // r9
  ...
  do
  {
    ...
    if ( !(*(int (__fastcall **)(int *, char *))(a1 + 12))(a2, v16) )
    {
      ...
      v7 = 42;
      v8 = g_zc;
      LOWORD(v9) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot"
    ...
    if ( !v10 )
    {
      ...
      LOWORD(v9) = -20464;
LABEL_3:
      HIWORD(v9) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp"
                                 "/release/build/godminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c" >> 16;
      zlog(v8, v9, 167, "stratum_subscribe_ks5", 21, v7, 100, v32);
      free(v16);
      if ( !v5 )
        goto LABEL_11;
      goto LABEL_4;
...
LABEL_35:
          ...
          zlog(
            ...
            "er-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c",
            167,
            "stratum_subscribe_ks5",
            21,
            77,
