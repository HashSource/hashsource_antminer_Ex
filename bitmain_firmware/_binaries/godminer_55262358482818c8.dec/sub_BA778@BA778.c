int __fastcall sub_BA778(int a1, int a2, void *src, size_t a4, void *a5, size_t a6)
{
  _DWORD *v7; // r0
  size_t v8; // r9
  int v11; // r8
  ...
  *((_BYTE *)&v26 + v11 + 3) = v13;
  sub_BA69C((int)"pic tx", (int)&v27, v11);
...
LABEL_12:
  ...
  v21 = v20;
  if ( iic_read(v19, (int)&v27, v20) != v20 )
  {
    v16 = 2;
    V_LOCK();
  ...
  sub_BA69C((int)"pic rx", (int)&v27, v20);
