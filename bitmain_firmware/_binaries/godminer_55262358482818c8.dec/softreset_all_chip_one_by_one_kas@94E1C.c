int __fastcall softreset_all_chip_one_by_one_kas(int *a1)
{
  ...
  zlog(g_zc, v4, 174, "softreset_all_chip_one_by_one_kas", 33, 658, 40, v14);
  if ( a1[84] > 0 )
  {
    v5 = 0;
    LOWORD(v6) = -26716;
    do
    {
      ...
      zlog(g_zc, v7, 153, "ChipSetting_software_reset_one_asic_KAS_2380", 44, 136, 20, v14);
      v8 = a1[107];
