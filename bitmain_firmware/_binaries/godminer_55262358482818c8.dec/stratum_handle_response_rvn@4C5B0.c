int __fastcall stratum_handle_response_rvn(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    V_LOCK();
    LOWORD(v23) = -27332;
    HIWORD(v23) = (unsigned int)"x %08x %08x %08x %08x " >> 16;
    logfmt_raw(v31, 0x1000u, 0, v23, *(_DWORD *)v29, v30);
    V_UNLOCK();
    LOWORD(v24) = -19812;
    HIWORD(v24) = (unsigned int)"stratum_subscribe_rvn" >> 16;
    zlog(g_zc, v24, 167, "stratum_handle_response_rvn", 27, 440, 40, v31);
    return 0;
  }
...
LABEL_28:
    V_LOCK();
    LOWORD(v17) = -26648;
    HIWORD(v17) = (unsigned int)"on failed, req_id=%d" >> 16;
    logfmt_raw(v31, 0x1000u, 0, v17, "stratum_handle_response_rvn");
    V_UNLOCK();
    LOWORD(v18) = -19812;
    HIWORD(v18) = (unsigned int)"stratum_subscribe_rvn" >> 16;
    v16 = 0;
    zlog(g_zc, v18, 167, "stratum_handle_response_rvn", 27, 472, 20, v31);
    goto LABEL_29;
  }
LABEL_18:
  if ( *v12 == 7 )
