int __fastcall stratum_handle_response_hns(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    LOWORD(v28) = -22300;
    LOWORD(v29) = -22196;
    HIWORD(v28) = (unsigned int)"h: %d" >> 16;
    HIWORD(v29) = (unsigned int)"hns_padding" >> 16;
    zlog(g_zc, v29, 167, v28, 27, 381, 40, v32);
    return 0;
  }
...
LABEL_43:
  LOWORD(v24) = -22300;
  V_LOCK();
  HIWORD(v24) = (unsigned int)"h: %d" >> 16;
  LOWORD(v25) = -26648;
  HIWORD(v25) = (unsigned int)"on failed, req_id=%d" >> 16;
  logfmt_raw(v32, 0x1000u, v12, v25, v24);
  V_UNLOCK();
  LOWORD(v26) = -22196;
  HIWORD(v26) = (unsigned int)"hns_padding" >> 16;
  zlog(g_zc, v26, 167, v24, 27, 405, 20, v32);
LABEL_24:
  if ( *((_DWORD *)v5 + 1) != -1 )
  {
