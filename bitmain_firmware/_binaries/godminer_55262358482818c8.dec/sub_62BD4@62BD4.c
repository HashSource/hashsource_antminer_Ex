int sub_62BD4()
{
  ...
  format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v23 + 72) + 16), v25);
  format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v23 + 72) + 16), v26);
  V_LOCK();
  ...
  if ( v24 > 0 )
  {
    ...
    do
    {
      v2 = *(_DWORD *)(*((_DWORD *)v20 + 1) + 240);
      v20 += 4;
      v3 = &dword_1965E0[54 * v2];
      v4 = *((_QWORD *)v3 + 8);
      v5 = *((_QWORD *)v3 + 10);
      format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v23 + 72) + 16), v25);
      v6 = format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v23 + 72) + 16), v26);
      v7 = dev_ctrl(v6);
      v8 = (*(int (__fastcall **)(_DWORD))(v7 + 60))(*(_DWORD *)(*(_DWORD *)v20 + 240));
      LODWORD(v4) = snprintf(
                      v30,
                      0x1000u,
                      "chain %d device %d alive chip count %d avg hashrate %s 30min avg hashrate %s hw %llu\n",
                      v8,
                      *(_DWORD *)(*(_DWORD *)v20 + 240),
                      (_DWORD)v4,
                      v25,
                      v26,
                      v5);
      v9 = snprintf(
             ...
             *(_DWORD *)v20 + 448,
             *(_DWORD *)(*(_DWORD *)v20 + 440),
             *(_DWORD *)(*(_DWORD *)v20 + 444),
             *(_DWORD *)(*(_DWORD *)v20 + 448),
             *(_DWORD *)(*(_DWORD *)v20 + 452),
             HIDWORD(v4));
      v10 = *(_DWORD *)v20;
      v11 = v4 + v9;
      v21 = *(_DWORD *)(*(_DWORD *)v20 + 336);
      if ( v21 > 0 )
      {
        v12 = 0;
        v19 = 0;
