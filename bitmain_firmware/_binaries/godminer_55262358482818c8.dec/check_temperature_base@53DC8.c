...
LABEL_14:
        ...
        HIWORD(v14) = (unsigned int)"tatus" >> 16;
        v47 = 0;
        v53 = 0;
        s = v13;
        v56 = v14;
...
LABEL_23:
        ...
        while ( 1 )
        {
          ...
          if ( *v16 != -64 )
          {
            v19 = *(_DWORD *)(*(_DWORD *)(all_created_runtime[v17] + 388) + v15 + 12);
            if ( !v19 )
            {
              v20 = &v75[4 * v47++];
              *((_DWORD *)v20 - 128) = v18;
              V_LOCK();
              V_INT((int)v63, s, *(int *)(all_created_runtime[v17] + 248));
              LOWORD(v21) = -14564;
              HIWORD(v21) = (unsigned int)"num :%d" >> 16;
...
LABEL_22:
              LOWORD(v24) = -14932;
              HIWORD(v24) = (unsigned int)"%d, set voltage to %d" >> 16;
              zlog(v23, v24, 169, "check_temperature_base", 22, v22, 20, v75);
              goto LABEL_18;
            }
            if ( v19 == 1 )
            {
              ...
              *((_DWORD *)v44 - 64) = v18;
              V_LOCK();
              V_INT((int)v65, s, *(int *)(all_created_runtime[v17] + 248));
...
LABEL_45:
              LOWORD(v43) = -14932;
              HIWORD(v43) = (unsigned int)"%d, set voltage to %d" >> 16;
              zlog(v42, v43, 169, "check_temperature_base", 22, v41, 100, v75);
            }
LABEL_34:
