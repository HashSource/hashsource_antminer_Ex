        ...
        char a7)
{
  ...
  V_INT((int)&v19, v10, *(int *)(a1 + 248));
  if ( a7 )
  {
    LOWORD(v11) = -10496;
    HIWORD(v11) = (unsigned int)"x is invalid!" >> 16;
    LOWORD(v12) = -10504;
    HIWORD(v12) = (unsigned int)"macro1 rx is invalid!" >> 16;
    logfmt_raw(
      var1004,
      0x1000u,
      0,
    ...
    V_UNLOCK();
    LOWORD(v13) = -14704;
    HIWORD(v13) = (unsigned int)" %s handshake failed!" >> 16;
    zlog(g_zc, v13, 177, "phy_external_loop_adapt", 23, 1905, 60, var1004);
  ...
  {
    LOWORD(v15) = -10496;
    HIWORD(v15) = (unsigned int)"x is invalid!" >> 16;
    LOWORD(v16) = -10448;
    HIWORD(v16) = (unsigned int)"d, pre=%02d, post=%02d" >> 16;
    logfmt_raw(
      var1004,
      0x1000u,
      0,
    ...
    zlog(g_zc, v17, 177, "phy_external_loop_adapt", 23, 1905, 60, var1004);
    phy_eq_main_set_by_apb(a1, a2, &v18, 1, a4);
    phy_eq_pre_set_by_apb(a1, a2, &v18, 1, a5);
    phy_eq_post_set_by_apb(a1, a2, &v18, 1, a6);
  }
