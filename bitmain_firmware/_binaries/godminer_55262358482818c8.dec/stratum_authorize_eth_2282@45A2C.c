int __fastcall stratum_authorize_eth_2282(int a1, int *a2)
{
  ...
  if ( a2[6] )
  {
    V_LOCK();
    LOWORD(v4) = -23172;
    HIWORD(v4) = (unsigned int)"Will Use Current Time!" >> 16;
    logfmt_raw((char *)&v48, 0x1000u, 0, v4, a2[6]);
    V_UNLOCK();
    LOWORD(v5) = -22736;
    HIWORD(v5) = (unsigned int)"tum_authorize_eth_2282" >> 16;
    zlog(g_zc, v5, 177, "stratum_authorize_eth_2282", 26, 380, 20, &v48);
    v6 = (char *)a2[6];
    goto LABEL_3;
  }
  V_LOCK();
  LOWORD(v16) = -23300;
  HIWORD(v16) = (unsigned int)"ht" >> 16;
  logfmt_raw((char *)&v48, 0x1000u, 0, v16);
  V_UNLOCK();
  LOWORD(v17) = -22736;
  HIWORD(v17) = (unsigned int)"tum_authorize_eth_2282" >> 16;
  zlog(g_zc, v17, 177, "stratum_authorize_eth_2282", 26, 362, 20, &v48);
  memset(s, 0, 32);
  v18 = socket(2, 1, 0);
  if ( v18 < 0 )
  {
  ...
  {
    LOWORD(v19) = -23248;
    HIWORD(v19) = (unsigned int)" Use MacAddr!" >> 16;
    v20 = v19[1];
    v48 = *v19;
    v49 = v20;
    ...
    {
      LOWORD(v21) = -23240;
      HIWORD(v21) = (unsigned int)"Addr!" >> 16;
  ...
  V_LOCK();
  LOWORD(v40) = -23212;
  HIWORD(v40) = (unsigned int)"%02X%02X%02X%02X%02X" >> 16;
  logfmt_raw((char *)&v48, 0x1000u, 0, v40);
  V_UNLOCK();
  LOWORD(v41) = -22736;
  HIWORD(v41) = (unsigned int)"tum_authorize_eth_2282" >> 16;
  zlog(g_zc, v41, 177, "stratum_authorize_eth_2282", 26, 371, 20, &v48);
  time(&v48);
  LOWORD(v42) = 24136;
  HIWORD(v42) = (unsigned int)"l generated local work  %d" >> 16;
...
LABEL_3:
  ...
  LOWORD(v11) = -23144;
  v12 = v10;
  HIWORD(v11) = (unsigned int)" Use Worker Name!->'%s'" >> 16;
...
LABEL_4:
  ...
  if ( !v22 )
  {
    V_LOCK();
    LOWORD(v38) = -27332;
    HIWORD(v38) = (unsigned int)"x %08x %08x %08x %08x " >> 16;
    v13 = 0;
    logfmt_raw((char *)&v48, 0x1000u, 0, v38, s[0], v47);
    V_UNLOCK();
    LOWORD(v39) = -22736;
    HIWORD(v39) = (unsigned int)"tum_authorize_eth_2282" >> 16;
    zlog(g_zc, v39, 177, "stratum_authorize_eth_2282", 26, 405, 100, &v48);
    free(v12);
    return v13;
  }
  LOWORD(v23) = -27288;
  HIWORD(v23) = (unsigned int)"d): %s" >> 16;
  v24 = json_object_get(v22, v23);
  LOWORD(v25) = 27772;
  v26 = (_DWORD *)v24;
  HIWORD(v25) = (unsigned int)"od-miner.c" >> 16;
  v27 = json_object_get(v22, v25);
  LOWORD(v28) = 28304;
  v29 = (_DWORD *)v27;
  HIWORD(v28) = (unsigned int)"lid" >> 16;
  ...
  else
  {
    ...
    V_UNLOCK();
    LOWORD(v34) = -22736;
    HIWORD(v34) = (unsigned int)"tum_authorize_eth_2282" >> 16;
    zlog(g_zc, v34, 177, "stratum_authorize_eth_2282", 26, 416, 80, &v48);
  }
  free(v12);
  if ( *((_DWORD *)v22 + 1) == -1 )
    return v13;
