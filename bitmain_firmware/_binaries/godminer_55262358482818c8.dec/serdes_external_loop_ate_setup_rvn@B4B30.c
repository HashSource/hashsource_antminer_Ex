int __fastcall serdes_external_loop_ate_setup_rvn(int a1, int a2, int a3, int a4)
{
  ...
  LOWORD(v8) = 6824;
  LOWORD(v9) = -17112;
  HIWORD(v8) = (unsigned int)"08x" >> 16;
  LOWORD(v10) = 7540;
  V_INT((int)v13, v7, *(int *)(a1 + 248));
  ...
  V_UNLOCK();
  zlog(g_zc, v10, 177, v8 + 468, 34, 710, 60, v17);
  ...
  V_UNLOCK();
  zlog(g_zc, v10, 177, v8 + 468, 34, 721, 60, v17);
