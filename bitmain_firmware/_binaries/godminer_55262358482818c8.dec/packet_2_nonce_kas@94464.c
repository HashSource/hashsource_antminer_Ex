int __fastcall packet_2_nonce_kas(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  ...
  v14 = v11;
  if ( v11 != v13 && *(_BYTE *)(a1 + 254) )
  {
    v28 = &dword_1A2F30[*(_DWORD *)(a1 + 248)];
    v29 = v28[1];
    v28[1] = v29 + 1;
    if ( v29 <= 9 )
    {
      ...
      V_INT((int)v61, v30, *(int *)(a1 + 248));
      LOWORD(v31) = -7852;
      HIWORD(v31) = (unsigned int)"ICKET_MASK_HNS_2130 %d" >> 16;
      logfmt_raw(s, 0x1000u, 0, v62, v61[0], v61[1], v61[2], v61[3], v61[4], v61[5], v61[6], v62, v31, 0, v14, v13);
      V_UNLOCK();
      LOWORD(v32) = -6092;
      HIWORD(v32) = (unsigned int)", expected freq: %.2f" >> 16;
      zlog(g_zc, v32, 174, "packet_2_nonce_kas", 18, 275, 40, s);
    }
    return 11;
  }
  else
    ...
    else
    {
      ...
      *a7 = v18;
      if ( v18 != -1 )
      {
        ...
        *(_BYTE *)(a3 + 16) = v15;
        *(_BYTE *)(a3 + 17) = v23;
        v24 = (unsigned int)*(unsigned __int8 *)(a2 + 6) / *(_DWORD *)(a1 + 428);
        if ( v24 >= *(_DWORD *)(a1 + 336) )
        {
          v52 = rand();
          sub_144704(v52, *(_DWORD *)(a1 + 336));
          v24 = v53;
        }
        *a6 = v24;
        *(_DWORD *)(a3 + 8) = v24;
        ...
        *a4 = 1;
        ...
        if ( v33 <= 0 )
        {
          ...
          v36 = 0;
LABEL_33:
          *(_QWORD *)&dword_1A2F30[v44 + 20] = v36;
          return 0;
        }
        v34 = *(_DWORD *)(a1 + 456);
        v35 = 0;
        ...
        v43 = v37;
        v44 = 2 * v60;
        v45 = *(_QWORD *)&dword_1A2F30[2 * v60 + 20];
        if ( v45 >= v36 )
        {
          LOWORD(v46) = 12288;
        }
        ...
        {
          LOWORD(v46) = (unsigned __int16)&unk_1A3000;
          if ( v36 - v45 <= 0x63 )
          {
            v47 = 0;
            HIWORD(v46) = (unsigned int)&unk_1A3000 >> 16;
            v48 = s;
            do
            {
              v50 = *(_QWORD *)v48;
              ...
              {
                close_one_chip_cores_kas(a1, (unsigned __int8)v47);
                v42 = *(_DWORD *)(a1 + 240);
                v43 = *(_DWORD *)(a1 + 336);
              }
              ++v47;
...
LABEL_31:
    ...
    LOWORD(v55) = -6092;
    HIWORD(v55) = (unsigned int)", expected freq: %.2f" >> 16;
    zlog(g_zc, v55, 174, "packet_2_nonce_kas", 18, v54, 20, s);
    return 12;
  }
}
