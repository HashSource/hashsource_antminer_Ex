int __fastcall prepare_for_pcba_test_rvn(int a1, int *a2)
{
  ...
  V_LOCK();
  LOWORD(v4) = -17112;
  HIWORD(v4) = (unsigned int)"ue %04x resp value %04x" >> 16;
  logfmt_raw((char *)v13, 0x1000u, 0, v4, "prepare_for_pcba_test_rvn");
  V_UNLOCK();
  LOWORD(v5) = 5292;
  HIWORD(v5) = (unsigned int)&unk_171494 >> 16;
  zlog(g_zc, v5, 174, "prepare_for_pcba_test_rvn", 25, 2487, 60, v13);
  v6 = *a2;
  if ( (unsigned int)*a2 > 0xA )
  {
    LOWORD(v12) = -15844;
    HIWORD(v12) = (unsigned int)"0x%llx, crc error: %s" >> 16;
  ...
  {
    LOWORD(v7) = -15800;
    HIWORD(v7) = (unsigned int)" sequence parameter\n" >> 16;
    printf(v7, "prepare_for_pcba_test_rvn");
    membist1_rvn(a1);
    stop_mining_rvn(a1);
    v8 = *(void (__fastcall **)(int, _DWORD *))(a1 + 264);
    v13[0] = 272381185;
    v13[2] = 1310721;
    v13[1] = 0;
    v13[3] = 0;
    ...
    *(_BYTE *)(a1 + 253) = 1;
    *(_BYTE *)(a1 + 254) = 1;
    HIWORD(v10) = (unsigned int)"prepare for pcba test\n" >> 16;
