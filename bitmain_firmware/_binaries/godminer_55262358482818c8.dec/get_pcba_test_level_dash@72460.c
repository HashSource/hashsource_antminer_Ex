...
LABEL_2:
  ...
  v6 = dev_ctrl((int)a1);
  v7 = ((int (__fastcall *)(_DWORD, int, int, int *))v6[25])(a1[60], 52, 393216, &v24);
  if ( !v7 )
  {
    v8 = (unsigned __int16 *)&unk_16A410;
    v9 = 700;
    v10 = (unsigned __int16)v24;
    v11 = HIWORD(v24);
    for ( i = (unsigned __int16 *)&unk_16A410; ; v9 = i[2] )
    {
...
LABEL_21:
    ...
    V_INT((int)v29, v16, (int)a1[62]);
    LOWORD(v17) = -22676;
    HIWORD(v17) = (unsigned int)" error" >> 16;
    v18 = &aGlobalIdxInitD_1[10 * a1[246] - 10];
    logfmt_raw(
      v31,
      0x1000u,
      0,
    ...
    V_UNLOCK();
    LOWORD(v19) = -22992;
    HIWORD(v19) = (unsigned int)"__custom_data init %p" >> 16;
    zlog(g_zc, v19, 176, "get_pcba_test_level_dash", 24, 1049, 40, v31);
    v2 = a1[246];
    goto LABEL_2;
  }
  *a2 = -1;
  ...
  V_INT((int)v26, v20, (int)a1[62]);
  LOWORD(v21) = -22708;
  LOWORD(v22) = 27772;
  HIWORD(v21) = (unsigned int)"ICKET_MASK_DASH_1766 %d" >> 16;
  HIWORD(v22) = (unsigned int)"od-miner.c" >> 16;
  V_STR(v28, v22, v21);
  logfmt_raw(
    v31,
    0x1000u,
  ...
  V_UNLOCK();
  LOWORD(v23) = -22992;
  HIWORD(v23) = (unsigned int)"__custom_data init %p" >> 16;
  zlog(g_zc, v23, 176, "get_pcba_test_level_dash", 24, 1027, 120, v31);
  return 15;
}
