int bitmain_get_power_status()
{
  ...
  if ( dword_1B36F4 || (v0 = sub_C7E8C(), v0 >= 0) )
  {
    v22 = 0;
    v21 = 0;
    v19 = 168077909;
    v20 = 14;
    if ( sub_C7500(dword_1B36F0, (unsigned __int8 *)&v19, 6u, (unsigned __int8 *)&v21, 8u) )
    {
      LOWORD(v1) = 26552;
      HIWORD(v1) = (unsigned int)"nont get sample voltage" >> 16;
      v2 = *v1;
      v3 = v1[1];
      v4 = v1[2];
      v5 = v1[3];
      ...
      zlog(g_zc, v7, 176, "_bitmain_get_power_status", 25, 532, 100, v30);
      LOWORD(v8) = 26576;
      HIWORD(v8) = (unsigned int)"get power status failed" >> 16;
      v9 = *v8;
      v10 = v8[1];
      v11 = v8[2];
      v12 = v8[3];
      ...
      V_UNLOCK();
      LOWORD(v15) = 25984;
      HIWORD(v15) = (unsigned int)"x, crc_read = 0x%04x" >> 16;
      zlog(g_zc, v15, 176, "bitmain_get_power_status", 24, 586, 100, v30);
      return -2147482880;
    }
  ...
  {
    LOWORD(v17) = 26340;
    HIWORD(v17) = (unsigned int)"power close ===========" >> 16;
    ...
    zlog(g_zc, v18, 176, "bitmain_get_power_status", 24, 582, 100, v30);
  }
  return v0;
}
