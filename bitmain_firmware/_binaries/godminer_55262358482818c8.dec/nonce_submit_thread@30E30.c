void __noreturn nonce_submit_thread()
{
  ...
  V_UNLOCK();
  LOWORD(v5) = 30380;
  HIWORD(v5) = (unsigned int)"it idle pool's nonce." >> 16;
  zlog(g_zc, v5, 138, "nonce_submit_thread", 19, 230, 40, v24);
  prctl(15, v2);
  v6 = pthread_self();
  pthread_detach(v6);
  ...
  LOWORD(v8) = 30872;
  LOWORD(v9) = 30380;
  HIWORD(v8) = (unsigned int)"pushed after %lld ms" >> 16;
  HIWORD(v9) = (unsigned int)"it idle pool's nonce." >> 16;
  v19 = v8;
  v20 = v9;
  while ( 1 )
  {
    while ( 1 )
    {
      (*(void (__fastcall **)(int, _QWORD *))(v7 + 40))(v7, v23);
      ...
      V_UNLOCK();
      zlog(g_zc, v20, 138, "nonce_submit_thread", 19, 250, 80, v24);
    }
