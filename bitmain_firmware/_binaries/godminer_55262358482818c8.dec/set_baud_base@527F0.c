int __fastcall set_baud_base(int a1, int a2)
{
  ...
  if ( a2 > 3000000 )
  {
    ...
    LOWORD(v11) = -14620;
    HIWORD(v11) = (unsigned int)"tection. Bias freq:%.2f" >> 16;
    logfmt_raw(v24, 0x1000u, 0, v11, chain_domain_num);
    V_UNLOCK();
    LOWORD(v12) = -14932;
    HIWORD(v12) = (unsigned int)"%d, set voltage to %d" >> 16;
    zlog(g_zc, v12, 169, "set_baud_base", 13, 149, 20, v24);
    V_LOCK();
    ...
    V_UNLOCK();
    LOWORD(v15) = -14932;
    HIWORD(v15) = (unsigned int)"%d, set voltage to %d" >> 16;
    zlog(g_zc, v15, 169, "set_baud_base", 13, 150, 20, v24);
