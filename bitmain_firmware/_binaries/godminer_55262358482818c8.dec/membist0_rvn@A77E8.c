int __fastcall membist0_rvn(int a1)
{
  ...
  zlog(g_zc, v4, 174, "membist0_rvn", 12, 814, 20, v54);
  LOWORD(v5) = 23936;
  v42[0] = -2023406815;
  v42[1] = 1266163410;
  v42[2] = 2015285835;
  ...
  do
  {
    ...
    V_UNLOCK();
    LOWORD(v8) = 5292;
    HIWORD(v8) = (unsigned int)&unk_171494 >> 16;
    zlog(*v3, v8, 174, "membist0_rvn", 12, 823, 60, v54);
    sub_A3FA8(a1, 164, v7);
    do
    {
      sub_A409C(a1, n, 28, 1);
      sub_A409C(a1, n, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v9 = ptr;
      v10 = sub_A4418(a1, (unsigned __int16)n, 161, ptr);
      if ( v10 > 0 )
      {
        v11 = &ptr[12 * v10];
        do
        {
          while ( (*(_DWORD *)v9 & 0x80) == 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v12) = 5292;
            HIWORD(v12) = (unsigned int)&unk_171494 >> 16;
            zlog(*v6, v12, 174, "membist0_rvn", 12, 845, 100, v54);
            if ( v9 == v11 )
              goto LABEL_10;
          }
          if ( (*(_DWORD *)v9 & 0xFFFFFF00) != 0 )
          {
            ...
            zlog(*v6, v34, 174, "membist0_rvn", 12, 839, 100, v54);
...
LABEL_10:
      v13 = ptr;
      v14 = sub_A4418(a1, (unsigned __int16)n, 162, ptr);
      if ( v14 > 0 )
      {
        v15 = &ptr[12 * v14];
        do
        {
          ...
          V_UNLOCK();
          LOWORD(v16) = 5292;
          HIWORD(v16) = (unsigned int)&unk_171494 >> 16;
          zlog(*v6, v16, 174, "membist0_rvn", 12, 854, 100, v54);
...
LABEL_16:
      v18 = ptr;
      v19 = sub_A4418(a1, (unsigned __int16)n, 163, ptr);
      if ( v19 > 0 )
      {
        LOWORD(v20) = 5660;
        v21 = &ptr[12 * v19];
        do
        {
          ...
          V_LOCK();
          v18 += 12;
          V_INT((int)v51, v36, *(int *)(a1 + 248));
          HIWORD(v20) = (unsigned int)"ist final pattern %08x" >> 16;
          logfmt_raw(
            v54,
            0x1000u,
            0,
          ...
          V_UNLOCK();
          LOWORD(v22) = 5292;
          HIWORD(v22) = (unsigned int)&unk_171494 >> 16;
          zlog(*v6, v22, 174, "membist0_rvn", 12, 864, 100, v54);
...
LABEL_22:
  ...
  do
  {
    ...
    v30 = *v26++;
    v24 += 4;
    HIWORD(v25) = (unsigned int)"rvnbist err cnt: %08x" >> 16;
    v31 = sprintf(v54, v25, v30, 8, v28);
  }
  while ( &s[20] != v24 );
  v32 = dev_ctrl(v31);
  ((void (__fastcall *)(_DWORD))v32[24])(*(_DWORD *)(a1 + 240));
  return 0;
}
