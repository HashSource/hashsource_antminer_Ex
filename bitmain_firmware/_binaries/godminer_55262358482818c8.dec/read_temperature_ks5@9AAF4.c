int __fastcall read_temperature_ks5(int a1, int *a2)
{
  ...
  if ( v2 > 0 )
  {
    ...
    for ( i = a2; v20 != i; i += 2 )
    {
      ...
      LOWORD(v14) = -2320;
      HIWORD(v14) = (unsigned int)&unk_16F6D8 >> 16;
      zlog(g_zc, v14, 174, "read_temperature_ks5", 20, v13, 100, v33);
      v6 = v21;
LABEL_4:
      *i = v6;
      v7 = v3[1];
...
LABEL_11:
        LOWORD(v16) = -2320;
        HIWORD(v16) = (unsigned int)&unk_16F6D8 >> 16;
        zlog(g_zc, v16, 174, "read_temperature_ks5", 20, v15, 100, v33);
        v12 = v22;
        goto LABEL_6;
      }
      v12 = v22;
