int __fastcall read_feedback_voltage(int a1)
{
  ...
  V_LOCK();
  LOWORD(v4) = 27048;
  HIWORD(v4) = (unsigned int)"ain_set_voltage failed" >> 16;
  logfmt_raw(v8, 0x1000u, 0, v4, a1, v7, v1, v2);
  V_UNLOCK();
  LOWORD(v5) = 26816;
  HIWORD(v5) = (unsigned int)"check_feedback_voltage" >> 16;
  return zlog(g_zc, v5, 153, "read_feedback_voltage", 21, 57, 20, v8);
}
