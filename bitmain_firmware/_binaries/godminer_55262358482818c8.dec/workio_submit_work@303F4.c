int __fastcall workio_submit_work(int a1, pthread_mutex_t *a2)
{
  ...
  if ( v5 )
  {
    ...
    lock = a2->__lock;
    LOWORD(v9) = 30344;
    HIWORD(v9) = (unsigned int)&off_147670 >> 16;
    LOWORD(v10) = 30352;
    V_INT((int)v21, v9, lock);
    HIWORD(v10) = (unsigned int)off_147678 >> 16;
    logfmt_raw(v23, 0x1000u, 0, v22, v21[0], v21[1], v21[2], v21[3], v21[4], v21[5], v21[6], v22, v10);
    V_UNLOCK();
    LOWORD(v11) = 30380;
    LOWORD(v12) = 30224;
    HIWORD(v12) = (unsigned int)"sn set in Release mode" >> 16;
    HIWORD(v11) = (unsigned int)"it idle pool's nonce." >> 16;
    zlog(g_zc, v11, 138, v12, 18, 18, 20, v23);
    return 0;
  }
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( v6 )
        break;
      v13 = dword_194B24;
      v14 = 3518437209LL * (unsigned int)dword_194B24;
      ...
      if ( v13 == 10000 * (HIDWORD(v14) >> 13) )
      {
        V_LOCK();
        LOWORD(v15) = 30344;
        HIWORD(v15) = (unsigned int)&off_147670 >> 16;
        V_INT((int)v19, v15, a2->__lock);
        LOWORD(v16) = 30520;
        HIWORD(v16) = (unsigned int)"n_godminer-new/miner.c" >> 16;
        logfmt_raw(v23, 0x1000u, 0, v20, v19[0], v19[1], v19[2], v19[3], v19[4], v19[5], v19[6], v20, v16, 0, v5);
        V_UNLOCK();
        LOWORD(v17) = 30224;
        LOWORD(v18) = 30380;
        HIWORD(v17) = (unsigned int)"sn set in Release mode" >> 16;
        HIWORD(v18) = (unsigned int)"it idle pool's nonce." >> 16;
        zlog(g_zc, v18, 138, v17, 18, 34, 100, v23);
        if ( v5 == 3 )
          return v6;
      }
      else if ( v5 == 3 )
