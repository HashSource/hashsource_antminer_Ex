int __fastcall stratum_authorize_rvn(int a1, int *a2, void *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v8 )
    {
      V_LOCK();
      LOWORD(v53) = -26916;
      HIWORD(v53) = (unsigned int)"subscribe send failed" >> 16;
      logfmt_raw(v70, 0x1000u, 0, v53);
      V_UNLOCK();
      LOWORD(v54) = -19812;
      HIWORD(v54) = (unsigned int)"stratum_subscribe_rvn" >> 16;
      zlog(g_zc, v54, 167, "stratum_authorize_rvn", 21, 191, 100, v70);
LABEL_2:
      free(v16);
      if ( !v6 )
        goto LABEL_10;
LABEL_3:
    ...
    {
      LOWORD(v18) = -27288;
      HIWORD(v18) = (unsigned int)"d): %s" >> 16;
      v19 = json_object_get(v6, v18);
      LOWORD(v20) = 27772;
      v58 = (_DWORD *)v19;
      HIWORD(v20) = (unsigned int)"od-miner.c" >> 16;
      v21 = json_object_get(v6, v20);
      LOWORD(v22) = 28304;
      v57 = (_DWORD *)v21;
      HIWORD(v22) = (unsigned int)"lid" >> 16;
      ...
      if ( v24 || *v58 == 6 )
      {
        V_LOCK();
        LOWORD(v36) = 30344;
        HIWORD(v36) = (unsigned int)&off_147670 >> 16;
        V_INT((int)&v60, v36, *a2);
        v37 = json_array_get(v57, 1u);
        v38 = json_string_value(v37);
        LOWORD(v39) = -23044;
        HIWORD(v39) = (unsigned int)"\": \"eth_submitLogin\"}" >> 16;
        logfmt_raw(v70, 0x1000u, 0, v67, v60, v61, v62, v63, v64, v65, v66, v67, v39, v38);
        V_UNLOCK();
        LOWORD(v40) = -19812;
        HIWORD(v40) = (unsigned int)"stratum_subscribe_rvn" >> 16;
        zlog(g_zc, v40, 167, "stratum_authorize_rvn", 21, 215, 80, v70);
        if ( !v3 )
        {
LABEL_36:
          v8 = 0;
        ...
        if ( !v57 )
        {
          ...
          if ( v43 )
          {
            LOWORD(v45) = -26888;
            v16 = v43;
            HIWORD(v45) = (unsigned int)"tum_subscribe timed out" >> 16;
            v8 = 0;
            v46 = *v45;
            v47 = v45[1];
            v48 = v45[2];
            ...
            *((_DWORD *)v44 + 3) = v49;
            ...
            V_LOCK();
            LOWORD(v51) = -26868;
            HIWORD(v51) = (unsigned int)"out" >> 16;
            logfmt_raw(v70, 0x1000u, 0, v51, v16, v59);
            V_UNLOCK();
            LOWORD(v52) = -19812;
            HIWORD(v52) = (unsigned int)"stratum_subscribe_rvn" >> 16;
            zlog(g_zc, v52, 167, "stratum_authorize_rvn", 21, 222, 100, v70);
LABEL_37:
            free(v16);
            if ( *((_DWORD *)v6 + 1) != -1 )
            {
LABEL_5:
          ...
          LOWORD(v55) = -26868;
          v8 = 0;
          HIWORD(v55) = (unsigned int)"out" >> 16;
          logfmt_raw(v70, 0x1000u, 0, v55, 0, v59);
          V_UNLOCK();
          LOWORD(v56) = -19812;
          HIWORD(v56) = (unsigned int)"stratum_subscribe_rvn" >> 16;
          zlog(g_zc, v56, 167, "stratum_authorize_rvn", 21, 222, 100, v70);
          if ( *((_DWORD *)v6 + 1) == -1 )
            return v8;
LABEL_27:
      ...
      else
      {
        ...
        LOWORD(v28) = -23044;
        HIWORD(v28) = (unsigned int)"\": \"eth_submitLogin\"}" >> 16;
        logfmt_raw(v70, 0x1000u, 0, v67, v60, v61, v62, v63, v64, v65, v66, v67, v28, v27);
        V_UNLOCK();
        LOWORD(v29) = -19812;
        HIWORD(v29) = (unsigned int)"stratum_subscribe_rvn" >> 16;
        zlog(g_zc, v29, 167, "stratum_authorize_rvn", 21, 215, 80, v70);
        if ( !v3 )
          goto LABEL_36;
      }
      ...
      V_LOCK();
      LOWORD(v30) = -26868;
      HIWORD(v30) = (unsigned int)"out" >> 16;
      logfmt_raw(v70, 0x1000u, 0, v30, v16, v59);
      V_UNLOCK();
      LOWORD(v31) = -19812;
      HIWORD(v31) = (unsigned int)"stratum_subscribe_rvn" >> 16;
      zlog(g_zc, v31, 167, "stratum_authorize_rvn", 21, 222, 100, v70);
      if ( v16 )
        goto LABEL_36;
      if ( *((_DWORD *)v6 + 1) != -1 )
        goto LABEL_27;
    ...
    else
    {
      V_LOCK();
      LOWORD(v41) = -27332;
      HIWORD(v41) = (unsigned int)"x %08x %08x %08x %08x " >> 16;
      logfmt_raw(v70, 0x1000u, 0, v41, *(_DWORD *)v68, v69);
      V_UNLOCK();
      LOWORD(v42) = -19812;
      HIWORD(v42) = (unsigned int)"stratum_subscribe_rvn" >> 16;
      zlog(g_zc, v42, 167, "stratum_authorize_rvn", 21, 205, 100, v70);
      free(v16);
    }
LABEL_10:
    if ( a3 )
