bool __fastcall sub_46700(int a1, int *a2, _DWORD *a3)
{
  _BOOL4 v4; // r4
  _DWORD *v7; // r0
  const char *v8; // r5
          ...
          if ( v4 )
          {
              ...
              if ( v4 )
              {
                ...
                if ( v4 )
                {
                  ...
                  if ( v4 )
                  {
                    ...
                    if ( memcmp(v27, &dword_195710, 0x20u) )
                    {
                      dword_195710 = *(_DWORD *)v27;
                      memset(dest, 0, sizeof(dest));
                      memset(&unk_195730, 0, 0x20u);
                      memset(v91, 0, 0xF0u);
                      hs_blake2b_init(v91, 32);
                      hs_blake2b_update((int)v91, v27, 0x20u);
                      hs_blake2b_update((int)v91, dest, 0x20u);
                      hs_blake2b_final((int)v91, &unk_195730, 0x20u);
                    }
                    v29 = a2 + 116;
                    v30 = a2[19];
            ...
            else
            {
              ...
              zlog(
                ...
                "dminer-origin_godminer-new/frontend/frontend_hns/frontend_hns.c",
                167,
                "stratum_notify_hns",
                18,
                209,
