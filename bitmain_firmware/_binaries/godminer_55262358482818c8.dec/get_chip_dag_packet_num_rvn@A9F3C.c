int __fastcall get_chip_dag_packet_num_rvn(int a1)
{
  ...
  else
  {
    ...
    V_INT((int)v27, v14, *(int *)(a1 + 248));
    LOWORD(v15) = 5888;
    HIWORD(v15) = (unsigned int)"HW Error" >> 16;
    v26 = 12;
    logfmt_raw(v33, 0x1000u, 0, v28, v27[0], v27[1], v27[2], v27[3], v27[4], v27[5], v27[6], v28, v15);
    V_UNLOCK();
    LOWORD(v16) = 5292;
    HIWORD(v16) = (unsigned int)&unk_171494 >> 16;
    zlog(g_zc, v16, 174, "get_chip_dag_packet_num_rvn", 27, 2091, 100, v33);
  }
  v21 = sub_A4654(a1, 116, v19);
  if ( v21 == 8 )
    goto LABEL_4;
  V_LOCK();
  LOWORD(v17) = 23936;
  HIWORD(v17) = (unsigned int)"p" >> 16;
  V_INT((int)v29, v17, *(int *)(a1 + 248));
  logfmt_raw(
    v33,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v18) = 5292;
  HIWORD(v18) = (unsigned int)&unk_171494 >> 16;
  zlog(g_zc, v18, 174, "get_chip_dag_packet_num_rvn", 27, 2098, 100, v33);
  v26 = 12;
  if ( v21 > 0 )
  {
LABEL_4:
    ...
    LOWORD(v6) = 30348;
    v7 = 0;
    HIWORD(v3) = (unsigned int)" dag crc status failed" >> 16;
    HIWORD(v4) = (unsigned int)"p" >> 16;
    HIWORD(v5) = (unsigned int)"_dash/frontend_dash.c" >> 16;
    HIWORD(v6) = (unsigned int)&off_147674 >> 16;
    v22 = v3;
    s = v4;
    v23 = v5;
    v24 = v6;
    do
    {
      ...
      zlog(g_zc, v12, 174, "get_chip_dag_packet_num_rvn", 27, 2107, 60, v33);
    }
    while ( v21 > v7 );
  }
  free(ptr);
