int __fastcall eeprom_rewrite_one_chain(unsigned int a1, int a2, int a3, int a4)
{
  ...
  if ( !sub_C4024(v53, v45) || !sub_C2F68(v53, (unsigned __int8 *)v45) )
  {
LABEL_6:
    *(_BYTE *)(a2 + a1 + 64) = 0;
  ...
  *(_BYTE *)(v44 + 64) = 1;
  snprintf(
    ...
    a1,
    *(unsigned __int16 *)(v45 + 35),
    *(unsigned __int16 *)(v45 + 35) + a3,
    *(unsigned __int16 *)(v45 + 37),
    *(unsigned __int16 *)(v45 + 37) + a4);
  V_LOCK();
  logfmt_raw((char *)v57, 0x1000u, 0, v56);
  V_UNLOCK();
  zlog(
  ...
  *(_WORD *)(v45 + 37) = v13;
  ...
  if ( init_eeprom_fmt_info(dest, v14) )
  {
    ...
    memcpy(&v53[HIBYTE(dest[0])], v15, LOBYTE(dest[9]));
    ...
    memcpy(&v53[LOBYTE(dest[1])], v16, BYTE1(dest[9]));
    ...
    memcpy(&v53[BYTE1(dest[1])], v17, BYTE2(dest[9]));
    ...
    if ( (unsigned int)*(unsigned __int8 *)(v45 + 2) - 1 <= 1 )
    {
      ...
      memcpy(&v53[HIBYTE(dest[1])], v57, LOBYTE(dest[10]));
    }
    else
    {
      memcpy(&v53[HIBYTE(dest[1])], v18, LOBYTE(dest[10]));
    }
    v53[LOBYTE(dest[2])] = *(_BYTE *)(v45 + 20);
    v19 = *(const void **)(v45 + 21);
    if ( !v19 )
    {
    ...
    memcpy(&v53[BYTE1(dest[2])], v19, BYTE2(dest[10]));
    v20 = HIBYTE(dest[2]);
    v21 = LOBYTE(dest[3]);
    v53[BYTE2(dest[2])] = *(_BYTE *)(v45 + 25);
    v22 = BYTE1(dest[3]);
    v23 = BYTE2(dest[3]);
    v53[v20] = *(_BYTE *)(v45 + 26);
    v53[v21] = *(_BYTE *)(v45 + 27);
    v24 = HIBYTE(dest[3]);
    v53[v22] = *(_BYTE *)(v45 + 28);
    v53[v23] = *(_BYTE *)(v45 + 29);
    v53[v24] = *(_BYTE *)(v45 + 30);
    v25 = *(const void **)(v45 + 31);
    if ( !v25 )
    {
    ...
    memcpy(&v53[LOBYTE(dest[4])], v25, BYTE1(dest[12]));
    src = HIBYTE(*(_WORD *)(v45 + 35)) | (*(_WORD *)(v45 + 35) << 8);
    memcpy(&v53[BYTE1(dest[4])], &src, BYTE2(dest[12]));
    v50 = HIBYTE(*(_WORD *)(v45 + 37)) | (*(_WORD *)(v45 + 37) << 8);
    memcpy(&v53[BYTE2(dest[4])], &v50, HIBYTE(dest[12]));
    v51 = (unsigned int)(float)(*(float *)(v45 + 39) * 100.0);
    memcpy(&v53[HIBYTE(dest[4])], &v51, LOBYTE(dest[13]));
    v26 = BYTE1(dest[5]);
    v27 = BYTE2(dest[5]);
    v53[LOBYTE(dest[5])] = *(_BYTE *)(v45 + 43);
    v28 = HIBYTE(dest[5]);
    v53[v26] = *(_BYTE *)(v45 + 44);
    v53[v27] = *(_BYTE *)(v45 + 45);
    v53[v28] = *(_BYTE *)(v45 + 46);
    v29 = *(const void **)(v45 + 47);
    if ( !v29 )
    {
    ...
    memcpy(&v53[LOBYTE(dest[6])], v29, BYTE1(dest[14]));
    v30 = HIBYTE(dest[6]);
    v53[BYTE1(dest[6])] = *(_BYTE *)(v45 + 51);
  ...
  if ( v34 )
  {
    ...
    while ( 1 )
    {
      eeprom_write(a1, 0, (unsigned __int8 *)v54, v9[1]);
      memset(s, 0, sizeof(s));
      ...
      else
      {
        ...
        if ( sub_C4024(v53, (int)v9) && sub_C2F68(v53, v9) )
        {
          *(_BYTE *)(v44 + 64) = 1;
          return v8;
        }
        ...
        *(_BYTE *)(v44 + 64) = v46;
        ...
        v37 = g_zc;
        v38 = 958;
        LOWORD(v39) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildr"
                                        "oot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/eeprom/bitmain_eeprom.c";
      }
      HIWORD(v39) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tm"
                                  "p/release/build/godminer-origin_godminer-new/backend/device/hal/eeprom/bitmain_eeprom.c" >> 16;
      zlog(v37, v39, 173, "eeprom_rewrite_one_chain", 24, v38, 100, v57);
LABEL_43:
      if ( !--v36 )
        return v8;
    }
