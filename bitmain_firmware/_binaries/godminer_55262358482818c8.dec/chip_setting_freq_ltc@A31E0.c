  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      if ( v10 - 800 <= 0x640 )
      {
        ...
        v13 = sub_144470(25 * (v10 / 0x19), v7);
        v11 = (float)sub_144470(v13, v8);
        goto LABEL_12;
      }
...
LABEL_12:
  V_LOCK();
  LOWORD(v14) = -24664;
  HIWORD(v14) = (unsigned int)" expected value %04x" >> 16;
  logfmt_raw(v22, 0x1000u, 0, v14, v11, v3, v12, v19, v20, v21);
  V_UNLOCK();
  LOWORD(v15) = 368;
  HIWORD(v15) = (unsigned int)"ting_working_mode_ltc" >> 16;
  zlog(g_zc, v15, 179, "chip_setting_freq_ltc", 21, 135, 60, v22);
  v16 = (*(int (__fastcall **)(int, int *))(a1 + 264))(a1, &v18);
  usleep(0x2710u);
  return v16;
}
