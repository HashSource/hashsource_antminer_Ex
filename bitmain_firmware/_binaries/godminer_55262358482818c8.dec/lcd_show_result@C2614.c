int __fastcall lcd_show_result(char a1, int a2, unsigned int a3)
{
  ...
  {
    LOWORD(v11) = 19080;
    HIWORD(v11) = (unsigned int)"n not registered before" >> 16;
    v12 = *v11;
    v13 = v11[1];
    v14 = v11[2];
    v15 = v11[3];
    ...
    V_UNLOCK();
    LOWORD(v17) = 21676;
    HIWORD(v17) = (unsigned int)"ve %d from flicker list" >> 16;
    zlog(g_zc, v17, 173, "lcd_show_result", 15, 490, 100, v21);
  }
  else
  {
    v6 = dword_1934B4;
    if ( dword_1934B4 < 0 )
    {
      dword_1934B4 = lcd_init((int)lcd_path);
    ...
    {
      LOWORD(v9) = 22084;
      HIWORD(v9) = (unsigned int)" not registered before" >> 16;
      snprintf((char *)s, 0x800u, v9, lcd_path);
      V_LOCK();
      logfmt_raw(v21, 0x1000u, 0, s);
      V_UNLOCK();
      LOWORD(v10) = 21676;
      HIWORD(v10) = (unsigned int)"ve %d from flicker list" >> 16;
      v7 = -1;
      zlog(g_zc, v10, 173, "lcd_show_result", 15, 506, 100, v21);
    }
    else
    {
