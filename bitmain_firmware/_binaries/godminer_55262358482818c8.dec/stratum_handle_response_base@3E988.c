int __fastcall stratum_handle_response_base(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    zlog(g_zc, v26, 155, "stratum_handle_response_base", 28, 321, 40, v31);
    return 0;
  }
...
LABEL_32:
    V_LOCK();
    LOWORD(v19) = -26648;
    HIWORD(v19) = (unsigned int)"on failed, req_id=%d" >> 16;
    logfmt_raw(v31, 0x1000u, 0, v19, "stratum_handle_response_base");
    V_UNLOCK();
    LOWORD(v20) = -27588;
    HIWORD(v20) = (unsigned int)"et: invalid parameters" >> 16;
    v16 = 0;
    zlog(g_zc, v20, 155, "stratum_handle_response_base", 28, 345, 20, v31);
    goto LABEL_33;
  }
LABEL_18:
  if ( *v12 == 7 )
