int __fastcall send_line(int a1, char *s)
{
  ...
  if ( a1 == -1 )
  {
    V_LOCK();
    LOWORD(v13) = -27288;
    HIWORD(v13) = (unsigned int)"send_line" >> 16;
    logfmt_raw((char *)&writefds, 0x1000u, 0, v13);
    V_UNLOCK();
    LOWORD(v14) = -27312;
    LOWORD(v15) = -27272;
    HIWORD(v14) = (unsigned int)"" >> 16;
    HIWORD(v15) = (unsigned int)"et_full" >> 16;
    zlog(g_zc, v15, 154, v14, 9, 12, 20, &writefds);
    return 0;
  }
  else
  {
