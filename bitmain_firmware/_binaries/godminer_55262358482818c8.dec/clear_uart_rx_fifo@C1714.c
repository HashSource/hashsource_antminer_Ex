int __fastcall clear_uart_rx_fifo(int a1)
{
  ...
  v2 = (pthread_mutex_t *)((char *)&unk_1B3468 + 24 * a1);
  pthread_mutex_lock(v2);
  v3 = sub_C094C((unsigned __int8)a1);
  v4 = v3;
  if ( !v3 )
  ...
  if ( v5 )
  {
    ...
    if ( v4 != v7 )
    {
      ...
      zlog(g_zc, v9, 175, "clear_uart_rx_fifo", 18, 672, 100, v14);
    }
    free(v6);
    usleep(0x2710u);
    return pthread_mutex_unlock(v2);
  ...
  LOWORD(v11) = 21372;
  HIWORD(v11) = (unsigned int)"set config type = %d" >> 16;
  snprintf(s, 0x800u, v11, "clear_uart_rx_fifo", a1);
  V_LOCK();
  logfmt_raw(v14, 0x1000u, 0, s);
  V_UNLOCK();
  LOWORD(v12) = 20892;
  HIWORD(v12) = (unsigned int)" %d is not supported!!!" >> 16;
  zlog(g_zc, v12, 175, "clear_uart_rx_fifo", 18, 662, 100, v14);
