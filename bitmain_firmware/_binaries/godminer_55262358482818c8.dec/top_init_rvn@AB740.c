int __fastcall top_init_rvn(int a1)
{
  ...
  zlog(g_zc, v4, 174, "top_init_rvn", 12, 2283, 60, v16);
  if ( !sub_A51DC((int *)a1) )
  {
    ...
    v7 = *(_DWORD *)(a1 + 488);
    *(_DWORD *)(a1 + 428) = 1;
    (*(void (__fastcall **)(int, int))(a1 + 256))(a1, v7);
    sub_A51DC((int *)a1);
    setup_clk_rvn(a1);
    set_baud_rvn(a1, (int)"l");
    sub_A4314(a1, 5250832);
    usleep(0x2710u);
  ...
  V_INT((int)v14, v8, *(int *)(a1 + 248));
  LOWORD(v9) = -17056;
  HIWORD(v9) = (unsigned int)"%02x cnt %08x" >> 16;
  ...
  zlog(g_zc, v10, 174, "top_init_rvn", 12, 2287, 100, v16);
  return 12;
}
