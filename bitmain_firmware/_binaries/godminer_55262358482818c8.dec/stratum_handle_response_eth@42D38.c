int __fastcall stratum_handle_response_eth(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    V_UNLOCK();
    LOWORD(v24) = -24164;
    HIWORD(v24) = (unsigned int)"without JSON-RPC 2.0" >> 16;
    zlog(g_zc, v24, 167, "stratum_handle_response_eth", 27, 1118, 40, v29);
    return 0;
  }
...
LABEL_9:
  if ( !v12 || *v12 == 7 )
  {
    ...
    v14 = 0;
    zlog(g_zc, v26, 167, "stratum_handle_response_eth", 27, 1147, 40, v29);
  }
  else
  {
    if ( v8 )
