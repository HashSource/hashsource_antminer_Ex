void __fastcall __noreturn check_working_freq(int a1)
{
  ...
  LOWORD(v3) = -14760;
  LOWORD(v4) = -14932;
  HIWORD(v2) = (unsigned int)"q %.2f cur freq %.2f" >> 16;
  HIWORD(v3) = (unsigned int)"achine_runtime_base.c" >> 16;
      ...
      if ( v24 > 0 )
      {
        ...
        for ( i = 0; i < v24; ++i )
        {
          ...
          if ( *(int *)(v10 + 336) > 0 )
          {
            ...
            do
            {
              pthread_mutex_lock((pthread_mutex_t *)(*(_DWORD *)(v9 + 528) + v11 + 20));
              v13 = *(_DWORD *)(*v7 + 528) + v11;
              v14 = *(float *)(v13 + 4);
              v15 = *(float *)(v13 + 12);
              *(float *)(v13 + 8) = v6;
              ...
              if ( v16 != v15 )
              {
                if ( !v12 )
                {
                  ...
                  logfmt_raw(
                    ...
                    0,
                    v20,
                    *(float *)(*(_DWORD *)(*v7 + 528) + v11 + 4),
                    *(float *)(*(_DWORD *)(*v7 + 528) + v11 + 8),
                    *(float *)(*(_DWORD *)(*v7 + 528) + v11 + 12));
                  V_UNLOCK();
                  zlog(g_zc, v19, 169, "check_working_freq", 18, 400, 20, v27);
                  if ( v16 < v15 && v6 < -1.0 )
                  {
                    V_LOCK();
                    LOWORD(v17) = 23936;
                    HIWORD(v17) = (unsigned int)"p" >> 16;
                    V_INT((int)v25, v17, *(int *)(*v7 + 248));
                    logfmt_raw(
                      v27,
                      0x1000u,
                      0,
                      ...
                      v6);
                    V_UNLOCK();
                    zlog(g_zc, v19, 169, "check_working_freq", 18, 403, 80, v27);
                  }
                }
                v1 = v16;
                (*(void (**)(void))(*v7 + 192))();
