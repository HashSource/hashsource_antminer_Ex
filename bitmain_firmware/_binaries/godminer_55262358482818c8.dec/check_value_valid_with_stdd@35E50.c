bool __fastcall check_value_valid_with_stdd(__int64 a1, int a2)
{
  ...
  v9 = (double)a2;
  LOWORD(v10) = -29800;
  HIWORD(v10) = (unsigned int)" passed to valid_ascii" >> 16;
  logfmt_raw(v13, 0x1000u, 0, v10, v8, v2, v8 - v2, v2 + v8, v9);
  V_UNLOCK();
  LOWORD(v11) = -30416;
  HIWORD(v11) = (unsigned int)"'%s' is not a number" >> 16;
  zlog(g_zc, v11, 137, "check_value_valid_with_stdd", 27, 442, 20, v13);
