int __fastcall work_2_packet_dcr(int a1, _DWORD *a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *v8 = (v22 + 1) & 0x7F;
  ...
  if ( !memcmp(&last_header_dcr, v10, 0xB4u) )
  {
    V_LOCK();
    LOWORD(v29) = -26652;
    HIWORD(v29) = (unsigned int)"mask reg %02x tm %02x" >> 16;
    logfmt_raw((char *)v32, 0x1000u, 0, v29);
    V_UNLOCK();
    LOWORD(v30) = -21212;
    HIWORD(v30) = (unsigned int)"misc_reinit_dcr" >> 16;
    zlog(g_zc, v30, 174, "work_2_packet_dcr", 17, 120, 80, v32);
  }
  ...
  *a4 = 186;
  ...
  V_LOCK();
  LOWORD(v25) = -26400;
  HIWORD(v25) = (unsigned int)"nt %d" >> 16;
  logfmt_raw((char *)v32, 0x1000u, 0, v25, "ChipSetting_bridge_reset_DCR_1727", 68);
  V_UNLOCK();
  LOWORD(v26) = -26872;
  HIWORD(v26) = (unsigned int)"stdiv1:%d, postdiv2:%d" >> 16;
  zlog(g_zc, v26, 153, "ChipSetting_bridge_reset_DCR_1727", 33, 110, 20, v32);
  v32[1] = 0;
  v33 = 0;
  v34 = 0;
