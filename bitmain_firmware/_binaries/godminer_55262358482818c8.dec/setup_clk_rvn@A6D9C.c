int __fastcall setup_clk_rvn(int a1)
{
  ...
  logfmt_raw((char *)&v9, 0x1000u, 0, v8, v7[0], v7[1], v7[2], v7[3], v7[4], v7[5], v7[6], v8, v4, v2 + 1204);
  V_UNLOCK();
  LOWORD(v5) = 5292;
  HIWORD(v5) = (unsigned int)&unk_171494 >> 16;
  zlog(g_zc, v5, 174, v2 + 1220, 13, 333, 60, &v9);
  v11 = 524289;
  v12 = 0;
  v10 = 0;
  v9 = 1076363553;
  (*(void (__fastcall **)(int, int *))(a1 + 264))(a1, &v9);
  usleep(0x2710u);
  v11 = 786433;
  v12 = 0;
  v10 = 0;
