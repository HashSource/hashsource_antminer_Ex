int __fastcall sub_59094(int a1, int *a2, int a3)
{
  size_t *v3; // r7
  int *v6; // r8
  int v7; // r3
  ...
  {
    v6 = a2 + 116;
    if ( a3 && memcmp(&unk_195A00, a2 + 116, 0x116u) )
    {
      qword_195B20 = 0;
      memcpy(&unk_195A00, v6, 0x11Eu);
    }
    ...
    if ( v7 && v7 == *v3 )
    {
      ...
      zlog(
        ...
        "rigin_godminer-new/dhash_content/kda/kda_2110/kda_2110_content.c",
        176,
        ...
        20,
        v16);
      memcpy(v3 + 1, &qword_195B20, *v3);
      if ( (unsigned __int64)qword_195B20 > 0xFF )
        qword_195B20 = 0;
      else
        ++qword_195B20;
    }
