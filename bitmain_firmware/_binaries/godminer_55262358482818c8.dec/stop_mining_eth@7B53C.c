int __fastcall stop_mining_eth(int a1)
{
  ...
  logfmt_raw((char *)&v9, 0x1000u, 0, v3, v1 + 624);
  V_UNLOCK();
  LOWORD(v4) = -17724;
  HIWORD(v4) = (unsigned int)&unk_16BAAC >> 16;
  zlog(g_zc, v4, 174, v1 + 640, 15, 1728, 60, &v9);
  ...
  *(_BYTE *)(a1 + 254) = 0;
  ...
  v12 = 0;
  v9 = 274347265;
  (*(void (__fastcall **)(int, unsigned int *))(a1 + 264))(a1, &v9);
  ...
  v12 = 0;
  v10 = 0;
  v7 = *(void (__fastcall **)(int, unsigned int *))(a1 + 264);
  v9 = 1;
  v7(a1, &v9);
  usleep((__useconds_t)&stru_186A0);
  v11 = 5636097;
