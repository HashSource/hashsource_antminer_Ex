int __fastcall check_nonce_dcr(int a1, int a2)
{
  ...
  if ( v14 <= 0x26 )
  {
    V_LOCK();
    LOWORD(v31) = -21036;
    HIWORD(v31) = (unsigned int)"727/backend_dcr_1727.c" >> 16;
    logfmt_raw(v36, 0x1000u, 0, v31, v15, *(unsigned __int8 *)(a2 + 64), 39);
    V_UNLOCK();
    LOWORD(v32) = -21212;
    HIWORD(v32) = (unsigned int)"misc_reinit_dcr" >> 16;
    zlog(g_zc, v32, 174, "check_nonce_dcr", 15, 573, 20, v36);
    return 2;
  }
  else
  {
...
LABEL_11:
        V_LOCK();
        LOWORD(v27) = -25192;
        HIWORD(v27) = (unsigned int)"%d) expected diff %d" >> 16;
        logfmt_raw(v36, 0x1000u, 0, v27, *(unsigned __int8 *)(a2 + 64), v33);
        V_UNLOCK();
        LOWORD(v28) = -21212;
        HIWORD(v28) = (unsigned int)"misc_reinit_dcr" >> 16;
        zlog(g_zc, v28, 174, "check_nonce_dcr", 15, 591, 20, v36);
        return 1;
      }
    }
    else if ( v33 > v14 )
    {
      V_LOCK();
      LOWORD(v29) = -25236;
      HIWORD(v29) = (unsigned int)"ICKET_MASK_CKB_2042 %d" >> 16;
      logfmt_raw(v36, 0x1000u, 0, v29, v15, *(unsigned __int8 *)(a2 + 64), v33);
      V_UNLOCK();
      LOWORD(v30) = -21212;
      HIWORD(v30) = (unsigned int)"misc_reinit_dcr" >> 16;
      zlog(g_zc, v30, 174, "check_nonce_dcr", 15, 578, 40, v36);
      return 3;
    }
    LOWORD(v17) = -20972;
    LOWORD(v18) = -21212;
    ...
    do
    {
      ...
      v21 = v22;
      HIWORD(v17) = (unsigned int)"ICKET_MASK_DCR_1727 %d" >> 16;
      v23 = *--v20;
      logfmt_raw(v36, 0x1000u, 0, v17, v21, v23);
      V_UNLOCK();
      HIWORD(v18) = (unsigned int)"misc_reinit_dcr" >> 16;
      zlog(g_zc, v18, 174, "fulltest_dcr", 12, 488, 20, v36);
