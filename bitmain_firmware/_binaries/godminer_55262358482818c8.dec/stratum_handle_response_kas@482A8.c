int __fastcall stratum_handle_response_kas(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    V_UNLOCK();
    LOWORD(v24) = -21276;
    HIWORD(v24) = (unsigned int)"cribe_kas" >> 16;
    zlog(g_zc, v24, 167, "stratum_handle_response_kas", 27, 294, 40, v31);
    return 0;
  }
...
LABEL_28:
    ...
    V_UNLOCK();
    LOWORD(v18) = -21276;
    HIWORD(v18) = (unsigned int)"cribe_kas" >> 16;
    v16 = 0;
    zlog(g_zc, v18, 167, "stratum_handle_response_kas", 27, 326, 20, v31);
    goto LABEL_29;
  }
LABEL_18:
  if ( *v12 == 7 )
