int __fastcall judge_load_config(char *a1)
{
  ...
  V_LOCK();
  LOWORD(v2) = 32172;
  HIWORD(v2) = (unsigned int)"l thread create failed!" >> 16;
  logfmt_raw(v64, 0x1000u, 0, v2, "judge_load_config");
  V_UNLOCK();
  LOWORD(v3) = 31144;
  HIWORD(v3) = (unsigned int)"port %d reject reasons" >> 16;
  zlog(g_zc, v3, 137, "judge_load_config", 17, 657, 20, v64);
  if ( a1 )
  {
...
LABEL_5:
      LOWORD(v12) = 31144;
      HIWORD(v12) = (unsigned int)"port %d reject reasons" >> 16;
      zlog(v9, v12, 137, "judge_load_config", 17, v11, v10, v64);
      return v8;
    }
    V_LOCK();
    LOWORD(v14) = 32240;
    HIWORD(v14) = (unsigned int)"of file '%s' failed %s" >> 16;
    logfmt_raw(v64, 0x1000u, 0, v14, "judge_load_config");
    V_UNLOCK();
    LOWORD(v15) = 31144;
    HIWORD(v15) = (unsigned int)"port %d reject reasons" >> 16;
    zlog(g_zc, v15, 137, "judge_load_config", 17, 675, 20, v64);
    LOWORD(v16) = 31844;
    HIWORD(v16) = (unsigned int)"= %d, need to remove %d pools" >> 16;
    ...
    LOWORD(v35) = -30580;
    LOWORD(v36) = -32140;
    HIWORD(v34) = (unsigned int)"tv_end_sys=%ld" >> 16;
    HIWORD(v35) = (unsigned int)"e failed" >> 16;
    HIWORD(v36) = (unsigned int)"o pool %d, empty url or user" >> 16;
    dword_194CAC = (int)v33;
    v59 = v34;
    format = v35;
    v60 = v36;
    v61 = v5;
    while ( (unsigned int)json_array_size(v18) > v6 )
    {
      ...
      LOWORD(v45) = 29240;
      HIWORD(v45) = (unsigned int)"remote" >> 16;
      ...
      V_LOCK();
      LOWORD(v48) = 32268;
      HIWORD(v48) = (unsigned int)"after json_load_file" >> 16;
    ...
    v5 = v61;
    v49 = (const char *)&unk_194CB0;
    v50 = total_pools;
    if ( total_pools == dword_194CAC )
    {
      if ( total_pools <= 0 )
      {
LABEL_8:
...
LABEL_9:
    LOWORD(v19) = 29348;
    HIWORD(v19) = (unsigned int)"pwm" >> 16;
    json_object_get(v5, v19);
    LOWORD(v20) = 29292;
    HIWORD(v20) = (unsigned int)"freq" >> 16;
    ...
    LOWORD(v22) = 29312;
    HIWORD(v22) = (unsigned int)"age" >> 16;
    ...
    V_LOCK();
    LOWORD(v27) = 32280;
    HIWORD(v27) = (unsigned int)"oad_file" >> 16;
  ...
  V_LOCK();
  LOWORD(v28) = 32184;
  HIWORD(v28) = (unsigned int)"ate failed!" >> 16;
  logfmt_raw(v64, 0x1000u, 0, v28, "judge_load_config");
  V_UNLOCK();
  LOWORD(v29) = 31144;
  HIWORD(v29) = (unsigned int)"port %d reject reasons" >> 16;
  zlog(g_zc, v29, 137, "judge_load_config", 17, 666, 100, v64);
  return 0;
}
