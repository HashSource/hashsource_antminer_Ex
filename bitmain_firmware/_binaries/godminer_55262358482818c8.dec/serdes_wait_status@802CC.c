int __fastcall serdes_wait_status(int a1, int a2, int a3, int a4, int a5)
{
  ...
  sub_7FA3C(a1, a3, 78, a4 | 0x310000);
  v9 = sub_7FA90(a1, a3, 79, v8);
  if ( !v9 )
  {
    free(v8);
    return 22;
  ...
  if ( v9 <= 0 )
    goto LABEL_12;
  LOWORD(v10) = -14524;
  HIWORD(v10) = (unsigned int)"backend_eth_phy_set.c" >> 16;
  v17 = &v8[12 * v9];
  v11 = v8;
  v12 = 0;
  do
...
LABEL_9:
    ...
    v11 += 12;
    zlog(v13, v15, 177, "serdes_wait_status", 18, v14, 60, v23);
  }
  while ( v11 != v17 );
LABEL_10:
  if ( v12 )
