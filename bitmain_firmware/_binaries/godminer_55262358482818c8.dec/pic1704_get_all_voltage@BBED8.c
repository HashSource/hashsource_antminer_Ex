int __fastcall pic1704_get_all_voltage(char a1, _DWORD *a2, _DWORD *a3, _DWORD *a4)
{
  ...
  *(_DWORD *)((char *)&v15[1] + 3) = 0;
  result = sub_BB11C(v13, 0, (int)&v12, (unsigned __int8 *)v15);
  if ( result )
  {
    LOWORD(v8) = 17064;
    HIWORD(v8) = (unsigned int)" response: vol = %d." >> 16;
    ...
    *a4 = v10;
    ...
    V_UNLOCK();
    LOWORD(v11) = 16368;
    HIWORD(v11) = (unsigned int)"close_pic" >> 16;
    zlog(g_zc, v11, 168, "pic1704_get_all_voltage", 23, 514, 20, v17);
    return 1;
  }
  return result;
}
