int __fastcall sub_9FF34(int a1)
{
  int v2; // r2
  int v3; // r3
  int v4; // r7
  ...
  v18 = 16711681;
  v17[0] = 1;
  if ( (*(int (__fastcall **)(int, _DWORD *))(a1 + 268))(a1, v17) < 0 )
  {
    V_LOCK();
    v14 = -1;
  ...
  else
  {
    ...
    v4 = v3 * v2;
    LOBYTE(v19) = 0;
    ptr = (int *)calloc(12 * v3 * v2, 1u);
    (*(void (__fastcall **)(int, _DWORD *, int, int *, int *, int, int, _DWORD))(a1 + 300))(
      a1,
      v17,
      v4,
      ptr,
