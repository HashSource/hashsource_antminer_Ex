int __fastcall stratum_authorize_kas(int a1, int *a2, void *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v8 )
    {
      V_LOCK();
      LOWORD(v34) = -26916;
      HIWORD(v34) = (unsigned int)"subscribe send failed" >> 16;
      logfmt_raw(v42, 0x1000u, 0, v34);
      V_UNLOCK();
      LOWORD(v35) = -21276;
      HIWORD(v35) = (unsigned int)"cribe_kas" >> 16;
      zlog(g_zc, v35, 167, "stratum_authorize_kas", 21, 139, 100, v42);
LABEL_2:
      free(v16);
      if ( !v6 )
        goto LABEL_10;
...
LABEL_10:
  ...
  if ( !v6 )
  {
    V_LOCK();
    LOWORD(v28) = -27332;
    HIWORD(v28) = (unsigned int)"x %08x %08x %08x %08x " >> 16;
    logfmt_raw(v42, 0x1000u, 0, v28, *(_DWORD *)v40, v41);
    V_UNLOCK();
    LOWORD(v29) = -21276;
    HIWORD(v29) = (unsigned int)"cribe_kas" >> 16;
    zlog(g_zc, v29, 167, "stratum_authorize_kas", 21, 153, 100, v42);
    free(v16);
    goto LABEL_10;
  }
  LOWORD(v18) = 28304;
  ...
  LOWORD(v21) = 27772;
  v37 = v20;
  HIWORD(v21) = (unsigned int)"od-miner.c" >> 16;
  ...
  V_UNLOCK();
  LOWORD(v26) = -21276;
  HIWORD(v26) = (unsigned int)"cribe_kas" >> 16;
  zlog(g_zc, v26, 167, "stratum_authorize_kas", 21, 163, 80, v42);
  if ( !v3
    || (v16 = json_dumps(v36, 3),
        ...
        V_UNLOCK(),
        LOWORD(v30) = -21276,
        HIWORD(v30) = (unsigned int)"cribe_kas" >> 16,
        zlog(g_zc, v30, 167, "stratum_authorize_kas", 21, 170, 100, v42),
        v16) )
  {
    v8 = 0;
LABEL_22:
