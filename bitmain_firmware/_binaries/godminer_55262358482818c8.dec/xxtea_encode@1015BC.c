unsigned int __fastcall xxtea_encode(unsigned int *a1, unsigned int a2, int a3)
{
  ...
  if ( a2 <= 1 )
  {
    V_LOCK();
    LOWORD(v13) = -26516;
    HIWORD(v13) = (unsigned int)"data_enc" >> 16;
    logfmt_raw(v16, 0x1000u, 0, v13);
    V_UNLOCK();
    LOWORD(v14) = -26572;
    LOWORD(v15) = -26476;
    HIWORD(v14) = (unsigned int)"l/thread_safe_queue.c" >> 16;
    HIWORD(v15) = (unsigned int)"put data length <= 1" >> 16;
    return zlog(g_zc, v15, 153, v14, 12, 24, 100, v16);
  }
  else
  {
    v4 = &a1[a2 - 1];
