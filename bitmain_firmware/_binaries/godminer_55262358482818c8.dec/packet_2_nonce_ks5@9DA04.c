int __fastcall packet_2_nonce_ks5(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  ...
  {
    v28 = &dword_1AB008[*(_DWORD *)(a1 + 248)];
    v29 = v28[1];
    v28[1] = v29 + 1;
    if ( v29 <= 9 )
    {
      ...
      V_UNLOCK();
      LOWORD(v32) = -2320;
      HIWORD(v32) = (unsigned int)&unk_16F6D8 >> 16;
      zlog(g_zc, v32, 174, "packet_2_nonce_ks5", 18, 275, 40, s);
    }
    return 11;
  }
  else
      ...
      if ( v18 != -1 )
      {
        ...
        *a4 = 1;
        ...
        if ( v33 <= 0 )
        {
          ...
          v36 = 0;
LABEL_33:
          *(_QWORD *)&dword_1AB008[v44 + 20] = v36;
          return 0;
        }
        v34 = *(_DWORD *)(a1 + 456);
        v35 = 0;
        ...
        v43 = v37;
        v44 = 2 * v60;
        v45 = *(_QWORD *)&dword_1AB008[2 * v60 + 20];
        if ( v45 >= v36 )
        {
          LOWORD(v46) = -20264;
        }
        ...
        {
          LOWORD(v46) = (unsigned __int16)&unk_1AB0D8;
          if ( v36 - v45 <= 0x63 )
          {
            v47 = 0;
            HIWORD(v46) = (unsigned int)&unk_1AB0D8 >> 16;
            v48 = s;
            do
            {
              v50 = *(_QWORD *)v48;
...
LABEL_31:
    ...
    LOWORD(v55) = -2320;
    HIWORD(v55) = (unsigned int)&unk_16F6D8 >> 16;
    zlog(g_zc, v55, 174, "packet_2_nonce_ks5", 18, v54, 20, s);
    return 12;
  }
}
