int __fastcall pic1704_get_an_voltage2(char a1, int a2)
{
  ...
  {
    LOWORD(v6) = 17128;
    HIWORD(v6) = (unsigned int)", vol1 = %d, vol2 = %d." >> 16;
    v7 = *v6;
    v8 = v6[1];
    v9 = v6[2];
    v10 = v6[3];
    ...
    zlog(g_zc, v14, 168, "pic1704_get_an_voltage2", 23, 445, 20, v37);
    snprintf(
      (char *)&s,
      0x800u,
      "an0 = %f, an2 %f, an6 %f.",
    ...
    V_UNLOCK();
    LOWORD(v15) = 16368;
    HIWORD(v15) = (unsigned int)"close_pic" >> 16;
    zlog(g_zc, v15, 168, "pic1704_get_an_voltage2", 23, 446, 20, v37);
    if ( a2 && ((v16 = (double)v28 * 3.3 * 0.0009765625, v2 > v16) || v3 < v16) )
    {
      LOWORD(v17) = 17188;
      HIWORD(v17) = (unsigned int)"= %f, an2 %f, an6 %f." >> 16;
      v18 = *v17;
      v19 = v17[1];
      v20 = v17[2];
      v21 = v17[3];
      ...
      return zlog(g_zc, v25, 168, "pic1704_get_an_voltage2", 23, 452, 20, v37);
    }
    else
    {
      return sub_BAFE8(v27);
    }
  }
  return result;
}
