int __fastcall get_all_chip_temp_kas(int a1)
{
  ...
  v38[3] = 0;
  v38[2] = 7340033;
  (*(void (__fastcall **)(int, _DWORD *, int, char *, _DWORD *))(a1 + 284))(a1, v38, v2, v3, v37);
  usleep((__useconds_t)&stru_186A0);
  (*(void (__fastcall **)(int, _DWORD *, int, char *, _DWORD *, int, int, _DWORD))(a1 + 284))(
    a1,
    v38,
    v2,
    v3,
  ...
  if ( v2 <= 0 )
  {
    LOWORD(v34) = -5584;
    LOWORD(v35) = -5580;
    HIWORD(v34) = (unsigned int)"  XXX" >> 16;
    HIWORD(v35) = (unsigned int)"X" >> 16;
    ...
    do
    {
      while ( 1 )
      {
        ...
        if ( !v23 )
          break;
        v22 = *v20++;
        HIWORD(v17) = (unsigned int)"pond wrong work id ,err" >> 16;
        v21 += snprintf(v25, v24, v17, (char *)&v40[184] + v21, v22);
        if ( v19 == v18 )
          goto LABEL_13;
      }
      HIWORD(v16) = (unsigned int)"ng work id ,err" >> 16;
      v21 += 5;
...
LABEL_13:
    LOWORD(v26) = -5584;
    LOWORD(v27) = -5580;
    HIWORD(v26) = (unsigned int)"  XXX" >> 16;
    ...
    do
    {
      ...
      {
        v31 = *v15++;
        HIWORD(v29) = (unsigned int)"id ,err" >> 16;
        fprintf(v30, v29, v31);
        if ( v19 == v14 )
          goto LABEL_17;
      }
      HIWORD(v28) = (unsigned int)"%5.2f" >> 16;
