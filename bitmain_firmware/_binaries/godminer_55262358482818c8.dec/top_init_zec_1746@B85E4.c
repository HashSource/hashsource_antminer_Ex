int __fastcall top_init_zec_1746(int a1)
{
  ...
  V_INT((int)v11, v2, *(int *)(a1 + 248));
  LOWORD(v3) = 15108;
  HIWORD(v3) = (unsigned int)"ed after retry %d times" >> 16;
  logfmt_raw(v13, 0x1000u, 0, v12, v11[0], v11[1], v11[2], v11[3], v11[4], v11[5], v11[6], v12, v3);
  V_UNLOCK();
  LOWORD(v4) = 14736;
  HIWORD(v4) = (unsigned int)"q: %d, reg_value: %08x" >> 16;
  zlog(g_zc, v4, 174, "top_init_zec_1746", 17, 644, 40, v13);
  v5 = *(_DWORD *)(a1 + 336);
  v6 = *(_DWORD *)(a1 + 488);
  ...
  *(_DWORD *)(a1 + 428) = v7;
  (*(void (__fastcall **)(int, int, int))(a1 + 256))(a1, v6, v5);
  sub_B7C68(a1, 1);
  return 0;
}
