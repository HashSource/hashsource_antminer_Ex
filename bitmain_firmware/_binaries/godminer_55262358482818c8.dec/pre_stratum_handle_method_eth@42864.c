    ...
    if ( !v12 && !strcasecmp(v11, "2.0") )
    {
      ...
      *(_BYTE *)(a2 + 1656) = 1;
      ...
      if ( !v22 )
      {
        ...
        V_UNLOCK();
        LOWORD(v46) = -24164;
        HIWORD(v46) = (unsigned int)"without JSON-RPC 2.0" >> 16;
        zlog(g_zc, v46, 167, "pre_stratum_handle_method_eth", 29, 1092, 80, v54);
        goto LABEL_31;
      }
    }
    else
            ...
            if ( !v22 )
            {
              ...
              *(_DWORD *)(a2 + 1588) = v22;
              if ( !v22 )
              {
                LOWORD(v50) = -26160;
                LOWORD(v51) = 28808;
                HIWORD(v50) = (unsigned int)"Failed to alloc xnonce1" >> 16;
...
LABEL_35:
      ...
      if ( !v34 || *v34 == 7 || json_integer_value((int)v34) != 2 )
      {
        ...
        V_UNLOCK();
        LOWORD(v36) = -24164;
        HIWORD(v36) = (unsigned int)"without JSON-RPC 2.0" >> 16;
        v22 = 0;
        zlog(g_zc, v36, 167, "pre_stratum_handle_method_eth", 29, 1084, 40, v54);
        goto LABEL_12;
      }
    }
    v22 = 1;
LABEL_31:
  ...
  V_UNLOCK();
  LOWORD(v28) = -24164;
  HIWORD(v28) = (unsigned int)"without JSON-RPC 2.0" >> 16;
  zlog(g_zc, v28, 167, "pre_stratum_handle_method_eth", 29, 995, 100, v54);
  return 0;
}
