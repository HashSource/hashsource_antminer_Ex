...
LABEL_18:
    LOWORD(v15) = 32188;
    HIWORD(v15) = (unsigned int)"failed!" >> 16;
    v16 = *v15;
    v17 = v15[1];
    v18 = v15[2];
    v27 = v16;
    ...
    V_UNLOCK();
    LOWORD(v19) = 32204;
    HIWORD(v19) = (unsigned int)"lcd_clear" >> 16;
    zlog(g_zc, v19, 174, "lcd_write", 9, 69, 80, v33);
    return -3;
  }
  else
  {
    v9 = pthread_mutex_lock(&stru_1B4054);
    if ( v9 )
    {
      LOWORD(v20) = 32400;
      HIWORD(v20) = (unsigned int)".c" >> 16;
      v21 = *v20;
      v22 = v20[1];
      v23 = v20[2];
      v24 = v20[3];
      ...
      V_UNLOCK();
      LOWORD(v26) = 32204;
      HIWORD(v26) = (unsigned int)"lcd_clear" >> 16;
      zlog(g_zc, v26, 174, "lcd_write", 9, 75, 100, v33);
      return -4;
    }
    else
    {
      do
      {
        ...
        v9 += v11;
        memcpy((char *)&unk_1B406C + 16 * v4, v12, v11);
        v5 -= v11;
        v4 = (char)v10;
      }
      while ( v10 <= 3u && v5 != 0 );
      write(dword_1B4050, &unk_1B406C, 0x40u);
