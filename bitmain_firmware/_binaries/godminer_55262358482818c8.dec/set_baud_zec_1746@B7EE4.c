...
LABEL_9:
  V_LOCK();
  LOWORD(v5) = 548;
  HIWORD(v5) = (unsigned int)"chip_setting_ltc_1489.c" >> 16;
  logfmt_raw(v14, 0x1000u, 0, v5, v4, a2);
  V_UNLOCK();
  LOWORD(v6) = 14736;
  HIWORD(v6) = (unsigned int)"q: %d, reg_value: %08x" >> 16;
  zlog(g_zc, v6, 174, "set_baud_zec_1746", 17, 776, 60, v14);
  v11[2] = 1835009;
  v11[0] = v4;
  v11[3] = 0;
  v11[1] = 0;
  ...
  zlog(g_zc, v8, 153, "ChipSetting_misc_ctrl_ZEC_1746", 30, 229, 40, v14);
  v9 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 264))(a1, v11);
  usleep(0x2710u);
  if ( v9 )
    return 47;
  else
