...
LABEL_64:
  ...
  LOWORD(v10) = 31712;
  v121 = 0;
  HIWORD(v10) = (unsigned int)" hashrate lifetime: %f" >> 16;
  v119 = 0;
  LOWORD(v11) = 31752;
  v120 = 0;
  v132 = 0;
  ...
  v114 = &v105;
  v116 = v10;
  HIWORD(v11) = (unsigned int)"e" >> 16;
  HIWORD(v12) = (unsigned int)"e failed" >> 16;
  HIWORD(v13) = (unsigned int)"p" >> 16;
  HIWORD(v14) = (unsigned int)"e, local:%d, remote:%d" >> 16;
  HIWORD(v15) = (unsigned int)"2x-%02x-%02x-%02x" >> 16;
  v113 = &v104;
  ...
  do
  {
    ...
    logfmt_raw(
      ...
      *v9,
      v9[1]);
    V_UNLOCK();
    zlog(*v112, v110, 196, "check_temperature", 17, 36, 20, v188);
    v60 = *v9;
    if ( *v9 == -64 )
    {
      v62 = 0;
    ...
    {
      LOWORD(v66) = 31992;
      HIWORD(v66) = (unsigned int)"update_temperature.c" >> 16;
...
LABEL_5:
    ...
    LOWORD(v67) = 32000;
    HIWORD(v67) = (unsigned int)"emperature.c" >> 16;
...
LABEL_6:
    ...
    *v25 = v183[4];
    ...
    V_UNLOCK();
    LOWORD(v38) = 31712;
    HIWORD(v38) = (unsigned int)" hashrate lifetime: %f" >> 16;
    zlog(*v112, v110, 196, v38, 17, 92, 20, v188);
    V_LOCK();
    V_INT((int)v165, s, *(int *)(a1 + 248));
    ...
    {
      LOWORD(v82) = 31992;
      HIWORD(v82) = (unsigned int)"update_temperature.c" >> 16;
    ...
    {
      LOWORD(v81) = 32000;
      HIWORD(v81) = (unsigned int)"emperature.c" >> 16;
    ...
    *v47 = v164[4];
    ...
    V_UNLOCK();
    zlog(*v128, v110, 196, "check_temperature", 17, 94, 40, v188);
  }
  while ( v126 != v9 );
  free(ptr);
...
LABEL_33:
  ...
  if ( v120 )
  {
    ...
    v70 = v123;
    v118[5] = v124;
    dword_1A2C28[v68] = v70;
    dword_1A2C28[v68 + 16] = 0;
    goto LABEL_35;
  }
LABEL_59:
  v69 = v68;
  v83 = &dword_1A2C28[v68];
  v84 = v83[16] + 1;
  v74 = v83[16] - 1 < 0;
  v83[16] = v84;
  if ( !(v74 ^ __OFSUB__(v84, 2) | (v84 == 2)) )
  {
    V_LOCK();
    LOWORD(v85) = 23936;
    HIWORD(v85) = (unsigned int)"p" >> 16;
    V_INT((int)v134, v85, *(int *)(a1 + 248));
    LOWORD(v86) = 32012;
    ...
    logfmt_raw(
      ...
      v135,
      v86,
      dword_1A2C28[*(_DWORD *)(a1 + 240) + 16]);
    V_UNLOCK();
    LOWORD(v87) = 31792;
    HIWORD(v87) = (unsigned int)"e, local:%d, remote:%d" >> 16;
    zlog(g_zc, v87, 196, "update_temperature", 18, 335, 120, v188);
    v68 = *(_DWORD *)(a1 + 240);
    v69 = v68;
    *(_DWORD *)(v133 + 16) |= 8u;
  }
LABEL_35:
  if ( v119 )
  {
    v71 = v118;
    v72 = v122;
    dword_1A2C28[v69 + 32] = 0;
    v71[4] = v72;
  }
  else
  {
    v96 = dword_1A2C28[v69 + 32] + 1;
    v74 = dword_1A2C28[v69 + 32] - 1 < 0;
    dword_1A2C28[v69 + 32] = v96;
    if ( !(v74 ^ __OFSUB__(v96, 2) | (v96 == 2)) )
    {
      V_LOCK();
      LOWORD(v97) = 23936;
      HIWORD(v97) = (unsigned int)"p" >> 16;
      V_INT((int)v136, v97, *(int *)(a1 + 248));
      LOWORD(v98) = 32056;
      HIWORD(v98) = (unsigned int)"emp exceed limit! (%d)" >> 16;
      logfmt_raw(
        v188,
        0x1000u,
        v119,
        ...
        v137,
        v98,
        dword_1A2C28[*(_DWORD *)(a1 + 240) + 32]);
      V_UNLOCK();
      LOWORD(v99) = 31792;
      HIWORD(v99) = (unsigned int)"e, local:%d, remote:%d" >> 16;
      zlog(g_zc, v99, 196, "update_temperature", 18, 352, 120, v188);
      v68 = *(_DWORD *)(a1 + 240);
      v69 = v68;
      *(_DWORD *)(v133 + 16) |= 8u;
    }
  }
  if ( *(_DWORD *)(a1 + 412) >= v121 )
  {
    dword_1A2C28[v69 + 48] = 0;
  }
  else
  {
    v73 = dword_1A2C28[v69 + 48] + 1;
    v74 = dword_1A2C28[v69 + 48] - 1 < 0;
    dword_1A2C28[v69 + 48] = v73;
    if ( !(v74 ^ __OFSUB__(v73, 2) | (v73 == 2)) )
    {
      V_LOCK();
      LOWORD(v100) = 23936;
      HIWORD(v100) = (unsigned int)"p" >> 16;
      V_INT((int)v138, v100, *(int *)(a1 + 248));
      LOWORD(v101) = 32100;
      HIWORD(v101) = (unsigned int)"temp exceed limit! (%d)" >> 16;
      logfmt_raw(
        v188,
        0x1000u,
        0,
        ...
        v139,
        v101,
        dword_1A2C28[*(_DWORD *)(a1 + 240) + 48],
        v121);
      V_UNLOCK();
      LOWORD(v102) = 31792;
      HIWORD(v102) = (unsigned int)"e, local:%d, remote:%d" >> 16;
      zlog(g_zc, v102, 196, "update_temperature", 18, 363, 120, v188);
      v68 = *(_DWORD *)(a1 + 240);
      *(_DWORD *)(v133 + 16) |= 0x10u;
      v69 = v68;
    }
  }
  if ( v118[4] > *(_DWORD *)(a1 + 400) || dword_1A2C28[v68] > *(_DWORD *)(a1 + 404) )
  {
    v88 = dword_1A2C28[v69 + 64] + 1;
    v74 = dword_1A2C28[v69 + 64] - 1 < 0;
    dword_1A2C28[v69 + 64] = v88;
    if ( !(v74 ^ __OFSUB__(v88, 2) | (v88 == 2)) )
    {
      V_LOCK();
      LOWORD(v89) = 23936;
      HIWORD(v89) = (unsigned int)"p" >> 16;
      V_INT((int)v140, v89, *(int *)(a1 + 248));
      LOWORD(v90) = 32168;
      HIWORD(v90) = (unsigned int)"ive_value_count = %d!" >> 16;
      logfmt_raw(
        v188,
        0x1000u,
        0,
        ...
        v141,
        v90,
        dword_1A2C28[*(_DWORD *)(a1 + 240) + 64],
        v118[4],
        dword_1A2C28[*(_DWORD *)(a1 + 240)]);
      V_UNLOCK();
      LOWORD(v91) = 31792;
      HIWORD(v91) = (unsigned int)"e, local:%d, remote:%d" >> 16;
      zlog(g_zc, v91, 196, "update_temperature", 18, 378, 120, v188);
      V_LOCK();
      LOWORD(v92) = 29688;
      LOWORD(v93) = 27800;
      HIWORD(v92) = (unsigned int)"=%d;" >> 16;
      HIWORD(v93) = (unsigned int)"r" >> 16;
      logfmt_raw(v188, 0x1000u, 0, v93, v92);
      V_UNLOCK();
      LOWORD(v94) = 31792;
      HIWORD(v94) = (unsigned int)"e, local:%d, remote:%d" >> 16;
      zlog(g_zc, v94, 196, "update_temperature", 18, 379, 100, v188);
      v95 = *(_DWORD *)(a1 + 240);
      *(_DWORD *)(v133 + 16) |= 2u;
      v69 = v95;
    }
  ...
  {
    dword_1A2C28[v69 + 64] = 0;
  }
  if ( v118[5] <= *(_DWORD *)(a1 + 408) )
  {
    v75 = &dword_1A2C28[v69];
    v76 = v75[80] + 1;
    v74 = v75[80] - 1 < 0;
    v75[80] = v76;
    if ( !(v74 ^ __OFSUB__(v76, 2) | (v76 == 2)) )
    {
      ...
      V_INT((int)v142, v77, *(int *)(a1 + 248));
      LOWORD(v78) = 32236;
      HIWORD(v78) = (unsigned int)" %d, max_pcb_temp = %d!" >> 16;
      logfmt_raw(
        v188,
        0x1000u,
        0,
        ...
        v143,
        v78,
        dword_1A2C28[*(_DWORD *)(a1 + 240) + 80],
        v118[5]);
      V_UNLOCK();
      LOWORD(v79) = 31792;
      HIWORD(v79) = (unsigned int)"e, local:%d, remote:%d" >> 16;
      zlog(g_zc, v79, 196, "update_temperature", 18, 394, 120, v188);
      *(_DWORD *)(v133 + 16) |= 4u;
    }
    return v129;
  }
  result = v129;
  dword_1A2C28[v69 + 80] = 0;
  return result;
}
