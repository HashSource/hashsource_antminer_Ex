int __fastcall work_2_packet_ckb(int a1, int a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v7 + 3584) = (v24 + 1) & 0x7F;
  ...
  if ( !v30 )
  {
    V_LOCK();
    LOWORD(v41) = -26652;
    HIWORD(v41) = (unsigned int)"mask reg %02x tm %02x" >> 16;
    logfmt_raw((char *)v57, 0x1000u, 0, v41);
    V_UNLOCK();
    LOWORD(v42) = -26632;
    HIWORD(v42) = (unsigned int)"x" >> 16;
    LOWORD(v43) = 32624;
    v44 = a2 + 39;
    zlog(g_zc, v42, 174, "work_2_packet_ckb", 17, 119, 80, v57);
    v45 = a2 + 87;
    v55 = (unsigned __int8)a3[3];
    do
    {
      v46 = *(unsigned __int8 *)++v44;
      HIWORD(v43) = (unsigned int)"d_print_uart_debug_log" >> 16;
    ...
    V_LOCK();
    LOWORD(v47) = -26456;
    HIWORD(v47) = (unsigned int)"042/backend_ckb_2042.c" >> 16;
    logfmt_raw((char *)v57, 0x1000u, 0, v47, v54, v55);
    V_UNLOCK();
    LOWORD(v48) = -26632;
    HIWORD(v48) = (unsigned int)"x" >> 16;
    zlog(g_zc, v48, 174, "dump_work_ckb", 13, 86, 20, v57);
    V_LOCK();
    LOWORD(v49) = -26416;
    HIWORD(v49) = (unsigned int)"bid %s, work count %d" >> 16;
    logfmt_raw((char *)v57, 0x1000u, 0, v49, v56);
    V_UNLOCK();
    LOWORD(v50) = -26632;
    HIWORD(v50) = (unsigned int)"x" >> 16;
    zlog(g_zc, v50, 174, "dump_work_ckb", 13, 87, 20, v57);
  }
  v31 = s2;
  v32 = &last_header_ckb;
  do
  ...
  *a4 = 54;
  ...
  V_LOCK();
  LOWORD(v38) = -26400;
  HIWORD(v38) = (unsigned int)"nt %d" >> 16;
  logfmt_raw((char *)v57, 0x1000u, 0, v38, "ChipSetting_bridge_reset_CKB_2042", 68);
  V_UNLOCK();
  LOWORD(v39) = -26872;
  HIWORD(v39) = (unsigned int)"stdiv1:%d, postdiv2:%d" >> 16;
  zlog(g_zc, v39, 153, "ChipSetting_bridge_reset_CKB_2042", 33, 110, 20, v57);
  v57[1] = 0;
  v57[2] = 4456449;
  v57[3] = 0;
  v57[0] = 2;
  (*(void (__fastcall **)(int, _DWORD *))(a1 + 264))(a1, v57);
  usleep(0x64u);
  return 0;
}
