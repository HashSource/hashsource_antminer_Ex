int __fastcall sync_get_dag_node_rvn(int a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  ...
  v24[0] = sub_144D54(a5, 0x3E8u);
  while ( v8 < a2 )
  {
    LOWORD(v10) = 28512;
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), (char *)&v25, 0x10Bu, v24) == 110 )
      {
        v5 = 3;
        goto LABEL_12;
      }
      V_LOCK();
      HIWORD(v10) = (unsigned int)"sync_get_core_reg_base5" >> 16;
      logfmt_raw(var1004, 0x1000u, 0, v10, v25, v26, v28);
      V_UNLOCK();
      LOWORD(v11) = 28552;
      HIWORD(v11) = (unsigned int)"x%02x chip_addr:%02x" >> 16;
      zlog(g_zc, v11, 157, "sync_get_dag_node_rvn", 21, 299, 20, var1004);
      if ( v25 != 170 || v26 != 85 )
      {
        v5 = 1;
        *a4 = v8;
