int __fastcall stratum_authorize_base(int a1, int a2)
{
  ...
  LOWORD(v8) = -26752;
  v9 = v7;
  HIWORD(v8) = (unsigned int)"cribe\", \"params\": []}" >> 16;
  ++*(_DWORD *)(a2 + 1920);
  sprintf(v7, v8);
...
LABEL_2:
  ...
  if ( !v13 )
  {
    ...
    V_LOCK();
    LOWORD(v30) = -27332;
    HIWORD(v30) = (unsigned int)"x %08x %08x %08x %08x " >> 16;
    logfmt_raw(v34, 0x1000u, 0, v30, *(_DWORD *)v32, v33);
    V_UNLOCK();
    LOWORD(v31) = -27588;
    HIWORD(v31) = (unsigned int)"et: invalid parameters" >> 16;
    zlog(g_zc, v31, 155, "stratum_authorize_base", 22, 283, 100, v34);
    free(v9);
    return v10;
  }
  LOWORD(v14) = -27288;
  HIWORD(v14) = (unsigned int)"d): %s" >> 16;
  v15 = json_object_get(v13, v14);
  LOWORD(v16) = 27772;
  v17 = (_DWORD *)v15;
  HIWORD(v16) = (unsigned int)"od-miner.c" >> 16;
  v18 = json_object_get(v13, v16);
  LOWORD(v19) = 28304;
  v20 = (_DWORD *)v18;
  HIWORD(v19) = (unsigned int)"lid" >> 16;
  ...
  if ( v23 || *v17 == 6 || v20 && *v20 != 7 )
  {
    V_LOCK();
    LOWORD(v25) = -26692;
    HIWORD(v25) = (unsigned int)",\"params\":[\"%s\",\"%s\"]}" >> 16;
    v10 = 0;
    logfmt_raw(v34, 0x1000u, 0, v25, v24);
    V_UNLOCK();
    LOWORD(v26) = -27588;
    HIWORD(v26) = (unsigned int)"et: invalid parameters" >> 16;
    zlog(g_zc, v26, 155, "stratum_authorize_base", 22, 293, 100, v34);
  }
  free(v9);
  if ( *((_DWORD *)v13 + 1) == -1 )
    return v10;
