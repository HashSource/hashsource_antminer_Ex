int __fastcall membist0(int a1)
{
  ...
  LOWORD(v1) = -16992;
  HIWORD(v1) = (unsigned int)"ailed after set addr" >> 16;
  v2 = &g_zc;
  v71 = v1;
  v72[0] = -2023406815;
  v72[1] = 1266163410;
  ...
  v72[3] = 517098360;
  LOWORD(v4) = -16876;
  HIWORD(v4) = (unsigned int)"membist0 err cnt: %08x" >> 16;
  v65 = v4;
  v72[4] = -766805986;
  V_LOCK();
  LOWORD(v5) = -17388;
  ...
  zlog(g_zc, v6, 174, "membist0", 8, 579, 40, v96);
  v70 = v72;
  memset(s, 0, sizeof(s));
  ...
  for ( i = 0; i != 5; ++i )
  {
    ...
    zlog(*v2, v9, 174, "membist0", 8, 589, 60, v96);
    sub_79174(a1, 164, v8);
    v10 = v2;
    v11 = a1;
    v12 = v10;
    do
    {
      sub_792A0(v11, v62, 12, 1);
      sub_792A0(v11, v62, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v13 = sub_79540(v11, (unsigned __int16)v62, 161, ptr);
      if ( v13 == 8 )
        goto LABEL_5;
      V_LOCK();
      LOWORD(v14) = 23936;
      HIWORD(v14) = (unsigned int)"p" >> 16;
      V_INT((int)v75, v14, *(int *)(v11 + 248));
      LOWORD(v15) = -16964;
      HIWORD(v15) = (unsigned int)"ist0 final pattern %08x" >> 16;
      logfmt_raw(v96, 0x1000u, 0, v76, v75[0], v75[1], v75[2], v75[3], v75[4], v75[5], v75[6], v76, v15, v13);
      V_UNLOCK();
      LOWORD(v16) = -17724;
      HIWORD(v16) = (unsigned int)&unk_16BAAC >> 16;
      zlog(*v12, v16, 174, "membist0", 8, 600, 100, v96);
      if ( v13 > 0 )
      {
LABEL_5:
        LOWORD(v17) = 23936;
        ...
        do
        {
          while ( (*v18 & 0x80) == 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v20) = -17724;
            HIWORD(v20) = (unsigned int)&unk_16BAAC >> 16;
            zlog(*v12, v20, 174, "membist0", 8, 616, 100, v96);
            if ( v13 <= v19 )
              goto LABEL_11;
          }
          if ( (*v18 & 0xFFFFFF00) != 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v49) = -17724;
            HIWORD(v49) = (unsigned int)&unk_16BAAC >> 16;
            zlog(*v12, v49, 174, "membist0", 8, 610, 100, v96);
...
LABEL_11:
      memset(ptr, 0, 0x600u);
      v21 = sub_79540(v11, (unsigned __int16)v62, 162, ptr);
      if ( v21 == 8 )
        goto LABEL_13;
      V_LOCK();
      LOWORD(v22) = 23936;
      HIWORD(v22) = (unsigned int)"p" >> 16;
      V_INT((int)v81, v22, *(int *)(v11 + 248));
      logfmt_raw(
        v96,
        0x1000u,
        0,
      ...
      V_UNLOCK();
      LOWORD(v23) = -17724;
      HIWORD(v23) = (unsigned int)&unk_16BAAC >> 16;
      zlog(*v12, v23, 174, "membist0", 8, 624, 100, v96);
      if ( v21 > 0 )
      {
LABEL_13:
        LOWORD(v24) = 23936;
        ...
        do
        {
          while ( (*v25 & 0x80) == 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v27) = -17724;
            HIWORD(v27) = (unsigned int)&unk_16BAAC >> 16;
            zlog(*v12, v27, 174, "membist0", 8, 639, 100, v96);
            if ( v21 <= v26 )
              goto LABEL_19;
          }
          if ( (*v25 & 0xFFFFFF00) != 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v51) = -17724;
            HIWORD(v51) = (unsigned int)&unk_16BAAC >> 16;
            zlog(*v12, v51, 174, "membist0", 8, 633, 100, v96);
...
LABEL_19:
      memset(ptr, 0, 0x600u);
      v28 = sub_79540(v11, (unsigned __int16)v62, 163, ptr);
      if ( v28 == 8 )
        goto LABEL_21;
      V_LOCK();
      LOWORD(v29) = 23936;
      HIWORD(v29) = (unsigned int)"p" >> 16;
      V_INT((int)v87, v29, *(int *)(v11 + 248));
      LOWORD(v30) = -16700;
      HIWORD(v30) = (unsigned int)"membist cnt not done!" >> 16;
      logfmt_raw(v96, 0x1000u, 0, v88, v87[0], v87[1], v87[2], v87[3], v87[4], v87[5], v87[6], v88, v30, v28);
      V_UNLOCK();
      LOWORD(v31) = -17724;
      HIWORD(v31) = (unsigned int)&unk_16BAAC >> 16;
      zlog(*v12, v31, 174, "membist0", 8, 647, 100, v96);
      if ( v28 > 0 )
      {
LABEL_21:
        LOWORD(v32) = 23936;
        LOWORD(v33) = -16652;
        HIWORD(v32) = (unsigned int)"p" >> 16;
        v63 = v32;
        v34 = 0;
        v35 = ptr;
        do
        {
          ...
          V_LOCK();
          v35 += 3;
          V_INT((int)v89, v63, *(int *)(v11 + 248));
          HIWORD(v33) = (unsigned int)"failed, resp_num: %d\n" >> 16;
          logfmt_raw(
            v96,
            0x1000u,
            0,
...
LABEL_26:
  ...
  LOWORD(v38) = -16608;
  LOWORD(v39) = 23936;
  HIWORD(v38) = (unsigned int)"ethbist err cnt: %08x" >> 16;
  LOWORD(v40) = -17724;
  v66 = v38;
  HIWORD(v39) = (unsigned int)"p" >> 16;
  HIWORD(v40) = (unsigned int)&unk_16BAAC >> 16;
  v67 = v39;
  v68 = v40;
  useconds = 0;
  free(ptr);
  ...
  do
  {
    ...
    do
    {
      ...
      logfmt_raw(
        ...
        v61);
      V_UNLOCK();
      v46 = zlog(*v2, v68, 174, "membist0", 8, 674, 100, v96);
    }
    while ( v42 != 8 );
    useconds += 4;
  }
  while ( useconds != 20 );
  v47 = dev_ctrl(v46);
  ((void (__fastcall *)(_DWORD))v47[24])(*((_DWORD *)v64 + 60));
  return 0;
}
