int __fastcall membist1(int a1)
{
  ...
  zlog(g_zc, v4, 174, "membist1", 8, 697, 60, v63);
  memset(s, 0, sizeof(s));
  LOWORD(v5) = -16432;
  HIWORD(v5) = (unsigned int)"membist err cnt: %08x" >> 16;
  v39 = v5;
  ...
  do
  {
    sub_792A0(a1, v41, 12, 1);
    usleep(0x61A80u);
    sub_792A0(a1, v41, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x600u);
    v6 = sub_79540(a1, (unsigned __int16)v41, 161, ptr);
    if ( v6 == 8 )
      goto LABEL_4;
    V_LOCK();
    LOWORD(v7) = 23936;
    HIWORD(v7) = (unsigned int)"p" >> 16;
    V_INT((int)v48, v7, *(int *)(a1 + 248));
    LOWORD(v8) = -16516;
    HIWORD(v8) = (unsigned int)"etherr: %llx/%llx/%llx" >> 16;
    logfmt_raw(v63, 0x1000u, 0, v49, v48[0], v48[1], v48[2], v48[3], v48[4], v48[5], v48[6], v49, v8, v6);
    V_UNLOCK();
    LOWORD(v9) = -17724;
    HIWORD(v9) = (unsigned int)&unk_16BAAC >> 16;
    zlog(g_zc, v9, 174, "membist1", 8, 721, 100, v63);
    if ( v6 > 0 )
    {
LABEL_4:
      LOWORD(v10) = 23936;
      ...
      do
      {
        while ( (*v11 & 0x80) == 0 )
        {
          ...
          V_UNLOCK();
          LOWORD(v13) = -17724;
          HIWORD(v13) = (unsigned int)&unk_16BAAC >> 16;
          zlog(g_zc, v13, 174, "membist1", 8, 737, 100, v63);
          if ( v6 <= v12 )
            goto LABEL_10;
        }
        if ( (*v11 & 0xFFFFFF00) != 0 )
        {
          ...
          zlog(g_zc, v29, 174, "membist1", 8, 730, 100, v63);
...
LABEL_10:
    memset(ptr, 0, 0x600u);
    v14 = sub_79540(a1, (unsigned __int16)v41, 162, ptr);
    if ( v14 == 8 )
      goto LABEL_12;
    V_LOCK();
    LOWORD(v15) = 23936;
    HIWORD(v15) = (unsigned int)"p" >> 16;
    V_INT((int)v54, v15, *(int *)(a1 + 248));
    logfmt_raw(
      v63,
      0x1000u,
      0,
    ...
    zlog(g_zc, v16, 174, "membist1", 8, 745, 100, v63);
    if ( v14 > 0 )
    {
LABEL_12:
      LOWORD(v17) = 23936;
      ...
      do
      {
        while ( (*v18 & 0x80) == 0 )
        {
          ...
          zlog(g_zc, v20, 174, "membist1", 8, 761, 100, v63);
          if ( v14 <= v19 )
            goto LABEL_18;
        }
        if ( (*v18 & 0xFFFFFF00) != 0 )
        {
          ...
          zlog(g_zc, v31, 174, "membist1", 8, 754, 100, v63);
...
LABEL_18:
  ...
  LOWORD(v23) = -17724;
  v24 = 0;
  HIWORD(v22) = (unsigned int)"membist lost cnt: %08x" >> 16;
  useconds = v21;
  ...
  do
  {
    ...
    v36 += v25;
    v40 += ptra;
    V_INT((int)v60, useconds, *(int *)(a1 + 248));
    v33 = v24++;
    logfmt_raw(
      v63,
      0x1000u,
      ...
      v36);
    V_UNLOCK();
    v26 = zlog(g_zc, v45, 174, "membist1", 8, 774, 100, v63);
  }
  while ( v24 != 8 );
  v27 = dev_ctrl(v26);
  ((void (__fastcall *)(_DWORD))v27[24])(*(_DWORD *)(a1 + 240));
  unk_1A2ED8 = s[0];
  unk_1A2EDC = s[1];
  unk_1A2EE0 = s[2];
  unk_1A2EE4 = s[3];
