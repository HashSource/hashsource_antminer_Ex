void __noreturn work_generator_thread()
{
  ...
  V_UNLOCK();
  LOWORD(v10) = 30380;
  HIWORD(v10) = (unsigned int)"it idle pool's nonce." >> 16;
  zlog(g_zc, v10, 138, "work_generator_thread", 21, 112, 40, v49);
...
LABEL_34:
      V_LOCK();
      LOWORD(v33) = 30608;
      HIWORD(v33) = (unsigned int)"s_%d" >> 16;
    ...
    while ( 1 )
    {
      ...
      if ( v13 == 110 )
      {
        V_LOCK();
        LOWORD(v39) = 30672;
        HIWORD(v39) = (unsigned int)"pool has been changed" >> 16;
      ...
      else
      {
        V_LOCK();
        LOWORD(v14) = 30700;
        HIWORD(v14) = (unsigned int)" for new job timeout" >> 16;
        logfmt_raw((char *)v49, 0x1000u, 0, v14);
        V_UNLOCK();
        v15 = 157;
      }
      LOWORD(v16) = 30380;
      HIWORD(v16) = (unsigned int)"it idle pool's nonce." >> 16;
      zlog(g_zc, v16, 138, "work_generator_thread", 21, v15, 20, v49);
      ...
      {
        LOWORD(v38) = 30836;
        HIWORD(v38) = (unsigned int)"pushed after %lld ms" >> 16;
        logfmt_raw(
          (char *)v49,
          0x1000u,
          0,
      ...
      LOWORD(v24) = 30380;
      HIWORD(v24) = (unsigned int)"it idle pool's nonce." >> 16;
      zlog(g_zc, v24, 138, "work_generator_thread", 21, v23, 20, v49);
      clock_gettime(1, &tp);
      v25 = max_timeout_value;
      v26 = 0;
      v27 = 0;
      v28 = -1;
      v29 = (int)&loc_F4240 * (__int64)(tp.tv_sec - send_job_timer) + (tp.tv_nsec - dword_1B43DC) / 1000;
      do
      {
        v31 = *v25++;
        v30 = v31;
    ...
    V_LOCK();
    LOWORD(v34) = 30648;
    HIWORD(v34) = (unsigned int)"current pool is NULL" >> 16;
...
LABEL_36:
    LOWORD(v37) = 30380;
    HIWORD(v37) = (unsigned int)"it idle pool's nonce." >> 16;
    zlog(v36, v37, 138, "work_generator_thread", 21, v35, 20, v49);
LABEL_37:
    sleep(0);
  }
}
