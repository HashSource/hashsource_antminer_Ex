int check_fan_valiad()
{
  ...
  V_LOCK();
  LOWORD(v0) = 24492;
  HIWORD(v0) = (unsigned int)"" >> 16;
  LOWORD(v1) = 24672;
  logfmt_raw(v30, 0x1000u, 0, v0);
  V_UNLOCK();
  LOWORD(v2) = 24472;
  LOWORD(v3) = 24516;
  HIWORD(v2) = (unsigned int)"7/dcr_1727_content.c" >> 16;
  HIWORD(v3) = (unsigned int)"Begain check_fan_valiad" >> 16;
  zlog(g_zc, v3, 153, v2, 16, 31, 60, v30);
  HIWORD(v1) = (unsigned int)"iner_util/check_fan.c" >> 16;
  v4 = 0;
  s = v1;
    ...
    if ( v4 == 120 * (v4 / 0x78) )
    {
      ...
      do
      {
        ...
        if ( v15 == -1 || (v16 = platform_get_fan_max_speed(v12), fan_get_check_fan_speed(v16) > v15) )
        {
          V_LOCK();
          V_INT((int)v27, s, v14);
          HIWORD(v13) = (unsigned int)"l/check_fan.c" >> 16;
          V_INT((int)v29, v13, v15 & ~(v15 >> 31));
          LOWORD(v17) = 24692;
          HIWORD(v17) = (unsigned int)"c" >> 16;
          logfmt_raw(
            v30,
            0x1000u,
            0,
          ...
          LOWORD(v18) = 24472;
          LOWORD(v19) = 24516;
          HIWORD(v19) = (unsigned int)"Begain check_fan_valiad" >> 16;
          HIWORD(v18) = (unsigned int)"7/dcr_1727_content.c" >> 16;
          zlog(g_zc, v19, 153, v18, 16, 52, 100, v30);
...
LABEL_22:
  V_LOCK();
  LOWORD(v22) = 24744;
  HIWORD(v22) = (unsigned int)"n control board PCB)" >> 16;
  logfmt_raw(v30, 0x1000u, 0, v22, v7);
  V_UNLOCK();
  LOWORD(v23) = 24516;
  LOWORD(v24) = 24472;
  HIWORD(v24) = (unsigned int)"7/dcr_1727_content.c" >> 16;
  HIWORD(v23) = (unsigned int)"Begain check_fan_valiad" >> 16;
  return zlog(g_zc, v23, 153, v24, 16, 61, 60, v30);
}
