int __fastcall work_2_packet_ltc(int a1, _DWORD *a2, unsigned __int8 *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v5 + 27136) = (v21 + 1) & 0x7F;
  ...
  if ( !v27 )
  {
    V_LOCK();
    LOWORD(v31) = -26652;
    HIWORD(v31) = (unsigned int)"mask reg %02x tm %02x" >> 16;
    LOWORD(v32) = 32624;
    logfmt_raw(v46, 0x1000u, 0, v31);
    V_UNLOCK();
    LOWORD(v33) = -2044;
    LOWORD(v34) = -1156;
    HIWORD(v33) = (unsigned int)"ICKET_MASK_KS5_2382 %d" >> 16;
    HIWORD(v34) = (unsigned int)"ctrl_ltc_1489" >> 16;
    zlog(g_zc, v34, 174, v33, 17, 198, 80, v46);
    v35 = (char *)a2 + 71;
    v36 = (char *)a2 + 151;
    v44 = a3[3];
    do
    {
      ...
      HIWORD(v32) = (unsigned int)"d_print_uart_debug_log" >> 16;
    ...
    V_LOCK();
    LOWORD(v38) = -980;
    HIWORD(v38) = (unsigned int)"489/backend_ltc_1489.c" >> 16;
    logfmt_raw(v46, 0x1000u, 0, v38, v43, v44);
    V_UNLOCK();
    LOWORD(v39) = -1156;
    HIWORD(v39) = (unsigned int)"ctrl_ltc_1489" >> 16;
    zlog(g_zc, v39, 174, "dump_work_ltc", 13, 117, 20, v46);
    V_LOCK();
    logfmt_raw(v46, 0x1000u, 0, "dump work: %s", v45);
    V_UNLOCK();
    LOWORD(v40) = -1156;
    HIWORD(v40) = (unsigned int)"ctrl_ltc_1489" >> 16;
    zlog(g_zc, v40, 174, "dump_work_ltc", 13, 118, 20, v46);
  }
  memcpy(&last_work_ltc, v11, 0x50u);
  v28 = BM_CRC16(a3 + 2, 82);
  a3[85] = v28;
  a3[84] = HIBYTE(v28);
  v29 = *(unsigned __int8 *)(a1 + 253);
  *a4 = 86;
  if ( !v29 || !*(_BYTE *)(a1 + 254) )
    return 0;
