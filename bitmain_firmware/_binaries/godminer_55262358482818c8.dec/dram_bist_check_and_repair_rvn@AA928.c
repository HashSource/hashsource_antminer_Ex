void __fastcall __noreturn dram_bist_check_and_repair_rvn(int a1, int a2, char *a3)
{
  ...
  V_LOCK();
  LOWORD(v6) = 6340;
  HIWORD(v6) = (unsigned int)"%d status not ready!" >> 16;
  ...
  LOWORD(v3) = 23936;
  LOWORD(v8) = -26872;
  zlog(g_zc, v7, 174, "dram_bist_check_and_repair_rvn", 30, 2590, 40, v29);
  HIWORD(v4) = (unsigned int)"mode[%d], chip-%d..." >> 16;
  v18 = v4;
  dest = malloc(0xCu);
  HIWORD(v3) = (unsigned int)"p" >> 16;
  s = v3;
  HIWORD(v8) = (unsigned int)"stdiv1:%d, postdiv2:%d" >> 16;
  v20 = v8;
  while ( 1 )
  {
    v9 = 0;
    ...
    if ( v23 > 0 )
    {
      ...
      do
      {
        ...
        logfmt_raw(
          ...
          *((_DWORD *)v12 - 3));
        V_UNLOCK();
        zlog(g_zc, v20, 153, "ChipSetting_get_chip_status_rvn_RVN", 35, 1591, 40, v29);
        v11 = v23;
      }
      while ( v9 < v23 );
    }
LABEL_7:
    ...
    if ( !v11 )
    {
      V_LOCK();
      LOWORD(v14) = 6420;
      HIWORD(v14) = (unsigned int)" reg %02x state %08x" >> 16;
      logfmt_raw(v29, 0x1000u, 0, v14, "dram_bist_check_and_repair_rvn", a2, a3);
      V_UNLOCK();
      LOWORD(v15) = 5292;
      HIWORD(v15) = (unsigned int)&unk_171494 >> 16;
      zlog(g_zc, v15, 174, "dram_bist_check_and_repair_rvn", 30, 2646, 40, v29);
    }
  }
}
