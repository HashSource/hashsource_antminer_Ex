  ...
  *((_BYTE *)a1 + 1904) = 1;
  ...
  if ( !v3 )
  {
    ...
    if ( a1 == v5 )
    {
      v9 = *a1;
      LOWORD(v10) = 30344;
      HIWORD(v10) = (unsigned int)&off_147670 >> 16;
      LOWORD(v11) = 31544;
      V_INT((int)v13, v10, v9);
      HIWORD(v11) = (unsigned int)"WTF No pool %d found!" >> 16;
      ...
      zlog(g_zc, v12, 137, "pool_died", 9, 406, 80, v17);
      return switch_pools();
    }
    else
    {
      LOWORD(v6) = 30344;
      HIWORD(v6) = (unsigned int)&off_147670 >> 16;
      V_INT((int)v15, v6, *a1);
      LOWORD(v7) = 31560;
      HIWORD(v7) = (unsigned int)"ound!" >> 16;
      logfmt_raw(v17, 0x1000u, 0, v16, v15[0], v15[1], v15[2], v15[3], v15[4], v15[5], v15[6], v16, v7);
      V_UNLOCK();
      LOWORD(v8) = 31144;
      HIWORD(v8) = (unsigned int)"port %d reject reasons" >> 16;
      return zlog(g_zc, v8, 137, "pool_died", 9, 409, 20, v17);
    }
  }
  return result;
}
