int __fastcall chip_setting_ticket_mask_ltc(_DWORD *a1, unsigned int a2)
{
  ...
  V_LOCK();
  LOWORD(v4) = 572;
  HIWORD(v4) = (unsigned int)"set_misc value %08x/%d" >> 16;
  logfmt_raw(v21, 0x1000u, 0, v4, "chip_setting_ticket_mask_ltc", 2, a2, v15, 0, 0, 0, 0);
  V_UNLOCK();
  LOWORD(v5) = 368;
  HIWORD(v5) = (unsigned int)"ting_working_mode_ltc" >> 16;
  zlog(g_zc, v5, 179, "chip_setting_ticket_mask_ltc", 28, 146, 60, v21);
  v6 = a1[85];
  v17 = 131073;
  v16 = (unsigned __int16)a2;
  v19 = v6;
  v20 = 1;
  v7 = (void (__fastcall *)(_DWORD *, unsigned int *))a1[67];
  v18 = 0;
  v7(a1, &v16);
  usleep(0x3E8u);
  v8 = a1[85];
  ...
  v19 = v8;
  v18 = 0;
  v9 = ((int (__fastcall *)(_DWORD *, unsigned int *))a1[67])(a1, &v16);
  if ( (a2 & 1) != 0 )
  {
    for ( i = 0; ; ++i )
    {
  ...
  V_LOCK();
  LOWORD(v11) = 604;
  HIWORD(v11) = (unsigned int)"ask %s reg %02x tm %08x" >> 16;
  logfmt_raw(v21, 0x1000u, 0, v11, v14);
  V_UNLOCK();
  LOWORD(v12) = 368;
  HIWORD(v12) = (unsigned int)"ting_working_mode_ltc" >> 16;
  zlog(g_zc, v12, 179, "chip_setting_ticket_mask_ltc", 28, 177, 60, v21);
  return v9;
}
