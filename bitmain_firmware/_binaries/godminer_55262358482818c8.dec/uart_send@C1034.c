size_t __fastcall uart_send(int a1, const void *a2, size_t a3)
{
  ...
  if ( sub_C0768(a1, &v20, &v16, &v17, &v18) )
  {
    LOWORD(v13) = 21104;
    HIWORD(v13) = (unsigned int)"%d is not supported!!!" >> 16;
    snprintf(v22, 0x800u, v13, a1);
    V_LOCK();
    logfmt_raw((char *)v23, 0x1000u, 0, v22);
    V_UNLOCK();
    LOWORD(v14) = 20892;
    HIWORD(v14) = (unsigned int)" %d is not supported!!!" >> 16;
    zlog(g_zc, v14, 175, "uart_send", 9, 350, 100, v23);
