int __fastcall sub_2980C(_DWORD *a1, int a2)
{
  ...
  *(_DWORD *)v144 = 0;
  ...
  else
  {
    ...
    if ( v25 )
    {
      sub_144A3C((__int64)(v19 * v20 * 100.0));
      v129 = json_real();
      json_object_set_new(v16, "GHS 5s", v129);
    }
    else
    {
      sub_144A3C((__int64)(v21 * v20 * 100.0));
      v26 = json_real();
      json_object_set_new(v16, "GHS 5s", v26);
      v24 = *(float *)&v20 * v24;
      v23 = *(float *)&v20 * v23;
    }
    sub_144A3C((__int64)(v24 * 100.0));
    v27 = json_real();
    json_object_set_new(v16, "GHS av", v27);
    sub_144A3C((__int64)(v23 * 100.0));
    v28 = json_real();
    json_object_set_new(v16, "rate_30m", v28);
    sub_144A3C((__int64)(v142 * 100.0));
    v29 = json_real();
...
LABEL_75:
    ...
    v102 = v97;
    if ( opt_algo == 9 )
      LODWORD(v102) = sub_144D54(v97, 0x3E8u);
