int __fastcall sub_4C3C4(int a1, int a2, int a3)
{
  const char *v3; // r3
  int v6; // r5
  int v7; // r4
  ...
  if ( v3 || (v3 = (const char *)calloc(1u, 0x68u), (*(_DWORD *)(a1 + 1132) = v3) != 0) )
  {
    v6 = *(_DWORD *)(a2 + 1588);
    if ( v6 )
    {
      ...
      set_cur_seed_rvn((_DWORD *)v6);
      set_cur_block_num_rvn(*(_QWORD *)(v6 + 96));
      return v7;
    }
    else
    {
