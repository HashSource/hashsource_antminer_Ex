int __fastcall work_2_packet_dash(int a1, int a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v5 + 21504) = (v19 + 1) & 0x7F;
  ...
  if ( !v23 )
  {
    V_LOCK();
    LOWORD(v32) = -26652;
    HIWORD(v32) = (unsigned int)"mask reg %02x tm %02x" >> 16;
    LOWORD(v33) = 32624;
    logfmt_raw((char *)v46, 0x1000u, 0, v32);
    V_UNLOCK();
    LOWORD(v34) = -22992;
    HIWORD(v34) = (unsigned int)"__custom_data init %p" >> 16;
    v35 = a2 + 39;
    v36 = a2 + 119;
    zlog(g_zc, v34, 176, "work_2_packet_dash", 18, 126, 80, v46);
    v44 = (unsigned __int8)a3[3];
    do
    {
      v37 = *(unsigned __int8 *)++v35;
      HIWORD(v33) = (unsigned int)"d_print_uart_debug_log" >> 16;
    ...
    V_LOCK();
    LOWORD(v38) = -22812;
    HIWORD(v38) = (unsigned int)"/backend_dash_1766.c" >> 16;
    logfmt_raw((char *)v46, 0x1000u, 0, v38, v43, v44);
    V_UNLOCK();
    LOWORD(v39) = -22992;
    HIWORD(v39) = (unsigned int)"__custom_data init %p" >> 16;
    zlog(g_zc, v39, 176, "dump_work_dash", 14, 76, 20, v46);
    V_LOCK();
    logfmt_raw((char *)v46, 0x1000u, 0, "dump work: %s", v45);
    V_UNLOCK();
    LOWORD(v40) = -22992;
    HIWORD(v40) = (unsigned int)"__custom_data init %p" >> 16;
    zlog(g_zc, v40, 176, "dump_work_dash", 14, 77, 20, v46);
  }
  ...
  *a4 = 86;
  ...
  v26 = dword_1A2EC8;
  v27 = 3435973837LL * (unsigned int)dword_1A2EC8++;
  v28 = v26 - 20 * (HIDWORD(v27) >> 4);
  if ( v26 == 20 * (HIDWORD(v27) >> 4) )
  {
    sub_6F410(a1, 20, 65280);
    V_LOCK();
    LOWORD(v29) = -26400;
    HIWORD(v29) = (unsigned int)"nt %d" >> 16;
    logfmt_raw((char *)v46, 0x1000u, v28, v29, "ChipSetting_bridge_reset_DASH_1766", 68);
    V_UNLOCK();
    LOWORD(v30) = -26872;
    HIWORD(v30) = (unsigned int)"stdiv1:%d, postdiv2:%d" >> 16;
    zlog(g_zc, v30, 153, "ChipSetting_bridge_reset_DASH_1766", 34, 110, 20, v46);
    v46[1] = v28;
    v48 = BYTE1(v28);
    v50 = v28;
    v49 = 68;
    v47 = 1;
    v46[0] = 2;
    (*(void (__fastcall **)(int, _DWORD *))(a1 + 264))(a1, v46);
    usleep(0x64u);
  }
  return 0;
}
