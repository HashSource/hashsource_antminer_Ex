int __fastcall phy_internal_bist(int a1, int a2, unsigned int a3, int a4)
{
  ...
  V_INT((int)v45, v8, *(int *)(a1 + 248));
  LOWORD(v9) = -17736;
  HIWORD(v9) = (unsigned int)&unk_16BAA0 >> 16;
  logfmt_raw(v65, 0x1000u, 0, v46, v45[0], v45[1], v45[2], v45[3], v45[4], v45[5], v45[6], v46, v9, "phy_internal_bist");
  V_UNLOCK();
  LOWORD(v10) = -14704;
  HIWORD(v10) = (unsigned int)" %s handshake failed!" >> 16;
  zlog(g_zc, v10, 177, "phy_internal_bist", 17, 1787, 0x14u, v65);
  v37 = malloc(0x600u);
  ...
  if ( check_core_reg_with_expect_data(a1, a2, a3, 125, 0x70007000u) )
  {
    ...
    V_INT((int)v47, v31, *(int *)(a1 + 248));
    LOWORD(v32) = -14284;
    HIWORD(v32) = (unsigned int)"8x" >> 16;
    logfmt_raw(
      v65,
      0x1000u,
      0,
  ...
  sub_7FA3C(a1, a3, 82, 0);
  LOWORD(v11) = -11708;
  usleep(0x64u);
  V_LOCK();
  LOWORD(v12) = 23936;
  HIWORD(v12) = (unsigned int)"p" >> 16;
  V_INT((int)v51, v12, *(int *)(a1 + 248));
  HIWORD(v11) = (unsigned int)"%02x wait ack failed!" >> 16;
  logfmt_raw(
    v65,
    0x1000u,
    0,
  ...
  if ( check_core_reg_with_expect_data(a1, a2, a3, 83, 0) )
  {
    ...
    LOWORD(v14) = -11672;
    V_INT((int)v63, v13, *(int *)(a1 + 248));
    LOWORD(v15) = -14744;
    HIWORD(v15) = (unsigned int)" reg %02x state %08x" >> 16;
    HIWORD(v14) = (unsigned int)"%02x sram boot success!" >> 16;
    logfmt_raw(
      v65,
      0x1000u,
      0,
    ...
    zlog(g_zc, v16, 177, "phy_handshake", 13, 1744, 100, v65);
  }
  phy_pll_switch(a1, a2, a3, a4);
  sub_7FA3C(a1, a3, 98, -1426085121);
  usleep(0x64u);
  if ( check_core_reg_with_expect_data(a1, a2, a3, 64, 0xFF000100) )
  {
    ...
    V_INT((int)v53, v34, *(int *)(a1 + 248));
    LOWORD(v35) = -11660;
    HIWORD(v35) = (unsigned int)"ot success!" >> 16;
    logfmt_raw(
      v65,
      0x1000u,
      0,
  ...
  sub_7FA3C(a1, a3, 133, 255);
  usleep(0x64u);
  sub_7FA3C(a1, a3, 134, 255);
  usleep(0x64u);
  sub_7FA3C(a1, a3, 132, -2147483647);
  sleep(6u);
  ...
  LOWORD(v17) = -11588;
  HIWORD(v17) = (unsigned int)"%02x mac bist failed!" >> 16;
  v39 = v17;
  v43 = -1970698105;
  v18 = 135;
...
LABEL_17:
  ...
  HIWORD(v22) = (unsigned int)"2x reg %04x rdata %08x" >> 16;
  v40 = v22;
  v44 = -2088599168;
  v24 = 128;
  for ( j = (int *)((char *)&v44 + 1); ; j = (_DWORD *)((char *)j + 1) )
  {
    ...
    if ( v26 )
    {
      ...
      do
      {
        ...
        V_LOCK();
        v25 += 3;
        V_INT((int)v60, v23, *(int *)(a1 + 248));
        V_INT((int)v62, v23, *(int *)(a1 + 248));
        logfmt_raw(
          v65,
          0x1000u,
          0,
