int __fastcall packet_2_nonce_zec_1746(int a1, _BYTE *a2, int a3, _BYTE *a4, _DWORD *a5, unsigned int *a6, _DWORD *a7)
{
  ...
  if ( (v7 & 0xF0) != 0xE0 )
    return 10;
  v11 = (unsigned int)(unsigned __int8)a2[3] / *(_DWORD *)(a1 + 428);
  v12 = v11;
  if ( v11 > 5 )
  {
    V_LOCK();
    LOWORD(v16) = 15348;
    HIWORD(v16) = (unsigned int)"%d)" >> 16;
    logfmt_raw(var1004, 0x1000u, 0, v16, "packet_2_nonce_zec_1746", v12);
    V_UNLOCK();
    LOWORD(v17) = 14736;
    HIWORD(v17) = (unsigned int)"q: %d, reg_value: %08x" >> 16;
    zlog(g_zc, v17, 174, "packet_2_nonce_zec_1746", 23, 394, 80, var1004);
    return 14;
  }
  else
  {
    ...
    if ( v14 == 15 )
    {
      ...
      do
      {
        ...
        if ( __PAIR64__(HIBYTE(v55), (unsigned __int8)v55) != __PAIR64__(v20[90], v20[89]) )
        {
          V_LOCK();
          LOWORD(v21) = 15372;
          HIWORD(v21) = (unsigned int)"%s chip %d is not exist" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
          ...
          V_UNLOCK();
          LOWORD(v22) = 14736;
          HIWORD(v22) = (unsigned int)"q: %d, reg_value: %08x" >> 16;
          zlog(g_zc, v22, 174, "verify_nonce_integrality_zec_1746", 33, 294, 20, var1004);
          return 11;
        }
        ++v18;
        v20 += 91;
      ...
      for ( i = 0; i != 16; ++i )
      {
        ...
        if ( (v26 & 0xF) != i )
        {
          V_LOCK();
          LOWORD(v27) = 15420;
          HIWORD(v27) = (unsigned int)"4x, expected %02x%02x" >> 16;
...
LABEL_15:
          ...
          zlog(g_zc, v29, 174, "verify_nonce_integrality_zec_1746", 33, v28, 20, var1004);
          return 47;
        }
      }
      v30 = v19;
      ...
      do
      {
        ...
        if ( v32 != *(unsigned __int8 *)(v19 + 1) )
        {
          V_LOCK();
          LOWORD(v34) = 15448;
          HIWORD(v34) = (unsigned int)"e is not continous i=%d" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
      ...
      do
      {
        ...
        if ( v37 != *(unsigned __int8 *)(v19 + 2) )
        {
          V_LOCK();
          LOWORD(v39) = 15484;
          HIWORD(v39) = (unsigned int)" different %02x != %02x" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
      ...
      do
      {
        ...
        if ( v41 != *(unsigned __int8 *)(v19 + 3) )
        {
          ...
          V_LOCK();
          LOWORD(v43) = 15520;
          HIWORD(v43) = (unsigned int)"fferent %02x != %02x" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
