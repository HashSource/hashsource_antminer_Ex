int __fastcall work_2_packet_rvn(int a1, int *a2, int a3, _DWORD *a4)
{
  ...
  if ( v4 )
  {
    ...
    *(_BYTE *)(a3 + 2) = 48;
    ...
    v13[513] = v11;
    *v13 = v10;
    v14 = (unsigned __int8)byte_1B30E0;
    v13[1] = v12;
    if ( *((unsigned __int8 *)a2 + 88) != v14 )
    {
      V_LOCK();
      LOWORD(v43) = 5596;
      HIWORD(v43) = (unsigned int)"once %016llx mixhash %s" >> 16;
      logfmt_raw(v47, 0x1000u, 0, v43, (unsigned __int8)byte_1B30E0, *((unsigned __int8 *)a2 + 88));
      V_UNLOCK();
      LOWORD(v44) = 5292;
      HIWORD(v44) = (unsigned int)&unk_171494 >> 16;
      zlog(g_zc, v44, 174, "work_2_packet_rvn", 17, 1165, 40, v47);
  ...
  else
  {
    V_LOCK();
    LOWORD(v45) = -5728;
    HIWORD(v45) = (unsigned int)"enth %08x" >> 16;
    logfmt_raw(v47, 0x1000u, 0, v45, "work_2_packet_rvn");
    V_UNLOCK();
    LOWORD(v46) = 5292;
    HIWORD(v46) = (unsigned int)&unk_171494 >> 16;
    v21 = 3;
    zlog(g_zc, v46, 174, "work_2_packet_rvn", 17, 1152, 0x14u, v47);
  }
  return v21;
}
