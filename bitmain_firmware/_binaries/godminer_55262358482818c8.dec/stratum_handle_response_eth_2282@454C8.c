int __fastcall stratum_handle_response_eth_2282(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    V_UNLOCK();
    LOWORD(v24) = -22736;
    HIWORD(v24) = (unsigned int)"tum_authorize_eth_2282" >> 16;
    zlog(g_zc, v24, 177, "stratum_handle_response_eth_2282", 32, 1137, 40, v29);
    return 0;
  }
...
LABEL_9:
  if ( !v12 || *v12 == 7 )
  {
    V_LOCK();
    LOWORD(v25) = -26648;
    HIWORD(v25) = (unsigned int)"on failed, req_id=%d" >> 16;
    logfmt_raw(v29, 0x1000u, 0, v25, "stratum_handle_response_eth_2282");
    V_UNLOCK();
    LOWORD(v26) = -22736;
    HIWORD(v26) = (unsigned int)"tum_authorize_eth_2282" >> 16;
    v14 = 0;
    zlog(g_zc, v26, 177, "stratum_handle_response_eth_2282", 32, 1166, 40, v29);
  }
  else
  {
    if ( v8 )
