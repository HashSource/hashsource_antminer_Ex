const char *__fastcall stratum_handle_method_base(int (__fastcall **a1)(_DWORD, _DWORD, _DWORD), int a2, int a3)
{
  ...
  if ( !v6 )
  {
    V_LOCK();
    LOWORD(v20) = -27332;
    HIWORD(v20) = (unsigned int)"x %08x %08x %08x %08x " >> 16;
    logfmt_raw(v30, 0x1000u, 0, v20, *(_DWORD *)v28, v29);
    V_UNLOCK();
    LOWORD(v21) = -27588;
    HIWORD(v21) = (unsigned int)"et: invalid parameters" >> 16;
    zlog(g_zc, v21, 155, "stratum_handle_method_base", 26, 65, 100, v30);
    return 0;
  }
...
LABEL_9:
  ...
  LOWORD(v10) = -27296;
  HIWORD(v10) = (unsigned int)"failed(%d): %s" >> 16;
  v11 = json_object_get(v7, v10);
  if ( !v11 )
  {
    LOWORD(v22) = -27288;
    HIWORD(v22) = (unsigned int)"d): %s" >> 16;
    v11 = json_object_get(v7, v22);
  }
  LOWORD(v12) = 28304;
  HIWORD(v12) = (unsigned int)"lid" >> 16;
  json_object_get(v7, v12);
  LOWORD(v13) = -27280;
  HIWORD(v13) = (unsigned int)"method" >> 16;
  ...
  LOWORD(v23) = -27264;
  HIWORD(v23) = (unsigned int)"result" >> 16;
  if ( !strcasecmp(v9, v23)
    || (LOWORD(v24) = -27240, HIWORD(v24) = (unsigned int)"mining.set_difficulty" >> 16, !strcasecmp(v9, v24)) )
  {
    v9 = (const char *)a1[14](a1, a2, v11);
    goto LABEL_9;
  }
  LOWORD(v25) = -27220;
  HIWORD(v25) = (unsigned int)"y" >> 16;
  if ( strcasecmp(v9, v25) )
  {
    V_LOCK();
    LOWORD(v26) = -27196;
    HIWORD(v26) = (unsigned int)"mining.set_extranonce" >> 16;
    v9 = 0;
    logfmt_raw(v30, 0x1000u, 0, v26, a3);
    V_UNLOCK();
    LOWORD(v27) = -27588;
    HIWORD(v27) = (unsigned int)"et: invalid parameters" >> 16;
    zlog(g_zc, v27, 155, "stratum_handle_method_base", 26, 105, 80, v30);
    goto LABEL_9;
  }
  v14 = a1[13](a1, a2, v11);
LABEL_7:
