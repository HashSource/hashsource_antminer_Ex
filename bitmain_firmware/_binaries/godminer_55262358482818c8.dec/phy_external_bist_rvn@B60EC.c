int __fastcall phy_external_bist_rvn(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  zlog(g_zc, v10, 177, "phy_external_bist_rvn", 21, 1095, 60, v90);
  memset(s, 0, sizeof(s));
  ...
  if ( a4 )
  {
    ...
    v69 = a3 - 1;
    LOWORD(v13) = 23936;
    HIWORD(v11) = (unsigned int)"ot success!" >> 16;
    ...
    do
    {
      ...
      zlog(
        ...
        "rigin_godminer-new/backend/backend_rvn_2044/backend_rvn_phy_set.c",
        177,
        "phy_external_bist_rvn",
        21,
        1227,
...
LABEL_6:
    ...
    {
      v19 = *++v18;
      sub_AE358(a1, v19, 133, 0xFFFF);
      sub_AE358(a1, *v18, 134, 1342177279);
    }
    while ( v15 != v18 );
    sub_AE314(a1, 132, -2147483647);
    LOWORD(v20) = -11624;
    sleep(0xAu);
    LOWORD(v21) = 23936;
    ...
    do
    {
      ...
      V_LOCK();
      V_INT((int)v76, v62, *(int *)(a1 + 248));
      HIWORD(v20) = (unsigned int)"%02x pcs lock failed!" >> 16;
      logfmt_raw(
        v90,
        0x1000u,
        0,
...
LABEL_12:
    ...
    HIWORD(v24) = (unsigned int)"2x reg %04x rdata %08x" >> 16;
    v63 = v23;
    v70 = v24;
    do
    {
        ...
        if ( v30 )
        {
          ...
          do
          {
            ...
            zlog(
              ...
              "iner-origin_godminer-new/backend/backend_rvn_2044/backend_rvn_phy_set.c",
              177,
              "phy_external_bist_rvn",
              21,
              1265,
...
LABEL_21:
      ...
      LOWORD(v37) = -11588;
      HIWORD(v37) = (unsigned int)"%02x mac bist failed!" >> 16;
      v25 = a1;
      v68 = v37;
      v38 = 135;
      v66 = (int *)((char *)&v85 + 1);
...
LABEL_31:
  ...
  free(ptr);
  v47 = *(_QWORD *)&dword_1B3110;
  v48 = &s[1];
  v49 = *(_QWORD *)&dword_1B3118;
  for ( i = &v89[1]; ; ++i )
  {
    v47 += v46;
    v49 += a4;
  ...
  *(_QWORD *)&dword_1B3110 = v47;
  *(_QWORD *)&dword_1B3118 = v49;
  V_LOCK();
  LOWORD(v53) = 23936;
  HIWORD(v53) = (unsigned int)"p" >> 16;
  V_INT((int)&v82, v53, *(int *)(a1 + 248));
  logfmt_raw(
    v90,
    0x1000u,
    0,
  ...
  zlog(g_zc, v54, 177, "phy_external_bist_rvn", 21, 1299, 60, v90);
  V_LOCK();
  LOWORD(v55) = 23936;
  HIWORD(v55) = (unsigned int)"p" >> 16;
  V_INT((int)&v85, v55, *(int *)(a1 + 248));
  logfmt_raw(
    v90,
    0x1000u,
    0,
  ...
  zlog(g_zc, v56, 177, "phy_external_bist_rvn", 21, 1300, 60, v90);
  return 0;
}
