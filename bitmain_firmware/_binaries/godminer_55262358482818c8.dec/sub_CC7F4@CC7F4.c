int __fastcall sub_CC7F4(int a1, int a2, int *a3, int *a4, unsigned __int64 a5)
{
  ...
  v16[0] = sub_144D54(a5, 0x3E8u);
  while ( a2 > v9 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), (char *)&v17, 0xAu, v16) == 110 )
      {
        V_LOCK();
        v8 = 3;
