int __fastcall top_init_kas(int a1)
{
  ...
  zlog(g_zc, v4, 174, "top_init_kas", 12, 1076, 60, v28);
  v5 = *(_DWORD *)(a1 + 336);
  v6 = *(_DWORD *)(a1 + 488);
  ...
  *(_DWORD *)(a1 + 428) = v7;
  v11 = 0;
  (*(void (__fastcall **)(int, int, int))(a1 + 256))(a1, v10, v5);
  v23[0] = 0;
  v23[2] = 1;
  v23[1] = 0;
  v22 = 0;
  ...
  if ( v22 > 0 )
  {
    ...
    do
    {
      ...
      {
        V_LOCK();
        V_INT((int)v26, s, *(int *)(a1 + 248));
        HIWORD(v14) = (unsigned int)" reg %04x state %08x" >> 16;
        logfmt_raw(
          v28,
          0x1000u,
          v16,
        ...
        V_UNLOCK();
        LOWORD(v17) = -26872;
        HIWORD(v17) = (unsigned int)"stdiv1:%d, postdiv2:%d" >> 16;
        zlog(g_zc, v17, 153, "ChipSetting_get_chip_status_KAS_2380", 36, 1565, 20, v28);
      }
      ++v11;
      v15 += 6;
    }
