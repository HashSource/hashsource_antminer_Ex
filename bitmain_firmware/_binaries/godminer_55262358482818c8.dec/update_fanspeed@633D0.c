int __fastcall update_fanspeed(int a1, _DWORD *a2, int a3)
{
  ...
  if ( v6 == a1 )
  {
    ...
    {
      LOWORD(v8) = 31064;
      HIWORD(v8) = (unsigned int)"bad asic id:" >> 16;
      v92 = v8;
      LOWORD(v9) = 24672;
      LOWORD(v8) = -30580;
      LOWORD(v10) = 24680;
      v11 = 0;
      v95 = 0;
      HIWORD(v8) = (unsigned int)"e failed" >> 16;
      HIWORD(v9) = (unsigned int)"iner_util/check_fan.c" >> 16;
      HIWORD(v10) = (unsigned int)"l/check_fan.c" >> 16;
      v12 = 0;
      v91 = v8;
      v97 = &g_fan_zc;
      v98 = &g_zc;
      ...
      do
      {
        ...
        *v29 = v108[4];
        ...
        V_UNLOCK();
        LOWORD(v33) = 31064;
        HIWORD(v33) = (unsigned int)"bad asic id:" >> 16;
        zlog(
          *v97,
...
LABEL_19:
    ...
    *((_DWORD *)v103 + 1) = v52;
    if ( !(v53 ^ __OFSUB__(v52, 15) | (v52 == 15)) )
    {
      V_LOCK();
      LOWORD(v54) = 31276;
      HIWORD(v54) = (unsigned int)"tus/update_fanspeed.c" >> 16;
      ...
      if ( !*(_BYTE *)(v102 + 254) )
      {
        LOWORD(v82) = 31064;
        LOWORD(v83) = 31080;
        HIWORD(v82) = (unsigned int)"bad asic id:" >> 16;
        HIWORD(v83) = (unsigned int)"%03d " >> 16;
        zlog(g_zc, v83, 193, v82, 15, 65, 20, v121);
      }
      if ( *((_DWORD *)v103 + 1) == 16 )
      {
        v44 = fan_num <= 0;
        *(_DWORD *)(v101 + 32) |= 4u;
        if ( !v44 )
        {
          ...
          LOWORD(v58) = 31080;
          v91 = "%s";
          HIWORD(v55) = (unsigned int)"c" >> 16;
          HIWORD(v56) = (unsigned int)"iner_util/check_fan.c" >> 16;
          HIWORD(v57) = (unsigned int)"l/check_fan.c" >> 16;
          HIWORD(v58) = (unsigned int)"%03d " >> 16;
          v88 = (int)&v104 + 3;
          v97 = &g_fan_zc;
          v98 = &g_zc;
          v59 = 0;
          ...
          do
          {
            ...
            *v62 = v117[4];
            ...
            V_UNLOCK();
            zlog(*v97, v95, 193, "update_fanspeed", 15, 72, 40, v121);
            V_LOCK();
            ...
            *v62 = v120[4];
            ...
            V_UNLOCK();
            zlog(*v98, v95, 193, "update_fanspeed", 15, 73, 100, v121);
