int __fastcall check_nonce_ckb(int a1, int a2)
{
  ...
  if ( v24 <= 0x26 )
  {
    ...
    V_UNLOCK();
    LOWORD(v41) = -26632;
    HIWORD(v41) = (unsigned int)"x" >> 16;
    zlog(g_zc, v41, 174, "check_nonce_ckb", 15, 560, 20, v54);
    return 2;
  }
  else
  {
...
LABEL_11:
        ...
        zlog(g_zc, v37, 174, "check_nonce_ckb", 15, 590, 20, v54);
        return 1;
      }
    }
    else if ( v7 > v24 )
    {
      ...
      V_UNLOCK();
      LOWORD(v39) = -26632;
      HIWORD(v39) = (unsigned int)"x" >> 16;
      zlog(g_zc, v39, 174, "check_nonce_ckb", 15, 565, 20, v54);
      return 3;
    }
    v27 = v48;
