int __fastcall serdes_wait_status_rvn(int a1, int a2, int a3, int a4, int a5)
{
  ...
  while ( 1 )
  {
    sub_AE358(a1, a3, 78, v18);
    v7 = sub_AE3AC(a1, v19, 79, ptr);
    if ( !v7 )
      break;
    if ( v7 <= 0 )
      goto LABEL_13;
...
LABEL_6:
      ...
      LOWORD(v14) = 7720;
      HIWORD(v14) = (unsigned int)"backend_rvn_phy_set.c" >> 16;
      logfmt_raw(
        v24,
        0x1000u,
        0,
...
LABEL_10:
      ...
      v8 += 12;
      zlog(g_zc, v12, 177, "serdes_wait_status_rvn", 22, v11, 60, v24);
    }
    while ( v10 != v8 );
LABEL_11:
    if ( v9 )
