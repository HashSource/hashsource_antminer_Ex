int __fastcall check_nonce_ltc(int a1, int a2)
{
  ...
  if ( v6 <= 0x1A )
  {
    V_LOCK();
    LOWORD(v21) = -712;
    HIWORD(v21) = (unsigned int)"s and set frequency." >> 16;
    logfmt_raw(v26, 0x1000u, 0, v21, v7, *(unsigned __int8 *)(a2 + 84), 27);
    V_UNLOCK();
    LOWORD(v22) = -1156;
    HIWORD(v22) = (unsigned int)"ctrl_ltc_1489" >> 16;
    zlog(g_zc, v22, 174, "check_nonce_ltc", 15, 707, 20, v26);
    return 2;
  }
...
LABEL_13:
    LOWORD(v18) = -1156;
    HIWORD(v18) = (unsigned int)"ctrl_ltc_1489" >> 16;
    zlog(g_zc, v18, 174, "check_nonce_ltc", 15, v17, 20, v26);
    return 3;
  }
  if ( v6 != v8 + 16 )
  {
    V_LOCK();
    LOWORD(v23) = -584;
    HIWORD(v23) = (unsigned int)" diff %02x (bit5 is 1)" >> 16;
...
LABEL_4:
  ...
  V_LOCK();
  LOWORD(v19) = -25192;
  HIWORD(v19) = (unsigned int)"%d) expected diff %d" >> 16;
  logfmt_raw(v26, 0x1000u, 0, v19, v7, v5);
  V_UNLOCK();
  LOWORD(v20) = -1156;
  HIWORD(v20) = (unsigned int)"ctrl_ltc_1489" >> 16;
  zlog(g_zc, v20, 174, "check_nonce_ltc", 15, 724, 20, v26);
  return 1;
}
