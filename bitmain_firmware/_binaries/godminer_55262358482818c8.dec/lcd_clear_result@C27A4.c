int lcd_clear_result()
{
  ...
  {
    LOWORD(v1) = 19080;
    HIWORD(v1) = (unsigned int)"n not registered before" >> 16;
    v2 = *v1;
    v3 = v1[1];
    v4 = v1[2];
    v5 = v1[3];
    ...
    V_UNLOCK();
    LOWORD(v7) = 21676;
    HIWORD(v7) = (unsigned int)"ve %d from flicker list" >> 16;
    return zlog(g_zc, v7, 173, "lcd_clear_result", 16, 521, 100, v11);
  }
  else
  {
    if ( dword_1934B4 > 0 )
