int __fastcall main(int argc, const char **argv, const char **envp)
{
  ...
  while ( 1 )
  {
    v14 = EVPX_EncryptInit_ex(argc, (int)argv, "a:c:hl:p:Po:u:v:F", (const char **)&off_1469E4, 0);
    if ( v14 < 0 )
      break;
  ...
  V_LOCK();
  logfmt_raw(s, 0x1000u, 0, "opt_algo %d, %s", opt_algo, off_14652C[opt_algo]);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
  ...
  if ( !v12 )
  {
    ...
    logfmt_raw(
      ...
      "2.0.0_release_clean_master_e676fcafab203d5acd3ad333d36a58ce43741c8d_Mar 21 2024 19:14:26");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer-ori"
    ...
    *(_DWORD *)s = 0;
    ...
    if ( !strcmp((const char *)(v20 + 304), "E9 Pro") )
    {
      V_LOCK();
    ...
    else if ( !strcmp((const char *)(v20 + 304), "KAWPOW") )
    {
      V_LOCK();
    ...
    signal(2, (__sighandler_t)sub_2E3C0);
    signal(3, (__sighandler_t)sub_2E3C0);
    signal(15, (__sighandler_t)sub_2E3C0);
    signal(11, (__sighandler_t)sub_2E3C0);
    signal(10, (__sighandler_t)sub_2E3C0);
    ...
    if ( create_pool_connect() == 35 )
      return 1;
    thr_info = 0;
    pthread_attr_init(&stru_1B41C0);
    v26 = pthread_create(dword_1B41BC, &stru_1B41C0, (void *(*)(void *))work_generator_thread, &thr_info);
    pthread_attr_destroy(&stru_1B41C0);
    if ( v26 )
    {
      V_LOCK();
      v12 = 1;
    ...
    {
      dword_1B41E8 = 1;
      pthread_attr_init((pthread_attr_t *)&dword_1B41EC[1]);
      v12 = pthread_create(
              dword_1B41EC,
              (const pthread_attr_t *)&dword_1B41EC[1],
              (void *(*)(void *))nonce_submit_thread,
              &dword_1B41E8);
      v21 = pthread_attr_destroy((pthread_attr_t *)&dword_1B41EC[1]);
      if ( !v12 )
      {
...
LABEL_46:
    ...
    zlog(g_zc, v24, 142, "main", v25, v23, 100, s);
  }
  return v12;
}
