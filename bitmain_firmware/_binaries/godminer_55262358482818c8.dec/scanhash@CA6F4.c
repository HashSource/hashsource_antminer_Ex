int __fastcall scanhash(int a1)
{
  ...
  v3 = syscall(224);
  LOWORD(v4) = 30592;
  HIWORD(v4) = (unsigned int)" count %d" >> 16;
  v31 = 0;
  logfmt_raw(v39, 0x1000u, 0, v4, v2, v3);
  V_UNLOCK();
  LOWORD(v5) = 27564;
  HIWORD(v5) = (unsigned int)algn_176B94 >> 16;
  zlog(g_zc, v5, 153, "scanhash", 8, 199, 40, v39);
  prctl(15, v2);
  v6 = *(_DWORD *)(a1 + 856);
  v34 = 1;
  v7 = calloc(1u, *(_DWORD *)(a1 + 832));
  v33 = 0;
  ...
  if ( !*(_BYTE *)(a1 + 896) )
  {
    while ( 1 )
    {
      ...
      if ( s[1] == 85 )
      {
        ...
        v10 = (*(int (__fastcall **)(_DWORD))(a1 + 172))((unsigned __int8)s[2]);
        v11 = v10 + 3;
        queue_dequeue(v6, &s[3], v10);
        check_and_print_uart_debug_log(a1 + 1016, v11, (unsigned __int8 *)s, *(_DWORD *)(a1 + 248), 0);
        v12 = *(unsigned __int8 *)(a1 + 896);
        if ( *(_BYTE *)(a1 + 896) )
          break;
        memset(v7, *(unsigned __int8 *)(a1 + 896), *(_DWORD *)(a1 + 832));
        v36 = v12;
        v37 = v12;
        v35 = v12;
        ...
        if ( v13 == 10 )
        {
          if ( !queue_enqueue(*(_DWORD *)(a1 + 868), s, v11) )
          {
            v19 = v34 > ++v33;
            if ( !v19 )
            {
              ...
              V_UNLOCK();
              LOWORD(v24) = 27564;
              HIWORD(v24) = (unsigned int)algn_176B94 >> 16;
              zlog(g_zc, v24, 153, "scanhash", 8, 320, 40, v39);
              V_LOCK();
              v25 = v33;
              LOWORD(v26) = 28052;
              HIWORD(v26) = (unsigned int)"packet_queue is false" >> 16;
              v33 = 0;
              logfmt_raw(v39, 0x1000u, 0, v26, v25, v34);
              V_UNLOCK();
              LOWORD(v27) = 27564;
              HIWORD(v27) = (unsigned int)algn_176B94 >> 16;
              zlog(g_zc, v27, 153, "scanhash", 8, 321, 40, v39);
              v28 = 10 * v34;
              if ( 10 * v34 >= 0x989680 )
                v28 = 10000000;
              v34 = v28;
        ...
        else if ( !v13 && *(_BYTE *)(a1 + 254) )
        {
          if ( !*(_BYTE *)(a1 + v37 + 536) && v35 && platform_check_repeat_nonce((int *)a1, v36, ptr) )
          {
            ++*(_QWORD *)(*(_DWORD *)(a1 + 456) + 48 * v36 + 32);
          }
          else
          {
            v14 = (*(int (__fastcall **)(int, void *))(a1 + 72))(a1, v7);
            if ( v14 <= 5 )
            {
              v15 = v36;
              v16 = (_QWORD *)(*(_DWORD *)(a1 + 456) + 8 * v14 + 48 * v36);
              ++*v16;
              if ( v14 <= 1 )
              {
                ...
                *(_QWORD *)(a1 + 448) = v17;
                ...
                if ( !v14
                  && !*(_BYTE *)(a1 + v18 + 536)
                  && !queue_enqueue(*(_DWORD *)(*(_DWORD *)(a1 + 872) + 864), (char *)v7, 1) )
                {
                  v19 = v32 > ++v31;
                  if ( !v19 )
                  {
                    ...
                    V_UNLOCK();
                    LOWORD(v20) = 27564;
                    HIWORD(v20) = (unsigned int)algn_176B94 >> 16;
                    zlog(g_zc, v20, 153, "scanhash", 8, 291, 40, v39);
                    V_LOCK();
                    v21 = v31;
                    LOWORD(v22) = 27920;
                    HIWORD(v22) = (unsigned int)"retrieve_queue is false" >> 16;
                    v31 = 0;
      ...
      v29 = *(_BYTE *)(a1 + 896);
      s[0] = s[1];
      check_and_print_uart_debug_log(a1 + 1016, 2, (unsigned __int8 *)s, v9, v29);
    }
  }
LABEL_5:
  *(_BYTE *)(a1 + 896) = 0;
