int __fastcall check_nonce_ks5(int a1, int a2)
{
  ...
  if ( v2 <= 0x23 )
  {
    ...
    logfmt_raw(
      ...
      v32[6],
      v33,
      "ans diff %d TICKET_MASK_KS5_2382 %d",
    ...
    LOWORD(v24) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/"
                                    "tmp/release/build/godminer-origin_godminer-new/backend/backend_ks5_2382/backend_ks5_2382.c";
LABEL_13:
    HIWORD(v24) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/"
                                "release/build/godminer-origin_godminer-new/backend/backend_ks5_2382/backend_ks5_2382.c" >> 16;
    zlog(v23, v24, 174, "check_nonce_ks5", 15, v22, 20, v34);
    return 2;
  }
  v6 = *(_DWORD *)(a1 + 824);
  v7 = (char *)&v30 + 3;
  ...
  while ( v7 != &v31 );
  v11 = target_to_diff_ks5((int)v32);
  v12 = v11;
  if ( v11 <= 0x23 )
  {
    V_LOCK();
    ...
    logfmt_raw(
      ...
      v25[6],
      v26,
      "hw error calculate diff %d ans diff %d TICKET_MASK_KS5_2382 %d",
      v12,
      *(unsigned __int8 *)(a2 + 17),
      36);
    V_UNLOCK();
