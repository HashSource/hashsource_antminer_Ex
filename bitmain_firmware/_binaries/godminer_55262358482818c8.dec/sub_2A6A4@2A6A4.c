int __fastcall sub_2A6A4(_DWORD *a1, int a2)
{
  int v4; // r0
  bool v5; // zf
  int v6; // r5
  ...
  {
    v6 = v4;
    sub_2585C(a1, 1, 11, *(const char **)(a2 + 8));
    v69 = json_array();
    v7 = json_object();
    ...
    v11 = v82;
    v12 = v83;
    format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v6 + 72) + 16), v74);
    v13 = v8;
    format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v6 + 72) + 16), v75);
    format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v6 + 72) + 16), v76);
    v14 = v12;
    format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v6 + 72) + 16), v77);
    format_hashrate_string(*(_DWORD *)(*(_DWORD *)(v6 + 72) + 16), v78);
    format_hashrate_double(*(_DWORD *)(*(_DWORD *)(v6 + 72) + 16), &v72, v73);
    v68 = v85;
    get_miner_elapsed_time();
    LODWORD(v15) = sub_144A3C(total_accepted);
    v70 = v11 * v9;
    v16 = v15;
    if ( v9 != 0.0 )
      v16 = v15 / v9;
    ...
    if ( v20 )
    {
      sub_144A3C((__int64)(v10 * v9 * 100.0));
      v65 = json_real();
      json_object_set_new(v7, "GHS 5s", v65);
      sub_144A3C((__int64)(v17 * 100.0));
      v66 = json_real();
      json_object_set_new(v7, "GHS av", v66);
      sub_144A3C((__int64)(v70 * 100.0));
    }
    else
    {
      sub_144A3C((__int64)(v13 * v9 * 100.0));
      v21 = json_real();
      json_object_set_new(v7, "GHS 5s", v21);
      sub_144A3C((__int64)(*(float *)&v9 * v17 * 100.0));
      v22 = json_real();
      json_object_set_new(v7, "GHS av", v22);
      sub_144A3C((__int64)(*(float *)&v9 * v70 * 100.0));
    }
    v23 = json_real();
    json_object_set_new(v7, "GHS 30m", v23);
    v24 = json_integer((unsigned int)dword_194990);
    ...
    sub_144A3C((__int64)(dbl_194998 * 100.0));
    v36 = json_real();
    json_object_set_new(v7, "Total MH", v36);
    v37 = json_real();
    json_object_set_new(v7, "Work Utility", v37);
    sub_144A3C((__int64)(total_diff_accepted * 100.0));
    v38 = json_real();
    json_object_set_new(v7, "Difficulty Accepted", v38);
    sub_144A3C((__int64)(total_diff_rejected * 100.0));
    v39 = json_real();
    json_object_set_new(v7, "Difficulty Rejected", v39);
    sub_144A3C((__int64)(total_diff_stale * 100.0));
    v40 = json_real();
    json_object_set_new(v7, "Difficulty Stale", v40);
    v41 = json_integer(*(__int64 *)&dword_1949A0);
    json_object_set_new(v7, "Best Share", v41);
    v67 = v68 + total_diff1;
    if ( v68 + total_diff1 )
    {
      LODWORD(v63) = sub_144A2C(v68);
      HIDWORD(v63) = v62;
      LODWORD(v64) = sub_144A2C(v67);
      sub_144A3C((__int64)(v63 / v64 * 100.0));
    }
    v42 = json_real();
    json_object_set_new(v7, "Device Hardware%", v42);
    if ( total_diff1 )
    {
      LODWORD(v43) = sub_144A3C(total_diff1);
      sub_144A3C((__int64)(total_diff_rejected / v43 * 100.0));
    }
    v44 = json_real();
