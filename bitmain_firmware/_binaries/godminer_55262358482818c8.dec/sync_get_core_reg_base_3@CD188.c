int __fastcall sync_get_core_reg_base_3(int a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  ...
  v29[1] = 1000000 * v16;
  v24 = 0;
  v29[0] = sub_144D54(a6, 0x3E8u);
  while ( v24 < a3 )
  {
    LOWORD(v17) = 28944;
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), (char *)&v30, 9u, v29) == 110 )
      {
        v7 = 3;
        goto LABEL_14;
      }
      V_LOCK();
      HIWORD(v17) = (unsigned int)"queue end for timeout" >> 16;
      logfmt_raw(v39, 0x1000u, 0, v17, v30, v31, v36, v37, v33, v34, v35);
      V_UNLOCK();
      LOWORD(v18) = 28552;
      HIWORD(v18) = (unsigned int)"x%02x chip_addr:%02x" >> 16;
      zlog(g_zc, v18, 157, "sync_get_core_reg_base_3", 24, 664, 20, v39);
