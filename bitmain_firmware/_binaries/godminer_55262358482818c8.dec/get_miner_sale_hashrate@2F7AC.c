int get_miner_sale_hashrate()
{
  ...
  {
    LOWORD(v26) = 29684;
    HIWORD(v26) = (unsigned int)"nnum=%d;" >> 16;
    v27 = *v26;
    freq_scan_status = 2;
...
LABEL_10:
  ...
  for ( i = 0; i != 8; ++i )
  {
    ...
    HIWORD(v9) = (unsigned int)"nnum=%d;" >> 16;
    v13 = *v9;
    LOWORD(v14) = 29692;
    v15 = i;
    freq_scan_status = 2;
...
LABEL_14:
  ...
  for ( j = 0; j != 16; ++j )
  {
    ...
    LOWORD(v19) = 29700;
    v20 = j;
    HIWORD(v19) = (unsigned int)"ion=%s;" >> 16;
    HIWORD(v16) = (unsigned int)"nnum=%d;" >> 16;
...
LABEL_18:
  ...
  v22 = v29;
  result = sub_144470((int)v30[0], v29) * v22;
  switch ( opt_algo )
  {
    case 6:
      result -= 50;
...
LABEL_29:
      ...
      if ( (unsigned int)(result - 3130) <= 0x63 )
        return 3180;
      return sub_144470(result, v22) * v22;
    case 7:
      result = sub_144470(result, v22) * v22 - 50;
      if ( result > 3729 )
        return 3780;
      goto LABEL_29;
    case 9:
