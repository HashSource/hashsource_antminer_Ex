int __fastcall sync_get_core_reg_base5(int a1, int a2, int a3, int *a4, int *a5, unsigned __int64 a6)
{
  ...
  *(_WORD *)((char *)&v36 + 3) = v14;
  ...
  v20 = 0;
  sub_144D54(a6, 0x3E8u);
  v34[1] = (_DWORD)&loc_F4240 * v21;
  v34[0] = sub_144D54(a6, 0x3E8u);
  while ( v20 < a3 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), (char *)&v37, 0xCu, v34) == 110 )
      {
        v7 = 3;
        goto LABEL_13;
      }
      if ( v37 != 170 || v38 != 85 )
      {
        ...
        zlog(g_zc, v25, 157, "sync_get_core_reg_base5", 23, 1786, 20, v42);
        goto LABEL_13;
      }
      v22 = HIBYTE(v41);
    ...
    V_UNLOCK();
    LOWORD(v26) = 28552;
    HIWORD(v26) = (unsigned int)"x%02x chip_addr:%02x" >> 16;
    zlog(g_zc, v26, 157, "sync_get_core_reg_base5", 23, 1793, 20, v42);
    *((_BYTE *)v33 + 4) = v41;
    V_LOCK();
    logfmt_raw(v42, 0x1000u, 0, "ret_array[%d].chip_addr %02x", v20, *((unsigned __int8 *)v33 + 4));
    V_UNLOCK();
    LOWORD(v27) = 28552;
    HIWORD(v27) = (unsigned int)"x%02x chip_addr:%02x" >> 16;
    zlog(g_zc, v27, 157, "sync_get_core_reg_base5", 23, 1795, 20, v42);
    *((_WORD *)v33 + 3) = v41 >> 8;
    V_LOCK();
    ...
    zlog(g_zc, v28, 157, "sync_get_core_reg_base5", 23, 1797, 20, v42);
    *((_BYTE *)v33 + 8) = v39[1];
    V_LOCK();
    logfmt_raw(v42, 0x1000u, 0, "ret_array[%d].core_id %02x", v20, *((unsigned __int8 *)v33 + 8));
    V_UNLOCK();
    LOWORD(v29) = 28552;
    HIWORD(v29) = (unsigned int)"x%02x chip_addr:%02x" >> 16;
    zlog(g_zc, v29, 157, "sync_get_core_reg_base5", 23, 1799, 20, v42);
    *v33 = v40;
    V_LOCK();
    v30 = *v33;
    v32 = v20++;
    ...
    V_UNLOCK();
    LOWORD(v31) = 28552;
    HIWORD(v31) = (unsigned int)"x%02x chip_addr:%02x" >> 16;
    zlog(g_zc, v31, 157, "sync_get_core_reg_base5", 23, 1801, 20, v42);
  }
LABEL_13:
  *a5 = v20;
