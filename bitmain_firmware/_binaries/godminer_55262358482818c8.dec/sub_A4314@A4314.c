int __fastcall sub_A4314(int a1, int a2)
{
  int v3; // r4
  ...
  logfmt_raw(v8, 0x1000u, 0, v7, v6[0], v6[1], v6[2], v6[3], v6[4], v6[5], v6[6], v7, "set misc ctrl %08x", v5[0]);
  V_UNLOCK();
  zlog(
    g_zc,
