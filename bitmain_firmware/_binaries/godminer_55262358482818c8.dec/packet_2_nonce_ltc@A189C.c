int __fastcall packet_2_nonce_ltc(_DWORD *a1, _BYTE *a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  ...
  V_LOCK();
  LOWORD(v11) = -472;
  HIWORD(v11) = (unsigned int)"orking_freq_ltc() out" >> 16;
  logfmt_raw(v29, 0x1000u, 0, v11);
  V_UNLOCK();
  LOWORD(v12) = -1156;
  HIWORD(v12) = (unsigned int)"ctrl_ltc_1489" >> 16;
  zlog(g_zc, v12, 174, "packet_2_nonce_ltc", 18, 239, 40, v29);
  ...
  if ( v14 == (a2[8] & 0x1F) )
  {
    ...
    *(_DWORD *)(a3 + 108) = *(_DWORD *)(v15 + 4 * (v20 + 6656));
    ...
    v22 = ((unsigned __int8)((_BYTE)v21 << 7) | ((unsigned __int8)a2[3] >> 1)) / a1[107];
    if ( v22 >= a1[84] )
    {
      v27 = rand();
      sub_144704(v27, a1[84]);
      v22 = v28;
      *a6 = v28;
      v21 = (unsigned __int8)a2[2];
    }
    ...
    *a4 = 1;
    V_LOCK();
    LOWORD(v24) = -380;
    HIWORD(v24) = (unsigned int)"x expected value %04x\n" >> 16;
    logfmt_raw(v29, 0x1000u, 0, v24);
    V_UNLOCK();
    LOWORD(v25) = -1156;
    HIWORD(v25) = (unsigned int)"ctrl_ltc_1489" >> 16;
    zlog(g_zc, v25, 174, "packet_2_nonce_ltc", 18, 286, 40, v29);
    return 0;
  }
  else
  {
    LOWORD(v26) = -448;
    HIWORD(v26) = (unsigned int)"packet_2_nonce_ltc() in" >> 16;
    printf(v26, a1[60], v14);
    return 11;
  }
}
