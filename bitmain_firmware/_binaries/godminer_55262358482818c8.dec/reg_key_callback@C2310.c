int __fastcall reg_key_callback(int a1)
{
  ...
  {
    LOWORD(v15) = 19080;
    HIWORD(v15) = (unsigned int)"n not registered before" >> 16;
    v16 = *v15;
    v17 = v15[1];
    v18 = v15[2];
    v19 = v15[3];
    ...
    V_UNLOCK();
    LOWORD(v21) = 21676;
    HIWORD(v21) = (unsigned int)"ve %d from flicker list" >> 16;
    zlog(g_zc, v21, 173, "reg_key_callback", 16, 418, 100, v30);
  }
  else
  {
    v3 = &off_1B3608;
    ...
    while ( *v3++ )
    {
      ...
      {
        LOWORD(v6) = 22024;
        HIWORD(v6) = (unsigned int)"already exist in map" >> 16;
        v7 = *v6;
        v8 = v6[1];
        v9 = v6[2];
        v10 = v6[3];
        ...
        V_UNLOCK();
        LOWORD(v13) = 21676;
        HIWORD(v13) = (unsigned int)"ve %d from flicker list" >> 16;
        zlog(g_zc, v13, 173, "reg_key_callback", 16, 434, 100, v30);
        goto LABEL_7;
      }
    }
