int __fastcall sub_42190(int a1, int a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  const char *v6; // r7
  _DWORD *v7; // r0
...
LABEL_24:
    v24 = g_zc;
    LOWORD(v25) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/"
...
LABEL_14:
  ...
  *(_BYTE *)(a2 + 444) = 1;
  ...
  {
    *(_DWORD *)(a2 + 1536) = get_epoch_number_rvn_0(v18);
    v19 = v18 + 103;
    *((_WORD *)v18 + 52) = 0;
    v18[106] = 0;
  ...
  LOWORD(v25) = -24164;
LABEL_25:
  HIWORD(v25) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/re"
                              "lease/build/godminer-origin_godminer-new/frontend/frontend_eth/frontend_eth.c" >> 16;
  zlog(v24, v25, 167, "stratum_notify_eth", 18, v23, 100, v29);
  pthread_mutex_unlock((pthread_mutex_t *)(a2 + 1592));
  return 0;
}
