int __fastcall gpio_write(int a1, int a2)
{
  ...
  if ( pthread_mutex_lock(&stru_1B32A4) )
  {
    ...
    zlog(g_zc, v15, 175, "gpio_write", 10, 414, 100, v46);
    return -1;
  }
  else
  {
    LOWORD(v4) = 19588;
    HIWORD(v4) = (unsigned int)"direction %s success!" >> 16;
    ...
    {
      LOWORD(v16) = 19760;
      HIWORD(v16) = (unsigned int)"al = %d, new val = %d" >> 16;
      v17 = *v16;
      v18 = v16[1];
      v19 = v16[2];
      v20 = v16[3];
      ...
      V_UNLOCK();
      LOWORD(v26) = 18736;
      HIWORD(v26) = (unsigned int)"exist" >> 16;
      zlog(g_zc, v26, 175, "gpio_write", 10, 422, 100, v46);
    ...
    else
    {
      ...
      {
        LOWORD(v27) = 19800;
        HIWORD(v27) = (unsigned int)"pio value for writing!" >> 16;
        v28 = *v27;
        v29 = v27[1];
        v30 = v27[2];
        v31 = v27[3];
        ...
        zlog(g_zc, v33, 175, "gpio_write", 10, 428, 100, v46);
        close(v6);
        pthread_mutex_unlock(&stru_1B32A4);
        return -3;
      }
