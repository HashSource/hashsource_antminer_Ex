int is_eeprom_loaded()
{
  ...
  if ( !dword_1B3628[0] || (result = *(unsigned __int8 *)(dword_1B3628[0] + 80), !*(_BYTE *)(dword_1B3628[0] + 80)) )
  {
    ...
    V_UNLOCK();
    LOWORD(v1) = 23232;
    HIWORD(v1) = (unsigned int)" not ready, chain = %d." >> 16;
    zlog(g_zc, v1, 173, "is_eeprom_loaded", 16, 1121, 20, v3);
    return 0;
  }
  return result;
}
