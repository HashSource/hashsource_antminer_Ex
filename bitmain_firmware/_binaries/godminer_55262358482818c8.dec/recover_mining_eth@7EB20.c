int __fastcall recover_mining_eth(int a1)
{
  ...
  V_LOCK();
  LOWORD(v2) = -16152;
  HIWORD(v2) = (unsigned int)"ry phy lock times %d" >> 16;
  logfmt_raw((char *)v12, 0x1000u, 0, v2, "recover_mining_eth", 0);
  V_UNLOCK();
  LOWORD(v3) = -17724;
  HIWORD(v3) = (unsigned int)&unk_16BAAC >> 16;
  zlog(g_zc, v3, 174, "recover_mining_eth", 18, 1851, 60, v12);
  v13 = 1310720;
  v12[0] = 272381185;
  ...
  release_all_phy(a1);
  reset_all_phy(a1);
  eeprom_phy_seq_level = api_get_eeprom_phy_seq_level(*(_DWORD *)(a1 + 240));
  if ( eeprom_phy_seq_level > 0xA )
  {
    V_LOCK();
    LOWORD(v7) = 23936;
    HIWORD(v7) = (unsigned int)"p" >> 16;
    V_INT((int)v10, v7, *(int *)(a1 + 248));
    LOWORD(v8) = -16124;
    HIWORD(v8) = (unsigned int)"nter, membist_done: %u" >> 16;
    logfmt_raw((char *)v12, 0x1000u, 0, v11, v10[0], v10[1], v10[2], v10[3], v10[4], v10[5], v10[6], v11, v8);
    V_UNLOCK();
    LOWORD(v9) = -17724;
    HIWORD(v9) = (unsigned int)&unk_16BAAC >> 16;
    zlog(g_zc, v9, 174, "recover_mining_eth", 18, 1866, 60, v12);
    return 31;
  }
  else
  {
    ...
    setup_mac(a1);
    set_dag_node_num(a1, *(__int64 *)*(_DWORD *)(a1 + 1004) >> 6);
