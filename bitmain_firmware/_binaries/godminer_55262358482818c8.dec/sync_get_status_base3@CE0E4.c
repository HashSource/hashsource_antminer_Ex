int __fastcall sync_get_status_base3(int a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  ...
  char v26[4096]; // [sp+40h] [bp-1004h] BYREF
  ...
  v7 = 0;
  sub_144D54(a5, 0x3E8u);
  v19[1] = 1000000 * v8;
  v19[0] = sub_144D54(a5, 0x3E8u);
  while ( v7 < a2 )
  {
    LOWORD(v9) = 29016;
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 868), (char *)&v20, 9u, v19) == 110 )
      {
        v5 = 3;
        goto LABEL_12;
      }
      V_LOCK();
      HIWORD(v9) = (unsigned int)" reg value %02x%02x%02x" >> 16;
      logfmt_raw(v26, 0x1000u, 0, v9, v20, v21, v24, v23, v22);
      V_UNLOCK();
      LOWORD(v10) = 28552;
      HIWORD(v10) = (unsigned int)"x%02x chip_addr:%02x" >> 16;
      zlog(g_zc, v10, 157, "sync_get_status_base3", 21, 1432, 20, v26);
      if ( v20 != 170 || v21 != 85 )
      {
        v5 = 1;
        *a4 = v7;
