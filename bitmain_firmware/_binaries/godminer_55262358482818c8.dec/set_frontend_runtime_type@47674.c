...
LABEL_3:
    ...
    default:
      V_LOCK();
      LOWORD(v6) = -21668;
      HIWORD(v6) = (unsigned int)"tend_runtime_instance" >> 16;
      v4 = 0;
      logfmt_raw(v9, 0x1000u, 0, v6, a2);
      V_UNLOCK();
      LOWORD(v7) = -21724;
      LOWORD(v8) = -21628;
      HIWORD(v7) = (unsigned int)"%s input value error" >> 16;
      HIWORD(v8) = (unsigned int)" define Frontend_Base" >> 16;
      zlog(g_zc, v8, 160, v7, 25, 63, 100, v9);
      break;
  }
  return v4;
}
