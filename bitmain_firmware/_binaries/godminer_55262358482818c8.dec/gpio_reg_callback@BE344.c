int __fastcall gpio_reg_callback(int a1, int a2)
{
  ...
  {
    LOWORD(v8) = 18912;
    HIWORD(v8) = (unsigned int)"atform/7020/7020_gpio.c" >> 16;
    v9 = *v8;
    v10 = v8[1];
    v11 = v8[2];
    v12 = v8[3];
...
LABEL_9:
    LOWORD(v17) = 18736;
    HIWORD(v17) = (unsigned int)"exist" >> 16;
    zlog(g_zc, v17, 175, "gpio_reg_callback", 17, v16, 100, v31);
    return -1;
  }
  if ( exists_c_map((int *)dword_1B32A0, (int)&v22) )
  {
    LOWORD(v3) = 18968;
    HIWORD(v3) = (unsigned int)"add %d to callback map" >> 16;
    snprintf((char *)&s, 0x800u, v3, v22);
    V_LOCK();
    logfmt_raw((char *)v31, 0x1000u, 0, &s);
    V_UNLOCK();
    LOWORD(v4) = 18736;
    HIWORD(v4) = (unsigned int)"exist" >> 16;
    zlog(g_zc, v4, 175, "gpio_reg_callback", 17, 164, 20, v31);
  }
  else
  {
    LOWORD(v6) = 18944;
    HIWORD(v6) = (unsigned int)"lock gpio ctrl mutex" >> 16;
    snprintf((char *)&s, 0x800u, v6, v22);
    V_LOCK();
    logfmt_raw((char *)v31, 0x1000u, 0, &s);
    V_UNLOCK();
    LOWORD(v7) = 18736;
    HIWORD(v7) = (unsigned int)"exist" >> 16;
    zlog(g_zc, v7, 175, "gpio_reg_callback", 17, 157, 20, v31);
    v31[0] = a2;
    v31[1] = -1;
    insert_c_map((int *)dword_1B32A0, &v22, 4u, v31, 8u);
  }
