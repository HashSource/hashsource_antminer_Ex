...
LABEL_18:
        ...
        *(_DWORD *)v28 = 0;
        ...
        if ( *(int *)v28 > 0 )
        {
          ...
          do
          {
            ...
            v9 += 4;
            ++v8;
            result = (*(int (__fastcall **)(_DWORD))(v10 + 96))(*(_DWORD *)(v11 + 240));
          }
          while ( v8 < *(int *)v28 );
        }
        if ( v7 )
  ...
  else
  {
    V_LOCK();
    LOWORD(v20) = 28444;
    HIWORD(v20) = (unsigned int)"mpile time: %s type: %s" >> 16;
    logfmt_raw(v28, 0x1000u, 0, v20, "set_working_voltage_and_runtime_freq");
    V_UNLOCK();
    LOWORD(v21) = 27616;
    HIWORD(v21) = (unsigned int)"some chip working slow" >> 16;
    zlog(g_zc, v21, 142, "set_working_voltage_and_runtime_freq", 36, 1146, 100, v28);
    V_LOCK();
    LOWORD(v22) = 28468;
    LOWORD(v23) = 27800;
    HIWORD(v22) = (unsigned int)"%s, power has not init!" >> 16;
    HIWORD(v23) = (unsigned int)"r" >> 16;
    logfmt_raw(v28, 0x1000u, 0, v23, v22);
    V_UNLOCK();
    LOWORD(v24) = 27616;
    HIWORD(v24) = (unsigned int)"some chip working slow" >> 16;
    zlog(g_zc, v24, 142, "set_working_voltage_and_runtime_freq", 36, 1147, 100, v28);
    return -1;
  }
  return result;
}
