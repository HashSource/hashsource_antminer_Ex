int __fastcall stratum_handle_method_eth_2282(int (__fastcall **a1)(_DWORD, _DWORD, _DWORD), int a2, int a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( *(_BYTE *)(a2 + 1656) )
    {
      ...
      if ( !v13 )
        goto LABEL_7;
      v30 = sub_43880(v11, a2);
      goto LABEL_23;
    }
    LOWORD(v18) = -27304;
    HIWORD(v18) = (unsigned int)" decode failed(%d): %s" >> 16;
    ...
    if ( v20 )
    {
      ...
      {
        LOWORD(v32) = -27288;
        HIWORD(v32) = (unsigned int)"d): %s" >> 16;
        v22 = json_object_get(v6, v32);
      }
      LOWORD(v23) = -27280;
      HIWORD(v23) = (unsigned int)"method" >> 16;
      if ( !strcasecmp(v20, v23) )
      {
        LOWORD(v27) = -23328;
        HIWORD(v27) = (unsigned int)"s\",\"%s\"]}" >> 16;
          ...
          if ( !v35 )
          {
            ...
            *(_DWORD *)(a2 + 1588) = v35;
            if ( !v35 )
            {
              LOWORD(v36) = -26160;
              LOWORD(v37) = 28808;
              HIWORD(v36) = (unsigned int)"Failed to alloc xnonce1" >> 16;
      ...
      LOWORD(v24) = -27264;
      HIWORD(v24) = (unsigned int)"result" >> 16;
      if ( !strcasecmp(v20, v24)
        || (LOWORD(v33) = -27240, HIWORD(v33) = (unsigned int)"mining.set_difficulty" >> 16, !strcasecmp(v20, v33)) )
      {
        v12 = a1[14](a1, a2, v22);
        goto LABEL_8;
      }
      LOWORD(v34) = -27220;
      HIWORD(v34) = (unsigned int)"y" >> 16;
...
LABEL_7:
  ...
  V_LOCK();
  LOWORD(v25) = -27332;
  HIWORD(v25) = (unsigned int)"x %08x %08x %08x %08x " >> 16;
  logfmt_raw(v40, 0x1000u, 0, v25, *(_DWORD *)v38, v39);
  V_UNLOCK();
  LOWORD(v26) = -22736;
  HIWORD(v26) = (unsigned int)"tum_authorize_eth_2282" >> 16;
  zlog(g_zc, v26, 177, "stratum_handle_method_eth_2282", 30, 687, 100, v40);
  return 0;
}
