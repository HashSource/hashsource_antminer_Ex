int __fastcall get_chip_dag_packet_num(int a1)
{
  ...
  while ( 1 )
  {
    v5 = sub_7977C(a1, 86, ptr);
    if ( v5 == 8 )
      break;
    V_LOCK();
    HIWORD(v1) = (unsigned int)"p" >> 16;
    V_INT((int)v43, v1, *(int *)(a1 + 248));
    v31 = v4++;
    HIWORD(v2) = (unsigned int)"level = P%d is invalid!" >> 16;
    logfmt_raw(v55, 0x1000u, 0, v44, v43[0], v43[1], v43[2], v43[3], v43[4], v43[5], v43[6], v44, v2, v5, v31);
    V_UNLOCK();
    LOWORD(v6) = -17724;
    HIWORD(v6) = (unsigned int)&unk_16BAAC >> 16;
    zlog(g_zc, v6, 174, "get_chip_dag_packet_num", 23, 1668, 100, v55);
    if ( v4 == 5 )
    {
      v42 = 12;
      goto LABEL_6;
...
LABEL_6:
  ...
  HIWORD(v8) = (unsigned int)": %d, retry_time: %d" >> 16;
  s = v7;
  v37 = v8;
  while ( 1 )
  {
    v10 = sub_7977C(a1, 83, v36);
    if ( v10 == 8 )
      goto LABEL_14;
    V_LOCK();
    V_INT((int)v45, s, *(int *)(a1 + 248));
    v32 = v9++;
    logfmt_raw(v55, 0x1000u, 0, v46, v45[0], v45[1], v45[2], v45[3], v45[4], v45[5], v45[6], v46, v37, v10, v32);
    V_UNLOCK();
    LOWORD(v11) = -17724;
    HIWORD(v11) = (unsigned int)&unk_16BAAC >> 16;
    zlog(g_zc, v11, 174, "get_chip_dag_packet_num", 23, 1682, 100, v55);
    if ( v9 == 5 )
      break;
    usleep(0x2710u);
  }
...
LABEL_11:
  ...
  v42 = 12;
  V_INT((int)v47, v13, *(int *)(a1 + 248));
  LOWORD(v14) = -15960;
  HIWORD(v14) = (unsigned int)": %d, retry_time: %d" >> 16;
  logfmt_raw(v55, 0x1000u, 0, v48, v47[0], v47[1], v47[2], v47[3], v47[4], v47[5], v47[6], v48, v14, 8 - v10);
  V_UNLOCK();
  LOWORD(v15) = -17724;
  HIWORD(v15) = (unsigned int)&unk_16BAAC >> 16;
  zlog(g_zc, v15, 174, "get_chip_dag_packet_num", 23, 1695, 100, v55);
LABEL_14:
  ...
  if ( sa )
  {
    ...
    LOWORD(v17) = -15896;
    LOWORD(v18) = -25680;
    HIWORD(v18) = (unsigned int)"_dash/frontend_dash.c" >> 16;
    V_INT((int)v51, v16, *(int *)(a1 + 248));
    HIWORD(v17) = (unsigned int)"ived dag size error!" >> 16;
    v38 = v17;
    v19 = "no";
    if ( *v36 )
      v19 = v18;
    ...
    zlog(g_zc, v20, 174, "get_chip_dag_packet_num", 23, 1707, 60, v55);
    if ( v10 > 1 )
    {
      LOWORD(v21) = 23936;
  ...
  else
  {
    ...
    V_INT((int)v49, v28, *(int *)(a1 + 248));
    LOWORD(v29) = -15932;
    HIWORD(v29) = (unsigned int)" VOL ABNORMAL CNT-%d" >> 16;
    logfmt_raw(v55, 0x1000u, 0, v50, v49[0], v49[1], v49[2], v49[3], v49[4], v49[5], v49[6], v50, v29);
    V_UNLOCK();
    LOWORD(v30) = -17724;
    HIWORD(v30) = (unsigned int)&unk_16BAAC >> 16;
    zlog(g_zc, v30, 174, "get_chip_dag_packet_num", 23, 1703, 100, v55);
  }
LABEL_12:
  free(ptr);
  free(v36);
