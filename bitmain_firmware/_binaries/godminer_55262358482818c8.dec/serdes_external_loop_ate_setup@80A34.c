int __fastcall serdes_external_loop_ate_setup(int a1, int a2, int a3, int a4)
{
  ...
  V_INT((int)v18, v7, *(int *)(a1 + 248));
  LOWORD(v8) = -17112;
  HIWORD(v8) = (unsigned int)"ue %04x resp value %04x" >> 16;
  logfmt_raw(
    v24,
    0x1000u,
    0,
  ...
  LOWORD(v10) = -14448;
  zlog(g_zc, v9, 177, "serdes_external_loop_ate_setup", 30, 1544, 60, v24);
  V_LOCK();
  LOWORD(v11) = 23936;
  HIWORD(v11) = (unsigned int)"p" >> 16;
  V_INT((int)v20, v11, *(int *)(a1 + 248));
  HIWORD(v10) = (unsigned int)"8x not equal to %08x" >> 16;
  logfmt_raw(
    v24,
    0x1000u,
    0,
  ...
  zlog(g_zc, v12, 177, "serdes_external_loop_ate_setup", 30, 1546, 60, v24);
  if ( LFSR31 )
  {
  ...
  {
    sub_7FA3C(a1, a3, 77, (int)&loc_90008 + 1);
    sub_7FA3C(a1, a3, 78, -2144251757);
    sub_7FA3C(a1, a3, 77, (int)&loc_90008 + 1);
    sub_7FA3C(a1, a3, 78, -2144251757);
    sub_7FA3C(a1, a3, 77, 1638425);
    sub_7FA3C(a1, a3, 78, -2144251757);
    sub_7FA3C(a1, a3, 77, (int)&loc_90008 + 1);
    sub_7FA3C(a1, a3, 78, -2144251757);
    sub_7FA3C(a1, a3, 77, 1638425);
  ...
  V_UNLOCK();
  LOWORD(v15) = -14704;
  HIWORD(v15) = (unsigned int)" %s handshake failed!" >> 16;
  zlog(g_zc, v15, 177, "serdes_external_loop_ate_setup", 30, 1575, 60, v24);
  sub_7FA3C(a1, a3, 77, 716778169);
  sub_7FA3C(a1, a3, 78, -2144251791);
  sub_7FA3C(a1, a3, 77, 715729577);
  sub_7FA3C(a1, a3, 78, -2144251791);
