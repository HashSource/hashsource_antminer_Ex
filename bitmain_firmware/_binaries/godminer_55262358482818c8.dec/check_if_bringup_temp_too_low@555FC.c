int __fastcall check_if_bringup_temp_too_low(int a1)
{
  ...
  if ( v18 > 0 )
  {
    ...
    if ( *(_DWORD *)(*(_DWORD *)all_created_runtime + 408) > v4 )
    {
      ...
      V_UNLOCK();
      LOWORD(v17) = -14932;
      HIWORD(v17) = (unsigned int)"%d, set voltage to %d" >> 16;
      zlog(g_zc, v17, 169, "check_if_bringup_temp_too_low", 29, 1201, 100, v19);
    }
    else
    {
      ...
      zlog(g_zc, v12, 169, "check_if_bringup_temp_too_low", 29, 1201, 100, v19);
      do
      {
