void __noreturn dag_gen_rvn_thread_func()
{
  ...
  LOWORD(v0) = 7296;
  HIWORD(v0) = (unsigned int)&unk_161C68 >> 16;
  v101 = v0;
  while ( 1 )
  {
    do
    ...
    while ( qword_195BD0 == *(_QWORD *)&dword_195BD8 );
    V_LOCK();
    logfmt_raw((char *)v112, 0x1000u, 0, "cur_block_num enter: %llu", qword_195BD0);
    V_UNLOCK();
    LOWORD(v2) = 23708;
    LOWORD(v3) = -9144;
    HIWORD(v3) = (unsigned int)"nce_rvn_high: %016llx" >> 16;
    HIWORD(v2) = (unsigned int)"block_num enter: %llu" >> 16;
    zlog(g_zc, v2, 167, v3, 23, 353, 60, v112);
    v102 = qword_195BD0;
    v4 = sub_144D54(qword_195BD0, 3u);
    v5 = &s[7];
    v6 = &v111;
...
LABEL_28:
    ...
    *(_QWORD *)&dword_195BD8 = v102;
    if ( v103 )
    {
      ...
      HIWORD(v52) = (unsigned int)"/rvn/rvn_dhash_common.c" >> 16;
      HIWORD(v53) = (unsigned int)"nce_rvn_high: %016llx" >> 16;
      HIWORD(v54) = (unsigned int)"block_num enter: %llu" >> 16;
      v78 = v52;
      v67 = v53;
      v70 = v54;
      do
      {
        ...
        v56 = &v109;
        v57 = 0;
        zlog(g_zc, v70, 167, v67, 23, 362, 40, v112);
        v58 = sub_144D54(qword_195BD0, 0x1D4Cu);
        v59 = *((_DWORD *)v55 + 1);
        v55 += 4;
        ...
        V_LOCK();
        LOWORD(v62) = 23916;
        HIWORD(v62) = (unsigned int)"gin..." >> 16;
        ++v72;
        logfmt_raw((char *)v112, 0x1000u, 0, v62);
        V_UNLOCK();
        zlog(g_zc, v70, 167, v67, 23, 368, 40, v112);
        v63 = v103;
        *(_BYTE *)(*(_DWORD *)v55 + 255) = 1;
      }
      while ( v63 > v72 );
    }
  }
