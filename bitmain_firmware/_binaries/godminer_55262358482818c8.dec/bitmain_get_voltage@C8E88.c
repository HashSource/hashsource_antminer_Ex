void bitmain_get_voltage()
{
  ...
  if ( dword_1B36F4 || sub_C7E8C() >= 0 )
  {
    ...
    v17 = 50637397;
    v18 = 7;
    if ( sub_C7500(dword_1B36F0, (unsigned __int8 *)&v17, 6u, (unsigned __int8 *)v19, 8u) )
    {
      LOWORD(v2) = 26632;
      HIWORD(v2) = (unsigned int)"nont set power watchdog" >> 16;
      v3 = *v2;
      v4 = v2[1];
      v5 = v2[2];
      v6 = v2[3];
      ...
      zlog(g_zc, v9, 176, "_bitmain_get_AD_conversion_N", 28, 361, 100, v28);
      LOWORD(v10) = 26660;
      HIWORD(v10) = (unsigned int)"AD conversion N failed" >> 16;
      v11 = *v10;
      v12 = v10[1];
      v13 = v10[2];
      v14 = v10[3];
      ...
      V_UNLOCK();
      LOWORD(v16) = 25984;
      HIWORD(v16) = (unsigned int)"x, crc_read = 0x%04x" >> 16;
      zlog(g_zc, v16, 176, "bitmain_get_voltage", 19, 697, 100, v28);
    }
    else
    {
  ...
  {
    LOWORD(v0) = 26340;
    HIWORD(v0) = (unsigned int)"power close ===========" >> 16;
    snprintf((char *)&s, 0x800u, v0, "bitmain_get_voltage");
    V_LOCK();
    logfmt_raw(v28, 0x1000u, 0, &s);
    V_UNLOCK();
    LOWORD(v1) = 25984;
    HIWORD(v1) = (unsigned int)"x, crc_read = 0x%04x" >> 16;
    zlog(g_zc, v1, 176, "bitmain_get_voltage", 19, 693, 100, v28);
  }
}
