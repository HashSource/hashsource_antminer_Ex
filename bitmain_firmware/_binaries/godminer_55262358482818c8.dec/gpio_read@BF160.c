int __fastcall gpio_read(int a1, _BYTE *a2)
{
  ...
  buf = 0;
  v4 = pthread_mutex_lock(&stru_1B32A4);
  if ( v4 )
  {
    LOWORD(v9) = 19080;
    HIWORD(v9) = (unsigned int)"n not registered before" >> 16;
    v4 = -1;
    v10 = *v9;
    v11 = v9[1];
    v12 = v9[2];
    ...
    zlog(g_zc, v15, 175, "gpio_read", 9, 371, 100, v33);
  }
  else
  {
    LOWORD(v5) = 19588;
    HIWORD(v5) = (unsigned int)"direction %s success!" >> 16;
    ...
    {
      LOWORD(v16) = 19620;
      HIWORD(v16) = (unsigned int)"ss/gpio/gpio%d/value" >> 16;
      ...
      v4 = -2;
      zlog(g_zc, v17, 175, "gpio_read", 9, 379, 100, v33);
      pthread_mutex_unlock(&stru_1B32A4);
    }
    else if ( read(v6, &buf, 4u) < 0 )
    {
      LOWORD(v18) = 19664;
      HIWORD(v18) = (unsigned int)"%d value for reading!" >> 16;
      v19 = *v18;
      v20 = v18[1];
      v21 = v18[2];
      v22 = v18[3];
      ...
      V_UNLOCK();
      LOWORD(v24) = 18736;
      HIWORD(v24) = (unsigned int)"exist" >> 16;
      v4 = -3;
      zlog(g_zc, v24, 175, "gpio_read", 9, 386, 100, v33);
      close(v7);
      pthread_mutex_unlock(&stru_1B32A4);
    }
    else
