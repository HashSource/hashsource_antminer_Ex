int __fastcall set_miner_6060info_asic_num_less_than_design_err(int a1, int a2)
{
  ...
  if ( a1 > 15 )
  {
    ...
    v3 = 0;
    zlog(g_zc, v11, 172, "set_miner_6060info_asic_num_less_than_design_err", 48, 122, 40, v13);
  }
  else
  {
    v3 = a1;
  }
  v4 = (char *)&stru_195CC8 + 8 * v3 + 344;
  ...
  if ( a2 )
  {
    ...
    *((_DWORD *)v4 + 7) = v13[0].tv_sec;
    if ( !v6 )
    {
      ...
      {
        LOWORD(v7) = 30124;
        HIWORD(v7) = (unsigned int)"MAX_CHAIN_NUM" >> 16;
        ...
        zlog(g_zc, v9, 172, "set_miner_6060info_asic_num_less_than_design_err", 48, 125, 100, v13);
        LOBYTE(a2) = v4[24];
      }
    }
  }
  *((_BYTE *)&stru_195CC8 + 8 * v3 + 888) = a2;
