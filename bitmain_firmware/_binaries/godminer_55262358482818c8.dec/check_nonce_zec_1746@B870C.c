int __fastcall check_nonce_zec_1746(int a1, int a2)
{
  ...
  *(_WORD *)((char *)&s[35] + 1) = 1344;
  ...
  if ( v9 != v8 )
  {
    ...
    V_UNLOCK();
    LOWORD(v29) = 14736;
    HIWORD(v29) = (unsigned int)"q: %d, reg_value: %08x" >> 16;
    zlog(g_zc, v29, 174, "check_nonce_zec_1746", 20, 886, 20, v48);
    return 3;
  }
  if ( v9 <= 0x11 )
  {
    ...
    v24 = 2;
    V_INT((int)v36, v23, *(int *)(a1 + 248));
    LOWORD(v25) = 15188;
    HIWORD(v25) = (unsigned int)", chip return diff %d," >> 16;
    logfmt_raw(v48, 0x1000u, 0, v37, v36[0], v36[1], v36[2], v36[3], v36[4], v36[5], v36[6], v37, v25, 2, v9, 18);
    V_UNLOCK();
    v26 = 892;
LABEL_11:
    LOWORD(v27) = 14736;
    HIWORD(v27) = (unsigned int)"q: %d, reg_value: %08x" >> 16;
    zlog(g_zc, v27, 174, "check_nonce_zec_1746", 20, v26, 20, v48);
    return v24;
  }
  if ( IsValidSolution(v46, a2 + 54) )
  {
    ...
    v24 = 2;
    V_INT((int)v38, v32, *(int *)(a1 + 248));
    LOWORD(v33) = 15232;
    HIWORD(v33) = (unsigned int)"iff %d, ticket mask %d" >> 16;
...
LABEL_13:
    ...
    v24 = 1;
    V_INT((int)v40, v30, *(int *)(a1 + 248));
    LOWORD(v31) = 15276;
    HIWORD(v31) = (unsigned int)"olution verify failed" >> 16;
  ...
  V_INT((int)v42, v19, *(int *)(a1 + 248));
  LOWORD(v20) = 15328;
  HIWORD(v20) = (unsigned int)"(%d) not reach pool(%d)" >> 16;
  logfmt_raw(v48, 0x1000u, 0, v43, v42[0], v42[1], v42[2], v42[3], v42[4], v42[5], v42[6], v43, v20);
  V_UNLOCK();
  LOWORD(v21) = 14736;
  HIWORD(v21) = (unsigned int)"q: %d, reg_value: %08x" >> 16;
  zlog(g_zc, v21, 174, "check_nonce_zec_1746", 20, 932, 20, v48);
  return 0;
}
