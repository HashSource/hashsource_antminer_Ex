unsigned int __fastcall xxtea_decode(unsigned int *a1, unsigned int a2, int a3)
{
  ...
  int v16; // r3
  int v17; // r1
  char v18[4100]; // [sp+18h] [bp-1004h] BYREF

  if ( a2 <= 1 )
  {
    V_LOCK();
    LOWORD(v16) = -26320;
    HIWORD(v16) = (unsigned int)"ommon/general/xxtea.c" >> 16;
    logfmt_raw(v18, 0x1000u, 0, v16);
    V_UNLOCK();
    LOWORD(v17) = -26476;
    HIWORD(v17) = (unsigned int)"put data length <= 1" >> 16;
    return zlog(g_zc, v17, 153, "xxtea_decode", 12, 53, 100, v18);
  }
  else
  {
