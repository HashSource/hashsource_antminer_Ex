int __fastcall recover_mining_rvn(int a1)
{
  ...
  V_LOCK();
  LOWORD(v2) = -17112;
  HIWORD(v2) = (unsigned int)"ue %04x resp value %04x" >> 16;
  ...
  if ( eeprom_phy_seq_level > 0xA )
  {
    ...
    V_INT((int)v9, v6, *(int *)(a1 + 248));
    LOWORD(v7) = 6000;
    HIWORD(v7) = (unsigned int)"ze: %lld, crc error: %s" >> 16;
    logfmt_raw((char *)v11, 0x1000u, 0, v10, v9[0], v9[1], v9[2], v9[3], v9[4], v9[5], v9[6], v10, v7);
    V_UNLOCK();
    LOWORD(v8) = 5292;
    HIWORD(v8) = (unsigned int)&unk_171494 >> 16;
    zlog(g_zc, v8, 174, "recover_mining_rvn", 18, 2185, 60, v11);
    return 31;
  }
  else
  {
