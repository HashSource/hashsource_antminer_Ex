int __fastcall sub_9BC58(int *a1, int a2)
{
  int v2; // r4
  void *v5; // r0
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v43, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_KS5_2382", a2);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  v5 = calloc(12 * a2, 1u);
  v23 = &v33;
  v6 = (void (__fastcall *)(int *, _DWORD *, int, void *, int *, int, int, _DWORD))a1[71];
  ptr = v5;
  v6(a1, v34, a2, v5, &v33, v24, 3000, 0);
  V_LOCK();
  V_INT((int)v35, "chain", a1[62]);
  logfmt_raw(
    v43,
    0x1000u,
    0,
  ...
  if ( v33 > 0 )
  {
    v26 = "ChipSetting_get_addr_KS5_2382";
    v29 = 0;
    v28 = "[GET ADDR] chip_type %04x/%04x chip %d reg %d addr %02x";
    v27 = "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/godminer"
    ...
    do
    {
      while ( 1 )
      {
        ...
        V_UNLOCK();
        zlog(g_zc, v27, 153, v26, 29, 64, 20, v43);
        if ( a1[82] == (unsigned __int16)v8 )
          break;
        v7 += 6;
        if ( v33 <= v2 )
          goto LABEL_7;
      ...
      V_UNLOCK();
      zlog(g_zc, v27, 153, v26, 29, 70, 20, v43);
    }
    while ( v33 > v2 );
LABEL_7:
    v2 = v29;
