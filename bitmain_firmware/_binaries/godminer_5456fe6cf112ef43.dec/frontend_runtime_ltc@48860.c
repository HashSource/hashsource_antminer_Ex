void *frontend_runtime_ltc()
{
  ...
  dword_16628C = (int)sub_48754;
  dword_166290 = (int)sub_487EC;
  dword_166294 = (int)sub_47CE0;
  dword_166288 = (int)sub_486A0;
  dword_166298 = (int)sub_4846C;
  dword_16629C = (int)stratum_subscribe_base;
  dword_1662A0 = (int)stratum_authorize_base;
  dword_1662A4 = (int)sub_47D18;
  dword_1662A8 = (int)sub_47A18;
