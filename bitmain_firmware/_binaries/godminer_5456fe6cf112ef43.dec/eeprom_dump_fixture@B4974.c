int __fastcall eeprom_dump_fixture(unsigned __int8 *a1)
{
  ...
  v2 = snprintf(s, 0x800u, "%-30s : 0x%04x\n", "key_version", *a1 & 0xF);
  V_LOCK(v2);
  ...
  zlog(
    ...
    100,
    v52);
  v4 = snprintf(s, 0x800u, "%-30s : 0x%04x\n", "algorithm_code", *a1 >> 4);
  V_LOCK(v4);
  ...
  zlog(
    ...
    100,
    v52);
  v6 = snprintf(s, 0x800u, "%-30s : 0x%04x\n", "fixture_info_len", a1[1]);
  V_LOCK(v6);
  ...
  zlog(
    ...
    100,
    v52);
  v8 = snprintf(s, 0x800u, "%-30s : 0x%04x\n", "fixture_standard", a1[45]);
  V_LOCK(v8);
  ...
  zlog(
    ...
    100,
    v52);
  v10 = snprintf(s, 0x800u, "%-30s : 0x%04x\n", "test_standard", a1[46]);
  V_LOCK(v10);
  ...
  zlog(
    ...
    100,
    v52);
  v14 = snprintf(s, 0x800u, "%-30s : 0x%02x\n", "fixture_fmt_version", a1[2]);
  V_LOCK(v14);
  ...
  zlog(
    ...
    100,
    v52);
  v18 = snprintf(s, 0x800u, "%-30s : 0x%02x-%02x\n", "pcb", a1[27], a1[28]);
  V_LOCK(v18);
  ...
  zlog(
    ...
    100,
    v52);
  v20 = snprintf(s, 0x800u, "%-30s : 0x%02x-%02x\n", "bom", a1[29], a1[30]);
  V_LOCK(v20);
  ...
  zlog(
    ...
    100,
    v52);
  v32 = snprintf(s, 0x800u, "%-30s : 0x%02x-%02x\n", "asic sensor", a1[20] >> 7, a1[20] & 0x7F);
  V_LOCK(v32);
  ...
  zlog(
    ...
    100,
    v52);
  v36 = snprintf(s, 0x800u, "%-30s : 0x%02x-%02x\n", "pic sensor", a1[25] >> 7, a1[25] & 0x7F);
  V_LOCK(v36);
  ...
  zlog(
    ...
    100,
    v52);
  v38 = snprintf(s, 0x800u, "%-30s : 0x%02x\n", "pic sensor addr", a1[26]);
  V_LOCK(v38);
  ...
  zlog(
    ...
    100,
    v52);
  v40 = snprintf(s, 0x800u, "%-30s : bin%d\n", "chip_bin", a1[15]);
  V_LOCK(v40);
