int __fastcall sub_C3018(_DWORD *a1, int a2)
{
  __int64 *v4; // r3
  __int64 *v5; // lr
  _DWORD *v6; // r8
  ...
  __int64 *v164; // [sp+90h] [bp-1CCh] BYREF
  __int64 *v165; // [sp+94h] [bp-1C8h]
  ...
  memcpy(dest, &unk_140DB8, sizeof(dest));
  v4 = (__int64 *)(a1 + 32);
  v5 = (__int64 *)&unk_140E80;
  v165 = (__int64 *)(a1 + 32);
  v6 = a1;
  ...
  {
    v119 = *((_DWORD *)v117 + 1);
    LODWORD(v115) = v115 ^ v114 ^ *(_DWORD *)v117;
    *(_DWORD *)v117++ = v115;
    *((_DWORD *)v117 - 1) = HIDWORD(v115) ^ HIDWORD(v114) ^ v119;
    if ( v116 == v117 )
      break;
    v118 = *v113++;
    v114 = v118;
