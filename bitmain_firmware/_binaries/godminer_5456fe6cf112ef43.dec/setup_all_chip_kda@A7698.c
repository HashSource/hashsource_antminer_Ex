int __fastcall setup_all_chip_kda(int a1)
{
  ...
  if ( !sub_A6CD8(a1) )
    return 3;
  v5 = *(_DWORD *)(a1 + 296);
  v6 = sub_12CC58(256, (unsigned __int8)v3);
  if ( (_BYTE)v3 )
  {
    v7 = v5 - 1;
    v8 = 0;
  ...
  v9 = *(int (__fastcall **)(int, int, int))(a1 + 148);
  *(_DWORD *)(a1 + 240) = v6;
  v10 = v9(a1, v5, v3);
  v20[2] = 4194305;
  v20[1] = 0;
  ...
  zlog(
    ...
    60,
    v21);
  (*(void (__fastcall **)(int, _DWORD *))(a1 + 156))(a1, v20);
  ...
  v12 = (char *)calloc(1u, 0x190u);
  v13 = *(_BYTE *)(a1 + 136);
  v14 = v12;
  v15 = rand();
  memset(v14 + 72, (unsigned __int8)(v13 + v15), 0x11Eu);
