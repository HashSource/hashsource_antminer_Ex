int sub_4D62C()
{
  ...
  {
    v4 = working_voltage + 20 - current_voltage;
    if ( v4 < 0 )
      v4 = current_voltage - (working_voltage + 20);
    if ( v4 > 4 )
    {
      V_LOCK(result);
      ...
      zlog(
        ...
        v14);
      v13 = is_power_init();
      return set_voltage_by_steps(working_voltage + 20, v13);
    }
  }
  return result;
}
