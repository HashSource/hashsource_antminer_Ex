int __fastcall sync_get_status_unclear_base(int a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v6; // r5
  ...
  if ( !*(_BYTE *)(a1 + 144) )
    return 4;
  v7 = (pthread_mutex_t *)(a1 + 688);
  pthread_mutex_lock((pthread_mutex_t *)(a1 + 688));
  v6 = 0;
  sub_12D53C(a5, a6, 1000, 0);
  v11 = 0;
  v18[1] = (_DWORD)&loc_F4240 * v12;
  v18[0] = sub_12D53C(a5, a6, 1000, 0);
  while ( v11 < a2 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 664), v19, 10, v18) == 110 )
      {
        v6 = 3;
        goto LABEL_12;
      }
