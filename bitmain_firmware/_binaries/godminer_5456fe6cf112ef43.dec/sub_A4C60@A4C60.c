int __fastcall sub_A4C60(int a1, int a2)
{
  int v2; // r9
  int v5; // r0
  int v6; // r0
  ...
  v6 = (*(int (__fastcall **)(int, _DWORD *, int, unsigned __int16 *, int *, int, int, _DWORD))(a1 + 176))(
         a1,
         v26,
         a2,
         ptr,
  ...
  if ( v25 > 0 )
  {
    ...
    do
    {
      ...
      zlog(
        ...
        v30);
      v8 = *(_DWORD *)(a1 + 196);
      if ( *(_DWORD *)(a1 + 192) == (unsigned __int16)__rev16(v11) )
        ++v23;
      if ( v8 > 0 )
      {
