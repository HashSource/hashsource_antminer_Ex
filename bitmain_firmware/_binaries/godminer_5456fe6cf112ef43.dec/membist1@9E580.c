int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_5C218(a1, v3, 12, 1);
    usleep(0x2710u);
    sub_5C218(a1, v3, 160, -2147483647);
    usleep((__useconds_t)&stru_1869C.st_value);
    v4 = ptr;
    v5 = sub_5C484(a1, (unsigned __int16)v3, 161, ptr);
    if ( v5 > 0 )
    {
      v6 = 3 * v5;
      v7 = &ptr[4 * v6];
...
LABEL_9:
    v9 = ptr;
    v10 = sub_5C484(a1, (unsigned __int16)v3, 162, ptr);
    if ( v10 > 0 )
    {
      v11 = 3 * v10;
      v12 = &ptr[4 * v11];
