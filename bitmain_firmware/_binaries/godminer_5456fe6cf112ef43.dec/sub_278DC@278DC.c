int __fastcall sub_278DC(int a1, const char **a2)
{
  int v3; // r5
  ...
  if ( v138 > 0 )
  {
    ...
    if ( v138 > 0 )
    {
      ...
      do
      {
        ...
        v126 = v138;
        v122 += 208;
        *(_DWORD *)&v124[4 * v3++] = *(_DWORD *)(*v123 + 140);
      }
      while ( v126 > v3 );
      v9 = v131;
    }
  ...
  {
    sub_25CE4();
    v17 = sub_12D578(LODWORD(v8), HIDWORD(v8));
  }
  else
  {
    v17 = 0;
  ...
  v19 = sub_12D578(COERCE_UNSIGNED_INT64(v14 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v14 * 100.0)));
  v20 = sub_12D224(v19, HIDWORD(v19));
  v21 = json_real(LODWORD(v20));
  json_object_set_new(v132, "rate_5s", v21);
  v22 = sub_12D578(COERCE_UNSIGNED_INT64(v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v15 * 100.0)));
  v23 = sub_12D224(v22, HIDWORD(v22));
  v24 = v23 / 100.0;
  ...
  if ( opt_algo == 5 )
    v16 = *(float *)&v24 * v16;
  v27 = sub_12D578(COERCE_UNSIGNED_INT64(v16 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v16 * 100.0)));
  v28 = sub_12D224(v27, HIDWORD(v27));
  v29 = json_real(LODWORD(v28));
  json_object_set_new(v132, "rate_avg", v29);
  v30 = strcmp(*(const char **)(*(_DWORD *)all_created_runtime + 188), "dash");
  v31 = v139;
  if ( v30 )
  {
    if ( opt_algo == 5 )
  ...
  v32 = v31 * 100.0;
LABEL_14:
  v33 = sub_12D578(LODWORD(v32), HIDWORD(v32));
  v34 = sub_12D224(v33, HIDWORD(v33));
  ...
  if ( v13 + total_diff1 )
  {
    v47 = sub_12D214(v13, HIDWORD(v13), (int)v13 + (int)total_diff1);
    v49 = sub_12D214(v46, HIDWORD(v46), v48);
    v50 = sub_12D578(
            COERCE_UNSIGNED_INT64(v47 / v49 * 100.0 * 10000.0),
            HIDWORD(COERCE_UNSIGNED_INT64(v47 / v49 * 100.0 * 10000.0)));
    v45 = sub_12D224(v50, HIDWORD(v50));
  }
  ...
  if ( v138 > 0 )
  {
    ...
    while ( 1 )
    {
      ...
      v61 = sub_12D578(LODWORD(v60), HIDWORD(v60));
      v62 = sub_12D224(v61, HIDWORD(v61));
      v63 = json_real(LODWORD(v62));
      json_object_set_new(v55, "rate_ideal", v63);
      v64 = sub_12D578(COERCE_UNSIGNED_INT64(v59 * v12 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v59 * v12 * 100.0)));
      v65 = sub_12D224(v64, HIDWORD(v64));
