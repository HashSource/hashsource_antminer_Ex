  ...
  else
  {
    ...
    *(_DWORD *)a2 = v4;
    ...
    LOWORD(v10) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/"
                                    "release/build/godminer-origin_master/backend/device/hal/platform/zynqmp/zynqmp_pwm.c";
  }
  HIWORD(v10) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/releas"
                              "e/build/godminer-origin_master/backend/device/hal/platform/zynqmp/zynqmp_pwm.c" >> 16;
  zlog(v9, v10, 168, "pwm_get", 7, v8, v7, v14);
  return v2;
}
