int __fastcall power_init(int a1)
{
  ...
  v2 = (unsigned __int8)byte_166340;
  if ( byte_166340 )
  {
    ...
    while ( &byte_16635C != v7 );
    if ( (unsigned __int16)word_166342 != v4 )
    {
      V_LOCK(v6);
...
LABEL_6:
    ...
    else
    {
      ...
      if ( opt_algo == 5 )
        return 0;
      if ( byte_16633C )
        v21 = (double)dword_166360 * 0.75 / 100.0;
      else
        v21 = -0.0075;
      v41 = 3;
      do
      {
        ...
        if ( v42 > 0 )
        {
          ...
          for ( i = 0; i < v42; ++i )
          {
            v26 = *(_DWORD *)(v24 + 4);
            v24 += 4;
            an_voltage1 = pic1704_get_an_voltage1((unsigned __int8)*(_DWORD *)(v26 + 140));
            V_LOCK(an_voltage1);
