int __fastcall serdes_phy_bist_external_all_phy(int a1, int a2, int a3, int a4)
{
  ...
  | ((_WORD)a4 << 8) & 0x700
  | (16 * (_BYTE)a4) & 0x70);
  sub_5D964(a1, 0xFFu, 61441, -15);
  sub_5D964(a1, 0xFFu, 61458, (2 * (_BYTE)a4) & 0xE);
  sub_5D964(a1, 0xFFu, 61441, 0);
  v9 = a4 & 0xF;
  v18[1] = 0;
  switch ( v9 )
  {
...
LABEL_7:
  ...
  zlog(
    ...
    60,
    v22);
  sub_5C218(a1, 0xFFu, 98, 255);
  enable_rxbist_autostop(a1, a2, 0xFFu, a3, 0x1Fu);
  read_rx_debug_reg2(a1, a2, (_BYTE *)0xFF, a3);
  sub_5D964(a1, 0xFFu, 61441, -9);
  sub_5D964(a1, 0xFFu, 61585, 8);
  sub_5D964(a1, 0xFFu, 61441, -1073741825);
  sub_5D964(a1, 0xFFu, 61559, 0x40000000);
  v13 = sub_5D964(a1, 0xFFu, 61441, 0);
  V_LOCK(v13);
  V_INT((int)v20, "chain");
  ...
  if ( a4 )
  {
    ...
    sub_5D964(a1, 0xFFu, 61441, -1073741825);
    sub_5D964(a1, 0xFFu, 61559, 0x40000000);
    v16 = sub_5D964(a1, 0xFFu, 61441, 0);
    V_LOCK(v16);
    V_INT((int)v21, "chain");
