        ...
        unsigned __int8 a9)
{
  ...
  | ((_WORD)a4 << 8) & 0x700
  | (16 * a4) & 0x70);
  sub_5D964(a1, a7, v14, -15);
  sub_5D964(a1, a7, v12, (2 * (_BYTE)a4) & 0xE);
  v15 = sub_5D964(a1, a7, v14, 0);
  if ( a5 )
  {
    v23 = a5 >> 1;
    if ( a5 >> 1 )
  ...
  while ( 1 )
  {
    ...
    sub_5D964(a1, a7, (unsigned __int16)(a9 << 12) | 1, -9);
    sub_5D964(a1, a7, (unsigned __int16)(a9 << 12) | 0x91, 8);
    sub_5D964(a1, a7, (unsigned __int16)(a9 << 12) | 1, -1073741825);
    sub_5D964(a1, a7, v29, 0x40000000);
    sub_5D964(a1, a7, (unsigned __int16)(a9 << 12) | 1, 0);
    usleep((__useconds_t)&loc_F4240);
    check_bist_tx_running_one_lane(a1, a2, a6, a8);
    check_bist_rx_running_one_lane(a1, a2, a7, a9);
    usleep(0x493E0u);
    sub_5D964(a1, a7, (unsigned __int16)(a9 << 12) | 1, -9);
    sub_5D964(a1, a7, (unsigned __int16)(a9 << 12) | 0x91, 0);
    sub_5D964(a1, a7, (unsigned __int16)(a9 << 12) | 1, 0);
