int __fastcall sub_287E0(int a1, const char **a2)
{
  int v2; // r4
  char *v5; // r7
  ...
  {
    sub_25CE4();
    v16 = sub_12D578(LODWORD(v11), HIDWORD(v11));
  }
  else
  {
    v16 = 0;
  ...
  v18 = sub_12D578(COERCE_UNSIGNED_INT64(v14 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v14 * 100.0)));
  v19 = sub_12D224(v18, HIDWORD(v18));
  v20 = json_real(LODWORD(v19));
  json_object_set_new(v10, "rate_5s", v20);
  v21 = sub_12D578(COERCE_UNSIGNED_INT64(v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v15 * 100.0)));
  v22 = sub_12D224(v21, HIDWORD(v21));
  v23 = v22 / 100.0;
...
LABEL_19:
  ...
  v38 = json_integer(dword_164FF8, dword_164FFC);
  v39 = json_object_set_new(v10, "bestshare", v38);
  appended = json_array(v39);
  v41 = appended;
  if ( appended && off_163320 )
  {
    v42 = &off_163320;
    do
    {
