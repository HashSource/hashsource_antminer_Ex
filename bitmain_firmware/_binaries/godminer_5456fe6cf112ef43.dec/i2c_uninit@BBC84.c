int __fastcall i2c_uninit(int a1)
{
  ...
  {
    if ( exists_c_map((_DWORD *)dword_16C6E4) == (_DWORD *)1 )
    {
      find_c_map((_DWORD *)dword_16C6E4, (int)&v10, (int)&v11);
      v6 = (int *)v11;
      ...
      zlog(
        ...
        40,
        v13);
      remove_c_map((_DWORD *)dword_16C6E4);
    }
    else
    {
    ...
    v3 = new_iterator_c_map(dword_16C6E4);
    if ( ((int (*)(void))*v3)() )
    {
    ...
    return pthread_mutex_unlock(&stru_16C6C8);
  }
}
