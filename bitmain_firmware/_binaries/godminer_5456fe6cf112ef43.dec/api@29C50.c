...
LABEL_102:
      ...
      *(_DWORD *)s1 = servlen;
      ...
      if ( !v24 || *v24 )
      {
        ...
        sub_255C4(v23, v119, (int)v123, 2u);
        goto LABEL_33;
      }
      ...
      if ( v49 && *v49 == 2 )
      {
        ...
        if ( v96 && *v96 == 5 )
        {
          ...
          {
            v106 = protocol;
            sub_255C4(v23, v119, (int)v123, protocol);
            goto LABEL_33;
          }
          v98 = protocol;
        }
        else
        {
          ...
          {
            v106 = 1;
            sub_255C4(v23, v119, (int)v123, 1u);
            goto LABEL_33;
          }
          v98 = 1;
        }
        ...
        if ( v101 )
        {
          sub_255C4(v23, v119, (int)v123, v98);
        }
        else
        {
          json_delete(v25);
          sub_255C4(v23, v119, (int)v123, v106);
        }
      }
      else
      {
        ...
        zlog(
          ...
          100,
          v143);
        sub_235C8(v23, 0, 24, "Missing JSON 'command'");
      }
LABEL_33:
      if ( v106 == 2 )
      {
