void *frontend_runtime_eth()
{
  ...
  dword_16604C = (int)sub_3EFC0;
  dword_166050 = (int)sub_3F5CC;
  dword_166054 = (int)sub_3EF54;
  dword_166048 = (int)sub_3EE1C;
  dword_166058 = (int)sub_3EEF0;
  dword_16605C = (int)stratum_subscribe_base;
  dword_166060 = (int)stratum_authorize_eth;
  dword_166068 = (int)sub_3EE14;
