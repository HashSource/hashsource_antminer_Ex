        ...
        int a7)
{
  ...
  | (a5 << 8) & 0x700
  | (16 * a5) & 0x70);
  sub_5D964(a1, (unsigned __int8)a3, v12, -15);
  sub_5D964(a1, (unsigned __int8)a3, v10, (2 * a5) & 0xE);
  v13 = sub_5D964(a1, (unsigned __int8)a3, v12, 0);
  if ( a6 )
  {
    v20 = a6 >> 1;
    if ( a6 >> 1 )
...
LABEL_20:
  ...
  read_rx_debug_reg2_one_lane(a1, a2, a3, 7u);
  sub_5C218(a1, (unsigned __int8)a3, 144, -9);
  sub_5C218(a1, (unsigned __int8)a3, 145, -2147467263);
  sub_5C218(a1, (unsigned __int8)a3, 144, 8);
  sub_5C218(a1, (unsigned __int8)a3, 145, -2147467119);
  sub_5C218(a1, (unsigned __int8)a3, 144, -1073741825);
  sub_5C218(a1, (unsigned __int8)a3, 145, -2147467263);
  sub_5C218(a1, (unsigned __int8)a3, 144, 0x40000000);
  sub_5C218(a1, (unsigned __int8)a3, 145, -2147467145);
  sub_5C218(a1, (unsigned __int8)a3, 144, 0);
  sub_5C218(a1, (unsigned __int8)a3, 145, -2147467263);
  usleep((__useconds_t)&loc_F4240);
