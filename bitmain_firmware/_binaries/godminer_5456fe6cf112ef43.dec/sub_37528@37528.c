int __fastcall sub_37528(int *a1, int **a2)
{
  int v4; // r6
  int v6; // r7
  bool v7; // zf
...
LABEL_95:
                  ...
                  {
                    sub_36448(a1, "<internal>", 1, "Unable to append to array");
                    a1[19] = 1;
                  }
                }
              }
          ...
          sub_36448(a1, "<format>", 9, "Unexpected end of format string");
        }
        break;
      }
      if ( !v4 || *(_DWORD *)(v4 + 4) == -1 )
    ...
    case 'f':
      *a2 = (int *)((((unsigned int)*a2 + 7) & 0xFFFFFFF8) + 8);
      ...
      if ( json_real_set() )
      {
        ...
        sub_36448(a1, "<args>", 15, "Invalid floating point value");
        v4 = 0;
        a1[19] = 1;
      }
      return v4;
    case 'i':
      ...
      {
LABEL_49:
        sub_36448(a1, "<internal>", 1, "Out of memory");
        a1[19] = 1;
      }
      return v4;
    case 'n':
    ...
    case 's':
      ...
      if ( v7 )
      {
        v15 = sub_365D8((int)a1, (size_t **)a2, "string", &v57, v58, v8);
        if ( !v15 )
        {
          if ( v6 == 63 && !a1[19] )
            return json_null();
    ...
    case '{':
      ...
      break;
    default:
      sub_36448(a1, "<format>", 9, "Unexpected format character '%c'", *((unsigned __int8 *)a1 + 36));
      v4 = 0;
      a1[19] = 1;
      return v4;
  }
  while ( 1 )
  {
    ...
    if ( v16 != 115 )
      break;
    v17 = (char *)sub_365D8((int)a1, (size_t **)a2, "object key", &v57, v58, 0);
    sub_364A8(a1);
    sub_364A8(a1);
    v18 = a1[7];
    v19 = a1[8];
...
LABEL_16:
        ...
        {
          sub_36448(a1, "<internal>", 1, "Unable to add key \"%s\"", v17);
          a1[19] = 1;
        }
      }
      if ( !v58[0] )
...
LABEL_32:
    ...
    if ( v21 != 42 )
    {
      sub_36448(a1, "<args>", 12, "NULL object value");
      a1[19] = 1;
    }
LABEL_19:
    sub_364A8(a1);
  }
  sub_36448(a1, "<format>", 9, "Expected format 's', got '%c'", *((unsigned __int8 *)a1 + 36));
LABEL_85:
  if ( v4 && *(_DWORD *)(v4 + 4) != -1 )
  {
