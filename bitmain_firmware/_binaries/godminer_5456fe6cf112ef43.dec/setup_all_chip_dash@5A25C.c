int __fastcall setup_all_chip_dash(int a1)
{
  ...
  sub_57EF0(a1);
  usleep(0x4E20u);
  v10 = eeprom_read(*(_DWORD *)(a1 + 140), 195, &v26, 1);
  V_LOCK(v10);
  ...
  {
    *(_BYTE *)(a1 + 310) = 1;
    v19 = eeprom_read(*(_DWORD *)(a1 + 140), 196, &v27, 1);
    V_LOCK(v19);
    ...
    zlog(
      ...
      v28);
    v21 = v27;
    v22 = eeprom_read(*(_DWORD *)(a1 + 140), 197, &v27, 1);
    V_LOCK(v22);
    ...
    v24 = zlog(
            ...
            20,
            v28);
    *(double *)(a1 + 312) = (double)(v27 | (v21 << 8)) * 1000.0 * 1000.0 * 1000.0;
    V_LOCK(v24);
