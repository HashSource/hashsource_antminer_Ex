int __fastcall serdes_phy_bist_internal_serial(int a1, int a2, _DWORD *a3, int a4, unsigned __int8 a5)
{
  ...
  | (a5 << 8) & 0x700
  | (16 * a5) & 0x70);
  sub_5D964(a1, (unsigned __int8)a3, v13, -15);
  sub_5D964(a1, (unsigned __int8)a3, v16, (2 * a5) & 0xE);
  sub_5D964(a1, (unsigned __int8)a3, v13, 0);
  sub_5C218(a1, (unsigned __int8)a3, 98, 255);
  check_bist_tx_running(a1, a2, a3, a4);
  sub_5D964(a1, (unsigned __int8)a3, v13, -13);
  sub_5D964(a1, (unsigned __int8)a3, v17, 12);
  sub_5D964(a1, (unsigned __int8)a3, v13, 0);
  config_rxifrx_sigdet_ovr(a1, a2, (unsigned __int8)a3, a4);
  read_rx_debug_reg2(a1, a2, a3, a4);
  sub_5D964(a1, (unsigned __int8)a3, v13, -9);
  sub_5D964(a1, (unsigned __int8)a3, v14, 8);
  sub_5D964(a1, (unsigned __int8)a3, v13, -1073741825);
  sub_5D964(a1, (unsigned __int8)a3, v10, 0x40000000);
  sub_5D964(a1, (unsigned __int8)a3, v13, 0);
  usleep((__useconds_t)&stru_1869C.st_value);
  check_bist_rx_running(a1, a2, (int)a3, a4);
  sub_5D964(a1, (unsigned __int8)a3, v13, -9);
  sub_5D964(a1, (unsigned __int8)a3, v14, 0);
  sub_5D964(a1, (unsigned __int8)a3, v13, 0);
