void *frontend_runtime_ckb()
{
  ...
  dword_165F24 = (int)sub_3C520;
  dword_165F28 = (int)sub_3C588;
  dword_165F2C = (int)sub_3BF38;
  dword_165F20 = (int)sub_3C46C;
  dword_165F30 = (int)sub_3C2EC;
  dword_165F34 = (int)stratum_subscribe_base;
  dword_165F38 = (int)stratum_authorize_base;
  dword_165F3C = (int)sub_3BF70;
  dword_165F40 = (int)sub_3BB94;
