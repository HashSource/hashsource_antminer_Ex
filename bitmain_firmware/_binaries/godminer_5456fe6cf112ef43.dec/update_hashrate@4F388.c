  ...
  *(double *)(a2 + 48) = v61;
  ...
  if ( *(_QWORD *)(a1 + 256) )
  {
    ...
    v9 = 1000LL * (*(_DWORD *)((char *)&unk_167990 + v6 + 12) - *(_DWORD *)((char *)&unk_167990 + v6 + 4))
       + v7 / 1000000;
    v10 = COERCE_FLOAT(((int (__fastcall *)(_DWORD, _DWORD, int))sub_12D420)(v9, HIDWORD(v9), v8));
    v11 = v10 / 1000.0;
    if ( (float)(v10 / 1000.0) >= 5.0 )
    {
      ...
      {
        v45 = (float)(sub_12D410(v44, HIDWORD(v44)) / v11) * (float)*(unsigned int *)(a1 + 244);
      }
      else
      {
        v53 = COERCE_FLOAT(
                ((int (__fastcall *)(int, unsigned int))sub_12D410)(
                  1 << *(_DWORD *)(a1 + 244),
                  (1 << (*(_DWORD *)(a1 + 244) - 32)) | (1u >> (32 - *(_DWORD *)(a1 + 244)))));
        v45 = v53 * (float)(sub_12D410(v44, HIDWORD(v44)) / v11);
      }
      ...
      *((float *)&unk_167A78 + 724 * v5 + v47) = v45;
      ...
      v51 = v45 + (float)(sub_12D410(v49, v50) * *(float *)(a2 + 40));
      v52 = sub_12D410(v54, HIDWORD(v54));
      *((_QWORD *)v46 + 361) = v54;
      *(float *)(a2 + 40) = v51 / v52;
    }
    else
    ...
    *(_QWORD *)(a2 + 72) = v26;
    ...
    v30 = 1000LL * (*(_DWORD *)((char *)&unk_167990 + v56 + 76) - *(_DWORD *)((char *)&unk_167990 + v56 + 68))
        + v29 / 1000000;
    if ( (float)(sub_12D420(v30, HIDWORD(v30), 1125899907 * v29) / 1000.0) < 900.0 )
      goto LABEL_41;
    if ( v54 > 0xB3 )
    {
      v32 = 180.0;
...
LABEL_41:
    if ( !strcmp(*(const char **)(a1 + 188), "dash") )
    {
      ...
      if ( (float)(sub_12D420(v41, HIDWORD(v41), 1000) / 1000.0) >= 3000.0 )
      {
