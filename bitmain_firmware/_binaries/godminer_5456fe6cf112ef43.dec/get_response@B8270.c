int __fastcall get_response(int a1)
{
  ...
  v4 = snprintf(v3, 0x40u, "%.10s_%d", "get_response", *(_DWORD *)(a1 + 136));
  V_LOCK(v4);
  syscall(224);
  ...
  {
    v7 = dev_ctrl((int)v6);
    v8 = (*(int (__fastcall **)(_DWORD, _BYTE *, int))(v7 + 52))(*(_DWORD *)(a1 + 136), v13, 256);
    v9 = *(unsigned __int8 *)(a1 + 685);
    v10 = v8;
    if ( *(_BYTE *)(a1 + 685) )
      break;
    if ( v8 <= 0 )
    ...
    {
      v2 = 64;
      queue_enqueue(*(_DWORD *)(a1 + 656), v13, v8);
