int __fastcall phy_external_bist_init(int a1, unsigned int a2, unsigned __int8 a3, int a4, int a5)
{
  ...
  int v20; // r0
  int v21; // r0
  unsigned __int8 v22; // [sp+38h] [bp-10DCh]
  unsigned __int8 v23; // [sp+3Ch] [bp-10D8h]
  ...
  zlog(
    ...
    60,
    v33);
  sub_6F0E8(a1, v26, 86, 3670024);
  usleep(0x12Cu);
  sub_6F0E8(a1, v26, 85, 109905420);
  usleep(0x12Cu);
  sub_6F0E8(a1, v26, 101, -268374016);
  usleep(0x12Cu);
  sub_6F0E8(a1, v26, 64, 256);
  usleep(0x12Cu);
  sub_6F0E8(a1, v26, 80, 33423870);
  usleep(0x12Cu);
  sub_6F0E8(a1, v26, 81, 832516511);
  usleep(0x12Cu);
  sub_6F0E8(a1, v26, 88, -1);
  usleep(0x12Cu);
  v12 = check_core_reg_with_expect_data(a1, a2, v26, 125, 0x70007000u);
  if ( v12 )
  {
    V_LOCK(v12);
    V_INT((int)v29, "chain");
    ...
    zlog(
      ...
      "godminer-new/backend/backend_eth_2280/backend_eth_phy_set.c",
      173,
      "phy_external_bist_init",
      22,
      1041,
  ...
  phy_eq_main_set_by_apb(a1, a2, &v26, 1, v22);
  phy_eq_pre_set_by_apb(a1, a2, &v26, 1, v25);
  phy_eq_post_set_by_apb(a1, a2, &v26, 1, v23);
  sub_6F0E8(a1, v26, 86, 137889800);
  usleep(0x12Cu);
  sub_6F0E8(a1, v26, 80, 0);
  usleep(0x12Cu);
