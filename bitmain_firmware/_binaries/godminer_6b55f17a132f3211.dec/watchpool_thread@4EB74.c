  ...
  while ( 1 )
  {
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        while ( 1 )
        {
          v5 = *(_DWORD *)(pools + 4 * v4++);
          if ( !pool_tget(v5, (unsigned __int8 *)(v5 + 1896)) )
          {
            v6 = *(_DWORD *)(v5 + 4);
            current_pool = get_current_pool();
            if ( v6 < *(_DWORD *)(current_pool + 4) && v24.tv_sec - *(_DWORD *)(v5 + 1900) > 120 )
              break;
          }
          if ( total_pools <= v4 )
            goto LABEL_9;
...
LABEL_9:
    v16 = get_current_pool();
    if ( pool_tget(v16, (unsigned __int8 *)(v16 + 1896)) )
      switch_pools();
    sleep(0x1Eu);
  }
}
