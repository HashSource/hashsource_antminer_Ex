int __fastcall sub_4BB6C(int a1, int *a2, int a3)
{
  size_t *v4; // r1
  size_t v6; // r6
  void *v7; // r0
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      if ( v6 >= 8 )
        ...
        v36 = v6;
      v8 = memcpy(v7, &dword_165F48, v36);
      ++*(_QWORD *)&dword_165F48;
    }
    memcpy((void *)(a2[73] + a2[21]), v8, v6);
    sha256(a2[73], a2[72]);
    sha256((int)&v47, 0x20u);
    v9 = a2[79];
    v47 = v37;
    v48 = v38;
    v49 = v39;
