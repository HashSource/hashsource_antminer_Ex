bool __fastcall sub_65EE8(int a1, int a2, char **a3)
{
  char v3; // r3
  _DWORD *v5; // r8
  int v6; // r0
  ...
  BYTE1(v39) = v3;
  v5 = calloc(0xCu, 1u);
  v6 = (*(int (__fastcall **)(int, int *, int, _DWORD *, int *))(a1 + 248))(a1, &v37, 1, v5, &v36);
  if ( v36 <= 0 )
  {
    v34 = 0;
  }
...
LABEL_9:
  ...
  *a3 = v34;
  ...
  v15 = (*(int (__fastcall **)(int, int *, int, _WORD *, int *, int, int, _DWORD, int, int, int, int, const char *, int, int, int))(a1 + 256))(
          a1,
          &v37,
          v14,
          ptr,
