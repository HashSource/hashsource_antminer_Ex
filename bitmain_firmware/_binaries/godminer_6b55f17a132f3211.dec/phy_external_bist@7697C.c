int __fastcall phy_external_bist(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  if ( a4 )
  {
    ...
    do
    {
      ...
      {
        v12 = *++v11;
        v13 = check_core_reg_with_expect_data(a1, a2, v12, 64, 0xFF000100);
        if ( v13 )
          break;
        if ( v11 == v10 )
          goto LABEL_6;
...
LABEL_6:
    ...
    {
      v17 = *++v16;
      sub_6F0E8(a1, v17, 133, 0xFFFF);
      sub_6F0E8(a1, *v16, 134, 1342177279);
    }
    while ( v11 != v16 );
    sub_6F0A4(a1, 132, -2147483647);
    sleep(0xAu);
    do
    {
      while ( 1 )
      {
        v18 = *++v15;
        v19 = check_core_reg_with_expect_data(a1, a2, v18, 139, 0xFF0000FF);
        if ( v19 )
          break;
        if ( v16 == v15 )
          goto LABEL_12;
...
LABEL_31:
  ...
  free(ptr);
  v47 = *(_QWORD *)&dword_176F08;
  v48 = &v72[8];
  v49 = *(_QWORD *)&dword_176F10;
  for ( i = &v73[1]; ; ++i )
  {
    v47 += v46;
    v49 += a4;
  ...
  *(_QWORD *)&dword_176F08 = v47;
  *(_QWORD *)&dword_176F10 = v49;
  V_LOCK(v47);
  V_INT((int)&v69, "chain");
