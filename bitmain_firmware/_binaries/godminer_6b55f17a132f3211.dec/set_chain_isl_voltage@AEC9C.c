int __fastcall set_chain_isl_voltage(unsigned __int8 a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    {
      v14 = -1;
      sub_AE678(v4, v5, 0, &v14, 1);
      usleep((__useconds_t)&stru_186A0);
      v15 = v3;
      sub_AE678(v4, v5, 33, (char *)&v15, 2);
      usleep((__useconds_t)&loc_30D40);
      v7 = sub_AEB78(v4, v5, &v16);
      ...
      zlog(
        *v2,
        ...
        "n_godminer-new/backend/device/hal/drv_pic/isl68127.c",
        164,
        ...
        60,
        v17);
      v7 = usleep((__useconds_t)&loc_30D40);
