int __fastcall sub_792A4(int a1, int a2)
{
  _DWORD *v2; // r6
  int v3; // r2
  int *v5; // r10
...
LABEL_6:
      *v5 = v14;
      v15 = v37;
      v16 = v6 + 2 * *(_DWORD *)(a1 + 208);
      v17 = v14 - *(unsigned __int8 *)(a1 + 928) - v37;
      v18 = v16;
      if ( v17 < 0 )
        v17 = v37 - (v14 - *(unsigned __int8 *)(a1 + 928));
      v19 = dword_1636F0[v16];
      v20 = v17 <= 3;
      v21 = dword_1636F0[v18 + 6];
      if ( v20 )
        goto LABEL_18;
      v22 = v19 == -64;
      if ( v19 == -64 )
      ...
      if ( v23 > v24 )
      {
        ...
        zlog(
          ...
          v47);
        v14 = v38;
        v15 = v38 - *(unsigned __int8 *)(a1 + 928);
        *(v5 - 1) = v15;
        v34 = *(_DWORD *)(a1 + 208);
        v37 = v15;
LABEL_32:
      ...
      if ( v23 < v24 )
      {
        ...
        zlog(
          ...
          v47);
        v15 = v37;
        v14 = *(unsigned __int8 *)(a1 + 928) + v37;
        *v5 = v14;
        v38 = v14;
        v34 = *(_DWORD *)(a1 + 208);
        goto LABEL_32;
...
LABEL_18:
      ++v6;
      if ( v19 != v15 )
        dword_1636F0[v16] = v15;
      if ( v21 != v14 )
        dword_1636F0[v18 + 6] = v14;
      v2 += 6;
      v5 += 2;
    }
    while ( v36 != v6 );
