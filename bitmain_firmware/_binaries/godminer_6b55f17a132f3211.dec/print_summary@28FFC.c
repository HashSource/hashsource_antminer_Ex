int print_summary()
{
  ...
  __int64 v68; // r4
  int v69; // r0
  int v70; // [sp+4h] [bp-2078h]
  int v71; // [sp+18h] [bp-2064h]
  _DWORD *v72; // [sp+1Ch] [bp-2060h]
  int v73; // [sp+20h] [bp-205Ch]
  int v74; // [sp+20h] [bp-205Ch]
  int i; // [sp+2Ch] [bp-2050h]
  int v76; // [sp+3Ch] [bp-2040h] BYREF
  int v77; // [sp+40h] [bp-203Ch] BYREF
  char v78[4040]; // [sp+78h] [bp-2004h] BYREF
  _BYTE v79[4100]; // [sp+1078h] [bp-1004h] BYREF

  read_system_status_from_monitor(&v77);
  get_miner_elapsed_time();
  v0 = sub_122014(total_accepted, dword_177F6C);
  V_LOCK(LODWORD(v0));
  ...
  if ( *(_QWORD *)&total_accepted || *(_QWORD *)&total_rejected )
  {
    ...
    sub_122014(100 * total_rejected, (unsigned __int64)(100LL * *(_QWORD *)&total_rejected) >> 32);
    sub_122014(v49 + total_accepted, (unsigned __int64)(v49 + *(_QWORD *)&total_accepted) >> 32);
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        v36 = zlog(
                ...
                80,
                v79);
        if ( *(_QWORD *)(v53 + 1920) || *(_QWORD *)(v53 + 1928) )
        {
          V_LOCK(v36);
          v68 = *(_QWORD *)(v53 + 1928);
          sub_122014(100 * v68, (unsigned __int64)(100 * v68) >> 32);
          sub_122014(v68 + *v54, (unsigned __int64)(v68 + *(_QWORD *)v54) >> 32);
