int __fastcall sub_6F13C(int a1, int a2, __int16 a3, void *a4)
{
  int v4; // r10
  ...
  v4 = *(_DWORD *)(a1 + 384);
  v5 = a2;
  LOWORD(v6) = (unsigned __int16)"ChipSetting_get_core_status_ETH";
  if ( a2 == 255 )
    v4 *= 16;
  HIWORD(v6) = (unsigned int)"ChipSetting_get_core_status_ETH" >> 16;
  v25 = 0;
  V_LOCK(a1);
  ...
  src = v11;
  v13 = v11;
  v14 = (*(int (__fastcall **)(int, _DWORD *, int, char *, int *, int, int, _DWORD))(a1 + 256))(
          a1,
          v26,
          v12,
          v11,
