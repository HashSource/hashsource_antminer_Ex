int __fastcall stratum_thread(int a1)
{
  ...
  if ( v4 )
  {
    ...
    v8 = snprintf(v7, 0x40u, "%.10s_%d", "stratum_thread", *(_DWORD *)v5);
    V_LOCK(v8);
    syscall(224);
    ...
    zlog(
      ...
      v36);
    prctl(15, v7);
    v4 = _strdup(*(const char **)(v5 + 8));
    *(_DWORD *)(v5 + 28) = v4;
    if ( v4 )
    {
      v30 = (_BYTE *)(v5 + 1908);
      pool_tset(v5, (_BYTE *)(v5 + 1896), 0);
      pool_tclear(v5, (_BYTE *)(v5 + 1908), 0);
      v31 = 1;
      dword_165B14 = 0;
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( !v13 )
              {
                v15 = (*(int (__fastcall **)(int, int))(v2 + 16))(v2, v5);
                if ( v15 )
                  break;
              }
              (*(void (__fastcall **)(int, int))(v2 + 4))(v5, v14);
              pool_tclear(v5, v30, 0);
              pool_died(v5);
              v16 = v11;
              v11 = (__PAIR64__(v11, v10) + 1) >> 32;
              v17 = sub_12228C(v10, v16, 50, 0);
              if ( !v18 )
              {
                V_LOCK(v17);
...
LABEL_11:
          if ( v5 != get_current_pool() )
            wait_pool_to_be_current_timeout(v5);
          if ( stratum_socket_full(v5, v32) )
            break;
          V_LOCK(0);
          ...
          zlog(
            ...
            v36);
LABEL_21:
          v24 = *(_DWORD *)(v5 + 1940) + 1;
          pools_active = 0;
          v25 = *(void (__fastcall **)(int))(v2 + 4);
          ++total_go;
          *(_DWORD *)(v5 + 1940) = v24;
          v25(v5);
          pool_tclear(v5, v30, 0);
        ...
        v19 = (*(int (__fastcall **)(int))(v2 + 8))(v5);
        v20 = (void *)v19;
        if ( !v19 )
          goto LABEL_21;
        if ( !(*(int (__fastcall **)(int, int, int))(v2 + 20))(v2, v5, v19) )
          (*(void (__fastcall **)(int, void *, int))(v2 + 28))(v2, v20, v5);
        free(v20);
        pools_active = 1;
      }
    }
