int __fastcall sub_4B260(_DWORD *a1, __int64 *a2)
{
  __int64 v2; // r2
  const char *v5; // r1
  int v6; // r12
  ...
  v6 = a1[52];
  v24[120] = dword_165E18;
  v24[121] = BYTE1(dword_165E18) | ((_BYTE)v6 << 6);
  ...
  zlog(
    ...
    "dminer-new/dhash_content/hns/hns_2130/hns_2130_content.c",
    172,
    "push_work_hns_2130",
    18,
    46,
