int __fastcall sub_7F1A8(int a1)
{
  int v2; // r0
  int v3; // r6
  ...
  v32 = 0;
  v36[1] = 0;
  v4 = *(int (__fastcall **)(int, _DWORD *))(a1 + 232);
  while ( 1 )
  {
    if ( v3 == 3 )
      goto LABEL_12;
    ...
    v10 = (*(int (__fastcall **)(int, _DWORD *, int, int *, int *, int, int, _DWORD, int, int, int, int, const char *, int, int, int, int, int))(a1 + 256))(
            a1,
            v36,
            v9,
            ptr,
