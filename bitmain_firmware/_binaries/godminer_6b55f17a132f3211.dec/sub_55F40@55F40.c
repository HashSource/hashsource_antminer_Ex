int __fastcall sub_55F40(_DWORD *a1)
{
  signed int *v1; // r0
  signed int v2; // r4
  int v3; // r0
  ...
  if ( v4 && *v4 == 2 )
  {
    ...
    if ( v7 && *v7 == 1 )
    {
      ...
      dword_178844 = (int)v9;
      dword_17885C = (int)calloc((size_t)v9, 2u);
      if ( (int)v9 > 0 )
      {
        do
        {
        ...
        if ( v17 && (unsigned int)(*v17 - 5) <= 1 )
        {
          ...
          if ( v20 && *v20 == 3 )
          {
            ...
            zlog(
              ...
              20,
              v43);
            dword_17884C = json_integer_value(v21);
            ...
            if ( v23 && *v23 == 3 )
            {
              ...
              zlog(
                ...
                20,
                v43);
              dword_178850 = json_integer_value(v24);
