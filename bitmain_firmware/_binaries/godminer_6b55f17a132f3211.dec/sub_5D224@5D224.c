int __fastcall sub_5D224(int a1, char a2)
{
  int v3; // r5
  _DWORD *v4; // r11
  int v5; // r0
  ...
  v5 = (*(int (__fastcall **)(int, _DWORD *, _DWORD *, _DWORD *, int *))(a1 + 248))(a1, v17, v6, v4, &v15);
...
LABEL_7:
  ...
  zlog(
    *v6,
    ...
    40,
    v22);
  v12 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 228))(a1, v17);
  usleep(0x2710u);
  return v12;
}
