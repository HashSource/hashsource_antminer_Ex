int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned __int16 a3, int a4)
{
  ...
  sub_8E400(a1, a3, 133, 255);
  usleep(0x64u);
  sub_8E400(a1, a3, 134, 255);
  usleep(0x64u);
  sub_8E400(a1, a3, 132, -2147483647);
  sleep(6u);
    ...
    if ( v19 )
    {
      ...
      do
      {
        ...
        v20 = zlog(
                ...
                "er-origin_godminer-new/backend/backend_rvn_2020/backend_rvn_phy_set.c",
                173,
                "phy_internal_bist_rvn",
                21,
                963,
