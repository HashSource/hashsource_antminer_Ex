int __fastcall sub_83CAC(_DWORD *a1, int a2)
{
  const char *v2; // r4
  void *v5; // r0
  int v6; // r0
  ...
  v7 = calloc(12 * a2, 1u);
  v43 = (char *)&v69;
  v8 = (int (__fastcall *)(_DWORD *, _DWORD *, int, void *, int *, char *, int, _DWORD))a1[62];
  ptr = v7;
  v9 = v8(a1, v70, a2, v7, &v69, v44, 3000, 0);
  V_LOCK(v9);
  V_INT((int)v71, "chain");
  v52 = "ChipSetting_get_addr_LTC_1489";
  v53 = v69;
  ...
  if ( v69 > 0 )
  {
    v62 = "ChipSetting_get_addr_LTC_1489";
    v65 = 0;
    v64 = "[GET ADDR] chip_type %04x/%04x chip %d reg %d addr %02x";
    v63 = "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/tmp/debug/build/godminer-ori"
          "gin_godminer-new/./backend/chip_setting.c";
    ...
    do
    {
      while ( 1 )
      {
        ...
        V_UNLOCK(v16);
        v11 = zlog(g_zc, v63, 151, v62, 29, 46, 20, v81);
        if ( a1[71] == (unsigned __int16)v13 )
          break;
        v12 += 6;
        if ( v69 <= (int)v2 )
          goto LABEL_7;
      ...
      V_UNLOCK(v29);
      v11 = zlog(g_zc, v63, 151, v62, 29, 52, 20, v81);
    }
    while ( v69 > (int)v2 );
LABEL_7:
    v2 = v65;
