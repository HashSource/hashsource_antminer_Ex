void ui_uninit()
{
  ...
  {
    dword_177430 = 0;
    pthread_join(dword_177468, 0);
    delete_c_map(dword_17744C);
    v0 = pthread_mutex_destroy(&stru_177434);
    v1 = hal_key_reset_addr(v0);
    v2 = gpio_unreg_callback(v1, (int)sub_A1DFC);
    v3 = hal_key_ipreport_addr(v2);
    v4 = gpio_unreg_callback(v3, (int)sub_A1DFC);
