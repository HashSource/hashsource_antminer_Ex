void *__fastcall sph_luffa384_addbits_and_close(unsigned int *a1, char a2, char a3, _BYTE *a4)
{
  ...
  int v315; // [sp+90h] [bp-4Ch]
  int v316; // [sp+90h] [bp-4Ch]
  int v317; // [sp+94h] [bp-48h]
  ...
  *((_BYTE *)a1 + v5) = (128 >> a3) | a2 & -(128 >> a3);
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v50 == 8 )
        break;
      v225 = dword_1508B8[v50];
      v57 = dword_1508D8[v50];
    }
    v92 = 23617341;
    v301 = v61;
    v315 = v56;
    ...
    while ( 1 )
    {
      ...
      if ( v93 == 8 )
        break;
      v226 = dword_1508F8[v93];
      v92 = dword_150918[v93];
    }
    v132 = 0;
    v293 = v94;
    v265 = v95;
    ...
    while ( 1 )
    {
      ...
      if ( v132 == 8 )
        break;
      v227 = dword_150938[v132];
      v133 = dword_150958[v132];
    }
    v172 = -534197825;
    v232 = v134;
    v271 = v135;
    ...
    while ( 1 )
    {
      ...
      if ( v173 == 8 )
        break;
      v228 = dword_150A18[v173];
      v172 = dword_150A38[v173];
    }
    v283 = v177;
    v243 = v174;
    v281 = v175;
    ...
    *a4 = (v325 ^ v306 ^ v240 ^ (unsigned int)v253) >> 24;
    a4[2] = (unsigned __int16)(v325 ^ v306 ^ v240 ^ v253) >> 8;
    a4[1] = (v325 ^ v306 ^ v240 ^ (unsigned int)v253) >> 16;
...
LABEL_18:
  ...
  a4[45] = BYTE2(v215);
  a4[46] = BYTE1(v215);
  result = memcpy(a1 + 9, &unk_150978, 0x80u);
  a1[8] = 0;
  return result;
}
