int __fastcall sub_8040C(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v7; // r8
  int v12; // r11
  _DWORD *v13; // r7
  ...
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 7) & 3)
  ...
  if ( BM_CRC5(a2 + 2, 67) != (*(_BYTE *)(a2 + 10) & 0x1F) && *(_BYTE *)(a1 + 218) )
  {
    v21 = dword_176F24;
    v22 = 274877907LL * (unsigned int)dword_176F24++;
