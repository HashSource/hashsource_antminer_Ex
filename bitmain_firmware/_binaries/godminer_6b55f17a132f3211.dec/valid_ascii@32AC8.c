int __fastcall valid_ascii(const char *a1)
{
  ...
  if ( !a1 )
  {
    ...
    LOWORD(v7) = 24392;
LABEL_9:
    HIWORD(v7) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/tmp/deb"
                               "ug/build/godminer-origin_godminer-new/util.c" >> 16;
    zlog(v6, v7, 133, "valid_ascii", 11, v11, 20, v12);
    return 0;
  }
  v2 = strlen(a1);
  if ( !v2 )
...
LABEL_8:
    v6 = g_zc;
    LOWORD(v7) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/tmp"
