int __fastcall sub_88014(_DWORD *a1, int a2)
{
  const char *v2; // r4
  void *v5; // r0
  int v6; // r0
  ...
  if ( v69 > 0 )
  {
    ...
    do
    {
      while ( 1 )
      {
        ...
        V_UNLOCK(v16);
        v11 = zlog(g_zc, v63, 149, v62, 24, 46, 20, v81);
      ...
      V_UNLOCK(v29);
      v11 = zlog(g_zc, v63, 149, v62, 24, 52, 20, v81);
    }
    while ( v69 > (int)v2 );
LABEL_7:
    v2 = v65;
