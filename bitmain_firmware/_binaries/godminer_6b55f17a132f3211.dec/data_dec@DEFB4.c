int __fastcall data_dec(unsigned int *a1, unsigned int a2, int a3, int a4)
{
  ...
  if ( (a2 & 7) != 0 )
  {
    ...
    LOWORD(v8) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/tmp"
                                   "/debug/build/godminer-origin_godminer-new/common/general/xxtea.c";
LABEL_4:
    HIWORD(v8) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/tmp/deb"
                               "ug/build/godminer-origin_godminer-new/common/general/xxtea.c" >> 16;
    zlog(v7, v8, 149, "data_dec", 8, v6, 100, v10);
    return 0;
  }
