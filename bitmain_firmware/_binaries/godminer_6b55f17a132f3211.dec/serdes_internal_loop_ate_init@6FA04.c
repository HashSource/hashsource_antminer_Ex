int __fastcall serdes_internal_loop_ate_init(int a1, unsigned int a2, int a3, int a4)
{
  ...
  v10 = sub_6F13C(a1, (unsigned __int16)a3, 240, v9);
  V_LOCK(v10);
  V_INT((int)v27, "chain");
  ...
  v12 = sub_6F13C(a1, (unsigned __int16)a3, 86, v9);
  V_LOCK(v12);
  V_INT((int)v28, "chain");
  ...
  v14 = sub_6F0E8(a1, a3, 86, 201853960);
  V_LOCK(v14);
  V_INT((int)v29, "chain");
  ...
  sub_6F0E8(a1, a3, 78, -2144272003);
  sub_6F660(a1, a3, 24642, v25 | 0x600);
  sub_6F0E8(a1, a3, 77, 0);
  sub_6F0E8(a1, a3, 78, -2144247741);
  sub_6F660(a1, a3, 24644, a4);
  sub_6F660(a1, a3, 24642, v25 | 7);
  sub_6F0E8(a1, a3, 77, 16777472);
  sub_6F0E8(a1, a3, 78, -2144247741);
  sub_6F660(a1, a3, 24644, a4 | 0x8000);
  sub_6F0E8(a1, a3, 77, 0);
  ...
  sub_6F0E8(a1, a3, 78, -2144272085);
  sub_6F660(a1, a3, 24644, a4 | 0x8020);
  sub_6F660(a1, a3, 24644, a4 | 0x8060);
  sub_6F0E8(a1, a3, 77, -1);
  sub_6F0E8(a1, a3, 78, -2144247719);
  sub_6F0E8(a1, a3, 77, -8388737);
  sub_6F0E8(a1, a3, 78, -2144247718);
  sub_6F0E8(a1, a3, 77, 0);
  ...
  sub_6F0E8(a1, a3, 77, (int)v16);
  sub_6F0E8(a1, a3, 78, -2144247739);
  sub_6F0E8(a1, a3, 77, -1);
  sub_6F0E8(a1, a3, 78, -2144247732);
  sub_6F0E8(a1, a3, 77, 268439552);
  ...
  if ( v25 == 2 )
    ...
    HIWORD(v17) = 501;
  sub_6F0E8(a1, a3, 77, v17);
  sub_6F0E8(a1, a3, 78, -2144247559);
  sub_6F0E8(a1, a3, 77, 25166208);
  sub_6F0E8(a1, a3, 78, -2144251901);
  sub_6F0E8(a1, a3, 77, 92800392);
  sub_6F0E8(a1, a3, 78, -2144251901);
  sub_6F0E8(a1, a3, 77, 0);
  sub_6F0E8(a1, a3, 78, -2144251900);
  sub_6F0E8(a1, a3, 77, 541073472);
  sub_6F0E8(a1, a3, 78, -2144251900);
  sub_6F0E8(a1, a3, 77, 0);
  ...
  sub_6F0E8(a1, a3, 77, (int)&dword_10000 + 1);
  sub_6F0E8(a1, a3, 78, -2144251791);
  sub_6F0E8(a1, a3, 77, (int)&loc_E000C + 2);
  sub_6F0E8(a1, a3, 78, -2144247768);
  sub_6F0E8(a1, a3, 77, (int)&loc_E000C + 2);
  sub_6F0E8(a1, a3, 78, -2144247768);
  sub_6F0E8(a1, a3, 77, (int)&loc_30000 + 3);
