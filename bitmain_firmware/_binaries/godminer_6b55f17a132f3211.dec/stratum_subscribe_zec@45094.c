int __fastcall stratum_subscribe_zec(int a1, int a2)
{
  ...
  do
  {
    ...
    if ( !(*(int (__fastcall **)(int, char *))(a1 + 12))(a2, v8) )
    {
      ...
      v13 = 182;
      v14 = g_zc;
      LOWORD(v15) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/"
                                      "tmp/debug/build/godminer-origin_godminer-new/frontend/frontend_zec/frontend_zec.c";
LABEL_9:
      HIWORD(v15) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_debug/build/rootfs/buildroot/tmp/"
                                  "debug/build/godminer-origin_godminer-new/frontend/frontend_zec/frontend_zec.c" >> 16;
      zlog(v14, v15, 163, "stratum_subscribe_zec", 21, v13, 100, v44);
LABEL_10:
      if ( !v8 )
      {
        if ( !v5 )
...
LABEL_51:
    ...
    if ( !v5 )
    {
      ...
      zlog(
        ...
        "n_godminer-new/frontend/frontend_zec/frontend_zec.c",
        163,
        "stratum_subscribe_zec",
        21,
        201,
          ...
          if ( v36 )
          {
            if ( strstr(v36, "nicehash") )
            {
              *(_DWORD *)(a2 + 1912) = 3;
              ...
              if ( v37 )
              {
                v19 = socket_full(*(_DWORD *)(a2 + 32), 30);
                if ( v19 )
                {
