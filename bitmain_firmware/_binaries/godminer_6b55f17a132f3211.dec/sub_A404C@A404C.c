int __fastcall sub_A404C(int a1, unsigned __int8 *a2, unsigned __int8 *a3)
{
  int v5; // r0
  int v6; // r3
  int v8; // r0
  ...
  if ( v5 == v6 )
    return 1;
  v8 = snprintf(s, 0x800u, "Fixture CRC check fail.fixture_crc = 0x%x, len = 0x%x, crc = 0x%x", v6, *a2, v5);
  V_LOCK(v8);
