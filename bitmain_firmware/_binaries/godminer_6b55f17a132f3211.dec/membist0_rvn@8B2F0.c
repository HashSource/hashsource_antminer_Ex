int __fastcall membist0_rvn(int a1)
{
  ...
  do
  {
    ...
    zlog(
      ...
      "godminer-new/backend/backend_rvn_2020/backend_rvn_2020.c",
      170,
      "membist0_rvn",
      12,
      577,
    ...
    do
    {
      sub_878DC(a1, v30, 28, 1);
      sub_878DC(a1, v30, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v6 = ptr;
      v7 = sub_87BF4(a1, (unsigned __int16)v30, 161, ptr);
      if ( v7 > 0 )
      {
        v8 = 3 * v7;
        v9 = &ptr[4 * v8];
...
LABEL_10:
      v11 = ptr;
      v12 = sub_87BF4(a1, (unsigned __int16)v30, 162, ptr);
      if ( v12 > 0 )
      {
        v13 = 3 * v12;
        v14 = &ptr[4 * v13];
        do
        {
          ...
          v13 = zlog(
                  ...
                  "iner-origin_godminer-new/backend/backend_rvn_2020/backend_rvn_2020.c",
                  170,
                  "membist0_rvn",
                  12,
                  608,
...
LABEL_16:
      v16 = ptr;
      v3 = sub_87BF4(a1, (unsigned __int16)v30, 163, ptr);
      if ( v3 > 0 )
      {
        v3 *= 3;
        v17 = &ptr[4 * v3];
