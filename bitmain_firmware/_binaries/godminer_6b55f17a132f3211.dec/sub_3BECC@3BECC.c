int __fastcall sub_3BECC(int a1, int a2, _DWORD *a3, unsigned int a4)
{
  _DWORD *v7; // r0
  char *v8; // r4
  _DWORD *v9; // r0
  ...
  if ( v23 )
  {
    ...
    *(_DWORD *)(a2 + 1580) = v25;
    if ( v25 )
    {
      *v25 = v11;
      memset(v25 + 1, 0, v11);
      v26 = pthread_mutex_unlock((pthread_mutex_t *)(a2 + 1584));
      V_LOCK(v26);
      ...
      zlog(
        ...
        "n_godminer-new/frontend/frontend_ckb/frontend_ckb.c",
        163,
