int __fastcall sub_43B5C(int a1, pthread_mutex_t *a2)
{
  void *v2; // r10
  int v5; // r11
  _DWORD *v6; // r6
  ...
  v45 = (unsigned __int8)a2[68].__size[16];
  if ( a2[68].__size[16] )
    return 1;
  v2 = 0;
  v5 = 0;
  ...
  do
  {
    spins = (const char *)a2[2].__spins;
    if ( spins )
      v14 = strlen(spins) + 256;
    else
      v14 = 256;
    v15 = (char *)malloc(v14);
    strcpy(v15, "{\"id\": 1, \"method\": \"mining.subscribe\", \"params\": [\"GodMiner/2.0.0\", null]}");
    if ( !(*(int (__fastcall **)(pthread_mutex_t *, char *))(a1 + 12))(a2, v15) )
    {
      V_LOCK(0);
    ...
    v9 = socket_full(a2[1].__owner, 30);
    if ( !v9 )
    {
      V_LOCK(0);
...
LABEL_4:
    ...
    v16 = (*(int (__fastcall **)(pthread_mutex_t *))(a1 + 8))(a2);
    v2 = (void *)v16;
    if ( v16 )
    {
      ...
      if ( !v6 )
      {
        ...
        zlog(
          ...
          "gin_godminer-new/frontend/frontend_rvn/frontend_rvn.c",
          163,
          "stratum_subscribe_rvn",
          21,
          62,
...
LABEL_44:
        ...
        owner = (void *)a2[64].__owner;
        if ( owner )
          free(owner);
        v37 = (char *)calloc(8u, 1u);
        v38 = (const char *)a2[3].__count;
        a2[64].__owner = (int)v37;
        strcpy(v37, v38);
        pthread_mutex_unlock(a2 + 66);
        if ( !(*(int (__fastcall **)(int, pthread_mutex_t *, _DWORD *, int))(a1 + 52))(a1, a2, v46, 1) )
        {
          V_LOCK(0);
        ...
        v39 = (const char *)a2[3].__count;
        v40 = a2[79].__nusers + 1;
        a2[79].__nusers = v40;
        sprintf(v15, "{\"id\": %d, \"method\": \"mining.extranonce.subscribe\", \"params\": [\"%s\"]}", v40, v39);
        v41 = (*(int (__fastcall **)(pthread_mutex_t *, char *))(a1 + 12))(a2, v15);
        if ( v41 )
        {
          v9 = socket_full(a2[1].__owner, 30);
          if ( v9 )
            (*(void (__fastcall **)(pthread_mutex_t *))(a1 + 8))(a2);
          else
            v9 = v41;
        }
      }
