int __fastcall get_response(int a1)
{
  ...
  v3 = snprintf(v2, 0x40u, "%.10s_%d", "get_response", *(_DWORD *)(a1 + 208));
  V_LOCK(v3);
  syscall(224);
  ...
  {
    v9 = dev_ctrl((int)v8);
    v10 = (*(int (__fastcall **)(_DWORD, _BYTE *, int))(v9 + 60))(*(_DWORD *)(a1 + 208), s, 256);
    v11 = v10;
    if ( *(_BYTE *)(a1 + 837) )
      break;
    if ( v10 <= 0 )
    ...
    {
      v6 = 64;
      if ( !queue_enqueue(*(_DWORD *)(a1 + 808), s, v10) && v5 <= ++v7 )
      {
        V_LOCK(0);
