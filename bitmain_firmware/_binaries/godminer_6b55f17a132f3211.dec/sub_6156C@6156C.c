int __fastcall sub_6156C(int a1)
{
  int v2; // r6
  int v3; // r0
  int v4; // r0
  ...
  v28[0] = 1;
  v30 = 255;
  v4 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 232))(a1, v28);
  if ( v4 < 0 )
  {
    V_LOCK(v4);
    v25 = -1;
  ...
  else
  {
    ...
    v8 = (*(int (__fastcall **)(int, _DWORD *, int, int *, int *, int, int, _DWORD, int, int, int, int, const char *, int))(a1 + 256))(
           a1,
           v28,
           v7,
           ptr,
