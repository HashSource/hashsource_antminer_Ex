int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_69350(a1, v24, 12, 1);
    usleep(0x61A80u);
    sub_69350(a1, v24, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x600u);
    v3 = sub_695F0(a1, (unsigned __int16)v24, 161, ptr);
    v4 = v3;
    if ( v3 == 8
      || (V_LOCK(v3),
          V_INT((int)v26, "chain"),
...
LABEL_10:
    memset(ptr, 0, 0x600u);
    v9 = sub_695F0(a1, (unsigned __int16)v24, 162, ptr);
    v10 = v9;
    if ( v9 == 8
      || (V_LOCK(v9),
          V_INT((int)v29, "chain"),
...
LABEL_18:
  ...
  v19 = dev_ctrl(v18);
  (*(void (__fastcall **)(_DWORD))(v19 + 80))(*(_DWORD *)(a1 + 208));
  unk_176EE0 = s[0];
  unk_176EE4 = s[1];
  unk_176EE8 = s[2];
  unk_176EEC = s[3];
