int __fastcall sub_5DF74(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v8; // r4
  int v12; // r9
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 65) = v12;
  *(_BYTE *)(a3 + 64) = v18;
  v19 = sub_1217D0(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 388));
  if ( v19 >= *(_DWORD *)(a1 + 292) )
  {
    v27 = rand();
    sub_121CDC(v27, *(_DWORD *)(a1 + 292));
    v19 = v28;
  }
  *a6 = v19;
  *(_DWORD *)(a3 + 8) = v19;
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 8) & 3)
  ...
  if ( BM_CRC5(a2 + 2, 75) != (*(_BYTE *)(a2 + 11) & 0x1F) && *(_BYTE *)(a1 + 218) )
  {
    v24 = dword_176ECC;
    v25 = 274877907LL * (unsigned int)dword_176ECC++;
