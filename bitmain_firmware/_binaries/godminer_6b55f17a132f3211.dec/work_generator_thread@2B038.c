...
LABEL_9:
    while ( 1 )
    {
      ...
      v13 = (pthread_mutex_t *)current_pool;
      if ( current_pool )
        break;
LABEL_34:
      V_LOCK(current_pool);
    ...
    while ( 1 )
    {
      if ( pool_tget(current_pool, &v13[79]) )
        goto LABEL_37;
      clock_gettime(1, v50);
      v48[1] = (v44 + v50[0].tv_nsec) % 1000000000;
      v48[0] = (v44 + v50[0].tv_nsec) / 1000000000 + v50[0].tv_sec + v45;
      v14 = pool_twait_to_be_expected_and_set(v13, &v13[79].__align + 3, 1, 0, v48);
      if ( v14 == 1 )
        break;
      if ( v14 == 110 )
      {
      ...
      zlog(
        ...
        20,
        v50);
      pthread_mutex_lock(v13 + 66);
      if ( pool_tget(v13, &v13[65].__align + 4) )
      {
        v42 = pthread_mutex_unlock(v13 + 66);
        V_LOCK(v42);
      ...
      if ( (*(int (__fastcall **)(_DWORD *, pthread_mutex_t *))(v1 + 36))(s, v13) == 2 )
      {
        V_LOCK(2);
        ...
        zlog(
          ...
          v50);
        v39 = (void *)s[281];
        nusers = v13[67].__nusers;
        ++*(_QWORD *)&total_getworks;
        v13[67].__nusers = nusers + 1;
        if ( v39 )
        {
          free(v39);
          s[281] = 0;
        ...
        v7 = 1;
        memcpy(s, &v13[18].__align + 4, sizeof(s));
        kind = (const char *)v13[65].__kind;
        if ( kind )
          s[281] = _strdup(kind);
      }
      i = pthread_mutex_unlock(v13 + 66);
      if ( !s[281] )
        goto LABEL_9;
      if ( v47 > 0 )
      {
        ...
        do
        {
          if ( v17 )
            ...
            v19 = v7;
          ++v17;
          (**(void (__fastcall ***)(_DWORD *, pthread_mutex_t *, int))(v1 + 72))(s, v13, v19);
          ++local_work;
          v20 = time(0);
          v21 = *(_DWORD *)(v1 + 72);
          last_getwork = v20;
      ...
      v26 = 0;
      v27 = -1;
      v28 = (int)&loc_F4240 * (__int64)(tp.tv_sec - send_job_timer) + (tp.tv_nsec - dword_177F9C) / 1000;
      do
      {
        v30 = *v24++;
        v29 = v30;
