...
LABEL_6:
  ...
  if ( a1 != *(_DWORD *)(*all_created_runtime + 208) )
  {
    while ( ++v5 != v16 )
    {
      ...
      if ( a1 == *(_DWORD *)(v12 + 208) )
        goto LABEL_7;
    }
    goto LABEL_6;
  }
LABEL_7:
  if ( *(_DWORD *)(fake_regio_runtime + 808) == *(_DWORD *)(fake_regio_runtime + 816) )
    pthread_create(
      (pthread_t *)(fake_regio_runtime + 828),
      0,
      (void *(*)(void *))get_response,
      (void *)fake_regio_runtime);
  result = (*(int (__fastcall **)(int, int, int, int, int))(fake_regio_runtime + 248))(
             fake_regio_runtime,
             a2,
             a3,
             a4,
  ...
  if ( *(_DWORD *)(fake_regio_runtime + 808) == *(_DWORD *)(fake_regio_runtime + 816) )
  {
    v15 = *(_DWORD *)(fake_regio_runtime + 828);
    *(_BYTE *)(fake_regio_runtime + 837) = 1;
    pthread_join(v15, 0);
    return v14;
  }
  return result;
