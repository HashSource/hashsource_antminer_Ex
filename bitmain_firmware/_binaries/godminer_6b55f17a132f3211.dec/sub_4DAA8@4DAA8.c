int __fastcall sub_4DAA8(int a1, pthread_mutex_t *a2)
{
  int *v2; // r10
  ...
  if ( v2 )
  {
    ...
    *v2 = v11;
    v2[3] = spins;
    sha256(a2[12].__count, lock);
    sha256((int)&v46, 0x20u);
    count = a2[13].__count;
    v46 = v36;
    v47 = v37;
    v48 = v38;
    ...
    if ( count > 0 )
    {
      ...
      do
      {
        ...
        v53[7] = v20;
        v53[8] = v21;
        sha256((int)&v46, 0x40u);
        sha256((int)v44, 0x20u);
        v22 = a2[13].__count;
        v46 = v36;
        v47 = v37;
        v48 = v38;
