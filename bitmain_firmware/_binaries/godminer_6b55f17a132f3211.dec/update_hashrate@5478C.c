_DWORD *__fastcall update_hashrate(int a1, int a2, _DWORD *a3)
{
  ...
  *(_QWORD *)(a2 + 56) = v7;
  if ( v6 <= 16 )
  {
    ...
    if ( !byte_16B398[v6] )
    {
      clock_gettime(1, (struct timespec *)&byte_16B398[v8 + 16]);
      clock_gettime(1, (struct timespec *)&byte_16B398[v8 + 272]);
      clock_gettime(1, (struct timespec *)((char *)&unk_16B5A8 + v8));
      *((_QWORD *)&unk_16B6A8 + v6) = 0;
      byte_16B398[v6] = 1;
    }
    if ( *(_QWORD *)(a1 + 408) )
    {
    ...
    clock_gettime(1, (struct timespec *)&byte_16B398[v8 + 24]);
    v9 = 1000LL * (*(_DWORD *)&byte_16B398[v8 + 24] - *(_DWORD *)&byte_16B398[v8 + 16])
       + (*(_DWORD *)&byte_16B398[v8 + 28] - *(_DWORD *)&byte_16B398[v8 + 20]) / 1000000;
    v10 = &flt_16B730[724 * v6];
    v11 = sub_122210(v9, HIDWORD(v9)) / 1000.0;
    if ( v11 >= 5.0 )
    {
      v34 = *(_DWORD *)(a1 + 408);
      v35 = *(_DWORD *)(a1 + 412);
      v37 = __PAIR64__(v35, v34) - *((_QWORD *)&unk_16B6A8 + v6);
      ...
      {
        v31 = COERCE_FLOAT(
                ((int (__fastcall *)(int, unsigned int))sub_122200)(
                  1 << *(_DWORD *)(a1 + 392),
                  (1 << (*(_DWORD *)(a1 + 392) - 32)) | (1u >> (32 - *(_DWORD *)(a1 + 392)))));
        v24 = sub_122200(v37, HIDWORD(v37));
      ...
      zlog(
        ...
        v43);
      clock_gettime(1, (struct timespec *)&byte_16B398[v8 + 16]);
      v27 = &flt_16B730[724 * v6];
      *((_DWORD *)&unk_16B6A8 + 2 * v6) = v34;
      v28 = *((_DWORD *)v27 + 723);
      v32 = *((_DWORD *)v27 + 720);
      v33 = v27;
      *((_DWORD *)&unk_16B6A8 + 2 * v6 + 1) = v35;
      v36 = *((_DWORD *)v27 + 722);
      flt_16B730[724 * v6 + v32] = v25;
      v29 = __PAIR64__(v28, v36) + 1;
      *((_DWORD *)v27 + 720) = (v32 + 1) % 720;
      v30 = v25 + (float)(sub_122200(v36, v28) * *(float *)(a2 + 44));
      *(float *)(a2 + 44) = v30 / sub_122200(v29, HIDWORD(v29));
      *((_QWORD *)v33 + 361) = v29;
    }
    sub_546F0((int)v10);
    *(float *)(a2 + 32) = 5.0;
    ...
    *(_QWORD *)(a2 + 80) = v15;
    clock_gettime(1, (struct timespec *)&byte_16B398[v8 + 280]);
    v18 = 1000LL * (*(_DWORD *)&byte_16B398[v8 + 280] - *(_DWORD *)&byte_16B398[v8 + 272])
        + (*(_DWORD *)&byte_16B398[v8 + 284] - *(_DWORD *)&byte_16B398[v8 + 276]) / 1000000;
    if ( (float)(sub_122210(v18, HIDWORD(v18)) / 1000.0) >= 900.0 )
    {
      sub_546F0((int)v10);
      v20 = *(_DWORD *)(a2 + 200);
      if ( v20 > 23 )
