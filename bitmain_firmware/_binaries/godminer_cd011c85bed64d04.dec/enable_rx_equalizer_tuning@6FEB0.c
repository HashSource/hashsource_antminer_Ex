int __fastcall enable_rx_equalizer_tuning(int a1, int a2, _BYTE *a3, int a4)
{
  ...
  sub_5E0B4(a1, (unsigned __int8)a3, v9, 0);
  sub_5E0B4(a1, (unsigned __int8)a3, v11, -4194305);
  sub_5E0B4(a1, (unsigned __int8)a3, v9, 0x400000);
  sub_5E0B4(a1, (unsigned __int8)a3, v11, -4194305);
  sub_5E0B4(a1, (unsigned __int8)a3, v9, 0);
  sub_5E0B4(a1, (unsigned __int8)a3, v11, -2049);
  sub_5E0B4(a1, (unsigned __int8)a3, v8, 2048);
  sub_5E0B4(a1, (unsigned __int8)a3, v11, -1073741825);
  sub_5E0B4(a1, (unsigned __int8)a3, v15, 0x40000000);
  sub_5E0B4(a1, (unsigned __int8)a3, v11, -16777217);
  sub_5E0B4(a1, (unsigned __int8)a3, v12, 0);
  sub_5E0B4(a1, (unsigned __int8)a3, v11, -16777217);
  sub_5E0B4(a1, (unsigned __int8)a3, v12, 0x1000000);
