int __fastcall hs_header_share_pow(unsigned __int64 *a1, unsigned __int64 *a2)
{
  ...
  _BYTE v9[404]; // [sp+240h] [bp-194h] BYREF

  hs_blake2b_update((int)v7, a1, 0x80u);
  hs_sha3_256_init(v9);
  hs_sha3_update(v9, a1, 128);
  hs_sha3_update(v9, a2, 8);
  hs_sha3_final(v9, v5);
  hs_blake2b_update((int)v8, v6, 0x40u);
  hs_blake2b_update((int)v8, a2, 0x20u);
