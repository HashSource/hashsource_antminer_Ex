int __fastcall setup_all_chip_vbk(int a1)
{
  ...
  *v2 = 0;
  v2[1] = 64;
  v3 = *(void (__fastcall **)(int, _DWORD, int))(a1 + 156);
  *(_DWORD *)(a1 + 248) = 64;
  v3(a1, *(_DWORD *)(a1 + 304), 4);
  v4 = sub_AC888(a1);
  v12[1] = 0;
  v13 = 0;
  v14 = 0;
  ...
  zlog(
    ...
    20,
    v15);
  v6 = *(int (__fastcall **)(int, _DWORD *))(a1 + 164);
  v13 = 1310721;
  v12[0] = 32;
  v7 = v6(a1, v12);
  *(_DWORD *)(a1 + 252) = 32;
  ...
  v15[0] = 1;
  v15[3] = 1280;
  v9 = (*(int (__fastcall **)(int, _DWORD *, int, _DWORD))(a1 + 176))(a1, v15, 20000, 0);
  V_LOCK(v9);
