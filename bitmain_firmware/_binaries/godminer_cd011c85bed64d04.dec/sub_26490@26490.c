int __fastcall sub_26490(int a1, int a2)
{
  ...
  *(_DWORD *)v159 = 0;
  ...
  else
  {
    ...
    {
      sub_25FC4();
      v26 = sub_12EA00(LODWORD(v22), HIDWORD(v22));
    }
    else
    {
      v26 = 0;
    ...
    v28 = sub_12EA00(COERCE_UNSIGNED_INT64(v23 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v23 * 100.0)));
    v29 = sub_12E6AC(v28, HIDWORD(v28));
    v30 = json_real(v29);
    json_object_set_new(v19, "GHS 5s", v30);
    v31 = sub_12EA00(COERCE_UNSIGNED_INT64(v25 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v25 * 100.0)));
    v32 = sub_12E6AC(v31, HIDWORD(v31));
    v33 = json_real(v32);
    json_object_set_new(v19, "GHS av", v33);
    v34 = sub_12EA00(COERCE_UNSIGNED_INT64(v24 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v24 * 100.0)));
    ...
    v38 = sub_12EA00(LODWORD(v37), HIDWORD(v37));
    v39 = sub_12E6AC(v38, HIDWORD(v38));
    v40 = json_real(v39);
