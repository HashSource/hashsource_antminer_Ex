...
LABEL_9:
  ...
  if ( v6 >= 0 )
  {
    ...
    while ( 1 )
    {
      servlen = (unsigned __int8)byte_165FEC;
      if ( byte_165FEC )
      {
LABEL_102:
      ...
      *(_DWORD *)::s1 = servlen;
      dword_165FE0 = servlen;
      dword_165FE4 = servlen;
      dword_165FE8 = servlen;
      v151[v14] = servlen;
      *(_DWORD *)v119 = servlen;
      *(_DWORD *)v123 = servlen;
      v120 = servlen;
      ...
      v125 = servlen;
      v126 = servlen;
      dword_165FD8 = time((time_t *)servlen);
      ...
      *(_DWORD *)s1 = servlen;
      ...
      if ( !v24 || *v24 )
      {
        ...
        sub_258A4(v23, v119, (int)v123, 2u);
        goto LABEL_33;
      }
      ...
      if ( v49 && *v49 == 2 )
      {
        ...
        if ( v96 && *v96 == 5 )
        {
          ...
          {
            v106 = protocol;
            sub_258A4(v23, v119, (int)v123, protocol);
            goto LABEL_33;
          }
          v98 = protocol;
        }
        else
        {
          ...
          {
            v106 = 1;
            sub_258A4(v23, v119, (int)v123, 1u);
            goto LABEL_33;
          }
          v98 = 1;
        }
        ...
        if ( v101 )
        {
          sub_258A4(v23, v119, (int)v123, v98);
        }
        else
        {
          json_delete(v25);
          sub_258A4(v23, v119, (int)v123, v106);
        }
      }
      else
      {
        ...
        zlog(
          ...
          100,
          v143);
        sub_238A0(v23, 0, 24, "Missing JSON 'command'");
      }
LABEL_33:
      if ( v106 == 2 )
      {
