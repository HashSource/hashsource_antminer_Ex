int __fastcall stratum_thread(int a1)
{
  ...
  if ( v4 )
  {
    ...
    zlog(
      ...
      v36);
    prctl(15, v7);
    v4 = _strdup((const char *)v5->__owner);
    v5[1].__count = (unsigned int)v4;
    if ( v4 )
    {
      v30 = &v5[86].__size[20];
      v31 = 1;
      pool_tset((int)v5, &v5[86].__size[8], 0);
      pool_tclear((int)v5, &v5[86].__size[20], 0);
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            ...
            while ( 1 )
            {
              v13 = (*(int (__fastcall **)(pthread_mutex_t *))(v2 + 4))(v12) == 0;
              v14 = v5;
              if ( !v13 )
              {
                v15 = (*(int (__fastcall **)(int, pthread_mutex_t *))(v2 + 20))(v2, v5);
                if ( v15 )
                  break;
              }
              (*(void (__fastcall **)(pthread_mutex_t *, pthread_mutex_t *))(v2 + 8))(v5, v14);
              pool_tclear((int)v5, v30, 0);
              pool_died(v5);
              v16 = v11;
              v11 = (__PAIR64__(v11, v10) + 1) >> 32;
              v17 = sub_12E924(v10, v16, 50, 0);
              if ( !v18 )
              {
                V_LOCK(v17);
...
LABEL_11:
          if ( v5 != (pthread_mutex_t *)get_current_pool() )
            wait_pool_to_be_current_timeout((int)v5);
...
LABEL_21:
          v24 = v5[88].__count + 1;
          pools_active = 0;
          v25 = *(void (__fastcall **)(pthread_mutex_t *))(v2 + 8);
          ++total_go;
          v5[88].__count = v24;
          v25(v5);
          pool_tclear((int)v5, v30, 0);
        ...
        v19 = (*(int (__fastcall **)(pthread_mutex_t *))(v2 + 12))(v5);
        v20 = (void *)v19;
        if ( !v19 )
          goto LABEL_21;
        if ( !(*(int (__fastcall **)(int, pthread_mutex_t *, int))(v2 + 24))(v2, v5, v19) )
