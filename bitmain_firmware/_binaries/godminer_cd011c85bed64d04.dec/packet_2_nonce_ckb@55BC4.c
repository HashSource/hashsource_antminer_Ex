int __fastcall packet_2_nonce_ckb(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v9; // r4
  _DWORD *v11; // r9
  int v13; // r1
  ...
  *(_BYTE *)(a3 + 63) = *(_BYTE *)(a2 + 6);
  *(_BYTE *)(a3 + 64) = *(_BYTE *)(a2 + 7) & 0x7F;
  *(_BYTE *)(a3 + 65) = *(_BYTE *)(a2 + 8);
  v21 = sub_12DE68(*(unsigned __int8 *)(a2 + 2));
  if ( v21 >= *(_DWORD *)(a1 + 204) )
  {
    v27 = rand();
    sub_12E374(v27, *(_DWORD *)(a1 + 204));
    v21 = v28;
  }
  *a6 = v21;
  *(_DWORD *)(a3 + 8) = v21;
  *(_DWORD *)(a3 + 12) = *(_BYTE *)(a2 + 6) & 0x1F;
  v22 = BM_CRC5(a2 + 2, 59);
  v23 = *(_BYTE *)(a2 + 9) & 0x1F;
  if ( v22 == v23 )
  {
