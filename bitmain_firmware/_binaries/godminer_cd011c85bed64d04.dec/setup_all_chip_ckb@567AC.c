int __fastcall setup_all_chip_ckb(int a1)
{
  ...
  while ( v2 != 243 );
  v4 = *(void (__fastcall **)(int, int, int))(a1 + 156);
  v5 = *(_DWORD *)(a1 + 304);
  *(_DWORD *)(a1 + 248) = 9;
  v4(a1, v5, 27);
  v6 = sub_563AC(a1);
  ...
  v29 = 0;
  v30 = 0;
  (*(void (__fastcall **)(int, int *, int, _DWORD))(a1 + 176))(a1, &v29, 20000, 0);
  v8 = (int)(float)(*(float *)(a1 + 768) - 100.0) / 25;
  if ( v8 > 0 )
  {
    v9 = 25;
    v10 = 25 * (v8 + 1);
      ...
      while ( 2 )
      {
        ...
        do
        {
          ...
          if ( v15 - 800 <= 0x640 )
          {
            ...
            v27 = sub_12E0E0(25 * (v15 / 0x19), v11);
            v11 = sub_12E0E0(v27, v13);
            goto LABEL_11;
          }
...
LABEL_11:
      ...
      zlog(
        ...
        20,
        &v29);
      (*(void (__fastcall **)(int, _DWORD *))(a1 + 164))(a1, v28);
      usleep(0x2710u);
      usleep(0x61A8u);
    }
    while ( v10 != v9 );
