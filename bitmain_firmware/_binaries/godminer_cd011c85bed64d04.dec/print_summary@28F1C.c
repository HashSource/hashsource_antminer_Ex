int print_summary()
{
  ...
  if ( byte_165FF8 )
    sub_25FC4();
  v0 = sub_12E6AC(total_accepted, HIDWORD(total_accepted));
  V_LOCK(LODWORD(v0));
  ...
  if ( total_accepted || total_rejected )
  {
    V_LOCK(v24);
    v49 = total_rejected;
    sub_12E6AC(100 * total_rejected, (unsigned __int64)(100 * total_rejected) >> 32);
    sub_12E6AC(v49 + total_accepted, (unsigned __int64)(v49 + total_accepted) >> 32);
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *(_QWORD *)(v53 + 2096) || *(_QWORD *)(v53 + 2104) )
        {
          V_LOCK(v36);
          v68 = *(_QWORD *)(v53 + 2104);
          sub_12E6AC(100 * v68, (unsigned __int64)(100 * v68) >> 32);
          sub_12E6AC(v68 + *v54, (unsigned __int64)(v68 + *(_QWORD *)v54) >> 32);
