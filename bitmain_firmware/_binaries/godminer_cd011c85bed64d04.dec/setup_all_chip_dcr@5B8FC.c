int __fastcall setup_all_chip_dcr(int a1)
{
  ...
  zlog(
    ...
    60,
    &v64);
  v4 = sub_12E0E0(256, (unsigned __int8)v2);
  v5 = v4;
  v6 = *(_BYTE **)(a1 + 304);
  if ( (_BYTE)v2 )
  {
  ...
  *v6 = rand();
  *(_DWORD *)(a1 + 248) = v5;
  v9 = (*(int (__fastcall **)(int, _DWORD, int))(a1 + 156))(a1, *(_DWORD *)(a1 + 304), v2);
  V_LOCK(v9);
  ...
  while ( 1 )
  {
    ...
    v13 = (*(int (__fastcall **)(int, _DWORD *, unsigned int, unsigned __int16 *, int *, int, int, _DWORD, int, int, int, int, const char *, const char *, int, int, int, int, int, int, const char *))(a1 + 184))(
            a1,
            v56,
            v52,
            ptr,
    ...
    else
    {
      ...
      do
      {
        ...
        zlog(
          ...
          &v64);
        v15 = *(_DWORD *)(a1 + 204);
        if ( (unsigned __int16)__rev16(v18) == *(_DWORD *)(a1 + 200) )
          ++s;
        if ( v15 > 0 )
        {
...
LABEL_23:
  ...
  v64 = 48;
  v31 = 0;
  v32 = *(void (__fastcall **)(int, int *))(a1 + 164);
  LOBYTE(v66) = 1;
  v32(a1, &v64);
  v66 = 524289;
  v67 = 255;
  v65 = 0;
  v64 = 0;
  (*(void (__fastcall **)(int, int *))(a1 + 168))(a1, &v64);
  ...
  do
  {
    v34 = *(void (__fastcall **)(int, int *))(a1 + 168);
    v64 = 23130;
    v66 = 131073;
    v65 = 0;
