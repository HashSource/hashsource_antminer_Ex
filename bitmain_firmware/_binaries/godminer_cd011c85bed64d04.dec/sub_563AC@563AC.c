int __fastcall sub_563AC(int a1)
{
  int v1; // r9
  int v3; // r0
  int v4; // r0
  ...
  v24[1] = 0;
  v24[3] = 0;
  ptr = (unsigned __int16 *)calloc(0x144u, 1u);
  v4 = (*(int (__fastcall **)(int, _DWORD *, int, unsigned __int16 *, int *, int, int, _DWORD))(a1 + 184))(
         a1,
         v24,
         27,
         ptr,
  ...
  if ( v23 > 0 )
  {
    ...
    do
    {
      ...
      zlog(
        ...
        v28);
      v6 = *(_DWORD *)(a1 + 204);
      if ( (unsigned __int16)__rev16(v9) == *(_DWORD *)(a1 + 200) )
        ++v21;
      if ( v6 > 0 )
      {
