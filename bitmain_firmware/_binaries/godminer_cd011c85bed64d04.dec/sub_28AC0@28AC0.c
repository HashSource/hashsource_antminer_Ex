int __fastcall sub_28AC0(int a1, const char **a2)
{
  ...
  {
    sub_25FC4();
    v16 = sub_12EA00(LODWORD(v11), HIDWORD(v11));
  }
  else
  {
    v16 = 0;
  ...
  v18 = sub_12EA00(COERCE_UNSIGNED_INT64(v14 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v14 * 100.0)));
  v19 = sub_12E6AC(v18, HIDWORD(v18));
  v20 = json_real(LODWORD(v19));
  json_object_set_new(v10, "rate_5s", v20);
  v21 = sub_12EA00(COERCE_UNSIGNED_INT64(v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v15 * 100.0)));
  v22 = sub_12E6AC(v21, HIDWORD(v21));
  v23 = v22 / 100.0;
  ...
  if ( opt_algo == 5 )
    v26 = v26 * v13 * 100.0;
  v27 = sub_12EA00(LODWORD(v26), HIDWORD(v26));
