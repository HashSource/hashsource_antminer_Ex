int __fastcall sub_272AC(int a1, int a2)
{
  ...
  else
  {
    ...
    if ( byte_165FF8 )
    {
      ...
      sub_25FC4();
      v85 = v11;
      v17 = sub_12E6AC(*v10, v10[1]);
      v18 = sub_12EA00(LODWORD(v11), HIDWORD(v11));
      if ( v11 == 0.0 )
        v85 = 1.0;
    }
    else
    {
      HIWORD(v10) = (unsigned int)&total_accepted >> 16;
      v85 = 1.0;
      v17 = COERCE_DOUBLE(((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(*v10, v10[1]));
      v18 = 0;
    }
    v19 = json_integer(v18, HIDWORD(v18));
    json_object_set_new(v8, "Elapsed", v19);
    v20 = sub_12EA00(COERCE_UNSIGNED_INT64(v14 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v14 * 100.0)));
    v21 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v20, HIDWORD(v20));
    v22 = json_real(v21);
    json_object_set_new(v8, "GHS 5s", v22);
    v23 = sub_12EA00(COERCE_UNSIGNED_INT64(v16 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v16 * 100.0)));
    v24 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v23, HIDWORD(v23));
    v25 = json_real(v24);
    json_object_set_new(v8, "GHS av", v25);
    v26 = sub_12EA00(COERCE_UNSIGNED_INT64(v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v15 * 100.0)));
    v27 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v26, HIDWORD(v26));
    v28 = json_real(v27);
    ...
    v35 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v34, HIDWORD(v34));
    v36 = json_real(v35);
    ...
    v43 = sub_12EA00(COERCE_UNSIGNED_INT64(dbl_166000 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(dbl_166000 * 100.0)));
    v44 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v43, HIDWORD(v43));
    v45 = json_real(v44);
    ...
    v49 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v48, HIDWORD(v48));
    v50 = json_real(v49);
    ...
    v52 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v51, HIDWORD(v51));
    v53 = json_real(v52);
    ...
    v55 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6AC)(v54, HIDWORD(v54));
    v56 = json_real(v55);
    ...
    {
      v81 = COERCE_DOUBLE(
              ((__int64 (__fastcall *)(unsigned int, unsigned int, _DWORD))sub_12E69C)(
                v91,
                v88,
                (v91 + total_diff1) | ((__PAIR64__(v88, v91) + total_diff1) >> 32)));
      v83 = sub_12E69C(v87, HIDWORD(v87), v82);
      v84 = sub_12EA00(COERCE_UNSIGNED_INT64(v81 / v83 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v81 / v83 * 100.0)));
      v58 = sub_12E6AC(v84, HIDWORD(v84));
    }
    ...
    if ( v65 != 0.0 )
    {
      ...
      v64 = sub_12E6AC(v66, HIDWORD(v66));
    }
    ...
    if ( v69 != 0.0 )
    {
      ...
      v68 = sub_12E6AC(v70, HIDWORD(v70));
    }
    ...
    if ( !strcmp(*(const char **)(*(_DWORD *)all_created_runtime + 196), "dash") )
    {
      v75 = v93;
      update_rate_ideal();
      v76 = sub_12EA00(COERCE_UNSIGNED_INT64(v75 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v75 * 100.0)));
      v77 = sub_12E6AC(v76, HIDWORD(v76));
