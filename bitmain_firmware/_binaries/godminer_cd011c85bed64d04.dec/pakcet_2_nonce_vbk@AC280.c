int __fastcall pakcet_2_nonce_vbk(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v8; // r12
  int v10; // r3
  int v13; // r2
  ...
  *(_DWORD *)(a3 + 48) = v18;
  *(_DWORD *)(a3 + 52) = v21;
  v22 = sub_12DE68(*(unsigned __int8 *)(a2 + 3));
  *a6 = v22;
  *(_DWORD *)(a3 + 8) = v22;
  *(_DWORD *)(a3 + 12) = 0;
  v23 = BM_CRC5(a2 + 2, 8 * *(unsigned __int8 *)(a2 + 2) - 5);
  v24 = *(_BYTE *)(a2 + 9) & 0x1F;
  if ( v23 == v24 )
  {
    *a5 = *(_DWORD *)(a3 + 24);
