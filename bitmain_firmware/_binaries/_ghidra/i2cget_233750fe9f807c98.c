// Decompiled: i2cget_233750fe9f807c98
    ...
    do {
        ...
        LAB_00010cf8:
            if (bVar16)
                goto LAB_00010e04;
            if (((param_1 <= iVar6 + 2) ||
                 (iVar4 = FUN_00011d70(param_2[iVar10]), iVar4 < 0)) ||
                (iVar5 = FUN_0001159c(param_2[iVar10 + 1], uVar13), iVar5 < 0))
                goto LAB_00010e00;
            if (iVar6 + 3 < param_1) {
                uVar14 = strtol((char *)param_2[iVar10 + 2], &local_44, 0);
                if ((*local_44 != '\0') || (0xff < uVar14))
                    goto LAB_00010de0;
                local_50 = 2;
            } else {
                uVar14 = 0xffffffff;
            ...
            LAB_00010e7c:
                ...
                iVar6 = FUN_00011ec4(iVar10, iVar5, uVar12);
                if (iVar6 != 0)
                    goto LAB_00010fac;
                if (bVar2) {
                LAB_00010f1c:
                    if ((bVar11 != false) && (iVar6 = ioctl(iVar10, 0x708, 1),
                                              pFVar3 = stderr, iVar6 < 0)) {
                        piVar7 = __errno_location();
                        pcVar8 = strerror(*piVar7);
                    ...
                    if (local_50 == 1) {
                        if ((uVar14 != 0xffffffff) &&
                            (iVar6 =
                                 i2c_smbus_write_byte(iVar10, uVar14 & 0xff),
                             iVar6 < 0)) {
                ...
                LAB_00011040:
                    ...
                    if (bVar11 != false)
                        goto LAB_0001128c;
                    fprintf(stderr, "Continue? [%s] ", &DAT_000121a4);
                    fflush(stderr);
                    iVar6 = FUN_00011f38(1);
                    if (iVar6 == 0)
                        goto LAB_000110f8;
                LAB_000111b8:
...

{
    ...
    __libc_start_main(FUN_00010c00, in_stack_00000000, &stack0x00000004,
                      0x11fd9, &DAT_00012015, param_1);
    /* WARNING: Subroutine does not return */
    abort();
}
...
uint FUN_00011654(undefined4 param_1, char *param_2, size_t param_3,
                  int param_4)
        ...
        if (pFVar2 == (FILE *)0x0) {
                    ...
                    if (pdVar11 != (dirent64 *)0x0) {
                        while (true) {
                            ...
                            if (iVar9 == 0) {
                                ...
                                iVar3 = FUN_00011654(local_3bc, auStack_3b4,
                                                     0x14, 1);
                                if (iVar3 < 0) {
                                    iVar9 = 4;
                                } else {
                            ...
                            uVar12 = uVar14 + 1;
                            if (((uVar12 & 7) == 0) &&
                                (pvVar1 = (void *)FUN_00011554(pvVar1, uVar12),
                                 pvVar1 == (void *)0x0)) {
                                return (void *)0x0;
                            }
                            ...
                            *(int *)((int)pvVar1 + uVar14 * 0x10 + 4) = iVar3;
                            if (iVar3 == 0)
                                goto LAB_00011900;
                            puVar13 = (&PTR_s_Dummy_bus_000125b4)[iVar9 * 2];
                            *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 8) =
                                (&PTR_s_dummy_000125b0)[iVar9 * 2];
            ...
            while (true) {
                ...
                *pcVar6 = '\0';
                ...
                if (((uVar14 & 7) == 0) &&
                    (pvVar1 = (void *)FUN_00011554(pvVar1, uVar14),
                     pvVar1 == (void *)0x0)) {
                    return (void *)0x0;
                }
...
ulong FUN_00011d70(char *param_1)
...
int FUN_00011ec4(int param_1, undefined4 param_2, int param_3)
...
undefined4 FUN_00011f38(undefined4 param_1)
...
void FUN_00011fd8(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
