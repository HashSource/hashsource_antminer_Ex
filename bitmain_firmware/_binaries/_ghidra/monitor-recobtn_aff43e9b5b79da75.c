// Decompiled: monitor-recobtn_aff43e9b5b79da75
...

{
    ...
    sprintf(acStack_48, "/sys/class/gpio/gpio%d", 0x16e);
    iVar1 = access(acStack_48, 0);
    if (iVar1 == 0) {
        sprintf(acStack_48, "/sys/class/gpio/gpio%d/value", 0x16e);
