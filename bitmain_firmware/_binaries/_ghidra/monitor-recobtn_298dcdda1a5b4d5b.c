// Decompiled: monitor-recobtn_298dcdda1a5b4d5b
...

{
    ...
    sprintf(acStack_48, "/sys/class/gpio/gpio%d", 0x3b9);
    iVar1 = access(acStack_48, 0);
    if (iVar1 == 0) {
        sprintf(acStack_48, "/sys/class/gpio/gpio%d/value", 0x3b9);
