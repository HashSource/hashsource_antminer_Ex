// Decompiled: lzotest_884814d3b09a24fc
...

{
    ...
    if ((uint)param_1[1] < param_2) {
        ...
        __assert_fail(
            "len <= mb->len",
            "/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/"
            "rootfs/buildroot/tmp/release/build/lzo-2.10/lzotest/lzotest.c",
...

{
    ...
    do {
        ...
        if (iVar2 == 0)
            goto LAB_00014cf4;
        iVar2 = FUN_00014320(param_1, &DAT_00030ef0);
        if (iVar2 == 0) {
            FUN_00014480(1, 4999);
            ...
            if (iVar2 == 0) {
                ...
                if (iVar2 == 0) {
                    ...
                    iVar2 = FUN_00014320(param_1, &DAT_00030f00);
                    if (iVar2 == 0) {
    ...
    do {
        ...
        if (DAT_00043570 < DAT_0004355c) {
            ...
            __assert_fail("block_c.len <= block_c.saved_len",
                          ...
                          "Antminer_E9_release/build/rootfs/buildroot/tmp/"
