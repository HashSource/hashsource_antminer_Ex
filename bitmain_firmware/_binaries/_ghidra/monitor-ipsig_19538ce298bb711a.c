// Decompiled: monitor-ipsig_19538ce298bb711a
...

{
    ...
    sprintf(acStack_48, "/sys/class/gpio/gpio%d", 0x3bd);
    ...
    sprintf(acStack_48, "/sys/class/gpio/gpio%d/value", 0x3bd);
