// Decompiled: bitmain_axi.ko_b17bf65072216325_debug
...
LAB_00010280:
    if (param_4 == 0 && param_3 < 0x8000001) {
    ...
    if (param_5 == 2) {
      bVar1 = 0xf8000000 < param_3;
      param_3 = param_3 + 0x7ffffff;
      param_4 = param_4 + (uint)bVar1;
      goto LAB_00010280;
    }
    if (param_5 == 0) goto LAB_00010280;
  }
  param_3 = 0xffffffea;
  param_4 = -1;
LAB_00010290:
...

{
  ...
  remap_pfn_range(param_2,*param_2 + param_2[0x13],0x20000,0x1000,uVar1 & 0xffffffc3,param_2,param_3);
  return;
}
...

{
  ...
  uVar3 = *param_4;
  if (param_2 == 0 || (param_4[1] != 0 || 0x7ffffff < uVar3)) {
    return 0xffffffea;
  }
  if ((int)-(param_4[1] + (uint)(0x8000000 < uVar3)) < (int)(uint)(0x8000000 - uVar3 < param_3)) {
    param_3 = 0x8000000 - uVar3;
  }
...

{
  ...
  if (iVar1 < 0) {
    printk(&DAT_00010620,"axi_fpga_dev");
  }
  else {
    fpga_cache_store_addr = memremap(0x18000000,0x8000000,1);
    if (fpga_cache_store_addr == 0) {
      printk(&DAT_00010649,"axi_fpga_dev");
      misc_deregister(&axi_fpga_misc_dev);
    }
    else {
      mmioset(fpga_cache_store_addr,0,0x8000000);
      iVar1 = 0;
      printk(&DAT_00010678,"axi_fpga_dev",fpga_cache_store_addr,fpga_cache_store_addr >> 0x1f);
      printk(&DAT_000106a5,"axi_fpga_dev",0x18000000,0);
      printk(&DAT_000106d2,"axi_fpga_dev",0x8000000,0);
    }
  }
  return iVar1;
}
