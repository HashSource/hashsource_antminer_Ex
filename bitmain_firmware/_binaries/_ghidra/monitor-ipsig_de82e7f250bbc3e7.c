// Decompiled: monitor-ipsig_de82e7f250bbc3e7
...

{
    ...
    __libc_start_main(&LAB_00010958, in_stack_00000000, &stack0x00000004,
                      0x11539, &DAT_00011575, param_1);
...

{
    ...
    sprintf(acStack_48, "/sys/class/gpio/gpio%d", 0x178);
    ...
    sprintf(acStack_48, "/sys/class/gpio/gpio%d/value", 0x178);
...

{
    ...
    iVar1 = FUN_00010afc(&DAT_000116e0, acStack_9c);
    if (iVar1 == 0) {
        puts("get IP error");
    }
    FUN_00010cc0(acStack_bc, &DAT_000116e0);
    ...
    *pcVar2 = ',';
    ...
    sVar3 = sendto(DAT_000220a4, acStack_74,
                   (size_t)(pcVar2 + (__n - (int)acStack_74) + 1), 0,
                   (sockaddr *)&DAT_000220e4, 0x10);
    if (-1 < sVar3) {
        printf("send ipmac:\n%s\n", acStack_74);
        return 1;
    }
...
void FUN_00011218(void *param_1)
...

{
    ...
    local_98.fds_bits[(int)uVar3 >> 5] =
        local_98.fds_bits[(int)uVar3 >> 5] | 1 << (uVar6 & 0xff);
    __s1 = (char *)calloc(0x1e, 1);
    iVar1 =
        select(uVar5 + 1, &local_98, (fd_set *)0x0, (fd_set *)0x0, &local_a0);
    if (iVar1 == -1) {
        /* WARNING: Subroutine does not return */
        exit(-1);
    }
    if (iVar1 != 0) {
        ...
        if ((local_98.fds_bits[(int)uVar5 >> 5] & 1 << (uVar3 & 0xff)) == 0)
            goto joined_r0x000113b8;
        local_a4 = 0x10;
...
void FUN_00011538(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
