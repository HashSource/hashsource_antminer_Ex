int __fastcall i2c_init(const char *a1)
{
  ...
  if ( !platform_inited[0] )
  {
    ...
    LOWORD(v15) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/"
                                    "release/build/godminer-origin_master/backend/device/hal/platform/zynqmp/zynqmp_i2c.c";
LABEL_21:
    HIWORD(v14) = (unsigned int)"i2c_init" >> 16;
    HIWORD(v15) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/rele"
                                "ase/build/godminer-origin_master/backend/device/hal/platform/zynqmp/zynqmp_i2c.c" >> 16;
    zlog(v13, v15, 168, v14, 8, v12, 100, s);
    return v9;
  }
  ...
  if ( dword_16D6F0 )
  {
    v2 = (_DWORD *)dword_16D6F4;
  }
  else
  {
    v2 = new_c_map((int)sub_BCCCC, 0, 0);
    dword_16D6F4 = (int)v2;
  }
...
LABEL_16:
    ...
    if ( !strcmp("power-api", a1) )
    {
      ...
      insert_c_map((_DWORD *)dword_16D6F4);
      v9 = dword_16D6F0;
      goto LABEL_14;
    }
    v7 = open64(a1);
