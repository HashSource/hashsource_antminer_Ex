...
LABEL_5:
      ...
      if ( v6 != v7 )
      {
        ...
        if ( v16 <= (unsigned int)v32 )
          v32 = &v32[v36 - v16];
        v9 = &v32[-v17];
        if ( v36 > (unsigned int)v9 )
          v9 = (char *)(v16 - (v36 - (_DWORD)v9));
      }
      a1[5] = (int)v9;
      if ( v14 > (unsigned int)v9 )
        v11 = v14 - (_DWORD)v9;
      else
        v11 = v14 - v10 + v16 - (_DWORD)v9;
