int ui_init()
{
  ...
  v17 = gpio_reg_callback(v16, (int)sub_B3BB8);
  v18 = hal_key_ipreport_addr(v17);
  gpio_reg_callback(v18, (int)sub_B3BB8);
  pthread_mutex_init(&stru_16D540, 0);
  off_16D55C = 0;
  dword_16D560 = 0;
  dword_16D564 = 0;
  dword_16D568 = 0;
  dword_16D56C = 0;
  dword_16D558 = new_c_map(sub_B3924, 0, 0);
  dword_16D53C = 1;
  pthread_create((pthread_t *)&dword_16D574, 0, (void *(*)(void *))sub_B3934, 0);
  dword_16D570 = 1;
  return 0;
}
