int __fastcall diff_to_target_kda(int a1)
{
  ...
  else
  {
    ...
    v5 = 2.69595353e67 / v1 - sub_12E694(v3, HIDWORD(v3), v4) * 6.27710174e57;
    v6 = sub_12EA20(COERCE_UNSIGNED_INT64(v5 * 2.93873588e-39), HIDWORD(COERCE_UNSIGNED_INT64(v5 * 2.93873588e-39)));
    v8 = v5 - sub_12E694(v6, HIDWORD(v6), v7) * 3.40282367e38;
    v9 = sub_12EA20(COERCE_UNSIGNED_INT64(v8 * 5.42101086e-20), HIDWORD(COERCE_UNSIGNED_INT64(v8 * 5.42101086e-20)));
    v11 = sub_12E694(v9, HIDWORD(v9), v10);
    v12 = sub_12EA20(
