int __fastcall membist0(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_5C968(a1, v34, 12, 1);
      sub_5C968(a1, v34, 160, 3);
      usleep((__useconds_t)&stru_1869C.st_value);
      v6 = ptr;
      v7 = sub_5CBD4(a1, (unsigned __int16)v34, 161, ptr);
      if ( v7 > 0 )
      {
        v8 = 3 * v7;
        v9 = &ptr[4 * v8];
...
LABEL_10:
      v11 = ptr;
      v12 = sub_5CBD4(a1, (unsigned __int16)v34, 162, ptr);
      if ( v12 > 0 )
      {
        v13 = 3 * v12;
        v14 = &ptr[4 * v13];
...
LABEL_16:
      v16 = ptr;
      v3 = sub_5CBD4(a1, (unsigned __int16)v34, 163, ptr);
      if ( v3 > 0 )
      {
        v3 *= 3;
        v17 = &ptr[4 * v3];
...
LABEL_22:
  ...
  do
  {
    ...
    ++v19;
    v28 = strlen(v44);
    v29 = sub_5D044(v44, v28);
  }
  while ( v19 != &s[5] );
  v30 = dev_ctrl((int)v29);
  (*(void (__fastcall **)(_DWORD))(v30 + 72))(*(_DWORD *)(a1 + 144));
  return 0;
}
