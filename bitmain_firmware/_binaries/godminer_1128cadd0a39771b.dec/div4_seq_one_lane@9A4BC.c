int __fastcall div4_seq_one_lane(int a1, int a2, unsigned __int8 a3, unsigned __int16 a4)
{
  ...
  sub_5E0B4(a1, a3, a4 | 0x8B, -252706816);
  sub_5E0B4(a1, a3, a4 | 1, -65536);
  sub_5E0B4(a1, a3, a4 | 0x8C, 61680);
  sub_5E0B4(a1, a3, a4 | 1, (int)&loc_FFFFC + 3);
  sub_5E0B4(a1, a3, a4 | 0x8C, 251658240);
  sub_5E0B4(a1, a3, a4 | 1, -1048576);
  sub_5E0B4(a1, a3, a4 | 0x8D, (int)&loc_F0F0C + 3);
  sub_5E0B4(a1, a3, a4 | 1, 0xFFFFFF);
  sub_5E0B4(a1, a3, a4 | 0x8D, -268435456);
  sub_5E0B4(a1, a3, a4 | 1, -16777216);
  sub_5E0B4(a1, a3, a4 & 0xF000 | 0x8E, 15790320);
  sub_5E0B4(a1, a3, a4 | 1, 4095);
  sub_5E0B4(a1, a3, a4 & 0xF000 | 0x8A, 252641280);
  sub_5E0B4(a1, a3, a4 | 1, -4096);
  sub_5E0B4(a1, a3, a4 | 0x8B, 3855);
