int __fastcall sync_get_core_reg_base3(pthread_mutex_t *a1, int a2, int a3, int a4, int *a5, int a6, int a7, int a8)
{
  int v9; // r5
  char v12; // r1
  __int16 v14; // r3
  ...
  v31[0] = sub_12E9BC(a7, a8, 1000, 0);
  while ( v20 < a3 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[28].__lock, v32, 10, v31) == 110 )
      {
        v9 = 3;
        goto LABEL_15;
      }
