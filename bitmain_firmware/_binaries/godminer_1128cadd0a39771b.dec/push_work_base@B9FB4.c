int __fastcall push_work_base(int a1, int a2)
{
  ...
  if ( !*(_BYTE *)(a1 + 154) && !*(_BYTE *)(a1 + 153) )
    return 4;
  v4 = (pthread_mutex_t *)(a1 + 744);
  v5 = calloc(1u, *(_DWORD *)(a1 + 648));
  v13 = 0;
  ...
  {
    v7 = dev_ctrl(v6);
    v6 = (*(int (__fastcall **)(_DWORD))(v7 + 60))(*(_DWORD *)(a1 + 144));
  }
  while ( v6 < v13 );
  v8 = dev_ctrl(v6);
  v9 = (*(int (__fastcall **)(_DWORD, void *, unsigned int))(v8 + 44))(*(_DWORD *)(a1 + 144), v5, v13);
