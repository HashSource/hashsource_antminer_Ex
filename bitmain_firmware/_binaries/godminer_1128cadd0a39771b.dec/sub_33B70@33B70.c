int __fastcall sub_33B70(_DWORD *a1, int a2, int a3, int a4, int (__fastcall *a5)(char *, int, int), int a6)
{
  int v7; // r5
  int v8; // r9
  unsigned int v9; // r8
    ...
    case 0:
      ...
      if ( (v11 & 0x80) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          v25 = strlen(v24);
          sub_337E0((int)v24, v25, a5, a6, v9);
          v26 = a5(v41, v21, a6) == 0;
          v27 = v22;
          v22 = v23;
          if ( !v26 )
          ...
          if ( sub_33B70(v28, v9, v48, v7, a5, a6) )
            return -1;
          if ( !v23 )
          {
            v8 = (int)base;
            v14 = 0;
            if ( !sub_33A68(v9, v44, 0, a5, a6) )
              goto LABEL_65;
            return -1;
          }
          if ( a5((char *)&word_12FC5C, 1, a6) || sub_33A68(v9, v48, 1, a5, a6) )
            return -1;
        }
      }
      ...
      while ( v34 );
      v7 = v51;
      qsort(basea, nmemb, 4u, (__compar_fn_t)sub_337D4);
      if ( nmemb )
      {
        v53 = v8;
        v36 = v52;
        ...
        do
        {
          ...
          v40 = strlen(v38);
          sub_337E0((int)v38, v40, a5, a6, v9);
          if ( a5(v41, v43, a6) || sub_33B70(v39, v9, v48, v51, a5, a6) )
          {
LABEL_70:
            v14 = -1;
            jsonp_free(basea);
          ...
          else if ( sub_33A68(v9, a3, 0, a5, a6) )
          {
            goto LABEL_70;
          }
        }
...
LABEL_47:
    ...
    case 2:
      ...
      return sub_337E0(v16, v17, a5, a6, v9);
    case 3:
  ...
  do
  {
    ...
    v14 = sub_33B70(v31, v9, v30, v7, a5, a6);
    if ( v14 )
      return -1;
    v32 = v42 - 1 > v29++;
    if ( v32 )
    {
      if ( a5((char *)&word_12FC5C, 1, a6) || sub_33A68(v9, v30, 1, a5, a6) )
        return -1;
    }
    else if ( sub_33A68(v9, v45, 0, a5, a6) )
    {
      return -1;
    }
  }
