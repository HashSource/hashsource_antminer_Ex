      ...
      while ( 1 )
      {
        ...
        if ( v3 == 128 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( &unk_142420 == (_UNKNOWN *)v10 )
              break;
            v11 = *(v10 - 10);
            v12 = 8 * *(v10 - 15);
            v13 = 2 * *(v10 - 16);
            v141 = (char *)&unk_1423E0 + v12;
            v14 = 2 * *(v10 - 14);
            v15 = *(v10 - 13);
            v155 = *(_DWORD *)((char *)&unk_1423E0 + v13 * 4);
            v16 = &v223[v12];
            v17 = (char *)&unk_1423E0 + 8 * v15;
            v18 = &v223[8 * v15];
            v19 = 2 * *(v10 - 12);
            v156 = *(_DWORD *)((char *)&unk_1423E0 + v13 * 4 + 4);
            v20 = 2 * *(v10 - 11);
            v21 = &v223[8 * v11];
            v152 = v208[v13 - 1];
            v153 = v208[v13];
            v154 = *((_DWORD *)&unk_1423E0 + 2 * *(v10 - 15));
            v151 = *((_DWORD *)v141 + 1);
            v140 = *((_DWORD *)v16 - 32);
            v142 = *((_DWORD *)v16 - 31);
            v160 = *(_DWORD *)((char *)&unk_1423E0 + v14 * 4);
            v161 = *(_DWORD *)((char *)&unk_1423E0 + v14 * 4 + 4);
            v143 = v208[v14 - 1];
            v157 = v208[v14];
            LODWORD(v158) = *((_DWORD *)&unk_1423E0 + 2 * *(v10 - 13));
            HIDWORD(v158) = *((_DWORD *)v17 + 1);
            v159 = *((_DWORD *)v18 - 32);
            v144 = *((_DWORD *)v18 - 31);
            v163 = *(_QWORD *)((char *)&unk_1423E0 + v19 * 4);
            v145 = *(_QWORD *)&v208[v19 - 1];
            v162 = *(_QWORD *)((char *)&unk_1423E0 + v20 * 4);
            v146 = *(_QWORD *)&v208[v20 - 1];
            v22 = *((_DWORD *)&unk_1423E0 + 2 * v11 + 1);
            v23 = *(v10 - 9);
            v147 = *((_QWORD *)v21 - 16);
            v167 = v22;
            v24 = (__int64 *)((char *)&unk_1423E0 + 8 * v23);
            v25 = &v223[8 * v23];
            v26 = 2 * *(v10 - 4);
            v27 = 2 * *(v10 - 5);
            v166 = *((_DWORD *)&unk_1423E0 + 2 * *(v10 - 10));
            v164 = *v24;
            v28 = 2 * *(v10 - 3);
            v165 = *((_DWORD *)v25 - 32);
            v148 = *((_DWORD *)v25 - 31);
            v171 = *((_QWORD *)&unk_1423E0 + *(v10 - 8));
            v168 = *(_QWORD *)&v208[2 * *(v10 - 8) - 1];
            v175 = *((_QWORD *)&unk_1423E0 + *(v10 - 6));
            v169 = *((_QWORD *)&unk_1423E0 + *(v10 - 7));
            v172 = *(_QWORD *)&v208[2 * *(v10 - 6) - 1];
            v170 = *(_QWORD *)&v208[2 * *(v10 - 7) - 1];
            v173 = *(_QWORD *)((char *)&unk_1423E0 + v27 * 4);
            v174 = *(_QWORD *)&v208[v27 - 1];
            v176 = *(_QWORD *)&v208[v26 - 1];
            v180 = *(_QWORD *)((char *)&unk_1423E0 + v26 * 4);
            v178 = *(_QWORD *)&v208[v28 - 1];
            v177 = *(_QWORD *)((char *)&unk_1423E0 + v28 * 4);
            v29 = *((_QWORD *)v10 - 1);
            v184 = *((_QWORD *)&unk_1423E0 + v29);
            v183 = *((_QWORD *)&unk_1423E0 + HIDWORD(v29));
