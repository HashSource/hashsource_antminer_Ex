...
LABEL_25:
  ...
  v7 = zlog(
         ...
         "in_master/common/general/http.c",
         142,
         "statusServiceThread",
         19,
         66,
...
LABEL_21:
              ...
              LOWORD(v26) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buil"
      ...
      do
      {
        ...
        v40 = zlog(
                ...
                "er-origin_master/common/general/http.c",
                142,
                "statusServiceThread",
                19,
                158,
        ...
        if ( v38 <= 0 )
        {
          ...
          v40 = zlog(
                  ...
                  "iner-origin_master/common/general/http.c",
                  142,
                  "statusServiceThread",
                  19,
                  162,
...
LABEL_23:
    ...
    HIWORD(v26) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_E9_release/build/rootfs/buildroot/tmp/rele"
                                "ase/build/godminer-origin_master/common/general/http.c" >> 16;
    zlog(v23, v26, 142, v25, 19, v24, 20, v53);
    return 0;
  }
}
