int __fastcall sub_258A4(int a1, const char *a2, int a3, unsigned int a4)
{
  int result; // r0
  const char *v9; // r1
  int v10; // r4
  ...
  *(_DWORD *)dest = 0;
  ...
  if ( a4 )
  {
    ...
    if ( !old_cmds )
      return (int)sub_238A0(a1, 0, 14, "Invalid command");
    v10 = 0;
...
LABEL_20:
  ...
  result = ((int (__fastcall *)(int, _UNKNOWN **))(&opt_api_description)[3 * a4 + 47])(a1, &new_cmds + 3 * a4);
  if ( result < 0 )
  {
