bool __fastcall sub_465C4(int a1, int *a2, _DWORD *a3)
{
  _BOOL4 v4; // r4
  _DWORD *v7; // r0
  const char *v8; // r5
                              ...
                              if ( v4 )
                              {
                                ...
                                if ( v4 )
                                {
                                  ...
                                  if ( v37 )
                                  {
                                    ...
                                    if ( memcmp(v78, &dword_167164, 0x20u) )
                                    {
                                      dword_167164 = *v78;
                                      memset(v119, 0, sizeof(v119));
                                      memset(&unk_167184, 0, 0x20u);
                                      hs_blake2b_init(dest, 32);
                                      hs_blake2b_update(dest, v78, 32);
                                      hs_blake2b_update(dest, v119, 32);
                                      v92 = hs_blake2b_final(dest, &unk_167184, 32);
                                      V_LOCK(v92);
