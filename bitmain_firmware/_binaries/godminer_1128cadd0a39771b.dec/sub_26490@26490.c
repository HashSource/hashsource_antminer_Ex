int __fastcall sub_26490(int a1, int a2)
{
  int v3; // r9
  void *v4; // r0
  void *v5; // r0
  ...
  *(_DWORD *)v159 = 0;
  ...
  {
    v5 = sub_238A0(a1, 1, 70, *(const char **)(a2 + 8));
    v150 = json_array(v5);
    v6 = json_object(v150);
    v7 = json_string("2.12");
    ...
    if ( v153 > 0 )
    {
      ...
      else
      {
        ...
        do
        {
          ...
          v138 += 52;
          v142 = v153 <= v3;
          *((_DWORD *)v140 + 1) = *(_DWORD *)(*v139 + 148) + 1;
          v140 += 4;
        }
        while ( !v142 );
        v18 = v3;
    ...
    {
      sub_25FC4();
      v26 = sub_12E9F8(LODWORD(v22), HIDWORD(v22));
    }
    else
    {
      v26 = 0;
    ...
    v28 = sub_12E9F8(COERCE_UNSIGNED_INT64(v23 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v23 * 100.0)));
    v29 = sub_12E6A4(v28, HIDWORD(v28));
    v30 = json_real(v29);
    json_object_set_new(v19, "GHS 5s", v30);
    v31 = sub_12E9F8(COERCE_UNSIGNED_INT64(v25 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v25 * 100.0)));
    v32 = sub_12E6A4(v31, HIDWORD(v31));
    v33 = json_real(v32);
    json_object_set_new(v19, "GHS av", v33);
    v34 = sub_12E9F8(COERCE_UNSIGNED_INT64(v24 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v24 * 100.0)));
    v35 = sub_12E6A4(v34, HIDWORD(v34));
    v36 = json_real(v35);
    ...
    v38 = sub_12E9F8(LODWORD(v37), HIDWORD(v37));
    v39 = sub_12E6A4(v38, HIDWORD(v38));
    v40 = json_real(v39);
