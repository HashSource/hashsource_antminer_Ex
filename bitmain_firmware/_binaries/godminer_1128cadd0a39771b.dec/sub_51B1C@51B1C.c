int __fastcall sub_51B1C(pthread_mutex_t *a1, int a2, int a3, _DWORD *a4, int a5, int a6)
{
  ...
  v17[0] = sub_12E9BC(a5, a6, 1000, 0);
  while ( a2 > v11 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[28].__lock, v18, 10, v17) == 110 )
      {
        v10 = 3;
        goto LABEL_11;
      }
