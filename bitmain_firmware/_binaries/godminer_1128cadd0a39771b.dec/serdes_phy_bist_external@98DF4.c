int __fastcall serdes_phy_bist_external(int a1, int a2, _BYTE *a3, int a4, unsigned __int8 a5, int a6)
{
  ...
  sub_5E0B4(a1, (unsigned __int8)a3, v12, (2 * a5) & 0xE);
  v13 = sub_5E0B4(a1, (unsigned __int8)a3, v11, 0);
  V_LOCK(v13);
  ...
  if ( a6 > 2 )
  {
    ...
    sub_5E0B4(a1, (unsigned __int8)a3, v11, -2);
    v18 = (unsigned __int16)v25 | 0x91;
    v19 = (unsigned __int16)v25 | 0x77;
    sub_5E0B4(a1, (unsigned __int8)a3, v18, 1);
    sub_5E0B4(a1, (unsigned __int8)a3, v11, -4194305);
    sub_5E0B4(a1, (unsigned __int8)a3, v19, 0x400000);
    sub_5E0B4(a1, (unsigned __int8)a3, v11, 0);
    sub_5E0B4(a1, (unsigned __int8)a3, v11, -9);
    sub_5E0B4(a1, (unsigned __int8)a3, v18, 8);
    sub_5E0B4(a1, (unsigned __int8)a3, v11, -1073741825);
    sub_5E0B4(a1, (unsigned __int8)a3, v19, 0x40000000);
    sub_5E0B4(a1, (unsigned __int8)a3, v11, 0);
    check_bist_tx_running(a1, a2, a3, a4);
    check_bist_rx_running(a1, a2, (int)a3, a4);
    usleep(0x493E0u);
    sub_5E0B4(a1, (unsigned __int8)a3, v11, -9);
    sub_5E0B4(a1, (unsigned __int8)a3, v18, 0);
    sub_5E0B4(a1, (unsigned __int8)a3, v11, 0);
  ...
  {
    v27 = 336529925;
    sub_5C968(a1, (unsigned __int8)a3, 98, 16);
    ...
    for ( i = 5; ; i = v17 )
    {
      ...
      sub_5C968(a1, (unsigned __int8)a3, 144, -9);
      sub_5C968(a1, (unsigned __int8)a3, 145, -2147454975);
      sub_5C968(a1, (unsigned __int8)a3, 144, 8);
      sub_5C968(a1, (unsigned __int8)a3, 145, -2147454831);
      sub_5C968(a1, (unsigned __int8)a3, 144, -1073741825);
      sub_5C968(a1, (unsigned __int8)a3, 145, -2147454975);
      sub_5C968(a1, (unsigned __int8)a3, 144, 0x40000000);
      sub_5C968(a1, (unsigned __int8)a3, 145, -2147454857);
    ...
    sub_5C968(a1, (unsigned __int8)a3, 98, 0);
    sub_5C968(a1, 3u, 83, 0);
    sub_5C968(a1, (unsigned __int8)a3, 98, 128);
    for ( j = 5; ; j = v23 )
    {
      enable_rxbist_autostop_one_lane(a1, a2, (unsigned __int8)a3, 7u, j);
      sub_5C968(a1, (unsigned __int8)a3, 144, -13);
      sub_5C968(a1, (unsigned __int8)a3, 145, -2147454975);
      sub_5C968(a1, (unsigned __int8)a3, 144, 12);
      sub_5C968(a1, (unsigned __int8)a3, 145, -2147454962);
      sub_5C968(a1, (unsigned __int8)a3, 144, 0);
      sub_5C968(a1, (unsigned __int8)a3, 145, -2147454975);
