unsigned int __fastcall stratum_handle_method_grin29(int a1, int a2, int a3)
{
  double v3; // d0
  _DWORD *v5; // r0
  _DWORD *v6; // r4
                  ...
                  while ( v190 > v102 )
                  {
                    ...
                    if ( !v145 || (v100 = strlen((const char *)v145) == 64, v145 = 32, !v100) )
                    {
                      ...
                      zlog(
                        ...
                        "d/godminer-origin_master/frontend/frontend_grin29/frontend_grin29.c",
                        163,
                        "stratum_notify",
                        14,
                        235,
  ...
  else
  {
    if ( !strcasecmp(v8, "client.reconnect") )
    {
      ...
      if ( !v73 )
      {
        ...
        zlog(
          ...
          "gin_master/frontend/frontend_grin29/frontend_grin29.c",
          163,
          "stratum_reconnect",
          17,
          476,
    ...
    if ( strcasecmp(v8, "client.get_algo") )
    {
      if ( !strcasecmp(v8, "client.get_stats") )
      {
        ...
        {
          sub_405A4(v105, (_DWORD *)1, "disabled");
        }
...
LABEL_90:
      ...
      else
      {
        ...
        sub_405A4(v81, (_DWORD *)0x26, "unknown method");
        v86 = (char *)json_dumps(v81, 0);
        v10 = stratum_send_line(a2, v86);
        if ( v81 && v81[1] != -1 )
        {
