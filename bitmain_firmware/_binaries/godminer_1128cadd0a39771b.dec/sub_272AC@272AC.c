int __fastcall sub_272AC(int a1, int a2)
{
  int v4; // r0
  bool v5; // zf
  int v6; // r5
  ...
  {
    v6 = v4;
    v7 = sub_238A0(a1, 1, 11, *(const char **)(a2 + 8));
    v90 = json_array(v7);
    v8 = json_object(v90);
    ...
    if ( byte_165FF8 )
    {
      ...
      sub_25FC4();
      v85 = v11;
      v17 = sub_12E6A4(*v10, v10[1]);
      v18 = sub_12E9F8(LODWORD(v11), HIDWORD(v11));
      if ( v11 == 0.0 )
        v85 = 1.0;
    }
    else
    {
      HIWORD(v10) = (unsigned int)&total_accepted >> 16;
      v85 = 1.0;
      v17 = COERCE_DOUBLE(((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(*v10, v10[1]));
      v18 = 0;
    }
    v19 = json_integer(v18, HIDWORD(v18));
    json_object_set_new(v8, "Elapsed", v19);
    v20 = sub_12E9F8(COERCE_UNSIGNED_INT64(v14 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v14 * 100.0)));
    v21 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v20, HIDWORD(v20));
    v22 = json_real(v21);
    json_object_set_new(v8, "GHS 5s", v22);
    v23 = sub_12E9F8(COERCE_UNSIGNED_INT64(v16 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v16 * 100.0)));
    v24 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v23, HIDWORD(v23));
    v25 = json_real(v24);
    json_object_set_new(v8, "GHS av", v25);
    v26 = sub_12E9F8(COERCE_UNSIGNED_INT64(v15 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v15 * 100.0)));
    v27 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v26, HIDWORD(v26));
    v28 = json_real(v27);
    json_object_set_new(v8, "GHS 30m", v28);
    v29 = json_integer(dword_165FFC, 0);
    json_object_set_new(v8, "Found Blocks", v29);
    v30 = json_integer(total_getworks, dword_16D89C);
    json_object_set_new(v8, "Getwork", v30);
    v31 = json_integer(*v10, v10[1]);
    json_object_set_new(v8, "Accepted", v31);
    v32 = json_integer(total_rejected, dword_16D8B4);
    ...
    v35 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v34, HIDWORD(v34));
    v36 = json_real(v35);
    json_object_set_new(v8, "Utility", v36);
    v37 = json_integer(total_discarded, dword_16D874);
    json_object_set_new(v8, "Discarded", v37);
    v38 = json_integer(total_stale, dword_16D864);
    ...
    v43 = sub_12E9F8(COERCE_UNSIGNED_INT64(dbl_166000 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(dbl_166000 * 100.0)));
    v44 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v43, HIDWORD(v43));
    v45 = json_real(v44);
    ...
    v49 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v48, HIDWORD(v48));
    v50 = json_real(v49);
    ...
    v52 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v51, HIDWORD(v51));
    v53 = json_real(v52);
    ...
    v55 = ((__int64 (__fastcall *)(_DWORD, _DWORD))sub_12E6A4)(v54, HIDWORD(v54));
    v56 = json_real(v55);
    json_object_set_new(v8, "Difficulty Stale", v56);
    v57 = json_integer(dword_166008, dword_16600C);
    ...
    {
      v81 = COERCE_DOUBLE(
              ((__int64 (__fastcall *)(unsigned int, unsigned int, _DWORD))sub_12E694)(
                v91,
                v88,
                (v91 + total_diff1) | ((__PAIR64__(v88, v91) + total_diff1) >> 32)));
      v83 = sub_12E694(v87, HIDWORD(v87), v82);
      v84 = sub_12E9F8(COERCE_UNSIGNED_INT64(v81 / v83 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v81 / v83 * 100.0)));
      v58 = sub_12E6A4(v84, HIDWORD(v84));
    }
    ...
    if ( v65 != 0.0 )
    {
      ...
      v64 = sub_12E6A4(v66, HIDWORD(v66));
    }
    ...
    if ( v69 != 0.0 )
    {
      ...
      v68 = sub_12E6A4(v70, HIDWORD(v70));
    }
    ...
    if ( !strcmp(*(const char **)(*(_DWORD *)all_created_runtime + 196), "dash") )
    {
      v75 = v93;
      update_rate_ideal();
      v76 = sub_12E9F8(COERCE_UNSIGNED_INT64(v75 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v75 * 100.0)));
      v77 = sub_12E6A4(v76, HIDWORD(v76));
