int __fastcall sub_2853C(int a1, const char **a2)
{
  float v2; // s0
  void *v5; // r0
  bool v6; // zf
      ...
      do
      {
        ...
        if ( v24 )
        {
          ...
          *(_DWORD *)v47 = 0;
          ...
          v41 = sub_12E9F8(*(_DWORD *)(v24 + 2128), *(_DWORD *)(v24 + 2132));
          ...
          {
            v13 = sub_12E9F8(*(_DWORD *)(v24 + 2136), *(_DWORD *)(v24 + 2140));
          }
          v14 = json_integer(v13, HIDWORD(v13));
          json_object_set_new(v25, "diffr", v14);
          v15 = sub_12E9F8(*(_DWORD *)(v24 + 1984), *(_DWORD *)(v24 + 1988));
          v16 = json_integer(v15, HIDWORD(v15));
          json_object_set_new(v25, "diffs", v16);
          v17 = sub_12E9F8(*(_DWORD *)(v24 + 1792), *(_DWORD *)(v24 + 1796));
