int __fastcall sub_24F08(int a1, int a2)
{
  void *v4; // r0
  bool v5; // zf
  int v6; // r5
  ...
  *(_DWORD *)v78 = 0;
  ...
  else
  {
    ...
    if ( total_pools )
    {
      v7 = sub_238A0(a1, 1, 7, *(const char **)(a2 + 8));
      v73 = json_array(v7);
      if ( total_pools > 0 )
      {
        appended = "";
        ...
        do
        {
          ...
          *(_DWORD *)v78 = 0;
          ...
          v57 = sub_12E9F8(COERCE_UNSIGNED_INT64(*v52 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(*v52 * 100.0)));
          v58 = sub_12E6A4(v57, HIDWORD(v57));
          v59 = json_real(v58);
          ...
          v61 = sub_12E6A4(v60, HIDWORD(v60));
          v62 = json_real(v61);
          json_object_set_new(v28, "Difficulty Rejected", v62);
          v63 = sub_12E9F8(COERCE_UNSIGNED_INT64(*v51 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(*v51 * 100.0)));
          v64 = sub_12E6A4(v63, HIDWORD(v63));
          v65 = json_real(v64);
          ...
          v67 = sub_12E6A4(v66, HIDWORD(v66));
          v68 = json_real(v67);
          ...
          if ( v20 != 0.0 )
          {
            ...
            v18 = sub_12E6A4(v21, HIDWORD(v21));
          }
          v22 = json_real(v18);
          ...
          if ( v24 != 0.0 )
          {
            ...
            v23 = sub_12E6A4(v25, HIDWORD(v25));
          }
          v26 = json_real(v23);
