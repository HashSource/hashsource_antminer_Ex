void *runtime_ctrl_zec_1746()
{
  ...
  LODWORD(v3[11]) = sub_A2BD8;
  v1 = v0;
  HIDWORD(v3[14]) = sub_A2BF8;
  ...
  HIDWORD(v3[25]) = sub_A3610;
  HIDWORD(v3[24]) = sub_A47C4;
