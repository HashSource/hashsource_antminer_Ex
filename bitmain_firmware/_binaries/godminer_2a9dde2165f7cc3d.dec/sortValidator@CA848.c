...
LABEL_7:
  ...
  do
  {
    v19 = v15[1];
    ++v15;
    v20 = sub_12E2E4(bswap32(v19), v99);
    v21 = v4 * HIDWORD(v20);
    sub_CA67C(v95, v20, v122, v100);
  ...
  {
    v29 = 0;
    qsort(ptr, nmemb, v17 + v27, sub_CA66C);
    v105 = 2 * (v17 + v27);
    v30 = &ptr[v17 + v27 + v17];
    v31 = &ptr[v17];
    nmemb = ((nmemb - 1) >> 1) + 1;
  ...
  do
  {
    v53 = v51[1];
    ++v51;
    v54 = sub_12E2E4(v53, v99);
    v55 = v111 * HIDWORD(v54);
    sub_CA67C(v95, v54, src, v100);
