void *runtime_ctrl_kda_2110()
{
  ...
  HIDWORD(v3[11]) = sub_8AA5C;
  LODWORD(v3[11]) = sub_8AB78;
  LODWORD(v3[12]) = sub_88EF4;
  HIDWORD(v3[12]) = sub_8A79C;
  LODWORD(v3[13]) = sub_8A674;
  LODWORD(v3[14]) = sub_89ED0;
  HIDWORD(v3[13]) = sub_8A298;
  HIDWORD(v3[14]) = sub_899DC;
  LODWORD(v3[15]) = sub_89638;
  ...
  HIDWORD(v3[24]) = sub_8B448;
  HIDWORD(v3[25]) = sub_88F0C;
