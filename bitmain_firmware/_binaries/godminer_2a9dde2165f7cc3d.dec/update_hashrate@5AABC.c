_DWORD *__fastcall update_hashrate(int a1, int a2, _DWORD *a3)
{
  ...
  *(_QWORD *)(a2 + 56) = v7;
  if ( v6 <= 16 )
  {
    ...
    v11 = sub_12E818(v9, HIDWORD(v9)) / 1000.0;
    if ( v11 >= 5.0 )
    {
      v34 = *(_DWORD *)(a1 + 416);
      v35 = *(_DWORD *)(a1 + 420);
      ...
      {
        v31 = COERCE_FLOAT(
                ((int (__fastcall *)(int, unsigned int))sub_12E808)(
                  1 << *(_DWORD *)(a1 + 400),
                  (1 << (*(_DWORD *)(a1 + 400) - 32)) | (1u >> (32 - *(_DWORD *)(a1 + 400)))));
        v24 = sub_12E808(v37, HIDWORD(v37));
      ...
      *((_DWORD *)v27 + 720) = (v32 + 1) % 720;
      v30 = v25 + (float)(sub_12E808(v36, v28) * *(float *)(a2 + 44));
      *(float *)(a2 + 44) = v30 / sub_12E808(v29, HIDWORD(v29));
      *((_QWORD *)v33 + 361) = v29;
    }
    sub_5AA20((int)v10);
    *(float *)(a2 + 32) = 5.0;
    ...
    *(_QWORD *)(a2 + 80) = v15;
    ...
    if ( (float)(sub_12E818(v18, HIDWORD(v18)) / 1000.0) >= 900.0 )
    {
      sub_5AA20((int)v10);
      v20 = *(_DWORD *)(a2 + 200);
      if ( v20 > 23 )
