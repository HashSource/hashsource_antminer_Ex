        ...
        int a13)
{
  ...
  v25 = COERCE_DOUBLE(sub_12E61C(*v15, v15[1]));
  v76 = v22 * v23;
  v26 = v25;
  if ( v23 != 0.0 )
    v26 = v25 / v23;
  ...
  v29 = sub_12E970(LODWORD(v23), HIDWORD(v23));
  ...
  if ( v30 )
  {
    v69 = sub_12E970(COERCE_UNSIGNED_INT64(v24 * v23 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v24 * v23 * 100.0)));
    v70 = sub_12E61C(v69, HIDWORD(v69));
    json_real(v70);
    ((void (__fastcall *)(int, const char *))json_object_set_new)(v13, "GHS 5s");
    v71 = sub_12E970(COERCE_UNSIGNED_INT64(v27 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v27 * 100.0)));
    v72 = sub_12E61C(v71, HIDWORD(v71));
    json_real(v72);
    ((void (__fastcall *)(int, const char *))json_object_set_new)(v13, "GHS av");
    v36 = sub_12E970(COERCE_UNSIGNED_INT64(v76 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v76 * 100.0)));
  }
  else
  {
    v31 = sub_12E970(COERCE_UNSIGNED_INT64(v21 * v23 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v21 * v23 * 100.0)));
    v32 = sub_12E61C(v31, HIDWORD(v31));
    json_real(v32);
    ((void (__fastcall *)(int, const char *))json_object_set_new)(v13, "GHS 5s");
    v33 = *(float *)&v23;
    v34 = sub_12E970(COERCE_UNSIGNED_INT64(v33 * v27 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v33 * v27 * 100.0)));
    v35 = sub_12E61C(v34, HIDWORD(v34));
    json_real(v35);
    ((void (__fastcall *)(int, const char *))json_object_set_new)(v13, "GHS av");
    v36 = sub_12E970(COERCE_UNSIGNED_INT64(v33 * v76 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v33 * v76 * 100.0)));
  }
  v37 = sub_12E61C(v36, HIDWORD(v36));
  json_real(v37);
  ...
  v38 = sub_12E970(COERCE_UNSIGNED_INT64(v28 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v28 * 100.0)));
  v39 = sub_12E61C(v38, HIDWORD(v38));
  json_real(v39);
  ...
  v40 = sub_12E970(COERCE_UNSIGNED_INT64(dbl_1731C0 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(dbl_1731C0 * 100.0)));
  v41 = sub_12E61C(v40, HIDWORD(v40));
  json_real(v41);
  ...
  v43 = sub_12E970(COERCE_UNSIGNED_INT64(*v18 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(*v18 * 100.0)));
  v44 = sub_12E61C(v43, HIDWORD(v43));
  json_real(v44);
  ...
  v46 = sub_12E61C(v45, HIDWORD(v45));
  json_real(v46);
  ((void (__fastcall *)(int, const char *))json_object_set_new)(v13, "Difficulty Rejected");
  v47 = sub_12E970(COERCE_UNSIGNED_INT64(*v17 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(*v17 * 100.0)));
  v48 = sub_12E61C(v47, HIDWORD(v47));
  json_real(v48);
  ...
  {
    v66 = COERCE_DOUBLE(
            ((__int64 (__fastcall *)(_DWORD, _DWORD, int, _DWORD))sub_12E60C)(
              v74,
              HIDWORD(v74),
              (int)v74 + (int)total_diff1,
              (v74 + total_diff1) | ((unsigned __int64)(v74 + total_diff1) >> 32)));
    v67 = ((double (__fastcall *)(_DWORD, _DWORD))sub_12E60C)(v73, HIDWORD(v73));
    v68 = sub_12E970(COERCE_UNSIGNED_INT64(v66 / v67 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v66 / v67 * 100.0)));
    v49 = sub_12E61C(v68, HIDWORD(v68));
  }
  json_real(v49);
  ...
  v58 = sub_12E970(COERCE_UNSIGNED_INT64(v55 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v55 * 100.0)));
  v59 = sub_12E61C(v58, HIDWORD(v58));
  json_real(v59);
  v60 = ((int (__fastcall *)(int, const char *))json_object_set_new)(v13, "Pool Rejected%");
  v61 = *v18 + total_diff_rejected + *v17;
  if ( v61 != 0.0 )
  {
    v62 = sub_12E970(COERCE_UNSIGNED_INT64(*v17 / v61 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(*v17 / v61 * 100.0)));
    v60 = sub_12E61C(v62, HIDWORD(v62));
  }
  json_real(v60);
