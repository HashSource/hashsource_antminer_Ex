int __fastcall sub_278C4(int a1, int a2)
{
  ...
  *(_DWORD *)v168 = 0;
  ...
  else
  {
    ...
    v32 = sub_12E970(LODWORD(v30), HIDWORD(v30));
    ...
    if ( v36 )
    {
      v149 = sub_12E970(COERCE_UNSIGNED_INT64(v29 * v30 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v29 * v30 * 100.0)));
      v150 = sub_12E61C(v149, HIDWORD(v149));
      v151 = json_real(v150);
      json_object_set_new(v26, "GHS 5s", v151);
    }
    else
    {
      v37 = sub_12E970(COERCE_UNSIGNED_INT64(v31 * v30 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v31 * v30 * 100.0)));
    ...
    v40 = sub_12E970(COERCE_UNSIGNED_INT64(v35 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v35 * 100.0)));
    v41 = sub_12E61C(v40, HIDWORD(v40));
    v42 = json_real(v41);
    json_object_set_new(v26, "GHS av", v42);
    v43 = sub_12E970(COERCE_UNSIGNED_INT64(v34 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v34 * 100.0)));
    v44 = sub_12E61C(v43, HIDWORD(v43));
    v45 = json_real(v44);
    json_object_set_new(v26, "rate_30m", v45);
    v46 = sub_12E970(COERCE_UNSIGNED_INT64(v166 * 100.0), HIDWORD(COERCE_UNSIGNED_INT64(v166 * 100.0)));
    v47 = sub_12E61C(v46, HIDWORD(v46));
    v48 = json_real(v47);
...
LABEL_75:
    ...
    v122 = v117;
    if ( opt_algo == 9 )
      v122 = sub_12E934(v117, HIDWORD(v117), 1000, 0);
