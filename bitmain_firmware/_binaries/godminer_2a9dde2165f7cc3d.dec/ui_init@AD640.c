int ui_init()
{
  ...
  v17 = gpio_reg_callback(v16, (int)sub_AD240);
  v18 = hal_key_ipreport_addr(v17);
  gpio_reg_callback(v18, (int)sub_AD240);
  ...
  dword_18D86C = 0;
  dword_18D870 = 0;
  dword_18D85C = new_c_map(sub_ACFAC, 0, 0);
  dword_18D840 = 1;
  pthread_create((pthread_t *)&dword_18D878, 0, (void *(*)(void *))sub_ACFBC, 0);
  dword_18D874 = 1;
  return 0;
}
