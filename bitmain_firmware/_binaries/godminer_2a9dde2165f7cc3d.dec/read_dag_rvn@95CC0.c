        ...
        do
        {
          ...
          do
          {
            ...
            *v9 = 0;
            v9[1] = 0;
            v9[2] = 0;
            (*(void (__fastcall **)(int, _DWORD *, int, _DWORD *, int *, int, int, _DWORD, int, int, char *, int, const char *, const char *))(v6 + 264))(
              v6,
              v44,
              1,
              v9,
            ...
            if ( v37 )
            {
              ...
              zlog(
                ...
                "dminer-origin_godminer-new/backend/backend_rvn_2020/backend_rvn_2020.c",
                174,
                "read_dag_rvn",
                12,
                413,
