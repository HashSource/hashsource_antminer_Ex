int __fastcall sub_640F8(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  int v8; // r4
  int v12; // r9
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 65) = v12;
  *(_BYTE *)(a3 + 64) = v18;
  v19 = sub_12DDD8(*(unsigned __int8 *)(a2 + 3), *(_DWORD *)(a1 + 396));
  if ( v19 >= *(_DWORD *)(a1 + 304) )
  {
    v27 = rand();
    sub_12E2E4(v27, *(_DWORD *)(a1 + 304));
    v19 = v28;
  }
  *a6 = v19;
  *(_DWORD *)(a3 + 8) = v19;
