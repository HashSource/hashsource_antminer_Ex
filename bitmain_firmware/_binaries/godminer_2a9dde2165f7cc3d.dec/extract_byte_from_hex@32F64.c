int __fastcall extract_byte_from_hex(const char *a1, int a2)
{
  ...
  if ( (unsigned int)(v6 - 97) > 5 && (unsigned int)(v6 - 48) > 9 )
  {
    ...
    v5 = (const __int32_t **)zlog(
                               g_zc,
                               "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/r"
                               "elease/build/godminer-origin_godminer-new/util.c",
                               137,
                               "extract_byte_from_hex",
                               21,
                               35,
