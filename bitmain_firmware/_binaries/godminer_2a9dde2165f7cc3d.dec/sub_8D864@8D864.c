int __fastcall sub_8D864(int a1, int a2, char a3)
{
  int v4; // r6
  _WORD *v5; // r10
  int v6; // r0
  ...
  v20 = 0;
  v5 = calloc(0xCu, 1u);
  v6 = (*(int (__fastcall **)(int, _DWORD *, int, _WORD *, int *))(a1 + 268))(a1, v18, 1, v5, &v17);
  if ( v17 <= 0 )
  {
    v14 = v13;
  }
  ...
  LOBYTE(v20) = -1;
  LOBYTE(v19) = v16;
  v10 = *(int (__fastcall **)(int, _DWORD *))(a1 + 244);
  BYTE1(v19) = v15;
  v18[0] = v14;
  result = v10(a1, v18);
  if ( result < 0 )
