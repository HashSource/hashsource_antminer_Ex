void *runtime_ctrl_dcr_1727()
{
  ...
  HIDWORD(v3[11]) = sub_6D760;
  LODWORD(v3[11]) = sub_6D87C;
  LODWORD(v3[12]) = sub_6BD10;
  LODWORD(v3[13]) = sub_6D490;
  HIDWORD(v3[13]) = sub_6D0B4;
  HIDWORD(v3[14]) = sub_6C7F8;
  LODWORD(v3[14]) = sub_6CCEC;
  LODWORD(v3[15]) = sub_6C454;
  ...
  HIDWORD(v3[24]) = sub_6E11C;
  HIDWORD(v3[23]) = set_frequency_dcr;
  LODWORD(v3[25]) = sub_6B230;
  LODWORD(v3[26]) = top_init_dcr;
  HIDWORD(v3[25]) = sub_6BD28;
