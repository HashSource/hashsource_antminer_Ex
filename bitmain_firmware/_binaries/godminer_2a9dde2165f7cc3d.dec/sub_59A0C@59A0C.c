int __fastcall sub_59A0C(int a1)
{
  ...
  _DWORD *v24; // [sp+20h] [bp-A8h]
  int v25; // [sp+24h] [bp-A4h]
  int v26; // [sp+30h] [bp-98h]
  int v27; // [sp+34h] [bp-94h]
  int v28; // [sp+4Ch] [bp-7Ch] BYREF
  char v29[32]; // [sp+50h] [bp-78h] BYREF
  char v30[32]; // [sp+70h] [bp-58h] BYREF
  _BYTE v31[20]; // [sp+90h] [bp-38h] BYREF
  char v32[4088]; // [sp+C8h] [bp+0h] BYREF
  _BYTE v33[4100]; // [sp+10C8h] [bp+1000h] BYREF

  v28 = 0;
  v27 = frontend_runtime_instance(a1);
  all_created_runtime = get_all_created_runtime(&v28);
  read_system_status_from_monitor((int)v31);
  format_hashrate_string(*(const char **)(*(_DWORD *)(v27 + 72) + 16), v29);
  v2 = format_hashrate_string(*(const char **)(*(_DWORD *)(v27 + 72) + 16), v30);
  V_LOCK(v2);
  ...
  result = zlog(
             ...
             "ner-origin_godminer-new/miner_util/miner_monitor/miner_monitor.c",
             171,
             "task_applog_printer",
             19,
             123,
  ...
  if ( v28 > 0 )
  {
    ...
    do
    {
      v5 = *(_DWORD *)(v24[1] + 220);
      ++v24;
      v6 = (char *)&unk_174938 + 216 * v5;
      v7 = *((_QWORD *)v6 + 8);
      v8 = *((_QWORD *)v6 + 10);
      format_hashrate_string(*(const char **)(*(_DWORD *)(v27 + 72) + 16), v29);
      v9 = format_hashrate_string(*(const char **)(*(_DWORD *)(v27 + 72) + 16), v30);
      v10 = dev_ctrl(v9);
      v11 = (*(int (__fastcall **)(_DWORD))(v10 + 48))(*(_DWORD *)(*v24 + 220));
      LODWORD(v7) = snprintf(
                      v32,
                      0x1000u,
      ...
      result = zlog(
                 ...
                 "odminer-origin_godminer-new/miner_util/miner_monitor/miner_monitor.c",
                 171,
                 "task_applog_printer",
                 19,
                 145,
