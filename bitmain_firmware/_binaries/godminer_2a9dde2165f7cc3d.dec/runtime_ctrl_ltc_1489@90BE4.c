void *__fastcall runtime_ctrl_ltc_1489(int a1)
{
  ...
  LODWORD(v7[11]) = sub_8F0F0;
  HIDWORD(v7[11]) = sub_8EFD4;
  LODWORD(v7[12]) = sub_8D2C8;
  HIDWORD(v7[12]) = sub_8CD38;
  LODWORD(v7[13]) = sub_8CD40;
  HIDWORD(v7[13]) = sub_8ED00;
  LODWORD(v7[14]) = sub_8E0BC;
  HIDWORD(v7[14]) = sub_8E92C;
  LODWORD(v7[15]) = sub_8E904;
  ...
  HIDWORD(v7[25]) = sub_8D2E0;
  LODWORD(v7[26]) = top_init_ltc;
  HIDWORD(v7[23]) = sub_8E538;
