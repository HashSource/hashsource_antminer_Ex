int print_summary()
{
  ...
  v0 = sub_12E61C(total_accepted, dword_18E3E4);
  V_LOCK(LODWORD(v0));
  ...
  if ( *(_QWORD *)&total_accepted || *(_QWORD *)&total_rejected )
  {
    ...
    sub_12E61C(100 * total_rejected, (unsigned __int64)(100LL * *(_QWORD *)&total_rejected) >> 32);
    sub_12E61C(v49 + total_accepted, (unsigned __int64)(v49 + *(_QWORD *)&total_accepted) >> 32);
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *((_QWORD *)v53 + 241) || *(_QWORD *)v54 )
        {
          ...
          v68 = *v54;
          v69 = v53[485];
          sub_12E61C(100 * *v54, (unsigned __int64)(100LL * *(_QWORD *)v54) >> 32);
          sub_12E61C(v68 + v53[482], (__PAIR64__(v69, v68) + *((_QWORD *)v53 + 241)) >> 32);
