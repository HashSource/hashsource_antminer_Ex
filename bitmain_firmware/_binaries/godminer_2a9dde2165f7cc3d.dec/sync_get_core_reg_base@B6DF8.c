int __fastcall sync_get_core_reg_base(int a1, int a2, int a3, int a4, int *a5, int a6, int a7, int a8)
{
  int v9; // r5
  char v12; // r1
  __int16 v14; // r3
  ...
  v29[0] = sub_12E934(a7, a8, 1000, 0);
  while ( a3 > v20 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 824), v30, 11, v29) == 110 )
      {
        v9 = 3;
        goto LABEL_15;
      }
