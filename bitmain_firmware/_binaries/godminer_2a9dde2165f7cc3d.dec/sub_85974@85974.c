int __fastcall sub_85974(int a1, char a2, int a3, char a4, int a5)
{
  int v5; // r6
  __int64 *v8; // r6
  double v9; // r0
  ...
  {
    v8 = (__int64 *)(a1 + 944);
    v9 = sub_12E60C(*(_DWORD *)(a1 + 944), *(_DWORD *)(a1 + 948)) / (double)a3 * *(float *)(a1 + 924);
    v10 = sub_12E998(LODWORD(v9), HIDWORD(v9));
    *v8 = v10;
