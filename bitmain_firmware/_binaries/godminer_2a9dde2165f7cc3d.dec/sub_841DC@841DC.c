unsigned int __fastcall sub_841DC(int a1, int a2, void *a3)
{
  int v3; // r4
  ...
  v15[0] = 0;
  v17 = a2;
  v6 = (unsigned __int16 *)calloc(0x450u, 1u);
  v7 = (*(int (__fastcall **)(int, _DWORD *, int, unsigned __int16 *, int *))(a1 + 260))(a1, v15, 92, v6, &v14);
  v8 = v14;
  if ( v14 > 0 )
  {
    v9 = v6;
