int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned __int16 a3, int a4)
{
  ...
  zlog(
    ...
    v52);
  v35 = malloc(0x300u);
  sub_99858(a1, a3, 86, 3670024);
  usleep(0x12Cu);
  sub_99858(a1, a3, 85, 109905420);
  usleep(0x12Cu);
  sub_99858(a1, a3, 101, -268374016);
  usleep(0x12Cu);
  ...
  sub_99858(a1, a3, 133, 255);
  usleep(0x64u);
  sub_99858(a1, a3, 134, 255);
  usleep(0x64u);
  sub_99858(a1, a3, 132, -2147483647);
  sleep(6u);
    ...
    if ( v19 )
    {
      ...
      do
      {
        ...
        v20 = zlog(
                ...
                "dminer-origin_godminer-new/backend/backend_rvn_2020/backend_rvn_phy_set.c",
                177,
                "phy_internal_bist_rvn",
                21,
                963,
