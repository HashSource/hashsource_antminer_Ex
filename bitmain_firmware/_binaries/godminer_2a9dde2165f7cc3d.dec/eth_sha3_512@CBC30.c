int __fastcall eth_sha3_512(int a1, unsigned int a2, int a3, unsigned int a4)
{
  ...
  {
    v145 = &unk_157DF0;
    v146 = (unsigned __int8 *)&unk_157E0F;
  }
  else
  {
    v7 = 0;
    ...
    while ( 1 )
    {
      ...
      for ( i = 0; ; i = (unsigned int)v64 )
      {
        ...
        v32 = (unsigned __int8 *)&unk_157DF8;
        v33 = 1;
        v34 = s[2];
        v35 = 10;
        v36 = s[3];
        v37 = (unsigned __int8 *)&unk_157E10;
        v38 = v146;
        while ( 1 )
        {
          v41 = -v33 & 0x3F;
  ...
  *((_BYTE *)s + v148) ^= 1u;
  ...
  for ( k = 0; ; k = v130[3] )
  {
    ...
    v100 = (unsigned __int8 *)&unk_157DF8;
    v139 = v85;
    v101 = 1;
    v102 = s[2];
    v103 = 10;
    v104 = s[3];
    v105 = (unsigned __int8 *)&unk_157E10;
    v106 = v146;
    while ( 1 )
    {
      v109 = -v101 & 0x3F;
