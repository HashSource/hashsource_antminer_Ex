int __fastcall get_all_chip_temp_kas(int a1)
{
  ...
  v30[3] = 0;
  v30[2] = 7340033;
  (*(void (__fastcall **)(int, _DWORD *, int, char *, _DWORD *))(a1 + 260))(a1, v30, v2, v3, v29);
  usleep((__useconds_t)&stru_1869C.st_value);
  (*(void (__fastcall **)(int, _DWORD *, int, char *, _DWORD *, int, int, _DWORD))(a1 + 260))(
    a1,
    v30,
    v2,
    v3,
