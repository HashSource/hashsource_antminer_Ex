int __fastcall sync_get_core_reg_ltc(int a1, int a2, int a3, int a4, int *a5, int a6, int a7, int a8)
{
  int v9; // r6
  __int16 v10; // r1
  __int16 v14; // r1
  ...
  v35[1] = 1000000 * v23;
  v31 = 0;
  v35[0] = sub_12E934(a7, a8, 1000, 0);
  while ( a3 > v31 )
  {
    while ( 1 )
    {
      v25 = queue_dequeue_for(*(_DWORD *)(a1 + 824), v36, 9, v35);
      if ( v25 == 110 )
      {
        v9 = 3;
        goto LABEL_16;
      ...
      if ( (v38 & 0x10) != 0 )
      {
        ...
        zlog(
          ...
          "-origin_godminer-new/backend/backend_ltc_1489/chip_reg_io_ltc_1489.c",
          178,
