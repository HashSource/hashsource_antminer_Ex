  ...
  if ( a4 )
  {
    ...
    do
    {
      ...
      zlog(
        ...
        "rigin_godminer-new/backend/backend_rvn_2020/backend_rvn_phy_set.c",
        177,
        "phy_external_bist_rvn",
        21,
        1227,
...
LABEL_6:
    ...
    {
      v17 = *++v16;
      sub_99858(a1, v17, 133, 0xFFFF);
      sub_99858(a1, *v16, 134, 1342177279);
    }
    while ( v11 != v16 );
    sub_99814(a1, 132, -2147483647);
    sleep(0xAu);
    do
    {
      while ( 1 )
        ...
        if ( v27 )
        {
          ...
          do
          {
            ...
            zlog(
              ...
              "iner-origin_godminer-new/backend/backend_rvn_2020/backend_rvn_phy_set.c",
              177,
              "phy_external_bist_rvn",
              21,
              1265,
...
LABEL_31:
  ...
  free(ptr);
  v47 = *(_QWORD *)&dword_18D368;
  v48 = &v72[8];
  v49 = *(_QWORD *)&dword_18D370;
  for ( i = &v73[1]; ; ++i )
  {
    v47 += v46;
    v49 += a4;
  ...
  *(_QWORD *)&dword_18D368 = v47;
  *(_QWORD *)&dword_18D370 = v49;
  V_LOCK(v47);
  V_INT((int)&v69, "chain");
