int __fastcall sub_2E67A0(int a1, int a2, int a3, int a4)
{
  int v8; // r0
  int v9; // r8
  int v10; // r3
  ...
  if ( a3 && (v8 = sub_2FC948(*(_DWORD *)(a2 + 28), a3, 0), (v9 = v8) != 0) )
  {
    ...
    if ( (unsigned int)(v10 - 3) <= 1 && (*(_BYTE *)(v8 + 51) & 2) != 0 && *(unsigned __int8 *)(v8 + 48) <= 1u )
    {
      *(_BYTE *)(v8 + 48) = 1;
      if ( v11 )
      {
        sub_2A6A84("%B: stack size specified and %s set", a1, a3);
      ...
      {
        sub_2A6A84("%B: %s not absolute", a1, a3);
        v10 = *(unsigned __int8 *)(v9 + 12);
        v11 = *(_DWORD *)(a2 + 16);
      }
    }
