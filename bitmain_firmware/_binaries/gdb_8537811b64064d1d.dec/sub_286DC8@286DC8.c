int __fastcall sub_286DC8(int a1)
{
  int v1; // r10
  char *v2; // r8
  size_t v4; // r0
  ...
  dword_4900D8 = v7;
  v28 = v7;
  v8 = (const char *)sub_2912D0(v1, v7);
  v9 = (const char **)sub_286D30(v8, v1, v28, v31, v38, v35);
  v36 = v9;
  if ( v9 )
    v29 = strcmp(v8, *v9) != 0;
  else
  ...
  if ( v36 )
  {
    v14 = (const char *)sub_285C48(&v36, dword_48ACC0);
    if ( v14 )
    {
      if ( a1 == 42 )
      {
        ...
        {
          v27 = sub_285EF0(*v21, 1, &v35);
          sub_294F64(v27);
          v22 = (const char *)sub_294F64(&word_3E1FAC);
          if ( v27 != *v21 )
            v22 = (const char *)sub_297780(v27);
        }
        sub_292770(v22);
        v16 = v36;
        goto LABEL_26;
      ...
      if ( a1 <= 42 )
      {
        ...
        {
LABEL_38:
          v19 = sub_2914F0("bad value %d for what_to_do in rl_complete", a1);
          sub_2945F0(v19, HIDWORD(v19));
          if ( v2 )
            free(v2);
          dword_4900F0 = 0;
          dword_4900F8 = 0;
...
LABEL_71:
            ...
            v14 = sub_285FA8(*v36, v1, 2, &v35);
            v16 = v36;
            v20 = v36[1];
          }
          else
          {
            v14 = sub_285FA8(*v36, v1, 1, &v35);
            v16 = v36;
            v20 = v36[1];
          }
        }
      ...
      sub_2849C8((int)*v16, v37, v35, v29);
      v16 = v36;
      goto LABEL_26;
    }
    sub_2945F0(0, v15);
