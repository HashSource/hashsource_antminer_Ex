int __fastcall sub_751E0(int a1, int a2, int a3)
{
  int v6; // r0
  int v7; // lr
  _DWORD *v8; // r12
  ...
  v6 = sub_1C3E80(dword_474AB0, dword_474AB4);
  v7 = *(_DWORD *)(a1 + 4);
  v30[1] = 0;
  v8 = v30;
  v30[0] = 0;
...
LABEL_34:
    ...
    if ( *(_DWORD *)(*v18 + 8) == 3 )
    {
      v26 = sub_1B5200(v18[1], v9);
      if ( v26 )
      {
        dword_474ABC = v26;
        v27 = sub_1B5178(v9, dword_487CD0, 1);
        v13 = 268;
        if ( v27 )
    ...
    else
    {
      ...
      {
LABEL_23:
        if ( sub_74BA0(a1, v9, dword_474AB4, 0, (int)v32) == 258 )
        {
          v25 = v30[0];
          v28 = 0;
          v13 = 270;
