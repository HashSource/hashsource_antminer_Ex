        ...
        void (__fastcall *a6)(int))
{
  ...
  *(_DWORD *)((char *)v59 + 3) = 0;
  v43 = ptr;
  sub_13275C(&v36, (int)&v39);
  if ( a1[1] == a1[2] )
    ((void (__fastcall *)(_DWORD *))loc_13A780)(a1);
  sub_12B248(&v31, a1, (int)&v39);
  v16 = v32;
  v17 = v31;
  v33 = 0;
  v34 = 0;
  v35 = 0;
  sub_1485E4(&v33, (v32 - v31) >> 3);
  for ( ; v17 != v16; v17 += 8 )
  {
    ...
    if ( ptr != (void *)v38[0] )
    {
      ...
      if ( !a4 || a4(a3, v20) )
      {
        if ( v34 == v35 )
        {
          sub_E4140(&v33, v34, (_DWORD *)(v17 + 4));
        }
        else
        {
          v23 = v34 + 4;
...
LABEL_22:
  ...
  if ( v33 != v34 )
  {
    sub_13FD50((int)v33, v34, 2 * (31 - __clz((v34 - v33) >> 2)));
    sub_13A974(v24, v25);
    v26 = v33;
    v25 = v34;
    if ( v33 != v34 )
