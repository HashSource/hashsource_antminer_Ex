int __fastcall sub_300A10(int a1, int a2, int a3, int a4, int a5, int a6)
{
  _DWORD *v10; // r6
  _DWORD *v11; // r5
  char **v12; // r3
...
LABEL_15:
  v16 = *(_DWORD *)(a2 + 4);
  v17 = sub_2A692C(a1) * v16;
  if ( !sub_3009B4((int)v11, a1, a4, v17) )
    return 4;
  v18 = (_DWORD *)v10[4];
  if ( (v18[5] & 0x1000) != 0 )
    v19 = 0;
  ...
  if ( v29 )
  {
    v43 = v11[3];
    v44 = sub_2A67CC(a1);
    v45 = sub_300904(v27, v43, v28, v44, v24);
    v28 = v11[1];
    v14 = v45;
  }
  v30 = v24 >> v28 << v11[5];
...
LABEL_41:
      ...
      break;
    case 4:
      sub_2A6C18((int)"reloc.c", 974, (int)"bfd_perform_relocation");
    default:
      result = 7;
      break;
  }
