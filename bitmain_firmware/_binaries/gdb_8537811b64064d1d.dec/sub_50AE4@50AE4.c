int __fastcall sub_50AE4(int result, char *a2, int a3, unsigned __int8 a4)
{
  int v5; // r2
  char *v6; // r12
  int *v7; // r8
  ...
  if ( (int)&a2[-result] > 640 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( sub_4FC64(v107, v106, v11 + 1, v11 + 4) < 0 )
        break;
      if ( sub_4FC64(v107, v106, v9, v10) < 0 )
        goto LABEL_26;
      v12 = sub_4FC64(v11 + 1, v11 + 4, v9, v10);
      v13 = v105;
      if ( v12 < 0 )
        goto LABEL_28;
      v14 = v11;
...
LABEL_8:
      ...
      for ( i = v106; ; i += 10 )
      {
        v27 = (char *)(v25 - 40);
        v28 = (char *)(v25 - 40);
        if ( sub_4FC64(v102, i, v7, v8) < 0 )
          goto LABEL_14;
        v29 = v26 - 40;
        do
        {
          v30 = sub_4FC64(v7, v8, (int *)v29 + 1, (_DWORD *)v29 + 4);
          v26 = v29;
          v29 -= 40;
        }
        while ( v30 < 0 );
...
LABEL_14:
      ...
      result = sub_50AE4(v25 - 40, v103, v104, a4);
      v6 = (char *)(v25 - 40);
      v5 = v27 - (char *)v105;
...
LABEL_17:
        ...
        do
        {
          ...
          v47 = v42 + 4;
          v42 -= 10;
          sub_4FCFC((int)v105, v41, v40, v43, v44, v45, v46, *v47, v47[1], v47[2], v47[3], v47[4], v47[5]);
        }
        while ( v41-- != 0 );
        v49 = v28;
        do
    ...
    if ( sub_4FC64(v11 + 1, v11 + 4, v9, v10) < 0 )
    {
      v90 = v11;
      v114 = *v105;
      v119 = v105[1];
