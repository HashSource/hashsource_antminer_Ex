void __fastcall sub_9B94C(int a1, int a2)
{
  const char *v2; // r5
  char **v4; // r4
  const char *v5; // r7
  ...
  if ( v2 && *(_DWORD *)(a1 + 28) )
  {
    ...
    {
LABEL_8:
      v7 = sub_93168("long_integer (&standard.%s)", v2);
    }
    else
    {
      while ( off_374060 != v4 )
      ...
      v7 = sub_93168("long_integer (&%s)", v2);
    }
    v8 = sub_93168("%s = %s", v5, v7);
    if ( v7 )
      free(v7);
    v9 = sub_92564((int)sub_9AD80, (int)v8);
    v10 = *(int **)(a1 + 28);
