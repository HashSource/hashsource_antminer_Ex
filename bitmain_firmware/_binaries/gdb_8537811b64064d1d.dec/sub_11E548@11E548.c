int __fastcall sub_11E548(int a1, int a2, int **a3, int a4)
{
  const char *v4; // r9
  int *v8; // r3
  int v9; // r5
  ...
  if ( *((_BYTE *)a3 + 17) )
  {
    if ( *((_BYTE *)v8 + 17) )
    {
      ((void (*)(void))loc_11E0B8)();
LABEL_29:
      v25 = sub_94728((int)"dwarf2read.c", 6664, "read_comp_unit_head: dwarf from non elf file");
      goto LABEL_30;
    }
    v8 = (int *)*v8;
  }
  ...
  *(_WORD *)(a1 + 4) = v16;
  ...
  v18 = sub_11E4E8(*(const char **)v9, v9 + 4, v15, *(_DWORD *)(a1 + 12));
  v19 = *(__int16 *)(a1 + 4);
  v20 = *(_DWORD *)(a1 + 12);
  *(_DWORD *)(a1 + 8) = v18;
  v21 = v15 + v20;
  ...
  *(_BYTE *)(a1 + 7) = v22;
  if ( a4 == 1 )
  {
    ...
    *(_QWORD *)(a1 + 32) = ((__int64 (__fastcall *)(int))*(_DWORD *)(*(_DWORD *)(v9 + 4) + 28))(v23);
    LODWORD(v25) = sub_11E4E8(*(const char **)v9, v9 + 4, v24, *(_DWORD *)(a1 + 12));
    v26 = *(_DWORD *)(a1 + 12);
    v27 = HIDWORD(v25) == 0;
    *(_DWORD *)(a1 + 40) = v25;
    if ( !HIDWORD(v25) )
...
LABEL_30:
      v30 = sub_988D4(v25);
      sub_94708("Dwarf Error: Too big type_offset in compilation unit header (is %s) [in module %s]", v30, v4);
    }
  }
  return v21;
}
