int __fastcall sub_1D238(_DWORD *a1)
{
  _DWORD *v1; // r4
  unsigned int v2; // r7
  unsigned int v3; // r0
  ...
  if ( !v3 )
  {
    ...
    v87[0] = 0;
    v87[1] = 0;
    ((void (__fastcall *)(int, unsigned int, _DWORD *))loc_1DFA24)(v20, HIWORD(v2) & 0xF, v87);
    v21 = v87[0];
    if ( v5 )
    {
      v79 = v1[3];
