int *__fastcall sub_21EC40(int *a1, int a2, int a3)
{
  int v3; // r6
  int v4; // r8
  int v5; // r9
...
LABEL_4:
    ...
    ((void (__fastcall *)(int, _DWORD))loc_21C208)(a2, 0);
  }
  v3 = *(__int16 *)(a2 + 22);
  if ( v3 < 0 )
    goto LABEL_4;
...
LABEL_23:
    ...
    v49 = v18;
    v19 = v17;
    sub_C37E0(SHIDWORD(v17), 0, &v32, &v33);
    v20 = ((int (__fastcall *)(int))loc_169700)(v19);
    v32 += v20;
    sub_21DED4((int)v34, v32);
    v21 = v36;
    v22 = v38;
    if ( v36 )
    {
...
LABEL_9:
  sub_21DF30(a1, **(_DWORD **)(a2 + 8), v9, 0);
  a1[2] = a2;
  if ( !a3 )
  {
    v12 = **(_DWORD **)(a2 + 8);
  ...
  if ( v10 && ((*(_BYTE *)(*(_DWORD *)(v10 + 4) + 40) & 1) != 0 || *(_DWORD *)(v10 + 24) == 9) )
  {
    v11 = *(_DWORD *)(a2 + 28);
    if ( (*(_BYTE *)(a2 + 33) & 1) != 0 )
      v11 = sub_1B7278(*(_DWORD *)(*(_DWORD *)(v11 + 4) + 4));
    a1[5] = **(_DWORD **)(a2 + 8);
    if ( ((int (__fastcall *)(int))loc_168F2C)(v11) )
      a1[5] = ((int (__fastcall *)(int, int))loc_168F78)(v11, a1[5]);
    return a1;
  }
  v14 = **(_DWORD **)(a2 + 8);
  if ( a1[5] < v14 )
