int __fastcall sub_2094B8(int *a1, unsigned __int8 **a2, int a3, int a4)
{
...
LABEL_5:
    ...
    if ( v6[1] != 58 )
      goto LABEL_81;
    v124 = sub_930BC(1u, 0x10u);
    v9 = v6 + 2;
    sub_92564((int)sub_205D50, (int)v124);
    v10 = *a2;
    if ( **a2 != 111 || v10[1] != 112 )
      goto LABEL_9;
    if ( sub_10A86C(v10[2]) )
...
LABEL_145:
          if ( v83 == 46 )
          {
            v85 = &unk_46DB6F;
LABEL_148:
            v88 = sub_93358(&unk_46DB6C, v85 - (_BYTE *)&unk_46DB6C);
            *a2 = v9 + 1;
            s = v88;
            goto LABEL_10;
          }
...
LABEL_10:
    ...
    *((_DWORD *)v124 + 1) = s;
    while ( 1 )
    {
      v15 = sub_930BC(1u, 0x14u);
      sub_92564((int)sub_205D50, (int)v15);
      if ( v12 )
      {
        v16 = *a2;
        *((_DWORD *)v15 + 2) = v12;
      ...
      else
      {
        ...
        v32 = sub_2067DC(a2, (struct obstack *)a4);
        v16 = *a2;
        v12 = v32;
        *((_DWORD *)v15 + 2) = v32;
        if ( *v16 != 58 )
      ...
      *a2 = v16 + 1;
      ...
      if ( (v19[1] & 4) != 0 )
      {
        if ( !((int (__fastcall *)(int))loc_170908)(v12) )
          ((void (__fastcall *)(_DWORD, int))loc_1709EC)(*((_DWORD *)v15 + 2), a3);
        *((_BYTE *)v15 + 16) |= 0x20u;
      }
      v21 = sub_93358(*a2, v17 - *a2);
      v22 = v17 + 2;
      *((_DWORD *)v15 + 1) = v21;
      *a2 = v17 + 2;
      v23 = v17[1];
...
LABEL_24:
        switch ( v24 )
        {
          ...
          default:
            if ( dword_47AC88 > 0 )
            {
              sub_F43DC(&off_46D334, "const/volatile indicator missing, got '%c'", v24);
              v22 = *a2;
            }
            break;
        }
      ...
      *a2 = v22 + 1;
      ...
      if ( v27 != 42 )
      {
        if ( dword_47AC88 > 0 )
        {
          sub_F43DC(&off_46D334, "member function type missing, got '%c'", v27);
          v26 = *a2;
        }
LABEL_31:
        v12 = 0;
      ...
      v34 = sub_2058FC(a2, 59, (int *)src, 0);
      v35 = *(_DWORD *)src;
      *((_WORD *)v15 + 9) = v34 + 2;
      if ( v35 )
        return 0;
...
LABEL_57:
      ...
      v40 = sub_2067DC(a2, (struct obstack *)a4);
      v26 = *a2;
      v12 = v40;
      if ( **a2 != 58 )
      {
...
LABEL_37:
    ...
    *a2 = v26 + 1;
    ...
    if ( v41 == 92 || v41 == 63 && !v26[2] )
      *a2 = (unsigned __int8 *)off_478984(a4);
    if ( sub_25BD54((int)s, "__base_ctor ") && sub_25BD54((int)s, "__base_dtor ") )
    {
      if ( strcmp(s, "__deleting_dtor") )
      {
        ...
        if ( v123 )
        {
          if ( v66 )
          {
            v101 = sub_930BC(1u, 0x10u);
            sub_92564((int)sub_205D50, (int)v101);
            v102 = sub_163544(a4 + 48, "~", *((_DWORD *)v124 + 1), 0);
            v103 = *(_DWORD *)(a4 + 64);
            v101[1] = v102;
            v104 = 16 * v123;
            v105 = *(_DWORD *)(a4 + 60);
...
LABEL_123:
              if ( !v61 )
              {
                if ( sub_3102D8(*((_DWORD *)v124 + 1), src, 2) || sub_3102D8(*((_DWORD *)v124 + 1), src, 0) )
                {
                  v91 = strlen(src);
                  v92 = *(void **)(a4 + 60);
                  v93 = v91;
            ...
            {
              *((_DWORD *)v124 + 1) = sub_163544(a4 + 48, "~", s, 0);
              free(s);
            }
LABEL_124:
            v68 = *(_DWORD *)(a4 + 64);
        ...
        v90 = (const char *)sub_100C68(v89);
        v17 = (unsigned __int8 *)v90;
        if ( !v90 )
        {
          if ( dword_47AC88 > 0 )
            sub_F43DC(&off_46D334, "Method has bad physname %s\n", v89);
          goto LABEL_124;
        }
