int __fastcall sub_30D598(int *a1, _DWORD *a2)
{
  int v4; // r0
  int v5; // r6
  size_t v6; // r7
  ...
  v31 = a2[21];
  if ( v31 )
    a1[21] = sub_327234(v31, 4 * a2[22]);
  result = a2[17];
  if ( result )
  {
    result = (int)sub_93050(4 * result);
    v35 = a2[17];
    v36 = result;
    a1[16] = result;
    if ( v35 > 0 )
  ...
  if ( a2[19] )
  {
    ...
    *(_DWORD *)v33 = 0;
    HIDWORD(v33) = v34;
    return sub_30D554(v33, *(_DWORD *)(v34 + 4));
  }
  return result;
}
