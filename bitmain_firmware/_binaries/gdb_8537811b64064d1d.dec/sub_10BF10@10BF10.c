int __fastcall sub_10BF10(int a1, int a2, int a3, unsigned int a4, int a5, char a6, _DWORD *a7)
{
  int v8; // r4
  int v10; // r0
  ...
  v12[2] = 0;
  v12[1] = 0;
  sub_10BAE4(v13, a1, (int)v14, (int)sub_10B868);
  sub_256788(v14);
  v14[2] = 0;
  v15 = 0;
  v14[0] = &off_3F294C;
  ...
  while ( v12[0] < a4 )
  {
    if ( v8 == a5 )
      break;
    v10 = sub_10BBF4(v13, a2, (int)v12, a6);
    if ( v10 <= 0 )
      break;
    ++v8;
    v12[0] += v10;
