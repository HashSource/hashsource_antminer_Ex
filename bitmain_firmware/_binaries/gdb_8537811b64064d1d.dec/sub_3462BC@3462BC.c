unsigned int *__fastcall sub_3462BC(unsigned int *a1, size_t a2, unsigned int a3, _BYTE *a4, unsigned int a5)
{
  unsigned int v6; // r1
  size_t v7; // r4
  int v8; // r7
  ...
  if ( a5 > v8 - v7 + 1073741820 )
    sub_33D1AC("basic_string::replace");
  v9 = a1;
  if ( (unsigned int)a4 < v6 )
    return sub_345500(a1, a2, v8, a4, a5);
...
LABEL_12:
  ...
  sub_3462A0((void **)&v14, a4, a5);
  v9 = sub_345500(v9, a2, v8, v14, a5);
