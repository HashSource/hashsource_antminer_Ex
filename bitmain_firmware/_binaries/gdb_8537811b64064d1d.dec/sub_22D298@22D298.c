int __fastcall sub_22D298(int a1, int a2, int a3)
{
  _DWORD *v5; // r0
  int v6; // r0
  _DWORD *v7; // r0
  ...
  sub_2594D8(*v5, "-> %s->to_program_signals (...)\n", (const char *)dword_489C90);
  v6 = off_489D8C(&unk_489C8C, a2, a3);
  v7 = (_DWORD *)sub_242FF0(v6);
  sub_2594D8(*v7, "<- %s->to_program_signals (", (const char *)dword_489C90);
