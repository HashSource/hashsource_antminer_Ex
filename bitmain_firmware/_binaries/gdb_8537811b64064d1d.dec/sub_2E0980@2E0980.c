        ...
        const char **a15)
{
  ...
  *a12 = 0;
  ...
  if ( v19 == &off_4708A8 )
    v20 = sub_2FC988(a1, a2, a3, 1, 0, 0);
  else
    v20 = sub_2FC948(*(_DWORD *)(a2 + 28), a3, 1);
  if ( !v20 )
    return 0;
  *a7 = v20;
  v21 = *(_BYTE *)(v20 + 52);
    ...
    if ( (*((_DWORD *)v29 + 10) & 0x200000) == 0 && (*(_DWORD *)(v16 + 40) & 0x200000) == 0 )
    {
      ...
      if ( v40 != v41 )
      {
        ...
        if ( v42 )
        {
          ...
          {
            if ( v96 )
              sub_2A6A84("%s: TLS definition in %B section %A mismatches non-TLS reference in %B", v46, v16, v88, v29);
            else
              sub_2A6A84("%s: TLS reference in %B mismatches non-TLS definition in %B section %A", v46, v16, v29, v97);
          }
          else
          {
            sub_2A6A84("%s: TLS reference in %B mismatches non-TLS reference in %B", v46, v16, v29);
          }
...
LABEL_207:
            ...
            else
            {
              if ( (v39 & v91) != 0 )
              {
                ...
                sub_2DC600(*(_DWORD *)(v16 + 4), v25, a4, v88 + 5, v35, v99);
