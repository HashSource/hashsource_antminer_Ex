int __fastcall sub_2F68F0(_DWORD *a1, unsigned int a2, int a3, int a4, char *a5, unsigned __int8 *a6)
{
  char *v6; // r4
  ...
  {
    v14 = a5;
    sub_2A6A84("Dwarf Error: Info pointer extends beyond end of attributes");
...
LABEL_28:
        ...
        if ( a2 > 0x15 )
        {
          v38 = sub_2ABC4C(v8, a5, v74, 0, (unsigned int)a6);
          v39 = &a5[v74[0]];
          if ( v38 == 33 )
          {
            v13 = sub_2ABC4C(v8, v39, v74, 1, (unsigned int)a6);
            v39 += v74[0];
          }
          return sub_2F68F0(a1, v38, v13, a4, v39, a6);
        }
LABEL_19:
        v14 = a5 + 8;
        if ( a6 < (unsigned __int8 *)a5 + 8 )
...
LABEL_70:
    ...
    if ( a2 <= 0x20 )
    {
      ...
      {
LABEL_55:
        v7 = (unsigned __int8 *)sub_2ACC1C(v8, 8);
        if ( v7 )
        {
          v29 = sub_2ABC4C(v8, a5, v74, 0, (unsigned int)a6);
          v30 = v74[0];
          *(_DWORD *)v7 = v29;
          v31 = &a5[v30];
          v14 = &a5[v30 + v29];
      ...
      if ( a2 == 31 )
      {
        ...
        v74[0] = v20;
        v25 = sub_2F5C40(v11, v24, v23, (int)(v19 + 23), v22, v19 + 22, v19 + 23);
        if ( v25 )
        {
          v14 = &a5[v74[0]];
...
LABEL_85:
      ...
      v67 = sub_2AD3D8(*(const char ***)(a4 + 8), "/usr/lib/debug");
      v46 = v67;
      if ( v67 )
      {
        v68 = sub_2AC78C((int)v67, 0);
        v71 = (int)v68;
        if ( v68 )
        {
          if ( sub_2AA894((int)v68, 1, v69, v70) )
          {
            v41[9] = v71;
            goto LABEL_85;
          }
...
LABEL_89:
  ...
  if ( a2 == 8 )
  {
    if ( a5 < (char *)a6 )
    {
      ...
      if ( *a5 )
      {
        v7 = sub_2F616C((unsigned __int8 *)a5, a6, v74);
        v6 = &a5[v74[0]];
      }
      else
      {
...
LABEL_74:
      v14 = 0;
      sub_2A6A84("Dwarf Error: Invalid or unhandled FORM value: %#x.", a2);
      ((void (__fastcall *)(int))loc_2A6C70)(17);
      return (int)v14;
    }
LABEL_75:
    LODWORD(v37) = sub_2F67D8(v8, *(unsigned __int8 *)(a4 + 92), (int)a5, (unsigned int)a6);
    *((_QWORD *)a1 + 1) = v37;
...
LABEL_49:
  ...
  if ( a2 > 0xC )
  {
    if ( a2 != 14 )
    {
      if ( a2 <= 0xE )
      {
        v12 = sub_2ABC4C(v8, a5, v74, 1, (unsigned int)a6);
LABEL_47:
        v27 = v74[0];
        a1[2] = v12;
        a1[3] = 0;
...
LABEL_46:
      v12 = sub_2ABC4C(v8, a5, v74, 0, (unsigned int)a6);
      goto LABEL_47;
    }
    ...
    v74[0] = v52;
    v25 = sub_2F5C40(v11, v55, v54, (int)(v51 + 21), v22, v51 + 20, v51 + 21);
    if ( v25 )
    {
      v14 = &a5[v74[0]];
