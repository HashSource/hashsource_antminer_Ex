void __fastcall sub_DD198(int a1, int a2)
{
  _BYTE *v3; // r5
  void *v4; // r0
  bool v5; // zf
  ...
  v17 = 0;
  v18 = 0;
  v3 = *(_BYTE **)(sub_19CD30(a1) + 4);
  v9 = v3;
  sub_D5DD0((int)&v12, &v9);
  v4 = ptr;
  v5 = ptr == 0;
  ptr = v12;
  v17 = v13;
  ...
  v19 = v20;
  sub_CB22C(&v19, v3, (int)v9);
  v10 = v19;
  sub_19CCC4(&v11, &v10, 1);
  v6 = *(_DWORD *)(a2 + 4);
  v7 = v11;
  v11 = 0;
  *(_DWORD *)(a2 + 4) = v7;
  if ( v6 )
  {
    ((void (__fastcall *)(int))loc_19D17C)(a2 + 4);
    if ( v11 )
      ((void (__fastcall *)(int *))loc_19D17C)(&v11);
    v7 = *(_DWORD *)(a2 + 4);
  }
  v8 = ((int (__fastcall *)(int))loc_19D250)(v7);
  v15 = sub_32727C(v8);
  sub_E0408(a2 + 8, &v15);
  if ( v19 != v20 )
    sub_339E8C(v19);
