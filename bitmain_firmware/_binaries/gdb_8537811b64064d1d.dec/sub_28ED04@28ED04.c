void sub_28ED04()
{
  ...
  if ( dword_48AE3C == dword_48AAA4 || dword_48AE0C )
  {
    ...
    if ( dword_48AE08 > 0 )
    {
      ...
      if ( (int)*v0 <= v9 )
      {
        ...
        v153 = *v151;
        *v0 = v152;
        v154 = sub_93078(v153, v152);
        v155 = (void **)v0[1];
        *v151 = v154;
        v156 = sub_93078(*v155, *v0);
        v7 = dword_48AE08;
        v186 = v156;
        *v155 = v156;
        v8 = v1 + v7;
  ...
  else
  {
    ...
    if ( v123 <= v1 + 2 )
    {
      ...
      v160 = *v158;
      *v0 = v159;
      v161 = sub_93078(v160, v159);
      v162 = (void **)v0[1];
      *v158 = v161;
      v186 = sub_93078(*v162, *v0);
      *v162 = v186;
    }
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        else
        {
          ...
          do
          {
            v19 = sub_28C450((const void *)dword_48AE0C, v190, v18, 1);
            if ( dword_490144 < v19 )
            {
              v195 = v190;
              v18 = sub_29B638(dword_48AE0C, v18, 0);
              v190 = v18;
              goto LABEL_33;
            }
            if ( dword_490144 == v19 )
...
LABEL_36:
      *(_DWORD *)(*(_DWORD *)(v0[1] + 4) + 4 * v14) = v18;
      if ( _ctype_get_mb_cur_max() > 1 && !dword_48BB60 && dword_48AEFC > 0 )
      {
        v114 = sub_28C450((const void *)dword_48AE0C, v195, v190, 1);
        v16 = dword_490144;
        v15 -= v114;
        goto LABEL_22;
      }
  ...
  if ( v23 < v21 )
  {
    do
    {
      ...
      if ( v20 + 8 >= (int)*v0 )
      {
        ...
        *v0 = v88;
        v188 = v87;
        v89 = sub_93078(*v87, v88);
        v90 = v188;
        v91 = *v0;
        v189 = (void **)v0[1];
        *v90 = v89;
        v92 = sub_93078(*v189, v91);
        v93 = (_BYTE **)v0[1];
        *v189 = v92;
        v186 = *v93;
      }
        ...
        if ( v26 == 9 )
        {
          ...
          if ( HIDWORD(v111) - 2 <= v14 )
          {
            ...
            *(_DWORD *)(v109 + 8) = 2 * HIDWORD(v111);
            LODWORD(v111) = sub_93078((void *)v111, 8 * HIDWORD(v111));
            v131 = v0[1];
            *(_DWORD *)(v202 + 4) = v111;
        ...
        else if ( v26 == 10 )
        {
          ...
          *v97 = 0;
          ...
          if ( v99 - 2 <= v14 )
          {
            v179 = *(void **)(v98 + 4);
            *(_DWORD *)(v98 + 8) = 2 * v99;
            *(_DWORD *)(v98 + 4) = sub_93078(v179, 8 * v99);
            v98 = v0[1];
          }
          v100 = *(_DWORD *)(v98 + 4);
          ++v14;
...
LABEL_72:
              ...
              if ( dword_490144 <= v15 )
              {
                ...
                if ( HIDWORD(v36) - 2 <= v14 )
                {
                  ...
                  *(_DWORD *)(v35 + 4) = sub_93078((void *)v36, 8 * HIDWORD(v36));
                  v35 = v0[1];
          ...
          if ( _ctype_get_mb_cur_max() <= 1 || dword_48BB60 )
          {
            ...
            if ( dword_490144 <= v15 )
            {
              ...
              if ( HIDWORD(v102) - 2 <= v14 )
              {
                ...
                *(_DWORD *)(v101 + 4) = sub_93078((void *)v102, 8 * HIDWORD(v102));
                v101 = v0[1];
        ...
        if ( v15 + 4 >= dword_490144 )
        {
          ...
          if ( HIDWORD(v108) - 2 <= v14 )
          {
            *(_DWORD *)(v106 + 8) = 2 * HIDWORD(v108);
            LODWORD(v108) = sub_93078((void *)v108, 8 * HIDWORD(v108));
            v116 = v0[1];
            *(_DWORD *)(v106 + 4) = v108;
...
LABEL_78:
  ...
  if ( v42 - 2 <= v14 )
  {
    v150 = (void *)v41[1];
    v41[2] = 2 * v42;
    mb_cur_max = (unsigned int)sub_93078(v150, 8 * v42);
    v41[1] = mb_cur_max;
    v41 = (int *)v0[1];
    v43 = v41[1];
  }
  *(_DWORD *)(v43 + 4 * (v14 + 1)) = v20;
  if ( dword_48AAF8 || !dword_490138 || !*(_BYTE *)dword_490138 )
  {
    ...
    if ( dword_490144 - 1 > v67 )
    {
      ...
      if ( v67 <= 0 )
      {
        v70 = v69 * sub_3476B8(dword_48AEF8 - 1);
        if ( v65 )
        {
          v115 = v70 <= 0;
          if ( v70 > 0 )
...
LABEL_149:
    ...
    dword_48AE48 = 0;
    v76 = dword_48AE04;
    sub_28D744(v75, v74, 0, dword_490144 + dword_48AE38, dword_490144 + v65, 0);
    if ( _ctype_get_mb_cur_max() > 1 )
    {
      v77 = dword_48AE04;
...
LABEL_163:
        ...
        v82 = *(_DWORD *)v0[1];
        dword_48AF00 = v81;
        sub_28CCF0(dword_48AEF8 - v70, (char *)(v82 + v70));
        dword_48AE30 = v70;
        goto LABEL_166;
      }
    }
    sub_28D710(dword_490144 - v177);
    v78 = dword_490144;
    if ( !v70 )
      goto LABEL_298;
    v80 = v77;
LABEL_257:
  ...
  else
  {
    ...
    if ( !dword_48BB60 )
    {
      mb_cur_max = sub_29B638(v186, dword_490130, 0);
      v41 = (int *)v0[1];
      v20 = mb_cur_max;
      v43 = v41[1];
      goto LABEL_90;
...
LABEL_90:
  ...
  while ( 1 )
  {
    ...
    mb_cur_max = sub_28D744((char *)mb_cur_max, v48, v44, v50, *(_DWORD *)(v43 + v45) - v46, v14);
    if ( !v44 )
    {
      mb_cur_max = _ctype_get_mb_cur_max();
      if ( mb_cur_max > 1
...
LABEL_284:
          ...
          if ( mb_cur_max )
          {
            mb_cur_max = sub_28D710(mb_cur_max);
            v53 = dword_48AE14;
          }
        }
LABEL_113:
...
LABEL_115:
  ...
  dword_48AE34 = v14;
  if ( (const char *)dword_48AE2C == v199 || (sub_28D034(v199), _ctype_get_mb_cur_max() != 1) && !dword_48BB60 )
  {
    if ( v199 )
      goto LABEL_302;
    v58 = dword_48AE14;
...
LABEL_133:
        if ( v64 < v61 )
        {
          v184 = _ctype_get_mb_cur_max() <= 1 || dword_48BB60
               ? v64
               : sub_28C450((const void *)(*(_DWORD *)v0[2] + v63), 0, v64, 1) - dword_48AE38;
          if ( v184 >= 0 && dword_48AE04 > v184 )
          {
            sub_294544(dword_48AE04 - v184);
            dword_48AE04 = v184;
          }
        }
        goto LABEL_134;
      ...
      {
        v185 = sub_28C450((const void *)dword_48AE0C, 0, v59, 1);
        v60 = dword_48AE14;
...
LABEL_134:
  if ( _ctype_get_mb_cur_max() > 1 && !dword_48BB60 || dword_48AE04 != v64 )
    sub_28CCF0(v64, (char *)(*(_DWORD *)v0[1] + v63));
LABEL_166:
