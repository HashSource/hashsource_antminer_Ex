int __fastcall sub_2409C4(int a1, _BYTE *a2, int a3, int a4, int a5)
{
  int v9; // r9
  int v10; // r5
  int v11; // r4
  ...
  if ( v43 )
  {
    ...
    v46 = 0;
    v48 = 0;
    ((void (__fastcall *)(void **))loc_23FF48)(&ptr);
  }
  else
  {
    v10 = dword_48A4D4;
    ...
    do
    {
      v12 = sub_23DA00(a2, v9, a3, a4, v10);
      v10 = *(_DWORD *)(v10 + 4);
      if ( v12 )
        ++v11;
    }
...
LABEL_146:
      if ( a2 && *a2 )
        return sub_2573B4(a1, "No threads match '%s'.\n", a2);
      else
        return sub_2573B4(a1, "No threads.\n");
    }
    BYTE3(v63[1]) = 0;
...
LABEL_75:
    ...
    while ( 1 )
    {
      while ( v15[7] != v14 || !sub_23DA00(a2, v9, a3, a4, (int)v15) )
      {
        v15 = (_DWORD *)v15[1];
        if ( !v15 )
          goto LABEL_75;
      ...
      if ( !sub_257418(a1) )
      {
        ...
        v16 = sub_240150((int)v15);
        sub_257610(a1, "id-in-tg", v16);
      }
      if ( a5 || sub_257418(a1) )
        sub_25752C(a1, "id", v15[5]);
      s = (char *)sub_230984(v15[2], v15[3], v15[4]);
      v17 = off_489AB0(&dword_4899A0, v15);
      v18 = (const char *)v15[8];
      v41 = (const char *)v17;
      if ( !v18 )
        v18 = (const char *)sub_2309B8((int)v15);
      if ( sub_257418(a1) )
      {
        sub_257610(a1, "target-id", s);
        if ( v41 )
          sub_257610(a1, "details", v41);
        if ( v18 )
          sub_257610(a1, "name", v18);
        goto LABEL_66;
      }
      v51 = 0;
      LOBYTE(v52[0]) = 0;
...
LABEL_63:
      ...
      {
        v39 = strlen(s);
        sub_33BC7C((int)&v50, 0, 0, s, v39);
        goto LABEL_64;
      }
      sub_93200((char **)&v59, "%s \"%s\"", s, v18);
      v35 = v50;
      if ( v59 == v61 )
      {
        sub_33B4B4(&v50, &v59);
...
LABEL_121:
      ...
      *v35 = 0;
      ...
      if ( v59 != v61 )
        goto LABEL_63;
LABEL_64:
      sub_257610(a1, "target-id", v50);
      if ( v50 != v52 )
        sub_339E8C(v50);
LABEL_66:
      if ( v15[11] == 1 )
      {
        sub_2573A8(a1, "(running)\n", v23, 1);
      }
      else
      {
        sub_23FA18();
        v24 = (int *)sub_15F810(0);
        v25 = sub_257418(a1);
        sub_20E810(v24, v25, 0, 0);
      }
      if ( sub_257418(a1) )
      {
        v26 = "running";
        if ( v15[11] != 1 )
          v26 = "stopped";
        sub_257610(a1, "state", v26);
      }
      v27 = sub_232394(v15[2], v15[3], v15[4]);
      if ( (sub_257418(a1) & (v27 != -1)) != 0 )
        sub_25752C(a1, "core", v27);
      sub_257374(a1, 0);
      v15 = (_DWORD *)v15[1];
      if ( !v15 )
        goto LABEL_75;
...
LABEL_76:
  result = ((int (__fastcall *)(void **))loc_23FCB4)(&ptr);
  if ( v46 )
    result = sub_257298(v48);
  if ( v43 )
    result = sub_257374(v49, 1);
  v29 = a2 == 0;
  if ( !a2 )
    v29 = a4 == -1;
  if ( v29 )
...
LABEL_96:
        ...
        v63[0] = qword_4878F0;
        result = sub_23DA9C(dword_4878EC, qword_4878F0, SHIDWORD(qword_4878F0), 2);
        if ( result )
        {
          v37 = ((int (*)(void))loc_23DC0C)();
          v38 = sub_240150(v37);
          return sub_2573B4(a1, "\nThe current thread <Thread ID %s> has terminated.  See `help thread'.\n", v38);
        }
...
LABEL_143:
      ...
      result = sub_25752C(a1, "current-thread-id", v32);
    }
    else
    {
      HIWORD(v30) = (unsigned int)&dword_475848 >> 16;
