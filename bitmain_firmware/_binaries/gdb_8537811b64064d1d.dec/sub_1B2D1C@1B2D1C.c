int __fastcall sub_1B2D1C(int result)
{
  int v1; // r4
  int v2; // r3
  _DWORD *v3; // r8
  ...
  if ( dword_48999C )
  {
    v87 = (int *)sub_242FF0(result);
    v88 = v3[3];
    v89 = *v87;
    v90 = (const char *)sub_1B87D0(*v3);
    sub_2594D8(v89, "Installing %d minimal symbols of objfile %s.\n", v88, v90);
    v2 = v3[3];
    v1 = *(_DWORD *)(*v3 + 40);
  }
  v4 = *(_DWORD *)(v1 + 84);
  ...
  *(_DWORD *)(v1 + 12) = v5 + v6;
  ...
  if ( !v4 )
  {
    ...
    if ( !v11 )
    {
      qsort(v9, 0, 0x30u, (__compar_fn_t)sub_1B0D3C);
      goto LABEL_30;
    }
    goto LABEL_10;
  }
...
LABEL_13:
  ...
  v10 = 48 * v4;
LABEL_18:
  qsort(v9, v4, 0x30u, (__compar_fn_t)sub_1B0D3C);
  if ( v4 > 0 )
  {
    v28 = v9;
    v29 = &v9[v10 - 48];
