        ...
        char a14)
{
  ...
  *a4 = 0;
  ...
  if ( v15 && *(_DWORD *)(a2 + 12) - (_DWORD)v18 != 16 )
  {
    ...
    if ( v26 )
      v22 = ((int (__fastcall *)(void **))loc_19D17C)(&v26);
    if ( v17 )
      free(v17);
    if ( v16 )
      free(v16);
  ...
  else
  {
    ...
    {
      if ( *(_DWORD *)(a2 + 4) )
        ((void (__fastcall *)(void **))loc_19CF8C)(&v26);
      else
        v26 = 0;
      v19 = (void *)*v18;
      if ( *v18 )
        v19 = (void *)sub_32727C(*v18);
      v20 = (void *)v18[1];
      v23 = *(_BYTE *)a2;
      ...
      v29 = v16;
      ptr = v17;
      sub_DDE50(v27, a1, (int *)v20, v21, &v26, (int *)v30, &v29, &ptr, a5, a6, a7, a8, a9, a10, a11, a12, a14, v23);
      if ( ptr )
        free(ptr);
      if ( v29 )
        free(v29);
      ...
      if ( v26 )
        ((void (__fastcall *)(void **))loc_19D17C)(&v26);
      v18 += 4;
      v17 = 0;
      v16 = 0;
    }
