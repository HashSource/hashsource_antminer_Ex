int __fastcall sub_A4AC4(int a1, int a2, char *a3, char ***a4, int a5)
{
  char *object_base; // r6
  char *next_free; // r9
  size_t v11; // r7
  ...
  obstack_begin(&obstack, 0, 0, (void *(*)(int))sub_93050, sub_9AD80);
  sub_A4924((int)&obstack, a2, a1, (int)a3, a5, &v94);
...
LABEL_87:
        ...
        {
          v69 = (int *)&v15[2 * v68];
          if ( sub_9FE58(*v69, 0, 0, 0) == 1
            && *((_DWORD *)off_46DBB8 + 4 * (*(unsigned __int8 *)(*v69 + 32) >> 3)) == 8 )
          {
            v70 = (const char *)sub_170CEC(*(_DWORD *)(*v69 + 24));
            v71 = (const char *)(sub_338BFC(v70, "___XR") - 3);
            if ( v70 < v71 )
            {
              v72 = v71;
              do
            ...
            nb = v71 - v70;
            sb = (char *)sub_93050(v71 - v70 + 1);
            strncpy(sb, v70, nb);
            sb[nb] = 0;
            na = sub_92564((int)sub_9AD80, (int)sb);
            if ( sub_9D1B8(sb, 0, (char *)1)
              || sub_338BFC(sb, &dword_3C43C4)
              || (v78 = sub_93168("_ada_%s", sb), sub_9D1B8(v78, 0, (char *)1)) )
            {
...
LABEL_93:
      ...
      LODWORD(v18) = sub_9AF54(*(const char **)(a1 + 32), a3, 0, 0);
      v16 = 0;
LABEL_120:
      v15 = *a4;
      if ( v16 )
...
LABEL_117:
    ...
    LODWORD(v18) = sub_9AF54(*(const char **)(a1 + 32), a3, **a4, (*a4)[1]);
    goto LABEL_120;
  }
  v27 = *v15;
...
LABEL_122:
      ...
      if ( *v42 == *v41 )
      {
        ...
        while ( 1 )
        {
          ...
          v95 = strlen(v48);
          v96 = strlen(v49);
          sub_9DFD4((unsigned __int8 *)v48, (int *)&v95);
          LODWORD(v18) = sub_9DFD4(
...
LABEL_47:
  ...
  do
  {
    ...
    if ( v52 )
    {
      ...
      {
        v53 = *(const char **)v52;
        LODWORD(v18) = sub_338BFC(*(_DWORD *)v52, "___XR");
        if ( (_DWORD)v18 )
        {
          v54 = v18 - (_DWORD)v53;
          v55 = 0;
