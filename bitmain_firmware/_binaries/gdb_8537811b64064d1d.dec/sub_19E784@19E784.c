int __fastcall sub_19E784(int a1, _DWORD *a2)
{
  int v2; // r3
  int result; // r0
  int v4; // r2
  ...
  if ( *(_WORD *)(v2 + 4) )
  {
    ...
    v12 = *(_DWORD **)(v9 + 20);
    *a2 = v12;
    v13 = (_DWORD *)sub_171280(v12);
    v14 = (_BYTE *)v13[6];
    if ( *v14 != 20 || (v15 = v13[5], v15 > 7) || (v14[1] & 1) != 0 )
    {
      if ( sub_171984(v13, &v19, &v20) < 0 )
        sub_94708("long_set failed to find discrete bounds for its subtype");
      v16 = v19;
    }
    else
    {
