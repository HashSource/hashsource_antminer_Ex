void __fastcall sub_32500(int a1, int a2)
{
  int v3; // r11
  char *v4; // r8
  int v5; // r6
  ...
  v3 = ((int (__fastcall *)(int))loc_1B7CA0)(a2);
  if ( v3 )
  {
    v33 = v41;
    v36 = 0;
LABEL_4:
    ...
    v34 = 0;
    v6 = v41;
    for ( i = "init_start"; ; i = (&off_34C460)[2 * v5] )
    {
      if ( v36 )
      {
        sub_93198(v40, 32, "rtld_%s", i);
        i = (const char *)v40;
      }
      sub_1CA898(&ptr, *(_DWORD *)(v3 + 4), "rtld", i);
      v8 = *(void **)v6;
      v9 = ptr;
      v10 = v38;
      v11 = v39;
        ...
        while ( 1 )
        {
          ...
          if ( *(unsigned int **)v33 != v19 )
          {
            do
            {
              ...
              sub_D8E08(a1, HIDWORD(v22));
              v24 = sub_31088();
              v25 = *(_DWORD *)(v24 + 40);
              if ( !v25 )
              {
                v25 = sub_323B08(1, sub_2FD7C, 195972, &loc_30570, sub_930BC, &loc_30570);
                *(_DWORD *)(v24 + 40) = v25;
              }
              v40[0] = v22;
              v20 = (int *)sub_324058(v25, v40, 1);
              if ( *v20 )
              {
                sub_94728(
                  "solib-svr4.c",
