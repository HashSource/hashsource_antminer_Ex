bool __fastcall sub_25B6F8(char *a1, unsigned __int8 *a2, int a3, _BOOL4 a4, int a5, int a6)
{
...
LABEL_7:
  while ( 2 )
  {
    sub_258328((unsigned __int8 **)&s1, &v50, v6);
    v9 = v50;
    v10 = s1;
...
LABEL_52:
            ...
            while ( 1 )
            {
              v26 = (char *)sub_338BFC(v26, "[abi:");
              s1 = v26;
              if ( !v26 )
                break;
              while ( sub_258770((const char **)&s1) && *s1 == 91 )
                ;
              if ( v26 != s1 )
              {
                v54 = v26;
                v55 = s1;
                sub_25C610(a6 + 4, &v54, &v55);
                goto LABEL_52;
              }
            }
          }
...
LABEL_90:
      ...
      v39 = s1;
      v40 = strlen(s1);
      v41 = sub_2585AC(v39, (unsigned __int8 *)&v39[v40]);
      v42 = (const char *)v50;
      v43 = v41 - v39;
      v44 = sub_2585AC((const char *)v50, v6);
      if ( v43 > v44 - v42 )
      {
        v43 = v44 - v42;
