int __fastcall sub_2A6CDC(char *s, int *a2)
{
  int v2; // r3
  char *v3; // r4
  unsigned int v5; // r10
  ...
  while ( *s )
  {
    if ( *s == 37 )
    {
      ...
      {
        v25 = s + 1;
        if ( v24 != 48 && (word_4388C0[v24] & 4) != 0 && s[2] == 36 )
        {
          v25 = s + 3;
          v64 = v24 - 49;
        ...
        if ( v24 == 42 )
        {
          ...
          v46 = v25 + 1;
          if ( v45 != 48 && (word_4388C0[v45] & 4) != 0 && v25[2] == 36 )
          {
            v47 = v45 - 49;
            v46 = v25 + 3;
          }
          ...
          if ( v47 > 8 )
            sub_2A6C18((int)"bfd.c", 980, (int)"_bfd_doprnt_scan");
          ++v5;
          v24 = (unsigned __int8)*v46;
          v25 = v46;
          LODWORD(v67[v47]) = 1;
        }
        else if ( (word_4388C0[v24] & 4) != 0 )
        {
          do
          {
        ...
        if ( v24 == 46 )
        {
          ...
          if ( v24 == 42 )
          {
            ...
            v55 = v25 + 2;
            if ( v54 != 48 && (word_4388C0[v54] & 4) != 0 && v25[3] == 36 )
            {
              v56 = v54 - 49;
              v55 = v25 + 4;
            }
            ...
            if ( v56 > 8 )
              sub_2A6C18((int)"bfd.c", 1005, (int)"_bfd_doprnt_scan");
            ++v5;
        ...
        while ( strchr("hlL", v24) )
        {
          switch ( v24 )
          {
            ...
            case 'L':
              ...
              break;
            default:
              sub_2A6C18((int)"bfd.c", 1028, (int)"_bfd_doprnt_scan");
          }
        ...
        switch ( v24 )
        {
          ...
          case 'x':
            ...
            break;
          default:
            sub_2A6C18((int)"bfd.c", 1103, (int)"_bfd_doprnt_scan");
        }
        if ( v32 > 8 )
          sub_2A6C18((int)"bfd.c", 1107, (int)"_bfd_doprnt_scan");
        ++v5;
        LODWORD(v67[v32]) = v29;
      }
    }
    ...
    for ( i = 0; i != v5; ++i )
    {
      switch ( LODWORD(v67[i]) )
      {
        ...
        case 5:
          ...
          break;
        default:
          sub_2A6C18((int)"bfd.c", 1157, (int)"error_handler_internal");
      }
    }
  }
  fflush((FILE *)stdout);
  ...
  while ( *v3 )
  {
    if ( *v3 == 37 )
    {
      ...
      else
      {
        ...
        if ( v10 != 48 && (word_4388C0[v10] & 4) != 0 && v3[2] == 36 )
        {
        ...
        if ( v10 == 42 )
        {
          v48 = v11[1];
          v14 = v11 + 1;
          if ( v48 != 48 && (word_4388C0[v48] & 4) != 0 && v11[2] == 36 )
          {
            v49 = v48 - 49;
            v14 = v11 + 3;
          }
...
LABEL_128:
          *v12++ = v10;
          ...
          if ( v10 == 42 )
          {
            v57 = v14[2];
            v58 = v14 + 2;
            if ( v57 != 48 && (word_4388C0[v57] & 4) != 0 && v14[3] == 36 )
            {
              v59 = v57 - 49;
              v58 = v14 + 4;
            }
        ...
        while ( strchr("hlL", v10) )
        {
          switch ( v10 )
          {
            ...
            case 'L':
              ...
              break;
            default:
              sub_2A6C18((int)"bfd.c", 775, (int)"_bfd_doprnt");
          }
          *v12++ = v10;
          v23 = *++v14;
          v10 = v23;
        ...
        *v12 = v10;
        ...
        switch ( v10 )
        {
          case 'A':
            v39 = v67[v33];
            if ( !v39 )
              sub_2A6C18((int)"bfd.c", 882, (int)"_bfd_doprnt");
            v40 = *(_DWORD *)(v39 + 148);
            v38 = *(const char **)v39;
            if ( !v40 )
              goto LABEL_104;
...
LABEL_93:
          ...
          case 'B':
            v36 = v67[v33];
            if ( !v36 )
              sub_2A6C18((int)"bfd.c", 908, (int)"_bfd_doprnt");
            v37 = *(_DWORD *)(v36 + 140);
            v38 = *(const char **)v36;
...
LABEL_100:
          ...
          case 's':
            goto LABEL_92;
          default:
            sub_2A6C18((int)"bfd.c", 918, (int)"_bfd_doprnt");
        }
      }
    }
    else
