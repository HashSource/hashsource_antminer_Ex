int __fastcall sub_2B0938(_DWORD *a1)
{
  int v2; // r11
  int v3; // r0
  bool v4; // zf
...
LABEL_70:
            ...
            if ( (word_4388C0[(unsigned __int8)v30] & 0x40) != 0 )
              break;
            if ( v32 >= v29 )
            {
              v29 *= 2;
              v33 = (char *)sub_2AB424(v27, v29 + 1);
              v28 = &v33[v32];
              if ( !v33 )
                goto LABEL_70;
              v27 = v33;
          ...
          *v28 = 0;
          v7 = (char *)sub_2ACC1C((int)a1, v28 + 1 - v27);
          v8 = v7;
          if ( !v7 )
            goto LABEL_70;
          strcpy(v7, v27);
...
LABEL_26:
          ...
          v36 = (_DWORD *)sub_2ACC1C((int)a1, 12);
          if ( !v36 )
            goto LABEL_27;
          v37 = a1[40];
          v36[1] = v8;
      ...
      else if ( v3 > 32 )
      {
        if ( v3 != 36 )
        {
          ...
          {
LABEL_18:
            sub_2B08A4((int)a1, v83, v3, v90);
            goto LABEL_27;
          }
          LODWORD(v85) = sub_2A8934((int)a1);
          HIDWORD(v85) = v12;
          if ( sub_2A8800((int)&v87, 3u, (int)a1) != 3 )
          {
LABEL_27:
            if ( ptr )
              free(ptr);
          ...
          if ( v19 > v16 )
          {
            sub_2A6A84("%B:%d: byte count %d too small\n", a1, v83, v16);
          ...
          {
LABEL_48:
            if ( 2 * v16 == sub_2A8800((int)ptr, 2 * v16, (int)a1) )
            {
              v20 = v16 - 1;
              switch ( v87 )
              {
...
LABEL_93:
                  ...
                  else
                  {
                    ...
                    v65 = strlen(s);
                    v66 = (char *)sub_2ACC1C((int)a1, v65 + 1);
                    v67 = strcpy(v66, s);
                    v68 = (_DWORD *)sub_2ADC10((int)a1, v67, 259);
                    v2 = (int)v68;
                    if ( !v68 )
                      goto LABEL_27;
                    v68[7] = v61;
                  ...
                  if ( (unsigned __int8)~v62 == (unsigned __int8)aCccccccccccccc[v63[1]]
                    ...
                    continue;
LABEL_89:
                  sub_2A6A84("%B:%d: Bad checksum in S-record file\n", a1, v83);
                  ((void (__fastcall *)(int))loc_2A6C70)(17);
                  break;
                case '7':
                  v48 = ptr + 2;
...
LABEL_88:
          ...
          if ( ptr )
            free(ptr);
          ptr = (unsigned __int8 *)sub_2AB390(2 * v16);
          if ( ptr )
          {
            v84 = 2 * v16;
            goto LABEL_48;
