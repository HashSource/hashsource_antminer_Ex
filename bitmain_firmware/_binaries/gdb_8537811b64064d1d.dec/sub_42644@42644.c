int __fastcall sub_42644(int a1, int a2, int *a3)
{
  int v3; // r9
  int v5; // r10
  _DWORD *v6; // r0
  ...
  stat_loc = 127;
  v5 = *(_DWORD *)(((int (*)(void))loc_23DC0C)() + 208);
  v27 = dword_4878EC;
  v28 = dword_4878F0;
  v29 = dword_4878F4;
  v6 = (_DWORD *)((int (*)(void))loc_23DC0C)();
  v7 = v6[54];
  v8 = v6[55];
  v33 = v6[53];
  v34 = v7;
  ...
  *(_DWORD *)(v9 + 28) = 2;
  if ( a3 )
  {
    v10 = sub_92564(sub_41A38, v9);
    if ( off_4720B0 )
      off_4720B0(v9);
    v11 = off_489B68();
    if ( !((int (__fastcall *)(int))loc_16A0FC)(v11) )
    {
      a3 = (int *)pid;
      sub_4C168(pid);
      if ( ptrace(PTRACE_SINGLESTEP, pid, 0, 0) < 0 )
        sub_258B2C("Couldn't do single step");
      if ( sub_4C3A8(pid, &stat_loc, 0) < 0 )
        sub_258B2C("Couldn't wait vfork process");
    }
...
LABEL_10:
    ...
    if ( v13 )
    {
      if ( dword_47202C )
      {
        v19 = (_DWORD *)sub_242FF0(v13);
        sub_2594D8(*v19, "LCFF: waiting for VFORK_DONE on %d\n", v25);
      }
      v12[5] = 1;
    }
    else
    {
      if ( dword_47202C )
      {
        ...
        sub_2594D8(*v18, "LCFF: no VFORK_DONE support, sleeping a bit\n");
      }
      usleep(0x2710u);
