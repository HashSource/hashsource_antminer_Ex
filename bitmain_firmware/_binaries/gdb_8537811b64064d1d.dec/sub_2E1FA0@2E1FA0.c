int __fastcall sub_2E1FA0(int a1, int *a2)
{
  int v5; // r0
  int v6; // r7
  char v7; // r3
...
LABEL_14:
        if ( !*(_DWORD *)(a1 + 44) && (*(_DWORD *)(a1 + 48) & 0x800000FF) == 0 )
          sub_2A6A84("warning: type and size of dynamic symbol `%s' are not defined", *(const char **)(a1 + 4));
  ...
  if ( v10 || (*(_BYTE *)(a1 + 51) & 1) == 0 || (*(_BYTE *)(a1 + 49) & 3) != 0 )
    goto LABEL_7;
  if ( sub_2FF718(*(_DWORD *)(v5 + 132), *(_DWORD *)(a1 + 4)) || sub_2E0880(*a2, a1) )
  {
LABEL_6:
    v7 = *(_BYTE *)(a1 + 51);
    goto LABEL_7;
