int __fastcall sub_22DC1C(int a1, int a2, int a3, int a4, int a5, _DWORD *a6)
{
  _DWORD *i; // r4
  ...
  if ( dword_489AD8 <= 1 )
    goto LABEL_34;
  for ( i = (_DWORD *)dword_4899A0; ; i = (_DWORD *)sub_224544("file I/O") )
  {
    while ( 1 )
    {
      if ( !i )
...
LABEL_38:
      v14 = sub_99EE0((unsigned int *)dword_489F94, 1, 8, 8);
      v20 = *v14;
      v25 = v14[1];
...
LABEL_11:
  ...
  if ( v12 == -1 )
    v18 = (_DWORD *)*v18;
  sub_2594D8(v19, "target_fileio_open (%d,%s,0x%x,0%o,%d) = %d (%d)\n", v17, a2, a3, a4, a5, v12, v18);
  return v12;
}
