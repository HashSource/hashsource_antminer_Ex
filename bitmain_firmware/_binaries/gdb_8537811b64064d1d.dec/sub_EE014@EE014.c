void __fastcall sub_EE014(_DWORD *a1, int a2, int a3, int *a4, _DWORD *a5, int a6)
{
  int v10; // r2
  _DWORD *v11; // r10
  int v12; // r11
  ...
  {
    v16 = sub_26FE18(v11);
    v15 = (const char *)((int (__fastcall *)(int))loc_26FEA4)(v16);
  }
  else
  {
    v15 = 0;
  }
  sub_ECC00(&v68, &v69, &v70, v12);
  v17 = *(unsigned __int8 **)(v69 + 24);
  if ( (unsigned int)*v17 - 3 > 1 )
  {
    sub_ED748((int)a1, a2, (void **)a3, a4, a5, (void **)a6);
    return;
  }
  v18 = (int *)".";
  if ( v70 )
  ...
  if ( a1 && !a1[19] && !a1[20] )
  {
    ...
    v36 = *v35;
    v71 = 0;
    v64 = sub_17326C(v69, &v71);
    v37 = sub_33CAC8((int)a1, "private");
    v38 = v36;
    v39 = v64;
    if ( v37 )
    {
      v56 = sub_33CAC8((int)a1, "protected");
      v39 = v64;
      if ( v56 )
        v57 = 2;
      else
...
LABEL_97:
    ...
    if ( !v46 || !*v46 )
    {
      if ( a3 )
      {
        ...
        if ( v53 == 3 )
        {
          sub_33BC7C(a3, 0, *(_DWORD *)(a3 + 4), "<anonymous struct>", 0x12u);
        }
        else if ( v53 == 4 )
        {
          sub_33BC7C(a3, 0, *(_DWORD *)(a3 + 4), "<anonymous union>", 0x11u);
        }
      }
      if ( !a6 )
        goto LABEL_109;
...
LABEL_109:
    ...
    if ( a3 )
    {
      ...
      sub_33BC7C(a3, 0, *(_DWORD *)(a3 + 4), v46, v47);
    }
    if ( !a6 )
      goto LABEL_109;
    sub_93200((char **)&v72, "((%s)%s%s)", v15, v62, v46);
    v48 = *(_BYTE **)a6;
    if ( v72 == v74 )
    {
      sub_33B4B4(a6, &v72);
...
LABEL_68:
        ...
        {
          v34 = strlen(v33);
          sub_33BC7C(a3, 0, *(_DWORD *)(a3 + 4), v33, v34);
        }
        return;
      default:
LABEL_61:
  ...
  if ( a3 )
  {
    ...
    v22 = strlen(v21);
    sub_33BC7C(a3, 0, *(_DWORD *)(a3 + 4), v21, v22);
  }
  if ( a4 && v68 )
    *a4 = sub_2647F0(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v69 + 24) + 24) + 24 * a2 + 12), v68);
  if ( a5 )
