int __fastcall sub_2A5074(int a1, unsigned int a2)
{
  char *v3; // r6
  int v4; // r4
  int v5; // r9
  ...
  if ( v31 )
  {
    ...
    if ( v4 )
    {
      ...
      do
      {
        if ( sub_2AA894(v4, 1) && (*(_DWORD *)(v4 + 40) & 0x200) != 0 )
        {
              ...
              for ( i = 0; v27 != i; ++i )
              {
                  ...
                  && (char **)HIDWORD(v19) != &off_4708A8 )
                {
                  ...
                  if ( *(_BYTE *)v20 == 95 && *(_BYTE *)(v20 + 1) == 95 )
                  {
                    ...
                    {
                      sub_2A6A84("%B: plugin needed to handle lto object", v4);
                      v20 = *(_DWORD *)(*((_DWORD *)v6 + i) + 4);
                    }
                  }
                  v13 = strlen((const char *)v20);
                  v14 = (int *)&v3[24 * v5];
                  v15 = sub_2ACC1C(v26, 4);
                  *v14 = v15;
                  v28 = (int *)v15;
                  if ( !v15 )
                    goto LABEL_35;
                  v16 = sub_2ACC1C(v26, v13 + 1);
                  v17 = *(char ***)&v3[24 * v5];
                  *v28 = v16;
                  if ( !*v17 )
                    goto LABEL_35;
