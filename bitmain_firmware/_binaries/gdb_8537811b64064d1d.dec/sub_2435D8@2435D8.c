int __fastcall sub_2435D8(unsigned __int8 *a1, int a2)
{
  _DWORD *v3; // r11
  void *v4; // r0
  int v5; // r3
  ...
  if ( a1 )
  {
    ...
    if ( v5 )
    {
      ...
      sub_57DA4((int)v6);
      v10 = sub_544F0(&v34, dword_474744, "", 0, 1);
      v11 = (char *)v34;
      v12 = dword_48A51C;
      v13 = v10;
      v14 = *v34;
      ...
      if ( v14 )
      {
        ...
        LOBYTE(v38[0]) = 0;
        ptr = v38;
        if ( (v17 & 0x180) != 0x80 && !sub_51ED8(v10) )
        {
          v18 = strlen(v11) - 1;
      ...
      while ( 1 )
      {
        ...
        else
        {
          ...
          if ( v15 == 128 )
          {
            sub_59BAC((char *)v14, a2, v13);
          }
          else if ( v15 == 256 )
          {
            ((void (__fastcall *)(size_t, int, int))loc_5A708)(v14, a2, v13);
          }
          else
          {
            if ( !sub_54C74(v13) )
              sub_94708("That is not a command, just a help topic.");
            if ( off_48A520 )
