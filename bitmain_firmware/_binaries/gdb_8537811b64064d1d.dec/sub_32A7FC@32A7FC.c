int __fastcall sub_32A7FC(int a1, int a2, int a3, int *a4)
{
  __int64 v4; // r6
  int v6; // r12
...
LABEL_31:
  ...
  else
  {
    ...
    if ( v6 <= 49 )
    {
      v9 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v6) + 0x7FFFFFFF);
    }
    else
    {
    ...
    {
      v12 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v10) + 0x7FFFFFFF);
    }
    v13 = *a4;
