char *__fastcall sub_9EBA8(const char *a1)
{
  char *v1; // r4
  int v2; // r5
  size_t v3; // r3
  ...
  if ( v4 )
    goto LABEL_7;
  v72 = v3;
  sub_9DFD4((unsigned __int8 *)v1, &v72);
  sub_9ADA8((int)v1, &v72);
  v10 = sub_338BFC(v1, "___");
  v11 = v72;
...
LABEL_24:
    if ( 2 * v12 >= v13 )
      v13 = 2 * v12;
    dword_477C94 = v13;
    v6 = sub_9D498(v6, &dword_477C94, 1);
    dword_477C98 = (int)v6;
  }
  v11 = v72;
  if ( v72 <= 1 )
...
LABEL_63:
  ...
  v52 = *(const char **)&asc_374020[12 * v47 + 124];
  strcpy(&s1[v26], v52);
  v28 = v72;
  v26 += strlen(v52);
  if ( v72 > v51 )
...
LABEL_7:
  ...
  if ( v5 > dword_477C94 )
  {
    if ( 2 * dword_477C94 >= v5 )
      v5 = 2 * dword_477C94;
    dword_477C94 = v5;
    v8 = sub_9D498((void *)dword_477C98, &dword_477C94, 1);
    ...
    if ( v9 == 60 )
      goto LABEL_14;
LABEL_9:
    sub_93198(v6, dword_477C94, "<%s>", v1);
    return v6;
  }
  if ( *v1 != 60 )
    goto LABEL_9;
