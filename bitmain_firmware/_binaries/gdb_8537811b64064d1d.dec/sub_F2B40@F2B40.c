int __fastcall sub_F2B40(_DWORD *a1, int a2)
{
  int v2; // r7
  _DWORD *v4; // r4
  int v5; // r0
  ...
  v135 = sub_92564((int)sub_2589E0, (int)&dword_4789E4);
  ...
  *(_QWORD *)(v131 + 8) = 0;
  if ( v9 )
  {
    sub_2ADD24(v134, sub_F1360, v131);
    sub_92564((int)sub_F1418, 0);
    v20 = *(_DWORD *)v131;
    v21 = *(_DWORD *)(v131 + 8);
    dword_478C0C = v20;
    v22 = v21 - v20;
    ...
    if ( v22 )
    {
      if ( sub_2A8A2C(v134, v19, v20, v20 >> 31, 0) < 0
        || (dword_4789B4 = (int)sub_93050(v22 + dword_4789AC[0]), v22 != sub_2A8800(dword_4789B4, v22, v134)) )
      {
        sub_94708("\"%s\": error reading line numbers.", v136);
      }
      memset((void *)(dword_4789B4 + v22), 0, dword_4789AC[0]);
    }
  }
  sub_92564((int)sub_F13F0, 0);
  if ( dword_4789B0 )
    free((void *)dword_4789B0);
  dword_4789B0 = 0;
  if ( v14 )
  {
    if ( sub_2A8A2C(v134, v23, v14, v14 >> 31, 0) < 0 )
      goto LABEL_249;
    v97 = sub_2A8800(v153, 4, v134);
    ...
    if ( !v100 )
    {
      v101 = (char **)sub_93050(v98);
      dword_4789B0 = (int)v101;
      *v101 = v153[0];
      if ( v99 != 4 && (v99 - 4 != sub_2A8800(v101 + 1, v99 - 4, v134) || *(_BYTE *)(dword_4789B0 + v99 - 1)) )
LABEL_249:
        sub_94708("\"%s\": can't get string table", v136);
    }
  }
  sub_1B2598(v144, a1);
  v24 = sub_1B7278(a1);
  v130 = v24;
  sub_2A8A2C(a1[9], HIDWORD(v24), 0, 0, 0);
  if ( sub_2A8A2C(a1[9], v25, v8, v8 >> 31, 0) < 0 )
    goto LABEL_277;
  v26 = a1[9];
  dword_4789C0 = (int)a1;
  dword_478A00 = v9;
  ...
  dword_4789B8 = 160;
  dword_4789BC = (int)sub_930BC(0xA0u, 4u);
  sub_F1458((int)a1, (int)"");
...
LABEL_15:
  if ( v9 > v28 )
  {
    ...
    {
      sub_258BFC(v27);
      ((void (__fastcall *)(char **, _DWORD *, int *))loc_F163C)(&s1, dword_478C2C, &dword_478C14);
      if ( v147 == (char *)v29 && v150 != 103 )
      {
        if ( sub_E684C() )
          ((void (__fastcall *)(_DWORD))loc_F15E8)(a1[38]);
        sub_F1458((int)a1, (int)"_globals_");
        *(_DWORD *)(dword_4788E0 + 20) = 13;
        sub_E6560((int)"_globals_");
        dword_4789C8 = 0;
        dword_4789CC = 0;
      }
      v61 = sub_E684C() == 0;
      ...
      if ( (v30 & v27) == 2 << dword_478A08 )
      {
        if ( v150 != 13 )
        {
          v91 = sub_F1570((int)&s1, (int)a1);
          v92 = (char *)v149;
          ((void (__fastcall *)(_BYTE *, char **, int, int, int))loc_F28F8)(v144, &s1, v149, 1, v91);
          v123 = v92;
          v153[0] = s1;
          v153[1] = v147;
          v153[2] = v148;
...
LABEL_190:
          v118 = (char *)sub_3245CC(byte_478C74);
          goto LABEL_158;
        }
        sub_94728((int)"coffread.c", 1398, "coff file name too long");
LABEL_281:
        sub_94728((int)"coffread.c", 1184, "sect_index_text not initialized");
LABEL_282:
        sub_94728((int)"coffread.c", 1147, "sect_index_text not initialized");
LABEL_283:
        sub_94728((int)"coffread.c", 1513, "sect_index_text not initialized");
LABEL_284:
        sub_94708("Bad coff function information.");
      }
      if ( v150 > 103 )
      {
        if ( v150 == 131 )
        ...
        if ( v150 > 150 )
        {
          ...
          if ( v150 == 255 )
            goto LABEL_171;
LABEL_113:
          v27 = (int)sub_F2460(&s1, &dword_478C14, a1);
          goto LABEL_114;
        }
        if ( v150 != 134 )
          goto LABEL_113;
...
LABEL_131:
          ...
          if ( v151 != -1 )
          {
            ...
            v77 = a1[9];
            v142[1] = &v141;
            sub_2ADD24(v77, sub_F1348, v142);
            v78 = v141;
            v79 = sub_F1570((int)&s1, (int)a1);
            v80 = v150 == 150;
            if ( v150 != 150 )
              v80 = v150 == 2;
            v116 = v149;
...
LABEL_150:
                v116 = ((int (__fastcall *)(int, int))loc_169FC8)(v130, v149);
LABEL_151:
                v27 = ((int (__fastcall *)(_BYTE *, char **, int, int, int))loc_F28F8)(v144, &s1, v116, v85, v79);
LABEL_152:
                if ( v27 )
                  v27 = ((int (__fastcall *)(int, int, int))loc_16A7E0)(v130, v150, v27);
          ...
          v116 = v149;
          v128 = 0;
          v27 = ((int (__fastcall *)(_BYTE *, char **, int, int, int))loc_F28F8)(v144, &s1, v149, 6, v79);
          goto LABEL_152;
        }
LABEL_127:
        v74 = s1;
...
LABEL_163:
        ...
        if ( !v27 && v125 )
        {
          ...
          if ( v86 == -1 )
          {
            v114 = sub_94728((int)"coffread.c", 950, "sect_index_text not initialized");
            if ( v153[0] )
              ((void (__fastcall *)(char *, _DWORD))loc_1625D0)(v153[0], HIDWORD(v114));
            v113 = sub_1B25AC(v144);
            sub_339024(v113);
          }
          v87 = dword_478C14;
          v88 = v149 + *(_DWORD *)(a1[36] + 4 * v86);
          v27 = sub_E6560((int)v118);
          dword_4789C8 = v88;
...
LABEL_171:
          if ( dword_47AC88 > 0 )
            v27 = sub_F43DC(&off_46D334, "Bad n_sclass for symbol %s", s1);
          goto LABEL_114;
        }
        goto LABEL_113;
      }
      if ( v150 == 100 )
      {
        ...
        if ( !strcmp(s1, ".bb") )
        {
          ...
          if ( v90 != -1 )
          {
            v27 = (int)sub_E63A4(++n, v149 + *(_DWORD *)(a1[36] + 4 * v90));
            goto LABEL_114;
          }
          sub_94728((int)"coffread.c", 1157, "sect_index_text not initialized");
LABEL_276:
          sub_94728((int)"coffread.c", 1015, "Section index is uninitialized");
LABEL_277:
          v112 = sub_1B87D0(a1);
          sub_258B2C(v112);
        }
        ...
        if ( !v27 )
        {
          if ( dword_478974 > 0 )
          {
            ...
            v27 = sub_F43DC(&off_46D334, "Mismatched .eb symbol ignored starting at symnum %d", dword_478988);
            --n;
          }
...
LABEL_114:
      ...
      if ( strcmp(s1, ".bf") )
      {
        ...
        if ( dword_478974 <= 0 )
        {
          if ( dword_47AC88 <= 0 )
            goto LABEL_182;
          v27 = sub_F43DC(&off_46D334, "`.ef' symbol without matching `.bf' symbol ignored starting at symnum %d", v147);
          v28 = dword_478988;
          dword_478980 = 0;
          goto LABEL_15;
        }
...
LABEL_182:
          ...
          {
            v27 = sub_F43DC(&off_46D334, "Unmatched .ef symbol(s) ignored starting at symnum %d", v147);
            v28 = dword_478988;
            dword_478980 = 0;
          }
          goto LABEL_15;
        ...
        if ( v148 == (char *)1 )
        {
          ...
          v111 = ((int (__fastcall *)(int, int))loc_169FC8)(v130, v133);
          sub_E606C(v110, v132, v111);
        }
        else
        {
          if ( dword_47AC88 > 0 )
            sub_F43DC(&off_46D334, "`.ef' symbol %d has no aux entry", v147);
          v129 = 0x7FFFFFFF;
LABEL_255:
          v102 = sub_1B7278(a1);
          v103 = dword_4789B4;
          ...
          if ( dword_4789B4 )
          {
            ...
            {
              if ( dword_47AC88 > 0 )
                sub_F43DC(&off_46D334, "Line number pointer %ld lower than start of line numbers", v127);
              v106 = dword_478C10;
            ...
            while ( v117 <= v103 + v106 )
            {
              ...
              v109 = ((int (__fastcall *)(int, int))loc_169FC8)(v140, v142[2] + *(_DWORD *)(a1[36] + 4 * v107));
              sub_E606C(v138, v108, v109);
              v103 = dword_4789B4;
              v106 = dword_478C10;
            }
          }
...
LABEL_261:
      ...
      if ( v148 != (char *)1 && dword_47AC88 > 0 )
        sub_F43DC(&off_46D334, "`.bf' symbol %d has no aux entry", v147);
      v132 = (unsigned __int16)dword_478C18;
      v133 = v149;
      v32 = sub_E63A4(0, (int)v123);
      ...
      v153[0] = v33;
      v27 = (int)sub_F2460(v153, &dword_478C5C, a1);
      v34 = dword_478988;
      v32[3] = v27;
      n = 0;
      if ( v9 <= v34 )
...
LABEL_34:
  if ( !v9 && dword_4789FC )
    ((void (__fastcall *)(_BYTE *, _DWORD *))loc_F0710)(v144, a1);
  if ( sub_E684C() )
    ((void (__fastcall *)(_DWORD))loc_F15E8)(a1[38]);
  for ( i = (_DWORD *)a1[5]; i; i = (_DWORD *)*i )
  {
    ...
    {
      for ( k = sub_C28D0(*(_DWORD **)(*(_DWORD *)(j[1] + 32) + 12), v145); ; k = sub_C290C((int)v145) )
      {
        v38 = k;
        if ( !k )
          break;
        ...
        if ( *((_DWORD *)off_46DBB8 + 4 * (v39 >> 3)) == 8 && (v39 & 7) == 1 )
        {
          ...
          if ( *(_BYTE *)v40 == 1 )
          {
            if ( *(_DWORD *)(*(_DWORD *)(v40 + 20) + 20) )
            {
              v41 = *(char **)k;
              v119 = *(char **)k;
              v42 = &dword_4789AC[sub_E6484(*(char **)k)];
...
LABEL_84:
  ...
  if ( (a1[3] & 0x80) == 0 )
    sub_2ADD24(v134, sub_F2A10, v131);
  if ( *(_DWORD *)(v131 + 24) )
  {
    if ( !*(_DWORD *)(v131 + 28) )
      sub_94708(
        ...
        v136);
    sub_2A8A2C(v134, 0, *(_DWORD *)(v134 + 24), *(_DWORD *)(v134 + 28), 0);
    sub_109068(
      a1,
      *(_DWORD *)(v131 + 16),
      *(_DWORD *)(v131 + 20),
  ...
  if ( !sub_1B7A7C(a1) )
  {
    v72 = sub_E469C((int)a1);
    if ( !v72 )
      v72 = sub_2125B4(a1);
    sub_92564((int)sub_F13D8, v72);
    if ( v72 )
    {
      sub_2127B4(v153, v72);
      sub_2137A0(v153[0], v72, a2, a1);
      if ( v153[0] )
        ((void (*)(void))loc_1625D0)();
    }
  }
  sub_92648(v135);
  return sub_1B25AC(v144);
}
