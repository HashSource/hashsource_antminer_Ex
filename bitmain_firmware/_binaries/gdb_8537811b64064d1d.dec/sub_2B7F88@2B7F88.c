int __fastcall sub_2B7F88(int a1, char *s, int a3, int a4, int a5, int a6, _DWORD *a7, char **a8)
{
  int v8; // r10
  size_t v13; // r0
  char *v14; // r4
  ...
  if ( *(_DWORD *)(v8 + 44) != 4 )
    return 0;
  v13 = strlen(s);
  v14 = (char *)sub_2AB390(v13 + 14);
  if ( !v14 )
    sub_2A6BE4("elf32-arm.c", 6788);
  sprintf(v14, "__%s_from_arm", s);
  v15 = sub_2FC948(v8, v14, 0);
  if ( v15 )
  {
    free(v14);
    v16 = *(_DWORD **)(a1 + 28);
    if ( v16[11] != 4 )
    {
      sub_2A6BE4("elf32-arm.c", 8884);
      __und(0);
    }
    if ( !v16[90] )
      sub_2A6BE4("elf32-arm.c", 8885);
    v17 = *(_DWORD *)(v15 + 24);
    if ( (v17 & 1) != 0 )
    {
      if ( a5 )
      ...
      *(_DWORD *)(v15 + 24) = v17 - 1;
      ...
      if ( (v23 & 1) != 0 || v16[13] || v16[102] )
      {
        ...
        sub_2B73F8(v22, v24, v23);
        LODWORD(v27) = -527646705;
        HIDWORD(v27) = a7[27] + v21;
        sub_2B73F8(v16[91], *(_DWORD *)(a4 + 4), v27);
        LODWORD(v28) = -516948196;
        HIDWORD(v28) = a7[27] + v17 + 7;
        sub_2B73F8(v16[91], *(_DWORD *)(a4 + 4), v28);
        v29 = v17 + 11;
        --v17;
      ...
      else
      {
        ...
        else
        {
          ...
          sub_2B73F8(v16[91], *(_DWORD *)(a4 + 4), v30);
          v31 = v17 + 7;
          v17 += 11;
