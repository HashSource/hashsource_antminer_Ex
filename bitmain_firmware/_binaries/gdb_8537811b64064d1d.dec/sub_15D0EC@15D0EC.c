int __fastcall sub_15D0EC(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, unsigned __int8 a9, int a10)
{
  int v10; // r5
  _DWORD *v11; // r0
  int v12; // r0
...
LABEL_3:
  if ( dword_487724 )
  {
    ...
    v12 = sub_2594D8(*v11, "{ frame_id_eq (l=");
    v13 = (int *)sub_242FF0(v12);
    v14 = sub_15C6F0(*v13, varg_r0, a2, a3, a4, a5);
    v15 = (_DWORD *)sub_242FF0(v14);
    v16 = sub_2594D8(*v15, ",r=");
    v17 = (int *)sub_242FF0(v16);
    v18 = sub_15C6F0(*v17, a6, a7, a8, a9, a10);
