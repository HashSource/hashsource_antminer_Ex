int __fastcall sub_1BACFC(int a1, int a2, int a3, int a4, int a5)
{
  int v8; // r0
  bool v9; // cc
  _DWORD *v10; // r4
  ...
  v8 = ((int (__fastcall *)(int, int))loc_16ECB0)(a1, dword_487C28);
  ...
  {
    if ( a5 != 16 )
      sub_94708("Invalid OpenCL vector size: %d", a5);
  }
  else if ( a5 == 3 )
  {
    v17 = 4 * a3;
