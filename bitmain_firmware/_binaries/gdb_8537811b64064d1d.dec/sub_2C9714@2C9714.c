int __fastcall sub_2C9714(int result, _DWORD *a2, _DWORD *a3)
{
  int v3; // r3
  int v4; // r12
  int v6; // r7
...
LABEL_26:
        ...
        {
          if ( v10 != 9 )
            sub_2A6C18((int)"elfcode.h", 914, (int)"bfd_elf32_write_relocs");
          v26 = 8;
          v25 = sub_2C8550;
        }
