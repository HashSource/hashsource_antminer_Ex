int __fastcall sub_23F2C0(int result, unsigned int a2, unsigned int a3, int a4)
{
  int v5; // r9
  int i; // r4
  int v7; // r10
...
LABEL_5:
  ...
  {
LABEL_22:
    result = sub_94728((int)"thread.c", 1005, "%s: Assertion `%s' failed.", "void set_executing(ptid_t, int)", "tp");
LABEL_23:
    if ( qword_46BBD0 == v10 )
      dword_48A4E0 = a4;
    return result;
