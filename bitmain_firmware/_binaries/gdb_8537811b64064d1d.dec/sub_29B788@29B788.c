char *__fastcall sub_29B788(int a1)
{
  int v2; // r3
  bool v3; // zf
  size_t v4; // r0
  ...
  if ( *(_BYTE *)a1 == 126 )
  {
    ...
    if ( v3 )
    {
      v20 = j_getenv("HOME");
      if ( !v20 )
        v20 = (const char *)sub_29B1C4();
      return sub_29B708(v20, a1, 1);
    }
    else
    {
      v4 = strlen((const char *)a1);
      v5 = (char *)sub_93050(v4);
      ...
      *v14 = 0;
      if ( !off_48BB64 || (v15 = (const char *)off_48BB64(v5, v6), (v16 = (char *)v15) == 0) )
      {
        ...
        if ( v17 )
        {
          v18 = sub_29B708(v17->pw_dir, a1, v11);
        }
        else if ( !off_48BB68
               || (v24 = (const char *)((int (__fastcall *)(char *))off_48BB68)(v8), (v25 = (char *)v24) == 0)
               || (v18 = sub_29B708(v24, a1, v11), sub_297780(v25), !v18) )
        {
          v26 = strlen((const char *)a1);
          v27 = (char *)sub_93050(v26 + 1);
