int __fastcall sub_2A9D48(int a1, int a2)
{
  int v4; // r0
  size_t n; // r2
  int v6; // r4
  ...
  v4 = sub_2A81EC(a1, a2);
  if ( v4 > 24 )
    sub_2A6C18((int)"compress.c", 486, (int)"bfd_init_section_decompress_status");
  if ( v4 )
    n = v4;
  else
    n = 12;
  ...
  else
  {
    if ( v6 )
    {
      if ( sub_2A8114(a1, (int)s1, a2, &v12) )
      {
        v9 = v12;
        goto LABEL_14;
      }
