unsigned int __fastcall sub_28D744(char *a1, const char *a2, const char *a3, signed int a4, int a5, int a6)
{
  int v8; // r7
  int v9; // r3
  int v10; // r2
...
LABEL_35:
  ...
  while ( 1 )
  {
    v78 = sub_29B27C(a1, v12, &v112, a2, v77, &v110) == 0;
    result = (unsigned int)a1;
    if ( v78 )
      break;
    v12 = sub_29B4F8(a1);
    v14 = &a1[v12];
    result = sub_29B4F8(a2);
    v77 = result;
    v15 = &a2[result];
    if ( a4 <= v12 )
    {
...
LABEL_25:
  ...
  {
    v101 = &a1[sub_29B638(a1, v17 - a1, 0)];
    v51 = v17;
    v64 = &a2[sub_29B638(a2, v19 - a2, 0)];
    v65 = v101 > v14;
    if ( v101 > v14 )
      v65 = v64 > v15;
    if ( !v65 )
    ...
    while ( 1 )
    {
      ...
      v110 = 0;
      v111 = 0;
      if ( !sub_29B27C(a1, v66 - a1, &v112, a2, v67 - a2, &v110) )
        break;
      v68 = v103;
      if ( *v66 == 32 )
        v68 = 0;
      v103 = v68;
      v66 = &a1[sub_29B638(a1, v66 - a1, 0)];
      v69 = sub_29B638(a2, v67 - a2, 0);
      v67 = &a2[v69];
      v70 = v66 > v108;
      if ( v66 > v108 )
        v70 = v67 > v15;
...
LABEL_82:
  ...
  if ( sub_29B27C(v100, 0, 0, v50, 0, 0) )
  {
    v102 = v50;
    v51 = v100;
  }
...
LABEL_83:
  if ( a3 )
  {
    if ( a3 == (const char *)dword_48AE2C || (sub_28D034(a3), _ctype_get_mb_cur_max() == 1) )
    {
      v107 = 0;
      goto LABEL_86;
    }
  ...
  if ( !dword_48AAF8 && dword_490140 && dword_48AE24 < v106 )
  {
    ...
    if ( !v62 )
    {
      ...
      if ( dword_48AE04 < v63 )
      {
        ...
        {
          v92 = sub_28C450((const void *)dword_48AE0C, 0, v106, 1);
          dword_48AE48 = 1;
...
LABEL_159:
  if ( dword_48BB60 )
    goto LABEL_160;
LABEL_88:
  v52 = sub_28C450(a2, pwc, v102 - a2, 1);
  v53 = v52 - sub_28C450(a1, v12, v51 - a1, 1);
  if ( a3 )
    goto LABEL_91;
LABEL_89:
...
LABEL_91:
  ...
  {
    result = sub_28C450(a2, pwc, v19 - a2, 1);
    v55 = result;
  }
  if ( v53 <= 0 )
  {
    if ( !dword_490128 || -v53 > (int)(2 * v55) )
    {
      ...
      if ( result > 1 && !dword_48BB60 )
      {
        v75 = sub_28C450(a1, 0, v17 - a1, 1);
        result = sub_28C450(a2, 0, v73, 1);
        v74 = v75 - result;
      }
      if ( v74 )
      {
        ...
        if ( result == 1 || dword_48BB60 || dword_48AE04 < dword_490144 )
        {
          ...
          if ( dword_4707A0 )
            v76 = (int)a3 < a6;
          if ( v76 )
            return sub_28C408(v74);
          else
            return sub_28D710(v74);
        }
      }
      return result;
    }
    if ( !dword_48AAF8 || dword_48AE04 || (result = nb, dword_48AE38 + nb) )
    {
      if ( v53 && -v53 <= dword_490144 )
      {
        ...
        if ( dword_490148 && *(_BYTE *)dword_490148 )
        {
          ...
          result = tputs(v91, -v53, (int (*)(int))sub_293BA8);
        }
        else if ( *(_BYTE *)dword_490128 )
        {
          ...
          {
            --v82;
            result = tputs(i, 1, (int (*)(int))sub_293BA8);
            if ( v82 == -1 )
              break;
          }
        }
    ...
    v81 = v15;
LABEL_261:
    result = sub_28C450(v81, 0, v80, 1) + dword_48AE04;
    dword_48AE04 = result;
...
LABEL_118:
          ...
          && dword_48AE38 >= v107 )
        {
          if ( (_ctype_get_mb_cur_max() == 1 || dword_48BB60) && nb != v53 )
            sub_2914F0("debug: insert_some_chars: count (%d) != col (%d)", nb, v53);
          if ( dword_490108 )
          {
            v60 = tgoto((const char *)dword_490108, 0, v53);
            tputs(v60, 1, (int (*)(int))sub_293BA8);
            result = sub_29452C((int)v15, nb);
          }
          else
          {
            if ( dword_49010C && *(_BYTE *)dword_49010C )
              tputs((const char *)dword_49010C, 1, (int (*)(int))sub_293BA8);
            ...
            if ( dword_49013C && *(_BYTE *)dword_49013C )
            {
              ...
              {
                --v87;
                tputs(v86, 1, (int (*)(int))sub_293BA8);
                if ( v87 == -1 )
                  break;
                v86 = (const char *)dword_49013C;
              }
            }
            sub_29452C((int)v15, nb);
            result = dword_490114;
            if ( dword_490114 && *(_BYTE *)dword_490114 )
              result = tputs((const char *)dword_490114, 1, (int (*)(int))sub_293BA8);
          }
          goto LABEL_125;
        }
      }
...
LABEL_125:
        ...
        if ( v105 - nb > 0 )
        {
          sub_29452C((int)&v15[nb], v105 - nb);
          if ( _ctype_get_mb_cur_max() > 1 && !dword_48BB60 )
            v61 = sub_28C450(&v15[nb], 0, v105 - v53, 1);
          dword_48AE04 += v61;
          result = _ctype_get_mb_cur_max();
