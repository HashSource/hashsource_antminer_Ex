void __fastcall sub_BFFF4(char *s1, int a2, int a3)
{
  const char *v5; // r3
  int v6; // r0
  void *v7; // r4
  ...
  {
    if ( *s1 == 47 )
      v5 = (const char *)sub_24A158(s1, &v14, 47, s1);
    v13 = (char *)v5;
    if ( !strcmp(v5, "$_ret") )
    {
      v11 = sub_B8974(0);
      sub_BFF54((int *)&ptr, a3, v11, v14);
      v7 = ptr;
      goto LABEL_10;
    }
  }
  v6 = sub_C259C(a3);
  sub_1C42A4(&ptr, &v13, a3, v6, 0);
  if ( a2 )
  {
    if ( v14 )
    {
    ...
    sub_BFEAC((int *)&v16, a3, (int)ptr);
    v7 = v16;
  }
  else
  {
    sub_BFDFC((int *)&v17, a3, (int)ptr, v14);
    v7 = v17;
  }
  if ( ptr )
    free(ptr);
