void *__fastcall sub_27A310(int a1, int a2, int a3, int a4, int a5)
{
  _DWORD *v5; // r8
  int v8; // r0
  _BOOL4 v9; // r4
  ...
  if ( v9 )
    return 0;
  v10 = ((int (__fastcall *)(int))loc_166EC4)(a3);
  v11 = sub_930BC(v10, 1u);
  v25 = sub_92564((int)sub_279530, (int)v11);
  v12 = sub_323B08(1, sub_279590, sub_279560, 0, sub_930BC, sub_279530);
  while ( 2 )
  {
    for ( i = sub_C28D0(v5, v27); ; i = sub_C290C((int)v27) )
    {
      v14 = i;
      if ( !i )
        break;
      v15 = (int *)sub_324058(v12, i, 1);
      if ( *v15 )
        continue;
      *v15 = v14;
      v16 = sub_92E50();
      ...
      while ( 1 )
      {
        ...
        if ( v20 < 3 )
          goto LABEL_13;
        if ( v20 <= 7 )
          sub_94708("Local symbol unhandled when generating C code.");
        if ( v20 != 14 )
          goto LABEL_13;
        sub_94728(
...
LABEL_20:
        ...
        v28 = &off_3F294C;
        v29 = v31;
        sub_2795A0(a1, (int)&v28, a3, (int)v11, a5, v22, v14);
