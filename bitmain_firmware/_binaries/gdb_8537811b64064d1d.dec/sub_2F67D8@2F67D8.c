int __fastcall sub_2F67D8(int a1, int a2, int a3, unsigned int a4)
{
  int v4; // r12
  unsigned int v5; // r0
...
LABEL_3:
    ...
    if ( a2 != 2 )
      sub_2A6C18((int)"./dwarf2.c", 900, (int)"read_address");
  ...
  if ( a2 != 2 )
    sub_2A6C18((int)"./dwarf2.c", 886, (int)"read_address");
