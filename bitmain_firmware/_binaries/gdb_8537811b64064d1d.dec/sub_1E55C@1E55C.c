int __fastcall sub_1E55C(_DWORD *a1)
{
  int v2; // r4
  unsigned int v3; // r0
  int v4; // r7
...
LABEL_19:
  ...
  if ( v5 )
  {
    if ( (BYTE1(v3) & 0x1F) == 0x1F )
    {
      ...
      {
        v8 = -1;
        sub_259880("no syscall record support\n");
        return v8;
      }
      ((void (__fastcall *)(int, int, _DWORD *))loc_1DFA24)(v4, 7, v25);
  ...
  ((void (__fastcall *)(int, int, _DWORD *))loc_1DFA24)(v4, BYTE1(v3) & 7, v25);
  if ( !v11 )
  {
    a1[7] = 0;
    goto LABEL_31;
