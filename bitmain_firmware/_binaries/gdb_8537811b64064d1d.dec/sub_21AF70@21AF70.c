void __fastcall sub_21AF70(int a1, char **src, size_t n, int a4, int a5)
{
  char v7; // r0
  int v9; // r4
  char **p_s; // r8
  ...
  if ( !*(_DWORD *)(v9 + 56) )
    *(_DWORD *)(v9 + 56) = sub_323B08(256, sub_219894, sub_219878, 0, sub_930BC, sub_219810);
  if ( *((_BYTE *)src + n) )
  {
    p_s = &s;
    memcpy(&s, src, n);
  ...
  v55 = p_s;
  v11 = (char **)sub_324058(*(_DWORD *)(v9 + 56), &v55, 1);
  v12 = *v11;
  v13 = v11;
  v14 = *(_BYTE *)(a1 + 20);
  if ( v12 )
  ...
  else
  {
    ...
    if ( v41 == 1 )
    {
      ...
      {
        v43 = sub_194460(i);
        v29 = sub_194500((int)v43, (int)p_s, &v54);
        v30 = v29;
        if ( v29 )
        {
  ...
  v28 = sub_194460(v14 & 0x1F);
  sub_194500((int)v28, (int)p_s, &v54);
  s = v54;
LABEL_27:
  if ( s )
  {
