int __fastcall sub_2FE2C0(_DWORD *a1, int *a2, int a3, unsigned int *a4)
{
  int v7; // r2
  int v8; // r4
  _DWORD *v9; // r0
  ...
  if ( v7 )
  {
    ...
    if ( v8 )
    {
      ...
      v9[1] = v10;
      v9[4] = v8;
      if ( !sub_2FC6B8(a1 + 30, a1 + 31, a4, (int)v9) )
        return 0;
    }
  }
LABEL_9:
...
LABEL_22:
      ...
      if ( v17
        ...
        && ((v19 = *(const char **)(v13 + 4), *(char ***)(v13 + 16) == &off_4708A8)
          ? (v17 = sub_2FC988((int)a1, a3, v19, 0, *(_DWORD *)(v13 + 20), 1))
          : (v17 = sub_2FC948(*(_DWORD **)(a3 + 28), v19, *(_DWORD *)(v13 + 20), 0, 1)),
            v17) )
      {
...
LABEL_37:
            ...
            *(_DWORD *)(v13 + 16) = v25;
            ...
            goto LABEL_24;
          default:
            sub_2A6C18((int)"linker.c", 2056, (int)"_bfd_generic_link_output_symbols");
        }
        goto LABEL_29;
      }
    }
...
LABEL_24:
    if ( v20 == 64 && !sub_2AAC54(*(_DWORD **)(a3 + 32), *(const char **)(v13 + 4), 0, 0) )
    {
      HIDWORD(v21) = *(_DWORD *)(v13 + 16);
      goto LABEL_27;
    }
        ...
        else
        {
          if ( (v21 & 0x800) == 0 )
          {
            if ( (_DWORD)v21 || (*(_DWORD *)(*(_DWORD *)(HIDWORD(v21) + 148) + 40) & 0x200000) == 0 )
              sub_2A6C18((int)"linker.c", 2171, (int)"_bfd_generic_link_output_symbols");
LABEL_27:
...
LABEL_50:
    if ( !sub_2FC6B8(a1 + 30, a1 + 31, a4, v13) )
      return 0;
    if ( v17 )
      *((_DWORD *)v17 + 7) = 1;
  }
