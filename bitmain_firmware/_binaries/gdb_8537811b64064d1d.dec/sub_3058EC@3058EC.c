int __fastcall sub_3058EC(int a1, int a2)
{
  ...
  if ( !a1 || !*(_DWORD *)(a1 + 32) || !*(_DWORD *)(a1 + 36) || (LODWORD(v3) = a2, HIDWORD(v3) = sub_305090(a1), v3 > 5) )
  {
    HIDWORD(v3) = -2;
    return HIDWORD(v3);
  }
        ...
        *(_BYTE *)(v83 + v82) = 8;
        ...
        if ( v84 )
        {
          ...
          *(_BYTE *)(v106 + v105) = v107;
          ...
          if ( v46[11] )
          {
            v171 = sub_30C6BC(*(_DWORD *)(a1 + 48), v4[2], v4[5]);
            v46 = (_DWORD *)v4[7];
            *(_DWORD *)(a1 + 48) = v171;
          }
          v4[8] = 0;
...
LABEL_111:
          if ( v46[9] )
          {
            ...
            while ( 1 )
            {
              if ( v4[3] == v71 )
              {
                ...
                if ( v46[11] )
                  v76 = v70 >= v71;
                if ( !v76 )
                  *(_DWORD *)(a1 + 48) = sub_30C6BC(*(_DWORD *)(a1 + 48), v4[2] + v70, v71 - v70);
                sub_304170(a1);
                v71 = v4[5];
                v70 = v71;
                if ( v71 )
            ...
            if ( v115 <= v70 )
              goto LABEL_148;
            v116 = sub_30C6BC(*(_DWORD *)(a1 + 48), v4[2] + v70, v115 - v70);
            v46 = (_DWORD *)v4[7];
            *(_DWORD *)(a1 + 48) = v116;
          }
          v114 = v46[11];
...
LABEL_149:
          if ( !v114 )
            goto LABEL_153;
          v117 = v4[5];
          if ( v117 + 2 <= (unsigned int)v4[3] || (sub_304170(a1), (v117 = v4[5]) == 0) )
          {
            v118 = *(_DWORD *)(a1 + 48);
            v119 = v4[2];
            v4[5] = v117 + 1;
...
LABEL_95:
        if ( v46[7] )
        {
          ...
          while ( 1 )
          {
            if ( v4[3] == v62 )
            {
              ...
              if ( v46[11] )
                v67 = v61 >= v62;
              if ( !v67 )
                *(_DWORD *)(a1 + 48) = sub_30C6BC(*(_DWORD *)(a1 + 48), v4[2] + v61, v62 - v61);
              sub_304170(a1);
              v62 = v4[5];
              v61 = v62;
              if ( v62 )
          ...
          if ( v46[11] )
          {
            ...
            if ( v68 > v61 )
            {
              v69 = sub_30C6BC(*(_DWORD *)(a1 + 48), v4[2] + v61, v68 - v61);
              v46 = (_DWORD *)v4[7];
              *(_DWORD *)(a1 + 48) = v69;
            }
          }
...
LABEL_70:
      ...
      if ( v47 )
      {
        ...
        if ( v50 + v52 > v51 )
        {
          do
          {
            ...
            if ( v55 )
              v56 = v54 > v50;
            if ( v56 )
              *(_DWORD *)(a1 + 48) = sub_30C6BC(*(_DWORD *)(a1 + 48), v4[2] + v50, v54 - v50);
            v4[8] += v53;
            sub_304170(a1);
            v50 = v4[5];
            if ( v50 )
        ...
        if ( v60 )
        {
          v172 = sub_30C6BC(*(_DWORD *)(a1 + 48), v4[2] + v50, v59 - v50);
          v46 = (_DWORD *)v4[7];
          *(_DWORD *)(a1 + 48) = v172;
        }
        v4[8] = 0;
...
LABEL_229:
                ...
                v133 = 0;
LABEL_230:
              sub_30B520(v4, v133, v4[27] - v199, 1);
              v200 = *v4;
              v4[23] = v4[27];
              sub_304170(v200);
              v18 = *(_DWORD *)(*v4 + 16) == 0;
      ...
      if ( v151 >= 0 )
        v152 += v151;
      sub_30B520(v4, v152, v131 - v151, 0);
      v153 = *v4;
      v4[23] = v4[27];
      sub_304170(v153);
    }
...
LABEL_195:
  ...
  if ( v132 >= 0 )
    goto LABEL_169;
LABEL_170:
  sub_30B520(v4, v133, v4[27] - v132, 0);
  v134 = *v4;
  v4[23] = v4[27];
  sub_304170(v134);
  v15 = *(_DWORD *)(*v4 + 16) != 0;
