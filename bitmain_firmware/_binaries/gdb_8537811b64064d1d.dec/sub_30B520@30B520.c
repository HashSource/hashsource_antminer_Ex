void *__fastcall sub_30B520(int a1, const void *a2, size_t a3, int a4)
{
  int v5; // r0
  char v6; // r9
...
LABEL_45:
      ...
      result = (void *)sub_30ACB4(a1, (int)&off_43012C, (int)&unk_4300B4);
      goto LABEL_48;
    }
    v19 = a1 + 4096;
    v11 = (_WORD *)(a1 + 2440);
LABEL_56:
    result = sub_30B304(a1, a2, a3, a4);
    goto LABEL_48;
  }
...
LABEL_38:
  ...
  v101 = a1 + 148;
  sub_30A068((_DWORD *)a1, (int *)(a1 + 2840));
  sub_30A068((_DWORD *)a1, (int *)(a1 + 2852));
  v11 = (_WORD *)(a1 + 2440);
  v12 = sub_30A5DC(a1, a1 + 148, *(_DWORD *)(a1 + 2844));
  v13 = (_DWORD *)sub_30A5DC(v12, a1 + 2440, *(_DWORD *)(a1 + 2856));
  sub_30A068(v13, (int *)(a1 + 2864));
  v14 = 15;
  v15 = 18;
  for ( i = (char *)&unk_4300B2; ; --i )
  {
...
LABEL_26:
  ...
  v62 = 16;
  v63 = 0;
  for ( j = &off_4300A0; ; j = (int (**)())((char *)j + 1) )
  {
    v66 = v59 <= 13;
    v67 = v59 + 3;
  ...
  v76 = sub_30A714(a1, v101, v103);
  v77 = sub_30A714(v76, a1 + 2440, v102);
  result = (void *)sub_30ACB4(v77, v101, a1 + 2440);
LABEL_48:
  v91 = a1;
  do
  {
