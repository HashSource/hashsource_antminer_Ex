int __fastcall sub_311874(__int64 a1, int a2, int a3)
{
  const char **v3; // r6
  unsigned int *v6; // r7
  unsigned int v7; // r1
  ...
  {
    LODWORD(a1) = a2;
    sub_30D348(a1, a3 - HIDWORD(a1));
  }
  sub_30D2C0((unsigned int)a2 | 0x100000000LL);
  **(_BYTE **)(a2 + 4) = 0;
  v7 = *v6;
  *v3 = (const char *)(a3 + 2);
  if ( (v7 & 0x1000) != 0 && *(_BYTE *)(a3 + 2) == 88 )
  {
    sub_30FA80(v6, v3, 0, (_DWORD *)a2);
    v7 = *v6;
  }
...
LABEL_10:
      if ( v10 == 95 && v8[1] == 95 )
      {
        ...
        if ( (word_4388C0[v14] & 8) != 0 && (word_4388C0[v8[3]] & 8) != 0 )
        {
          v15 = v8[4];
          if ( v8[4] )
          {
              ...
              if ( !v8[5] )
              {
                ...
                while ( ++v31 != 79 )
                {
                  ...
                  if ( strlen(v34) == 3 && *(unsigned __int8 *)v33 == v8[2] )
                  {
                    ...
                    {
                      *(_DWORD *)(a2 + 4) = v8;
                      sub_30D40C(a2, "operator");
                      v20 = off_432978[3 * v31 + 1];
                      if ( v20 )
                        goto LABEL_39;
                      goto LABEL_24;
                    }
...
LABEL_23:
      v37 = v13;
      if ( sub_30E850(v6, &v37, (unsigned int)&ptr) )
      {
        *(_DWORD *)(a2 + 4) = *(_DWORD *)a2;
        sub_30D40C(a2, "operator ");
        sub_30D554(__SPAIR64__(&ptr, a2), v39);
        if ( ptr )
        {
          free(ptr);
          v8 = *(unsigned __int8 **)a2;
  ...
  if ( v8[1] == 112 && strchr(&byte_471494, v8[2]) )
  {
    ...
    if ( v11 > 9 )
    {
      ...
      if ( !v23 )
      {
        ...
        *(_DWORD *)(a2 + 4) = v8;
        sub_30D40C(a2, "operator");
        v27 = off_432978[3 * v23 + 1];
        if ( v27 && *v27 )
          sub_30D40C(a2, v27);
        sub_30D40C(a2, (char *)&word_3FDE4C);
        v8 = *(unsigned __int8 **)a2;
        v9 = *(unsigned __int8 **)(a2 + 4);
        return v9 == v8 || v9 - v8 != 1 || *v8 != 46;
      }
