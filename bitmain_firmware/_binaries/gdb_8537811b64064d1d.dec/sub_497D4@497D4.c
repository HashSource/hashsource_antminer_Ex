unsigned __int64 __fastcall sub_497D4(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  _DWORD *v4; // r6
  bool v5; // zf
  int v6; // r3
  ...
  if ( v5 )
  {
    if ( (unsigned __int64)(*(_QWORD *)&dword_46B090 + 1LL) > 1 )
      sub_92078(&unk_4726AC);
    v4 = &unk_47260C;
    *(_QWORD *)&dword_46B090 = 0;
    dword_4726B8 = 0;
    sub_920A8(&unk_4726AC);
    sub_9206C(&unk_4726AC, "<osdata type=\"process groups\">\n", 31);
    v8 = opendir("/proc");
    if ( v8 )
    {
      ptr = (void *)sub_98394(0x2000);
      v32 = ptr;
      v33 = (char *)ptr + 0x2000;
      while ( 1 )
      {
      ...
      if ( ptr != v32 )
      {
        ...
        sub_4959C((int)ptr, (int *)v32, 2 * (31 - __clz(((_BYTE *)v32 - (_BYTE *)ptr) >> 4)));
        if ( v16 > 256 )
        {
          v23 = (__int64 *)(v14 + 256);
          sub_49F84(v14, v14 + 256, 0);
    ...
    sub_9206C(&unk_4726AC, "</osdata>\n", 11);
    dword_4726B8 = sub_920BC(&unk_4726AC);
