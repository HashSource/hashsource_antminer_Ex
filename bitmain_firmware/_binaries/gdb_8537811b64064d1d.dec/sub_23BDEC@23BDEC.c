void __fastcall sub_23BDEC(void **a1, char *a2, char **a3, int *a4, int *a5, int *a6)
{
  char *v7; // lr
  _BYTE *v8; // r12
  char *v11; // r8
...
LABEL_5:
  ...
  if ( v17 )
  {
    ...
    *(_DWORD *)v17 = v17 + 8;
    ...
    v58 = *a4;
    v60 = *a6;
    sub_235120(v17, v21, (int)v20 + (_DWORD)v19);
    v19 = ptr[0];
    *((_DWORD *)v17 + 7) = v22;
    *((_DWORD *)v17 + 6) = v58;
    *((_DWORD *)v17 + 8) = v60;
