int __fastcall sub_2297C4(int a1, int a2)
{
  _DWORD *v3; // r0
  int v4; // r0
  _DWORD *v5; // r0
  ...
  sub_2594D8(*v3, "-> %s->to_post_attach (...)\n", (const char *)dword_489C90);
  v4 = off_489CB0(&unk_489C8C, a2);
  v5 = (_DWORD *)sub_242FF0(v4);
  sub_2594D8(*v5, "<- %s->to_post_attach (", (const char *)dword_489C90);
