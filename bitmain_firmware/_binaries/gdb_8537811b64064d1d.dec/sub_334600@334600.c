int __fastcall sub_334600(wint_t *a1, const wchar_t *a2, unsigned int a3, int a4, unsigned int a5)
{
  wint_t v5; // r5
    ...
    while ( 2 )
    {
      ...
      switch ( v5 )
      {
        ...
        case '@':
          ...
          if ( v8[1] != 40 )
            goto LABEL_48;
          result = sub_333FE0((wchar_t *)v5, s, (unsigned int)a2, a3, a4, a5);
          if ( result == -1 )
            goto LABEL_48;
          return result;
        case '*':
          ...
          {
            result = sub_333FE0((wchar_t *)0x2A, s, (unsigned int)a2, a3, v24, a5);
            if ( result != -1 )
              return result;
          }
          ...
          if ( v30 )
          {
            ...
            do
            {
              if ( *v29 == 40 )
                ...
                v33 = 0;
              if ( !v33 || (v34 = sub_333D90(v29), v34 == v29) )
              {
                v34 = v29;
                if ( v28 == 63 )
                {
...
LABEL_220:
                ...
                if ( v47 > a2 )
                {
                  ...
                  do
                  {
                    v65 = sub_334600(v63, a2++, v26, v64, a5);
                    v64 = 0;
                    if ( !v65 )
                      return 0;
                  }
...
LABEL_144:
              ...
              while ( 1 )
              {
                ...
                if ( v28 == v51 )
                {
                  ...
                  if ( v24 )
                    v67 = 1;
                  if ( !sub_334600(v49, v50, v26, v67, a5) )
                    break;
                }
                v24 = 0;
                if ( v48 <= a2 )
            ...
            return sub_334600(v29, a2 + 1, v26, (a5 >> 2) & 1, a5) != 0;
          }
          else
          {
            if ( (a5 & 1) == 0 || (a5 & 8) != 0 )
        ...
        case '?':
          ...
          {
            result = sub_333FE0((wchar_t *)0x3F, s, (unsigned int)a2, a3, a4, a5);
            if ( result != -1 )
              return result;
          }
