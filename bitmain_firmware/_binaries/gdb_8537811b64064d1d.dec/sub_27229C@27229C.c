_DWORD *__fastcall sub_27229C(_DWORD *a1, int **a2, int a3)
{
  int *v3; // r4
  int *v6; // r3
  int v7; // r2
  ...
  *a1 = 0;
  ...
  if ( v57 )
  {
    ...
    sub_26FD94((int)&s1, v8);
    sub_26FD94((int)&s2, v68);
    if ( (void *)n == v88 && (!n || !memcmp(s1, s2, n)) )
    {
      ...
      *v71 = v72;
      v78 = 0;
      sub_270234(&v78, v68, 0, 1);
      v57 = 0;
    }
    else
    {
      sub_33B4B4(v68 + 12, v8 + 12);
      v69 = v8[37];
      v68[36] = v8[36];
      v68[37] = v69;
      v74 = 0;
      sub_270234(&v74, v8, 0, 1);
      sub_26FA98(v68);
      v8 = v68;
      *a2 = v68;
    }
  ...
  ((void (__fastcall *)(int *))loc_23FF48)(&v99);
  v58 = v8[26];
  ...
  {
LABEL_104:
    if ( !sub_26F9EC((int)(v8 + 26)) )
      goto LABEL_102;
LABEL_105:
    v62 = sub_92E50();
    v60 = sub_14CD64(*(int **)v8[26]);
    sub_92E68((int)v62);
    ((void (__fastcall *)(int *))loc_23FCB4)(&v99);
    if ( v3[20]
      && v60
      && (v63 = sub_26BC98(v60), v3[21] >= 0)
      && *(_DWORD *)(*(_DWORD *)(v3[26] + 36) + 32)
      && (v64 = sub_26FA5C((int)v3, v60, v63)) != 0 )
    {
      ptr = 0;
      sub_270234(&ptr, v3, 1, 1);
      v61 = *a2;
      v57 = v64;
      v3[21] = -1;
      v3[37] = -1;
...
LABEL_102:
  ...
  v61 = *a2;
LABEL_112:
  v65 = sub_2704F8(v61, v60);
  v66 = (int)*a2;
  if ( !v65 )
    v65 = v57;
  v91 = v65;
  v90 = v66;
  if ( sub_270858(v66, v60, v65) )
    v93 = 1;
  if ( v60 )
  {
    v95 = 1;
    if ( v94 != 1 )
    {
      ((void (__fastcall *)(void **, int *))loc_2733B4)(&v75, &v90);
      if ( v96 )
        sub_339E8C(v96);
LABEL_6:
      v9 = v75;
          ...
          *(v10 - 1) = v21;
          ...
          if ( !v95 )
          {
            ...
            if ( *(int *)(v23 + 84) >= 0
              ...
              && (v27 = sub_26FA5C(v23, v24, v25)) != 0 )
            {
              v73 = 0;
              sub_270234(&v73, (_DWORD *)v23, 1, 1);
              *(_DWORD *)(v23 + 76) = v26;
              *(_DWORD *)(v23 + 84) = -1;
              *(_DWORD *)(v23 + 148) = -1;
              *(_DWORD *)(v23 + 144) = -1;
...
LABEL_33:
        ...
        if ( *(_BYTE *)v28 )
        {
          v36 = ((int (__fastcall *)(int, void **, void **, void **, void **, int *, int, _DWORD, _DWORD))loc_271B10)(
                  v23,
                  &v78,
                  &ptr,
                  &s2,
...
LABEL_46:
            ...
            if ( v93 || v91 )
              ((void (__fastcall *)(_DWORD *, int *))loc_2733B4)(a1, &v90);
            goto LABEL_33;
          }
          if ( (_BYTE)v74 || s2 != v88 )
          {
          ...
          if ( v40 - 1 >= 0 )
          {
            ...
            while ( 1 )
            {
              ...
              v100 = 1;
              v104 = 1;
              ((void (__fastcall *)(void **, int *))loc_2733B4)(&v75, &v99);
              if ( v105 )
                sub_339E8C(v105);
              --v41;
              v42 -= 4;
...
LABEL_75:
          ...
          if ( !v93 && !v92 )
            goto LABEL_25;
               ...
               && !*(_DWORD *)(v28 + 16)
               && ((((void (__fastcall *)(int, _DWORD, _DWORD, _DWORD, _DWORD, int *, _DWORD, _DWORD, _DWORD))loc_271B10)(
                      v23,
                      0,
                      0,
                      0,
