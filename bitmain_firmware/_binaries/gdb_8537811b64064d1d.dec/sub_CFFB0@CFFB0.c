int __fastcall sub_CFFB0(int a1, int a2)
{
  int v4; // r0
  int v5; // r3
  int v6; // r8
  ...
  v4 = sub_CFD68(*(_DWORD *)a2, *(_DWORD *)(a2 + 4), *(_DWORD *)(a2 + 8), *(_DWORD *)(a2 + 12));
  v5 = *(_DWORD *)(a1 + 12);
  v6 = v4;
  if ( !v4 )
    v6 = *(_DWORD *)(a1 + 88);
  ...
  *(_DWORD *)(v14 + 236) = *(_DWORD *)(a2 + 8);
  ...
  ((void (__fastcall *)(int, int))loc_CA0F8)(v14, v19);
  ...
  if ( v21 )
    return v14;
  v27 = dword_487D2C;
  ((void (__fastcall *)(_BYTE *))loc_23FF48)(v28);
  sub_1CD68C(*(_DWORD *)(v14 + 48));
  v23 = sub_CFEFC(*(_DWORD *)(v14 + 44), *(_DWORD *)(v14 + 52));
  ((void (__fastcall *)(_BYTE *))loc_23FCB4)(v28);
  ((void (__fastcall *)(int))loc_1CD2B8)(v27);
  result = v14;
  if ( v23 )
    *(_BYTE *)(v14 + 40) = 1;
  return result;
