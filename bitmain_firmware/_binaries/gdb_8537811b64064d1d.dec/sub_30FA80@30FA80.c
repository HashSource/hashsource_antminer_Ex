void __fastcall sub_30FA80(unsigned int *a1, const char **a2, signed int a3, _DWORD *a4)
{
  unsigned int v5; // r4
  const char **v6; // r9
  const char *v8; // r10
...
LABEL_46:
          ...
          v46 = (void *)*a1;
          *a1 |= 1u;
          sub_30D40C((int)a4, (char *)&word_364FCC);
          if ( v10 > v50 )
          {
            v48 = v6;
            v30 = v50;
            while ( 1 )
            {
              ...
              else
              {
                if ( v33 != 88 )
                {
                  if ( !sub_30E850(a1, &v50, (unsigned int)&ptr) )
                    goto LABEL_90;
                  if ( v30 == v50 )
                  {
                    *a1 = (unsigned int)v46;
                ...
                v50 = v30 + 1;
                if ( !sub_30E850(a1, &v50, (unsigned int)&v54) )
                  goto LABEL_90;
                sub_30D40C((int)&ptr, "(");
                LODWORD(v31) = &ptr;
                HIDWORD(v31) = &v54;
...
LABEL_90:
              ...
              v50 = v32;
              if ( !sub_30D490(&v50, (int)&ptr) )
                goto LABEL_90;
LABEL_59:
              sub_30D554(__SPAIR64__(&ptr, (unsigned int)a4), v52);
              sub_30D40C((int)a4, (char *)&word_3D7D68);
              v30 = v50;
              if ( v50 >= v10 )
              {
                v42 = ptr;
...
LABEL_13:
    ...
    else
    {
      ...
      if ( a3 )
      {
        sub_30D348(__SPAIR64__((unsigned int)v18, (unsigned int)a4), a3);
        v18 = (unsigned __int8 *)*v6;
      }
    }
LABEL_20:
  ...
  if ( v19 && (v20 = v19 - v8, v19 - v8 < a3) )
  {
    if ( v20 )
    {
      sub_30D348(__SPAIR64__((unsigned int)v8, (unsigned int)a4), v20);
      v8 = *v6;
      v5 = *a1;
    }
  }
  ...
  {
    sub_30D348(__SPAIR64__((unsigned int)v8, (unsigned int)a4), a3);
    v8 = *v6;
    v5 = *a1;
  }
  v21 = a1[13];
  ...
  *a1 = v5 | 1;
  ...
  while ( 2 )
  {
    ...
    switch ( **v6 )
    {
      case 'A':
        *v6 = v22 + 1;
        v37 = sub_30D034((unsigned __int8 **)v6);
        if ( v37 > 0 && v37 <= (int)strlen(*v6) )
        {
          ...
          v38 = *a1;
          *((_BYTE *)v47 + v37) = 0;
          v39 = sub_30DFD4((const char *)v47, v38);
          v40 = v39;
          if ( v39 )
          {
            if ( *v39 )
      ...
      case 'U':
        ...
        *v6 = v22 + 1;
        ...
        {
          case 'N':
            sub_30D40C((int)&ptr, (char *)&word_3C148C);
            v26 = *v6;
            break;
          case 'P':
            break;
          case 'M':
            sub_30D40C((int)&ptr, "-2147483648");
            ++*v6;
            goto LABEL_32;
          default:
            goto LABEL_40;
        ...
        *v6 = v26 + 1;
        ...
        if ( (word_4388C0[v35] & 4) != 0 )
        {
          do
          {
            byte_48FEA8 = v35;
            if ( v35 )
              sub_30D40C((int)&ptr, &byte_48FEA8);
            v36 = *v6 + 1;
            *v6 = v36;
            v35 = *(unsigned __int8 *)v36;
          }
          while ( (word_4388C0[v35] & 4) != 0 );
          if ( v23 == 85 )
            sub_30D40C((int)&ptr, "U");
          goto LABEL_32;
        }
LABEL_40:
        sub_30D40C((int)a4, ">");
      ...
      case 'T':
        *v6 = v22 + 1;
        if ( sub_30E850(a1, (unsigned __int8 **)v6, (unsigned int)&ptr) )
        {
LABEL_32:
          sub_30D554(__SPAIR64__(&ptr, (unsigned int)a4), v52);
