int __fastcall sub_2FD438(int a1, int a2, int (__fastcall *a3)(int, int, char *, _DWORD, int *))
{
  size_t v3; // r0
  int v6; // r3
  _DWORD *v7; // r5
    ...
    while ( 1 )
    {
      ...
      do
      {
        ...
        if ( v32 && *((_QWORD *)v7 + 1) == v24 )
          goto LABEL_25;
        v15 = sub_2FC948(*(_DWORD **)(a2 + 28), (const char *)*v7, 0, 0, 1);
        v16 = v15;
        if ( v15 )
        {
        ...
        else
        {
          ...
          if ( strncmp((const char *)*v7, "__imp_", 6u) )
            goto LABEL_15;
          v18 = sub_2FC948(*(_DWORD **)(a2 + 28), v17 + 6, 0, 0, 1);
          v16 = v18;
          if ( !v18 )
            goto LABEL_15;
...
LABEL_25:
        ...
        v11 = *((_QWORD *)v7 + 1);
        if ( v11 != v24
          && (v25 = v10, v22 = sub_2A39C4(a1, v10, v11), (v28 = v22) == 0 || !sub_2AA894(v22, v25, v23, v22))
