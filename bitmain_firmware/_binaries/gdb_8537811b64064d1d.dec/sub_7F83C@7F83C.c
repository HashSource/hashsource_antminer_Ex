int __fastcall sub_7F83C(int a1, unsigned __int8 *a2, int a3, int a4, int a5)
{
  ...
  if ( a4 )
  {
    ...
    *v7 = 0;
    ...
    if ( v17 != 105 )
    {
      ...
      {
        --v13;
        *(_DWORD *)(a5 + 16) = *(_DWORD *)(sub_103A64(v18) + 48);
      }
      else
      {
        if ( v17 != 108 )
        {
LABEL_12:
          *(_DWORD *)(a5 + 16) = *(_DWORD *)(sub_103A64(v18) + 52);
          goto LABEL_13;
        }
        --v13;
        *(_DWORD *)(a5 + 16) = *(_DWORD *)(sub_103A64(v18) + 56);
      }
LABEL_13:
      if ( sub_1C450C(v42, v13) )
        return 264;
      else
        return 268;
    }
    if ( v13 != 1 )
    {
      ...
      {
        v13 -= 2;
        *(_DWORD *)(a5 + 16) = *(_DWORD *)(sub_103A64(v18) + 60);
        goto LABEL_13;
      }
      if ( v37 == 108 )
      {
        v13 -= 2;
        *(_DWORD *)(a5 + 16) = *(_DWORD *)(sub_103A64(v18) + 68);
        goto LABEL_13;
      }
    }
    v13 = v14 - 1;
    *(_DWORD *)(a5 + 16) = *(_DWORD *)(sub_103A64(v18) + 64);
    goto LABEL_13;
  }
  if ( *a2 != 48 )
    goto LABEL_17;
...
LABEL_21:
    ...
    if ( v27 )
    {
      LODWORD(v24) = sub_347F9C(v6 * v21, (__PAIR64__(HIDWORD(v46), v6) * v21) >> 32, v46, HIDWORD(v46));
...
LABEL_25:
  ...
  if ( v45 || HIDWORD(v21) )
  {
    v32 = *(_DWORD *)(sub_103A64(v31) + 32);
    v33 = *(_DWORD *)(sub_103A64(*(_DWORD *)(*(_DWORD *)(v43 + 4) + 4)) + 36);
    v34 = 0;
    v35 = 0x80000000;
    goto LABEL_57;
  }
  v32 = *(_DWORD *)(sub_103A64(v31) + 24);
  if ( v6 == 10 )
