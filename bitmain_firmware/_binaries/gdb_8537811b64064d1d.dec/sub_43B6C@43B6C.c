        ...
        __int64 *a8)
{
  ...
  {
    case 7:
      return ((int (__fastcall *)(int, int, const char *, char *, const void *))loc_BC070)(a1, 7, a3, a4, a5);
    case 15:
      v20 = ((__int64 (__fastcall *)(const char *, char *, _DWORD, _DWORD, _DWORD, _DWORD))loc_49348)(
              a3,
              a4,
              a6,
              HIDWORD(a6),
      ...
      *a8 = v20;
      return v20 != 0;
    case 1:
      return sub_432E0(a3, a4, a5, SHIDWORD(a7), a6, a7, a8);
    case 2:
      v14 = sub_16F67C(a1);
      v15 = ((int (__fastcall *)(int))loc_166694)(v14);
      if ( v15 <= 0x3F )
      ...
      if ( a7 < 12 )
        return ((int (__fastcall *)(int, int, const char *, char *, const void *, int, _DWORD, _DWORD, _DWORD, _DWORD, __int64 *))off_472194)(
                 ...
                 HIDWORD(a7),
                 a8);
      v16 = sub_98F90(&dword_4878EC);
      sub_93198(v24, 64, "/proc/%ld/mem", v16);
      v17 = sub_967DC(v24, (a4 == 0) | 0x20000, 0);
      v18 = v17;
      if ( v17 == -1 )
        return ((int (__fastcall *)(int, int, const char *, char *, const void *, int, _DWORD, _DWORD, _DWORD, _DWORD, __int64 *))off_472194)(
                 a1,
