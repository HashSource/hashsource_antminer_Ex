int __fastcall sub_110B28(int a1, int *a2)
{
  __int64 v4; // r0
  int v5; // r7
  int v6; // r5
  ...
  v7 = ((int (__fastcall *)(int))loc_166F70)(v5);
  v8 = *a2;
  if ( *a2 )
    return v8;
  v10 = v6 + v7;
  v8 = sub_15D2A4(72);
  *(_DWORD *)(v8 + 12) = sub_15D2A4(24 * v10);
  *a2 = v8;
  v99 = sub_15DE3C(a1);
  v11 = (unsigned __int8 *)((int (__fastcall *)(int *, int))loc_1103B0)(&v99, v8 + 44);
  if ( !v11 )
  {
    v83 = sub_94728(
            (int)"dwarf2-frame.c",
  ...
  sub_10FC34((int)&src, v99, *(_QWORD **)v11);
  *(_DWORD *)(v8 + 40) = *(_DWORD *)(*(_DWORD *)v11 + 56);
  sub_10EA74((int)&src, (int)v11);
  v12 = *(char **)(*(_DWORD *)v11 + 40);
  v13 = *(_DWORD *)(*(_DWORD *)v11 + 44);
  v14 = sub_15DE3C(a1);
  sub_10EDC0(v11, v12, v13, v5, v14, &src);
  v15 = v101;
  v85 = v102;
  v16 = v105;
  v97 = v107;
  ...
  if ( v21 )
    free(v21);
  v22 = sub_15DF80(a1, &v98);
  v23 = *((_DWORD *)v11 + 4);
  v24 = (char *)*((_DWORD *)v11 + 3);
  if ( v22 )
  {
    v24 = (char *)sub_10EDC0(v11, v24, v23, v5, v98, &src);
    if ( v105 == 1 )
    {
      v73 = sub_115FE0(v5, v103);
      v50 = v73 == ((int (__fastcall *)(int))loc_167318)(v5);
      v23 = *((_DWORD *)v11 + 4);
      if ( v50 )
      {
        v74 = v102;
  ...
  v25 = sub_15DE3C(a1);
  sub_10EDC0(v11, v24, v23, v5, v25, &src);
  v26 = sub_92E50();
  if ( v105 != 1 )
  {
    if ( v105 == 2 )
    {
      *(_DWORD *)v8 = sub_10EC70(
                        v106,
                        *(_DWORD *)(v8 + 40),
                        v103,
                        v104,
    ...
    v80 = sub_94728((int)"dwarf2-frame.c", 1061, "Unknown CFA rule.");
    v81 = v80;
    LODWORD(v80) = v26;
    v82 = HIDWORD(v80);
    sub_92E68(v80);
...
LABEL_113:
    ...
    v84 = (int *)sub_339EA0(v83);
    if ( v84[1] != 9 )
      sub_92F44(*v84, v84[1], v84[2]);
    *(_DWORD *)(v8 + 4) = 1;
    sub_339F20(v84);
    goto LABEL_39;
  }
  v53 = sub_10DCD8(a1, v103);
  v54 = v118;
  v55 = v102;
  *(_DWORD *)v8 = v53;
  if ( v54 )
...
LABEL_12:
  ...
  for ( i = 0; i != v10; ++i )
  {
    ...
    v29 = (void (__fastcall **)(int, int, int, int))((int (__fastcall *)(int, int))loc_16ECB0)(v5, dword_4872C4);
    (*v29)(v5, i, v28, a1);
  }
  if ( v101 <= 0 )
  {
...
LABEL_20:
    ...
    if ( !v33[4] )
    {
      ...
      {
        v57 = (const char *)((int (__fastcall *)(int, int))loc_1677E8)(v5, v32);
        v58 = (const char *)sub_25ACB4(v5, v108);
        sub_F43DC(&off_46D334, "incomplete CFI data; unspecified registers (e.g., %s) at %s", v57, v58);
      }
      goto LABEL_20;
    }
    v35 = *v33;
