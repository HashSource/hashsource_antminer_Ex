int __fastcall sub_14BE48(int *a1, int a2, _DWORD *a3, _DWORD *a4, int a5)
{
  int result; // r0
  int i; // r4
  int v8; // r5
  ...
  if ( !v10 )
  {
    ...
    if ( (v15 & 0x1F) != 0xE )
    {
      ...
      while ( 1 )
      {
        result = sub_13CA48((int)&v86, a4, &v84);
        if ( !(_BYTE)v87 )
          break;
        result = v84;
        v19 = *(_BYTE *)(v84 + 24);
        ...
        *v20 = 0;
        ...
        v75 = a1[1];
        v32 = (unsigned __int64)sub_34769C(v29, v75) >> 32;
        ...
        if ( v33 )
        {
          ...
          while ( (const char *)v29 != v36 || strcmp(s1, v34[1]) )
          {
            if ( *v34 )
            {
              ...
              v33 = (const char ***)v34;
              v34 = (const char **)*v34;
              if ( v32 == (unsigned __int64)sub_34769C(v36, v35) >> 32 )
                continue;
            }
            v11 = v73;
            v22 = v76;
          ...
          if ( !v37 )
            goto LABEL_58;
          sub_1490B0((int)(v76 + 2), v76[4]);
          sub_339E8C(v76);
        }
        else
        {
LABEL_58:
          v37 = sub_14B614(a1, v32, v29, v22);
        }
        sub_1490B0((int)&v86, v88);
        v86 = v78;
        v87 = a5;
        LOBYTE(v88) = 0;
        v89 = 0;
        result = sub_149278((int)v85, v37 + 2, &v86);
        v16 = v11-- != 0;
        if ( !v16 )
          goto LABEL_31;
LABEL_11:
...
LABEL_31:
  ...
  if ( !v10 )
  {
    ...
    while ( 1 )
    {
      result = sub_13CA48((int)&v86, a4, &v83);
      if ( !(_BYTE)v87 )
        break;
      result = v83;
      v47 = *(_BYTE *)(v83 + 24);
      ...
      *v48 = 0;
      ...
      v81 = a1[1];
      v60 = (unsigned __int64)sub_34769C(v57, v81) >> 32;
      ...
      if ( v61 )
      {
        ...
        while ( (const char *)v57 != v63 || strcmp(s1a, v62[1]) )
        {
          if ( *v62 )
          {
            ...
            v61 = (const char ***)v62;
            v62 = (const char **)*v62;
            if ( v60 == (unsigned __int64)sub_34769C(v63, v81) >> 32 )
              continue;
          }
          v41 = v74;
          v50 = v77;
        ...
        if ( !v64 )
          goto LABEL_63;
        sub_1490B0((int)(v77 + 2), v77[4]);
        sub_339E8C(v77);
      }
      else
      {
LABEL_63:
        v64 = sub_14B614(a1, v60, v57, v50);
      }
      sub_1490B0((int)&v86, v88);
      LOBYTE(v88) = 1;
      v86 = v79;
      v87 = a5;
      v89 = 0;
      result = sub_149278((int)v85, v64 + 2, &v86);
      v16 = v41-- != 0;
      if ( !v16 )
        return result;
LABEL_36:
