int __fastcall sub_13AA00(int a1, const char *a2, int *a3, int a4)
{
  __int64 v8; // r0
  int v9; // r5
  int *v10; // r3
  ...
  else if ( sub_11E024(a3) )
  {
    return 0;
  }
  if ( (((int (__fastcall *)(int *))loc_11E7D0)(a3) & 0x100) == 0 )
    return 0;
  if ( !*((_BYTE *)a3 + 16) )
    ((void (__fastcall *)(int, int *))loc_11FFF8)(a1, a3);
  v8 = sub_1B7278(a1);
  *(_DWORD *)(a4 + 20) = ((int (__fastcall *)(_DWORD, _DWORD))loc_165BE0)(v8, HIDWORD(v8));
  v9 = a3[1];
  if ( *((_BYTE *)a3 + 17) )
  {
    v10 = (int *)*a3;
    if ( *(_BYTE *)(*a3 + 17) )
    {
      v88 = ((__int64 (*)(void))loc_11E0B8)();
      return sub_13B0D0(v88, HIDWORD(v88));
    }
  }
  else
  {
  ...
  v11 = *(_DWORD *)(*v10 + 148);
  LODWORD(v12) = sub_11E040(v11 + 4, a3[1], &v93);
  v13 = v93;
  v14 = (_BYTE *)(v9 + v93);
  if ( v93 == 4 )
    v15 = 4;
  ...
  *(_BYTE *)(a4 + 24) = v16;
  ...
  if ( v19 == 5 )
  {
    ...
    if ( v20 )
    {
      sub_946D8("Section .debug_names in %s has unsupported padding %d, ignoring .debug_names.", a2, v20);
      return 0;
    }
    else
    {
      ...
      *(_DWORD *)(a4 + 32) = v23;
      ...
      if ( v25 )
      {
        sub_946D8("Section .debug_names in %s has unsupported %lu foreign TUs, ignoring .debug_names.", a2, v25);
        return 0;
      }
...
LABEL_23:
      ...
      if ( v43 )
      {
        ...
        *((_QWORD *)v47 + 2) = 0;
        v47[8] = 0;
        *((_QWORD *)v47 + 1) = v43;
        v49 = (unsigned __int64)sub_34769C(v43, v48) >> 32;
        v50 = sub_12437C(v90 + 18, v49, (__int64 *)v47 + 1);
        if ( v50 && *v50 )
        {
          sub_124334(v47);
          v51 = sub_988A8(v43, SHIDWORD(v43));
          sub_946D8("Section .debug_names in %s has duplicate index %s, ignoring .debug_names.", a2, v51);
          return 0;
        }
        v52 = sub_14A114(v90 + 18, v49, v43, v47);
        v53 = *v41;
        v40 = v41 + 1;
        v54 = v52;
        v55 = v53 & 0x7F;
...
LABEL_46:
  ...
  {
    sub_946D8("Section .debug_names in %s has unsupported version %d, ignoring .debug_names.", a2, v19);
    return 0;
  }
}
