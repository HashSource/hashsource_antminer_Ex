char *__fastcall sub_127FE0(const char ***a1, char **a2, _BYTE *a3, _DWORD *a4, int a5)
{
  char *s; // r5
  int v7; // lr
  char v8; // t1
  ...
  if ( v37 )
  {
    ...
    if ( !v13 )
LABEL_7:
      sub_94708("Dwarf Error: could not find abbrev number %d [in module %s]", v37, **a1);
    ...
    *((_DWORD *)v18 + 1) = v10;
    if ( v24 )
    {
      ...
      do
      {
        ...
        v26 += 8;
        *((_WORD *)v31 + 12) = v32;
        s = sub_127384(a1, v30, v34, v33, *(_QWORD *)(v33 + 8), s);
      }
