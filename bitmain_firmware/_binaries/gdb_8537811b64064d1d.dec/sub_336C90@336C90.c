int __fastcall sub_336C90(unsigned __int8 *a1, char *s, int a3, int (__fastcall *a4)(char *), int *a5)
{
  size_t v8; // r0
  int v9; // r1
  DIR *v10; // r7
...
LABEL_19:
      ...
      if ( v22 )
      {
        ...
        if ( sub_336214((char *)a1, (char *)(v19 + 19), v55) )
          goto LABEL_17;
        v23 = v56 == 10;
        if ( v56 != 10 )
          v23 = v56 == 0;
...
LABEL_27:
      ...
      else
      {
        ...
        if ( v21 != 10 )
          v40 = v21 == 0;
        if ( !v40 || sub_336214((char *)a1, (char *)(v19 + 19), v55) )
          goto LABEL_17;
      }
      if ( (a3 & 0x200) != 0 )
        v41 = sub_336AFC(s, n, v20, (int (__fastcall **)(_BYTE *, _BYTE *))a5 + 8);
      else
        v41 = sub_349254(v62, v20, v63, 0) == 0;
      if ( v41 )
        goto LABEL_27;
      if ( (a3 & 0x200) == 0 )
        goto LABEL_18;
