int __fastcall sub_CB370(int result, unsigned int *a2, int a3, int a4)
{
  int v5; // r2
  char *v6; // r5
  unsigned int *v7; // r6
...
LABEL_43:
    ...
    do
    {
      ...
      v6 -= 4;
      *(_DWORD *)v6 = *v7;
      result = sub_CB0AC((int)v7, 0, (v6 - (char *)v7) >> 2, v37);
    }
    while ( v6 - (char *)v7 > 4 );
    return result;
  }
