int __fastcall sub_33998C(char a1, int a2, int a3)
{
  int v4; // r7
  char *v6; // r5
  char *v7; // r4
  ...
  if ( (a1 & 3) == 1 )
  {
    if ( (a1 & 8) != 0 )
    {
      v57 = a2;
      v53 = a1 & 8 | 2;
      sub_348608(a3, 0, 12, 0, &v57);
      goto LABEL_13;
    }
    v25 = *(_DWORD *)(a2 + 32);
    sub_3485B4(a3, 0, 13, 0, &v62);
    if ( v25 == v62 )
    {
      v57 = a2;
      sub_348608(v4, 0, 12, 0, &v57);
      v52 = *(_DWORD *)(a2 + 48);
      if ( v52 )
      {
        v26 = *(_DWORD *)(a2 + 40);
...
LABEL_4:
  ...
  sub_348608(v4, 0, 12, 0, &v57);
LABEL_13:
  v54 = (unsigned __int8 *)sub_3491C8(v4);
  if ( !v54 )
    goto LABEL_6;
  v6 = sub_339904(v4, v54, (int)&v62);
  if ( v67 == 255 )
    v7 = 0;
  else
    v7 = (char *)sub_3398CC(v67, v4);
  v64 = v7;
  sub_3485B4(v4, 0, 15, 0, &v61);
  v8 = (v61 & 0xFFFFFFFE) - 1;
...
LABEL_47:
  ...
  while ( 1 )
  {
    ...
    v10 = 0;
    if ( v68 != 255 )
      v10 = (char *)sub_3398CC(v68, 0);
    v11 = sub_339808(v9, v10, v6, (unsigned int *)&v59);
    v12 = v68;
    v13 = (char *)v11;
    v14 = 0;
    if ( v68 != 255 )
      v14 = (char *)sub_3398CC(v68, 0);
    v15 = sub_339808(v12, v14, v13, &v60);
    v16 = v68;
    v17 = (char *)v15;
    v18 = 0;
    if ( v68 != 255 )
      v18 = (char *)sub_3398CC(v68, 0);
    v19 = v16;
    v20 = 0;
    v21 = sub_339808(v19, v18, v17, &v61);
    v22 = 0;
    v6 = (char *)v21;
    do
    {
...
LABEL_73:
  ...
  v44 = 0;
LABEL_76:
  sub_339808(v67, v64, (char *)(v65 + v44), &v60);
...
LABEL_40:
  ...
  if ( v26 < 0 )
  {
    sub_339904(v4, v54, (int)&v62);
    if ( v67 == 255 )
      v45 = 0;
    else
      v45 = (char *)sub_3398CC(v67, v4);
    v64 = v45;
...
LABEL_42:
  v58 = a2;
  sub_348608(v4, 0, 0, 0, &v58);
  v59 = v20;
  sub_348608(v4, 0, 1, 0, &v59);
  sub_3485B4(v4, 0, 15, 0, &v60);
  v60 = v60 & 1 | v52;
  sub_348608(v4, 0, 15, 0, &v60);
  if ( v27 == 2 )
