int __fastcall sub_17905C(_DWORD *a1)
{
  int v1; // r0
  char *v2; // r1
  int v3; // r2
  ...
  if ( (unsigned __int8)(v3 - 3) > 1u )
  {
    ...
    return sub_1792C0(v21, HIDWORD(v21));
  }
  if ( v3 == 4 )
    return 0;
  v5 = v1;
  ...
  {
    v6 = *((_DWORD *)v2 + 7);
    if ( (__int16 *)v6 != &word_3B4A54 && (*(_BYTE *)(v6 + 8) & 3) != 0 )
  ...
  while ( 1 )
  {
    ...
    if ( v10 != 128 || (v12 = *(__int16 **)(v9 + 28), v12 == &word_3B4A54) )
    {
      if ( v8 >= 0 )
        break;
      goto LABEL_14;
