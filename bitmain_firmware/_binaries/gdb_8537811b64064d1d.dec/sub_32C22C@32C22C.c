int __fastcall sub_32C22C(int a1, int a2, int a3, int *a4)
{
  ...
  if ( v11 && (*(_BYTE *)(a1 + 8) & 0x40) == 0 )
  {
    if ( v11 > 0 )
    {
      ...
      if ( *a4 != v11 )
      {
        ...
        if ( v14 < v16 )
        {
          sub_327D5C((int *)a1, v16 - v14, v14);
          v15 = *(_DWORD *)a1;
        }
        if ( v15 > 1 || *(_WORD *)(a1 + 10) )
          *(_DWORD *)a1 = sub_328484((char *)(a1 + 10), v15, v11);
        goto LABEL_4;
      }
LABEL_24:
      *(_WORD *)(a1 + 10) = 0;
    ...
    if ( !v18 )
      v13 = HIDWORD(v4) >> 1;
    sub_328658((_WORD *)(a1 + 10), v13, -v11);
    *(_DWORD *)a1 += v11;
  }
LABEL_4:
  v8 = v20;
