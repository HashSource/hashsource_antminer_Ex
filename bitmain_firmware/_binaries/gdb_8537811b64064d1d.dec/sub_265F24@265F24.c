void __fastcall sub_265F24(wint_t a1, int a2, int a3, int a4, unsigned int a5, struct obstack *a6, int c, int *a8)
{
  int v9; // r9
  size_t v10; // r0
  char *v11; // r2
...
LABEL_23:
      ...
      break;
    default:
      if ( !sub_265E64(a1) || v9 && (iswdigit(a1) || a1 - 56 <= 1) )
      {
        if ( a4 <= a3 )
        {
          for ( i = a4; ; i += a4 )
          {
            LODWORD(v37) = sub_15C278((unsigned __int8 *)(a2 - a4 + i), a4, a5);
            if ( v37 > 0x1FF )
              sub_93198((char *)v42, 0x1Eu, "\\x%lx", (_DWORD)v37);
            else
              sub_93198((char *)v42, 0x1Eu, "\\%.3o", (_DWORD)v37);
            sub_265EB0(v42, (int)a6);
            if ( a4 + i > a3 )
              break;
          }
        }
