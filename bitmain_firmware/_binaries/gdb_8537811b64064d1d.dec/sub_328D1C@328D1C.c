unsigned int __fastcall sub_328D1C(unsigned __int16 *a1, int a2, unsigned __int16 *a3, int a4, int a5)
{
  ...
  v28 = sub_3275D8(a1, a2, a3, a4, a5 / 3, (signed int)v27, -dword_438D28[a5 % 3]);
  if ( v28 >= 0 )
  {
    v30 = *v27;
