void __fastcall sub_2EF990(int a1, int a2)
{
  int v2; // r3
  char *v5; // r2
  int v6; // r10
  ...
  if ( v2 )
  {
    v5 = (char *)sub_2AB390(v2 + 1);
    ptr = v5;
    if ( v5 )
    {
      if ( sub_2ADF04(a1, *(_DWORD **)(a2 + 44), v5, *(_DWORD *)(a2 + 24), 0, *(_DWORD *)(a2 + 24)) )
      {
        ptr[*(_DWORD *)(a2 + 24)] = 0;
        if ( *ptr == 65 )
        {
          ...
          if ( v6 != 1 )
          {
            ...
            if ( (unsigned int)(ptr + 1) < v7 - 4 )
            {
              ...
              while ( 1 )
              {
                ...
                if ( v12 <= 4 )
                {
                  sub_2A6A84("%B: error: attribute section length too small: %ld", a1, v12);
                  break;
                }
                v13 = v12 - 4;
                ...
                if ( v20 )
                {
                  while ( 1 )
                  {
                    v22 = sub_2ABC4C(a1, v18, v37, 0, v7);
                    v23 = &v18[v37[0]];
                    v8 = v23 + 4;
                          ...
                          (unsigned int)v8 < v25) )
                    {
                      do
                      {
                        v26 = sub_2ABC4C(a1, v18, v37, 0, v25);
                        v27 = &v18[v37[0]];
                        v28 = sub_2EF684(a1, v17, v26) & 3;
                        switch ( v28 )
                        {
                          case 2:
                            sub_2EF740(a1, v17, v26, v27);
                            v18 = &v27[strlen(v27) + 1];
                            break;
                          case 3:
                            v31 = sub_2ABC4C(a1, v27, v37, 0, v25);
                            s = &v27[v37[0]];
                            sub_2EF7AC(a1, v17, v26, v31, s);
                            v18 = &s[strlen(s) + 1];
                            break;
                          case 1:
                            v30 = sub_2ABC4C(a1, v27, v37, 0, v25);
                            v18 = &v27[v37[0]];
                            sub_2EF6E4(a1, v17, v26, v30);
                            break;
                          default:
                            sub_2A6C18((int)"elf-attrs.c", 551, (int)"_bfd_elf_parse_attributes");
                        }
                      }
