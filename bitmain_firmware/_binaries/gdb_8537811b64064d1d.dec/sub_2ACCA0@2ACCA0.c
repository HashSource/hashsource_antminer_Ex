size_t *__fastcall sub_2ACCA0(int a1)
{
  size_t *v2; // r4
  int v3; // r0
  int v4; // r6
  ...
  if ( !a1 )
    sub_2A6BE4("opncls.c", 1821);
  v2 = *(size_t **)(a1 + 172);
  if ( v2 && *v2 )
    return v2;
  v3 = sub_2AD7D4(a1, ".note.gnu.build-id");
  v4 = v3;
  if ( !v3 )
  {
    v2 = 0;
  ...
  v2 = (size_t *)sub_2AE004(a1, v3, &ptr);
  if ( !v2 )
  {
    if ( !ptr )
      return 0;
LABEL_22:
  ...
  if ( v8 <= 0xFFFFFFFC )
  {
    ...
    {
      v13 = (size_t *)sub_2ACC1C(a1, v10 + 8);
      v2 = v13;
      if ( v13 )
      {
        *v13 = v10;
