int __fastcall sub_32882C(int a1, int a2, char a3, char a4, int *a5)
{
  unsigned int v6; // r0
  int v7; // r12
  char v8; // r7
  ...
  *a5 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( v11 == v20 - 1 || *v10 != dword_438D28[v12] * ((unsigned int)(dword_438B40[v12] * (*v10 >> v12)) >> 17) )
      goto LABEL_23;
  }
  if ( !v11 )
    return a1;
