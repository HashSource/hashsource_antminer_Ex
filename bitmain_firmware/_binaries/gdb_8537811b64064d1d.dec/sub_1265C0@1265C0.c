int sub_1265C0()
{
  ...
  if ( !v4 )
  {
    ...
    sub_33BC7C((int)&v67, 0, 0, *(void **)(v3 + 4), v49);
    goto LABEL_30;
  }
  v5 = (const char *)sub_3245CC(*(_DWORD *)(v4 + 4));
  sub_25AFAC(v70, *(_DWORD *)(v3 + 4));
  if ( v70[1] == (void *)0x7FFFFFFF )
    sub_33D1AC("basic_string::append");
  v6 = sub_33C348(v70, &word_39899C, 1);
  v72 = v74;
  v9 = v6;
  v10 = (int *)(v6 + 8);
  v11 = *(_DWORD *)v6 == v6 + 8;
...
LABEL_30:
  if ( (unsigned int)(0x7FFFFFFF - v68) <= 3 )
    sub_33D1AC("basic_string::append");
  sub_33C348(&v67, ".dwp", 4);
  sub_11D6D4(&v72, (int)v67);
  if ( v72 )
    goto LABEL_32;
  v59 = *(const char **)(v3 + 4);
  v60 = (const char *)sub_1B87D0(v3);
  v61 = (void *)strcmp(v59, v60);
  if ( v61 )
  {
    v63 = (char *)sub_1B87D0(v3);
    v64 = strlen(v63);
    sub_33BC7C((int)&v67, 0, v68, v63, v64);
    if ( (unsigned int)(0x7FFFFFFF - v68) <= 3 )
      sub_33D1AC("basic_string::append");
    sub_33C348(&v67, ".dwp", 4);
    sub_11D6D4(&ptr, (int)v67);
    v61 = v72;
    v27 = (const char **)ptr;
    if ( v72 )
      v61 = (void *)((int (*)(void))loc_1625D0)();
    v72 = v27;
  }
  else
  {
...
LABEL_32:
    ...
    *(_DWORD *)(v3 + 56) = v42;
    ...
    sub_2ADD24(v27[2], &loc_11EF48, v27);
    v27[58] = (const char *)sub_1203A0(v27, 0);
    v43 = sub_1203A0(v27, 1);
    v44 = (int *)v27[58];
    ...
    else
    {
      if ( !v43 )
      {
        v27[1] = (const char *)2;
LABEL_64:
        sub_2ADD24(v27[2], &loc_11EDBC, v27);
LABEL_54:
        v27[60] = (const char *)sub_3239A8(3, sub_124654, sub_12465C, 0, v24, sub_25AF14, nullsub_44);
        v47 = sub_3239A8(3, sub_124654, sub_12465C, 0, v24, sub_25AF14, nullsub_44);
        v48 = dword_4872F4;
        v27[61] = (const char *)v47;
        if ( v48 )
        {
          v50 = (_DWORD *)sub_242FF0(v47);
          v51 = sub_2594D8(*v50, "DWP file found: %s\n", *v27);
          v52 = (int *)sub_242FF0(v51);
          v53 = v27[58];
          v54 = *v52;
          if ( v53 )
            v55 = *((_DWORD *)v53 + 2);
  ...
  if ( dword_4872F4 )
  {
    v62 = (_DWORD *)sub_242FF0(v61);
    sub_2594D8(*v62, "DWP file not found: %s\n", (const char *)v67);
    v27 = 0;
LABEL_55:
    if ( v72 )
