int __fastcall sub_F68FC(int a1, int a2, const char *a3, size_t a4)
{
  int result; // r0
  int v7; // r4
  int v8; // r6
  ...
  if ( *(__int16 *)(v7 + 4) > 0 )
  {
    ...
    while ( 1 )
    {
      v11 = (*(_WORD *)(v7 + 2) & 0x380) == 0x80 ? *(__int16 **)(v7 + 28) : &word_3B4A54;
      v12 = *v11;
      v13 = *(_DWORD *)(v7 + 24) + v9;
      if ( v12 > v10 )
        break;
      ...
      if ( v14 )
      {
        if ( *v14 )
        {
          ...
          if ( !result )
          {
            v23[0] = sub_32727C(v14);
            result = sub_F7F88(a2, v23);
            v7 = *(_DWORD *)(v8 + 24);
          }
          goto LABEL_12;
        }
...
LABEL_12:
    ...
    result = *(_DWORD *)(v13 + 12);
LABEL_33:
    result = sub_F68FC(result, a2, a3, a4);
    v7 = *(_DWORD *)(v8 + 24);
    goto LABEL_12;
  }
LABEL_13:
  ...
  if ( v16 >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v20 )
      {
        ...
        {
          if ( !v21 )
            v17 = (const char *)sub_170CEC(v8);
          if ( !v17 || (result = strcmp(v17, v20)) != 0 )
          {
            v21 = 1;
            v23[0] = sub_32727C(v20);
            result = sub_F7F88(a2, v23);
          }
          else
          {
