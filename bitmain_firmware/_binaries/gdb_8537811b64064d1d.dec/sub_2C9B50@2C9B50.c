int __fastcall sub_2C9B50(int a1, void (*a2)(void), int a3)
{
  int *v4; // r9
  int v6; // r10
  int v8; // r1
  ...
  if ( v24 )
  {
    ...
    do
    {
      ...
      v56 = v36;
      v57 = v37;
      sub_2C9270(v6, &v44, (int)v43);
      ((void (__fastcall *)(_DWORD *, int, int))a2)(v43, 40, a3);
      if ( v45 != 8 )
      {
        ptr = 0;
        if ( v56
          || (v40 = sub_2CFF1C(a1, v25, v38)) != 0
          && (*(_DWORD *)(v40 + 108) || (*(_DWORD *)(v40 + 20) &= ~0x4000u, sub_2AE004(a1, v40, (int *)&ptr)) && ptr) )
        {
          a2();
          if ( ptr )
            free(ptr);
