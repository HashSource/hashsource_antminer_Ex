int __fastcall sub_2B5834(unsigned int a1, int *a2, _DWORD *a3, int *a4)
{
  int v6; // r5
  int v8; // r2
  int v9; // r7
  ...
  if ( (a1 & 0xF000E10) != 0xE000A00 )
  {
    ...
    else
    {
      if ( (a1 & 0xE100E00) == 0xC100A00 )
      {
        ...
        v21 = sub_2B57F8(a1, 12, 22);
        switch ( v23 )
        {
          case 0:
LABEL_74:
            sub_2A6C18((int)"elf32-arm.c", 7981, (int)"bfd_arm_vfp11_insn_decode");
          case 2:
          case 3:
          case 5:
...
LABEL_34:
  ...
  v15 = sub_2B57F8(a1, 12, 22);
  v16 = sub_2B57F8(a1, 0, 5);
