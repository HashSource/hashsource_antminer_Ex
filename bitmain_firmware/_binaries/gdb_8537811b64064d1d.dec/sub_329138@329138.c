int __fastcall sub_329138(int result, int *a2, unsigned __int64 a3)
{
  int v3; // r12
...
LABEL_5:
        ...
        if ( v3 == dword_438D28[v6] - 1 )
        {
          *v7 = dword_438D28[v6 - 1];
          for ( i = v7 - 1; v4 <= i; --i )
            *i = 0;
          ...
          *(_DWORD *)(result + 4) = v10;
          if ( v5 + v10 > v11 )
            return sub_327934(result, (int)a2, (_DWORD *)HIDWORD(a3));
          return result;
        }
LABEL_15:
        v12 = 1;
LABEL_16:
        ...
        return sub_3275D8(v4, v13, word_4714A4, 1, 0, (signed int)v4, v12);
      }
LABEL_27:
      if ( (a3 & 0x80000000) == 0LL )
        return result;
...
LABEL_35:
      ...
      if ( v3 != dword_438D28[v14 - 1] )
        goto LABEL_35;
      *v15 = LOWORD(dword_438D28[v14]) - 1;
      for ( j = v15 - 1; v4 <= j; --j )
        *j = 999;
      v19 = *a2;
      v20 = a2[2];
