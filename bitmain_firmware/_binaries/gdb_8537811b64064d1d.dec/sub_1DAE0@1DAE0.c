int __fastcall sub_1DAE0(_DWORD *a1)
{
  unsigned int v1; // r1
  int v3; // r5
  int v4; // r0
  ...
  if ( v4 != 4 )
  {
    ...
    {
      v8 = HIWORD(v1) & 0xF;
      ((void (__fastcall *)(_DWORD, int, _DWORD *))loc_1DFA24)(a1[1], v8, v43);
      v9 = a1[3];
      v10 = v43[0];
