unsigned __int64 __fastcall sub_47FF4(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  _DWORD *v4; // r6
  bool v6; // zf
  int v7; // r3
  ...
  if ( (unsigned __int64)(*(_QWORD *)&dword_46AFB0 + 1LL) > 1 )
    sub_92078(&unk_47264C);
  v4 = &unk_47260C;
  *(_QWORD *)&dword_46AFB0 = 0;
  dword_472658 = 0;
  sub_920A8(&unk_47264C);
  sub_9206C(&unk_47264C, "<osdata type=\"message queues\">\n", 31);
  sub_96818((int)&stream, (int)"/proc/sysvipc/msg", "r");
  v9 = stream;
  if ( stream )
  {
...
LABEL_13:
  sub_9206C(&unk_47264C, "</osdata>\n", 11);
  dword_472658 = sub_920BC(&unk_47264C);
