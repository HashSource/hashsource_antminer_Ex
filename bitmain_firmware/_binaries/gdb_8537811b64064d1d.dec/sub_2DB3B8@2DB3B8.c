int __fastcall sub_2DB3B8(_DWORD *a1, int a2, int a3, int a4, int a5, _DWORD *a6)
{
  int v6; // r6
  int v7; // r2
  bool v8; // cc
  ...
  *a6 = 0;
  ...
  if ( !(*(int (__fastcall **)(_DWORD *, char *, int, int))(*(_DWORD *)(*(_DWORD *)(a1[1] + 444) + 392) + 40))(
          ...
          1) )
    return -1;
  v19 = sub_347440(*((_DWORD *)v14 + 9), v15[10]);
  v20 = (_DWORD *)*((_DWORD *)v14 + 17);
  v21 = 6 * v19;
  if ( v19 <= 0 )
  {
    v54 = sub_2AB390(24 * v19);
    *a6 = v54;
    if ( !v54 )
      return -1;
    return 0;
