int __fastcall sub_2D7728(int a1, FILE *s)
{
  int v2; // r7
  int v5; // r6
  int v6; // r8
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        sub_2A7CB8(a1, s, *(_DWORD *)(v7 - 56));
        fwrite(" vaddr 0x", 1u, 9u, s);
        sub_2A7CB8(a1, s, *(_DWORD *)(v7 - 52));
        fwrite(" paddr 0x", 1u, 9u, s);
        sub_2A7CB8(a1, s, *(_DWORD *)(v7 - 48));
        v10 = sub_2ABB1C(*(_DWORD *)(v7 - 36));
        fprintf(s, " align 2**%u\n", v10);
        fwrite(&unk_41A854, 1u, 0x12u, s);
        sub_2A7CB8(a1, s, *(_DWORD *)(v7 - 44));
        fwrite(" memsz 0x", 1u, 9u, s);
        sub_2A7CB8(a1, s, *(_DWORD *)(v7 - 40));
        v11 = *(_DWORD *)(v7 - 60);
        if ( (v11 & 4) != 0 )
          v12 = 114;
        else
  ...
  v15 = sub_2AD7D4(a1, ".dynamic");
  if ( !v15 )
    goto LABEL_26;
  fwrite("\nDynamic Section:\n", 1u, 0x12u, s);
  if ( !sub_2AE004(a1, (int)v15, (int *)&ptr) )
  {
LABEL_20:
    v16 = (char *)ptr;
    goto LABEL_21;
...
LABEL_128:
      ...
      if ( v46 )
      {
        v41 = (const char *)sub_2CD884(a1, v43, v46);
        if ( !v41 )
          goto LABEL_20;
      }
      else
