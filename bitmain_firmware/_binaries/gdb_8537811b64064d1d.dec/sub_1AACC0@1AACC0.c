int __fastcall sub_1AACC0(int a1, int a2, unsigned int a3, int *a4, int a5, const char *a6)
{
  int v6; // r10
  int v9; // r4
  ...
  if ( (_UNKNOWN *)a3 == (_UNKNOWN *)((char *)&loc_FFFFC + 3) )
    return sub_1A76C4(6, dword_487ABC);
  if ( *(_DWORD *)(*(_DWORD *)(dword_487AA4 + 152) + 72 * a1 + 48) <= a3 )
  {
    if ( dword_47AC88 > 0 )
      sub_F43DC(&off_46D334, "bad aux index at symbol %s", a6);
    return sub_1A76C4(6, dword_487ABC);
  }
  v9 = a2 + 4 * a3;
  (*(void (__fastcall **)(int, int, unsigned __int8 *))(dword_487AA8 + 72))(a5, v9, &v99);
  v103 = sub_1A76C4(v99 >> 2, dword_487ABC);
  v10 = v99;
  if ( !v103 )
  {
    switch ( v99 >> 2 )
    {
      ...
      default:
        if ( dword_47AC88 > 0 )
          sub_F43DC(&off_46D334, "cannot map ECOFF basic type 0x%x for %s", v99 >> 2, a6);
        return sub_1A76C4(6, dword_487ABC);
    }
  }
  if ( (v99 & 1) == 0 )
  ...
  if ( !a4 )
  {
    ...
    if ( dword_47AC88 > 0 )
    {
      sub_F43DC(&off_46D334, "can't handle TIR fBitfield for %s", a6);
      v10 = v99;
      v12 = v99 & 0xFC;
    }
  }
...
LABEL_7:
  ...
  if ( ((int)s2[0] & 0xFFF) == 0xFFF )
  {
    ...
    if ( dword_47AC88 > 0 )
      sub_F43DC(&off_46D334, "unable to cross ref btIndirect for %s", a6);
    return sub_1A76C4(6, dword_487ABC);
  }
  v11 += 4;
  v13 = (int)s2[0] & 0xFFF;
LABEL_11:
  v14 = sub_1A7244(a1, v13);
  v15 = sub_1AACC0(
...
LABEL_12:
  ...
  {
LABEL_21:
    v20 = sub_1ABA24(a1, v11, &v103, v6, s2, a5, a6);
    v21 = v103;
    v11 += 4 * v20;
    if ( !v103 )
    {
      v21 = ((int (__fastcall *)(int, int, _DWORD))loc_173508)(dword_487ABC, v6, 0);
      v103 = v21;
    }
    v22 = *(char **)(v21 + 24);
    v23 = *v22;
    ...
    {
      if ( dword_47AC88 > 0 )
        sub_F43DC(&off_46D334, "unexpected type code for %s", a6);
LABEL_29:
      v12 = v99 & 0xFC;
      goto LABEL_30;
    }
...
LABEL_61:
    ...
    if ( dword_47AC88 > 0 )
      sub_F43DC(&off_46D334, "guessed tag type of %s incorrectly", a6);
    goto LABEL_61;
  }
LABEL_30:
  if ( v12 == 64 )
  {
    v40 = sub_1ABA24(a1, v11, &v103, v6, s2, a5, a6);
    v41 = v103;
    v11 += 4 * v40;
    if ( !v103 )
    {
      v41 = ((int (__fastcall *)(int, int, _DWORD))loc_173508)(dword_487ABC, v6, 0);
      v103 = v41;
    }
    v89 = *(void **)(v41 + 24);
    if ( *(_BYTE *)v89 == 12 )
  ...
  {
LABEL_75:
    v11 += 4 * sub_1ABA24(a1, v11, &v103, v6, s2, a5, a6);
    if ( !v103 )
    {
      if ( dword_47AC88 > 0 )
        sub_F43DC(&off_46D334, "unable to cross ref btTypedef for %s", a6);
      v103 = sub_1A76C4(6, dword_487ABC);
    }
    v42 = v99 & 0xFC;
LABEL_77:
    if ( v42 == 64 )
  ...
  {
    v31 = v11 + 4 * sub_1AB79C(a1, &v103, i & 0xF, v11, a5, a6);
    if ( (v101 & 0xF0) == 0 )
      break;
    v27 = v31 + 4 * sub_1AB79C(a1, &v103, v101 >> 4, v31, a5, a6);
    if ( (v102 & 0xF) == 0 )
      break;
    v28 = v27 + 4 * sub_1AB79C(a1, &v103, v102 & 0xF, v27, a5, a6);
    if ( (v102 & 0xF0) == 0 )
      break;
    v29 = v28 + 4 * sub_1AB79C(a1, &v103, v102 >> 4, v28, a5, a6);
    if ( (v100 & 0xF) == 0 )
      break;
    v30 = v29 + 4 * sub_1AB79C(a1, &v103, v100 & 0xF, v29, a5, a6);
    if ( (v100 & 0xF0) == 0 )
      break;
    v11 = v30 + 4 * sub_1AB79C(a1, &v103, v100 >> 4, v30, a5, a6) + 4;
    if ( (v99 & 2) == 0 )
      return v103;
    (*(void (__fastcall **)(int))(dword_487AA8 + 72))(a5);
  }
  if ( (v99 & 2) != 0 && dword_47AC88 > 0 )
    sub_F43DC(&off_46D334, "illegal TIR continued for %s", a6);
  return v103;
}
