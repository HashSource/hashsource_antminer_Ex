        ...
        int a9)
{
  ...
  v11 = (_BYTE *)a4[2];
  v25[0] = v26;
  sub_1CF040(v25, v11, (int)&v11[v10]);
  v14 = (void *)v25[0];
  v15 = 1;
  v16 = *a4;
  ...
  *(_DWORD *)((char *)var8 + 3) = 0;
  v31 = v25[1];
  for ( i = (int *)sub_1D08A0(a1, 1)[6]; i; i = (int *)*i )
    *((_BYTE *)i + 55) &= 0xFCu;
  v20 = sub_1D08A0(a1, 1);
  for ( j = v20[6]; j; j = *(_DWORD *)j )
  {
    while ( 1 )
    {
      v20 = (_DWORD *)sub_258BFC(v20);
      if ( !*(_BYTE *)(j + 52) && !*(_DWORD *)(j + 24) )
      {
        if ( !a3
          || !*(_BYTE *)(j + 54)
          && (((int (__fastcall *)(int, _DWORD))a3)(a2, *(_DWORD *)(j + 4))
           || (dword_489708 || (v23 = sub_3245CC(*(_DWORD *)(j + 4)), (v20 = (_DWORD *)a3(a2, v23, 1)) != 0))
           && (v22 = sub_1CE11C(j), (v20 = (_DWORD *)a3(a2, (int)v22, 0)) != 0)) )
        {
          v20 = (_DWORD *)sub_1CE2E0(j, (int)a1, a9, (int)&v27, a5, a6);
          if ( v20 )
          {
            v20 = (_DWORD *)sub_1CE218((int)a1, j);
            if ( a8 )
              break;
          }
        }
