void __fastcall sub_1F31D4(int a1)
{
  int v2; // r0
  int v3; // r0
  int v4; // r0
  ...
  v91 = 0;
  v92 = 0;
  v2 = ((int (__fastcall *)(int))loc_1E21C0)(27);
  if ( v2 == 1 )
  {
    sub_2305B8(&ptr, a1, 17, 0);
    v56 = ptr;
    if ( !ptr )
      goto LABEL_18;
    if ( *(_BYTE *)ptr )
    {
      sub_274CC4("threads", "threads.dtd", &off_3D4C48, ptr, &v90);
      v56 = ptr;
      if ( !ptr )
        goto LABEL_18;
    }
  ...
  else
  {
    ...
    if ( !*(_DWORD *)(dword_488C94 + 128) )
      goto LABEL_3;
    sub_1E7E14("qfThreadInfo");
    v4 = sub_1E4EE0((char **)v5, (size_t *)(v5 + 4), 0, 0, 0);
    v70 = *(char **)v5;
...
LABEL_3:
      ...
      while ( 1 )
      {
        ...
        v11 = dword_488C94;
        v12 = sub_1E28B8(v10);
        v13 = v12 <= 538 ? sub_1E28B8(v12) / 16 - 2 : 32;
        v14 = *(char **)v11;
        *v14 = 113;
        v14[1] = 76;
        v15 = sub_9916C(v14 + 2, v8);
        v16 = sub_99184(v15, v13);
        v17 = (unsigned __int8 *)v84;
        v18 = v16 + 16;
        do
        {
          v19 = *v17++;
          v16 = sub_99184(v16, v19);
        }
        while ( v18 > v16 );
        *v16 = 0;
        sub_1E7E14(*(const char **)v11);
        v20 = sub_1E4EE0((char **)v11, (size_t *)(v11 + 4), 0, 0, 0);
        v21 = *(const char **)v11;
        if ( !**(_BYTE **)v11 )
          break;
        v22 = sub_16F67C(v20);
        ((void (__fastcall *)(int))loc_1E2798)(v22);
        v23 = v21 + 5;
        v24 = (unsigned int)&v21[*(_DWORD *)(dword_488C94 + 4) - 14];
        v25 = sub_1E0E4C((unsigned __int8 *)v21 + 2, 2);
        v8 = sub_9910C(*((unsigned __int8 *)v21 + 4));
        v26 = (int)v23;
        v27 = 0;
        v28 = sub_1E0EB8(v26, (char *)(v11 + 136));
        v29 = (char *)v85;
        while ( 1 )
        {
          v30 = v25 - v27 > 0;
        ...
        {
          if ( v8 != 1 )
            sub_946D8("RMT ERROR : failed to get remote thread list.");
          goto LABEL_18;
        }
LABEL_88:
        if ( v13 < v27 )
        {
          sub_946D8("RMT ERROR: threadlist response longer than requested.");
          goto LABEL_18;
        }
        v74 = 8 * (v27 + 18);
        v75 = v86 + 143;
        ...
        if ( !--v83 )
        {
          sub_946D8("Remote fetch threadlist -infinite loop-.");
          goto LABEL_18;
        }
      }
      sub_23E910(v20);
LABEL_66:
    ...
    if ( *v70 == 109 )
    {
      do
      {
        do
        {
          sub_1E13FC((int)v97, v71, &v88);
          sub_1F589C(&v90, v97);
          v72 = v88;
          v71 = ++v88;
        }
        while ( *v72 == 44 );
        sub_1E7E14("qsThreadInfo");
...
LABEL_18:
  ...
  if ( !sub_1E3688(dword_4878EC, qword_4878F0, SHIDWORD(qword_4878F0)) )
  {
LABEL_19:
...
LABEL_24:
    ...
    v89[0] = &v90;
    v89[1] = 0;
    v39 = (void *)((int (__fastcall *)(int, int (*)(), _DWORD *))loc_1E7980)(dword_488CE4, sub_1F50A4, v89);
    v40 = (unsigned int *)v90;
    v41 = v91;
    if ( v91 == v90 )
    {
...
LABEL_41:
    ...
    v49 = sub_232978(v39);
    sub_1EC690(*v40, v40[1], v40[2], v49 != 0);
    v50 = *((_DWORD *)v42 - 18);
    v51 = *((_DWORD *)v42 - 17);
    v94 = *((_DWORD *)v42 - 19);
    v95 = v50;
    v96 = v51;
    v52 = sub_23E430(v94, v50, v51);
    v53 = (_DWORD *)((int (__fastcall *)(int))loc_1E3914)(v52);
    v53[13] = *((_DWORD *)v42 - 4);
    v54 = (unsigned int *)*((_DWORD *)v42 - 16);
    v55 = (_BYTE *)v53[1];
    if ( v54 == v40 + 5 )
    {
      sub_33B4B4(v53 + 1, v40 + 3);
