int __fastcall sub_2E9250(int a1, int a2, int a3, int *a4, int a5)
{
  unsigned int v5; // r9
  int v7; // r1
  unsigned int v8; // r6
  ...
  if ( v14 || (unsigned __int64)sub_34769C((v5 >> 18) & 0xF, (v5 >> 22) & 0xF) >> 32 )
    goto LABEL_12;
  v30 = v15 == 0;
  if ( v15 )
    v30 = a1 == 0;
  ...
  do
  {
    switch ( v11 )
    {
      ...
      case 1u:
        ...
        break;
      default:
        sub_2A6C18((int)"elflink.c", 8468, (int)"get_value");
    }
    v17 -= v11;
    v15 += v11;
  }
      ...
      switch ( v11 )
      {
        ...
        case 1u:
          *v25 = v23;
          ...
          break;
        default:
          sub_2A6C18((int)"elflink.c", 8414, (int)"put_value");
      }
      v25 -= v11;
    }
    while ( &v25[v26] );
