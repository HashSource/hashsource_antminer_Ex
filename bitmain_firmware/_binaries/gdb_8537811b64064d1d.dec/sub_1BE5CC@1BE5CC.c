void __fastcall sub_1BE5CC(_BYTE *a1)
{
  int v2; // r7
  int v3; // r9
  int v4; // r8
  ...
  if ( v3 == v58 )
    sub_94708("Available types of OS data not reported.");
  if ( v58 == v4 )
  {
LABEL_71:
    v8 = 0;
  ...
  if ( sub_257418(v2) || (v40 = *(_DWORD *)(v4 - 12), v40 == *(_DWORD *)(v4 - 8)) )
  {
    v7 = -1;
  }
  else
...
LABEL_13:
          ...
          *((_BYTE *)v19 + (_DWORD)v13) = 0;
          ...
          if ( v15 > 0xF )
          {
            v48 = (_DWORD *)sub_33B2E4(ptr, &v61, 0);
            ptr[0] = v48;
            v65[0] = v61;
          }
          else
...
LABEL_17:
      ...
      {
        v20 = (_DWORD *)sub_33B2E4(v62, ptr, 0);
        v62[0] = v20;
        v63[0] = ptr[0];
      }
  ...
  if ( v3 != v58 )
  {
    ...
    if ( v57 != v21 )
    {
      ...
      do
      {
        ...
        if ( v23 != v24 )
        {
          ...
          do
          {
            if ( v7 != v26 )
            {
              ...
              sub_257610(v2, s, *(_DWORD *)(*(_DWORD *)(v22 - 12) + v25 + 24));
              v23 = *(_DWORD *)(v22 - 8);
              v24 = *(_DWORD *)(v22 - 12);
            }
            ++v26;
        ...
        sub_257374(v2, 0);
        sub_2573A8(v2, &word_356660, v27, v28);
        v29 = v57 == v22;
        v22 += 12;
      }
      while ( !v29 );
