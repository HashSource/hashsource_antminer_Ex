int __fastcall sub_1E220(_DWORD *a1)
{
  unsigned int v1; // r1
  int v3; // r0
  int v4; // r2
  ...
  if ( v4 == 9 )
  {
    ...
    {
      ((void (__fastcall *)(int, unsigned int, _DWORD *))loc_1DFA24)(v3, HIWORD(v1) & 0xF, v28);
      v19 = a1[5];
      v20 = v28[0];
      v8 = 4;
      a1[7] = 1;
  ...
  if ( v4 != 3 )
  {
    switch ( v4 )
    {
      ...
      case 11:
        if ( !v6 )
        {
          sub_1CDD4((int)a1, &src, (int)v32, 1);
          goto LABEL_48;
        }
LABEL_29:
