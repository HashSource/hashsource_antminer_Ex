int __fastcall sub_3E71C(int a1, int a2, int *a3)
{
  int *v3; // r5
  int v4; // r7
  int v5; // r8
  ...
  else
  {
    ...
    if ( dword_471BF0 )
    {
      ...
      v14 = sub_154BB0(*v16, *v15, v15[1], v15[2], "Warning: find_new_threads_once: ");
    }
    v10 = sub_339F20(v14);
    v9 = 1;
  }
  if ( dword_471BF0 )
  {
    ...
    sub_2594D8(*v12, "Found %d new threads in iteration %d.\n", v19, v4);
  }
  result = v19;
  *v3 = v9;
  return result;
