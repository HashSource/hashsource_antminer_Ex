        ...
        if ( (*(_BYTE *)(v3 + 10) & 4) == 0 )
        {
          ...
          if ( v4 )
          {
            if ( *v4 )
            {
              ...
              if ( v7 )
              {
                v8 = sub_323B08(1, off_4714A0, off_47149C[0], 0, sub_930BC, &loc_11C860);
                v9 = sub_323B08(1, off_4714A0, off_47149C[0], 0, sub_930BC, &loc_11C860);
                ...
                if ( v11 && *v11 )
                {
                  ...
                  do
                  {
                    ((void (__fastcall *)(void **, int, int, unsigned int, int))loc_125754)(
                      &ptr,
                      v8,
                      v12,
                      v11[v13 + 2],
