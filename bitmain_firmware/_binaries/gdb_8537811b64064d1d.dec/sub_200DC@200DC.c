int __fastcall sub_200DC(_DWORD *a1, unsigned int a2, size_t n)
{
  int v6; // r5
  unsigned int v7; // r6
  __int64 v8; // r0
  ...
  if ( v6 )
  {
    if ( dword_487D4C )
    {
      v10 = (const char *)sub_25ACB4(*a1, a1[2]);
      sub_259880("Process record: error reading memory at addr %s len = %d.\n", v10, n);
      return -1;
    }
    return -1;
  }
  ...
  if ( a2 == 1 )
  {
    ...
    if ( v7 >> 28 != 15 )
    {
      v9 = ((int (__fastcall *)(_DWORD *))(&off_349370)[HIDWORD(v8) + 371])(a1);
      goto LABEL_12;
    }
    v15 = a1[8];
    LODWORD(v8) = a1[1];
        ...
        if ( !HIDWORD(v8) && (v7 & 0x90) == 0x90 && !a1[8] )
        {
          ...
          if ( v51 )
          {
            ...
            if ( v51 == 1 )
            {
              ...
              {
LABEL_177:
                sub_1CDD4((int)a1, &v70, (int)&src, v51);
                v7 = a1[3];
                v19 = v7 >> 23;
                goto LABEL_57;
              }
...
LABEL_174:
          ...
          ((void (__fastcall *)(_DWORD, unsigned int, _DWORD *))loc_1DFA24)(v8, HIWORD(v7) & 0xF, v68);
          v7 = a1[3];
          v64 = v68[0];
          if ( a1[5] == 8 )
            v65 = 4;
...
LABEL_74:
        ...
        a2 = HIWORD(v7) & 0xF;
        v27 = (v7 >> 21) & 7;
        ((void (__fastcall *)(int, unsigned int, _DWORD *))loc_1DFA24)(v26, a2, v68);
        v28 = a1[3];
        if ( (v28 & 0x800000) != 0 )
        {
        ...
        {
          ((void (__fastcall *)(int, int, int *))loc_1DFA24)(v26, a1[3] & 0xF, &v69);
...
LABEL_117:
    ...
    else
    {
      v48 = HIWORD(v7) & 0xF;
      v67 = v38;
      ((void (__fastcall *)(_DWORD, int, _DWORD *))loc_1DFA24)(a1[1], v48, v68);
...
LABEL_61:
  ...
  a1[4] = -1;
  if ( !((int (__fastcall *)(_DWORD *))(&off_349370)[((unsigned __int16)v7 >> 13) + 379])(a1) )
    return 0;
LABEL_13:
  sub_1ABB8(a1);
  return -1;
