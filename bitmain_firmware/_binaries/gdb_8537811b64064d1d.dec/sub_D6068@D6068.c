int __fastcall sub_D6068(int a1, int a2, _DWORD *a3, _DWORD *a4, _DWORD *a5)
{
  int *v5; // r5
  unsigned int v6; // r6
  unsigned int *v7; // r7
  ...
  v124 = 0;
  v11 = 0;
  if ( !sub_CA3DC(a1) || *(_BYTE *)(a1 + 39) && !*(_BYTE *)(a1 + 36) )
    return 0;
  v12 = *(_QWORD *)(a1 + 48);
  v13 = *(_DWORD *)(a1 + 56);
...
LABEL_148:
    ...
    if ( v6 )
    {
      ...
      if ( *(_BYTE *)v108 != 34 )
        sub_94708("No format string following the location");
      sub_96C74(v143, &v135);
      v109 = v135 + 1;
      v133 = v135++;
      if ( *v133 != 34 )
        sub_94708("Bad format string, non-terminated '\"'.");
      LODWORD(v110) = sub_93634(v109);
      ...
      v135 = (const char *)sub_93634(v110);
      v140 = 0;
      v111 = v135;
      v141 = 0;
      ...
      {
        v136 = v111;
        v114 = sub_C259C((unsigned int)v8);
        sub_1C42A4(&ptr, &v136, v8, v114, 1);
        v115 = v141;
        v113 = 0;
        v116 = ptr;
        ptr = 0;
      ...
      v117 = sub_92E50();
      sub_C0354((int *)&v138, (int)v8, v107, 0, 0, 0, v132, (int)&v133[-v132], (v141 - (_BYTE *)v140) >> 2, (int)v140);
      v118 = (int)v117;
      v6 = v138;
      sub_92E68(v118);
      if ( v140 )
...
LABEL_7:
    ...
    if ( v17 <= 1 )
    {
      if ( v14[3] != 2 )
      {
        ...
        if ( v28 )
        {
          ...
          if ( dword_4788B4 )
          {
            ...
            if ( v30 != v29 )
            {
              ...
              *(_DWORD *)(a1 + 12) = v30;
              if ( !v31 )
              {
                v32 = (_DWORD *)sub_242FB4(v28);
                sub_25A440(*v32, "Note: automatically using hardware breakpoints for read-only addresses.\n");
                dword_4788C4 = 1;
              }
            }
          }
          else if ( !v29 && *(_DWORD *)(v28 + 16) != 1 )
          {
            ...
            v69 = (const char *)sub_25ACB4(v67, v66);
            sub_2594D8(
              a2,
      ...
      if ( dword_489690 && (v33 = *(_DWORD *)(a1 + 64)) != 0 && sub_2142C8(v33) )
      {
        if ( !dword_478354 )
        {
          if ( *(_DWORD *)(a1 + 12) == 1 )
          {
            sub_946D8("hardware breakpoint %d not supported in overlay!", *(_DWORD *)(*(_DWORD *)(a1 + 16) + 24));
          }
          else
          {
            v52 = (void *)sub_21473C(*(_DWORD *)(a1 + 52), *(_DWORD *)(a1 + 64));
            v53 = *(_DWORD *)(a1 + 88);
            v54 = (_BYTE *)(a1 + 172);
            v55 = *(_DWORD *)(a1 + 92);
            v56 = a1 + 103;
            ...
            *(_QWORD *)(a1 + 188) = *(_QWORD *)(a1 + 120);
            sub_DF744(a1 + 196, a1 + 128);
            sub_DF744(a1 + 208, a1 + 140);
            v59 = v143[0];
            *(_DWORD *)(a1 + 220) = *(_DWORD *)(a1 + 152);
            *(_DWORD *)(a1 + 164) = v59;
            v60 = sub_92E50();
            sub_C95C4(*(_DWORD *)(a1 + 16));
            v61 = v143[0];
            *(_DWORD *)(a1 + 192) = v62;
            v63 = *(_DWORD *)(a1 + 44);
            *(_DWORD *)(a1 + 160) = v61;
            if ( sub_230788(v63, a1 + 156) )
            {
              v11 = 0;
              v10 = -1;
              sub_92E68((int)v60);
              v124 = 1;
              sub_2594D8(a2, "Overlay breakpoint %d failed: in ROM?\n", *(_DWORD *)(*(_DWORD *)(a1 + 16) + 24));
            }
            else
            {
              sub_92E68((int)v60);
...
LABEL_39:
            ...
            {
LABEL_40:
              sub_FA684(v143, -1, *(_DWORD *)(a1 + 44), *(_DWORD *)(a1 + 52));
              sub_2594D8(
                a2,
                "Cannot insert breakpoint %d.\n%s\n",
                *(_DWORD *)(*(_DWORD *)(a1 + 16) + 24),
...
LABEL_78:
        if ( v51 != 1 )
        {
          if ( v11 )
          {
            sub_2594D8(a2, "Cannot insert breakpoint %d: %s\n", *(_DWORD *)(*(_DWORD *)(a1 + 16) + 24), v11);
            return 1;
          }
          goto LABEL_40;
        }
        ...
        *a5 = v11 != 0;
        ...
        if ( v11 )
        {
          sub_2594D8(a2, "Cannot insert hardware breakpoint %d%s", v83, ":");
          sub_2594D8(a2, "%s.\n", v11);
          return 1;
        }
LABEL_192:
...
LABEL_92:
      if ( sub_201954(*(_DWORD *)(a1 + 48), *(_DWORD *)(a1 + 52))
        || sub_1B8734(*(_DWORD *)(a1 + 48), *(_DWORD *)(a1 + 52)) )
      {
        v65 = *(_DWORD *)(a1 + 16);
        *(_BYTE *)(a1 + 37) = 1;
        sub_1B9D78(v65);
        if ( !*a3 )
        {
          sub_2594D8(a2, "Cannot insert breakpoint %d.\n", *(_DWORD *)(*(_DWORD *)(a1 + 16) + 24));
          sub_2594D8(a2, "Temporarily disabling shared library breakpoints:\n");
        }
        *a3 = 1;
        sub_2594D8(a2, "breakpoint #%d\n", *(_DWORD *)(*(_DWORD *)(a1 + 16) + 24));
        return 0;
      }
      v51 = *(_DWORD *)(a1 + 12);
      goto LABEL_78;
...
LABEL_232:
        sub_94708("Invalid argument syntax", HIDWORD(v110));
      }
      v25 = v24(a1);
      v26 = v25;
      if ( v25 )
      {
        ...
        *(_DWORD *)(*(_DWORD *)(a1 + 16) + 16) = 0;
        HIWORD(v27) = 56;
        sub_946D8(v27, *(_DWORD *)(*(_DWORD *)(a1 + 16) + 24), 0);
      }
      *(_BYTE *)(a1 + 39) = v26 == 0;
      return 0;
    }
  ...
  if ( v21 == 1 )
  {
    if ( *(_DWORD *)(a1 + 60) == 1 )
    {
      if ( dword_478368 < (unsigned int)(dword_478368 + 4 * dword_47836C) && (v70 = *(_DWORD **)dword_478368) != 0 )
      {
        ...
        while ( (_DWORD *)a1 == v70 || v70[15] != 2 || !((int (__fastcall *)(int, _DWORD *))loc_C70CC)(a1, v70) )
        {
        ...
        *(_DWORD *)(a1 + 124) = v70[31];
        sub_DF744(a1 + 128, v70 + 32);
        sub_DF744(a1 + 140, v70 + 35);
        v76 = v70[38];
        *(_DWORD *)(a1 + 60) = 2;
        v22 = 1;
        *(_DWORD *)(a1 + 152) = v76;
