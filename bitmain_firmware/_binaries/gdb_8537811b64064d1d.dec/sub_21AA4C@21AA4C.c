void __fastcall sub_21AA4C(_BYTE *a1, int a2, int a3)
{
  _DWORD *v4; // r4
  void *v5; // r6
  _DWORD *i; // r4
...
LABEL_5:
  while ( !((int (__fastcall *)(_BYTE *, void *, _DWORD, _DWORD, int, int))loc_21A8DC)(a1, v5, v4[5], 0, a2, a3) )
  {
    v4 = (_DWORD *)*v4;
    if ( !v4 )
    {
