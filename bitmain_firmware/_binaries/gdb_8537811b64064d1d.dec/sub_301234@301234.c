int __fastcall sub_301234(_DWORD *a1, int a2, unsigned int a3, _BYTE *a4)
{
  unsigned int v5; // r6
  int v8; // r8
  int v9; // r10
...
LABEL_9:
      ...
      switch ( v16 )
      {
        ...
        case 1:
          break;
        default:
          sub_2A6C18((int)"reloc.c", 1564, (int)"_bfd_relocate_contents");
      }
      if ( (v22 & v18) != 0 )
      {
        if ( (v22 & v26) == (v22 & v18) )
...
LABEL_7:
      ...
      switch ( v10 )
      {
        ...
        case 4:
          ...
          break;
        case 8:
          sub_2A6C18((int)"reloc.c", 1594, (int)"_bfd_relocate_contents");
        default:
          sub_2A6C18((int)"reloc.c", 1580, (int)"_bfd_relocate_contents");
      }
      return result;
    case 8:
      sub_2A6C18((int)"reloc.c", 1468, (int)"_bfd_relocate_contents");
    default:
      sub_2A6C18((int)"reloc.c", 1452, (int)"_bfd_relocate_contents");
  }
}
