...
LABEL_24:
        if ( a9 >= 0 )
        {
          ...
          if ( v15 < 0 )
LABEL_33:
            sub_16DB8(*(const char **)(a1 + 4), a3, "close", *v14);
        }
        v13 = _errno_location();
        if ( (a2 & 8) == 0 || dup2(1, 2) >= 0 )
        {
          ...
          {
            execvp(a3, a4);
            sub_16DB8(*(const char **)(a1 + 4), a3, "execvp", *v13);
          }
          execv(a3, a4);
          sub_16DB8(*(const char **)(a1 + 4), a3, "execv", *v13);
        }
        v16 = *v13;
        LOWORD(v17) = (unsigned __int16)"dup2";
LABEL_39:
        HIWORD(v17) = (unsigned int)"dup2" >> 16;
        sub_16DB8(*(const char **)(a1 + 4), a3, v17, v16);
      }
LABEL_32:
      v14 = _errno_location();
      goto LABEL_33;
