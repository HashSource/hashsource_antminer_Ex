int __fastcall sub_15FB4(int a1)
{
  int v2; // r7
  int v3; // r0
  int v4; // r5
  ...
  sub_15FA54(v8, a1);
  if ( !sub_15CD80(v8[0], v8[1], v8[2], v8[3], v8[4]) )
    sub_94728(
      "infrun.c",
      7464,
  ...
  v2 = ((int (__fastcall *)(int))loc_1602F0)(a1);
  memset(s, 0, 0x24u);
  v3 = ((int (__fastcall *)(int))loc_15FA08)(a1);
  v4 = ((int (__fastcall *)(int, int))loc_169FC8)(v2, v3);
  v5 = sub_214860();
  v6 = ((int (__fastcall *)(int))loc_15DAEC)(a1);
  sub_15FA54(&v9, a1);
  s[4] = v4;
  s[2] = v5;
  v19 = v6;
  ...
  v17 = v12;
  v18 = v13;
  return sub_184D84(v2, v6, s[0], s[1], v5, s[3], v4, s[5], s[6], s[7], s[8], v9, v10, v11, v12, v13, 15);
}
