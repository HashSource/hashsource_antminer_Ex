unsigned __int8 *__fastcall sub_4D8A4(int a1)
{
  int v2; // r9
  int v3; // r7
  int v4; // r0
  ...
  v5 = sub_4D714(v4);
  v6 = ps_getpid_0(a1);
  result = (unsigned __int8 *)sub_4D714(v6);
  if ( v2 )
  {
    v8 = 0;
    v9 = result;
...
LABEL_26:
          sub_258B2C("Unexpected error setting breakpoint");
        *v11 = 0;
      }
      else
      {
    ...
    for ( i = v9 + 136; ; i += 8 )
    {
      result = (unsigned __int8 *)sub_4D7A4();
...
LABEL_24:
      sub_258B2C("Unexpected error setting watchpoint");
    goto LABEL_14;
  }
  return result;
}
