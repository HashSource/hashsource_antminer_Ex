_DWORD *__fastcall sub_2FF940(_DWORD *a1, unsigned __int8 *a2, unsigned int a3, int a4)
{
  unsigned int v5; // r10
  size_t v9; // r9
...
LABEL_28:
  ...
  v13 = *(_DWORD **)(*a1 + 4 * ((unsigned __int64)sub_34769C(v5, a1[3]) >> 32));
  if ( v13 )
  {
...
LABEL_16:
  if ( !a4 )
    return (_DWORD *)a4;
LABEL_17:
  v15 = sub_2AAA60((int)a1, (int)a2, v5);
  v13 = v15;
  if ( v15 )
  {
    v15[3] = v9;
