int __fastcall sub_5D924(int a1, int a2, int a3, int a4)
{
  int v7; // r11
  int i; // r0
  int v9; // r0
  ...
  if ( v7 )
  {
    while ( 1 )
    {
      for ( i = sub_C28D0(v7, v26); ; i = sub_C290C(v26) )
      {
        v11 = i;
        if ( !i )
          break;
...
LABEL_27:
            ...
            sub_21D6D8(v23, *(_DWORD *)i, v7, 1, 0);
            v15 = v23[0];
            if ( !v23[0] )
            {
              v9 = sub_94728(
...
LABEL_30:
            ...
            if ( a2 != 1 )
            {
              ...
              if ( (unsigned int)**(unsigned __int8 **)(sub_171280(*(_DWORD *)(v15 + 24)) + 24) - 2 <= 2 )
                goto LABEL_6;
            }
            v9 = v15;
            if ( (*(_BYTE *)(v11 + 33) & 2) == 0 )
              goto LABEL_35;
            sub_20CDB4(v15, a3, v20, v23);
LABEL_6:
            v10 = (char *)v22;
LABEL_7:
            if ( v10 != "only" )
              sub_5D480((int)v20, a1, a2, a4);
            if ( v25 != "no" )
              sub_5D480((int)v23, a1, a2, a4);
            if ( ptr )
              free(ptr);
            if ( v24 )
              free(v24);
