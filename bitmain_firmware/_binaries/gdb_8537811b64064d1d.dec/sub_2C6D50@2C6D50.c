int __fastcall sub_2C6D50(_DWORD *a1, int a2)
{
  int v2; // r11
  int v4; // r3
  int v5; // r6
  ...
  do
  {
    ...
    qsort(*(void **)(v7 + 152), v8, 8u, (__compar_fn_t)sub_2B5F28);
    v10 = *(_DWORD *)(v7 + 144);
    v11 = ptr;
    if ( !v10 )
      goto LABEL_58;
...
LABEL_52:
            ...
            if ( v30 )
            {
              ...
              else
              {
                ...
                if ( v34 != 4 )
                {
                  sub_2A6BE4("elf32-arm.c", 7240);
                  __und(0);
                }
                v36 = v33[90];
                if ( !v36 )
                {
                  sub_2A6BE4("elf32-arm.c", 7241);
                  v36 = v33[90];
                }
                v37 = sub_2AD88C(v36, ".text.stm32l4xx_veneer");
                if ( !v37 )
                  sub_2A6BE4("elf32-arm.c", 7246);
                v56 = v37[35];
                v38 = (char *)sub_2AB390(31);
                if ( !v38 )
                  sub_2A6BE4("elf32-arm.c", 7253);
                sprintf(v38, "__stm32l4xx_veneer_%x", v33[101]);
                if ( sub_2FC948(v33, v38, 0) )
                  sub_2A6BE4("elf32-arm.c", 7261);
                v61 = 0;
                sub_2FD6EC(a2, v33[90], (int)v38, 9, (int)v37, v33[87], 0, 1, 0, (int)&v61);
                v39 = v61;
                v40 = *(_BYTE *)(v61 + 52);
                *(_BYTE *)(v61 + 48) = 2;
                *(_BYTE *)(v39 + 52) = v40 | 8;
                ++*((_DWORD *)v56 + 41);
                v41 = sub_2AB514(0x14u);
                v42 = v33[101];
                v43 = *((_DWORD *)v56 + 42);
                v41[3] = v42;
                v41[4] = 1;
                ...
                *((_DWORD *)v56 + 42) = v41;
                ...
                if ( sub_2FC948(v33, v38, 0) )
                  sub_2A6C18((int)"elf32-arm.c", 7295, (int)"record_stm32l4xx_erratum_veneer");
                v17 += 4;
                v61 = 0;
                sub_2FD6EC(a2, v13, (int)v38, 1, v53, v17, 0, 1, 0, (int)&v61);
                v44 = v61;
                v45 = *(_BYTE *)(v61 + 52);
                *(_BYTE *)(v61 + 48) = 2;
                *(_BYTE *)(v44 + 52) = v45 | 8;
                ...
                if ( !v46 )
                {
                  v47 = v33[90];
                  v61 = 0;
                  sub_2FD6EC(a2, v47, (int)"$t", 1, (int)v37, 0, 0, 1, 0, (int)&v61);
                  v48 = v61;
                  v49 = *(_BYTE *)(v61 + 52);
                  *(_BYTE *)(v61 + 48) = 0;
                  *(_BYTE *)(v48 + 52) = v49 | 8;
                  sub_2B9E2C(v37[35], 116, 0);
                  v46 = v33[87];
                }
                HIDWORD(v50) = -1;
                v9 = v52;
...
LABEL_40:
          ...
          v28 = *(_DWORD *)(v54 + 400);
LABEL_51:
          v29 = sub_347FD8((unsigned __int16)v24);
          goto LABEL_52;
        }
      }
LABEL_24:
