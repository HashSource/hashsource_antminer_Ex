void __fastcall sub_13CB34(int *a1, _DWORD *a2, _DWORD *a3, int a4, int a5, int a6)
{
  int v6; // r8
  _DWORD *v7; // r9
  int v8; // r2
      ...
      if ( -858993459 * ((v15 - v14) >> 2) <= 4 * v16 / 3u )
      {
        ...
        if ( v14 != v15 )
        {
          ...
          do
          {
            ...
            if ( v31 )
            {
              v32 = (_DWORD *)sub_11DCD0((int)a1, *((char **)v29 - 5));
              v33 = *((_DWORD *)v29 - 4);
              v34 = (void *)v32[2];
              v32[3] = 0;
              v32[4] = 0;
...
LABEL_46:
        ...
        v41 = sub_14868C(&v45, HIDWORD(v40));
        sub_339024(v41);
      }
      v18 = *(char **)(v17 + 12);
      v6 = a5 | (a6 << 31) | (v6 << 28);
