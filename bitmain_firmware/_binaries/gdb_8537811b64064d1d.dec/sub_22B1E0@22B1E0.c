int __fastcall sub_22B1E0(int a1, int a2, int a3, int a4, int a5, int a6)
{
  _DWORD *v8; // r0
  int v9; // r6
  _DWORD *v10; // r0
  ...
  sub_2594D8(*v8, "-> %s->to_verify_memory (...)\n", (const char *)dword_489C90);
  v9 = off_489EDC(&unk_489C8C, a2, a3, off_489EDC, a5, a6);
  v10 = (_DWORD *)sub_242FF0(v9);
  sub_2594D8(*v10, "<- %s->to_verify_memory (", (const char *)dword_489C90);
