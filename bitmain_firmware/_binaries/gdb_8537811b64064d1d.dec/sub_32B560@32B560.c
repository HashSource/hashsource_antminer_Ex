int __fastcall sub_32B560(int result, int a2, int a3, int a4, int *a5)
{
  char *v5; // r10
  int v6; // r6
  int v7; // lr
  ...
  if ( ((v6 | v9) & 0x70) == 0 )
  {
    ...
    {
      if ( v9 <= 49 )
        v29 = *((unsigned __int8 *)&dword_438B40[5] + v9);
      else
        v29 = (v9 + 2) / 3u;
      v30 = *((unsigned __int8 *)&dword_438B40[5] + a4);
      v31 = 2 * (v30 + v29);
      if ( v31 > 98 )
      {
      ...
      else
      {
        ...
        do
        {
          while ( 1 )
          {
            ...
            if ( !v39 )
              break;
            v34 = sub_3275D8(&v20[v32], v34 - v32, (unsigned __int16 *)(v93 + 10), v29, 0, (signed int)&v20[v32], v38)
                + v32;
            ++v32;
            if ( v37 == v36 )
              goto LABEL_51;
...
LABEL_52:
            ...
            *(_DWORD *)v8 = v41;
            ...
            if ( v47 )
              v45 = -1999999998;
            *(_DWORD *)(v8 + 4) = v45;
            sub_328A28(v8, v90, v20, v41, &v101, a5);
            sub_3295C0((_DWORD *)v8, v90, &v101, a5);
            goto LABEL_58;
          }
        }
        v62 = 18;
          ...
          if ( v70 )
          {
            if ( v100 > v20 )
            {
              ...
              do
              {
                ...
                if ( v73 > 0x3B9AC9FF )
                {
                  v75 = sub_347F9C(v74, HIDWORD(v74), 1000000000, 0);
                  v76 = v75;
                  v77 = v75;
                  if ( v75 > 0x3B9AC9FF )
                  {
                    v78 = sub_347F9C(v72, HIDWORD(v72), -1486618624, 232830643);
                    v79 = v78;
                    v71[1] += v78;
                    sub_347F9C(v72, HIDWORD(v72), -1486618624, 232830643);
...
LABEL_59:
  ...
  {
    sub_32AC34(result, a2, a3, (int *)a4, a5);
    return v8;
  }
