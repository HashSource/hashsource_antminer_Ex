int __fastcall sub_3024C4(int a1, _DWORD *a2, int a3, int (__fastcall *a4)(int, int), int a5)
{
  unsigned int v5; // r12
  _BOOL4 v7; // r7
  char *v11; // r6
  ...
  if ( v7 || !a3 )
    return 0;
  v29 = a2[10];
  if ( !sub_2AE004(a1, (int)a2, (int *)&ptr) )
  {
LABEL_27:
    if ( ptr )
      free(ptr);
...
LABEL_13:
  ...
  if ( !v20 )
  {
    v20 = (_DWORD *)sub_2ACC1C(a1, 4 * v23);
    *(_DWORD *)(a3 + 4) = v20;
    if ( !v20 )
      goto LABEL_27;
  }
