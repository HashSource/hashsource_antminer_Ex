int __fastcall sub_362AC(char *a1, int a2, int a3)
{
  int v3; // r6
  int v4; // r0
  int v5; // r5
  ...
  sub_93198(&obstack, 100, "/proc/%d/cmdline", v3);
  v4 = sub_231864(&ptr, 0, &obstack);
  if ( !ptr )
  {
    v5 = 0;
    goto LABEL_6;
  ...
  memset(s, 0, sizeof(s));
  s[4] = v3;
  v35 = (const char *)sub_3245CC(ptr);
  v36 = strncpy((char *)&s[8], v35, 0x11u);
  LOBYTE(s[12]) = 0;
  p_object_base = (char **)sub_17FF44(v36);
  v79 = (char *)v81;
  if ( ptr )
    v38 = (int)ptr + strlen((const char *)ptr);
  else
    v38 = -1;
  sub_357B4(&v79, ptr, v38);
  v39 = v79;
  if ( p_object_base )
  {
    LODWORD(v82) = v83;
    sub_357B4(&v82, v79, (int)chunk + (_DWORD)v79);
    if ( HIDWORD(v82) == 0x7FFFFFFF )
      sub_33D1AC("basic_string::append");
    sub_33C348(&v82, &word_3E1FAC, 1);
    v40 = strlen((const char *)p_object_base);
    if ( 0x7FFFFFFF - HIDWORD(v82) < v40 )
      sub_33D1AC("basic_string::append");
    v41 = (int *)sub_33C348(&v82, p_object_base, v40);
...
LABEL_66:
        ...
        *chunk_size = 0;
        if ( (char **)v84.chunk_size != &v84.object_base )
          sub_339E8C((void *)v84.chunk_size);
        if ( (_DWORD *)v82 != v83 )
          sub_339E8C((void *)v82);
        v39 = v79;
        goto LABEL_71;
...
LABEL_71:
  ...
  BYTE1(s[32]) = 0;
  sub_93198(&obstack, 100, "/proc/%d/stat", v3);
  sub_231864(&v82, 0, &obstack);
  ...
  if ( (_DWORD)v82 )
  {
    ...
    v53 = (const char *)sub_935F8(v50);
    v54 = strrchr(v53, 41);
    if ( v54 )
    {
      v55 = (const char *)sub_935F8(v54 + 1);
      if ( sscanf(v55, "%c%d%d%d%*d%*d%u%*s%*s%*s%*s%*s%*s%*s%*s%*s%ld", c, &s[5], &s[6], &s[7], &v75, &v76) == 6 )
      {
        ...
        BYTE1(s[0]) = v56;
        s[1] = v75;
        sub_93198(&obstack, 100, "/proc/%d/status", v3);
        sub_231864(&v84, 0, &obstack);
        v59 = v84.chunk_size;
        ...
        if ( v84.chunk_size )
        {
          if ( !*(_BYTE *)v84.chunk_size )
            goto LABEL_104;
          v61 = sub_338BFC(v84.chunk_size, "Uid:");
          if ( v61 )
          {
...
LABEL_73:
  ...
  if ( ptr )
    free(ptr);
  if ( ((int (__fastcall *)(char *))loc_16661C)(a1) == 64 )
    v4 = sub_2DA79C(a2, 0, a3, s);
  else
    v4 = sub_2DA5C4(a2, 0, a3, s);
  v5 = v4;
LABEL_6:
  v6 = sub_92E50(v4);
  sub_2407BC();
  v7 = sub_92E68(v6);
  v8 = ((int (__fastcall *)(int))loc_23DC0C)(v7);
  v9 = *(_DWORD *)(v8 + 144);
  v10 = (_DWORD *)v8;
  if ( !v9 )
  {
    v34 = sub_23E4C8(sub_348E8, 0);
    if ( v34 )
    {
      v10 = (_DWORD *)v34;
      v9 = *(_DWORD *)(v34 + 144);
...
LABEL_15:
  ...
  if ( !v81[0] )
    return 0;
  v15 = (void *)sub_23059C(&dword_4899A0, 7, 0, &ptr);
  if ( (int)v15 > 0 )
  {
    v14 = sub_2DA3D8(a2, v14, a3, (int)"CORE", 6, ptr, (int)v15);
    v15 = ptr;
    if ( ptr )
      free(ptr);
    if ( !v14 )
  ...
  v16 = sub_16F67C(v15);
  v72 = ((int (__fastcall *)(int))loc_165BE0)(v16);
  v73 = sub_23059C(&dword_4899A0, 1, 0, src);
  if ( v73 >= 1 )
  {
    v70 = 0;
    while ( 2 )
    {
      v17 = off_34CEB8;
      v18 = sub_15C278((char *)src[0] + v70, 4, v72);
      v19 = "object-id";
      v20 = v18;
      while ( 1 )
      {
        sub_93198(&v84, 32, "%d/%s", v20, v19);
        v22 = sub_23059C(&dword_4899A0, 1, &v84, &v82);
        v23 = v22;
        if ( v22 >= 1 )
        {
          sub_93198(&obstack, 32, "SPU/%s", &v84);
          v14 = sub_2DA3D8(a2, v14, a3, (int)&obstack, 1, (void *)v82, v23);
          if ( (_DWORD)v82 )
            free((void *)v82);
          if ( !v14 )
          {
  ...
  v25 = ((int (__fastcall *)(char *))loc_165F08)(a1);
  v26 = sub_1773EC(a1, v25, 0, "long");
  obstack_begin(&v84, 0, 0, (void *(*)(int))sub_93050, sub_33B78);
  obstack_begin(&obstack, 0, 0, (void *(*)(int))sub_93050, sub_33B78);
  ...
  v84.next_free += v30;
  sub_34EB4(
    (void (__fastcall *)(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _BOOL4, _BOOL4, _BOOL4, int, char *, int))sub_34A40,
    (int)&v82);
  if ( v82 )
  {
    sub_26DA10(v84.object_base, v26, v82, HIDWORD(v82));
    ...
    v84.next_free += v33;
    v14 = sub_2DA3D8(a2, v14, a3, (int)"CORE", 1179208773, v84.object_base, v67);
  }
