int __fastcall sub_90364(__int64 a1)
{
  int *v1; // r9
  int v2; // r4
  int v3; // r5
  ...
  {
    v4 = (const char *)sub_90094(a1, (_DWORD *)HIDWORD(a1));
    v5 = sub_8D0FC(v4, dword_487CD0);
    if ( !v5 )
      sub_94708("No typed name '%s' in current context", v4);
  }
  else
  {
...
LABEL_43:
      sub_94708("Negative array length", HIDWORD(v10));
    }
    v2 = HIDWORD(a1);
    v3 = a1;
    switch ( *(_DWORD *)(HIDWORD(a1) + 4) )
    {
      ...
      case 0x12:
        goto LABEL_9;
      case 2:
        LODWORD(v10) = sub_90364(a1, *(_DWORD *)(HIDWORD(a1) + 16));
        v11 = *(_QWORD *)(v2 + 40);
        if ( v11 < 0 )
          goto LABEL_43;
        v5 = sub_172168(v10, (unsigned __int64)(v11 - 1) >> 32, 0, 0, v11 - 1, (unsigned __int64)(v11 - 1) >> 32);
LABEL_7:
        while ( !v5 )
        {
          a1 = sub_94728(
                 ...
                 "result != NULL");
LABEL_9:
          v9 = sub_90364(a1, *(_DWORD *)(HIDWORD(a1) + 16));
          v5 = sub_1700E8(v9);
        }
        break;
      case 3:
        v1 = &dword_4751A0;
        sub_8FFF8(&ptr, a1, *(int ***)(HIDWORD(a1) + 16));
        v2 = dword_4751A4;
        ...
        goto LABEL_41;
      case 7:
        sub_8FFF8(&s, a1, *(int ***)(HIDWORD(a1) + 40));
        v32 = sub_90364(v3, *(_DWORD *)(v2 + 16));
        v33 = s;
        if ( v38 == s )
          v33 = 0;
        v34 = ((int (__fastcall *)(int, int, char *))loc_1715E4)(v32, (v38 - s) >> 2, v33);
        v5 = sub_1700E8(v34);
        if ( s )
          sub_339E8C(s);
        goto LABEL_7;
      case 0x16:
        v7 = sub_8C474("usize");
        v8 = sub_90364(v3, *(_DWORD *)(v2 + 16));
        v5 = sub_1FB848("&[*gdb*]", v8, v7);
        goto LABEL_7;
      default:
        sub_94728(
          "rust-exp.y",
...
LABEL_13:
        ...
        *(_DWORD *)(v24 + 8) = v31;
        v5 = sub_8D0FC(v28, dword_487CD0);
        if ( !v5 )
          sub_94708("could not find tuple type '%s'", v28);
        if ( ptr )
          sub_339E8C(ptr);
        break;
    }
