void __fastcall sub_27CE6C(int a1, int a2, int a3)
{
  int v3; // r4
  int v4; // r5
  int v5; // r6
  ...
  if ( (*(_DWORD *)(a2 + 20) & 3) == 3 && *(_DWORD *)(a2 + 36) )
  {
    ...
    *(_DWORD *)(a1 + 156) = 0;
    s[7] = v15(a1);
    v16 = sub_92564((int)sub_27CAB4, (int)v34);
    v17 = *(_DWORD *)(a2 + 36);
    v18 = v16;
    v35[1] = 1;
    v35[0] = 0;
    ...
    v35[5] = 0;
    v19 = sub_93050(v17);
    sub_92564(2607848, (int)v19);
    v20 = sub_2A7B7C(a1, s, v35, v19, 0, a3);
    if ( !v20 )
    {
      v23 = *(const char **)a1;
      v24 = *(const char **)a2;
      ...
      sub_94708("Cannot map compiled module \"%s\" section \"%s\": %s", v23, v24, v26);
    }
    if ( v19 == (void *)v20 )
    {
      v21 = *(_DWORD *)(a2 + 28);
      v22 = sub_2304AC(v21, (int)v19, *(_DWORD *)(a2 + 36));
      if ( v22 )
      {
        v27 = *(const char **)a1;
        v28 = *(const char **)a2;
        v29 = sub_16F67C(v22);
        v30 = sub_25ACB4(v29, v21);
        v31 = sub_16F67C((int)v30);
        v32 = sub_25ACB4(v31, v21 + *(_DWORD *)(a2 + 36));
        sub_94708(
