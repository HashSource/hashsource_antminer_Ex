int *__fastcall sub_4DC30(_DWORD *a1, int a2)
{
  int v4; // r4
  char *v5; // r3
  int v6; // r0
...
LABEL_15:
    v15 = sub_94728(
            ...
            "i != count");
    return (int *)sub_4DD64(v15, HIDWORD(v15));
  }
  v5 = sub_4D7A4();
  v6 = v4;
  if ( !v5 )
...
LABEL_6:
  ...
  v16[0] = a2;
  result = (int *)sub_4492C(v17[0], v17[1], v17[2], (int (__fastcall *)(int, int))sub_4DE94, (int)v16);
LABEL_12:
  if ( v13 == v7 )
    goto LABEL_15;
  return result;
