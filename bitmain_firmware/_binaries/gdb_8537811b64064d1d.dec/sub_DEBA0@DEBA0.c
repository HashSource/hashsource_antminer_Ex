void __fastcall sub_DEBA0(int **a1, _DWORD *a2)
{
  int *v3; // r6
  int v5; // r1
  _DWORD *v6; // r6
...
LABEL_25:
    ...
    sub_93200((char **)ptr, "Type commands for breakpoint(s) %s, one per line.", (const char *)*a1[2]);
    v17 = sub_C721C;
    if ( (unsigned int)(a2[3] - 27) > 2 )
      v17 = 0;
    v18 = *a1;
    sub_580A4(&v28, (int)ptr[0], *a1[3], 1, (void (__fastcall *)(_DWORD, int))v17, (int)a2);
    v19 = v28;
    sub_E048C(&v29, &v28);
    v20 = v29;
    if ( v29 )
...
LABEL_2:
  ...
  if ( (unsigned int)(a2[3] - 27) > 2 )
    ...
    ((void (__fastcall *)(_DWORD *))loc_C9484)(a2);
  v6 = (_DWORD *)a2[12];
  v7 = **a1;
  v8 = (_DWORD *)(*a1)[1];
  a2[11] = v7;
