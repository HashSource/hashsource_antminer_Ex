int __fastcall sub_229880(int a1, int a2, int a3, int a4, int a5, int a6)
{
  _DWORD *v9; // r0
  int v10; // r5
  _DWORD *v11; // r0
  ...
  sub_2594D8(*v9, "-> %s->to_set_syscall_catchpoint (...)\n", (const char *)dword_489C90);
  v10 = off_489D78(&unk_489C8C, a2, a3, a4, a5, a6, a5, a6);
  v11 = (_DWORD *)sub_242FF0(v10);
  sub_2594D8(*v11, "<- %s->to_set_syscall_catchpoint (", (const char *)dword_489C90);
