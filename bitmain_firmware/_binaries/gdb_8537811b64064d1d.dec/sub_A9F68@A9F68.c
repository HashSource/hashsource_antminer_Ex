int __fastcall sub_A9F68(int a1, int a2, int a3, int a4, int a5)
{
  int v6; // r4
  unsigned int v7; // r5
  int v8; // r0
      ...
      else
      {
        ...
        if ( v28 )
        {
          ...
          if ( v34 )
            v34 += v35;
          v36 = sub_A25C0(v30);
          v37 = sub_A9F10(v36, v33, v34, v31, 0);
          v38 = *(_DWORD *)(v37 + 20);
...
LABEL_91:
    ...
    if ( v86 != -1 )
    {
      ...
      if ( a3 )
        ...
        v62 = 0;
      v63 = sub_A9B34(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 24) + 24) + v59 + 12), a2, v62, a4);
      if ( v63 )
      {
  ...
  else
  {
    ...
    if ( v67 )
      sub_946D8("Invalid type size for `%s' detected: %d.", v67, 0);
    else
      sub_946D8("Invalid type size for <unnamed> detected: %d.", 0);
  }
  sub_26C328(v91);
  if ( *(_DWORD *)(v10 + 20) > *(_DWORD *)(v90 + 0x24) )
    sub_94708("record type with dynamic size is larger than varsize-limit");
  return v10;
}
