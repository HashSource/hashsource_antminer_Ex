        ...
        ...)
{
  ...
  if ( v32 )
  {
    v23 = sub_CFD68(varg_r2, varg_r3, a5, a6);
    if ( !v23 )
      v23 = a2;
    sub_C87C4(v23, varg_r2, a8, a6, -1);
  }
  ((void (__fastcall *)(_DWORD *, int, int, int, int, int, int, int, int, int, int, int, int, int))loc_D01A4)(
    a1,
    a2,
    varg_r2,
    varg_r3,
  ...
  a1[4] = v17;
  v19 = sub_194460(14);
  result = sub_19DC08(var4, (int *)va, v19, 0);
  v21 = a1[19];
  v22 = var4[0];
  var4[0] = 0;
  a1[19] = v22;
  if ( v21 )
  {
    result = ((int (__fastcall *)(_DWORD *))loc_19D17C)(a1 + 19);
    if ( var4[0] )
      result = ((int (__fastcall *)(_DWORD *))loc_19D17C)(var4);
  }
  a1[23] = 14;
  return result;
}
