int sub_1895AC()
{
  ...
  dword_487974 = (int)sub_153298((int)sub_1851E8, 0);
  sub_539B4(
    "signals",
    (int)sub_1874F4,
    (int)"What debugger does when program gets various signals.\n"
         "Specify a signal as argument to print info on that signal only.");
  sub_547B0((int)"handle", (unsigned __int8 *)"signals", 0);
  v0 = sub_539E8(
         "handle",
         0,
         (int)sub_186850,
  ...
  sub_53274(v0, 1599396);
  if ( !dword_487A74 )
    dword_4879AC = sub_5329C(
                     "stop",
                     10,
                     (int)nullsub_62,
  ...
  sub_535E0(
    ...
    (int **)&dword_47475C,
    (int **)&dword_47474C);
  dword_48797C = (int)sub_93050(0x98u);
  dword_487980 = (int)sub_93050(0x98u);
  dword_487948 = (int)sub_93050(0x98u);
  dword_487984 = (int)sub_93050(0x98u);
  v1 = sub_93050(0x98u);
  ...
  *(_BYTE *)(v4 + 2) = 0;
  ...
  sub_1B9F60(1592392);
  sub_1B9958(sub_185C08);
  sub_1B9898(sub_1874C4);
  sub_1BA1C4(1598476);
  sub_26CBB8("_siginfo", &off_3BBE94, 0);
  return sub_535E0(
           "observer",
           -1,
           (int)&dword_487990,
