void __fastcall sub_14A6E8(_DWORD *a1)
{
  _DWORD *v1; // r4
  __int64 v2; // r6
  double v3; // r0
  ...
  {
    sub_149468((int)(v1 + 7), v7 - HIDWORD(v6));
  }
  else if ( (unsigned int)2.0 < HIDWORD(v6) )
  {
    v1[8] = v6 + 4 * v7;
  }
  sub_1485E4((int)(v1 + 10), v138);
  ...
  do
  {
    ...
    HIDWORD(v2) = (unsigned __int64)sub_34769C(v2, (HIDWORD(v2) - (int)v12) >> 2) >> 32;
    v18 = sub_98394(0xCu);
    *v18 = v12[HIDWORD(v2)];
    v18[1] = v2;
    v18[2] = v11;
...
LABEL_139:
    ...
    sub_15C374(v1[7] + 4 * v137, 4, v1[13], v1[7], (v19 >> 2) + 1, 0);
    v23 = (char *)v1[11];
    v129 = (_DWORD *)*v21;
    if ( !*v21 )
    {
...
LABEL_16:
    ...
    sub_15C374(v25 - 4, 4, v1[13], v129[1], v129[1], 0);
    LODWORD(v2) = v129[2];
    v26 = v1[39];
    v127 = v1 + 41;
    v27 = *(const char **)(v2 + 4);
    ...
    v34 = sub_34769C(v30, v1[42]);
    v35 = sub_149BF4(v127, SHIDWORD(v34), &v139, v30);
    if ( v35 && *v35 )
    {
    ...
    else
    {
      ...
      v93 = (const char **)sub_98394(0x10u);
      v94 = v91 - v90;
      v95 = 0;
      ...
      *v93 = 0;
      ...
      v100 = (unsigned __int64)sub_34769C(v95, v1[42]) >> 32;
      v101 = sub_149BF4(v127, v100, v96, v95);
      if ( v101 && *v101 )
        sub_339E8C(ptra);
      else
        sub_14A5F0(v127, v100, v95, ptra);
      v102 = strlen(v27);
      v103 = v1[50];
      v104 = v102;
      v105 = v1[49];
    ...
    while ( 1 )
    {
      ...
      v40 = (unsigned __int64)sub_34769C(v39, v38) >> 32;
      v134 = v40;
      v41 = *(int ***)(v1[52] + 4 * v40);
      if ( v41 )
      {
        ...
        while ( v39 != v43 || v128 != v42[1] || *((unsigned __int8 *)v42 + 8) != v131 || ptr != (void *)v42[3] )
        {
          if ( *v42 )
          {
            ...
            v41 = (int **)v42;
            v42 = (int *)*v42;
            if ( v40 == (unsigned __int64)sub_34769C(v43, v38) >> 32 )
              continue;
          }
          goto LABEL_100;
        }
...
LABEL_116:
      ...
      else
      {
        ...
        *v76 = v89;
        if ( v89 )
          v80[(unsigned __int64)sub_34769C(*(_DWORD *)(v89 + 20), v1[53]) >> 32] = v76;
        v80[v134] = v136;
      }
      v45 = v76 + 4;
      ++v1[55];
...
LABEL_113:
      ...
      v1[53] = v79;
      v1[52] = v80;
      v134 = (unsigned __int64)sub_34769C(v39, v79) >> 32;
      goto LABEL_116;
    }
    while ( 1 )
    {
