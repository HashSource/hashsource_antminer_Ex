        ...
        char *s1)
{
  ...
  while ( 1 )
  {
    ...
    if ( a4 )
      break;
    v23 = sub_94728((int)"exec.c", 790, "failed internal consistency check", 0);
    v32 = v8;
    v33 = v24;
    v25 = HIDWORD(v23);
    v27 = v26;
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v15 > v9 )
    {
      ...
      v18 = v9 - v14;
      if ( v12 )
        v19 = sub_2ADE10(v16, v13, v12, SHIDWORD(v18), v18, SHIDWORD(v18), na);
      else
        v19 = sub_2ADF04(v16, v13, v11, SHIDWORD(v18), v18, SHIDWORD(v18), na);
      if ( v19 )
      {
        *a5 = v17;
        return 1;
...
LABEL_13:
  ...
  v21 = v9 - v14;
  if ( v12 )
    v22 = sub_2ADE10(v16, v13, v12, SHIDWORD(v21), v21, SHIDWORD(v21), a4);
  else
    v22 = sub_2ADF04(v16, v13, v11, SHIDWORD(v21), v21, SHIDWORD(v21), a4);
  if ( v22 )
  {
    *a5 = a4;
    return 1;
