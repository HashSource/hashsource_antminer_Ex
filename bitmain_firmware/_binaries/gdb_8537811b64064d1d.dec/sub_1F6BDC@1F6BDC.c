void __fastcall sub_1F6BDC(const char *a1)
{
  int v1; // r4
  int v2; // r7
  int v3; // r5
...
LABEL_14:
  ...
  if ( sub_1F5FBC(&v17, &v18) || (v2 = v18, sub_1F5FBC(&v17, &v19)) )
  {
LABEL_13:
    sub_1F61CC(-1, 5);
    return;
  ...
  if ( v1 == -2 )
  {
    ...
    {
      v14 = sub_25686C(dword_487A3C, v4, 0x3FFF);
      v15 = v14 > 0;
      ...
      {
        v16 = v14 - v3;
        dword_489354 = (int)sub_93050(v14 - v3);
        dword_489358 = v16;
