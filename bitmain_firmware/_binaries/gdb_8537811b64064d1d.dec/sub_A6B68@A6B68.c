bool __fastcall sub_A6B68(int a1, int a2, int a3, int a4)
{
  ...
  if ( *(_DWORD *)a3 == 2 )
  {
    v7 = (int (__fastcall *)(int, int, _DWORD))sub_9AA74;
  }
  else if ( *(_BYTE *)(a3 + 4) )
  {
    v7 = (int (__fastcall *)(int, int, _DWORD))sub_A462C;
  }
  else
  {
    v7 = (int (__fastcall *)(int, int, _DWORD))sub_A4348(a3);
  }
  for ( i = (_DWORD *)sub_C2640(a2); i; i = (_DWORD *)i[4] )
  {
    if ( i[5] || *i && *(_BYTE *)*i )
      continue;
    v9 = (_BYTE *)i[1];
    ...
    *(_DWORD *)((char *)v44 + 3) = 0;
    v28 = v22[1];
    sub_A4924(a1, a2, (int)&v24, a4, 1, 0);
