int __fastcall sub_33883C(int a1, int a2, char *a3, unsigned int a4)
{
  size_t v7; // r8
  int *v8; // r3
  char *v9; // r1
  ...
  if ( a4 )
  {
    ...
    {
      v36 = v16 + a4;
      v37 = sub_338618((char *)(a1 + i), 0, v16 + a4 - i);
      v38 = v16 + a4;
      if ( v16 + a4 )
        v38 = 1;
      if ( v37 )
...
LABEL_9:
    ...
    {
      v19 = v16 + a4;
      v20 = sub_338618((char *)(a1 + j), 0, v16 + a4 - j) == 0;
      if ( !(v16 + a4) )
        v20 = 0;
      if ( !v20 )
        return 0;
