        ...
        char a14)
{
  ...
  if ( *(_DWORD *)(v14 + 8) != *(_DWORD *)(v14 + 4) )
  {
    ...
    do
    {
      ((void (__fastcall *)(void **, _DWORD))loc_19CF8C)(&v26, *(_DWORD *)(a2 + 4));
      v17 = sub_98394(0xA8u);
      memset(v17, 0, 0xA8u);
      v18 = *(_DWORD *)(v14 + 4);
      *((_BYTE *)v17 + 32) = 0;
      ...
      *a4 = 0;
      ptr = v22;
      sub_DDE50((int)v17, v25, v30, v31, &v26, (int *)&v27, &v28, &ptr, a5, a6, a7, a8, a9, a10, a11, a12, a14, v21);
      if ( ptr )
        free(ptr);
      if ( v28 )
        free(v28);
      ...
      v17[41] = v16;
      v30 = v17;
      sub_D906C(a13, (int *)&v30, 0);
      result = v30;
      if ( v30 )
        result = (int *)(*(int (__fastcall **)(int *))(*v30 + 4))(v30);
      if ( v26 )
        result = (int *)((int (__fastcall *)(void **))loc_19D17C)(&v26);
      ++v16;
    }
