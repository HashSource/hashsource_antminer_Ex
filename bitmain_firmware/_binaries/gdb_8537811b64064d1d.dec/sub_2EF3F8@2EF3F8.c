size_t __fastcall sub_2EF3F8(int a1, _BYTE *a2, int a3)
{
  int v4; // r9
  size_t result; // r0
  size_t v6; // r10
  ...
  *a2 = 65;
    ...
    if ( result )
    {
      ...
      *v12 = 1;
      ...
      do
      {
        ...
        result = sub_2EF0E4(v19);
        if ( !result )
        {
          result = (size_t)sub_2EF1AC(v14, v20, v19);
          v14 = (_BYTE *)result;
        }
        ++v15;
      }
      ...
      {
        result = sub_2EF0E4(i + 2);
        if ( !result )
        {
          result = (size_t)sub_2EF1AC(v14, i[1], v22);
          v14 = (_BYTE *)result;
        }
      }
    }
  ...
  if ( a3 != v7 )
    sub_2A6C18((int)"elf-attrs.c", 225, (int)"bfd_elf_set_obj_attr_contents");
  return result;
}
