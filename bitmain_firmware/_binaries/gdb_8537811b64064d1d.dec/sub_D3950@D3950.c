void sub_D3950()
{
  ...
  if ( v0 )
  {
    ...
    do
    {
      while ( 1 )
      {
        v9 = (_DWORD *)sub_CB2DC((int)v0);
        if ( !v9[18] )
        {
          sub_1CA898(&ptr, v0, v23, v24);
        ...
        if ( (_UNKNOWN *)v9[16] != &unk_478868 )
        {
          ...
          if ( v2 )
            goto LABEL_5;
          sub_1B1444((int)&ptr, "_Unwind_DebugHook");
          if ( ptr )
          {
            v19 = (__int16 *)ptr;
            v20 = v28;
...
LABEL_5:
            ...
            if ( v4 == -1 )
            {
              sub_94728((int)"breakpoint.c", 3502, "Section index is uninitialized");
              v21 = ptr;
              if ( ptr )
                sub_339E8C(ptr);
              sub_339024(v21);
            }
            v5 = ((int (__fastcall *)(int, int, int *))loc_169F00)(
                   v3,
                   *((_DWORD *)v2 + 2) + *(_DWORD *)(*(_DWORD *)(v9[17] + 144) + 4 * v4),
                   &dword_4899A0);
            v6 = sub_D03C8(v3, v5, 25, (int)&unk_47849C);
            sub_19CCA0(&ptr);
            v28 = v22;
            ...
            *(_DWORD *)(v6 + 76) = v8;
            if ( v7 )
            {
              ((void (__fastcall *)(int))loc_19D17C)(v6 + 76);
              if ( v26 )
                ((void (__fastcall *)(int *))loc_19D17C)(&v26);
            }
            *(_DWORD *)(v6 + 16) = 0;
            goto LABEL_10;
          }
...
LABEL_10:
      ...
      do
      {
        ...
        v15 = sub_D03C8(v25, v14, 25, (int)&unk_47849C);
        sub_19CE58(&ptr, "-probe-stap libgcc:unwind");
        v16 = ptr;
        ptr = 0;
        v17 = *(_DWORD *)(v15 + 76);
        *(_DWORD *)(v15 + 76) = v16;
        if ( v17 )
        {
          ((void (__fastcall *)(int))loc_19D17C)(v15 + 76);
          if ( ptr )
