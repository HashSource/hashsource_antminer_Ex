void **__fastcall sub_18810(void **a1, int (***a2)(void))
{
  int (**v2)(void); // r2
  int (*v5)(void); // r2
  int v6; // r0
      ...
      switch ( HIBYTE(v67) & 0xF )
      {
        ...
        case 0xE:
          if ( (unsigned __int16)v67 >> 12 == 15 )
            sub_94708("Invalid update to pc in instruction");
          return result;
        default:
          break;
      }
    }
    else if ( sub_18310(v67 >> 28, v68) )
    {
      switch ( HIBYTE(v67) & 0xF )
      {
        case 4:
        ...
        case 7:
          ...
          if ( v82 == 15 )
            ...
            v83 = sub_93014(v59, v82);
          if ( (v67 & 0x1000000) != 0 )
          {
            if ( (v67 & 0x2000000) != 0 )
              v114 = sub_186F8(v59, v67, (v68 >> 29) & 1, v66);
            else
              v114 = v67 & 0xFFF;
            if ( (v67 & 0x800000) != 0 )
              v83 += v114;
        ...
        case 9:
          if ( (v67 & 0x108000) != 0x108000 )
            goto LABEL_101;
          v79 = sub_93014(v59, HIWORD(v67) & 0xF);
          if ( (v67 & 0x800000) != 0 )
          {
            v113 = sub_182E8(v67 & 0x7FFF);
            v122 = 4 * v113;
            if ( (v67 & 0x1000000) != 0 )
              v122 = 4 * v113 + 4;
          }
        ...
        default:
          ...
          if ( (v67 & 0x3C00000) == 0 && (unsigned __int8)v67 >> 4 == 9 )
            sub_94708("Invalid update to pc in instruction");
          if ( (_UNKNOWN *)((v67 >> 4) & 0xFFFFFD) != &loc_12FFF0 )
          {
            v108 = HIWORD(v67) & 0xF;
            v109 = (v68 >> 29) & 1;
            if ( v108 == 15 )
              ...
              v110 = sub_93014(v59, v108);
            if ( (v67 & 0x2000000) != 0 )
              v111 = __ROR4__((unsigned __int8)v67, 2 * (BYTE1(v67) & 0xF));
            else
              v111 = sub_186F8(v59, v67, (v68 >> 29) & 1, v66);
            switch ( (v67 >> 21) & 0xF )
            {
              case 1u:
                v111 ^= v110;
...
LABEL_105:
  ...
  v126 = -1;
  v115 = sub_1DFB64(v9);
  v10 = sub_93014(a2[4], 25);
  v11 = BYTE1(v10);
  LODWORD(v12) = (v10 >> 25) & 3;
  HIDWORD(v12) = v11 & 0xC;
  if ( v12
    || (v13 = ((int (__fastcall *)(unsigned int, int, int (**)(void)))**a2)(v115, 2, v8), sub_182C4(v13) != 4)
...
LABEL_43:
  ...
  v136 = 0;
  v137 = 0;
  sub_19D0C(&v135, &v138, v54);
  if ( v119 )
  {
    v138 = v126 | 1;
    sub_19D0C(&v135, &v138, v56);
  }
  v17 = v135;
  v16 = v136;
  v15 = v137;
...
LABEL_30:
  ...
  if ( !a2[3] )
  {
    ...
    if ( !sub_18310((unsigned int)v116 >> 4, v27) )
    {
      v138 = (sub_182C4(v25) + v23) | 1;
      sub_19D0C(&ptr, &v138, v89);
    }
    goto LABEL_20;
  }
  v121 = v25 & 0xFF00;
  if ( v121 == 48896 )
  {
    if ( (v25 & 0xF) != 0 )
    {
      ...
      v29 = sub_182C4(v25) + v23;
      if ( v92 )
      {
        do
        {
          if ( sub_18310(v92 >> 4, v28) )
            break;
...
LABEL_90:
        ...
        if ( (v26 & 0xFF70) != 0xF850 || (v85 & 0xF000) != 0xF000 )
        {
          if ( (v26 & 0xFFF0) == 0xE8D0 )
          {
            ...
            {
              if ( (v26 & 0xF) != 0xF )
                v70 = sub_93014(v24, v26 & 0xF);
              v112 = sub_93014(v24, v86 & 0xF);
        ...
        else
        {
          ...
          if ( (v86 & 0x800) == 0 )
          {
            if ( (v86 & 0xFC0) != 0 )
              goto LABEL_160;
            v103 = v102 + (sub_93014(v24, v86 & 0xF) << ((v86 >> 4) & 3));
LABEL_197:
...
LABEL_13:
      ...
      {
        v29 = sub_182C4(v25) + v23;
        for ( i = sub_18428(v116); ; i = sub_18428(v97) )
        {
          v97 = i;
          if ( !i || sub_18310(i >> 4, v28) )
            break;
...
LABEL_153:
  ...
  v90 = 4 * sub_182E8((unsigned __int8)v25);
  v91 = sub_93014(v24, 13);
