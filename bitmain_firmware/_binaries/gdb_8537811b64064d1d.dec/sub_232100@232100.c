_DWORD *sub_232100(_DWORD *a1, int a2, ...)
{
  _DWORD *v3; // r0
  int v4; // r0
  int v5; // r1
  ...
  *a1 = v32[0];
  a1[1] = v5;
  a1[2] = v6;
  v7 = (_DWORD *)sub_242FF0(v4);
  sub_2594D8(*v7, "<- %s->to_wait (", (const char *)dword_489C90);
