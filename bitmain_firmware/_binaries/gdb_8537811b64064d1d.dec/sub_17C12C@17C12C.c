int __fastcall sub_17C12C(const char *a1)
{
  void *v1; // r4
  char *v2; // r7
  char *next_free; // r5
  ...
  if ( !a1 )
    return 0;
  v1 = (void *)sub_17BDB8(a1, (int *)&v27, &v28, &s, &v30, &v31);
  if ( !v1 )
    return 0;
  obstack_begin(&obstack, 0, 0, (void *(*)(int))sub_93050, sub_17BA1C);
  v2 = s;
  if ( s )
  {
