int __fastcall sub_259F74(char *a1, int a2, void *a3)
{
  int v3; // r6
  int v4; // r9
  int v5; // r11
...
LABEL_30:
      ...
      {
        v13 = (const char *)v26;
        v14 = (const char *)&unk_3F34C8;
        v15 = (const char *)&unk_3F34D8;
      }
      sub_93200((char **)&ptr, "%s%s(%s or %s) %s", v14, v13, v7, v6, v15);
      sub_33B284(&v23);
      v16 = off_46D458;
      v24[1] = &off_46D458;
      ...
      while ( 1 )
      {
        v20 = (int *)sub_242FB4();
        sub_256834(*v20);
        v21 = (unsigned __int8 *)sub_243CDC((char *)ptr);
        if ( !v21 )
        {
          sub_259F38("EOF [assumed %c]\n", v4);
          goto LABEL_47;
        }
        v18 = *v21;
        free(v21);
        ...
        if ( v19 )
          goto LABEL_47;
        sub_259F38("Please answer %s or %s.\n", v7, v6);
      }
      v3 ^= 1u;
LABEL_47:
      sub_33B284(&v23);
    ...
    else
    {
      ...
      sub_259B80("");
      v10 = (int *)sub_242FB4();
      sub_259EAC(*v10, a1, a3);
      sub_259F38("(%s or %s) [answered %c; input not from terminal]\n", v7, v6, v4);
      v11 = (int *)sub_242FB4();
      sub_256834(*v11);
      if ( ptr == (void *)1 )
        goto LABEL_30;
