int __fastcall sub_2F4288(int *a1, int a2, int a3, char *src)
{
  _DWORD *v5; // r1
  int *v6; // r7
  void *v7; // r0
  ...
  if ( !v110 )
    sub_2A6BE4("elf-eh-frame.c", 1930);
  v5 = *(_DWORD **)(a2 + 28);
...
LABEL_21:
      ...
      if ( v20 == 4 )
      {
        if ( v15 == v16 - 32 )
          goto LABEL_64;
        v15 += 32;
        sub_2A6BE4("elf-eh-frame.c", 1971);
        if ( v15 >= v16 )
          return sub_2ADE10(
                   (int)a1,
                   *(_DWORD **)(a3 + 60),
...
LABEL_95:
            ...
            {
              if ( (v106 & 1) == 0 )
                sub_2A6BE4("elf-eh-frame.c", 2033);
              *v67++ = 82;
              v77 = v110 - 2;
                ...
                switch ( v80 )
                {
                  case 'L':
                    if ( (v79 & 2) != 0 )
                    {
                      ...
                      {
                        sub_2A6BE4("elf-eh-frame.c", 2045);
                        LOBYTE(v88) = *v78;
                      }
                      if ( (v88 & 0x7F) == 0 )
                      {
                  ...
                  case 'P':
                    ...
                    v109 = v83;
                    v100 = 0;
                    sub_2A6BE4("elf-eh-frame.c", 2056);
                    v83 = v109;
LABEL_131:
                    v86 = v83 & 0x70;
                    ...
                    {
                      v108 = v83;
                      sub_2A6BE4("elf-eh-frame.c", 2058);
                      v83 = v108;
                    }
                    if ( v86 == 80 )
...
LABEL_138:
                  ...
                  case 'R':
                    if ( (v79 & 1) != 0 )
                    {
                      ...
                      {
                        sub_2A6BE4("elf-eh-frame.c", 2086);
                        LOBYTE(v87) = *v78;
                      }
                      if ( (v87 & 0x7F) == 0 )
                      {
...
LABEL_151:
                  ...
                  case 'S':
                    goto LABEL_137;
                  default:
                    sub_2A6BE4("elf-eh-frame.c", 2095);
                    continue;
                }
              }
            }
        ...
        else
        {
          ...
          if ( (*(_BYTE *)a2 & 3) != 2 )
          {
            ...
            {
              v31 = sub_2F18CC(v30, v110);
              v104 = v31;
            }
            v32 = a1 + 1;
            v33 = sub_2F1B18(a1 + 1, v98, v31, (v30 >> 3) & 1);
            v34 = v33;
            if ( v33 )
            {
              ...
              switch ( v35 )
              {
                case 32:
                  if ( v103 )
                  {
                    sub_2A6BE4("elf-eh-frame.c", 2125);
                    v36 = v34;
                  }
                  else
                  {
LABEL_37:
                ...
                case 48:
                  ...
                  if ( v81 != 56 )
                  {
                    if ( v81 == 62 )
                    {
                      ...
                      if ( !v96 )
                      {
                        sub_2A6BE4("elf-eh-frame.c", 2132);
                        v96 = *(_DWORD *)(a1[40] + 524);
                      }
                      v36 = v34 + v96;
                      break;
                  ...
                  {
                    sub_2A6BE4("elf-eh-frame.c", 2146);
                    v82 = v113[29];
                  }
                  v36 = v34
                      + *(_DWORD *)(v82 + 24)
              ...
              v37 = v34;
              v34 = v36;
              sub_2F1BB8((int)v32, v98, v37, v31);
            }
            if ( v103 )
            {
              v38 = v31;
              ...
              *(_DWORD *)(v39 + 4 * v40) = v34;
              v41 = v39 + 4 * v40;
              v42 = sub_2F1B18(v32, v98 + v104, v38, 0);
              v43 = v103[1];
              v44 = v103[6];
              v45 = *(_DWORD *)(a3 + 56);
            ...
            if ( (v48 & 0x70) == 0x10 || (*(_BYTE *)(v29 + 6) & 2) != 0 )
            {
              ...
              if ( (v48 & 0x60) != 0x60 )
                v31 = sub_2F18CC(*(_BYTE *)(v15 + 25), v110);
              v63 = sub_2F1B18(v32, v62, v31, (v48 >> 3) & 1);
              if ( v63 )
              {
                if ( (*(_BYTE *)(v15 + 25) & 0x70) == 0x10 )
                {
                  sub_2F1BB8((int)v32, v62, v63 + *(_DWORD *)(v15 + 16) - *(_DWORD *)(v15 + 20), v31);
                }
                else
                {
                  if ( (*(_BYTE *)(v29 + 6) & 2) != 0 )
                  ...
                  sub_2F1BB8((int)v32, v62, v63, v31);
                }
              }
            }
            ...
            if ( v49 )
            {
              ...
              if ( (v50 & 0x60) == 0x60 )
                ...
                v51 = sub_2F18CC(*(_BYTE *)(v15 + 24), v110);
              ...
              if ( *v49 )
              {
                ...
                while ( 1 )
                {
                  ...
                  v58 = 4 * v56++;
                  v59 = v98 + v57;
                  v60 = sub_2F1B18(v32, v59, v51, (v50 >> 3) & 1);
                  if ( v60 )
                  {
                    ...
                    sub_2F1BB8((int)v32, v59, v60, v51);
                  }
                  v49 = *(unsigned int **)(v15 + 28);
                  if ( *v49 < v56 )
                    break;
