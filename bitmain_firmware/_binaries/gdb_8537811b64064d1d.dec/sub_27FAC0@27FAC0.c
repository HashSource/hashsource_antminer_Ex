int __fastcall sub_27FAC0(int result, int *a2, int a3, int a4)
{
  int v5; // r6
  int v6; // r7
  int v7; // r12
  ...
  if ( *(_BYTE *)(dword_4900CC + 2048) )
    return sub_27F494(256, (int *)dword_4900CC, 0);
