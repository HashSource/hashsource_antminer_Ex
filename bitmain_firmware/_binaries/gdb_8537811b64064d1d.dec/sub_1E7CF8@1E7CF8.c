int __fastcall sub_1E7CF8(const char **a1)
{
  int v2; // r0
  int result; // r0
  _DWORD *v4; // r5
  ...
  if ( *(_DWORD *)(*(_DWORD *)(dword_488C94 + 408) + 4 * (_DWORD)(a1[6] + 2)) )
  {
    if ( dword_48935C )
    {
      ...
      sub_2594D8(*v6, "notif: process: '%s' ack pending event\n", *a1);
    }
    ((void (__fastcall *)(const char **, _DWORD))a1[3])(a1, *v4);
    *(_DWORD *)(v4[102] + 4 * (_DWORD)(a1[6] + 2)) = 0;
    while ( 1 )
    {
      sub_1E4EE0((char **)v4, v4 + 1, 0, 0, 0);
  ...
  {
    v7 = (_DWORD *)sub_242FF0(result);
    return sub_2594D8(*v7, "notif: process: '%s' no pending reply\n", *a1);
  }
  return result;
}
