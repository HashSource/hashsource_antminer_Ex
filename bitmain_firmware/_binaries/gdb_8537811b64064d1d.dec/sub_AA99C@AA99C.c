int __fastcall sub_AA99C(int a1, int a2)
{
  int result; // r0
  int v4; // r4
  int v5; // r6
  ...
  {
    v62 = sub_A0D24(result);
    if ( v62 )
      goto LABEL_63;
    v5 = sub_A0E60(v4, (const char *)&dword_375E58);
    if ( !v5 )
      goto LABEL_42;
LABEL_4:
    v61 = v4;
    ((void (__fastcall *)(int))loc_A0950)(v5);
    do
    {
      v6 = sub_171280(v4);
      v7 = *(_DWORD *)(v5 + 24);
...
LABEL_50:
          ...
          if ( (unsigned int)*(unsigned __int8 *)(v53 + v55) - 48 > 9
            || !sub_9D4A4(v53, v55, &v65, &v63)
            || *(_QWORD *)(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + 24) != v65 )
          {
            break;
          }
          ++v12;
          v56 = sub_171280(*(_DWORD *)(*(_DWORD *)(v8 + 24) + 20));
          v57 = *(_DWORD *)(v5 + 24);
          v8 = v56;
        ...
        if ( v28 > 0 )
        {
          ...
          while ( 1 )
          {
            v31 = *(_DWORD *)(v27 + 24);
            v32 = 3 * (v28 - v30++);
            v33 = ((int (__fastcall *)(_DWORD, int))loc_A7DB8)(*(_DWORD *)(v31 + 8 * v32 - 12), a2);
            v34 = sub_16FF80(v29);
            v4 = sub_17214C(v34, v4, v33);
...
LABEL_42:
      ...
      if ( !v42 )
      {
        ...
        {
          v61 = v4;
          ((void (__fastcall *)(_DWORD))loc_A0950)(0);
          break;
        }
      }
      v43 = strlen(v42);
      ...
      if ( v46 != 80 )
      {
        ((void (__fastcall *)(_DWORD, int, int, _BYTE *))loc_A0950)(0, v44, v46, v59);
        v61 = v4;
        break;
      }
    ...
    while ( v5 );
LABEL_45:
    v47 = sub_A0898(*(_DWORD *)(*(_DWORD *)(v4 + 24) + 20));
    v48 = sub_A9F10(v47, 0, 0, a2, 1);
    v49 = v47 == v48;
    if ( v47 == v48 )
      v49 = !v62;
    if ( v49 )
    ...
    v50 = sub_16FF80(v4);
    v4 = sub_17214C(v50, v48, *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v4 + 24) + 24) + 12));
LABEL_37:
    v35 = *(_DWORD *)(v4 + 24);
    v36 = *(_DWORD *)(v61 + 24);
    v16 = !v62;
    *(_DWORD *)(v35 + 8) = *(_DWORD *)(v36 + 8);
    if ( !v16 )
    {
      v37 = sub_347440(*(_DWORD *)(v4 + 20), *(_DWORD *)(*(_DWORD *)(v35 + 20) + 20));
