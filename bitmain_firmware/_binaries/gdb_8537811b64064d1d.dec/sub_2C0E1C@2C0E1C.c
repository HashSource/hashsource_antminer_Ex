int __fastcall sub_2C0E1C(int a1, int a2, int a3, int *a4, int a5, _DWORD *a6, int a7, int a8)
{
  _DWORD *v8; // r9
  unsigned int v11; // r7
...
LABEL_118:
    ...
    if ( v21 && v22 >> 4 != 2 )
    {
      ...
      v65 = sub_2CD86C(a3, v98[25], *(_DWORD *)(v19 + 8));
      v96(a2, v65, a3, a4, *v8, 1);
    }
    if ( !v93[108] )
    {
      v28 = 0;
      v56 = sub_2DB22C(a1, v90, &v102, v8);
      v23 = (char **)v102;
      v95 = v56;
      goto LABEL_121;
    }
...
LABEL_137:
    ...
    {
      sub_3015C8(v92, a3, a4, a5 + *v8);
      if ( (*(_BYTE *)a2 & 3) == 2
        && (a4[5] & 0x2000) != 0
        && (v57 = sub_2D0604(a4[15]), v58 = *(_DWORD *)(v57 + 24), v59 = *(_DWORD *)(v57 + 40), v58 > v59) )
      {
...
LABEL_28:
    v26 = (char *)sub_2CD86C(a3, v98[25], *(_DWORD *)(v90 + 8));
    s = v26;
    if ( v26 && *v26 )
    {
      if ( v25 )
...
LABEL_32:
        ...
        if ( (v94 == 6) != v30 )
        {
          ...
          sub_2A6A84(v31, a3, a4, *v8, *((_DWORD *)v92 + 8), s);
        }
        goto LABEL_46;
      }
    }
    v28 = v25;
LABEL_46:
    if ( sub_2B5790((_BYTE *)a2, v12, v28) == v14 )
    {
...
LABEL_84:
          v48 = *(_BYTE *)(v28 + 50) & 3;
LABEL_85:
          v49 = sub_2BCB30(v92, a3, a1, a4, a5, v8, v95, a2, (char **)v102, s, v94, v48, v28, &v103, &v104);
          if ( v103 && ((a4[5] & 0x2000) == 0 || (*(_BYTE *)(v28 + 51) & 8) == 0) && sub_2DB314(a1, a2, a4, *v8) != -1 )
          {
            sub_2A6A84(
...
LABEL_207:
          ...
          sub_2A6A84("%B(%A+%#Lx): unexpected ARM instruction '%#lx' in TLS trampoline", a3, a4, v42, v41);
LABEL_60:
          v103 = 0;
LABEL_61:
...
LABEL_210:
          ...
          if ( (v33 & 0xFF87) != 0x4780 )
          {
            ...
            sub_2A6A84("%B(%A+%#Lx): unexpected Thumb instruction '%#lx' in TLS trampoline", a3, a4, v35, v34);
            goto LABEL_60;
          }
          v73 = *(void (__fastcall **)(int, int))(*(_DWORD *)(a3 + 4) + 60);
          v74 = a5 + v35;
...
LABEL_168:
        v105 = v102;
        v70 = sub_2DB2E0(a1, v90, &v105, v69);
...
LABEL_121:
      ...
      sub_2A6A84("%B(%A+%#Lx): %s relocation against SEC_MERGE section", a3, a4, *v8, *((_DWORD *)v92 + 8));
      return 0;
  }
}
