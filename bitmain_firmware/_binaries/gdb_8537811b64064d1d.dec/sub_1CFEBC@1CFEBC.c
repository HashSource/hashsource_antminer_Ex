int __fastcall sub_1CFEBC(char *a1, int a2, _DWORD *a3, int (__fastcall *a4)(_DWORD *, int, int), int a5, int a6)
{
  int v10; // r2
  _BYTE *v11; // r0
  int v12; // r1
  ...
  *(_DWORD *)((char *)v41 + 3) = 0;
  v25 = v19[1];
  for ( i = sub_C2928(a3, (int)&v21, v19); ; i = sub_C2974((int)&v21, (int)v19) )
  {
    v16 = i;
    if ( !i )
    {
    ...
    if ( sub_21D9D8(*(_BYTE *)(i + 20) & 0x1F, *(_BYTE *)(i + 32) & 7, a2) && a4(a3, v16, a5) )
      break;
  }
  v17 = 1;
  if ( !v38 )
