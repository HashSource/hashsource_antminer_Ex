int __fastcall sub_1D60F4(int a1, int *a2, int *a3, _DWORD *a4, int a5)
{
  int v5; // r6
  int v7; // r5
  int v8; // r0
  ...
  if ( dword_487D4C )
  {
    v36 = *(_DWORD *)sub_242FF0(a1);
    v37 = sub_E1798(a3);
    v38 = sub_E1798(a4);
    a1 = sub_2594D8(v36, "[record-btrace] itrace (0x%x): [%u; %u)\n", a5, v37, v38);
  }
  v7 = sub_16F67C(a1);
  v45 = (void *)sub_25799C(v5, "asm_insns");
  sub_10BAE4(v50, v7, (int)v51, (int)sub_10B868);
  sub_256788(v51);
  v51[0] = &off_3F294C;
  v51[1] = &v52;
  v51[2] = 0;
  ...
  v53[0] = &off_3F294C;
  v53[1] = &v54;
  while ( sub_E1A64(v46, a4) )
  {
    v13 = (int *)((int (__fastcall *)(_DWORD *))loc_E16D4)(v46);
    v14 = v13;
    if ( !v13 )
      goto LABEL_42;
    if ( (a5 & 0x20) == 0 )
...
LABEL_39:
      if ( v11 )
        goto LABEL_35;
      v11 = (void *)sub_25795C(v5, "src_and_asm_line");
      sub_25799C(v5, "line_asm_insn");
      if ( v11 )
        goto LABEL_35;
      goto LABEL_41;
    }
...
LABEL_22:
    ...
    do
    {
      if ( v11 )
        sub_92648(v11);
      v11 = (void *)sub_25795C(v5, "src_and_asm_line");
      sub_2053F8(v17, v26, v26 + 1, (a5 >> 2) & 2);
      sub_25799C(v5, "line_asm_insn");
      ++v26;
    }
    while ( v20 != v26 );
...
LABEL_35:
      ...
      if ( (v28 & 1) != 0 )
        LOBYTE(v49) = v49 | 1;
      sub_10BBF4(v50, v5, (int)&v47, a5 | 0x40);
      goto LABEL_38;
    }
LABEL_41:
    sub_94728(
...
LABEL_42:
    ...
    v31 = sub_E1798(v46);
    sub_2576BC(v5, "insn-number", "%u", v31);
    sub_2573A8(v5, "\t", v32, v33);
    v34 = sub_E1780(v46);
    sub_1D57D8(v5, v34, *v30);
LABEL_38:
    ((void (__fastcall *)(_DWORD *, int))loc_E1830)(v46, 1);
  }
  sub_92648(v45);
  sub_2564A0(v53);
  return sub_2564A0(v51);
}
