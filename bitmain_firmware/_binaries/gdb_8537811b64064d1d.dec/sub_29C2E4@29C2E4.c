int __fastcall sub_29C2E4(int a1, int a2, signed int a3, int a4)
{
  int *v6; // r1
    ...
    do
    {
      ...
      if ( v32 == 37 )
      {
        ...
        switch ( v31[1] )
        {
          ...
          case '8':
          case '9':
            v39 = sub_29C20C(v31 + 1, a3, &v100, &v101);
            v33 = v39;
            switch ( *v39 )
            {
              case '\'':
...
LABEL_201:
              ...
              case 'f':
                ...
                if ( v100 <= 7 )
                  ...
                  v7(v9, "#%s", off_3FDE64[(v100 & 7) + 161]);
                goto LABEL_55;
              case 'g':
                v31 = v39 + 1;
                v7(v9, "%s", off_3FDE64[v100 + 189]);
                goto LABEL_55;
              case 'k':
                v31 = v39 + 1;
                v7(v9, "%ld", v99 - v100);
...
LABEL_190:
                ...
                v7(v9, "%s", (&off_3FDE64[18 * dword_4707E4 + 2])[v58]);
                goto LABEL_55;
              case 'w':
                v31 = v39 + 1;
                v65 = &off_3FDE64[v100];
          ...
          case 'A':
            v7(v9, "[%s", (&off_3FDE64[18 * dword_4707E4 + 2])[v75]);
            if ( (a3 & 0x1200000) != 0 )
            {
              v40 = v94;
              v41 = v79;
          ...
          case 'F':
            v31 += 2;
            v43 = (unsigned int)"15R" & a3;
            if ( ((unsigned int)"15R" & a3) == 0x8000 )
            {
              v7(v9, "1");
            }
          ...
          case 'L':
            v31 += 2;
            v44 = (void *)(a3 & (unsigned int)&unk_400100);
            if ( (a3 & (unsigned int)&unk_400100) == 0x100 )
            {
              v7(v9, "w");
            }
            else if ( (int)(a3 & (unsigned int)&unk_400100) <= 256 )
            {
              if ( !v44 )
                v7(v9, "b");
            }
            else if ( v44 == &unk_400000 )
            {
              v7(v9, "h");
            }
            else if ( v44 == &unk_400100 )
            {
LABEL_111:
              v7(v9, "d");
            }
          ...
          case 'Q':
            v31 += 2;
            v46 = (unsigned int)"15R" & a3;
            if ( ((unsigned int)"15R" & a3) == 0x8000 )
              goto LABEL_111;
            if ( v46 == 0x400000 )
            {
LABEL_157:
              v7(v9, (const char *)&word_40CD44);
            }
            else if ( v46 )
            {
LABEL_119:
...
LABEL_140:
          ...
          case 'i':
            ...
            break;
          case 'l':
            v47 = (&off_3FDE64[18 * dword_4707E4 + 2])[v75];
            if ( (a3 & 0x100) != 0 )
            {
              v7(v9, "[%s", v47);
              if ( v82 )
            ...
            {
              v7(v9, (const char *)&word_419FF0, 0, v48);
            }
            break;
          case 'r':
            v31 += 2;
            v49 = (&off_3FDE64[18 * dword_4707E4 + 2])[v75];
            switch ( ((unsigned int)a3 >> 21) & 1 | (a3 >> 22) & 6 )
            {
              case 1u:
              case 3u:
                v7(v9, "[%s], %c%s", v49, v97, (&off_3FDE64[18 * dword_4707E4 + 2])[v86]);
                if ( v98 )
                  v7(v9, ", lsl #%d", v98);
                break;
              case 4u:
