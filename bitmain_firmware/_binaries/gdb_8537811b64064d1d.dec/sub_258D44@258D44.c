int __fastcall sub_258D44(int a1, _DWORD *a2)
{
  _BYTE *v2; // r3
  unsigned int v3; // r12
  int v4; // r6
...
LABEL_10:
        v11 = v3;
        obstack_begin(&v12, 0, 0, (void *(*)(int))sub_93050, sub_2582F8);
        v5 = sub_EEC10();
        v6 = sub_EEBE0();
        sub_EEF2C(v5, v6, &v11, 1u, 1, &v12, 0);
...
LABEL_17:
  ...
  v8 = ((int (__fastcall *)(_DWORD))loc_EEEBC)((unsigned __int8)*v2);
  if ( (unsigned int)*(unsigned __int8 *)*a2 - 48 <= 7 )
  {
    ++*a2;
    v8 = 8 * v8 + ((int (*)(void))loc_EEEBC)();
    if ( (unsigned int)*(unsigned __int8 *)*a2 - 48 <= 7 )
    {
      ++*a2;
      return 8 * v8 + ((int (*)(void))loc_EEEBC)();
    }
  }
  return v8;
}
