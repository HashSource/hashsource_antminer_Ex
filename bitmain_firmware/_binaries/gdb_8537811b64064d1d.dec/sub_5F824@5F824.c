void __fastcall sub_5F824(int a1, char **a2, int a3)
{
  int v5; // r5
  char *v6; // r0
  int v7; // r9
  ...
  if ( (unsigned int)(a3 - 1) > 3 )
    sub_94708("-var-list-children: Usage: [PRINT_VALUES] NAME [FROM TO]");
  if ( (a3 & 0xFFFFFFFD) == 1 )
    v6 = *a2;
  else
    v6 = a2[1];
  ...
  v8 = (_DWORD *)sub_272068(v7, &v14, &v15);
  sub_25752C(v5, "numchild", v15 - v14);
...
LABEL_26:
  v13 = sub_26FCBC(v7, v10);
  sub_25752C(v5, "has_more", v13);
  if ( ptr )
    free(ptr);
}
