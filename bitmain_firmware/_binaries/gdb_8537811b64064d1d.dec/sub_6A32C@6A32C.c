int *__fastcall sub_6A32C(int a1)
{
  int v2; // r0
  _DWORD *v3; // r1
  int v4; // r4
  ...
  if ( !v4 )
    return 0;
  v7 = (int *)sub_930BC(1, 0x10u);
  *v7 = v4;
  v7[1] = sub_930BC(v4, 4u);
  v8 = sub_930BC(v4, 4u);
  v9 = v7[1];
  v10 = v8 - 4;
  v7[2] = v8;
  ...
  v14 = sub_930BC(*(_DWORD *)(a1 + 108), 4u);
  v15 = *(_DWORD *)(a1 + 100);
  v7[3] = v14;
  if ( v15 )
  {
...
LABEL_21:
        ...
        if ( v24 && (*(_DWORD *)(v15 + 20) & 2) != 0 )
          sub_946D8("Loadable section \"%s\" outside of ELF segments", *(const char **)v15);
      }
      v15 = *(_DWORD *)(v15 + 12);
      ++v16;
    }
