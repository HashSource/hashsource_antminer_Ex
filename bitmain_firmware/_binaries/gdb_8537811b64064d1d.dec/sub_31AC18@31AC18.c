int __fastcall sub_31AC18(_DWORD *a1)
{
  ...
  {
    v8 = sub_314198((int)a1);
    if ( *(_BYTE *)a1[3] != 66 )
      return (int)v8;
    return sub_314290(a1, (int)v8);
  }
  if ( (unsigned int)(v3 - 97) <= 0x19 )
  {
    ...
    if ( v9 )
    {
      if ( *v9 == 49 )
      {
        ...
        {
          v14 = sub_314198((int)a1);
          v8 = (_DWORD *)sub_313750(a1, 54, __SPAIR64__((unsigned int)v14, (unsigned int)v8));
        }
      }
    }
    goto LABEL_17;
