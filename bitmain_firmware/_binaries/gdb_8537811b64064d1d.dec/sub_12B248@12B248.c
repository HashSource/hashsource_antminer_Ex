int *__fastcall sub_12B248(int *a1, _DWORD *a2, int a3)
{
  int v3; // r12
  ...
  if ( v9 && !*v10
    || (v27[3] = (int)a2,
        v27[4] = (int)&v25,
        v13 = sub_124048(v11, v12, (int *)&s, (int)a2, (int (__fastcall **)(int, int))&v25),
        v11 = v13,
        *(_BYTE *)(a3 + 4)) )
  {
    ptr = v30;
    ...
    *((_BYTE *)ptr + v23) = v24 + 1;
    ...
    {
      v27[0] = (int)ptr;
      v12 = sub_124048(v11, v12, v27, (int)a2, (int (__fastcall **)(int, int))&v25);
      v22 = ptr;
      if ( ptr == v30 )
        goto LABEL_13;
    }
