const char *__fastcall sub_285FA8(const char *a1, int a2, int a3, _BYTE *a4)
{
  int v6; // r8
...
LABEL_9:
        ...
        if ( !dword_48AD00 )
        {
          result = (const char *)sub_2950C4(v9, a2, v13);
          if ( a1 == v9 )
            return result;
          return (const char *)sub_297780(v9);
        }
        v14 = dword_4900DC;
        if ( dword_4900DC > a2 )
        {
