int __fastcall sub_335138(int a1, char *s, unsigned int a3, unsigned int a4, unsigned __int8 a5, unsigned int a6)
{
  char *i; // r4
  size_t v9; // r0
  int v10; // r1
  ...
  switch ( v57 )
  {
    case '!':
      ...
      while ( 2 )
      {
        ...
        while ( 2 )
        {
          if ( sub_335740(v48 + 1, a3, v44, v45, v46) )
          {
            v48 = (int *)*v48;
            if ( v48 )
              continue;
            ...
            if ( !sub_335740(v57, v44, v47, v51, v46) )
              return 0;
          }
          break;
        }
...
LABEL_56:
      ...
      do
      {
        if ( a3 <= v35 )
        {
          ...
          do
          {
            v40 = sub_335740(v39, a3, v38, v36, v37);
            if ( !v40 )
            {
              if ( a3 == v38 )
              {
                if ( !sub_335740(i, a3, v35, v36, v37) )
                  return 0;
              }
              else
              {
                if ( *(_BYTE *)(v38 - 1) == 47 )
                  v40 = v56 == 5;
                if ( !sub_335740(i, v38, v35, v40, v37) )
                  return 0;
                ...
                if ( v42 )
                  v43 = v43 == 5;
                if ( !sub_335740(v57, v38, v35, v43, v37) )
                  return 0;
              }
            }
            ++v38;
...
LABEL_49:
  ...
  while ( 2 )
  {
    ...
    if ( !sub_335740(v33, a3, v30, v31, v32) )
      return 0;
    v22 = (int *)*v22;
    v58 = v22;
    if ( v22 )
