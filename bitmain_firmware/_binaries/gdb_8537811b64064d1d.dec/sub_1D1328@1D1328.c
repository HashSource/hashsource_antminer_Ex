int __fastcall sub_1D1328(_DWORD *a1, int a2, int a3, int a4)
{
  bool v4; // zf
  char *v5; // r6
  _BOOL4 v8; // r9
  ...
  *(_DWORD *)((char *)v40 + 3) = 0;
  ...
  while ( 1 )
  {
    if ( *(_BYTE *)(v10 + 52) || !sub_1D00C0((int)a1, (_DWORD *)v10, v5, v8, a4) )
      goto LABEL_12;
    v17[0] = 0;
    v12 = sub_1CE218((int)a1, v10);
    v13 = sub_C2F28(
