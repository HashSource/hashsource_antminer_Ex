int __fastcall sub_4C9FC(int a1, int *a2, int *a3, int *a4, int *a5, unsigned int a6, int a7)
{
  ssize_t v10; // r0
  ssize_t v11; // r4
  int v12; // r4
  ...
  if ( v10 < 0 )
  {
    if ( dword_473724 )
    {
      v14 = (const char *)sub_988A8(v10, v10 >> 31);
      sub_92B3C("namespace-helper: recv failed (%s)\n", v14);
    }
    sub_4C770();
    return v11;
  }
  else
  {
    if ( v10 <= 11 || (message.msg_flags & 0x28) != 0 )
    {
      if ( dword_473724 )
      {
        v15 = (const char *)sub_988A8(v10, v10 >> 31);
        sub_92B3C("namespace-helper: recv truncated (%s 0x%x)\n", v15, message.msg_flags);
      }
      sub_4C770();
      v12 = -1;
      *_errno_location() = 74;
    ...
    if ( !dword_473724 )
      return v12;
    sub_92B3C("mnsh: recv: ");
    sub_4C4FC(*a2, *a3, *a4, *a5, a6, v12);
    sub_92B3C((const char *)&word_356660);
    return v12;
  }
}
