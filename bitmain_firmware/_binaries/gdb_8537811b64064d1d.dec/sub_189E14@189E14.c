int __fastcall sub_189E14(_DWORD *a1, _DWORD *a2)
{
  _DWORD *v4; // r5
  int v5; // r0
  int v6; // r7
  ...
  if ( dword_487930 )
  {
    v5 = sub_2775A0(&ptr, a2);
    v4 = a1 + 2;
    v6 = *(_DWORD *)sub_242FF0(v5);
    v7 = (const char *)ptr;
    v8 = ps_getpid_0((int)(a1 + 2));
    v9 = sub_98F90((int)(a1 + 2));
    v10 = sub_98F98((int)(a1 + 2));
    sub_2594D8(v6, "infrun: saving status %s for %d.%ld.%ld\n", v7, v8, v9, v10);
    if ( ptr != (char *)&v31 + 4 )
      sub_339E8C(ptr);
  }
  else
  ...
  a1[41] = v13;
  a1[42] = 1;
  result = sub_1DDB68(*v4, v4[1], v4[2]);
  if ( *a2 == 1 && a2[1] == 5 )
  {
    v15 = *(_DWORD *)(result + 4);
    v16 = sub_1DFB64(result);
    sub_189C90((int)a1, a1[38], a1 + 39);
    v20 = v4[1];
    v21 = v4[2];
    v26 = qword_4878EC;
    v27 = dword_4878F4;
    ...
    else
    {
      ...
      if ( !off_489A00(&dword_4899A0) && (result = sub_CF7F0(v15, v16)) != 0 )
      {
LABEL_23:
        a1[37] = 2;
      }
...
LABEL_14:
        ...
        result = sub_23DDA4(a1);
        if ( !result )
        {
          result = sub_184CD4(a1);
          if ( result )
            a1[37] = 4;
        }
      }
