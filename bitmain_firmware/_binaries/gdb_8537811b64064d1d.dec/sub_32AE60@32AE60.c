int __fastcall sub_32AE60(int a1, int a2, int a3, int a4, unsigned __int8 a5, int *a6)
{
...
LABEL_41:
    ...
    if ( (v11 & 0x30) != 0 )
    {
      ...
      if ( (v11 & 0x10) == 0 || (v12 & 0x20) == 0 )
      {
        ...
        v14 = sub_328D1C((unsigned __int16 *)(v9 + 10), v32, (unsigned __int16 *)(a3 + 10), v34, 0);
        if ( *(char *)(v9 + 8) < 0 )
          v14 = -v14;
        if ( v14 != 0x80000000 )
        {
...
LABEL_30:
    sub_32AC34(a1, a2, a3, (int *)a4, a6);
    return a1;
  }
  if ( (unsigned int)a5 - 7 > 1 )
    goto LABEL_10;
  v14 = sub_328ED4(a2, a3, 1);
  if ( v14 == 0x80000000 )
    goto LABEL_41;
LABEL_11:
  v15 = a5 == 6;
...
LABEL_64:
  *(_BYTE *)(a1 + 8) = v27;
  v29 = *(_DWORD *)v9;
  *(_DWORD *)(a1 + 4) = v28;
  sub_328A28(a1, (int *)a4, (unsigned __int16 *)(v9 + 10), v29, v35, a6);
  sub_3295C0((_DWORD *)a1, (int *)a4, v35, a6);
  return a1;
}
