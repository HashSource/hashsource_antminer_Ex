int __fastcall sub_327E54(int a1, char *a2, char a3)
{
  __int64 v3; // r4
  int v5; // r3
  int v6; // r8
  ...
  {
    v7 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v5) + 0x7FFFFFFF);
  }
  v8 = *(_BYTE *)(a1 + 8);
