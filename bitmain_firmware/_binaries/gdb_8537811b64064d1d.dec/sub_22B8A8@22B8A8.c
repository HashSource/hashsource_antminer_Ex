int __fastcall sub_22B8A8(int a1, int a2, int a3, int a4, int a5, int a6)
{
  _DWORD *v6; // r0
  int v7; // r7
  _DWORD *v8; // r0
  ...
  sub_2594D8(*v6, "-> %s->to_get_thread_local_address (...)\n", (const char *)dword_489C90);
  v7 = off_489E0C(&unk_489C8C, v31, v32, v33, a5, a6);
  v8 = (_DWORD *)sub_242FF0(v7);
  sub_2594D8(*v8, "<- %s->to_get_thread_local_address (", (const char *)dword_489C90);
