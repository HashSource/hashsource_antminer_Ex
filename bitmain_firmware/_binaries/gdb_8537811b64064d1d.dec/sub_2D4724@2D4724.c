int __fastcall sub_2D4724(int a1)
{
  _DWORD *v2; // r9
  int v3; // r3
  int v4; // r1
  ...
  if ( (*(_BYTE *)(a1 + 43) & 0x40) == 0 && !sub_2D15AC(a1, *(_BYTE *)(a1 + 43) & 0x40) )
    return 0;
  v3 = *(_DWORD *)(a1 + 160);
  v4 = v2[98];
  v56 = 0;
  v53 = *(_DWORD **)(v3 + 64);
  sub_2ADD24(a1, *(int (__fastcall **)(int, int, int))(v4 + 28), (int)&v56);
  if ( v56 )
    return 0;
  v6 = *(_DWORD **)(a1 + 160);
  v7 = v6[16];
...
LABEL_14:
    ...
    if ( !v16 || (*(_DWORD *)(v16 + 20) & 0x8000000) == 0 )
      goto LABEL_7;
    v46 = *(char **)v16;
    if ( !sub_2A9F38(a1, *(_DWORD *)(v13 + 44), *(char **)(v13 + 48)) )
      return 0;
    if ( (*(_BYTE *)(v16 + 24) & 0x30) == 0x10 && (*(_DWORD *)(a1 + 40) & 0x400000) == 0 )
    {
      v46 = sub_2CBDF8(a1, v46);
      if ( !v46 )
        return 0;
    }
    if ( *(_DWORD *)v13 != -1 )
      sub_2A6C18((int)"elf.c", 6263, (int)"_bfd_elf_assign_file_positions_for_non_load");
    v47 = sub_2F01AC(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 160) + 2348) + 4), v46, 0);
    v48 = *(_DWORD *)(v16 + 140);
    *(_DWORD *)v13 = v47;
    v49 = *(int **)(v48 + 60);
    v52 = v48;
    if ( v49 )
    {
      if ( !sub_2CCB28(a1, v49, v46, 0) )
        return 0;
    }
    v50 = *(int **)(v52 + 76);
    if ( v50 )
    {
      if ( !sub_2CCB28(a1, v50, v46, 1) )
        return 0;
    }
    v18 = *(_DWORD *)(v13 + 36);
    v51 = *(_DWORD *)(v16 + 108);
...
LABEL_24:
  sub_2F068C(*(_DWORD *)(v9 + 4));
  v21 = *(_DWORD *)(a1 + 160);
  v22 = sub_2F04F4(*(_DWORD *)(*(_DWORD *)(v21 + 2348) + 4));
  v23 = *(_DWORD *)(v21 + 164);
  *(_DWORD *)(v21 + 152) = v22;
  if ( v23 > 1 )
  {
...
LABEL_43:
    if ( *(_DWORD *)(v34 + 4)
      && (sub_2A8A2C(a1, *(_QWORD *)(v28 + 144), 0)
       || !sub_2F05B0(a1, *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 160) + 2348) + 4))) )
    {
      return 0;
    }
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      *v39 = v40;
      ...
      {
        v43 = *(_DWORD *)(v42 + 24);
        if ( sub_2A8A2C(a1, *(_QWORD *)(v42 + 16), 0) || sub_2A88AC(*(_DWORD *)(*v37 + 48), v43, a1) != v43 )
          return 0;
      }
      ++v38;
      v28 = *(_DWORD *)(a1 + 160);
