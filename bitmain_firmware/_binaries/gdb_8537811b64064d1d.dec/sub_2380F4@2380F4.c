void __fastcall sub_2380F4(_DWORD *a1, char *a2, int a3)
{
  void *v3; // r7
  int v4; // r3
  _DWORD *v5; // r5
  ...
  if ( v5 == v7 )
  {
    sub_23B2DC(a1 + 8, v5, &v15, &v14, &v16, &v17);
  }
  else
  {
    ptr[0] = v19;
    ...
    if ( v5 )
    {
      ...
      v12 = v17;
      *v5 = v5 + 2;
      sub_235120(v5, (_BYTE *)ptr[0], (int)ptr[0] + (unsigned int)ptr[1]);
      v5[6] = v10;
      v5[7] = v11;
      v5[8] = v12;
    }
