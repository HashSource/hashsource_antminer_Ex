int __fastcall sub_2E2BB4(int a1, int a2, int a3, unsigned int a4)
{
  int v7; // r8
  int v8; // r11
  int v9; // r5
  ...
  else
  {
    ...
    if ( !v9 || (v10 = *(_DWORD *)(v9 + 40), v10 != *(_DWORD *)(a3 + 40)) )
    {
      sub_2A6A84("%B: relocation size mismatch in %B section %A", a1, *(_DWORD *)(a2 + 148), a2);
  ...
  if ( v10 )
  {
    ...
    v21 = *(_DWORD *)(v13 + 4);
    v20 = v10;
    v17 = a4 + sub_347440(*(_DWORD *)(a3 + 24), v10) * 12 * v16;
    v18 = v20;
    v15 = v21;
    if ( a4 >= v17 )
      goto LABEL_12;
    ...
    if ( v18 )
LABEL_12:
      v15 += sub_347440(*(_DWORD *)(a3 + 24), v18);
  }
  *(_DWORD *)(v13 + 4) = v15;
  return 1;
}
