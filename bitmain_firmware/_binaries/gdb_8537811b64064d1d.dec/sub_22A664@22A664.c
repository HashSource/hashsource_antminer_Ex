int __fastcall sub_22A664(int a1, int a2, int a3, int a4)
{
  _DWORD *v4; // r0
  int v5; // r6
  _DWORD *v6; // r0
  ...
  sub_2594D8(*v4, "-> %s->to_record_method (...)\n", (const char *)dword_489C90);
  v5 = off_489F14(&unk_489C8C, v21, v22, v23);
  v6 = (_DWORD *)sub_242FF0(v5);
  sub_2594D8(*v6, "<- %s->to_record_method (", (const char *)dword_489C90);
