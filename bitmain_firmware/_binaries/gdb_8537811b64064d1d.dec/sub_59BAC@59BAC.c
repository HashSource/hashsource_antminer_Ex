void __fastcall sub_59BAC(char *s, int a2, int a3)
{
  unsigned int v4; // r2
  char *v5; // r4
  size_t v7; // r0
            ...
            && (v53 = strncmp(v5, "enable", v50)) != 0 )
          {
            ...
            else
            {
              if ( strncmp(v5, "auto", v50) )
              {
                ...
                if ( !v55 )
LABEL_182:
                  sub_94708("\"on\", \"off\" or \"auto\" expected.");
              }
              v50 = 2;
            }
          }
...
LABEL_68:
        v42 = (const char *)sub_988D4(v82, HIDWORD(v82));
        sub_94708("integer %s out of range", v42);
      }
      if ( v34 == 4 )
        goto LABEL_172;
      goto LABEL_170;
    ...
    case 8u:
      ...
      if ( !s )
      {
        if ( v39 != 6 )
LABEL_170:
          sub_51EC4("integer to set it to.");
LABEL_172:
        sub_51EC4("integer to set it to, or \"unlimited\".");
      }
      if ( v39 == 6 && sub_5998C((int)s) )
      {
...
LABEL_106:
    ...
    case 7u:
      if ( !s )
        sub_51EC4("filename to set it to.");
LABEL_4:
      v7 = strlen(s) - 1;
      v8 = &v5[v7];
      if ( !__CFADD__(v5, v7) )
      ...
      v15 = (void *)sub_3272DC(v5, v8 + 1 - v5);
      v16 = (void *)sub_29B938(v15);
      free(v15);
      goto LABEL_16;
    case 0xAu:
      if ( !s )
      ...
      else
      {
        ...
        if ( HIDWORD(v82) - (((_DWORD)v82 != -1) - 1) < 0 != __OFSUB__(HIDWORD(v82), -1, (_DWORD)v82 == -1) )
          sub_94708("only -1 is allowed to set as unlimited");
      }
      v20 = *(_DWORD **)(a3 + 76);
      v21 = *(void (__fastcall **)(int, _DWORD, int))(a3 + 16);
      if ( *v20 == v19 )
...
LABEL_28:
      ...
      if ( v23 )
      {
        ...
        while ( v61 );
        v64 = (char *)sub_93050(v24);
        v65 = (char *)sub_93050(4 * v62);
        v66 = a3;
        v67 = v65;
        v68 = v65 - 4;
        while ( 1 )
          ...
          switch ( (*(unsigned __int8 *)(a3 + 13) >> 1) & 0xF )
          {
            case 0:
              if ( **(_DWORD **)(a3 + 76) )
                ...
                v81 = "off";
              sub_1BA5CC(v64, v81, "off", "on");
              break;
            case 1:
              sub_1BA5CC(v64, *(&off_3564CC + **(_DWORD **)(a3 + 76)), **(_DWORD **)(a3 + 76), &off_3564CC);
              break;
            case 2:
            case 9:
              sub_93198(&ptr, 64, "%u", **(_DWORD **)(a3 + 76));
              goto LABEL_149;
            case 3:
            case 8:
            case 0xA:
              sub_93198(&ptr, 64, "%d", **(_DWORD **)(a3 + 76));
LABEL_149:
              sub_1BA5CC(v64, &ptr, v79, v80);
              break;
            case 4:
            case 5:
            case 6:
            case 7:
            case 0xB:
              sub_1BA5CC(v64, **(_DWORD **)(a3 + 76), v77, *(_DWORD *)(a3 + 76));
              break;
            default:
              break;
          }
    ...
    case 0xBu:
      ...
      if ( !s )
      {
        ...
        sub_94708("Requires an argument. Valid arguments are %s.", (const char *)ptr);
      }
      v26 = strchr(s, 32);
      if ( v26 )
        v27 = v26 - v5;
      ...
      if ( !v31 )
LABEL_183:
        sub_94708("Undefined item: \"%s\".", v5);
      if ( v31 != 1 )
        sub_94708("Ambiguous item \"%s\".", v5);
LABEL_45:
      ...
      *v33 = v29;
      ...
      goto LABEL_28;
    default:
      sub_94708("gdb internal error: bad var_type in do_setshow_command");
  }
}
