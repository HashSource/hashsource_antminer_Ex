signed int __fastcall sub_2857D0(char **a1, signed int a2, const char *a3)
{
  signed int v3; // r9
          ...
          if ( **v4 )
          {
            do
            {
              ...
              else
              {
                ...
                v31 = *v4;
                v46 = p;
                if ( !sub_29B27C(v30, v7, &p, v31, v7, &v45) )
                  break;
                v32 = sub_29B21C(&(*(v4 - 1))[v7], &v46);
                v33 = v32 <= 1;
                v34 = v32 - 1;
                if ( !v33 )
                  v7 += v34;
