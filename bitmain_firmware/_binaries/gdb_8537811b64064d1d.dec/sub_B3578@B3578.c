int __fastcall sub_B3578(int a1, int a2, int a3, int a4, int a5, int a6, _DWORD *src, int a8, int a9, int a10, int a11)
{
  int v12; // r8
  int v13; // r4
  int v15; // r6
...
LABEL_20:
      ...
      else
      {
        if ( !sub_A0350(a1, v13) )
        {
          ...
          if ( *src )
          {
            sub_25A440(a4, (const char *)&word_356660);
            sub_25A7C8(v48, a4);
          }
          else
          {
          ...
          sub_B77FC(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 24) + 24) + v15 + 12));
          v17 = sub_9E610(*(const char **)(*(_DWORD *)(*(_DWORD *)(a1 + 24) + 24) + v15 + 16));
          v18 = sub_25A440(a4, "%.*s", v17, *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 24) + 24) + v15 + 16));
          sub_B783C(v18);
          v19 = sub_25A6E4(" => ", a4);
          sub_B785C(v19);
          v20 = *(_DWORD *)(a1 + 24);
          ...
          if ( (v23 & 0xFFFFFFF0) != 0 )
          {
            if ( (*(_WORD *)(v20 + 2) & 0x380) == 0x80
              && (v44 = *(_DWORD *)(v20 + 28), (__int16 *)v44 != &word_3B4A54)
              && (v45 = *(_DWORD *)(v44 + 28)) != 0
              && (((int)*(unsigned __int8 *)(v45 + (v13 >> 3)) >> (v13 & 7)) & 1) != 0 )
            {
              v33 = sub_25A6E4("<optimized out or zero length>", a4);
            }
            else
            {
              v24 = *(_DWORD *)(v22 + 12);
              ...
              if ( v26 <= 0 )
                v28 = -(-v26 & 7);
              v29 = sub_A7620(0, a2, a3 + v26 / 8, v28, v25, v24);
              memcpy(dest, src, 0x4Cu);
              v30 = *(_DWORD *)(a1 + 24);
              dest[13] = 0;
              v31 = *(_DWORD *)(*(_DWORD *)(v30 + 24) + v15 + 12);
              v32 = sub_26C008(v29);
              v33 = sub_266A10(v31, v49, v32, SHIDWORD(v32), 0, a4, v49, v29, dest, a11);
            }
          }
          else
          {
