int __fastcall sub_114C38(int a1, _BYTE *a2, unsigned int a3, unsigned int *a4, int *a5, int *a6, int a7)
{
  unsigned int v10; // r8
  char *v11; // r6
  unsigned int v12; // r7
...
LABEL_35:
        if ( v38 != (char *)v10 )
        {
          ...
          if ( v38 )
          {
            v46 = sub_132098(a1, v40);
            *a5 = v46;
            if ( (unsigned int)(v45 + 4) <= a3 )
            {
              *a6 = v46;
              *a6 += sub_15C278(v45, 4, a7);
