int __fastcall sub_29D7F8(int result, int (__fastcall **a2)(int), int a3)
{
  __int64 v4; // r6
  const char *v5; // r4
  char *i; // r3
  ...
  {
    v5 = "bxns\t%3-6r";
    for ( i = (char *)&unk_3FE1D8; ; v5 = (const char *)*((_DWORD *)i + 9) )
    {
      i += 20;
      if ( !v5 )
        goto LABEL_66;
...
LABEL_91:
                  ...
                  case 'c':
                    v5 = v26 + 2;
                    result = ((int (__fastcall *)(_DWORD, char *, char *))v4)(HIDWORD(v4), "%s", off_3FDE64[v29 + 144]);
                    goto LABEL_17;
                  case 'd':
                    v31 = v29;
                    v5 = v26 + 2;
                  ...
                  case 'r':
                    ...
                    result = ((int (__fastcall *)(_DWORD, char *, char *))v4)(
                               HIDWORD(v4),
                               "%s",
                               (&off_3FDE64[18 * dword_4707E4 + 2])[v29]);
                    goto LABEL_17;
                  case 'x':
                    v5 = v26 + 2;
...
LABEL_66:
        ...
        case 'C':
          ...
          if ( dword_48BB6C )
            goto LABEL_26;
          result = ((int (__fastcall *)(_DWORD, __int16 *))v4)(HIDWORD(v4), &word_3DDCA0);
          break;
        case 'D':
          v5 += 2;
          result = ((int (__fastcall *)(_DWORD, char *, char *))v4)(
                     HIDWORD(v4),
                     "%s",
                     (&off_3FDE64[18 * dword_4707E4 + 2])[v39]);
          break;
        case 'I':
          ...
          result = ((int (*)(_DWORD, const char *, ...))v4)(
                     HIDWORD(v4),
                     "\t%s",
                     off_3FDE64[((unsigned __int8)a3 >> 4) + 144]);
          break;
        case 'M':
          v36 = 0;
          v34 = 0;
...
LABEL_34:
          ...
          for ( j = 0; j != 8; ++j )
          {
            if ( (a3 & (1 << j)) != 0 )
            {
              ...
              ((void (__fastcall *)(_DWORD, char *, char *))v4)(
                HIDWORD(v4),
                "%s",
                (&off_3FDE64[18 * dword_4707E4 + 2])[j]);
              v13 = 1;
            }
          }
          if ( v36 )
          {
            ...
            ((void (__fastcall *)(_DWORD, char *, char *))v4)(HIDWORD(v4), "%s", off_3FDE64[18 * dword_4707E4 + 16]);
            if ( v34 )
              goto LABEL_44;
          }
          else if ( v34 )
...
LABEL_44:
              ((void (__fastcall *)(_DWORD, char *))v4)(HIDWORD(v4), ", ");
            ((void (__fastcall *)(_DWORD, char *, char *))v4)(HIDWORD(v4), "%s", off_3FDE64[18 * dword_4707E4 + 17]);
          }
          v5 = v32 + 2;
        ...
        case 'S':
          ...
          result = ((int (__fastcall *)(_DWORD, char *, char *))v4)(
                     HIDWORD(v4),
                     "%s",
                     (&off_3FDE64[18 * dword_4707E4 + 2])[v38]);
          break;
        case 'W':
          v5 += 2;
        ...
        case 'X':
          ...
          if ( dword_48BB6C )
            result = ((int (*)(_DWORD, const char *, ...))v4)(
                       HIDWORD(v4),
                       "\t; unpredictable <IT:%s>",
                       off_3FDE64[((unsigned __int8)dword_48BB6C >> 4) + 144]);
          break;
        case 'b':
          v5 += 2;
          result = a2[19](v41);
        ...
        case 'c':
          ...
          if ( dword_48BB6C )
LABEL_26:
            result = ((int (__fastcall *)(_DWORD, char *, char *))v4)(HIDWORD(v4), "%s", off_3FDE64[(v12 >> 4) + 144]);
          break;
        case 's':
          v5 += 2;
