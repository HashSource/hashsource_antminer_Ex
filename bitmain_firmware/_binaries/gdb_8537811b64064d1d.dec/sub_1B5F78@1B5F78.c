int __fastcall sub_1B5F78(unsigned int a1, _DWORD *a2)
{
  char **v2; // r11
  char **v5; // r4
  int v6; // r2
  ...
  do
  {
    ...
    if ( v6 == -1 )
    {
      v14 = sub_94728((int)"objc-lang.c", 1294, "Section index is uninitialized");
      sub_92E68((int)&v18);
      if ( HIDWORD(v14) != 1 )
      {
        sub_339EA0(v14);
    ...
    *(v5 - 1) = (char *)((int (__fastcall *)(int, int))loc_1B2B40)(v9, v8);
  }
