int __fastcall sub_4E68C(int a1)
{
  int v2; // r0
  int v3; // r5
  int v4; // r1
  ...
  v2 = sub_1DD5B4(a1);
  v3 = sub_163EA0(v2);
  ((void (__fastcall *)(_BYTE *, int))loc_1DD5C0)(v12, a1);
  v4 = sub_98F90(v12);
  if ( dword_46AF88 == 1 )
  {
    v5 = 260;
  ...
  if ( ptrace(v9, v4, v8, v7) < 0 )
    sub_258B2C("Unable to fetch VFP registers.");
  return sub_4EF4C(a1, v12, *(_DWORD *)(v3 + 16));
}
