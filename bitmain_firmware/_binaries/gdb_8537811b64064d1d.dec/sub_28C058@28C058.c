int __fastcall sub_28C058(int a1)
{
  _DWORD *v2; // r0
  int v3; // r3
  _DWORD *v4; // r4
  ...
  *v19 = 0;
  ...
  dword_48ADF8 = (int)v4;
  v4[26] = dword_4900D8;
  sub_28B380(v24, v23 & 1);
  if ( (dword_48AAA0 & 0x80000) != 0 )
    return 0;
  do
  {
    sub_28B760((int)v4);
    v25 = sub_28B7DC((int)v4, v4[19]);
  }
  while ( v25 > 0 );
  return sub_28B640(v4, v25);
}
