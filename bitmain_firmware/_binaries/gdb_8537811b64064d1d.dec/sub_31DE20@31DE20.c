FILE *__fastcall sub_31DE20(FILE *result, const char ***a2)
{
  int flags; // r1
  FILE *v4; // r11
  int v5; // r10
...
LABEL_14:
    ...
    if ( *ptr )
    {
      if ( (word_4388C0[(unsigned __int8)*ptr] & 0x40) == 0 )
      {
LABEL_25:
        src = sub_31DB30(ptr);
        v18 = *src;
        v19 = (const char **)sub_31DA60((int *)*a2);
        *a2 = v19;
        if ( v18 )
        {
          v24 = src;
...
LABEL_24:
    n = v20;
    v30 = v21;
    v22 = (const char **)sub_93078(v19, 4 * (v4->_flags + 1 + v18));
    v23 = v4->_flags;
    *a2 = v22;
