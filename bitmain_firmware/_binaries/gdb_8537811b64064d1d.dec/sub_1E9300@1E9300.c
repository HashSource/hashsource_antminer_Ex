unsigned int *__fastcall sub_1E9300(int a1, const char *a2)
{
  unsigned int *v3; // r4
  int v4; // r0
  int v5; // r8
...
LABEL_19:
    sub_94708("Remote failure reply: %s", (const char *)HIDWORD(v6));
  v7 = sub_92564((int)sub_24D424, (int)&v19);
  v8 = (_BYTE *)v20;
  v9 = v7;
  ++v20;
  if ( *v8 == 109 )
  {
    do
    {
      ...
      if ( !v19 )
      {
        v10 = (const char **)sub_930BC(1u, 0x10u);
        v19 = v10;
      }
      v11 = v20;
      while ( 1 )
      {
        sub_24D470(v11, &v20, v10);
