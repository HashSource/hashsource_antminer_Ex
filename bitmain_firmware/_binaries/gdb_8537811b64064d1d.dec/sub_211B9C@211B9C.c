int __fastcall sub_211B9C(int result, int *a2, int *a3)
{
  size_t n; // r5
  unsigned int v4; // r3
  int v5; // r11
  ...
  if ( !v4 )
  {
    ...
    if ( v10 <= v11 )
    {
      v22 = sub_94728(
              ...
              "quick_push");
      return sub_211D18(v22, HIDWORD(v22));
    }
    else
    {
      *v6 = v11 + 1;
      ...
      *v16 = v21;
      ...
      v16[5] = 0;
      v16[7] = v19;
      return sub_2ADF04(v5, (int)a2, v19, 0, 0, 0, n);
    }
  }
  return result;
}
