void __fastcall sub_172A68(_DWORD *a1, int a2)
{
  int v2; // r2
  int v3; // r3
  int v4; // r2
  ...
  do
  {
    ...
    if ( (v10 & 0x10) != 0 )
      sub_1B7278(v11);
    v69 = (char *)sub_21ABF0(a1, a2, v5);
    v12 = (const char *)sub_1008E4(v69);
    ptr = (char *)v12;
    if ( !v12 || (v13 = strchr(v12, 40), (v14 = v13) == 0) )
      sub_94708("Internal: Cannot demangle mangled name `%s'.", v69);
    ...
    if ( v42 != 41 && v14[1] )
    {
      ...
      do
      {
        ...
        if ( v50 )
        {
          ...
          {
            v76 = (char *)&v66[6 * v68];
            v61 = (int *)sub_242FDC(v51);
            v77 = *v61;
            *(_DWORD *)sub_242FDC(v61) = &dword_48A9A4;
            v75 = sub_92E50();
            v62 = sub_14E778(v44, v43 - v44);
            v63 = sub_92E68((int)v75);
            ++v68;
            *(_DWORD *)sub_242FDC(v63) = v77;
            *((_DWORD *)v76 + 3) = v62;
            v46 = v43 + 1;
            v44 = v43 + 1;
            v16 = v43 + 1;
...
LABEL_52:
    ...
    *(_DWORD *)(v72 + 16 * v5) = v69;
    sub_170C88(v52, (int)a1, *(_DWORD *)(*(_DWORD *)(v52 + 24) + 20), (int)v66, v68, *(v16 - 2) == 46);
...
LABEL_5:
  ...
  if ( v4 && strncmp(*v74, "_Z", 2u) )
  {
    ...
    if ( v56 )
      v57 = *(_DWORD *)(v57 + 32);
    v58 = sub_3102D8(*(_DWORD *)(v57 + v67), v78, 2);
    if ( v58 )
      goto LABEL_79;
    v64 = a1[6];
    if ( (*(_WORD *)(v64 + 2) & 0x380) == 0x80 )
      v58 = *(_DWORD *)(*(_DWORD *)(v64 + 28) + 32);
    if ( sub_3102D8(*(_DWORD *)(v58 + v67), v78, 0) )
    {
LABEL_79:
      v59 = a1[6];
