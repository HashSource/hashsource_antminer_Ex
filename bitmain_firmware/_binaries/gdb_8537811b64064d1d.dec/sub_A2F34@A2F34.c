int __fastcall sub_A2F34(const char *a1)
{
  const char *v1; // r5
  char *v2; // r0
  int v3; // r0
...
LABEL_16:
    if ( (v1[1] & 0xFD) == 0x55 && sscanf(v1 + 2, "%x", &v16) == 1 )
    {
      ...
      if ( (unsigned int)dword_477CB0 <= 0xF )
      {
        ...
        if ( v12 <= 0xF )
          dword_477CB0 = v9;
        v13 = (char *)sub_9D498((void *)dword_477CB4, &dword_477CB0, 1);
        v10 = dword_477CB0;
        v11 = v13;
      ...
      if ( (v16 & 0xFFFFFF80) != 0 || !isprint(v16) )
      {
        if ( v1[1] == 85 )
          ...
          LOWORD(v15) = 21460;
        HIWORD(v15) = 55;
        sub_93198(v11, v10, v15, v14);
      }
      else
      {
        sub_93198(v11, v10, "'%c'", v14);
      }
      return dword_477CB4;
    }
    return (int)v1;
  }
  v3 = sub_338BFC(v2 + 1, &dword_3C43C4);
  if ( !v3 )
  {
LABEL_13:
    v3 = sub_338BFC(v1, "$");
...
LABEL_4:
  ...
  if ( v5 > dword_477CB0 )
  {
    ...
    if ( 2 * dword_477CB0 < v5 )
      v7 = v3 - (_DWORD)v1 + 1;
    dword_477CB0 = v7;
    v6 = (char *)sub_9D498((void *)dword_477CB4, &dword_477CB0, 1);
    dword_477CB4 = (int)v6;
  }
  strncpy(v6, v1, v4);
  v6[v4] = 0;
