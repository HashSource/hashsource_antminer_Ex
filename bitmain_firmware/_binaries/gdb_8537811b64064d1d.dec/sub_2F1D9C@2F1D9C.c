void __fastcall sub_2F1D9C(int a1, int a2, int a3, int *a4)
{
  int v4; // r12
  int v5; // r6
  int v6; // r4
...
LABEL_20:
    ...
    else
    {
      ...
      v178 = (int *)sub_2AB514(32 * v14 + 8);
      if ( v178 )
      {
        if ( v13 )
        {
          v98 = sub_2AB514(116 * v13);
          v21 = v98;
          if ( !v98 )
          {
LABEL_63:
...
LABEL_87:
        if ( *v63 != v65 - v66 )
          goto LABEL_62;
        v69 = sub_2ED3F4(a2, v179, v189, a4, 0);
        if ( v69 )
        {
...
LABEL_91:
      ...
      {
LABEL_99:
        if ( !sub_2F1B18((int *)(a1 + 4), v78, v74, 0) )
        {
      ...
      if ( *((_BYTE *)v59 + 10) == 122 )
      {
        if ( !sub_2F11A4((unsigned __int8 **)&src, (unsigned int)v36, (int *)&v194) )
          goto LABEL_62;
...
LABEL_52:
    ...
    if ( !sub_2F11A4((unsigned __int8 **)&src, (unsigned int)v36, v40 + 8) )
    {
LABEL_62:
      v9 = v181;
      v6 = v179;
    ...
    else if ( !sub_2F11A4((unsigned __int8 **)&src, (unsigned int)v36, v40 + 10) )
    {
      goto LABEL_62;
    }
    v101 = (_DWORD *)a4[1];
...
LABEL_316:
    ...
    *((_BYTE *)v40 + 62) = -1;
    ...
    {
      v183 = (int)v40 + 11;
      if ( !sub_2F11A4((unsigned __int8 **)&src, (unsigned int)v36, v40 + 11) )
        goto LABEL_62;
      v162 = (_DWORD *)a4[1];
      v163 = a4[2];
      v106 = ptr;
...
LABEL_160:
          a4[1] = (int)v117;
LABEL_161:
          if ( (v113 & 0x60) == 0x60 || !sub_2F18CC(v113, v180) )
            goto LABEL_62;
          goto LABEL_151;
        case 'S':
          goto LABEL_151;
...
LABEL_110:
    ...
    while ( v36 > v96 )
    {
      ...
      if ( v97 )
      {
        if ( v97 == 1 )
          ++v184;
        if ( !sub_2F1210(&v196, (unsigned int)v36, v94) )
          goto LABEL_62;
        v95 = v196;
        v96 = v196;
      }
      ...
      if ( (*((_BYTE *)v59 + 62) & 0x70) == 0x10 || (v133 & 8) != 0 )
      {
        ...
        *v165 = v184;
        ...
        while ( v195 < v36 )
        {
          ...
          if ( !sub_2F1210(&v195, (unsigned int)v36, v194) )
            goto LABEL_62;
        }
      }
    }
...
LABEL_287:
  if ( v25 != v14 )
    sub_2A6BE4("elf-eh-frame.c", 1031);
  if ( v185 != v13 )
    sub_2A6BE4("elf-eh-frame.c", 1032);
