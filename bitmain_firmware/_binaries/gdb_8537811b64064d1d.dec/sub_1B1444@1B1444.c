int *__fastcall sub_1B1444(int *a1, char *s, const char *a3, _DWORD *a4)
{
  const char *v4; // r8
  unsigned int v5; // r5
  unsigned int v7; // r3
  ...
  if ( v11 > 0xF )
  {
    v40 = (_DWORD *)sub_33B2E4(&v65, &v68, 0);
    v65 = v40;
    v67[0] = v68;
  }
  else
...
LABEL_42:
      if ( v27 )
      {
        v41 = *(_DWORD *)sub_242FF0(v11);
        v42 = sub_98F14(v19);
        sub_2594D8(v41, "lookup_minimal_symbol (...) = %s (external)\n", v42);
      }
      v28 = v60;
      *a1 = v59;
      a1[1] = v28;
    ...
    while ( 1 )
    {
      ...
      if ( dword_48970C )
      {
        v24 = *(_DWORD *)sub_242FF0(v11);
        v25 = sub_1B87F4(v52);
        v11 = sub_2594D8(v24, "lookup_minimal_symbol (%s, %s, %s)\n", v4, v58, v25);
      }
      for ( i = *(_DWORD *)(v52[10] + 4 * v5 + 96); i; i = *(_DWORD *)(i + 36) )
      {
        ...
        if ( !v11 )
        {
          v11 = sub_1B13C0(&v59, a3, (int)v52, i);
          if ( v11 )
            break;
        }
      }
      ...
      else
      {
        ...
        do
        {
          ...
          v34 = sub_194460(v32);
          v11 = sub_194598((int)v34, (int)&v68);
          ...
          for ( j = *(_DWORD *)(v52[10] + 4 * v33 + 8252); j; j = *(_DWORD *)(j + 40) )
          {
            ...
            if ( v11 )
            {
              v11 = sub_1B13C0(&v59, a3, (int)v52, j);
              if ( v11 )
                break;
            }
          }
...
LABEL_94:
  ...
  if ( v61 )
  {
    if ( v27 )
    {
      v47 = *(_DWORD *)sub_242FF0(v11);
      v48 = sub_98F14(v43);
      sub_2594D8(v47, "lookup_minimal_symbol (...) = %s (file-local)\n", v48);
    }
    v44 = v62;
    *a1 = v61;
    a1[1] = v44;
  ...
  else
  {
    ...
    if ( v63 )
    {
      if ( v27 )
      {
        v49 = *(_DWORD *)sub_242FF0(v11);
        v50 = sub_98F14(v45);
        sub_2594D8(v49, "lookup_minimal_symbol (...) = %s (trampoline)\n", v50);
      }
      v46 = v64;
      *a1 = v63;
      a1[1] = v46;
    ...
    else
    {
      if ( v27 )
      {
        v51 = (_DWORD *)sub_242FF0(v11);
        sub_2594D8(*v51, "lookup_minimal_symbol (...) = NULL\n");
      }
      *a1 = 0;
      a1[1] = 0;
    }
