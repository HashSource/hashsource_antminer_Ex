int __fastcall sub_1EB0A0(int a1)
{
  int v1; // r0
  int v2; // r0
  const char **v3; // r4
  ...
  sub_93198(v4, v6, "g");
  sub_1E7E14(*v3);
  v7 = sub_1E4EE0((char **)v3, v5, 0, 0, 0);
  v8 = *v3;
  v9 = *(unsigned __int8 *)*v3;
  if ( v9 == 69 )
    sub_94708("Remote failure reply: %s", *v3);
  ...
  if ( v10 && v9 != 120 )
  {
    do
    {
      if ( dword_48A590 )
      {
        ...
        sub_2594D8(*v14, "Bad register packet; fetching a new packet\n");
      }
      v7 = sub_1E4EE0((char **)v3, v5, 0, 0, (_DWORD *)v11);
      v8 = *v3;
  ...
  v15 = strlen(v8);
  if ( (v15 & 1) != 0 )
    sub_94708("Remote 'g' packet reply is of odd length: %s", v8);
  return v15 >> 1;
}
