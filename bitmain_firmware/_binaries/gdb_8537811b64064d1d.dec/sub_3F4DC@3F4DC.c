int __fastcall sub_3F4DC(char *file, int a2)
{
  int v4; // r0
  void *v6; // r7
  int v7; // r5
  ...
  if ( dword_471BF0 )
  {
    v18 = (_DWORD *)sub_242FF0(file);
    sub_2594D8(*v18, "Trying host libthread_db library: %s.\n", file);
  }
  if ( !a2 )
    goto LABEL_8;
  v4 = access(file, 4);
...
LABEL_8:
    ...
    if ( !v6 )
    {
      if ( !dword_471BF0 )
        return 0;
      v19 = *(_DWORD *)sub_242FF0(0);
      v20 = dlerror();
      sub_2594D8(v19, "dlopen failed: %s.\n", v20);
      return 0;
    }
    if ( dword_471BF0 )
    {
      if ( !strchr(file, 47) )
      {
        ...
        if ( v34 )
        {
          ...
          if ( v35 )
          {
            ...
            if ( v52[0] )
            {
              v37 = (_DWORD *)sub_242FF0(v35);
              sub_2594D8(*v37, "Host %s resolved to: %s.\n", file, v36);
            }
          }
        }
      }
    }
    v7 = sub_930BC(1, 0x40u);
    ...
    *(_DWORD *)v7 = v9;
    ...
    if ( v10 )
    {
      *(_DWORD *)(v7 + 36) = v10;
      ...
      {
        v21 = sub_3E4E8(v11);
        sub_946D8("Cannot initialize libthread_db: %s", v21);
      ...
      if ( v12 )
      {
        ...
        *(_DWORD *)(v7 + 24) = v14;
        ...
        if ( v15 )
        {
          if ( dword_471BF0 )
          {
            v39 = *(_DWORD *)sub_242FF0(v15);
            v40 = sub_3E4E8(v16);
            sub_2594D8(v39, "td_ta_new failed: %s\n", v40);
          }
          else if ( v15 != 12 && v15 != 22 )
          {
            v38 = sub_3E4E8(v15);
            sub_946D8("td_ta_new failed: %s", v38);
          }
          goto LABEL_23;
        }
            ...
            *(_DWORD *)(v7 + 60) = v29;
            ...
            if ( v41 )
            {
              ...
              *(_DWORD *)(v7 + 48) = v41;
              ...
              v51 = v44;
              v45 = sub_92E50(v42);
              sub_3E88C(v49, v50, v51, 1);
              sub_92E68(v45);
LABEL_47:
              sub_259880("[Thread debugging using libthread_db enabled]\n");
              if ( *(_BYTE *)dword_471BF8 || dword_471BF0 )
              {
                ...
                if ( *(_BYTE *)dword_471BF8 )
                  v48 = *(_DWORD *)sub_242FB4(v46);
                else
                  v48 = *(_DWORD *)sub_242FF0(v46);
                sub_2594D8(v48, "Using host libthread_db library \"%s\".\n", v47);
              }
              if ( !*(_DWORD *)dword_471BF4 )
                sub_231BA0(&unk_471C3C);
              return 1;
            }
            sub_3ED58("td_ta_thr_iter");
            *(_DWORD *)(v7 + 48) = 0;
          }
          else
          {
            sub_3ED58("td_thr_get_info");
            *(_DWORD *)(v7 + 52) = 0;
          }
        }
        else
        {
          sub_3ED58("td_ta_map_lwp2thr");
          *(_DWORD *)(v7 + 44) = 0;
        }
      }
      else
...
LABEL_23:
  ...
  if ( !dword_471BF0 )
    return 0;
  v23 = *(_DWORD *)sub_242FF0(v4);
  v24 = _errno_location();
  v25 = (const char *)sub_6FFC0(*v24);
  sub_2594D8(v23, "open failed: %s.\n", v25);
  return 0;
}
