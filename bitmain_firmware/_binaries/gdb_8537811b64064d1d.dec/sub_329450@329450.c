int __fastcall sub_329450(int result, int *a2, int *a3, int *a4)
{
  int v4; // r5
  int v5; // r12
  int v6; // r8
  ...
  if ( *(_WORD *)(result + 10) || *(_DWORD *)result != 1 || (*(_BYTE *)(result + 8) & 0x70) != 0 )
  {
    ...
    *a4 |= 0x1000u;
    ...
    if ( v6 > 0 )
    {
      ...
      v26 = v17;
      v21[0] = v18 - v6;
      result = sub_328A28(v9, v21, (unsigned __int16 *)(v9 + 10), v18, a3, a4);
      if ( *a3 )
      {
        HIDWORD(v20) = a4;
        LODWORD(v20) = *a3;
        result = sub_329138(v9, v21, v20);
      }
      if ( (*a4 & 0x20) != 0 )
        *a4 |= 0x2000u;
      if ( *(_DWORD *)(v9 + 4) > v4 )
      {
        result = sub_328484((char *)(v9 + 10), *(_DWORD *)v9, 1);
        v19 = *(_DWORD *)(v9 + 4);
        *(_DWORD *)v9 = result;
        *(_DWORD *)(v9 + 4) = v19 - 1;
      }
