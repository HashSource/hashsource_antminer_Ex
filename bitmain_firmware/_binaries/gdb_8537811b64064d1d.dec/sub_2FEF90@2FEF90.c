unsigned int __fastcall sub_2FEF90(_DWORD *a1, int a2, int a3)
{
...
LABEL_6:
      ...
      if ( v10 == *(_DWORD *)(v7 + 36) )
      {
        if ( v10 )
        {
          ...
          if ( sub_2AE004(v11, (int)a1, (int *)&ptr) )
          {
            if ( sub_2AE004(*(_DWORD *)(*(_DWORD *)(a2 + 4) + 148), *(_DWORD *)(a2 + 4), (int *)&v13) )
            {
...
LABEL_26:
    sub_2A6C18((int)"linker.c", 2814, (int)"_bfd_handle_already_linked");
  }
  if ( result )
    goto LABEL_26;
  v7 = *(_DWORD *)(a2 + 4);
