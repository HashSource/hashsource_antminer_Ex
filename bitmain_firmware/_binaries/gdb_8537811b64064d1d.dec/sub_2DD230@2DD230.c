int __fastcall sub_2DD230(int a1, int a2, int a3)
{
  int v3; // r3
  int i; // r9
  int v6; // r10
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v8 != v6 && (*(_DWORD *)(v8 + 40) & 0x800) != 0 )
      {
        ...
        if ( *(_DWORD *)(v9 + 2328) )
        {
          v10 = sub_347440(*(_DWORD *)(v9 + 264), *(unsigned __int8 *)(*(_DWORD *)a2 + 5));
          v11 = v10;
    ...
    v21 = (char *)sub_2CDA30(v8, v9 + 240, v11, v12, 0, 0, 0);
    if ( !v21 )
      return 0;
    v13 = *(_DWORD *)(v8 + 160);
    ptr = sub_2AB390(*(_DWORD *)(v13 + 376));
    if ( !ptr )
      goto LABEL_41;
    if ( sub_2A8A2C(v8, *(_QWORD *)(v13 + 368), 0)
      || sub_2A8800((int)ptr, *(_DWORD *)(v13 + 376), v8) != *(_DWORD *)(v13 + 376) )
    {
      break;
    }
    v14 = (int)ptr + 2 * v12;
    ...
    if ( v21 < v15 )
    {
      ...
      while ( 1 )
      {
        if ( (unsigned __int8)v16[12] >> 4 )
        {
          if ( *((_DWORD *)v16 + 4) )
          {
            v17 = sub_2CD86C(v8, *(_DWORD *)(v9 + 268), *((_DWORD *)v16 + 2));
            if ( !strcmp(v17, *(const char **)(i + 4)) )
            {
              sub_2CD6E8(v8, v14, v22);
              if ( (v22[0] & 0x8000) == 0 && ((*(_BYTE *)(i + 51) & 2) == 0 || (*(_BYTE *)(i + 52) & 8) == 0) )
                sub_2A6C18((int)"elflink.c", 9505, (int)"elf_link_check_versioned_symbol");
