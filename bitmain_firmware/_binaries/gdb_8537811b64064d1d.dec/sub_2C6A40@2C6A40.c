void __fastcall sub_2C6A40(_DWORD *a1, int a2)
{
  int v2; // r3
  int v3; // r6
  char *v5; // r0
                                       ...
                                       + *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v9 + 20) + 60) + 28) )
            {
              switch ( j[4] )
              {
                ...
                case 3:
                  ...
                  break;
                default:
                  sub_2A6C18((int)"elf32-arm.c", 8337, (int)"bfd_elf32_arm_vfp11_fix_veneer_locations");
              }
              v9 = sub_2FC948(v3, i, 0);
              if ( !v9 )
              {
                sub_2A6A84("%B: unable to find VFP11 veneer `%s'", a1, i);
                v9 = 0;
              }
              v10 = j[2];
              j = (_DWORD *)*j;
