int __fastcall sub_2F879C(int a1, int a2, int a3, _DWORD *a4, _DWORD *a5)
{
  int v6; // r0
  int v9; // r10
...
LABEL_6:
    v15 = sub_2ABC4C(v9, v14, &v43, 0, (unsigned int)v13);
    if ( v15 )
    {
      ...
      {
LABEL_54:
        sub_2A6A84("Dwarf Error: Could not find abbrev number %u.", v15);
      ...
      if ( v17 )
      {
        ...
        do
        {
          ...
          v44 = v21;
          v24 = sub_2F68F0(&v44, v22, v23, a1, v19, v13);
          v19 = (char *)v24;
          if ( !v24 )
            break;
          if ( a2 == v24 )
          {
            sub_2A6A84("Dwarf Error: Abstract instance recursion detected.");
            ((void (__fastcall *)(int))loc_2A6C70)(17);
            return 0;
          }
          if ( v44 == 71 )
          {
            result = sub_2F879C(a1, v24, &v44, a4, a5);
            if ( !result )
              return result;
          }
          else if ( v44 <= 0x47 )
...
LABEL_33:
    sub_2A6A84("Dwarf Error: Invalid abstract instance DIE ref.");
    ((void (__fastcall *)(int))loc_2A6C70)(17);
    return 0;
  }
  v32 = *(_DWORD **)(a1 + 84);
  ...
  if ( v33 )
    goto LABEL_50;
  v36 = sub_2AD3D8(*(const char ***)(a1 + 8), "/usr/lib/debug");
  ptr = v36;
  if ( !v36 )
    goto LABEL_73;
  v37 = sub_2AC78C((int)v36, 0);
  v40 = (int)v37;
  if ( !v37 )
  {
LABEL_72:
  ...
  if ( !sub_2AA894((int)v37, 1, v38, v39) )
  {
    sub_2ACA04(v40);
    goto LABEL_72;
  }
  ...
  v33 = *(_DWORD **)(v41 + 36);
LABEL_50:
  if ( sub_2F5C40(v33, (const char **)(v32[2] + 32), 0, v11, v10, v32 + 12, v32 + 13) )
  {
...
LABEL_73:
  sub_2A6A84("Dwarf Error: Unable to read alt ref %llu.", v10);
  ((void (__fastcall *)(int))loc_2A6C70)(17);
  return 0;
}
