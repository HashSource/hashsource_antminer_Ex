int __fastcall sub_A6954(char *a1, _QWORD *a2, int a3)
{
  _BYTE *v5; // r0
  char **v6; // r2
  int v7; // r1
  ...
  *(_DWORD *)((char *)v38 + 3) = 0;
  v22 = v16[1];
  v9 = sub_20F3B0(0);
  v10 = sub_A4AC4((int)&v18, v9, (char *)1, v16, 1);
  v11 = sub_92564(634240, (int)v16[0]);
  v12 = v11;
  if ( v10 == 1 )
  {
    v13 = sub_2611B4(*v16[0], v16[0][1]);
    sub_92648(v12);
    if ( !v35 )
      goto LABEL_15;
  }
