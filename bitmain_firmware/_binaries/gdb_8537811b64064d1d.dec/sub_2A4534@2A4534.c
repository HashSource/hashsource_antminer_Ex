int __fastcall sub_2A4534(int a1)
{
  int v3; // r1
  int v4; // r0
  _DWORD *v5; // r6
  ...
  if ( sub_2A8A2C(a1, 0, **(_DWORD **)(a1 + 160), *(_DWORD *)(*(_DWORD *)(a1 + 160) + 4), 0) )
    return 0;
  if ( sub_2A8800(s1, 16, a1) != 16 )
    return 1;
  if ( sub_2A8A2C(a1, v3, -16, -1, 1) )
    return 0;
...
LABEL_14:
  ...
  v11 = sub_2A8800(v10, v6, a1);
  if ( v11 != v6 )
  {
    if ( sub_2A6938(v11) != 1 )
      ((void (__fastcall *)(int))loc_2A6C70)(10);
    sub_2AD218(a1, *(_DWORD *)(*(_DWORD *)(a1 + 160) + 24));
