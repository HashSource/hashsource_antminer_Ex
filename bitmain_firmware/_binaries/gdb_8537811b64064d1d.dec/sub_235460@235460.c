void __fastcall sub_235460(int a1)
{
  const char *v1; // r0
  int v2; // r2
  int *v3; // r6
  ...
  else
  {
    ...
    {
      v73 = v75;
      sub_235120(&v73, (_BYTE *)v68[0], (int)v68[0] + (unsigned int)v68[1]);
      if ( v74 == 0x7FFFFFFF )
...
LABEL_8:
  ...
  sub_259F38("Tested %lu XML files, %d failed\n", (v28 - v4) >> 3, v8);
  if ( v68[0] != v69 )
    sub_339E8C(v68[0]);
  if ( ptr )
    free(ptr);
