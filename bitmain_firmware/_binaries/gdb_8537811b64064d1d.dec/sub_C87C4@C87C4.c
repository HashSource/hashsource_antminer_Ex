int __fastcall sub_C87C4(int result, int a2, int a3, int a4, int a5)
{
  _DWORD *v5; // r4
  int v6; // r10
  _DWORD *v7; // r12
        ...
        do
        {
          ...
          if ( v13 > 0 )
          {
            ...
            if ( v14 )
            {
              ...
              {
                if ( a5 != -1 )
                  sub_259F38(" (all threads)");
              }
              else
              {
                sub_259F38(" (thread %d)", v15);
              }
              ...
              {
                v17 = (char *)&word_3D7D68;
              }
              sub_259F38("%s%s ", v16, v17);
            }
          }
LABEL_39:
          v12 = (_DWORD *)v12[2];
      ...
      sub_259F38("also set at pc ");
      v18 = sub_25ACB4(v20, a3);
