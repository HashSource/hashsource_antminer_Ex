void __fastcall sub_FED70(const char *a1, _DWORD *a2)
{
  size_t v3; // r0
  size_t *v4; // r12
  size_t v5; // r4
  ...
  if ( v3 > 0xF )
  {
    v22 = (_DWORD *)sub_33B2E4(&v25, &v28, 0);
    v25 = v22;
    v27[0] = v28;
  }
  else
...
LABEL_5:
  ...
  *(_DWORD *)((char *)v48 + 3) = 0;
  v32 = v26;
  for ( i = sub_C2928(a2, (int)&v28, &v25); i; i = sub_C2974((int)&v28, (int)&v25) )
  {
    if ( *(_DWORD *)(i + 24) )
    {
      v12 = dword_47B1A4;
...
LABEL_28:
        ...
        if ( s1 )
        {
          if ( !strcmp(s1, a1) )
          {
            ...
            {
              dword_46D41C *= 2;
              v21 = sub_93078((void *)dword_47B1A8, 8 * v20);
              v19 = dword_47B1A4;
