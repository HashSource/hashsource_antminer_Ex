int __fastcall sub_336214(char *a1, char *a2, unsigned int a3)
{
  size_t v4; // r0
  int v5; // r4
  size_t v7; // r0
        ...
        if ( !v13 && v12 <= 0x3FFFFFFF )
        {
          ...
          if ( !v14 )
          {
            ...
            if ( mbsinit(&ps) )
            {
              ...
              return sub_334600((wint_t *)&s, v17, (unsigned int)&v17[v11], (a3 >> 2) & 1, a3);
            }
LABEL_19:
          ...
          if ( v18 )
          {
            ...
            if ( mbsinit(&ps) )
            {
              ...
              v5 = sub_334600(v19, v21, (unsigned int)&v21[v11], (a3 >> 2) & 1, a3);
              free(v19);
              return v5;
            }
            goto LABEL_19;
  ...
  v4 = strlen(s);
  return sub_335740(src, s, (unsigned int)&s[v4], (a3 >> 2) & 1, a3);
}
