void __fastcall sub_6344C(char *a1, int *a2, int a3)
{
  size_t v6; // r0
  size_t v7; // r2
  int v8; // r0
  ...
  ptr = v21;
  v6 = strlen(a1);
  sub_631C0(&ptr, a1, (int)&a1[v6]);
  if ( !a3 )
    goto LABEL_2;
  v22 = v24;
  sub_631C0(&v22, ptr, (int)ptr + v20);
  if ( v23 == 0x7FFFFFFF )
    sub_33D1AC("basic_string::append");
  sub_33C348(&v22, &word_3E1FAC, 1);
  v7 = strlen((const char *)*a2);
  if ( 0x7FFFFFFF - v23 < v7 )
    sub_33D1AC("basic_string::append");
  v8 = sub_33C348(&v22, *a2, v7);
  v25 = v27;
  v10 = v8;
  v12 = (int *)(v8 + 8);
  v11 = *(void **)v8;
