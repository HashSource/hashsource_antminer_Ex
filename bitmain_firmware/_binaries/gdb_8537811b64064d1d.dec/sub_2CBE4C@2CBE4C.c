int __fastcall sub_2CBE4C(_DWORD *a1, int a2)
{
  char *v4; // r0
  int v5; // r6
  int v6; // r11
...
LABEL_37:
  ...
  if ( (a1[10] & 0x2000) != 0 )
  {
    ...
    for ( i = v17; v18; v18 = (_DWORD *)v18[3] )
    {
      ...
      if ( (*(_DWORD *)(v20 + 8) & 0x1000000) != 0 )
      {
        ...
        {
          sub_2A6A84("%B: GNU_MBIN section `%A' has invalid sh_info field: %d", a1, v18);
        }
      }
    }
  }
  ...
  if ( v14 )
  {
    v15 = v14(a1, a2);
    if ( v15 == -1 )
      sub_2A6C18((int)"elf.c", 4405, (int)"get_program_header_size");
    v5 += v15;
  }
