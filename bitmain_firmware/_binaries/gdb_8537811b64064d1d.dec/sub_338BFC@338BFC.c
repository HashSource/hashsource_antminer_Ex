int __fastcall sub_338BFC(const char *a1, _BYTE *a2)
{
  int v2; // r12
  const char *v3; // r8
  _BYTE *v4; // r11
...
LABEL_11:
    if ( !v6 )
    {
      ...
      if ( !v11 )
      {
        ...
        if ( v8 > 0x1F )
          return sub_33883C((int)v10, v15, v14, v8);
        if ( v8 > 2 )
        {
          v17 = sub_33872C((int)v14, v8, &v58);
          v54 = v58;
        }
        else
        {
        ...
        if ( !v18 )
        {
          ...
          {
            v21 = v8 + v19;
            v22 = sub_338618(&v12[i], 0, v8 + v19 - i) == 0;
            if ( !(v8 + v19) )
              v22 = 0;
            if ( !v22 )
              return 0;
...
LABEL_47:
        ...
        {
          v41 = v8 + v19;
          v42 = sub_338618(&v12[v37], 0, v8 + v19 - v37) == 0;
          if ( !(v8 + v19) )
            v42 = 0;
          if ( !v42 )
            return 0;
