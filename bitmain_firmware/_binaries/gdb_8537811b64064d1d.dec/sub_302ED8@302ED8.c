...
LABEL_44:
          ...
          else
          {
            ...
            {
              v44 = strlen(v25) + 1;
              v45 = (_DWORD *)sub_2ACC1C((int)a1, v42 + v44);
              v13[10] = v45;
              if ( !v45 )
                return 0;
              memcpy(v45, s, v42);
...
LABEL_10:
  ...
  v13 = (_DWORD **)sub_2AD0C4((int)a1, 0x2Cu);
  if ( !v13 )
    return 0;
  *v13 = sub_2AD7D4((int)a1, ".stab");
  v46 = sub_2AD7D4((int)a1, ".stabstr");
  v47 = (int)*v13;
  v13[1] = v46;
  v48 = v47 == 0;
  if ( v47 )
  ...
  if ( v48 )
  {
    *v13 = sub_2AD7D4((int)a1, "$GDB_SYMBOLS$");
    v46 = sub_2AD7D4((int)a1, "$GDB_STRINGS$");
    v47 = (int)*v13;
    v13[1] = v46;
    v70 = v46 == 0;
    if ( v46 )
  ...
  if ( !v111 )
    v111 = *((_DWORD *)v46 + 9);
  v13[2] = (_DWORD *)sub_2ACC1C((int)a1, n);
  v50 = sub_2ACC1C((int)a1, v111);
  v51 = v13[2];
  v13[3] = (_DWORD *)v50;
  v52 = v51 == 0;
  if ( v51 )
  ...
  if ( v52 )
    return 0;
  if ( !sub_2ADF04((int)a1, *v13, v51, (int)*v13, 0, n) )
    return 0;
  if ( !sub_2ADF04((int)a1, v13[1], v13[3], v111, 0, v111) )
    return 0;
  v53 = sub_2A6B04((int)a1);
  v54 = v53;
  if ( v53 < 0 )
    return 0;
  v55 = (char *)sub_2AB390(v53);
  v56 = v54 != 0;
  if ( v55 )
    v56 = 0;
  if ( v56 )
    return 0;
  v57 = sub_2A6B38((int)a1);
  if ( v57 < 0 )
  {
    if ( !v55 )
      return 0;
    ...
    if ( *(_DWORD *)v55 )
    {
      ...
      do
      {
        ...
        if ( v69 )
        {
          ...
          {
LABEL_95:
            sub_2A6A84("Unsupported .stab relocation");
...
LABEL_109:
  ...
  v13[5] = v77;
  v78 = sub_2ACC1C((int)a1, 24 * (_DWORD)v77);
  v13[4] = (_DWORD *)v78;
  if ( v78 )
  {
    v130 = a3;
    ...
    while ( 2 )
    {
      ...
      if ( (int)v84 <= v126 || v83 >= (unsigned int)v13[2] + v73 )
      {
        ...
        v95[5] = 0;
        v13[5] = (_DWORD *)sb;
        qsort(v89, sb, 0x18u, (__compar_fn_t)sub_302A80);
        *a9 = v13;
        goto LABEL_6;
      }
