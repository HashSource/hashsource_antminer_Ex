void __fastcall sub_ED748(int a1, int a2, void **a3, int *a4, _DWORD *a5, void **a6)
{
  int v10; // r0
  char *v11; // r5
  size_t v12; // r0
  ...
  if ( a6 )
  {
    ...
    *(_BYTE *)ptr = 0;
    if ( ptr != v61 )
      sub_339E8C(ptr);
    v10 = sub_26FE18(a1);
    v11 = (char *)((int (__fastcall *)(int))loc_26FEA4)(v10);
    v12 = strlen(v11);
    sub_33BC7C((int)&v47, 0, v48, v11, v12);
  }
  sub_ECC00(&v44, &v45, &v46, 0);
  v13 = *(_DWORD *)(v45 + 24);
  switch ( *(_BYTE *)v13 )
  {
    case 1:
      if ( !a3 )
        goto LABEL_51;
      sub_93200((char **)&v56, "*%s", *(const char **)a1);
      v34 = (void **)*a3;
      if ( v56 == v58 )
      {
        sub_33B4B4(a3, &v56);
    ...
    case 2:
      if ( a3 )
      {
        v22 = sub_98C44(
                *(_QWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v13 + 24) + 12) + 24) + 24) + 8) + a2,
                ...
                0);
        v23 = strlen(v22);
        sub_33BC7C((int)a3, 0, (int)a3[1], v22, v23);
      }
      if ( a4 && v44 )
      {
        v24 = a2
            + *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v45 + 24) + 24) + 12) + 24) + 24)
                        + 8);
        v25 = sub_92E50();
        *a4 = sub_25CE34(v44, v26, v24, v24 >> 31);
        sub_92E68((int)v25);
      }
      if ( a5 )
        *a5 = sub_1715C0(v45);
      ...
      v28 = sub_98C44(
            ...
            + a2,
              ...
              0,
              0);
      sub_93200((char **)&v50, "(%s)[%s]", v27, v28);
      v29 = (void **)*a6;
      if ( v50 == v52 )
      {
        sub_33B4B4(a6, &v50);
    ...
    case 4:
      ...
      if ( v15 && *v15 )
      {
        if ( a3 )
        {
          ...
          sub_33BC7C((int)a3, 0, (int)a3[1], v15, v16);
        }
        if ( a6 )
        {
          v17 = (int *)".";
          if ( v46 )
            v17 = &dword_364FF4;
          sub_93200((char **)&v53, "(%s)%s%s", v47, v17, v15);
          v18 = (void **)*a6;
          if ( v53 == v55 )
          {
            sub_33B4B4(a6, &v53);
      ...
      else
      {
        if ( a3 )
        {
          ...
          if ( **(_BYTE **)(*(_DWORD *)(v14 + 12) + 24) == 3 )
            sub_33BC7C((int)a3, 0, v43, "<anonymous struct>", 0x12u);
          else
            sub_33BC7C((int)a3, 0, v43, "<anonymous union>", 0x11u);
        }
        if ( a6 )
          sub_33BC7C((int)a6, 0, (int)a6[1], "", 0);
      }
      if ( a4 && v44 )
        *a4 = sub_ECFF0(v44, a2);
      v27 = (char *)v47;
...
LABEL_41:
    ...
    default:
      if ( a3 )
        sub_33BC7C((int)a3, 0, (int)a3[1], "???", 3u);
      if ( !a6 )
        goto LABEL_40;
      sub_33BC7C((int)a6, 0, (int)a6[1], "???", 3u);
      v27 = (char *)v47;
      goto LABEL_41;
  }
}
