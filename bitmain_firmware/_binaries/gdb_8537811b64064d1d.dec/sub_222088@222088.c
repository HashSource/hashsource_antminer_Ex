void __fastcall sub_222088(const char *a1)
{
  char *v1; // r5
  char *v2; // r0
  char *v3; // r8
  ...
  if ( v29[0] != v29[1] )
  {
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        v13 = *(_DWORD *)(v12 + 28);
        v14 = sub_204330(v13);
        sub_93200((char **)&v32, "%s:'%s'", v14, **(const char ***)(v6 + 4));
        v15 = v30;
        if ( v32 == (char *)v33 + 4 )
        {
          sub_33B4B4(&v30, &v32);
...
LABEL_24:
        ...
        *v15 = 0;
        ...
        v18 = *(_DWORD *)v6;
        v19 = *(_DWORD *)(v6 + 4);
        v20 = (const char *)((int (__fastcall *)(int))loc_2043FC)(v17);
        sub_21B658(1, v19, v18, v20);
        LODWORD(v6) = v6 + 16;
        if ( HIDWORD(v6) == (_DWORD)v6 )
          goto LABEL_27;
      }
      sub_93200((char **)&ptr, v27, *v11);
      v7 = v30;
      if ( ptr == (char *)v35 + 4 )
      {
        sub_33B4B4(&v30, &ptr);
