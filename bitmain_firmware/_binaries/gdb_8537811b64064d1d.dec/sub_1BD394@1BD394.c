int sub_1BD394()
{
  ...
  else
  {
    ...
    while ( strcmp(v1, v3) )
    {
      if ( ++v4 == 20 )
      {
        sub_94728((int)"osabi.c", 627, "Invalid OS ABI \"%s\" passed to command handler.", v1);
        goto LABEL_15;
      }
      v3 = (&off_3C9F54)[2 * v4];
    }
  ...
  v0 = v11;
  sub_B8690(v11);
  result = sub_B81D0(v11[0], v11[1], v11[2], v11[3], v11[4], v11[5], v11[6]);
  if ( !result )
  {
LABEL_15:
    v5 = sub_94728((int)"osabi.c", 636, "Updating OS ABI failed.");
    v9[1] = v0;
    v10 = v6;
    v7 = v5;
    v8 = *(_DWORD *)(v5 + 160);
