void __fastcall sub_21F52C(int **a1, int a2, int a3, char *a4, char *a5, char *s, int a7)
{
  char *v9; // r5
  int v10; // r3
  char *v11; // r12
...
LABEL_56:
                  ...
                  v35 = sub_21B3EC(v31);
                  sub_21F0BC((int)a1, v34, v35, (int)&v77, v64[0], v33);
                  v36 = v64[0];
                  v61 = a5;
                  v23 = (_BYTE *)sub_21B3EC(v31);
                  v37 = v23;
                  if ( ((*v23 - 43) & 0xFD) == 0 )
                  {
                    if ( *v64[0] == 91 )
                      sub_21F0BC((int)a1, 3, (int)(v23 + 1), (int)&v77, v64[0], v61);
                    while ( 1 )
                    {
                      v40 = strlen(v37);
                      v39 = dword_4897F4;
                      ...
                      dword_4897F8 = (int)sub_93078((void *)dword_4897F8, v39);
                    }
                    v23 = strchr(v37, 32);
                    if ( v23 )
                    {
                      ...
                      if ( !v41 )
                      {
                        ...
                        *(_BYTE *)(v51 + v62) = 32;
                        ...
                        sub_21F0BC((int)a1, 3, v51, (int)&v77, v36, v61);
                        v42 = (char *)dword_4897F8;
                        if ( *v36 != 91 )
                          goto LABEL_76;
                        sub_21F0BC((int)a1, 3, dword_4897F8 + 1, (int)&v77, v36, v61);
                      }
                      if ( src )
                      {
                        v42 = (char *)dword_4897F8;
LABEL_76:
                        ...
                        if ( v43 )
                          *v43 = 0;
                        sub_21F0BC((int)a1, 3, (int)v42, (int)&v77, v36, v61);
                      }
                    }
                  }
LABEL_79:
            ...
            while ( v30 )
            {
              ...
              if ( v32 )
              {
                do
                {
                  sub_21F220((int)v32, (int)a1, v63, (int)&v77, v64[0], a5, a7);
                  v32 = (_DWORD *)*v32;
                }
                while ( v32 );
                v30 = (_DWORD *)*v30;
...
LABEL_52:
          ...
          v75 = &a5;
          v76 = &a7;
          sub_215320(0, 0, (int)&v77);
          v45 = sub_20F3B0(0);
          v46 = (int *)sub_C2690((int)v45);
          i = sub_C26C4((int)v45);
          srca = (char *)i;
          if ( v46 )
          {
            ...
            {
              sub_258BFC(i);
              for ( i = sub_C28D0(v45, &v71); ; i = sub_C290C((int)&v71) )
              {
                v48 = i;
                if ( !i )
                  break;
                if ( a7 )
                {
                  if ( (*(_BYTE *)(i + 32) & 7) == 2 && a7 == **(char **)(*(_DWORD *)(i + 24) + 24) )
                    sub_21F1D4((int)a1, i, (int)&v77, v64[0], a5);
                }
                else
                {
                  sub_21F1D4((int)a1, i, (int)&v77, v64[0], a5);
                  if ( *((_DWORD *)off_46DBB8 + 4 * (*(unsigned __int8 *)(v48 + 32) >> 3)) == 8 )
                    sub_21F3C4((int)a1, v48, (int)&v77, v64[0], a5);
                }
              }
              if ( v45[2] )
              {
            ...
            if ( a7 )
              goto LABEL_116;
            for ( j = sub_C28D0(v46, &v71); j; j = sub_C290C((int)&v71) )
            {
              if ( *((_DWORD *)off_46DBB8 + 4 * (*(unsigned __int8 *)(j + 32) >> 3)) == 8 )
                sub_21F3C4((int)a1, j, (int)&v77, v64[0], a5);
            }
          }
          else if ( a7 )
          {
LABEL_116:
          ...
          if ( srca )
          {
            for ( k = sub_C28D0(srca, &v71); k; k = sub_C290C((int)&v71) )
            {
              if ( *((_DWORD *)off_46DBB8 + 4 * (*(unsigned __int8 *)(k + 32) >> 3)) == 8 )
                sub_21F3C4((int)a1, k, (int)&v77, v64[0], a5);
            }
          }
          if ( off_46D5A4[0][6] == (char *)1 && !a7 )
          {
            ...
            if ( v55 )
            {
              v65 = &v67;
              v66 = sub_21F47C;
              sub_1A3670(*v55, (int)v55[1], (int)&v67, (int)sub_21F47C);
              free(v56);
            }
            v65 = &v67;
            v66 = sub_21F47C;
            sub_1A3628(dword_487A1C, (int)&v67, (int)sub_21F47C);
          }
          goto LABEL_116;
        }
        v58 = &v73;
