FILE *__fastcall sub_45174(int a1, sigset_t *set, sigset_t *a3, sigset_t *a4)
{
  FILE *v8; // r2
  FILE *result; // r0
  ...
  sigemptyset(a3);
  sigemptyset(a4);
  sub_93198(v13, 4096, "/proc/%d/status", a1);
  sub_96818((int)&stream, (int)v13, "r");
  v8 = stream;
  if ( !stream )
    sub_94708("Could not open %s", v13);
