int __fastcall sub_31D624(char *s1, int a2, void (__fastcall *a3)(_BYTE *), int a4)
{
  int v8; // r2
  bool v9; // zf
  int v10; // r3
...
LABEL_32:
  ...
  if ( v13 == 1 )
  {
    v19 = (_DWORD *)sub_31CFE4(v21, 1);
LABEL_36:
    if ( (a2 & 1) != 0 )
      goto LABEL_37;
    return v19 && sub_31D518(a2, v19, a3, a4);
  }
  if ( !v13 )
  {
    v19 = sub_319DF8((int)v21);
    goto LABEL_36;
  }
  ...
  {
    s = s1 + 13;
    v17 = (_DWORD *)sub_31C88C((int)v21, 0);
  }
  else
  {
    v20[1] = s1 + 11;
    v16 = strlen(s1 + 11);
    v17 = sub_31412C(v21, (int)(s1 + 11), v16);
  }
  v19 = (_DWORD *)sub_313750(v21, v15, (unsigned int)v17);
  s += strlen(s);
  if ( (a2 & 1) != 0 )
  {
LABEL_37:
