void __fastcall sub_1925C0(int a1, int *a2)
{
  int v4; // r5
  int v5; // r2
  int v6; // r5
...
LABEL_3:
    ...
    if ( v5 != -1 )
    {
      ...
      if ( dword_4879D8 )
      {
        v8 = *(_DWORD *)sub_242FF0(*a2);
        v9 = (const char *)sub_25ACB4(a1, v7);
        sub_2594D8(v8, "jit_breakpoint_re_set_internal, breakpoint_addr = %s\n", v9);
      }
      if ( a2[1] != v7 )
      {
        if ( a2[2] )
          ((void (*)(void))loc_DB0D8)();
        a2[1] = v7;
        a2[2] = sub_D0468(a1, v7);
      }
      return;
    }
    sub_94728((int)"jit.c", 1071, "Section index is uninitialized");
    goto LABEL_20;
  }
  sub_1B24B0((int)&v95, "__jit_debug_register_code");
  v4 = v95;
  if ( !v95 )
    return;
  v10 = *(__int16 *)(v95 + 22);
  if ( v10 != -1 )
  {
    ...
    if ( !(*(_DWORD *)(v95 + 8) + *(_DWORD *)(*(_DWORD *)(v96 + 144) + 4 * v10)) )
      return;
    sub_1B1444((int)v97, "__jit_debug_descriptor");
    v12 = v97[0];
    if ( !v97[0] )
      return;
...
LABEL_20:
  sub_94728((int)"jit.c", 1053, "Section index is uninitialized");
LABEL_21:
  v15 = sub_94728((int)"jit.c", 1059, "Section index is uninitialized");
  v16 = (_DWORD **)HIDWORD(v15);
  v94 = (void *)HIDWORD(v15);
  v93 = *(int **)(v15 + 28);
  v17 = (char *)sub_98394(0xD8u);
  v18 = ((int (__fastcall *)(char *, _DWORD, const char *, int))loc_1B6F04)(v17, 0, "<< JIT compiled code >>", 64);
  v19 = *((_DWORD *)v17 + 10);
  *(_DWORD *)(v19 + 52) = sub_16F67C(v18);
  sub_1B28C8(v17);
  ptr = *v16;
  if ( *v16 )
  {
    do
    {
      v20 = ptr[1];
      v92 = (_DWORD *)ptr[4];
      v21 = sub_213008(v17, ptr[3]);
      v88 = v21;
      v22 = v20 + 2;
      sub_212E78(v21, ptr[3]);
      sub_21319C(v21);
      v23 = sub_21A700(v21);
      v25 = (_DWORD *)ptr[2];
      v90 = v23;
      ...
      *v91 = v22;
      if ( v42 > 1 )
      {
        ...
        do
        {
          v56 = sub_C26E0((int)(v17 + 48), v36);
          v57 = sub_22087C(v17);
          v58 = sub_1B7278(v17);
          srca = (void *)((int (__fastcall *)(int, int, int, char *))loc_177350)(v58, 10, 8, "void");
          v59 = sub_10B2D8((int)(v17 + 48), v90, 0);
          v60 = v45[4];
          *v56 = v45[3];
          ...
          v61 = *(_DWORD *)(v88 + 12);
          *(_BYTE *)(v57 + 32) = 81;
          ((void (__fastcall *)(int, int))loc_220A20)(v57, v61);
          v62 = sub_170380((int)srca);
      ...
      v67 = sub_C277C((int)(v17 + 48), v36);
      v68 = sub_10B2D8((int)(v17 + 48), v90, 0);
      v67[3] = 0;
      v67[4] = v68;
      *v67 = v46;
      v67[1] = v47;
      v91[2] = v67;
      ((void (__fastcall *)(_DWORD *, int))loc_C281C)(v67, v88);
      v70 = sub_C26E0((int)(v17 + 48), v69);
      v71 = sub_10B2D8((int)(v17 + 48), v90, 0);
      v72 = ptr;
      v73 = (_DWORD *)*ptr;
      v70[3] = v67;
      v70[4] = v71;
  ...
  v82 = *v93;
  *(_DWORD *)(sub_192570((int)v17) + 8) = v82;
  free(v94);
}
