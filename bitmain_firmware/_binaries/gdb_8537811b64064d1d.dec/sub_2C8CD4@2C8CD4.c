int __fastcall sub_2C8CD4(_DWORD *a1, int a2, int a3, int a4, _DWORD *a5, int a6, int a7)
{
  int v11; // r8
  void *v12; // r4
  int v14; // r11
  ...
  v11 = *(_DWORD *)(a1[1] + 444);
  v12 = sub_2AB390(*(_DWORD *)(a3 + 24));
  if ( !v12 )
    return 0;
  if ( sub_2A8A2C((int)a1, *(_QWORD *)(a3 + 16), 0)
    || sub_2A8800((int)v12, *(_DWORD *)(a3 + 24), (int)a1) != *(_DWORD *)(a3 + 24) )
  {
    free(v12);
    return 0;
  }
  ...
  if ( a4 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v27 )
      {
        ...
        sub_2A6A84("%B(%A): relocation %d has invalid symbol index %ld", a1, a2, v16, v27);
      }
      *a5 = off_4709EC;
      a5[2] = v33;
      if ( v14 != 12 )
