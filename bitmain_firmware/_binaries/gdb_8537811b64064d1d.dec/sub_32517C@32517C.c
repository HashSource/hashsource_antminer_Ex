const char *__fastcall sub_32517C(int a1, unsigned int a2, int a3, int a4, int a5, _BYTE *ptr, int a7, int *a8)
{
  FILE *v9; // r0
  int v11; // r10
  int v13; // r6
  ...
  if ( *(_DWORD *)(a1 + 16) )
  {
    if ( !sub_324F58((int *)a1, 0, (int)&v45, (int)a8) )
      return v45;
...
LABEL_21:
    ...
    if ( (a2 & 4) != 0 )
    {
      ptr = sub_31E2A4(*(const char **)(a1 + 8), (int)ptr, 0, v18);
...
LABEL_52:
  ...
  v33 = sub_325040((const char **)(a1 + 8), a2, (int)ptr, *(_DWORD *)a1);
  v34 = v33;
  if ( !v33 )
  {
    ptr = v14;
