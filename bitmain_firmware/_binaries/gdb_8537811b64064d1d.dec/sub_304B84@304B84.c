int __fastcall sub_304B84(int *a1, int a2)
{
  int v2; // r12
  unsigned int v3; // r3
  int v4; // lr
...
LABEL_51:
    ...
    sub_303E84(v34, (void *)(a1[14] + v29), v37);
    v36 = a1[23];
    v29 = v37 + a1[27];
    a1[27] = v29;
    goto LABEL_52;
