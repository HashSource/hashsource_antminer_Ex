int __fastcall sub_1E76C(_DWORD *a1)
{
  unsigned int v1; // r4
  int v3; // r0
  int v4; // r0
  ...
  if ( ((v1 >> 11) & 3) > 1 )
  {
    switch ( BYTE1(v1) & 0xF )
    {
      ...
      case 5:
        ...
        ((void (__fastcall *)(int, int, _DWORD *))loc_1DFA24)(v3, 13, v24);
        if ( (_BYTE)v1 )
        {
          v10 = 0;
          do
...
LABEL_22:
      ...
      case 0xE:
        v15 = a1[2];
        a1[8] = 2;
        v16 = (const char *)sub_25ACB4(*a1, v15);
