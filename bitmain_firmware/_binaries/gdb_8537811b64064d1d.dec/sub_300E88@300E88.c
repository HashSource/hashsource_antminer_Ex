int __fastcall sub_300E88(int a1, int **a2, int a3, int a4, int a5)
{
  int *v6; // r4
  int v10; // r6
  ...
  {
    v15 = (_DWORD)v14 * sub_2A692C(a1);
    if ( !sub_3009B4((int)v6, a1, a5, v15) )
      return 4;
    v16 = *(_DWORD **)(v10 + 16);
    v17 = v6[9];
    if ( (v16[5] & 0x1000) != 0 )
...
LABEL_22:
      ...
      if ( v27 )
      {
        v42 = v6[3];
        v32 = sub_2A67CC(a1);
        v33 = sub_300904(v27, v42, v28, v32, v24);
        v28 = v6[1];
        v12 = v33;
      }
      else
