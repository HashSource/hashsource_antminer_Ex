_DWORD *__fastcall sub_32FFE0(_DWORD *a1, int a2, int *a3)
{
  char v3; // r12
  void *v4; // r11
  int v5; // r4
  ...
  if ( (v3 & 0x70) == 0 )
  {
    ...
    {
      sub_32AB94((int)a1, a2);
      a1[1] = v59;
      sub_3295C0(a1, a3, &v60, (int *)&v61);
      v55 = 0;
      v5 = v61;
      free(0);
      goto LABEL_39;
    ...
    if ( v8 > 49 )
      ...
      v11 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v8) + 5);
    if ( v11 > 36 )
    {
      v40 = malloc(v11);
      ptr = v40;
    ...
    if ( v10 > 49 )
      ...
      v13 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v10) + 5);
    if ( v13 <= 36 )
    {
      v4 = 0;
      v18 = &v84;
    ...
    *(_DWORD *)v17 = 3;
    ...
    sub_32B560((int)v17, (int)v17, (int)v12, (int)v73, &v62);
    LODWORD(v21) = &v69;
    HIDWORD(v21) = v73;
    sub_32C3D8((int)v17, (int)v17, v21, 0, &v62);
    v67 = 0;
    v22 = 3;
    v66[1] = 0;
    v68 = 0;
    ...
    do
    {
      ...
      if ( v23 >= v10 )
        ...
        v25 = v23;
      v73[0] = v25;
      sub_32D420((int)v18, (int)v12, v24, 0x80u, &v62);
      sub_32C3D8((int)v18, (int)v18, __SPAIR64__(v73, (unsigned int)v17), 0, &v62);
      sub_32B560((int)v17, (int)v18, (int)&v69, (int)v73, &v62);
      v22 = v73[0];
    }
    while ( v73[0] < v10 );
    v63 = 0;
    ...
    *((_DWORD *)v17 + 1) += v56 / 2;
    ...
    v81 = v32;
    v78 = 3;
    sub_328A28((int)v17, &v75, (unsigned __int16 *)v17 + 5, v29, &v60, (int *)&v63);
    sub_3295C0(v17, &v75, &v60, (int *)&v63);
    if ( (v63 & 0x200) != 0 )
    {
      v61 = v63;
      sub_32AB94((int)a1, (int)v17);
      v5 = v61;
LABEL_38:
      free(ptr);
      goto LABEL_39;
    ...
    *((_DWORD *)v17 + 1) -= v58;
    ...
    v73[0] = v34 - 1;
    v70 = ~v33;
    sub_32C3D8((int)v18, (int)v17, v36, 0x80u, &v62);
    v74 = 1;
    sub_32B560((int)v18, (int)v18, (int)v18, (int)v73, &v62);
    sub_32AE60((int)v18, (int)v12, (int)v18, (int)v73, 1u, &v62);
    if ( v18[8] < 0 )
    {
      HIDWORD(v45) = v73;
      LODWORD(v45) = &v69;
      ++v70;
      v72 = 1;
      sub_32C3D8((int)v17, (int)v17, v45, 0x80u, &v62);
      v42 = v77;
    ...
    else
    {
      HIDWORD(v37) = v73;
      LODWORD(v37) = &v69;
      sub_32C3D8((int)v18, (int)v17, v37, 0, &v62);
      v74 = 5;
      sub_32B560((int)v18, (int)v18, (int)v18, (int)v73, &v62);
      sub_32AE60((int)v18, (int)v18, (int)v12, (int)v73, 1u, &v62);
      if ( v18[8] >= 0 )
        goto LABEL_47;
      HIDWORD(v41) = v73;
      LODWORD(v41) = &v69;
      ++v70;
      v72 = 1;
      sub_32C3D8((int)v17, (int)v17, v41, 0, &v62);
      v42 = v77;
      v43 = v76;
      v44 = __PAIR64__(&v75, (unsigned int)v17);
    }
    v77 = v42 - v58;
    v76 = v43 - v58;
    sub_32C3D8((int)v17, (int)v66, v44, 0, &v62);
LABEL_47:
    *((_DWORD *)v17 + 1) += v58;
    sub_32AB94((int)v18, (int)v17);
    sub_32882C((int)v18, (int)a3, 1, 1, &v64);
    if ( 2 * *(_DWORD *)v18 - 1 > v57
      || (v65 = 0, sub_32B560((int)v18, (int)v18, (int)v18, (int)v73, &v65), (v65 & 0x200) != 0)
      || (sub_32AE60((int)&v69, (int)v18, a2, (int)v73, 1u, &v65), v72)
      || v69 != 1
      || (v71 & 0x70) != 0 )
    {
      v38 = v61 | 0x820;
    ...
    else
    {
      ...
      if ( v59 - v46 >= 0 )
      {
        ...
        if ( v47 > 0 )
        {
          ...
          sub_328658((_WORD *)v17 + 5, v49, v47);
          v38 = v61;
