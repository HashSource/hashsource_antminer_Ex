int __fastcall sub_3129C0(_DWORD *a1, unsigned __int8 **a2, const void **a3)
{
...
LABEL_50:
    ...
    {
LABEL_65:
      sub_30D40C((int)a3, " virtual table");
      return v11;
    }
    while ( v21 != 81 )
    {
...
LABEL_85:
      ...
      {
        v37 = v22;
        sub_30D348(__SPAIR64__((unsigned int)v20, (unsigned int)a3), v22);
        v20 = *a2;
        v22 = v37;
      }
      v20 += v22;
...
LABEL_67:
        ...
        if ( v16 != 75 )
        {
          ...
          sub_30D348(__SPAIR64__((unsigned int)v18, (unsigned int)a3), v17);
          v18 = *a2;
LABEL_35:
          v19 = &v18[v17];
          v11 = 1;
...
LABEL_69:
          ...
          if ( (*a1 & 4) == 0 )
            v25 = "::";
          *a2 = v26;
          sub_30D40C((int)a3, v25);
          v27 = *a2;
          v28 = strlen((const char *)*a2);
          if ( v28 )
          {
            sub_30D348(__SPAIR64__((unsigned int)v27, (unsigned int)a3), v28);
            v27 = *a2;
          }
          *a2 = &v27[v28];
          return v11;
  ...
  if ( strncmp((const char *)v4, "__thunk_", 8u) )
  {
    ...
    *a2 = v4 + 4;
    ...
    if ( v9 != 81 )
    {
      ...
      if ( v9 != 75 )
      {
        v11 = sub_30E850(a1, a2, (unsigned int)a3);
LABEL_15:
        if ( v11 && !**a2 )
        {
          if ( *v10 )
            sub_30D40C((int)a3, v10);
          return v11;
        }
        return 0;
      }
