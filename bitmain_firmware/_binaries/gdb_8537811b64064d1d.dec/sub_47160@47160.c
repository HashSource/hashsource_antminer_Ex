unsigned __int64 __fastcall sub_47160(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  _DWORD *v4; // r5
  bool v6; // zf
  int v7; // r3
  ...
  if ( v6 )
  {
    if ( (unsigned __int64)(*(_QWORD *)&dword_46AF90 + 1LL) > 1 )
      sub_92078(&unk_47260C);
    v4 = &unk_47260C;
    *(_QWORD *)&dword_46AF90 = 0;
    dword_472618 = 0;
    sub_920A8(&unk_47260C);
    sub_9206C(&unk_47260C, "<osdata type=\"modules\">\n", 24);
    sub_96818((int)&stream, (int)"/proc/modules", "r");
    v9 = stream;
    if ( stream )
    {
      while ( 1 )
      {
        ...
        {
          v10 = strtok(s, (const char *)&word_3E1FAC);
          if ( v10 )
          {
            v11 = strtok(0, (const char *)&word_3E1FAC);
            if ( v11 )
            {
              if ( sscanf(v11, "%u", &v21) == 1 )
              {
                v14 = strtok(0, (const char *)&word_3E1FAC);
                if ( v14 )
                {
                  if ( sscanf(v14, "%d", &v22) == 1 )
                  {
                    v19 = strtok(0, (const char *)&word_3E1FAC);
                    if ( v19 )
                    {
                      v15 = strtok(0, (const char *)&word_3E1FAC);
                      if ( v15 )
                      {
                        v16 = strtok(0, (const char *)&word_356660);
                        if ( v16 )
                        {
    ...
    sub_9206C(&unk_47260C, "</osdata>\n", 11);
    dword_472618 = sub_920BC(&unk_47260C);
