int __fastcall sub_2BA0B4(int a1, int a2, _DWORD *a3, int a4)
{
  int v5; // r4
  int v10; // r3
  void *v11; // r9
  ...
  if ( (*(_DWORD *)(*(_DWORD *)(a2 + 52) + 40) & 0x40) != 0 )
    sub_2A6BE4("elf32-arm.c", 17357);
  if ( !*(_DWORD *)(v5 + 436) )
    return sub_2D06D8(a1, a2, a3, a4);
  v27 = *(_DWORD *)(a2 + 28);
  if ( *(_DWORD *)(v27 + 44) != 4 )
    __und(0);
  v10 = *(_DWORD *)(v27 + 1280);
    ...
    else
    {
      ...
      do
      {
        ...
        if ( (v19 & 8) != 0 && (v19 & 0x82) != 0 )
        {
          ...
          {
            maxlen = v20;
            v23 = sub_2AB424(v11, v20);
            v21 = v26;
            v11 = v23;
          }
          snprintf((char *)v11, maxlen, "%s%s", "__acle_se_", v21);
          v22 = (unsigned __int8 *)sub_2FC948(v27, v11, 0);
