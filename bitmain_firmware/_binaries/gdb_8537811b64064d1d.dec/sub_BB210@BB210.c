void __fastcall sub_BB210(const char *a1, int a2, int a3)
{
  int v4; // r6
  int *v5; // r5
  int v6; // r0
  ...
  sub_243C5C();
  v5 = (int *)sub_B97AC(dword_487D2C);
  if ( a1 && *a1 )
  {
    v34 = (const char *)re_comp(a1);
    if ( v34 )
      sub_94708("Invalid regexp: %s", v34);
  }
  else
  {
    re_comp("");
  ...
  if ( v5 )
  {
    ...
    if ( *v5 )
    {
      ptr = &v36;
      v46 = a3;
      sub_324160(v6, sub_BB19C, &ptr);
      v7 = (char *)v36;
      v8 = v37;
      if ( v36 != v37 )
      {
        v9 = (char *)v37 - (_BYTE *)v36;
        sub_BBAD8(v36, v37, 2 * (31 - __clz(((char *)v37 - (_BYTE *)v36) >> 2)), sub_B9580);
        if ( v9 <= 64 )
        {
          sub_BB8BC(v7, v8, sub_B9580);
          v15 = v5[1];
          if ( v15 )
            goto LABEL_14;
          goto LABEL_22;
...
LABEL_14:
      ...
      if ( v39 != v40 )
      {
        sub_BBAD8(v39, v40, 2 * (31 - __clz(((char *)v40 - (_BYTE *)v39) >> 2)), sub_B9580);
        if ( v18 <= 64 )
        {
          sub_BB8BC(v16, v17, sub_B9580);
        }
        else
        {
          v20 = (const char ***)(v16 + 64);
          sub_BB8BC(v16, v16 + 64, sub_B9580);
          while ( v17 != v20 )
          {
            v21 = *v20;
            for ( j = v20; ; j[1] = *j )
...
LABEL_24:
      if ( v27 )
        sub_2573A8(v4, &word_356660, v25, v26);
      goto LABEL_26;
    }
LABEL_22:
    v25 = &unk_478244;
...
LABEL_26:
  ...
  *((_BYTE *)v42 + (_DWORD)ptr) = 0;
  ...
  {
    if ( a1 && *a1 )
      sub_2573B4(v4, "No auto-load scripts matching %s.\n", a1);
    else
      sub_2573B4(v4, "No auto-load scripts.\n");
  }
  if ( v39 )
    sub_339E8C(v39);
  if ( v36 )
