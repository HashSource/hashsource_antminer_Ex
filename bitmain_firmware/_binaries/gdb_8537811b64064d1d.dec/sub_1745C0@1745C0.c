int __fastcall sub_1745C0(int a1, int a2, int a3)
{
  int v3; // r4
  int v5; // r3
  _BOOL4 v7; // r3
...
LABEL_2:
  if ( v5 == 23 )
    v3 = sub_171280((_DWORD *)v3);
  while ( 2 )
  {
    if ( **(_BYTE **)(a2 + 24) == 23 )
      a2 = sub_171280((_DWORD *)a2);
...
LABEL_27:
    ...
    if ( !sub_173DFC((_DWORD *)v3, (_DWORD *)a2) )
    {
        ...
        if ( (unsigned __int8)(v10 - 18) > 1u )
        {
          ...
          switch ( v10 )
          {
            case 1:
              ...
              switch ( *(_BYTE *)v22 )
              {
                case 1:
                  ...
                  if ( **(_BYTE **)(v38 + 24) == 10 )
                    goto LABEL_60;
                  v39 = sub_173978((_DWORD *)v38, *(_DWORD **)(v22 + 20), 0);
                  if ( v39 < 0 )
                    goto LABEL_27;
                  HIWORD(v45) = v39;
                  LOWORD(v45) = 1;
                ...
                case 7:
                  ...
                  goto LABEL_44;
                case 8:
                  if ( !a3 || **(_BYTE **)(sub_26BC98(a3) + 24) != 8 )
                    goto LABEL_27;
                  if ( !sub_26EB44(a3) )
                    goto LABEL_60;
                  if ( dword_46D4B4 )
            ...
            case 3:
              if ( **(_BYTE **)(a2 + 24) != 3 )
                goto LABEL_27;
              v24 = sub_173978((_DWORD *)v3, (_DWORD *)a2, 0);
              if ( v24 < 0 )
                goto LABEL_27;
              HIWORD(v45) = v24;
              LOWORD(v45) = 2;
              ...
              switch ( *(_BYTE *)v27 )
              {
                ...
                case 8:
                  ...
                  else
                  {
                    ...
                    v44 = *((_DWORD *)v9 + 2);
                    v43 = *(_DWORD *)(v27 + 8);
                    if ( sub_15EAC(v44, v43) )
                      goto LABEL_40;
                  }
                  if ( !sub_15EAC(v43, (int)"int") || !sub_15EAC(v44, (int)"long") )
                    goto LABEL_60;
                  break;
                case 9:
                  goto LABEL_60;
