void sub_30764()
{
  ...
  if ( !v0 || (*(_DWORD *)(v0 + 40) & 0x800) == 0 || sub_BC32C(&dword_4899A0, 9, &v109) <= 0 )
    return;
  ...
  if ( *(_DWORD *)(v2 + 4) == 5 )
  {
    if ( ((*(_DWORD *)(*(_DWORD *)(v2 + 444) + 20) - 1) & v3) != 0 )
      return;
    v10 = (char *)sub_2FFEC(-1, (int *)&v110, &v111, 0);
    v11 = v10;
    ...
    v16 = sub_93050(v13[11] * v14);
    v17 = v13[5];
    ptr = (void *)v16;
    v18 = sub_2A8A2C(v12, HIDWORD(v16), v17, 0, 0);
    if ( v18 || v15 != sub_2A8800(ptr, v15, v12) )
    {
      free(ptr);
      if ( v11 )
        free(v11);
    ...
    v19 = sub_16F67C();
    v107 = ((int (__fastcall *)(int))loc_165BE0)(v19);
    if ( v110 == v15 )
    {
      v22 = sub_2A78C4(*(_DWORD *)(dword_487D2C + 8));
      if ( v22 == v111 )
      {
        if ( v22 == 32 )
        {
          ...
          while ( 1 )
          {
            ...
            {
              v73 = &v11[v37];
              v74 = sub_15C278(v73 + 8, 4, v107) - *(_DWORD *)(v36 + 12);
              v75 = sub_15C278(v73 + 12, 4, v107);
...
LABEL_70:
          ...
          while ( v77 < v30 >> 5 )
          {
            ...
            {
              v80 = sub_15C278(v76 + 2, 4, v78);
              sub_15C374(v76 + 2, 4, v78, v105, v80 - v105, 0);
              v81 = sub_15C278(v76 + 3, 4, v78);
              sub_15C374(v76 + 3, 4, v78, v105, v81 - v105, 0);
              if ( memcmp(v76, v79, 0x20u) )
              {
                ...
                {
LABEL_74:
                  v82 = sub_2AD7D4(*(_DWORD *)(dword_487D2C + 8), v100);
                  v83 = v82;
                  if ( !v82
                    || ((v84 = v107,
                         v107 = *(_DWORD *)(v82 + 20) & 0x100,
                         v85 = &v106[v84 + 16],
                         v86 = sub_15C278(v85, 4, v78),
                         v87 = *(_DWORD *)(v83 + 36),
                         !v107)
                      ? (v88 = v86 - v87)
                      : (v88 = v86 + v87),
                        sub_15C374(v85, 4, v78, 0, v88, 0),
...
LABEL_60:
        ...
        else
        {
          ...
          while ( 1 )
          {
            ...
            {
              v38 = &v11[56 * v25];
              v39 = sub_15C278(v38 + 16, 8, v107) - *(_DWORD *)(v29 + 12);
              v40 = sub_15C278(v38 + 24, 8, v107);
...
LABEL_50:
          ...
          while ( v44 < ((v23 >> 3) * (unsigned __int64)(unsigned int)v101) >> 32 )
          {
            ...
            {
              v46 = sub_15C278(v43 + 4, 8, v42);
              sub_15C374(v43 + 4, 8, v42, 0, v46 - v105, 0);
              v47 = sub_15C278(v43 + 6, 8, v42);
              sub_15C374(v43 + 6, 8, v42, 0, v47 - v105, 0);
              if ( memcmp(v43, v45, 0x38u) )
              {
                ...
                *p_s2 = *(_DWORD *)v66;
                ...
                {
LABEL_55:
                  v48 = sub_2AD7D4(*(_DWORD *)(dword_487D2C + 8), v99);
                  v49 = v48;
                  if ( !v48 )
                    goto LABEL_60;
                  v50 = v107;
                  ...
                  v51 = &v106[v50 + 32];
                  v52 = sub_15C278(v51, 8, v42);
                  v53 = *(_DWORD *)(v49 + 36);
                  v54 = v107 ? v52 + v53 : v52 - v53;
                  sub_15C374(v51, 8, v42, 0, v54, 0);
                  if ( memcmp(v43, v45, 0x38u) )
                    goto LABEL_60;
                }
              }
...
LABEL_6:
  ...
  {
    v20 = sub_16F67C();
    v21 = (const char *)sub_25ACB4(v20, v3);
    sub_259880(
