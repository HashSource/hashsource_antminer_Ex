int __fastcall sub_2B2C60(int a1, int a2, _DWORD *a3, int a4, int a5)
{
  bool v7; // cc
  int v8; // r3
  bool v9; // zf
  ...
  v26[14] = 14;
  v26[15] = 15;
  memcpy(dest, &unk_4135E4, sizeof(dest));
  memcpy(v28, &unk_413628, sizeof(v28));
  memcpy(v29, &unk_413670, sizeof(v29));
  v7 = a4 <= 17;
  if ( a4 <= 17 )
    v7 = a2 <= 17;
  v21[17] = v28;
  ...
  if ( !v7 )
  {
    sub_2A6A84("error: %B: Unknown CPU architecture", a1);
    return -1;
  }
  if ( a2 == 11 )
  {
...
LABEL_19:
  ...
  *a3 = -1;
  ...
  {
LABEL_36:
    sub_2A6A84("error: %B: Conflicting CPU architectures %d/%d", a1, a2, a4, a3);
    return -1;
  }
  return result;
}
