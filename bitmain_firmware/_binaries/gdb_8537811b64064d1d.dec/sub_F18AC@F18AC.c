int __fastcall sub_F18AC(int a1, int a2, unsigned int a3, int a4)
{
  int v6; // r7
  int v7; // r0
  int v8; // r3
  ...
  *(_BYTE *)v8 = 3;
  *(_DWORD *)(v8 + 28) = &word_3B4A54;
  *(_WORD *)(v8 + 2) = v10;
  *(_DWORD *)(v7 + 20) = a2;
  while ( dword_478988 < v58 && dword_478988 < (unsigned int)dword_478A00 )
  {
    ((void (__fastcall *)(_DWORD *, char *, _BYTE *))loc_F163C)(v62, v59, v60);
...
LABEL_35:
        ...
        *(_DWORD *)(a4 + 56) = v50;
        v55 = sub_F1C70(v62, v65, v60, a4, v51[0]);
        v53 = 0;
        LOBYTE(v54) = v54 & 0xF1;
        v52 = 8 * v63;
        v54 &= 0xFu;
LABEL_33:
    ...
    else
    {
      if ( v64 == 18 )
      {
        ...
        *(_DWORD *)(a4 + 56) = v40;
        v41 = sub_F1C70(v62, v65, v60, a4, v51[0]);
        v53 = 0;
        LOBYTE(v54) = v54 & 0xF1;
        v55 = v41;
        v52 = v63;
