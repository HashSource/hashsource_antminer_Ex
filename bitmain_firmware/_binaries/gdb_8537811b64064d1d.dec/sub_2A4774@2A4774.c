int __fastcall sub_2A4774(int a1, int a2, _DWORD *a3, _DWORD *a4)
{
  const char *v4; // r6
  const char *v5; // r4
  size_t v6; // r12
  ...
  *a4 = 0;
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( (*(_BYTE *)(a1 + 44) & 1) != 0 )
      {
        ...
        if ( !v4 || j_strcmp(v4, v11) )
        {
          ...
          else
          {
            v12 = v11;
            if ( **(_BYTE **)a1 != 47 )
              v12 = (const char *)sub_2A3034(v11, *(const char **)a1);
          }
          v13 = strlen(v12) + v9;
          if ( a2 )
            v9 = v13 + 2;
      ...
      v14 = (const char *)sub_3245CC(*(_DWORD *)v5);
      v15 = strlen(v14);
      v16 = v15;
      if ( n >= v15 )
        break;
...
LABEL_43:
      *v26 = *(_BYTE *)(*(_DWORD *)(v21 + 4) + 25);
      ...
      if ( (*(_BYTE *)(a1 + 44) & 1) != 0 && *(_QWORD *)(v21 + 56) )
      {
        ...
        sub_2A3330(&v26[v32 + 1], maxlen - v32, "%-ld");
      }
      else
      {
        sub_2A3330(v27, maxlen, "%-ld");
      }
      if ( v25 != v5 )
      {
        v20 += v24 + 1;
...
LABEL_36:
        ...
        if ( !v5 || j_strcmp(v5, v22) )
        {
          if ( *v22 == 47 || **(_BYTE **)a1 == 47 )
            ...
            v25 = (const char *)sub_2A3034(v22, *(const char **)a1);
          goto LABEL_55;
        }
        v24 = strlen(v5);
