int __fastcall sub_2E1CE4(int a1, int *a2)
{
  const char *v2; // r11
  int v4; // r5
  int result; // r0
...
LABEL_24:
    if ( !v11 )
    {
      ...
      if ( v22 )
      {
        v23 = sub_2FF570(v22, *(_DWORD *)(a1 + 4), &v28);
        *(_DWORD *)(a1 + 64) = v23;
        if ( v23 )
        {
          if ( v28 )
...
LABEL_30:
  ...
  sub_2A6A84("%B: version node not found for symbol %s", v7, v8);
