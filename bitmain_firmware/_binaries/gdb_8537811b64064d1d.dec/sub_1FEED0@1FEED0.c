int __fastcall sub_1FEED0(const char *a1)
{
  size_t v2; // r0
  void *v3; // r4
  _DWORD *v4; // r3
  ...
  if ( v2 > 0xF )
  {
    v10 = (_DWORD *)sub_33B2E4(ptr, &v11, 0);
    ptr[0] = v10;
    v15[0] = v11;
LABEL_11:
...
LABEL_5:
  ...
  *((_BYTE *)v3 + (_DWORD)v4) = 0;
  v5 = sub_98394(0x6Cu);
  sub_1FECAC((unsigned int)v5 + 8, v12, 0, ptr);
  sub_33ACE8(v5, &dword_48938C);
  v6 = ptr[0];
  v7 = ptr[0] == v15;
  ...
  *(_DWORD *)(dword_489390 + 8) = HIDWORD(v8);
  ...
  if ( v12[0] != v13 )
    sub_339E8C(v12[0]);
  return sub_259F38("Function %s will be skipped when stepping.\n", a1);
}
