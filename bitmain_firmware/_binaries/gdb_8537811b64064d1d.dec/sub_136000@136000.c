int __fastcall sub_136000(char *a1, int a2, int *a3)
{
  int v6; // r10
  const char *v7; // r0
  int v8; // r3
  ...
  v6 = *a3;
  if ( !sub_130A20(a2, (int)a3) )
    return sub_135A04(a1, a2, a3, 1);
  v7 = (const char *)sub_12EA5C(a2, a3);
  v8 = a3[16];
  v9 = (char *)v7;
  if ( v8 != 12 )
  {
...
LABEL_22:
  ...
  if ( v17 )
  {
    ...
    v14 = 1;
LABEL_13:
    v16 = (const char *)sub_135A04(a1, a2, a3, 1);
    v11 = v16;
