int __fastcall sub_342DE0(int result, int a2, _DWORD *a3)
{
  _DWORD *v3; // r5
  int v4; // r4
  int v6; // r3
...
LABEL_59:
    ...
    default:
LABEL_15:
      result = sub_3401DC(result, a2, (int)a3);
      break;
  }
  return result;
}
