int __fastcall sub_9FE58(int a1, const char **a2, _DWORD *a3, _DWORD *a4)
{
  int v7; // r8
  int v8; // r3
  int v9; // r7
  ...
  switch ( *((_DWORD *)off_46DBB8 + 4 * (*(unsigned __int8 *)(a1 + 32) >> 3)) )
  {
    ...
    case 0xD:
    case 0xE:
      v11 = sub_338BFC(*(_DWORD *)a1, "___XR");
      if ( !v11 )
        return 0;
      switch ( *(_BYTE *)(v11 + 5) )
      {
    ...
    case 8:
      ...
      if ( *(_WORD *)(v8 + 4) != 1 )
        return 0;
      v17 = sub_170CEC(*(_DWORD *)(a1 + 24));
      if ( !v17 )
        return 0;
      v18 = sub_338BFC(v17, "___XR");
      if ( !v18 )
        return 0;
