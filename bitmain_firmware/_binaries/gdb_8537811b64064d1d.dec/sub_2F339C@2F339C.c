int __fastcall sub_2F339C(int *a1, int a2, int a3, int (__fastcall *a4)(int, int *), int *a5)
{
  int *v6; // r8
  unsigned int v9; // r4
  int v10; // r0
  ...
  do
  {
    ...
    if ( (*((_BYTE *)v13 + 27) & 1) == 0 && *v13 )
    {
      ...
      if ( (*(_DWORD *)(a3 + 20) & 0x100000) != 0 && !v14 )
      {
        ...
        {
          v80 = sub_2F18CC(*((_BYTE *)v13 + 24), v88);
          v14 = v80;
        }
        v19 = sub_2F1B18(a1 + 1, (int)v13[4] + v14 + *(_DWORD *)(a3 + 108) + 8, v80, (v79 >> 3) & 1) != 0;
      }
      else
      {
        v15 = a5[2];
        ...
        {
          sub_2A6BE4("elf-eh-frame.c", 1516);
          v18 = (int)(v13[4] + 2);
        }
        v19 = a4(v18, a5) == 0;
      }
      ...
      if ( *(unsigned __int8 *)(v51 + 60) != 255 )
      {
        ...
        *(_DWORD *)(v51 + 52) = v52;
        ...
        if ( (unsigned int)v55 >= a5[5] || (v56 = a5[3] + 20 * (_DWORD)v55, *(unsigned __int8 *)(v56 + 12) >> 4) )
        {
          ...
          *(_DWORD *)(v51 + 48) = i;
          if ( !sub_2E2F10(i, a2, 0) )
            goto LABEL_85;
        }
        else
        {
          sa = v55;
          v82 = sub_2CFF1C((int)a1, *(_DWORD *)(v56 + 16));
          if ( !v82 )
            goto LABEL_93;
          v83 = *(_DWORD *)(v82 + 124);
          if ( !v83 )
...
LABEL_85:
      v58 = sub_324294(v51, 4, 0);
      v92 = sub_324294(v51 + 8, 1, v58);
      v59 = strlen((const char *)(v51 + 10));
      v60 = sub_324294(v51 + 10, v59 + 1, v92);
      v61 = sub_324294(v51 + 32, 4, v60);
      v62 = sub_324294(v51 + 36, 4, v61);
      v63 = sub_324294(v51 + 40, 4, v62);
      v64 = sub_324294(v51 + 44, 4, v63);
      v65 = sub_324294(v51 + 48, 8, v64);
      v66 = sub_324294(**(_DWORD **)(v51 + 56) + 60, 4, v65);
      v67 = sub_324294(v51 + 60, 1, v66);
      v68 = sub_324294(v51 + 61, 1, v67);
      v69 = sub_324294(v51 + 62, 1, v68);
      v70 = sub_324294(v51 + 63, 1, v69);
      v71 = *(unsigned __int8 *)(v51 + 63);
      if ( v71 >= 0x32 )
        v71 = 50;
      v72 = sub_324294(v51 + 65, v71, v70);
      v73 = v12[45];
      *(_DWORD *)(v51 + 4) = v72;
      if ( !v73 )
      {
        v73 = sub_323B80(1, sub_2F1208, sub_2F1798, free);
        v12[45] = v73;
        if ( !v73 )
          goto LABEL_93;
        v72 = *(_DWORD *)(v51 + 4);
      }
      v74 = (char *)sub_323E90(v73, v51, v72, 1);
      if ( v74 )
      {
        v75 = *(_DWORD *)v74;
        if ( *(_DWORD *)v74 )
...
LABEL_42:
  ...
  *(_DWORD *)(a3 + 40) = v38;
  ...
  do
  {
    ...
    v45 = sub_2F1910(*(_DWORD *)v41, (_DWORD *)a3);
    v41 += 20;
    if ( v45 )
    {
      v44 = 1;
