unsigned __int8 *__fastcall sub_3247A4(char *a1, unsigned __int8 *a2, void *a3, int a4)
{
...
LABEL_9:
  if ( a4 )
    v4 = (unsigned __int8 *)sub_3245F8(v6);
  else
...
LABEL_25:
  ...
  v21 = sub_324654((unsigned __int8 *)v62, v65);
  v62 = v21;
  if ( !v21 )
  {
LABEL_24:
