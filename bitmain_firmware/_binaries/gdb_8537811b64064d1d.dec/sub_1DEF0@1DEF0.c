int __fastcall sub_1DEF0(_DWORD *a1)
{
  unsigned int v1; // r12
  int v2; // r3
  int v4; // r0
  ...
  {
    v20 = (v1 >> 23) & 3;
    ((void (__fastcall *)(int, unsigned int, unsigned int *))loc_1DFA24)(v4, HIWORD(v1) & 0xF, &v25);
    if ( v7 )
    {
      do
      {
