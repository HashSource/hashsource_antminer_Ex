int __fastcall sub_2B17E8(_DWORD *a1, int a2, unsigned int a3, unsigned int a4)
{
  int result; // r0
  unsigned int v7; // r1
  int v8; // r0
  ...
  if ( a2 == 51 )
  {
    if ( sub_2B13A0(src, v35, &v36, a4) )
    {
      v16 = sub_2AD7D4((int)a1, (const char *)src);
      if ( v16
        || (v32 = (char *)sub_2ACC1C((int)a1, v36 + 1), (v33 = v32) != 0)
        && (memcpy(v32, src, v36 + 1), (v16 = (char *)sub_2ADCE8((int)a1, v33)) != 0) )
      {
        v17 = 0;
        while ( 1 )
        {
          ...
          switch ( *(_BYTE *)v35[0] )
          {
            ...
            case '7':
            case '8':
              v20 = (_DWORD *)sub_2ACC1C((int)a1, 28);
              v21 = v35[0];
              v22 = v20;
              ...
              *(_DWORD *)(v25 + 8) = v22;
              if ( !sub_2B13A0(src, v35, &v36, a4) )
                return 0;
              v28 = (void *)sub_2ACC1C((int)a1, v36 + 1);
              v22[1] = v28;
              if ( !v28 )
                return 0;
              ...
              if ( (v23 & 0xFB) == 0x33 )
              {
                ...
                if ( !v17 )
                {
                  v17 = sub_2AD7F4(0, (const char **)v16);
                  if ( !v17 )
                  {
                    v17 = (char *)sub_2ADB70(
                                    (int)a1,
...
LABEL_38:
              if ( !sub_2B12D0(v35, (int *)&v37, a4) )
                return 0;
              v22[2] = v37 - *((_DWORD *)v16 + 7);
              break;
            case '1':
              ++v35[0];
              if ( !sub_2B12D0(v35, (int *)v16 + 7, a4) || !sub_2B12D0(v35, (int *)&v37, v18) )
                return 0;
              v19 = *((_DWORD *)v16 + 7);
              if ( v19 <= v37 )
              {
