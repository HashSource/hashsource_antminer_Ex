bool __fastcall sub_112CCC(int a1, unsigned __int8 *a2, unsigned int a3, int *a4)
{
  int v4; // r12
  ...
  v9 = sub_115FE0(a1, v28);
  if ( v9 != ((int (__fastcall *)(int))loc_167318)(a1) || (unsigned int)v5 >= a3 )
    return 0;
  v16 = *v5;
  v17 = 0;
  v18 = (char *)(v5 + 1);
