_DWORD *__fastcall sub_8D7EC(int a1, unsigned int a2)
{
  const char *v2; // r5
  const char *v5; // r0
  unsigned int v6; // r10
  ...
  v5 = (const char *)sub_C25D0(dword_487CD0);
  if ( *(_DWORD *)a1 != 40 )
  {
    sub_94728(
      "rust-exp.y",
  ...
  v2 = v5;
  if ( !*v5 )
    sub_94708("Couldn't find namespace scope for self::");
  if ( !a2 )
  {
    v6 = strlen(v5);
    goto LABEL_5;
  ...
  for ( i = &v2[v27]; v2[v27]; i = &v2[v27] )
  {
    ...
    v27 += 2 + sub_100330(&v2[v27 + 2]);
  }
  v30 = ((char *)v33 - (_BYTE *)ptr) >> 2;
  if ( a2 >= v30 )
LABEL_40:
    sub_94708("Too many super:: uses from '%s'", v2);
...
LABEL_5:
  ...
  *(_DWORD *)(v19 + 8) = v25;
  ...
  return sub_8CDB4((int)ptr, (int)v33, *(_DWORD *)(a1 + 40));
}
