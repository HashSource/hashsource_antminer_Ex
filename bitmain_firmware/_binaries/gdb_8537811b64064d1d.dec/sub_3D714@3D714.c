int __fastcall sub_3D714(int a1, const char *a2, _DWORD *a3, const char *a4)
{
  const char *v8; // r6
  size_t v9; // r0
  const char *v10; // r5
  ...
  v8 = (const char *)sub_3D11C();
  v9 = strlen(a4);
  v11 = v9 > 2 && (v10 = &a4[v9], *(v10 - 3) == 99) && *(v10 - 2) == 115 && *(v10 - 1) == 104;
  sub_33BC7C(a1 + 12, 0, *(_DWORD *)(a1 + 16), "exec ", 5u);
  if ( v8 )
  {
    v12 = strlen(v8);
...
LABEL_47:
  ...
  v54[0] = 0;
  sub_33B7D8(&ptr);
  sub_33BA94((int)&ptr, v53, 0, 1u, 32);
  sub_33C348(&ptr, *a3, a3[1]);
  sub_33C348(a1 + 12, ptr, v53);
  if ( ptr != v54 )
    sub_339E8C(ptr);
  v41 = *(char **)a1;
  v42 = *(char **)(a1 + 8);
