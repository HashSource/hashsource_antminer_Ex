void __fastcall sub_198014(_DWORD *a1, unsigned int j, char *a3, int a4, void **a5, void **a6)
{
  char *v6; // r8
  void *v8; // r11
  unsigned int *v9; // r5
  ...
  if ( v85[1] )
    v6 = (char *)v85[0];
  v8 = sub_92564(1659940, (int)&v87);
  p_ptr = a1;
  v91 = j;
  ptr = 0;
  v93 = 0;
  ((void (__fastcall *)(char *, void **))loc_1B57E0)(v6, &v87);
  v9 = (unsigned int *)v87;
  v10 = (_DWORD *)a1[2];
  if ( v87 && *(_DWORD *)v87 )
  {
    ...
    do
    {
      ...
      v34 += 4;
      sub_196FDC(v36, 1, (int)&p_ptr, v10);
      ++v35;
    }
    while ( v35 < *v9 );
  }
  ...
  {
    sub_196FDC(v6, a4, (int)&p_ptr, (_DWORD *)a1[2]);
  }
  sub_92648(v8);
  if ( !ptr )
    goto LABEL_9;
...
LABEL_14:
  ...
  {
    v12 = v11 + 2;
    v13 = sub_197FBC(v11 + 2);
    if ( !v13 )
      break;
    v11 = v13;
  }
  v94 = v96;
  sub_195F94(&v94, v6, (int)v11);
  v14 = v87;
  if ( v94 == v96 )
  {
    sub_33B4B4(&v87, &v94);
...
LABEL_29:
  ...
  *v14 = 0;
  if ( v94 != v96 )
    sub_339E8C(v94);
  v16 = strlen(v12);
  sub_33BC7C((int)&p_ptr, 0, v91, v12, v16);
  v77 = 0;
  v17 = (char *)v87;
  v76 = sub_323B08(1, off_4714A0, off_47149C[0], 0, sub_930BC, sub_195418);
  if ( !v17 )
    v18 = -1;
  v97 = v99;
  if ( v17 )
    v18 = (int)&v17[strlen(v17)];
  v19 = sub_195F94(&v97, v17, v18);
  v21 = v97;
  v22 = 1;
  v101 = 0;
  v102 = 0;
  ...
  *(_DWORD *)((char *)v120 + 3) = 0;
    ...
    if ( *(_DWORD *)j )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          v97 = &v76;
          v62 = &v100;
          sub_195D38((int)a1, (int)&v100, 2, 3, 0, 0, (int)&v76, (int)sub_196164);
          v97 = &v76;
          v98 = sub_196164;
          sub_195D38((int)a1, (int)&v100, 1, 3, 0, 0, (int)&v76, (int)sub_196164);
        }
        ++v25;
      }
      while ( v25 < *(_DWORD *)j );
  ...
  if ( v76 )
    sub_323BAC(v76);
  v72 = v26;
  v67 = sub_92564((int)sub_1953F4, (int)&v72);
  if ( v72 && *v72 )
  {
    v70 = sub_92E50();
    v37 = (char *)p_ptr;
    v38 = v72;
    v65 = v72;
    v39 = sub_92564((int)nullsub_39, 0);
    if ( !v38 )
      v40 = (size_t)v65;
    v71 = v39;
    if ( v38 )
    ...
    qsort(v41, v40, 4u, (__compar_fn_t)sub_195A20);
    v73 = 0;
    v82[0] = a1;
    v84 = 0;
    v82[1] = j;
    v83 = 0;
    sub_92564((int)sub_195448, (int)&v73);
    v74 = 0;
    sub_92564((int)sub_195424, (int)&v74);
    if ( !v65 || !*v65 )
      goto LABEL_123;
    v42 = 0;
    v69 = nullsub_39;
    ...
    for ( j = 1; ; ++j )
    {
      ...
      if ( v45[6] )
        goto LABEL_149;
      ((void (__fastcall *)(_DWORD))loc_1CD2B8)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v44 + 4) + 4) + 16));
      v46 = sub_171280(*(_DWORD **)(v43 + 24));
      sub_196AF8(v46, *(_BYTE *)(v43 + 20) & 0x1F, v37, &v74, &v73);
      if ( v38 == (size_t *)(*v65 - 1) )
        goto LABEL_95;
      if ( j >= *v65 )
        break;
      if ( v45 != *(_DWORD **)(*(_DWORD *)(*(_DWORD *)(sub_220A04(*v62) + 4) + 4) + 16) )
      {
LABEL_95:
        v38 = v74;
        if ( v74 )
        ...
        v68 = sub_92564((int)v69, 0);
        do
        {
          v75 = 0;
          sub_92564((int)v66, (int)&v75);
          if ( v51 && *v51 )
          {
            v53 = v51 + 1;
            v54 = 0;
            do
            {
              v55 = v53[1];
              ++v53;
              sub_196AF8(v55, v52, v37, &v74, &v75);
              ++v54;
            }
            while ( v54 < *v51 );
          }
...
LABEL_123:
        ...
        sub_92F8C(2, "see caller, this text doesn't matter", v84);
LABEL_145:
        if ( v73 )
...
LABEL_149:
    ...
    v60 = (int *)sub_339EA0(v59);
    if ( v60[1] != 2 )
      sub_92F44(*v60, v60[1], v60[2]);
    sub_339F20(v60);
  }
LABEL_64:
  sub_92648(v67);
