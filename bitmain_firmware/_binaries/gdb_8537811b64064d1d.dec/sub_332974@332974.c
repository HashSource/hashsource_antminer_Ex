int *__fastcall sub_332974(int *a1, int *a2, int a3)
{
  int v3; // r3
  int v4; // r5
  _BYTE *v5; // r4
  ...
  {
    sub_3312D4((int)v39, 64);
    v40 = *(_DWORD *)(a3 + 12);
    sub_32D1E0((int)v31, (unsigned int)v5, (int)v39);
    v9 = v5[8];
    v5 = v31;
    v4 = v41;
    v10 = v9 & 0x80 | v32;
...
LABEL_18:
    ...
    if ( v15 >= 0x300 )
    {
      sub_332718((unsigned int)v5, &v29, v15 - 767);
      v4 |= 0x400u;
      v12 = v29;
      v16 = 66846720;
      v10 = v5[8];
...
LABEL_45:
  ...
  else
  {
    ...
    {
      sub_332718((unsigned int)v5, &v29, 0);
      v10 = v5[8];
    }
    v12 = v29;
    if ( (v10 & 0x20) != 0 )
