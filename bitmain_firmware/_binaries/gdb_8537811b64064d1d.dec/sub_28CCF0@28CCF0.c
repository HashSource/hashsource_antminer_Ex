unsigned int __fastcall sub_28CCF0(unsigned int result, char *a2)
{
  int v2; // r9
  int v3; // r6
  bool v4; // zf
  ...
  if ( !v4 )
  {
    ...
    {
      result = sub_28C450(a2, v7, v6, 1);
      dword_48AE48 = 1;
      v8 = result + dword_48AE10;
      goto LABEL_23;
    }
    result = sub_28C450(a2, 0, v6, 1);
    v8 = result;
    if ( dword_48AE20 < v6
...
LABEL_27:
    ...
    {
      result = tputs((const char *)dword_490140, 1, (int (*)(int))sub_293BA8);
      v3 = 0;
      dword_48AE04 = 0;
    }
    if ( v3 < v8 )
    {
      ...
      else
      {
        ...
        if ( dword_490110 )
        {
          ...
          {
            ++v3;
            result = tputs(v11, 1, (int (*)(int))sub_293BA8);
            if ( v8 == v3 )
              break;
            v11 = (const char *)dword_490110;
          }
