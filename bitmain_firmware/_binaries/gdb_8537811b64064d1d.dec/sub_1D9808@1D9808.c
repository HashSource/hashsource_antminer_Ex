int __fastcall sub_1D9808(_DWORD *a1, int a2, int a3, int a4, int a5, int a6)
{
  _BOOL4 v7; // r7
  int v8; // lr
  int v9; // r6
  ...
  if ( v10 )
  {
    ...
    v13 = sub_1DDBE4(v12);
    ((void (__fastcall *)(int, int))loc_1D9698)(v13, a6);
    if ( !a5 )
    {
      if ( ((int (__fastcall *)(int))loc_16A0FC)(v12) )
      {
        v14 = ((int (*)(void))loc_23DC0C)();
        if ( sub_23DDA4(v14) )
          dword_488090 = 1;
        else
          v7 = sub_DCACC(v12) == 0;
