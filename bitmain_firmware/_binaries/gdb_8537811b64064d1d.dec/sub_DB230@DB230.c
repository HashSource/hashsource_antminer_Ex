int __fastcall sub_DB230(__int64 a1)
{
  int *v1; // lr
  int v2; // r3
  int v3; // r2
...
LABEL_9:
  ...
  if ( *v1 )
  {
    do
    {
      while ( 1 )
      {
        ...
        if ( v5[18] == dword_487D2C )
        {
          ...
          if ( !v8 )
          {
            ...
            if ( (_DWORD)a1 )
            {
              LODWORD(a1) = ((int (__fastcall *)(_DWORD, _DWORD))loc_19DB64)(a1, HIDWORD(a1));
              if ( (_DWORD)a1 )
                break;
            }
          }
      ...
      LODWORD(a1) = ((int (__fastcall *)(_DWORD *, _DWORD))loc_DB0D8)(v5, HIDWORD(a1));
      v5 = v6;
    }
    while ( v6 );
  }
