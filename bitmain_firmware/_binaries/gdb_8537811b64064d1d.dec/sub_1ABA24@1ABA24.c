int __fastcall sub_1ABA24(int a1, int a2, int *a3, int a4, _DWORD *a5, int a6, const char *a7)
{
  int v8; // r12
  int v12; // r1
  int v13; // r9
...
LABEL_14:
      *a5 = "<undefined>";
      v25 = ((int (__fastcall *)(int, int, _DWORD))loc_173508)(dword_487ABC, a4, 0);
      v26 = *(_DWORD *)(v25 + 24);
      *a3 = v25;
      *(_BYTE *)(v26 + 1) |= 4u;
      return 2;
...
LABEL_4:
  ...
  if ( (signed int)(v39 >> 12) >= *(_DWORD *)(v14 + 20) )
  {
    ...
    *a5 = "<illegal>";
    if ( v36 > 0 )
      sub_F43DC(&off_46D334, "bad rfd entry for %s: file %d, index %d", a7, v17, v16);
    return v13;
  }
...
LABEL_8:
    ...
    *a5 = "<illegal>";
    if ( v22 > 0 )
    {
      sub_F43DC(&off_46D334, "bad rfd entry for %s: file %d, index %d", a7, v17, v39 >> 12);
      return v13;
    }
    return v13;
  }
...
LABEL_38:
        v35 = ((int (__fastcall *)(int, int, _DWORD))loc_173508)(dword_487ABC, a4, 0);
        *a3 = v35;
LABEL_39:
        sub_1A7340(v15, v18, v35);
        return v13;
      }
    }
    ...
    if ( (v40[2] & 0xF) != 0 && dword_47AC88 > 0 )
      sub_F43DC(&off_46D334, "illegal tq0 in forward typedef for %s", a7);
    v37 = v40[0] >> 2;
    switch ( v37 )
    {
      case 12:
      ...
      case 15:
        ...
        *a3 = v38;
        sub_1A7340(v15, v18, v38);
        break;
      case 26:
        *a3 = ((int (__fastcall *)(int, int, _DWORD))loc_173508)(dword_487ABC, a4, 0);
        *a5 = "<undefined>";
        break;
      default:
        if ( dword_47AC88 > 0 )
          sub_F43DC(&off_46D334, "illegal bt %d in forward typedef for %s", v37, a7);
        *a3 = ((int (__fastcall *)(int, int, _DWORD))loc_173508)(dword_487ABC, a4, 0);
        break;
    }
    return v13;
