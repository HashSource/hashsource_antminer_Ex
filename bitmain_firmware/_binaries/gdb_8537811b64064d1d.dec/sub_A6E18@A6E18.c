void __fastcall sub_A6E18(int a1, int a2, int a3, int a4)
{
  int v4; // r12
  int *i; // r6
  int v9; // r1
  ...
  for ( i = *(int **)(dword_487D2C + 36); i; i = (int *)*i )
  {
    ...
    if ( v37 )
      ...
      v12 = sub_9D334;
    if ( v37 )
      v11(i, v9, a3, a4, sub_9D804, v40, v12, v12);
    else
      v11(i, v9, a3, a4, sub_9D804, v40, (int (__fastcall *)(const char *, unsigned __int8 *))1, v12);
    v13 = (_DWORD *)i[5];
    while ( v13 )
    {
      v14 = sub_A6B68(a1, *(_DWORD *)(v13[8] + 8), a2, a3);
      v13 = (_DWORD *)*v13;
      if ( v14 )
        v41 = 1;
    }
  ...
  if ( (unsigned int)(*(_DWORD *)(a1 + 12) - *(_DWORD *)(a1 + 8)) <= 7 && (a4 & (v37 ^ 1)) != 0 )
  {
    ...
    *(_DWORD *)v19 = v21;
    *(_DWORD *)(v19 + 4) = 0;
    v26 = sub_33BA94((int)&ptr, v48, 0, 1u, 62);
    v42 = v44;
    v28 = v26;
    v30 = (int *)(v26 + 8);
    v29 = *(void **)v26;
