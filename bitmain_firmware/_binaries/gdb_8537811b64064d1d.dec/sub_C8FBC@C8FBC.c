int *__fastcall sub_C8FBC(int *a1, int a2, _DWORD *a3, int a4)
{
  ...
  *a1 = 0;
  a1[1] = 0;
  v8 = sub_33C6EC(a3, 45, a4);
  if ( v8 == -1 )
  {
    v13 = sub_C8F34(a2, v7, 0, 0);
    *a1 = v13;
    a1[1] = v13;
    return a1;
  }
  else
  {
    ...
    v10 = sub_C8F34(a2, v7, 45, 0);
    *a1 = v10;
    v11 = sub_C8F34(a2, v9, 0, (unsigned __int8 *)&v16);
    a1[1] = v11;
    if ( v10 > v11 )
    {
      ...
      sub_94708(v14, v16 - (_DWORD)v7, v7);
    }
    return a1;
  }
}
