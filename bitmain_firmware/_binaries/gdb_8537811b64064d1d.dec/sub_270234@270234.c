void __fastcall sub_270234(_DWORD *a1, _DWORD *a2, int a3, int a4)
{
  int v5; // r4
  int v9; // r2
  int v10; // r4
...
LABEL_42:
      ...
      {
        v31 = (int *)sub_242FF0();
        sub_2594D8(*v31, "Deleting %s\n", (const char *)a2[12]);
        v17 = (const char *)a2[12];
      }
      sub_946D8("Assertion failed: Could not find variable object \"%s\" to delete", v17);
      goto LABEL_15;
    }
    v26 = 0;
    ...
    sub_946D8("Assertion failed: Could not find varobj \"%s\" in root list", (const char *)a2[12]);
    goto LABEL_15;
  }
}
