        ...
        int a2)
{
  ...
  v7 = *(_DWORD *)(v6 + 12);
  if ( dword_46AF64
    && (sub_93198(v55, 100, "/proc/%d/coredump_filter", *(_DWORD *)(v6 + 12)), sub_231864(v53, v4, v55), v53[0]) )
  {
    sscanf(v53[0], "%x", v54);
    v39 = *(_DWORD *)v54;
    if ( v53[0] )
  ...
  sub_93198(v54, 100, "/proc/%d/smaps", v7);
  sub_231864(&s, 0, v54);
  v8 = s;
  if ( !s )
  {
    sub_93198(v54, 100, "/proc/%d/maps", v7);
    sub_231864(v53, 0, v54);
    v27 = s;
    v8 = (char *)v53[0];
    v53[0] = 0;
    v28 = s == 0;
  ...
  v9 = strtok_r(v8, (const char *)&word_356660, &save_ptr);
  if ( !v9 )
    goto LABEL_32;
  do
  {
    v45 = 0;
    sub_33BC0(v9, &v49, &v50, &v42, &v46, &v51, &v43, &v47, &v52, (int *)&string);
    v10 = string;
    v11 = byte_471B20;
    __dmb(0xBu);
    if ( (v11 & 1) == 0 && sub_33A57C(&byte_471B20) )
    {
      sub_33A684(&byte_471B20);
      _aeabi_atexit(&obj, (void (*)(void *))sub_37600);
    }
    if ( !dword_471B88 )
    {
      dword_471B88 = -1;
      ...
      {
        byte_471B84 = 0;
        sub_163764(&stru_471B64);
        sub_163764(&stru_471B44);
        sub_163764(&obj);
      }
      memset(&obj, 0, 0x60u);
      sub_1636E0(&obj, "^/dev/zero\\( (deleted)\\)\\?$", 8, "Could not compile regex to match /dev/zero filename");
      sub_1636E0(
        &stru_471B44,
        "^/\\?SYSV[0-9a-fA-F]\\{8\\}\\( (deleted)\\)\\?$",
        8,
        "Could not compile regex to match shmem filenames");
      sub_1636E0(&stru_471B64, " (deleted)$", 8, "Could not compile regex to match '<file> (deleted)'");
      byte_471B84 = 1;
      dword_471B88 = 1;
LABEL_53:
...
LABEL_15:
    v15 = v42;
    v16 = v46;
    v32 = sub_338618(v42, 114, v46) != 0;
    v33 = sub_338618(v15, 119, v16) != 0;
    v34 = sub_338618(v15, 120, v16) != 0;
    v37 = sub_338618(v15, 112, v16);
    v17 = strtok_r(0, (const char *)&word_356660, &save_ptr);
    v9 = v17;
    ...
    while ( 1 )
    {
      ...
      if ( strcmp((const char *)v53, "Anonymous:") )
      {
        if ( !strcmp((const char *)v53, "VmFlags:") )
        {
          ...
          LOBYTE(v45) = v45 | 1;
          v21 = sub_93674(v9);
          v22 = (char *)sub_935F8(v21);
          for ( i = strtok_r(v22, (const char *)&word_3E1FAC, &v48); i; i = strtok_r(
                                                                              0,
                                                                              (const char *)&word_3E1FAC,
                                                                              &v48) )
          {
            if ( !strcmp(i, "io") )
            {
      ...
      {
        sub_946D8("Error parsing {s,}maps file '%s' number", v54);
        v31 = v19;
LABEL_29:
        v20 = string;
        if ( !v31 )
      ...
      if ( v48 )
        v2 = 1;
LABEL_20:
      v18 = strtok_r(0, (const char *)&word_356660, &save_ptr);
      v9 = v18;
      if ( !v18 || (unsigned int)(unsigned __int8)*v18 - 65 > 0x19 )
        goto LABEL_29;
    }
    sub_946D8("Error parsing {s,}maps file '%s'", v54);
    v20 = string;
    if ( !v31 )
      goto LABEL_30;
LABEL_66:
