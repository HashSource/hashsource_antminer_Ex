int __fastcall sub_1E620C(int a1, int *a2)
{
  int v2; // r4
  int v4; // r0
  int v5; // r0
  ...
  v11 = sub_1E28B8(v5) - 1;
  if ( ((int (__fastcall *)(int))loc_1E21C0)(10) == 2 )
    return 0;
  v7 = v6[106] == v2;
  if ( v6[106] == -1 )
    v7 = 0;
  if ( v7 )
    return 0;
  sub_1E16BC(&v10, &v11, "vFile:setfs:");
  sub_93198(s, 9u, "%x", v2);
  sub_1E16BC(&v10, &v11, s);
  v8 = sub_1E6058((int)v10 - *v6, 10, a2, 0, 0);
  if ( ((int (__fastcall *)(int))loc_1E21C0)(10) == 2 )
    return 0;
  result = v8;
  if ( !v8 )
