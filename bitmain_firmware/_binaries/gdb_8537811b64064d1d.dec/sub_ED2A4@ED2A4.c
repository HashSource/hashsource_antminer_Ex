int __fastcall sub_ED2A4(_DWORD *a1)
{
  int v2; // r0
  int v3; // r3
  char *v5; // r3
  ...
  else
  {
    ...
    sub_ECC00(&v18, &v19, 0, v12);
    sub_ED100(v19, &v20);
    if ( sub_33CAC8((int)a1, "public") )
    {
      if ( sub_33CAC8((int)a1, "private") )
        return v22;
      else
        return v21;
    }
