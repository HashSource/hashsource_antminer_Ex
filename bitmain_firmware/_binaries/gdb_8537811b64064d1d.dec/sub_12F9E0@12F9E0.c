int __fastcall sub_12F9E0(int a1, _DWORD *a2, unsigned int *a3, _DWORD *a4)
{
  int result; // r0
  unsigned int v9; // r3
  ...
  v16 = 0;
  v15 = -1;
  result = sub_12EF5C((_WORD *)a1, &v17, v18, a4, 0);
  if ( result <= 1 )
  {
    for ( i = *(unsigned __int16 **)(a1 + 12); i; i = (unsigned __int16 *)*((_DWORD *)i + 4) )
    {
      ...
      if ( v11 == 46 )
      {
        result = sub_12F924((int)i, &v15, &v16, a4);
      }
      else if ( v11 == 57 || v11 == 30 )
      {
        result = sub_12F9E0(i, &v17, v18, a4);
        v13 = v17;
        if ( v17 != -1 )
        {
          v14 = v16;
