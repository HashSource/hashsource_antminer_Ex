int __fastcall sub_21A3C4(int a1, int a2, const char *a3)
{
  int v3; // r3
  int v6; // r0
  int v7; // r6
  ...
  if ( !v6 )
    return 0;
  v8 = sub_C2F28(*(_DWORD **)(*(_DWORD *)(v6 + 32) + 4 * (a2 + 2)), a3, 2, (int (__fastcall *)(int, int))sub_C31DC, 0);
  if ( !v8 )
    sub_16448(a2, a3, *(_DWORD *)(v7 + 12));
  result = *(_DWORD *)(v8 + 24);
  v10 = *(unsigned __int8 **)(result + 24);
  if ( (unsigned int)*v10 - 3 <= 1 && !*((_WORD *)v10 + 2) )
  {
    if ( (*((_WORD *)v10 + 1) & 0x380) != 0x80
      || (v11 = (__int16 *)*((_DWORD *)v10 + 7), v11 == &word_3B4A54)
      || !v11[2] )
    {
