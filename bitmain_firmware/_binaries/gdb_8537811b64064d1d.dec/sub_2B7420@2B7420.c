int __fastcall sub_2B7420(int a1, int a2, _DWORD *a3, _DWORD *a4, int a5, int a6)
{
  _DWORD *v7; // r4
  _DWORD *v9; // r8
  _DWORD *v10; // r10
    ...
    if ( !v7[105] )
    {
      if ( v7[107] )
      {
        ...
        if ( *a4 || !*(_DWORD *)(v26 + 388) && a4[1] )
          sub_2A6BE4("elf32-arm.c", 9433);
        LODWORD(v28) = v27 & 0xFFF | 0xE300C000 | (16 * v27) & 0xF0000;
        HIDWORD(v28) = v23;
        sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v28);
        HIDWORD(v29) = v23 + 4;
        LODWORD(v29) = HIWORD(v27) & 0xFFF | (v27 >> 12) & 0xF0000 | 0xE340C000;
        sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v29);
        LODWORD(v30) = -527646705;
        HIDWORD(v30) = v23 + 8;
        sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v30);
        HIDWORD(v31) = v23 + 12;
        LODWORD(v31) = v25 & 0xFFFFFF | 0xEA000000;
        sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v31);
      }
      else
      {
        v73 = a4;
        if ( sub_2B6434(v7 + 311) )
        {
          v20 = sub_2B64AC(v7 + 311);
          if ( !v20 )
          {
            sub_2A6A84("%B: Warning: thumb-1 mode PLT generation not currently supported", a1);
            return v20;
          }
          v55 = v68 - 12 - v71;
          HIDWORD(v56) = v23;
          ...
          sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v56);
          LODWORD(v57) = v55 & 0xFF0000 | (v55 >> 28) | 0xC00F2C0 | (16 * v55) & 0x70000000 | (v55 >> 17) & 0x400;
          HIDWORD(v57) = v23 + 4;
          sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v57);
          LODWORD(v58) = -119782148;
          HIDWORD(v58) = v23 + 8;
          sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v58);
          LODWORD(v59) = -1090457600;
          HIDWORD(v59) = v23 + 12;
          sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v59);
        }
        else
        {
          v52 = *(_DWORD *)(a2 + 28);
          ...
          {
            sub_2B72EC(v7[91], *(_DWORD *)(a1 + 4), 18296, (_BYTE *)(v23 - 4));
            sub_2B72EC(v7[91], *(_DWORD *)(a1 + 4), 18112, (_BYTE *)(v23 - 2));
          }
          ...
          if ( dword_48FD14 )
          {
            ...
            sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v60);
            HIDWORD(v61) = v23 + 4;
            LODWORD(v61) = v72 | 0xE28CC600;
            sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v61);
            HIDWORD(v62) = v23 + 8;
            LODWORD(v62) = (unsigned __int8)(v53 >> 12) | 0xE28CCA00;
            sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v62);
            HIDWORD(v63) = v23 + 12;
            LODWORD(v63) = v53 & 0xFFF | 0xE5BCF000;
            sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v63);
          }
          else
          {
            if ( (v53 & 0xF0000000) != 0 )
              sub_2A6BE4("elf32-arm.c", 9509);
            HIDWORD(v54) = v23;
            LODWORD(v54) = v72 | 0xE28FC600;
            sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v54);
            sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), __SPAIR64__(v23 + 4, (unsigned __int8)(v53 >> 12) | 0xE28CCA00));
            sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), __SPAIR64__(v23 + 8, v53 & 0xFFF | 0xE5BCF000));
          }
        }
      }
LABEL_29:
    ...
    if ( (*(_BYTE *)a2 & 1) != 0 )
    {
      ...
      for ( i = 0; i != 2; LODWORD(v37) = dword_413C38[i] )
      {
        HIDWORD(v37) = v23;
        if ( i == 5 )
        {
        ...
        sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v37);
LABEL_46:
        ++i;
        v23 += 4;
        if ( i == v7[104] >> 2 )
...
LABEL_71:
      ...
      else
      {
        ...
        v76 = v68;
        v77 = (v51 << 8) + 2;
        sub_2C858C(a1, &v76, v48 + 12);
      }
      goto LABEL_29;
    }
    for ( LODWORD(v42) = -442515456; ; LODWORD(v42) = dword_413C50[v35] )
    {
      switch ( v35 )
      {
        case 2:
...
LABEL_59:
          HIDWORD(v42) = v23;
          sub_2B73F8(v7[91], *(_DWORD *)(a1 + 4), v42);
          goto LABEL_60;
        case 5:
          if ( v7[108] )
            v44 = 8;
...
LABEL_11:
    ...
    if ( v7[108] )
    {
      v18 = (void (__fastcall *)(int, int *, int))sub_2C8550;
      v19 = v17 + 8 * v65;
    }
    else
    {
      v18 = (void (__fastcall *)(int, int *, int))sub_2C858C;
      v19 = v17 + 12 * v65;
    }
    v20 = 1;
    v18(a1, &v76, v19);
...
LABEL_35:
  sub_2B6800(a1, *(_DWORD **)(a2 + 28), v64, (int)&v76);
  return 1;
}
