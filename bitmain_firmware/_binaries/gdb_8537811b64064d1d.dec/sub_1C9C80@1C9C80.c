void __fastcall sub_1C9C80(int a1)
{
  int v2; // r0
  ...
  if ( !a1 )
  {
    sub_94728((int)"probe.c", 425, "%s: Assertion `%s' failed.", "void print_ui_out_info(probe*)", "probe != NULL");
    goto LABEL_22;
  }
  v2 = (*(int (__fastcall **)(int))(*(_DWORD *)a1 + 36))(a1);
  v3 = *(void (__fastcall **)(void **, int))(*(_DWORD *)v2 + 16);
  if ( v3 == (void (__fastcall *)(void **, int))sub_1C9B04 )
  {
    ptr = 0;
    v14 = 0;
    v15 = 0;
  ...
  if ( v4 == (void (__fastcall *)(void **, int))sub_6E058 )
  {
    v5 = 0;
    v6 = 0;
    v16 = 0;
...
LABEL_22:
  ...
  if ( v14 != ptr )
  {
    ...
    do
    {
      v9 = v6[v8];
      v10 = v7[2 * v8];
      v11 = (_DWORD *)sub_243004(v6);
      if ( v9 )
        sub_257610(*v11, v10, v9);
      else
        sub_2575CC(*v11, v10);
      v7 = ptr;
      ++v8;
