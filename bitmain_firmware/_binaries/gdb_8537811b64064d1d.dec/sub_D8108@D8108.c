int __fastcall sub_D8108(int *a1, unsigned int a2, int a3, int a4, int a5, int a6)
{
  int v6; // r6
  const char *v7; // r7
  int v9; // r5
    ...
    if ( dword_478860 )
    {
      if ( *(_DWORD *)dword_478860 )
      {
        ...
        do
        {
          ...
          if ( sub_CF418(v30, (int)a1, a2) && sub_C9304(v30 + 3) )
          {
            v27 = (int *)sub_98394(0x20u);
            v28 = v30[2];
            *v27 = 0;
            v27[1] = (int)v30;
            v29 = v30[4];
...
LABEL_125:
      ...
      v64 = sub_154BB0(*v63, *v62, v62[1], v62[2], v66);
      sub_339F20(v64);
      goto LABEL_80;
    }
    v6 = *(_DWORD *)(v12 + 8);
    ...
    v24 = *(_DWORD *)(v6 + 112);
    if ( v24 != -1 && v24 != sub_23E5A0(v69, v70, v71)
      || (v31 = *(_DWORD *)(v6 + 116)) != 0 && v31 != ((int (__fastcall *)(int, int, int))loc_AFCE4)(v69, v70, v71) )
    {
      *(_BYTE *)(v12 + 25) = 0;
LABEL_26:
      *(_DWORD *)(v12 + 28) = 1;
    ...
    v32 = ((int (__fastcall *)(int))loc_157FFC)(v6);
    *(_BYTE *)(v12 + 25) = v32;
...
LABEL_57:
      ...
      sub_946D8("Watchpoint condition cannot be tested in the current scope");
LABEL_80:
      sub_26C328(a1);
    }
LABEL_81:
