int __fastcall sub_AE450(int a1, int a2, _DWORD *a3, int *a4, int a5)
{
  int v7; // r3
  int v8; // r2
  int v9; // r3
  ...
  *a4 = v8;
  ...
  v10 = sub_AB0A4(a1);
  v15 = sub_26BC98(v10);
  if ( v15 && sub_A1DAC(v15) )
    v10 = sub_A8AD4(v10);
  v16 = sub_AB0A4(a2);
  if ( !sub_26C1FC(v16) )
    sub_94708("Left operand of assignment is not a modifiable lvalue.");
  v17 = sub_26BC98(v16);
  v18 = sub_171280(v17);
  v19 = v18;
  if ( (_DWORD)v18 && sub_A1DAC(v18) )
  {
    v16 = sub_A8AD4(v16);
    v20 = sub_26BC98(v16);
    v21 = *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(sub_171280(v20) + 24) + 24) + 12) + 24) + 24);
    v22 = *(_QWORD *)(v21 + 8);
    v23 = *(_QWORD *)(v21 + 24);
  ...
  {
    if ( **(_BYTE **)(v19 + 24) != 3 )
      sub_94708("Left-hand side must be array or record.", HIDWORD(v18));
    v78 = 0;
    v24 = -1;
    sub_A19D4(0, v19, 0, 0, 0, 0, 0, &v78);
    v74 = -1;
    v67 = 0;
    v68 = v78 - 1;
  }
  ...
  do
  {
    ...
    if ( v38 == 115 )
    {
      ...
      *(_DWORD *)HIDWORD(v66) = v42;
      ...
      {
LABEL_66:
        sub_AB8A0(0, a3, (int *)HIDWORD(v66), 1);
        goto LABEL_52;
      }
      for ( i = 0; i != v39; ++i )
        sub_AB8A0(0, a3, v41, 1);
      v71 = i;
      ...
      while ( 1 )
      {
        ...
        v53 = (int *)HIDWORD(v66);
        ++v77;
        v54 = sub_AB8A0(0, a3, (int *)HIDWORD(v66), 0);
        v49 = sub_26EB44(v54);
        v55 = sub_AB8A0(0, a3, v53, 0);
        v56 = sub_26EB44(v55);
        v50 = v56;
        if ( v56 >= v49 )
          goto LABEL_45;
        sub_9AB60(v49, v56, v72, &v75, v70);
LABEL_50:
      ...
      else
      {
        if ( v46 == 40 )
        {
          v47 = (char *)sub_21B3EC(v45[12]);
        }
        else
        {
          if ( v46 != 89 )
            sub_94708("Invalid record component association.");
          v47 = (char *)&a3[4 * v77 + 12];
        }
        sub_AB8A0(0, a3, &v77, 1);
        v78 = 0;
        v48 = sub_26BC98(v35);
        if ( !sub_A19D4(v47, v48, 0, 0, 0, 0, 0, &v78) )
          sub_94708("Unknown component name: %s.", v47);
        v49 = v78;
        v50 = v78;
      }
LABEL_45:
      ...
      sub_9AB60(v49, v50, v72, &v75, v70);
      do
      {
        v78 = v74;
        sub_AEBA0(v36, v35, v49, HIDWORD(v49), a3, &v78);
        ++v49;
      }
      while ( v50 >= v49 );
      goto LABEL_50;
    ...
    {
      if ( v38 != 114 )
        sub_94708("Internal error: bad aggregate clause");
      if ( HIDWORD(v65) - 1 != (_DWORD)v66 )
        sub_94708("Misplaced 'others' clause");
      if ( v75 > 2 )
      {
        ...
        do
        {
          ...
          {
            v78 = v74;
            sub_AEBA0(v36, v35, j, HIDWORD(j), a3, &v78);
          }
          v57 += 2;
        }
        while ( v57 != v73 );
    ...
    v59 = sub_267284(v37[8], v37[9]);
    v60 = v67 + v59;
    v63 = v60 - 1;
    v64 = v60 - 1;
    if ( v68 == __PAIR64__((int)v60 - 1, (int)v60 - 1) )
      sub_946D8((const char *)v65);
    if ( v68 < v60 )
      goto LABEL_66;
    sub_9AB60(v60, v60, v72, &v75, v70);
    v61 = HIDWORD(v66);
    *(_DWORD *)HIDWORD(v66) += 3;
    sub_AEBA0(v36, v35, v60, HIDWORD(v60), a3, v61);
LABEL_52:
