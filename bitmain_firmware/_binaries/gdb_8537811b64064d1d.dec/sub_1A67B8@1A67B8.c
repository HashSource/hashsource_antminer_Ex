int __fastcall sub_1A67B8(int a1)
{
  char v3; // r3
  const char *v4; // r0
  const char *v5; // r6
...
LABEL_17:
      ...
      v9 = sub_347C84(v6, HIDWORD(v6)) / 1000000.0;
      v10 = sub_347C84(v8, HIDWORD(v8));
      sub_259880(v5, HIDWORD(v10), v9, v10 / 1000000000.0);
      goto LABEL_20;
    }
LABEL_8:
    if ( (v3 & 2) == 0 )
