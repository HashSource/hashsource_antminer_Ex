int __fastcall sub_318644(int result, int a2, _DWORD *a3)
{
  _DWORD *v3; // r5
  unsigned int v4; // r4
  char *v6; // r7
...
LABEL_22:
      ...
      while ( v25 != (int *)((char *)&dword_364FE4 + 2) );
      return result;
    case 0x25:
      v31 = (char *)&unk_433C4F;
...
LABEL_57:
    ...
    default:
LABEL_15:
      result = sub_314768(result, a2, (int)a3);
      break;
  }
  return result;
}
