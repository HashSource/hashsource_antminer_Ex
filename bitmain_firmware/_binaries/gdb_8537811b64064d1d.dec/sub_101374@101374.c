int __fastcall sub_101374(int a1, int a2, __int64 a3, int a4, int a5, int block, void *a7, int *a8, int a9, int a10)
{
  int v10; // r4
  int v11; // r2
  bool v12; // zf
...
LABEL_4:
  ...
  if ( v93 > 0 )
  {
    ...
    *(struct obstack *)dest = stru_47B208;
    v112 = sub_26E740(a7, stru_47B208.extra_arg);
    if ( !a9 )
    {
    ...
    while ( 1 )
    {
      v44 = sub_171280(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + 24 * v36 + 12));
      v45 = *(_DWORD *)(v10 + 24);
      v46 = v44;
      ...
      v37 = sub_92E50();
      v96 = sub_FC5C4(v10, v36, v112, SHIDWORD(a3), a3, SHIDWORD(a3), a4, (int)a7);
      sub_92E68((int)v37);
      v38 = *(_DWORD *)(v10 + 24);
      if ( (*(_WORD *)(v38 + 2) & 0x380) != 0x80 )
        break;
      v50 = *(_DWORD *)(v38 + 28);
      if ( (__int16 *)v50 == &word_3B4A54 )
        break;
      v39 = *(_DWORD *)(v50 + 16);
      if ( !v39 )
        goto LABEL_84;
        ...
        || a3 + (int)v96 >= *(unsigned int *)(a2 + 20) )
      {
        ...
        v97 = a4 + v96;
        v70 = sub_230048(v97, v104, v68);
        v71 = v46;
        v72 = (void *)v104;
        v39 = v70 != 0;
        v101 = (void *)sub_26DD58(v71, v104, v97);
        v103 = sub_26BC98(v101);
        if ( v72 )
          sub_339E8C(v72);
        v96 = 0;
        v46 = v103;
...
LABEL_64:
      ...
      else
      {
        v41 = v106 + v96;
        if ( a8[16]
          || (v42 = ((int (__fastcall *)(void *))loc_26C0C4)(v101),
              !((int (__fastcall *)(int, char **, _DWORD, _DWORD, int, int, void *, void *, int *, char **))loc_157DBC)(
                 v46,
                 off_46D5A4[0],
                 v41,
                 HIDWORD(v41),
                 ...
                 off_46D5A4[0])) )
        {
          v43 = ((int (__fastcall *)(void *))loc_26C0C4)(v101);
          sub_101374(v46, v103, v41, SHIDWORD(v41), v43, a5, v113, (int)v101, (int)a8, (int)stru_47B208.object_base, 0);
        }
      }
      sub_25A6E4(", ", a5);
LABEL_71:
...
LABEL_84:
    ...
    if ( !*a8 )
      goto LABEL_64;
LABEL_85:
    sub_25A440(a5, (const char *)&word_356660);
    sub_25A7C8(2 * (_DWORD)v113, a5);
    goto LABEL_64;
  }
LABEL_6:
  v12 = v98 == 0;
  ...
  if ( v12 )
  {
    sub_25A440(a5, "<No data fields>");
    return sub_25A440(a5, "}");
  }
  v118 = v13;
  if ( a10 )
  {
    v102 = sub_17326C(v10, &v118);
    if ( v98 <= v93 )
      goto LABEL_49;
    v111 = v13;
    v110 = v13;
...
LABEL_44:
  ...
  do
  {
    ...
    if ( !sub_174F34(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v16, v26) )
    {
      if ( v17 )
      {
LABEL_88:
...
LABEL_30:
          sub_B77FC();
          if ( sub_174F34(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v16, v30) )
            sub_25A6E4("static ", a5);
          sub_25A878(a5, *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v16 + 16), off_46D5A4[0][2], 3);
          sub_B783C();
          if ( **(_BYTE **)(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v16 + 16) )
            sub_25A6E4(" = ", a5);
          sub_B785C();
          v32 = sub_174F34(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v16, v31);
          v33 = *(_DWORD *)(v10 + 24);
          if ( v32 )
          {
          ...
          else
          {
            ...
            {
              if ( v18 != 128
                || (v75 = *(_DWORD *)(v33 + 28), (__int16 *)v75 == &word_3B4A54)
                || (v76 = *(_DWORD *)(v75 + 28)) == 0
                || (((int)*(unsigned __int8 *)(v76 + (v15 >> 3)) >> (v15 & 7)) & 1) == 0 )
              {
                if ( sub_26BFE0(a7, 0, *(_DWORD *)v19, *((_DWORD *)v19 + 1), v34 >> 4, 0) )
                {
                  sub_25A6E4("<synthetic pointer>", a5);
                }
                else
                {
                  memcpy(dest, a8, sizeof(dest));
                  *(_DWORD *)&dest[52] = 0;
                  v74 = sub_26D790(v10, v15, v27, HIDWORD(a3), a3, HIDWORD(a3), a7);
                  sub_266BEC(v74, a5, v100, dest, off_46D5A4[0]);
                }
                goto LABEL_23;
              }
LABEL_89:
              sub_25A6E4("<optimized out or zero length>", a5);
LABEL_23:
              v17 = 1;
              sub_B787C();
              goto LABEL_24;
          ...
          if ( v18 != 128
            || (v51 = *(_DWORD *)(v33 + 28), v19 = &word_3B4A54, (__int16 *)v51 == &word_3B4A54)
            || (v52 = *(_DWORD *)(v51 + 28)) == 0
            || (v19 = (__int16 *)(v15 & 7), (((int)*(unsigned __int8 *)(v52 + (v15 >> 3)) >> (v15 & 7)) & 1) == 0) )
          {
            if ( sub_174F34(*(_DWORD *)(v33 + 24) + v16, v19) )
            {
              v57 = sub_92E50();
              v58 = ((int (__fastcall *)(int, int))loc_26D264)(v10, v15);
              sub_92E68((int)v57);
              ...
              else
              {
                ...
                if ( v60 == 3 )
                {
                  ...
                  do
                  {
                    ...
                    {
                      v10 = (int)v115;
                      v82 = ((int (__fastcall *)(int))loc_26C0C4)(v58);
                      ...
                      *v83 = v82;
                      dword_47B1BC += 4;
                      v108 = sub_171280(v107);
                      v116 = (void *)sub_26BD58(v58);
                      v84 = sub_26C008(v58);
                      sub_101374(v108, (int)v116, v84, SHIDWORD(v84), v82, a5, v100, v58, (int)a8, 0, 1);
                      goto LABEL_23;
                    }
                    v80 = ((int (__fastcall *)(int))loc_26C0C4)(v58);
                    v81 = *(_DWORD *)(v79 - 4);
                    v79 -= 4;
                  }
                  while ( v80 != v81 );
                  v10 = (int)v115;
LABEL_143:
                  sub_25A6E4("<same as static member of an already seen type>", a5);
                }
                else
                {
                  if ( v60 == 2 )
                  ...
                  *(_DWORD *)&dest[52] = 0;
                  v114 = sub_26C008(v58);
                  v67 = ((int (__fastcall *)(int))loc_26C0C4)(v58);
                  sub_266A10(
                    v107,
                    (int)off_46D5A4[0],
                    v114,
            ...
            else if ( v102 == v15 && v118 == v10 )
            {
              ...
              if ( sub_26672C(a5, v109, v89, v89 >> 31, a7) )
              {
                v90 = sub_15AED0(v27 + v89, v109);
                v91 = sub_170068(v10);
                sub_267E2C(a8, v91, v90, a5);
              }
            }
            else
            {
...
LABEL_27:
      ...
      if ( v28 )
      {
        sub_25A440(a5, (const char *)&word_356660);
        sub_25A7C8(v95, a5);
        sub_25A6E4("members of ", a5);
        v49 = sub_170CEC(v10);
        sub_25A6E4(v49, a5);
        sub_25A6E4(&word_3B6A28, a5);
        v28 = *a8;
        goto LABEL_80;
      }
      goto LABEL_29;
