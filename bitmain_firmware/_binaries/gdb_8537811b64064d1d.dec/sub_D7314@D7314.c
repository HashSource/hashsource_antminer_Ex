void __fastcall sub_D7314(int a1, int a2, int a3)
{
  int v3; // r1
  int v4; // r0
  int v5; // r3
...
LABEL_12:
  ...
  qsort(v8, dword_47836C, 4u, (__compar_fn_t)sub_C6C38);
  v13 = 0;
  v14 = dword_478368;
  dword_47885C = 0;
  dword_478858 = 0;
...
LABEL_57:
        if ( v34 == v36 )
        {
          ...
          if ( v40 )
          {
            if ( !*(_BYTE *)(v12 + 39) || (v12 = sub_CA3DC(v12)) != 0 )
            {
              v31 = v44;
              goto LABEL_55;
            }
...
LABEL_51:
      v12 = sub_CC448(v39);
      if ( v12 )
        v12 = sub_259F38("warning: Error removing breakpoint %d\n", *(_DWORD *)(*(_DWORD *)(v120 + 16) + 24));
      if ( v40 )
      {
        v31 = v34;
        goto LABEL_55;
...
LABEL_73:
      ...
      *(_DWORD *)(v85 + 16) = 0;
      ...
      v96 = sub_94728(
              ...
              "quick_push");
      ((void (__fastcall *)(_BYTE *, _DWORD))loc_23FCB4)(v121, HIDWORD(v96));
      v95 = ((int (__fastcall *)(int))loc_1CD2B8)(v120);
      goto LABEL_214;
    }
    v47 = (int *)(v14 + 4);
    while ( 1 )
    {
      v42 = ((int (__fastcall *)(int, int))loc_CF988)(v46, v39) == 0;
      v39 = v120;
      if ( !v42 )
      {
...
LABEL_74:
      *(_DWORD *)(v39 + 16) = 0;
      v12 = ((int (__fastcall *)(int *))loc_CC758)(&v120);
    }
LABEL_55:
    v29 = (int *)dword_478368;
    if ( v99 <= (char *)v30 )
        ...
        *(_BYTE *)(v51 + 41) = v61;
        ...
        if ( v54 )
        {
          ...
          if ( v56
            ...
            && (v12 = ((int (__fastcall *)(int, int))loc_CF988)(v51, v56)) != 0 )
          {
            if ( *(_BYTE *)(v51 + 39) )
              sub_D32B4(v51, v56);
            *(_BYTE *)(v51 + 41) = 1;
...
LABEL_121:
    ...
    v112[2] = 0;
    v113 = 0;
    sub_25650C(v112, "Warning:\n", 9);
    v116 = dword_487D2C;
    v63 = ((int (__fastcall *)(_BYTE *))loc_23FF48)(v117);
      ...
      if ( *(_DWORD *)dword_478368 )
      {
        ...
        do
        {
          ...
          if ( v63
            ...
            && (*(_DWORD *)(*(_DWORD *)(v64 + 16) + 112) == -1 || (v63 = sub_23E554()) != 0) )
          {
            v68 = sub_1CD68C(*(_DWORD *)(v64 + 48));
            v69 = sub_16F67C(v68);
            if ( ((int (__fastcall *)(int))loc_16D924)(v69) || (v63 = sub_98FA0(&dword_4878EC, &dword_475848)) == 0 )
            {
              v63 = sub_D6068(v64, (int)v112, &v106, &v107, &v108);
              if ( v63 )
                v66 = v63;
            }
          }
...
LABEL_149:
            v73 = v70[6];
            v107 = 1;
            v63 = sub_2567B4(v112, "Could not insert hardware watchpoint %d.\n", v73);
            v66 = -1;
          }
        }
LABEL_150:
...
LABEL_151:
    ...
    ((void (__fastcall *)(_BYTE *))loc_23FCB4)(v117);
    ((void (__fastcall *)(int))loc_1CD2B8)(v116);
    sub_2564A0(v112);
LABEL_187:
    v120 = dword_487D2C;
    ((void (__fastcall *)(_BYTE *))loc_23FF48)(v121);
        ...
        if ( (unsigned int)(v90 - 27) <= 2 )
        {
          ...
          if ( v92 )
          {
            ...
            if ( v93 )
            {
              ...
              do
              {
                if ( sub_CA3DC(v93) && !*(_BYTE *)(v93 + 39) )
                {
                  sub_1CD68C(*(_DWORD *)(v93 + 48));
    ...
    ((void (__fastcall *)(_BYTE *))loc_23FCB4)(v121);
    ((void (__fastcall *)(int))loc_1CD2B8)(v120);
  }
  else if ( sub_CD2B0(v12) )
  {
    if ( a1 )
      goto LABEL_121;
    v109 = 0;
    ...
    v114[2] = 0;
    v115 = 0;
    sub_25650C(v114, "Warning:\n", 9);
    v118 = dword_487D2C;
    v74 = ((int (__fastcall *)(_BYTE *))loc_23FF48)(v119);
    if ( dword_478368 < (unsigned int)(dword_478368 + 4 * dword_47836C) )
    {
        ...
        do
        {
          ...
          if ( !v79 )
          {
            if ( *(_BYTE *)(v75 + 39) )
            {
              if ( *(_BYTE *)(v75 + 36) )
              {
                v80 = sub_1CD68C(*(_DWORD *)(v75 + 48));
                v81 = sub_16F67C(v80);
                if ( ((int (__fastcall *)(int))loc_16D924)(v81) || (v74 = sub_98FA0(&dword_4878EC, &dword_475848)) == 0 )
                {
                  v74 = sub_D6068(v75, (int)v114, &v109, &v110, &v111);
                  if ( v74 )
                    v77 = v74;
                }
              }
    ...
    ((void (__fastcall *)(_BYTE *))loc_23FCB4)(v119);
    ((void (__fastcall *)(int))loc_1CD2B8)(v118);
    sub_2564A0(v114);
  }
  else if ( a1 )
  {
