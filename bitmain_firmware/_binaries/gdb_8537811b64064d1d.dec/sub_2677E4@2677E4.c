void __fastcall sub_2677E4(int a1, unsigned __int8 *a2, size_t a3, unsigned __int8 *a4, int a5)
{
  ...
  if ( ((unsigned __int8)a4 & 0x80) != 0 )
  {
    ...
    v8 = (unsigned __int8 *)sub_98394(4 * a3);
    ptr = v39;
    goto LABEL_51;
  }
  v7 = 4 * a3;
