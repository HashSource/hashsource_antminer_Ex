        ...
        unsigned __int64 *a8)
{
  ...
  if ( a2 == 11 )
  {
    ...
    {
      if ( !a4 )
        sub_94708("tfile_xfer_partial: tdesc is read-only");
  ...
  if ( a2 != 2 )
    return -1;
  if ( !a4 )
    sub_94708("tfile_xfer_partial: trace file is read-only");
  if ( sub_24B5C4(a1) == -1 )
    return sub_95D74(a4, a6, a7, (int)a8);
  v9 = 0;
  v25 = 0;
  while ( 1 )
  {
    v27 = 77;
    v11 = sub_24656C((int (__fastcall *)(_DWORD, int))sub_245D60, v9, (int)&v27);
    v12 = v11;
    if ( v11 < 0 )
      break;
    v13 = sub_16F67C(v11);
    ...
    sub_246520(&buf, 8);
    LODWORD(v15) = sub_15C278((unsigned __int8 *)&buf, 8, v14);
    buf = v15;
    sub_246520(&v28, 2);
    v16 = sub_15C278((unsigned __int8 *)&v28, 2, v14);
    v17 = v16;
