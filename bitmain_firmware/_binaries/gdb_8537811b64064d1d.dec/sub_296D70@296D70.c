int __fastcall sub_296D70(char a1, int a2)
{
  unsigned int v3; // r3
  int result; // r0
  int v5; // r0
  ...
  if ( !*((_BYTE *)off_46DED0 + 8 * a2) && *((_DWORD *)off_46DED0 + 2 * a2 + 1) == 2715668 )
  {
    if ( (a1 & 2) != 0 )
    {
      ...
      else
      {
        ...
        if ( v6 < 0 )
          ...
          return sub_27F89C(v6, (int *)off_46DED0);
      }
    }
    else
    {
  ...
  else
  {
    ...
    if ( v3 > 9 )
    {
      if ( (a2 & 0xFFFFFF7F) != 0x2D || dword_48AB0C )
      {
        ...
        sub_28D534(v5);
        dword_48AAA0 &= ~0x400u;
        result = sub_27F89C(a2, (int *)off_46DED0);
        if ( (dword_48AAA0 & 0x80000) != 0 )
        {
          if ( !dword_48FF30 )
            off_470784(0);
