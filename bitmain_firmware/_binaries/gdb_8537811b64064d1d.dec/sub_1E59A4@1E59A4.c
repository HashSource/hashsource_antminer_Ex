int sub_1E59A4(const char *a1, ...)
{
  ...
  **v3 = 0;
  ...
  {
    v6 = sub_94728((int)"remote.c", 8446, "Too long remote packet.");
LABEL_5:
    sub_94708("Communication problem with target.", HIDWORD(v6));
  }
  v5 = strlen(*v3);
  if ( sub_1E51EC((int)*v3, v5) < 0 )
    goto LABEL_5;
  **v3 = 0;
  sub_1E4EE0(v3, (size_t *)v3 + 1, 0, 0, 0);
  return sub_1E1728(*v3);
}
