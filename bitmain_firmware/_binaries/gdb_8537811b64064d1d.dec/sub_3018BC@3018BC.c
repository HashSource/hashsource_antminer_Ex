int __fastcall sub_3018BC(int a1, int a2, int a3, int a4, int a5)
{
  int v6; // r4
  int v8; // r5
  signed int v9; // r6
    ...
    if ( *v11 )
    {
      ...
      if ( v15 )
      {
        ...
        while ( 1 )
        {
          ...
          v29 = v13[1];
          v27 = sub_2A692C(v8);
          sub_3015C8(*(_DWORD *)(*v16 + 12), v8, (const char **)v6, (_BYTE *)(v18 + v27 * (_DWORD)v29));
          v21 = (_DWORD *)*v16;
          v28 = off_4709EC;
          v21[2] = 0;
          *v21 = v28;
...
LABEL_26:
        ...
        if ( a5 )
        {
          v20 = sub_300A10(v8, (int)v13, v30, v6, a1, (int)v31);
          v21 = (_DWORD *)*v16;
          goto LABEL_17;
        }
        v20 = sub_300A10(v8, (int)v13, v30, v6, 0, (int)v31);
LABEL_18:
        if ( v20 != 2 )
        {
          switch ( v20 )
