int __fastcall sub_285424(const char *a1, __int16 *a2, int a3)
{
  size_t v6; // r0
  int v7; // r2
  int v8; // r5
...
LABEL_16:
  ...
  if ( a1 == (const char *)a2 )
  {
    v30 = (const char *)sub_29B938(a1);
    p.__count = (int)v30;
    if ( !dword_48ACF4 )
    {
      if ( !sub_284880((int)v30) )
      {
        sub_297780(p.__count);
        return v8;
      }
      v20 = 47;
      sub_297780(p.__count);
  ...
  *((_BYTE *)a1 - 1) = 0;
  ...
  count = (const char *)sub_29B938(a2);
  p.__count = (int)count;
  if ( off_48ACDC )
  {
    off_48ACDC(&p);
