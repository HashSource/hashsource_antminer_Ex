int __fastcall sub_168BC(int a1, int a2, _DWORD *a3, _DWORD *a4, _BYTE *a5)
{
  int v6; // r0
  int v9; // r7
  int v10; // r3
    ...
    if ( v23 == -2 )
    {
      if ( (*a5 & 0xC0) == 0x40 )
      {
        sub_2A6A84(
          ...
          a2,
          *(_DWORD *)(v21 + 4));
        sub_2A6A84("%B:%A: error: try relinking with --gc-keep-exported enabled.", a1, a2);
...
LABEL_26:
  ...
  if ( *(_BYTE *)(*(_DWORD *)(v9 + 392) + 10) == 32 )
  {
    ...
    {
      if ( v29 )
        sub_2A6C18("elflink.c", 8745, "elf_link_adjust_relocs");
      v30 = sub_2DB8B0;
    }
  }
  else if ( v29 == 1 )
  ...
  {
    if ( v29 )
      sub_2A6C18("elflink.c", 8756, "elf_link_adjust_relocs");
    v30 = sub_2DB8C4;
  }
  v31 = *(_DWORD *)(*a3 + 40);
  v32 = *(char **)(*a3 + 48);
  ...
  if ( v31 > 0x18 )
    sub_2A6C18("elflink.c", 8765, "elf_link_adjust_relocs");
  v33 = *(char **)(*a3 + 48);
  v34 = v33;
