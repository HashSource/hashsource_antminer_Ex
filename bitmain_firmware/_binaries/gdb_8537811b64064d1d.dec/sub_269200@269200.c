void __fastcall sub_269200(int a1, int a2, int a3, int a4, const char *a5, int a6, int c, int a8, int a9)
{
  int v9; // r11
  int v10; // r4
  int v13; // r0
  ...
  v10 = a2;
  v13 = sub_170068(a2);
  v14 = ((int (__fastcall *)(int))loc_165BE0)(v13);
  v90 = v14;
  v15 = *(_DWORD *)(v10 + 20);
  if ( a4 == -1 )
  {
  ...
  {
    v10 = a4 - 1;
    LODWORD(v17) = sub_15C278((unsigned __int8 *)(a3 + (a4 - 1) * v15), v15, v90);
    if ( v17 )
      goto LABEL_11;
    --a4;
LABEL_10:
    if ( !a4 )
      goto LABEL_7;
LABEL_11:
    sub_EF578(v104, a3, a4 * v15, a5, v15);
    v100 = 0;
    v95 = sub_92564((int)sub_266350, (int)&v100);
    if ( !*(_DWORD *)(a9 + 28) )
    {
      v19 = v100;
      if ( v100 )
    ...
    while ( 1 )
    {
      ...
      if ( !v100 || (v23 = *v100) == 0 )
      {
        v24 = sub_EF1B8((int)v104, &v107[1], &v101, (char **)&v107[18], &v107[19]);
        v107[0] = v24;
        if ( v24 > 0 )
        {
          if ( v24 > 3 )
...
LABEL_44:
            if ( *v19 )
            {
              ...
              v94 = v34;
              v96 = sub_266344;
              obstack_begin(&v105, 0, 0, (void *(*)(int))sub_93050, sub_266344);
              v20 = v100;
              v35 = btowc(c);
              v36 = 0;
              v92 = v35;
...
LABEL_127:
                    ...
                    do
                    {
                      while ( 1 )
                      {
                        ...
                        if ( *(_DWORD *)(v10 + 4) )
                          break;
                        sub_265F24(*(_DWORD *)(v10 + 8), v83, v84, v15, v90, v16, c, &v103);
                        if ( *(_DWORD *)(v10 + 80) <= ++v82 )
                          goto LABEL_108;
                      }
                      sub_265F24(0xFFFFFFFF, v83, v84, v15, v90, v16, c, &v103);
                      ++v82;
                    }
...
LABEL_52:
                    ...
                    v44 = *(_DWORD *)(v10 + 72);
                    v105.next_free += v42;
                    sub_265F24(0xFFFFFFFF, v44, v43, v15, v90, v16, 0, &v103);
...
LABEL_57:
                    ...
                    obstack_begin(&v106, 0, 0, (void *(*)(int))sub_93050, v96);
                    v52 = (const char *)sub_EF47C();
                    v53 = sub_EEBE0();
                    sub_EEF2C(v52, v53, v105.object_base, v105.next_free - v105.object_base, 4, &v106, 1);
                    v54 = v106.next_free;
                    ...
                    *v54 = 0;
                    sub_25A6E4(v106.object_base, a1);
                    sub_92648(v95);
                    obstack_free(&v106, 0);
                    obstack_free(v16, 0);
                    sub_EF188((int)v104);
...
LABEL_126:
      ...
      while ( 1 )
      {
        v30 = sub_EF1B8((int)v104, &src[1], &v102, (char **)&src[18], &src[19]);
        v9 = v30;
        src[0] = v30;
        if ( v30 > 0 )
        {
...
LABEL_80:
        ...
        v105.next_free += v63;
        if ( v48 )
          sub_265F24(*(_DWORD *)(v10 + 8), v64, v65, v15, v90, v16, c, &v103);
        else
          sub_265F24(0xFFFFFFFF, v64, v65, v15, v90, v16, c, &v103);
