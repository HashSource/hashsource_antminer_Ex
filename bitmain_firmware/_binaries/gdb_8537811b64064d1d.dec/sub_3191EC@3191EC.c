int __fastcall sub_3191EC(int result, int a2, int **a3, int a4)
{
  int **v4; // r4
  unsigned int v6; // r5
  int *v8; // r1
...
LABEL_5:
  ...
  *(_DWORD *)(v6 + 272) = v8;
  if ( v11 == 41 )
  {
    result = sub_318F00(v6, a2, v10 + 3, (int **)*v4);
    *(_DWORD *)(v6 + 272) = v9;
    return result;
  }
  if ( v11 == 42 )
  {
    result = sub_319574(v6, a2, v10 + 2, *v4);
    *(_DWORD *)(v6 + 272) = v9;
    return result;
  }
  if ( v11 != 2 )
  {
    result = sub_318644(v6, a2, v10);
    *(_DWORD *)(v6 + 272) = v9;
    goto LABEL_9;
  }
  v12 = *(_DWORD *)(v6 + 276);
...
LABEL_26:
  ...
  while ( v22 <= 1 );
LABEL_30:
  result = sub_314768(v6, a2, (int)v18);
  *(_DWORD *)(v6 + 272) = v9;
  return result;
}
