int __fastcall sub_22BE18(int a1, int a2, int a3, int a4)
{
  _DWORD *v7; // r0
  int v8; // r6
  _DWORD *v9; // r0
  ...
  sub_2594D8(*v7, "-> %s->to_watchpoint_addr_within_range (...)\n", (const char *)dword_489C90);
  v8 = off_489D20(&unk_489C8C, a2, a3, a4);
  v9 = (_DWORD *)sub_242FF0(v8);
  sub_2594D8(*v9, "<- %s->to_watchpoint_addr_within_range (", (const char *)dword_489C90);
