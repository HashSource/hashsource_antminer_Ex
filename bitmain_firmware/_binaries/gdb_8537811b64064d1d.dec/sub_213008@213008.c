_DWORD *__fastcall sub_213008(int a1, int a2)
{
  int v3; // r3
  ...
  *(_DWORD *)(a1 + 56) = v21;
  ...
  if ( v26 )
  {
    v27 = *(_DWORD *)sub_242FF0(v19);
    v28 = sub_98F14((int)v8);
    sub_2594D8(v27, "Created compunit symtab %s for %s.\n", v28, (const char *)v8[2]);
  }
  return v8;
}
