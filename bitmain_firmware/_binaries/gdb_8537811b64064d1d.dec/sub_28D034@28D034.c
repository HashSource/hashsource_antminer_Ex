const char *__fastcall sub_28D034(const char *result)
{
  const char *v1; // r5
  int v2; // r7
  const char *v3; // r4
  ...
  if ( (const char *)dword_48AE2C != result && dword_49014C >= (int)result )
  {
    ...
    if ( (int)&result[-dword_48AE2C] <= 0 )
    {
      ...
      if ( dword_490138 && *(_BYTE *)dword_490138 )
      {
        ...
        {
          ++v5;
          result = (const char *)tputs(result, 1, (int (*)(int))sub_293BA8);
          if ( v5 == v4 )
            break;
          result = (const char *)dword_490138;
        }
    ...
    else
    {
      ...
      while ( v1 != v3 );
      result = (const char *)tputs((const char *)dword_490140, 1, (int (*)(int))sub_293BA8);
      dword_48AE04 = 0;
    }
    dword_48AE2C = v2;
  }
