int __fastcall sub_36130(int a1, void *a2, int a3, int a4, size_t n)
{
  int v8; // r5
  const char *v9; // r1
  int v10; // r1
  ...
  sub_93200(&v15, "%s/%ld", ".note.linuxcore.siginfo", dword_4878F0);
  v13 = ptr;
  if ( v15 == v17 )
  {
    sub_33B4B4(&ptr, &v15);
...
LABEL_12:
  ...
  *v13 = 0;
  ...
  v18 = (const char *)ptr;
LABEL_3:
  v10 = sub_2AD7D4(dword_47ACB8, v9);
  if ( !v10 || !sub_2ADF04(dword_47ACB8, v10, a2, v11, a3, a4, n) )
    v8 = -1;
  if ( ptr != v21 )
    sub_339E8C(ptr);
  return v8;
