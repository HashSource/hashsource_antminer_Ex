const char *__fastcall sub_2743AC(struct XML_ParserStruct *a1, const XML_Char *a2, int a3, char *s2)
{
  const char *v6; // r4
...
LABEL_3:
  ...
  else
  {
    ...
    if ( v6 )
      goto LABEL_3;
    sub_94728((int)"xml-support.c", 551, "could not locate built-in DTD %s", v11);
  }
  return v6;
}
