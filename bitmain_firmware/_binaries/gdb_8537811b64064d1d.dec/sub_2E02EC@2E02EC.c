bool __fastcall sub_2E02EC(int a1, int a2)
{
  _DWORD *v2; // r5
  const char *v5; // r1
  int v7; // r6
  ...
  if ( (*(_BYTE *)(v7 + 464) & 0x20) == 0 )
    v5 = ".rel.got";
  v9 = sub_2ADB70(a1, v5, (const char *)((unsigned int)v8 | 8));
  if ( !v9 )
    return 0;
  *(_DWORD *)(v9 + 64) = *(unsigned __int8 *)(*(_DWORD *)(v7 + 392) + 11);
  v2[56] = v9;
  v10 = sub_2ADB70(a1, ".got", v8);
  v11 = v10;
  if ( !v10 )
    return 0;
...
LABEL_8:
  ...
  *(_DWORD *)(v11 + 36) += *(_DWORD *)(v7 + 400);
  if ( (v13 & 8) == 0 )
    return 1;
  v14 = sub_2E01D0(a1, a2, v11, (int)"_GLOBAL_OFFSET_TABLE_");
