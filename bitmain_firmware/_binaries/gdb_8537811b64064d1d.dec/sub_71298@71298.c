int __fastcall sub_71298(int a1, int a2, const char *a3)
{
  int v4; // r5
  int *v5; // r3
  const char *v6; // r6
  ...
  v83 = sub_92564(nullsub_39, 0);
  if ( !a2 )
    v5 = &dword_487CD0;
  HIWORD(v4) = (unsigned int)&dword_4748E8 >> 16;
  if ( !a2 )
    v76 = *v5;
  v6 = (const char *)sub_9EAF0(a3);
  v7 = strlen(v6);
  v8 = *(void **)(v4 + 0x3C);
  v75 = v7;
...
LABEL_41:
    ...
    if ( v76 != dword_487CD0 )
      sub_94708("No definition of \"%s\" in specified context.", a3);
    sub_94708("No definition of \"%s\" in current context.", a3);
  }
  v78 = v4;
LABEL_16:
  while ( 1 )
  {
    ...
    v11[v15] = 0;
    v79 = v15;
    v17 = sub_A5428(v11, v76, 1, &v84);
    v77 = &v11[v15];
    sub_92564(460660, v84);
    v11[v15] = v16;
    if ( v17 == 1 )
      break;
    v18 = v84;
    ...
    v23 = 0;
LABEL_28:
    switch ( sub_9FE58(v23, &src, &n, &v87) )
    {
      case 0:
        if ( v15 != v75 )
        {
...
LABEL_46:
          v29 = 0;
          v30 = a1;
          sub_70780(a1, v84[1], *v84);
LABEL_67:
          sub_711B8(v30, v27);
          goto LABEL_68;
        }
        v43 = sub_70FB4(a1, v11);
        if ( v43 )
        {
          v29 = v43;
          sub_92648(v83);
        ...
        {
LABEL_75:
          sub_1C3B9C(a1, v88[0], v88[1]);
          sub_711B8(a1, v77);
          sub_92648(v83);
          return 0;
        }
        if ( !strncmp(v11, "standard__", 0xAu) )
          sub_94708("No definition of \"%s\" found.", a3);
LABEL_33:
        if ( !--v15 )
          goto LABEL_41;
  ...
  while ( 2 )
  {
    switch ( *((_DWORD *)off_46DBB8 + 4 * (*(unsigned __int8 *)(v19 + 32) >> 3)) )
    {
      ...
      case 0xE:
        goto LABEL_25;
      case 8:
        if ( sub_A1118(*(_DWORD *)(v19 + 24), v20) )
        {
          v21 = v22;
...
LABEL_25:
        ...
        v27 = &v11[v15];
        v4 = v78;
        switch ( sub_9FE58(v32, &src, &n, &v87) )
        {
          case 0:
            if ( v15 == v75 )
            {
...
LABEL_100:
              ...
              v56 = sub_71168(v47, (const char *)v27, v53 - v27);
              if ( v56 >= 0 )
              {
                v46 = *v53;
                v27 = v53;
            ...
            if ( !v29 )
LABEL_98:
              sub_94708("Invalid attempt to select from type: \"%s\".", a3);
            return result;
          case 1:
LABEL_66:
            v30 = a1;
            v29 = 0;
            sub_709AC(a1, v76, src, n, v87, 10);
            goto LABEL_67;
          case 2:
          case 3:
          case 4:
LABEL_54:
            ...
            *(_DWORD *)(v4 + 56) = v40;
            ...
            v75 = v75 + n - v15;
            if ( v13 )
              sub_94708("Could not find renamed symbol \"%s\"", a3);
            goto LABEL_14;
          default:
LABEL_130:
            sub_94728("ada-exp.y", 1289, "impossible value from ada_parse_renaming");
            goto LABEL_131;
        }
LABEL_68:
        sub_92648(v83);
