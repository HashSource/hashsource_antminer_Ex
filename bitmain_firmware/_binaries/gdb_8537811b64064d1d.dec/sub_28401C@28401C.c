int __fastcall sub_28401C(int result, int a2, int a3, int a4, unsigned __int8 a5)
{
  int v5; // lr
  int v6; // r1
  int v7; // r1
  ...
  if ( a3 )
  {
    ...
    if ( !v7 )
      *(_DWORD *)(v8 + 4) = sub_292230;
  }
  if ( a5 && !*(_BYTE *)(result + 8 * a5) )
    *(_DWORD *)(result + 8 * a5 + 4) = 2710084;
  if ( a4 )
  {
    v9 = *(unsigned __int8 *)(result + 8 * (__int16)a4);
    result += 8 * (__int16)a4;
    if ( !v9 )
      *(_DWORD *)(result + 4) = sub_291FF8;
  }
  return result;
}
