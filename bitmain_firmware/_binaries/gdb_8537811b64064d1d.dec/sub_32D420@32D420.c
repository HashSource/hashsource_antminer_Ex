int __fastcall sub_32D420(int a1, int a2, unsigned __int64 a3, unsigned __int8 a4, int *a5)
{
  int v5; // r6
  int v6; // r11
  int v7; // r12
  ...
  if ( ((v7 | v8) & 0x70) != 0 )
  {
    ...
    {
      sub_32AC34(a1, a2, a3, (int *)HIDWORD(a3), a5);
      v122 = 0;
      free(0);
      goto LABEL_11;
    }
    if ( (v7 & 0x40) == 0 )
    {
      ...
      if ( (a4 & 0x50) != 0 )
      {
        ...
        *(_DWORD *)(a1 + 4) = *(_DWORD *)(a2 + 4);
        sub_328A28(a1, v124, (unsigned __int16 *)(a2 + 10), v81, &v127, a5);
      }
      else
      {
        *(_DWORD *)(a1 + 4) = v10;
      ...
      ptr = 0;
      sub_3295C0((_DWORD *)a1, v124, v9, a5);
      v122 = 0;
      goto LABEL_10;
    }
    if ( (v8 & 0x40) == 0 )
...
LABEL_219:
  ...
  if ( !*(_WORD *)(a2 + 10) && v12 == 1 && (v7 & 0x70) == 0 )
  {
    if ( (a4 & 0x80) != 0 )
    {
      ...
      *(_DWORD *)(a1 + 4) = v82;
      *(_BYTE *)(a1 + 8) = v123;
      sub_3295C0((_DWORD *)a1, v124, &v127, a5);
      free(0);
    }
    else if ( (a4 & 0x20) != 0 )
    {
  ...
  if ( ((a4 != 128) & ((unsigned int)v110 >> 31)) != 0 )
  {
    ...
    if ( v13 <= v15 && (v110 != -1) | (a4 >> 6) & 1 )
    {
      ...
      *(_DWORD *)(a1 + 4) = v13;
      v127 = 0;
      sub_328A28(a1, (int *)HIDWORD(a3), (unsigned __int16 *)(a2 + 10), v12, &v127, a5);
      sub_3295C0((_DWORD *)a1, v124, &v127, a5);
      v122 = (char *)(a4 & 0x20);
      free(0);
      goto LABEL_11;
  ...
  if ( v12 <= 49 )
  {
    HIDWORD(v20) = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v12) + 0x7FFFFFFF);
  }
  else
  {
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      ...
      v48 = sub_3476B8(*(v22 - 1) + 1000 * HIDWORD(v20));
      v50 = v48 == 0;
      if ( v48 )
        v49 = v48;
      else
      ...
      sub_3275D8((unsigned __int16 *)v46, v19 - v44, v29, v108, 0, v46, v48);
LABEL_114:
      HIDWORD(v20) = *v22;
    }
LABEL_142:
...
LABEL_196:
      ...
      if ( v84 )
      {
        ...
        if ( v125 > v110 )
        {
          ...
          if ( v86 == v83 )
          {
            ...
            {
              v110 = j + v85;
              if ( j == v87 || dword_438D28[j + 1] * ((dword_438B40[j + 1] * (v86 >> (j + 1))) >> 17) != v86 )
                break;
            }
            v89 = sub_328658(v115, v112, j);
            v113 = sub_327CD0((int)v115, v89);
          }
        }
      }
    }
  ...
  else
  {
    ...
    if ( v65 )
    {
      v19 = sub_328658((_WORD *)v21, v19, v65);
      v63 = *(_DWORD *)(a2 + 4);
      v64 = v119[1];
    }
    v67 = sub_327CD0(v21, v19);
    v69 = v67;
    if ( v67 <= 49 )
    {
      v70 = 35648;
...
LABEL_188:
    ...
    v91 = sub_3275D8((unsigned __int16 *)v21, v46, (unsigned __int16 *)v21, v46, 0, v21, 1);
    v92 = v91;
    v93 = *v119;
    if ( (int)*v119 > 49 )
      LOWORD(v94) = -21845;
    ...
    v97 = sub_328D1C((unsigned __int16 *)v21, v91, v29, v96, v119[1] - v110);
    if ( v97 != 0x80000000 )
    {
      v98 = v21 + 2 * v92;
      if ( v21 < v98 )
...
LABEL_260:
      ...
      if ( (int)*v119 <= 49 )
      {
        HIDWORD(v106) = dword_438B40;
        v101 = *((unsigned __int8 *)&dword_438B40[5] + v101);
      }
      else
      {
      ...
      if ( (int)*v119 > 49 )
        v101 = HIDWORD(v106) >> 1;
      v123 ^= 0x80u;
      v107 = sub_3275D8((unsigned __int16 *)v21, v46, v29, v101, v104, v21, -dword_438D28[v105]);
      v115 = (unsigned __int16 *)v21;
      v113 = sub_327CD0(v21, -v107);
LABEL_189:
      *(_BYTE *)(a1 + 8) = v123 & 0x80;
      *(_DWORD *)(a1 + 4) = v110;
      sub_328A28(a1, v124, v115, v113, &v127, a5);
      sub_3295C0((_DWORD *)a1, v124, &v127, a5);
      goto LABEL_10;
    }
    *a5 |= 0x10u;
