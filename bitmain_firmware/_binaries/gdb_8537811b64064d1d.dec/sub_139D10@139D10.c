void __fastcall sub_139D10(int a1, int a2, _WORD *a3)
{
  int v3; // r6
  int v4; // r8
  int v6; // r4
  ...
  v7 = sub_12E6BC((int)a3, 16, *(_DWORD *)(a1 + 4));
  if ( !v7 )
    goto LABEL_3;
  v8 = *(_DWORD *)(v7 + 8);
  v9 = *(_DWORD *)(v3 + 172);
  ...
  v52 = v8;
  v51 = v9;
  v11 = (_DWORD *)sub_324058(v10, &v51, 1);
  v12 = v11;
  if ( *v11 )
  {
    **(_DWORD **)(v4 + 24) = *v11;
  ...
  ((void (__fastcall *)(_DWORD **, int, int))loc_1394E8)(&v50, v8, v3);
  v13 = v50;
  if ( !v50 )
  {
LABEL_3:
  ...
  *(_DWORD *)(v6 + 56) = v30;
  ...
  if ( v33 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v43 )
      {
        v36 = sub_31E360(v42, v41, &word_39899C, v42, v44);
        goto LABEL_25;
      }
LABEL_26:
      v38 = v13[13];
