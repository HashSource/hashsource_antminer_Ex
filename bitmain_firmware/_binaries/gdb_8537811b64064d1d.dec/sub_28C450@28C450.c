int __fastcall sub_28C450(const void *a1, int a2, signed int a3, char a4)
{
  int v9; // r4
  int v10; // r3
  int v11; // r9
  ...
  {
    sub_2914F0("_rl_col_width: called with MB_CUR_MAX == 1");
    return a3 - a2;
  }
  else
  {
    ...
    if ( v10 )
    {
      ...
      else
      {
        ...
        if ( !v12 && dword_48AE0C && !memcmp(a1, (const void *)dword_48AE0C, dword_48AE08) )
        {
          ...
          return v19 + sub_28C450(a1, v11, a3, 1);
        }
      }
      v13 = a3;
    }
