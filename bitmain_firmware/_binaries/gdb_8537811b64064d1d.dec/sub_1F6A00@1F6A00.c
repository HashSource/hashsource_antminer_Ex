int __fastcall sub_1F6A00(const char *a1)
{
  int v2; // r5
  int v3; // r0
  int v4; // r4
  ...
  v8 = a1;
  if ( sub_1F6138(&v8, &v9, &v10) )
    return sub_1F61CC(-1, 5);
  if ( sub_1F5FBC(&v8, &v11) )
    return sub_1F61CC(-1, 5);
  v2 = v11;
  if ( sub_230048(v9, &v7, v10) )
    return sub_1F61CC(-1, 5);
  ...
  if ( !v3 && (((v14 & 0xF000) - 0x4000) & 0xFFFFBFFF) != 0 )
    return sub_1F61CC(-1, 13);
  if ( v2 && (sub_961AC(v13, v12), v12[0] = 0, v5 = _errno_location(), v6 = sub_2304AC(v2, v12, 64), (*v5 = v6) != 0) )
    return sub_1F649C();
  else
