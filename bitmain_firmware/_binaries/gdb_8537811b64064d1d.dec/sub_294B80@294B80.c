int __fastcall sub_294B80(int a1, unsigned __int8 a2)
{
  size_t v4; // r5
  const char *v5; // r0
  const char *v6; // r6
...
LABEL_4:
  if ( a1 > 1024 )
  {
    v5 = (const char *)sub_93050((v4 << 10) + 1);
    v6 = v5;
    if ( (int)(v4 << 10) > 0 )
    {
      v7 = (char *)v5;
...
LABEL_16:
  ...
  if ( (dword_48AAA0 & 0x800) == 0 && sub_292DAC() )
  {
    sub_292F30(a2);
    return v10;
  }
