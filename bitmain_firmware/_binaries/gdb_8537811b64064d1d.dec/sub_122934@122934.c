_DWORD *__fastcall sub_122934(int a1, int a2)
{
  _DWORD *v4; // r6
  int v5; // r0
  signed int v6; // r4
  ...
  if ( !v5 )
  {
    v33 = sub_3239A8(3, sub_11C3C4, sub_11C3DC, 0, *(_DWORD *)(dword_4872D8 + 344) + 48, sub_25AF14, nullsub_44);
    v34 = dword_4872D8;
    v4[92] = v33;
    v5 = *(_DWORD *)(v34 + 368);
  }
  ...
  *(_DWORD *)(v13 + 56) = v21;
  ...
  else
  {
    ...
    if ( v6 >= 0 )
      ...
      v36 = v6 & 0x7FFFFFFF;
    HIWORD(v35) = 58;
    v37 = sub_93168(v35, v36);
    v38 = sub_1D0734(v17[5], v37, 0, v17[5] + 108, v17[5] + 120);
    *(_DWORD *)(v38 + 64) = v17;
    *(_DWORD *)(v38 + 60) = sub_148130;
    *(_BYTE *)(v38 + 53) = 1;
    v17[6] = v38;
    *(_BYTE *)(v38 + 54) = 1;
    if ( v37 )
