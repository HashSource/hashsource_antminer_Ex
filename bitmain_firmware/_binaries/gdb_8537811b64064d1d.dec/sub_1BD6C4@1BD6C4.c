int __fastcall sub_1BD6C4(int a1, int a2, int a3)
{
  _DWORD *v3; // r7
  unsigned int v5; // r3
  const char *v7; // r5
  ...
  {
    if ( ((int (__fastcall *)(int, int, _BYTE *, _DWORD *, const char *, int))loc_1BD594)(a1, a2, v9, v10, "GNU", 16) )
    {
      ...
      switch ( result )
      {
        ...
        case 4:
          goto LABEL_10;
        default:
          result = sub_946D8("GNU ABI tag value %u unrecognized.", result);
          break;
      }
    }
    else
    {
      result = ((int (__fastcall *)(int, int, _BYTE *, _DWORD *, const char *, int))loc_1BD594)(
                 a1,
                 a2,
                 v9,
                 v10,
