void __fastcall sub_19BBEC(int a1, _DWORD *a2, int *a3, unsigned int *a4)
{
  unsigned int v6; // r3
  int v8; // r2
  unsigned int v9; // r4
    ...
    if ( v6 )
    {
      ...
      for ( i = 0; i < v6; ++i )
      {
        ...
        if ( v10 != v8 )
        {
          do
          {
            v12 = sub_195BC8((const char **)(*a2 + 8 * v9));
            v13 = sub_92564((int)sub_195418, (int)v12);
            if ( !strcmp(v11, v12) )
            {
              v14 = v33;
              v15 = (int *)(*a3 + 40 * v9);
              if ( v33 == v34 )
              {
                sub_DFC70((char **)&ptr, v33, (int *)(*a3 + 40 * v9));
              }
              else
              {
                if ( v33 )
