        ...
        void (__fastcall *a8)(char *, char **))
{
  ...
  sub_3DCB4((int)&argv, v8, a2, (const char *)v10);
  v29 = _environ;
  sub_3D154();
  v11 = sub_3D12C();
  path = (char *)sub_17FCFC(v11);
  if ( path )
  {
    sub_97FD8(&ptr, path);
    v12 = v32;
...
LABEL_14:
  ...
  _environ = v29;
  ((void (__fastcall *)(__pid_t))loc_3D1BC)(v14);
  if ( a5 )
    a5(v15);
  if ( v39 != &v40 )
    sub_339E8C(v39);
