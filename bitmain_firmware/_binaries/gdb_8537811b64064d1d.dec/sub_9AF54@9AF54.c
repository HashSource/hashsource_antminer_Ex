char *__fastcall sub_9AF54(const char *a1, char *a2, char *a3, char *a4)
{
  char *result; // r0
  char *v8; // r4
  unsigned int v9; // r0
  ...
  result = (char *)sub_9AE3C(dword_487D2C);
  v8 = result;
  if ( !a3
    || (a3[33] & 1) != 0
    && (*(char **)(*(_DWORD *)(*(_DWORD *)(sub_220A04(a3) + 4) + 32) + 8) == a4
     || (result = (char *)sub_220A04(a3), *(char **)(*(_DWORD *)(*((_DWORD *)result + 1) + 32) + 12) == a4)) )
  {
    v9 = sub_1B1374(a1);
    v10 = *((_DWORD *)v8 + 4);
    v11 = *((_DWORD *)v8 + 3);
