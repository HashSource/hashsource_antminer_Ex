int __fastcall sub_3486D8(int a1, int a2, int a3, int a4)
{
  _DWORD *v6; // r1
  int v8; // r11
  __int64 v9; // r2
  ...
  if ( !(_DWORD)v9 )
  {
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        {
          if ( sub_348E9C(a3, v44, v9, HIDWORD(v9)) )
            return 9;
          if ( v41 )
          {
            v38 = sub_3485EC(a3, 0xFu);
            sub_348640(a3, 0xEu, v38);
            sub_348640(a3, 0xFu, (int)_cxa_call_unexpected);
            return 7;
          }
          return 8;
        }
        ...
        switch ( v15 )
        {
          case 1:
            ...
            {
              v35 = v12;
              *(_DWORD *)(a2 + 32) = sub_3485EC(a3, 0xDu);
LABEL_65:
              *(_DWORD *)(a2 + 36) = v43;
LABEL_54:
              *(_DWORD *)(a2 + 40) = v35;
...
LABEL_46:
            v29 = *(_DWORD *)(a2 + 32);
            if ( v29 != sub_3485EC(a3, 0xDu) || v12 != *(int **)(a2 + 40) )
            {
LABEL_47:
              v16 = *v12;
LABEL_31:
            ...
            *(_QWORD *)(a2 + 48) = v9;
            if ( *v12 < 0 )
            {
              v39 = sub_3481E0(&v12[v17 + 1]);
              sub_348640(a3, 0xFu, (int)v39);
              sub_348640(a3, 0, a2);
              return 7;
            }
            v41 = 1;
...
LABEL_43:
        v27 = *(_DWORD *)(a2 + 32);
        if ( v27 == sub_3485EC(a3, 0xDu) && v12 == *(int **)(a2 + 40) )
        {
          v28 = sub_3481E0(v12);
          sub_348640(a3, 0xFu, (int)v28);
          sub_348640(a3, 0, a2);
          return 7;
        }
        goto LABEL_42;
