void __fastcall sub_196FDC(const char *a1, int a2, int a3, _DWORD *a4)
{
  char *v7; // r1
  unsigned int v8; // r5
  _BYTE *v9; // r0
...
LABEL_17:
      ...
      ((void (__fastcall *)(_DWORD, int *, _DWORD *, unsigned int))loc_1962C0)(v27[0], &v34, a4, v18);
    }
    else
    {
      v19 = *v15;
      ...
      v32 = sub_197420;
      v31 = &v28;
      sub_195D38(v19, (int)&v34, 1, 1, a4, 1, (int)&v28, (int)sub_197420);
      ((void (__fastcall *)(_DWORD, int *, _DWORD *, _DWORD))loc_1962C0)(v27[0], &v34, a4, 0);
    }
    v15 = (int *)v27[0];
    ++v8;
    v16 = *(unsigned int **)(v27[0] + 4);
