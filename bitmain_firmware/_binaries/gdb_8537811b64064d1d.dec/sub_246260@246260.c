int __fastcall sub_246260(int a1, int a2)
{
  int v3; // r2
  size_t v5; // r0
  int v6; // r2
  ...
  if ( (*(_DWORD *)(a2 + 12) & 0xFFFFFFFB) == 2 )
  {
    ...
    sub_99448(*(_DWORD *)(a2 + 20), savedregs, v5);
...
LABEL_25:
      v21 = *(FILE **)(a1 + 4);
      v22 = sub_98A18(v12, SHIDWORD(v12), 8, v13);
...
LABEL_26:
  v23 = *(FILE **)(a1 + 4);
  v24 = sub_98A18(v14, SHIDWORD(v14), 8, v15);
...
LABEL_18:
  ...
  {
    v19 = strlen(v18);
    sub_99448((int)v18, savedregs, v19);
