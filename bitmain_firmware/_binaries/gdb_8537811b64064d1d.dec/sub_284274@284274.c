int __fastcall sub_284274(int result)
{
  int v1; // r8
  FILE *v2; // r0
  int v3; // r6
    ...
    *v4 = 0;
    ...
    else
    {
      ...
      if ( v6 )
      {
        ...
        if ( dword_46DED4 )
          v10 = (_DWORD *)*v10;
        sub_28401C((int)v10, termios_p.c_cc[2], termios_p.c_cc[3], termios_p.c_cc[14], v22);
        v9 = ::termios_p.c_cc[4];
      }
