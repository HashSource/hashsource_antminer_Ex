unsigned __int64 __fastcall sub_483B4(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  _DWORD *v4; // r5
  bool v6; // zf
  int v7; // r3
  ...
  if ( (unsigned __int64)(*(_QWORD *)&dword_46AFB8 + 1LL) > 1 )
    sub_92078(&unk_47265C);
  v4 = &unk_47260C;
  *(_QWORD *)&dword_46AFB8 = 0;
  dword_472668 = 0;
  sub_920A8(&unk_47265C);
  sub_9206C(&unk_47265C, "<osdata type=\"semaphores\">\n", 27);
  sub_96818((int)&stream, (int)"/proc/sysvipc/sem", "r");
  v9 = stream;
  if ( stream )
  {
...
LABEL_12:
    ...
    if ( v25 )
    {
      sub_47FB8(v31, v25 | HIDWORD(v25), v25);
      v13 = v26;
      v14 = v26 | HIDWORD(v26);
      if ( !v26 )
        goto LABEL_22;
...
LABEL_23:
    ...
    sub_47FB8(v32, v14, v13);
    goto LABEL_23;
  }
LABEL_13:
  sub_9206C(&unk_47265C, "</osdata>\n", 11);
  dword_472668 = sub_920BC(&unk_47265C);
