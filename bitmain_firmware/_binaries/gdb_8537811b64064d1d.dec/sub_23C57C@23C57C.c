void __fastcall sub_23C57C(void **a1, char *a2, char **a3, char **a4)
{
  char *v8; // r8
  _DWORD *v9; // r5
  unsigned int v10; // r0
...
LABEL_5:
  ...
  if ( v16 )
    ...
    v17 = -1;
  sub_235120(ptr, v16, v17);
  if ( v14 )
  {
    v18 = v63[0];
    v19 = v63[1];
    *(_DWORD *)v14 = v14 + 8;
    sub_235120(v14, v18, (int)v19 + (_DWORD)v18);
    v20 = ptr[0];
    v21 = ptr[1];
    *((_DWORD *)v14 + 6) = v14 + 32;
    sub_235120((_DWORD *)v14 + 6, v20, (int)v21 + (_DWORD)v20);
  }
  if ( ptr[0] != v62 )
    sub_339E8C(ptr[0]);
  if ( v63[0] != v64 )
