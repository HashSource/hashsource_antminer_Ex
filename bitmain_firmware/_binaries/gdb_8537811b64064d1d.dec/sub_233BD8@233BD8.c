int __fastcall sub_233BD8(int result, char *a2, int a3)
{
  int v3; // r3
  _DWORD *v4; // r5
  char *v5; // r6
...
LABEL_16:
      ...
      result = sub_233BD8(v35 - 40, v78, v80);
      v3 = v5 - (char *)v4;
      if ( v5 - (char *)v4 <= 640 )
        return result;
      v78 = (char *)(v35 - 40);
...
LABEL_19:
        ...
        do
        {
          ...
          v53 -= 10;
          LOBYTE(v77) = 0;
          sub_234630(v4, v52, v51, v54, v55, v56, v57, *v58, v58[1], v58[2], v58[3], v58[4], v58[5], v77);
        }
        while ( v52-- != 0 );
        v60 = v79;
        do
