int __fastcall sub_2EDD28(int a1, char *a2)
{
  int v2; // r3
  int v3; // r7
  char v6; // r2
  ...
  if ( (*(_BYTE *)(v3 + 466) & 2) != 0 && *(_DWORD *)(*((_DWORD *)a2 + 7) + 40) == 1 )
  {
    ...
    if ( !v10 )
    {
      do
      {
        ...
        {
          for ( i = sub_2AD7D4((int)v7, ".eh_frame"); i; i = sub_2AD7F4(0, (const char **)i) )
          {
            if ( !sub_2E29A4(v28, (int)a2, (int)i) )
              break;
            sub_2F1D9C();
            if ( *(_DWORD *)(*((_DWORD *)i + 35) + 136) && (*((_DWORD *)i + 5) & 0x100000) == 0 )
              *(_DWORD *)(v7[40] + 584) = i;
            sub_2DBC30((int)v28, (int)i);
          }
          v6 = a2[3];
        }
        v7 = (_DWORD *)v7[39];
    ...
    sub_2FCBFC(v8, sub_2DC8F8, &v27, v9);
    if ( !v27 )
      return 0;
    sub_2FCBFC(v8, sub_2E2A6C, &v27, v27);
    if ( !v27 )
      return 0;
    v15 = *(_DWORD *)(v8 + 48);
    if ( v15 || (v15 = *a2, v15 < 0) )
      sub_2FCBFC(v8, *(_DWORD *)(v3 + 188), a2, v15);
...
LABEL_40:
              ...
              do
              {
                ...
                if ( (*(_BYTE *)(v23 + 24) & 8) == 0 && (v24 & 0x8000) == 0 )
                {
                  ...
                  *(_DWORD *)(v23 + 20) = v25;
                  ...
                  {
                    if ( *(_DWORD *)(v23 + 36) )
                      sub_2A6A84("Removing unused section '%A' in file '%B'", v23, v21);
                  }
                }
                v23 = *(_DWORD *)(v23 + 12);
              }
  ...
  {
    sub_2A6A84("Warning: gc-sections option ignored");
    return 1;
  }
}
