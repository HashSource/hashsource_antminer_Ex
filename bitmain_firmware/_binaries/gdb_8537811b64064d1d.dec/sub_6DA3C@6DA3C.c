void __fastcall sub_6DA3C(int a1, int *a2, int a3)
{
  int v3; // r4
  _DWORD *v5; // r9
  int v6; // r10
    ...
    if ( *(_DWORD *)(*(_DWORD *)(v3 + 160) + 2308) )
    {
      ...
      if ( v60 )
      {
        ...
        if ( v5 )
        {
          ...
          {
            v16 = v5 + 2;
            v17 = sub_2A78C4(*(_DWORD *)(v6 + 36)) / 8;
            v18 = 2 * v17;
            v47 = sub_1B7278(v6);
            v19 = 3 * v17;
            v20 = sub_1780DC(v47);
            v21 = (char *)v5 + 3 * v17 + 8;
            v45 = sub_338618(v21, 0, v5[1] - 3 * v17);
            if ( v45 )
            {
              v7 = *(_DWORD *)(v20 + 152);
              s = (char *)(v45 + 1);
              v51 = sub_15AED0(v5 + 2, v7);
              v8 = v49 - sub_15AED0((char *)v5 + v17 + 8, v7);
              v52 = v8;
              v9 = sub_15AED0((char *)v5 + v18 + 8, v7);
              v11 = v9;
              if ( v9 )
                v10 = v8;
              v12 = v5[1];
              ...
              if ( v13 )
              {
                ...
                if ( v14 )
                {
                  if ( (_DWORD *)sub_338618(v14, 0, v48) == (_DWORD *)((char *)v16 + v12 - 1) )
                  {
                    v60 = v62;
                    v23 = (_BYTE *)strlen(s);
                    v24 = v23;
                    ...
                    {
                      v43 = (_DWORD *)sub_33B2E4(&v60, &ptr, 0);
                      v60 = v43;
                      v62[0] = ptr;
                    }
                    else
...
LABEL_28:
                        ...
                        if ( v26 > 0xF )
                        {
                          v44 = (_DWORD *)sub_33B2E4(&ptr, &v56, 0);
                          ptr = v44;
                          v59[0] = v56;
                        }
                        else
...
LABEL_31:
              ...
              {
                v15 = sub_1B87D0(v6);
                sub_F43DC(&off_46D334, "corrupt probe argument when reading `%s'", v15);
              }
            }
            else if ( dword_47AC88 > 0 )
            {
              v22 = (const char *)sub_1B87D0(v6);
              sub_F43DC(&off_46D334, "corrupt probe name when reading `%s'", v22);
            }
LABEL_15:
            v5 = (_DWORD *)*v5;
          }
        ...
        if ( (a2[1] - *a2) >> 2 == (v54 - v53) >> 2 && dword_47AC88 > 0 )
          sub_F43DC(&off_46D334, "could not parse SystemTap probe(s) from inferior");
      }
      else if ( dword_47AC88 > 0 )
      {
        sub_F43DC(
