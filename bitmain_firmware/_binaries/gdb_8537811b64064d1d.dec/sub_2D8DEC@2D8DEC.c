int __fastcall sub_2D8DEC(int a1, int *a2)
{
  char *v4; // r2
  int result; // r0
  int v6; // r6
  ...
  {
    case 7:
      result = sub_2D8D38(a1, ".qnx_core_info", a2[1], a2[5], (unsigned int)a2[5]);
      break;
    case 8:
      v6 = a2[4];
      ...
      *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 160) + 2344) + 4) = v7;
      ...
      v15 = strlen(s);
      v16 = (char *)sub_2ACC1C(a1, v15 + 1);
      v17 = v16;
      if ( v16 && (strcpy(v16, s), (v18 = (_DWORD *)sub_2ADB70(a1, v17, (const char *)0x100)) != 0) )
      {
        v19 = a2[5];
        v20 = a2[1];
        v18[21] = 0;
        ...
        v18[9] = v20;
        v18[16] = 2;
        result = sub_2CCA08(a1, ".qnx_core_status", (int)v18);
      }
      else
      {
LABEL_17:
    ...
    case 10:
      v4 = ".reg2";
LABEL_3:
      result = sub_2CCA6C(a1, a2 + 1, a2 + 5, dword_471208, v4);
      break;
    default:
      result = 1;
      break;
