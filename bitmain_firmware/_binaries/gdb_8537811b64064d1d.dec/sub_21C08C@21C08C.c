int __fastcall sub_21C08C(int a1, unsigned int a2, _DWORD *a3, int a4)
{
  int result; // r0
  unsigned int v7; // r5
  unsigned int v8; // r2
  ...
  result = (int)sub_1B216C(a2, *(char **)a1, a3, a4);
  if ( result )
  {
  ...
  else
  {
    ...
    do
    {
      ...
      if ( result )
      {
        ...
        if ( v9 == a3[42] )
        {
          sub_94728((int)"symtab.c", 1695, "Section index is uninitialized");
          JUMPOUT(0x21C208);
        }
        v14 = *(_DWORD *)(v9 - 8);
        ...
        result = sub_163004(*(_DWORD *)(v14 + 36), *(_DWORD *)(v9 - 12));
        if ( a2 >= v15 - v17 + *(_DWORD *)(v16 + 4 * result) )
        {
          v18 = *(_DWORD *)(v9 - 8);
          v21 = *(_DWORD *)(v18 + 144);
          v20 = *(_DWORD *)(*(_DWORD *)(v9 - 12) + 28) + *(_DWORD *)(*(_DWORD *)(v9 - 12) + 36);
          result = sub_163004(*(_DWORD *)(v18 + 36), *(_DWORD *)(v9 - 12));
