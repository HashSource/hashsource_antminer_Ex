bool __fastcall sub_343D30(char *s1, void (__fastcall *a2)(_BYTE *), int a3)
{
  int v3; // r11
  int v7; // r10
  bool v8; // zf
...
LABEL_20:
  ...
  if ( v12 == 1 )
  {
    if ( v3 != 95 || s1[1] != 90 )
      return 0;
    v41 = s1 + 2;
    v20 = (_DWORD *)sub_33FB98((int)v39, 1);
    if ( (v40 & 1) != 0 )
    {
      while ( 1 )
      {
...
LABEL_51:
        ...
        LODWORD(v33) = v20;
        v20 = (_DWORD *)sub_33D738((int)v39, 77, v33);
      }
    }
    else
    {
LABEL_65:
  ...
  else if ( v12 )
  {
    ...
    {
      v41 = s1 + 13;
      v18 = (_DWORD *)sub_33FB98((int)v39, 0);
    }
    else
    {
      v38 = v14;
    ...
    v20 = (_DWORD *)sub_33D738((int)v39, v16, (unsigned int)v18);
    v41 += strlen(v41);
    v21 = *(unsigned __int8 *)v41;
  }
  else
  {
    v20 = sub_33ED0C((int)v39);
    v21 = *(unsigned __int8 *)v41;
  }
  v22 = (int)v20;
  if ( v20 )
  ...
  v69 = 0;
  v70[0] = 0;
  sub_33D804((int)v70, &v67, v20);
  v70[1] = 0;
  v65 = &v38;
  v70[0] *= v67;
  v68 = &v38;
  sub_3401DC((int)v53, 17, (int)v20);
  v23 = v56;
  v53[v54] = 0;
  v23(v53);
  return v60 == 0;
