char *__fastcall sub_297B70(char *result)
{
  int *v1; // r5
  char *v2; // r6
  int v3; // r2
...
LABEL_4:
    ...
    if ( dword_48BB2C )
    {
      ...
      {
        dword_48BB2C += 50;
        v14 = sub_93078((void *)dword_48BB28, 4 * (v4 + 50));
        v5 = *v1;
    ...
    {
      dword_48BB2C = 50;
      dword_48BB28 = (int)sub_93050(0xC8u);
      *v1 = 1;
    }
LABEL_8:
    v6 = time(0);
    ...
    v9 = strcpy(v8, v15);
    *v9 = byte_48BB34;
    result = (char *)sub_297A40(v2, (int)v9);
    v10 = *v1;
    v11 = dword_48BB28;
