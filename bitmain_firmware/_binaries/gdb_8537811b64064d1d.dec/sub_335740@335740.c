int __fastcall sub_335740(_BYTE *a1, _BYTE *a2, unsigned int a3, unsigned int a4, unsigned int a5)
{
  int v6; // r5
  _BYTE *v8; // r10
    ...
    while ( 2 )
    {
      ...
      switch ( v6 )
      {
        ...
        case '@':
          ...
          if ( v9[1] != 40 )
            goto LABEL_49;
          result = sub_335138(v6, s, (unsigned int)a2, a3, a4, a5);
          if ( result == -1 )
            goto LABEL_49;
          return result;
        case '*':
          ...
          {
            result = sub_335138(42, s, (unsigned int)a2, a3, a4, a5);
            if ( result != -1 )
              return result;
          }
          ...
          if ( v32 )
          {
            ...
            do
            {
              if ( *v31 == 40 )
                ...
                v35 = 0;
              if ( !v35 || (v36 = sub_333EB8(v31), v36 == v31) )
              {
                v36 = v31;
                if ( v30 == 63 )
                {
          ...
          if ( v30 )
          {
            if ( (a5 & 1) != 0 )
              ...
              v47 = 0;
            v48 = sub_338618(a2, v47, v28 - (_DWORD)a2);
            if ( v48 )
              v49 = (_BYTE *)v48;
            else
              v49 = (_BYTE *)v28;
...
LABEL_214:
                ...
                if ( a2 < v49 )
                {
                  ...
                  do
                  {
                    v65 = sub_335740(v63, a2++, v28, v64, a5);
                    v64 = 0;
                    if ( !v65 )
                      return 0;
                  }
...
LABEL_155:
              ...
              while ( 1 )
              {
                ...
                if ( v51 == v30 )
                {
                  ...
                  if ( a4 )
                    v66 = 1;
                  if ( !sub_335740(sa, v50, v28, v66, a5) )
                    break;
                }
                a4 = 0;
                if ( a2 == v49 )
            ...
            return sub_335740(v31, a2 + 1, v28, (a5 >> 2) & 1, a5) != 0;
          }
          else
          {
            if ( (a5 & 1) == 0 || (a5 & 8) != 0 )
              return 0;
            return sub_338618(a2, 47, v28 - (_DWORD)a2) != 0;
          }
        case '/':
          if ( (a5 & 5) != 5 )
            goto LABEL_49;
        ...
        case '?':
          if ( (a5 & 0x20) != 0 && v9[1] == 40 )
          {
            result = sub_335138(63, s, (unsigned int)a2, a3, a4, a5);
            if ( result != -1 )
              return result;
          }
          if ( (_BYTE *)a3 == a2 )
