char *__fastcall sub_284C44(char *s, int a2)
{
  const char *v2; // r5
  const char *v3; // r6
  int *v4; // r4
...
LABEL_17:
  ...
  {
    sub_297780(dword_48ACD0);
    v70 = strlen((const char *)dword_48ACC8);
    v71 = (char *)sub_93050(v70 + 1);
