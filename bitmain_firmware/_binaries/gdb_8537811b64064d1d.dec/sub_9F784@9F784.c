int __fastcall sub_9F784(const char *a1, int a2, int a3)
{
  char *v5; // r0
  int v6; // r1
  int v7; // r4
  ...
  else
  {
    v5 = (char *)sub_21A5BC();
    if ( a3 <= 0 )
      sub_94708("Request to select 0 symbols!");
    v87 = 2;
  }
  if ( v91 > 1 )
  {
    if ( v5 == "cancel" )
      sub_94708("canceled because the command is ambiguous\nSee set/show multiple-symbol.");
    v7 = v89;
    v8 = v89 != 1;
    if ( v5 != "all" )
      v8 = 0;
...
LABEL_78:
        if ( v49 == ++v47 )
        {
          v58 = v88;
          v59 = nptr;
          v60 = sub_9F5B8(v88, v91, v89, v89 > 1, (int)"overload-choice");
          v91 = v60;
          if ( v60 > 0 )
          {
            v61 = v58 - 1;
      ...
      if ( v51 == 10 )
      {
        sub_21EC40(v96, *(_DWORD *)&v48[8 * v47], 1);
        v80 = v97;
        v81 = v98;
        v82 = sub_259880("[%d] ", v47);
        v83 = (_DWORD *)sub_242FB4(v82);
        ((void (__fastcall *)(_DWORD, _DWORD))loc_9D9B8)(*v83, *(_DWORD *)&v48[8 * v47]);
        if ( v80 )
        {
          v84 = (const char *)((int (__fastcall *)(int))loc_2043FC)(v80);
          sub_259880(" at %s:%d\n", v84, v81);
        }
        else
        {
          sub_259880(" at <no source file available>:%d\n", v81);
        }
        goto LABEL_78;
      }
      ...
      if ( *(_WORD *)(v50 + 34) )
      {
        if ( v53 )
        {
          v75 = sub_259880("[%d] ", v47);
          v76 = (_DWORD *)sub_242FB4(v75);
          ((void (__fastcall *)(_DWORD, _DWORD))loc_9D9B8)(*v76, *(_DWORD *)&v48[8 * v47]);
          v77 = (const char *)((int (__fastcall *)(int))loc_2043FC)(v53);
        ...
        {
LABEL_98:
          v78 = sub_259880("[%d] ", v47);
          v79 = (_DWORD *)sub_242FB4(v78);
          ((void (__fastcall *)(_DWORD, _DWORD))loc_9D9B8)(*v79, *(_DWORD *)&v48[8 * v47]);
LABEL_99:
          sub_259880(v94);
          goto LABEL_78;
        }
      ...
      {
        v54 = sub_259880("[%d] ", v47);
        v55 = (_DWORD *)sub_242FB4(v54);
        ((void (__fastcall *)(_DWORD, _DWORD))loc_9D9B8)(*v55, *(_DWORD *)&v48[8 * v47]);
        if ( !v53 )
          goto LABEL_99;
        v56 = " at %s:?\n";
        goto LABEL_77;
...
LABEL_88:
      ...
      {
        v69 = sub_259880("[%d] ", v47);
        v70 = *(_DWORD *)(*(_DWORD *)&v48[8 * v47] + 24);
        v71 = (_DWORD *)sub_242FB4(v69);
        sub_B2354(v70, 0, *v71, -1, 0, "\a");
        if ( dword_46D448 )
          v72 = (const char *)sub_21B3EC(*(_DWORD *)&v48[8 * v47]);
        else
          v72 = **(const char ***)&v48[8 * v47];
        sub_259880("'(%s) (enumeral)\n", v72);
        goto LABEL_78;
      }
      v73 = sub_259880("[%d] ", v47);
      v74 = (_DWORD *)sub_242FB4(v73);
      ((void (__fastcall *)(_DWORD, _DWORD))loc_9D9B8)(*v74, *(_DWORD *)&v48[8 * v47]);
      if ( !v53 )
      {
        sub_259880(" (enumeral)\n");
        goto LABEL_78;
      ...
      v56 = " in %s (enumeral)\n";
LABEL_77:
      v57 = ((int (__fastcall *)(int))loc_2043FC)(v53);
      sub_259880(v56, v57);
      goto LABEL_78;
    }
  }
