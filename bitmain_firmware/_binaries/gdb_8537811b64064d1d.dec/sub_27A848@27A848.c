__int64 __fastcall sub_27A848(int *a1, _DWORD *a2)
{
  _DWORD *v3; // r4
  int v4; // r0
  int v6; // r8
  ...
  v3 = (_DWORD *)sub_171280(a2);
  v47 = v3;
  v4 = sub_323E64(a1[5], &v47);
  if ( v4 )
    return *(_QWORD *)(v4 + 8);
  v6 = v3[4] & 0x83;
  if ( v6 )
  ...
  else
  {
    ...
    {
      case 1:
        v34 = sub_27A848(a1, *(_DWORD *)(v7 + 20));
        v35 = HIDWORD(v34);
      ...
      case 2:
        ...
        {
          if ( sub_171B58((int)v3, &v46, &v48) && v46 )
          {
            sub_94728(
      ...
      case 4:
        ...
        if ( *(__int16 *)(v31 + 4) > 0 )
        {
          ...
          {
            ++v6;
            sub_27A848(a1, *(_DWORD *)(*(_DWORD *)(v31 + 24) + v45 + 12));
      ...
      case 7:
        ...
        if ( !v12 )
        {
          ...
          {
            v12 = *(_DWORD *)(sub_1780EC(*(_DWORD *)(v7 + 16)) + 12);
          }
          else
          {
            sub_1780DC();
          ...
          sub_946D8("function has unknown return type; assuming int");
        }
        sub_27A848(a1, v12);
        LODWORD(v48) = *(__int16 *)(v3[6] + 4);
        v13 = (char *)sub_93050(8 * v48);
        v14 = v3[6];
        v15 = v13;
        HIDWORD(v48) = v13;
        if ( *(__int16 *)(v14 + 4) > 0 )
        {
          ...
          while ( 1 )
          {
            ...
            v16 += 24;
            v19 = sub_27A848(a1, *(_DWORD *)(v18 + 12));
            v14 = v3[6];
            *(_QWORD *)&v15[v17] = v19;
            if ( *(__int16 *)(v14 + 4) <= v6 )
              break;
      ...
      case 0xE:
        if ( (*(_BYTE *)(v7 + 2) & 0x10) != 0 )
          sub_1780EC(*(_DWORD *)(v7 + 16));
        else
          sub_1780DC();
        sub_946D8("variable has unknown type; assuming int");
        v9 = ((__int64 (*)(void))*(_DWORD *)(*(_DWORD *)(*a1 + 4) + 56))();
        break;
      case 0x15:
        ...
        break;
      case 0x16:
        v10 = sub_27A848(a1, *(_DWORD *)(v7 + 20));
        v11 = HIDWORD(v10);
