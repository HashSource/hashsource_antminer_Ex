int __fastcall sub_22A76C(int a1, int a2, int a3, int a4, int a5)
{
  _DWORD *v5; // r0
  int v6; // r7
  _DWORD *v7; // r0
  ...
  sub_2594D8(*v5, "-> %s->to_enable_btrace (...)\n", (const char *)dword_489C90);
  v6 = off_489F00(&unk_489C8C, v26, v27, v28, a5);
  v7 = (_DWORD *)sub_242FF0(v6);
  sub_2594D8(*v7, "<- %s->to_enable_btrace (", (const char *)dword_489C90);
