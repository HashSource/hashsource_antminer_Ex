int __fastcall sub_5ABA4(unsigned __int8 **a1, int a2, int a3, unsigned __int8 *a4)
{
  ...
  if ( v7 == 36 )
  {
    v17 = sub_26DDF0(v6, &v31);
    v18 = v17;
    if ( v17 )
    {
      if ( **(_BYTE **)(sub_26BC98(v17) + 24) == 8 )
      {
        v10 = sub_26EB44(v18);
      }
      else
      {
        v10 = 0;
        sub_259F38("History value must have integer type.\n");
      }
    }
    else
    {
      ...
      v30[v25] = 0;
      v27 = sub_26CC1C(v26);
      v10 = sub_26EB64(v27, v32);
      if ( v10 )
        v10 = v32[0];
      else
        sub_259F38("Convenience variable must have integer value.\n");
    }
  }
  else
  {
...
LABEL_20:
  *a1 = (unsigned __int8 *)sub_93634(v9);
  if ( v8 )
    return -v10;
  return v10;
}
