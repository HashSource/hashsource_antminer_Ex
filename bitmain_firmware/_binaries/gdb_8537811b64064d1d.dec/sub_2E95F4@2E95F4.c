int __fastcall sub_2E95F4(int *a1, int a2)
{
  int v3; // r2
  int v5; // r0
  int v6; // r2
  ...
  {
    v155 = 0;
    v142 = sub_347440(*(_DWORD *)(v5 + 96), *(unsigned __int8 *)(*(_DWORD *)(v6 + 392) + 5));
  }
  else
  {
    v142 = *(_DWORD *)(v5 + 104);
  ...
  v85 = sub_2CDA30(a2, v153, v142, 0, a1[10], (char *)a1[8], (char *)a1[9]);
  v145 = v85;
  if ( v85 )
  {
    v8 = *(_DWORD *)(a2 + 160);
      ...
      while ( 1 )
      {
        ...
        if ( v31 )
        {
          ...
          else
          {
            ...
            {
              v37 = sub_300644(v140, &v170, *(_DWORD *)(*(_DWORD *)(v32 + 140) + 136), *(_DWORD *)v9);
              v13 = v170;
              *(_DWORD *)v9 = v37;
            }
          }
        ...
        *v10 = v13;
        ...
        v18 = sub_2CD86C(a2, *(_DWORD *)(v141 + 100), *(_DWORD *)(v9 + 8));
        if ( !v18 )
          return 0;
        v19 = *a1;
        if ( (*(_BYTE *)(*a1 + 1) & 0x60) == 0x40 )
        {
          if ( !sub_2AAC54(*(_DWORD **)(v19 + 32), v18, 0, 0) )
            goto LABEL_40;
          v19 = *a1;
        }
...
LABEL_33:
          ...
          v29 = *(_DWORD *)(v140 + 124);
          v30 = sub_2DCC70(a1, v18, &v171, (int)v25, 0);
          if ( !v30 )
            return 0;
          if ( v30 == 1 )
            *v12 = v29;
...
LABEL_32:
          if ( !v143 )
          {
            ...
            if ( (v34 & 0x40) != 0 )
              v33 = 0;
            if ( !sub_2DCC70(a1, v33, &v171, (int)&off_470950, 0) )
              return 0;
          }
          goto LABEL_33;
        }
...
LABEL_82:
      ...
      else
      {
        ...
        else
        {
          ...
          if ( v55 == -1 )
          {
            ...
            v175 = v130;
            v133 = *(_DWORD *)(v131 + 60);
            v134 = sub_2CD86C(v144, v132, v127);
            if ( !v134 )
              return 0;
            v175 = sub_2D4BA4(v140, v133);
            if ( v175 == -257 )
              return 0;
            v135 = v134;
            v136 = *(_DWORD *)(v140 + 124);
            v171 += *(_DWORD *)(v38 + 56);
            v137 = sub_2DCC70(a1, v135, &v171, v38, 0);
            if ( !v137 )
              return 0;
            if ( v137 != 1 )
              sub_2A6C18((int)"elflink.c", 10462, (int)"elf_link_input_bfd");
            v55 = v136;
    ...
    {
      src = (void *)a1[5];
      if ( !sub_2A96A8(v144, v38, (int *)&src) )
        return 0;
      v45 = *(_DWORD *)(v38 + 20);
    }
    if ( (v45 & 4) == 0 )
      goto LABEL_96;
    v160 = sub_2E2780(v144, v38, a1[6], (_DWORD *)a1[7], 0);
    ...
    if ( v56 > n )
    {
        ...
        || !strncmp(v57, ".dtors", 6u) && !strcmp(**(const char ***)(v38 + 60), ".fini_array") )
      {
        ...
        if ( v59 )
        {
          ...
          {
            sub_2A6A84("error: %B: size of section %A is not multiple of address size", v144, v38);
      ...
      for ( j = v160; v62 > j; j += 3 )
      {
        ...
        if ( v67 )
        {
          ...
          else
          {
            v70 = v145 + 20 * v67;
            v71 = *(_BYTE *)(v70 + 12);
            v170 = (char **)sub_2CDDD0(v144, v153, v70, (int)v69);
            v72 = v71 & 0xF;
          }
...
LABEL_146:
    ...
    if ( v90 )
    {
      v91 = *(_DWORD *)(v90 + 40);
      if ( v91 )
        v92 = sub_347440(*(_DWORD *)(v90 + 24), v91);
      else
        v92 = 0;
    ...
    while ( 1 )
    {
      ...
      v109 = sub_2DB314(v140, v96, v38, *(v95 - 3));
      *(v95 - 3) = v109;
      if ( v109 <= 0xFFFFFFFD )
      {
        v98 = (_BYTE *)*a1;
              ...
              *v150 = 0;
              ...
              if ( (v106 & 0xF) != 3 )
              {
                ...
                if ( v107 == -1 )
                {
                  ...
                  v157 = sub_2CD86C(v144, *(_DWORD *)(v141 + 100), v173);
                  if ( !v157 )
                    return 0;
                  v116 = *(_DWORD *)(v154 + 60);
                  v175 = sub_2D4BA4(v140, v116);
                  if ( v175 == -257 )
                    return 0;
                  v117 = *a1;
                  ...
                  v121 = sub_2DCC70(a1, v157, &v171, v154, 0);
                  if ( !v121 )
                    return 0;
                  if ( v121 != 1 )
                    sub_2A6C18((int)"elflink.c", 10940, (int)"elf_link_input_bfd");
...
LABEL_259:
        if ( v90 && *(_DWORD *)(v90 + 24) )
        {
          ...
          v122 = *(_DWORD *)(v90 + 40);
          if ( v122 )
            v123 = sub_347440(*(_DWORD *)(v90 + 24), v122);
          else
            v123 = 0;
...
LABEL_96:
        ...
        if ( !v51 || !v51(v140, *a1, v38, src) )
        {
          ...
          {
            case 1:
              if ( !sub_302758(v140, *(_DWORD *)(*a1 + 28) + 132, v38, *(_DWORD *)(v38 + 140) + 136, src) )
                return 0;
              break;
            case 2:
              if ( !sub_3003EC(v140, v38, *(_DWORD *)(*(_DWORD *)(v38 + 140) + 136)) )
                return 0;
              break;
            case 3:
              if ( !sub_2F4288(v140, *a1, v38, src) )
                return 0;
              break;
            case 6:
              if ( !sub_2F4050(v140, *a1, v38, src) )
                return 0;
              break;
            default:
              ...
              if ( (v79 & 0x4000000) != 0 )
              {
                ...
                {
                  v77 -= n;
                  if ( !sub_2ADE10(v140, *(_DWORD **)(v38 + 60), (char *)src + v77, v79, v80, n) )
                    return 0;
                  if ( !v77 )
                    goto LABEL_99;
              ...
              if ( !sub_2ADE10(v140, *(_DWORD **)(v38 + 60), src, v79, v80, v77) )
                return 0;
              break;
          }
        }
