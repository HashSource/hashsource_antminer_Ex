int __fastcall sub_2D91E4(int a1, int a2)
{
  char *v4; // r0
  unsigned int v5; // r3
  int v7; // r0
  ...
  if ( v5 == 1 )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(v13 + 4) = v12;
      v15 = sub_2D8FC0(a1, v14, 0x1Fu);
      v16 = *(_DWORD *)(a2 + 20);
      v17 = *(_DWORD *)(a2 + 4);
      *(_DWORD *)(v13 + 16) = v15;
      return sub_2D8D38(a1, ".note.netbsdcore.procinfo", v17, 0, v16);
    }
  }
  else
  {
    ...
    return sub_2D8D38(a1, ".reg", *(_DWORD *)(a2 + 4), *(_DWORD *)(a2 + 20), *(unsigned int *)(a2 + 20));
  }
}
