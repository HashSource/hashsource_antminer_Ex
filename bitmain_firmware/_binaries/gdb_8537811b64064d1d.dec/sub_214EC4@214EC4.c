int __fastcall sub_214EC4(int a1, _DWORD *a2)
{
  int v4; // r0
  int v5; // r12
  int v6; // r6
...
LABEL_62:
      ...
      for ( i = *(_DWORD *)(v15 + 100); i; i = *(_DWORD *)(i + 12) )
      {
        if ( (*(_DWORD *)(i + 20) & 1) != 0 )
        {
          ...
          *(_DWORD *)(i + 32) = v48;
          *(_DWORD *)(i + 28) = v48;
          sub_95B18(*(const char **)v15, v47, *(_DWORD *)(v44 + 4 * v47));
