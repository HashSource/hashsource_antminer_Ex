int *sub_126EA0()
{
  ...
  v3 = (char *)sub_2AD260(*(_DWORD *)(*(_DWORD *)(dword_4872D8 + 344) + 36), &v42, &v43);
  v4 = v3;
  if ( !v3 )
  {
    v38 = sub_2A6938(0);
    ...
    {
      v39 = sub_2A6938(v38);
      v40 = (const char *)sub_2A6948(v39);
      sub_94708("could not read '.gnu_debugaltlink' section: %s", v40);
    }
    return v1;
  }
  v46 = 0;
  ...
  v6 = sub_1B87D0(*(_DWORD *)(dword_4872D8 + 344));
  sub_984CC((int *)&ptr, v6);
  sub_25AFAC(v48, ptr);
  if ( v48[1] == (void *)0x7FFFFFFF )
    sub_33D1AC("basic_string::append");
  v7 = sub_33C348(v48, &word_39899C, 1);
  v50 = v52;
  v10 = v7;
  v11 = (int *)(v7 + 8);
  v12 = *(_DWORD *)v7 == v7 + 8;
...
LABEL_25:
  ...
  *v22 = 0;
  ...
  if ( ptr )
    free(ptr);
LABEL_33:
  ((void (__fastcall *)(void **, void *, int, int))loc_1629B4)(&v50, v24, dword_47ACA8, -1);
  v25 = (unsigned __int8 *)v43;
  if ( !v50 )
  {
LABEL_54:
    sub_E4404((const char ***)&v53, v41, v25);
    v36 = v53;
    if ( v50 )
    ...
    if ( !v36 )
    {
      v37 = (const char *)sub_1B87D0(v26);
      sub_94708("could not find '.gnu_debugaltlink' file for %s", v37);
    }
    goto LABEL_37;
  }
  if ( !sub_E4380((const char **)v50, v41, v43) )
  {
    v25 = (unsigned __int8 *)v43;
    v50 = 0;
    goto LABEL_54;
...
LABEL_37:
  ...
  *(_DWORD *)(v26 + 56) = v34;
  ...
  v50 = 0;
  v30[35] = v35;
  sub_2ADD24(v35, sub_11EC98, v30);
  sub_163228(*(_DWORD *)(*(_DWORD *)(dword_4872D8 + 344) + 36), v30[35]);
  v12 = v50 == 0;
