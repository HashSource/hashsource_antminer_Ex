int __fastcall sub_91250(unsigned int a1)
{
  int v2; // r0
  int v3; // r7
  int v4; // r2
  ...
  v2 = obstack_begin(&v23, 0, 0, (void *(*)(int))sub_93050, sub_8D05C);
  v31 = a1;
  v24 = 0;
  v25 = 0;
  v26 = 0;
  ...
  v3 = ((int (__fastcall *)(int))loc_8DB20)(v2);
  if ( !v3 )
  {
    v4 = v24;
LABEL_5:
    sub_907E0(__SPAIR64__(v4, a1), v4, 0);
    goto LABEL_6;
  }
  if ( dword_487CAC )
  {
