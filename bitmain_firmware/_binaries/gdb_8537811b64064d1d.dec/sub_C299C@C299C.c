_BYTE *__fastcall sub_C299C(_DWORD *a1, const char *a2, size_t a3, int a4)
{
  size_t v8; // r0
  int v9; // r1
  size_t v10; // r4
  ...
  if ( v8 > 0xF )
  {
    v17 = (_DWORD *)sub_33B2E4(&v20, &v23, 0);
    v20 = v17;
    v22[0] = v23;
LABEL_26:
...
LABEL_5:
  ...
  *(_DWORD *)((char *)v43 + 3) = 0;
  if ( v14 )
  {
    v15 = (_BYTE *)sub_C2928(a1, (int)&v23, &v20);
    if ( v15 )
    {
      v14 = 0;
      do
      {
        if ( sub_21D9D8(v15[20] & 0x1F, v15[32] & 7, a4) )
        {
          v14 = v15;
          if ( (v15[33] & 2) == 0 )
            break;
        }
        v15 = (_BYTE *)sub_C2974((int)&v23, (int)&v20);
      }
      while ( v15 );
      goto LABEL_18;
    }
LABEL_44:
  ...
  while ( 1 )
  {
    ...
    if ( v19 == a4 )
      break;
    if ( sub_21D9D8(*(_BYTE *)(v18 + 20) & 0x1F, v19, a4) )
      v14 = (_BYTE *)v18;
    v18 = sub_C2974((int)&v23, (int)&v20);
    if ( !v18 )
      goto LABEL_18;
  }
  v14 = (_BYTE *)v18;
