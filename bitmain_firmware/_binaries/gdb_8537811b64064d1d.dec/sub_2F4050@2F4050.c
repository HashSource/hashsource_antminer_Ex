int __fastcall sub_2F4050(int a1, int a2, int a3, void *src)
{
  int v5; // r0
  void *v7; // r7
  int v8; // r2
  ...
  if ( (*(_WORD *)(a3 + 24) & 0x380) != 0x300 )
    sub_2A6BE4("elf-eh-frame.c", 1845);
  if ( (*(_DWORD *)(a3 + 20) & 0x8000) != 0 || (v10[5] & 0x8000) != 0 )
    return 1;
  result = sub_2ADE10(a1, *(_DWORD **)(a3 + 60), v7, 0, *(unsigned int *)(a3 + 56), *(_DWORD *)(a3 + 40));
  if ( result )
  {
    ...
    if ( v13 > 8 )
    {
      ...
      sub_2A6A84("%B: %A not in order", *(_DWORD *)(a3 + 148), a3);
      return 0;
    }
LABEL_17:
    ...
    if ( ((v17 - v13) & 1) != 0 )
    {
      sub_2A6A84("%B: %A invalid input section size", *(_DWORD *)(a3 + 148));
      goto LABEL_27;
    }
    if ( v17 <= v12 )
    {
      sub_2A6A84("%B: %A points past end of text section", *(_DWORD *)(a3 + 148));
LABEL_27:
    ...
    if ( v19 != v13 + 8 )
      sub_2A6BE4("elf-eh-frame.c", 1898);
    if ( !*(_DWORD *)(v20 + 448) )
      sub_2A6BE4("elf-eh-frame.c", 1900);
    ...
    return sub_2ADE10(a1, *(_DWORD **)(a3 + 60), srca, v24, v24, 8u);
  }
  return result;
}
