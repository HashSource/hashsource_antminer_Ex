int __fastcall sub_28B7DC(int a1, int a2)
{
  char v2; // r6
  int v3; // r8
  int v4; // r3
...
LABEL_23:
    ...
    if ( v7 == (int (__fastcall *)(_DWORD))sub_28C258 )
    {
      if ( (v3 & 1) == 0 )
      {
LABEL_129:
...
LABEL_33:
    ...
    {
      if ( v7 != (int (__fastcall *)(_DWORD))sub_28C260 )
      {
        if ( v7 == (int (__fastcall *)(_DWORD))sub_29603C )
        {
          *(_DWORD *)(a1 + 76) = -3;
LABEL_13:
          if ( (v3 & 8) == 0 )
        ...
        v11 = v7 == (int (__fastcall *)(_DWORD))sub_291A8C;
        if ( v7 != (int (__fastcall *)(_DWORD))sub_291A8C )
          v11 = a2 == 25;
        if ( v11 )
        {
          *(_DWORD *)(a1 + 76) = -6;
...
LABEL_59:
      ...
      switch ( (unsigned int)mb_cur_max )
      {
        case 0u:
          ...
          *(_DWORD *)(a1 + 16) = v71;
          mb_cur_max = (unsigned __int8 *)sub_93078(mb_cur_max, v71);
          v72 = dword_4900DC;
...
LABEL_89:
        ...
        case 1u:
          ...
          if ( dword_4900DC <= v49 )
            goto LABEL_107;
          v50 = sub_29B474(dword_48AAD4, *(_DWORD *)(a1 + 12) + dword_4900D8);
          mb_cur_max = (unsigned __int8 *)sub_2911F8(v50);
          if ( !mb_cur_max )
            goto LABEL_107;
...
LABEL_97:
          ...
          {
            v53 = sub_29B474(dword_48AAD4, i);
            if ( !sub_2911F8(v53) )
              break;
            if ( _ctype_get_mb_cur_max() > 1 && !dword_48BB60 )
            {
LABEL_138:
              v51 = sub_29B4F8(dword_48AAD4);
              goto LABEL_97;
            }
          }
          v48 = *(_DWORD *)(a1 + 12);
          ...
          if ( (int)v16 >= v54 )
          {
            v74 = v51 - v49 + 2 + v54;
            *(_DWORD *)(a1 + 16) = v74;
            mb_cur_max = (unsigned __int8 *)sub_93078(mb_cur_max, v74);
            v48 = *(_DWORD *)(a1 + 12);
            *(_DWORD *)(a1 + 8) = mb_cur_max;
          }
          if ( v51 > v49 )
...
LABEL_91:
        ...
        case 2u:
          v13 = -1;
          sub_295124(*(_DWORD *)(*(_DWORD *)(a1 + 20) + 4 * *(_DWORD *)(a1 + 44)), 0);
          v42 = *(_DWORD *)(a1 + 40);
          dword_4900D8 = *(_DWORD *)(a1 + 36);
          dword_4900D4 = v42;
          v43 = sub_28D4A0(dword_4900D8);
          sub_28D534(v43);
          return v13;
        case 3u:
          v39 = *(_DWORD *)(a1 + 12);
...
LABEL_107:
            mb_cur_max = (unsigned __int8 *)sub_2945F0(mb_cur_max, v16);
          }
          else
          {
            if ( !dword_48ADF0 )
            ...
            *(_DWORD *)(a1 + 12) = dword_48ADF4;
            mb_cur_max = (unsigned __int8 *)sub_28B380(v68, v67 & 1);
          }
LABEL_108:
          v27 = *(_DWORD *)(a1 + 4);
          v26 = *(_DWORD *)(a1 + 12);
...
LABEL_46:
  ...
  if ( (int)v18 + 2 >= SHIDWORD(v18) )
  {
    ...
    *(_DWORD *)(a1 + 8) = sub_93078(v70, HIDWORD(v18) + 128);
  }
...
LABEL_123:
  ...
  *(_DWORD *)(a1 + 52) = *(_DWORD *)(v35 + 4 * v34);
  sub_295124(*(_DWORD *)(v35 + 4 * v34), v76 & 4);
  v36 = *(_DWORD *)(a1 + 4);
  v37 = *(_DWORD *)(a1 + 104);
  *(_DWORD *)(a1 + 48) = *(_DWORD *)(a1 + 68);
  v38 = *(const char **)(a1 + 8);
  dword_4900D8 = v37;
  sub_28B380(v38, v36 & 1);
  return 1;
}
