        ...
        int (__fastcall *a5)(int, int, int, int, int))
{
  ...
  {
    if ( sub_2ABC4C(v8, v7, &v30, 0, (unsigned int)a3) )
    {
      sub_2A6A84("Dwarf Error: Zero format count.");
  ...
  {
    ++v12;
    sub_2ABC4C(v8, v7, &v30, 0, (unsigned int)a3);
    v13 = &v7[v30];
    sub_2ABC4C(v8, v13, &v30, 0, (unsigned int)a3);
    v7 = &v13[v30];
  }
  while ( v12 < v10 );
  v26 = sub_2ABC4C(v8, v7, &v30, 0, (unsigned int)a3);
  v14 = &v7[v30];
  if ( a3 - (unsigned __int8 *)&v7[v30] >= v26 )
  {
    if ( v26 )
    {
      ...
      while ( 1 )
      {
        ...
        while ( 2 )
        {
          v17 = sub_2ABC4C(v8, v15, &v30, 0, (unsigned int)a3);
          v18 = &v15[v30];
          switch ( v17 )
          {
            case 1:
            ...
            case 5:
              ...
              v20 = (int *)&v31;
LABEL_14:
              v21 = sub_2ABC4C(v8, v18, &v30, 0, (unsigned int)a3);
              v15 = &v18[v30];
              v14 = (char *)sub_2F68F0(&v33, v21, 0, v23, v14, a3);
              if ( !v14 )
                return 0;
              switch ( v21 )
              {
              ...
              break;
            default:
              sub_2A6A84("Dwarf Error: Unknown format content type %Lu.", v17);
              ((void (__fastcall *)(int))loc_2A6C70)(17);
              return 0;
          }
          break;
...
LABEL_20:
  ...
  sub_2A6A84("Dwarf Error: data count (%Lx) larger than buffer size.", v26);
  ((void (__fastcall *)(int))loc_2A6C70)(17);
  return 0;
}
