int __fastcall sub_2F4FEC(int a1, int a2)
{
  int v2; // r4
  _DWORD *v3; // r6
  _BOOL4 v4; // r2
  ...
  if ( (*(_BYTE *)(a2 + 3) & 0x60) != 0x40 )
  {
    ...
    if ( v11 )
    {
      ...
      *((_BYTE *)v10 + 1) = (*(int (__fastcall **)(int, int, char *, _DWORD, _DWORD *, int, int *))(*(_DWORD *)(*(_DWORD *)(a1 + 4) + 444)
      ...
      qsort(*(void **)(v2 + 192), *(_DWORD *)(v2 + 184), 0xCu, (__compar_fn_t)sub_2F1AD8);
      v23 = 0;
...
LABEL_39:
      ...
      if ( !sub_2ADE10(a1, (_DWORD *)v3[15], v10, v3[14], (unsigned int)v3[14], v3[9]) )
        v5 = 0;
      free(v10);
      v17 = *(void **)(v2 + 192);
      if ( v17 )
  ...
  if ( v3[9] != 8 )
    sub_2A6C18((int)"elf-eh-frame.c", 2359, (int)"write_compact_eh_frame_hdr");
  v18 = *(_DWORD *)(a1 + 4);
  v26 = 0;
  src = 2;
  v19 = *(_DWORD *)(v18 + 444);
  ...
  {
    sub_2A6BE4("elf-eh-frame.c", 2367);
  ...
  (*(void (__fastcall **)(unsigned int, int *))(*(_DWORD *)(a1 + 4) + 48))(
    ...
    &v26);
  return sub_2ADE10(a1, (_DWORD *)v3[15], &src, v3[14], (unsigned int)v3[14], v3[9]);
}
