int __fastcall sub_2B1E64(_DWORD *a1)
{
  int i; // r6
  int j; // r5
  int v4; // r1
  ...
  for ( i = *(_DWORD *)(a1[40] + 12); i; i = *(_DWORD *)(i + 8452) )
  {
    for ( j = 0; j != 0x2000; j += 32 )
    {
      ...
      sub_2B15F4((int)a1, 54, (unsigned int)v22, v5);
    }
LABEL_10:
    ;
  }
  ...
  {
    v21 = v22;
    sub_2B1714((size_t)&v21, *(const char **)k);
    v9 = v21++;
    *v9 = 49;
    sub_2B1478(&v21, *(_DWORD *)(k + 28));
    sub_2B1478(&v21, *(_DWORD *)(k + 28) + *(_DWORD *)(k + 36));
    sub_2B15F4((int)a1, 51, (unsigned int)v22, v21);
  }
  v10 = (int *)a1[30];
  if ( v10 && *v10 )
  {
    do
    {
      ...
      if ( v11 != 63 )
      {
        v12 = *v10;
        v21 = v22;
        sub_2B1714((size_t)&v21, **(const char ***)(v12 + 16));
        switch ( v11 )
        {
          case 'A':
            v20 = v21++;
          ...
          default:
LABEL_18:
            sub_2B1714((size_t)&v21, *(const char **)(v12 + 4));
            sub_2B1478(&v21, *(_DWORD *)(*(_DWORD *)(v12 + 16) + 28) + *(_DWORD *)(v12 + 8));
            sub_2B15F4((int)a1, 51, (unsigned int)v22, v21);
            break;
        }
      }
  ...
  if ( sub_2A88AC((int)"%0781010\n", 9, (int)a1) != 9 )
    sub_2A6C18((int)"tekhex.c", 901, (int)"tekhex_write_object_contents");
  return 1;
}
