int __fastcall sub_F59DC(int a1, int a2, unsigned __int8 *a3, int a4, int a5)
{
  int v7; // r1
  int v8; // r0
  unsigned int v11; // r2
  ...
  {
    v43 = sub_93050(((v8 - v7) & 0xFFFFFFFC) + 8);
    ptr = v46;
    v12 = &a3[a5 - a4];
    v45 = 0;
    LOBYTE(v46[0]) = 0;
...
LABEL_23:
    ...
    *v43 = v28;
    if ( v29 )
    {
      ...
      v38 = (const char *)sub_31E360(v28, v28, &ptr, 0, v40);
