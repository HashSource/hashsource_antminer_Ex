int __fastcall sub_2E9094(int a1, _DWORD *a2)
{
  int v2; // r12
  int result; // r0
  char *v6; // r0
  ...
  *a2 = 0;
  ...
  if ( (*(_BYTE *)(a1 + 40) & 7) != 1 )
    return 1;
  v6 = sub_2AD7D4(a1, ".dynamic");
  v7 = (int)v6;
  if ( !v6 || !*((_DWORD *)v6 + 9) )
    return 1;
  if ( sub_2AE004(a1, (int)v6, (int *)&ptr) )
  {
    v8 = sub_2D4BA4(a1, v7);
    if ( v8 != -257 )
    {
      ...
      if ( ptr < v12 )
      {
        do
        {
          ...
          if ( v22[0] == 1 )
          {
            v19 = sub_2CD86C(a1, v15, v22[1]);
            if ( !v19 )
              goto LABEL_8;
            v20 = (_DWORD *)sub_2ACC1C(a1, 12);
            if ( !v20 )
              goto LABEL_8;
            *v20 = *a2;
            v20[1] = a1;
