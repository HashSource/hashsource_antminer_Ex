void __fastcall sub_1AD5E0(int a1, int a2)
{
  int v2; // r4
  int v3; // r3
  int v4; // r6
  ...
  if ( v3 > 0 )
  {
    do
    {
      if ( !*(_BYTE *)(*(_DWORD *)(*(_DWORD *)(v4 + 28) + 4 * v2) + 52) )
      {
        if ( dword_48A514 )
        {
          v126 = (_DWORD *)sub_242FB4(a1);
          sub_25A6E4(&word_3E1FAC, *v126);
          v127 = sub_259B80("");
          v128 = (_DWORD *)sub_242FB4(v127);
          sub_25A6E4("and ", *v128);
          sub_259B80("");
          sub_259F38("%s...", *(const char **)(*(_DWORD *)(*(_DWORD *)(v4 + 28) + 4 * v2) + 4));
          v129 = sub_259B80("");
          v130 = (_DWORD *)sub_242FB4(v129);
          sub_256834(*v130);
        }
        a1 = sub_1AD5E0(v148);
        v3 = *(_DWORD *)(v4 + 32);
  ...
  *(_QWORD *)&dword_487AA4 = v14;
  ...
  {
LABEL_111:
    v87 = sub_1A7E74((int)"unknown", 0, (int)v148);
    v51 = *(_DWORD *)(v87 + 12);
    v15 = 0;
    v152 = v87;
    v153 = 0;
...
LABEL_67:
    ...
    v50 = sub_1A7E74(*(_DWORD *)(v4 + 4), v153, (int)v148);
    v51 = *(_DWORD *)(v50 + 12);
    v152 = v50;
...
LABEL_42:
          ...
          else if ( v42 == 1 || v42 == 5 )
          {
            v42 = (v84 - 1088) & 0xFF80;
            if ( v42 )
              v42 = sub_1AC050(v44 + 8, v81, 0, v82, v154, v148);
          }
          --v43;
          v44 += 20;
        }
      ...
      if ( *v72 && dword_487AEC )
      {
        v45 = (const char *)((int (__fastcall *)(int))loc_2043FC)(v42);
        sub_259F38("File %s contains %d unresolved references:", v45, dword_487AEC);
      ...
      if ( *v46 > 2 )
      {
        if ( v47 == 3 || (qsort(v46 + 4, v47 - 2, 4u, (__compar_fn_t)sub_1A731C), v47 = *v46, *v46 > 2) )
        {
          v88 = v46 + 3;
          v89 = 0;
          v90 = 2;
...
LABEL_61:
    ...
    v96 = (unsigned int *)sub_93050(56 * v61);
    v163 = sub_92564(1735488, (int)v96);
...
LABEL_165:
      if ( *(_DWORD *)(v15 + 28) > v102 )
        v53 = (int *)sub_93078(v53, 8 * v102 + 4);
    ...
    while ( 1 )
    {
      ...
      if ( v153 <= v102 )
      {
        if ( dword_47AC88 > 0 )
        {
          ...
          sub_F43DC(&off_46D334, "guessed size of linetable for %s incorrectly", v117);
          v102 = *v53;
          v150 = *(__int16 *)(v15 + 42);
        }
        goto LABEL_163;
  ...
  while ( 1 )
  {
    ...
    if ( (int (*)())((v169 >> 12) & (unsigned int)&loc_FFF00) == sub_8F300 )
    {
      ...
      if ( (v26 & 0xE0) == 0 )
      {
        if ( *(_BYTE *)(v22 + v24) == 35 )
LABEL_156:
          sub_10797C(68, 0, v168, v25, v154, v148, v27);
LABEL_31:
        if ( v26 == 36 )
        {
          v28 = dword_487ABC;
          ...
          *(_DWORD *)(v28 + 56) = v36;
          v37 = sub_1A751C("__GDB_EFI_INFO__");
          memset(v32, 0, 0x3Cu);
          *(_BYTE *)(v37 + 32) = 12;
          v38 = *(_DWORD *)sub_1780EC((int)v148);
          *(_DWORD *)(v37 + 8) = v32;
          *(_DWORD *)(v37 + 24) = v38;
          v32[20] = -1;
          sub_E5AD0((_DWORD *)v37, (_DWORD **)&dword_4788E8);
        }
        goto LABEL_27;
      }
    }
      ...
      if ( *(_BYTE *)(v22 + v24) != 35 )
      {
        ...
        if ( v17 == 5 )
        {
          if ( (v169 & 0xFFFFF000) != 0xFFFFF000 )
          {
            ...
            v122 = ((int (__fastcall *)(int, unsigned int))loc_169FC8)(v164, v168 + *(_DWORD *)(v154 + 4 * v120));
            sub_E606C(v121, v21, v122);
          }
        }
        else
        {
          ...
          if ( !v19 && dword_47AC88 > 0 )
            sub_F43DC(&off_46D334, "unknown stabs symbol %s", v25);
        }
        goto LABEL_27;
      }
      v26 = v21 - 586496;
    ...
    {
      v157 = 0;
      sub_10797C(v26, 0, v23, v25, v154, v148, v27);
      goto LABEL_31;
    }
    v124 = v148[38];
    if ( v124 == -1 )
...
LABEL_27:
    ...
    if ( v20 <= v16 )
    {
      if ( !v157 )
      {
        ...
        if ( v141 == -1 )
          goto LABEL_199;
        v152 = sub_E747C(*(_DWORD *)(v4 + 20), v141);
        sub_20C1BC(v152);
      }
      v131 = *(__int16 *)(v15 + 42);
      if ( v131 > 0 )
      {
        v132 = (int *)sub_93050(56 * v131);
        v133 = sub_92564(1735488, (int)v132);
        v134 = *(__int16 *)(v15 + 42);
  ...
  sub_94728((int)"mdebugread.c", 4044, "sect_index_text not initialized");
LABEL_198:
  sub_94728((int)"mdebugread.c", 4094, "sect_index_text not initialized");
LABEL_199:
  v142 = sub_94728((int)"mdebugread.c", 4110, "sect_index_text not initialized");
  v147 = v143;
  v144 = v142;
  if ( dword_48A514 )
  {
    v145 = sub_259F38("Reading in symbols for %s...", *(const char **)(v142 + 4));
    v146 = (_DWORD *)sub_242FB4(v145);
    sub_256834(*v146);
  }
  off_478984 = sub_1A72B0;
  sub_1AD5E0(HIDWORD(v144));
  ((void (__fastcall *)(_DWORD))loc_20BE8C)(HIDWORD(v144));
  if ( !dword_48A514 )
