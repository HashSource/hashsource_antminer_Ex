int __fastcall sub_173F68(unsigned int a1, unsigned int a2)
{
  unsigned int *v2; // r4
...
LABEL_51:
  ...
  if ( a1 == a2 )
    return 1;
  v7 = 0;
  v3 = (struct obstack *)sub_C1960(0, 0);
  v8 = sub_99EE0(0, 1, 8, 8);
  v2 = v8;
  if ( *v8 >= v8[1] )
  {
LABEL_52:
  ...
  *v8 = v9;
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      v53 = v12;
      *v2 = v10 - 1;
      sub_C1658(&v52, 8u, v3, (struct obstack *)&v51);
      if ( v51 )
      {
        v13 = v53;
        v14 = (_DWORD *)sub_171280(v52);
        v15 = (_DWORD *)sub_171280(v13);
        v16 = v15;
        if ( v14 != v15 )
          break;
      }
    ...
    v49 = *v17;
    v47 = v18;
    if ( !sub_16FB4C(*((const char **)v17 + 3), v18[3]) || !sub_16FB4C(*((const char **)v17 + 2), v47[2]) )
      goto LABEL_11;
    v24 = v47;
    if ( v49 == 12 )
    {
      if ( !sub_1707A4(*((_DWORD *)v17 + 6), (int)v47[6]) )
        goto LABEL_11;
      v17 = (char *)v14[6];
  ...
  if ( (v26 & 1) == 0 )
  {
    ...
    while ( 2 )
    {
      if ( ((*(_DWORD *)(v25 + 8) ^ *(_DWORD *)(v45 + 8)) & 0xFFFFFFF0) == 0
        && (v26 & 0xE) == 0
        && sub_16FB4C(*(const char **)(v25 + 16), *(const char **)(v45 + 16)) )
      {
        ...
        switch ( v27 )
        {
          ...
          case 2:
            ...
            goto LABEL_36;
          case 3:
            if ( !sub_16FB4C(*(const char **)v25, *(const char **)v45) )
              break;
            goto LABEL_36;
          case 4:
            v32 = *(const char **)v25;
...
LABEL_36:
            ...
            *v2 = v30;
            ...
            continue;
          default:
            sub_94728((int)"gdbtypes.c", 3606, "Unsupported field kind %d by check_types_equal", v27);
            goto LABEL_64;
        }
      }
      break;
