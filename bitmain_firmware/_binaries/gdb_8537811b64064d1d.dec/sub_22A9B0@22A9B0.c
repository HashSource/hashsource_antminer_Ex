_DWORD *__fastcall sub_22A9B0(_DWORD *a1, int a2, int a3, int a4)
{
  _DWORD *v7; // r0
  int v8; // r0
  int v9; // r1
  ...
  sub_2594D8(*v7, "-> %s->to_get_ada_task_ptid (...)\n", (const char *)dword_489C90);
  ...
  *a1 = v30[0];
  ...
  sub_2594D8(*v11, "<- %s->to_get_ada_task_ptid (", (const char *)dword_489C90);
