void __fastcall sub_153E08(char *a1)
{
  void *v2; // r0
  size_t v3; // r0
  int v4; // r4
  ...
  {
    v3 = strlen(a1);
    v2 = (void *)sub_33BC7C((int)&ptr, 0, v44, a1, v3);
    v4 = dword_487668;
    goto LABEL_3;
  }
  v4 = dword_487668;
  ...
  if ( v9 == 2 )
  {
    sub_94728((int)"event-top.c", 370, "double prompt");
    v38 = ptr;
    if ( ptr != v45 )
      sub_339E8C(ptr);
    sub_339024(v38);
...
LABEL_3:
      ...
      {
        sub_153BEC();
        ((void (__fastcall *)(void *))loc_153D10)(ptr);
      }
      else
      {
        v5 = ptr;
        v6 = (_DWORD *)sub_242FB4(v2);
        v7 = sub_256878(v5, *v6);
