int __fastcall sub_2DC34(int a1, _DWORD *a2)
{
  _BYTE *v2; // r7
  int v3; // r4
  const char *v5; // r9
  ...
  if ( v8 == 44 )
  {
    ...
    *((_BYTE *)&v25 + (_DWORD)v13) = 0;
    if ( sub_257EBC(a1, (char *)&v25) == -1 )
      sub_94708("Invalid register name `%s' on expression `%s'.", (const char *)&v25, (const char *)v26[4]);
    v15 = (const char *)sub_93634(i + 1);
    ...
    if ( *endptr[0] == 93 )
    {
      ...
      sub_1C37E4(v26 + 1, 38);
      v21 = sub_1780DC(a1);
      sub_1C391C(v20, *(_DWORD *)(v21 + 16));
      sub_1C38C0(v20, v22, v25, v25 >> 31);
      sub_1C37E4(v20, 38);
      if ( v17 )
        sub_1C37E4(v20, 58);
      sub_1C37E4(v20, 44);
      ...
      endptr[2] = v13;
      v3 = 1;
      sub_1C4F34(v20, &v25, v13);
      sub_1C37E4(v20, 44);
      sub_1C37E4(v20, 1);
      sub_1C37E4(v20, 52);
      v23 = v26;
      v24 = sub_1700E8(v26[5]);
      sub_1C391C(v20, v24);
      sub_1C37E4(v20, 52);
      sub_1C37E4(v20, 61);
      *v23 = v19 + 1;
