int *__fastcall sub_57350(const char **a1)
{
  char *v1; // r5
  char *v3; // r0
  char *v4; // r6
  ...
  v1 = (char *)*a1;
  if ( !*a1 )
    sub_51EC4("name of command to define");
  v3 = &v1[strlen(*a1)];
  if ( v1 >= v3 )
  {
LABEL_22:
...
LABEL_11:
  ...
  ptr = v16;
  sub_572A0(&ptr, v1, (int)(v5 - 1));
  v14 = (unsigned __int8 *)ptr;
  v7 = *(int **)(sub_544F0(&v14, dword_474744, "", 0, 1) + 52);
  v13 = ptr;
  if ( !v7 )
    sub_94708("\"%s\" is not a prefix command.", (const char *)ptr);
  *a1 = v5;
  if ( v13 == v16 )
  {
    v1 = v5;
  ...
  if ( *v1 )
  {
    do
    {
      if ( isalnum(v8) )
        ...
        v9 = v8 != 45;
      if ( v8 != 95 && v9 )
        sub_94708("Junk in argument list: \"%s\"", v1);
