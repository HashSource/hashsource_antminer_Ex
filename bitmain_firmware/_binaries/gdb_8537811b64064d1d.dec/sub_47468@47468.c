unsigned __int64 __fastcall sub_47468(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  _DWORD *v4; // r7
  ...
  if ( v6 )
  {
    if ( (unsigned __int64)(*(_QWORD *)&dword_46AF98 + 1LL) > 1 )
      sub_92078(&unk_47261C);
    v4 = &unk_47260C;
    *(_QWORD *)&dword_46AF98 = 0;
    dword_472628 = 0;
    sub_920A8(&unk_47261C);
    sub_9206C(&unk_47261C, "<osdata type=\"files\">\n", 22);
    v9 = opendir("/proc");
    if ( v9 )
    {
      v25 = v5;
      while ( 1 )
      {
        ...
        if ( (unsigned int)*(unsigned __int8 *)(v10 + 19) - 48 <= 9 )
        {
          ...
          {
            sub_93198(v26, 17, "/proc/%s", v11);
            if ( !_xstat64(3, v26, v28) && (v29 & 0xF000) == 0x4000 )
            {
              v12 = strtol(v11, 0, 10);
              sub_46ECC(v27, 0x20u, v12);
              v13 = (char *)sub_93168("/proc/%s/fd", v11);
              v14 = opendir(v13);
              if ( v14 )
              {
                while ( 1 )
                {
                  ...
                  {
                    v17 = (const char *)sub_93168("%s/%s", v13, (const char *)(v15 + 19));
    ...
    sub_9206C(&unk_47261C, "</osdata>\n", 11);
    dword_472628 = sub_920BC(&unk_47261C);
