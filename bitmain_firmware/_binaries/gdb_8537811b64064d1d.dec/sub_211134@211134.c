const char *__fastcall sub_211134(char *s, const char *a2, const char *a3, int a4, int a5)
{
  size_t v9; // r10
  size_t v10; // r0
  size_t v11; // r4
  ...
  v12 = strlen(a3);
  v13 = (const char *)sub_93050(v11 + v12 + 9 + v9);
  v14 = (char *)stpcpy(v13, s);
  strcpy(v14, a3);
  if ( !sub_210F94(v13, a4, a5) )
  {
    ...
    if ( !sub_210F94(v13, a4, a5) )
    {
      v17 = (unsigned int *)sub_98354((char *)dword_489698);
      v31 = (void *)sub_25B33C();
      if ( v17 && *v17 )
      {
        v30 = s;
