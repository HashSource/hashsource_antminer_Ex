_DWORD *__fastcall sub_1056CC(int a1, _DWORD *a2, int a3, _DWORD *a4, int a5, size_t a6, void *a7, int a8, int a9)
{
  size_t v12; // r10
  __int64 v13; // r0
  int v14; // r8
  ...
  a2[5] = a6;
  if ( !a6 && dword_47B270 && ((int (__fastcall *)(_DWORD, _DWORD))loc_16C5EC)(v13, HIDWORD(v13)) )
  {
    ...
    *(_BYTE *)(v12 + 8 * (_DWORD)src) = 0;
    sub_1B1444((int)v66, v18);
    v19 = v66[0];
    if ( v66[0]
      || (v60 = (char *)v63,
          *(_BYTE *)(v12 + 8 * (_DWORD)src) = 95,
          v62[1] = 0,
          sub_1B1444((int)v66, v60),
          (v19 = v66[0]) != 0) )
    {
      v20 = *(__int16 *)(v19 + 22);
      v21 = *(_DWORD *)(v19 + 8);
      if ( v20 == -1 )
      {
        v61 = sub_94728((int)"dbxread.c", 2084, "Section index is uninitialized", v21);
        return (_DWORD *)sub_105B4C(v61, HIDWORD(v61));
      }
      a2[5] = *(_DWORD *)(*(_DWORD *)(v66[1] + 144) + 4 * v20) + v21 + *(_DWORD *)(v19 + 24);
    }
    dword_47B270 = 0;
  }
  if ( ((int (__fastcall *)(int))loc_16C5EC)(v14) )
  {
    if ( a9 )
    {
      a2[4] = a2[5];
