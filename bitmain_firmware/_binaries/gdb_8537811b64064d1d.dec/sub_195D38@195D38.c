int __fastcall sub_195D38(int result, int a2, int a3, int a4, _DWORD *a5, char a6, int a7, int a8)
{
  char v9; // r3
  int v11; // r3
  int v12; // r3
  ...
  if ( dword_487D28 )
  {
    ...
    do
    {
      ...
      if ( !v11 && !v23[6] )
      {
        result = ((int (__fastcall *)(_DWORD *))loc_1CD2B8)(v23);
            ...
            if ( a6 )
            {
              ...
              if ( *v17 > 2 )
              {
                ...
                do
                {
                  ...
                  v30 = v29;
                  v31 = sub_19538C;
                  result = v20(v19, a2, a3, v29, sub_19538C);
                  v17 = *(int **)(*(_DWORD *)(v15 + 4) + 32);
                }
                while ( *v17 > v18 );
                j = v22;
