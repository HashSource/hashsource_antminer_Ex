char *__fastcall sub_2AAC54(_DWORD *a1, const char *a2, int a3, int a4)
{
  const char *v4; // r6
  int v5; // r1
  ...
  v15 = *(char **)(*a1 + 4 * ((unsigned __int64)sub_34769C(v14, a1[3]) >> 32));
  if ( v15 )
  {
...
LABEL_16:
    if ( v15 )
    {
      ...
      return (char *)sub_2AAA60((int)a1, (int)v4, v14);
    }
    ((void (__fastcall *)(int))loc_2A6C70)(6);
    return v15;
  }
  return (char *)sub_2AAA60((int)a1, (int)v4, v14);
}
