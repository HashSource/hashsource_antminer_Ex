int __fastcall sub_289DBC(unsigned __int8 *a1)
{
  int v1; // r5
  int v2; // r4
  bool v3; // zf
...
LABEL_125:
    ...
    while ( 1 )
    {
      ...
      if ( !v7 )
        break;
      ++v72;
      v71 = (const char *)*(&off_3FD53C + 2 * v72);
      if ( !v71 )
      {
        v7 = 0;
        sub_28884C((int)"unknown parser directive");
        return v7;
      }
    }
    ((void (__fastcall *)(const char *))(&off_3FD2F8)[2 * v72 + 146])(v65);
    return v7;
  }
...
LABEL_140:
    v7 = 1;
    sub_28884C((int)"no closing `\"' in key binding");
    return v7;
  }
  v12 = 1;
  while ( v73 == 92 )
    ...
    if ( !v18 )
    {
        ...
        *v109 = 0;
        ...
        if ( v112 )
        {
          ...
          if ( v113 && v11[v113 - 1] == v111 )
            v11[v113 - 1] = 0;
          sub_28957C(v104, (char *)v11 + 1, (int)off_46DED0);
        }
        else
        {
          v114 = (int (*)())sub_289904((const char *)v11);
          sub_289320(0, v104, v114, (int)off_46DED0);
        }
        v7 = 0;
        sub_297780(v104);
      }
      else
      {
        ...
        do
        {
          ...
          {
            v28 = (int)(&off_3FD2F8)[2 * v27 + 156];
            goto LABEL_56;
          }
          ++v27;
          v25 = (&off_3FD564)[2 * v27];
        }
        while ( v25 );
...
LABEL_65:
        ...
        if ( v36 )
        {
          ...
          if ( v37 && v11[v37 - 1] == v35 )
            v11[v37 - 1] = 0;
          v7 = 0;
          sub_28957C(&v115, (char *)v11 + 1, (int)off_46DED0);
        }
        else
        {
          ...
          {
            v7 = 0;
            v100 = sub_289904((const char *)v11);
            sub_288C1C(v28, v100);
          }
          else
          {
            v115 = v28;
            v116 = 0;
            sub_289320(1, &v115, (int (*)())&unk_46F728, (int)off_46DED0);
          }
        }
      }
      return v7;
