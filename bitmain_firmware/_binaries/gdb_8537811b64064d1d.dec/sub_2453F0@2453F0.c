int __fastcall sub_2453F0(const char *a1, int *a2, int a3)
{
  int v6; // r7
  int v7; // r0
  int result; // r0
  ...
  v46 = 0;
  v7 = sub_16F67C(v6);
  v44 = ((int (__fastcall *)(int))loc_165BE0)(v7);
  if ( a3 )
  {
    result = (*(int (__fastcall **)(int *, const char *))(*a2 + 4))(a2, a1);
    if ( !result )
      sub_94708("Target failed to save trace data to '%s'.", a1);
  }
  else
  {
    v9 = &dword_4899A0;
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v15 < 0 )
LABEL_41:
          sub_94708("Failure to get requested trace buffer data", HIDWORD(v15), v16, v18);
        v19 = *a2;
        if ( !v15 )
      ...
      if ( !v14(&dword_4899A0, v47, v13, HIDWORD(v13), 6, 0) )
        break;
      v20 = sub_15C278(v47, 2, v44);
      v43 = sub_15C278(v48, 4, v44);
        ...
        do
        {
          ...
          switch ( v47[0] )
          {
            ...
            case 'V':
              ...
              if ( v15 < 12 )
                goto LABEL_41;
              v37 = sub_15C1B8(v47, 4, v44);
              v38 = sub_15C1B8(v49, 8, v44);
            ...
            case 'M':
              ...
              v40 = v13 + 11;
              v42 = v22 + 11;
              v26 = sub_15C278(v47, 8, v44);
              v28 = v27;
              v29 = (unsigned __int16)sub_15C278(v50, 2, v44);
              ...
              break;
            default:
              sub_94708("Unknown block type '%c' (0x%x) in trace frame", v47[0], v47[0]);
          }
          v22 = v42 + v24;
          v13 = v40 + v25;
        }
