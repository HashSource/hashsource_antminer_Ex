void __fastcall sub_59364(int a1, char *a2)
{
  _DWORD *v2; // r4
  int v4; // r7
  int v5; // r6
  ...
  if ( v2 )
  {
    ...
    if ( dword_474758 < (unsigned int)((v6 - dword_474810) >> 2) )
      sub_94708("Max user call depth exceeded -- command aborted.");
    v7 = dword_487668;
    v8 = dword_46B144;
    ...
    *v9 = 0;
    v14 = v10;
    while ( (unsigned int)sub_59010((int)v2) <= 1 )
    {
      v2 = (_DWORD *)*v2;
      if ( !v2 )
        goto LABEL_10;
    }
    sub_946D8("Error executing canned sequence of commands.");
LABEL_10:
    dword_46B144 = v8;
    if ( v7 != -36 )
      *(_DWORD *)(v7 + 36) = v13;
