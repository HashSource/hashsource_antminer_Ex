int __fastcall sub_6A628(const char *a1, int a2)
{
  int v2; // r4
  int v3; // r7
  int v4; // r8
  ...
  if ( v11 != -1 )
  {
    ...
    if ( result )
    {
      v13 = sub_1B6B4C(v12, dword_4748B8);
      if ( !v13 )
      {
        v13 = sub_3239A8(1, &loc_6AAE0, sub_6A57C, 0, v12 + 48, sub_25AF14, nullsub_44);
        sub_1B6B44(v12, dword_4748B8, v13);
      }
      v14 = *(_QWORD *)(v12 + 60);
      ...
      *(_DWORD *)(v12 + 56) = v23;
      v24 = (_DWORD *)sub_324058(v13, v20, 1);
      v25 = (_DWORD *)*v24;
      v26 = v24;
      if ( *v24 )
      {
        ...
        if ( *v25 != a2 )
        {
          v29 = (const char *)sub_25ACB4(v27, *v25);
          v30 = (const char *)sub_25ACB4(v28, a2);
          sub_946D8(
  ...
  v31 = sub_94728("elfread.c", 669, "Section index is uninitialized");
  v56 = v2;
  v57 = a2;
  v58 = a1;
  v59 = v3;
  ...
  v64 = v32;
  v33 = v31;
  v34 = sub_15F734(v31, HIDWORD(v31));
  v35 = sub_15ECDC(v34);
  v36 = *(_DWORD *)(sub_1780DC(v35) + 160);
  v37 = *(_DWORD *)(*(_DWORD *)(v36 + 24) + 20);
  v38 = sub_1DDB68(dword_4878EC, dword_4878F0, dword_4878F4);
  v39 = *(_DWORD *)(v33 + 12);
  if ( v39 == 33 )
  {
    v40 = v38;
    while ( 1 )
    {
      ...
      if ( v39 != 32 )
      {
        if ( v39 != 33 )
        {
          sub_94728("elfread.c", 968, "handle_inferior_event: Invalid gnu-indirect-function breakpoint type %d", v39);
          goto LABEL_42;
        }
        ((void (__fastcall *)(int))loc_DB0D8)(v33);
      }
      v39 = *(_DWORD *)(v41 + 12);
      v33 = v41;
    }
    ...
    v44 = *(_DWORD *)(v33 + 28);
    *v43 = 1;
    sub_26C1A0(v42, *(_DWORD *)(v44 + 72));
    v54 = sub_26BBA8(v37);
    v45 = sub_26BCE0();
    ((void (__fastcall *)(int, int, int, int, int, _DWORD))loc_168BCC)(v35, v42, v37, v40, v45, 0);
    v46 = sub_26EBD0(v54);
    v47 = ((int (__fastcall *)(int, int, int *))loc_169F00)(v35, v46, &dword_4899A0);
    v48 = ((int (__fastcall *)(int, int))loc_169FC8)(v35, v47);
    v49 = *(_DWORD *)(v33 + 72);
    v50 = v49 == 0;
    if ( v49 )
    ...
    if ( v50 )
    {
      v51 = ((int (__fastcall *)(_DWORD))loc_19D250)(*(_DWORD *)(v33 + 76));
      sub_6A628(v51, v48);
      *(_DWORD *)(v33 + 12) = 1;
      v52 = dword_487D2C;
      sub_21DED4(v55, v48);
      sub_D0F34(v33, v52, v55, 1, 0, 0);
      __asm { POP             {R4-R11,PC} }
    }
  }
  else
...
LABEL_45:
  ...
  return sub_324258(v53 + 4, HIDWORD(v53));
}
