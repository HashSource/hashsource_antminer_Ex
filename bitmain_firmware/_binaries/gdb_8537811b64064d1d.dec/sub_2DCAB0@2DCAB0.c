int __fastcall sub_2DCAB0(int a1, int a2, int a3, int a4, _DWORD *a5)
{
  unsigned int v7; // r4
  int v9; // r0
  int v11; // r2
  ...
  v7 = a4;
  v9 = sub_2A8800(a4, *(_DWORD *)(a3 + 24), a1);
  if ( v9 != *(_DWORD *)(a3 + 24) )
    return 0;
  v11 = *(_DWORD *)(a1 + 160);
  v12 = v9;
  v13 = *(_DWORD *)(v11 + 112);
  if ( v13 )
    v14 = sub_347440(*(_DWORD *)(v11 + 96), v13);
  else
    v14 = 0;
  v15 = *(_DWORD *)(a3 + 40);
...
LABEL_17:
    if ( v14 <= v20 )
    {
      sub_2A6A84("%B: bad reloc symbol index (%#Lx >= %#lx) for offset %#Lx in section `%A'", a1);
