  ...
  while ( 1 )
  {
    ...
    if ( !v1 )
    {
      ...
      if ( v6 )
      {
        ...
        {
          v18 = (_DWORD *)sub_33B2E4(ptr, &v29, 0);
          ptr[0] = v18;
          v25[0] = v29;
          goto LABEL_23;
        }
...
LABEL_40:
            sub_94708("Usage: demangle [-l language] [--] name");
          }
          while ( 2 )
          {
            v13 = sub_93638(v12);
            ...
            if ( strncmp((const char *)v12, "-l", v13 - v12) )
            {
              ...
              {
                sub_5B084((int *)&v29, (int *)&v23);
                sub_94708("Unrecognized option '%s' to demangle command.  Try \"help demangle\".", (const char *)v29);
              }
              v14 = (unsigned __int8 *)sub_93634(v13);
              v15 = *v14;
              v12 = v14;
LABEL_13:
              if ( v15 )
              {
                ...
                v22 = sub_194404(s2);
                if ( !v22 )
                  sub_94708("Unknown language \"%s\"", s2);
                v16 = (char **)sub_194460(v22);
LABEL_16:
                v17 = (char *)sub_1944D8(v16, v12, 3);
                if ( v17 )
                {
                  sub_259F38("%s\n", v17);
                  free(v17);
                ...
                sub_94708("Can't demangle \"%s\"", (const char *)v12);
              }
              goto LABEL_40;
            }
            sub_5B084((int *)&v29, (int *)&v23);
...
LABEL_29:
            ...
            *v19 = 0;
            if ( v29 != v31 )
              sub_339E8C(v29);
            v21 = (unsigned __int8 *)sub_93634(v23);
            v15 = *v21;
            v12 = v21;
            if ( v15 != 45 )
              goto LABEL_13;
