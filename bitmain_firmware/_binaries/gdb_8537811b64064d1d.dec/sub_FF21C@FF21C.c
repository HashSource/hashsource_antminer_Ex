_DWORD *__fastcall sub_FF21C(_DWORD *a1, char *s, int a3, int a4)
{
  size_t v8; // r8
  void *v9; // r0
  void *v10; // r1
  ...
  LOBYTE(v25[0]) = 0;
  v8 = strlen(s);
  v9 = sub_7F674(&sa, (int)s, 0);
  v13 = (int *)sa;
  if ( sa )
  {
    sub_FF86C(sa, *((_DWORD *)sa + 1), a3, a4);
    sub_7F58C(&sa, v13[1], 2 * v8);
    if ( !sa )
    {
      sub_94728(
        (int)"cp-support.c",
    ...
    v15 = strlen(sa);
    sub_33BC7C((int)&ptr, 0, v24, sa, v15);
    v16 = sub_33CAC8((int)&ptr, s);
    v14 = a1 + 2;
    v9 = sa;
    if ( !v16 )
    {
