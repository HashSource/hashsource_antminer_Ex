int __fastcall sub_122F6C(unsigned int *a1, int a2)
{
  unsigned int v2; // r8
  unsigned int v3; // r7
  int v4; // r3
  ...
  while ( 2 )
  {
    ...
    switch ( *(_BYTE *)(v5 + v2) )
    {
      case 3:
        ...
        HIDWORD(v47) += 4;
        v12 = sub_11E3E8(v47, v5 + v8, a2, v55);
        goto LABEL_11;
      case 6:
        if ( v3 > v8 )
          goto LABEL_28;
...
LABEL_25:
        if ( dword_47AC88 <= 0 )
          return 0;
        sub_F43DC(&off_46D334, "location description stack overflow");
        return 0;
      case 0x9B:
      case 0xE0:
...
LABEL_5:
        ...
        if ( !v6 )
        {
          if ( dword_47AC88 > 0 )
          {
            sub_F43DC(&off_46D334, "location description stack underflow");
            return 0;
          }
          return 0;
        }
...
LABEL_8:
      ...
      case 0xFC:
        ++v6;
        v12 = sub_122ED4((unsigned __int8 *)(a2 + 14), v54, (_BYTE *)(v5 + v8), v55);
LABEL_11:
        v2 = v8 + v55[0];
        v55[v6 + 1] = v12;
LABEL_12:
        ...
        goto LABEL_8;
      default:
        v48 = (const char *)sub_322B64(*(unsigned __int8 *)(v5 + v2));
        if ( v48 )
        {
          if ( dword_47AC88 > 0 )
            sub_F43DC(&off_46D334, "unsupported stack op: '%s'", v48);
        }
        else if ( dword_47AC88 > 0 )
        {
          sub_F43DC(&off_46D334, "unsupported stack op: '%02x'", v7);
        }
        return v55[v6 + 1];
    }
  }
