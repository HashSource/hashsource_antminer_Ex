int __fastcall sub_124A74(int result, int a2, int a3)
{
  int v5; // r2
  bool v6; // cc
  int v7; // r3
  ...
  if ( v12 != 3 )
  {
    if ( v12 == 251 )
    {
      ...
      if ( v9 == v14 - v13 + 1 )
      {
        *(_DWORD *)(a2 + 8) = sub_122ED4((unsigned __int8 *)(a3 + 14), (__int64 *)(a3 + 176), v13, &v19);
        goto LABEL_23;
      }
    }
LABEL_13:
    result = ((int (*)(void))loc_124790)();
  ...
  HIDWORD(v16) += 4;
  *(_DWORD *)(a2 + 8) = sub_11E3E8(v16, (int)(v10 + 1), a3, &v19);
LABEL_23:
  *(_BYTE *)(a2 + 32) = *(_BYTE *)(a2 + 32) & 7 | 0x10;
  result = sub_21C7F0(a2, v11);
  v17 = *(__int16 *)(a2 + 22);
  if ( v17 == -1 )
  {
    v18 = sub_94728((int)"dwarf2read.c", 21159, "Section index is uninitialized");
    return sub_124C10(v18, HIDWORD(v18));
  }
  else
  {
