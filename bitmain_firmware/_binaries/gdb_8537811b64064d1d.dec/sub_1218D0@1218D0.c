...
LABEL_44:
              if ( dword_47AC88 > 0 )
              {
                v45 = sub_988A8(v22, SHIDWORD(v22));
                sub_F43DC(&off_46D334, "Unknown format content type %s", v45);
              }
            }
            else
            {
...
LABEL_38:
                ...
                break;
              case 26:
                v46 = sub_121864((const char **)a1, (int)v12, a4, &v72);
                v12 += v72;
