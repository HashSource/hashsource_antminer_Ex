int __fastcall sub_2FFDD4(int a1, int a2, _DWORD *a3, void (__fastcall *a4)(int, _DWORD))
{
  _DWORD *v4; // r11
  int *v5; // r3
  int v6; // r10
      ...
      if ( v29[11] )
      {
        ...
        if ( v38 )
        {
          ...
          if ( v45 )
          {
            if ( v40 == -1 )
            {
              v46 = (int (*)(const void *, const void *))sub_2FF7C0;
            }
            else
            {
              v46 = (int (*)(const void *, const void *))sub_2FF7C0;
              if ( v37[10] < v40 )
                v46 = (int (*)(const void *, const void *))sub_2FF844;
            }
...
LABEL_57:
  ...
  while ( 1 )
  {
    ...
    {
      while ( sub_2FFB28((_DWORD *)v4[2], v10, 1u, v6) )
      {
        v10 += v7[30];
...
LABEL_20:
    ...
    if ( v17 )
      v16 = v78;
    v18 = sub_2FFB28((_DWORD *)v4[2], v10, v16, v6);
    if ( !v18 )
      break;
    v19 = v7[30];
    v10 += v18[3];
...
LABEL_46:
        ...
        {
          if ( !sub_2FFB28((_DWORD *)v4[2], v10, v78, v6) )
            goto LABEL_15;
          v19 = v7[30];
          v9 = 1;
        }
    ...
    if ( !*v10 )
    {
      ...
      v25 = v24;
      if ( !sub_2FFB28((_DWORD *)v4[2], (unsigned __int8 *)"", v78, v6) )
        break;
      if ( v11 <= (unsigned int)++v10 )
        goto LABEL_8;
      if ( !v25[1] )
