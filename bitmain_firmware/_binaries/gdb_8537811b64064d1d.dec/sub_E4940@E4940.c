_DWORD *__fastcall sub_E4940(int a1, _DWORD *a2, char *a3, int a4, int a5, unsigned int a6, int a7, int a8)
{
  int v12; // r8
  int v13; // r6
  char v14; // r1
  ...
  v75 = sub_1B7278(*(_DWORD *)dword_4788DC);
  if ( !a7 )
  {
    v15 = sub_C26E0(v13, v14);
...
LABEL_69:
    if ( a8 )
    {
      v15[4] = sub_10B284(v16);
      sub_10B4E0();
    }
    else
    {
      v15[4] = sub_10B0CC(v74, v16, *a2);
    }
    *v15 = a5;
    *(_QWORD *)(v15 + 1) = a6;
    goto LABEL_4;
  }
  v15 = sub_C277C(v13, v14);
  v16 = *(_DWORD *)(dword_4788DC + 28);
  if ( !a1 )
    goto LABEL_69;
LABEL_3:
  v17 = sub_10B2D8(v74, v16, *a2);
  v18 = *(_DWORD *)(a1 + 24);
  v15[4] = v17;
  *v15 = a5;
  v19 = *(_DWORD *)(v18 + 24);
    ...
    if ( v52 )
    {
      ...
      if ( !v28 )
      {
        ...
        *(_WORD *)(v55 + 4) = v54;
        ...
        {
          v60 = sub_93050(24 * v54);
        }
        v65 = v15[4];
        *(_DWORD *)(*(_DWORD *)(v18 + 24) + 24) = v60;
        v66 = sub_10B538(v65, v85);
        v78 = v12;
        v67 = v81;
        v82 = a2;
        v68 = 0;
...
LABEL_4:
  if ( a4 )
    ((void (__fastcall *)(int, _DWORD *, int))loc_1B6C48)(v12, v15, a4);
  v21 = (int *)*a2;
  if ( *a2 )
  {
    v22 = dword_478930;
  ...
  *a2 = 0;
  if ( v24 < v25 )
  {
    if ( a1 )
    {
      ...
      {
        if ( dword_46D448 )
          v26 = (const char *)sub_21B3EC(a1);
        else
          v26 = *(const char **)a1;
        sub_F43DC(&off_46D334, "block end address less than block start address in %s (patched it)", v26);
        v25 = *v15;
      }
    }
    else if ( dword_47AC88 > 0 )
    {
      v50 = (const char *)sub_25ACB4(v75, v24);
      v51 = (const char *)sub_25ACB4(v75, *v15);
      sub_F43DC(&off_46D334, "block end address %s less than block start address %s (patched it)", v50, v51);
      v25 = *v15;
    }
    v15[1] = v25;
  }
...
LABEL_58:
        ...
        {
          if ( dword_46D448 )
            v45 = (const char *)sub_21B3EC(a1);
          else
            v45 = *(const char **)a1;
          sub_F43DC(&off_46D334, "inner block not inside outer block in %s", v45);
          v31 = v27[1];
          v43 = *v15;
          v42 = *(_DWORD *)v31;
        }
LABEL_63:
    ...
    if ( v44 > 0 )
    {
      v83 = (const char *)sub_25ACB4(v75, v42);
      v80 = (const char *)sub_25ACB4(v75, *((_DWORD *)v27[1] + 1));
      v76 = (const char *)sub_25ACB4(v75, *v15);
      v49 = (const char *)sub_25ACB4(v75, v15[1]);
      sub_F43DC(&off_46D334, "inner block (%s-%s) not inside outer block (%s-%s)", v83, v80, v76, v49);
      v31 = v27[1];
      v43 = *v15;
      v42 = *(_DWORD *)v31;
    }
...
LABEL_34:
  if ( a7 )
  {
    sub_C2658((int)v15, dword_4788F8, v74);
    v33 = dword_478934;
    dword_4788F8 = 0;
    if ( dword_478934 )
      goto LABEL_36;
  ...
  {
    sub_C2658((int)v15, dword_4788EC, v74);
    v33 = dword_478934;
    dword_4788EC = 0;
    if ( dword_478934 )
      goto LABEL_36;
  }
  obstack_begin(&stru_478938, v33, v33, (void *(*)(int))sub_93050, sub_E47E4);
LABEL_36:
