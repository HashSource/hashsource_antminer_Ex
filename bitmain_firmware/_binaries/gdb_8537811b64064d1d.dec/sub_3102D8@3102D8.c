int __fastcall sub_3102D8(unsigned __int8 *a1, char *a2, int a3)
{
  size_t v6; // r0
  unsigned int v7; // r5
  int v8; // r3
  ...
  if ( v8 != 95 )
  {
    ...
    if ( v9 && a1[1] == 112 && strchr(&byte_471494, a1[2]) )
    {
      ...
      if ( v7 <= 9 || (v22 = memcmp(a1 + 3, "assign_", 7u)) != 0 )
      {
        ...
        v10 = 1;
        strcpy(a2, "operator");
        strcpy(a2 + 8, off_432978[3 * v32 + 1]);
      }
      else
      {
        v23 = v7 - 10;
        ...
        v10 = 1;
        strcpy(a2, "operator");
        *(_WORD *)stpcpy(a2 + 8, off_432978[3 * v22 + 1]) = 61;
      }
      goto LABEL_8;
    }
LABEL_5:
...
LABEL_27:
    v39 = v19;
    if ( sub_30E850(v43, &v39, (unsigned int)&src) )
    {
      v10 = 1;
      v20 = src;
      strcat(a2, "operator ");
  ...
  if ( (word_4388C0[v12] & 8) == 0 || (word_4388C0[a1[3]] & 8) == 0 )
    goto LABEL_5;
  v13 = a1[4];
  if ( a1[4] )
  {
...
LABEL_20:
  v10 = 1;
  strcpy(a2, "operator");
  strcpy(a2 + 8, off_432978[3 * v13 + 1]);
LABEL_8:
  sub_30CCBC(v43);
  return v10;
}
