int __fastcall sub_2CE710(_DWORD *a1, unsigned int a2)
{
  unsigned int *v2; // r9
  unsigned int v3; // r2
  int v4; // r12
  ...
  if ( (unsigned int)++dword_48FD18 > 3 )
  {
    ...
    v33 = sub_2AD0C4((int)a1, 4 * v3);
    dword_48FD1C = (int)a1;
    dword_48FD20 = (int)v33;
LABEL_54:
    if ( v33[a2] )
    {
      sub_2A6A84("%B: warning: loop in section dependencies detected", a1);
      return 0;
    }
    v2 = (unsigned int *)a1[40];
    v33[a2] = 1;
  ...
  if ( *v8 )
  {
    v30 = sub_2CD884((int)a1, v2[15], *v8);
    v9 = (char *)v30;
    if ( !v30 )
      goto LABEL_19;
  }
  ...
  if ( v10 > 0xA )
  {
    if ( v10 == 18 )
    {
      ...
      {
LABEL_128:
        v109 = (unsigned int *)sub_2ACC1C((int)a1, 64);
        if ( v109 )
        {
          v110 = *v8;
          v111 = v8[1];
...
LABEL_120:
      ...
      if ( !(*(int (__fastcall **)(_DWORD *, unsigned int *, char *, unsigned int))(v11 + 76))(a1, v8, v9, a2) )
      {
        ...
        if ( v108 < 0 )
        {
          ...
          {
LABEL_127:
            sub_2A6A84("%B: unknown type [%#x] section `%s'", a1);
            v4 = 0;
            goto LABEL_20;
          }
        }
...
LABEL_70:
    ...
    if ( v8[8] * v70 <= v71 )
    {
      if ( v69 )
      {
        sub_2A6A84("%B: warning: multiple dynamic symbol tables detected - ignoring the table in section %u", a1, a2);
        v4 = 1;
      }
      else
      {
...
LABEL_96:
    ...
    if ( v99 <= v98 )
    {
      sub_2A6A84("%B: invalid link %u for reloc section %s (index %u)", a1);
      v4 = sub_2CF250(a1, v8, v9, a2);
      goto LABEL_20;
    }
    v100 = v97[16];
          ...
          if ( sub_2CE710(a1, v159) )
          {
            ...
            if ( v164 < *(_DWORD *)(v163 + 532) )
            {
              ...
              if ( v165 )
              {
                ...
                if ( !v169 )
                {
                  v170 = (unsigned int *)sub_2ACC1C((int)a1, 56);
                  if ( v170 )
                  {
                    v171 = v8[1];
                    v172 = v8[2];
...
LABEL_185:
  ...
  switch ( v10 )
  {
    ...
    case 2u:
      ...
      if ( v73 )
      {
        sub_2A6A84("%B: warning: multiple symbol tables detected - ignoring the table in section %u", a1, a2);
        v4 = 1;
        goto LABEL_20;
      }
      v75 = *v8;
      ...
      *(_DWORD *)(v80 + 4 * a2) = v72 + 18;
      ...
      if ( (v72[20] & 2) != 0 && ((v90 >> 5) & 0x40) != 0 && !sub_2CF250(a1, v72 + 18, v9, a2) )
        goto LABEL_19;
      v91 = (_DWORD *)a1[40];
      v92 = v91[130];
      if ( v92 )
