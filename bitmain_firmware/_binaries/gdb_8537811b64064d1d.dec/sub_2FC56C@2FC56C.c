int __fastcall sub_2FC56C(int result, int a2)
{
  _DWORD *v2; // r4
  int v3; // r3
  __int64 v4; // r2
    ...
    case 0:
      ...
      if ( (_DWORD)v4 )
      {
        if ( (v4 & 0x80000000000LL) == 0 )
          return sub_2A6BE4("linker.c", 2209);
      }
      else
      {
        HIDWORD(v4) |= 0x800u;
      ...
      *(_DWORD *)(result + 8) = *(_DWORD *)(a2 + 24);
      ...
      if ( (*(_DWORD *)(v3 + 20) & 0x1000) == 0 )
      {
        if ( (char **)v3 != &off_4708A8 )
          result = sub_2A6BE4("linker.c", 2242);
LABEL_6:
        v2[4] = &off_470800;
      }
      return result;
    ...
    case 7:
      return result;
    default:
      sub_2A6C18((int)"linker.c", 2202, (int)"set_symbol_from_hash");
  }
}
