int __fastcall sub_330FC8(int a1, int a2, int a3, int *a4)
{
  int *v4; // lr
  int v9; // r0
  int v10; // r1
  ...
  {
    sub_32AC34(a1, a2, a3, a4, &v35);
  }
  else
  {
    v18 = sub_328ED4(a2, a3, 0);
    if ( v18 == 0x80000000 )
    {
      v16 = v35 | 0x10;
      v35 |= 0x10u;
    ...
    if ( v18 )
    {
      ...
      v36[0] = 1;
      v38 = 1;
      sub_32C3D8(a1, a2, v21, v34, &v35);
      if ( sub_330EEC((int *)a1, (int)a4) )
        return a1;
    }
    else
    {
