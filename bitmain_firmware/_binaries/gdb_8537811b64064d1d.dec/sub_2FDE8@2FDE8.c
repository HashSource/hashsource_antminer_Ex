int __fastcall sub_2FDE8(int a1, int a2, int *a3, _DWORD *a4)
{
  int v7; // r7
  int v8; // r1
  int *v9; // r3
...
LABEL_12:
  ...
  v12 = dest;
  v28 = dest;
  if ( sub_2ADF04(a2, v8, dest, 0, 0, 0, n) )
  {
    v13 = &dest[n];
    v14 = v7 == 32 ? 8 : 16;
    if ( dest < v13 )
    {
      do
      {
        ...
        if ( v15 == a1 )
        {
          ...
          {
            v18 = sub_16F67C();
            v19 = *(_DWORD *)(sub_1780DC(v18) + 152);
            v20 = v12 - v28 + v27;
            v21 = sub_230048(v7 / 8 + v20, v31, v7 / 8);
            v22 = v26;
            if ( !v21 )
              v22 = sub_15AED0(v31, v19);
            v23 = v29;
            v24 = v29 == 0;
            *v30 = v22;
            if ( !v24 )
