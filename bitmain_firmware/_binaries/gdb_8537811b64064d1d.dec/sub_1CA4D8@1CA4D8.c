int __fastcall sub_1CA4D8(int a1, int a2, _DWORD *a3, int a4)
{
  int v7; // r8
  int v8; // r0
  int v9; // r9
...
LABEL_8:
    v15 = sub_98E44(v7);
    sub_94708("No probe at PC %s", v15);
  }
  v9 = v8;
  sub_1CA420(v16, v7);
  v10 = v16[0];
  ...
  if ( a4 == -1 )
  {
    *a3 = 0;
    sub_1780DC();
    a3[1] = *(_DWORD *)(v14 + 12);
    return sub_C0B84((char *)a2, v12);
  }
  else
  {
    if ( a4 >= v11 )
      sub_94708("Invalid probe argument %d -- probe has %d arguments available", a4, v11);
