void __fastcall sub_1CB1D8(int a1)
{
  _DWORD *v1; // r0
  char *v2; // r6
  char *v3; // r4
  ...
  v16[0] = v17;
  v18[0] = v19;
  sub_1CA1E8(a1, v14, v16, v18);
  v1 = sub_1CAE78(&ptr, (int)v18, (int)v14, (int)v16, &off_3CD484);
  v2 = v13;
  if ( ptr == v13 )
  {
    v11 = (_DWORD *)sub_243004(v1);
    sub_2573B4(*v11, "No probes matched.\n");
  }
  else
  {
    v3 = (char *)ptr + 8;
    do
    {
      ...
      if ( (char *)v9 != (char *)nullsub_10 )
        v8 = v9();
      v10 = (_DWORD *)sub_243004(v8);
      sub_2573B4(
        *v10,
        "Probe %s:%s disabled.\n",
        *(const char **)(*((_DWORD *)v3 - 2) + 28),
