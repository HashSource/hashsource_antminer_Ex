int __fastcall sub_282D54(int a1, int a2)
{
  int v2; // r4
  unsigned int v3; // r3
  int v5; // r9
...
LABEL_17:
        ...
        while ( 1 )
        {
          while ( 1 )
          {
            ...
            if ( mb_cur_max == 1 || dword_48BB60 || (mb_cur_max = sub_29B638(dword_48AAD4, v2, 0), mb_cur_max == v2) )
            {
              if ( --v2 < 0 )
                goto LABEL_39;
            }
...
LABEL_56:
      ...
      while ( 1 )
      {
        mb_cur_max = sub_29B4F8(dword_48AAD4);
        v2 = mb_cur_max;
LABEL_57:
        if ( dword_4900DC <= v2 )
        {
LABEL_39:
          sub_2945F0(mb_cur_max, v12);
          return -1;
        }
