_DWORD *__fastcall sub_16724(int a1, int a2)
{
  char *v4; // r0
  char *v5; // r4
  _DWORD *v6; // r6
  ...
  qsort(v4, (v9 - v4) >> 2, 4u, (__compar_fn_t)sub_2DB890);
  if ( v9 <= v5 )
  {
    v12 = 0;
  }
  ...
  v14 = 12 * v12 + 12;
  v15 = sub_2AB390(v14 + 8 * ((v9 - v5) >> 2), v10);
  v6 = (_DWORD *)v15;
  if ( v15 )
  {
    v16 = v15 + v14;
