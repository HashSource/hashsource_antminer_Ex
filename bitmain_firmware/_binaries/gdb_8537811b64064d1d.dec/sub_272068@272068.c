_DWORD *__fastcall sub_272068(_DWORD *a1, int *a2, int *a3)
{
  int v3; // r3
  int v7; // r2
  unsigned int v8; // r3
  ...
  *(_BYTE *)v3 = 1;
  ...
  {
    v18 = a1 + 23;
    ((void (__fastcall *)(_DWORD *, _DWORD, _DWORD, _DWORD, _DWORD))loc_271B10)(a1, 0, 0, 0, 0);
    sub_26FD38(v18, a2, a3);
    return v18;
  }
  else
  {
    ...
    if ( v19 > 0 )
    {
      ...
      while ( 1 )
      {
        if ( !*(_DWORD *)(v12 + 4 * v14) )
        {
          ...
          v16 = sub_270E58((int)a1, v14, (int)ptr);
          if ( ptr[0] != v23 )
            sub_339E8C(ptr[0]);
