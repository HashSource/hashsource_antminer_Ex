void __fastcall sub_279CC4(int *a1, int a2, int a3, char *a4)
{
  int v4; // r6
  void *v7; // r6
  int v8; // r7
...
LABEL_41:
  ...
  if ( v38 )
  {
    ...
    if ( v10 )
    {
      ...
      {
LABEL_15:
        sub_279798(a1, (int)v40, v41, 0, v11);
LABEL_16:
        sub_92E68((int)v7);
        return;
      }
    ...
    else
    {
      ...
      if ( v42 )
      {
        ...
        if ( v14 != v15 )
        {
          ...
          {
            v32 = (int *)sub_242FF0();
            sub_2594D8(*v32, "gcc_convert_symbol \"%s\": global symbol\n", a4);
          }
          sub_279798(a1, (int)v42, v43, 1, 0);
          v16 = dword_48AA50;
        }
      }
      else
    ...
    v17 = (int *)sub_242FF0();
    sub_2594D8(*v17, "gcc_convert_symbol \"%s\": local symbol\n", a4);
    goto LABEL_15;
  }
  if ( v12 == 1 )
  {
    sub_1B1444((int *)&v42, a4, (const char *)v38, 0);
    v18 = v42;
    if ( v42 )
    {
      v19 = *((__int16 *)v42 + 11);
      if ( v19 != -1 )
      {
        ...
        switch ( (_BYTE)v42[8] & 0xF )
        {
          ...
          case 9:
          case 0xA:
            v21 = *(_DWORD *)(sub_1780EC(v43) + 80);
            v22 = 1;
            break;
          default:
            v21 = *(_DWORD *)(sub_1780EC(v43) + 84);
            v22 = 1;
            break;
        }
        v37 = sub_27A848(a1, v21);
        v23 = (int)v18;
        v24 = *a1;
      ...
      v34 = sub_94728((int)"compile/compile-c-symbols.c", 366, "Section index is uninitialized");
      goto LABEL_41;
    }
  }
  sub_92E68((int)v7);
LABEL_19:
  ...
  {
    v13 = (int *)sub_242FF0();
    sub_2594D8(*v13, "gcc_convert_symbol \"%s\": lookup_symbol failed\n", a4);
  }
}
