int __fastcall sub_301D0C(int a1, int a2, int a3, int a4, _DWORD *a5, unsigned int *a6)
{
  unsigned int v6; // lr
  unsigned int v7; // r8
  int *v8; // r7
  ...
  {
    v25 = sub_2AB080(a1, a2);
    *v8 = (int)v25;
    if ( !v25 )
      goto LABEL_12;
    sub_2AB118(v25, "", 1, 1);
    if ( !sub_2AAA34((int)(v8 + 1), (int)sub_301CBC, 16) )
      goto LABEL_12;
    v26 = sub_2ADB70(v9, ".stabstr", (const char *)&loc_102108);
    v8[8] = v26;
    if ( !v26 )
      goto LABEL_12;
    v6 = *(_DWORD *)(a3 + 36);
  ...
  v10 = v6 / 0xC;
  v81 = v6 / 0xC;
  v11 = (_DWORD *)sub_2ACC1C(v9, 4 * (v6 / 0xC) + 8);
  v12 = v11;
  *a5 = v11;
  if ( v11 )
  {
    ...
    *(_DWORD *)(a3 + 40) = v13;
    ...
    if ( sub_2AE004(v9, a3, (int *)&ptr) )
    {
      if ( sub_2AE004(v9, a4, (int *)&v92) )
      {
        if ( a6 )
          v7 = *a6;
        ...
        if ( ptr < v76 )
        {
          ...
          while ( 1 )
          {
            ...
            {
              sub_2A6A84("%B(%A+%#lx): Stabs entry has invalid string index.", v78, a3, v28 - (_BYTE *)ptr);
              ((void (__fastcall *)(int))loc_2A6C70)(17);
              goto LABEL_12;
            }
            v34 = v28 + 12;
            v83 = (char *)v92 + v33 + v79;
            *(v27 - 1) = sub_2AB118((_DWORD *)*v82, v83, 1, 1);
            v85 = v28 + 12;
            if ( v29 != 130 )
              goto LABEL_48;
            if ( v76 <= v34 )
...
LABEL_100:
              ...
              *v67 = v68;
              *v88 = v67;
              v70 = sub_2AAEF0((int)(v82 + 1), 16);
              v71 = (_DWORD *)v70;
              if ( !v70 )
                goto LABEL_12;
              *(_DWORD *)(v70 + 4) = v41;
              *(_DWORD *)(v70 + 8) = v40;
              v72 = sub_2AB4DC(s2, v40);
              v73 = *((_DWORD *)v56 + 3);
              v71[3] = v72;
              *v71 = v73;
              *((_DWORD *)v56 + 3) = v71;
...
LABEL_17:
        ...
        *(_DWORD *)(v18 + 36) = sub_2AB208(v15);
        if ( v87 )
        {
          v19 = sub_2ACC1C(v9, v84);
          v12[1] = v19;
          if ( !v19 )
            goto LABEL_12;
          if ( !v81 )
