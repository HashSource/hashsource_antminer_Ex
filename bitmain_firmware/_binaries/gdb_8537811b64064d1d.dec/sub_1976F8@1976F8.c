_DWORD *__fastcall sub_1976F8(_DWORD *a1, _DWORD *a2)
{
  ...
  do
  {
    while ( 2 )
    {
      while ( 2 )
      {
        ...
        {
LABEL_28:
          v14 = (char *)sub_93634(v12);
          v12 = (unsigned __int8 *)v14;
          if ( v14 && sub_195C04(v14) )
          {
LABEL_75:
            v28 = a2[1];
            a1[1] = v3;
...
LABEL_66:
      ...
      if ( v5 != 40 )
      {
        ...
        {
          v21 = v12 - v3;
          if ( *(_DWORD *)(a2[6] + 8) != 4 || v21 <= 8 || !sub_338BFC(v3, "operator") )
            goto LABEL_54;
          if ( !sub_FC59C() )
          {
            v21 = a2[1] - (_DWORD)v3;
