int __fastcall sub_3BF4C(fd_set *a1, char *s1)
{
  const char *v2; // r6
  int v4; // r9
  char *v5; // r0
  ...
  v6 = v5;
  if ( !v5 )
    sub_94708("net_open: No colon in host name!");
  v7 = v5 - v2;
  if ( v5 - v2 >= 99 )
    v7 = 99;
  v26 = v7;
...
LABEL_29:
  ...
  v25 = (_DWORD *)sub_242FDC(0);
  sub_2594D8(*v25, "%s: unknown host\n", dest);
  *_errno_location() = 2;
  return -1;
}
