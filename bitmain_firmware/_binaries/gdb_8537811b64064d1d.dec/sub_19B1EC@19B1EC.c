void __fastcall sub_19B1EC(_DWORD *a1, const char *a2, int *a3)
{
  void *v6; // r8
  void *v7; // r7
  int v8; // r2
  ...
  sub_195528(v30, 0, (int)off_46D5A4[0], 0, 0, 0, 0);
  v6 = sub_92564((int)sub_19546C, (int)v30);
  v30[0] = a2;
  v34[0] = (int)a3;
  v30[1] = a2;
  v39 = a1;
  v31[10] = 1;
  v7 = sub_92E50();
  sub_19A708((int)&v29, (int)v30, a2, a3);
  if ( v29 )
    sub_339E8C(v29);
  sub_92E68((int)v7);
  v8 = v37;
  if ( v37 )
  {
    if ( v38 )
    {
      ...
      if ( !*(_BYTE *)(v38 + 1) )
      {
        ...
        sub_F6CB8(a1, &ptr, v9, (char *)v9, (char *)v9);
        if ( ptr )
          free(ptr);
        v8 = v37;
      }
  ...
  {
    v35 = 0;
    sub_198014(v31, v34[4], v33, (int)a3, (void **)&v27, &ptr);
    v34[5] = v27;
    v34[6] = (int)ptr;
    sub_196A38(a1, (int)v30, (int)s);
    v11 = s;
  }
  else
  {
...
LABEL_9:
  sub_F59CC((int)a1, v11 - a2);
  sub_198F10(v34, (int)a1, s, v35, v32);
  if ( !v37 && (unsigned int)v35 <= 2 && a1[17] == a1[18] )
  {
    ...
    {
      sub_F59CC((int)a1, v12);
      sub_54BA8((int)a1, (const char **)&off_3C1CA4, v13, (int)v13);
    }
  }
  sub_92648(v6);
}
