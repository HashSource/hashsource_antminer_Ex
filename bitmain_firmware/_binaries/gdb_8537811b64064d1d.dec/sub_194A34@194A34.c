void sub_194A34()
{
  ...
  dword_487A0C = (int)sub_16EBE8((int)sub_193BA0);
  sub_53420(
    "check",
    -1,
    (int)sub_193C18,
    ...
    0,
    (int **)&dword_47475C);
  sub_5474C((int)&word_3FD7F0, (unsigned __int8 *)"check", -1, 1, &dword_47475C);
  sub_5474C((int)"ch", (unsigned __int8 *)"check", -1, 1, &dword_47475C);
  sub_53420(
    "check",
    -1,
    (int)sub_193C00,
    ...
    (int **)&dword_47474C);
  v0 = off_46D5A4;
  sub_5474C((int)&word_3FD7F0, (unsigned __int8 *)"check", -1, 1, &dword_47474C);
  sub_5474C((int)"ch", (unsigned __int8 *)"check", -1, 1, &dword_47474C);
  v1 = off_46D5A4;
  sub_53514(
    "range",
    4,
  ...
  *(_DWORD *)v5 = 0;
  if ( v3 != v5 )
  {
    sub_195104(v2 + 3, v5, 2 * (31 - __clz((v5 - v3) >> 2)), sub_193A50);
    if ( v5 - v3 <= 64 )
    {
      sub_194EFC(v3, v5, sub_193A50);
    }
    else
    {
      sub_194EFC(v3, v4 + 19, sub_193A50);
      v8 = v4 + 19;
      if ( v5 != (char *)(v4 + 19) )
      {
        v9 = (char *)(v4 + 20);
  ...
  do
  {
    ...
    if ( (unsigned int)v22[2] > 1 )
    {
      ...
      sub_2567B4(&v27, "%-16s Use the %c%s language\n", v23, v25, v24);
    }
  }
  while ( v0 != v16 );
  sub_53514(
    ...
    (int **)&dword_47474C);
  sub_2564A0(&v27);
  dword_487A00 = sub_32727C("auto");
  sub_32727C("auto");
  dword_4879FC = sub_32727C("auto");
  dword_4879F8 = sub_32727C("auto");
