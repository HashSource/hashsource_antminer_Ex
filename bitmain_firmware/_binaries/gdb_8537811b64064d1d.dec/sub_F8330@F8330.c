int __fastcall sub_F8330(int result, char *a2, int a3, int (__fastcall *a4)(_DWORD, int))
{
  char *v4; // r9
  int v5; // r1
...
LABEL_22:
    ...
    {
      v23 = *v22--;
      sub_F81F4((int)v7, v21, v20, v23, v6);
    }
    while ( v21-- != 0 );
    do
    {
      ...
      *(_DWORD *)v27 = *(_DWORD *)v7;
      result = sub_F81F4((int)v7, 0, (v27 - v7) >> 2, v25, v6);
    }
    while ( v27 - v7 > 4 );
    return result;
  }
