int __fastcall sub_221220(int result, char *a2, int a3)
{
  int v3; // r3
  char *v4; // r6
  char *v5; // r10
  ...
  if ( (int)&a2[-result] > 256 )
  {
    ...
    while ( 1 )
    {
      ...
      --v41;
      v9 = &v4[16 * (v8 >> 1)];
      v10 = sub_21F004(v42, v9);
      v11 = v5 - 16;
      if ( v10 < 0 )
        break;
      if ( sub_21F004(v42, v11) < 0 )
      {
        v44 = *(_DWORD *)v4;
        v48 = *((_DWORD *)v4 + 1);
        v52 = *((_DWORD *)v4 + 2);
...
LABEL_24:
      ...
      v12 = sub_21F004(&v4[16 * (v8 >> 1)], (_DWORD *)v5 - 4);
      v44 = *(_DWORD *)v4;
      v48 = *((_DWORD *)v4 + 1);
      v52 = *((_DWORD *)v4 + 2);
      v56 = *((_DWORD *)v4 + 3);
...
LABEL_8:
      ...
      while ( 1 )
      {
        v6 = (char *)(v16 - 16);
        v18 = (char *)(v16 - 16);
        if ( sub_21F004((_DWORD *)(v16 - 16), v4) < 0 )
          goto LABEL_14;
        v19 = v17 - 16;
        do
        {
          v20 = sub_21F004(v4, v19);
          v17 = v19;
          v19 -= 16;
        }
        while ( v20 < 0 );
...
LABEL_14:
      ...
      result = sub_221220(v16 - 16, v5, v41);
      v3 = v6 - v4;
      if ( v6 - v4 <= 256 )
        return result;
      v5 = (char *)(v16 - 16);
...
LABEL_17:
        ...
        do
        {
          ...
          *((_DWORD *)v18 + 3) = v29;
          LOBYTE(v40) = 0;
          result = sub_2229DC(v4, 0, (v18 - v4) >> 4, v46, v50, v54, v58, v40);
        }
        while ( v18 - v4 > 16 );
        return result;
      }
    }
    if ( sub_21F004(&v4[16 * (v8 >> 1)], v11) < 0 )
    {
      v47 = *(_DWORD *)v4;
      v51 = *((_DWORD *)v4 + 1);
      v55 = *((_DWORD *)v4 + 2);
    ...
    v30 = sub_21F004(v42, (_DWORD *)v5 - 4);
    v44 = *(_DWORD *)v4;
    v48 = *((_DWORD *)v4 + 1);
    v52 = *((_DWORD *)v4 + 2);
    v56 = *((_DWORD *)v4 + 3);
