int __fastcall sub_2E0688(int a1, int a2)
{
  _DWORD *v3; // r8
  int v5; // r4
  const char *v6; // r7
  ...
  if ( (*(_BYTE *)(v5 + 465) & 4) != 0 )
    v7 |= 8u;
  v8 = sub_2ADB70(a1, ".plt", (const char *)v7);
  if ( !v8 )
    return 0;
  *(_DWORD *)(v8 + 64) = (*(_DWORD *)(v5 + 464) >> 13) & 0xF;
  ...
  if ( (v9 & 8) != 0 )
  {
    v13 = sub_2E01D0(a1, a2, v8, (int)"_PROCEDURE_LINKAGE_TABLE_");
  ...
  if ( (*(_BYTE *)(v5 + 464) & 0x20) == 0 )
    v10 = ".rel.plt";
  v11 = sub_2ADB70(a1, v10, (const char *)((unsigned int)v6 | 8));
  if ( !v11 )
    return 0;
  *(_DWORD *)(v11 + 64) = *(unsigned __int8 *)(*(_DWORD *)(v5 + 392) + 11);
  ...
  if ( (*(_BYTE *)(v5 + 466) & 0x10) == 0 )
    return 1;
  v14 = sub_2ADB70(a1, ".dynbss", (const char *)&loc_100000 + 1);
  if ( !v14 )
    return 0;
  v15 = *(_BYTE *)(v5 + 466);
  v3[59] = v14;
  if ( (v15 & 0x20) != 0 )
  {
    v21 = sub_2ADB70(a1, ".data.rel.ro", v6);
    if ( !v21 )
      return 0;
    v3[61] = v21;
  }
  ...
  if ( (*(_BYTE *)(v5 + 464) & 0x20) == 0 )
    v16 = ".rel.bss";
  v17 = sub_2ADB70(a1, v16, (const char *)((unsigned int)v6 | 8));
  if ( !v17 )
    return 0;
  *(_DWORD *)(v17 + 64) = *(unsigned __int8 *)(*(_DWORD *)(v5 + 392) + 11);
  ...
  if ( (*(_BYTE *)(v5 + 464) & 0x20) == 0 )
    v19 = ".rel.data.rel.ro";
  v20 = sub_2ADB70(a1, v19, (const char *)((unsigned int)v6 | 8));
  if ( !v20 )
    return 0;
