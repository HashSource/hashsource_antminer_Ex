int __fastcall sub_3B67C(int a1)
{
  int v2; // r0
  tcflag_t v3; // r3
  int v4; // r0
  ...
  if ( v2 < 0 )
  {
    v9 = *(_DWORD *)sub_242FDC(v2);
    v10 = _errno_location();
    v11 = (const char *)sub_6FFC0(*v10);
    sub_2594D8(v9, "get_tty_state failed: %s\n", v11);
  }
  termios_p.c_iflag = 0;
  termios_p.c_oflag = 0;
  termios_p.c_lflag = 0;
  ...
  *(_WORD *)&termios_p.c_cc[5] = 0;
  ...
  if ( result < 0 )
  {
    ...
    v7 = _errno_location();
    v8 = (const char *)sub_6FFC0(*v7);
    return sub_2594D8(v6, "set_tty_state failed: %s\n", v8);
  }
  return result;
}
