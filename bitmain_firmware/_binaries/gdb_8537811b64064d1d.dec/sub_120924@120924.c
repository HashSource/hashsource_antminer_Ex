char *__fastcall sub_120924(char *result, int a2, int a3, char a4, _DWORD *a5, int *a6, void **a7)
{
  char *v8; // r5
  unsigned int v11; // r6
  unsigned int v12; // r7
  ...
  v38 = *(_DWORD *)sub_242FF0(result);
  v39 = (const char *)((int (__fastcall *)(int))loc_11E120)(a2);
  if ( *(_BYTE *)(a2 + 17) )
  {
    v40 = *(_DWORD *)a2;
    if ( *(_BYTE *)(*(_DWORD *)a2 + 17) )
    {
      ((void (__fastcall *)(const char *))loc_11E0B8)(v39);
      JUMPOUT(0x120C04);
    }
  }
  else
  ...
  result = (char *)sub_2594D8(v38, "Reading %s for %s\n", v39, **(const char ***)(*(_DWORD *)v40 + 148));
  if ( !*(_BYTE *)(a2 + 16) )
LABEL_31:
    result = (char *)((int (__fastcall *)(char *, int))loc_11FFF8)(v8, a2);
LABEL_3:
  v11 = *(_DWORD *)(a2 + 4);
  if ( v11 < v11 + *(_DWORD *)(a2 + 8) )
  {
    ...
    do
    {
      sub_1207F4((int)v43, a2, a3, v12, 0);
      v28 = v12 - v11;
      if ( v44 == 2 )
      {
        v29 = *((_DWORD *)v8 + 16);
      ...
      *((_BYTE *)v16 + 10) = v23 & 0xF7 | (8 * (v41 & 1));
      ...
      {
        *a5 = 2 * v26;
        result = (char *)sub_93078(result, 8 * v26);
        v26 = *a6;
        *a7 = result;
      }
      v11 = *(_DWORD *)(a2 + 4);
