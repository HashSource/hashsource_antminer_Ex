_DWORD *__fastcall sub_E71CC(unsigned int a1, int a2, int a3)
{
  int v5; // r8
  _DWORD *v6; // r5
  char *v7; // r3
  ...
  if ( dword_478974 > 0 )
  {
    ...
    {
      if ( dword_47AC88 > 0 )
        sub_F43DC(&off_46D334, "Context stack not empty in end_symtab");
      dword_478974 = 0;
    }
  }
  if ( (*(_DWORD *)(v5 + 12) & 1) != 0 )
...
LABEL_16:
        while ( 1 )
        {
          v12 = (unsigned int **)sub_9846C(4 * v11);
          if ( v12 )
            break;
          v11 >>= 1;
          if ( !v11 )
...
LABEL_32:
  ...
  sub_20BC48(v5);
  ((void (__fastcall *)(int))loc_20C1EC)(v5);
  if ( a3 || dword_478934 || dword_4788F0 || dword_4788F4 || dword_478970 || dword_4788FC || dword_4788F8 )
    return sub_E4940(0, &dword_4788F0, 0, 0, dword_478964, a1, 0, a2);
  else
    return 0;
}
