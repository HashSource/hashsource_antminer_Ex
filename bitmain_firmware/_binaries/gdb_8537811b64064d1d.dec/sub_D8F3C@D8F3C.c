int __fastcall sub_D8F3C(int a1, int a2, int a3, int a4)
{
  ...
  v10 = sub_214860(a3);
  LOBYTE(v14) = 1;
  ((void (__fastcall *)(int, int, _DWORD, _DWORD, _DWORD, int, int, int, int, int, int, int, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, int))loc_D8E30)(
    a1,
    a2,
    v9[0],
    v9[1],
