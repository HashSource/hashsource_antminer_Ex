int __fastcall sub_AA634(int a1, unsigned int a2, int a3, unsigned int a4)
{
  ...
  if ( !v9 )
  {
    ...
    else if ( a3 )
    {
      ...
      if ( v11 != -1 )
      {
        v39 = *(__int16 *)(*(_DWORD *)(v5 + 24) + 4);
LABEL_11:
        HIDWORD(v4) = sub_26DD58(v5, v4, a3);
        v5 = sub_26BC98(HIDWORD(v4));
LABEL_12:
        v12 = sub_16FF80(v5);
        v13 = *(_DWORD *)(v12 + 24);
        v6 = v12;
        ...
        *(_DWORD *)(v6 + 20) = v30;
        ...
        if ( a3 )
          ...
          v34 = 0;
        LODWORD(v35) = sub_A9B34(*(_DWORD *)(v32 + v27 + 12), v4, v34, SHIDWORD(v4));
        if ( (_DWORD)v35 )
        {
          HIDWORD(v35) = "S";
  ...
  return sub_A9F68(v9, v4, a3, SHIDWORD(v4), 1);
}
