char *__fastcall sub_C1658(const void *a1, size_t a2, struct obstack *a3, struct obstack *a4)
{
  ...
  if ( a4 )
    a3->chunk_size = 0;
  if ( !v5[1].next_free )
    obstack_begin(v5, 0, 0, (void *(*)(int))sub_93050, sub_C15D0);
  ...
  if ( object_base >= 5 * chunk_size )
  {
    ...
    v35 = (struct _obstack_chunk *)sub_93050(4 * v32);
    memset(v35, 0, 4 * v32);
    v36 = v5[1].chunk_size;
    chunk = v5[1].chunk;
  ...
  v12 = v10(a1, a2);
  v13 = HIWORD(v12);
  v14 = (unsigned __int64)sub_34769C(v12, v5[1].chunk_size) >> 32;
