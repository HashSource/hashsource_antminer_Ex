int __fastcall sub_104E60(int a1, int a2, int a3)
{
  int result; // r0
  const void *v7; // r7
  size_t v8; // r5
  ...
  result = sub_21B7B8(a1);
  if ( result )
  {
    v7 = (const void *)sub_21B7B8(a1);
    v8 = ((int (*)(void))loc_100338)();
    v9 = *(void **)(a3 + 12);
    ...
    *(_DWORD *)(a3 + 8) = v15;
    return sub_C2608(a2, v12, (struct obstack *)a3);
  }
  return result;
}
