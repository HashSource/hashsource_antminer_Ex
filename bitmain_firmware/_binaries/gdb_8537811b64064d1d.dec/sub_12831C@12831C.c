char *__fastcall sub_12831C(int a1, char *s, int a3)
{
  int v3; // r6
  int v6; // r11
  unsigned int i; // r4
...
LABEL_12:
      ...
      v31 = *(_QWORD *)(v11 + 8);
      v36[0] = 1;
      sub_127384((const char ***)a1, (int)v36, v12, 1, v31, s);
      if ( (v36[1] & 0x7FFF) == 0x10 )
      {
        if ( dword_47AC88 <= 0 )
          goto LABEL_38;
        sub_F43DC(&off_46D334, "ignoring absolute DW_AT_sibling");
        v12 = *(unsigned __int16 *)(*(_DWORD *)(v3 + 12) + v9 + 2);
      }
      else
      {
        v21 = v33 + sub_11CF40((int)v36);
        if ( v21 >= (unsigned int)s )
        {
          if ( *(_DWORD *)(a1 + 20) >= v21 )
            return (char *)v21;
          if ( dword_47AC88 > 0 )
            sub_121F30(*(_BYTE **)(a1 + 12));
LABEL_38:
          v12 = *(unsigned __int16 *)(*(_DWORD *)(v3 + 12) + v9 + 2);
          goto LABEL_13;
        }
        if ( dword_47AC88 <= 0 )
          goto LABEL_38;
        sub_F43DC(&off_46D334, "DW_AT_sibling points backwards");
        v12 = *(unsigned __int16 *)(*(_DWORD *)(v3 + 12) + v9 + 2);
      }
LABEL_13:
      v13 = v12 > 0x11;
...
LABEL_75:
            ...
            if ( v29 )
              v30 = (const char *)v29;
            sub_94708("Dwarf Error: Cannot handle %s in DWARF reader [in module %s]", v30, *v32);
          }
          if ( v12 == 21 )
            goto LABEL_62;
          if ( v12 <= 0x15 )
