int __fastcall sub_2CCC90(int result, int a2, _DWORD *a3)
{
  int v4; // r7
  int v6; // r4
  char *v7; // r8
  ...
  else if ( (*(_DWORD *)(a2 + 20) & 0x10000000) != 0 )
  {
    if ( ((*(_DWORD *)(result + 40) >> 5) & 0x28000) != 0 )
    {
      if ( v7[1] == 122 )
      {
        result = (int)sub_2CBDAC(result, *(char **)a2);
        v7 = (char *)result;
        if ( !result )
          goto LABEL_39;
      }
    ...
    {
      result = (int)sub_2CBDF8(result, *(char **)a2);
      if ( !result )
        goto LABEL_39;
      if ( v7[1] == 122 )
      {
        v7 = (char *)result;
        sub_2A6BE4("elf.c", 3184);
      }
      else
      {
        v7 = (char *)result;
  ...
  result = sub_2F01AC(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v4 + 160) + 2348) + 4), v7, 0);
  *(_DWORD *)v6 = result;
  if ( result == -1 )
    goto LABEL_39;
...
LABEL_6:
  ...
  *(_DWORD *)(v6 + 24) = v11;
  if ( LODWORD(v9) > 0x1E )
  {
    result = sub_2A6A84("%B: error: Alignment power %d of section `%A' is too big", v4);
    goto LABEL_39;
  }
...
LABEL_12:
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v19 )
      {
        result = sub_2A6A84("warning: section `%A' type changed to PROGBITS", v9);
        HIDWORD(v9) = *(_DWORD *)(a2 + 20);
        *(_DWORD *)(v6 + 4) = 1;
        v10 = BYTE4(v9) & 1;
        v12 = HIDWORD(v9) & 0x2000000;
...
LABEL_13:
    ...
    || (result = *v15 & 3, result != 2) && (v15[3] & 8) == 0 )
  {
    ...
    if ( v30 )
      ...
      v22 = (int **)(v6 + 76);
    result = sub_2CCBB0(v4, v22, v7, v21, v37);
    if ( !result )
      goto LABEL_39;
    goto LABEL_67;
  }
  if ( v16 )
  {
    if ( *(_DWORD *)(v6 + 60) )
      goto LABEL_126;
    result = sub_2CCBB0(v4, (int **)(v6 + 60), v7, 0, v37);
    if ( result )
    {
      v17 = *(_DWORD *)(v6 + 80);
LABEL_126:
...
LABEL_37:
  if ( !*(_DWORD *)(v6 + 76) )
  {
    result = sub_2CCBB0(v4, (int **)(v6 + 76), v7, 1, v37);
    if ( !result )
      goto LABEL_39;
  }
LABEL_67:
