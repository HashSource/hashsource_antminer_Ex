int __fastcall sub_1B46C8(const char *a1)
{
  const char *v1; // r6
  int v2; // r3
  int v3; // r8
  ...
  if ( a1 )
  {
    ...
    if ( v2 )
    {
      ...
      v8 = v7;
      if ( v7 + 4 > 0x800 )
        sub_94708("Regexp is too long: %s", v1);
    ...
    if ( a1 )
      sub_94708("Invalid regexp (%s): %s", a1, v1);
    v47 = &dword_487D2C;
  ...
  else
  {
    ...
    {
      v1 = "*";
      return sub_259F38("No selectors matching \"%s\"\n", v1);
    }
    v3 = 0;
  }
  v15 = 0;
      ...
      do
      {
        ...
        if ( a1 )
        {
          ...
          if ( ((v17 - 43) & 0xFD) == 0 && a1[1] == 91 && (!v3 || v17 == v3) )
          {
            ...
            {
              v44 = sub_21B3EC(v16);
              a1 = (const char *)sub_F43DC(&off_46D334, v45, v44);
            }
          }
        }
        v18 = v16[12];
...
LABEL_72:
  ...
  if ( v1 )
    v19 = (char *)v1;
  v20 = (char *)sub_259F38("Selectors matching \"%s\":\n\n", v19);
  v21 = *(_DWORD **)(*v47 + 36);
  v22 = &v45;
  if ( v21 )
  {
    ...
    while ( v21 );
    qsort(&v45, v14, 4u, (__compar_fn_t)sub_1B3F60);
    v49[0] = 0;
    if ( v14 )
    {
      v27 = &(&v45)[v14];
      ...
      do
      {
        sub_258BFC(v26);
        v29 = (int)*v22++;
        v30 = (const char *)sub_21B3EC(v29);
        v31 = strchr(v30, 32);
        v32 = v31;
        v33 = v31 + 1;
        if ( v49[0] )
        {
          v26 = sub_1B3E54((unsigned __int8 *)v31 + 1, v49);
          if ( !v26 )
            continue;
        }
        ...
        *v37 = 0;
        v26 = ((int (__fastcall *)(unsigned __int8 *, int, _DWORD))loc_25A550)(v49, v28, 0);
      }
      while ( v27 != v22 );
    }
  }
  ...
  {
    qsort(&v45, 0, 4u, (__compar_fn_t)sub_1B3F60);
    v49[0] = 0;
  }
  return sub_25A6F0(v26);
}
