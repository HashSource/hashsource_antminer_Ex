_DWORD *sub_1D742C(_DWORD *a1, _DWORD *a2, ...)
{
  int v2; // r10
  void *v4; // r0
  unsigned int *v6; // r0
  ...
  if ( dword_487D4C )
  {
    v19 = *(_DWORD *)sub_242FF0(v4);
    v20 = (const char *)sub_230984(varg_r2, varg_r3, v78);
    sub_2594D8(v19, "[record-btrace] wait %s (0x%x)\n", v20, v80);
  }
  if ( dword_48794C != 1 && !sub_1D5138((int)a2, dword_46BBCC, dword_46BBD0, dword_46BBD4) )
  {
  ...
  v68 = 0;
  v69 = 0;
  sub_92564((int)sub_1D4490, (int)&v68);
  v6 = (unsigned int *)sub_92564((int)sub_1D4490, (int)&v69);
  ...
  if ( dword_48A4D4 )
  {
    do
    {
      if ( v7[11] != 2 )
      {
        v6 = (unsigned int *)sub_99074(v7 + 2, (int *)varg_r2a);
        if ( v6 )
        {
          if ( (v7[74] & 0x1F) != 0 )
          {
...
LABEL_15:
      if ( v8 )
      {
        while ( *v8 > v9 )
        {
          ...
          if ( !v13 )
          {
            v64 = *(_DWORD *)sub_242FF0(v6);
            v65 = sub_240150(v12);
            v56 = sub_230984(v12[2], v12[3], v12[4]);
            ...
            sub_2594D8(v64, "[record-btrace] stepping thread %s (%s): %x (%s)\n", v65, v56, v14 & 0x1F, v58);
          }
          if ( (v14 & 0xF) == 0 || !sub_E1F68((int)v12) )
          {
            switch ( v14 & 0x1F )
            {
              case 1:
...
LABEL_41:
              ...
              case 0x10:
                ...
                goto LABEL_30;
              default:
                v46 = sub_94728((int)"record-btrace.c", 2362, "invalid stepping type.");
                goto LABEL_101;
            }
          }
          v23 = 12;
        ...
        do
        {
          if ( v40[11] != 2 )
          {
            ...
            if ( (v41 & 0x1F) != 0 )
            {
              if ( dword_487D4C )
              {
                v63 = *(_DWORD *)sub_242FF0(v39);
                v43 = sub_240150(v40);
                v44 = sub_230984(v40[2], v40[3], v40[4]);
                if ( (unsigned int)(v42 - 1) > 0xF )
                  v45 = "<invalid>";
                else
                  v45 = (char *)&unk_3CFDCC + 4 * v42 - 4;
                if ( (unsigned int)(v42 - 1) <= 0xF )
                  v45 = (const char *)*((_DWORD *)v45 + 70);
                sub_2594D8(v63, "[record-btrace] cancel resume thread %s (%s): %x (%s)\n", v43, v44, v42, v45);
                v41 = v40[74];
              }
              v40[74] = v41 & 0xFFFFFFE0;
              v39 = sub_1D4B04((int)v40);
            }
          }
          v40 = (_DWORD *)v40[1];
        }
...
LABEL_70:
        ...
        v12[75] = 0;
        v12[76] = 0;
        v50 = sub_1DDC0C(v12[2], v12[3], v12[4]);
        if ( dword_487D4C )
        {
          v51 = *(_DWORD *)sub_242FF0(v50);
          v52 = (const char *)sub_240150(v12);
          v53 = (const char *)sub_230984(*v49, v49[1], v49[2]);
          sub_2775A0(&ptr, v79);
          sub_2594D8(v51, "[record-btrace] wait ended by thread %s (%s): %s\n", v52, v53, (const char *)ptr);
          if ( (_DWORD *)ptr != v74 )
            sub_339E8C((void *)ptr);
        }
        sub_92648(v67);
...
LABEL_98:
        if ( dword_487D4C )
        {
          v60 = (_DWORD *)sub_242FF0(v46);
          sub_2594D8(*v60, "[record-btrace] no-history pending\n");
        }
        goto LABEL_95;
      }
    }
    ...
    {
LABEL_95:
      sub_1532E4((_DWORD *)dword_487D94);
      goto LABEL_70;
    }
LABEL_101:
    v61 = (_DWORD *)sub_242FF0(v46);
    v46 = sub_2594D8(*v61, "[record-btrace] movers pending\n");
    goto LABEL_102;
  }
  v13 = dword_487D4C == 0;
  *v79 = 13;
  if ( !v13 )
  {
    v16 = *(_DWORD *)sub_242FF0(v6);
    v17 = (const char *)sub_230984(dword_475848, qword_47584C, HIDWORD(qword_47584C));
    sub_2775A0(&ptr, v79);
    sub_2594D8(v16, "[record-btrace] wait ended by %s: %s\n", v17, (const char *)ptr);
    if ( (_DWORD *)ptr != v74 )
      sub_339E8C((void *)ptr);
  }
  sub_92648(v67);
