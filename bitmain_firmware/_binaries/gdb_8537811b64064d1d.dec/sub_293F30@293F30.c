int __fastcall sub_293F30(char *a1)
{
  int v1; // r8
  char *v2; // r5
  FILE *v3; // r0
...
LABEL_9:
    ...
    if ( (dword_490144 <= 0 || (v5 = dword_49014C, dword_49014C <= 0))
      && ((sub_293BB8(v1, 0), dword_490144 <= 0) || (v5 = dword_49014C, dword_49014C <= 0)) )
    {
      dword_490144 = 79;
      v6 = 1896;
      dword_49014C = 24;
  ...
  if ( !dword_48BAC8 )
    dword_48BAC8 = (int)sub_93050(0x7F0u);
  v8 = (char *)dword_48BACC;
  if ( !dword_48BACC )
  {
    v8 = (char *)sub_93050(0xFF0u);
    dword_48BACC = (int)v8;
  }
  ...
  dword_48BAF4 = v16;
  sub_293B14(&unk_46FF30);
  sub_293B14(&unk_46E718);
  sub_293B14(&dword_46DF10);
  return 0;
}
