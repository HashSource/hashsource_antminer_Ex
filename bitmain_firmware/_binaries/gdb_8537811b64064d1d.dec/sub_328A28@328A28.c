int __fastcall sub_328A28(int result, int *a2, unsigned __int16 *a3, int a4, int *a5, int *a6)
{
  int v6; // r12
  int v7; // lr
  int v8; // r6
...
LABEL_6:
    ...
    {
      LOWORD(v15) = (unsigned __int16)dword_438B40;
      if ( v6 == 1 )
      {
        v16 = *a3;
        HIWORD(v15) = (unsigned int)dword_438B40 >> 16;
        v17 = *a5;
      }
      else
      {
