void __fastcall sub_C6050(int a1, char *a2, char *a3)
{
  char *v3; // r3
  char *v4; // r8
  _BYTE *v5; // r0
  ...
  if ( !a2 )
    v23 = a3;
  v23 = (char *)sub_93634(v3);
  v5 = (_BYTE *)sub_93634(v23);
  v6 = v5;
  if ( *v5 )
  {
    v7 = v5;
    ...
    {
      ptr = v8;
      if ( sub_5B274((const char **)&ptr, "if", 2u) )
        break;
      v7 = sub_93638(v8);
      v8 = (_BYTE *)sub_93634(v7);
    }
    while ( *v8 );
    v23 = v8;
    if ( v6 >= v7 )
...
LABEL_11:
  ...
  if ( LODWORD(v26[0]) )
  {
    v10 = ptr;
    v11 = sub_98394(0x20u);
    sub_1636E0(v11, v10, 8, "invalid type-matching regexp");
    v12 = sub_98394(0xA8u);
  }
  else
  {
  ...
  *((_BYTE *)v12 + 148) = 0;
  v12[35] = v12 + 37;
  v13 = sub_B8974(0);
  sub_D026C(v12, v13, v4, v9, &unk_478300);
  v14 = ptr;
  v12[3] = 1;
  v12[34] = a1;
  v15 = (_BYTE *)v12[35];
