int __fastcall sub_23F5A4(int result, int a2, int a3)
{
  _DWORD *v3; // r3
  int v4; // r6
  _DWORD *v5; // r4
  ...
  while ( 1 )
  {
    ...
    if ( dword_48A4D4 )
      break;
LABEL_29:
    result = sub_94728((int)"thread.c", 1076, "%s: Assertion `%s' failed.", "void finish_thread_state(ptid_t)", "tp");
LABEL_30:
    if ( v12 == v3[2] )
    {
      v4 = 1;
...
LABEL_10:
        ...
        if ( v5[9] )
          break;
        v5[11] = 0;
        result = sub_23DBFC((int)v5);
        v5 = (_DWORD *)v5[1];
        if ( !v5 )
        {
LABEL_14:
          if ( v6 )
            return sub_1B9A74(v10, v11, v12);
          return result;
        }
      }
      v7 = v5[11];
