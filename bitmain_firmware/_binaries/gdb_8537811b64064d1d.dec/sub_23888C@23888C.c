_DWORD *__fastcall sub_23888C(_DWORD *result, int a2)
{
  int v2; // r4
  int v3; // r5
  int v4; // r6
...
LABEL_25:
          sub_235120(v30, v17, v21);
          ptr[0] = v29;
          if ( v26 )
            v22 = (int)&v26[strlen(v26)];
          else
            v22 = -1;
          sub_235120(ptr, v26, v22);
          if ( v18 )
          {
            *v18 = v18 + 2;
            sub_235120(v18, (_BYTE *)v30[0], (int)v30[0] + (unsigned int)v30[1]);
            v23 = ptr[0];
            v24 = ptr[1];
            v18[6] = v18 + 8;
            sub_235120(v18 + 6, v23, (int)v24 + (_DWORD)v23);
          }
          if ( ptr[0] != v29 )
            sub_339E8C(ptr[0]);
          if ( v30[0] != v31 )
...
LABEL_37:
        sub_23C57C(v19 + 24, v18, &s, &v26);
        __asm { POP             {R4-R8,PC} }
      }
      sub_94728((int)"target-descriptions.c", 1659, "Attempted to add duplicate property \"%s\"", s);
    }
    sub_94728(
      (int)"target-descriptions.c",
      1656,
...
LABEL_8:
  if ( v9 == (int *)result[5] )
    return (_DWORD *)sub_23C48C(result + 3);
  v12 = v9 == 0;
  v13 = v9 + 1;
  if ( !v12 )
    *(v13 - 1) = a2;
