int __fastcall sub_2C8710(_DWORD *a1, _DWORD *a2, _DWORD *a3)
{
  int v3; // r11
  _DWORD *v4; // r3
  _DWORD *v5; // r4
  ...
  if ( a3 )
  {
    ...
    if ( v5 )
      v5 = v4 + 88;
    if ( (v4[583] && !v4[144] || v4[584] && !v4[145]) && !sub_2D6EC4(a1, 0) )
      return -1;
  }
  v8 = *(_DWORD *)(v3 + 24) >> 4;
  v40 = *(_DWORD *)(a1[1] + 444);
  if ( v8 )
  {
    v39 = (_DWORD *)sub_2CDA30((int)a1, v3, v8, 0, 0, 0, 0);
    if ( !v39 )
      return -1;
    v11 = (char *)sub_2AD0C4((int)a1, 52 * v8);
    if ( !v11 )
      goto LABEL_80;
    if ( v5 )
    {
      ...
      if ( v15 != v8 )
      {
        v16 = 0;
        ptr = 0;
        sub_2A6A84("%B: version count (%Ld) does not match symbol count (%ld)", a1, v15, v8);
LABEL_32:
        v17 = v39 + 5;
        if ( &v39[5 * v8] <= v39 + 5 )
        {
...
LABEL_74:
            ...
            *((_DWORD *)v18 - 2) = &off_470800;
            ...
            {
              v38 = sub_2AD7D4((int)a1, "COMMON");
              if ( !v38 )
              {
                v38 = (char *)sub_2ADC10((int)a1, "COMMON", (int)&loc_209000 + 1);
                if ( !v38 )
                {
                  if ( !ptr )
                    goto LABEL_80;
...
LABEL_59:
      ...
      if ( sub_2A8A2C((int)a1, *((_QWORD *)v5 + 2), 0) )
        goto LABEL_80;
      v37 = (char *)sub_2AB390(v5[6]);
      ptr = v37;
      if ( v37 )
      {
        if ( sub_2A8800((int)v37, v5[6], (int)a1) != v5[6] )
          goto LABEL_79;
        v16 = ptr + 2;
        goto LABEL_32;
      }
      if ( v5[6] || sub_2A8800(0, 0, (int)a1) != v5[6] )
      {
LABEL_80:
        if ( *(_DWORD **)(v3 + 48) != v39 )
        {
