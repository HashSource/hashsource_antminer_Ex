char *__fastcall sub_28C298(char *result)
{
  char *v1; // r4
  signed int v2; // r1
  _DWORD *v3; // r6
  ...
  if ( *(_DWORD *)off_47077C[0] )
  {
    if ( dword_470778 < (int)result )
    {
      ...
      *v6 = v9;
      result = (char *)sub_93078(*v10, dword_470778);
      v2 = dword_470778;
      *v10 = result;
    }
  }
  else
  {
    ...
    *v11 = v12;
    result = (char *)sub_93050(dword_470778);
    v2 = dword_470778;
    *v13 = result;
  }
  ...
  if ( !v3[1] )
  {
    ...
    *(_DWORD *)(v14 + 8) = 256;
    ...
    v20 = off_47077C[0];
    v17[3] = v19;
    v21 = sub_93050(4 * *(_DWORD *)(v20 + 8));
    v22 = off_470780;
    *(_DWORD *)(v20 + 4) = v21;
    result = (char *)sub_93050(4 * *(_DWORD *)(v22 + 8));
    v23 = off_470780;
    v24 = off_47077C[0];
    *(_DWORD *)(v22 + 4) = result;
    v25 = *(_DWORD **)(v24 + 4);
