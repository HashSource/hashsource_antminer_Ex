void __fastcall sub_279798(_DWORD *a1, int a2, int a3, int a4, int a5)
{
  __int64 v8; // r0
  int v9; // r7
  int v10; // r10
  ...
  else
  {
    switch ( *((_DWORD *)off_46DBB8 + 4 * (v13 >> 3)) )
    {
      case 0:
        if ( dword_46D448 )
          v26 = (const char *)sub_21B3EC(a2);
        else
          v26 = *(const char **)a2;
        sub_94728((int)"compile/compile-c-symbols.c", 210, "LOC_UNDEF found for \"%s\".", v26);
        goto LABEL_31;
      case 1:
LABEL_31:
      ...
      case 0xB:
        if ( dword_46D448 )
          v33 = (const char *)sub_21B3EC(a2);
        else
          v33 = *(const char **)a2;
        sub_94708("Unsupported LOC_CONST_BYTES for symbol \"%s\".", v33);
      case 0xC:
        goto LABEL_14;
      case 0xD:
        if ( dword_46D448 )
          v32 = (const char *)sub_21B3EC(a2);
        else
          v32 = *(const char **)a2;
        sub_94708("Symbol \"%s\" cannot be used for compilation evaluation as it is optimized out.", v32);
      case 0xE:
        if ( a5 )
        {
LABEL_21:
...
LABEL_14:
          ...
          if ( v17 )
          {
            ...
            {
              if ( dword_46D448 )
                v39 = (const char *)sub_21B3EC(a2);
              else
                v39 = *(const char **)a2;
              sub_94708("Symbol \"%s\" cannot be used because there is no selected frame", v39);
            }
          }
          v18 = ((int (__fastcall *)(int, int, int))loc_15B3C8)(a2, a3, v17);
          nullsub_31();
          if ( *v19 != 1 )
          {
            if ( dword_46D448 )
              v20 = (const char *)sub_21B3EC(a2);
            else
              v20 = *(const char **)a2;
            sub_94708("Symbol \"%s\" cannot be used for compilation evaluation as its address has not been found.", v20);
          }
          v41 = v18;
          v43 = 1;
          v14 = 0;
          ((void (__fastcall *)(int))loc_26C0C4)(v41);
        }
LABEL_23:
        v21 = a2;
        v44 = *a1;
...
LABEL_24:
      ...
      case 0xF:
        if ( dword_46D448 )
          ...
          v34 = *(const char **)a2;
        sub_94708("Fortran common block is unsupported for compilation evaluaton of symbol \"%s\".", v34);
      default:
        v40 = sub_94728(
