int __fastcall sub_27F494(int a1, int *a2, int a3)
{
  int v4; // r5
  int v6; // r2
  int *v7; // r10
...
LABEL_20:
    ...
    if ( dword_46DED4 )
      v14 = 0;
    v15 = v4 == 27 && v14;
    if ( !v15 || (v31 = sub_292F08(0), v13 = v7[1], v31) )
    {
      dword_4900CC = v13;
      ++dword_48AADC;
      ...
      {
        v29 = sub_27F494();
        return sub_27FAC0(v29, a2, v4, a3);
      }
LABEL_50:
      sub_291244();
    }
...
LABEL_8:
      ...
      if ( v4 == 256 )
        v10 = 0;
      if ( !v10 || !sub_2810B4(v4) )
        return 0;
      sub_281068(v4, dword_46DEDC, dword_46DEE0);
      return v9;
    }
    v23 = strlen(v22);
    v9 = 0;
    v24 = (char *)sub_93050(v23 + 1);
  ...
  if ( v26 != (void (__fastcall *)(int, int))sub_295BC8 )
  {
    dword_48AAA0 |= 0x20u;
    dword_4900C4 = (int)a2;
    dword_48FF28 = 1;
