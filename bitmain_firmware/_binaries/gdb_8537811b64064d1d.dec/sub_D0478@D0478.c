void sub_D0478()
{
  ...
  for ( i = *(_DWORD **)(dword_487D2C + 36); i; i = (_DWORD *)*i )
  {
    ...
    if ( *v8 != loc_D05FC )
    {
      if ( !v9 )
      {
        sub_1B1FE0((int)&v15, "_ovly_debug_event");
        if ( !v15 )
        {
          *v10 = loc_D05FC;
          continue;
      ...
      if ( v1 == -1 )
      {
        v12 = sub_94728((int)"breakpoint.c", 3244, "Section index is uninitialized");
        sub_D0600(v12, HIDWORD(v12));
        return;
      }
      v2 = *(_DWORD *)(v9 + 8) + *(_DWORD *)(*(_DWORD *)(v10[1] + 144) + 4 * v1);
      v3 = sub_1B7278(i);
      v4 = sub_D03C8(v3, v2, 22, loc_D05FC - 972);
      sub_19CCA0(&v15);
      v16 = v13;
      ...
      *(_DWORD *)(v4 + 76) = v6;
      if ( v5 )
      {
        ...
        if ( v14 )
          ((void (__fastcall *)(int *))loc_19D17C)(&v14);
      }
      v7 = dword_489690 == 2;
      *(_DWORD *)(v4 + 16) = v7;
      *(_DWORD *)(loc_D05FC - 1312 + 0xC) = v7;
    }
  }
}
