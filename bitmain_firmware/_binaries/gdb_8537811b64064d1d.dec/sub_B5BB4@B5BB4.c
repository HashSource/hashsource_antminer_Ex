char **__fastcall sub_B5BB4(char **a1, int a2, int a3)
{
  int v5; // r3
  int v6; // r5
  int v7; // r3
  ...
  if ( v7 == 2 )
  {
    ...
    if ( v9 && sub_A24C4(v6) )
    {
      ...
      if ( v11 )
      {
        sub_B56D0(&ptr, v9, (int)v16);
        sub_93200(a1, "[%d] %s", v10, (const char *)ptr);
        if ( ptr != &v15 )
          sub_339E8C(ptr);
        return a1;
      }
