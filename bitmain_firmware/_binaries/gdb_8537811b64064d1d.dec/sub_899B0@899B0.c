    ...
    switch ( *v0 )
    {
      ...
      case 34:
        ...
        while ( 1 )
        {
          ...
          {
            dword_475180 += 64;
            dword_475184 = sub_93078(dword_475184, dword_475180);
          }
          v22 = (_BYTE *)v96[0];
...
LABEL_35:
          ...
          if ( v24 )
          {
            v96[0] = v22 + 1;
            if ( *v22 != 34 )
              sub_94708("Unterminated string in expression.");
            v55 = dword_475184;
        ...
        ++v96[0];
        v25 = sub_258D44(*(_DWORD *)(*(_DWORD *)(dword_47517C + 4) + 4), v96);
        if ( v25 != -1 )
        {
      ...
      case 39:
        ...
        if ( v26 == 92 )
        {
          v26 = sub_258D44(*(_DWORD *)(*(_DWORD *)(dword_47517C + 4) + 4), &dword_487CC0);
        }
        else if ( v26 == 39 )
        {
          sub_94708("Empty character constant.");
        }
        *(_QWORD *)&dword_475160 = v26;
        v27 = sub_1780DC(*(_DWORD *)(*(_DWORD *)(dword_47517C + 4) + 4));
        ...
        v30 = v29 - (_DWORD)v0;
        if ( v30 <= 2 )
          sub_94708("Invalid character constant.");
        dword_487CC0 = v29;
        if ( *(_BYTE *)(v29 - 1) != 39 )
          sub_94708("Unmatched single quote.");
        v31 = v30 - 2;
        src = v4;
        v32 = (void *)sub_893D4((int)v4, v30 - 2);
        goto LABEL_50;
      case 40:
...
LABEL_114:
          ...
          while ( 1 )
          {
            if ( v37 || (v3 & 0xDF) != 0x45 )
            {
              ...
              {
                result = sub_89490(dword_47517C, (unsigned __int8 *)v0, v39 - (_DWORD)v0, v58 | v56, (int)&dword_475160);
                if ( result == 270 )
                {
                  v60 = (const char *)memcpy(&dest, v0, v39 - (_DWORD)v0);
                  *((_BYTE *)&dest + v39 - (_DWORD)v0) = 0;
                  sub_94708("Invalid number \"%s\".", v60);
                }
                dword_487CC0 = v39;
                return result;
              }
      ...
      default:
        ...
        else
        {
          if ( (v3 & 0xFFFFFFDF) - 65 > 0x19 )
            sub_94708("Invalid character '%c' in expression.", v3);
          v31 = 0;
        }
LABEL_94:
        v46 = result == 95;
...
LABEL_109:
        v54 = (_BYTE *)sub_893D4((int)v0, v31);
        v32 = v54;
...
LABEL_50:
        ...
        if ( v31 != 6 )
        {
          if ( v31 == 4 )
          {
            ...
            {
              sub_21D6D8(v96, "this", dword_487CD0, 1, 0);
              if ( v96[0] )
              {
                free(v32);
                return 272;
...
LABEL_53:
        ...
        if ( *(_BYTE *)src == 36 )
        {
          sub_1C4FC4(dword_47517C, dword_475160, dword_475164);
          v67 = (char *)memcpy(&dest, src, v31);
          *((_BYTE *)&dest + v31) = 0;
          dword_475188 = sub_26CA70(v67 + 1);
          if ( v32 )
            free(v32);
          return 271;
        }
        v33 = (char *)sub_1C3E80(dword_475160, dword_475164);
        v95[0] = 0;
        if ( dword_475178 && dword_47515C && sub_1728B0(dword_47515C, v33, 1) )
        {
LABEL_57:
          v34 = v31 + 1;
LABEL_58:
          v35 = 1;
LABEL_59:
          v36 = (char *)sub_93078(dword_475184, v34);
        ...
        result = sub_21D6D8(v96, v33, dword_487CD0, 1, v95);
        v48 = v96[0];
        v49 = v95[0];
        if ( v96[0] )
        {
...
LABEL_105:
        ...
        if ( dword_475178 && dword_47515C && sub_1728B0(dword_47515C, v33, 1) )
          goto LABEL_57;
        result = sub_21D6D8(v96, v33, *(_DWORD *)v94, 1, v95);
        v48 = v96[0];
        if ( v96[0] )
        {
          v49 = v95[0];
...
LABEL_189:
        ...
        if ( result )
          goto LABEL_174;
        dword_475168 = sub_1946F0(**(_DWORD **)(dword_47517C + 4), *(_DWORD *)(*(_DWORD *)(dword_47517C + 4) + 4), v33);
        if ( dword_475168 )
          goto LABEL_188;
...
LABEL_231:
        ...
        if ( sub_89490(dword_47517C, (unsigned __int8 *)src, v31, 0, (int)v96) != 258 )
          goto LABEL_193;
        dword_475168 = 0;
        dword_47516C = 0;
        dword_475170 = v95[0] != 0;
