_DWORD *__fastcall sub_220FAC(_DWORD *a1, char *s, char *a3)
{
  size_t v5; // r9
  _DWORD *v6; // r11
  _DWORD *v7; // r7
...
LABEL_13:
      ...
      while ( 1 )
      {
        ...
        {
          v9 = sub_15A0A0(&v15, v8[3]) == 0;
          v10 = (const char *)v8[3];
          if ( !v9 || (v9 = j_strncmp(v10, s, v5) == 0, v10 = (const char *)v8[3], !v9) )
          {
            v11 = sub_3245CC(v10);
            v12 = (const char *)v11;
            if ( v8[3] == v11 || sub_15A0A0(&v15, v11) || j_strncmp(v12, s, v5) )
              goto LABEL_12;
            v10 = v12;
          }
          sub_220F28(v10, s, a3, (int)a1);
        }
LABEL_12:
        v8 = (_DWORD *)*v8;
        if ( !v8 )
...
LABEL_15:
    ...
    v16[2] = a3;
    v16[4] = a1;
    sub_2153B8((int)sub_221178, (int)v16, 0);
    sub_15A088(&v15);
  }
  return a1;
}
