int __fastcall sub_29E6E4(void (__fastcall *a1)(_DWORD, _DWORD), int a2, unsigned int a3, int a4)
{
  int v4; // r11
  _DWORD *v7; // r3
  const char *i; // r5
  ...
  do
  {
    ...
    if ( v19 == 37 )
    {
      switch ( v20[1] )
      {
        ...
        case '8':
        case '9':
          v25 = sub_29C20C((unsigned __int8 *)v20 + 1, v62, &v95, &v94);
          v21 = v25;
          switch ( *v25 )
          {
            case '\'':
...
LABEL_135:
            ...
            case 'e':
              ...
              goto LABEL_130;
            case 'r':
              ((void (*)(int, const char *, ...))a1)(a2, "%s", (&off_3FDE64[18 * dword_4707E4 + 2])[LODWORD(v95)]);
              goto LABEL_130;
            default:
              goto LABEL_194;
          }
          break;
        case 'A':
          v31 = *((unsigned __int8 *)&off_3FDE64[670] + v71);
          v32 = v31 & 0xF;
          v33 = (v31 >> 4) + 1;
          a1(a2, "{");
          v34 = v33;
          ...
          else if ( v32 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( v32 == v36 )
                break;
              v37 += v38;
              v35 = (const char *)&word_3D7D68;
            }
            v21 = (unsigned __int8 *)(v20 + 1);
          }
          ((void (*)(int, const char *, ...))a1)(a2, "}, [%s", (&off_3FDE64[18 * dword_4707E4 + 2])[v68]);
          if ( v83 )
...
LABEL_86:
          ...
          {
            ((void (*)(int, const char *, ...))a1)(a2, ", %s", (&off_3FDE64[18 * dword_4707E4 + 2])[v67]);
          }
          break;
        case 'C':
          if ( v84 )
...
LABEL_100:
        ...
        case 'u':
          ...
          v61 = 1;
LABEL_50:
          ((void (*)(int, const char *, ...))a1)(a2, "%s", off_3FDE64[(v24 >> 4) + 144]);
          break;
        default:
          goto LABEL_194;
      }
