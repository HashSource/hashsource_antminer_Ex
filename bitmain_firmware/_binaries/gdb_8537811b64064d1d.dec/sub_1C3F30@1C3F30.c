int **__fastcall sub_1C3F30(char **a1, _BYTE **a2, int a3, void ***a4, int a5, int *a6)
{
  _BYTE *v6; // r12
  int **v9; // r6
  void **v11; // r3
  ...
  dword_487CB4 = 0;
  if ( !v6 || !*v6 )
    sub_51EC4("expression to compute");
  v11 = v29;
  v12 = dword_487CA8;
  ...
  if ( !a4 )
  {
    a1 = (char **)sub_20F3B0(&dword_487CD4);
    dword_487CD0 = (int)a1;
    if ( !a1 )
    {
      a1 = (char **)sub_203238(&v30);
      if ( ptr )
  ...
  if ( dword_487A04
    || (a1 = (char **)sub_C23D8((int)a4)) == 0
    || (a1 = sub_194460((_BYTE)a1[5] & 0x1F), (v13 = a1) == 0)
    || !a1[2] )
  {
LABEL_12:
    v13 = off_46D5A4[0];
  }
  v14 = sub_B8974((int)a1);
  v30 = 10;
  v15 = sub_93050(0xC0u);
  *v15 = v13;
  v16 = off_46D5A4[0];
  ...
  sub_92E68((int)v19);
  v20 = sub_1C3784(v9, (int)&v30);
  v21 = *v9;
  if ( dword_487CD8 )
  {
    v22 = (int *)sub_242FF0(v20);
    sub_1569D0((int)v21, *v22, "before conversion to prefix form");
    v21 = *v9;
  }
  v23 = sub_1C3EE8(v21);
  if ( a6 )
