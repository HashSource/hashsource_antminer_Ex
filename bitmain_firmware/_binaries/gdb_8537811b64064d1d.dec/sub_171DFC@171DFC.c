int __fastcall sub_171DFC(int a1, _DWORD *a2, _DWORD *a3, _DWORD *a4, int a5)
{
  _DWORD *v5; // r6
  int v6; // r4
  int v9; // r3
  ...
  *(_DWORD *)(v20 + 24) = v15;
  ...
  if ( v5 )
  {
    ...
    if ( (*(_BYTE *)(v20 + 2) & 0x10) != 0 )
      v21 = *(_DWORD *)(v20 + 16);
    ((void (__fastcall *)(int, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, int, int))loc_17112C)(
      3,
      v5[3],
      *v5,
      v5[1],
