const char ***__fastcall sub_E4404(const char ***a1, int a2, unsigned __int8 *a3)
{
  char *v3; // r4
  unsigned int *v4; // r4
  unsigned int v5; // r9
  ...
  if ( v4 && *v4 )
  {
    ...
    do
    {
      ...
      if ( !access(v25, 0) )
      {
        ...
        if ( v7 )
        {
          v9 = sub_92564((int)v27, v7);
          ((void (__fastcall *)(const char ***, int, int, int))loc_1629B4)(&v35, v8, dword_47ACA8, -1);
          v10 = v35;
          if ( *v31 )
