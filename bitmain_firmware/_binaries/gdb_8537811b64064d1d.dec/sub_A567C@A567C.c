void __fastcall sub_A567C(const char *a1, int a2, char *a3, _DWORD *a4)
{
  int *v4; // r9
  int *v5; // r10
  size_t v10; // r0
  ...
  v35[0] = v36;
  sub_9D908(v35, &word_364FCC, (int)&word_364FCC + 1);
  v10 = strlen(a1);
  if ( 0x7FFFFFFF - (unsigned int)v35[1] < v10 )
    sub_33D1AC("basic_string::append");
  v11 = sub_33C348(v35, a1, v10);
  ptr = v39;
  v13 = v11;
  v15 = (int *)(v11 + 8);
  v14 = *(void **)v11;
  ...
  *(_DWORD *)v13 = v15;
  *(_DWORD *)(v13 + 4) = 0;
  v19 = sub_33BA94((int)&ptr, v38, 0, 1u, 62);
  v32 = v34;
  v21 = v19;
  v23 = (int *)(v19 + 8);
  v22 = *(void **)v19;
  ...
  *(_DWORD *)(v21 + 4) = 0;
  ...
  sub_A55E8(v31, (char *)v32, a2, a3, 0);
  v28 = v32;
  v29 = v31[1];
  v16 = v32 == v34;
  *a4 = v31[0];
