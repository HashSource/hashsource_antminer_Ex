int __fastcall sub_1C16E4(_DWORD *a1, int a2, __int64 a3, int a4, int a5, int a6, int a7, int *a8, int a9, int a10)
{
  int v10; // r4
  int v11; // r12
  int v12; // r6
    ...
    else
    {
      ...
      if ( v65 > 0 )
      {
        *(struct obstack *)dest = stru_487C6C;
        ...
        while ( 1 )
        {
          v39 = sub_171280(*(_DWORD **)(*(_DWORD *)(v11 + 24) + 24 * v34 + 12));
          v40 = sub_170CEC(v39);
          v41 = *(_DWORD *)(v10 + 24);
          v71 = (char *)v40;
          ...
          v36 = sub_92E50();
          v64 = sub_FC5C4(v10, v34, a2, SHIDWORD(a3), a3, SHIDWORD(a3), v35, a7);
          sub_92E68((int)v36);
...
LABEL_68:
  ...
  do
  {
    ...
    if ( !sub_174F34(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v15) )
    {
      if ( v13 )
      {
LABEL_81:
...
LABEL_11:
          ...
          sub_25A878(a5, *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v15 + 16), 4, 3);
          sub_B783C();
          sub_25A6E4(" = ", a5);
          sub_B785C();
          v18 = sub_174F34(*(_DWORD *)(*(_DWORD *)(v10 + 24) + 24) + v15);
          v19 = *(_DWORD *)(v10 + 24);
          if ( v18 )
          {
...
LABEL_15:
            if ( v20 != 128
              || (v51 = *(_DWORD *)(v19 + 28), (__int16 *)v51 == &word_3B4A54)
              || (v52 = *(_DWORD *)(v51 + 28)) == 0
              || (((int)*(unsigned __int8 *)(v52 + (v12 >> 3)) >> (v12 & 7)) & 1) == 0 )
            {
              if ( sub_174F34(*(_DWORD *)(v19 + 24) + v15) )
              {
                v21 = sub_26D790(v10, v12, a2, HIDWORD(a3), a3, HIDWORD(a3), a7);
                v22 = v21;
                if ( v21 )
                {
                  v74 = sub_26BC98(v21);
                  if ( !sub_26E738(v22) )
                  {
                    if ( **(_BYTE **)(v74 + 24) == 3 )
                    {
                      ...
                      while ( --v24 >= 0 )
                      {
                        v25 = ((int (__fastcall *)(int))loc_26C0C4)(v22);
                        v26 = *(_DWORD *)(v23 - 4);
                        v23 -= 4;
                        if ( v25 == v26 )
                        {
                      ...
                      v10 = v77;
                      v27 = ((int (__fastcall *)(int))loc_26C0C4)(v22);
                      ...
                      *v28 = v27;
                      dword_487C4C += 4;
                      v75 = sub_171280((_DWORD *)v74);
                      v78 = sub_26E740(v22, v29);
                      v30 = sub_26C008(v22);
                      sub_1C16E4(v75, v78, v30, HIDWORD(v30), v27, a5, v67, v22, a8, 0, 1);
                    }
                    else
                    {
                      memcpy(dest, a8, sizeof(dest));
                      *(_DWORD *)&dest[52] = 0;
                      sub_266BEC(v22, a5, v67, dest, off_46D5A4[0]);
                    }
                    goto LABEL_65;
                  }
                  v21 = v22;
...
LABEL_65:
          ...
          else
          {
            ...
            if ( (v46 & 0xFFFFFFF0) == 0 )
              goto LABEL_15;
            if ( v20 != 128
              || (v62 = *(_DWORD *)(v19 + 28), (__int16 *)v62 == &word_3B4A54)
              || (v63 = *(_DWORD *)(v62 + 28)) == 0
              || (((int)*(unsigned __int8 *)(v63 + (v12 >> 3)) >> (v12 & 7)) & 1) == 0 )
            {
              if ( sub_26BFE0(a7, 0, *v45, v45[1], v46 >> 4, 0) )
              {
              ...
              {
                memcpy(dest, a8, sizeof(dest));
                v61 = sub_26D790(v10, v12, a2, HIDWORD(a3), a3, HIDWORD(a3), a7);
                *(_DWORD *)&dest[52] = 0;
                sub_266BEC(v61, a5, v67, dest, off_46D5A4[0]);
              }
              goto LABEL_65;
            }
          }
