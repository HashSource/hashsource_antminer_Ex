_DWORD *__fastcall sub_19A378(_DWORD *a1, _DWORD *a2, const char **a3, const void *a4)
{
  unsigned int v4; // r4
  unsigned int *v9; // r0
  unsigned int v10; // r2
  ...
  v4 = 0;
  v33 = 0;
  v32 = sub_92564((int)sub_195424, (int)&v33);
  v36 = a2;
  v37 = 0;
  v9 = sub_9A008(0, 1);
  v10 = *v9;
  ...
  *v9 = v10 + 1;
  v9[v10 + 2] = 0;
  sub_92564((int)sub_1953AC, (int)&v37);
  v38 = 0;
  v39 = 0;
  v12 = ((int (__fastcall *)(const void *, unsigned int **))loc_1B57E0)(a4, &v33);
  v13 = v33;
  v31 = v12;
  if ( v33 && *v33 )
  {
...
LABEL_18:
    ...
    sub_93200((char **)&ptr, "%s:%s", v23, (const char *)&v31);
    v24 = v40;
    if ( ptr == (char *)v43 + 4 )
    {
      sub_33B4B4(&v40, &ptr);
