int __fastcall sub_21DBB0(unsigned int a1, int a2)
{
  unsigned int v4; // r3
  unsigned int v5; // r2
  bool v6; // cc
    ...
    for ( i = (_DWORD *)v7[5]; i; i = (_DWORD *)*i )
    {
      ...
      if ( a2 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( (v19 & 1) != 0 )
            ((void (__fastcall *)(int, _DWORD *))loc_21C208)(v16, v7);
          v17 = *(__int16 *)(v16 + 22);
          v18 = v17 < 0;
          if ( v17 >= 0 )
            v19 = v7[42];
          v20 = 3 * v17;
          v21 = v18 ? 0 : v19 + 4 * v20;
          if ( ((int (__fastcall *)(int, int))loc_21BE38)(v21, a2) )
            break;
          v16 = sub_C290C((int)v28);
          if ( !v16 )
            goto LABEL_18;
        }
      }
