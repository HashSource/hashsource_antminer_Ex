void __fastcall sub_68658(int *a1, char *a2, int *a3)
{
  char *v6; // r5
  int v7; // r0
  unsigned int v8; // r2
  ...
  if ( &v6[ptr] )
  {
    ...
    *v11 = v15;
    for ( v11[1] = v15; v13 != v12; v17 += 12 )
    {
      ...
      {
        *v17 = v17 + 2;
        sub_631C0(v17, *(_BYTE **)v12, *(_DWORD *)v12 + *(_DWORD *)(v12 + 4));
        v17[6] = v17 + 8;
        sub_631C0(v17 + 6, *(_BYTE **)(v12 + 24), *(_DWORD *)(v12 + 24) + *(_DWORD *)(v12 + 28));
      }
      v12 += 48;
    }
