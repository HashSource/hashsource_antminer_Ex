unsigned int *__fastcall sub_33BC7C(unsigned int *a1, size_t a2, unsigned int a3, char *src, size_t a5)
{
  unsigned int v6; // r0
  size_t v8; // r10
  unsigned int v9; // r8
  ...
  if ( a5 > a3 + 0x7FFFFFFF - v6 )
    sub_33D1AC("basic_string::_M_replace");
  v8 = a5 - a3;
  v9 = *a1;
  v10 = v6 + a5 - a3;
