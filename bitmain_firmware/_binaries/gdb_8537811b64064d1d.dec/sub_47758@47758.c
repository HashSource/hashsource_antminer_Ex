unsigned __int64 __fastcall sub_47758(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  _DWORD *v4; // r5
  bool v6; // zf
  int v7; // r3
  ...
  if ( v6 )
  {
    if ( (unsigned __int64)(*(_QWORD *)&dword_46AFA0 + 1LL) > 1 )
      sub_92078(&unk_47262C);
    v4 = &unk_47260C;
    *(_QWORD *)&dword_46AFA0 = 0;
    dword_472638 = 0;
    sub_920A8(&unk_47262C);
    sub_9206C(&unk_47262C, "<osdata type=\"cpus\">\n", 21);
    sub_96818((int)&stream, (int)"/proc/cpuinfo", "r");
    v9 = stream;
    if ( stream )
    {
      v29 = 1;
          ...
          if ( v10 )
          {
            ...
            if ( v11 )
            {
              ...
              *v11 = 0;
              ...
              {
                if ( v29 )
                  sub_9206C(&unk_47262C, "<item>", 6);
                else
                  sub_9206C(&unk_47262C, "</item><item>", 13);
                v29 = 0;
              }
              sub_920D8(&unk_47262C, "<column name=\"%s\">%s</column>", v10, v12);
            }
          }
        }
        if ( feof(stream) )
      ...
      if ( !v29 )
        sub_9206C(&unk_47262C, "</item>", 7);
    }
    sub_9206C(&unk_47262C, "</osdata>\n", 11);
    dword_472638 = sub_920BC(&unk_47262C);
