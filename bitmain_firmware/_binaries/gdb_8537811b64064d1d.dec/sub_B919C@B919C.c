int __fastcall sub_B919C(const char *a1, const char *a2)
{
  size_t v4; // r4
  size_t v5; // r9
  void *v6; // r0
...
LABEL_9:
    ...
    if ( !dword_478228 )
      return 1;
    v21 = (_DWORD *)sub_242FF0(v6);
    sub_2594D8(*v21, "auto-load: Matched - empty pattern\n");
    return 1;
  }
  v7 = v5 - 1;
...
LABEL_20:
      ...
      if ( dword_478228 )
      {
        v17 = (_DWORD *)sub_242FF0(dword_478228);
        sub_2594D8(*v17, "auto-load: Not matched - pattern \"%s\".\n", (const char *)savedregs);
        return 0;
      }
      return result;
    }
...
LABEL_17:
    *((_BYTE *)savedregs + v11) = 0;
    v13 = ((int (__fastcall *)(_DWORD *, _DWORD *, int, _BYTE *))loc_25B54C)(savedregs, savedregs, 3, v12);
