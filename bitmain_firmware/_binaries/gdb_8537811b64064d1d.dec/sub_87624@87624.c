    ...
    switch ( *v1 )
    {
      ...
      case 0x27u:
        ...
        else
        {
          if ( !v1[1] )
LABEL_129:
            sub_94708("Unterminated string or character constant.");
          v16 = 1;
          while ( 1 )
          {
            v43 = v9 == 92;
...
LABEL_35:
            sub_94708("Invalid character '%c' in expression.", v8);
          for ( i = (int)v1; ; ++i )
          {
            v53 = v8 == 95;
            if ( v8 != 95 )
          ...
          if ( *v1 == 36 )
          {
            sub_1C4FC4(dword_475148, dword_475138, dword_47513C);
            return 290;
          }
          else
          {
            v58 = sub_1C3E80(dword_475138, dword_47513C);
            if ( sub_21ABAC(v58) )
              return 268;
            sub_21D6D8(v76, v58, dword_487CD0, 1, 0);
            v59 = v76[0];
            if ( v76[0] )
            {
              ...
              else
              {
                ...
                v61 = *v60;
                v62 = v60[1];
                v63 = sub_1C3E80(dword_475138, dword_47513C);
                if ( !sub_170D00(v61, v62, v63, dword_487CD0, 1) )
                {
                  switch ( *((_DWORD *)off_46DBB8 + 4 * (*(unsigned __int8 *)(v59 + 32) >> 3)) )
                  {
                    case 0:
                      sub_94708("internal:  Undefined class in m2lex()");
                    case 1:
                    case 2:
                    case 3:
                    case 4:
                    ...
                    case 9:
                    case 0xC:
                      sub_94708("internal:  Unforseen case in m2lex()");
                    case 0xA:
                      return 268;
                    default:
                      sub_94708("unhandled token in m2lex()");
                  }
                }
                return 271;
              }
            ...
            else
            {
              ...
              v65 = sub_1C3E80(dword_475138, dword_47513C);
              if ( sub_170D00(v64, HIDWORD(v64), v65, dword_487CD0, 1) )
                return 271;
...
LABEL_9:
          ...
          *v0 = (int)v68;
          ...
          if ( v11 )
          {
            ...
            if ( v75 < 0 )
              sub_194360("Overflow on numeric constant -- number too large.");
          }
          v8 = 258;
          *(_QWORD *)&dword_475138 = v75;
          goto LABEL_19;
        ...
        while ( 2 )
        {
          if ( v28 == 10 && (unsigned int)(v6 - 48) > 9 )
            sub_94708("Invalid digit '%c' in number.", v6);
          if ( v32 == v1 )
          {
            v67 = v7;
            v34 = v4;
...
LABEL_105:
            ...
            if ( (unsigned int)(v39 - 56) <= 1 )
              sub_94708("Invalid digit '%c' in octal number.", v39);
            v42 = v39 - 48;
            if ( (unsigned int)(v39 - 48) > 9 )
            {
LABEL_124:
...
LABEL_123:
        ...
        if ( v28 != 10 )
          sub_94708("Floating point numbers must be base 10.");
        LODWORD(v75) = v27;
        sub_19E518(*(_DWORD *)(*(_DWORD *)(dword_475148 + 4) + 4));
        if ( !sub_1C450C(v4, v75) )
        {
LABEL_125:
          v48 = n;
          v49 = (const char *)memcpy(&v66, v4, n);
          *((_BYTE *)&v66 + v48) = 0;
          sub_94708("Invalid number \"%s\".", v49);
        }
        v8 = 265;
LABEL_19:
        *v0 = (int)v7;
