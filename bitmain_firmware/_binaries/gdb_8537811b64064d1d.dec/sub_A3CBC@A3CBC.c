int __fastcall sub_A3CBC(int a1, int a2)
{
  char *v2; // r6
  _BYTE *v5; // r1
  int v6; // r3
  ...
  *(_BYTE *)(a1 + 8) = 0;
  ...
  if ( *v5 == 60 )
  {
    ...
    {
      if ( !v6 )
        sub_33D234("%s: __pos (which is %zu) > this->size() (which is %zu)", "basic_string::substr", 1u, 0);
      ptr = (char *)v33 + 4;
      sub_9D908(&ptr, v5 + 1, (int)&v5[v6]);
      v8 = *(char **)a1;
      if ( ptr == (char *)v33 + 4 )
      {
        sub_33B4B4(a1, &ptr);
...
LABEL_29:
  ...
  *(_BYTE *)(a1 + 24) &= ~4u;
  v13 = sub_33C654(a2 + 8, &dword_3C43C4, 0, 2);
  *(_BYTE *)(a1 + 24) = *(_BYTE *)(a1 + 24) & 0xFE | (v13 != -1);
  if ( v13 == -1 && (v14 = sub_9EAF8(*(const char **)(a2 + 8)), v15 = sub_9DC24(v14, 0), (v16 = (char *)v15) != 0) )
  {
    v17 = strlen(v15);
    sub_33BC7C(a1, 0, *(_DWORD *)(a1 + 4), v16, v17);
  }
  else
  {
    sub_33B4B4(a1, a2 + 8);
  ...
  if ( !strncmp(*(const char **)a1, "standard__", 0xAu) )
  {
    ...
    if ( v26 <= 9 )
      sub_33D234(
        ...
        *(_DWORD *)(a1 + 4));
    v34 = (char *)v35 + 4;
    sub_9D908(&v34, v18 + 10, (int)&v18[v26]);
    v27 = *(char **)a1;
    if ( v34 == (char *)v35 + 4 )
    {
      sub_33B4B4(a1, &v34);
