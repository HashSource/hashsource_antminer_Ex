int __fastcall sub_701BC(int a1, char *nptr, int a3, const char *a4)
{
  int v7; // r0
  int v8; // r6
  int *v9; // r7
  ...
  v9 = _errno_location();
  *v9 = 0;
  v10 = sub_93384(a3, &v22, v8);
  if ( *v9 == 34 )
LABEL_24:
    sub_94708("Integer literal out of range");
  v11 = *v22;
  if ( isxdigit(v11) )
    sub_94708("Invalid digit `%c' in based literal", v11);
  if ( (int)a4 > 0 )
  {
    v12 = sub_347440(-1, v8);
  ...
  v14 = ((int (__fastcall *)(_DWORD))loc_165E90)(*(_DWORD *)(*(_DWORD *)(a1 + 4) + 4));
  ...
  if ( v15 )
  {
    dword_474908 = *(_DWORD *)(sub_1780DC(v16) + 12);
  }
  else
  {
    v17 = ((int (__fastcall *)(int))loc_165F08)(v16);
    ...
    if ( v15 )
    {
      dword_474908 = *(_DWORD *)(sub_1780DC(v18) + 16);
    }
    else
    {
      v20 = ((int (__fastcall *)(int))loc_165F08)(v18);
      ...
      if ( v15 )
      {
        dword_474908 = *(_DWORD *)(sub_1780DC(v21) + 36);
      ...
      {
        dword_474908 = *(_DWORD *)(sub_1780DC(v21) + 68);
      }
    }
  }
