void __fastcall sub_D9360(const char *a1, int a2, int a3, int a4)
{
  unsigned int v4; // r4
  int v5; // r5
  _BYTE *v7; // r1
...
LABEL_77:
          ...
          if ( v64 == 6 )
          {
            if ( strncmp(v63, "thread", 6u) )
              goto LABEL_121;
            if ( v54 != -1 )
              sub_94708("You can specify only one thread.");
            v82 = sub_242360(v62, v132);
...
LABEL_121:
            ...
            if ( v5 )
              sub_94708("You can specify only one mask.");
            v65 = sub_26C208(0);
            v66 = sub_14CCF4(&v127);
            v5 = 1;
            v53 = sub_26EBD0(v66);
...
LABEL_122:
  ...
  v132[0] = v133;
  dword_487CE0 = 0;
  sub_CB22C(v132, v7, v4);
  v8 = (const char *)v132[0];
  v113 = (char *)v132[0];
  sub_1C42A4(&ptr, &v113, 0, 0, 0);
  v9 = v113;
  if ( v8 < v113 )
  {
...
LABEL_21:
    ...
    sub_94708("Cannot watch constant value `%.*s'.", v22, v8);
  }
  while ( 2 )
  {
    v18 = sub_1C4288(v16, v17, &v121, &v127);
    v17 -= v121;
    v19 = &v16[16 * v17];
    switch ( *((_DWORD *)v19 + 4) )
    {
...
LABEL_25:
        v24 = dword_487CE0;
        v109 = sub_26C208(v18);
        sub_14CDE0(ptr, &v117, &v114, &v115, 0, a3);
        if ( v114 )
        {
          if ( !a3 )
          {
          ...
          v111 = sub_26BCB8(v114);
          v112 = sub_26BCC8(v114);
        }
        else
        {
          if ( !a3 )
        ...
        v114 = sub_2616E4(v115);
        sub_26C3E0(v114);
        sub_26C328(v109);
        if ( v5 )
        {
          v99 = sub_26EBD0(v114);
          v100 = sub_232564(v99, v102);
          if ( v100 == -1 )
            sub_94708("This target does not support masked watchpoints.");
          if ( v100 == -2 )
            sub_94708("Invalid mask or memory region.");
        }
        v24 = 0;
LABEL_28:
        s1 = (char *)sub_93634(v113);
        v25 = sub_93638((unsigned __int8 *)s1);
        v26 = s1;
        v27 = v25;
        ...
        v28 = sub_C37FC(v24);
        ((void (__fastcall *)(int *, int))loc_15CFC8)(&v122, v28);
        v29 = v28;
        if ( v28 )
          v29 = 1;
        if ( !v24 )
          v29 = 0;
        if ( v29 && (sub_15FA54(&v127, v28), (v29 = sub_15CD80(v127, v128, v129, v130, v131)) != 0) )
        {
          v85 = ((int (__fastcall *)(int))loc_1602F0)(v28);
          v86 = ((int (__fastcall *)(int))loc_15FA08)(v28);
          v105 = (_DWORD *)sub_D03C8(v85, v86, 17, (int)&dword_4784E4);
          v87 = (int)v127;
          v88 = v128;
          v89 = v129;
          v90 = v130;
        ...
        *((_DWORD *)v31 + 5) = 3;
        ...
        if ( a3 )
        {
          ...
          *((_DWORD *)v31 + 35) = v119;
          v39 = sub_93168("-location %.*s", v9 - v8, v8);
        }
        else
        {
          v39 = sub_93358(v8, v9 - v8);
        }
        *((_DWORD *)v31 + 34) = v39;
        if ( v5 )
        {
          *((_DWORD *)v31 + 54) = v102;
          ...
          {
LABEL_50:
            *((_DWORD *)v31 + 25) = sub_93358(v40, v110 - (_BYTE *)v40);
            goto LABEL_51;
          }
        }
        else
        ...
        *((_DWORD *)v31 + 25) = v103;
LABEL_51:
        if ( sub_15CD80(v122, v123, v124, v125, v126) )
        {
          v41 = &dword_4878EC;
          v42 = v122;
          v43 = v123;
