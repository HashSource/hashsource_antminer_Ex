_DWORD *__fastcall sub_2F0C14(_DWORD *a1, int a2)
{
  const char *v2; // r4
  _DWORD *v3; // r9
  _DWORD *v4; // r5
  ...
  do
  {
    ...
    v8 = *(_DWORD *)(v7 + 444);
    if ( *(_DWORD *)(v8 + 8) == v50 && *(unsigned __int8 *)(*(_DWORD *)(v8 + 392) + 12) == v6 && sub_2AD7D4((int)v4, v2) )
    {
      v9 = (_DWORD *)v3[14];
      if ( v9 )
        goto LABEL_15;
LABEL_46:
      if ( *(_BYTE *)(*(_DWORD *)(v52 + 392) + 12) == 2 )
        ...
        v29 = 4;
      v51 = sub_2AD7D4((int)v4, ".note.gnu.property");
      if ( !v51 )
        sub_2A6BE4("elf-properties.c", 401);
      v30 = v3[4];
      if ( v30 > 0 )
      {
        v46 = sub_2F08BC((int)v4, 1u, v29);
        if ( v46[3] )
        {
...
LABEL_56:
          *((_DWORD *)v51 + 9) = v32;
          v35 = (char *)sub_2AD0C4((int)v4, v32);
          ...
          if ( v37 )
          {
            ...
            do
            {
              ...
              if ( v37[4] != 4 )
                sub_2A6C18((int)"elf-properties.c", 492, (int)"_bfd_elf_link_setup_gnu_properties");
              v42 = v37[2];
              if ( v42 == 4 )
              {
              ...
              {
                sub_2A6C18((int)"elf-properties.c", 473, (int)"_bfd_elf_link_setup_gnu_properties");
              }
              v37 = (_DWORD *)*v37;
              v39 = v40 & (v38 + v41 + v42);
            }
    ...
    if ( v10 )
    {
      ...
      if ( v4 )
      {
        ...
        if ( v16 )
        {
          ...
          {
LABEL_35:
            if ( sub_2F081C((int)v3, (int)v4, 0, v16 + 1) )
            {
              v23 = v16[1];
              if ( v23 == 2 )
                *(_BYTE *)(v4[40] + 2341) |= 0x20u;
              v24 = sub_2F08BC((int)v4, v23, v16[2]);
              if ( v24[3] )
                sub_2A6C18((int)"elf-properties.c", 301, (int)"elf_merge_gnu_property_list");
              v25 = v16[2];
              v26 = v16[3];
              v27 = v16[4];
              *v24 = v16[1];
...
LABEL_64:
          ...
          v19 = 0;
LABEL_28:
          sub_2F081C((int)v3, (int)v4, v13 + 1, v19);
          v21 = v13[4];
          v22 = v21 == 3;
          if ( v21 == 3 )
            v21 = *v13;
...
LABEL_41:
            ...
            {
LABEL_42:
              v28 = sub_2AD7D4((int)v9, ".note.gnu.property");
              if ( v28 )
