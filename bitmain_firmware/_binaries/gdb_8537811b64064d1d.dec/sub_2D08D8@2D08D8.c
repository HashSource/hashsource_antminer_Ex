int __fastcall sub_2D08D8(_DWORD *a1, int a2)
{
  int v3; // r11
  _DWORD *v4; // r5
  int *v5; // r10
...
LABEL_20:
  ...
  v27 = sub_2AB3DC(v26, 4u);
  base = v27;
  if ( !v27 )
    return 0;
  v28 = 0;
  v29 = sub_2A67CC((int)v4);
  v30 = (_DWORD *)v4[25];
  v31 = 0;
  v32 = 2 * ~(-1 << (v29 - 1)) + 1;
  if ( v30 )
  {
    ...
    while ( v30 );
    if ( v4[27] < v31 )
      sub_2A6BE4("elf.c", 4602);
  }
  qsort(v27, v31, 4u, (__compar_fn_t)sub_2CBBB4);
  v134[0] = 0;
  v37 = sub_2AD7D4((int)v4, ".interp");
  if ( v37 )
  {
    if ( (*((_DWORD *)v37 + 5) & 2) != 0 )
    {
      v123 = v37;
      v65 = sub_2AD0C4((int)v4, 0x2Cu);
      v66 = v65;
      if ( !v65 )
        goto LABEL_93;
      v67 = v65[32];
  ...
  if ( !v38 )
    v38 = 1;
  v130 = v38;
  v132 = sub_2AD7D4((int)v4, ".dynamic");
  if ( v132 )
  {
...
LABEL_96:
  ...
  if ( ((v4[10] >> 5) & 0x100) != 0 )
  {
    ...
    if ( v41 >= v40 )
    {
      v125 = (unsigned __int64)sub_34769C(v41, v130) >> 32;
      if ( v125 >= (unsigned __int64)sub_34769C(v40, v130) >> 32 )
      {
        v42 = s2;
        if ( (v41 & -v130) >= v28 )
          v42 = 1;
...
LABEL_61:
    if ( !v47(a2, v4, v49) )
      goto LABEL_62;
LABEL_113:
    v69 = sub_2CBC9C((int)v4, (int)base, v126, i, s2);
    if ( !v69 )
      goto LABEL_93;
    v70 = v122;
    v48 = v49[5];
...
LABEL_67:
  ...
  {
    v75 = sub_2CBC9C((int)v4, (int)base, v126, i, s2);
    if ( !v75 )
      goto LABEL_93;
    v76 = v122;
    v122 = v75;
  ...
  while ( 2 )
  {
    ...
    if ( (v64 & 2) != 0 && !strncmp(*(const char **)v60, ".note", 5u) )
    {
        ...
        && (*(_DWORD *)(v103 + 20) & 2) != 0 )
      {
        ...
        v72 = (unsigned int)sub_2AD0C4(v127, 4 * v105 + 40);
        v71 = (_DWORD *)v72;
        if ( !v72 )
          goto LABEL_93;
        *(_DWORD *)(v72 + 36) = v105;
...
LABEL_177:
  ...
  if ( v78 )
  {
    ...
    *((_DWORD *)v78 + 2) = 4;
    ...
    v83 = 0;
    sub_2A6A84("%B: TLS sections are not adjacent:", v127);
    v85 = v62;
    do
    {
      ...
      {
        ++v83;
        sub_2A6A84("\t    TLS: %A", v84);
      }
      else
      {
        sub_2A6A84("\tnon-TLS: %A", v84);
      }
      v85 = *(_DWORD *)(v85 + 12);
    }
    while ( v77 > v83 );
