int __fastcall sub_214A28(int *a1)
{
  bool v1; // zf
  __int64 v3; // r0
  __int64 v4; // r0
  ...
  if ( !v1 )
  {
    if ( !dword_4896DC )
      goto LABEL_10;
    sub_1B1444(v41, "_ovly_table", 0, 0);
    if ( !v41[0] )
      goto LABEL_44;
    v5 = *(__int16 *)(v41[0] + 22);
    v6 = *(_DWORD *)(v41[0] + 8);
    if ( v5 == -1 )
    {
      v3 = sub_94728((int)"symfile.c", 3578, "Section index is uninitialized", v6);
      v38 = *(_DWORD *)(HIDWORD(v3) + 148);
      if ( (*(_DWORD *)(HIDWORD(v3) + 20) & 4) != 0 )
      {
        v39 = HIDWORD(v3);
        sub_2ADD24(v38, sub_210B30, 0);
        LODWORD(v3) = sub_2AE0B4(v38, v39);
      }
      return v3;
    }
    if ( v6 + *(_DWORD *)(*(_DWORD *)(v41[1] + 144) + 4 * v5) == dword_4896E0 )
    {
      v29 = *a1;
      v30 = sub_1B7278(a1[1]);
      v31 = ((int (*)(void))loc_165F08)();
      v32 = ((int (__fastcall *)(int))loc_165BE0)(v30);
      LODWORD(v3) = dword_4896DC;
      if ( dword_4896E4 )
      {
        v33 = 0;
        ...
        sub_2114C8(dword_4896E0 + v33 * (v31 / 8), v34, 4, v31 / 8, v32);
        LODWORD(v3) = dword_4896DC;
...
LABEL_10:
  ...
  dword_4896DC = 0;
  dword_4896E0 = 0;
  sub_1B1444(v42, "_novlys", 0, 0);
  v8 = v42[0];
  if ( !v42[0] )
    goto LABEL_42;
  sub_1B1C10(&v43, "_ovly_table");
  v9 = v43;
  v10 = v44;
  if ( !v43 )
LABEL_44:
    sub_94708(
      ...
      HIDWORD(v4));
  v11 = sub_1B7278(v44);
  v12 = ((int (*)(void))loc_165F08)();
  v13 = v11;
  v14 = v12 / 8;
  v15 = ((int (__fastcall *)(int))loc_165BE0)(v13);
  v16 = *(__int16 *)(v8 + 22);
  v17 = v15;
  if ( v16 == -1 )
  {
    v4 = sub_94728((int)"symfile.c", 3502, "Section index is uninitialized");
    goto LABEL_44;
  }
  dword_4896E4 = sub_FA948(*(_DWORD *)(v8 + 8) + *(_DWORD *)(*(_DWORD *)(v42[1] + 144) + 4 * v16), 4, v15);
  v18 = (unsigned int *)sub_93050(16 * dword_4896E4);
  v19 = *(__int16 *)(v9 + 22);
  dword_4896DC = (int)v18;
  if ( v19 == -1 )
  {
    v7 = sub_94728((int)"symfile.c", 3506, "Section index is uninitialized");
LABEL_42:
    sub_94708(
  ...
  LODWORD(v3) = sub_2114C8(dword_4896E0, v18, 4 * dword_4896E4, v14, v17);
