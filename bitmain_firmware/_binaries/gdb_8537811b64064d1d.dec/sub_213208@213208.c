char *__fastcall sub_213208(int a1, const char *a2, unsigned int a3, _DWORD *a4, int a5, int a6)
{
  unsigned int v9; // r5
  unsigned int v10; // r6
  int v11; // r8
...
LABEL_8:
  ...
  if ( v13 )
    goto LABEL_12;
LABEL_49:
  if ( !sub_25A40C("Load new symbol table from \"%s\"? ", a2) )
    sub_94708("Not confirmed.");
LABEL_50:
  v11 |= 0x20u;
LABEL_13:
  v14 = (char *)sub_98394(0xD8u);
  ((void (__fastcall *)(char *, int, const char *, int))loc_1B6F04)(v14, a1, a2, v11);
  if ( a6 )
    ((void (__fastcall *)(char *, int))loc_1B74C0)(v14, a6);
  if ( v9 )
  {
    if ( !off_4896D0 )
      goto LABEL_75;
  ...
  {
    a2 = (const char *)(v10 & 4);
    v15 = sub_211A7C(*(_DWORD *)(*((_DWORD *)v14 + 9) + 4));
    ((void (__fastcall *)(char *, int))loc_217784)(v14, v15);
    if ( !*((_DWORD *)v14 + 33) )
      break;
    ...
    else
    {
      ...
      *a4 = 0;
      ...
      a4[2] = 0;
      a4[3] = 0;
      sub_92564((int)sub_210C10, (int)a4);
      v16 = a4;
    }
    if ( (v10 & 4) == 0 )
      goto LABEL_23;
    sub_92564((int)sub_213200, 0);
...
LABEL_23:
      if ( *a4 )
        ((void (__fastcall *)(_DWORD *, _DWORD))loc_212050)(a4, *((_DWORD *)v14 + 9));
      (*(void (__fastcall **)(char *))(*((_DWORD *)v14 + 33) + 4))(v14);
      sub_F4444(&off_46D334, 1, v10 & 2);
...
LABEL_75:
    sub_259880("Reading symbols from %s...", a2);
    v36 = sub_259B80("");
    v37 = (_DWORD *)sub_242FB4(v36);
    sub_256834(*v37);
  }
  v26 = sub_163074(*((_DWORD *)v14 + 9));
  v27 = *((_DWORD *)v14 + 16);
  v28 = 4 * v26;
  v29 = *((_DWORD *)v14 + 15);
  *((_DWORD *)v14 + 37) = v26;
...
LABEL_31:
  ...
  sub_259880("expanding to full symbols...");
  v24 = sub_259B80("");
  v25 = (_DWORD *)sub_242FB4(v24);
  sub_256834(*v25);
  v18 = *((_DWORD *)v14 + 33);
  if ( v18 )
  {
...
LABEL_32:
  ...
  if ( *((_DWORD *)v14 + 33) )
  {
    ...
    sub_F4444(&off_46D334, 0, v10 & 2);
    v20 = sub_1B96B4((int)v14);
    sub_2A8F8C(v20);
    return v14;
  }
  else
