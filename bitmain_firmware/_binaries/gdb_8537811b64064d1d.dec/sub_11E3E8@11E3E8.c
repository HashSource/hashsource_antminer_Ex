int __fastcall sub_11E3E8(__int64 a1, int a2, int a3, _DWORD *a4)
{
  int v5; // lr
  const char *v6; // r3
  int v7; // r12
...
LABEL_6:
    ...
    a1 = sub_94728((int)"dwarf2read.c", 19222, "read_address: bad switch, unsigned [in module %s]", v6);
    goto LABEL_10;
  }
  if ( v7 == 4 )
  {
  ...
  if ( v7 != 8 )
  {
    ...
    a1 = sub_94728((int)"dwarf2read.c", 19203, "read_address: bad switch, signed [in module %s]", (const char *)a1);
    goto LABEL_6;
  }
LABEL_10:
