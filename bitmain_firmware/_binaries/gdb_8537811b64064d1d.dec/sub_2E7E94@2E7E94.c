int __fastcall sub_2E7E94(int a1, int a2)
{
  int v2; // r5
  int v3; // r4
  int v4; // r6
  ...
  if ( *(_DWORD *)(*(_DWORD *)(a2 + 28) + 40) == 1 )
  {
    ...
    if ( !*(_DWORD *)(*(_DWORD *)(v2 + 28) + 48) && (*(_BYTE *)(v4 + 467) & 8) == 0 )
      return 1;
    v6 = sub_2DBD14(v3, (char *)v2, &v101);
    v7 = *(_DWORD *)(v2 + 28);
    v8 = v6;
    if ( !*(_DWORD *)(v7 + 48) )
      return 1;
    v9 = *(_DWORD *)(v7 + 56);
    v10 = sub_2AD88C(v9, ".gnu.version");
    if ( !v10 )
      sub_2A6BE4("elflink.c", 6981);
    if ( ((unsigned int)v10[5] & 0x8000) == 0 )
    {
      v10[9] = (const char *)(2 * v8);
      v36 = (const char *)sub_2AD0C4(v3, 2 * v8);
      v10[27] = v36;
      if ( !v36 || !sub_2E30A0(v2, 1879048176, 0) )
        return 0;
    }
    v11 = *(_DWORD *)(*(_DWORD *)(v2 + 28) + 268);
    if ( !v11 )
      sub_2A6BE4("elflink.c", 7000);
    v12 = v8 * *(unsigned __int8 *)(*(_DWORD *)(v4 + 392) + 5);
    *(_DWORD *)(v11 + 36) = v12;
    v13 = (void *)sub_2ACC1C(v3, v12);
    *(_DWORD *)(v11 + 108) = v13;
    if ( !v13 )
      return 0;
    ...
    *(_DWORD *)(*(_DWORD *)(v2 + 28) + 100) = 0;
    if ( (v15 & 2) != 0 )
    {
      ...
      s[0] = v34;
      s[1] = 0;
      sub_2FCBFC(v35, sub_2DD594, s, v33);
      if ( s[1] )
      {
        free(v34);
        return 0;
      ...
      v46 = (s[0] - (int)v34) >> 2;
      v47 = sub_2DD00C(v2, (int *)v34, v46, 0);
      free(v34);
      v48 = v46;
      if ( v46 )
        v48 = 1;
      ...
      *(_DWORD *)(*(_DWORD *)(v2 + 28) + 100) = v47;
      v49 = sub_2AD88C(v9, ".hash");
      if ( !v49 )
        sub_2A6BE4("elflink.c", 7055);
      v50 = *((_DWORD *)v49[35] + 10);
      v51 = v50 * (v8 + 2 + v47);
      v49[9] = (const char *)v51;
      v52 = (char *)sub_2AD0C4(v3, v51);
      v49[27] = v52;
      if ( !v52 )
        return 0;
      v53 = 8 * v50;
      ...
      else
      {
        switch ( v53 )
        {
          ...
          case 64:
            ...
            break;
          default:
            sub_2A6C18((int)"elflink.c", 7062, (int)"bfd_elf_size_dynsym_hash_dynstr");
        }
      }
      v15 = *(_BYTE *)(v2 + 4);
    }
    ...
    {
LABEL_28:
      n = sub_2AD88C(v9, ".dynstr");
      if ( !n )
        sub_2A6BE4("elflink.c", 7237);
      v26 = *(_DWORD *)(v2 + 28);
      v27 = *(_DWORD *)(v26 + 84);
      v28 = *(_DWORD *)(v26 + 56);
      v92 = v26;
      ...
      v30 = sub_2AD88C(v28, ".dynamic");
      if ( !v30 )
        sub_2A6BE4("elflink.c", 3529);
...
LABEL_55:
      ...
      for ( i = *(_DWORD **)(v92 + 196); i; i = (_DWORD *)*i )
        i[6] = sub_2F0508(v27);
      sub_2FCBFC(v92, sub_2DD76C, v27, v37);
      v39 = *(_DWORD *)(v3 + 160);
      if ( *(_DWORD *)(v39 + 568) )
      {
        v43 = sub_2AD88C(v28, ".gnu.version_d")[27];
        do
        {
          v44 = (int)v43;
          v43 += 20;
          sub_2CD350(v3, v44, (int)s);
          if ( s[3] == 20 && HIWORD(s[1]) )
          {
            ...
            {
              ++v45;
              sub_2CD490(v3, (int)v43, v102);
              v102[0] = sub_2F0508(v27);
              sub_2CD4CC(v3, v102, (int)v43);
              v43 += 8;
            }
      ...
      if ( *(_DWORD *)(v39 + 580) )
      {
        v40 = sub_2AD88C(v28, ".gnu.version_r")[27];
        do
        {
          sub_2CD508(v3, (int)v40, (int)s);
          s[1] = sub_2F0508(v27);
          sub_2CD580(v3, (unsigned __int16 *)s, (int)v40);
          v40 += 16;
          if ( HIWORD(s[0]) )
          {
            v41 = 0;
            ...
            {
              ++v41;
              sub_2CD5F8(v3, (int)v40, (int)v102);
              v102[2] = sub_2F0508(v27);
              sub_2CD670(v3, (int)v102, (int)v40);
              v40 += 16;
            }
      ...
      v42 = 0;
      n[9] = (const char *)sub_2F04F4(*(_DWORD *)(*(_DWORD *)(v2 + 28) + 84));
      while ( sub_2E30A0(v2, 0, 0) )
      {
    ...
    s[1] = v4;
    s[10] = -1;
    sub_2FCBFC(v18, sub_2DD66C, s, v17);
    if ( s[17] || (v19 = sub_2DD00C(v2, (int *)s[4], s[2], 1)) == 0 )
    {
LABEL_73:
      free((void *)s[4]);
      return 0;
    }
    v91 = sub_2AD88C(v9, ".gnu.hash");
    if ( !v91 )
      sub_2A6BE4("elflink.c", 7109);
    v20 = s[2];
    if ( !s[2] )
    {
      if ( s[10] != -1 )
        sub_2A6BE4("elflink.c", 7114);
      free((void *)s[4]);
      v21 = (*(unsigned __int8 *)(*(_DWORD *)(v4 + 392) + 10) >> 3) + 20;
      v91[9] = (const char *)v21;
      v22 = (char *)sub_2AD0C4(v3, v21);
      v23 = v22;
      if ( v22 )
      {
        v24 = *(_DWORD *)(v3 + 4);
        ...
        switch ( v25 )
        {
          ...
          case 64:
            ...
            break;
          default:
            sub_2A6C18((int)"elflink.c", 7130, (int)"bfd_elf_size_dynsym_hash_dynstr");
        }
...
LABEL_106:
    ...
    if ( v62 )
    {
      ...
      while ( v74 != v71 );
      if ( v73 != v8 )
        sub_2A6BE4("elflink.c", 7187);
      s[11] = v19;
      s[13] = s[10];
      v76 = (s[3] >> 3) + 4 * (s[2] + 4 + v19);
      v91[9] = (const char *)v76;
      v77 = (char *)sub_2AD0C4(v3, v76);
      v78 = v77;
      if ( v77 )
      {
        v79 = *(_DWORD *)(v3 + 4);
        ...
        v85 = *(_DWORD *)(v2 + 28);
        s[9] = v99 + nb;
        sub_2FCBFC(v85, sub_2DC69C, s, v99 + nb);
        v86 = v91[27] + 16;
        if ( v94 )
        {
          v87 = 0;
          ...
          do
          {
            switch ( v88 )
            {
              ...
              case 0x40u:
                ...
                break;
              default:
                sub_2A6C18((int)"elflink.c", 7227, (int)"bfd_elf_size_dynsym_hash_dynstr");
            }
            ++v87;
            v88 = *(unsigned __int8 *)(*(_DWORD *)(v4 + 392) + 10);
            v86 += v88 >> 3;
