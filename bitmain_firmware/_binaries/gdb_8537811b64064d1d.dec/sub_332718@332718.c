unsigned int __fastcall sub_332718(unsigned int result, int *a2, int a3)
{
  int v3; // r12
  ...
  if ( v3 <= 49 )
  {
    v5 = 2 * (byte_438B54[v3] + 0x7FFFFFFF);
...
LABEL_23:
  if ( v3 <= 49 )
    v22 = 2 * (byte_438B54[v3] + 0x7FFFFFFF);
  else
