int __fastcall sub_287704(int a1)
{
  int v1; // r1
  int v2; // r4
  bool v3; // zf
  ...
  v3 = dword_48AAD0 == (_DWORD)sub_287704;
  if ( (int (*)())dword_48AAD0 != sub_287704 )
    v3 = dword_48AAD0 == (_DWORD)sub_287BA0;
  v4 = a1;
  ...
  *(_DWORD *)(v2 + 8) = 0;
  if ( !v11 )
  {
    ...
    if ( !v11 )
      v11 = (int (__fastcall *)(const char *, signed int))sub_284C44;
  }
  *(_DWORD *)(v2 + 0xC4) = 0;
  v12 = dword_4900D8;
  v44 = 0;
  ...
  *(_DWORD *)(v2 + 0xC0) = v12;
  if ( v12 )
  {
    v33 = sub_286258(&v44, &dword_48AD78);
    v12 = dword_4900D8;
    *(_BYTE *)(v2 + 0xC8) = v33;
    v13 = *(_DWORD *)(v2 + 0xC0);
  }
  ...
  *(_DWORD *)(v2 + 0xCC) = v12;
  dword_4900D8 = v13;
  v14 = (const char *)sub_2912D0(v12, v13);
  v15 = *(_DWORD *)(v2 + 0xC0);
  v16 = *(_DWORD *)(v2 + 0xCC);
  v42 = v44;
  v43 = *(unsigned __int8 *)(v2 + 0xC8);
  *(_DWORD *)(v2 + 0xB0) = v14;
  v17 = (const char **)sub_286D30(v14, v16, v15, v11, v42, v43);
  *(_DWORD *)(v2 + 0xB4) = v17;
  if ( !v17 )
  {
    *(_DWORD *)(v2 + 0xD0) = 0;
LABEL_27:
  ...
  {
    *(_DWORD *)(v2 + 0xD0) = 1;
    if ( !sub_285C48((const char ***)&dword_48AD68, v20) )
      goto LABEL_27;
  }
  else
  {
  ...
  *(_DWORD *)(v2 + 0xB8) = v30;
  if ( v31 )
  {
    if ( v25[1] )
      ...
      v35 = 1;
    sub_285FA8((const char *)a1, *(_DWORD *)(v2 + 0xCC), v35, &byte_48AD7C);
...
LABEL_6:
  if ( *(_DWORD *)(v2 + 0xB4) && (v1 = *(_DWORD *)(v2 + 0xB8)) != 0 )
  {
    ...
    *(_DWORD *)(v2 + 0xBC) = v5;
    if ( v5 || *(int *)(v2 + 0xB8) <= 1 )
    {
      sub_285FA8(*(const char **)(*(_DWORD *)(v2 + 0xB4) + 4 * v5), *(_DWORD *)(v2 + 0xCC), 1, &byte_48AD7C);
      v6 = *(const char **)(*(_DWORD *)(v2 + 0xB4) + 4 * *(_DWORD *)(v2 + 0xBC));
      v7 = strcmp(*(const char **)(v2 + 0xB0), v6);
      sub_2849C8((int)v6, *(_DWORD *)(v2 + 0xC4), *(unsigned __int8 *)(v2 + 0xC8), v7);
    }
    else
    {
      sub_2945F0(0, v1);
      sub_285FA8(**(const char ***)(v2 + 0xB4), *(_DWORD *)(v2 + 0xCC), 2, &byte_48AD7C);
    }
    *(_DWORD *)(v2 + 0x50) = 1;
    return 0;
  }
