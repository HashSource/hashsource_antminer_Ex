int __fastcall sub_2C23FC(int a1, int a2, _DWORD *a3, int a4)
{
  _DWORD *v4; // r9
  int v6; // r12
  int v7; // r12
  ...
  if ( v8[39] )
  {
    ...
    for ( i = *(_DWORD *)(*(_DWORD *)(a1 + 4) + 8) ? 0 : 3; v10; v10 = (_DWORD *)*v10 )
    {
      ...
      {
        if ( v17 != 2 )
          sub_2A6C18((int)"elf32-arm.c", 18390, (int)"elf32_arm_write_section");
        v12 = v10[2];
        ...
        if ( v14 )
        {
          sub_2A6A84("%B: error: VFP11 veneer out of range", a1);
          v12 = v10[2];
        }
        v15 = *(_DWORD *)(v12 + 12);
        *(_BYTE *)(a4 + (i ^ v19)) = v15;
  ...
  if ( src[41] )
  {
    ...
    if ( v24 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v32 != 1 )
          sub_2A6C18((int)"elf32-arm.c", 18473, (int)"elf32_arm_write_section");
        v26 = v24[2];
        v27 = *(_DWORD *)(v26 + 4) - v33 - 4;
        if ( v27 < 0x1000000 )
          break;
        sub_2A6A84("%B: error: Cannot create STM32L4XX veneer.", a1);
LABEL_39:
        v24 = (_DWORD *)*v24;
        if ( !v24 )
        {
      ...
      if ( (v28 & 0xFFD02000) != 0xE8900000 )
      {
        if ( (v28 & 0xFFD02000) != 0xE9100000 )
        {
          ...
          if ( (unsigned __int8)v28 <= 8u )
          {
            ...
            sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v28, (_BYTE *)(v138 + v34));
            if ( v107 + 0x1000000 >= 0x2000000 )
              sub_2A6BE4("elf32-arm.c", 17577);
            v155 = v29 + 8;
            sub_2B7314(
              *(_DWORD *)(v25 + 364),
              *(_DWORD *)(a1 + 4),
          ...
          else
          {
            ...
            while ( 1 )
            {
              ...
              sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v72 | v69 | v70 | v71 & 0xF000 | v68, v63);
              if ( v67 == v66 )
                break;
              v63 += 4;
            }
        ...
        v48 = sub_347FD8((unsigned __int16)v28);
        v49 = v48;
        if ( v48 <= 8 )
        {
          v106 = v27 - 4;
          sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v28, v29);
        ...
        {
          v147 = v48;
          sub_2A6BE4("elf32-arm.c", 17941);
          v49 = v147;
        }
        if ( (v28 & 0xC000) == 0xC000 )
        {
          v152 = v49;
          sub_2A6BE4("elf32-arm.c", 17944);
          v49 = v152;
        }
        ...
        else if ( !(v51 | v153) )
        {
          ...
          v55 = v54 | (8 * v148);
          v54 <<= 16;
          sub_2B72EC(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v55 | 0x4600, v29);
          sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v156 | 0xE9300000 | v54, v29 + 2);
          v56 = v53 | 0xE9100000 | v54;
          v57 = v139 - (_DWORD)(v29 + 10);
          sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v56, v29 + 6);
        ...
        if ( (v52 & (v50 ^ 1)) != 0 )
        {
          if ( !v51 )
          {
            ...
            sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v156 | v128, v29);
            sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v53 | v128, v29 + 4);
...
LABEL_201:
            ...
            else
            {
              ...
              v132 = v131 | (8 * v148);
              v148 = v131;
              sub_2B72EC(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v132 | 0x4600, v29);
            }
            sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v156 | 0xE9300000 | (v148 << 16), v130);
            v133 = v139 - (_DWORD)(v130 + 8);
            sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v53 | 0xE9100000 | (v148 << 16), v130 + 4);
            ...
            if ( (v52 & v50) != 0 )
            {
              ...
              sub_2B72EC(
                ...
                *(_DWORD *)(a1 + 4),
                ...
                v29 + 4);
              sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v53 | 0xE8B00000 | (v127 << 16), v29 + 6);
              sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v156 | 0xE8900000 | (v127 << 16), v29 + 10);
              v47 = v29 + 14;
LABEL_81:
              v46 = (unsigned int)(v29 + 16);
              goto LABEL_70;
...
LABEL_176:
            v120 = v118 << 16;
            sub_2B7314(v116, v115, v117 | (v118 << 8), v119);
            sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v53 | 0xE8B00000 | v120, v29 + 4);
            sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v156 | 0xE8900000 | v120, v29 + 8);
            v47 = v29 + 12;
            goto LABEL_81;
          }
        }
...
LABEL_200:
      ...
      if ( sub_347FD8((unsigned __int16)v28) <= 8 )
      {
        v105 = v29 + 4;
        sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v28, v29);
        if ( !v146 )
      ...
      if ( (v28 & 0x2000) != 0 )
        sub_2A6BE4("elf32-arm.c", 17798);
      if ( (v28 & 0xC000) == 0xC000 )
        sub_2A6BE4("elf32-arm.c", 17801);
      v38 = HIWORD(v28) & 0xF;
      v39 = v28 & 0xDF80;
      v40 = v28 & 0x7F;
      if ( ((v28 >> 21) & 1 & ((int)(unsigned __int16)v28 >> (BYTE2(v28) & 0xF))) != 0 )
      {
        sub_2A6BE4("elf32-arm.c", 17804);
        v108 = *(_DWORD *)(a1 + 4);
        v109 = *(_DWORD *)(v25 + 364);
      }
      else
      {
        ...
        if ( v28 >> 21 == 1860 )
        {
          ...
          else
          {
            ...
            v43 = v29 + 2;
            sub_2B72EC(v41, v42, v125 | 0x4600 | v38 & 7 | ((unsigned __int16)(v38 >> 3) << 7), v29);
            v41 = *(_DWORD *)(v25 + 364);
            v42 = *(_DWORD *)(a1 + 4);
          }
          v44 = v38 << 16;
          sub_2B7314(v41, v42, v40 | 0xE8B00000 | v44, v43);
          sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v39 | 0xE8900000 | v44, v43 + 4);
          v45 = v43 + 8;
          if ( !v146 )
          {
      ...
      v45 = v29 + 8;
      sub_2B7314(v109, v108, v40 | v110, v29);
      sub_2B7314(*(_DWORD *)(v25 + 364), *(_DWORD *)(a1 + 4), v39 | v110, v29 + 4);
      if ( !v146 )
      {
...
LABEL_69:
      ...
      v47 = v45;
LABEL_70:
      sub_2B736C(v25, a1, (char)v29, v47, v46);
      goto LABEL_39;
    }
  }
LABEL_51:
  if ( src[1] != 1879048193 )
  {
    if ( v4[95] )
    {
      v166[0] = a3;
      v166[1] = a4;
      sub_2AAFB8((int)(v4 + 313), (int (__fastcall *)(_DWORD *, int))sub_2B2A94, (int)v166);
    }
    if ( nmemb )
    {
      if ( v4[91] )
      {
        v91 = 0;
        v92 = 3 - a4;
        qsort(ptr, nmemb, 8u, (__compar_fn_t)sub_2B5F28);
        v95 = *ptr;
        v96 = ptr;
        v97 = nmemb - 1;
        do
...
LABEL_111:
  ...
  do
  {
    ...
    v80 += 8;
    sub_2B5F68(a1 + 4, v90, v89, v73);
  }
  while ( v78 > v80 );
LABEL_125:
  if ( (a3[5] & 0x8200) == 0 )
    sub_2ADE10(a1, (_DWORD *)a3[15], srca, 0, (unsigned int)a3[14], a3[9]);
  return 1;
}
