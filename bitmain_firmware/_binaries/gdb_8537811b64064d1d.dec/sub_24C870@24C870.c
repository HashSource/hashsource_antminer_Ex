void __fastcall sub_24C870(const char *a1, int a2)
{
  int v3; // r3
  void *v5; // r0
  char *v6; // r6
...
LABEL_8:
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      v10 = strchr(v9, 58);
      if ( !v10 )
        sub_94708("Malformed trace status, at %s\nStatus line: '%s'\n", v9, a1);
      v6 = strchr(v9, 59);
      if ( !v6 )
      ...
      if ( !v12 )
      {
        v6 = (char *)sub_991B0(v13, (unsigned int *)&v34);
        *(_DWORD *)(a2 + 12) = 3;
        goto LABEL_8;
      }
      ...
      {
        v28 = sub_991B0(v13, (unsigned int *)&v34);
        HIDWORD(v29) = v34;
        LODWORD(v29) = 5;
        v6 = (char *)v28;
        *(_QWORD *)(a2 + 12) = v29;
      ...
      if ( !v16 )
      {
        ...
        else
        {
          ...
          *(_DWORD *)(a2 + 20) = v18;
          v20 = v15 - v13;
          v13 = v15;
          sub_99220(v19, v18, v20 / 2)[*(_DWORD *)(a2 + 20)] = 0;
        }
      }
      v21 = sub_991B0(v13 + 1, (unsigned int *)&v34);
      *(_DWORD *)(a2 + 12) = 2;
      v9 = (const char *)(v21 + 1);
      if ( !*v21 )
        return;
    ...
    else if ( !strncmp(v9, off_46DD10, v11) )
    {
      ...
      else
      {
        ...
        v25 = sub_93050(v24 + 1);
        *(_DWORD *)(a2 + 20) = v25;
        sub_99220(v13, v25, v24)[*(_DWORD *)(a2 + 20)] = 0;
      }
      v26 = sub_991B0((unsigned __int8 *)v23 + 1, (unsigned int *)&v34);
      HIDWORD(v27) = v34;
      LODWORD(v27) = 6;
      v6 = (char *)v26;
      *(_QWORD *)(a2 + 12) = v27;
    ...
    else if ( !strncmp(v9, "username", v11) )
    {
      ...
      v31 = sub_93050(v30 >> 1);
      *(_DWORD *)(a2 + 48) = v31;
      sub_99220(v13, v31, (v6 - (char *)v13) / 2)[*(_DWORD *)(a2 + 48)] = 0;
    }
    else if ( !strncmp(v9, "notes", v11) )
    {
      ...
      v33 = sub_93050(v32 >> 1);
      *(_DWORD *)(a2 + 52) = v33;
      sub_99220(v13, v33, (v6 - (char *)v13) / 2)[*(_DWORD *)(a2 + 52)] = 0;
    }
    else
    {
