void __fastcall sub_FB484(int a1, int a2, const char *a3, size_t a4, int a5, const char *a6, int a7)
{
  size_t v8; // r10
  int v11; // r3
  int v12; // r0
  ...
  sub_93200((char **)&v27, "%s/%ld", a3, v13);
  v19 = ptr;
  if ( v27 == (char *)v28 + 4 )
  {
    sub_33B4B4(&ptr, &v27);
...
LABEL_29:
  ...
  *v19 = 0;
  ...
  v29 = (const char *)ptr;
LABEL_11:
  v15 = sub_2AD7D4(dword_47ACB8, a3);
  v16 = v15;
  if ( v15 )
  {
    n = *(_DWORD *)(v15 + 36);
    if ( v8 > n )
    {
      sub_946D8("Section `%s' in core file too small.", v29);
    }
    else
    {
      if ( v8 == n )
        ...
        v18 = v23 ^ 1;
      if ( v18 )
        sub_946D8("Unexpected size of section `%s' in core file.", v29);
      if ( sub_2ADF04(dword_47ACB8, v16, dest, 0, 0, 0, n) )
      {
        if ( a2 )
        {
      ...
      {
        sub_946D8("Couldn't read %s registers from `%s' section in core file.", a6, v29);
      }
    }
  }
  else if ( a7 )
  {
    sub_946D8("Couldn't find %s registers in core file.", a6);
  }
  if ( ptr != (char *)v31 + 4 )
    sub_339E8C(ptr);
}
