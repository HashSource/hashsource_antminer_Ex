int __fastcall sub_330878(int a1, int a2, int a3, int *a4, char a5, int *a6)
{
  int v6; // r6
  int v8; // r12
  int v9; // r10
  ...
  if ( ((v6 | v8) & 0x70) == 0 )
  {
    ...
    if ( *(_WORD *)(a2 + 10) || v15 != 1 || (v6 & 0x70) != 0 )
    {
      ...
      if ( v18 <= 0 )
      {
        ...
        if ( v18 )
        {
          v17 = sub_328484((char *)(a1 + 10), *(_DWORD *)a1, -v18);
          v26 = *(_DWORD *)(a1 + 4);
          *(_DWORD *)a1 = v17;
          v16 = v18 + v26;
          *(_DWORD *)(a1 + 4) = v16;
      ...
      else
      {
        ...
        *(_DWORD *)(a1 + 4) = v27;
        ...
        v29[5] = v22;
        v29[6] = v23;
        sub_328A28(a1, v29, (unsigned __int16 *)(a2 + 10), v15, &v28, a6);
        LODWORD(v24) = v28;
        if ( v28 )
        {
          HIDWORD(v24) = a6;
          sub_329138(a1, v29, v24);
        }
        v16 = *(_DWORD *)(a1 + 4);
        v28 = 0;
        v17 = *(_DWORD *)a1;
        if ( v13 < v16 )
        {
          ...
          v17 = sub_328484((char *)(a1 + 10), *(_DWORD *)a1, 1);
          v25 = *(_DWORD *)(a1 + 4);
          *(_DWORD *)a1 = v17;
          v16 = v25 - 1;
          *(_DWORD *)(a1 + 4) = v16;
    ...
    if ( a4[1] - v17 + 1 >= v16 )
    {
      sub_3295C0((_DWORD *)a1, a4, &v28, a6);
      *a6 &= ~0x2000u;
      return a1;
    }
LABEL_4:
