int __fastcall sub_589DC(int a1, int a2, const char *a3)
{
  int v6; // r8
  const char *i; // r0
  unsigned int v8; // r3
  ...
  for ( i = a3; ; i = v11 + 1 )
  {
    ...
    if ( !strncmp(v10, "$arg", 4u) )
    {
      ...
      if ( !v9 )
      {
        ...
        sub_33C348(a1, a3, v11 - a3);
        if ( v11[4] == 99 )
        {
          sub_59668(endptr, vsnprintf, 16, "%u", (*(_DWORD *)(a2 + 28) - *(_DWORD *)(a2 + 24)) >> 3);
          sub_33C348(a1, endptr[0], endptr[1]);
          if ( endptr[0] != &v20 )
            sub_339E8C(endptr[0]);
          a3 = v11 + 5;
        }
          ...
          *v14 = 0;
          ...
          if ( (v15 || a3 != endptr[0]) && !*v14 )
          {
            ...
            if ( v15 >= (HIDWORD(v16) - (int)v16) >> 3 )
              sub_94708("Missing argument %ld in user function.", v15);
            v17 = *(_DWORD *)(v16 + 8 * v15);
            v18 = *(_DWORD *)(v16 + 8 * v15 + 4);
            if ( 0x7FFFFFFF - *(_DWORD *)(a1 + 4) < v18 )
              sub_33D1AC("basic_string::append");
            sub_33C348(a1, v17, v18);
            a3 = endptr[0];
          }
        }
        v6 = *(_DWORD *)(a1 + 4);
