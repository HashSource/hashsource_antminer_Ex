void __fastcall sub_D1510(_DWORD *a1)
{
  int v2; // r7
  void *v3; // r3
  _BYTE *v4; // r4
  ...
  v2 = dword_487D2C;
  ((void (__fastcall *)(void **, _DWORD *, _DWORD, int, _DWORD *))loc_D0964)(&v10, a1, a1[19], dword_487D2C, v8);
  v4 = (_BYTE *)v8[0];
  v5 = a1[21];
  if ( v8[0] )
  {
  ...
  if ( v5 )
  {
    ((void (__fastcall *)(void **, _DWORD *, int, int, _DWORD *))loc_D0964)(&ptr, a1, v5, v2, v8);
    v7 = ptr;
    if ( v8[0] )
    {
  ...
  sub_D0F34(a1, v2, v6, v9, (int *)v7, v5);
  if ( v10 )
    sub_339E8C(v10);
  if ( v7 )
    sub_339E8C(v7);
