int __fastcall sub_1AE708(int a1, int a2, int a3)
{
  int v6; // r7
  int v7; // r1
  int v8; // r3
  ...
  *(_DWORD *)(a1 + 56) = v14;
  if ( !(*(int (__fastcall **)(int, int, _DWORD *))(a2 + 120))(v6, a3, v10) )
  {
    ...
    sub_94708("Error reading ECOFF debugging information: %s", v17);
  }
  sub_1AE5E0((int)v18, a1, a2, v10);
  sub_1B2D1C(v18);
  return sub_1B25AC(v18);
}
