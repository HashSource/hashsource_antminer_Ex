int __fastcall sub_226CA8(int a1, int a2)
{
  _DWORD *v3; // r0
  int v4; // r5
  _DWORD *v5; // r0
  ...
  sub_2594D8(*v3, "-> %s->to_upload_trace_state_variables (...)\n", (const char *)dword_489C90);
  v4 = off_489EBC(&unk_489C8C, a2);
  v5 = (_DWORD *)sub_242FF0(v4);
  sub_2594D8(*v5, "<- %s->to_upload_trace_state_variables (", (const char *)dword_489C90);
