int __fastcall sub_2AF264(_DWORD *a1)
{
  char *v2; // r3
  int v3; // t1
  _DWORD *v4; // r0
  ...
  if ( sub_2A8A2C((int)a1, 0, 0) )
    return 0;
  if ( sub_2A8800((int)&v49, 9u, (int)a1) == 9 )
  {
    if ( v49 == 58 )
    {
      v2 = v50;
      while ( 1 )
      {
        ...
        if ( &v51 == v2 )
        {
          if ( (unsigned __int8)aCccccccccccccc[v50[7]] + 16 * (unsigned int)(unsigned __int8)aCccccccccccccc[v50[6]] > 5 )
            goto LABEL_23;
          v36 = a1[40];
          v4 = (_DWORD *)sub_2ACC1C((int)a1, 8);
          if ( !v4 || (a1[40] = v4, *v4 = 0, v4[1] = 0, sub_2A8A2C((int)a1, 0, 0)) )
          {
LABEL_17:
            v8 = a1[40];
            v9 = v8 == v36;
          ...
          else
          {
            ...
            v44 = 0;
            format = ".sec%d";
            while ( sub_2A8800((int)s, 1u, (int)a1) == 1 )
            {
              ...
              if ( s[0] != 13 )
              {
                ...
                else
                {
                  ...
                  {
LABEL_43:
                    sub_2AF1C8((int)a1, v7, v11, 0);
                    goto LABEL_15;
                  }
                  LODWORD(v38) = sub_2A8934((int)a1);
                  HIDWORD(v38) = v12;
                  if ( sub_2A8800((int)v47, 8u, (int)a1) != 8 )
                    goto LABEL_15;
                  ...
                  if ( v16 >= v5 )
                  {
                    v6 = (unsigned __int8 *)sub_2AB424(v6, 2 * (v15 + 1));
                    if ( !v6 )
                      goto LABEL_17;
                    v5 = 2 * (v15 + 1);
                  }
                  if ( v16 != sub_2A8800((int)v6, 2 * (v15 + 1), (int)a1) )
                    goto LABEL_15;
                  v18 = v16 - 1;
                  v19 = v6 - 1;
                  v20 = v6;
                  ...
                  switch ( v23 )
                  {
                    case 0:
                      ...
                      else if ( v15 )
                      {
                        ...
                        v31 = strlen(s);
                        v32 = (char *)sub_2ACC1C((int)a1, v31 + 1);
                        v33 = v32;
                        if ( !v32 )
                          goto LABEL_15;
                        strcpy(v32, s);
                        v34 = (_DWORD *)sub_2ADC10((int)a1, v33, 259);
                    ...
                    case 2:
                      if ( v15 != 2 )
                      {
                        sub_2A6A84("%B:%u: bad extended address record length in Intel Hex file", a1, v7);
                        ((void (__fastcall *)(int))loc_2A6C70)(17);
                        goto LABEL_15;
                      }
                      v37 = 0;
                    ...
                    case 3:
                      if ( v15 != 4 )
                      {
                        sub_2A6A84("%B:%u: bad extended start address length in Intel Hex file", a1, v7);
                        ((void (__fastcall *)(int))loc_2A6C70)(17);
                        goto LABEL_15;
                      }
                      v37 = 0;
                    ...
                    case 4:
                      if ( v15 != 2 )
                      {
                        sub_2A6A84("%B:%u: bad extended linear address record length in Intel Hex file", a1, v7);
                        ((void (__fastcall *)(int))loc_2A6C70)(17);
                        goto LABEL_15;
                      }
                      v37 = 0;
                    ...
                    case 5:
                      ...
                      {
                        sub_2A6A84("%B:%u: bad extended linear start address length in Intel Hex file", a1, v7);
                        ((void (__fastcall *)(int))loc_2A6C70)(17);
                        goto LABEL_15;
                      }
                      ...
                      continue;
                    default:
                      sub_2A6A84("%B:%u: unrecognized ihex type %u in Intel Hex file", a1, v7);
                      ((void (__fastcall *)(int))loc_2A6C70)(17);
                      goto LABEL_15;
                  }
                }
