int __fastcall sub_2D6EC4(int a1, int a2)
{
  int v3; // r6
  int v4; // r10
  unsigned int v5; // r7
...
LABEL_3:
      ...
      {
LABEL_7:
        sub_2A6A84("%B: .gnu.version_d invalid entry", a1);
      ...
      if ( sub_2A8A2C(a1, *(_QWORD *)(v3 + 480), 0)
        || (v71 = sub_2A8800((int)v6, *(_DWORD *)(v3 + 488), a1), v71 != *(_DWORD *)(v3 + 488)) )
      {
LABEL_8:
        v8 = *(_DWORD *)(a1 + 160);
        goto LABEL_9;
              ...
              if ( *(_WORD *)(v39 + 6) )
              {
                ...
                while ( 1 )
                {
                  ...
                  *(_DWORD *)(v64 - 12) = v67;
                  if ( v68 )
                  {
                    v70 = sub_2CD884(a1, *(_DWORD *)(v3 + 492), v68);
                    *(_DWORD *)(v64 - 8) = v70;
                    if ( !v70 )
                      goto LABEL_66;
                    v67 = *(_DWORD *)(v64 - 12);
...
LABEL_25:
        if ( v4 )
        {
          ...
          *(_WORD *)(v14 + 6) = 1;
          *(_DWORD *)(v14 + 20) = a1;
          v15 = (_DWORD *)sub_2E9060(a1);
          *(_DWORD *)(v14 + 24) = v15;
          if ( v15 && (*(_DWORD *)(v14 + 28) = 0, v15 = sub_2AD0C4(a1, 0x10u), (*(_DWORD *)(v14 + 32) = v15) != 0) )
          {
            v15[2] = *(_DWORD *)(v14 + 24);
            return 1;
          }
...
LABEL_21:
  ...
  if ( (unsigned int)v6 > v9 >> 4 )
  {
    v6 = 0;
LABEL_14:
    sub_2A6A84("%B: .gnu.version_r invalid entry", a1);
    ((void (__fastcall *)(int))loc_2A6C70)(17);
LABEL_15:
    v10 = *(_DWORD *)(a1 + 160);
LABEL_16:
  ...
  if ( sub_2A8A2C(a1, *(_QWORD *)(v3 + 424), 0)
    || sub_2A8800((int)v6, *(_DWORD *)(v3 + 432), a1) != *(_DWORD *)(v3 + 432) )
  {
    goto LABEL_15;
  }
  v18 = *(_DWORD *)(a1 + 160);
  v19 = sub_2AD070(a1, *(_DWORD *)(v3 + 440), 0x20u);
  v20 = *(_DWORD *)(a1 + 160);
  *(_DWORD *)(v18 + 580) = v19;
  v21 = *(_DWORD *)(v20 + 580);
  v10 = v20;
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v21 + 16) = a1;
    if ( v23 )
    {
      v55 = sub_2CD884(a1, *(_DWORD *)(v74 + 436), v23);
      *(_DWORD *)(v21 + 20) = v55;
      if ( !v55 )
        goto LABEL_41;
    }
...
LABEL_41:
    ...
    *(_DWORD *)(v21 + 24) = v46;
    ...
    if ( *(_WORD *)(v21 + 2) )
    {
      ...
      while ( 1 )
      {
        sub_2CD5F8(a1, v48, v46);
        v50 = *(_DWORD *)(v46 + 8);
        if ( v50 )
        {
          v54 = sub_2CD884(a1, *(_DWORD *)(v74 + 436), v50);
          *(_DWORD *)(v46 + 16) = v54;
          if ( !v54 )
            goto LABEL_41;
        }
