  ...
  while ( 2 )
  {
    ...
    switch ( *v0 )
    {
      ...
      case 0x27u:
        ...
        if ( *v14 == 39 )
        {
          v66 = ((int (__fastcall *)(char *))loc_7B760)("char");
          v67 = ((int (__fastcall *)(unsigned __int8 *, int))loc_7B6FC)(v0, dword_474F5C - (_DWORD)v0);
          v68 = ((int (__fastcall *)(int, int, int))loc_7B7BC)(60, v66, v67);
          v3 = 258;
          dword_474F6C = v68;
        }
        else
      ...
      case 0x28u:
        ...
        v13 = ((int (__fastcall *)(const char *, int))loc_7B6FC)("(anonymous namespace)", 21);
        v3 = 260;
        dword_474F6C = v13;
        return v3;
      case 0x29u:
...
LABEL_64:
        ...
        if ( v28 )
        {
          v60 = byte_4387C0[v1[v29 - 1]];
          if ( v60 == 102 )
          {
            --v29;
            v62 = ((int (__fastcall *)(char *))loc_7B760)("float");
          }
          else if ( v60 == 108 )
          {
            --v29;
            v62 = ((int (__fastcall *)(const char *))loc_7B760)("long double");
          }
          else
          {
            if ( v60 == 46 )
            ...
            v62 = ((int (__fastcall *)(char *))loc_7B760)("double");
          }
          v63 = ((int (__fastcall *)(unsigned __int8 *, int))loc_7B6FC)(v1, v29);
          v64 = ((int (__fastcall *)(int, int, int))loc_7B7BC)(v30, v62, v63);
          v3 = 259;
          dword_474F6C = v64;
          goto LABEL_88;
        }
        if ( v29 <= 0 )
        {
          v32 = 0;
LABEL_251:
          v81 = ((int (__fastcall *)(const char *))loc_7B760)("unsigned int");
          v65 = ((int (__fastcall *)(char *))loc_7B760)("int");
          v37 = v81;
          v38 = v65;
          goto LABEL_85;
        }
        ...
        if ( v28 == 1 )
        {
          v81 = ((int (__fastcall *)(const char *))loc_7B760)("unsigned long");
          v36 = ((int (__fastcall *)(const char *))loc_7B760)("long");
        }
        else
        {
          v81 = ((int (__fastcall *)(const char *))loc_7B760)("unsigned long long");
          v36 = ((int (__fastcall *)(const char *))loc_7B760)("long long");
        }
        v37 = v81;
        v38 = v36;
LABEL_85:
        if ( v32 )
          v38 = v37;
        v39 = ((int (__fastcall *)(unsigned __int8 *, int))loc_7B6FC)(v1, v29);
        v40 = ((int (__fastcall *)(int, int, int))loc_7B7BC)(v30, v38, v39);
        v3 = 258;
        dword_474F6C = v40;
LABEL_88:
        dword_474F5C = v21;
      ...
      case 0x3Cu:
        ...
        if ( v10 == 60 )
        {
          ...
          {
            dword_474F5C = (int)(v0 + 3);
            dword_474F6C = (int)&off_364FFC;
            return 290;
          }
          else
          {
            dword_474F5C = (int)(v0 + 2);
            dword_474F6C = (int)&dword_364FD0;
            return 302;
          }
        }
        else if ( v10 == 61 )
      ...
      case 0x3Eu:
        ...
        if ( v7 == 62 )
        {
          ...
          {
            dword_474F5C = (int)(v0 + 3);
            dword_474F6C = (int)&off_364FF8;
            return 290;
          }
          else
          {
            dword_474F5C = (int)(v0 + 2);
            dword_474F6C = (int)&dword_3CE948;
            return 303;
          }
        }
        else if ( v7 == 61 )
      ...
      default:
        ...
        if ( v2 != 95 )
          v52 = v2 == 36;
        LOWORD(v53) = (unsigned __int16)word_4388C0;
        dword_474F60 = (int)v0;
        if ( v52 )
        {
          HIWORD(v53) = 67;
        ...
        {
          HIWORD(v53) = (unsigned int)word_4388C0 >> 16;
        ...
        switch ( v54 )
        {
          ...
          case 6:
            ...
            v75 = ((int (__fastcall *)(unsigned __int8 *, int))loc_7B6FC)(v70, v71 - (_DWORD)v70);
            dword_474F5C = v71;
            v3 = 293;
            dword_474F6C = v75;
            return v3;
          ...
          default:
LABEL_148:
            v59 = ((int (__fastcall *)(unsigned __int8 *, int))loc_7B6FC)(v0, v54);
            v3 = 260;
            dword_474F6C = v59;
            return v3;
        }
