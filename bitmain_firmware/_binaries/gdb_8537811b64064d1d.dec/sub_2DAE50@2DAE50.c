char *__fastcall sub_2DAE50(int a1, void *a2, _DWORD *a3, char *s1, void *a5, size_t a6)
{
  const char *v10; // r3
  int v12; // r12
  const char *v13; // r3
  ...
  if ( !strcmp(s1, ".reg2") )
    return sub_2DA3D8(a1, a2, a3, "CORE", 2, a5, a6);
...
LABEL_8:
    ...
    return sub_2DA3D8(a1, a2, v14, v13, v12, src, v16);
  }
  v10 = "FreeBSD";
  if ( *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 4) + 444) + 12) != 9 )
    v10 = "LINUX";
  return sub_2DA3D8(a1, a2, a3, v10, 514, a5, a6);
}
