unsigned int *__fastcall sub_34568C(unsigned int *a1, size_t a2, _BYTE *a3, unsigned int a4)
{
  unsigned int v5; // r6
  size_t v7; // r2
  int v11; // r2
  ...
  if ( a2 > v7 )
    sub_33D234(
      ...
      *(_DWORD *)(*a1 - 12));
  if ( 1073741820 - v7 < a4 )
    sub_33D1AC("basic_string::insert");
  if ( (unsigned int)a3 < v5 )
    return sub_345500(a1, a2, 0, a3, a4);
