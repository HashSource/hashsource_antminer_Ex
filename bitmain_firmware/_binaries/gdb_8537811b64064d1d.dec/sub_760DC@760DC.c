int __fastcall sub_760DC(int a1, _DWORD *a2)
{
  int v2; // r2
  char *object_base; // r4
  int v4; // r9
...
LABEL_12:
    ...
    switch ( *object_base )
    {
      case 0:
        ...
        dword_474A80[0] = 0;
LABEL_15:
        v10 = (const char *)sub_1A2A0C(&dword_487CC0, sub_1A2C7C, dword_474AD0);
        v11 = (char *)v10;
        if ( !v10 )
          continue;
        if ( dword_474A80[0] )
...
LABEL_115:
        ...
        v28 = sub_74BA0(v78, object_base, v24 - (_DWORD)object_base, v50 | v48, (int)&dword_474AB0);
        if ( v28 == 280 )
        {
          v72 = (const char *)memcpy(v73, object_base, v24 - (_DWORD)object_base);
          v73[v24 - (_DWORD)object_base] = 0;
          sub_94708("Invalid number \"%s\".", v72);
        }
        goto LABEL_125;
      case 48:
      case 49:
...
LABEL_34:
        ...
        if ( dword_474C68 )
          ...
          dword_474C68 = 1;
        obstack_begin(&obstack, 0, 0, (void *(*)(int))sub_93050, sub_74B94);
        v18 = (int)v79;
...
LABEL_161:
          if ( !v59 )
LABEL_204:
            sub_94708("Empty character constant.", HIDWORD(v63));
          if ( v59 <= 2 )
          {
            if ( v59 != 2 )
              return 263;
...
LABEL_95:
          ...
          v44 = (const char *)sub_1C3E80(object_base, v40);
          while ( 1 )
          {
            v45 = 4 * v43;
...
LABEL_100:
        ...
        while ( 1 )
        {
          ...
          {
            v79 = v20 + 1;
            v62 = sub_759D0((char **)v77, &obstack);
            v20 = v79;
            v59 += v62;
            goto LABEL_150;
          }
            ...
            if ( strncmp(object_base, "dynamic_cast", v36 - object_base) )
            {
              if ( strncmp(object_base, "static_cast", v39) )
              {
                if ( strncmp(object_base, "reinterpret_cast", v39) )
                {
                  ...
                  {
                    v42 = sub_1C3D28(&object_base[v39]);
                    if ( v42 )
