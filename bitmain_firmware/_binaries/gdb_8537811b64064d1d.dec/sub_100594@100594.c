int __fastcall sub_100594(const char *a1, char *a2, int a3, int a4)
{
  _DWORD *v6; // r0
  _DWORD *v7; // r8
  size_t v8; // r6
  ...
  *v6 = 0;
  dword_47B1A8 = (int)v6;
  v7 = sub_92564((int)sub_FE4D4, (int)v6);
  sub_FF164(a1, a2);
  if ( *a2 )
  {
    v8 = strlen(a2);
  ...
  for ( j = (_DWORD *)sub_20F3B0(0); j; j = (_DWORD *)j[3] )
    sub_FED70(a1, j);
  v15 = sub_20F3B0(0);
  v16 = sub_C2690(v15);
  v17 = (_DWORD *)v16;
