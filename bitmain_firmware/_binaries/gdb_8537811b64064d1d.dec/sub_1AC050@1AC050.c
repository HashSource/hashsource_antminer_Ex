int __fastcall sub_1AC050(int a1, int a2, int a3, int a4, int a5, _DWORD *a6)
{
  int v6; // r9
  signed int v9; // r8
  char *v10; // r6
  ...
  switch ( v13 )
  {
    ...
    case 25:
      ...
      if ( v14 != -1 )
        goto LABEL_5;
      v12 = sub_94728((int)"mdebugread.c", 630, "sect_index_data not initialized");
LABEL_9:
      v16 = *(_BYTE *)(a1 + 8);
      if ( (v16 & 0x3Fu) - 7 <= 1 )
        goto LABEL_6;
    ...
    case 14:
      ...
      if ( v14 == -1 )
      {
        sub_94728((int)"mdebugread.c", 634, "Section index is uninitialized");
LABEL_240:
        sub_94728((int)"mdebugread.c", 623, "sect_index_text not initialized");
LABEL_241:
        v198 = sub_93050(v9);
LABEL_230:
        v202 = 0;
        *(_DWORD *)(*(_DWORD *)(v11 + 24) + 24) = v198;
        for ( i = sub_C28D0(v10, &v223); ; i = sub_C290C((int)&v223) )
        {
          v206 = i == 0;
          if ( i )
            v206 = v202 == v6;
      ...
      switch ( v16 & 0x3F )
      {
        ...
        case 1:
          ...
          *(_DWORD *)(v66 + 8) = *(_DWORD *)(a1 + 4);
          sub_1ABF78(a1, a2, a4, v66, 2, v65, (int)a6, s2);
          return src;
        case 2:
        ...
        case 3:
          ...
          *(_DWORD *)(dword_487AC4 + 32) = v78;
          if ( sub_10A86C((unsigned __int8)*s2) && s2[1] == 116 )
          {
            v79 = s2;
            if ( !s2[2] )
              v79 = "this";
          ...
          *(_QWORD *)(v82 + 8) = v9;
          src = 1;
          v88 = sub_1AACC0(v87, a2, v86 >> 12, 0, a4, s2);
          v89 = dword_487AC4;
          *(_DWORD *)(v82 + 24) = v88;
          v90 = *(_DWORD *)(v89 + 12);
          ((void (__fastcall *)(int, _DWORD))loc_220A20)(v82, *(_DWORD *)(v89 + 8));
          sub_10B4D4(*(_DWORD *)(v90 + 16));
          return src;
        case 4:
          ...
          *(_QWORD *)(v74 + 8) = v9;
          ...
          {
            src = 1;
            sub_1ABF78(a1, a2, a4, v74, dword_487AD8, v73, (int)a6, s2);
            return src;
          }
          v77 = 7;
          v207 = v73;
          ...
          v208 = (int)a6;
LABEL_105:
          sub_1ABF78(a1, a2, a4, v76, v77, v207, v208, v209);
          return 1;
        case 5:
          src = 1;
          v67 = sub_1A751C(s2);
          ...
          *(_BYTE *)(v67 + 32) = 73;
          *(_DWORD *)(v67 + 8) = v68;
          v70 = sub_1780EC((int)a6);
          v71 = *(_DWORD *)(dword_487AC4 + 12);
          v72 = *(_DWORD *)(dword_487AC4 + 8);
          *(_DWORD *)(v69 + 24) = *(_DWORD *)(v70 + 12);
          ((void (__fastcall *)(int, int))loc_220A20)(v69, v72);
          sub_10B4D4(*(_DWORD *)(v71 + 16));
          return src;
        case 6:
        case 0xE:
          if ( (v16 & 0x3F) == 6 && (WORD2(v12) & 0x7C0) != 0x40 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( v106 == 8 )
                break;
              if ( dword_47AC88 > 0 )
                sub_F43DC(&off_46D334, "unknown symbol type 0x%x", *(_BYTE *)(a1 + 8) & 0x3F);
            }
            return src;
          }
          v135 = sub_1A751C(s2);
          ...
          *(_BYTE *)(v135 + 32) = 81;
          ...
          if ( v141 )
          {
            v142 = *(_DWORD **)(sub_1780EC((int)a6) + 12);
          }
          else
          {
            v142 = (_DWORD *)sub_1AACC0(dword_487AD4, a2, (*(_DWORD *)(a1 + 8) >> 12) + 1, 0, a4, s2);
            if ( !strcmp(s2, "malloc") && *(_BYTE *)v142[6] == 10 )
              v142 = sub_1700B8(v142, 0);
          }
          ...
          ((void (__fastcall *)(int))loc_220A20)(v137);
          sub_10B4D4(*(_DWORD *)(v143 + 16));
          v144 = sub_170380((int)v142);
          v145 = *(_BYTE *)(v137 + 20);
          *(_DWORD *)(v137 + 24) = v144;
          v146 = v145 & 0x1F;
          if ( v146 == 4 )
            *(_BYTE *)(*(_DWORD *)(v144 + 24) + 1) |= 0x20u;
          v147 = sub_930BC(1u, 0x18u);
          v148 = sub_10B478(v146);
          v149 = dword_487AC4;
          v150 = *(_DWORD *)(a1 + 4);
          v147[4] = v148;
          v151 = *(_DWORD *)(v149 + 8);
        ...
        case 7:
          ...
          else
          {
            ...
            *(_DWORD *)(dword_487AC4 + 16) = 7;
            src = 1;
            v166 = sub_930BC(1u, 0x18u);
            v167 = sub_10B284(v165);
...
LABEL_16:
              if ( dword_47AC88 > 0 )
                sub_F43DC(&off_46D334, "stEnd with storage class %d not handled", v13);
              goto LABEL_18;
            }
            goto LABEL_161;
          }
          ...
          *((_DWORD *)v10 + 1) += *(_DWORD *)(a1 + 4);
          v173 = sub_1A751C("__GDB_EFI_INFO__");
          *(_BYTE *)(v173 + 32) = 12;
          v174 = (_DWORD *)sub_1780EC(dword_487ABC);
          v175 = dword_487ABC;
          ...
          *(_DWORD *)(v173 + 8) = v179;
          ...
          v179[20] = -1;
          *(_DWORD *)v179 = v185;
          ((void (__fastcall *)(int, _DWORD))loc_220A20)(v173, v184[2]);
          sub_10B4D4(*(_DWORD *)(v186 + 16));
          v187 = *v172;
          v20 = (int *)dword_487AC4;
          if ( *v172 > 0 )
          {
        ...
        case 9:
          ...
          *(_DWORD *)(v98 + 4) = 0;
          v223 = 0;
          v99 = sub_1AACC0(v94, a2, v97 >> 12, &v223, a4, s2);
          v100 = v223;
          v101 = *(_DWORD *)(v98 + 8);
          *(_DWORD *)(v98 + 12) = v99;
        ...
        case 0xA:
          ...
          do
          {
            ...
            {
LABEL_91:
              v57 = sub_1AACC0(dword_487AD4, a2, *(_DWORD *)(a1 + 8) >> 12, 0, a4, s2);
              sub_1A7340(dword_487AB4, a3, v57);
              v55 = dword_487AB4;
              goto LABEL_92;
            }
          }
...
LABEL_92:
          ...
          *(_DWORD *)(v58 + 24) = v57;
          *(_DWORD *)(v58 + 8) = v61;
          ((void (*)(void))loc_220A20)();
          sub_10B4D4(*(_DWORD *)(v61 + 16));
          v62 = *(char **)(v60[6] + 24);
          if ( *((_DWORD *)v62 + 2) )
            return 1;
          v63 = *v62;
...
LABEL_40:
              ...
              default:
                if ( dword_47AC88 <= 0 )
                  goto LABEL_40;
                v25 = &v10[(_DWORD)v25];
                sub_F43DC(&off_46D334, "declaration block contains unhandled symbol type %d");
                continue;
            }
            break;
          }
        ...
        default:
          if ( dword_47AC88 <= 0 )
            return 1;
          src = 1;
          sub_F43DC(&off_46D334, "unknown symbol type 0x%x", v16 & 0x3F);
          return src;
      }
      do
      {
        ...
        {
LABEL_56:
          v35 = ((int (__fastcall *)(int))loc_16FD6C)(dword_487ABC);
          v36 = *(_DWORD *)(v35 + 24);
          v37 = v35;
          v214 = v35;
          LOWORD(v35) = *(_WORD *)(v36 + 2);
          *(_DWORD *)(v36 + 28) = &word_3B4A54;
          *(_DWORD *)(v36 + 8) = 0;
          *(_WORD *)(v36 + 2) = v35 & 0xFC7F | 0x80;
          sub_1A7340(dword_487AB4, a3, v37);
          goto LABEL_57;
        }
      }
      while ( a3 != v34[1] );
...
LABEL_62:
      ...
      {
        *(_DWORD *)(v38 + 12) = sub_163544(dword_487ABC + 48, s2, 0);
        v38 = *(_DWORD *)(v214 + 24);
      }
      v41 = *(_BYTE *)(v38 + 2);
      v42 = *(_DWORD *)(a1 + 4);
      ...
      *(_DWORD *)(v54 + 24) = v47;
      if ( srca == 5 )
      {
        ...
        if ( v108 )
          v109 = v107 == v108;
        if ( v109 )
          *(_DWORD *)(v214 + 20) = ((int (__fastcall *)(int))loc_165E90)(v220) / 8;
        ...
        while ( (v225 & 0x3F) == 9 )
        {
          ...
          *(_DWORD *)(v129 + 8) = v119;
          *(_DWORD *)(v129 + 12) = 0;
          ((void (__fastcall *)(int, int))loc_220A20)(v129, v122);
          sub_10B4D4(*(_DWORD *)(v121 + 16));
