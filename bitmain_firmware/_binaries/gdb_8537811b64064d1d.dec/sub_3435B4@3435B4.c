int __fastcall sub_3435B4(int result, int a2, int **a3, int a4)
{
  int v5; // r5
  int **v7; // r4
  int *v8; // r9
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v5 + 272) = v10;
    if ( v9 == 41 )
    {
      result = sub_3433E8(v5, a2, v8 + 3, (int **)*v7);
      *(_DWORD *)(v5 + 272) = v11;
      return result;
    }
    if ( v9 == 42 )
    {
      result = sub_34381C(v5, a2, v8 + 2, *v7);
      *(_DWORD *)(v5 + 272) = v11;
      return result;
    }
    if ( v9 == 2 )
      break;
    result = sub_342DE0(v5, a2, v8);
    *(_DWORD *)(v5 + 272) = v11;
LABEL_12:
    v7 = (int **)*v7;
    if ( !v7 || *(_DWORD *)(v5 + 280) )
...
LABEL_24:
  ...
  while ( sub_33D8FC(v19) );
  result = sub_3401DC(v5, a2, (int)v18);
  *(_DWORD *)(v5 + 272) = v11;
  return result;
}
