int __fastcall sub_1B25DC(int *a1, char *s1, size_t a3, int a4, int a5, int a6, __int16 a7)
{
  char *v8; // r9
  int v11; // r4
  int v12; // r3
...
LABEL_9:
  v18 = (int)v16 + v17;
  ((void (__fastcall *)(int, int, _DWORD))loc_21AEEC)(v18, 1, *(_DWORD *)(v12 + 40));
  v19 = &v16[4 * v15 + 4 * v14];
  sub_21AF70(v18, v8, a3, a4, *a1);
  v20 = *(_DWORD *)(*a1 + 40);
  v21 = *((_BYTE *)v19 + 40);
  v19[4] = a5;
  v22 = *(_BYTE *)(v20 + 92);
