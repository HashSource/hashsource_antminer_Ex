void __fastcall sub_24A8A0(int a1)
{
  unsigned int *v1; // r0
  unsigned int *v2; // r11
  unsigned int v3; // r12
  ...
  v1 = (unsigned int *)((int (*)(void))loc_D211C)();
  v2 = v1;
  if ( !v1 )
LABEL_56:
    sub_94708("No tracepoints defined, not starting trace");
  v3 = *v1;
  if ( !*v1 )
  {
    free(v1);
  ...
  do
  {
    while ( 1 )
    {
      ...
      v9 = "";
LABEL_6:
      sub_946D8("May not insert %stracepoints, skipping tracepoint %d", v9, *(_DWORD *)(v10 + 24));
      v3 = *v2;
      if ( ++v8 >= *v2 )
        goto LABEL_13;
    }
...
LABEL_13:
  if ( !v7 )
  {
    if ( !off_489B54(&dword_4899A0) )
      goto LABEL_54;
    sub_946D8("No tracepoints enabled");
  }
  if ( !v4 )
  {
    free(v2);
    sub_94708("No tracepoints that may be downloaded, not starting trace");
  }
...
LABEL_54:
            free(v2);
            sub_94708("No tracepoints enabled, not starting trace");
          }
          while ( 1 )
          {
  ...
  else
  {
    ...
    if ( !off_489BE8(&dword_4899A0, dword_48A8B8, dword_48A8B4, 0) )
    {
      ...
      if ( !v26 )
LABEL_46:
        sub_946D8("Target does not support trace user/notes, info ignored");
    }
  }
