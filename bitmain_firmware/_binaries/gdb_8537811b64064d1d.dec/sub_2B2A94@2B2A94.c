int __fastcall sub_2B2A94(_DWORD *a1, _DWORD *a2)
{
  _DWORD *v2; // r3
  int result; // r0
  unsigned int v4; // r12
...
LABEL_11:
      ...
      {
        sub_2A6A84("%B: error: Cortex-A8 erratum stub out of range (input file too large)", v7);
        return 0;
      }
      else
      {
...
LABEL_9:
    sub_2A6A84("%B: error: Cortex-A8 erratum stub is allocated in unsafe location", v7);
    return 0;
  }
  v9 = v8 ^ v6;
  v10 = v6 - v8;
