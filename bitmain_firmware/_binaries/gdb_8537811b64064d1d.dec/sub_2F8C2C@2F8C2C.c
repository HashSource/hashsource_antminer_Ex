int __fastcall sub_2F8C2C(int a1)
{
  char *v2; // r9
  ...
  *v4 = 0;
  ...
  while ( 1 )
  {
    v7 = sub_2ABC4C(v48, v2, &v54, 0, (unsigned int)v3);
    v2 += v54;
    if ( !v7 )
      break;
...
LABEL_95:
      ...
      if ( dword_4712B8 != v7 )
      {
        sub_2A6A84("Dwarf Error: Could not find abbrev number %u.", v7);
        dword_4712B8 = v28;
      }
...
LABEL_8:
    ...
    if ( v8[3] )
    {
      ...
      while ( 1 )
      {
        ...
        v55 = v16;
        v19 = sub_2F68F0(&v55, v17, v18, a1, v2, v3);
        v2 = (char *)v19;
        if ( !v19 )
          goto LABEL_8;
        if ( !v12 )
        {
          if ( v11 )
          {
            if ( v55 == 58 )
            {
              *(_DWORD *)(v11 + 4) = sub_2F76BC(*(_DWORD *)(a1 + 64), v57);
            }
            else if ( v55 > 0x3A )
            {
              if ( v55 == 59 )
                      ...
                      if ( *v29 == v31 + 1 )
                      {
                        ...
                        switch ( v32 )
                        {
                          ...
                          case 64:
                            ...
                            break;
                          default:
                            sub_2A6C18((int)"./dwarf2.c", 3251, (int)"scan_unit_for_symbols");
                        }
                        *(_DWORD *)(v11 + 20) = v33;
                      }
                    }
...
LABEL_63:
        ...
        if ( v55 == 88 )
        {
          v12[2] = sub_2F76BC(*(_DWORD *)(a1 + 64), v57);
          goto LABEL_31;
        }
        if ( v55 <= 0x58 )
        {
          if ( v55 != 71 )
          {
            if ( v55 == 85 && !sub_2F7590(a1, v12 + 9, v57) )
              goto LABEL_8;
            goto LABEL_31;
          }
LABEL_93:
          if ( !sub_2F879C(a1, v19, (int)&v55, v12 + 8, v12 + 7) )
            goto LABEL_8;
          goto LABEL_31;
        }
        if ( v55 == 110 || v55 == 8199 )
...
LABEL_42:
            ...
            if ( v12 )
              v20 = v51 == 0;
            if ( v20 || sub_2F66A4((int *)(a1 + 8), v12 + 9, v52, v51) )
              goto LABEL_48;
            goto LABEL_8;
          }
        }
...
LABEL_31:
      ...
      else if ( v55 > 0x12 )
      {
        if ( v55 == 49 )
          goto LABEL_93;
        if ( v55 == 58 )
          v12[3] = sub_2F76BC(*(_DWORD *)(a1 + 64), v57);
      }
      else if ( v55 == 3 )
      {
        if ( !v12[8] )
