int sub_D2414()
{
  ...
  if ( !dword_4783C0 )
    sub_CA548();
  sub_1B95A8(sub_C9208);
  sub_1B9720(sub_CAD00);
  sub_1BA33C(sub_C76F8);
  dword_4787FC = sub_1B6B00(0, sub_CB1F0);
  dword_478348 = 0;
  dword_478360 = 0;
  dword_478898 = 0;
  sub_539E8(
  ...
  sub_53420(
    ...
    1,
    (int **)&dword_474744);
  sub_547D8((int)"dis", "disable", 6, 1);
  sub_547D8((int)"disa", "disable", 6, 1);
  sub_5329C(
    "breakpoints",
    8,
    (int)sub_DD08C,
  ...
  sub_53420(
    ...
    1,
    (int **)&dword_474744);
  sub_547D8((int)"d", (unsigned __int8 *)"delete", 6, 1);
  sub_547D8((int)"del", (unsigned __int8 *)"delete", 6, 1);
  sub_5329C(
    "breakpoints",
    8,
    (int)sub_DC274,
  ...
  v4 = sub_539E8(
         ...
         (int)"Set breakpoint at specified location.\n"
              ...
              "\n"
              "Do \"help breakpoints\" for info on other commands dealing with breakpoints.");
  sub_53274(v4, (int)sub_F7450);
  sub_547D8((int)"b", "break", 0, 1);
  sub_547D8((int)"br", "break", 0, 1);
  sub_547D8((int)"bre", "break", 0, 1);
  sub_547D8((int)"brea", "break", 0, 1);
  if ( dword_487A74 )
  {
    sub_534B4(
      "stop",
      ...
      1,
      (int **)&dword_474744);
    sub_5329C("in", 6, (int)sub_DAC0C, (int)"Break in function or address.", &dword_4747A4);
    sub_5329C("at", 6, (int)sub_DAB6C, (int)"Break at a line in the current file.", &dword_4747A4);
    sub_539E8(
      "status",
      5,
      (int)sub_D5DB8,
  ...
  sub_539B4(
    ...
    (int)"Status of specified breakpoints (all user-settable breakpoints if no argument).\n"
         ...
         "Convenience variable \"$bpnum\" contains the number of the last\n"
         "breakpoint set.");
  sub_547B0((int)"b", (unsigned __int8 *)"breakpoints", 1);
  sub_5329C(
    "breakpoints",
    11,
    (int)sub_D5DA0,
  ...
  sub_53420(
    ...
    0,
    (int **)&dword_474744);
  sub_D21EC("fork", (int)"Catch calls to fork.", (int)sub_DA1BC, 0, 2, 0);
  sub_D21EC("vfork", (int)"Catch calls to vfork.", (int)sub_DA1BC, 0, 3, 1);
  sub_D21EC("exec", (int)"Catch calls to exec.", (int)sub_D9F44, 0, 0, 1);
  sub_D21EC(
    "load",
  ...
  v7 = sub_539E8(
         ...
         (int)"Set a watchpoint for an expression.\n"
              ...
              "If -l or -location is given, this evaluates EXPRESSION and watches\n"
              "the memory to which it refers.");
  sub_53274(v7, (int)sub_F7440);
  sub_539B4("watchpoints", (int)sub_D5D3C, (int)"Status of specified watchpoints (all watchpoints if no argument).");
  sub_5389C(
  ...
  sub_53274(v8, (int)sub_F7450);
  sub_547D8((int)"tp", (unsigned __int8 *)"trace", 8, 0);
  sub_547D8((int)"tr", (unsigned __int8 *)"trace", 8, 1);
  sub_547D8((int)"tra", (unsigned __int8 *)"trace", 8, 1);
  sub_547D8((int)"trac", (unsigned __int8 *)"trace", 8, 1);
  v9 = sub_539E8(
         "ftrace",
         6,
         (int)sub_DAF3C,
  ...
  sub_539B4(
    ...
    (int)"Status of specified tracepoints (all tracepoints if no argument).\n"
         ...
         "last tracepoint set.");
  sub_547B0((int)"tp", (unsigned __int8 *)"tracepoints", 1);
  sub_5329C(
    "tracepoints",
    7,
    (int)sub_DBC98,
    ...
    &dword_4747A0);
  sub_5474C((int)"tr", (unsigned __int8 *)"tracepoints", 7, 1, (int *)&dword_4747A0);
  v11 = sub_5329C(
          "tracepoints",
          7,
          (int)sub_DD0A4,
  ...
  v14 = sub_5329C(
          ...
          (int **)&dword_478364);
  sub_53274(v14, (int)&loc_F6D28);
  v15 = sub_547D8((int)"save-tracepoints", "save tracepoints", 7, 0);
  sub_532D0(v15, (int)"save tracepoints");
  sub_53420(
    "breakpoint",
    11,
    (int)nullsub_49,
  ...
  sub_53514(
    ...
    (int **)&dword_47475C,
    (int **)&dword_47474C);
  dword_4788B8 = sub_32727C("printf");
  sub_536B0(
    "dprintf-function",
    4,
    (int)&dword_4788B8,
  ...
  dword_4788B4 = 1;
  sub_1B9AF0(sub_C7960);
  return sub_1B9898(817576);
}
