int __fastcall sub_32F4A8(int a1, int a2, int *a3)
{
  void *v4; // r7
  int v7; // r4
  void *v8; // r8
...
LABEL_10:
  ...
  if ( *(_WORD *)(a2 + 10) || v10 != 1 )
  {
    ...
    v31 = v11;
    v34[0] = 1;
    sub_328A28((int)&v30, v34, (unsigned __int16 *)(a2 + 10), v10, v36, v37);
    v4 = (void *)(v37[0] & 0x20);
    if ( (v37[0] & 0x20) == 0 && v33[0] == 1 )
    {
      sub_329740((int)&v30, v31);
      v26 = v31;
      v27 = v30;
      v8 = v4;
      *(_BYTE *)(a1 + 8) = v32;
      *(_DWORD *)(a1 + 4) = v26;
      v36[0] = (int)v4;
      sub_328A28(a1, a3, v33, v27, v36, &v28);
      sub_3295C0((_DWORD *)a1, a3, v36, &v28);
      v7 = v28;
      goto LABEL_3;
    }
    goto LABEL_10;
...
LABEL_11:
  ...
  if ( v12 + 3 <= 49 )
  {
    v14 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v13) + 5);
    if ( v14 > 0x24 )
      goto LABEL_15;
  }
  else
...
LABEL_18:
  ...
  else
  {
    ...
    v30 = 2;
    v34[0] = v21;
    sub_32ECB8((int)v25, (int)&v30, v34, &v29);
    v34[0] = *a3;
    sub_32D420(a1, (int)v16, __PAIR64__(v34, (unsigned int)v25), 0x80u, &v28);
    v7 = v28;
  }
LABEL_3:
  free(v8);
