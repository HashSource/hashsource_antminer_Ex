FILE *__fastcall sub_46FD8(__int64 a1)
{
  void *v2; // r9
  FILE *v3; // r0
  int v4; // r5
  ...
  v2 = (void *)sub_93168("/proc/%lld/cmdline", a1);
  sub_96818((int)&stream, (int)v2, "r");
  v3 = stream;
  if ( stream )
  {
    v4 = 0;
    ...
    {
      v5 = (FILE *)sub_93050(32);
      LOBYTE(v5->_flags) = 91;
      sub_46ECC((char *)&v5->_flags + 1, 0x1Fu, a1);
