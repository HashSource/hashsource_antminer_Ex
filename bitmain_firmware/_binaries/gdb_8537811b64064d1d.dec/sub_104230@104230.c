int *__fastcall sub_104230(int *a1, int *a2, char *a3, _DWORD *a4)
{
  _DWORD *v4; // r11
  int v6; // r1
  int v7; // r4
  ...
  *a1 = 0;
  ...
  while ( 1 )
  {
    v10 = v9 == 128 ? *(__int16 **)(v6 + 28) : &word_3B4A54;
    if ( *v10 <= v7 )
      return a1;
    ...
    if ( v12 )
    {
      v13 = 1;
      v38 = *(_DWORD *)(v11 + 12);
      sub_104174(a1, v12, a3, a4, 1, 0);
      if ( *a1 )
        return a1;
      v42[0] = v43;
      v14 = strlen(v12);
      sub_103A94(v42, v12, (int)&v12[v14]);
      if ( v42[1] == (void *)0x7FFFFFFF )
        sub_33D1AC("basic_string::append");
      v15 = sub_33C348(v42, ".", 1);
      v44 = v46;
      v17 = v15;
      v19 = (int *)(v15 + 8);
      v18 = *(void **)v15;
      ...
      *(_DWORD *)(v17 + 4) = 0;
      ...
      if ( 0x7FFFFFFF - v45 < v23 )
        sub_33D1AC("basic_string::append");
      v24 = (_DWORD *)sub_33C348(&v44, a3, v23);
      ptr = v41;
      v26 = v24;
      v28 = v24 + 2;
      v27 = (_DWORD *)*v24;
      ...
      *v26 = v28;
      ...
      if ( v42[0] != v43 )
        sub_339E8C(v42[0]);
      sub_21CFDC(a1, ptr, a4, 1);
      v32 = ptr;
      if ( *a1 )
        goto LABEL_38;
      sub_21D0E4(a1, ptr, 1);
      if ( *a1
        || ((v33 = sub_171280(v38), v34 = *(_DWORD *)(v33 + 24), (*(_WORD *)(v34 + 2) & 0x380) != 0x80)
          ? (v35 = &word_3B4A54)
          : (v35 = *(__int16 **)(v34 + 28)),
            *v35 > 0 && (sub_104230(a1, v33 + 24, a3, a4), *a1)) )
      {
        v32 = ptr;
LABEL_38:
        if ( v32 != v41 )
