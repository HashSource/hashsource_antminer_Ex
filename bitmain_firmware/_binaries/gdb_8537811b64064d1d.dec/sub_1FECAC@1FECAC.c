int __fastcall sub_1FECAC(__int64 a1, _DWORD *a2, char a3, _DWORD *a4)
{
  int v4; // r4
  _DWORD *v5; // r6
  _DWORD *v6; // r12
...
LABEL_14:
  ...
  if ( !*(_BYTE *)(v4 + 4) )
  {
    ...
    {
LABEL_9:
      sub_1636E0((regex_t *)(v4 + 60), *(const char **)(v4 + 36), 9, "regexp");
      *(_BYTE *)(v4 + 92) = 1;
    }
    return v4;
  }
  v17 = sub_94728(
          ...
          "skiplist_entry::skiplist_entry(bool, std::__cxx11::string&&, bool, std::__cxx11::string&&, skiplist_entry::private_key)",
          "!m_file.empty ()");
  return sub_1FEED0(v17, HIDWORD(v17));
}
