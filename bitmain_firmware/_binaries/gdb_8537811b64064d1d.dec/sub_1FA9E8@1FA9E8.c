int __fastcall sub_1FA9E8(_DWORD *a1, const char *a2, int a3, int a4, int a5, int a6)
{
  int v10; // r3
  int v11; // r0
  int result; // r0
  ...
  if ( a4 > 0 || (v10 = a1[6], (v11 = *(_DWORD *)(v10 + 8)) == 0) )
  {
    ...
    switch ( *v14 )
    {
      case 2:
        sub_25A6E4("[", a3);
        sub_1FA9E8(*(_DWORD *)(*(_DWORD *)(v13 + 24) + 20), 0, a3, a4 - 1, a5, a6);
        if ( (unsigned int)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v13 + 24) + 24) + 12)
                          ...
                          - 3) <= 1 )
        {
          sub_25A440(a3, "; variable length");
        }
        else if ( sub_171B58(v13, &v52, &v53) )
        {
          v41 = sub_988D4(v53 - v52 + 1);
          sub_25A440(a3, "; %s", v41);
        }
        return sub_25A6E4(&word_419FF0, a3);
      case 3:
        return sub_1FA790(v13, a2, a3, a4, a5, a6);
      case 4:
        if ( sub_1F9284((int)v14) )
          return sub_1FA790(v13, a2, a3, a4, a5, a6);
        sub_25A6E4("enum ", a3);
      ...
      case 7:
        if ( (char)v14[1] < 0 )
          return sub_E93C0(v13, a2, a3, a4, a5, a6);
        sub_25A6E4("fn ", a3);
        if ( a2 )
          sub_25A6E4(a2, a3);
        v36 = sub_25A6E4("(", a3);
        if ( *(__int16 *)(*(_DWORD *)(v13 + 24) + 4) > 0 )
        {
          ...
          while ( 1 )
          {
            ...
            v37 += 24;
            v40 = sub_1FA9E8(*(_DWORD *)(v39 + 12), "", a3, -1, 0, a6);
        ...
        {
          sub_25A6E4(" -> ", a3);
          return sub_1FA9E8(*(_DWORD *)(*(_DWORD *)(v13 + 24) + 20), "", a3, -1, 0, a6);
        }
        return result;
      case 0xA:
        return sub_25A6E4("()", a3);
...
LABEL_55:
          ...
          while ( 1 )
          {
            ...
            if ( v50 )
            {
              sub_1FA9E8(*(_DWORD *)(v46 + 12), 0, a3, v45, v31, a6);
            ...
            {
              sub_25A440(a3, "%s: ", *(_DWORD *)(v46 + 16), v45);
              sub_1FA9E8(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v32 + 24) + 24) + v43 + 12), 0, a3, v45, v31, a6);
              if ( *(__int16 *)(*(_DWORD *)(v32 + 24) + 4) <= v44 )
              {
                v26 = v51;
                break;
