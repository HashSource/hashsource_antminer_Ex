int __fastcall sub_2EAAB8(int a1, int a2)
{
  int v2; // r4
  int v4; // r10
  int v5; // r3
  ...
  if ( v342 )
  {
    v377 = sub_2AD88C(v353, ".hash");
    v378 = sub_2AD88C(v353, ".gnu.version");
  }
  else
  {
    v377 = 0;
    ...
    do
    {
      while ( 1 )
      {
        ...
        *(_BYTE *)(v44 + 24) |= 2u;
        ...
        {
          v334 = v44;
          v49 = sub_347440(*(_DWORD *)(v48 + 96), *(unsigned __int8 *)(*(_DWORD *)(v319 + 392) + 5));
          v44 = v334;
        }
        else
        {
      ...
      *(_DWORD *)(v18 + 76) += v26;
      if ( v28 )
      {
        ...
        if ( v56 )
        {
          ...
          {
            v336 = v22[16];
            v59 = sub_347440(*(_DWORD *)(v56 + 24), v57);
            v58 = v336;
          }
          else
          {
        ...
        if ( v60 )
        {
          ...
          v62 = v22[20];
          if ( v61 )
            v63 = sub_347440(*(_DWORD *)(v60 + 24), v61);
          else
            v63 = 0;
...
LABEL_48:
  ...
  if ( v35 == 2 )
    ...
    v36 = v34 & 1;
  if ( v36 )
    sub_2FCBFC(v313, sub_2DD990, v355, v35);
LABEL_57:
  v37 = *(_BYTE *)(v4 + 43);
  v38 = v320;
  ...
  *(_DWORD *)(v4 + 124) = v38;
  if ( (v37 & 0x40) != 0 )
    sub_2A6BE4("elflink.c", 11778);
  if ( !sub_2D15AC(v4, a2) )
  {
LABEL_122:
    sub_2DD7A0((_DWORD *)(v4 + 100), &v374);
    return 0;
  }
  for ( i = *(_DWORD **)(v4 + 100); i; i = (_DWORD *)i[3] )
  {
    v40 = i[35];
    if ( (i[5] & 4) != 0
      && (*(_DWORD *)(v40 + 60) && !sub_2DD518(v4, (_DWORD *)(v40 + 60))
       || *(_DWORD *)(v40 + 76) && !sub_2DD518(v4, (_DWORD *)(v40 + 76))) )
    {
      goto LABEL_122;
    }
    v41 = *(_QWORD *)(v40 + 16);
    ...
    *(_DWORD *)(v40 + 80) = 0;
    if ( v41 == -1 )
    {
      ...
      if ( *(_DWORD *)(v40 + 48) )
        v42 = 1;
      if ( v42 )
        sub_2A6C18((int)"elflink.c", 11809, (int)"bfd_elf_final_link");
      v43 = sub_2AB390(*(_DWORD *)(v40 + 24));
      if ( !v43 )
        goto LABEL_122;
      *(_DWORD *)(v40 + 48) = v43;
    }
  ...
  *(_DWORD *)(v4 + 124) = 0;
  ...
  if ( v74 )
  {
    sub_2D07A8((int)(v321 + 18), *(_QWORD *)(*(_DWORD *)(v73 + 2348) + 32), 1);
    v364 = 0;
    v365 = 0;
    v368 = 0;
    v366 = 0;
    v367 = 0;
    if ( sub_2DCC70(&v374, 0, &v364, (int)&off_4708A8, 0) != 1 )
      goto LABEL_122;
    v76 = *(_DWORD *)(v4 + 160);
    v365 = 0;
    v364 = 0;
      ...
      do
      {
        ...
        if ( v79 )
        {
          ...
          *(_DWORD *)(v79 + 136) = v81;
          if ( (v80 & 3) != 2 )
            v364 = *(_DWORD *)(v79 + 28);
          if ( sub_2DCC70(&v374, 0, &v364, v79, 0) != 1 )
            goto LABEL_122;
        }
      }
  ...
  if ( v350 )
  {
    v380 = sub_2AB390(v350);
    if ( !v380 )
      goto LABEL_122;
  }
  if ( ptr )
  {
    v381 = sub_2AB390(12 * ptr);
    if ( !v381 )
      goto LABEL_122;
  }
  v382 = sub_2AB390(v71 * *(unsigned __int8 *)(*(_DWORD *)(v319 + 392) + 5));
  if ( !v382 )
    goto LABEL_122;
  v384 = sub_2AB390(20 * v71);
  if ( !v384 )
    goto LABEL_122;
  v385 = sub_2AB390(4 * v71);
  if ( !v385 )
    goto LABEL_122;
  v386 = sub_2AB390(4 * v71);
  if ( !v386 )
    goto LABEL_122;
  if ( v328 )
  {
    v383 = sub_2AB390(4 * v328);
    if ( !v383 )
      goto LABEL_122;
  }
  v82 = v313[51];
  ...
  while ( 2 )
  {
    ...
    while ( 2 )
    {
      if ( v90[1] == 1 )
      {
        ...
        if ( *(_DWORD *)(*(_DWORD *)(LODWORD(v91) + 4) + 4) == 5
          && *(unsigned __int8 *)(*(_DWORD *)(LODWORD(v91) + 160) + 4) == *(unsigned __int8 *)(*(_DWORD *)(v93 + 392)
                                                                                             + 12)
          && (v339 = HIDWORD(v91), v330 = *(_DWORD *)(v97 + 148), (v126 = sub_2D4BA4(v330, v90[4])) != 0)
      ...
      if ( !v96 )
      {
        ...
        if ( HIDWORD(v91) )
          v132 = v92 == 0;
        if ( v132 )
          sub_2A6A84("%A has both ordered and unordered sections", v91);
        else
          sub_2A6A84(
    ...
    if ( v135 )
    {
      ...
      v138 = v133;
      v139 = &v133[4 * v136];
      qsort(v133, v136, 4u, (__compar_fn_t)sub_2DCE6C);
      do
      {
        v140 = *(_DWORD *)(*(_DWORD *)v138 + 16);
        v141 = v135 & (-1 << *(_DWORD *)(v140 + 64));
        v142 = sub_2A692C(v4);
        v143 = sub_347440(v141, v142);
        v144 = *(_DWORD *)v138;
        v138 += 4;
        *(_DWORD *)(v140 + 56) = v143;
        v145 = *(_DWORD *)(v144 + 12);
    ...
    {
      qsort(v133, (size_t)v90, 4u, (__compar_fn_t)sub_2DCE6C);
    }
    free(v134);
LABEL_192:
    v89 = *(_DWORD *)(v89 + 12);
      ...
      for ( k = (_DWORD *)v101[40]; k; k = (_DWORD *)*k )
      {
        ...
        if ( v105 == 1 )
        {
            ...
            && *(unsigned __int8 *)(*(_DWORD *)(v102 + 160) + 4) == *(unsigned __int8 *)(*(_DWORD *)(v319 + 392) + 12) )
          {
            ...
            {
              if ( !sub_2E95F4(&v374, *(_DWORD *)(k[4] + 148)) )
              {
                v4 = v103;
                goto LABEL_122;
              }
        ...
        else if ( (unsigned int)(v105 - 3) <= 1 )
        {
          ...
          v107 = sub_301780(v103, *(_DWORD *)k[4]);
          if ( !v107 )
          {
            v4 = v103;
            ((void (__fastcall *)(int))loc_2A6C70)(17);
          ...
          if ( k[1] == 3 )
          {
            ...
            if ( !v338 )
              sub_2A6BE4("elflink.c", 11101);
            ptrb[v111] = 0;
          }
          else
          {
            v146 = sub_2FC988(v103, a2, v110, 0, 0, 1);
            if ( v146 )
            {
          ...
          if ( !v113 )
          {
            ...
            if ( v65 )
              goto LABEL_121;
            v149 = sub_301234(v107, v103, compara, v64);
            if ( v149 != 2 )
            {
              if ( v149 != 3 )
                sub_2A6C18((int)"elflink.c", 11166, (int)"elf_reloc_link_order");
              v150 = *(_DWORD **)(k[4] + 4);
              if ( k[1] == 3 )
                v150 = (_DWORD *)*v150;
            ...
            v151 = k[2];
            v152 = sub_2A692C(v103);
            v153 = sub_2ADE10(v103, v101, ptra, 0, (unsigned int)(v152 * v151), n);
            free(ptra);
            if ( !v153 )
            {
LABEL_121:
        ...
        if ( !sub_2FEA18(v103, a2, v101, k) )
        {
          ...
          if ( v129[1] == 1 && *(_DWORD *)(*(_DWORD *)(v102 + 4) + 4) == 5 )
          {
            ...
            if ( v131 != v130 )
            {
              ...
              {
                if ( v130 != 2 )
                  sub_2A6C18((int)"elflink.c", 12049, (int)"bfd_elf_final_link");
                v179 = "ELFCLASS64";
              }
              else
              {
              ...
              {
                if ( v131 != 2 )
                  sub_2A6C18((int)"elflink.c", 12057, (int)"bfd_elf_final_link");
                v178 = "ELFCLASS64";
              }
              else
              {
              ...
              sub_2A6A84("%B: file class %s incompatible with %s", v102, v178, v179);
            }
          }
          goto LABEL_122;
        }
  ...
  v361 = 1;
  v363 = &v374;
  sub_2AAFB8(*(_DWORD *)(a2 + 28), (int (__fastcall *)(_DWORD *, int))sub_2DF3E8, (int)&v360);
  v2 = v360;
  if ( v360 )
    return 0;
  ...
  if ( v154 )
  {
    ...
    if ( (*(_BYTE *)(a2 + 1) & 0x60) != 0x60 )
      v155 = base | 1;
    if ( v155 && !v154(v4, a2, &v374, sub_2DCC70) )
      return 0;
  }
        ...
        if ( (v159 & 1) != 0 || v313[13] )
        {
          ...
          while ( v181 )
          {
            ...
            if ( v183 > 0 )
            {
              v184 = *(_DWORD *)(v182 + 92);
              if ( v184 <= 0 )
                sub_2A6BE4("elflink.c", 12154);
              v373 = v184;
              if ( (unsigned int)(v184 - 65280) < 0xFFFF0000 && !sub_2DCC44(v4) )
                return v2;
  ...
  v360 = 0;
  v361 = 0;
  sub_2AAFB8(v167, (int (__fastcall *)(_DWORD *, int))sub_2DF3E8, (int)&v360);
  v2 = v360;
  if ( v360 )
    return 0;
  ...
  if ( v168 )
  {
    ...
    if ( (*(_BYTE *)(a2 + 1) & 0x60) != 0x60 )
      v169 = base | 1;
    if ( v169 && !v168(v4, a2, &v374, sub_2DCC70) )
      return 0;
  }
  sub_2F068C(v376);
  v170 = *(_DWORD *)(v374 + 28);
  ...
  {
    sub_2A6BE4("elflink.c", 9290);
    v171 = *(_DWORD *)(v170 + 88);
    v172 = v375;
  }
  v173 = *(_DWORD *)(*(_DWORD *)(v172 + 4) + 444);
  v174 = sub_2AB390(v171 * *(unsigned __int8 *)(*(_DWORD *)(v173 + 392) + 5));
  if ( !v174 )
    return 0;
  if ( v387 )
  {
    v387 = sub_2AB514(4 * *(_DWORD *)(v375 + 124));
    if ( !v387 )
    {
      free(v174);
      return v2;
  ...
  if ( sub_2A8A2C(v375, *(_QWORD *)(v186 + 88) + *(unsigned int *)(v186 + 96), 0)
    || v187 != sub_2A88AC((int)v174, v187, v375) )
  {
    free(v174);
    free(*(void **)(v170 + 96));
    *(_DWORD *)(v170 + 96) = 0;
...
LABEL_358:
  ...
  if ( v188 )
  {
    ...
    if ( v209 && *(_DWORD *)v209 )
    {
      ...
      *(_DWORD *)(v209 + 36) = 4;
      v211 = sub_2D07A8(v209, v210, 1);
      if ( sub_2A8A2C(v4, *(_QWORD *)(v209 + 16), 0) || sub_2A88AC((int)v387, v311, v4) != v311 )
        return 0;
      v208 = *(_DWORD *)(v4 + 160);
    }
    v212 = v376;
    ...
    *(_DWORD *)(v208 + 208) = sub_2F04F4(v212);
    *(_DWORD *)(v208 + 224) = 0;
    *(_DWORD *)(v208 + 212) = 0;
    *(_DWORD *)(v208 + 216) = 0;
    *(_DWORD *)(v208 + 220) = 1;
    v214 = sub_2D07A8(v208 + 184, v211, 1);
    v215 = *(_QWORD *)(v208 + 200);
    *(_QWORD *)(*(_DWORD *)(*(_DWORD *)(v4 + 160) + 2348) + 32) = v214;
    if ( !sub_2A8A2C(v4, v215, 0) && sub_2F05B0(v4, v376) )
      goto LABEL_359;
    return 0;
  }
LABEL_359:
  ...
  if ( v189 )
  {
    ...
    if ( sub_2AA89C(*(_DWORD *)(a2 + 52), 1) )
    {
      v191 = (*(_DWORD *)(v4 + 40) >> 5) & 0xFFFFF;
      if ( sub_2A7A38(v189, 0) )
      {
        if ( sub_2A6B78(v189, v191 & 0xFFFFC) )
        {
          v192 = sub_2A67A8(v4);
          v193 = sub_2A67B4(v4);
          if ( (*(int (__fastcall **)(int, int, int))(*(_DWORD *)(v189 + 4) + 340))(v189, v192, v193)
            || (*(_BYTE *)(v4 + 43) & 4) == 0 && (v199 = sub_2A67A8(v4), v199 == sub_2A67A8(v189)) )
          {
            ...
            if ( v194 >= 0 )
            {
              ...
              if ( v197 )
                ...
                v198 = sub_2D06D8(v4, a2, v195, v196);
              if ( !v198 )
              {
                ((void (__fastcall *)(int))loc_2A6C70)(7);
                sub_2A6A84("%B: no symbol found for import library", v189);
                goto LABEL_374;
              }
              v298 = (_DWORD *)sub_2AD070(v189, v198, 0x34u);
              v299 = v195 - 1;
              v300 = 0;
              while ( v198 > v300 )
              {
...
LABEL_374:
    ...
    sub_2A6A84("%B: failed to generate import library", *(_DWORD *)(a2 + 52));
    return v2;
  }
LABEL_380:
  for ( jj = *(char **)(v4 + 100); jj; jj = (char *)*((_DWORD *)jj + 3) )
  {
    ...
    if ( (*((_DWORD *)jj + 5) & 4) != 0 )
    {
      ...
      if ( v203 )
        ...
        v204 = 1;
      if ( *(_DWORD *)(v202 + 60) && !sub_168BC(v4, (int)jj, (_DWORD *)(v202 + 60), (_DWORD *)v204, (_BYTE *)a2)
        || *(_DWORD *)(v202 + 76) && !sub_168BC(v4, (int)jj, (_DWORD *)(v202 + 76), (_DWORD *)v204, (_BYTE *)a2) )
      {
        return 0;
      }
      *((_DWORD *)jj + 19) = 0;
  ...
  if ( v342 )
  {
    ...
    v340 = sub_2A692C(v4);
    v230 = sub_2AD7D4(v4, ".rela.dyn");
    v231 = sub_2AD7D4(v4, ".rel.dyn");
    v232 = v231;
    if ( v230 )
    {
      v233 = *((_DWORD *)v230 + 9);
        ...
        if ( *((_DWORD *)v231 + 9) )
        {
          ...
          while ( v243 )
          {
            if ( v243[1] == 1 )
            {
              ...
              v250 = (unsigned __int64)sub_34769C(v249, *(unsigned __int8 *)(v246 + 3)) >> 32;
              if ( (unsigned __int64)sub_34769C(v249, *(unsigned __int8 *)(v246 + 4)) >> 32 )
              {
                if ( v250 )
                {
LABEL_658:
                  ...
                  jj = 0;
                  v219 = 0;
                  sub_2A6A84("%B: Unable to sort relocs - they are of an unknown size", baseb);
...
LABEL_526:
                  ...
                  jj = 0;
                  v219 = 0;
                  sub_2A6A84("%B: Unable to sort relocs - they are in more than one size", baseb);
                  ((void (__fastcall *)(int))loc_2A6C70)(5);
                  goto LABEL_421;
                }
                v242 = 1;
          ...
          for ( kk = (_DWORD *)*((_DWORD *)v344 + 40); kk; kk = (_DWORD *)*kk )
          {
            ...
            {
              v277 = *(_DWORD *)(kk[4] + 36);
              v278 = (unsigned __int64)sub_34769C(v277, *(unsigned __int8 *)(v246 + 3)) >> 32;
              if ( (unsigned __int64)sub_34769C(v277, *(unsigned __int8 *)(v246 + 4)) >> 32 )
              {
                if ( v278 )
                  goto LABEL_658;
                v245 &= v242;
...
LABEL_488:
          ...
          if ( v237 == *((_DWORD *)v230 + 9) )
          {
            ...
            v240 = sub_347440(v237, v323);
            v241 = v240;
            if ( v240 )
            {
              basea = (char *)sub_2AB514(v240 * comparb);
              if ( !basea )
              {
                v219 = 0;
              ...
              while ( v247 )
              {
                if ( v247[1] == 1 )
                {
                  ...
                  v356 = v219 + v274;
                  v275 = &basea[comparb * sub_347440(v273[14] * v340, v323) + 8];
                  while ( v356 > v219 )
                  {
                    v276 = v219;
                    v219 += v323;
              ...
              v219 = 0;
              qsort(basea, v241, comparb, (__compar_fn_t)sub_2DC868);
              v279 = basea;
              while ( v279[1] == 1 )
              {
                ++v219;
...
LABEL_602:
              qsort(v279, v241 - v219, comparb, (__compar_fn_t)sub_2DF394);
...
LABEL_629:
              ...
              while ( v281 )
              {
                if ( v281[1] == 1 )
                {
                  ...
                  v293 = *(_DWORD *)(v291 + 36);
                  v333 = v291;
                  v294 = sub_347440(v282 - basea, comparb);
                  v295 = v292 + v293;
                  *(_DWORD *)(v333 + 56) = sub_347440(v323 * v294, v340);
                  while ( v295 > v292 )
                  {
                    v296 = v292;
                    v297 = v282 + 8;
              ...
              free(basea);
LABEL_421:
              v220 = sub_2AD88C(v353, ".dynamic");
              if ( !v220 )
                sub_2A6BE4("elflink.c", 12318);
              v221 = v220[27];
              ...
              while ( 1 )
              {
                ...
                if ( v369 == 6 )
                {
                  v222 = ".dynsym";
LABEL_434:
                  v223 = sub_2AD88C(v353, v222);
LABEL_435:
                  if ( !v223 || (v224 = v223[15], (char **)v224 == &off_470950) )
                  {
LABEL_652:
                    sub_2A6A84("could not find section %s", v222);
                    goto LABEL_122;
                  }
                  if ( *(_DWORD *)(*(_DWORD *)(v224 + 140) + 4) == 7 )
                  {
                    sub_2A6A84("warning: section '%s' is being made into a note", v222);
                    ((void (__fastcall *)(int))loc_2A6C70)(15);
                    goto LABEL_122;
                  }
                  v225 = *(_DWORD *)(v224 + 28);
...
LABEL_443:
                  ...
                  {
                    v331 = v227;
                    sub_2A6A84("warning: %s section has zero size", v222);
                    v228 = *((_DWORD *)v331 + 9);
                  }
                  v370 = v228;
                  v226 = *(_DWORD *)(v319 + 392);
...
LABEL_393:
      ...
      if ( (v254 & 0x100) != 0 )
      {
        if ( *(_DWORD *)(nn + 36) )
        {
          ...
          if ( v255 != &off_470950 && (v254 & 0x100000) != 0 && v313[41] != nn && v313[42] != nn )
          {
            ...
            {
              if ( sub_2A8A2C(v4, *((_QWORD *)v255[35] + 2), 0) || !sub_2F05B0(v4, v313[21]) )
                goto LABEL_122;
            }
            else
            {
  ...
  if ( (*(_BYTE *)(a2 + 1) & 0x10) == 0 )
  {
    ...
    if ( (*(_BYTE *)a2 & 3) != 2 )
      sub_2A6BE4("elflink.c", 12591);
    sub_2ADD24(v4, (int (__fastcall *)(int, int, int))sub_2CC3FC, (int)&v369);
    if ( v369 )
      goto LABEL_122;
  }
  if ( v313[41] && !sub_302948(v4, v313 + 33) || !sub_2F4FEC(v4, a2) )
    goto LABEL_122;
  v2 = 1;
  sub_2DD7A0((_DWORD *)(v4 + 100), &v374);
  *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v4 + 160) + 2348) + 56) = 1;
  if ( v354 )
  {
    v216 = sub_2AB390(v357);
    v217 = v216;
    if ( v216 )
    {
      sub_2EF3F8(v4, v216, v357);
      sub_2ADE10(v4, v354, v217, 0, 0, v357);
      free(v217);
      return v2;
    }
    return 0;
