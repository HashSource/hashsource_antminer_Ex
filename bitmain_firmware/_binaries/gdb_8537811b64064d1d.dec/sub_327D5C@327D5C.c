int *__fastcall sub_327D5C(int *result, int a2, int a3)
{
  int *v3; // r4
  int v4; // r1
  int v5; // r6
  ...
  else
  {
    ...
    if ( v9 != 3 )
      *(_WORD *)(v5 + v8) = (unsigned __int64)sub_34769C(*(unsigned __int16 *)(v5 + v8), dword_438D28[v9]) >> 32;
    *v3 = sub_327CD0(v5, (v8 >> 1) + 1);
    return v3;
  }
  return result;
}
