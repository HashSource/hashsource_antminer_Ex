int __fastcall sub_1542E8(int *a1, const char *a2, int a3, int a4)
{
  ...
  {
    sub_9206C(a1, (const void *)HIDWORD(v4), v8 - 1);
    LODWORD(v4) = 0;
  ...
  if ( v9 == v10 )
  {
    ...
    if ( v19 )
    {
      if ( dword_48A55C )
      {
        if ( sub_244AD4(dword_487668) )
        {
          v21 = sub_298EDC(v4, &ptr);
          if ( v21 )
          {
            sub_259880("%s\n", (const char *)ptr);
            if ( v21 < 0 )
...
LABEL_8:
      ...
      if ( a3 )
      {
        ...
        if ( !*(_BYTE *)v4 || !v11 || !sub_244AD4(dword_487668) )
        {
LABEL_19:
          if ( dword_48A4EC )
            free((void *)dword_48A4EC);
          LODWORD(v4) = sub_32727C(v4);
          dword_48A4EC = v4;
          return v4;
        }
      }
      else if ( !*(_BYTE *)v4 || !v11 || !sub_244AD4(dword_487668) )
      {
        return v4;
      }
      sub_243E50(v4);
