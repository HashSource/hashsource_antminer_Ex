void __fastcall sub_1EF678(int a1)
{
  int v1; // r0
  const char **v2; // r4
  char *v3; // r7
  ...
  if ( *(_DWORD *)(dword_487D2C + 32) )
  {
    ...
    sub_1E7E14("qOffsets");
    sub_1E4EE0((char **)v2, (size_t *)v2 + 1, 0, 0, 0);
    v3 = (char *)*v2;
    if ( **v2 )
    {
      if ( **v2 == 69 )
      {
        sub_946D8("Remote failure reply: %s", *v2);
        return;
      }
      if ( !strncmp(*v2, "Text=", 5u) )
      {
        ...
        if ( !strncmp(v5, ";Data=", 6u) )
        {
          ...
          if ( !v16 )
          {
            ...
            {
              v24 = 1;
              sub_946D8("Target reported unsupported offsets: %s", v3);
              v25 = *v19;
            }
            goto LABEL_43;
          }
...
LABEL_43:
        ...
        v30 = (_DWORD *)sub_214E58(*(_DWORD *)(*(_DWORD *)(v29 + 32) + 36));
        v31 = v30;
        if ( v16 )
        {
          dest = v6;
...
LABEL_69:
            ...
            if ( v42 != -1 )
            {
              ...
              *(&dest + v42) = v6;
              ...
              sub_94728((int)"remote.c", 3673, "sect_index_data not initialized");
            }
            v45 = sub_94728((int)"remote.c", 3666, "sect_index_text not initialized");
LABEL_82:
            sub_94708("Can not handle qOffsets TextSeg response with this symbol file", HIDWORD(v45));
          }
          v41 = *v30;
          if ( *v30 == 2 )
          {
...
LABEL_68:
        ...
        LODWORD(v45) = ((int (__fastcall *)(_DWORD, _DWORD *, int *, int, int *))loc_2151DC)(
      ...
      sub_94708("Malformed response to offset query, %s", v3);
    }
  }
}
