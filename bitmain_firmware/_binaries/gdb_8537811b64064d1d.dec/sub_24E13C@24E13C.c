int __fastcall sub_24E13C(int a1, int a2)
{
  int v3; // r3
  int v4; // r1
  int v5; // r3
  ...
  if ( v3 )
  {
    if ( dword_48A514 )
    {
      ...
      if ( a1 != *(_DWORD *)(v45 + 8) )
      {
        ...
        {
          *(_DWORD *)a1 = a1 + 8;
          sub_248B4C((_DWORD *)a1, &v47, (int)v48);
          a1 = *(_DWORD *)(v45 + 4);
        }
        *(_DWORD *)(v45 + 4) = a1 + 24;
        v4 = dword_48A514;
...
LABEL_7:
  ...
  if ( v12 == *(_DWORD **)(v45 + 8) )
  {
    a1 = sub_25014C(v45, *(_DWORD *)(v45 + 4), &v47);
    v4 = dword_48A514;
  }
  else
  {
    if ( v12 )
    {
      *v12 = v12 + 2;
      v13 = strlen(&v47);
      a1 = (int)sub_248B4C(v12, &v47, (int)&v48[v13 - 1]);
      v12 = *(_DWORD **)(v45 + 4);
    }
    v4 = dword_48A514;
    *(_DWORD *)(v45 + 4) = v12 + 6;
...
LABEL_20:
  if ( !v4 )
    goto LABEL_21;
  a1 = sub_259F38((const char *)&word_356660);
  v14 = *(_QWORD *)(a2 + 32);
  if ( HIDWORD(v14) != (_DWORD)v14 && dword_48A514 )
  {
    a1 = sub_259F38("Collecting memranges: \n");
LABEL_21:
    v14 = *(_QWORD *)(a2 + 32);
  }
  v15 = 0;
  ...
  else
  {
    ...
    do
    {
      ...
      if ( dword_48A514 )
      {
        ...
        v27 = sub_16F67C(v19);
        v28 = sub_25ACB4(v27, *(_DWORD *)(*(_DWORD *)(a2 + 32) + v15 + 4));
        sub_259F38(
          "(%d, %s, %ld)\n",
          v26,
          v28,
      ...
      v25 = sub_98A18(v23, v23 >> 31, 0, v22);
      if ( v21 == -1 )
