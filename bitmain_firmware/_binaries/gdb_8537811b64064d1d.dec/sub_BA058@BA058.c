int sub_BA058(char *s2, int a2, ...)
{
  ...
  {
    va_copy(v10, varg_r2);
    v3 = (_DWORD *)sub_242FF0(s2);
    sub_25936C(*v3, varg_r1, (char *)varg_r2);
  }
  if ( sub_B93A8(s2, (const char **)&ptr) )
  {
    v4 = ptr;
    v5 = 1;
  }
  ...
  {
    ((void (*)(void))loc_B9D20)();
    v5 = sub_B93A8(s2, (const char **)&ptr);
    v4 = ptr;
    if ( v5 )
    {
      v5 = 1;
    ...
    else
    {
      ...
      else
      {
        ...
        if ( v7 )
          v8 = v7;
        sub_93200((char **)&v10, "%s/%s", v8, ".gdbinit");
        sub_259F38(
