int __fastcall sub_2C6364(_DWORD *a1, int a2)
{
  int v2; // r4
  int v3; // r2
  int v4; // r4
  ...
  while ( 1 )
  {
    ...
    ptr = *(void **)(v11 + 48);
LABEL_25:
    qsort(*(void **)(v11 + 152), v12, 8u, (__compar_fn_t)sub_2B5F28);
    v13 = *(_DWORD *)(v11 + 144);
    v14 = (char *)ptr;
    if ( v13 )
    {
...
LABEL_27:
      ...
      while ( 1 )
      {
        ...
        if ( v8 == 2 )
        {
          if ( sub_2B5834(v30, &v63, v66, &v64) != 3 && sub_2B273C(v63, (int)v65, v62) )
            goto LABEL_65;
          v8 = 0;
          v14 = (char *)ptr;
          v20 = v58 + 4;
LABEL_40:
        ...
        {
          if ( (sub_2B5834(v30, &v63, v65, &v62) & 0xFFFFFFFD) == 0 )
          {
            v58 = v20;
            v20 += 4;
            v14 = (char *)ptr;
...
LABEL_65:
        ...
        if ( v33 != 4 )
        {
          sub_2A6BE4("elf32-arm.c", 7120);
          __und(0);
        }
        v34 = v32[90];
        if ( !v34 )
        {
          sub_2A6BE4("elf32-arm.c", 7121);
          v34 = v32[90];
        }
        v35 = sub_2AD88C(v34, ".vfp11_veneer");
        v53 = v35[35];
        v36 = (char *)sub_2AB390(27);
        if ( !v36 )
          sub_2A6BE4("elf32-arm.c", 7133);
        sprintf(v36, "__vfp11_veneer_%x", v32[99]);
        if ( sub_2FC948(v32, v36, 0) )
          sub_2A6BE4("elf32-arm.c", 7141);
        v37 = v32[90];
        v51 = v32[86];
        v66[0] = 0;
        sub_2FD6EC(a2, v37, (int)v36, 9, (int)v35, v51, 0, 1, 0, (int)v66);
        v38 = v66[0];
        v39 = *(_BYTE *)(v66[0] + 52);
        *(_BYTE *)(v66[0] + 48) = 2;
        *(_BYTE *)(v38 + 52) = v39 | 8;
        ++*((_DWORD *)v53 + 39);
        v40 = sub_2AB514(0x14u);
        v41 = v32[99];
        v42 = *((_DWORD *)v53 + 40);
        v40[4] = 2;
        v40[1] = -1;
        ...
        *((_DWORD *)v53 + 40) = v40;
        ...
        if ( sub_2FC948(v32, v36, 0) )
          sub_2A6C18((int)"elf32-arm.c", 7175, (int)"record_vfp11_erratum_veneer");
        v66[0] = 0;
        sub_2FD6EC(a2, v21, (int)v36, 1, v57, v58 + 4, 0, 1, 0, (int)v66);
        v43 = v66[0];
        v44 = *(_BYTE *)(v66[0] + 52);
        *(_BYTE *)(v66[0] + 48) = 2;
        *(_BYTE *)(v43 + 52) = v44 | 8;
        ...
        if ( !v45 )
        {
          v46 = v32[90];
          v66[0] = 0;
          sub_2FD6EC(a2, v46, (int)"$a", 1, (int)v35, 0, 0, 1, 0, (int)v66);
          v47 = v66[0];
          v48 = *(_BYTE *)(v66[0] + 52);
          *(_BYTE *)(v66[0] + 48) = 0;
          *(_BYTE *)(v47 + 52) = v48 | 8;
          sub_2B9E2C(v35[35], 97, 0);
          v45 = v32[86];
        }
        v20 += 4;
        v49 = v32[99];
