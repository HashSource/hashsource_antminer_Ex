int __fastcall sub_1D00C0(int a1, _DWORD *a2, char *s, int a4, int a5)
{
  int v6; // r4
  char *v10; // r7
  size_t v11; // r0
  ...
  if ( !v6 )
    return v6;
  if ( off_46D5A4[0][2] == (char *)4 && strchr(s, 40) && (sub_100160(&sa, (int)s), (v10 = sa) != 0) )
  {
    v35[0] = v36;
  }
  else
  {
    v10 = (char *)sub_32727C(s);
    v35[0] = v36;
  }
  v11 = strlen(v10);
  v12 = sub_1CF040(v35, v10, (int)&v10[v11]);
  v13 = (void *)v35[0];
  v14 = 1;
  v38 = 0;
  v39 = 0;
...
LABEL_40:
    ...
    while ( 1 )
    {
      v31 = v29;
      v32 = *v29++;
      if ( sub_21D9D8(*(_BYTE *)(v32 + 20) & 0x1F, *(_BYTE *)(v32 + 24) & 7, a5) )
      {
        if ( sub_21B820(*(v29 - 1)) )
          break;
      }
...
LABEL_38:
  ...
  else
  {
    ...
    {
LABEL_64:
      sub_94728((int)"psymtab.c", 719, "failed internal consistency check");
      sub_AF598((int)&sa);
      free(v10);
      sub_339024(v33);
    }
    ...
    while ( 1 )
    {
      v22 = sub_21B804(*(_DWORD *)v19);
      if ( sub_25A8E0(v22, v10) >= 0 )
        v21 = v19;
      else
        v20 = v19 + 4;
      if ( v20 >= v21 )
...
LABEL_32:
        ...
        while ( v18 >= (unsigned int)v25 )
        {
          ...
          if ( !sub_21B820(v26) )
            break;
          if ( sub_21D9D8(*(_BYTE *)(*(v25 - 1) + 20) & 0x1F, *(_BYTE *)(*(v25 - 1) + 24) & 7, a5) )
          {
            v6 = *v27;
            goto LABEL_38;
          }
...
LABEL_29:
  ...
  v34 = sub_94728((int)"psymtab.c", 732, "failed internal consistency check");
  return sub_1D04A4(v34, HIDWORD(v34));
}
