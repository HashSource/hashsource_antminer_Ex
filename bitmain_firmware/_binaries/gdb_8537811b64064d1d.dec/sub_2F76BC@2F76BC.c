char *__fastcall sub_2F76BC(int a1, int a2)
{
  char *v2; // r0
  char *v3; // r4
  int v5; // r2
  ...
  {
    if ( a2 )
      sub_2A6A84("Dwarf Error: mangled line number section (bad file number).");
    goto LABEL_4;
  }
  v5 = *(_DWORD *)(a1 + 24);
  v6 = a2 + 0xFFFFFFF;
...
LABEL_14:
  ...
  v22 = (char *)sub_2AB390(v19 + v18 + 3 + v21);
  v3 = v22;
  if ( !v22 )
    return v3;
