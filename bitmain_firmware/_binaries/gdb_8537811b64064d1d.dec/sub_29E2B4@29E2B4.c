int __fastcall sub_29E2B4(int a1, void (__fastcall **a2)(int, __int64 *), unsigned int a3)
{
  int v4; // r5
  __int64 v5; // r6
  int v6; // r8
  ...
  else
  {
    ((void (*)(_DWORD, const char *, ...))v5)(
      HIDWORD(v5),
      "[%s",
      (&off_3FDE64[18 * dword_4707E4 + 2])[HIWORD(a3) & 0xF]);
    v7 = a3 & 0x2000000;
    if ( v4 )
    {
      if ( v7 )
      {
        ...
        sub_29E160(a3, (int (*)(int, const char *, ...))v5, SHIDWORD(v5), 1);
      }
      else
      {
        v4 = a3 & 0xFFF;
    ...
    else
    {
      ...
      LOWORD(v7) = (unsigned __int16)&word_3C148C;
      if ( v15 )
      {
        v4 = a3 & 0xFFF;
        ...
        if ( !v6 )
        {
          HIWORD(v7) = (unsigned int)&word_3C148C >> 16;
          v11 = v7;
        }
