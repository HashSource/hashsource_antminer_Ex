int __fastcall sub_2EE1DC(int a1, int a2, int a3, unsigned int a4)
{
  unsigned int *v6; // r2
  char v7; // r7
  char *v8; // r9
  ...
  if ( !v6 )
  {
    v6 = (unsigned int *)sub_2AD0C4(a1, 0xCu);
    *(_DWORD *)(a3 + 68) = v6;
    if ( !v6 )
      return 0;
  }
...
LABEL_9:
  ...
  if ( v8 )
  {
    v12 = (char *)sub_2AB424(v8 - 4, 4 * ((v11 >> v7) + 1));
    if ( v12 )
    {
...
LABEL_8:
  ...
  {
    v12 = (char *)sub_2AB514(4 * ((v11 >> v7) + 1));
    if ( v12 )
      goto LABEL_8;
  }
  return 0;
