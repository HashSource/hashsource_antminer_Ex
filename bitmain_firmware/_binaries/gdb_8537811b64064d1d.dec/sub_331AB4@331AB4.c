int *__fastcall sub_331AB4(int *a1, int *a2, int a3)
{
  int v3; // r3
  int v4; // r4
  _BYTE *v5; // r7
  ...
  {
    sub_3312D4((int)v25, 32);
    v26 = *(_DWORD *)(a3 + 12);
    sub_32D1E0((int)v23, (unsigned int)v5, (int)v25);
    v9 = v5[8];
    v5 = v23;
    v4 = v27;
    v10 = v9 & 0x80 | v24;
  ...
  if ( (v10 & 0x70) == 0 )
  {
    ...
    if ( (unsigned int)(v14 + 101) <= 0xBF )
    {
      ...
      v22 = v17;
      if ( v6 || (v17 |= word_43A6D0[*((unsigned __int16 *)v5 + 6)] << 10, v22 = v17, v21 != 7) )
      {
        v18 = 0;
        goto LABEL_18;
      }
