void __fastcall sub_23664C(int a1)
{
  char *v1; // r5
  int v2; // r4
  size_t v3; // r0
  ...
  if ( a1 )
  {
    ...
    if ( v2 )
      goto LABEL_3;
LABEL_143:
    sub_94708("There is no target description to print.");
  }
  v73 = sub_1836B0();
  v74 = *(_DWORD **)(v73 + 164);
  if ( !v74 )
  {
    v74 = sub_930BC(1u, 0xCu);
    *(_DWORD *)(v73 + 164) = v74;
  }
  v2 = v74[1];
  v75 = sub_1836B0();
  ...
  if ( !v2 )
    goto LABEL_143;
  if ( !v1 )
    sub_94708("The current target description did not come from an XML file.");
LABEL_3:
  s1 = (char *)v84;
  v3 = strlen(v1);
  sub_235120(&s1, v1, (int)&v1[v3]);
  v4 = sub_33C70C((int)&s1, "/features/", -1, 0xAu);
  if ( v4 == -1 )
    goto LABEL_4;
  v70 = v4 + 10;
  if ( v4 + 10 > v83 )
    sub_33D234("%s: __pos (which is %zu) > this->size() (which is %zu)", "basic_string::substr", v70, v83);
  v94 = &v96;
  sub_235120(&v94, &s1[v70], (int)&s1[v83]);
  v71 = (unsigned int *)s1;
  if ( v94 == &v96 )
  {
    sub_33B4B4(&s1, &v94);
...
LABEL_4:
    ...
    || !strncmp(v5, "aarch64", 7u) )
  {
    v94 = off_3E9B84;
    v95 = v97;
    sub_235120(&v95, v5, v7);
    v99 = 0;
    v100 = 0;
    v101 = 0;
    v8 = (const char *)sub_3245CC(v95);
    v9 = strlen(v8);
    ptr = sub_93050(v9 + 1);
    v11 = ptr;
    ...
    *v11 = 0;
    sub_259880("/* THIS FILE IS GENERATED.  -*- buffer-read-only: t -*- vi:set ro:\n", v10);
    v102 = 0;
    v94 = off_3E9BAC;
    v16 = sub_33C770(&v95, 46, -1);
    v85 = v87;
    if ( v16 > v96 )
      v17 = (char *)v95 + v96;
    else
      v17 = (char *)v95 + v16;
    sub_235120(&v85, v95, (int)v17);
    v18 = v95;
    if ( v85 == v87 )
    {
      sub_33B4B4(&v95, &v85);
...
LABEL_24:
        ...
        *v18 = 0;
        ...
        if ( v20 != sub_2399F4 )
          goto LABEL_131;
        v21 = (const char *)sub_3245CC(v95);
        sub_259880("  Original: %s */\n\n", v21);
        sub_259880("#include \"arch/tdesc.h\"\n");
        sub_259880((const char *)&word_356660);
        v80 = *(int **)(v2 + 40);
        if ( *(int **)(v2 + 36) == v80 )
          goto LABEL_66;
        v78 = *(int **)(v2 + 36);
...
LABEL_65:
        ...
        v88 = v90;
        sub_235120(&v88, v95, (int)v95 + v96);
        v24 = sub_33C6EC(&v88, 46, 0);
        v91 = v93;
        if ( v24 > v89 )
          v25 = (char *)v88 + v89;
        else
          v25 = (char *)v88 + v24;
        sub_235120(&v91, v88, (int)v25);
        v26 = v88;
        if ( v91 == v93 )
        {
          sub_33B4B4(&v88, &v91);
...
LABEL_37:
            ...
            *v26 = 0;
            ...
            for ( i = *(int (*****)())(v22 + 32); i != v39; v102 = (int (**)())((char *)v102 + 1) )
            {
              ...
              if ( (int)v44 < (int)v102 )
              {
                sub_259880("ERROR: \"regnum\" attribute %ld ", v44);
                sub_259880("is not the largest number (%d).\n", v102);
                sub_94708("\"regnum\" attribute %ld is not the largest number (%d).", v41[7], v102);
              }
              if ( (int)v44 > (int)v102 )
              {
              ...
              sub_259880("  tdesc_create_reg (feature, \"%s\", regnum++, %d, ", (const char *)v41[1], v41[8]);
              if ( v41[10] )
                sub_259880("\"%s\", ", (const char *)v41[9]);
              else
                sub_259880("NULL, ");
...
LABEL_131:
  ...
  v53 = (const char *)sub_3245CC(v95);
  sub_259880("  Original: %s */\n\n", v53);
  sub_259880("#include \"defs.h\"\n");
  sub_259880("#include \"osabi.h\"\n");
  sub_259880("#include \"target-descriptions.h\"\n");
  sub_259880((const char *)&word_356660);
  sub_259880("struct target_desc *tdesc_%s;\n", (const char *)ptr);
  sub_259880("static void\n");
  sub_259880("initialize_tdesc_%s (void)\n", (const char *)ptr);
  sub_259880("{\n");
  sub_259880("  struct target_desc *result = allocate_target_description ();\n");
  v54 = *(_DWORD *)(v2 + 4);
  if ( v54 )
  {
    sub_259880("  set_tdesc_architecture (result, bfd_scan_arch (\"%s\"));\n", *(const char **)(v54 + 24));
    sub_259880((const char *)&word_356660);
  }
  v55 = *(_DWORD *)(v2 + 8);
  if ( v55 - 1 <= 0x12 )
  {
    v77 = sub_1BD8B8(v55);
    sub_259880("  set_tdesc_osabi (result, osabi_from_tdesc_string (\"%s\"));\n", v77);
    sub_259880((const char *)&word_356660);
  }
  v56 = *(int **)(v2 + 12);
  v57 = *(int **)(v2 + 16);
  if ( v56 != v57 )
  {
    ...
    {
      v58 = *v56++;
      sub_259880("  tdesc_add_compatible (result, bfd_scan_arch (\"%s\"));\n", *(const char **)(v58 + 24));
    }
    while ( v57 != v56 );
  ...
  for ( j = *(const char ***)(v2 + 28); j != v59; v59 += 12 )
    sub_259880("  set_tdesc_property (result, \"%s\", \"%s\");\n", *v59, v59[6]);
  sub_259880("  struct tdesc_feature *feature;\n");
  v81 = *(int **)(v2 + 40);
  if ( *(int **)(v2 + 36) != v81 )
  {
    ...
    do
    {
      ...
      if ( v62 == sub_23910C )
      {
        ...
        while ( HIDWORD(v66) != (_DWORD)v66 )
        {
          ...
          if ( v69 == sub_238B38 )
          {
            sub_259880("  tdesc_create_reg (feature, \"%s\", %ld, %d, ", (const char *)v67[1], v67[7], v67[8]);
            if ( v67[10] )
              sub_259880("\"%s\", ", (const char *)v67[9]);
            else
              sub_259880("NULL, ");
