int __fastcall sub_95D74(void *a1, unsigned __int64 a2, unsigned __int64 a3, int a4)
{
  int v5; // r5
  unsigned int **v6; // r0
  unsigned int *v7; // r4
  ...
  v5 = a2;
  v6 = (unsigned int **)sub_22F4A8(&dword_475224);
  v7 = *v6;
  ...
  {
    if ( (*(_DWORD *)(v7[2] + 20) & 8) != 0 && sub_1B05C8(*v7, v7[1] - *v7, v5, a3) )
    {
      v9 = *v7;
      v10 = v7[1];
...
LABEL_23:
  ...
  {
    while ( !sub_1B05C8(*v12, v12[1], v5, a3) )
    {
      v12 += 2;
      if ( v13 == v12 )
      {
    ...
    {
      v17 = sub_9548C(a1, a2, v15, (_QWORD *)a4);
      v13 = (unsigned int *)ptr;
    }
  }
  if ( v13 )
