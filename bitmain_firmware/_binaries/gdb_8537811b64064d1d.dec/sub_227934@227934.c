int __fastcall sub_227934(int a1, int a2, int *a3)
{
  _DWORD *v5; // r0
  int v6; // r5
  _DWORD *v7; // r0
  ...
  sub_2594D8(*v5, "-> %s->to_make_corefile_notes (...)\n", (const char *)dword_489C90);
  v6 = off_489E00(&unk_489C8C, a2, a3);
  v7 = (_DWORD *)sub_242FF0(v6);
  sub_2594D8(*v7, "<- %s->to_make_corefile_notes (", (const char *)dword_489C90);
  ...
  if ( v6 )
    ...
    v20 = "(null)";
  v21 = (_DWORD *)sub_242FF0("(null)");
  v22 = sub_256878(v20, *v21);
  v23 = (_DWORD *)sub_242FF0(v22);
  sub_256878(&word_356660, *v23);
  return v6;
}
