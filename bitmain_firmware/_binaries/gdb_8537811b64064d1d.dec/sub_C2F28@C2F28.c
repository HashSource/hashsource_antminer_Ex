int __fastcall sub_C2F28(_DWORD *a1, const char *a2, int a3, int (__fastcall *a4)(int, int), int a5)
{
  size_t v9; // r0
  size_t v10; // r4
  _DWORD *v11; // r2
  ...
  if ( v9 > 0xF )
  {
    v19 = (_DWORD *)sub_33B2E4(&v21, &v24, 0);
    v21 = v19;
    v23[0] = v24;
LABEL_29:
...
LABEL_5:
  ...
  *(_DWORD *)((char *)v44 + 3) = 0;
  ...
  if ( v15 && *(_DWORD *)(v15 + 12) )
  {
    ...
    v20 = sub_AF598((int)&v24);
    sub_339024(v20);
  }
  for ( i = sub_C2928(a1, (int)&v24, &v21); ; i = sub_C2974((int)&v24, (int)&v21) )
  {
    v17 = i;
    if ( !i )
      break;
    if ( sub_21D9D8(*(_BYTE *)(i + 20) & 0x1F, *(_BYTE *)(i + 32) & 7, a3) && a4(v17, a5) )
      goto LABEL_21;
  }
  v17 = 0;
LABEL_21:
