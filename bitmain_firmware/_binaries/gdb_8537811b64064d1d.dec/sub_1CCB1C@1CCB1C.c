int __fastcall sub_1CCB1C(const char *a1, char *a2, char *a3)
{
  ...
  *(_DWORD *)a3 = 0;
  *(_DWORD *)a2 = 0;
  v6 = (unsigned __int8 *)sub_338BFC(a1, "Version");
  if ( v6 )
  {
    v7 = sub_93638(v6);
    v13 = 0;
  ...
  if ( byte_487D1C )
    return 0;
  sub_946D8("Could not recognize version of Intel Compiler in: \"%s\"", a1);
  byte_487D1C = 1;
  return v10;
}
