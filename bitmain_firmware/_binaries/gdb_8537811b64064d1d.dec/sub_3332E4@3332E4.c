_BYTE *__fastcall sub_3332E4(unsigned int *a1, _BYTE *a2, int a3, unsigned int *a4)
{
  _BYTE *v4; // lr
  int v5; // r2
  unsigned int v6; // r12
  ...
  if ( v10 != 3 )
  {
    v66 = 4 * (unsigned __int16)word_439EBC[(16 * (_WORD)v9) & 0x3F0 | (v8 >> 28)];
    v62 = 4 * (unsigned __int16)word_439EBC[((_WORD)v5 << 6) & 0x3C0 | (v9 >> 26)];
    v65 = 4 * (unsigned __int16)word_439EBC[(4 * (_WORD)v8) & 0x3FC | (v6 >> 30)];
    v11 = (unsigned __int16)word_439EBC[(v8 >> 8) & 0x3FF];
    v12 = 4 * (unsigned __int16)word_439EBC[(v8 >> 18) & 0x3FF];
    v67 = 4 * v11;
    v13 = 4 * (unsigned __int16)word_439EBC[((unsigned int)v5 >> 4) & 0x3FF];
    v64 = 4 * (unsigned __int16)word_439EBC[(v6 >> 20) & 0x3FF];
    v14 = &byte_438E18[v62];
    v15 = (((unsigned int)v5 >> 14) & 0xFFF) - 6176 + (v10 << 12);
    v16 = 4 * (unsigned __int16)word_439EBC[v6 & 0x3FF];
    v17 = 4 * (unsigned __int16)word_439EBC[HIWORD(v9) & 0x3FF];
    v73 = &byte_438E18[v12];
    v63 = 4 * (unsigned __int16)word_439EBC[(v6 >> 10) & 0x3FF];
    v72 = &byte_438E18[v67];
    v18 = 4 * (unsigned __int16)word_439EBC[(unsigned __int16)v9 >> 6];
    v74 = &byte_438E18[v66];
    v71 = &byte_438E18[v65];
    v19 = &byte_438E18[v13];
    v70 = &byte_438E18[v64];
    v20 = (unsigned int)&byte_438E18[v17];
    v21 = &byte_438E18[v18];
    v69 = &byte_438E18[v63];
    v68 = &byte_438E18[v16];
    if ( v61 )
              ...
              if ( v36 )
              {
                ...
                *((_BYTE *)v32 + 1) = v39;
                if ( v36 >= 1000 )
                {
                  ...
                  v59 = (1049 * (v36 >> 3)) >> 17;
                  *((_BYTE *)v32 - 4) = v59 + 48;
                  *(unsigned int *)((char *)v32 - 3) = *(_DWORD *)&byte_438E18[4 * (v36 - 1000 * v59) + 1];
                }
                else
                {
                  v40 = byte_438E18[4 * v36];
                  *(unsigned int *)((char *)v32 + 2) = *(_DWORD *)&byte_438E18[4 * v36 + 4 - v40];
...
LABEL_10:
  ...
  if ( dword_439DBC[v7] )
  {
    ...
    if ( v6 | v8 | v9 )
    {
      ...
      v13 = 4 * (unsigned __int16)word_439EBC[((unsigned int)v5 >> 4) & 0x3FF];
      v15 = 0;
      v65 = 4 * (unsigned __int16)word_439EBC[v42];
      v14 = &byte_438E18[v62];
      v17 = 4 * (unsigned __int16)word_439EBC[HIWORD(v9) & 0x3FF];
      v67 = 4 * (unsigned __int16)word_439EBC[v41];
      v64 = 4 * (unsigned __int16)word_439EBC[(v6 >> 20) & 0x3FF];
      v74 = &byte_438E18[v66];
      v72 = &byte_438E18[v67];
      v63 = 4 * (unsigned __int16)word_439EBC[(v6 >> 10) & 0x3FF];
    ...
    else
    {
      ...
      v15 = 0;
      v13 = 4 * (unsigned __int16)word_439EBC[((unsigned int)v5 >> 4) & 0x3FF];
      v20 = (unsigned int)byte_438E18;
      v68 = byte_438E18;
      v69 = byte_438E18;
      v21 = byte_438E18;
      v62 = 4 * *(unsigned __int16 *)((char *)word_439EBC + (((_WORD)v5 << 7) & 0x780));
      v16 = 0;
      v70 = byte_438E18;
      v12 = 0;
      v71 = byte_438E18;
