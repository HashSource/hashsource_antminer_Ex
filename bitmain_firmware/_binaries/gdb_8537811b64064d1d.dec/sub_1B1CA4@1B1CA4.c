unsigned int __fastcall sub_1B1CA4(int a1, int a2, int (__fastcall *a3)(unsigned int, int), int a4)
{
  const char *v8; // r6
  unsigned int v9; // r1
  const char *v10; // r0
  ...
  if ( v21 != v20 )
  {
    ...
    do
    {
      ...
      v25 = a2 + v24;
      v26 = sub_194460(v24);
      v27 = (int (__fastcall *)(int, int, _DWORD, int, _DWORD, _DWORD))sub_194598((int)v26, a2);
      if ( *(_BYTE *)(a2 + v24 + 208) )
      {
