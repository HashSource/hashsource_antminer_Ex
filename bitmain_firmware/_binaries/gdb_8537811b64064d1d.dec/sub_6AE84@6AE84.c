void __fastcall sub_6AE84(const char *a1, int *a2)
{
  _DWORD *v3; // r4
  int v4; // r7
  int v5; // r8
  ...
  while ( 1 )
  {
    ...
    if ( sub_2AD7D4(v9, v25) )
    {
      v11 = *(_DWORD *)(v27 + 24);
      if ( v11 == v7 && !sub_230048(v26 + v10, &v22, v11) )
      {
        v12 = sub_15AED0(&v22, v6);
        v13 = ((int (__fastcall *)(int, int, int *))loc_169F00)(v5, v12, v22);
        v14 = ((int (__fastcall *)(int, int))loc_169FC8)(v5, v13);
        if ( v23 )
          *v23 = v14;
        if ( sub_6A628(v24, v14) )
          return;
      }
    }
LABEL_3:
  ...
  v16 = sub_94728("elfread.c", 798, "Section index is uninitialized");
