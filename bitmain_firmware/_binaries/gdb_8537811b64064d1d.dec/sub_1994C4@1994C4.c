int __fastcall sub_1994C4(int a1, unsigned int **a2, int a3, int a4)
{
  unsigned int *v5; // r1
  int *v6; // r6
  void *v8; // r10
  ...
  *(_DWORD *)(a1 + 8) = 0;
  if ( v5 && *v5 )
  {
    ...
    if ( v6 )
    {
      ...
      while ( 1 )
      {
        ((void (__fastcall *)(_DWORD))loc_1CD2B8)(*(_DWORD *)(*(_DWORD *)(v6[1] + 4) + 16));
        sub_220DCC(&ptr, v6, a3, a4);
        v8 = ptr;
        v9 = v28;
        if ( ptr != v28 )
        {
          ...
          do
          {
            while ( 1 )
            {
              ...
              if ( v19 != v20 )
                break;
              sub_DFC70((char **)a1, (char *)v19, (int *)&ptr);
              if ( v9 == v10 )
                goto LABEL_13;
            }
            if ( v19 )
