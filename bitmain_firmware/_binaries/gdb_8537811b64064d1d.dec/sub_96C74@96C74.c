_DWORD *__fastcall sub_96C74(_DWORD *a1, const char **a2)
{
  const char *v4; // r5
  char *v5; // r4
  char *v6; // r2
        ...
        switch ( v10 )
        {
          ...
          case 'v':
            *v6++ = 11;
            break;
          default:
            sub_94708("Unrecognized escape character \\%c in format string.", v10);
        }
      }
      else
      {
    ...
    if ( v8 )
    {
      ...
      else
      {
        ...
        *v21 = 0;
        ...
        if ( !*v15 )
LABEL_31:
          sub_94708("Incomplete format specifier at end of format string");
        while ( 1 )
        {
...
LABEL_106:
        ...
        switch ( v15[1] )
        {
          ...
          case 0x2Au:
LABEL_110:
            sub_94708("`*' not supported for precision or width in printf");
          case 0x45u:
          case 0x47u:
          case 0x65u:
          case 0x66u:
...
LABEL_84:
          ...
          case 0x6Eu:
LABEL_135:
            sub_94708("Format specifier `n' not supported in printf");
          case 0x70u:
            v39 = 1;
LABEL_69:
            v62 = 4;
...
LABEL_102:
            ...
            if ( v51 )
LABEL_67:
              sub_94708("Inappropriate modifiers to format specifier '%c' in printf", *v33);
LABEL_97:
            v38 = v62;
LABEL_86:
            v5 = (char *)(v33 + 1);
...
LABEL_73:
          ...
          default:
LABEL_134:
            sub_94708("Unrecognized format specifier '%c' in printf", v32);
        }
      }
    }
  }
