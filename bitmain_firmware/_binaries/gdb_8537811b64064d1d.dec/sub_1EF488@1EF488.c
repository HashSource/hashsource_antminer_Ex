int __fastcall sub_1EF488(int a1, char *s)
{
  __int64 v4; // kr00_8
  __int64 v5; // kr08_8
  int v6; // r1
    ...
    if ( *s == 84 && strlen(s) > 3 )
    {
      ...
      if ( v9 )
      {
        while ( 1 )
        {
          ...
          {
            sub_1E13FC((int)&v16, (unsigned __int8 *)v13 + 1, &v15);
            goto LABEL_4;
          }
...
LABEL_4:
  ...
  if ( sub_98FA0((_DWORD *)a1, &dword_475848) )
  {
    sub_1EF3BC(v14, dword_4878EC, qword_4878F0, SHIDWORD(qword_4878F0));
    v6 = v14[1];
    v7 = v14[2];
    *(_DWORD *)a1 = v14[0];
    *(_DWORD *)(a1 + 4) = v6;
