_DWORD *__fastcall sub_D0F34(_DWORD *result, int a2, _DWORD *a3, int a4, int *a5, int a6)
{
  int v6; // r6
  bool v9; // zf
  _DWORD *v10; // r4
  ...
  if ( a6 )
  {
    ...
    {
      result[4] = 0;
      return (_DWORD *)sub_259880("Could not reset ranged breakpoint %d: multiple locations found\n", result[6]);
    }
  }
  v10 = (_DWORD *)result[7];
  if ( v10 )
...
LABEL_80:
  ...
  if ( a3 != v22 )
  {
    ...
    do
    {
      ...
      v21 += 10;
      *(_DWORD *)(v23 + 56) = 1 - a3[5] + sub_C8B54(*a5, a5[1], a5[2], a5[3], a5[4], a5[5], a5[6], a5[7], a5[8], a5[9]);
    }
    while ( v21 != v22 );
LABEL_51:
    v10 = v42;
  ...
  v30 = *(_DWORD **)(v6 + 28);
  v31 = sub_323B08(13, sub_324258, sub_25AA34, 0, sub_930BC, sub_C6E84);
  if ( !v30 )
  {
LABEL_57:
    v34 = 0;
    result = (_DWORD *)sub_323BAC(v31);
    goto LABEL_58;
  }
  while ( 1 )
  {
...
LABEL_56:
  ...
  v33 = (_DWORD *)sub_324058(v31, v30[21], 1);
  if ( !*v33 )
  {
    *v33 = v32;
    goto LABEL_56;
...
LABEL_68:
    ...
    if ( v34 )
    {
      if ( v35 )
      {
        while ( 1 )
        {
          result = (_DWORD *)((int (__fastcall *)(_DWORD *, int *))loc_CF988)(v36, v35);
          if ( result )
            break;
          v35 = (int *)*v35;
          if ( !v35 )
