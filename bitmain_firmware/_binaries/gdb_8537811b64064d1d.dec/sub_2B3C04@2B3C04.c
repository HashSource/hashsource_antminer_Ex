int __fastcall sub_2B3C04(int a1, int a2)
{
  int v2; // r10
  int v5; // r6
  int v6; // r3
        ...
        if ( v11 )
        {
          if ( (*(_BYTE *)(v11 + 2340) & 0x3F) == 4 )
          {
            ...
            if ( v10 )
            {
              v17 = (_DWORD *)v8[40];
              v18 = v17[134];
              v19 = sub_347440(v17[24], *(unsigned __int8 *)(*(_DWORD *)(*(_DWORD *)(v8[1] + 444) + 392) + 5));
              v20 = v17[26];
              v21 = v19;
              if ( v19 > v20 )
              {
                ...
                do
                {
                  ...
                  {
                    v25 = *(_DWORD *)(v23 + 20);
                    if ( (*(_BYTE *)(v25 + 24) & 8) == 0 && !sub_2ED534(a1, v25, a2) )
                      return 0;
                  }
                }
                while ( v21 != v20 );
