int __fastcall sub_21DF30(int *a1, unsigned int a2, int a3, int *a4)
{
  _DWORD *v4; // r9
  int v5; // r11
  int *v6; // r7
  ...
  if ( v42[0] )
  {
    ...
    {
      sub_1B1FE0(v43, *(char **)v42[0], 0);
      if ( v43[0] )
      {
        v35 = *(__int16 *)(v43[0] + 22);
        if ( v35 == -1 )
        {
          v17 = sub_94728((int)"symtab.c", 3162, "Section index is uninitialized");
LABEL_62:
        ...
        if ( v36 == -1 )
        {
          v39 = sub_94728((int)"symtab.c", 3163, "Section index is uninitialized", v37);
          return sub_21E264(v39);
        }
        if ( v38 != v37 + *(_DWORD *)(*(_DWORD *)(v42[1] + 144) + 4 * v36) )
        {
          sub_21DED4((int)a1, v38);
          return (int)a1;
        }
      }
    }
