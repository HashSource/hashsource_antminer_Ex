int __fastcall sub_3EF80(int a1, int a2, int a3)
{
  int v3; // r0
  int v4; // r4
  int v5; // r1
...
LABEL_9:
  ...
  *(_DWORD *)(v4 + 24) = v6;
  ...
  if ( v10 )
  {
    v15 = sub_98F90(&v17);
    v16 = sub_3E4E8(v10);
    sub_94708("Cannot find user-level thread for LWP %ld: %s", v15, v16);
  }
...
LABEL_11:
    v14 = sub_3E4E8(v11);
    sub_94708("thread_get_info_callback: cannot get thread info: %s", v14);
  }
  v12 = sub_23E430(v17, v18, v19);
  return sub_3EE04(v12, v17, v18, v19, v20, (int)v21);
}
