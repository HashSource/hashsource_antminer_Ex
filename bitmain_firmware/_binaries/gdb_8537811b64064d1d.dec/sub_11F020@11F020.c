int __fastcall sub_11F020(const char **a1, int a2, __int64 a3, int c)
{
  unsigned int v4; // r8
  const char **v5; // r4
  const char *v6; // r10
  ...
  v14 = sub_324058(v13, v12, 1);
  v15 = *(_DWORD *)v14;
  if ( *(_DWORD *)v14 )
    return *(_DWORD *)v14;
  if ( !*((_DWORD *)v7 + 3) )
LABEL_175:
    sub_94708("Dwarf Error: bad DWP hash table, lookup didn't terminate [in module %s]", *v5);
  v18 = v6;
  v19 = v7;
  v218 = (_DWORD *)v14;
  v20 = v18;
      ...
      if ( v24 != (const char *)1 )
      {
        ...
        if ( v24 != (const char *)2 )
        {
          sub_94728(
            ...
            "dwp_file->version == 2");
LABEL_177:
          sub_94708("Dwarf Error: bad DWP hash table, section number too large [in module %s]", *v5);
        }
        if ( dword_4872F4 )
        {
          v217 = *(_DWORD *)sub_242FF0(c);
          v212 = sub_988A8(v25, 0);
          v108 = sub_98B30(a3, SHIDWORD(a3));
          sub_2594D8(v217, "Reading %s %s/%s in DWP V2 file: %s\n", v27, v212, v108, *v5);
        }
        memset(v230, 0, 0x38u);
        ...
        sub_93200((char **)&src, "virtual-dwo/%ld-%ld-%ld-%ld", v39, v40, v30, v41);
        v42 = (_DWORD **)sub_11CFC0((int)src, a2);
        v43 = *v42;
        v44 = v42;
        if ( *v42 )
        {
          if ( dword_4872F4 )
          {
            v152 = (_DWORD *)sub_242FF0(v42);
            sub_2594D8(*v152, "Using existing virtual DWO: %s\n", (const char *)src);
            v43 = *v44;
          }
        ...
        else
        {
          if ( dword_4872F4 )
          {
            v202 = (_DWORD *)sub_242FF0(v42);
            sub_2594D8(*v202, "Creating virtual DWO: %s\n", (const char *)src);
          }
          v109 = *(_DWORD *)(v29 + 64);
          v45 = (struct obstack *)(v29 + 48);
          v110 = *(_DWORD *)(v29 + 60);
          ...
          *v43 = v120;
          v43[1] = a2;
          sub_11CE7C((int)&v221, (int *)v5 + 18, (int)v230[0], (int)v38);
          v124 = v222;
          v125 = v223;
          v126 = v224;
          v43[3] = v221;
          ...
          v127 = v230[2];
          v43[7] = v225;
          sub_11CE7C((int)&v221, (int *)v5 + 28, (int)v127, (int)v219);
          v128 = v222;
          v129 = v223;
          v130 = v224;
          v43[8] = v221;
          ...
          v131 = v230[4];
          v43[12] = v225;
          sub_11CE7C((int)&v221, (int *)v5 + 33, (int)v131, (int)v209);
          v132 = v222;
          v133 = v223;
          v134 = v224;
          v43[13] = v221;
          ...
          v135 = v230[7];
          v43[17] = v225;
          sub_11CE7C((int)&v221, (int *)v5 + 38, (int)v230[6], (int)v135);
          v136 = v222;
          v137 = v223;
          v138 = v224;
          v43[23] = v221;
          ...
          v139 = v230[9];
          v43[27] = v225;
          sub_11CE7C((int)&v221, (int *)v5 + 43, (int)v230[8], (int)v139);
          v140 = v222;
          v141 = v223;
          v142 = v224;
          v43[28] = v221;
          ...
          v143 = v230[10];
          v43[32] = v225;
          sub_11CE7C((int)&v221, (int *)v5 + 48, (int)v143, (int)v215);
          v144 = v222;
          v145 = v223;
          v146 = v224;
          v43[38] = v221;
        ...
        *(_DWORD *)(v49 + 16) = v56;
        if ( c )
          ...
          v61 = (int *)(v5 + 23);
        sub_11CE7C((int)&v221, v61, (int)v230[12], (int)v230[13]);
        v62 = v222;
        v63 = v223;
        v64 = v224;
        *v56 = v221;
...
LABEL_60:
      ...
      if ( dword_4872F4 )
      {
        v104 = *(_DWORD *)sub_242FF0(v5[59]);
        v105 = sub_988A8(v25, 0);
        v106 = sub_98B30(a3, SHIDWORD(a3));
        sub_2594D8(v104, "Reading %s %s/%s in DWP V1 file: %s\n", v67, v105, v106, *v5);
      }
      v69 = 0;
      memset(v230, 0, 0x8Cu);
      v70 = 4 * v25;
      ...
      while ( 1 )
      {
        ...
        v72 = *(int **)&v5[63][4 * v71];
        v73 = (char *)*v72;
        if ( sub_11EC44((char *)*v72, (const char **)off_39EE68) )
        {
          if ( v230[0] )
            goto LABEL_79;
          v107 = (int *)v72[9];
        ...
        else if ( sub_11EC44(v73, (const char **)off_39EE70) || sub_11EC44(v73, (const char **)off_39EEB0) )
        {
          if ( v230[30] )
            goto LABEL_79;
          v103 = (int *)v72[9];
        ...
        else if ( sub_11EC44(v73, (const char **)off_39EE78) )
        {
          if ( v230[5] )
            goto LABEL_79;
          v74 = (int *)v72[9];
        ...
        else if ( sub_11EC44(v73, (const char **)off_39EE80) )
        {
          if ( v230[10] )
            goto LABEL_79;
          v153 = (int *)v72[9];
        ...
        else if ( sub_11EC44(v73, (const char **)off_39EE90) )
        {
          if ( v230[15] )
            goto LABEL_79;
          v203 = (int *)v72[9];
        ...
        else if ( sub_11EC44(v73, (const char **)off_39EE98) )
        {
          if ( v230[20] )
            goto LABEL_79;
          v205 = (int *)v72[9];
        ...
        {
          if ( !sub_11EC44(v73, (const char **)off_39EEA8) || v230[25] )
LABEL_79:
            sub_94708("Dwarf Error: bad DWP hash table, invalid section found [in module %s]", *v5);
          v206 = (int *)v72[9];
          v230[25] = v72;
          v230[27] = v206;
        }
...
LABEL_87:
        if ( BYTE1(v230[34]) )
          ...
          v76 = sub_11E024(&v230[30]);
        if ( !v76 && !(BYTE1(v230[4]) ? v230[2] == 0 : sub_11E024(v230)) )
        {
          if ( v69 == 7 )
            sub_94708("Dwarf Error: bad DWP hash table, too many DWO sections [in module %s]", *v5);
          v78 = sub_11E0EC(v230);
          v79 = sub_11E0EC(&v230[5]);
          v80 = sub_11E0EC(&v230[10]);
          v81 = sub_11E0EC(&v230[25]);
          sub_93200((char **)&src, "virtual-dwo/%d-%d-%d-%d", v78, v79, v80, v81);
          v82 = (_DWORD **)sub_11CFC0((int)src, a2);
          v83 = *v82;
          v84 = v82;
          if ( *v82 )
          {
            if ( dword_4872F4 )
            {
              v201 = (_DWORD *)sub_242FF0(v82);
              sub_2594D8(*v201, "Using existing virtual DWO: %s\n", (const char *)src);
              v83 = *v84;
            }
          ...
          else
          {
            if ( dword_4872F4 )
            {
              v204 = (_DWORD *)sub_242FF0(v82);
              sub_2594D8(*v204, "Creating virtual DWO: %s\n", (const char *)src);
            }
            v154 = *(_DWORD *)(v75 + 64);
            v211 = (struct obstack *)(v75 + 48);
            v155 = *(_DWORD *)(v75 + 60);
      ...
      sub_94708("Dwarf Error: bad DWP hash table, missing DWO sections [in module %s]", *v5);
    }
    if ( !v21 )
      return 0;
    ++v15;
