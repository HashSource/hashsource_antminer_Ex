int __fastcall sub_216AB8(int a1, const char *a2, const char *a3, int a4, int a5)
{
  int v8; // r8
  int v9; // r10
  const char *v10; // r9
  ...
  v11 = sub_98F14((int)&vars1C);
  sub_25A440(v9, "qf->map_symtabs_matching_filename (%s, \"%s\", \"%s\", %s)\n", v10, a2, a3, v11);
  ...
  sub_25A440(*v13, "qf->map_symtabs_matching_filename (...) = %d\n", v12);
  return v12;
}
