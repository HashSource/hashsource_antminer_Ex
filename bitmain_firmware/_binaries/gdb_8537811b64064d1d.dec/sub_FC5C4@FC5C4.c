int __fastcall sub_FC5C4(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  int v8; // r5
  void *v12; // r5
  int v13; // r4
  ...
  if ( !off_46D394 )
  {
    ...
    if ( HIDWORD(v15) == 1 )
    {
      v17 = (int *)sub_339EA0(v15);
      if ( v17[1] != 9 )
        sub_92F44(*v17, v17[1], v17[2]);
      v16 = sub_92F8C(9, "Cannot determine virtual baseclass offset of incomplete object");
    }
    sub_339EA0(v16);
    sub_92E88();
  }
