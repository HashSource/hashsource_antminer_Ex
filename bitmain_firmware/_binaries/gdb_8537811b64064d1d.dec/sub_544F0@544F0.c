int __fastcall sub_544F0(unsigned __int8 **a1, int a2, const char *a3, int a4, int a5)
{
  ...
  v32 = 0;
  if ( !v6 )
    sub_94708("Lack of needed %scommand", a3);
  v9 = a2;
  v10 = sub_54344(a1, a2, &v32, a5);
  v11 = v10;
  if ( v10 )
  {
    if ( v10 == -1 )
        ...
        if ( !strncmp((const char *)v18, v24, v20) )
        {
          ...
          if ( v31 + v25 + 6 > 0x63 )
          {
            *(_WORD *)&v33[v31] = 11822;
            v33[v26 + 2] = 0;
LABEL_44:
            sub_94708("Ambiguous %scommand \"%s\": %s.", a3, (const char *)v18, v33);
          }
          if ( v33[0] )
          {
            *(_WORD *)&v33[v31] = *(_WORD *)", ";
    ...
    if ( (*(_WORD *)(v10 + 12) & 0x180) == 0x80 )
    {
      if ( !**a1 )
        return v11;
      if ( !isspace(**a1) )
        sub_94708("Argument must be preceded by space.");
    }
    while ( 1 )
    {
      v14 = v13 == 32;
    ...
    if ( !v16 && (*(_BYTE *)(v11 + 12) & 0x20) == 0 )
      sub_158C0(*(const char **)(v11 + 56), (const char *)v12);
  }
  else if ( !a4 )
  {
    v27 = *a1;
