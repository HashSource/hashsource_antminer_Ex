int *__fastcall sub_103CFC(int *a1, int a2, char *a3, _DWORD *a4, int a5, int a6)
{
  int v10; // r0
  int v11; // r2
  _BOOL4 v13; // r3
  ...
  if ( v13 )
  {
    v14 = a4 ? sub_C2364(a4) : sub_16F67C(v10);
    v15 = ((int (__fastcall *)(int, int, char *))loc_194734)(a2, v14, a3);
    if ( v15 )
    {
      *a1 = v15;
      a1[1] = 0;
  ...
  if ( !v41 && a6 )
  {
    ...
    if ( !v23 )
    {
      ...
      v30 = *(char **)(*(_DWORD *)(sub_171280(*(_DWORD *)(*(_DWORD *)(*((_DWORD *)v53 + 6) + 24) + 20)) + 24) + 8);
      v31 = strlen(v30);
      sub_33BC7C((int)&v44, 0, v45, v30, v31);
      v32 = strlen(a3);
      sub_33BC7C((int)&ptr, 0, v48, a3, v32);
LABEL_40:
      sub_21D748(&v43, v44, a4, a5);
      v33 = ptr;
      if ( v43 )
      {
        sub_103B44(&v41, *(_DWORD *)(v43 + 24), (const char *)ptr, (int)a4);
        v16 = v41;
        v17 = v42;
        if ( ptr != v49 )
          sub_339E8C(ptr);
