int __fastcall sub_709AC(int a1, int a2, const void *a3, size_t a4, char *a5, int a6)
{
  char *next_free; // r0
  char *v11; // r2
  char v12; // r3
  ...
  v47 = a2;
  if ( !a6 )
    sub_94708("Could not find renamed symbol");
  if ( !a2 )
    v47 = sub_20F3B0(0);
  ...
  sub_A567C(v15, v47, 1, &v50);
  if ( !v50 )
  {
    v46 = (const char *)sub_9EBA8(object_base);
    sub_94708("Could not find renamed variable: %s", v46);
  }
  ...
  if ( v17 )
  {
    if ( v17 != 1 )
      goto LABEL_55;
    result = sub_709AC(a1, v51, src, n, v52, a6 - 1);
  }
  else
  {
    result = sub_70780(a1, v51, v50);
  }
LABEL_18:
  v19 = 0;
  while ( *a5 == 88 )
...
LABEL_20:
    switch ( a5[1] )
    {
      ...
      case 'R':
        ...
        v40 = (int)v53;
        v38[v34] = 0;
        result = sub_70970(a1, 81, (int)v39, v40);
        if ( *a5 != 88 )
          goto LABEL_47;
        goto LABEL_20;
      case 'S':
LABEL_22:
        ...
        if ( (unsigned int)(unsigned __int8)a5[2] - 48 <= 9 )
        {
          ...
          if ( v20 == v52 )
            goto LABEL_55;
          sub_1C37E4(a1, 38);
          v44 = sub_1780DC(*(_DWORD *)(*(_DWORD *)(a1 + 4) + 4));
          sub_1C391C(a1, *(_DWORD *)(v44 + 12));
          sub_1C38C0(a1, v45, v43, v43 >> 31);
          result = sub_1C37E4(a1, 38);
        }
        else
        {
          a5 = strchr(a5 + 2, 88);
          ...
          sub_A567C(v28, 0, 1, &v52);
          if ( !v52 )
            sub_94708("Could not find %s", v26);
          v30 = off_46DBB8;
          ...
          result = sub_70780(a1, (int)v30, (int)v52);
        }
        if ( v19 )
        {
          if ( v19 != 1 )
          {
            result = sub_1C37E4(a1, 36);
            goto LABEL_18;
          }
          v19 = 2;
        }
        ...
        {
          sub_1C37E4(a1, 46);
          sub_1C38C0(a1, v41, 1, 0);
          result = sub_1C37E4(a1, 46);
        }
        break;
      default:
        goto LABEL_55;
...
LABEL_47:
  if ( v19 )
LABEL_55:
    sub_94708("Internal error in encoding of renaming declaration");
  return result;
}
