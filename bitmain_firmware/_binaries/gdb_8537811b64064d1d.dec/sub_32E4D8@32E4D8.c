int __fastcall sub_32E4D8(int a1, int a2, int *a3, int *a4)
{
  char v4; // r12
  void *v8; // r5
  void *v9; // r3
    ...
    if ( v13 >= 0 )
    {
      ...
      *(_WORD *)(a1 + 10) = 1;
      if ( v14 == 1 )
        ...
        v15 = sub_328484((char *)(a1 + 10), 1, v14 - 1);
      *(_DWORD *)a1 = v15;
      *(_DWORD *)(a1 + 4) = 1 - v14;
      v8 = 0;
      v51 = 0;
...
LABEL_69:
      ...
      sub_32B560((int)v31, (int)v31, (int)v52, (int)v67, a4);
      if ( v46 == 31 )
      {
LABEL_79:
        v38 = *((unsigned __int16 *)v31 + 5);
...
LABEL_77:
      sub_32B560((int)v31, (int)v31, (int)v31, (int)v67, a4);
      v42 = *a4;
      v45 = 1;
      v44 = *a4 & 0x2200;
      goto LABEL_69;
    ...
    else
    {
      if ( v18 > 49 )
        ...
        v25 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v18) + 5);
      if ( v25 <= 0x3C )
      {
        v27 = (int *)&v76;
        ptr = 0;
    ...
    if ( v29 > 49 )
      ...
      v30 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v29) + 5);
    if ( v30 > 0x78 )
    {
      v49 = malloc(v30);
      v8 = v49;
    ...
    if ( v55 > 47 )
      ...
      v32 = 2 * (*((unsigned __int8 *)&dword_438B40[6] + v57) + 5);
    if ( v32 <= 0x48 )
    {
      v33 = (int *)v77;
      v51 = 0;
LABEL_52:
      sub_32AB94((int)v33, v10);
      *v31 = 1;
      *((_WORD *)v31 + 5) = 1;
      *((_BYTE *)v31 + 8) = 0;
      v31[1] = 0;
      ...
      while ( 1 )
      {
        sub_32C3D8((int)v31, (int)v31, __SPAIR64__(v67, (unsigned int)v33), 0, a4);
        sub_32B560((int)v33, (int)v33, v53, (int)v69, &v58);
        HIDWORD(v34) = v69;
        LODWORD(v34) = &v63;
        sub_32D420((int)v33, (int)v33, v34, 0x80u, &v58);
        v35 = *v33 + v33[1] + v55 < *v31 + v31[1];
        if ( *v31 < v55 )
          v35 = 0;
        if ( v35 )
          break;
        sub_32C3D8((int)&v63, (int)&v63, __SPAIR64__(v75, v60), 0, &v58);
      }
      v36 = *v31;
      v37 = v31[1];
      if ( !v54 )
...
LABEL_83:
        ...
        *(_DWORD *)(a1 + 4) = v37;
        v67[0] = v40;
        sub_328A28(a1, v67, (unsigned __int16 *)v31 + 5, v36, &v59, a4);
        sub_3295C0((_DWORD *)a1, a3, &v59, a4);
        goto LABEL_16;
      }
      v52 = v31;
      v31 = v33;
