void __fastcall sub_636A8(char *a1, int a2, int *a3)
{
  size_t v6; // r0
  void *v7; // r0
  _DWORD *v8; // r0
  ...
  ptr = v23;
  v6 = strlen(a1);
  v7 = sub_631C0(&ptr, a1, (int)&a1[v6]);
  if ( a2 )
  {
    v24 = v26;
    sub_631C0(&v24, ptr, (int)ptr + v22);
    if ( v25 == 0x7FFFFFFF )
      sub_33D1AC("basic_string::append");
    sub_33C348(&v24, &word_3E1FAC, 1);
    v9 = strlen((const char *)a3);
    if ( 0x7FFFFFFF - v25 < v9 )
      sub_33D1AC("basic_string::append");
    v10 = sub_33C348(&v24, a3, v9);
    v27 = v29;
    v12 = v10;
    v14 = (int *)(v10 + 8);
    v13 = *(void **)v10;
