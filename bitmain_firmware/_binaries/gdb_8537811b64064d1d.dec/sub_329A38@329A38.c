int __fastcall sub_329A38(int a1, unsigned __int8 *a2, int a3)
{
...
LABEL_75:
    ...
    {
      v17 = *((unsigned __int8 *)&dword_438B40[5] + v7);
      if ( 2 * v17 > 0x1E )
      {
...
LABEL_23:
  ...
  *(_BYTE *)(a1 + 8) = v65;
  ...
  {
    v69 = 0;
    sub_328A28(a1, (int *)a3, v66, v7, &v69, &v70);
    sub_3295C0((_DWORD *)a1, (int *)a3, &v69, &v70);
    v39 = v70;
  }
  else
  {
