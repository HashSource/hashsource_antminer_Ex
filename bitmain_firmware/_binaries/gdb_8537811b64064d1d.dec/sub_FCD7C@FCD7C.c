_DWORD *__fastcall sub_FCD7C(_DWORD *a1, int *a2, const char *a3, int a4, int a5, int a6, int a7, int a8)
{
  int *v8; // r11
  int v13; // r3
  int v14; // r2
  ...
  if ( a7 && (sub_FCB94(v48, a4, a5, a6, a8), (v13 = v48[0]) != 0)
    || (sub_21CFDC(v48, a4, a5, a6), (v13 = v48[0]) != 0)
    || !a8 && (sub_21D0E4(v48, a4, a6), (v13 = v48[0]) != 0) )
  {
    v14 = v48[1];
    *a1 = v13;
    a1[1] = v14;
  ...
  else
  {
    ...
    if ( *v19 > 0 )
    {
      for ( i = 0; ; ++i )
      {
        v21 = v18 == 128 ? *(__int16 **)(v17 + 28) : &word_3B4A54;
        if ( *v21 <= i )
          break;
        ...
        if ( v23 )
        {
          ...
          *(_DWORD *)(v38 + 4) = 0;
          ...
          if ( v56 != v58 )
            sub_339E8C(v56);
          sub_FCD7C(v49, v25, a3, ptr, a5, a6, 1, a8);
          v45 = v49[0];
          v46 = v49[1];
          if ( v49[0] )
          {
