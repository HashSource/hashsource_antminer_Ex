int __fastcall sub_2F4ED8(int a1)
{
  _DWORD *v1; // r2
  int v3; // r4
  _DWORD *v4; // r12
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(HIDWORD(v6) + 56) = v5;
    ...
    if ( *(_DWORD *)(v8 + 60) != v7 )
    {
      sub_2A6A84("Invalid output section for .eh_frame_entry: %A", v6);
      return 0;
    }
  }
...
LABEL_17:
      sub_2A6C18((int)"elf-eh-frame.c", 2320, (int)"_bfd_elf_fixup_eh_frame_hdr");
    while ( 1 )
    {
  ...
  sub_2A6A84("Invalid contents in %A section", v6);
  return 0;
}
