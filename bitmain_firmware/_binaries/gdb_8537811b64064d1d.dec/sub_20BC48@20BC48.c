int *__fastcall sub_20BC48(int *result)
{
  int *v1; // r9
  int v2; // t1
  char *v3; // r1
  ...
  if ( dword_489424 < (unsigned int)(dword_489424 + 4 * dword_489420) )
  {
    do
    {
      ...
      {
        if ( dword_47AC88 > 0 )
          result = sub_F43DC(&off_46D334, "forward-referenced types left unresolved, type code %d.", v4);
      }
      else if ( (v3[1] & 4) != 0 )
      {
        if ( *((_DWORD *)v3 + 3) )
            ...
            do
            {
              ...
              if ( v7 > 0 )
              {
                ...
                do
                {
                  ...
                  result = (int *)((int (__fastcall *)(int, int))loc_17059C)(v24, v23);
                  v7 = v5[1];
                }
                while ( v7 > v9 );
              }
LABEL_16:
        ...
        {
          result = sub_F43DC(&off_46D334, "need a type name");
        }
      }
    }
  ...
  if ( dword_489414[0] > 0 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(v26 + 16) = *(_DWORD *)(v20 + 16);
      result = (int *)((int (__fastcall *)(int))loc_17059C)(v21);
    }
