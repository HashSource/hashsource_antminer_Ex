int sub_1C79B4()
{
  ...
  dword_487CFC = -1;
  sub_1B9720((int)&loc_1C6C50);
  sub_539B4("address", (int)sub_1C6608, (int)"Describe where symbol SYM is stored.");
  sub_539B4(
    "symbol",
    (int)sub_1C615C,
  ...
  sub_539B4("display", (int)sub_1C5BB0, (int)"Expressions to display when program stops, with code numbers.");
  sub_5329C(
    "undisplay",
    1,
    (int)sub_1C6E38,
  ...
  sub_547D8((int)"p", (unsigned __int8 *)"print", 1, 1);
  sub_547D8((int)"inspect", (unsigned __int8 *)"print", 1, 1);
  sub_53834(
    "max-symbolic-offset",
    -1,
    (int)&dword_46DAA4,
