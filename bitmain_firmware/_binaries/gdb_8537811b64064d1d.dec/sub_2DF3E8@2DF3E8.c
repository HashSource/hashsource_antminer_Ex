int __fastcall sub_2DF3E8(int a1, _DWORD *a2)
{
  int v2; // r4
  int *v4; // r5
  int v5; // r8
  ...
  if ( *(_BYTE *)(v2 + 12) == 1 )
  {
    ...
    if ( (!v55 || !v55(v2)) && (*(_BYTE *)(v2 + 51) & 4) != 0 )
    {
      ...
      if ( (*(_BYTE *)(v2 + 51) & 1) == 0 || (*(_BYTE *)v56 & 0x40) != 0 )
      {
        ...
        {
          if ( sub_2DD230(v56 + 28, v5 + 392, v2) )
            goto LABEL_107;
          v56 = *v4;
        }
...
LABEL_107:
  ...
  if ( (*(_BYTE *)*v4 & 3u) > 1
    ...
    || *(_DWORD *)(*(_DWORD *)(v6 + 28) + 40) == 1 && sub_2DD230(v6 + 28, v5 + 392, v2) )
  {
    if ( *(_DWORD *)(v2 + 28) == -2 )
    {
      v11 = 0;
    ...
    if ( ((*(_BYTE *)(v2 + 51) & 0xC) != 0 || !*(_BYTE *)(v2 + 12)) && (*(_BYTE *)(v2 + 51) & 3) == 0
      ...
      || v7 == 64 && !sub_2AAC54(*(_DWORD **)(*v4 + 32), *(const char **)(v2 + 4), 0, 0) )
    {
      v9 = *(unsigned __int8 *)(v2 + 48);
      goto LABEL_63;
    }
          ...
          case 3:
            ...
            if ( !v20 )
            {
              ...
              if ( v27 && (*((_DWORD *)v27 + 10) & 0x800) == 0 )
                sub_2A6BE4("elflink.c", 9757);
              goto LABEL_36;
            }
            v86 = sub_2D4BA4(v4[1], v20);
            if ( v86 == -257 )
            {
              v14 = 0;
              sub_2A6A84("%B: could not find output section %A for input section %A", v4[1], v16[15], v16);
...
LABEL_24:
          ...
          case 5:
            return 1;
          default:
            sub_2A6C18((int)"elflink.c", 9710, (int)"elf_link_output_extsym");
        }
      }
    }
    v70 = *(_DWORD *)(v2 + 44);
...
LABEL_25:
      ...
      switch ( v19 )
      {
        ...
        case 4:
          ...
          if ( (*(_BYTE *)*v4 & 3) != 2 )
LABEL_207:
            sub_2A6C18((int)"elflink.c", 9532, (int)"elf_link_convert_common_type");
...
LABEL_144:
        ...
        case 5:
          ...
          break;
        default:
          sub_2A6C18((int)"elflink.c", 9797, (int)"elf_link_output_extsym");
      }
    }
LABEL_37:
    v19 = v9 & 0xF;
...
LABEL_47:
        ...
        if ( v31 != 2 )
        {
          ...
          if ( (v84 & 3) != 0 && v83 >> 4 != 2 && *(_BYTE *)(v2 + 12) == 1 && (*(_BYTE *)(v2 + 51) & 2) == 0 )
          {
            ...
            v14 = 0;
            sub_2A6A84(v35, v4[1], *(_DWORD *)(v2 + 4));
        ...
        if ( *(_DWORD *)(v36 + 268) && *(_DWORD *)(v2 + 32) != -1 && *(_DWORD *)(v36 + 48) )
        {
          ...
          if ( !*(_DWORD *)(v2 + 64) && (v31 > 1 || (*(_BYTE *)(v2 + 51) & 6) != 2) )
          {
            ...
            if ( v54 )
            {
              if ( v54[1] )
              {
                sub_2A6A84("%B: No symbol version section for versioned symbol `%s'", v78, v79);
                goto LABEL_98;
              }
            }
          }
          ...
          if ( v39 )
          {
            ...
            v42 = sub_34769C(*(_DWORD *)(v2 + 60), v41);
            v43 = 8 * v40;
            ...
            else
            {
              switch ( v43 )
              {
                ...
                case 64:
                  ...
                  break;
                default:
                  sub_2A6C18((int)"elflink.c", 9955, (int)"elf_link_output_extsym");
              }
            }
          }
          v47 = v4[4];
          if ( v47 )
          {
            ...
            if ( v48 )
            {
              ...
              sub_2CD708(v4[1], (unsigned __int16 *)v87, v48 + 2 * *(_DWORD *)(v2 + 32));
            }
          }
        }
        ...
        if ( !v11 && ((unsigned int)v16[5] & 0x8000) == 0 )
        {
          if ( a2[1] )
          {
            ...
            if ( !v14 )
            {
              ...
              if ( v50[14] )
              {
                ...
                memset(v87, 0, 12);
                v87[4] = -15;
                if ( !sub_2DCC70(v50, 0, v87, (int)&off_4708A8, 0) )
                  return v14;
                a2[2] = 1;
              }
            }
          ...
          v51 = v4;
          v52 = *(_DWORD *)(v4[1] + 124);
          v53 = sub_2DCC70(v51, *(_BYTE **)(v2 + 4), &v80, (int)v16, v2);
          v14 = v53;
          if ( v53 )
          {
            if ( v53 == 1 )
            ...
            if ( *(_DWORD *)(v2 + 28) == -2 )
              sub_2A6C18((int)"elflink.c", 10049, (int)"elf_link_output_extsym");
            return 1;
          }
LABEL_98:
          v14 = 0;
...
LABEL_133:
  ...
  if ( (char **)v60 == &off_470950 )
    ...
    v61 = *(_DWORD *)(v60 + 148);
  sub_2A6A84(v59, v4[1], *(_DWORD *)(v2 + 4), v61);
  ((void (__fastcall *)(int))loc_2A6C70)(17);
  *a2 = 1;
  return v14;
}
