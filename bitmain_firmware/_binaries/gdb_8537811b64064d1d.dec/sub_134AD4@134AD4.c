int __fastcall sub_134AD4(int a1, int a2, int *a3, _DWORD *a4)
{
  bool v4; // zf
  int v8; // r4
  unsigned int v10; // r3
  ...
  {
    v72 = a3;
    v30 = sub_12E648((int *)(a2 + 8), a1, &v72);
    v31 = (unsigned __int16 *)sub_12E6BC(v30, 2, (int)v72);
    if ( v31 || (v31 = (unsigned __int16 *)sub_12E6BC(v30, 56, (int)v72)) != 0 )
    {
      v32 = *v31;
      if ( v32 == 2 )
      {
        ...
        if ( !v46 )
        {
          ...
          *v50 = sub_1345EC(v30, v55);
          ((void (__fastcall *)(int *, int *, unsigned __int16 *))loc_1246AC)(a3, v50 + 2, v31 + 4);
          a4[2] = v50;
          *a4 = 4;
          return 1;
        }
        ...
        if ( dword_47AC88 > 0 )
          sub_121FF0("DW_AT_location", "dynamic property");
      }
      else
      {
        if ( v32 != 56 )
          return 1;
        if ( sub_12FFC0(v30, (int)v72, (int)&v73) )
        {
          v33 = *(_DWORD *)(v8 + 64);
          v34 = *(_DWORD *)(v8 + 60);
          v35 = v33 - v34;
          ...
          *(_DWORD *)(v8 + 56) = v40;
          v42 = sub_132DBC(v41, v72);
          v43 = v73;
          v44 = v72;
          *(_DWORD *)v36 = v42;
          *(_QWORD *)(v36 + 8) = v43;
          *(_DWORD *)(v36 + 16) = sub_1345EC(v30, v44);
          a4[2] = v36;
          *a4 = 2;
          return 1;
        }
