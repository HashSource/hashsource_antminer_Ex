char *__fastcall sub_135430(unsigned __int16 *a1, int *a2)
{
  size_t v2; // r5
  int v3; // r3
  bool v4; // zf
  ...
  if ( (v9 & 0xFFFB) == 0x13 )
    v7 = 0;
  if ( !v7 && !sub_12E770((int)a1, 3, v8) )
  {
    v12 = sub_12FAE4((int)v10, (int)v8);
    v13 = v12;
    if ( v12 )
    {
      v14 = *(char **)(v12 + 8);
  ...
  v54 = v8;
  v28 = sub_1309D4((int)v10, (int *)&v54);
  if ( v28 )
  {
    v29 = *(_DWORD *)(v28 + 20);
    v8 = v54;
  ...
  if ( (*(_BYTE *)(v29 + 3) & 1) != 0 )
  {
    v41 = sub_12FB18(v10, v8);
    v42 = sub_12FB18((_WORD *)v29, v8);
    v43 = v42;
    if ( dword_47AC88 > 0 )
    {
      v44 = "<unknown>";
      ...
      if ( v41 )
        v44 = v41;
      v17 = "";
      sub_F43DC(&off_46D334, "template param type '%s' defined within parent '%s'", v44, v43);
      return (char *)v17;
    }
    return "";
  }
  switch ( *(_WORD *)v29 )
  {
    ...
    case 0x1E:
    case 0x38:
      v40 = *(_DWORD *)(sub_132DBC((unsigned __int16 *)v29, v8) + 24);
      goto LABEL_66;
    case 4:
      v40 = *(_DWORD *)(sub_132DBC((unsigned __int16 *)v29, v8) + 24);
      if ( (*(_BYTE *)(v40 + 2) & 0x20) == 0 )
        return (char *)sub_135430(v29, v8);
LABEL_66:
    ...
    case 0x3C:
      ...
      if ( !v33 )
        return "";
      v55 = v8;
      v34 = sub_1309D4((int)v10, (int *)&v55);
      if ( v34 )
      {
      ...
      break;
    case 0x39:
      v30 = *(_DWORD *)(sub_132DBC((unsigned __int16 *)v29, v8) + 24);
      if ( v8[16] != 4 )
        return *(char **)(v30 + 12);
  ...
  while ( *(_WORD *)v35 != 46 || !sub_12EA5C(v35, v8) )
  {
    v35 = *(_DWORD *)(v35 + 16);
    if ( !v35 )
      return "";
  }
  v14 = (char *)sub_194560(v8[17]);
  if ( !v14 )
    return "";
  v36 = sub_12FB18(v10, v8);
  v37 = v36;
  if ( !v36
    || !strcmp(v36, v14)
