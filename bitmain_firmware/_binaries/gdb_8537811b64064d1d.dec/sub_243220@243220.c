FILE *__fastcall sub_243220(int a1)
{
  char *v1; // r11
  int v2; // r8
  int v3; // r10
  ...
  sub_25B104(&v18, a1);
  if ( sub_31E128(v18) <= 1 )
    sub_94708("usage: new-ui <interpreter> <tty>");
  if ( !v18 )
  {
  ...
  do
  {
    v5 = sub_967DC(v2, 258);
    if ( v5 < 0 )
      sub_258B2C("opening terminal failed");
    v6 = fdopen(v5, "w+");
    v7 = *v4;
    *v4++ = v6;
    if ( v7 )
  ...
  v9 = v20;
  v10 = sub_98394(0x5Cu);
  sub_243018((int)v10, v8, v9);
  v10[9] = 1;
  dword_487668 = (int)v10;
  sub_19164C(v1);
  v11 = sub_191AE8();
  ((void (__fastcall *)(int))loc_1917B4)(v11);
  dword_487668 = v3;
  v19 = 0;
  v20 = 0;
  sub_259880("New UI allocated\n");
  v12 = (FILE **)&v20 + 1;
  sub_31DAF8(v18);
  result = 0;
  while ( v12 != &v19 )
