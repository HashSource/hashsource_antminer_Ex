int __fastcall sub_1A1050(int a1, unsigned __int8 **a2)
{
  unsigned int v2; // r6
  int v3; // r7
  int *v4; // r8
...
LABEL_64:
      sub_94708("Unterminated comment in macro expansion.");
    v8 = v5 + 4;
...
LABEL_73:
          ...
          if ( v26 == 34 )
            break;
          if ( v26 == 10 )
            sub_94708("Newline characters may not appear in string constants.");
          ++v15;
          if ( v26 == 92 )
          {
            v38[0] = v15;
...
LABEL_99:
        ...
        if ( !v34 )
LABEL_108:
          sub_94708("A character constant must contain at least one character.");
        v20 = v8 + 1 - v5;
LABEL_82:
        *(_DWORD *)v3 = v5;
        *(_DWORD *)(v3 + 4) = v20;
...
LABEL_109:
    sub_94708("Unmatched single quote.", HIDWORD(v9));
  }
  if ( HIDWORD(v9) )
  {
    HIDWORD(v9) = v2 & 0xFFFFFFDF;
