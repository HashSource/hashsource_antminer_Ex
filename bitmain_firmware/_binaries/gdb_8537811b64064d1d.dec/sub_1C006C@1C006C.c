int __fastcall sub_1C006C(int result, int a2, int a3, int a4, int a5)
{
  _DWORD *v5; // r7
  int v8; // r3
  char *v9; // r3
  ...
  while ( 2 )
  {
    ...
    sub_259B80("    ");
    if ( !v5 )
      return sub_25A6E4("<type unknown>", a2);
    v8 = v5[6];
    ...
    switch ( *(_BYTE *)v13 )
    {
      ...
      case 0x17:
        ...
        continue;
      case 2:
        return sub_1C1418(*(_DWORD *)(v13 + 20), 0, a2, 0, 0, a5);
      case 3:
        v23 = result;
        v39 = *(_DWORD *)(v13 + 12);
        if ( v39 )
        ...
        if ( (*(_WORD *)(v13 + 2) & 0x380) != 0x80 || *(__int16 **)(v13 + 28) == &word_3B4A54 )
          sub_25A440(a2, "record ");
        else
          sub_25A440(a2, "class ");
        goto LABEL_31;
      case 4:
...
LABEL_31:
        ...
        if ( a3 || !*(_DWORD *)(v25 + 12) )
        {
          ...
          while ( 1 )
          {
            ...
            {
              if ( v26 )
                sub_25A6E4(&word_3E1FAC, a2);
              v40 = sub_25A440(a2, (const char *)&word_356660);
              v41 = *(_DWORD *)(v23 + 24);
              v82 = *(__int16 *)(v41 + 4);
...
LABEL_166:
                    ...
                    while ( 2 )
                    {
                      ...
                      {
                        v40 = sub_10A86C(*(unsigned __int8 *)(v50 + 5));
                        if ( !v40 )
                        {
                          v48 = *(_DWORD *)(v23 + 24);
                          goto LABEL_79;
                        ...
                        if ( (*(_WORD *)(v48 + 2) & 0x380) == 0x80 )
                        {
                          ...
                          if ( (__int16 *)v51 != &word_3B4A54 )
                          {
                            ...
                            else
                            {
                              ...
                              {
                                v87 = 1;
                                sub_25A7E8(a4 + 2, a2, "public\n");
                              }
                            }
                          }
                        }
                        sub_25A7C8(a4 + 4, a2);
                        if ( sub_174F34(*(_DWORD *)(*(_DWORD *)(v23 + 24) + 24) + v49) )
                          sub_25A440(a2, "static ");
                        v46 = *(_QWORD *)(*(_DWORD *)(*(_DWORD *)(v23 + 24) + 24) + v49 + 12);
                        sub_1C1418(v46, HIDWORD(v46), a2, a3 - 1, a4 + 4, a5);
                        if ( !sub_174F34(*(_DWORD *)(*(_DWORD *)(v23 + 24) + 24) + v49) )
                        {
                          v47 = *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v23 + 24) + 24) + v49 + 8);
                          if ( (v47 & 0xFFFFFFF0) != 0 )
                            sub_25A440(a2, " : %d", v47 >> 4, v47 & 0xFFFFFFF0);
                        }
                        v40 = sub_25A440(a2, ";\n");
                      }
                      if ( ++v45 == v82 )
                              ...
                              if ( v62 > 0 )
                              {
                                ...
                                while ( 1 )
                                {
                                  ...
                                  if ( v69 )
                                  {
                                    ...
                                    {
                                      sub_25A440(a2, "destructor  ");
                                    }
                                  }
                                  else
                                  {
                                    sub_25A440(a2, "constructor ");
                                  }
                                  sub_1BFF20(v68, (int)s2, a2);
                                  v67 = *(_DWORD *)(*((_DWORD *)v63[1] + 6) + 20);
                                  if ( v67 && **(_BYTE **)(v67 + 24) != 10 )
                                  {
                                    sub_25A6E4(" : ", a2);
                                    sub_255DD8(*(_DWORD *)(*((_DWORD *)v63[1] + 6) + 20), "", a2, -1);
                                  }
                                  if ( *((unsigned __int16 *)v63 + 7) > 1u )
                                    sub_25A440(a2, "; virtual");
                                  ++v64;
                                  sub_25A440(a2, ";\n");
                                  v63 += 4;
                                  if ( v64 == v62 )
                                ...
                                sub_25A440(a2, "<undefined type> %s;\n", *v63);
                              }
LABEL_145:
                              v77 = v85 == v84 + 12;
                              v84 += 12;
            ...
            v33 = v26 ? ", " : (char *)&word_3B6A28;
            sub_25A6E4(v33, a2);
            v34 = *(_DWORD *)(v23 + 24);
            if ( (*(_WORD *)(v34 + 2) & 0x380) != 0x80 )
              break;
            v35 = *(_DWORD *)(v34 + 28);
            if ( (__int16 *)v35 == &word_3B4A54 )
              break;
            v36 = *(_DWORD *)(v35 + 20);
            ...
            if ( ((v27 >> (v26 & 7)) & 1) != 0 )
              v28 = " virtual";
LABEL_39:
            sub_25A440(a2, "%s%s ", v37, v28);
            v29 = 3 * v26++;
            v30 = sub_170CEC(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v23 + 24) + 24) + 8 * v29 + 12));
            v31 = "(null)";
            if ( v30 )
              v31 = (const char *)v30;
            sub_25A440(a2, "%s", v31);
...
LABEL_156:
            ...
            if ( v81 > 0 )
            {
              ...
              {
                sub_259B80("    ");
                sub_25A6E4(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v21 + 24) + 24) + v73 + 16), a2);
                ...
                if ( !v77 )
                {
                  ...
                  v79 = sub_988D4(v78);
                  LODWORD(v78) = sub_25A440(a2, " := %s", v79);
      ...
      case 0xB:
        v20 = result;
        sub_25A6E4("set of ", a2);
        return sub_1C1418(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v20 + 24) + 24) + 12), "", a2, a3 - 1, a4, a5);
      case 0xC:
        v16 = *(_DWORD *)(v13 + 20);
        v17 = result;
        sub_255F78(v16, v12, *(_DWORD *)(*(_DWORD *)(v13 + 24) + 8), *(_DWORD *)(*(_DWORD *)(v13 + 24) + 12), a2);
        sub_25A6E4(&word_3BB878, a2);
        v18 = *(_QWORD *)(*(_DWORD *)(*(_DWORD *)(v17 + 24) + 24) + 24);
        return sub_255F78(v16, v19, v18, HIDWORD(v18), a2);
      case 0xD:
        v11 = "String";
        v10 = a2;
        return sub_25A6E4(v11, v10);
