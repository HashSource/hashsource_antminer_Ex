unsigned __int8 *__fastcall sub_31F948(void **a1, unsigned __int8 *a2, int a3)
{
  int v4; // r8
  ...
  if ( !a2 )
    return 0;
  if ( (word_4388C0[*a2] & 4) == 0 )
    return 0;
  v4 = 0;
  v33 = 0;
  v6 = sub_31EE5C(a2, (int *)&v33);
  v7 = v6;
  if ( !v6 )
    return 0;
  v8 = v33;
  ...
  if ( a3 == 4 )
  {
    ...
    if ( *a1 != v9 )
      v4 = v9 - (_BYTE *)*a1;
    HIDWORD(v12) = "_D";
    while ( (word_4388C0[*v7] & 4) == 0 )
    {
      if ( !strncmp((const char *)v7, "_D", 2u) )
      {
        v7 = (unsigned __int8 *)sub_320BC8(a1, v7, 1, v13, v32, HIDWORD(v32));
LABEL_30:
        if ( !v7 )
          goto LABEL_15;
      }
...
LABEL_15:
    ...
    v7 = (unsigned __int8 *)sub_31FE9C(a1, v7, 3, HIDWORD(v12), v32, HIDWORD(v32));
    goto LABEL_30;
  }
...
LABEL_61:
        ...
        default:
LABEL_33:
          sub_31EC3C(__SPAIR64__((unsigned int)v7, (unsigned int)a1), v8);
          v7 += v33;
          break;
      }
      return v7;
    ...
    v20 = v7[3];
    v21 = ((word_4388C0[v20] ^ 4u) >> 2) & 1;
    if ( v20 == 48 )
      v21 = 1;
    if ( !v21 )
    {
      v22 = (unsigned __int8 *)sub_31F948(a1, v7 + 3);
      sub_31E880((int)a1, "!(");
      if ( !v22 )
      {
LABEL_87:
      ...
      if ( *v22 )
      {
        while ( v23 != 90 )
        {
          ...
          {
            case 'T':
              v22 = (unsigned __int8 *)sub_320108(a1, v22 + 1);
              break;
            case 'V':
              v29 = v22[1];
              v36 = 0;
              v35 = 0;
              ptr = 0;
              v30 = (unsigned int)sub_320108(&ptr, v22 + 1) | 0x100000000LL;
              v31 = (_BYTE *)v30;
              LODWORD(v30) = &ptr;
              sub_31E810(v30);
              *v35 = 0;
              v22 = sub_31F1F0((unsigned int)a1, v31, (char *)ptr, v29);
              if ( ptr )
                free(ptr);
              break;
            case 'S':
              v22 = (unsigned __int8 *)sub_31F948(a1, v22 + 1);
              break;
            default:
              v22 = 0;
              goto LABEL_51;
