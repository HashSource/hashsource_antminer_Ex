int __fastcall sub_2FE0A8(int a1, int a2)
{
  int v2; // r3
  int result; // r0
  _DWORD *v6; // r5
...
LABEL_15:
      v21 = 0;
      result = sub_2FD6EC(a2, a1, v10, v14, v15, v13[2], s2, 0, 0, &v21);
      if ( !result )
        return result;
      v11 = v13[3];
      v12 = v21;
...
LABEL_27:
  ...
  if ( v2 == 2 )
    return sub_2FD438(a1, a2, (int (__fastcall *)(int, int, char *, _DWORD, int *))sub_2FCE28);
