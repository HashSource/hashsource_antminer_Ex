int __fastcall sub_2B6A80(int a1, int a2)
{
  _DWORD *v2; // r6
  int v6; // r3
  char v7; // r2
...
LABEL_29:
    ...
    if ( *(int *)(a2 + 40) <= 0 )
      goto LABEL_29;
LABEL_24:
    if ( !sub_2E2F10(a2, a1, 1) && ((*(_BYTE *)(a2 + 49) & 3) == 0 || *(_BYTE *)(a2 + 12) != 2) )
      return 1;
    goto LABEL_29;
  }
LABEL_8:
  sub_2A6BE4("elf32-arm.c", 15139);
  v6 = *(unsigned __int8 *)(a2 + 48);
...
LABEL_11:
    if ( (*(_BYTE *)(a2 + 52) & 0x40) != 0 && (*(_BYTE *)a1 & 1) == 0 && !v2[13] )
    {
      ...
      if ( (*(_BYTE *)a1 & 8) == 0 && (v8 & 1) != 0 )
      {
        if ( *(_DWORD *)(a2 + 44) )
        {
          sub_2B68E4(*(_DWORD *)(a1 + 28), v10, 1);
          *(_BYTE *)(a2 + 51) |= 0x40u;
        }
      }
      return sub_2E2D3C(a1, a2, v9);
    }
    return 1;
  }
LABEL_32:
