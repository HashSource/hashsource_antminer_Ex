int __fastcall sub_A7A4C(char *a1, int a2, int a3, int a4)
{
  int v6; // r0
  int v7; // r11
  int v8; // r5
...
LABEL_6:
      ...
      {
        if ( sub_9DF48(v13, a1) )
          return sub_A79A0(a2, a3, v10, v8);
        v11 = sub_A029C(v8, v10);
        v7 = *(_DWORD *)(v8 + 24);
        if ( v11 )
        {
          result = sub_A7A4C(
...
LABEL_13:
        ...
        else if ( sub_A0350(v8, v10) )
        {
          v17 = sub_A0898(*(_DWORD *)(*(_DWORD *)(v7 + 24) + v12 + 12));
          v7 = *(_DWORD *)(v8 + 24);
          v18 = v17;
          v19 = *(_DWORD *)(v17 + 24);
          ...
          if ( *(__int16 *)(v19 + 4) > 0 )
          {
            ...
            while ( 1 )
            {
              ...
              v22 += 24;
              result = sub_A7A4C(a1, a2, v21 + *(_QWORD *)v23 / 8LL, *(_DWORD *)(v23 + 12));
              if ( result )
                return result;
              v19 = *(_DWORD *)(v18 + 24);
