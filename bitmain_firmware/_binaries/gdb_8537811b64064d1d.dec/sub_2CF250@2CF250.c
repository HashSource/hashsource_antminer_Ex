int __fastcall sub_2CF250(int a1, _DWORD *a2, const char *a3, int a4)
{
  int v4; // r8
  _DWORD *v6; // r4
  char *v9; // r5
  ...
  if ( v10 )
  {
    ...
    *(_DWORD *)(v10 + 28) = v25;
    *(_BYTE *)(v10 + 24) = v26 | 1;
    if ( sub_2ADDE4(a1, v10, v6[6]) )
    {
      v11[16] = sub_2ABB1C(v6[9]);
      v27 = v6[1];
      v122 = 0;
      if ( v27 == 8 )
      {
...
LABEL_29:
        ...
        if ( v32 && !v32(&v122, v6) || !sub_2ADD00(a1, (int)v11, v122) )
          return 0;
        if ( v6[1] == 7 )
        {
          v4 = sub_2AE004(a1, (int)v11, (int *)ptr);
          if ( !v4 )
            return v4;
          sub_2CC6C0(a1, (unsigned int)ptr[0], v6[6], v6[5], v6[4], v6[5], v6[9]);
          free(ptr[0]);
        }
        v33 = v122;
        if ( (v122 & 1) != 0 )
...
LABEL_69:
        if ( (v33 & 0x2000) != 0 )
        {
          ...
          v55 = sub_2A9954(a1, (int)v11, v124, (int *)ptr);
          if ( v55 && (*(_DWORD *)(a1 + 40) & 0x100000) != 0 )
          {
            v4 = sub_2A9D48(a1, (int)v11);
            if ( !v4 )
            {
              sub_2A6A84("%B: unable to initialize decompress status for section %s", a1, v9);
              return v4;
            }
            v56 = 2;
          }
          else
          {
            ...
            v4 = sub_2A9E74(a1, (int)v11);
            if ( !v4 )
            {
              sub_2A6A84("%B: unable to initialize compress status for section %s", a1, v9);
              return v4;
            }
            v56 = 1;
          }
          if ( (*(_BYTE *)(a1 + 44) & 8) != 0 )
          {
            ...
            {
              v57 = sub_2CBDAC(a1, v9);
              if ( !v57 )
                return 0;
              sub_2ADD0C(a1, v11, v57);
            }
          }
          else
          {
...
LABEL_143:
        ...
        do
        {
          ...
          if ( *(_DWORD *)(v97 + 4) == 17 )
          {
            ...
            {
              if ( !sub_2CE710((_DWORD *)a1, v95) )
                return 0;
              v99 = v96 + 1;
              v100 = *(_DWORD *)(v97 + 24);
              v120 = v100;
              *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a1 + 160) + 2312) + 4 * v96) = v97;
              v101 = (void *)sub_2AD070(a1, v100, 1u);
              *(_DWORD *)(v97 + 48) = v101;
              if ( v101 )
              {
                v102 = v120 & 0x3FFFFFFF;
                memset(v101, 0, v120 & 0x3FFFFFFF);
                if ( !sub_2A8A2C(a1, *(_QWORD *)(v97 + 16), 0)
                  && (v103 = sub_2A8800(*(_DWORD *)(v97 + 48), *(_DWORD *)(v97 + 24), a1), v103 == *(_DWORD *)(v97 + 24)) )
                {
                  v110 = *(_DWORD *)(v97 + 48);
                  ...
                  while ( 1 )
                  {
                    ...
                    if ( v94 <= v113 )
                    {
                      sub_2A6A84("%B: invalid SHT_GROUP entry", a1);
                      v113 = 0;
                    }
                ...
                {
                  sub_2A6A84("%B: invalid size field in group section header: %#Lx", a1, *(_DWORD *)(v97 + 24));
              ...
              {
                sub_2A6A84("%B: corrupt size field in group section header: %#Lx", a1, *(_DWORD *)(v97 + 24), v120);
                ((void (__fastcall *)(int))loc_2A6C70)(17);
                v58 = *(_DWORD **)(a1 + 160);
              }
            }
        ...
        if ( v58[579] != v109 )
        {
          ...
          if ( !v109 )
          {
            v58[578] = 0;
            v58[579] = -1;
            sub_2A6A84("%B: no valid group sections found", a1);
            ((void (__fastcall *)(int))loc_2A6C70)(17);
            v77 = v116[35];
            goto LABEL_119;
          }
          ...
          if ( v71 && (v72 = v70[6], v72 > 3) )
          {
            ...
            while ( 1 )
            {
              if ( v71 == v75 )
              {
                ...
                {
                  if ( sub_2CE710((_DWORD *)a1, v84) )
                  {
                    v85 = *(_DWORD *)(a1 + 160) + 72;
                    if ( sub_2CDA30(a1, v85, 1u, v70[8], (unsigned int)v124, (char *)ptr, v123) )
                    {
                      v86 = sub_2CDDD0(a1, v85, (int)v124, 0);
                      if ( v86 )
                      {
                        v77 = v11[35];
                        *(_DWORD *)(v77 + 116) = v86;
...
LABEL_119:
            ...
            sub_2A6A84("%B: no group info for section '%A'", a1, v11);
          }
          else
          {
            sub_2A6A84("%B: group section '%A' has no contents", a1, v70[11]);
            v4 = 0;
