unsigned __int8 *__fastcall sub_2987E4(int a1, int *a2, int a3)
{
  int v3; // r12
  int v4; // r6
  size_t v5; // r4
  ...
  while ( 1 )
  {
    if ( _ctype_get_mb_cur_max() > 1 && !dword_48BB60 )
    {
      v53[0] = 0;
      v53[1] = 0;
      sub_29B348(a1, v10, v53);
      v28 = sub_29B21C(v12, v53);
      if ( v28 > 1 )
      {
        v10 += v28 - 1;
        goto LABEL_26;
...
LABEL_33:
  ...
  {
LABEL_61:
    v19 = (int (__fastcall *)(char *, int))sub_29B078;
    *a2 = v10;
    goto LABEL_41;
  }
LABEL_34:
...
LABEL_36:
    ...
    if ( dword_48BB38 )
    {
      v19 = (int (__fastcall *)(char *, int))sub_29B070;
      sub_297780(v17);
      v20 = strlen((const char *)dword_48BB38);
      v21 = (char *)sub_93050(v20 + 1);
...
LABEL_45:
  ...
  v33 = v22;
  v34 = (unsigned __int8 **)sub_297940();
  dword_490164 = dword_490158;
  if ( v9 )
  {
    if ( dword_48BB38 )
    ...
    v35 = (void **)sub_2985A0(*v34, v33, v53);
    v36 = v53[0];
    v37 = v35;
    if ( v53[0] != -1 )
    {
