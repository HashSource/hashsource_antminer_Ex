        ...
        int *a10)
{
  ...
  while ( 1 )
  {
    ...
    if ( v17 )
      break;
    v18 = 24 * v14;
    v19 = sub_FC5C4(a7, v14, a2, a5, v24, SHIDWORD(v24), a5, a6);
    v20 = v19;
    v27 = v19;
    if ( sub_17392C(a1, *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a7 + 24) + 24) + 24 * v14 + 12)) )
    {
      v12 = *(_DWORD *)(a7 + 24);
      if ( (__int64)(v28 + v20) >= a8 && (__int64)(v28 + v20) < a8 + *(_DWORD *)(a9 + 20) )
      {
        ...
        if ( !*a10 )
        {
          v23 = sub_25F73C(*(_DWORD **)(*(_DWORD *)(v12 + 24) + v18 + 12), a5 + v24 + v27, 1);
          v12 = *(_DWORD *)(a7 + 24);
          *a10 = v23;
        }
      }
