int __fastcall sub_1912DC(int *a1, int a2)
{
  _DWORD *v4; // r0
  _DWORD *v5; // r5
  int v6; // r6
  ...
  if ( a2 )
  {
    ...
    v19 = v17;
    v18 = v16;
    *(_DWORD *)v16 = &off_3C0714;
    *(_DWORD *)(v16 + 4) = sub_32727C(HIDWORD(v16));
    *(_BYTE *)(v18 + 12) = 0;
    __asm { POP             {R4,PC} }
  }
  if ( v6 )
  {
    v14 = (_DWORD *)sub_243004(v4);
    sub_2573F4(*v14);
