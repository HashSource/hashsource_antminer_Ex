void __fastcall sub_13894C(int a1, int a2, int *a3, unsigned int a4, unsigned int a5, int a6)
{
  int v7; // r3
  _DWORD *v8; // r3
  int v9; // r2
  ...
  if ( a6 )
  {
    ...
    if ( v39 == -1 )
    {
      sub_94728((int)"dwarf2read.c", 20775, "sect_index_text not initialized");
      JUMPOUT(0x1394E8);
    }
    v40 = *(_DWORD *)(a1 + 60);
    ...
    if ( v40 < *(_DWORD *)(a1 + 64) )
    {
      ...
      while ( 1 )
      {
        sub_12C1EC((int)v163, v156, v43, a4 == 0);
        if ( !a4 )
        {
          v44 = *(_DWORD *)(v164 + 48);
              ...
              case 0:
                ...
                switch ( *(_BYTE *)(v52 + v83) )
                {
                  ...
                  case 2:
                    LODWORD(v142) = *v155;
                    HIDWORD(v142) = v155 + 1;
                    v143 = sub_11E3E8(v142, v52 + v83 + 1, (int)a3, &v162);
                    v144 = a5 > v143;
                    v40 += v162;
                    if ( v143 )
                      v144 = 0;
                    if ( v144 )
                      sub_12A7D8((int)v163, a3, v40);
                    v165 = 0;
                    v168 = ((int (__fastcall *)(_DWORD, unsigned int, _DWORD))loc_16AA18)(v163[0], v158 + v143, 0);
                    goto LABEL_115;
                  case 3:
                    if ( *(_BYTE *)(v88 + 1) )
                    {
                    ...
                    v162 = v106;
                    sub_138868(v43, (const char *)v160, v159, v117, v124);
                    goto LABEL_115;
                  case 4:
                    v92 = *(_BYTE *)(v88 + 1);
                    v93 = (char *)(v88 + 2);
...
LABEL_116:
                    ...
                    if ( dword_47AC88 <= 0 )
                      goto LABEL_2;
                    sub_F43DC(&off_46D334, "mangled .debug_line section");
                    v8 = (_DWORD *)a4;
                    if ( !a4 )
                      goto LABEL_118;
                    goto LABEL_3;
              ...
              case 9:
                ...
                v91 = ((int (__fastcall *)(_DWORD, int, int))loc_16AA18)(v163[0], v90, 1);
                v165 = 0;
                v168 += v91;
                continue;
              default:
...
LABEL_56:
      ...
      a1 = v43;
      if ( dword_47AC88 > 0 )
        sub_F43DC(&off_46D334, ".debug_line section has line program sequence without an end");
      sub_12BEF0((int)v163, 1);
    }
  }
LABEL_2:
    ...
    if ( v9 != v10 )
    {
      ...
      do
      {
        if ( *(_BYTE *)(v9 + v11 + 16) )
        {
          ...
          if ( v20
            || v18
            && ((v16 = (const char *)sub_31E2A4(v18, &word_39899C, v16), sub_92564(1165408, (int)v16), *v16 != 47)
              ? (v21 = v19 & 1)
              : (v21 = 0),
                !v21) )
          {
LABEL_21:
          ...
          {
            v22 = v16;
            v16 = (const char *)sub_31E2A4(a2, &word_39899C, v16);
            sub_92564(1165408, (int)v16);
          }
...
LABEL_25:
          ...
          {
            ptra = (char *)sub_31E2A4(v24, &word_39899C, v14[1]);
...
LABEL_118:
    ...
    if ( (_DWORD)v130 != HIDWORD(v130) )
    {
      ...
      do
      {
        ...
        sub_11DB54(*(_BYTE **)(v130 + v132), v137);
        v138 = dword_4788E0;
        v139 = *(_DWORD *)(dword_4788E0 + 24);
        if ( !v139 )
        {
          v140 = sub_212E78(v131, *(_DWORD *)(dword_4788E0 + 4));
          v141 = dword_4788E0;
          *(_DWORD *)(v138 + 24) = v140;
          v139 = *(_DWORD *)(v141 + 24);
        }
