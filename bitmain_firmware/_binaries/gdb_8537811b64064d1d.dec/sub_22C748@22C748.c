__int64 __fastcall sub_22C748(int a1, int a2, int a3, int a4, int a5, int a6)
{
  _DWORD *v9; // r0
  __int64 v10; // r6
  _DWORD *v11; // r0
  ...
  sub_2594D8(*v9, "-> %s->to_get_raw_trace_data (...)\n", (const char *)dword_489C90);
  v10 = off_489EC0(&unk_489C8C, a2, a3, a4, a5, a6);
  v11 = (_DWORD *)sub_242FF0(v10);
  sub_2594D8(*v11, "<- %s->to_get_raw_trace_data (", (const char *)dword_489C90);
  ...
  sub_256878(", ", *v23);
  v25 = sub_9892C(a5, a6, 0, v24);
  v26 = (_DWORD *)sub_242FF0(v25);
  v27 = sub_256878(v25, *v26);
  v28 = (_DWORD *)sub_242FF0(v27);
  sub_256878(") = ", *v28);
  v30 = sub_9892C(v10, SHIDWORD(v10), 0, v29);
  v31 = (_DWORD *)sub_242FF0(v30);
  v32 = sub_256878(v30, *v31);
  v33 = (_DWORD *)sub_242FF0(v32);
  sub_256878(&word_356660, *v33);
  return v10;
}
