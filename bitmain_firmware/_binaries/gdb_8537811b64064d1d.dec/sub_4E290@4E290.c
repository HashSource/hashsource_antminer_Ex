int __fastcall sub_4E290(int a1)
{
  int v2; // r0
  int v3; // r7
  int v4; // r0
  ...
  v2 = sub_1DD5B4(a1);
  v3 = sub_163EA0(v2);
  ((void (__fastcall *)(_BYTE *, int))loc_1DD5C0)(v10, a1);
  v4 = sub_98F90(v10);
  v5 = v4;
  if ( dword_46AF88 == 1 )
  {
  ...
  if ( v6 < 0 )
    sub_258B2C("Unable to fetch VFP registers (for update).");
  sub_4EFA0(a1, v10, *(_DWORD *)(v3 + 16));
  if ( dword_46AF88 == 1 )
  {
    v8 = v10;
    v9 = 260;
  ...
  if ( result < 0 )
    sub_258B2C("Unable to store VFP registers.");
  return result;
}
