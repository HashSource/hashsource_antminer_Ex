int __fastcall sub_22A198(int a1, int a2, int a3, int a4, int a5, int a6, unsigned int a7)
{
  _DWORD *v9; // r0
  int v10; // r0
  _DWORD *v11; // r0
  ...
  sub_2594D8(*v9, "-> %s->to_insn_history_range (...)\n", (const char *)dword_489C90);
  v10 = off_489F48(&unk_489C8C, off_489F48, a3, a4, a5, a6, a7);
  v11 = (_DWORD *)sub_242FF0(v10);
  sub_2594D8(*v11, "<- %s->to_insn_history_range (", (const char *)dword_489C90);
