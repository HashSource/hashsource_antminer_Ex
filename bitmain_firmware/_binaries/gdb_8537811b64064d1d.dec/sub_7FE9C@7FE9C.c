int __fastcall sub_7FE9C(int a1)
{
    ...
    switch ( *v1 )
    {
      ...
      case 0x27u:
        ...
        if ( dword_474FF8 )
          ...
          dword_474FF8 = 1;
        obstack_begin(&stru_474FFC, 0, 0, (void *(*)(int))sub_93050, sub_7F830);
        v16 = 0;
        v17 = v67 + 1;
...
LABEL_82:
            ...
            if ( *v65 == 36 )
              return 289;
            dword_474FE0 = sub_1946F0(**(_DWORD **)(v64 + 4), *(_DWORD *)(*(_DWORD *)(v64 + 4) + 4), v44);
            if ( dword_474FE0 )
              return 260;
            v61 = *v65;
            if ( v61 <= 0x60 )
            ...
            {
LABEL_125:
              if ( sub_7F83C(v64, v65, v38, 0, (int)v68) == 263 )
                return 262;
            }
LABEL_127:
...
LABEL_45:
            ...
            if ( v31 && (unsigned __int8)((v27 & 0xDF) - 65) > 0x19u )
            {
              ...
              v49 = v28;
LABEL_90:
              result = sub_7F83C(v64, v48, v47 - (_DWORD)v48, v49 | v24, (int)&dword_474FD8);
              if ( result == 268 )
              {
                v62 = (const char *)memcpy(&v63, v48, v47 - (_DWORD)v48);
                *((_BYTE *)&v63 + v47 - (_DWORD)v48) = 0;
                sub_94708("Invalid number \"%s\".", v62);
              }
              *v66 = v47;
              return result;
            }
...
LABEL_49:
      ...
      default:
        ...
        if ( !v33 && (v12 & 0xFFFFFFDF) - 65 > 0x19 )
          sub_94708("Invalid character '%c' in expression", *v1);
        for ( i = v1; ; ++i )
        {
          v36 = result == 95;
          if ( result != 95 )
