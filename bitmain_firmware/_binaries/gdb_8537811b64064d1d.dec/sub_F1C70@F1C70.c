int __fastcall sub_F1C70(const char **a1, unsigned int a2, int a3, int a4)
{
  int v6; // r12
  int v9; // lr
  int v10; // r1
  ...
  if ( (a2 & ~dword_4789F4) != 0 )
  {
    ...
    {
      v26 = sub_F1C70(a1, v10, a3, a4);
      return sub_1700E8(v26);
    }
    else if ( v9 == 2 << dword_478A08 )
    {
      v36 = sub_F1C70(a1, v10, a3, a4);
      return sub_170380(v36);
    }
    else if ( v9 == 3 << dword_478A08 )
    {
      ...
      *v13 = 0;
      v17 = sub_F1C70(a1, v10, a3, a4);
      v18 = sub_1780EC(a4);
      v19 = sub_171950(0, *(_DWORD *)(v18 + 12), 0, 0, v12 - 1, (v12 - 1) >> 31);
      return sub_17214C(0, v17, v19);
    }
    else
    {
      return 0;
  ...
  if ( (int)a1[2] > 0 )
  {
    ...
    if ( *(_DWORD *)a3 )
    {
      ...
      if ( ((unsigned int)(v22 - 10) & 0xFFFFFFFD) == 0 )
        v23 = 0;
      if ( v23 )
        return sub_F1498(v21);
      if ( dword_47AC88 > 0 )
      {
        sub_F43DC(&off_46D334, "Symbol table entry for %s has bad tagndx value", *a1);
        v6 = dword_4789F4;
      }
    }
  }
  ...
  switch ( v24 )
  {
    case 0:
    case 1:
      return *(_DWORD *)sub_1780EC(a4);
    case 2:
      return *(_DWORD *)(sub_1780EC(a4) + 4);
    case 3:
      return *(_DWORD *)(sub_1780EC(a4) + 8);
    case 4:
      return *(_DWORD *)(sub_1780EC(a4) + 12);
    case 5:
      if ( a1[4] == (const char *)18
        && (v37 = *(unsigned __int16 *)(a3 + 6), v37 > ((int (__fastcall *)(int))loc_165F08)(v25)) )
      {
        return *(_DWORD *)(sub_1780EC(a4) + 20);
      }
      else
      {
        return *(_DWORD *)(sub_1780EC(a4) + 16);
      }
    case 6:
      return *(_DWORD *)(sub_1780EC(a4) + 48);
    case 7:
      return *(_DWORD *)(sub_1780EC(a4) + 52);
    case 8:
      v27 = (int)a1[1];
      if ( a1[2] == (const char *)1 )
        return sub_F18AC(v27, *(unsigned __int16 *)(a3 + 6), *(_DWORD *)(a3 + 12), a4);
      v28 = sub_F1498(v27);
      v29 = *(_DWORD *)(v28 + 24);
      v11 = v28;
      LOWORD(v28) = *(_WORD *)(v29 + 2);
      *(_BYTE *)v29 = 3;
      *(_DWORD *)(v29 + 28) = &word_3B4A54;
      *(_DWORD *)(v29 + 8) = 0;
    ...
    case 9:
      ...
      if ( a1[2] == (const char *)1 )
      {
        v11 = sub_F18AC(v30, *(unsigned __int16 *)(a3 + 6), *(_DWORD *)(a3 + 12), a4);
        v32 = *(_DWORD *)(v11 + 24);
      }
      else
      {
    ...
    case 10:
      ...
      break;
    case 12:
      return *(_DWORD *)(sub_1780EC(a4) + 28);
    case 13:
      return *(_DWORD *)(sub_1780EC(a4) + 32);
    case 14:
      return *(_DWORD *)(sub_1780EC(a4) + 36);
    case 15:
      if ( a1[4] == (const char *)18
        && (v38 = *(unsigned __int16 *)(a3 + 6), v38 > ((int (__fastcall *)(int))loc_165F08)(v25)) )
      {
        return *(_DWORD *)(sub_1780EC(a4) + 44);
      }
      else
      {
        return *(_DWORD *)(sub_1780EC(a4) + 40);
      }
    case 16:
      return *(_DWORD *)(sub_1780EC(a4) + 56);
    default:
      if ( dword_47AC88 > 0 )
        sub_F43DC(&off_46D334, "Unexpected type for symbol %s", *a1);
      return *(_DWORD *)sub_1780EC(a4);
  }
  while ( 1 )
  {
    ...
    if ( dword_478988 >= v81 || dword_478988 >= (unsigned int)dword_478A00 )
      break;
    ((void (__fastcall *)(_DWORD *, _BYTE *, _BYTE *))loc_F163C)(v91, v89, v90);
  ...
  v11 = v87;
  if ( !v86 )
    v46 = ((int (__fastcall *)(int, _BYTE *, _BYTE *))loc_165E90)(v88, v44, v43) / 8;
  v47 = *(_DWORD *)(v87 + 24);
  *(_DWORD *)(v87 + 20) = v46;
  v48 = 24 * v39;
  v49 = *(_BYTE *)(v47 + 2);
