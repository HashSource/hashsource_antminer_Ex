int __fastcall sub_3489F0(unsigned int *a1, int a2, unsigned int a3, int a4)
{
  unsigned int v5; // r6
  unsigned int v6; // r8
  unsigned int v7; // r7
...
LABEL_59:
            ...
            if ( v5 <= 0xF )
              sub_348CBC(v43, v33, v8);
            if ( v9 )
              sub_348CCC(v42, v33, v8);
            return 0;
          }
LABEL_68:
          v40 = v33 + 1;
          a1[14] = (unsigned int)v40;
          sub_348CAC(v43, v40, v8);
          return 0;
        }
        v31 = 2 * (16 - v5);
        v32 = &v43[2 * v5];
