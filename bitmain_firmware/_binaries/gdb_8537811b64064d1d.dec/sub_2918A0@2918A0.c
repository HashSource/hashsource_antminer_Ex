int __fastcall sub_2918A0(const char *a1, int a2)
{
  int v3; // r5
  const char **v5; // r0
  int v6; // r1
  ...
  else
  {
    if ( dword_48B6C8 )
    {
      ...
      if ( dword_48B6CC == 10 )
      {
        sub_297780(*(_DWORD *)dword_48B6C8);
        v5 = (const char **)dword_48B6C8;
      ...
      {
        ++dword_48B6CC;
        v5 = (const char **)sub_93078((void *)dword_48B6C8, 4 * (v3 + 1));
        v6 = 4 * (v3 + 1) - 4;
        dword_48B6C8 = (int)v5;
      }
