bool __fastcall sub_1A478(int a1, unsigned int a2)
{
  int v3; // r6
  unsigned int i; // r9
  int v5; // r0
  ...
  v3 = ((int (*)(void))loc_165C50)();
  if ( sub_C37E0(a2, 0, &v15, &v16) && v16 > a2 )
  {
    for ( i = a2; ; i = v10 )
    {
      if ( sub_230048(i, v17, 2) )
        return 0;
      v5 = sub_15C278(v17, 2, v3);
      v6 = v5 == 18167;
      if ( v5 != 18167 )
        v6 = (v5 & 0xFF80) == 18176;
      v7 = v5;
      ...
      {
        if ( sub_182C4(v5) != 4 || sub_230048(i + 2, v17, 2) )
          return 0;
        v10 = i + 4;
        v11 = sub_15C278(v17, 2, v3);
        if ( v7 == 59581 )
        {
          if ( v11 < 0 )
          {
            ...
            if ( v8 < v15 )
              return 0;
LABEL_27:
            if ( sub_230048(v8, v17, 4) )
              return 0;
            v12 = sub_15C278(v17, 2, v3);
            v13 = sub_15C278(v18, 2, v3);
