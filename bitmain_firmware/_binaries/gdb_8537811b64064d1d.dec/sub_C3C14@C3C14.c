int __fastcall sub_C3C14(int a1)
{
  int v2; // r8
  __int64 v3; // r2
  int v4; // r1
  ...
  if ( HIDWORD(v3) <= 7 )
    ...
    LOWORD(v4) = -12276;
  HIWORD(v4) = 55;
  sub_2573A8(v2, v4, v3, HIDWORD(v3));
  ...
  else
  {
    ...
    do
    {
      ...
      if ( 0x7FFFFFFF - v12 < v13 )
        sub_33D1AC("basic_string::append");
      sub_33C348(&ptr, v11, v13);
      v7 = 0;
    }
    while ( v6 != v5 );
    sub_257610(v2, "what", ptr);
    if ( ptr != v20 )
      sub_339E8C(ptr);
  }
  sub_2573A8(v2, "\" ", v14, v15);
  result = sub_257418(v2);
  if ( result )
    return sub_257610(v2, "catch-type", "signal");
  return result;
}
