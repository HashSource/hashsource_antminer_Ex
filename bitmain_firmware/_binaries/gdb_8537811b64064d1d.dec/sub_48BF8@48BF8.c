unsigned __int64 __fastcall sub_48BF8(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  int v4; // r9
  ...
  if ( v6 )
  {
    if ( (unsigned __int64)(*(_QWORD *)&dword_46AFC8 + 1LL) > 1 )
      sub_92078(&unk_47267C);
    v4 = (int)&unk_47260C;
    *(_QWORD *)&dword_46AFC8 = 0;
    dword_472688 = 0;
    sub_920A8(&unk_47267C);
    sub_9206C(&unk_47267C, "<osdata type=\"processes\">\n", 26);
    dirp = opendir("/proc");
    if ( dirp )
    {
      v35 = v5;
        ...
        if ( (unsigned int)*(unsigned __int8 *)(v9 + 19) - 48 <= 9 )
        {
          ...
          if ( strlen((const char *)(v9 + 19)) <= 0x14 )
          {
            ...
            if ( _xstat64(3, v39, s) || (v41 & 0xF000) != 0x4000 )
              ...
              sub_47AA8((char *)v39, uid);
            ptr = (_DWORD *)sub_930BC(v32, 4u);
            v11 = v36;
            ...
            if ( v12 )
            {
              ...
              while ( 1 )
              {
                ...
                {
                  sscanf(v15, "%lld", &v37);
                  sub_98F70(v38, v11, v37, 0);
                  v16 = sub_48A84(v38[0], v38[1], v38[2]);
                  v17 = v16 <= 0;
                  if ( v16 >= 0 )
                    v17 = v32 <= v16;
                  if ( !v17 )
...
LABEL_50:
    ...
    sub_9206C(&unk_47267C, "</osdata>\n", 11);
    dword_472688 = sub_920BC(&unk_47267C);
