int __fastcall sub_40178(char *a1)
{
  int v2; // r2
  char *v3; // r0
  int v4; // r0
  ...
  v2 = *(_DWORD *)sub_243004();
  v3 = a1;
  if ( !a1 )
    v3 = "";
  v44 = v2;
  v4 = *(unsigned __int8 *)sub_93634(v3);
  if ( v4 )
    sub_94708("'info auto-load libthread-db' does not accept any parameters");
  ...
  base = (char *)sub_93050(v6);
  v8 = sub_92564(255708, base);
  v9 = (_DWORD *)dword_471BF4;
  v46 = v8;
  if ( !dword_471BF4 )
  {
    qsort(base, 0, 4u, (__compar_fn_t)sub_3E6A0);
LABEL_65:
    v24 = 0;
    v10 = 0;
    v23 = 0;
  ...
  while ( v9 );
  qsort(base, v10, 4u, (__compar_fn_t)sub_3E6A0);
  if ( !v10 )
    goto LABEL_65;
  v11 = 0;
  v12 = 0;
...
LABEL_31:
  ...
  if ( a1 == (char *)&unk_478244 )
    sub_2573A8(v44, &word_356660, a1, &unk_478244);
LABEL_36:
  v47 = (void *)18;
  ptr = v52;
  ptr = (void *)sub_33B2E4(&ptr, &v47, 0);
  *(_DWORD *)v52 = v47;
  qmemcpy(ptr, "LinuxThreadDbTable", 18);
  v51 = (int)v47;
  *((_BYTE *)v47 + (_DWORD)ptr) = 0;
  sub_257074(v44, 2, v24, &ptr);
  if ( ptr != v52 )
    sub_339E8C(ptr);
  ptr = v52;
  strcpy(v49, "filename");
  ...
  sub_257254(v44);
  v42 = v11 + 1;
  v25 = (_BYTE *)sub_93050(v11 + 1);
  sub_92564(255708, v25);
  if ( v10 )
  {
    v26 = 0;
    v27 = 0;
    do
    {
      ...
      sub_257610(v44, "filename", *(_DWORD *)(v40 + 12));
      if ( v26 >= v10 )
      {
        v29 = v25;
      }
      else
      {
        ...
        do
        {
          ...
          v29 = &v30[sub_93198(v30, &v25[v42] - v30, "%u", *(_DWORD *)(v31 + 4))];
          if ( &v25[v42] <= v29 )
          {
            sub_94728(
              "linux-thread-db.c",
      ...
      *v29 = 0;
      sub_257610(v44, "pids", v25);
      sub_2573A8(v44, &word_356660, v33, v34);
      sub_257374(v44, 0);
      v27 = v26;
    }
    while ( v26 < v10 );
    sub_257298(v44);
    return sub_92648(v46);
  }
  else
  {
    sub_257298(v44);
    sub_92648(v46);
    return sub_2573B4(v44, "No auto-loaded libthread-db.\n");
  }
}
