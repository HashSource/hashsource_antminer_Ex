struct XML_ParserStruct **__fastcall sub_274BB4(
        ...
        struct XML_ParserStruct *a4)
{
  ...
  *a1 = NS;
  ...
  XML_SetElementHandler(*a1, (XML_StartElementHandler)sub_274B08, (XML_EndElementHandler)&loc_273F18);
  XML_SetCharacterDataHandler(*a1, (XML_CharacterDataHandler)sub_273B7C);
  v7 = a1[4];
  if ( v7 == a1[5] )
  {
    sub_2752A0(v5);
