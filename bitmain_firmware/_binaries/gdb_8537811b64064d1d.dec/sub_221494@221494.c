int *__fastcall sub_221494(int *a1, char *a2, int a3, int a4, int a5)
{
  int v5; // r7
  unsigned int v6; // r9
  char *v10; // r3
...
LABEL_195:
    ...
    if ( v6 <= 0x2F )
    {
      ...
      {
        if ( v75[1] != 41 )
          sub_94708("`operator ()' must be specified without whitespace in `()'", HIDWORD(v78));
        goto LABEL_181;
      }
      if ( v6 <= 0x28 )
      {
...
LABEL_181:
          ...
          strlen(v75);
          a2 = v97;
          sprintf(v97, "operator%.*s%s", v5, (const char *)&word_3E1FAC, v75);
          if ( dword_4879F4 == 1 )
            v16 = 10;
          else
            v16 = 8;
          ...
          {
            s[32] = 0;
            sub_163764((regex_t *)s);
          }
          goto LABEL_17;
        }
      }
LABEL_219:
      sub_94708("`operator %s' not supported", v75);
    }
    if ( v6 == 94 )
      goto LABEL_181;
    if ( v6 > 0x5E )
    ...
    if ( v91 == 91 )
    {
      ...
      if ( v92 == 93 )
        sub_94708("mismatched quoting on brackets, try 'operator\\[\\]'", HIDWORD(v78));
      if ( v92 != 92 || v75[3] != 93 )
        sub_94708("nothing is allowed between '[' and ']'", HIDWORD(v78));
      goto LABEL_181;
    }
  }
  if ( v6 == 124 )
...
LABEL_14:
  if ( dword_4879F4 == 1 )
    ...
    v16 = 8;
LABEL_17:
  sub_1636E0((regex_t *)s, a2, v16, "Invalid regexp");
  s[32] = 1;
LABEL_18:
  v111 = sub_21A808;
  v109[0] = (int)&a5;
  ...
  v108 = s;
  v104 = &v108;
  v112[1] = (int)sub_219CD4;
  v112[0] = (int)&v108;
  i = sub_215320((int)v110, (int)v111, (int)v18);
...
LABEL_23:
    ...
    while ( 1 )
    {
      ...
      do
      {
        ...
        do
        {
          for ( i = sub_C28D0(*(_DWORD **)(v105 + 4 * (v22 + 2)), v113); ; i = sub_C290C((int)v113) )
          {
            v108 = (_BYTE *)i;
            if ( !i )
              break;
            ...
            if ( (v31 & 1) == 0 )
            {
              ((void (__fastcall *)(int, int, int, int))loc_21A4E4)(i, v23, v24, v31);
              if ( s[32] )
                ((void (__fastcall *)(_BYTE *))loc_1CC500)(s);
              v46 = (void *)*a1;
              if ( *a1 )
                sub_339E8C(v46);
              sub_339024(v46);
...
LABEL_29:
                if ( !dword_489708 )
                {
                  v25 = (const char *)sub_3245CC(*(_DWORD *)(v32 + 12));
                  if ( v106 )
                  {
                    if ( !sub_21A794(v25, a5, v106, 1) )
                      continue;
                  }
                }
                v26 = sub_204330(v32);
                ...
                else if ( !sub_21A794(v26, a5, v106, 0) )
                {
                  continue;
                }
              }
...
LABEL_50:
            v35 = (const char *)sub_21B3EC((int)v108);
...
LABEL_54:
              ...
              else
              {
                ...
                {
LABEL_65:
                  sub_222650(a1, v36, &v107, v104, eflags, v94, v95, v96);
                  continue;
                }
              }
              v38 = v36 == 0;
...
LABEL_74:
    ...
    if ( *a1 == v5 )
      goto LABEL_87;
    sub_221220(*a1, (char *)a1[1], 2 * (31 - __clz((v5 - v40) >> 4)));
    if ( v5 - v40 <= 256 )
    {
      i = sub_222924(v40, v5, 0, v41, eflags, v94, v95, v96);
    }
    else
    {
      v42 = v40 + 256;
      i = sub_222924(v40, v40 + 256, 0, v41, eflags, v94, v95, v96);
      while ( v5 != v42 )
      {
        i = sub_2228CC(v42, 0);
        v42 += 16;
    ...
    while ( 1 )
    {
      ...
      if ( v17 == (int *)(v5 + 16) )
        goto LABEL_84;
      i = sub_21F004((_DWORD *)v5, (_DWORD *)(v5 + 16));
      if ( !i )
        goto LABEL_123;
      v5 += 16;
    }
...
LABEL_120:
  ...
  while ( 2 )
  {
    ...
    if ( (v110[8] & 0x10) != 0
      ...
      || s[32]
      && (v57 = (const char *)sub_21B3EC((int)v110),
...
LABEL_106:
  ...
  if ( a3 != 1 )
  {
    sub_21CAC4(v113, v109[0], *(char **)v50);
    v55 = v113[0] == 0;
    goto LABEL_113;
  }
  v52 = *(__int16 *)(v50 + 22);
...
LABEL_113:
  ...
  i = sub_94728((int)"symtab.c", 4401, "Section index is uninitialized", -1, eflags, 0, 0, a3);
LABEL_123:
  if ( v17 == (int *)v5 )
  {
LABEL_84:
...
LABEL_149:
      ...
      while ( 2 )
      {
        ...
        if ( s[32] )
        {
          v70 = (const char *)sub_21B3EC((int)v110);
        ...
        if ( a3 == 1 )
        {
          ...
          if ( v67 == -1 )
          {
            sub_94728((int)"symtab.c", 4483, "Section index is uninitialized");
            goto LABEL_157;
          }
          v68 = *(_DWORD *)(v65 + 8) + *(_DWORD *)(*(_DWORD *)(v109[0] + 144) + 4 * v67);
          v69 = sub_214960(v68);
          v14 = sub_21DBB0(v68, (int)v69) == 0;
          v65 = (int)v110;
          if ( !v14 )
          {
LABEL_136:
      ...
      sub_21CAC4(v112, v109[0], *(char **)v65);
      if ( !v112[0] )
      {
        v71 = (int *)a1[1];
        if ( v71 != (int *)a1[2] )
        ...
        sub_222788(a1, v71, &v107, &v110, v109);
      }
      v65 = (int)v110;
      goto LABEL_136;
    }
