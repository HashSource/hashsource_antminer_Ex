int __fastcall sub_1F98C8(int a1, int *a2, int a3, int a4, int a5, int a6)
{
  int v9; // r7
  char v10; // r3
  int v11; // r9
  ...
  *(_BYTE *)(a1 + 28) = v10 & 0xFE;
  if ( !v11 )
    sub_94708("Encountered void enum value");
  v12 = *(_DWORD *)(v9 + 24);
  v13 = *(char **)(v12 + 16);
  if ( !strncmp(v13, "RUST$ENCODED$ENUM$", 0x12u) )
  {
    ...
    *(_BYTE *)(a1 + 28) = v14 | 1;
    if ( v11 != 1 )
      sub_94708("Only expected one field in %s type", "RUST$ENCODED$ENUM$");
    v112 = v113;
    v15 = strlen(v13);
    v16 = *(_DWORD *)(v12 + 12);
    sub_1F9584(&v112, v13, (int)&v13[v15]);
    v17 = strtok_r((char *)v112 + 18, "$", &save_ptr);
    if ( !v17 )
LABEL_62:
      sub_94708("Invalid form for %s", "RUST$ENCODED$ENUM$");
    while ( sscanf(v17, "%lu", &v111) == 1 )
    {
      v18 = *(_DWORD *)(v16 + 24);
      if ( *(__int16 *)(v18 + 4) <= v111 )
        sub_94708("%s refers to field after end of member type", "RUST$ENCODED$ENUM$");
      v19 = *(_DWORD *)(v18 + 24);
...
LABEL_34:
    ...
    else
    {
      *(_DWORD *)(a1 + 24) = 1;
      ...
      if ( v21 )
        ...
        v22 = -1;
      sub_1F9584(&v114, v21, v22);
      if ( v115 == 2147483646 || v115 == 0x7FFFFFFF )
        sub_33D1AC("basic_string::append");
      v23 = sub_33C348(&v114, "::", 2);
      v117 = v119;
      v26 = v23;
      v27 = (int *)(v23 + 8);
  ...
  v44 = *(_DWORD *)(v43 + 24);
  if ( !*(_WORD *)(v44 + 4) )
    sub_94708("Could not find enum discriminant field");
  if ( v11 == 1 )
  {
    ...
    if ( v86 )
      ...
      v88 = -1;
    sub_1F9584(&v114, v86, v88);
    if ( v115 == 2147483646 || v115 == 0x7FFFFFFF )
      sub_33D1AC("basic_string::append");
    v89 = sub_33C348(&v114, "::", 2);
    v117 = v119;
    v92 = v89;
    v93 = (int *)(v89 + 8);
...
LABEL_113:
  ...
  if ( v45 )
    sub_94708("Rust debug format has changed");
  sub_256788(&ptr);
  v46 = *a2;
  v121[8] = 0;
  v47 = *(_DWORD *)(v43 + 24);
  ...
  *(_DWORD *)&v121[4] = 0;
  ...
  ptr = &off_3F294C;
  *(_DWORD *)v121 = &v121[8];
  sub_EC14C(v52, v55 + (v53 | (HIDWORD(v54) << 29)), a5, (int)&ptr, 0, a6, v122);
  v56 = *(_BYTE **)a1;
...
LABEL_59:
    if ( *(_DWORD *)(a1 + 24) == -1 && *(_DWORD *)(a1 + 4) )
      sub_94708("Could not find variant of %s with discriminant %s", *(const char **)(*a2 + 12), v59);
  }
  else
  {
    v63 = *(_DWORD *)(*a2 + 24);
