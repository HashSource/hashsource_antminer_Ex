void __fastcall sub_D43CC(_BYTE *a1, int a2, int a3)
{
  _BYTE *v3; // r12
  _DWORD *v4; // r4
  _BYTE *v5; // r3
...
LABEL_10:
      ...
      sub_93200((char **)&v22, "%d", dword_478360);
      v9 = ptr;
      if ( v22 == v24 )
      {
        sub_33B4B4(&ptr, &v22);
...
LABEL_24:
    ...
    sub_93200((char **)&v19, "%d-%d", dword_47835C + 1, dword_478360);
    v5 = ptr;
    if ( v19 == v21 )
    {
      sub_33B4B4(&ptr, &v19);
...
LABEL_3:
  ...
  v24[0] = &v13;
  v24[1] = &v12;
  sub_CABC8(v3, (int)&v22, (int (__fastcall *)(int, int, int))sub_DEBA0);
  if ( ptr != v18 )
    sub_339E8C(ptr);
  v4 = v15;
  if ( v15 )
