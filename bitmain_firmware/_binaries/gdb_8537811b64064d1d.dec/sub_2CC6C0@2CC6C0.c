int __fastcall sub_2CC6C0(int a1, unsigned int a2, unsigned int a3, int a4, unsigned int a5, int a6, unsigned int a7)
{
  int v7; // r3
  unsigned int v8; // r6
  unsigned int v9; // r2
  ...
  if ( a3 > 0xB )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v40 != 4 )
      {
        ...
        {
          v25 = (_DWORD *)sub_2ACC1C(a1, v17 + 12);
          v17 = n;
          v26 = src;
      ...
      if ( *s1 == 71 && s1[1] == 78 && s1[2] == 85 && !s1[3] )
      {
        if ( v42 == 3 )
        {
          if ( !v15 )
            return 0;
          v31 = (size_t *)sub_2ACC1C(a1, v15 + 7);
          v32 = v31;
          if ( !v31 )
            return 0;
          v33 = n;
