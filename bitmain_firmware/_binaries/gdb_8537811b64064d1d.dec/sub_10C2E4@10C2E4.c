int __fastcall sub_10C2E4(int a1, int a2, int a3, unsigned int a4, unsigned int a5, int a6, char a7)
{
  int v7; // r5
  int *v8; // r6
  int v10; // r2
  ...
  if ( !a3 || (v8 = *(int **)(a3 + 8)) == 0 )
  {
    ...
    sub_257374(v7, 0);
    if ( (_BYTE)v59 )
      ((void (__fastcall *)(int *))loc_5FD80)(v48);
    if ( (_BYTE)v57 )
      ((void (__fastcall *)(int *))loc_5FD2C)(v49);
    v47 = sub_257374(v7, 1);
    sub_339024(v47);
  }
  v11 = v8 + 1;
...
LABEL_34:
    ...
    do
    {
      ...
      v34 += sub_10BF10(v51, a2, v14[1], v14[2], a6, a7, 0);
...
LABEL_32:
  qsort(&v48, v26, 0xCu, (__compar_fn_t)sub_10B80C);
LABEL_33:
  sub_2578D4(a2, 1);
  v49 = &v56;
  v48 = &v58;
