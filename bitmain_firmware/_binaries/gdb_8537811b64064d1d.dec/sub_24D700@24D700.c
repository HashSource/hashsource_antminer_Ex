int __fastcall sub_24D700(int a1, unsigned int a2, int a3, unsigned int a4)
{
  int result; // r0
  int v9; // r3
  unsigned int v10; // r2
  ...
  if ( result )
  {
    *(_DWORD *)(a1 + 4) = *(_DWORD *)a1;
    ...
    if ( *(_DWORD *)result != v9 )
    {
      ...
      do
      {
        if ( sub_1B05C8(*(_DWORD *)(v12 - 8), *(_DWORD *)(v12 - 4), a2, v32) )
        {
          v14 = *(char **)(v12 - 8);
          dest = v14;
