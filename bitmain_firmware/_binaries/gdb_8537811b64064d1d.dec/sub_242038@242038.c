int __fastcall sub_242038(int result, char *a2, int a3, int (__fastcall *a4)(_DWORD, int))
{
  int v5; // r2
  char *v6; // r6
  char *v8; // r9
...
LABEL_19:
        ...
        {
          v24 = *v23--;
          sub_241EE8((int)v6, v22, v21, v24, a4);
        }
        while ( v22-- != 0 );
        do
        {
          ...
          *(_DWORD *)v16 = *(_DWORD *)v6;
          result = sub_241EE8((int)v6, 0, (v16 - v6) >> 2, v26, a4);
        }
        while ( v16 - v6 > 4 );
        return result;
      }
