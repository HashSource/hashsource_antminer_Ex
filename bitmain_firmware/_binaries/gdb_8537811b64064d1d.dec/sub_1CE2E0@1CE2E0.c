int __fastcall sub_1CE2E0(int a1, int a2, int a3, int a4, int a5, int (__fastcall *a6)(int, int))
{
  int v6; // r6
  int v8; // r0
  int v12; // r12
  ...
  if ( v8 > 0 )
  {
    do
    {
      ...
      result = sub_1CE2E0(v12, a2, a3, a4, a5, a6);
      if ( result )
      {
...
LABEL_8:
  ...
  while ( 1 )
  {
    while ( v17 > (unsigned int)v18 )
    {
      ...
      v16 = sub_1CE2A0(v16, a4);
      v19 = v16;
      if ( v16 )
      {
        if ( !a6 || (v21 = sub_21B804(*v18), (v16 = a6(a5, v21)) != 0) )
        {
          v20 = 1;
          goto LABEL_12;
        }
