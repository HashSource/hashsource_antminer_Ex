int __fastcall sub_2DBF10(int a1, int a2, int a3)
{
  int v3; // r4
  int v4; // r4
  int v6; // r6
  ...
  v9 = sub_2D4BA4(*(_DWORD *)(a1 + 148), a1);
  v10 = sub_2D4BA4(v6, a2);
  v11 = v10 == -257;
  if ( v10 != -257 )
    v11 = v9 == -257;
  if ( v11 )
  ...
  v80 = *(_DWORD **)(v6 + 160);
  v14 = sub_347440(v80[24], *(unsigned __int8 *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v6 + 4) + 444) + 392) + 5));
  v15 = v14 == 0;
  if ( !v13 )
    v15 = 1;
  v16 = v14;
  ...
  if ( v17 )
    goto LABEL_15;
  v48 = sub_2CDA30(v3, v83 + 72, v13, 0, 0, 0, 0);
  ptr = (char *)v48;
  if ( !v48 )
    return 0;
  if ( (*(_BYTE *)(a3 + 4) & 8) == 0 )
  {
    v17 = sub_16724(v13, v48);
...
LABEL_44:
        if ( v10 <= v32 )
        {
          ...
          if ( !v50 )
          {
            v51 = 8 * (_DWORD)v49;
            v82 = 2 * (_DWORD)v49;
            v35 = (char *)sub_2AB390(8 * v26);
            v52 = (char *)sub_2AB390(v51);
            v53 = v52 == 0;
            if ( v52 )
              v53 = v35 == 0;
            v38 = v52;
              ...
              if ( *v20 < v55 )
              {
                ...
                do
                {
                  *((_DWORD *)v57 - 2) = v59;
                  ...
                  v60 = *v59;
                  v59 += 2;
                  *((_DWORD *)v57 - 3) = sub_2CD86C(v56, *(_DWORD *)(v83 + 100), v60);
                }
              ...
              if ( (unsigned int)v61 < v62 )
              {
                ...
                do
                {
                  *((_DWORD *)v63 - 2) = v61;
                  ...
                  v64 = *v61;
                  v61 += 2;
                  *((_DWORD *)v63 - 3) = sub_2CD86C(v6, v80[25], v64);
                }
                while ( v62 > (unsigned int)v61 );
              }
              qsort(v35, v26, 8u, (__compar_fn_t)sub_2DBD08);
              qsort(v38, v26, 8u, (__compar_fn_t)sub_2DBD08);
...
LABEL_37:
    ...
    v34 = sub_2CDA30(v6, (int)(v80 + 18), v16, 0, 0, 0, 0);
    v85 = (char *)v34;
    if ( v34 )
    {
      if ( v17 )
...
LABEL_80:
  ...
  v85 = (char *)sub_2CDA30(v6, (int)(v80 + 18), v16, 0, 0, 0, 0);
  if ( !v85 )
    goto LABEL_80;
LABEL_51:
  v35 = (char *)sub_2AB390(8 * v13);
  v36 = (char *)sub_2AB390(8 * v16);
  v37 = v36 == 0;
  if ( !v35 )
    v37 = 1;
  v38 = v36;
  ...
  do
  {
    v70 = *(_DWORD *)v69;
    v69 += 8;
    *((_DWORD *)v69 - 1) = sub_2CD86C(v3, *(_DWORD *)(v83 + 100), *(_DWORD *)(v70 + 8));
  }
  while ( &v35[8 * v40] != v69 );
  v71 = &v38[8 * v45];
  v72 = v38;
  do
  {
    v73 = *(_DWORD *)v72;
    v72 += 8;
    *((_DWORD *)v72 - 1) = sub_2CD86C(v6, v80[25], *(_DWORD *)(v73 + 8));
  }
  while ( v71 != v72 );
  v74 = 4;
  qsort(v35, v40, 8u, (__compar_fn_t)sub_2DBD08);
  v75 = 0;
  qsort(v38, v40, 8u, (__compar_fn_t)sub_2DBD08);
  do
  {
