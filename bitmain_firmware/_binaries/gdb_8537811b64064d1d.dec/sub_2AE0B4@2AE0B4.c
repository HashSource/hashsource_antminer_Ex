int __fastcall sub_2AE0B4(_DWORD *a1, _DWORD *a2, int a3, int a4)
{
  int result; // r0
  int v9; // r8
  int v10; // r10
  ...
  {
    v18 = a3;
    result = sub_2A96A8((int)a1, (int)a2, &v18);
    if ( !result )
      return result;
    return v18;
  }
...
LABEL_22:
  ...
  v13 = 0;
LABEL_9:
  sub_2ADD24((int)a1, (int (__fastcall *)(int, int, int))sub_2AE03C, (int)&v19);
  if ( !a4 )
  {
    sub_2FE0A8(a1, s);
  ...
  v18 = sub_2A7B7C((int)a1, (int)s, (int)v21);
  if ( v18 )
    v9 = 0;
  if ( v9 )
    free(v13);
  sub_2ADD24((int)a1, (int (__fastcall *)(int, int, int))sub_2AE080, (int)&v19);
  free(ptr);
  sub_2FC50C(a1);
  a1[39] = v10;
  return v18;
