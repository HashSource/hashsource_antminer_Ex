int __fastcall sub_337270(const char *a1, int a2, int (__fastcall *a3)(char *), int a4)
{
  bool v4; // zf
  int v5; // r4
  unsigned int v6; // r11
...
LABEL_13:
  ...
  v148 = sub_336940(v14, v5);
  if ( !v148 )
  {
LABEL_131:
    free(s);
    return sub_337270(v8, v5 & 0xFFFFFBFF, a3, v7);
  }
  v15 = v148;
  while ( 1 )
  {
  ...
  while ( 1 )
  {
    ...
    v25 = sub_337270(s, v5 & 0xFFFFF7CF | 0x20, a3, v7);
    v26 = v25 == 0;
    if ( v25 )
      v26 = v25 == 3;
    if ( !v26 )
...
LABEL_44:
  ...
  {
    v38 = 0;
    v35 = (unsigned __int8 *)&word_39899C;
    v149 = 0;
  ...
  if ( v37 )
  {
    ...
    {
      *v94 = 0;
      v124 = sub_337270(v35, v5 & 0xFFFFF7ED | 2, a3, v7);
      v71 = v124;
      if ( v124 )
      {
        v125 = v124 == 3;
...
LABEL_210:
  ...
  {
    v85 = nb - (char *)v35;
    v84 = sub_338618(v35, 92, nb - (char *)v35);
    goto LABEL_172;
  }
...
LABEL_53:
  if ( !v146 )
  {
    if ( (v5 & 0x10) == 0 )
    {
      ...
      else if ( sub_349248(v35, &resultbuf) || ((int)resultbuf.pw_gecos & 0xF000) != 0x4000 )
      {
        return 3;
      }
    }
...
LABEL_80:
  ...
  if ( (v45 & 5) != 0 )
  {
    ...
    v72 = sub_337270(v35, v5 & 0x241 | 0x2004, a3, &v173);
    v27 = v72;
    if ( !v72 )
    {
      if ( v173 )
      {
        ...
        {
          v73 = *(_DWORD *)v7;
          v74 = sub_336C90(v146, *(char **)(v174 + 4 * v27), v5 & 0xFFFFF7CF | 0x20, a3, (int *)v7);
          if ( v74 != 3 )
          {
            if ( v74 )
            {
...
LABEL_146:
  ...
  if ( (v45 & 2) != 0 )
  {
    ...
    while ( *v50 );
LABEL_90:
    v52 = sub_336C90(v146, (char *)v35, v5 & 0xFFFFF7EF, a3, (int *)v7);
    if ( v52 )
    {
      v53 = v52 == 3;
      if ( v5 == (v5 & 0xFFFFF7EF) )
  ...
  else
  {
    if ( v38 )
      goto LABEL_90;
    v52 = sub_336C90(v146, (char *)v35, v5, a3, (int *)v7);
    if ( v52 )
      return v52;
  }
  if ( v33 && sub_3369D4((const char *)v35, *(_DWORD *)(v7 + 4) + 4 * (na + *(_DWORD *)(v7 + 8)), *(_DWORD *)v7 - na) )
  {
LABEL_195:
    v93 = *(_DWORD *)(v7 + 4);
LABEL_196:
...
LABEL_123:
    ...
    else if ( !sub_349248(v68, &resultbuf) && ((int)resultbuf.pw_gecos & 0xF000) == 0x4000 )
    {
      goto LABEL_123;
    }
    ++v65;
