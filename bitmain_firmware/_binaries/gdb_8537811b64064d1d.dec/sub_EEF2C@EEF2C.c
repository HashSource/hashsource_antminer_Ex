void *__fastcall sub_EEF2C(const char *a1, const char *a2, char *a3, size_t a4, int a5, struct obstack *a6, int a7)
{
  char *v11; // r0
  void *result; // r0
  iconv_t v13; // r8
  ...
  if ( strcmp(a1, a2) )
  {
    ...
    if ( v13 == (iconv_t)-1 )
      sub_258B2C("Converting character sets");
    inbytesleft = a4;
    inbuf = a3;
    if ( !a4 )
    ...
    while ( 1 )
    {
      ...
      if ( v19 == -1 )
      {
        ...
        {
          if ( v22 != 7 )
            sub_258B2C("Internal error while converting character sets");
          a4 *= 2;
          v15 = inbytesleft;
          goto LABEL_9;
        }
        if ( !a7 )
          sub_94708("Could not convert character to `%s' character set", a2);
        if ( a5 > 0 )
        {
          v23 = inbuf;
          v24 = 0;
          do
          {
            sub_93198(s, 5u, "\\%.3o", (unsigned __int8)*v23);
            v25 = strlen(s);
            v26 = a6->next_free;
