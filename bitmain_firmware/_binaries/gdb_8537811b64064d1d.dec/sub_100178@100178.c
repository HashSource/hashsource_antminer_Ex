_DWORD *__fastcall sub_100178(_DWORD *a1, const char *a2, int a3)
{
  char v4; // r5
  void *v5; // r3
  int v8; // r5
  ...
  if ( *a2 )
  {
    ...
    if ( v9 > 0xF )
    {
      v15 = (_DWORD *)sub_33B2E4(&v19, &v18, 0);
      v19 = v15;
      v21[0] = v18;
    }
    else
...
LABEL_12:
    ...
    *((_BYTE *)v11 + v10) = 0;
    do
    {
      if ( !v20 )
        break;
      sub_33B5CC(&v19, v20 - 1, 1);
      sub_FEB7C(&ptr, (int)v19, 0);
      v12 = v16;
      v13 = ptr;
      ptr = 0;
      v14 = v16 == 0;
