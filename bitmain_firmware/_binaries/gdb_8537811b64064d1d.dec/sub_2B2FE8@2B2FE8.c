void __fastcall sub_2B2FE8(_DWORD *a1, int a2)
{
  int v2; // r4
  int v3; // r3
  int v4; // r2
              ...
              if ( *(_DWORD *)(v5 + 4) == 1879048193 )
              {
                ...
                else
                {
                  if ( v8 != *(unsigned __int8 *)(v7 + 4) )
                    sub_2A6C18((int)"elf32-arm.c", 14739, (int)"elf32_arm_update_relocs");
                  v9 = *(void (__fastcall **)(_DWORD, _DWORD, _DWORD))(v7 + 64);
                  v51 = *(void (__fastcall **)(_DWORD, _DWORD, _DWORD))(v7 + 68);
                }
                v10 = v6[12];
                if ( v8 )
                  v11 = 12 * (sub_347440(v6[6], v8) + 1);
                else
                  v11 = 12;
                v12 = (char *)sub_2AB514(v11);
                ptr = v12;
                v13 = (_DWORD *)a1[40];
                if ( v13 )
                {
                  ...
                  do
                  {
                    ...
                    else if ( v17 == 1 )
                    {
                      ...
                      else
                      {
                        v26 = v25[19];
                        if ( !v26 || (v28 = *(_DWORD *)(v26 + 40), v28 != v6[10]) )
                          sub_2A6C18((int)"elf32-arm.c", 14782, (int)"elf32_arm_update_relocs");
                        v42 = v25 + 19;
                      }
                      if ( v27 )
                      {
                        v50 = (_DWORD *)v25[45];
                        v43 = a1[7] + v45[14];
                        if ( v28 && (unsigned int)sub_347440(*(_DWORD *)(v26 + 24), v28) )
                        {
                          v46 = v13;
                          v29 = 0;
                          do
...
LABEL_46:
                          ...
                          while ( (unsigned int)sub_347440(*(_DWORD *)(*v42 + 24), v34) > v29 );
                          v13 = v46;
                        }
                        if ( *v50 == 1 )
                        {
                      ...
                      else if ( v28 && (unsigned int)sub_347440(*(_DWORD *)(v26 + 24), v28) )
                      {
                        v44 = v14;
                        v38 = v15;
                        while ( 1 )
                        {
                          ...
                          v41 = sub_347440(*(_DWORD *)(*v42 + 24), v40);
