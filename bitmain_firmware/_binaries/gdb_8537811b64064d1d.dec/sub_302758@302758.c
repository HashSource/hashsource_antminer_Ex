int __fastcall sub_302758(int a1, int *a2, int a3, _DWORD **a4, char *src)
{
  _DWORD *v5; // r5
  char *v7; // r7
  _DWORD *v8; // r4
  ...
  if ( *(_DWORD *)(a3 + 36) != n )
  {
    sub_2A6BE4("stabs.c", 721);
    n = *(_DWORD *)(a3 + 36);
  }
  return sub_2ADE10(a1, *(_DWORD **)(a3 + 60), v7, n, *(unsigned int *)(a3 + 56), n);
}
