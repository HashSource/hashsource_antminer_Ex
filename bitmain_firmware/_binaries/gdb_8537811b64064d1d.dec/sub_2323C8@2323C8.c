int __fastcall sub_2323C8(unsigned int a1, int a2, unsigned int a3, int a4, __int64 a5)
{
  unsigned int v5; // r12
  __int64 v6; // r4
  __int64 v7; // r6
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned __int64)(a5 - v6) > 0x3FF )
      v9 = 1024;
    if ( sub_22F878(a1 | 0x200000000LL, 0, (int)s2, 0, v11, a3 + v12, (__PAIR64__(v5, a3) + v12) >> 32, v9, &v16) != 1 )
      break;
    v7 = v16;
