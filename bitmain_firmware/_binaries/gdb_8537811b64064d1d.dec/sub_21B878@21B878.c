_DWORD *__fastcall sub_21B878(_DWORD *result, int a2, int a3, int a4, char *s2, int a6, _DWORD *a7, _DWORD *a8)
{
  _DWORD *v9; // r5
  _DWORD *v10; // r4
  int v12; // r3
...
LABEL_13:
      ...
      *a8 = v18;
      if ( v19 )
      {
        v26 = *(_DWORD *)sub_242FF0(v15);
        if ( a4 )
          v27 = "Static";
        else
          v27 = "Global";
        v28 = (const char *)((int (__fastcall *)(int))loc_21A5CC)(a6);
        sub_2594D8(v26, "%s block symbol cache miss for %s, %s\n", v27, s2, v28);
      }
      v20 = v10[1];
      *v9 = 0;
      v9[1] = 0;
...
LABEL_24:
  if ( dword_48970C )
  {
    ...
    if ( v14[4 * v17] != 1 )
      v31 = "";
    v32 = (const char *)((int (__fastcall *)(int))loc_21A5CC)(a6);
    sub_2594D8(v29, "%s block symbol cache hit%s for %s, %s\n", v30, v31, s2, v32);
  }
  v23 = v14[4 * v17];
  ++*v10;
  if ( v23 == 1 )
