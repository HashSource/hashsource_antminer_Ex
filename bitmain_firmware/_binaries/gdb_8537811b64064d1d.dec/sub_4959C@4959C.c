int __fastcall sub_4959C(int result, int *a2, int a3)
{
  int v3; // r3
  int v4; // r7
  int v5; // r11
  ...
  if ( (int)a2 - result > 256 )
  {
    ...
    while ( 1 )
    {
      LOBYTE(v26) = 0;
      --v5;
      sub_49CAC(v4, v28, v4 + 16 * ((int)((((int)v7 - v4) >> 4) + (((unsigned int)v7 - v4) >> 31)) >> 1), v6 - 4, v26);
      v8 = *(_QWORD *)(v4 + 8);
      v9 = (unsigned int)v6;
      for ( i = v29; ; i += 16 )
      {
...
LABEL_22:
        ...
        do
        {
          ...
          *v22 = *(_DWORD *)v4;
          ...
          v22[3] = v25;
          LOBYTE(v27) = 0;
          result = sub_4A084(v4, 0, ((int)v22 - v4) >> 4, v37, v31, v33, v35, v37, v27);
        }
        while ( (int)v22 - v4 > 16 );
        return result;
      }
