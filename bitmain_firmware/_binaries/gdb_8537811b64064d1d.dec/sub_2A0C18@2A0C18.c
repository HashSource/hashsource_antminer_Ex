int __fastcall sub_2A0C18(int a1, int a2, int a3)
{
  int v5; // r7
  ...
  v7 = *(_DWORD **)(a2 + 64);
  result = sub_29C2E4(a1, a2, a3, 0);
  if ( !result )
  {
    result = sub_29E6E4(*(void (__fastcall **)(_DWORD, _DWORD))a2, *(_DWORD *)(a2 + 4), a3, 0);
    if ( !result )
    {
      v9 = -509607936;
      v10 = (int *)&unk_40027C;
        ...
        do
        {
          ...
          if ( v28 == 37 )
          {
            switch ( *(_BYTE *)(v26 + 1) )
            {
              ...
              case '8':
              case '9':
                result = (int)sub_29C20C((unsigned __int8 *)(v26 + 1), v27, &v90, &v89);
                v29 = result;
                switch ( *(_BYTE *)result )
                {
                  case '\'':
...
LABEL_126:
                    ...
                    result = ((int (*)(int, const char *, ...))v6)(v5, "%s", (&off_3FDE64[18 * dword_4707E4 + 2])[v41]);
                    goto LABEL_40;
                  case 'W':
                    v26 = result + 1;
...
LABEL_121:
              ...
              case 'A':
                v26 += 2;
                ((void (*)(int, const char *, ...))v6)(v5, "[%s", (&off_3FDE64[18 * dword_4707E4 + 2])[v66]);
                if ( v64 )
                {
                  v54 = v69;
                  if ( v57 )
                    ...
                    result = v6(v5, (const char *)&word_419FF0);
                }
                else
                {
                  result = v6(v5, (const char *)&word_419FF0);
...
LABEL_167:
                ...
                else
                {
                  ...
                  if ( (v27 & 0x80000) != 0 )
                    result = v6(v5, "f");
                  if ( (v27 & 0x40000) != 0 )
                    result = v6(v5, (const char *)&word_3DDCA0);
                  if ( (v27 & 0x20000) != 0 )
                    result = v6(v5, "x");
                  if ( (v27 & 0x10000) != 0 )
                    result = v6(v5, (const char *)&word_3FD7F0);
                }
                break;
              case 'E':
                v26 += 2;
              ...
              case 'U':
                ...
                if ( (v27 & 0xF0) != 0x60 )
                {
                  if ( (unsigned int)(v56 - 1) > 0xE || (v49 = off_3FDE64[v56 + 673]) == 0 )
                  {
LABEL_91:
              ...
              case 'a':
                v39 = v27;
LABEL_87:
                result = sub_29E2B4(a1, (void (__fastcall **)(int, __int64 *))a2, v39);
                v26 += 2;
                v54 = result;
                break;
              case 'b':
              ...
              case 'c':
                v26 += 2;
                if ( v72 != 14 )
                  result = ((int (*)(int, const char *, ...))v6)(v5, "%s", off_3FDE64[v72 + 144]);
                break;
              case 'e':
                v26 += 2;
                v54 = v76;
              ...
              case 'm':
                ...
                do
                {
                  ...
                  if ( v36 )
                  {
                    ...
                    v34 = 1;
                    ((void (__fastcall *)(int, char *, char *))v6)(v5, "%s", (&off_3FDE64[18 * dword_4707E4 + 2])[v33]);
                  }
                  ++v33;
                }
                while ( v33 != 16 );
...
LABEL_162:
                ...
                result = sub_29E160(v27, (int (*)(int, const char *, ...))v6, v5, 1);
                break;
              case 'p':
                v26 += 2;
              ...
              case 'q':
                v26 += 2;
                result = sub_29E160(v27, (int (*)(int, const char *, ...))v6, v5, 0);
                break;
              case 's':
                v62 = 0;
LABEL_50:
...
LABEL_174:
                    ...
                    ((void (*)(int, const char *, ...))v6)(v5, "[pc, #%s%d]\t; ", (const char *)&word_3C148C, v65);
                    v50 = -v65;
                    goto LABEL_174;
                  }
...
LABEL_58:
                    ...
                    else
                    {
                      ((void (*)(int, const char *, ...))v6)(
                        ...
                        ", %s%s",
                        v70,
                        (&off_3FDE64[18 * dword_4707E4 + 2])[v56]);
                      if ( v62 )
                        goto LABEL_58;
                      if ( v67 )
                      {
                  ...
                  if ( v68 )
                  {
                    if ( v58 )
                      ...
                      result = ((int (*)(int, const char *, ...))v6)(v5, "], #%s%d", (const char *)&word_3C148C, v65);
                    v54 = v82;
                    if ( v62 )
                      break;
                  }
