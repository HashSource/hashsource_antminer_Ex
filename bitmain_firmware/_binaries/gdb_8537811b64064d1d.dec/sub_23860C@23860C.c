void __fastcall sub_23860C(_DWORD *a1, int a2, char *a3)
{
  _DWORD *v3; // r5
  void *v4; // r7
  int v5; // r3
  ...
  if ( dword_48A2B0 != 3 )
  {
    ...
    ((void (__fastcall *)(int *, int, int, int *))loc_23500C)(dword_48A294, v10, 17, v8);
    goto LABEL_16;
  }
LABEL_7:
  v3 = (_DWORD *)a1[9];
  ...
  {
LABEL_16:
    sub_23BDEC(a1 + 8, v3, &s, &v19, &v18, &v20);
    return;
  }
  ptr[0] = v22;
  if ( s )
    v11 = (int)&s[strlen(s)];
  sub_235120(ptr, s, v11);
  if ( v3 )
  {
    v13 = v18;
    v14 = v19;
    v15 = v20;
    *v3 = v3 + 2;
    sub_235120(v3, (_BYTE *)ptr[0], (int)ptr[0] + (unsigned int)ptr[1]);
    v3[6] = v14;
    v3[7] = v13;
    v3[8] = v15;
  }
