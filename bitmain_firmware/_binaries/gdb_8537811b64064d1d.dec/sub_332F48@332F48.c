int *__fastcall sub_332F48(int *a1, int *a2, int a3)
{
  int v3; // r9
  int v4; // r3
  int v5; // r4
  ...
  {
    sub_3312D4((int)v36, 128);
    v37 = *(_DWORD *)(a3 + 12);
    sub_32D1E0((int)v39, (unsigned int)v6, (int)v36);
    v10 = v6[8];
    v6 = v39;
    v5 = v38;
    v11 = v10 & 0x80 | v40;
  ...
  if ( (v11 & 0x70) != 0 )
  {
    ...
    else
    {
      ...
      {
        sub_332718((unsigned int)v6, &v32, 0);
        v11 = v6[8];
      }
      if ( (v11 & 0x20) != 0 )
        v12 = v35 | 0x7C000000;
  ...
  else
  {
    ...
    if ( *((_WORD *)v6 + 5) || *(_DWORD *)v6 != 1 )
    {
      ...
      sub_332718((unsigned int)v6, &v32, v22);
      v23 = v35 & 0x3FFF;
      v24 = v35 >> 14;
      if ( v35 >> 14 > 7 )
      {
