int __fastcall sub_110694(int a1, unsigned int a2, int a3, int *a4, _QWORD *a5, _DWORD *a6, _DWORD *a7, _DWORD *a8)
{
  _QWORD **v10; // r0
  int v11; // r4
  void *v12; // r8
  ...
  v50 = a2;
  v10 = (_QWORD **)((int (__fastcall *)(unsigned int *, int *))loc_1103B0)(&v50, &v49);
  v11 = (int)v10;
  if ( !v10 )
    sub_94708("Could not compute CFA; needed to translate this expression");
  sub_10FC34((int)&src, v50, *v10);
  sub_10EA74((int)&src, v11);
  sub_10EDC0((unsigned __int8 *)v11, *(char **)(*(_DWORD *)v11 + 40), *(_DWORD *)(*(_DWORD *)v11 + 44), a1, a2, &src);
  v12 = v52;
  v41 = v53;
  v13 = 24 * (_DWORD)v52;
  v44 = v54;
  ...
  if ( v20 )
    free(v20);
  sub_10EDC0((unsigned __int8 *)v11, *(char **)(v11 + 12), *(_DWORD *)(v11 + 16), a1, a2, &src);
  if ( v56 == 1 )
  {
    v28 = sub_117670(a1, v21, v54, v55);
    v19 = v66 == 0;
    *a4 = v28;
    if ( !v19 )
    {
  ...
  else
  {
    if ( v56 != 2 )
    {
      sub_94728((int)"dwarf2-frame.c", 915, "Unknown CFA rule.");
      sub_1118E4(ptr);
      v35 = sub_1118E4(&src);
      sub_339024(v35);
    }
