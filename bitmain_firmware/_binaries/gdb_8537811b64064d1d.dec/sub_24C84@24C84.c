unsigned int __fastcall sub_24C84(int a1, unsigned int a2)
{
  int v4; // r6
  int v5; // r7
  unsigned int v6; // r6
  ...
  if ( sub_C37E0(a2, 0, &v36, 0) )
  {
    v4 = ((int (__fastcall *)(int, unsigned int))loc_21EDF4)(a1, v36);
    v5 = sub_21DDD4(v36);
    if ( v4 )
    {
      v8 = ((int (__fastcall *)(int))loc_165C50)(a1);
      v9 = sub_24874(a1, v4);
      v10 = ((int (__fastcall *)(int))loc_165C50)(a1);
      if ( sub_24874(a1, v4) )
      {
        v11 = sub_FA9FC(v4, 2, v10);
        if ( (v11 & 0xF800) == 0x4800 )
        {
          v30 = v10;
          v17 = HIBYTE(v11) & 7;
          v18 = 2;
          v16 = sub_FA984((v4 & 0xFFFFFFFC) + 4 + ((4 * v11) & 0x3FC), 4, v30);
        }
        else
        {
          if ( (v11 & 0xFBF0) != 0xF240 )
            goto LABEL_12;
          v35 = v11;
          v23 = sub_FA9FC(v4 + 2, 2, v10);
          v24 = sub_FA9FC(v4 + 4, 2, v10);
          v25 = v10;
          v26 = v24;
          v27 = sub_FA9FC(v4 + 6, 2, v25);
      ...
      {
        v13 = sub_FA9FC(v4, 4, v10);
        v14 = v13;
        if ( (v13 & 0xE5F0000) == 0x41F0000 )
        {
          v17 = (unsigned __int16)v13 >> 12;
          v29 = sub_FA984(v4 + 8 + (v13 & 0xFFF), 4, v10);
          v18 = 4;
          v16 = v29;
        }
        else
      ...
      if ( v16 )
      {
        ...
        if ( v37 )
        {
          if ( !strncmp(*v37, "__stack_chk_guard", 0x11u) )
          {
            ...
            if ( v9 )
            {
              v20 = sub_FA9FC(v19, 2, v8);
              if ( (v20 & 0xF800) != 0x6800 )
                goto LABEL_12;
              if ( ((v20 >> 3) & 7) != v17 )
                goto LABEL_12;
              v34 = v20;
              v21 = sub_FA9FC(v19 + 2, 2, v8);
...
LABEL_12:
      if ( v5 )
      {
        ...
        if ( v12 )
        {
          ...
          {
            v22 = sub_24874(a1, v36) ? sub_21DE8(a1, v36, v4, 0) : sub_22EF4(a1, v36, v4, 0);
            if ( v22 != v4 )
              return v36;
          }
        }
...
LABEL_3:
  v6 = ((int (__fastcall *)(int, unsigned int))loc_21EDF4)(a1, a2);
  if ( !v6 )
    v6 = a2 + 64;
  if ( sub_24874(a1, a2) )
    return sub_21DE8(a1, a2, v6, 0);
  return sub_22EF4(a1, a2, v6, 0);
}
