int __fastcall sub_CDDAC(int a1, int a2, int a3)
{
  int v3; // r4
  int v6; // r9
  int *v7; // r5
  ...
  while ( 1 )
  {
    ...
    {
      v9 = sub_16F67C(a1);
      a1 = ((int (__fastcall *)(int))loc_16D924)(v9);
      if ( a1 || v6 == *(_DWORD *)(*(_DWORD *)(v3 + 48) + 20) )
      {
        v10 = *(_DWORD *)(v3 + 56);
        if ( !v10 )
          v10 = 1;
        a1 = sub_1B05C8(a2, a3, *(_DWORD *)(v3 + 52), v10);
        if ( a1 )
        {
          if ( !dword_489690 )
            break;
          if ( !sub_2142C8(*(_DWORD *)(v3 + 64)) )
            break;
          a1 = sub_2142F8(*(_DWORD *)(v3 + 64));
          if ( a1 )
            break;
        }
      }
