unsigned int __fastcall sub_2F5664(_DWORD **a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _DWORD *a5, _DWORD *a6)
{
  ...
  if ( !a2[8] )
  {
    ...
    {
      v40 = sub_2AD7D4((int)*a1, ".line");
      if ( !v40 )
        return 0;
      v41 = *((_DWORD *)v40 + 10);
      if ( !v41 )
        v41 = *((_DWORD *)v40 + 9);
      v16 = sub_2AE0B4(*a1, v40, 0, (int)a1[1]);
      a1[5] = (_DWORD *)v16;
      if ( !v16 )
        return 0;
      v17 = (_DWORD *)(v16 + v41);
...
LABEL_28:
  ...
  if ( !v11 )
  {
    ...
    {
      while ( sub_2F543C((int)(*a1 + 1), &s, v33, HIDWORD(v33)) )
      {
        v37 = v48 == 20;
        if ( v48 != 20 )
          v37 = v48 == 6;
