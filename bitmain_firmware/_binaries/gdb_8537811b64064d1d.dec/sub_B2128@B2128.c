void __fastcall sub_B2128(int a1, int a2)
{
  int v4; // r4
  int v5; // r0
  int v6; // r8
  ...
  v7 = sub_26E9A0(v4);
  v8 = sub_26BC98(v4);
  ((void (*)(double *, int, int, const char *, ...))loc_252558)(
    &ptr,
    v7,
    v8,
    "%g",
...
LABEL_6:
  ...
  *v9 = 0;
  if ( (_DWORD *)LODWORD(ptr) != v18 )
    sub_339E8C((void *)LODWORD(ptr));
  sub_25A440(a2, "delta %s", (const char *)LODWORD(v15));
  if ( sub_25E0A4(v4, v6) )
    goto LABEL_9;
  v11 = sub_26E9A0(v6);
  v12 = sub_26BC98(v6);
  ((void (*)(double *, int, int, const char *, ...))loc_252558)(&v19, v11, v12, "%g", v15);
...
LABEL_17:
  ...
  *v13 = 0;
  if ( (_DWORD *)LODWORD(v19) != v20 )
    sub_339E8C((void *)LODWORD(v19));
  sub_25A440(a2, " <'small = %s>", (const char *)LODWORD(v15));
LABEL_9:
  if ( (_DWORD *)LODWORD(v15) != v16 )
    sub_339E8C((void *)LODWORD(v15));
}
