int __fastcall sub_1CDD4(int a1, int *a2, int a3, int a4)
{
  unsigned int v5; // r4
  int v8; // r9
  int v9; // r3
  ...
  *(_DWORD *)(a1 + 20) = (v5 >> 21) & 0xF;
  ...
  if ( v9 != 10 )
  {
    if ( v9 == 8 )
    {
      v18 = v5 & 0xF;
      v19 = HIWORD(v5) & 0xF;
      ((void (__fastcall *)(int, int, _DWORD *))loc_1DFA24)(v8, v18, v30);
      ((void (__fastcall *)(int, int, _DWORD *))loc_1DFA24)(v8, v19, v31);
      HIDWORD(v20) = v30[0];
      if ( v19 == 15 )
        HIDWORD(v20) = v30[0] + 8;
      if ( *(_DWORD *)(a1 + 20) == 12 )
    ...
    if ( v10 )
    {
      ...
      ((void (__fastcall *)(int, int, _DWORD *))loc_1DFA24)(v8, v12, v30);
      v14 = *(_DWORD *)(a1 + 20);
      v15 = v14 == 6;
      if ( v14 != 6 )
        v15 = v14 == 15;
    ...
    else
    {
      ...
      if ( !v27 )
        return 0;
      ((void (__fastcall *)(int, unsigned int, _DWORD *))loc_1DFA24)(v8, v5 & 0xF, v30);
      ((void (__fastcall *)(int, unsigned int, _DWORD *))loc_1DFA24)(v8, HIWORD(v5) & 0xF, v31);
      v28 = *(_DWORD *)(a1 + 20);
      v29 = v28 == 4;
      if ( v28 != 4 )
        v29 = v28 == 13;
  ...
  v21 = HIWORD(v5) & 0xF;
  ((void (__fastcall *)(int, int, _DWORD *))loc_1DFA24)(v8, v21, v30);
  v22 = v5 & 0xF;
  v23 = v30[0];
  v24 = v5 >> 8;
  if ( v21 == 15 )
