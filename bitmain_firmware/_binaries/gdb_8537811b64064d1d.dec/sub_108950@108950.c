int __fastcall sub_108950(int result, int a2)
{
  int v3; // r4
  int v4; // r3
  _DWORD *v5; // r8
  ...
  if ( !*(_BYTE *)(a2 + 52) )
  {
    ...
    if ( v4 > 0 )
    {
      do
      {
        ...
        if ( !*(_BYTE *)(v6 + 52) )
        {
          if ( dword_48A514 )
          {
            v34 = (_DWORD *)sub_242FB4(result);
            sub_25A6E4(&word_3E1FAC, *v34);
            v35 = sub_259B80("");
            v36 = (_DWORD *)sub_242FB4(v35);
            sub_25A6E4("and ", *v36);
            sub_259B80("");
            sub_259F38("%s...", *(const char **)(*(_DWORD *)(*(_DWORD *)(a2 + 28) + 4 * v3) + 4));
            v37 = sub_259B80("");
            v38 = (_DWORD *)sub_242FB4(v37);
            sub_256834(*v38);
            v6 = *(_DWORD *)(*(_DWORD *)(a2 + 28) + 4 * v3);
          }
          result = sub_108950(v5, v6);
          v4 = *(_DWORD *)(a2 + 32);
        }
        ++v3;
      }
    ...
    if ( !*(_DWORD *)(*(_DWORD *)(a2 + 64) + 4) )
      goto LABEL_6;
    v7 = nullsub_23();
    ((void (__fastcall *)(int))loc_E685C)(v7);
    v8 = *(_DWORD **)(a2 + 64);
    v9 = v5[9];
    v10 = v8[3];
    v11 = v8[2];
    dword_47B268 = v8[5];
    dword_47B258 = v11;
    sub_2A8A2C(v9, v11, v10, v10 >> 31, 0);
    v12 = *(int **)(a2 + 64);
    dword_47B2A0 = (int)v5;
    v13 = *v12;
    v14 = v12[1];
    ...
    v49 = *(_DWORD *)(a2 + 20);
    v47 = v5[36];
    dword_47B264 = *(_DWORD *)(sub_1B6B4C(v5, dword_47B26C) + 12);
    sub_E6560(0);
    v15 = (_DWORD *)v5[9];
    dword_47B25C = 0;
    ...
    *(_QWORD *)&dword_47B244 = (unsigned int)(v13 + v14);
    ...
    else
    {
      ...
      v55 = v45;
      v5[49] = v43 + 1;
      v16 = __PAIR64__(&byte_47898D, (unsigned int)sub_105558((int)v5, &v51));
      v44 = (const char *)v16;
      byte_47898D = 0;
      if ( v52 == 4 )
      {
    ...
    {
      v18 = (char *)sub_347440(v14, dword_47B258);
      ...
      if ( v18 )
      {
        do
        {
          ...
          v18 = (char *)sub_105558((int)v5, &v51);
          v22 = v18;
          if ( (v21 & 0xE0) != 0 )
          {
            v18 = (char *)sub_10797C(v21, (int *)v54, v55, v18, v47, v5, *(_DWORD *)(*(_DWORD *)(a2 + 64) + 24));
          }
          else if ( v21 == 4 )
          {
      ...
      if ( v32 != -1 )
      {
        v33 = sub_E747C(v49, v32);
        *(_DWORD *)(a2 + 56) = v33;
        sub_20C1BC(v33);
        dword_47B2A0 = 0;
        result = sub_E5BF4((int)v50);
LABEL_6:
        *(_BYTE *)(a2 + 52) = 1;
        return result;
      }
      v16 = sub_94728((int)"dbxread.c", 2448, "sect_index_text not initialized");
    }
    sub_94708("First symbol in segment of executable not a source symbol", HIDWORD(v16));
  }
  v31 = (_DWORD *)sub_242FDC(result);
  return sub_2594D8(*v31, "Psymtab for %s already read in.  Shouldn't happen.\n", *(const char **)(a2 + 4));
}
