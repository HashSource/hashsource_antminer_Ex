void sub_215834()
{
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v3 )
        break;
      v55 = sub_1B87D0((int)v0);
      v31 = _xstat64(3, v55, v70) == 0;
      v1 = v66;
      if ( v31 )
        goto LABEL_10;
LABEL_51:
      v56 = (const char *)sub_1B87D0((int)v1);
      sub_259880("`%s' has disappeared; keeping its symbols.\n", v56);
LABEL_3:
      v1 = v66;
LABEL_4:
      v0 = (_DWORD *)*v1;
...
LABEL_10:
    ...
    if ( v1[11] == v71 )
      goto LABEL_4;
    v5 = sub_1B87D0((int)v1);
    sub_259880(v63, v5);
    dest = v66;
    v64 = sub_92564((int)v62, 0);
    v6 = v66;
    ...
    v11 = *v10;
    ((void (__fastcall *)(int *, const char *, int, int))loc_1629B4)(&v67, *v10, *v61, -1);
    v12 = v67;
    v67 = 0;
    v66[9] = v12;
    if ( !v12 )
      sub_94708("Can't open %s to read symbols.", v11);
    ((void (__fastcall *)(const char **))loc_1625D0)(v10);
    v13 = (const char *)sub_32727C(v66[1]);
    sub_92564(2165776, (int)v13);
    v14 = sub_2AA894(v66[9], 1);
    v15 = v66;
    if ( !v14 )
    {
      v57 = (const char *)sub_1B87D0((int)v66);
      v58 = sub_2A6938(v57);
      v59 = (const char *)sub_2A6948(v58);
      sub_94708("Can't read symbols from %s: %s.", v57, v59);
    }
    ...
    v23[8] = 0;
    v23[52] = 0;
    obstack_begin((struct obstack *)(v23 + 12), 0, 0, (void *(*)(int))sub_93050, sub_210C10);
    sub_1B6B54((int)v66);
    v24 = v66;
    v25 = strlen(v13);
    v26 = (void *)v66[15];
    ...
    *(_BYTE *)(v27 + v25) = 0;
    ...
    v24[14] = v33;
    v34 = sub_211A7C(*(_DWORD *)(v32[9] + 4));
    ((void (__fastcall *)(_DWORD *, int))loc_217784)(v32, v34);
    sub_1B6DF4((int)v66);
    sub_1B28C8((int)v66);
    v35 = v66;
    v36 = v66[16];
    ...
    (*(void (**)(void))(v46[33] + 4))();
    sub_F4444(&off_46D334, 1, 1);
    v66[3] &= ~0x10u;
    sub_1B85FC();
    sub_213800((int)v66, 0);
    if ( !sub_1B7ACC(v66) )
    {
      sub_259B80("");
