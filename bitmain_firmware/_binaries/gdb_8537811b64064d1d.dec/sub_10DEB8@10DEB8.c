unsigned int __fastcall sub_10DEB8(_DWORD *a1, _DWORD *a2, int a3, unsigned int *a4, int *a5, char a6)
{
  _DWORD *v8; // r5
  __int64 v9; // r0
  int v10; // r4
...
LABEL_67:
      ...
      *(_DWORD *)(HIDWORD(v18) + 48) = v119 + 1;
      ...
      {
        v119 += 2;
        v104 = ((int (__fastcall *)(int))loc_16661C)(v11);
        v80 = *(unsigned __int8 *)(HIDWORD(v18) + 66);
        v83 += v104 / 8;
      }
      if ( v80 <= 3 )
      {
        *(_DWORD *)(HIDWORD(v18) + 56) = ((int (__fastcall *)(int))loc_166740)(v11);
      ...
      *(_DWORD *)(HIDWORD(v18) + 60) = a3
                                     ? ((int (__fastcall *)(int))loc_16661C)(v11) / 8
...
LABEL_148:
          *(_QWORD *)(HIDWORD(v18) + 32) = v100;
LABEL_119:
          *(_QWORD *)(HIDWORD(v18) + 32) = sub_10D998(v11, v100, a3);
          v28 = *v119 == 122;
                  ...
                  while ( 1 )
                  {
                    switch ( v112 )
                    {
                      ...
                      case 'P':
                        ...
                        LODWORD(v116) = a1;
                        sub_10D9E0(v116, *(_DWORD *)(HIDWORD(v18) + 60), (int)(v58 + 1), v132, 0);
                        v58 += v132[0] + 1;
                        goto LABEL_130;
                    }
                    if ( v112 != 83 )
...
LABEL_156:
                  sub_94708("Found a CIE when not expecting it.", HIDWORD(v17));
                }
                v61 = v59 + 1;
                v62 = 4 * (v59 + 1);
                v63 = (char *)sub_93078(v60, v62);
...
LABEL_11:
    if ( (v19 & 2) == 0 )
      sub_94708("Found an FDE when not expecting it.");
    if ( a3 )
    {
      if ( v70 == 12 )
        v20 = 8;
    ...
    *(_DWORD *)(v21 + 56) = HIDWORD(v29);
    ...
    v30 = sub_10DD98(a4, v29);
    *v25 = v30;
    if ( !v30 )
    {
      sub_10DEB8(a1, a1[2] + v18, a3, a4, a5, 1);
      v30 = sub_10DD98(a4, v18);
      *v25 = v30;
      if ( !v30 )
      {
        sub_94728(
...
LABEL_95:
    ...
    LODWORD(v34) = a1;
    v120 = sub_10D9E0(v34, v33, (int)v119, v132, 0);
    v35 = ((int (__fastcall *)(int, int))loc_16A960)(v11, v120);
    v36 = *v25;
    v37 = v132[0];
    v25[1] = v35;
    LODWORD(v38) = a1;
    ...
    v40 = sub_10D9E0(v38, *(_DWORD *)(v36 + 60), v39, v132, 0);
    v25[2] = v40;
    v41 = ((int (__fastcall *)(int, int))loc_16A960)(v11, v120 + v40);
    v42 = *v25;
    v43 = v132[0];
    v44 = v41 - v25[1];
    v25[2] = v44;
...
LABEL_40:
    ...
    sub_F43DC(v56, v55, **(_DWORD **)(v54 + 148), *(_DWORD *)v54);
  }
  return v15;
}
