        ...
        __int64 *a9)
{
  ...
  if ( a8 )
  {
    ...
    if ( a4 && !dword_46DBC8 )
    {
      v45 = sub_98EAC(a6);
      v46 = sub_988D4(a8);
      sub_94708("Writing to memory is not allowed (addr %s, len %s)", v45, v46);
    }
    LODWORD(a1) = 0;
    v14 = HIDWORD(a1) > 2;
    if ( HIDWORD(a1) != 2 )
    ...
    *a9 = a1;
    if ( !v14 )
    {
      ...
      if ( a3 )
      {
        v21 = sub_22F600(SHIDWORD(v12), v12, a3, 0, (unsigned int)v17, v11, a9);
        v22 = v21;
        if ( v21 == 1 )
        {
          v23 = &dword_4899A0;
          if ( !dword_489FA4 )
            v21 = ((int (__fastcall *)(int, _DWORD))loc_CD750)(a3, 0);
          if ( dword_489C84 )
          {
            v18 = 0;
            goto LABEL_29;
      ...
      else
      {
        ...
        if ( (_DWORD)v11 )
        {
          ...
          ((void (__fastcall *)(_DWORD, void *, int, char *, unsigned int, _DWORD, _DWORD, _DWORD))loc_CD750)(
            0,
            ptra,
            a4,
            v39,
        ...
        {
          ptra = 0;
          ((void (__fastcall *)(_DWORD, _DWORD, int, int, unsigned int, _DWORD, _DWORD, _DWORD))loc_CD750)(
            0,
            0,
            a4,
            v20,
        ...
        v21 = sub_22F600(SHIDWORD(v12), v12, 0, (int)ptra, v18, v11, a9);
        v22 = v21;
        if ( ptra )
          sub_339E8C(ptra);
      }
...
LABEL_29:
        ...
        v52 = sub_98F14(a3);
        v26 = sub_98F14(a4);
        v10 = sub_98EAC((int)v10);
        HIDWORD(v12) = sub_988A8(a8, SHIDWORD(a8));
        v27 = sub_988A8(*(_DWORD *)a9, *((_DWORD *)a9 + 1));
        v28 = a4;
        if ( !a4 )
          v28 = a3;
        a4 = v28;
        ...
        if ( v30 )
        {
          v32 = (_DWORD *)sub_242FF0(v29);
          v29 = sub_256878(", bytes =", *v32);
          if ( *a9 )
          {
...
LABEL_39:
            ...
            if ( v34 )
            {
              v47 = (_DWORD *)sub_242FF0(v29);
              v29 = sub_2594D8(*v47, " ...");
            }
            else
            {
              v35 = (_DWORD *)sub_242FF0(v29);
              v29 = sub_2594D8(*v35, (const char *)&word_356660);
LABEL_43:
              while ( 1 )
              {
                v36 = (_DWORD *)sub_242FF0(v29);
                v37 = *v33++;
                sub_2594D8(*v36, " %02x", v37);
                v29 = v12 + 1;
                if ( *(_QWORD *)v23 <= v12 )
                  break;
                ++v12;
    ...
    if ( sub_22D610(a3, a4, a6, a7, v11, &a8, (int **)v15) )
    {
      v21 = sub_22F500((int *)HIDWORD(v12), a3, a4, (int)a9, a6, a7, a8, SHIDWORD(a8), a9);
      v22 = v21;
      goto LABEL_22;
    }
    return -1;
