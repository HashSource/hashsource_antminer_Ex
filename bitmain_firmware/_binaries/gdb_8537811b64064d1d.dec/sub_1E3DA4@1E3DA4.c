int __fastcall sub_1E3DA4(int a1, _DWORD *a2)
{
  int v4; // r0
  __int64 v5; // kr08_8
  int *v6; // r9
  ...
  *((_QWORD *)a2 + 1) = v5;
  v7 = sub_16F67C(v4);
  ((void (__fastcall *)(int))loc_1E2798)(v7);
  v8 = 11;
  v9 = dword_488C94;
  a2[5] = 11;
  a2[13] = -1;
  ...
  switch ( *(_BYTE *)a1 )
  {
    ...
    case 'W':
    case 'X':
      v10 = sub_991B0((unsigned __int8 *)(a1 + 1), (unsigned int *)&v149);
      if ( *(_BYTE *)a1 == 87 )
      {
        HIDWORD(v67) = v149;
        LODWORD(v67) = 0;
...
LABEL_79:
          sub_94708("unknown stop reply packet: %s", (const char *)a1);
        sub_991B0(v10 + 9, (unsigned int *)v150);
        v13 = v150[0];
      }
LABEL_13:
      sub_98F78(&v144, v13);
    ...
    case 'w':
      a2[5] = 15;
      v33 = sub_991B0((unsigned __int8 *)(a1 + 1), (unsigned int *)v150);
      a2[6] = v150[0];
      if ( *v33 != 59 )
        sub_94708("stop reply packet badly formatted: %s", (const char *)a1);
      sub_1E13FC((int)&v144, v33 + 1, 0);
      v8 = v144;
      v34 = v145;
      v35 = v146;
      *v6 = v144;
  ...
  while ( 1 )
  {
    ...
    if ( !v23 )
      sub_94708("Malformed packet(a) (missing colon): %s\nPacket: '%s'\n", v21, (const char *)a1);
    if ( v23 == v21 )
      sub_94708("Malformed packet(a) (missing register number): %s\nPacket: '%s'\n", v21, (const char *)a1);
    if ( v23 <= v21 )
      goto LABEL_59;
    switch ( v22 )
    {
      case 't':
        ...
        if ( !v28 )
        {
          sub_1E13FC((int)&v144, (unsigned __int8 *)v23 + 1, (unsigned __int8 **)&v147);
          v8 = v144;
          v30 = v145;
          v31 = v146;
          v32 = v147;
...
LABEL_49:
          a2[5] = v42;
          v8 = (int)sub_991B0(v24 + 1, (unsigned int *)v150);
          v32 = (const char *)v8;
          v147 = (const char *)v8;
          a2[6] = v150[0];
          goto LABEL_38;
...
LABEL_56:
            ...
            {
              a2[11] = 1;
              if ( ((int (__fastcall *)(int, unsigned __int8 *))loc_1E21C0)(79, v36) != 1 )
                sub_94708("Unexpected swbreak stop reason");
LABEL_75:
...
LABEL_59:
        v52 = (unsigned __int8 *)&unk_3D5B8F;
...
LABEL_62:
        ...
        if ( !v60 )
        {
          v88 = v24 + 1;
          v141 = 1;
          v89 = sub_991B0(v88, (unsigned int *)&v149);
          v90 = v89 - v88;
          v147 = (const char *)v89;
          sub_99220(v88, v150, (v89 - v88) / 2);
          *((_BYTE *)v150 + v90 / 2) = 0;
          v8 = sub_32727C(v150);
          a2[6] = v8;
          a2[5] = 6;
...
LABEL_68:
        if ( !v141 )
        {
          if ( v24 != sub_991B0((unsigned __int8 *)v21, (unsigned int *)v150) )
          {
            v8 = strchrnul(v24 + 1, 59);
            v147 = (const char *)v8;
            goto LABEL_71;
          ...
          if ( a2[1] == dword_475848 && a2[2] == (_DWORD)qword_47584C )
          {
            ...
            v118 = sub_338BFC(v24 + 1, ";thread:");
            if ( v118 )
            {
              sub_1E13FC((int)&v144, (unsigned __int8 *)(v118 + 8), 0);
              v119 = v145;
              v120 = v146;
              *v6 = v144;
            }
...
LABEL_127:
          ...
          v107 = sub_183AB0(*v6, a2[2], a2[3]);
          if ( v107 )
          {
            a2[9] = *(_DWORD *)(v107 + 168);
            v140 = ((int (*)(void))loc_1E2798)();
LABEL_120:
            v91 = a2[9];
            v92 = 0;
            v142 = v150[0];
            while ( 1 )
            {
              if ( ((int (__fastcall *)(int))loc_166EC4)(v91) <= v92 )
              {
                v106 = sub_98B30(v150[0], SHIDWORD(v150[0]));
                sub_94708("Remote sent bad register number %s: %s\nPacket: '%s'\n", v106, v147, (const char *)a1);
              }
            ...
            v96 = v24 + 1;
            v143 = v93;
            v97 = ((int (__fastcall *)(_DWORD, unsigned int))loc_1DD448)(a2[9], v95);
            v98 = sub_93050(v97);
            v99 = a2[9];
            v147 = (const char *)v96;
            v100 = ((int (__fastcall *)(int, _DWORD))loc_1DD448)(v99, *(_DWORD *)(v143 + 4));
            v101 = (int)sub_99220(v96, v98, v100);
            v102 = a2[9];
            v103 = *(_DWORD *)(v143 + 4);
            v147 += 2 * v101;
            v8 = ((int (__fastcall *)(int, int))loc_1DD448)(v102, v103);
            if ( v101 < v8 )
              v8 = sub_946D8("Remote reply is too short: %s", a1);
...
LABEL_86:
          ...
          case 'h':
            ...
            {
              a2[11] = 2;
              if ( ((int (__fastcall *)(int, _DWORD, const char *))loc_1E21C0)(80, 0, v108) != 1 )
                sub_94708("Unexpected hwbreak stop reason");
              goto LABEL_75;
            }
            goto LABEL_59;
          case 'l':
          ...
          case 'f':
            ...
            if ( v129 )
              goto LABEL_59;
            sub_1E13FC((int)&v144, v24 + 1, (unsigned __int8 **)&v147);
            v8 = v144;
            v131 = v145;
            v132 = v146;
            v32 = v147;
...
LABEL_38:
        if ( *v32 != 59 )
          sub_94708("Remote register badly formatted: %s\nhere: %s", (const char *)a1, v32);
        v21 = (char *)(v32 + 1);
        v147 = v21;
        break;
    }
...
LABEL_17:
    a2[5] = 1;
    v17 = sub_9910C(*(unsigned __int8 *)(a1 + 1));
    v18 = sub_9910C(*(unsigned __int8 *)(a1 + 2)) + 16 * v17;
    if ( v18 <= 0x97 )
      a2[6] = v18;
    else
      v19 = 143;
    if ( v18 > 0x97 )
      a2[6] = v19;
    result = sub_232978(v18);
    if ( result )
    {
LABEL_23:
      result = sub_98FA0(a2 + 1, &dword_475848);
      if ( result )
        sub_94708("No process or thread specified in stop reply: %s", (const char *)a1);
    }
  }
  else
  {
LABEL_14:
    result = sub_232978(v8);
    if ( result )
      goto LABEL_23;
  }
  return result;
