int __fastcall sub_32CCF0(int a1, int a2, int a3, int *a4, int *a5)
{
  void *v9; // r8
  int v10; // lr
  int v11; // r1
  ...
  {
    if ( sub_327A70((int *)a2, a5, &v22) )
      goto LABEL_16;
    v9 = (void *)(*(_BYTE *)(a3 + 8) & 0x70);
    if ( (*(_BYTE *)(a3 + 8) & 0x70) != 0 )
      goto LABEL_3;
  }
  if ( sub_327A70((int *)a3, a5, &v22) )
    goto LABEL_16;
LABEL_3:
  v9 = (void *)(a4[2] & 0x70);
  if ( (a4[2] & 0x70) != 0 || !sub_327A70(a4, a5, &v22) )
  {
    v10 = *(_DWORD *)a2;
    v11 = a5[1];
    v12 = a5[2];
    ...
    if ( v26 <= 49 )
    {
      v17 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v26) + 5);
      if ( v17 > 0x3C )
        goto LABEL_6;
    }
    else
...
LABEL_6:
        ...
        if ( !v18 )
        {
          ...
          v22 |= 0x10u;
LABEL_12:
          sub_327E0C(a1, v21, (int)a5);
          return a1;
        }
        v19 = (char *)v18;
LABEL_9:
        sub_32B560((int)v19, a2, a3, (int)&v26, &v22);
        v21 = v22;
        if ( (v22 & 0x80) != 0 )
        {
          if ( (v22 & 0x40000000) == 0 )
        ...
        sub_32C3D8(a1, (int)v19, __SPAIR64__((unsigned int)a5, (unsigned int)a4), 0, &v22);
        goto LABEL_16;
      }
    }
    v19 = &v33;
