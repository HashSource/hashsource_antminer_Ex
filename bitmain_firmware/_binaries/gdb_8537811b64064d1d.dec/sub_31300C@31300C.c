void *__fastcall sub_31300C(_DWORD *a1, char *a2)
{
  char *v2; // r6
  int v4; // r7
  int v5; // r10
  ...
  if ( a2 && *a2 )
  {
    ...
    if ( (v7 & 0x300) != 0 )
    {
      v8 = sub_3129C0(a1, (unsigned __int8 **)&s, (const void **)&ptr);
      if ( v8 )
      {
LABEL_5:
        v9 = s;
...
LABEL_34:
    ...
    s = v14;
    v15 = sub_3129C0(a1, (unsigned __int8 **)&s, (const void **)&ptr);
    v2 = s;
    if ( v15 )
    {
LABEL_29:
...
LABEL_122:
            if ( v41 )
            {
              while ( 1 )
              {
                v42 = sub_30D034((unsigned __int8 **)&s);
...
LABEL_103:
              ...
              v36 = strstr(v2, (const char *)&dword_3C43C4);
              v28 = (int)v36;
              if ( !v36 || !v36[2] )
                goto LABEL_41;
LABEL_67:
              v8 = sub_312818(a1, (unsigned __int8 **)&s, &ptr, v28);
              if ( v8 )
                goto LABEL_5;
LABEL_7:
              if ( a1[10] != 2 )
...
LABEL_8:
                if ( a1[11] == 2 )
                {
                  sub_30D3E0((unsigned int)&ptr, "global destructors keyed to ");
                  a1[11] = 0;
                  goto LABEL_10;
                }
                if ( a1[15] != 1 )
                  goto LABEL_10;
LABEL_87:
                sub_30D3E0((unsigned int)&ptr, "import stub for ");
                a1[15] = 0;
LABEL_10:
                sub_30D1AC(a1);
                if ( !v8 )
...
LABEL_32:
              sub_30D3E0((unsigned int)&ptr, "global constructors keyed to ");
              a1[10] = 0;
              sub_30D1AC(a1);
              if ( !v8 )
              {
...
LABEL_33:
            ...
            v8 = 1;
            sub_30D40C((int)&ptr, " virtual table");
            v9 = s;
LABEL_6:
            if ( !*v9 )
              goto LABEL_7;
LABEL_31:
            v8 = sub_311DAC(a1, (unsigned __int8 **)&s, (unsigned int)&ptr);
            if ( a1[10] != 2 )
              goto LABEL_8;
            goto LABEL_32;
          }
...
LABEL_111:
      v8 = 1;
      v37 = strlen(v2);
      sub_30FA80(a1, (const char **)&s, v37, &ptr);
      v9 = s;
      goto LABEL_6;
    }
    v29 = (unsigned __int8)v2[2];
    if ( (word_4388C0[v29] & 4) != 0 )
    {
      v2 += 2;
      if ( (v25 & 0x1C00) != 0 )
      {
        s = v2;
        sub_30D034((unsigned __int8 **)&s);
        v20 = s;
        if ( s )
        {
LABEL_46:
