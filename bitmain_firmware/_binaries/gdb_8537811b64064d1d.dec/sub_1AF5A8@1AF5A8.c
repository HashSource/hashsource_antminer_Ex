void __fastcall sub_1AF5A8(const char *a1, int a2)
{
  unsigned int v3; // r9
  _BYTE *v4; // r3
  int v5; // r2
  ...
  sub_1AF0F8(a2);
  sub_5B084((int *)&v27, (int *)&v26);
  if ( !sub_33CAC8((int)&v27, "") )
    sub_94708("no lo address");
  v3 = sub_14CBC4((int)v27);
  sub_5B084((int *)&ptr, (int *)&v26);
  v4 = v27;
  if ( ptr == v32 )
  {
    sub_33B4B4(&v27, &ptr);
...
LABEL_11:
  ...
  *v4 = 0;
  if ( ptr != v32 )
    sub_339E8C(ptr);
  if ( !sub_33CAC8((int)&v27, "") )
    sub_94708("no hi address");
  v6 = sub_14CBC4((int)v27);
  v7 = 1;
  v33 = 1;
  v34 = 0;
  v35 = 0;
...
LABEL_20:
    v40 = 0;
    *v8 = 0;
    v10 = sub_33CAC8((int)&v27, "");
    if ( v39 != v41 )
      sub_339E8C(v39);
    if ( !v10 )
      break;
    if ( sub_33CAC8((int)&v27, "rw") )
    {
      if ( sub_33CAC8((int)&v27, "ro") )
      {
        if ( sub_33CAC8((int)&v27, "wo") )
        {
          if ( sub_33CAC8((int)&v27, "8") )
          {
            if ( sub_33CAC8((int)&v27, "16") )
            {
              if ( sub_33CAC8((int)&v27, "32") )
              {
                if ( sub_33CAC8((int)&v27, "64") )
                {
                  if ( sub_33CAC8((int)&v27, "cache") )
                  {
                    v25 = sub_33CAC8((int)&v27, "nocache");
                    if ( v25 )
                      sub_94708("unknown attribute: %s", (const char *)v27);
                  }
                  else
                  {
                    v25 = 1;
                ...
                {
                  if ( ((v3 | v6) & 7) != 0 )
                    sub_94708("region bounds not 64 bit aligned");
                  v24 = 4;
                }
              }
              else
              {
                if ( ((v3 | v6) & 3) != 0 )
                  sub_94708("region bounds not 32 bit aligned");
                v24 = 3;
              }
            }
            else
            {
              if ( ((v3 | v6) & 1) != 0 )
                sub_94708("region bounds not 16 bit aligned");
              v24 = 2;
            }
          }
          else
...
LABEL_48:
    ...
    while ( 2 )
    {
      if ( v18 >= 0 && -858993459 * ((dword_487B38 - dword_487B34) >> 3) > (unsigned int)v18 )
      {
        ...
        {
LABEL_69:
          sub_259880("overlapping memory region\n");
          goto LABEL_70;
        }
        if ( v3 <= (unsigned int)v20 )
        {
LABEL_64:
      ...
      {
        v43 = ++dword_487B40;
        sub_1AFFCC(&dword_487B34, v12, v42);
        goto LABEL_70;
      }
      continue;
    }
  }
  sub_259880("invalid memory region: low >= high\n");
LABEL_70:
  if ( v27 != v29 )
    sub_339E8C(v27);
}
