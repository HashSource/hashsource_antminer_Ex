void __fastcall sub_584FC(const char *a1, int a2)
{
  int v4; // r1
  int v5; // r0
  int v6; // r6
  ...
  v5 = sub_544F0(&v19, v4, "", 0, 1);
  if ( *(_DWORD *)(v5 + 8) != 14 )
    sub_94708("Command \"%s\" is built-in.", a1);
  v6 = v5;
  sub_93198(v22, 128, "Type documentation for \"%s\".", a1);
  sub_580A4(&v20, (int)v22, a2, 0, 0, 0);
  v7 = *(void **)(v6 + 28);
  if ( v7 )
    free(v7);
  v8 = v20;
