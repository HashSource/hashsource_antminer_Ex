_DWORD *__fastcall sub_1B0D90(_DWORD *a1, unsigned int a2, int a3, int a4)
{
  _DWORD *v4; // r4
  unsigned int v5; // r6
  unsigned int v6; // r7
...
LABEL_11:
      ...
      while ( 1 )
      {
        if ( *v14 )
        {
          ...
          v18 = *(_DWORD *)(*v14 + 28);
          v19 = *(_DWORD *)(v17 + 144);
          if ( v5 >= v18 + *(_DWORD *)(v19 + 4 * sub_163004(*(_DWORD *)(v17 + 36), *v14)) )
          {
            v20 = v14[1];
            v21 = *(_DWORD *)(v20 + 144);
            v22 = *(_DWORD *)(*v14 + 28) + *(_DWORD *)(*v14 + 36);
            if ( v5 < v22 + *(_DWORD *)(v21 + 4 * sub_163004(*(_DWORD *)(v20 + 36), *v14)) )
            {
              v23 = *v14;
              v24 = v14[1];
              v25 = *(_DWORD *)(v24 + 144);
              v6 = v5 - *(_DWORD *)(v25 + 4 * sub_163004(*(_DWORD *)(v24 + 36), v23));
              if ( *(_DWORD *)(v16 + 8) > v6 )
                goto LABEL_10;
              v26 = v13 - 1;
              v27 = 0;
              ...
              while ( 2 )
              {
                ...
                if ( v41 >= 0 )
                {
                  ...
                  if ( v42 )
                  {
                    v68 = v37;
                    v67 = v40;
                    v43 = ((int (__fastcall *)(int, int))loc_21BE38)(v42, a3);
                    v40 = v67;
                    v37 = v68;
                    if ( !v43 )
                      goto LABEL_51;
...
LABEL_10:
    v4 = (_DWORD *)((int (__fastcall *)(_DWORD, _DWORD *))loc_1B7330)(*(_DWORD *)(a3 + 4), v4);
    if ( v4 )
      goto LABEL_11;
  }
  *a1 = v63;
