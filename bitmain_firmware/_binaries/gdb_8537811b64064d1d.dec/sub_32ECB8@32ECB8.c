int __fastcall sub_32ECB8(int a1, int a2, int *a3, int *a4)
{
  char v4; // r12
  void *v7; // r2
  int v9; // r3
...
LABEL_15:
      sub_329A38(a1, (unsigned __int8 *)v17, (int)&v66);
      *a4 |= 0x820u;
      goto LABEL_5;
    }
  }
  ...
  {
    if ( v18 < 16 )
      v42 = (char *)&dword_438B40[4];
    else
      v42 = (char *)dword_438B40 + v18;
  ...
  {
    if ( v21 < 16 )
      v22 = (char *)&dword_438B40[4];
    else
      v22 = (char *)dword_438B40 + v21;
  ...
  sub_3312D4(&v66, 64);
  sub_329740((int)v20, *(_DWORD *)(a2 + 4) + *(_DWORD *)a2);
  v24[8] = 0;
  *((_DWORD *)v24 + 1) = 0;
  *((_WORD *)v24 + 5) = 0;
  *(_DWORD *)v24 = 1;
  sub_3290E8((int *)v24, (unsigned int)&loc_232278 + 1);
  *((_DWORD *)v24 + 1) = -6;
  sub_32B560((int)v20, (int)v20, (int)v24, (int)&v66, &v59);
  v25 = *(_DWORD *)(a2 + 4);
  v26 = *(_DWORD *)a2;
  v24[8] = *(_BYTE *)(a2 + 8);
  *((_DWORD *)v24 + 1) = v25;
  ...
  v66 = 2;
  v60 = 0;
  sub_328A28((int)v24, &v66, (unsigned __int16 *)(a2 + 10), v26, (int *)&v60, &v59);
  *((_DWORD *)v24 + 1) = 0;
  v27 = sub_327B2C((int)v24);
  v28 = v27;
  if ( v27 <= 9 )
    v28 = 10 * v27;
  v58 = *((unsigned __int16 *)&dword_438B40[16] + v28);
  sub_329740((int)v24, v58 >> 2);
  v24[8] = 0x80;
  v66 = 16;
  *((_DWORD *)v24 + 1) = -3 - (v58 & 3);
  v29 = 9;
  v69 = 3;
  sub_32C3D8((int)v20, (int)v20, __SPAIR64__(&v66, (unsigned int)v24), 0, &v59);
  v30 = a3[1];
  v31 = a3[2];
  LOBYTE(v72) = 0;
  v62 = 0;
  ...
  {
    v20[8] = ~(v20[8] ^ 0x7F);
    sub_32E4D8((int)v24, (int)v20, v73, &v59);
    v20[8] = ~(v20[8] ^ 0x7F);
    sub_32B560((int)v24, (int)v24, a2, (int)v73, &v59);
    HIDWORD(v36) = v73;
    LODWORD(v36) = v61;
    sub_32C3D8((int)v24, (int)v24, v36, 0x80u, &v59);
    v37 = *(_DWORD *)v24;
    v38 = *(_DWORD *)v20;
...
LABEL_48:
  ...
  sub_32AE60((int)v64, a2, (int)v61, (int)&v66, 1u, &v59);
  v39 = v65;
  v40 = v20[8];
  v46 = v65 == 0;
  if ( v65 )
...
LABEL_57:
  ...
  *(_DWORD *)(a1 + 4) = v39;
  v66 = v41;
  sub_328A28(a1, &v66, (unsigned __int16 *)v20 + 5, v18, (int *)&v60, a4);
  sub_3295C0((_DWORD *)a1, a3, (int *)&v60, a4);
LABEL_5:
  free(ptr);
LABEL_6:
  free(v55);
