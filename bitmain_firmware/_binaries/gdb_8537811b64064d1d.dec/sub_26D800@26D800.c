_BYTE *__fastcall sub_26D800(int a1, int a2, unsigned int a3, int a4, __int64 a5, __int64 a6)
{
  int v8; // r0
  __int64 v9; // kr00_8
  char v10; // r10
  ...
  v8 = sub_170068(a1);
  v24 = ((int (__fastcall *)(int))loc_165BE0)(v8);
  ...
  if ( v14 & ~v22 | v15 & ~v23 )
  {
    ...
    a4 = v23 & v15;
    v21 = sub_988D4(a6);
    sub_946D8("Value does not fit in %s bits.", v21);
  }
  v16 = (a6 + v9 + 7) / 8;
  v17 = sub_15C278(v11, v16, v24);
  v25 = v18;
  v19 = sub_170068(a1);
  if ( ((int (__fastcall *)(int))loc_165DA0)(v19) )
    v10 = 8 * v16 - v9 - a6;
  return sub_15C374(
           v11,
           v16,
