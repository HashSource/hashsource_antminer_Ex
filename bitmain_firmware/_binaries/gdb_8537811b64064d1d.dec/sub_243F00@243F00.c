int __fastcall sub_243F00(char *a1, int a2, char *a3)
{
  char *v3; // r3
  int v5; // r2
  int v6; // r3
  ...
  while ( 1 )
  {
    sub_259B80(v32);
    v7 = v38;
    sub_256834(*(_DWORD *)(*v38 + 72));
    sub_256834(*(_DWORD *)(*v7 + 80));
    if ( dword_48A53C )
      ++dword_48A540;
    if ( v36 == v35 )
    {
      if ( dword_48968C > 1 )
      {
        sub_25A710(&unk_3EC8F8);
        sub_25A710(s);
        sub_25A710(&word_356660);
        if ( dword_48A544 )
        {
LABEL_42:
          v8 = *v38;
          if ( !dword_487A50 && sub_242F08(v8) )
          {
      ...
      v8 = *v38;
      if ( dword_48A548 && !dword_487A50 && sub_242F08(v8) )
      {
        v20 = (const char *)sub_243CDC(a1);
        goto LABEL_30;
      }
    }
    else
...
LABEL_13:
    ...
    {
      v12 = v38;
      sub_256878(a1, *(_DWORD *)(*v38 + 72));
      v11 = (_DWORD *)sub_256834(*(_DWORD *)(*v12 + 72));
    }
    v13 = v10 / 32;
    LOBYTE(v14) = v10 & 0x1F;
    if ( v10 <= 0 )
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        while ( &v43[31] != v18 );
        *(v16 - 32) |= v17;
        if ( sub_15474C(v15, (fd_set *)v43, 0, 0, 0) != -1 )
          break;
        v11 = _errno_location();
        if ( *v11 != 4 )
          sub_258B2C("select");
      ...
      v40 = v19;
      v11 = sub_9206C(v41, &v40, 1u);
    }
    if ( v42 )
    {
LABEL_29:
      v39 = 0;
      sub_9206C(v41, &v39, 1u);
      v20 = (const char *)sub_920BC(v41);
      goto LABEL_30;
    }
    v28 = (void *)sub_920BC(v41);
    if ( v28 )
      free(v28);
    v20 = 0;
LABEL_30:
    v21 = sub_1542E8((int *)&unk_48A530, v20, v34, (int)s);
    if ( v21 == -1 )
      break;
    a1 = 0;
    if ( v21 )
