char *__fastcall sub_30DA14(const char *a1)
{
  const char *v1; // r9
  int v2; // r7
  char *v3; // r8
  ...
  v1 = a1;
  LOWORD(v2) = (unsigned __int16)word_4388C0;
  if ( !strncmp(a1, "_ada_", 5u) )
    v1 += 5;
  HIWORD(v2) = (unsigned int)word_4388C0 >> 16;
  v3 = (char *)(*(_WORD *)(v2 + 2 * *(unsigned __int8 *)v1) & 8);
  if ( !v3 )
    goto LABEL_14;
  v4 = v1;
  v5 = strlen(v1);
  v6 = (char *)sub_93050(v5 + 8);
    ...
    while ( 1 )
    {
      ...
      else
      {
        if ( v7 != 79 )
          goto LABEL_14;
        v11 = "Oabs";
        for ( i = 4; strncmp(v4, v11, i); i = strlen((&off_432DC8)[2 * v10]) )
        {
          ++v10;
          v11 = (&off_432DC8)[2 * v10];
          if ( !v11 )
            goto LABEL_14;
        }
        v13 = &off_432978[2 * v10];
        v14 = &v4[i];
        src = v13[277];
        v15 = strlen(src);
        v16 = src;
...
LABEL_55:
    ...
    if ( v7 == 95 && v14[3] != 95 )
    {
      v33 = "_elabb";
      v34 = v30;
      for ( j = 6; strncmp(v4, v33, j); j = strlen(off_432E68[2 * v32]) )
      {
        ++v32;
        v33 = off_432E68[2 * v32];
        if ( !v33 )
          goto LABEL_14;
      }
      v36 = off_432978[2 * v32 + 317];
      v37 = strlen(v36);
      v38 = &v34[v37];
      memcpy(v34, v36, v37);
      *v38 = 0;
