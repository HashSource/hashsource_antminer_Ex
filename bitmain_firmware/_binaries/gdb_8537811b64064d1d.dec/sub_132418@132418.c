int sub_132418()
{
  ...
  dword_4872F0 = sub_1B6B00(0, sub_11D9BC);
  sub_53420(
    "dwarf",
    11,
    (int)sub_11DFF4,
  ...
  dword_48730C = ((int (__fastcall *)(int, void *))loc_22050C)(14, &unk_39D968);
  dword_487304 = ((int (__fastcall *)(int, int (**)()))loc_22050C)(14, off_39D94C);
  dword_487308 = ((int (__fastcall *)(int, int (**)()))loc_2206AC)(10, &off_39D98C);
  result = ((int (__fastcall *)(int, int (**)()))loc_2206AC)(10, &off_39D984);
  dword_487300 = result;
  return result;
}
