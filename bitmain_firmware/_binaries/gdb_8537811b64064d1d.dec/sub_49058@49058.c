unsigned __int64 __fastcall sub_49058(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  int v4; // r6
  ...
  if ( v6 )
  {
    if ( (unsigned __int64)(*(_QWORD *)&dword_46AFD0 + 1LL) > 1 )
      sub_92078(&unk_47268C);
    v4 = (int)&unk_47260C;
    *(_QWORD *)&dword_46AFD0 = 0;
    dword_472698 = 0;
    sub_920A8(&unk_47268C);
    sub_9206C(&unk_47268C, "<osdata type=\"threads\">\n", 24);
    v9 = opendir("/proc");
    if ( v9 )
    {
      v22 = v5;
      while ( 1 )
      {
        ...
        if ( (unsigned int)*(unsigned __int8 *)(v10 + 19) - 48 <= 9 )
        {
          ...
          {
            sub_93198(v25, 17, "/proc/%s", v11);
            if ( !_xstat64(3, v25, v27) && (v28 & 0xF000) == 0x4000 )
            {
              ptr = (char *)sub_93168("/proc/%s/task", v11);
              v12 = strtol(v11, 0, 10);
              sub_46ECC(v26, 0x20u, v12);
              v13 = opendir(ptr);
              if ( v13 )
              {
                while ( 1 )
                {
                  ...
                  {
                    v16 = strtol(v15, 0, 10);
                    sub_98F70(v24, v12, v16, 0);
                    v17 = sub_48A84(v24[0], v24[1], v24[2]);
                    sub_920D8(
                      &unk_47268C,
    ...
    sub_9206C(&unk_47268C, "</osdata>\n", 11);
    dword_472698 = sub_920BC(&unk_47268C);
