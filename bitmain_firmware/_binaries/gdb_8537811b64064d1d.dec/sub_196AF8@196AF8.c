void __fastcall sub_196AF8(int a1, int a2, char *a3, unsigned int **a4, unsigned int **a5)
{
  _DWORD *v7; // r6
  int v8; // r2
  _BYTE *v9; // r0
  ...
  *(_DWORD *)((char *)v72 + 3) = 0;
  ...
  v15 = sub_194460(a2);
  v48 = &v52;
  v49 = (int (__fastcall *)(const char *, int *, _DWORD))sub_194598((int)v15, (int)&v52);
  v16 = sub_171280(v7);
  v17 = *(_DWORD *)(v16 + 24);
  v7 = (_DWORD *)v16;
  ...
  if ( v20 > 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (!strncmp(v24, (const char *)&dword_3C43C4, 2u) || !strncmp(v24, "op", 2u) || !strncmp(v24, "type", 4u))
        && (sub_3102D8(v24, v50, 2) || sub_3102D8(v24, v50, 0)) )
      {
        v24 = (const char *)v50;
      }
      if ( v49(v24, &v52, 0) )
      {
        ...
        v27 = v26 == 128 ? *(__int16 **)(v25 + 28) : &word_3B4A54;
...
LABEL_50:
  ...
  {
    v40 = v7[6];
    v41 = (*(_WORD *)(v40 + 2) & 0x380) == 0x80 ? *(__int16 **)(v40 + 28) : &word_3B4A54;
    if ( *v41 <= i )
      break;
    v42 = *a5;
