int __fastcall sub_10FDEC(int a1)
{
  int v1; // r1
  char v2; // r2
  int v3; // r3
  ...
  *v6 = v12;
  ...
  if ( !v11 )
  {
    ((void (__fastcall *)(int, int, _DWORD *, _DWORD *, _DWORD *))loc_12B110)(a1, 1, v6 + 4, v6 + 2, v6 + 3);
    if ( v6[3] )
    {
      v43 = sub_2AD7D4(*v6, ".got");
      v45 = v43 == 0;
      if ( v43 )
        v44 = *(_DWORD *)(v43 + 28);
      v46 = *v6;
      if ( !v45 )
        v6[5] = v44;
      v47 = sub_2AD7D4(v46, ".text");
      if ( v47 )
        v6[6] = *(_DWORD *)(v47 + 28);
      v48 = (struct obstack *)sub_92E50();
      v49 = (_DWORD *)v6[2];
      v52 = v48;
      v50 = v49;
      while ( v49 < (_DWORD *)((char *)v50 + v6[3]) )
      {
        v51 = sub_10DEB8(v6, v49, 1, &v53, (int *)&nmemb, 3);
        v50 = (_DWORD *)v6[2];
        v49 = (_DWORD *)v51;
      }
      sub_92E68((int)v52);
  ...
  ((void (__fastcall *)(int, _DWORD, _DWORD *, _DWORD *, _DWORD *))loc_12B110)(a1, 0, v6 + 4, v6 + 2, v6 + 3);
  if ( v6[3] )
  {
    v38 = sub_92E50();
    v39 = (_DWORD *)v6[2];
    ...
    {
      v42 = sub_10DEB8(v6, v39, 0, &v53, (int *)&nmemb, 3);
      v41 = (_DWORD *)v6[2];
      v39 = (_DWORD *)v42;
    }
    sub_92E68(v40);
  ...
  *(_DWORD *)(a1 + 56) = v20;
  if ( !v21 )
  {
    v16[1] = 0;
    *v16 = 0;
    return sub_1B6B44(a1, dword_4872C8, v16);
  }
  qsort(base, v21, 4u, (__compar_fn_t)sub_10D930);
  if ( (int)nmemb > 0 )
  {
    v23 = (int)base;
    v24 = *(_DWORD *)base;
