int __fastcall sub_226D9C(int a1, int a2)
{
  _DWORD *v3; // r0
  int v4; // r5
  _DWORD *v5; // r0
  ...
  sub_2594D8(*v3, "-> %s->to_upload_tracepoints (...)\n", (const char *)dword_489C90);
  v4 = off_489EB8(&unk_489C8C, a2);
  v5 = (_DWORD *)sub_242FF0(v4);
  sub_2594D8(*v5, "<- %s->to_upload_tracepoints (", (const char *)dword_489C90);
