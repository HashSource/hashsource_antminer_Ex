int __fastcall ps_pglobal_lookup(_DWORD *a1, int a2, char *a3, _DWORD *a4)
{
  ...
  v6 = sub_183AB0(*a1, a1[1], a1[2]);
  v7 = dword_487D2C;
  ((void (__fastcall *)(_DWORD))loc_1CD2B8)(*(_DWORD *)(v6 + 36));
  sub_1B1444((int)v16, a3);
  if ( v16[0] )
  {
    v8 = *(__int16 *)(v16[0] + 22);
    v9 = *(_DWORD *)(v16[0] + 8);
    if ( v8 == -1 )
    {
      v14 = sub_94728("proc-service.c", 106, "Section index is uninitialized", v9);
      v15 = ((int (__fastcall *)(int, _DWORD))loc_1CD2B8)(v7, HIDWORD(v14));
      sub_339024(v15);
    }
