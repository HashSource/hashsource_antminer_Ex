int __fastcall sub_2BAB5C(int a1, char *a2, int a3, _DWORD *a4)
{
  int v7; // r3
  _DWORD *v8; // r8
  _DWORD *v10; // r4
  ...
  if ( !v10[64] )
  {
    v52 = sub_2ADB70(v10[14], ".iplt", (const char *)((unsigned int)v13 | 0x18));
    if ( !v52 )
      return 0;
  ...
  if ( !v10[65] )
  {
    ...
    if ( v10[108] )
      v37 = ".rel.iplt";
    v38 = sub_2ADB70(v11, v37, (const char *)((unsigned int)v13 | 8));
    if ( !v38 )
      return 0;
  ...
  if ( !v10[63] )
  {
    v51 = sub_2ADB70(v11, ".igot.plt", v13);
    if ( !v51 )
      return 0;
  ...
  v59 = v14;
  v60 = v14[134];
  v57 = v15 ? sub_347440(v14[24], v15) : 0;
  ...
  while ( 2 )
  {
    ...
    if ( v18 >= v57 )
    {
      ...
      sub_2A6A84("%B: bad symbol index: %d", a1, v16 >> 8);
      return 0;
    }
    v39 = v59[26];
    if ( v18 < v39 )
    {
      v28 = sub_2CFE60((int)(v8 + 118), a1, v16 >> 8);
      if ( !v28 )
        return 0;
      v19 = sub_2B5790(a2, v17, 0);
      v20 = v19;
...
LABEL_50:
          ...
          v27 = *((_DWORD *)a2 + 7);
          if ( *(_DWORD *)(v27 + 44) != 4 || !*(_DWORD *)(v27 + 424) && !sub_2E02EC(v8[14], a2) )
            return 0;
          goto LABEL_51;
        case 43:
        case 44:
...
LABEL_75:
                ...
                {
                  v32 = (_DWORD *)sub_2ACC1C(v8[14], 16);
                  if ( !v32 )
                    return 0;
                  v33 = 1;
                  *v32 = *v31;
...
LABEL_113:
            ...
            v35 = sub_2EEE30(v55, v62, 2, a1, v8[108] == 0);
            v61 = v35;
            if ( !v35 )
              return 0;
            if ( v8[106] )
              sub_2ADD00(v62, v35, *(_DWORD *)(v35 + 20) & 0xFFFFFFFC);
            if ( i )
              goto LABEL_74;
LABEL_99:
            if ( (*(_BYTE *)(v28 + 12) & 0xF) == 0xA )
            {
              v46 = (char *)sub_2B358C(a1, v16 >> 8);
              if ( !v46 )
                return 0;
              v31 = (_DWORD **)(v46 + 20);
            }
            ...
            {
              v36 = sub_2CFF1C(a1, *(_DWORD *)(v28 + 16), v20);
              if ( !v36 )
                sub_2A6C18((int)"elf32-arm.c", 3435, (int)"elf32_arm_get_local_dynreloc_list");
...
LABEL_129:
      ...
      case 100:
        if ( i )
        {
          if ( !sub_2EE1DC(a1, v55, i, *a4) )
            return 0;
        }
        else
        {
LABEL_103:
          sub_2A6BE4("elf32-arm.c", 14579);
        }
        goto LABEL_51;
      case 101:
LABEL_54:
        if ( !sub_2EE0DC(a1, v55, i, *a4) )
          return 0;
        goto LABEL_51;
      case 105:
        goto LABEL_56;
