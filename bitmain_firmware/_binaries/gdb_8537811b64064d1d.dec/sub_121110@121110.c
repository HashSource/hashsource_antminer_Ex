int __fastcall sub_121110(int a1, int a2)
{
  int v3; // r5
  char *v4; // r11
  int v5; // r1
  ...
  {
    v84 = ((int (*)(void))loc_11E0B8)();
    return sub_1217C4(v84);
  }
  else
  {
    v4 = (char *)sub_93050(0x34u);
    *(_DWORD *)v4 = a2;
    v91 = (struct obstack *)(v4 + 4);
    obstack_begin((struct obstack *)(v4 + 4), 0, 0, (void *(*)(int))sub_93050, (void (*)(void *))&loc_11C860);
    v5 = *((_DWORD *)v4 + 5);
    v6 = *((_DWORD *)v4 + 4);
    v7 = v5 - v6;
    ...
    *((_DWORD *)v4 + 3) = v12;
    memset(v8, 0, 0x1E4u);
    if ( !*(_BYTE *)(a1 + 16) )
      ((void (__fastcall *)(int, int))loc_11FFF8)(v3, a1);
    v13 = 0;
    v14 = *(_DWORD *)(a1 + 4);
    v15 = *(_BYTE *)(v14 + a2);
    v16 = (char *)(v14 + a2 + 1);
