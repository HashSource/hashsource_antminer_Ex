int __fastcall sub_48A84(int a1, int a2, int a3)
{
  int v3; // r4
  int v4; // r6
  int v5; // r0
  ...
  sub_96818((int)&stream, (int)s, "r");
  if ( !stream )
    return -1;
  v6 = 0;
  do
  {
    v6 = (char *)sub_93078(v6, v3 + 1024);
  ...
  if ( !v9 )
    goto LABEL_13;
  v10 = v9 + 1;
  if ( !v10 || !strtok_r(v10, (const char *)&word_3E1FAC, &save_ptr) )
    goto LABEL_13;
  do
  {
    ++v8;
    v11 = strtok_r(0, (const char *)&word_3E1FAC, &save_ptr);
    v12 = v8 == 36;
    if ( v8 != 36 )
      v12 = v11 == 0;
  }
