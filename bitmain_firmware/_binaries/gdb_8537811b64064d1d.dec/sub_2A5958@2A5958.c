bool __fastcall sub_2A5958(_DWORD *a1, int a2, const char ***a3, int a4, int a5)
{
  int v6; // r12
  int v7; // r9
  int v8; // r6
  ...
  *(_QWORD *)(v8 + 40) = 24;
  sub_2A3330((char *)&v33[8], 0xCu, "%ld");
  sub_2A3330((char *)&v33[14], 6u, "%ld");
  sub_2A3330((char *)&v33[17], 6u, "%ld");
  if ( !sub_2A3398((char *)&v33[24], 0xAu, v9) )
    return 0;
  v33[29] = 2656;
  if ( sub_2A88AC(v33, 60, a1) != 60 )
    return 0;
  (*(void (__fastcall **)(int, char *))(a1[1] + 84))(v7, v30);
  if ( sub_2A88AC(v30, 4, a1) != 4 )
    return 0;
  ...
  if ( a4 )
  {
    ...
    if ( sub_2A88AC(v30, 4, a1) == 4 )
    {
      ...
      while ( 1 )
      {
        ...
        v22 = *v21;
        v23 = strlen(*v21) + 1;
        if ( sub_2A88AC(v22, v23, a1) != v23 )
          break;
        if ( &a3[6 * a4] == v20 )
          return (a5 & 1) == 0 || sub_2A88AC("", 1, a1) == 1;
      }
    }
    return 0;
  }
