int __fastcall sub_1008E4(char *a1)
{
  int v1; // r4
  char **v3; // r0
  int v4; // r4
  ...
  if ( dword_46D420 == -1 )
  {
    dword_46D420 = sub_258A74(0);
    if ( !dword_46D420 )
      dword_46D418 = 0;
  }
  if ( !dword_46D424
    || (v15.sa_handler = (__sighandler_t)sub_FE4E0,
  ...
  if ( !dword_47B1AC )
  {
    sub_93200((char **)&v11, "unable to demangle '%s' (demangler failed with signal %d)", a1, v1);
    v3 = sub_93200((char **)&ptr, "%s:%d: %s: %s", "cp-support.c", 1582, "demangler-warning", (const char *)v11);
    v4 = dword_46DC04;
    v5 = sub_22F070(v3);
    v6 = sub_25A6F0(v5);
    if ( dword_46D420 )
    ...
    v8 = sub_25C444((int)"cp-support.c", 1596);
    dword_47B1AC = 1;
    if ( v4 == 1 )
    {
      sub_22F070(v8);
