int __fastcall sub_5AE5C(int a1, int a2, int a3)
{
  int v4; // r5
  int v5; // r3
  int result; // r0
  ...
  else
  {
    ...
    if ( v8 == (unsigned __int8 *)45 )
      sub_94708("negative value");
    result = sub_5ABA4((unsigned __int8 **)(a1 + 4), 45, a3, v8);
    v9 = *(unsigned __int8 **)(a1 + 4);
    *(_DWORD *)(a1 + 8) = result;
    v7 = *v9;
    if ( v7 == 45 )
    {
      *(_DWORD *)(a1 + 16) = sub_93634(v9 + 1);
      v12 = sub_5ABA4((unsigned __int8 **)(a1 + 16), v4, v11, (unsigned __int8 *)(a1 + 16));
      result = *(_DWORD *)(a1 + 8);
      *(_DWORD *)(a1 + 12) = v12;
      v13 = result == v12;
      if ( result > v12 )
        sub_94708("inverted range");
      if ( result == v12 )
      {
