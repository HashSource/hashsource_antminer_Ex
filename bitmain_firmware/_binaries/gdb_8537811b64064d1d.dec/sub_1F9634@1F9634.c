_DWORD *__fastcall sub_1F9634(_DWORD *a1, int a2, char *a3, int a4, int a5)
{
  char *v5; // r9
  int v7; // r1
  char *v11; // r0
  ...
  *a1 = 0;
  ...
  if ( v7 )
  {
    v32 = *(_DWORD *)sub_242FF0(0);
    v33 = sub_98F14(a4);
    v5 = sub_C25D0(a4);
    v34 = (const char *)((int (__fastcall *)(int))loc_21A5CC)(a5);
    sub_2594D8(v32, "rust_lookup_symbol_non_local (%s, %s (scope %s), %s)\n", a3, v33, v5, v34);
  }
  if ( !a3[sub_100330(a3)] )
  {
    v11 = sub_C25D0(a4);
    ...
    if ( *v11 )
    {
      ...
      *(_DWORD *)v16 = v18;
      ...
      if ( 0x7FFFFFFF - v41 < v22 )
        sub_33D1AC("basic_string::append");
      v23 = (_DWORD *)sub_33C348(&ptr, a3, v22);
      v35 = v36;
      v25 = v23;
      v27 = v23 + 2;
      v26 = (_DWORD *)*v23;
      ...
      *v25 = v27;
      ...
      if ( v37 != v39 )
        sub_339E8C(v37);
      sub_21CFDC(a1, v35, a4, a5);
      v31 = v35;
      if ( !*a1 )
      {
        sub_21D748(a1, v35, a4, a5);
        v31 = v35;
      }
      if ( v31 != v36 )
        sub_339E8C(v31);
