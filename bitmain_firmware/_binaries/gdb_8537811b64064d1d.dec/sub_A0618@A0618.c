bool __fastcall sub_A0618(__int64 a1, int a2, int a3)
{
  int v4; // r2
  int v5; // r1
  int v6; // r6
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)*(unsigned __int8 *)(v6 + v9) - 48 > 9
      || !sub_9D4A4(v6, v9, &v12, &v11)
      || *(_BYTE *)(v6 + v11) != 84
      || (unsigned int)*(unsigned __int8 *)(v6 + v11 + 1) - 48 > 9
      || !sub_9D4A4(v6, v11 + 1, &v13, &v11) )
    {
      return 0;
    }
    if ( a1 >= v12 && v13 >= a1 )
...
LABEL_12:
  ...
  if ( v7 != 83 )
    return v7 == 79;
  v10 = v5 + 1;
  if ( (unsigned int)*(unsigned __int8 *)(v6 + v10) - 48 <= 9 && sub_9D4A4(v6, v10, &v13, &v11) )
  {
    if ( v13 == a1 )
      return 1;
    goto LABEL_12;
