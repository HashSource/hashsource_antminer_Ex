int __fastcall sub_24656C(int (__fastcall *a1)(_DWORD, int), int a2, int a3)
{
  int v5; // r6
  ssize_t v7; // r0
  int v8; // r0
  ...
  while ( 1 )
  {
    ...
    switch ( buf )
    {
      ...
      case 'M':
        ...
        *(_WORD *)v12 = sub_15C278(v12, 2, v9);
        lseek64(dword_46DCEC);
        a2 = *(unsigned __int16 *)v12 + 10 + v5;
        break;
      default:
        sub_94708("Unknown block type '%c' (0x%x) in trace frame", buf, buf);
    }
    if ( dword_48A5A8 <= a2 )
      return -1;
  }
