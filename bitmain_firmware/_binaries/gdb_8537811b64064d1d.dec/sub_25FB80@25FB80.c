        ...
        unsigned int *a10)
{
  ...
  if ( !*a6 )
  {
    ...
    v40 = v39 == 128 ? *(__int16 **)(v38 + 28) : &word_3B4A54;
    v41 = v40[2] - 1;
    if ( v41 >= 0 )
    {
      v42 = 12 * v41;
...
LABEL_19:
    ...
    while ( 1 )
    {
      --v23;
      v24 -= 24;
      sub_25FB80(a1, a2, v31 + a3, a4 + __CFADD__(v31, a3) + v30, *(_DWORD *)(v27 + 12), a6, a7, a8, a9, a10);
      if ( v23 == -1 )
        break;
      v20 = v14[6];
...
LABEL_22:
      v32 = *(_DWORD *)(v20 + 28);
      if ( (__int16 *)v32 == &word_3B4A54 )
        goto LABEL_19;
      v33 = *(_DWORD *)(v32 + 16);
      if ( !v33 || (((int)*(unsigned __int8 *)(v33 + (v23 >> 3)) >> (v23 & 7)) & 1) == 0 )
        goto LABEL_19;
      v50 = sub_26E740(*a1, v23 & 7);
      v34 = __PAIR64__(a4, a3) + sub_26BCA8(*a1);
      v35 = ((int (__fastcall *)(int))loc_26C0C4)(*a1);
      v31 = sub_FC5C4((int)v14, v23, v50, v34, v34, SHIDWORD(v34), v35, *a1);
      v30 = v31 >> 31;
