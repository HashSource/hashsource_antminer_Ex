bool __fastcall sub_2AA0E8(int a1, int a2, _DWORD *a3, int a4)
{
  _DWORD *v4; // r11
  char v7; // r3
  char **v8; // r1
          ...
          && *((unsigned __int8 *)v11 + 27) <= v13 )
        {
          ...
          *(_DWORD *)(a1 + 4) = *v10;
          ...
          if ( v16 )
          {
            ...
            if ( v71 )
              sub_2AAA44(&v78);
            if ( (*(_BYTE *)(a1 + 40) & 7) == 2 && (*(char *)(a1 + 43) >= 0 || sub_2A6938() == 4) )
            {
              if ( off_470AA4 != v68 )
                v68 = *v10;
              if ( ptr )
            ...
            v71 = sub_2ACC1C(a1, 1);
            v85 = *(_DWORD *)(a1 + 172);
            if ( !v71 || !sub_2AAA34(a1 + 72, sub_2AD6E8, 184) )
              goto LABEL_37;
            v12 = v17;
          }
          else if ( sub_2A6938() != 3 )
          {
            goto LABEL_37;
          }
        }
...
LABEL_55:
      ...
      if ( v65 != 1 )
      {
        if ( v65 )
        {
          ...
          *(_DWORD *)(a1 + 4) = v69;
          *(_BYTE *)(a1 + 40) = v52;
          ((void (__fastcall *)(int))loc_2A6C70)(13);
          if ( v4 )
          {
            *v4 = ptr;
            v53 = &ptr[v65];
...
LABEL_54:
  ...
  if ( !(*(int (__fastcall **)(int))(*(_DWORD *)(a1 + 4) + 4 * (*(_BYTE *)(a1 + 40) & 7) + 100))(a1) )
  {
    ...
    {
LABEL_87:
      ((void (__fastcall *)(int))loc_2A6C70)(12);
LABEL_37:
