int __fastcall sub_2A1D18(unsigned int a1, int a2, int a3)
{
  char *v3; // r5
  int v6; // r6
  char *v7; // r0
  ...
  if ( v3 )
  {
    do
    {
      ...
      {
        v37 = off_3FDEAC;
        if ( sub_29C12C((unsigned __int8 *)v3, "reg-names-raw") )
        {
          while ( 1 )
          {
            ++v6;
            ...
            if ( v6 == 8 )
              break;
            if ( !sub_29C12C((unsigned __int8 *)v3, (unsigned __int8 *)*(v37 - 18)) )
              goto LABEL_52;
          }
...
LABEL_237:
    ...
    for ( i = 0; i < v10; ++i )
    {
      if ( sub_29E558(*(_DWORD *)(a2 + 48), i, v115) )
      {
        v10 = *(_DWORD *)(a2 + 56);
        v8[3] = 1;
        goto LABEL_248;
...
LABEL_58:
  ...
  if ( !v12 )
  {
    ...
    *(_DWORD *)(a2 + 104) = 4;
    ...
    if ( v106 )
      LOWORD(v43) = (unsigned __int16)sub_2A0C18;
    v45 = v114;
    if ( v106 )
      HIWORD(v43) = (unsigned int)sub_2A0C18 >> 16;
    else
      v43 = 3096;
    if ( !v106 )
    {
