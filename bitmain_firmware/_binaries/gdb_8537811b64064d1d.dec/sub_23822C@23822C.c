void __fastcall sub_23822C(_DWORD *a1, char *a2, int a3, int a4, int a5)
{
  void *v5; // r7
  int v7; // r0
  _BOOL4 v8; // r0
...
LABEL_16:
  ...
  if ( v9 == (_DWORD *)a1[10] )
  {
    sub_23B68C(a1 + 8, v9, &v18, &a5, &v17, &v16);
  }
  else
  {
    ptr[0] = v20;
    ...
    if ( v9 )
    {
      ...
      v14 = v16;
      *v9 = v9 + 2;
      sub_235120(v9, (_BYTE *)ptr[0], (int)ptr[0] + (unsigned int)ptr[1]);
      v9[6] = v12;
      v9[7] = v13;
      v9[8] = v14;
    }
