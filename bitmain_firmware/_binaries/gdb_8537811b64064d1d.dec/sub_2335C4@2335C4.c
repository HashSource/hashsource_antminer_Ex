_DWORD *__fastcall sub_2335C4(_DWORD *a1, int a2, __int64 a3, __int64 a4)
{
  int v4; // r4
  int v5; // r0
  __int64 v6; // r8
  ...
  *a1 = 0;
  ...
  a1[2] = 0;
  v5 = sub_16F67C(0);
  v42 = ((int (__fastcall *)(int))loc_16EA3C)(v5);
  if ( a4 >= 1 )
  {
    v39 = v4;
    v6 = 0;
...
LABEL_14:
          ...
          if ( v7 < a4 - v6 )
            v37 = v7;
          v15 = v6 + a3;
          ptr = sub_93050(v42 * v37);
          v16 = sub_22FF30(a2, 2u, 0, (int)ptr, v6 + a3, v37);
          if ( v16 >= 1 )
          {
            v51 = v6 + a3;
            v17 = (__int64 *)a1[1];
            ...
            if ( v17 == v18 )
            {
              v18 = (__int64 *)sub_234294(a1, v17, &v51, &v52, &ptr);
            }
            else
            {
              if ( v17 )
...
LABEL_22:
          ...
          v47 = sub_93050(v37);
          if ( sub_22F878((unsigned int)a2 | 0x200000000LL, 0, (int)v47, 0, v35, v49, HIDWORD(v49), 1u, &v52) == 1 )
          {
            ++v15;
            v44 = 1;
            v40 = v51;
...
LABEL_29:
              ...
              if ( v40 - v23 == sub_22FF30(a2, 2u, 0, (int)v47 + v42 * (v23 - v49), v23, v40 - v23) )
              {
                v51 = v45;
                v40 = v45;
              }
