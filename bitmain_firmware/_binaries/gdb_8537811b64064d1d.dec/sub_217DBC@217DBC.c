int __fastcall sub_217DBC(int a1)
{
  int result; // r0
  _DWORD *i; // r4
  int v4; // r0
  ...
  if ( dword_487D28 )
  {
    do
    {
      for ( i = (_DWORD *)v18[9]; i; i = (_DWORD *)*i )
      {
        ...
        sub_259F38("\nObject file %s:  ", v5);
        v6 = sub_259F38("Objfile at ");
        v7 = (_DWORD *)sub_242FB4(v6);
        sub_25A474(i, *v7);
        v8 = sub_259F38(", bfd at ");
        v9 = i[9];
        v10 = (_DWORD *)sub_242FB4(v8);
        sub_25A474(v9, *v10);
        result = sub_259F38(", %d minsyms\n\n", *(_DWORD *)(i[10] + 84));
        v11 = i[33];
        if ( v11 )
        ...
        if ( i[5] )
        {
          ...
          for ( j = (_DWORD *)i[5]; j; j = (_DWORD *)*j )
          {
            ...
            {
              v14 = (const char *)((int (__fastcall *)(_DWORD *))loc_2043FC)(k);
              v15 = sub_259F38("%s at ", v14);
              v16 = (_DWORD *)sub_242FB4(v15);
              sub_25A474(k, *v16);
              sub_259F38(", ");
              if ( *(_DWORD **)(k[1] + 4) != i )
                sub_259F38("NOT ON CHAIN!  ");
              sub_259B80("  ");
            }
          }
          result = sub_259F38("\n\n");
