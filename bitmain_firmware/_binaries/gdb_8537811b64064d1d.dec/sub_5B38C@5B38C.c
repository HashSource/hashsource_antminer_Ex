void __fastcall sub_5B38C(int a1, int a2, int a3)
{
  int v5; // r5
  int v6; // r0
  int v7; // r1
  ...
  while ( 1 )
  {
    v6 = sub_60314("-break-insert", a3, a2, &off_358D48, &v55, &nptr);
    if ( v6 < 0 )
      break;
    switch ( v6 )
    {
  ...
  if ( a3 <= v55 )
  {
    if ( !v5 )
    {
      ...
      if ( a1 )
        v41 = "dprintf";
      sub_94708("-%s-insert: Missing <location>", v41);
    }
    if ( a1 )
    {
      v9 = v44;
            ...
            while ( strlen(*v12) > v11 )
            {
              ...
              switch ( (*v12)[v11] )
              {
                ...
                default:
                  ...
                  {
                    sub_93198(v58, 5, "\\%o", v14);
                    v15 = strlen(v58);
                    if ( 0x7FFFFFFF - v68 < v15 )
                      sub_33D1AC("basic_string::append");
                    sub_33C348(&ptr, v58, v15);
                  }
                  break;
              }
              ++v11;
...
LABEL_131:
          sub_94708("-dprintf-insert: Missing <format>", v7, v9, v8);
        }
      }
LABEL_15:
      sub_94708("-dprintf-insert: does not support -h or -a");
    }
    if ( v5 )
      sub_94708("-break-insert: Garbage following explicit location");
    if ( v55 < a3 - 1 )
      sub_94708("-break-insert: Garbage following <location>");
    v53 = *(const char **)(a2 + 4 * v55);
  }
LABEL_66:
  if ( !dword_47482C )
  {
    sub_1B9BB0(sub_5B2F4);
    dword_47482C = 1;
  }
  v18 = dword_474828;
  dword_474828 = 1;
...
LABEL_73:
    if ( v59 && !v60 && !v61 && v63 == 3 )
    {
      ...
      if ( a1 )
        v40 = "dprintf";
      sub_94708("-%s-insert: --source option requires --function, --label, or --line", v40);
    }
    v21 = sub_19D0E0(v58, &v59);
    v22 = *(_DWORD *)v58;
    *(_DWORD *)v58 = 0;
    v23 = v54 == 0;
    v54 = v22;
    if ( !v23 )
    {
      v21 = ((int (__fastcall *)(int *))loc_19D17C)(&v54);
      if ( *(_DWORD *)v58 )
        v21 = ((int (__fastcall *)(char *))loc_19D17C)(v58);
    }
    goto LABEL_78;
  }
LABEL_88:
  v21 = sub_19D9C4(&v57, &v53, off_46D5A4[0], v5, v42);
  v25 = v57;
  v57 = 0;
  v23 = v54 == 0;
  v54 = v25;
  if ( !v23 )
  {
    v21 = ((int (__fastcall *)(int *))loc_19D17C)(&v54);
    if ( v57 )
      v21 = ((int (__fastcall *)(int *))loc_19D17C)(&v57);
  }
  if ( *v53 )
    sub_94708("Garbage '%s' at end of location", v53);
LABEL_78:
  v24 = sub_B8974(v21);
  sub_DA378(v24, v54, v48, v46, v64, 0, v45, v20, v47, v49 ^ 1, v19, 0, v50, 0, 0);
  dword_474828 = v18;
  if ( v64 != v66 )
    sub_339E8C(v64);
  if ( v54 )
    ((void (__fastcall *)(int *))loc_19D17C)(&v54);
}
