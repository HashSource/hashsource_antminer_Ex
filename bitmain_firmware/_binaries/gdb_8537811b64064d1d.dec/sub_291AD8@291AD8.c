int __fastcall sub_291AD8(const char *a1)
{
  int v1; // r1
  bool v2; // zf
  const char *v3; // r8
  ...
  v1 = dword_48AAD0;
  v2 = dword_48AAD0 == (_DWORD)sub_291A8C;
  if ( (int (__fastcall *)(int, int))dword_48AAD0 != sub_291A8C )
    v2 = dword_48AAD0 == (_DWORD)sub_291AD8;
  if ( !v2 )
    goto LABEL_13;
  if ( !dword_48B6C8 )
    goto LABEL_13;
