int __fastcall sub_270858(int a1, int a2, int a3)
{
  int v3; // r6
  int v4; // r7
  _DWORD *v5; // r8
    ...
    if ( a2 )
    {
      ...
      if ( a2 )
      {
        ...
        if ( v15 )
        {
          ...
          {
            v29 = sub_92E50();
            ((void (__fastcall *)(int))loc_26E034)(v3);
            sub_92E68((int)v29);
          }
        }
LABEL_14:
        ...
        v39 = 0;
        LOBYTE(v40[0]) = 0;
        if ( sub_26BF74(v3) || *(_DWORD *)(*(_DWORD *)(a1 + 152) + 8) )
          goto LABEL_16;
        sub_2706D8(&v41, v3, *(_DWORD *)(a1 + 108));
        v30 = s2;
        if ( v41 == v43 )
        {
          sub_33B4B4(&s2, &v41);
...
LABEL_24:
  ...
  *(_BYTE *)(a1 + 112) = 0;
  if ( !*(_DWORD *)(v17 + 8) )
    goto LABEL_34;
  sub_2706D8(&ptr, *(_DWORD *)(a1 + 80), *(_DWORD *)(a1 + 108));
  v18 = s2;
  if ( ptr == v46 )
  {
    sub_33B4B4(&s2, &ptr);
...
LABEL_34:
  sub_33B4B4(a1 + 116, &s2);
  v21 = *(_DWORD *)(a1 + 80);
  if ( v21 && !sub_26BC98(v21) )
  {
    sub_94728(
      (int)"varobj.c",
      1418,
