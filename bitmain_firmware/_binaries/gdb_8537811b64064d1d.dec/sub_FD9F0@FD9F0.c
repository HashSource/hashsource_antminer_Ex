_DWORD *__fastcall sub_FD9F0(_DWORD *a1, char *a2, char *a3, _DWORD *a4, int a5, int a6, int a7, int a8)
{
  int v8; // r4
  _DWORD *v13; // r6
  int v14; // r10
...
LABEL_26:
  ...
  if ( v19 )
  {
    ...
    if ( !strcmp(a3, v20) )
    {
      sub_FD768(&v28, (char *)*v13, v27, a4, a5);
      v14 = v28;
      v8 = v29;
    }
  }
...
LABEL_36:
  ...
  if ( v25 )
  {
    if ( !strcmp(a3, v25) )
    {
      sub_FD768(&v28, a2, (char *)*v13, a4, a5);
      goto LABEL_39;
    }
LABEL_25:
    v13[5] = 0;
  ...
  sub_FD9F0(&v28, *v13, a3, a4, a5, 1, 0, 0);
LABEL_39:
  v8 = v29;
  if ( !v28 )
    goto LABEL_25;
