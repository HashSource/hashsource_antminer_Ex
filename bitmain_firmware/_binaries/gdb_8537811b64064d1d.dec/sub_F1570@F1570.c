int __fastcall sub_F1570(int a1, int a2)
{
  int v2; // r5
  int v3; // r6
  int v4; // r7
  ...
  v36 = 0;
  v37[1] = &v36;
  sub_2ADD24(v9, sub_F1348, v37);
  if ( v36 )
    return sub_163004(*(_DWORD *)(a2 + 36), v36);
  result = *(_DWORD *)(a2 + 152);
  if ( result == -1 )
  {
    v11 = sub_94728((int)"coffread.c", 308, "sect_index_text not initialized");
    v34 = a2;
    v35 = v12;
    dword_478964 = dword_4789C8;
    if ( v11 != -1 )
    {
      sub_E747C(dword_4789CC, v11);
      return sub_E6560(0);
    }
    v13 = sub_94728((int)"coffread.c", 425, "sect_index_text not initialized", &dword_4789AC, v34, v35);
    v32[3] = a2;
    v32[4] = v2;
    v32[5] = v3;
    v32[6] = v4;
    ...
    *(_DWORD *)(v13 + 4) = dword_478988;
    if ( dword_4789E0 == sub_2A8800(dword_4789E4, HIDWORD(v13), dword_4789DC) )
    {
      ...
      *(_DWORD *)(v15 + 8) = v18;
      if ( !v18 )
        goto LABEL_9;
      if ( dword_4789EC == sub_2A8800(dword_4789F0, dword_4789EC, dword_4789DC) )
      {
          ...
          *(_DWORD *)(v15 + 24) = v25;
          ...
          if ( dword_4789FC )
          {
            ...
            if ( v24 )
            {
              ...
              v32[0] = v24;
              v31 = 0;
              sub_2ADD24(dword_4789E8, sub_F1348, v32);
              v26 = v31;
              if ( v31 )
                v26 = *(_DWORD *)(v31 + 28);
              *(_DWORD *)(v15 + 12) += v26;
...
LABEL_19:
        ...
        while ( 1 )
        {
          v29 = sub_2A8800(dword_4789F0, v27, dword_4789DC);
          v27 = dword_4789EC;
          if ( dword_4789EC != v29 )
            break;
          v18 = *(_DWORD *)(v15 + 8);
    ...
    v30 = (const char *)sub_1B87D0(dword_4789C0);
    sub_94708("%s: error reading symbols", v30);
  }
  return result;
}
