int __fastcall sub_85414(int a1)
{
    ...
    switch ( *v1 )
    {
      ...
      case 0x60u:
        ...
        if ( dword_4750F4 )
          ...
          dword_4750F4 = 1;
        obstack_begin(&stru_4750F8, 0, 0, (void *(*)(int))sub_93050, sub_84DE8);
        v15 = 0;
        v16 = v62 + 1;
        v17 = *v62++;
        v61 = (int)&v62;
LABEL_19:
        ...
        do
        {
          ...
          {
            v62 = v16 + 1;
            v53 = sub_759D0((char **)v61, &stru_4750F8);
            v16 = v62;
            v15 += v53;
            goto LABEL_19;
          }
...
LABEL_32:
        ...
        while ( 2 )
        {
          if ( v20 || (v11 & 0xDF) != 0x45 )
          {
            ...
            {
              result = sub_84DF4(v59, v1, v21 - (_DWORD)v1, v24 | v22, (int)&dword_4750D8);
              if ( result == 282 )
              {
                v26 = (const char *)memcpy(&v58, v1, v21 - (_DWORD)v1);
                *((_BYTE *)&v58 + v21 - (_DWORD)v1) = 0;
                sub_94708("Invalid number \"%s\".", v26);
              }
              dword_487CC0 = v21;
              return result;
            }
