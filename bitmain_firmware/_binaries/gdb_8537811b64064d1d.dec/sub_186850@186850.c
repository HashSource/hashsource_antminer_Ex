int __fastcall sub_186850(int a1, int a2)
{
  char **v3; // r10
  char *v4; // r8
  const char *v5; // r0
  ...
  v62 = a2;
  if ( !a1 )
    sub_51EC4("signal to handle");
  memset(v60, 0, sizeof(v60));
  v68 = 0;
  sub_25B104(&v68, a1);
  v3 = v68;
  v66 = &v3[sub_31E128(v68)];
  if ( v66 == v3 )
    goto LABEL_21;
  v67 = v3;
...
LABEL_47:
                v25 = sub_99AB0(v4);
                if ( v25 == 143 )
                  sub_94708("Unrecognized or ambiguous flag word: \"%s\".", v4);
                v13 = v25;
                v15 = v25;
                goto LABEL_49;
              }
...
LABEL_13:
      if ( v14 || v60[v13] )
        goto LABEL_15;
      v22 = sub_99A74(v13);
      if ( !sub_25A40C(v64, v22) )
      {
        v23 = sub_259880(v63);
        v24 = (_DWORD *)sub_242FB4(v23);
        sub_256834(*v24);
        goto LABEL_15;
      }
LABEL_19:
...
LABEL_21:
  ...
  while ( 1 )
  {
    ...
    if ( v19 )
      break;
    if ( ++v17 == 152 )
      return sub_31DAF8(v68);
  }
  sub_1867D0();
  sub_230AA0(152, dword_487988);
  sub_230AC8(152, dword_487948);
  if ( v62 )
  {
