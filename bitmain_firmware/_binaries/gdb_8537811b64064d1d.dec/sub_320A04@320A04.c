unsigned __int8 *__fastcall sub_320A04(int a1, unsigned __int8 *a2)
{
  ...
  if ( ptr == v14 )
    ...
    v6 = v14 - (_BYTE *)ptr;
  v7 = sub_320844((int)&v16, (unsigned __int8 *)v5);
  if ( v16 != v17 )
  {
    v8 = v17 - (_BYTE *)v16;
    LODWORD(v9) = sub_320108((int)&v19, v7);
    HIDWORD(v9) = v19;
...
LABEL_13:
      sub_31E880(a1, "(");
      if ( v8 )
        sub_31EC3C(__SPAIR64__((unsigned int)v16, a1), v8);
      goto LABEL_15;
    }
LABEL_28:
    LODWORD(v9) = a1;
...
LABEL_15:
  ...
  if ( v6 )
  {
    sub_31EC3C(__SPAIR64__((unsigned int)ptr, a1), v6);
    v11 = ptr;
  }
  if ( v11 )
  {
