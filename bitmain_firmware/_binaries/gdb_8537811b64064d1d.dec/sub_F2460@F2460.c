_DWORD *__fastcall sub_F2460(char **a1, _DWORD *a2, _DWORD *a3)
{
  int v6; // r0
  _DWORD *v7; // r4
  char *v8; // r9
  ...
  if ( **a1 == *(_BYTE *)(*(_DWORD *)(a3[9] + 4) + 24) )
    ++v8;
  ((void (__fastcall *)(int, _DWORD, _DWORD *))loc_21AEEC)(v6, *(_DWORD *)(dword_4788E0 + 20), a3 + 12);
  v9 = strlen(v8);
  sub_21AF70((int)v7, v8, v9, 1, (int)a3);
  v10 = *((_BYTE *)v7 + 32);
  v11 = (unsigned __int8 *)a1[3];
  v7[3] = 0;
  *((_BYTE *)v7 + 32) = v10 & 0xF8 | 1;
  v7[2] = v11;
  v12 = sub_F1570((int)a1, (int)a3);
  ...
  *((_WORD *)v7 + 11) = v12;
  if ( (v14 & v13) != 2 << v15 )
  {
    v28 = sub_F1C70((const char **)a1, v13, (int)a2, (int)a3);
    v30 = (int)a1[4];
    v7[6] = v28;
    if ( v30 != 12 )
    {
        ...
        if ( v30 != 3 )
        {
          if ( v30 > 3 )
          {
            if ( v30 == 9 )
            {
              ...
              *((_BYTE *)v7 + 33) = v44;
              sub_E5AD0(v7, (_DWORD **)&dword_4788E8);
              return v7;
            }
            if ( v30 != 10 )
            {
...
LABEL_45:
          ...
          *((_BYTE *)v7 + 32) = v7[8] & 7 | 0x10;
          ...
          if ( v38 != -1 )
          {
            ...
            sub_E5AD0(v7, (_DWORD **)&dword_4788F4);
            return v7;
          }
LABEL_61:
          v50 = sub_94728((int)"coffread.c", 1681, "sect_index_text not initialized");
          v65 = v53;
...
LABEL_63:
              ...
              sub_1B25DC(v57, (char *)v54, v58, 1, v56, v55, v66);
              goto LABEL_64;
            }
        ...
        *((_BYTE *)v7 + 32) = 65;
        ...
        if ( v33 == 1 )
        {
          ...
          if ( !*(_DWORD *)(v34 + 20) )
          {
            if ( **(_BYTE **)(v34 + 24) )
            {
              v35 = &dword_4789AC[sub_E6484((char *)*v7)];
              v7[2] = v35[25];
              v35[25] = (int)v7;
            }
          }
...
LABEL_11:
        sub_E5AD0(v7, (_DWORD **)&dword_4788F0);
        return v7;
      }
    }
LABEL_47:
    ...
    if ( !*(_DWORD *)(v40 + 12) )
    {
      ...
      if ( *v7 )
      {
        ...
        if ( v42 != 126 )
          v43 = v42 == 46;
        if ( !v43 )
          *(_DWORD *)(v40 + 12) = sub_31E2A4(v41, 0, v29);
      }
    }
    goto LABEL_11;
  }
  ...
  if ( v16 == -1 )
  {
    sub_94728((int)"coffread.c", 1649, "sect_index_text not initialized");
LABEL_60:
    sub_94728((int)"coffread.c", 1691, "sect_index_text not initialized");
    goto LABEL_61;
  }
  v17 = dword_4789F4;
  ...
  *((_QWORD *)v7 + 1) += *(unsigned int *)(a3[36] + 4 * v16);
  ...
  if ( !*a2 )
    a1[2] = 0;
  v20 = sub_F1C70((const char **)a1, v19, (int)a2, (int)a3);
  v21 = sub_170380(v20);
