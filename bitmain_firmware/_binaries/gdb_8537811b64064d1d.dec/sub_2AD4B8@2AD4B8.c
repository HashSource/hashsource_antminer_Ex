int __fastcall sub_2AD4B8(int a1, int a2, int a3)
{
  int v3; // r11
  FILE *v4; // r6
  size_t v9; // r0
    ...
    if ( v4 )
    {
      while ( 1 )
      {
        ...
        if ( (_UNKNOWN *)((char *)&unk_48BBFC + v10) > &unk_48BBFC )
        {
          ...
          {
            v14 = *v13++;
            v12 = dword_411D50[(unsigned __int8)(v14 ^ v12)] ^ (v12 >> 8);
          }
          while ( v11 != v13 );
        }
        v3 = ~v12;
      ...
      fclose(v4);
      v15 = (const char *)sub_3245CC(a3);
      v16 = strlen(v15);
      v17 = (v16 + 4) & 0xFFFFFFFC;
      v18 = (char *)sub_2AB390(v17 + 4);
      v19 = v18;
      if ( v18 )
      {
        memcpy(v18, v15, v16);
        ...
        v4 = (FILE *)sub_2ADE10(a1, a2, v19, 0, 0, 0, v17 + 4);
        if ( v4 )
          return 1;
        else
          free(v19);
