void __fastcall sub_21F0BC(int a1, int a2, int a3, int a4, char *a5, char *a6)
{
  _BYTE *v7; // r12
  int v10; // r3
  char **v11; // r0
  ...
  *(_DWORD *)(a1 + 36) = v10;
  v11 = sub_194460(a2);
  v12 = (int (__fastcall *)(int, int, int))sub_194598((int)v11, a4);
  if ( v12(a3, a4, a1) )
  {
    if ( !*(_DWORD *)a1 )
    {
    ...
    sub_F5774((int *)&v15, *(const char **)a1, a5, a6);
    v13 = v15;
    v15 = 0;
    ptr = v13;
    sub_F6CB8((_DWORD *)a1, &ptr, a1 + 28, a5, a6);
    if ( ptr )
      free(ptr);
    if ( v15 )
      free(v15);
