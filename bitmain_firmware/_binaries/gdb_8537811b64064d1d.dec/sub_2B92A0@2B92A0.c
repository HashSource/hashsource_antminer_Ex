int __fastcall sub_2B92A0(int a1, int a2)
{
  int v2; // r3
  _DWORD *v3; // r6
  char v7; // r3
  ...
  if ( v2 != 6 )
  {
    ...
    if ( *(_BYTE *)(a1 + 48) == 10 )
    {
      if ( sub_2E2F10(a1, a2, 1) )
      {
        v46 = *(_DWORD *)(a1 + 84);
        *(_BYTE *)(a1 + 93) |= 1u;
        if ( !v46 )
        {
          if ( sub_2E2F10(a1, a2, 0) )
            *(_DWORD *)(a1 + 36) = 0;
        }
      }
    }
...
LABEL_6:
    ...
    sub_2B696C(a2, *(_BYTE *)(a1 + 93) & 1, (_DWORD *)(a1 + 40), (_DWORD *)(a1 + 76));
    if ( (*(_BYTE *)a2 & 1) == 0 )
    {
      v22 = v3[105];
      if ( (*(_BYTE *)(a1 + 51) & 2) != 0 )
      ...
      if ( v19 )
      {
        sub_2B68E4(v26, v25, 1);
        v25 = v3[113];
        v26 = *(_DWORD *)(a2 + 28);
      }
      sub_2B68E4(v26, v25, 2);
    }
LABEL_7:
    v8 = *(_DWORD *)(a1 + 36);
    *(_DWORD *)(a1 + 96) = -1;
    ...
    if ( *(_DWORD *)(a1 + 32) == -1 && (*(_BYTE *)(a1 + 52) & 8) == 0 && *(_BYTE *)(a1 + 12) == 2 && !sub_2E0880(a2, a1) )
      return 0;
    v10 = v3[106];
    if ( v10 )
      goto LABEL_29;
    ...
    *(_DWORD *)(a1 + 36) = v12;
    if ( !v9 )
      sub_2A6C18((int)"elf32-arm.c", 15373, (int)"allocate_dynrelocs_for_symbol");
    v13 = v3[12];
    if ( v9 == 1 )
    {
      *(_DWORD *)(v11 + 36) = v12 + 4;
...
LABEL_19:
    ...
    if ( (*(_BYTE *)a2 & 1) != 0 )
    {
      if ( (*(_DWORD *)(a1 + 32) != -1 || (*(_BYTE *)(a1 + 52) & 8) != 0) && !sub_2E2F10(a1, a2, 0) )
      {
        v45 = *(_DWORD *)(a1 + 32);
LABEL_103:
        v10 = v45;
...
LABEL_20:
        if ( v18 | *(_BYTE *)a2 & 1 )
        {
          ...
          {
            if ( (v9 & 4) != 0 )
              sub_2B68E4(*(_DWORD *)(a2 + 28), v3[56], 1);
            v19 = (v9 & 2) == 0;
            v20 = v9 & 8;
            if ( v19 )
            {
              if ( v20 )
              {
                sub_2B68E4(*(_DWORD *)(a2 + 28), v3[58], 1);
                v3[116] = -1;
              }
            }
            else
...
LABEL_119:
          ...
          {
            sub_2B62A4(*(_DWORD **)(a2 + 28), v3[56], 1);
            goto LABEL_29;
          }
...
LABEL_29:
          ...
          && (*(_BYTE *)(a1 + 49) & 3) == 0 )
        {
          ...
          sub_2FD6EC(a2, *(_DWORD *)(v39 + 148), (int)s, 2, v39, *(_DWORD *)(a1 + 24), 0, 1, 0, (int)&v47);
          v40 = v47;
          v41 = v47[50];
          v42 = v47[52];
          v47[48] = 2;
          ...
          v40[52] = v42 | 8;
          *(_DWORD *)(a1 + 100) = v40;
          v43 = *(_QWORD *)(sub_2B90E4(a2, *(const char **)(a1 + 4)) + 20);
          HIDWORD(v43) &= ~1u;
...
LABEL_87:
            ...
            if ( *(_BYTE *)(a1 + 48) == 10 && !*(_DWORD *)(a1 + 84) && sub_2E2F10(a1, a2, 0) )
              sub_2B62A4(*(_DWORD **)(a2 + 28), v37, v21[2]);
            else
              sub_2B68E4(*(_DWORD *)(a2 + 28), v37, v21[2]);
            v21 = (_DWORD *)*v21;
          }
          while ( v21 );
          return 1;
