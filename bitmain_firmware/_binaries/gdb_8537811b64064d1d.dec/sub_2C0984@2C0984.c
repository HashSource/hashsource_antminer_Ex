int __fastcall sub_2C0984(int result, int a2)
{
  int v2; // r12
  int v3; // lr
  _DWORD *v4; // r4
  ...
  if ( v3 == 4 )
  {
    ...
    switch ( *(_DWORD *)(result + 36) )
    {
      ...
      case 0x14:
        ...
        break;
      default:
        sub_2A6C18((int)"elf32-arm.c", 4616, (int)"arm_stub_required_alignment");
    }
...
LABEL_18:
      ...
      if ( v7 )
      {
        ...
        do
        {
          ...
          {
            v35 = v30;
            LODWORD(v29) = sub_2B56B8(v29);
            v30 = v35;
          }
          else
          {
            LODWORD(v29) = &dword_415334[13 * v29];
          }
          ++v24;
          sub_2BCB30(
            (char *)v29,
