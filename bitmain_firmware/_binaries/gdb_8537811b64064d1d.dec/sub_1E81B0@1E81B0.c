bool __fastcall sub_1E81B0(int a1, int a2, int a3, int a4)
{
  int v5; // r0
  int v6; // r5
  int v7; // r1
  ...
  v9[1] = v16;
  v17 = v9 + 2;
  if ( sub_98FA0(&v21, dword_488C70) || sub_98FA0(&v21, dword_488CF4) )
  {
    sub_93198(v17, v15 - (_DWORD)v17, "0");
  }
  else if ( sub_98FA0(&v21, &qword_46BBCC) )
  {
    sub_93198(v17, v15 - (_DWORD)v17, "-1");
  }
  else
  {
    sub_1E2A14((int)v17, v15, v21, v22, v23);
  }
  sub_1E7E14(*(const char **)v6);
  sub_1E4EE0((char **)v6, (size_t *)(v6 + 4), 0, 0, 0);
  result = v21;
  v18 = v22;
  v19 = v23;
  if ( a4 )
