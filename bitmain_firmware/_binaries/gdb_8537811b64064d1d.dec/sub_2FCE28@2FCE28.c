int __fastcall sub_2FCE28(_DWORD *a1, int a2, int a3, int a4, _DWORD *a5)
{
  int *v6; // r5
  int *v7; // r6
  unsigned int v8; // r2
  ...
  *a5 = 0;
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      {
        v11 = sub_2FC948(*(_DWORD **)(a2 + 28), *(const char **)(v9 + 4), 0, 0, 1);
        v12 = v11;
        if ( v11 )
        {
