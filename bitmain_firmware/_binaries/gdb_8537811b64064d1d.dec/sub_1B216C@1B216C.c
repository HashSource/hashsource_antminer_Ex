_DWORD *__fastcall sub_1B216C(int a1, char *s2, _DWORD *a3, int a4)
{
  unsigned int v4; // r6
  char *v5; // lr
  unsigned int v6; // r12
...
LABEL_8:
  ...
  {
LABEL_22:
    v21 = sub_94728((int)"minsyms.c", 589, "Section index is uninitialized", v18, a4);
    v34 = v22;
