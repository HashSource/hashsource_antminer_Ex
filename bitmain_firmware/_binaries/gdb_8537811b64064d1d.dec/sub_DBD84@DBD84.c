void __fastcall sub_DBD84(const char *a1, int a2)
{
  int v4; // r7
  unsigned int *v5; // r5
  unsigned int *v6; // r8
  ...
  if ( a1 )
  {
    ...
    v56 = 0;
    if ( v5 == v6 )
      sub_94708("No breakpoint at %s.", a1);
    v7 = v5[1];
    v52 = v5;
  }
  else
  {
    ...
    v7 = s[1];
    if ( !s[1] )
      sub_94708("No source file specified.");
    ptr = 0;
    v5 = s;
    v55 = 0;
    v6 = (unsigned int *)&v58;
...
LABEL_12:
  ...
  if ( ptr == v55 )
  {
    if ( a1 )
      sub_94708("No breakpoint at %s.", a1);
    sub_94708("No breakpoint at this line.");
  }
  v25 = (char *)v55 - (_BYTE *)ptr;
  sub_CB370((int)ptr, v55, 2 * (31 - __clz(((char *)v55 - (_BYTE *)ptr) >> 2)), 0);
  if ( v25 <= 64 )
  {
    sub_CB5C8(v23, v24);
  }
...
LABEL_69:
    if ( (char *)v46 - (char *)v37 == 4 )
      sub_259880("Deleted breakpoint ");
    else
      sub_259880("Deleted breakpoints ");
    v37 = (unsigned int *)ptr;
    v46 = v55;
    if ( v55 == ptr )
    {
...
LABEL_72:
      ...
      v43 = v44;
      if ( a2 )
        sub_259880("%d ", *(_DWORD *)(v43 + 24));
      ((void (__fastcall *)(int))loc_DB0D8)(v43);
    }
    while ( v46 != v37 );
    if ( !a2 )
      goto LABEL_76;
