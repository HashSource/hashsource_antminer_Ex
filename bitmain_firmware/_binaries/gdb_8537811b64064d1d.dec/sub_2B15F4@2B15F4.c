int __fastcall sub_2B15F4(int a1, int a2, unsigned int a3, unsigned __int8 *a4)
{
  ...
  v19[4] = v16;
  if ( sub_2A88AC((int)v19, 6, a1) != 6 )
    sub_2A6C18((int)"tekhex.c", 792, (int)"out");
  v17 = (int)(v4 + 1);
  *a4 = 10;
  result = sub_2A88AC(a3, v17, a1);
  if ( result != v17 )
    sub_2A6C18((int)"tekhex.c", 796, (int)"out");
  return result;
}
