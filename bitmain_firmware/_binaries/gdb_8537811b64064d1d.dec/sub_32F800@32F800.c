int __fastcall sub_32F800(int a1, int a2, int a3, int *a4)
{
  char *v4; // r6
  int v6; // r10
  int v8; // r11
  ...
  if ( ((v6 | v8) & 0x70) != 0 )
  {
    ...
    if ( (v8 & 0x40) != 0 )
    {
      if ( (v6 & 0x80u) == 0 || !*(_WORD *)(a2 + 10) && *(_DWORD *)a2 == 1 && (v6 & 0x70) == 0 )
      {
        ...
        v59[0] = 1;
        v61 = 1;
        sub_32B330((int)v69, a2, (int)v59, (int)a4);
        v18 = v69[8];
        *(_BYTE *)(a1 + 8) = 0;
        *(_DWORD *)(a1 + 4) = 0;
        *(_DWORD *)a1 = 1;
          ...
          if ( !v70 )
          {
            ...
            *(_WORD *)(a1 + 10) = 1;
            if ( v19 == 1 )
              ...
              v20 = sub_328484((char *)(a1 + 10), 1, v19 - 1);
            v21 = v58;
            v11 = 0;
            *(_DWORD *)a1 = v20;
            *(_DWORD *)(a1 + 4) = 1 - v19;
...
LABEL_35:
  if ( v14 < 0 )
    goto LABEL_36;
  if ( sub_327A70((int *)v4, a4, &v58) || sub_327A70((int *)a3, a4, &v58) )
  {
    v10 = 0;
    v12 = v58;
    v11 = 0;
...
LABEL_50:
  if ( v30 > 49 )
    ...
    v31 = 2 * (*((unsigned __int8 *)&dword_438B40[5] + v30) + 5);
  if ( v31 > 0x30 )
  {
    v46 = malloc(v31);
    v11 = v46;
  ...
  if ( !v55 )
  {
    ...
    sub_32ECB8((int)v32, (int)v4, &v62, &v58);
    if ( *((_WORD *)v32 + 5) || (v41 = *(_DWORD *)v32, *(_DWORD *)v32 != 1) || (v43 = v32[8], (v43 & 0x70) != 0) )
    {
      v47 = a3;
      v10 = 0;
      sub_32B560((int)v32, (int)v32, v47, (int)&v62, &v58);
      sub_32E4D8((int)v32, (int)v32, &v62, &v58);
      v41 = *(_DWORD *)v32;
      v43 = v32[8];
    }
    else
...
LABEL_91:
    ...
    *(_BYTE *)(a1 + 8) = v43;
    *(_DWORD *)(a1 + 4) = v44;
    sub_328A28(a1, a4, v42, v41, &v57, v53);
    sub_3295C0((_DWORD *)a1, a4, &v57, v53);
    v12 = v58;
    goto LABEL_4;
  }
  v33 = *(char *)(a3 + 8);
  ...
  *((_DWORD *)v32 + 1) = 0;
  ...
  {
    v53 = &v58;
    sub_32AB94((int)v59, (int)v32);
    sub_32D420((int)v32, (int)v59, __PAIR64__(&v62, (unsigned int)v4), 0x80u, &v58);
    if ( v31 <= 0x30 )
    {
      v4 = &v71;
      goto LABEL_111;
    ...
    if ( v48 )
    {
      v4 = (char *)v48;
LABEL_111:
      sub_32AB94((int)v4, (int)v32);
      sub_32AB94((int)v32, (int)v59);
      goto LABEL_61;
    }
LABEL_101:
    v12 = v58 | 0x10;
...
LABEL_62:
  ...
  sub_32B560((int)v32, (int)v32, (int)v4, (int)&v62, v53);
  if ( v37 != 31 )
  {
LABEL_70:
    sub_32B560((int)v32, (int)v32, (int)v32, (int)&v62, v53);
    v35 = v58;
    v36 = v55;
    v38 = v58 & 0x2200;
    goto LABEL_62;
...
LABEL_93:
  v32[8] = v45 & 0x7F | v54;
  sub_3295C0(v32, a4, &v57, v53);
  sub_32AB94(a1, (int)v32);
  v12 = v58;
LABEL_4:
  free(v11);
  free(v10);
