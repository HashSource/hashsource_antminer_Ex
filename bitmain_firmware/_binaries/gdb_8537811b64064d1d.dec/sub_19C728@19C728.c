_DWORD *__fastcall sub_19C728(_DWORD *a1, const char **a2, _DWORD *a3, int a4)
{
  const char *v5; // r4
  const char *v10; // r0
  int v11; // r5
  ...
  if ( !strchr(v10, v11) )
  {
    ...
    if ( (v19 & 0xFD) != 0 )
    {
      ...
      *a2 = v5;
      ...
      {
        v20 = v5;
        while ( !isspace(v26) && !sub_197438((char *)v20 + 1) )
        {
          v28 = *a2;
...
LABEL_34:
        v18 = strlen(v5);
        *a2 = &v5[v18];
        *a1 = sub_93358(v5 + 1, v18 - 1);
        return a1;
      }
LABEL_29:
      sub_94708("Unmatched quote, %s.", v5);
    }
    if ( !v13[1] )
      goto LABEL_33;
    v13 += 2;
