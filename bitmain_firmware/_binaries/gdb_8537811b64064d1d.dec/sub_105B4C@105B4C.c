void __fastcall sub_105B4C(int a1, int a2)
{
  unsigned int v2; // r7
  int v4; // r3
  int v5; // r3
  ...
  v177 = a1;
  v175 = sub_1B7278(a2);
  v4 = *(_DWORD *)sub_1B6B4C(a2, dword_47B26C);
  v167 = (int (__fastcall **)(int))&off_478984;
  v166 = v4;
  v5 = *(_DWORD *)(sub_1B6B4C(a2, dword_47B26C) + 4);
  dword_47B268 = 0;
  v169 = v5;
  dword_47B278 = 0;
  dword_47B264 = *(_DWORD *)(sub_1B6B4C(a2, dword_47B26C) + 12);
  src = dest;
  v182 = &v165;
  dword_47B23C = 20;
  dword_47B238 = (int)sub_93050(0xF0u);
  dword_47B27C = dword_47B238;
  v170 = sub_92564((int)sub_104BF0, a2);
  sub_E6560(0);
  v6 = *(_DWORD *)(a2 + 156);
  v7 = *(char **)(a2 + 36);
  dword_47B25C = 0;
  ...
  dword_47B280 = -1;
  dword_47B260 = (int)v7;
  off_478984 = (_UNKNOWN *)sub_1050B4;
  if ( v6 == -1 )
  {
    v171 = *(_DWORD *)(a2 + 160);
    if ( v171 == -1 )
    {
      ...
      if ( v171 == -1 )
      {
        v8 = sub_94728((int)"dbxread.c", 1105, "sect_index_rodata not initialized");
LABEL_277:
        v131 = *(_DWORD *)(a2 + 152);
        if ( v131 != -1 )
        {
...
LABEL_341:
        sub_94728((int)"dbxread.c", 1977, "sect_index_text not initialized");
LABEL_342:
        sub_94708("string table offset backs up at %d", v2);
      }
    }
  }
  v172 = 30;
  ...
  while ( 2 )
  {
    LODWORD(v8) = sub_1B6B4C(a2, dword_47B26C);
...
LABEL_140:
        ...
        if ( v90 < *(_DWORD *)(v185 + 20) )
          v90 = *(_DWORD *)(v185 + 20);
        sub_1056CC(a2, (_DWORD *)v185, (int)v182, (_DWORD *)v184, dword_47B258 * HIDWORD(v8), v90, src, v181, v180);
        goto LABEL_143;
      }
      goto LABEL_277;
    }
      ...
      case 240:
        ...
        if ( *v51 == 45 && v51[1] == 108 || (v52 = &v51[strlen(v51)], *(v52 - 1) == 111) && *(v52 - 2) == 46 )
        {
          ...
          if ( v54 && v55 >= *(_DWORD *)(v185 + 16) )
          {
            ...
            if ( v55 < v56 )
              v55 = v56;
            sub_1056CC(a2, (_DWORD *)v185, (int)v182, (_DWORD *)v184, dword_47B258 * dword_478988, v55, src, v161, v180);
            v184 = 0;
            dword_47B274 = 0;
            v185 = 0;
            v2 = dword_478988;
...
LABEL_31:
        ...
        if ( v187 > 8u )
        {
          ...
          else
          {
            ...
            if ( v35 != -1 )
              goto LABEL_38;
            sub_94728((int)"dbxread.c", 455, "sect_index_data not initialized");
          }
          if ( v32 != 12 )
            goto LABEL_129;
        }
...
LABEL_39:
                s1 = (char *)v35;
                v37 = strlen(v33);
                sub_1B25DC(v177, v33, v37, 1, v34, v36, (int)s1);
                v2 = dword_478988;
                goto LABEL_30;
              }
LABEL_129:
            ...
            sub_94728((int)"dbxread.c", 491, "sect_index_data not initialized");
LABEL_171:
            v35 = *(_DWORD *)(a2 + 152);
            if ( v35 == -1 )
              goto LABEL_345;
...
LABEL_150:
        ...
        sub_94728((int)"dbxread.c", 470, "sect_index_text not initialized");
LABEL_344:
        sub_94728((int)"dbxread.c", 462, "sect_index_data not initialized");
LABEL_345:
        sub_94728((int)"dbxread.c", 438, "sect_index_text not initialized");
LABEL_346:
        sub_94728((int)"dbxread.c", 442, "sect_index_data not initialized");
        sub_107870();
        return;
      case 32:
      case 36:
...
LABEL_71:
        ...
        {
          s1 = (char *)&ptr;
          v154 = (_DWORD *)sub_33B2E4(v191, &ptr, 0);
          v155 = s1;
          v191[0] = v154;
          v192[0] = ptr;
        }
...
LABEL_258:
            v191[1] = v119;
            v119[(_DWORD)v120] = 0;
            sub_FFE70((int)p_ptr, (char *)v191[0]);
            n = v194;
            if ( v194 )
            {
              v122 = *(void **)(a2 + 60);
            ...
            switch ( *(_BYTE *)(v60 + 1) )
            {
              ...
              case 'F':
                if ( !v185 )
                {
                  ...
                  v22[v2] = v185;
                  if ( v23 > 0 )
                    sub_F43DC(&off_46D334, "function `%s' appears to be defined outside of all compilation units", v22);
                  free(v22);
                }
                v24 = *(_DWORD *)(a2 + 152);
                if ( v24 == -1 )
                ...
                v190 += v26;
                if ( v190 == v26 && ((int (__fastcall *)(int))loc_16C5EC)(v175) )
                {
                  if ( v185 )
                  {
                    v153 = sub_104CB0((const char *)v58, *(_DWORD *)(v185 + 4));
                    v27 = v180 & 1;
                    if ( !v153 )
                    {
                      if ( v180 )
                  ...
                  {
                    v153 = sub_104CB0((const char *)v58, 0);
                    if ( !v153 )
                    {
                      v173 = v190;
                      goto LABEL_27;
                ...
                {
LABEL_295:
                  v150 = ((int (__fastcall *)(int))loc_16C5EC)(v175);
                  v173 = v190;
                  if ( !v150 )
                    goto LABEL_26;
                  v180 = 0;
...
LABEL_23:
                if ( *(_DWORD *)(v185 + 16) > v173 )
                {
                  ...
                  if ( v28 == -1 )
                  {
                    sub_94728((int)"dbxread.c", 1794, "sect_index_text not initialized");
                    goto LABEL_341;
                  }
...
LABEL_27:
                ...
                v30 = a2 + 108;
LABEL_28:
                sub_1D2280(s1, v174, 1, 1, 10, v30, v173, v29, a2);
                goto LABEL_29;
              case 'G':
                v190 += *(_DWORD *)(*(_DWORD *)(a2 + 144) + 4 * v171);
                sub_1D2280(s1, v174, 1, 1, 2, a2 + 108, v190, dword_47B28C, a2);
                v2 = dword_478988;
                goto LABEL_30;
              case 'S':
                v190 += *(_DWORD *)(*(_DWORD *)(a2 + 144) + 4 * v171);
                if ( ((int (__fastcall *)(int))loc_16C4E8)(v175) )
                  ((void (__fastcall *)(int, int))loc_16C534)(v175, v58);
                sub_1D2280(s1, v174, 1, 1, 2, a2 + 120, v190, dword_47B28C, a2);
                v2 = dword_478988;
                goto LABEL_30;
              case 'T':
                if ( v60 >= v58 + 2 )
                ...
                if ( v60 == v58 + 1 )
                {
                  ...
                  {
LABEL_201:
                    sub_1D2280(s1, v174, 1, 2, 8, a2 + 120, 0, dword_47B28C, a2);
                    v99 = *(unsigned __int8 *)(v60 + 2);
                    if ( v99 == 116 )
                    {
                      ++v60;
                      sub_1D2280(s1, v174, 1, 1, 8, a2 + 120, 0, dword_47B28C, a2);
                      v99 = *(unsigned __int8 *)(v60 + 2);
                    }
                  }
                }
...
LABEL_236:
                  ...
                  if ( v111 )
                  {
                    ...
                    v117 = 0;
LABEL_248:
                    sub_1D2280(v110, v117, 1, 1, 1, a2 + 120, 0, dword_47B28C, a2);
                    v106 = *v107;
                    if ( !*v107 )
                      continue;
                    while ( v106 != 44 )
...
LABEL_242:
                ...
                goto LABEL_248;
              case 'c':
                sub_1D2280(s1, v174, 1, 1, 1, a2 + 120, 0, dword_47B28C, a2);
                v2 = dword_478988;
                goto LABEL_30;
              case 'f':
                if ( !v185 )
                {
                  v156 = (char *)sub_93050(v2 + 1);
                  v157 = v60 - v58;
                  v158 = v156;
                  ...
                  v158[v2] = v185;
                  if ( v159 > 0 )
                    sub_F43DC(&off_46D334, "function `%s' appears to be defined outside of all compilation units", v158);
                  free(v158);
                }
                v94 = *(_DWORD *)(a2 + 152);
                if ( v94 == -1 )
                {
                  sub_94728((int)"dbxread.c", 1682, "sect_index_text not initialized");
LABEL_332:
                  sub_94728((int)"dbxread.c", 1289, "sect_index_text not initialized");
                  if ( ptr != v195 )
                    sub_339E8C(ptr);
                  goto LABEL_334;
                }
                ...
                v190 += v96;
                if ( v190 == v96 && ((int (__fastcall *)(int))loc_16C5EC)(v175) )
                {
                  if ( v185 )
                  {
                    v152 = sub_104CB0((const char *)v58, *(_DWORD *)(v185 + 4));
                    v97 = v180 & 1;
                    if ( !v152 )
                    {
                      if ( v180 )
                  ...
                  {
                    v152 = sub_104CB0((const char *)v58, 0);
                    if ( !v152 )
                    {
                      v173 = v190;
                      goto LABEL_191;
                ...
                {
LABEL_297:
                  v151 = ((int (__fastcall *)(int))loc_16C5EC)(v175);
                  v173 = v190;
                  if ( !v151 )
                    goto LABEL_190;
                  v180 = 0;
...
LABEL_187:
                if ( *(_DWORD *)(v185 + 16) > v173 )
                {
                  ...
                  if ( v98 == -1 )
                  {
                    sub_94728((int)"dbxread.c", 1725, "sect_index_text not initialized");
LABEL_338:
                    sub_94728((int)"dbxread.c", 1191, "sect_index_text not initialized");
LABEL_339:
                    sub_94728((int)"dbxread.c", 1751, "sect_index_text not initialized");
LABEL_334:
                    v160 = v191[0];
                    if ( v191[0] != v192 )
                      sub_339E8C(v191[0]);
...
LABEL_191:
              ...
              default:
                if ( dword_47AC88 <= 0 )
                  goto LABEL_29;
                sub_F43DC(&off_46D334, "unknown symbol descriptor `%c'", *(unsigned __int8 *)(v60 + 1));
                v2 = dword_478988;
                goto LABEL_30;
            }
          }
        ...
        goto LABEL_258;
      case 98:
        if ( !v185 || !((int (__fastcall *)(int))loc_16C5EC)(v175) )
          goto LABEL_29;
        v163 = v181;
        v181 = 0;
        sub_1056CC(a2, (_DWORD *)v185, (int)v182, (_DWORD *)v184, dword_47B258 * dword_478988, 0, src, v163, v180);
        v184 = 0;
        dword_47B274 = 0;
        v185 = 0;
        v2 = dword_478988;
      ...
      case 100:
        ...
        if ( !v190 )
        {
          v87 = ((int (__fastcall *)(int))loc_16C5EC)(v175);
          v88 = s1;
          v11 = v87;
          if ( v87 )
          {
        ...
        if ( dword_478988 - 1 != dword_46D434 )
        {
          ...
          if ( v185 )
          {
            ...
            v181 = 0;
            v184 = 0;
            sub_1056CC(a2, (_DWORD *)v185, (int)v182, v82, dword_47B258 * dword_478988, (size_t)v81, src, v162, v180);
            v80 = dword_478988;
            v185 = 0;
            dword_47B274 = 0;
          }
        ...
        dword_46D434 = v80;
        v83 = sub_105558(a2, &v186);
        v84 = (int)v83;
        if ( !*v83 )
          goto LABEL_117;
        v85 = (_BYTE *)sub_3245CC(v83);
...
LABEL_117:
        ...
        v133 = sub_1D0734(a2, v84, s1, a2 + 108, a2 + 120);
        v135 = *(_DWORD *)(a2 + 60);
        v185 = v133;
        v136 = *(_DWORD *)(a2 + 64);
      ...
      case 130:
        ...
        if ( v185 )
        {
          ...
          if ( dword_47B27C >= (unsigned int)(dword_47B238 + 12 * dword_47B23C) )
          {
            ...
            dword_47B23C *= 2;
            v67 = (char *)sub_93078((void *)dword_47B238, 24 * v63);
        ...
        if ( dword_47AC88 > 0 )
        {
          sub_F43DC(&off_46D334, "N_BINCL %s not in entries for any file, at symtab pos %d", v61, dword_478988);
          v2 = dword_478988;
        }
        goto LABEL_30;
      case 132:
...
LABEL_119:
      ...
      default:
        v86 = sub_98B30(v19, 0);
        if ( dword_47AC88 > 0 )
          sub_F43DC(&off_46D334, "unknown symbol type %s", v86);
        goto LABEL_29;
    }
  }
}
