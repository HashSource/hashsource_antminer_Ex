int __fastcall sub_179B54(_DWORD *a1, int a2, __int64 a3)
{
  int v5; // r12
  int v6; // r2
  int v7; // r10
...
LABEL_1:
  ...
  if ( a3 || ((unsigned __int16)v6 != 128 ? (v8 = &word_3B4A54) : (v8 = *(__int16 **)(v5 + 28)), v9 = v8[2], v9 <= 0) )
  {
LABEL_17:
    v18 = 0;
    for ( i = 0; ; ++i )
    {
      if ( v7 != 128 || (v21 = *(__int16 **)(v5 + 28), v21 == &word_3B4A54) )
      {
        if ( i >= 0 )
          return 0;
      }
