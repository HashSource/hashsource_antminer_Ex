void __fastcall sub_13136C(int a1, int *a2)
{
  int v4; // r3
  int v5; // r2
  _DWORD *v6; // r3
  ...
  v41 = sub_1311C0(*(_DWORD *)(a1 + 36), (*(unsigned __int8 *)(a1 + 7) >> 6) & 1, a2);
...
LABEL_13:
    ...
    if ( v6 && *v6 && !*(_DWORD *)(a1 + 40) && (*(_BYTE *)(a1 + 6) & 1) != 0 )
    {
      ...
      if ( v8 )
      {
        ...
        v9 = a1;
        do
          v9 = sub_1311C0(*(_DWORD *)(v9 + 36), (*(unsigned __int8 *)(v9 + 7) >> 6) & 1, a2);
...
LABEL_26:
          ...
          if ( v10 )
          {
            ...
            v11 = (const char *)sub_194560(a2[17]);
            v12 = (char *)v11;
            if ( v11 )
            {
              v13 = *(_DWORD *)(*a2 + 40);
