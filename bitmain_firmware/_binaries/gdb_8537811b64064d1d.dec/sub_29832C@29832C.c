int __fastcall sub_29832C(int a1, int *a2, int a3, int a4, _DWORD *a5)
{
  int v5; // r4
  int v6; // r7
  _BYTE *v11; // r6
...
LABEL_25:
  ...
  do
  {
    if ( _ctype_get_mb_cur_max() <= 1 || dword_48BB60 || (v15 = sub_29B21C(v11, v22), v15 <= 1) )
    {
      v14 = v13 + 1;
