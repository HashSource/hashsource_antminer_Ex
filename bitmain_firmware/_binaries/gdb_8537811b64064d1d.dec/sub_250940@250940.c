int __fastcall sub_250940(int *a1, int *a2, int a3, int (__fastcall *a4)(int, int))
{
  int result; // r0
  int v6; // r2
  char *v8; // r4
...
LABEL_14:
      ...
      result = sub_250940(v17 - 3, v41, v42, a4);
      v6 = v8 - (char *)a1;
      if ( v8 - (char *)a1 <= 192 )
        return result;
      v41 = v17 - 3;
...
LABEL_17:
        ...
        do
        {
          ...
          v29 = v26[2];
          v26 -= 3;
          sub_2507AC((int)a1, v25, v24, v27, v28, v29, a4);
        }
        while ( v25-- != 0 );
        do
        {
          ...
          *v19 = *a1;
          v19[1] = v32;
          v19[2] = v33;
          result = sub_2507AC((int)a1, 0, -1431655765 * (v19 - a1), v31, v49, v53, a4);
        }
