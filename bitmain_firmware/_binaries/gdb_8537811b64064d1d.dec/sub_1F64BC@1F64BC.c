int __fastcall sub_1F64BC(const char *a1)
{
  int v1; // r4
  int v3; // r5
  int v4; // r3
  ...
  v14 = a1;
  if ( sub_1F6138(&v14, &v15, &v16) )
    return sub_1F61CC(-1, 5);
  v1 = sub_1F5FBC(&v14, v17);
  if ( v1 )
    return sub_1F61CC(-1, 5);
  if ( (v17[0] & 0x200) != 0 )
    v1 = 64;
  ...
  if ( (v17[0] & 2) != 0 )
    v1 |= 2u;
  if ( sub_1F5FBC(&v14, v17) )
    return sub_1F61CC(-1, 5);
  sub_1F5F34(v17[0], 1);
  v3 = sub_230048(v15, &v13, v16);
  if ( v3 )
    return sub_1F61CC(-1, 5);
  ...
  if ( (v1 & 3) != 0 )
    return sub_1F61CC(-1, 21);
LABEL_23:
  v5 = sub_967DC((int)&v13, v1);
  if ( v5 >= 0 )
  {
    v6 = dword_489350;
    if ( dword_489350 <= 0 )
...
LABEL_29:
        dword_489350 += 10;
        v9 = (char *)sub_93078((void *)dword_48934C, 4 * (v6 + 10));
        v10 = dword_489350;
        dword_48934C = (int)v9;
        if ( v6 < dword_489350 )
        {
