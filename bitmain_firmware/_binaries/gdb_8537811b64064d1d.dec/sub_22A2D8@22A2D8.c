int __fastcall sub_22A2D8(int a1, int a2, int a3, int a4, int a5, unsigned int a6)
{
  _DWORD *v8; // r0
  int v9; // r0
  _DWORD *v10; // r0
  ...
  sub_2594D8(*v8, "-> %s->to_insn_history_from (...)\n", (const char *)dword_489C90);
  v9 = off_489F44(&unk_489C8C, off_489F44, a3, a4, a5, a6);
  v10 = (_DWORD *)sub_242FF0(v9);
  sub_2594D8(*v10, "<- %s->to_insn_history_from (", (const char *)dword_489C90);
