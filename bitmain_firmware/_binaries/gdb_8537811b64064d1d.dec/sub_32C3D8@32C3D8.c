int __fastcall sub_32C3D8(int a1, int a2, signed __int64 a3, unsigned __int8 a4, int *a5)
{
  int v5; // r9
  int v7; // lr
  ...
  if ( !v13 && v15 == 1 && (v5 & 0x70) == 0 )
  {
    ...
    *(_DWORD *)(a1 + 4) = v17;
    v78 = 0;
    sub_328A28(a1, (int *)HIDWORD(a3), (unsigned __int16 *)(a3 + 10), v72, &v78, a5);
    ...
    *(_BYTE *)(a1 + 8) = v38;
    ...
    if ( v36 || *(_DWORD *)a1 != 1 || (v38 & 0x70) != 0 )
    {
      if ( v39 < 0 )
      {
        ...
        {
          v40 = sub_328484((char *)(a1 + 10), v40, -v39);
        }
        v43 = *(_DWORD *)(a1 + 4);
        *(_DWORD *)a1 = v40;
        *(_DWORD *)(a1 + 4) = v43 + v39;
...
LABEL_98:
    sub_3295C0((_DWORD *)a1, v71, &v78, a5);
    v11 = 0;
    goto LABEL_71;
  }
  ...
  if ( !(_DWORD)a3 && v72 == 1 )
  {
    if ( (v7 & 0x70) == 0 )
    {
      ...
      *(_DWORD *)(a1 + 4) = v74;
      v78 = 0;
      sub_328A28(a1, (int *)HIDWORD(a3), (unsigned __int16 *)(v14 + 10), v15, &v78, a5);
      v63 = v17 - *(_DWORD *)(a1 + 4);
      if ( v63 < 0 )
      {
        v64 = *(_DWORD *)a1;
        ...
        {
          v64 = sub_328484((char *)(a1 + 10), v64, -v63);
        }
        v66 = *(_DWORD *)(a1 + 4);
        *(_DWORD *)a1 = v64;
        *(_DWORD *)(a1 + 4) = v66 + v63;
...
LABEL_112:
      ...
      if ( v71[2] <= v17 )
      {
        ...
        if ( v73 >= v15 )
        {
          ...
          {
            v55 = v13 + a3;
            if ( v55 < 1000 && (v15 > 2 || dword_438D28[v15] > v55) )
            {
              if ( (_DWORD)v14 != a1 )
                sub_32AB94(a1, v14);
              *(_WORD *)(a1 + 10) = v55;
          ...
          if ( v68 > 0 )
          {
            ...
            *(_WORD *)(a1 + 10) = v68;
            ...
            if ( !v70 )
              v15 = HIDWORD(v69) >> 1;
            *(_DWORD *)a1 = sub_327CD0(a1 + 10, v15);
            goto LABEL_71;
          }
          LODWORD(a3) = v72;
          v76 = 1;
...
LABEL_111:
  ...
  if ( (int)a3 > v73 + v15 + 1 )
  {
    ...
    *(_BYTE *)(a1 + 8) = *(_BYTE *)(HIDWORD(v14) + 8);
    ...
    v78 = v49;
    *(_DWORD *)(a1 + 4) = v48;
    sub_328A28(a1, v71, (unsigned __int16 *)(HIDWORD(v14) + 10), v72, &v78, a5);
    if ( v47 > 0 )
    {
      v50 = sub_328484((char *)(a1 + 10), *(_DWORD *)a1, v47);
      v51 = *(_DWORD *)(a1 + 4);
      *(_DWORD *)a1 = v50;
      *(_DWORD *)(a1 + 4) = v51 - v47;
    }
  ...
  v21 = v8 - 1;
  v9 = -3 * v21;
  v76 = dword_438D28[HIDWORD(a3) + -3 * v21];
  if ( v75 < 0 )
    goto LABEL_111;
LABEL_14:
  if ( (int)a3 < v15 )
...
LABEL_126:
  ...
  *(_DWORD *)(a1 + 4) = *(_DWORD *)(v14 + 4);
  ...
  if ( v72 > 49 )
    v29 = HIDWORD(v14) >> 1;
  v30 = sub_3275D8(v24, v28, v27, v29, v21, (signed int)v23, v76);
  HIDWORD(v32) = 3 * v30;
  if ( 3 * v30 >= 0 )
  {
  ...
  if ( v23 != v22 )
  {
    if ( v73 < SHIDWORD(v32) )
    {
      ...
      if ( !v33 )
        v31 = HIDWORD(v32) >> 1;
      HIDWORD(v32) = sub_327CD0((int)v23, v31);
      *(_DWORD *)a1 = HIDWORD(v32);
    }
    v21 = (int)&v78;
    sub_328A28(a1, v71, v23, SHIDWORD(v32), &v78, a5);
  ...
  if ( SHIDWORD(v32) > 49 )
    HIDWORD(v34) >>= 1;
  *(_DWORD *)a1 = sub_327CD0(a1 + 10, SHIDWORD(v34));
  sub_3295C0((_DWORD *)a1, v71, (int *)v21, a5);
