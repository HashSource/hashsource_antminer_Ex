        ...
        _DWORD *a7)
{
  ...
  if ( !a1[16] )
  {
    if ( !a1[11] || (v22 = sub_2F7864((int)a1, a7), (a1[16] = v22) == 0) || a1[14] < a1[15] && !sub_2F8C2C((int)a1) )
    {
      a1[9] = 1;
      return 0;
    }
  ...
  *a4 = 0;
  if ( v13 )
  {
    ...
    else
    {
      ...
      if ( v7 )
LABEL_100:
        sub_2A6BE4("./dwarf2.c", 2598);
      qsort(v23, v13, 0xCu, (__compar_fn_t)sub_2F621C);
      v55 = v23[2];
      if ( v13 > 1 )
      {
        v56 = v23;
