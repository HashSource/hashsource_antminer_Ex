void __fastcall sub_FF86C(int a1, unsigned int *a2, int (__fastcall *a3)(_DWORD, int), int a4)
{
  unsigned int v8; // r3
  bool v9; // cc
  int v10; // r2
  ...
  if ( a3 )
  {
    ...
    if ( v10 )
    {
      sub_7F58C(&ptr, (int)a2, 10);
      if ( ptr )
      {
        v11 = sub_92E50();
        sub_21D6D8(&v50, ptr, 0, 1, 0);
        v12 = v50;
        sub_92E68((int)v11);
        if ( v12 )
        {
...
LABEL_22:
      sub_FF86C(a1, i, a3, a4);
LABEL_23:
      sub_FF86C(a1, a2[3], a3, a4);
      return;
    default:
      return;
  }
...
LABEL_39:
      if ( v17 )
      {
        sub_FF86C(a1, v16, a3, a4);
      }
      else
      {
        sub_25650C(&ptr, v16[2], v16[3]);
        v31 = *(void **)(a1 + 20);
        v32 = *(_DWORD *)(a1 + 24);
        v33 = n;
        *a2 = 0;
    ...
    while ( 1 )
    {
      ...
      if ( !*v18 )
        break;
      sub_FF86C(a1, v18, a3, a4);
      sub_7F58C(s, v16[2], 100);
      if ( !s[0] )
        goto LABEL_49;
      v42 = strlen(s[0]);
      sub_25650C(&ptr, s[0], v42);
      if ( s[0] )
        free(s[0]);
LABEL_38:
      sub_25650C(&ptr, "::", 2);
    ...
    *(_DWORD *)(a1 + 16) = v29;
    s[3] = v30;
    if ( !sub_FF3F0(a1, (int)s, a3, a4) )
      goto LABEL_38;
    n = 0;
    *(_BYTE *)src = 0;
    sub_7F58C(&v49, (int)s, 100);
    if ( v49 )
    {
      v43 = sub_FE42C(a1 + 8, v49, &v48);
      v44 = (_DWORD *)a2[2];
      v45 = v48;
      v44[2] = v43;
      v46 = a2[2];
