char *__fastcall sub_127384(const char ***a1, int a2, unsigned int a3, int a4, __int64 a5, char *s)
{
  int v7; // r5
  __int64 v10; // r6
  int v11; // r0
      ...
      if ( a3 > 0x21 )
      {
        if ( a3 == 7938 )
        {
          if ( a1[2] )
          {
            ...
            {
              v130 = *(_DWORD *)(v82 + 36);
              ((void (__fastcall *)(int, const char **))loc_11FFF8)(v82, v84 + 33);
              v85 = v130;
            }
            if ( !*((_BYTE *)v84 + 168) )
            {
              v129 = v85;
              ((void (__fastcall *)(int, const char **))loc_11FFF8)(v82, v84 + 38);
              v85 = v129;
            }
            if ( !v84[34] )
              sub_94708(
          ...
          v111 = 7938;
LABEL_152:
          v121 = sub_321668(v111);
          v122 = "DW_FORM_<unknown>";
          if ( v121 )
            v122 = (const char *)v121;
          sub_94708("Dwarf Error: %s found in non-DWO CU [in module %s]", v122, *v12);
        }
        if ( a3 > 0x1F02 )
        {
          if ( a3 != 7968 )
...
LABEL_12:
              v14 = sub_126EA0();
              LODWORD(v15) = sub_11E4E8(*v12, v13, (int)s, *(_DWORD *)(v7 + 20));
              v131[0] = *(_DWORD *)(v7 + 20);
              v16 = sub_121E9C((int)v14, v15);
              v17 = *(_BYTE *)(a2 + 3);
              v18 = 0;
              v19 = v131[0];
              *(_DWORD *)(a2 + 8) = v16;
...
LABEL_145:
            ...
            sub_94708("Dwarf Error: Cannot handle %s in DWARF reader [in module %s]", v120, *v12);
          }
          goto LABEL_52;
        }
        if ( a3 != 7937 )
        ...
        v112 = sub_122ED4((unsigned __int8 *)(v7 + 14), (__int64 *)(v7 + 176), s, v131);
        v39 = v131[0];
        *(_DWORD *)(a2 + 8) = v112;
LABEL_64:
        v20 = &s[v39];
...
LABEL_14:
      ...
      if ( (*(_BYTE *)(*(_DWORD *)(v7 + 136) + 10) & 8) != 0 )
        goto LABEL_11;
      v96 = sub_121864(v12, (int)s, v7 + 8, v131);
      v97 = *(_BYTE *)(a2 + 3);
      v18 = 0;
      v98 = v131[0];
      *(_DWORD *)(a2 + 8) = v96;
...
LABEL_13:
    ...
    if ( a3 != 21 )
    {
      ...
      {
LABEL_52:
        LODWORD(v31) = sub_11E4E8(*v12, (int)(v12 + 1), (int)s, *(_DWORD *)(v7 + 20));
        v32 = *(_DWORD *)(v7 + 20);
        *(_QWORD *)(a2 + 8) = v31;
        v131[0] = v32;
        v20 = &s[v32];
      ...
      if ( a3 <= 0x17 )
      {
        ...
        v20 = (char *)sub_127384((int)a1, a2, v123, SHIDWORD(v41), v10, SHIDWORD(v10), v40);
        v18 = v123 == 6;
        goto LABEL_13;
      }
LABEL_127:
      v103 = 0;
      v104 = (int *)sub_11C9C0(v7);
      v105 = s + 1;
      v106 = *s & 0x7F;
      if ( *s < 0 )
      {
...
LABEL_18:
    if ( *(_WORD *)a2 == 11 && v18 )
    {
      ...
      if ( v23 > 0xFFFFFFFE )
      {
        if ( dword_47AC88 > 0 )
        {
          v46 = sub_98B30(v23, SHIDWORD(v23));
          sub_F43DC(&off_46D334, "Suspicious DW_AT_byte_size value treated as zero instead of %s", v46);
        }
        *(_QWORD *)(a2 + 8) = 0;
      }
    }
  ...
  if ( a3 <= 9 )
  {
    ...
    if ( a3 <= 5 )
    {
      ...
      else
      {
        ...
        HIDWORD(v25) = v12 + 1;
        LODWORD(v25) = *v12;
        *(_DWORD *)(a2 + 8) = sub_11E3E8(v25, (int)s, v7, v131);
        v26 = ((int (__fastcall *)(int))loc_16A960)(v24);
        v27 = v131[0];
        *(_DWORD *)(a2 + 8) = v26;
        v20 = &s[v27];
      }
  ...
  else
  {
    ...
    if ( a3 != 15 )
    {
      if ( a3 > 0xF )
      {
        ...
        if ( *(_WORD *)(v7 + 12) == 2 )
        {
          *(_DWORD *)(a2 + 8) = sub_11E3E8(v37, (int)s, v7, v131);
          *(_DWORD *)(a2 + 12) = 0;
          v39 = v131[0];
        }
        else
        {
          LODWORD(v38) = sub_11E4E8((const char *)v37, SHIDWORD(v37), (int)s, *(_DWORD *)(v7 + 20));
          v39 = *(_DWORD *)(v7 + 20);
          *(_QWORD *)(a2 + 8) = v38;
          v131[0] = v39;
        }
      ...
      if ( (*(_BYTE *)(*(_DWORD *)(v7 + 136) + 10) & 8) != 0 )
        goto LABEL_12;
      LODWORD(v53) = sub_11E4E8(*v12, (int)(v12 + 1), (int)s, *(_DWORD *)(v7 + 20));
      v131[0] = *(_DWORD *)(v7 + 20);
      v54 = sub_1217C4(v12, v53, dword_4872D8 + 140, "DW_FORM_strp", ".debug_str");
      v55 = *(_BYTE *)(a2 + 3);
      v56 = v131[0];
      *(_DWORD *)(a2 + 8) = v54;
      *(_BYTE *)(a2 + 3) = v55 & 0x7F;
