void __fastcall sub_F6E70(_DWORD *a1, char *a2, int a3)
{
  void *v5; // r5
  int v6; // r4
  void *v7; // r5
  ...
  if ( ptr )
  {
    if ( !v6 )
    {
      if ( v61 )
      {
        v8 = sub_92564((int)sub_F45D8, (int)ptr);
        ((void (__fastcall *)(_DWORD *, void *, void *, int))loc_21FF2C)(a1, ptr, ptr, v61);
        sub_92648(v8);
        return;
      }
      v7 = ptr;
    ...
    if ( (unsigned int)(unsigned __int8)v12 - 3 <= 1 )
    {
      ...
      v66 = 0;
      v67 = 0;
      sub_F68FC(v11, (int)&v65, (const char *)ptr, v54);
      if ( ptr )
        free(ptr);
      sub_F6DFC(a1, &v65);
      v55 = v65;
...
LABEL_78:
    v40 = strlen(v25);
    sub_21FEFC(a1, 0, 3, v18, a3);
    if ( v40 == strcspn(v25, " \t\n*|\"';:?><") )
    {
      sub_220FAC((int)&v65, v25);
      v41 = (void **)v62;
      v42 = v63;
      v43 = (void **)v66;
      v15 = v62 == v63;
  ...
  sub_21FF9C((int)a1, 0, 3, v18, a3, (int)v27);
  free(v27);
LABEL_51:
  v32 = (char **)v62;
  v33 = (char **)v63;
  ...
  sub_F6DFC(a1, (void ***)&v62);
  if ( a1[17] == a1[18] )
    sub_21FEFC(a1, 0, 3, a2, a3);
  v34 = (void **)v62;
  v35 = v63;
  if ( v62 != v63 )
  {
