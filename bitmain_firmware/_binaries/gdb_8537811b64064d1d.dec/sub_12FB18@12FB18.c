char *__fastcall sub_12FB18(_WORD *a1, _DWORD *a2)
{
  int v4; // r0
  int v5; // r5
  int v6; // r3
...
LABEL_16:
        ...
        if ( *(char *)(v11 + 3) < 0 )
          return v7;
        v12 = (const char *)sub_1008E4(*(char **)(v11 + 8));
        v13 = (char *)v12;
        if ( v12 )
        {
          v14 = *(_DWORD *)(*a2 + 40);
...
LABEL_39:
      if ( *(char *)(v5 + 3) < 0 )
        return v7;
      result = sub_124164(v7, a2 + 16, *(_DWORD *)(*a2 + 40));
      v27 = *(_BYTE *)(v5 + 3);
      *(_DWORD *)(v5 + 8) = result;
      *(_BYTE *)(v5 + 3) = v27 | 0x80;
      break;
