int __fastcall sub_12618C(char *a1, char *a2, int a3, int a4, int (__fastcall **a5)(int, int))
{
  int result; // r0
  int v7; // r2
  char *v8; // r9
...
LABEL_15:
      ...
      result = sub_12618C(v20 - 2, v53, v54, varg_r3, a5);
      v7 = v8 - a1;
      if ( v8 - a1 <= 128 )
        return result;
      v53 = (char *)(v20 - 2);
...
LABEL_18:
        ...
        v32 = ((v7 >> 3) - 2) >> 1;
        do
          sub_125EB4((int)a1, v32, v31, *(_DWORD *)&a1[8 * v32], *(_DWORD *)&a1[8 * v32 + 4], varg_r3, a5);
        while ( v32-- != 0 );
        v34 = v52;
        do
        {
          ...
          *v34 = *(_DWORD *)a1;
          v34[1] = v35;
          result = sub_125EB4((int)a1, 0, ((char *)v34 - a1) >> 3, v37, v36, varg_r3, a5);
        }
        while ( (char *)v34 - a1 > 8 );
        return result;
      }
