int __fastcall sub_226BEC(int a1)
{
  _DWORD *v1; // r0
  int v2; // r5
  _DWORD *v3; // r0
  ...
  sub_2594D8(*v1, "-> %s->to_get_min_fast_tracepoint_insn_len (...)\n", (const char *)dword_489C90);
  v2 = ((int (__fastcall *)(void *))off_489EC4)(&unk_489C8C);
  v3 = (_DWORD *)sub_242FF0(v2);
  sub_2594D8(*v3, "<- %s->to_get_min_fast_tracepoint_insn_len (", (const char *)dword_489C90);
