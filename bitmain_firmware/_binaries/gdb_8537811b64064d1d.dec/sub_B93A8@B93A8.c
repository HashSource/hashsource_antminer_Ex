int __fastcall sub_B93A8(char *s2, const char **a2)
{
  int v4; // r11
  const char *v5; // r5
  int v6; // r6
...
LABEL_11:
  ...
  *a2 = v5;
  ...
  if ( dword_478228 )
  {
    ...
    sub_2594D8(*v18, "auto-load: Resolved file \"%s\" as \"%s\".\n", s2, *a2);
    v5 = *a2;
  }
LABEL_12:
  if ( !strcmp(v5, s2) )
...
LABEL_8:
  if ( dword_478228 )
  {
    ...
    sub_2594D8(*v11, "auto-load: File \"%s\" matches directory \"%s\".\n", s2, v8);
  }
  return 1;
}
