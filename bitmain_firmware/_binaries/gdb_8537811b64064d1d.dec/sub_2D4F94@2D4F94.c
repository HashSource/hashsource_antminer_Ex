int __fastcall sub_2D4F94(int a1, _DWORD *a2)
{
  int v2; // r3
  int v4; // r2
  _DWORD *v5; // r11
...
LABEL_339:
        ...
        do
        {
          if ( v5[8 * v153] == 1 )
          {
            ...
            {
              if ( v156 > 0x40000000 )
                sub_2A6A84("%B: warning: segment alignment of %#Lx is too large", a1);
              else
                v154 = v155[7];
            }
          }
...
LABEL_265:
  ...
  {
    if ( *(v35 - 3) || !*(v35 - 2) )
      sub_2A6A84("%B: warning: Empty loadable segment detected at vaddr=%#Lx, is this intentional?", a1, *(v35 - 5));
    goto LABEL_111;
  }
LABEL_126:
  ptr = sub_2AB3DC(v38, 4u);
  if ( !ptr )
    return 0;
  if ( v40 )
  {
    ...
    while ( 2 )
    {
      ...
      if ( v115 )
      {
        ...
        if ( !v112 )
        {
          ...
          if ( v117 != v113 )
            sub_2A6C18((int)"elf.c", 7027, (int)"rewrite_elf_program_header");
          goto LABEL_221;
        }
...
LABEL_228:
    ...
    if ( !*((_DWORD *)v56 + 9) )
      sub_2A6BE4("elf.c", 7066);
    v125 = v262;
    v262 = v56;
    *v125 = v56;
    if ( v249 >= v38 )
      goto LABEL_260;
    v126 = sub_2AD0C4((int)a2, v276);
    v56 = v126;
    if ( v126 )
    {
      v127 = *(v35 - 8);
