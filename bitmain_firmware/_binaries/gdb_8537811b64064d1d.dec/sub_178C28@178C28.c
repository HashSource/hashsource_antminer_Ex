int __fastcall sub_178C28(int a1, int a2, int a3, int a4, __int64 a5, int a6, int a7)
{
  int v7; // r5
  int v8; // r4
  int v9; // r3
  ...
  if ( v13 < v11 )
  {
    ...
    while ( 1 )
    {
      ...
      v43 = a3;
      v41 = v19;
      v35 = sub_10A86C((unsigned __int8)v19[3]);
      v19 = v41;
      a3 = v43;
      if ( !v35 )
        break;
          ...
          if ( *(_BYTE *)v23 == 1 )
          {
              ...
              && (v42 = a3, v27 = strcmp(v25, v26), a3 = v42, v22 = v40, !v27) )
            {
              ...
              if ( sub_26B3CC(
                     ...
                     *(int *)(v29 + 20) >> 31) )
              {
                return a5 - a6 + sub_26D258(v29, v28 + a5 + v31);
              }
              v38 = sub_92F8C(9, "Virtual baseclass pointer is not available");
              return sub_178F50(v38);
            }
          }
        }
      }
...
LABEL_35:
  ...
  if ( v13 <= a2 + 1 )
LABEL_38:
    sub_94708("Baseclass offset not found");
  while ( 1 )
  {
    result = sub_178C28(a1, v37, v12, v36, v8, HIDWORD(a5), a6, a7);
    if ( result )
      return result;
    if ( v13 == ++v37 )
      goto LABEL_38;
