        ...
        char **a10)
{
  ...
  if ( a5 )
  {
    ...
    {
LABEL_25:
      v13 = sub_2FC988(a2, a1, s2, 1, a8, 0);
      if ( !v13 )
        return 0;
      v14 = 5;
LABEL_14:
  ...
  if ( (char **)a5 != &off_4708A8 )
  {
    ...
    else if ( (*(_DWORD *)(a5 + 20) & 0x1000) != 0 )
    {
      ...
      {
        v13 = 0;
        sub_2A6A84("%B: plugin needed to handle lto object", a2);
        v14 = 4;
      }
      else
      {
...
LABEL_15:
    ...
    if ( v14 <= 1 )
      goto LABEL_118;
LABEL_111:
    v15 = sub_2FC948(*(_DWORD **)(a1 + 28), (const char *)a3, 1, a8, 0);
    goto LABEL_112;
  }
  v13 = 0;
LABEL_118:
  v15 = sub_2FC988(a2, a1, (const char *)a3, 1, a8, 0);
LABEL_112:
  if ( !v15 )
  {
    if ( !a10 )
...
LABEL_16:
  if ( (*(_BYTE *)(a1 + 1) & 1) == 0
    && ((v56 = *(_DWORD **)(a1 + 36)) == 0
     || !sub_2AAC54(v56, (const char *)a3, *(_BYTE *)(a1 + 1) & 1, *(_BYTE *)(a1 + 1) & 1))
         ...
         a4) )
  {
    ...
    while ( 1 )
    {
      ...
      {
        case 0:
          sub_2A6C18((int)"linker.c", 1457, (int)"_bfd_generic_link_add_one_symbol");
        case 1:
          v20 = 1;
          v46 = *(_DWORD *)(a1 + 28);
          *((_DWORD *)v15 + 5) = a2;
          v15[12] = 1;
          sub_2FCC8C(v46, (int)v15);
          return v20;
        case 2:
          *((_DWORD *)v15 + 5) = a2;
          v15[12] = 2;
        ...
        case 5:
          ...
          if ( !v16 )
          {
            sub_2FCC8C(v47, (int)v15);
            v47 = *(_DWORD *)(a1 + 28);
          }
          v15[12] = 5;
          v48 = sub_2AAEF0(v47, 8);
          *((_DWORD *)v15 + 5) = v48;
          if ( !v48 )
            return 0;
          *((_DWORD *)v15 + 6) = a6;
...
LABEL_60:
          ...
          *((_DWORD *)v15 + 6) = a6;
          ...
          if ( !v39 || *(unsigned __int8 *)(v36 + 7) != *(unsigned __int8 *)(v36 + 9) )
            return 1;
          if ( v16 == 4 )
            sub_2A6C18((int)"linker.c", 1537, (int)"_bfd_generic_link_add_one_symbol");
          v20 = 1;
...
LABEL_36:
          if ( v13[12] == 6 )
          {
            if ( *((char **)v13 + 5) == v15 )
            {
              sub_2A6A84("%B: indirect symbol `%s' to `%s' is a loop", a2, a3, s2);
          ...
          else if ( !v13[12] )
          {
            *((_DWORD *)v13 + 5) = a2;
            v13[12] = 1;
            sub_2FCC8C(*(_DWORD *)(a1 + 28), (int)v13);
          }
          if ( !v15[12] )
          {
            *((_DWORD *)v15 + 5) = v13;
...
LABEL_47:
          ...
          *((_BYTE *)v23 + 12) = 7;
          ...
          {
            v31 = strlen(s2) + 1;
            v32 = (void *)sub_2AAEF0((int)v28, v31);
            v33 = v32;
            if ( !v32 )
              return 0;
            memcpy(v32, s2, v31);
