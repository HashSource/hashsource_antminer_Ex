...
int32_t function_110e8(void);
int32_t function_11218(char *p_a1);
int32_t function_11270(void);
int32_t function_114a4(void);
int32_t function_11538(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
int32_t function_11574(void);
int32_t function_11578(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
...
int32_t entry_point(int32_t i_a1, int32_t i_a2) {
    ...
    __libc_start_main(0x10958, i_a2, (char **)&i_v1, (void (*)())0x11539,
...
int32_t function_109f8(void) {
    int32_t i_v1 =
        *(int32_t *)((int32_t)&i_g1 + (int32_t) "io%d/value" + 152); // 0x10a04
    if (i_v1 == 0) {
...
int32_t function_10da0(int32_t i_a1) {
    ...
    memset(&i_v1, 0, 64);
    sprintf((char *)&i_v1, "echo %d > /sys/class/gpio/gpio%d/value", i_a1, 408);
    system((char *)&i_v1);
    sprintf((char *)&i_v1, "echo %d > /sys/class/gpio/gpio%d/value", i_a1, 411);
...
int32_t function_10e1c(void) {
    ...
    memset(&i_v1, 0, 64);
    sprintf((char *)&i_v1, "/sys/class/gpio/gpio%d", 376);
    ...
    // 0x10eb8
    sprintf((char *)&i_v1, "/sys/class/gpio/gpio%d/value", 376);
...
// Address range: 0x10f58 - 0x10fe4
int32_t function_10f58(int32_t i_a1) {
    // 0x10f58
    int32_t i_v1; // bp-80, 0x10f58
    memset(&i_v1, 0, 64);
    int32_t i_v2 = i_a1 == 0 ? 408 : 411;
    int32_t i_v3; // 0x10fd0
...
// Address range: 0x10fe4 - 0x110e8
int32_t function_10fe4(void) {
    int32_t i_v1 = socket(AF_INET, SOCK_DGRAM, IPPROTO_IP); // 0x10ffc
    i_g3 = i_v1;
    if (i_v1 == -1) {
        // 0x110bc
        printf("socket error");
...
// Address range: 0x110e8 - 0x11218
int32_t function_110e8(void) {
    // 0x110e8
    int32_t i_v1; // bp-188, 0x110e8
    memset(&i_v1, 0, 30);
    int32_t i_v2; // bp-156, 0x110e8
    memset(&i_v2, 0, 40);
    int32_t i_v3; // bp-116, 0x110e8
    memset(&i_v3, 0, 100);
    ...
    int32_t i_v4 = strlen((char *)&i_v1); // 0x11150
    strncpy((char *)&p_g5, (char *)&i_v1, i_v4);
    char *p_v5 = stpcpy((char *)&i_v3, (char *)&i_v2); // 0x11174
    int32_t i_v6 = (int32_t)p_v5;                      // 0x11174
    *p_v5 = 44;
    int32_t i_v7 = i_v4 + 1;
    memcpy((int32_t *)(i_v6 + 1), &i_v1, i_v7);
    int32_t i_v8 = sendto(i_g3, &i_v3, i_v7 - (int32_t)&i_v3 + i_v6, 0,
                          (struct sockaddr *)&p_g11, 16); // 0x111c8
    if (i_v8 < 0) {
        // 0x11200
        printf("send error....");
        return 1;
...
// Address range: 0x11218 - 0x11270
int32_t function_11218(char *p_a1) {
    int32_t i_v1 = sendto(i_g3, (int32_t *)p_a1, 10, 0,
                          (struct sockaddr *)&p_g11, 16); // 0x1124c
    int32_t i_v2 = i_v1 < 0 ? 0x116f8 : i_v1 % 0x10000 | 0x10000;
    return printf(i_v1 >= 0 ? (char *)0x11718 : (char *)i_v2);
}

// Address range: 0x11270 - 0x114a4
int32_t function_11270(void) {
    int32_t i_v1 = 0;     // bp-156, 0x1128c
    int32_t i_v2 = 2;     // bp-160, 0x11290
    int32_t i_v3 = &i_v1; // 0x11290
    i_v3 += 4;
    *(int32_t *)i_v3 = 0;
    int32_t i_v4; // bp-28, 0x11270
    while (i_v3 != (int32_t)&i_v4) {
        // 0x11294
        i_v3 += 4;
        *(int32_t *)i_v3 = 0;
    }
    int32_t i_v5 = i_g3;  // 0x112b0
    int32_t i_v6 = -i_v5; // 0x112c4
    int32_t i_v7;         // bp-24, 0x11270
    int32_t i_v8 = (int32_t)&i_v7 - 128;
    int32_t *p_v9 =
        (int32_t *)(4 * ((i_v5 < 0 ? i_v5 + 31 : i_v5) >> 5) + i_v8); // 0x112e0
    *p_v9 = 1 << (i_v6 < 0 ? i_v5 % 32 : -((i_v6 % 32))) | *p_v9;
    int32_t *p_v10 = calloc(30, 1); // 0x112ec
    int32_t i_v11;                  // bp-152, 0x11270
    int32_t i_v12 = select(i_v5 + 1, (struct _TYPEDEF_fd_set *)&i_v11, NULL,
                           NULL, (struct timeval *)&i_v2); // 0x1130c
    switch (i_v12) {
    case -1: {
        // 0x114a0
        exit(-1);
    ...
    default: {
        int32_t i_v13 = i_g3;   // 0x11320
        int32_t i_v14 = -i_v13; // 0x11330
        int32_t i_v15 =
        ...
        int32_t i_v16 = 16; // bp-164, 0x113e8
        if (recvfrom(i_v13, p_v10, 30, 0, (struct sockaddr *)&p_g7, &i_v16) >=
            1) {
            // 0x11404
            printf("rev:\n%s\t", p_v10);
            i_g6 = 0;
            int32_t i_v17 = strlen((char *)&p_g5); // 0x11424
            int32_t i_v18;                         // 0x11270
...
// Address range: 0x114a4 - 0x11538
int32_t function_114a4(void) {
    int32_t i_v1 = 0; // 0x114ac
    for (int32_t i_v2 = 5; i_v2 > 0; i_v2--) {
        int32_t i_v3 = i_v1;
        int32_t i_v4 = i_v3; // 0x114b8
        if (function_10e1c() == 0) {
            // 0x11528
            usleep(0x4e20);
            i_v4 = i_v3 + 1;
...
int32_t function_11538(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    int32_t i_v1 = function_10794(i_a1, i_a2, i_a3, i_a4); // 0x11548
    return 0x21f12 - (int32_t)&i_g2 >> 2 == 0 ? i_v1 : i_a1;
}

// Address range: 0x11574 - 0x11576
int32_t function_11574(void) {
    // 0x11574
    int32_t i_v1; // 0x11574
    return i_v1;
}

// Address range: 0x11578 - 0x11580
int32_t function_11578(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    // 0x11578
    return i_a1;
}
