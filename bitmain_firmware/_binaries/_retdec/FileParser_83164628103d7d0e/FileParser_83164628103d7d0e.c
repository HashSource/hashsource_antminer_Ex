...
int32_t function_11f08(uint32_t i_a1, int32_t i_a2);
int32_t function_12274(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
int32_t function_122b0(void);
int32_t function_122b4(int32_t i_a1, int32_t *p_a2);
int32_t function_122b8(void);
int32_t function_122c0(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
...
int32_t entry_point(int32_t i_a1, int32_t i_a2) {
    ...
    __libc_start_main(0x11f08, i_a2, (char **)&i_v1, (void (*)())0x12275,
                      (void (*)())0x11f08, (void (*)())i_a1);
    abort();
    // UNREACHABLE
}
...
int32_t function_10868(void) {
    int32_t i_v1 = *(int32_t *)((int32_t)&i_g1 + (int32_t) "ething Wrong!\n" +
                                112); // 0x10874
    if (i_v1 == 0) {
...
// Address range: 0x11460 - 0x11f08
int32_t function_11460(int32_t *p_a1, int32_t *p_a2, int32_t *p_a3,
                       uint32_t i_a4, uint32_t i_a5, uint32_t i_a6) {
    // 0x11460
    int32_t i_v1; // bp-192, 0x11460
    function_122b4((int32_t)p_a1, &i_v1);
    ...
    struct _IO_FILE *p_v39 = fopen64("/usr/bin/fw_version", "w"); // 0x1190c
    if (p_v39 != NULL) {
        // 0x11920
        fwrite((int32_t *)(i_v6 + 13), 1, 8, p_v39);
        fclose(p_v39);
    }
    if (i_v11 != 0) {
        struct _IO_FILE *p_v40 =
            fopen64("/tmp/tmpfw/miner.pem", "w"); // 0x1195c
        if (p_v40 == NULL) {
            // 0x119b8
        ...
        // 0x11970
        fwrite((int32_t *)i_v36, 1, i_v35, p_v40);
        fclose(p_v40);
        struct _IO_FILE *p_v41 =
            fopen64("/tmp/tmpfw/miner.pem.sig", "w"); // 0x119a0
        if (p_v41 == NULL) {
            // 0x119f4
        ...
        // 0x119cc
        fwrite((int32_t *)i_v37, 1, 256, p_v41);
        fclose(p_v41);
    }
    // 0x11a08
    int32_t i_v42; // bp-2272, 0x11460
    memset(&i_v42, 0, 1056);
    int32_t i_v43; // bp-2384, 0x11460
    SHA256_Init(&i_v43);
    SHA256_Update(&i_v43, i_v6, 2048, &i_v43);
    SHA256_Final(&i_v42, &i_v43, &i_v43, &i_v42);
    int32_t i_v44 = &i_v42;
    if (i_v12 != 0) {
        int32_t i_v45 = i_v44 + 32;    // 0x11b38
        int32_t i_v46 = (int32_t)p_v4; // 0x11b8c
        for (int32_t i_v47 = 0; i_v47 < i_v21; i_v47++) {
            int32_t i_v48 = 5 * i_v47 + i_v6;              // 0x11a98
            unsigned char i_v49 = *(char *)(i_v48 + 1310); // 0x11aa4
            unsigned char i_v50 = *(char *)(i_v48 + 1311); // 0x11acc
            unsigned char i_v51 = *(char *)(i_v48 + 1312); // 0x11af4
            unsigned char i_v52 = *(char *)(i_v48 + 1313); // 0x11b20
            unsigned char i_v53 = *(char *)(i_v48 + 1309); // 0x11b6c
            function_10de8(i_v46,
                           0x10000 * (int32_t)i_v50 |
                               0x1000000 * (int32_t)i_v49 |
                               256 * (int32_t)i_v51 | (int32_t)i_v52,
                           i_v45 + 32 * i_v47, (int32_t)i_v53, 0, i_v11);
        }
        int32_t i_v54 = 0;
        int32_t i_v55 = i_v54 + 1;
        unsigned char i_v56 = *(char *)(i_v6 + 1309 + 5 * i_v54); // 0x11c00
        function_10de8(i_v46, 256, 32 * (i_v55 + i_v21) + i_v44, (int32_t)i_v56,
                       1, i_v11);
        while (i_v55 < i_v21) {
            // 0x11bbc
            i_v54 = i_v55;
            i_v55 = i_v54 + 1;
            i_v56 = *(char *)(i_v6 + 1309 + 5 * i_v54);
            function_10de8(i_v46, 256, 32 * (i_v55 + i_v21) + i_v44,
                           (int32_t)i_v56, 1, i_v11);
        }
    }
    int32_t i_v57 = 0; // bp-2640, 0x11c48
    int32_t i_v58;     // bp-2636, 0x11460
    memset(&i_v58, 0, 252);
    fseek(p_v4, -256, SEEK_END);
    fread(&i_v57, 256, 1, p_v4);
    int32_t i_v59 = 0; // bp-2672, 0x11c98
    int32_t i_v60;     // bp-2784, 0x11460
    SHA256_Init(&i_v60);
    SHA256_Update(&i_v60, i_v44, 64 * i_v21 | 32, &i_v60);
    SHA256_Final(&i_v59, &i_v60, &i_v60, &i_v59);
    int32_t i_v61 = BIO_new_mem_buf(i_v36, 1024);            // 0x11d50
    int32_t i_v62 = PEM_read_bio_RSA_PUBKEY(i_v61, 0, 0, 0); // 0x11d68
    if (i_v62 == 0) {
        // 0x11d7c
        printf("OpenSSL error: %s\n",
               (char *)ERR_error_string(ERR_get_error(0), 0));
    ...
    int32_t i_v63 =
        RSA_verify(672, &i_v59, 32, (int32_t)&i_v57, 256, i_v62); // 0x11de8
    RSA_free(i_v62);
    if (i_v61 != 0) {
        // 0x11e10
        BIO_free(i_v61);
    ...
    if (i_v63 != 1) {
        int32_t i_v64 =
            ERR_get_error(puts("Check File Sig failed!\r")); // 0x11e30
        printf("OpenSSL error: %s\n", (char *)ERR_error_string(i_v64, 0));
        // 0x11efc
        return 18;
    }
    // 0x11e6c
    ...
    if (i_a5 % 256 != 0) {
        ...
        int32_t i_v65 = 0; // bp-3044, 0x11ea4
        int32_t i_v66;     // bp-3040, 0x11460
        memset(&i_v66, 0, 253);
        memcpy(&i_v65, (int32_t *)(i_v6 + 1360), 256);
        puts((char *)&i_v65);
    }
    // 0x11efc
    return 0;
...
int32_t function_11f08(uint32_t i_a1, int32_t i_a2) {
    ...
    int32_t *p_v1 = (int32_t *)(i_a2 + 4); // 0x11f48
    if (*(char *)*p_v1 != 45) {
        // 0x12268
        return 2;
    }
    int32_t i_v2 = 0; // bp-144, 0x11f74
    int32_t i_v3;     // bp-140, 0x11f08
    memset(&i_v3, 0, 124);
    int32_t i_v4 = 0; // bp-272, 0x11f90
    int32_t i_v5;     // bp-268, 0x11f08
    memset(&i_v5, 0, 124);
    int32_t i_v6; // bp-2320, 0x11f08
    memset(&i_v6, 0, 2048);
    int32_t i_v7; // bp-2576, 0x11f08
    memset(&i_v7, 0, 253);
    switch (i_a1) {
    case 5: {
        int32_t *p_v8 = (int32_t *)(i_a2 + 12); // 0x12014
        uint32_t i_v9 = strlen((char *)*p_v8);  // 0x1201c
        ...
        int32_t *p_v10 = (int32_t *)(i_a2 + 16); // 0x12064
        uint32_t i_v11 = strlen((char *)*p_v10); // 0x1206c
    ...
    case 2: {
    lab_0x12140:;
        unsigned char i_v12 = *(char *)(*p_v1 + 1); // 0x12158
        i_g6 = (int32_t)i_v12 - 102;
        char i_v13 = 0;    // 0x12164
        char i_v14 = 1;    // 0x12164
        int32_t i_v15 = 0; // 0x12164
        int32_t i_v16 = 0; // 0x12164
        char i_v17 = 0;    // 0x12164
        char i_v18 = 0;    // 0x12164
        int32_t i_v19;     // 0x11f08
        switch (i_v12) {
        case 120: {
            // 0x121d4
            i_v13 = 1;
    ...
    case 3: {
        int32_t *p_v21 = (int32_t *)(i_a2 + 8);  // 0x120c4
        uint32_t i_v22 = strlen((char *)*p_v21); // 0x120cc
...
// Address range: 0x12274 - 0x122a8
int32_t function_12274(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    int32_t i_v1 = function_106e8(i_a1, i_a2, i_a3, i_a4); // 0x12284
    return 0x22f0a - (int32_t)&i_g2 >> 2 == 0 ? i_v1 : i_a1;
}

// Address range: 0x122b0 - 0x122b2
int32_t function_122b0(void) {
    // 0x122b0
    int32_t i_v1; // 0x122b0
    return i_v1;
}

// Address range: 0x122b4 - 0x122b8
int32_t function_122b4(int32_t i_a1, int32_t *p_a2) {
    // 0x122b4
    return i_a1;
}

// Address range: 0x122b8 - 0x122be
int32_t function_122b8(void) {
    // 0x122b8
    int32_t i_v1; // 0x122b8
    return __xstat64(3, (char *)i_v1, (struct stat64 *)i_v1);
}

// Address range: 0x122c0 - 0x122c8
int32_t function_122c0(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    // 0x122c0
    return i_a1;
}
