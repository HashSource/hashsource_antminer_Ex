...
int32_t function_10da0(int32_t i_a1) {
    ...
    memset(&i_v1, 0, 64);
    sprintf((char *)&i_v1, "echo %d > /sys/class/gpio/gpio%d/value", i_a1, 943);
    system((char *)&i_v1);
    sprintf((char *)&i_v1, "echo %d > /sys/class/gpio/gpio%d/value", i_a1, 944);
...
int32_t function_10e1c(void) {
    ...
    memset(&i_v1, 0, 64);
    sprintf((char *)&i_v1, "/sys/class/gpio/gpio%d", 957);
    ...
    // 0x10eb8
    sprintf((char *)&i_v1, "/sys/class/gpio/gpio%d/value", 957);
