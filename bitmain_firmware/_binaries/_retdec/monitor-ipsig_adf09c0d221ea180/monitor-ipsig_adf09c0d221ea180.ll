...
@global_var_1177c = constant [9 x i8] c"21:00:08\00"
@global_var_11788 = constant [12 x i8] c"Mar 13 2023\00"
...
; uselistorder directives
  ...
  uselistorder i32 (i32, i32, ...)* @ioctl, { 2, 0, 1, 3 }
...
dec_label_pc_10da0:
  ...
  %2 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %1, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @global_var_115dc, i32 0, i32 0), i32 %arg1, i32 943), !insn.addr !155
  %3 = call i32 @system(i8* nonnull %1), !insn.addr !156
  %4 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %1, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @global_var_115dc, i32 0, i32 0), i32 %arg1, i32 944), !insn.addr !157
...
dec_label_pc_10e1c:
  ...
  %2 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @global_var_11604, i32 0, i32 0), i32 957), !insn.addr !163
...
dec_label_pc_10e78:                               ; preds = %dec_label_pc_10e5c
  %7 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @global_var_11618, i32 0, i32 0), i32 957), !insn.addr !170
...
dec_label_pc_10eb8:                               ; preds = %dec_label_pc_10f28, %dec_label_pc_10eb0, %dec_label_pc_10e1c
  %12 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @global_var_11664, i32 0, i32 0), i32 957), !insn.addr !176
...
dec_label_pc_10f58:
  ...
  %spec.select = select i1 %1, i32 943, i32 944
...
; uselistorder directives
  ...
  uselistorder i32* (i32*, i32, i32)* @memset, { 3, 2, 1, 5, 0, 4, 6, 7 }
}
