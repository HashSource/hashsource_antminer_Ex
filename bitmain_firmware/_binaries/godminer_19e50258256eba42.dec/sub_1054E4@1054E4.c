int __fastcall sub_1054E4(int a1, __int16 a2, __int16 a3, char a4, _BYTE *a5)
{
  int v5; // r3
  unsigned int v6; // r0
  int v7; // r5
  ...
  logfmt_raw(
    ...
    v25,
    "%s core_num %d",
    "ChipSetting_check_2282_dag_reg_ETH",
    v40);
  V_UNLOCK();
  zlog(
    g_zc,
