int __fastcall sub_156A54(int a1)
{
  int v2; // [sp+4h] [bp-10A8h]
  _BYTE v4[48]; // [sp+3Ch] [bp-1070h] BYREF
  ...
  zlog(
    ...
    150,
    "ChipSetting_start_nonce_offset_HNS_2130",
    39,
    883,
    20,
    v4);
  ...
  for ( i = 0; i <= 1; ++i )
  {
    ...
    (*(void (__fastcall **)(int, _WORD *, _DWORD, void *, int *, int, int, _DWORD))(a1 + 316))(
      a1,
      s,
      *(_DWORD *)(a1 + 372),
      ptr,
