int __fastcall open_cores_by_work_num_rvn(int a1)
{
  ...
  V_LOCK();
  logfmt_raw(v10, 0x1000u, 0, "%s...", "open_cores_by_work_num_rvn");
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  memcpy(
    ...
    "c851a8b84eddf42356e6dbccdc582de589e03aa396771b661fbd854365b3400d6fe3434ed512083a36ee6943018127e3id_map is null",
    sizeof(v12));
  sub_1B4A74(a1, 29, 0);
  s = calloc(1u, 0x59u);
  for ( i = 0; i <= 0xF; ++i )
