int __fastcall sub_168124(int a1)
{
  int v3; // [sp+4h] [bp-10F8h]
  _BYTE v5[60]; // [sp+40h] [bp-10BCh] BYREF
  ...
  zlog(
    ...
    150,
    "ChipSetting_hash_clock_count_KAS_2380",
    37,
    1006,
    20,
    v5);
  ...
  if ( v19 >= 0 )
  {
    ...
    LOBYTE(s[3]) = 0;
    v20 = 0;
    v18 = *(_DWORD *)(a1 + 376) * *(_DWORD *)(a1 + 372);
    ptr = malloc(12 * v18);
    memset(ptr, 0, 12 * v18);
