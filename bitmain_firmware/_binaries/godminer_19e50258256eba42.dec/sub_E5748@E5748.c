int __fastcall sub_E5748(int a1, __int16 a2, unsigned __int16 a3, __int16 a4, void *dest)
{
  int v5; // r5
  int v6; // r6
  int v7; // r7
  ...
  logfmt_raw(
    ...
    v19,
    "%s core_num %d",
    "ChipSetting_get_num_core_status_eth_2282_DASH_1766",
    a3);
  V_UNLOCK();
  zlog(
    g_zc,
