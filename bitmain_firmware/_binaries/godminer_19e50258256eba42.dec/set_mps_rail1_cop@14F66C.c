int __fastcall set_mps_rail1_cop(int a1, char a2, unsigned __int16 a3, unsigned __int8 a4)
{
  char v4; // r0
  ...
  do
  {
    if ( get_mps_rail1_cop(a1, a2, &v11) )
    {
      ++v13;
      goto LABEL_8;
    }
    ...
    {
      V_LOCK();
      logfmt_raw(v10, 0x1000u, 0, "mps cop r1 is already set to %d", a4 * a3);
      V_UNLOCK();
      zlog(
        g_zc,
...
LABEL_8:
  ...
  {
    V_LOCK();
    logfmt_raw(v10, 0x1000u, 0, "set_mps_cop_r1 error, fd %d, which %d", a1, (unsigned __int8)a2);
    V_UNLOCK();
    zlog(
      g_zc,
