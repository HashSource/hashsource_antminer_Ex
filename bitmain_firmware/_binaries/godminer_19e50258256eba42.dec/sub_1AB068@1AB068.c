int __fastcall sub_1AB068(int a1, char a2)
{
  _BYTE v5[24]; // [sp+1Ch] [bp-1018h] BYREF
  _DWORD s[4]; // [sp+101Ch] [bp-18h] BYREF

  V_LOCK();
  logfmt_raw(v5, 0x1000u, 0, "software_reset %s %02x", "ChipSetting_software_reset_one_asic_RVN", 252);
  V_UNLOCK();
  zlog(
    g_zc,
    ...
    150,
    "ChipSetting_software_reset_one_asic_RVN",
    39,
    193,
    20,
    v5);
