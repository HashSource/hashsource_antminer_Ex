int __fastcall sub_1CD504(int a1, int a2, int a3, int a4, int *a5, _DWORD *a6, int a7)
{
  ...
  *a6 = 0;
  *a5 = -64;
  v29 = sub_1CCF68(a1, 0, a7, a2, a4, a3, &s, &v15, 1);
  if ( s >= 0 )
  {
    if ( (s & 0x40000000) != 0 )
    {
      V_LOCK();
      sub_1C61DC((int)v19, *(int *)(a1 + 272));
      logfmt_raw(
        v14,
        0x1000u,
        0,
      ...
      zlog(
        ...
        150,
        "ChipSetting_sensor_temp_config_slt_eth_2282_RVN",
        47,
        1294,
        100,
        v14);
