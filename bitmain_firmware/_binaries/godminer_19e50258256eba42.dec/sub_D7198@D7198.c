int __fastcall sub_D7198(int a1, char a2, unsigned __int8 a3)
{
  int v3; // r5
  int v4; // r6
  int v5; // r7
  ...
  V_LOCK();
  logfmt_raw(v11, 0x1000u, 0, "%s response_num %d", "ChipSetting_get_single_core_status_CKB_2042", v12);
  V_UNLOCK();
  zlog(
    g_zc,
    ...
    150,
    "ChipSetting_get_single_core_status_CKB_2042",
    43,
    2147,
    40,
    v11);
  for ( i = 0; i < v12; ++i )
  {
    ...
    v5 = sub_CA9FC(*((_WORD *)ptr + 6 * i + 3));
    v6 = sub_CA9D4(*((_DWORD *)ptr + 3 * i));
    logfmt_raw(
      v11,
      0x1000u,
      0,
