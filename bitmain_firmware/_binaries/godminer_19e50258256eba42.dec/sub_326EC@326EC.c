int __fastcall sub_326EC(json_t *a1, int a2, char *a3)
{
  _BYTE v6[28]; // [sp+20h] [bp-105Ch] BYREF
  ...
  if ( v7 > 0 )
  {
    if ( v13 && a1 )
    {
      sub_2DE54(a1, 1, 81, *(const char **)(v13 + 8));
      if ( v14 && *v14 )
      {
        nptr = v14;
        ...
        zlog(
          ...
          40,
          v6);
        set_remain_debug_print_lines(all_created_runtime[v10] + 1072, v9);
