int __fastcall iic_read_reg_e11(int a1, unsigned __int8 *a2, int a3, int a4, unsigned int a5, int a6)
{
  char v12[2048]; // [sp+20h] [bp-1804h] BYREF
  int v13; // [sp+820h] [bp-1004h] BYREF
  int reg_e11; // [sp+1828h] [bp+4h]
  ...
  {
    reg_e11 = i2c_read_reg_e11(a1, a2, a3, a4, a5, a6);
