int __fastcall set_miner_6060info_runtime_bad_asic_err(int a1, char a2)
{
  ...
  byte_5AD6D8[8 * v4 + 216] = a2;
  tv.tv_sec = 0;
  tv.tv_usec = 0;
  if ( byte_5AD6D8[8 * v4 + 216] )
  {
    gettimeofday(&tv, 0);
    *(_DWORD *)&byte_5AD6D8[8 * v4 + 220] = tv.tv_sec;
  }
  if ( byte_5AD8C8[8 * v4 + 216] != 1 && byte_5AD6D8[8 * v4 + 216] )
  {
    snprintf(v5, 0x80u, "J%d:1", v4);
    V_LOCK();
  ...
  byte_5AD8C8[8 * v4 + 216] = byte_5AD6D8[8 * v4 + 216];
