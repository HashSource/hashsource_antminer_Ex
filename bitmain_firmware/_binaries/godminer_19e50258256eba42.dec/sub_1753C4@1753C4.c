int __fastcall sub_1753C4(int a1, unsigned int a2)
{
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v6, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_KDA_2110", a2);
  V_UNLOCK();
  zlog(
    g_zc,
