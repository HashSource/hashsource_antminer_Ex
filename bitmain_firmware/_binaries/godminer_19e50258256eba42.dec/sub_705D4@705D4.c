int __fastcall sub_705D4(int a1, int *a2, const json_t *a3)
{
  json_t *v3; // r0
  json_t *v4; // r0
  json_t *v5; // r0
  ...
  if ( (unsigned __int8)valid_ascii(s2) == 1 && src )
  {
    if ( v19 )
    {
      ...
      v9 = strdup(s2);
      v19[281] = (int)v9;
      LODWORD(v10) = sub_6E914(src, HIDWORD(src));
      v23 = v10;
      src = v10;
      memcpy(v19 + 2, &src, 8u);
      for ( k = 0; k <= 3; ++k )
      {
        LODWORD(v11) = sub_6E914(v18[2 * k - 1], v18[2 * k]);
        v23 = v11;
  ...
  else
  {
    ...
    zlog(
      ...
      "_godminer-new/frontend/frontend_ks5/frontend_ks5.c",
      164,
      "stratum_notify_ks5",
      18,
      387,
