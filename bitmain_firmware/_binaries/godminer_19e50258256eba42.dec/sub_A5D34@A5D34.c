int __fastcall sub_A5D34(int a1, __int64 *a2)
{
  int *v2; // r2
  int v3; // r1
  ...
  unsigned __int8 *v15; // [sp+DCh] [bp-8h]

  v15 = (unsigned __int8 *)*((_DWORD *)a2 + 283);
  v14 = a2 + 1;
  v13 = 0;
  v7 = *a2;
  ...
  memcpy((char *)&v7 + 64 - *v15, v15 + 9, *v15 - 5);
  v12 = (double)(unsigned int)target_to_diff_ks5((int)(a2 + 129));
  *(_DWORD *)(a1 + 532) = 0;
