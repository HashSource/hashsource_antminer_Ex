int __fastcall sub_1A36BC(int a1, char a2, unsigned __int8 a3)
{
  int v3; // r5
  int v4; // r6
  int v5; // r7
  ...
  LOBYTE(s[6]) = a2;
  memset(ptr, 0, 0x5A0u);
  (*(void (__fastcall **)(int, _WORD *, int, void *, int *))(a1 + 336))(a1, s, 120, ptr, &v12);
  V_LOCK();
  logfmt_raw(v11, 0x1000u, 0, "%s response_num %d", "ChipSetting_get_single_core_status_LTC_1489", v12);
  V_UNLOCK();
  zlog(
    g_zc,
    ...
    152,
    "ChipSetting_get_single_core_status_LTC_1489",
    43,
    2147,
    40,
    v11);
  for ( i = 0; i < v12; ++i )
  {
    ...
    v5 = sub_197CBC(*((_WORD *)ptr + 6 * i + 3));
    v6 = sub_197C94(*((_DWORD *)ptr + 3 * i));
    logfmt_raw(
      v11,
      0x1000u,
      0,
