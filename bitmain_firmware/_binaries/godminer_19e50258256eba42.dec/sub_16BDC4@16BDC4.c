int __fastcall sub_16BDC4(int a1, __int16 a2, __int16 a3, int a4, _BYTE *a5)
{
  int v5; // r3
  unsigned int v6; // r0
  ...
  logfmt_raw(
    ...
    v17,
    "%s core_num %d",
    "ChipSetting_check_2282_fake_dag_reg_KAS_2380",
    v22);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  if ( !v18 && v22 == v14 )
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( i >= v22 )
        break;
      if ( a4 != sub_162700(v19[3 * i]) )
      {
        V_LOCK();
        v6 = sub_162700(v19[3 * i]);
