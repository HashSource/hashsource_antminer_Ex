int __fastcall sub_E4EA0(int a1, char a2, char a3, int a4, void *dest)
{
  int v5; // r3
  ...
  src = malloc(0x5E8u);
  memset(src, 0, 0x5E8u);
  (*(void (__fastcall **)(int, _WORD *, int, void *, int *))(a1 + 316))(a1, s, 126, src, &v12);
  for ( i = 0; i < v12; ++i )
  {
    if ( a4 == *((unsigned __int16 *)src + 6 * i + 3) )
    {
      ...
      zlog(
        ...
        150,
        "ChipSetting_get_chip_status_rvn_DASH_1766",
        41,
        1728,
        40,
        v11);
