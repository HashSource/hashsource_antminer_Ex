int __fastcall sub_199C64(int a1, int a2, char a3)
{
  _BYTE v7[24]; // [sp+4Ch] [bp-1098h] BYREF
  ...
  ptr = malloc(0xCu);
  memset(ptr, 0, 0xCu);
  (*(void (__fastcall **)(int, _DWORD *, int, void *, int *))(a1 + 336))(a1, s, 1, ptr, &v9);
  for ( i = 0; i < v9; ++i )
  {
    if ( *((_WORD *)ptr + 6 * i + 3) == 255 )
    {
      V_LOCK();
      sub_1978B0((int)v10, *(int *)(a1 + 272));
      logfmt_raw(
        v7,
        0x1000u,
        0,
        ...
        "ChipSetting_same_nonce_LTC_1489",
  ...
  LOBYTE(s[3]) = -1;
  s[0] = v21;
  v19 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 300))(a1, s);
  if ( v19 < 0 )
  {
    V_LOCK();
    sub_1978B0((int)v14, *(int *)(a1 + 272));
    logfmt_raw(
      v7,
      0x1000u,
      0,
