int __fastcall sub_18565C(int a1, unsigned int a2)
{
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v6, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_KS5_2382", a2);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  {
    V_LOCK();
    sub_184FA8((int)v15, *(int *)(a1 + 272));
    sub_184F70(v17, "asic num error");
    logfmt_raw(
      v6,
      0x1000u,
      0,
