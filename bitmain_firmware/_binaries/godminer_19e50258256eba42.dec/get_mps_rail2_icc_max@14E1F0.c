int __fastcall get_mps_rail2_icc_max(int a1, char a2, unsigned __int16 *a3)
{
  char v3; // r0
  char v4; // r0
  char v5; // r0
  ...
  *a3 = -1;
  ...
  else
  {
    ...
    else if ( v11[0] == 2 )
    {
      ...
      else
      {
        ...
        *a3 = v12;
        V_LOCK();
        logfmt_raw(v10, 0x1000u, 0, "chain-%d get_mps_rail2_icc_max: %u", a1, *a3);
        V_UNLOCK();
        zlog(
          g_zc,
  ...
  {
    V_LOCK();
    logfmt_raw(v10, 0x1000u, 0, "get_mps_rail2_icc_max error, fd %d", a1);
    V_UNLOCK();
    zlog(
      g_zc,
