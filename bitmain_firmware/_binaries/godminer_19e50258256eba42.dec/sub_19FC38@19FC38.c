int __fastcall sub_19FC38(int a1, __int16 a2, __int16 a3, char a4, _BYTE *a5)
{
  int v5; // r3
  unsigned int v6; // r0
  int v7; // r5
  ...
  v40 = *(_DWORD *)(a1 + 464);
  if ( a2 == 255 )
    v40 = 117 * *(_DWORD *)(a1 + 464);
  V_LOCK();
  sub_1978B0((int)v24, *(int *)(a1 + 272));
  logfmt_raw(
    v21,
    0x1000u,
    0,
    ...
    v25,
    "%s core_num %d",
    "ChipSetting_check_2282_dag_reg_LTC_1489",
    v40);
  V_UNLOCK();
  zlog(
    g_zc,
