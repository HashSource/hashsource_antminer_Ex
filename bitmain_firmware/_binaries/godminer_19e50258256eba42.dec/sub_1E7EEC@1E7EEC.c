int __fastcall sub_1E7EEC(int a1, int a2, int a3, int a4, int *a5, _DWORD *a6, int a7)
{
  ...
  *a6 = 0;
  *a5 = -64;
  v29 = sub_1E7950(a1, 0, a7, a2, a4, a3, &s, &v15, 1);
  if ( s >= 0 )
  {
    if ( (s & 0x40000000) != 0 )
    {
      ...
      zlog(
        ...
        150,
        "ChipSetting_sensor_temp_config_slt_eth_2282_ZEC_1746",
        52,
        1294,
        100,
        v14);
