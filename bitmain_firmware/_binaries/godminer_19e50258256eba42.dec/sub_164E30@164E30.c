bool __fastcall sub_164E30(int a1, int a2, int *a3)
{
  const char *v3; // r3
  ...
  for ( i = 0; i < v10; ++i )
  {
    if ( *((_WORD *)ptr + 6 * i + 3) == 255 )
    {
      ...
      zlog(
        ...
        150,
        "ChipSetting_nonce_counter_KAS_2380",
        34,
        484,
        20,
        v8);
