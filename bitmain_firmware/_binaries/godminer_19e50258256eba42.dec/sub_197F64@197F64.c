int __fastcall sub_197F64(int a1, unsigned int a2)
{
  int v3; // [sp+4h] [bp-1618h]
  _BYTE v6[64]; // [sp+5Ch] [bp-15C0h] BYREF
  ...
  const char *v17[8]; // [sp+15D0h] [bp-4Ch] BYREF
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v6, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_LTC_1489", a2);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  ptr = malloc(12 * a2);
  memset(ptr, 0, 12 * a2);
  (*(void (__fastcall **)(int, _WORD *, unsigned int, void *, int *, int, int, _DWORD))(a1 + 316))(
    a1,
    v10,
    a2,
    ptr,
  ...
  for ( i = 0; i < v9; ++i )
  {
    ...
    zlog(
      ...
      20,
      v6);
    if ( v23 == *(_DWORD *)(a1 + 364) )
    {
      v18 = (unsigned int)*((unsigned __int8 *)ptr + 12 * i + 4) / *(_DWORD *)(a1 + 468);
      ++s[v18];
      ++v24;
      V_LOCK();
      sub_1978B0((int)v13, *(int *)(a1 + 272));
      logfmt_raw(
        v6,
        0x1000u,
        0,
  ...
  if ( v24 < *(_DWORD *)(a1 + 372) )
  {
    V_LOCK();
    sub_1978B0((int)v15, *(int *)(a1 + 272));
    sub_197878(v17, "asic num error");
    logfmt_raw(
      v6,
      0x1000u,
      0,
