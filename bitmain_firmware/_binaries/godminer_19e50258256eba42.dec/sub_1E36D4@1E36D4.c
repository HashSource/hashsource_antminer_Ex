bool __fastcall sub_1E36D4(int a1, int a2, int *a3)
{
  const char *v3; // r3
  ...
  for ( i = 0; i < v10; ++i )
  {
    ...
    {
      v9 = 0;
      sub_1E0F20(&v9, *(_DWORD *)ptr);
      v25 += v9;
      V_LOCK();
      sub_1E0BC0((int)v12, *(int *)(a1 + 272));
      logfmt_raw(
        v8,
        0x1000u,
        0,
      ...
      zlog(
        ...
        150,
        "ChipSetting_nonce_counter_ZEC_1746",
        34,
        484,
        20,
        v8);
