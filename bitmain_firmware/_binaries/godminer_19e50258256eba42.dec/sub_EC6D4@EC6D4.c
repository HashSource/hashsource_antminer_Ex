int __fastcall sub_EC6D4(int a1, unsigned int a2)
{
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v6, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_DCR_1727", a2);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  {
    V_LOCK();
    sub_EC020((int)v15, *(int *)(a1 + 272));
    sub_EBFE8(v17, "asic num error");
    logfmt_raw(
      v6,
      0x1000u,
      0,
