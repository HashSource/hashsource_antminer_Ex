int __fastcall sub_18A170(int a1, int a2)
{
  int v4; // [sp+4h] [bp-10F8h]
  _BYTE v7[60]; // [sp+40h] [bp-10BCh] BYREF
  ...
  zlog(
    ...
    150,
    "ChipSetting_clock_delay_KS5_2382",
    32,
    911,
    40,
    v7);
  ...
  LOBYTE(s[3]) = -1;
  s[0] = a2;
  v21 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 300))(a1, s);
  if ( v21 >= 0 )
  {
    usleep((__useconds_t)&stru_186A0);
    LOBYTE(s[3]) = 0;
    v22 = 0;
    v20 = *(_DWORD *)(a1 + 376) * *(_DWORD *)(a1 + 372);
    ptr = malloc(12 * v20);
    memset(ptr, 0, 12 * v20);
