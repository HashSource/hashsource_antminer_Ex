int __fastcall sub_108B84(int a1, char a2, __int16 a3, __int16 a4, void *dest)
{
  ...
  V_LOCK();
  logfmt_raw(v10, 0x1000u, 0, "%s core_no %d response_num %d", "ChipSetting_get_single_chip_core_status_ETH", v17, v11);
  V_UNLOCK();
  zlog(
    g_zc,
