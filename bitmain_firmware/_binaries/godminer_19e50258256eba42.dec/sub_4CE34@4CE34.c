int __fastcall sub_4CE34(unsigned __int8 *a1, unsigned int a2, int a3)
{
  int v3; // r3
  unsigned int v5; // [sp+8h] [bp-2Ch]
  unsigned __int8 *v6; // [sp+18h] [bp-1Ch]
  unsigned __int16 *v7; // [sp+1Ch] [bp-18h]
  unsigned __int8 *v8; // [sp+20h] [bp-14h]
...
LABEL_54:
  ...
  else
  {
    ...
    while ( v5 > 0xC )
    {
      v25 = v24 + *((_DWORD *)v8 + 1);
      v10 = v9 + *((_DWORD *)v8 + 2);
      v40 = __ROR4__(v10, 28) ^ (v39 + *(_DWORD *)v8 - v10);
      v11 = v10 + v25;
    ...
    switch ( v5 )
    {
      case 0u:
        ...
        break;
      case 1u:
        v43 = v39 + (unsigned __int8)*(_DWORD *)v8;
        goto LABEL_54;
      case 2u:
        v43 = v39 + (unsigned __int16)*(_DWORD *)v8;
        goto LABEL_54;
      case 3u:
        v43 = v39 + (*(_DWORD *)v8 & 0xFFFFFF);
        goto LABEL_54;
      case 4u:
        v43 = v39 + *(_DWORD *)v8;
        goto LABEL_54;
