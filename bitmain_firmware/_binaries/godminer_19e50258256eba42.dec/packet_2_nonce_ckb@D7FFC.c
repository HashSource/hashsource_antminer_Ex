int __fastcall packet_2_nonce_ckb(int a1, _BYTE *a2, int a3, _BYTE *a4, void *dest, _DWORD *a6, _DWORD *a7)
{
  int v8; // r0
  int v9; // r1
  unsigned int v10; // r2
  ...
  *a7 = *(_DWORD *)(v23 + 8 * v22);
  strcpy((char *)(v25 + 16), (const char *)(v23 + 32 * (v22 + 32)));
  memcpy((void *)(v25 + 48), (const void *)(v23 + 48 * v22 + 5120 + 32), 0x10u);
  memcpy((void *)(v25 + 58), v26 + 3, 7u);
  *(_BYTE *)(v25 + 65) = v22;
  ...
  *(_DWORD *)(v25 + 8) = *a6;
  v21 = (v26[7] << 6) & 0x40 | (v26[8] >> 2);
  v20 = v26[8] & 3;
  *(_DWORD *)(v25 + 12) = 4 * v21 + v20;
  v19 = 10;
  v18 = BM_CRC5(v26 + 2, 0x4Bu);
  v17 = v26[11] & 0x1F;
  if ( v18 == v17 || !*(_BYTE *)(a1 + 279) )
  {
    memcpy(dest, (const void *)(v25 + 48), 0x10u);
    *a4 = 1;
    return 0;
  }
  else
