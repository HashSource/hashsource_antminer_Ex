int __fastcall sub_16DDCC(int a1, __int16 a2, __int16 a3, void *a4)
{
  ...
  logfmt_raw(
    ...
    v18,
    "%s core_no %d",
    "ChipSetting_get_core_status_5chips_KAS_2380",
    v34);
  V_UNLOCK();
  zlog(
    g_zc,
