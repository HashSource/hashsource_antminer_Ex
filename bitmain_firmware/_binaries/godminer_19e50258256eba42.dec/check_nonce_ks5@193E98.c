int __fastcall check_nonce_ks5(int a1, int a2)
{
  ...
  if ( *(unsigned __int8 *)(a2 + 17) > 0x23u )
  {
    ...
    for ( i = 0; i <= 31; ++i )
      v7[31 - i] = v7[i + 32];
    v16 = target_to_diff_ks5((int)v7);
    if ( v16 > 0x23u )
    {
      if ( v16 < (unsigned int)v25
        || (unsigned __int8)sub_193DDC((int)v7, v19 + 32 * (*(unsigned __int8 *)(v20 + 16) + 260)) != 1 )
      {
        V_LOCK();
