int __fastcall sub_1EB0D4(int a1, char a2, char a3, int a4, void *dest)
{
  int v5; // r3
  ...
  src = malloc(0x48u);
  memset(src, 0, 0x48u);
  (*(void (__fastcall **)(int, _WORD *, int, void *, int *))(a1 + 316))(a1, s, 6, src, &v12);
  for ( i = 0; i < v12; ++i )
  {
    if ( a4 == *((unsigned __int16 *)src + 6 * i + 3) )
    {
      ...
      zlog(
        ...
        150,
        "ChipSetting_get_chip_status_rvn_ZEC_1746",
        40,
        1728,
        40,
        v11);
