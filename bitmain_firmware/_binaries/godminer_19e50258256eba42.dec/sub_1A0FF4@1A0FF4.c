int __fastcall sub_1A0FF4(int a1, char a2, char a3, int a4, void *dest)
{
  int v5; // r3
  _BYTE v11[72]; // [sp+44h] [bp-1048h] BYREF
  ...
  src = malloc(0x5A0u);
  memset(src, 0, 0x5A0u);
  (*(void (__fastcall **)(int, _WORD *, int, void *, int *))(a1 + 316))(a1, s, 120, src, &v12);
  for ( i = 0; i < v12; ++i )
  {
    if ( a4 == *((unsigned __int16 *)src + 6 * i + 3) )
    {
      ...
      zlog(
        ...
        152,
        "ChipSetting_get_chip_status_rvn_LTC_1489",
        40,
        1728,
        40,
        v11);
