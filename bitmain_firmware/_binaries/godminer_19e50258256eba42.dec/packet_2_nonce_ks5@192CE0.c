int __fastcall packet_2_nonce_ks5(int a1, unsigned __int8 *a2, int a3, _BYTE *a4, void *dest, _DWORD *a6, _DWORD *a7)
{
  int v8; // r1
  int v9; // r2
  int *v10; // r1
      ...
      *a7 = *(_DWORD *)(v24 + 8 * v23);
      if ( *a7 == -1 )
      {
        ...
        zlog(
          ...
          "igin_godminer-new/backend/backend_ks5_2382/backend_ks5_2382.c",
          171,
          "packet_2_nonce_ks5",
          18,
          291,
      ...
      else
      {
        ...
        *a4 = 1;
        ...
        memset(v19, 0, 0x800u);
        v22 = *(_DWORD *)(a1 + 264);
        if ( ++dword_C1D814[*(_DWORD *)(a1 + 264)] == 1000 )
        {
          dword_C1D814[*(_DWORD *)(a1 + 264)] = 0;
          ...
          if ( v35 > qword_C1D858[*(_DWORD *)(a1 + 264)] && v35 - qword_C1D858[*(_DWORD *)(a1 + 264)] <= 0x63 )
          {
            for ( j = 0; j < *(_DWORD *)(a1 + 372); ++j )
            {
              if ( v19[j] > qword_C1D8D8[256 * *(_DWORD *)(a1 + 264) + j]
                && v19[j] - qword_C1D8D8[256 * *(_DWORD *)(a1 + 264) + j] > 0x190u )
              {
                close_one_chip_cores_ks5(a1, j);
              }
            }
          }
          for ( k = 0; k < *(_DWORD *)(a1 + 372); ++k )
            qword_C1D8D8[256 * *(_DWORD *)(a1 + 264) + k] = v19[k];
          qword_C1D858[*(_DWORD *)(a1 + 264)] = v35;
        }
        return 0;
      }
    }
  ...
  else
  {
    v8 = *(_DWORD *)(a1 + 272);
    v9 = dword_C1D808[v8];
    dword_C1D808[v8] = v9 + 1;
    if ( v9 <= 9 )
    {
      V_LOCK();
      sub_184FA8((int)v20, *(int *)(a1 + 272));
      logfmt_raw(
        v19,
        0x1000u,
        0,
