int __fastcall sub_5DAD0(int a1, int a2, const json_t *a3, size_t a4)
{
  json_t *v4; // r0
  json_t *v5; // r0
  ...
  *(_DWORD *)(a2 + 80) = calloc(1u, *(_DWORD *)(a2 + 76));
  ...
  V_LOCK();
  logfmt_raw(v11, 0x1000u, 0, "save xnonce1 into work->xnonce2 to submit");
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  *(_DWORD *)(v13 + 1132) = calloc(1u, 0x10u);
  if ( *(_DWORD *)(v13 + 1132) )
  {
    v12 = *(size_t **)(v13 + 1132);
    *v12 = *(_DWORD *)(a2 + 76);
