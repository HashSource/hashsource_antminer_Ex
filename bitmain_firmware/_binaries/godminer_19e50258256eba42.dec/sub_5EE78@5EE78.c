int __fastcall sub_5EE78(int a1, int a2)
{
  json_t *v2; // r0
  _BOOL4 v3; // r3
  _BOOL4 v4; // r2
          ...
          if ( s1 && v20 && v19 && s )
          {
                ...
                || (*(_DWORD *)(a2 + 76) = strlen(s) >> 1, (*(_DWORD *)(a2 + 80) = calloc(1u, *(_DWORD *)(a2 + 76))) != 0) )
              {
                ...
                *(_WORD *)src = 0;
                ...
                zlog(
                  ...
                  "miner-origin_godminer-new/frontend/frontend_eth/frontend_eth.c",
                  164,
            ...
            else
            {
              ...
              zlog(
                ...
                "ner-origin_godminer-new/frontend/frontend_eth/frontend_eth.c",
                164,
                "stratum_parse_subscribe_reply_1",
                31,
                148,
