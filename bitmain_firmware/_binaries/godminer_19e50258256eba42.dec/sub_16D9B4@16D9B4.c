int __fastcall sub_16D9B4(int a1, char a2, __int16 a3, void *a4)
{
  int v4; // r5
  int v5; // r6
  int v6; // r7
  ...
  logfmt_raw(
    ...
    v18,
    "%s core_no %d",
    "ChipSetting_get_cache_done_status_rvn_KAS_2380",
    v23);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  for ( i = 0; i < v15; ++i )
  {
    ...
    v6 = sub_162728(*((_WORD *)src + 6 * i + 3));
    v7 = sub_162700(*((_DWORD *)src + 3 * i));
    logfmt_raw(
      v14,
      0x1000u,
      0,
