int __fastcall get_mps_rail1_cop(int a1, char a2, unsigned __int16 *a3)
{
  char v3; // r0
  char v4; // r0
  char v5; // r0
  ...
  *a3 = -1;
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        *a3 = v12;
        V_LOCK();
        logfmt_raw(v10, 0x1000u, 0, "chain-%d get_mps_rail1_cop: %04x", a1, *a3);
        V_UNLOCK();
        zlog(
          g_zc,
  ...
  {
    V_LOCK();
    logfmt_raw(v10, 0x1000u, 0, "get_mps_rail1_cop error, fd %d", a1);
    V_UNLOCK();
    zlog(
      g_zc,
