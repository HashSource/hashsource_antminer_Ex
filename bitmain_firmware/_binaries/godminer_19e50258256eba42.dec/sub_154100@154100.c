int __fastcall sub_154100(int a1, int a2, char a3)
{
  ...
  for ( i = 0; i < v9; ++i )
  {
    if ( *((_WORD *)ptr + 6 * i + 3) == 1 )
    {
      V_LOCK();
      sub_151C00((int)v10, *(int *)(a1 + 272));
      logfmt_raw(
        v7,
        0x1000u,
        0,
