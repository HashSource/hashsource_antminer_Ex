int __fastcall sub_8333C(int a1, char a2, __int16 a3, __int16 a4, char a5, _BYTE *a6)
{
  int v6; // r3
  unsigned int v7; // r0
  int v8; // r5
  ...
  if ( !v38 && v40 == v23 )
  {
    for ( i = 0; i < v40; ++i )
    {
      if ( a5 )
      {
        if ( a5 == 1 )
        {
          if ( (sub_7AED8(*((_DWORD *)ptr + 3 * i)) & 1) == 1 )
          {
            V_LOCK();
            sub_7AAF4((int)v33, *(int *)(a1 + 272));
            logfmt_raw(
              v22,
              0x1000u,
              0,
      ...
      {
        v37 = 2;
        v7 = sub_7AED8(*((_DWORD *)ptr + 3 * i));
        if ( (v37 & v7) >> 1 == 1 )
        {
          V_LOCK();
          sub_7AAF4((int)v29, *(int *)(a1 + 272));
          v8 = *((unsigned __int8 *)ptr + 12 * i + 4);
          v9 = *((unsigned __int8 *)ptr + 12 * i + 8);
          v10 = sub_7AED8(*((_DWORD *)ptr + 3 * i));
          logfmt_raw(
            v22,
            0x1000u,
            0,
