int __fastcall sub_10DE64(int a1, _DWORD *a2)
{
  ...
  zlog(
    ...
    20,
    v5);
  ++core_nonce[432 * *(_DWORD *)(a1 + 272) + 72 * a2[2] + a2[3]];
  return printf("0: header %s nonce %016llx mixhash %s\n", v7, *(_QWORD *)((char *)a2 + 26), v6);
}
