int __fastcall iic_write_eeprom_e11(int a1, _DWORD *a2, int a3, int a4, unsigned int a5, int a6)
{
  ...
  {
    v14 = i2c_write_eeprom_e11(a1, a2, a3, a4, a5, a6);
