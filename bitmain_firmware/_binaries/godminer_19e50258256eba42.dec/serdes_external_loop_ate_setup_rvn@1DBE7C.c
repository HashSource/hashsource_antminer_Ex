int __fastcall serdes_external_loop_ate_setup_rvn(int a1, unsigned __int8 a2, char a3, unsigned __int8 a4)
{
  _BYTE v9[12]; // [sp+30h] [bp-104Ch] BYREF
  _DWORD v10[7]; // [sp+1030h] [bp-4Ch] BYREF
  int v11; // [sp+104Ch] [bp-30h]
  _DWORD v12[7]; // [sp+1050h] [bp-2Ch] BYREF
  int v13; // [sp+106Ch] [bp-10h]
