int __fastcall sub_1522B4(int a1, unsigned int a2)
{
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v6, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_HNS_2130", a2);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  {
    V_LOCK();
    sub_151C00((int)v15, *(int *)(a1 + 272));
    sub_151BC8(v17, "asic num error");
    logfmt_raw(
      v6,
      0x1000u,
      0,
