int __fastcall sub_1ED76C(int a1, char a2, unsigned __int8 a3)
{
  int v3; // r5
  int v4; // r6
  int v5; // r7
  ...
  LOBYTE(s[6]) = a2;
  memset(ptr, 0, 0x48u);
  (*(void (__fastcall **)(int, _WORD *, int, void *, int *))(a1 + 336))(a1, s, 6, ptr, &v12);
  V_LOCK();
  logfmt_raw(v11, 0x1000u, 0, "%s response_num %d", "ChipSetting_get_single_core_status_ZEC_1746", v12);
  V_UNLOCK();
  zlog(
    g_zc,
    ...
    150,
    "ChipSetting_get_single_core_status_ZEC_1746",
    43,
    2147,
    40,
    v11);
  ...
  {
    V_LOCK();
    sub_1E0BC0((int)v14, *(int *)(a1 + 272));
    v3 = *((unsigned __int8 *)ptr + 12 * i + 4);
    v4 = *((unsigned __int8 *)ptr + 12 * i + 8);
    v5 = sub_1E0FCC(*((_WORD *)ptr + 6 * i + 3));
    v6 = sub_1E0FA4(*((_DWORD *)ptr + 3 * i));
    logfmt_raw(
      v11,
      0x1000u,
      0,
