int __fastcall get_mps_result(int a1, char a2, unsigned __int16 *a3)
{
  char v3; // r0
  char v4; // r0
  char v5; // r0
  ...
  *a3 = -1;
  ...
  else
  {
    ...
    else if ( v11[0] == 1 )
    {
      ...
      else
      {
        ...
        *a3 = v12;
        V_LOCK();
        logfmt_raw(v10, 0x1000u, 0, "chain-%d get_mps_result: %u", a1, v12, v12);
        V_UNLOCK();
        zlog(
          g_zc,
  ...
  {
    V_LOCK();
    logfmt_raw(v10, 0x1000u, 0, "get_mps_result error, fd %d", a1);
    V_UNLOCK();
    zlog(
      g_zc,
