unsigned int __fastcall sub_1B3EC4(int a1, int a2, void *a3)
{
  int v3; // r5
  int v4; // r6
  unsigned int v5; // r0
  ...
  src = malloc(0x60u);
  memset(src, 0, 0x60u);
  (*(void (__fastcall **)(int, _WORD *, int, void *, unsigned int *))(a1 + 316))(a1, s, 8, src, &v12);
  for ( i = 0; i < (int)v12; ++i )
  {
