unsigned int __fastcall sub_E48BC(int a1, int a2, void *a3)
{
  int v3; // r5
  int v4; // r6
  unsigned int v5; // r0
  ...
  src = malloc(0x5E8u);
  memset(src, 0, 0x5E8u);
  (*(void (__fastcall **)(int, _WORD *, int, void *, unsigned int *))(a1 + 316))(a1, s, 126, src, &v12);
  for ( i = 0; i < (int)v12; ++i )
  {
    if ( a2 == *((unsigned __int16 *)src + 6 * i + 3) )
    {
      ...
      zlog(
        ...
        150,
        "ChipSetting_get_chip_status_DASH_1766",
        37,
        1674,
        20,
        v11);
