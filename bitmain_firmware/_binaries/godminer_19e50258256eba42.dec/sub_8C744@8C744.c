bool __fastcall sub_8C744(int a1, int a2, int *a3)
{
  const char *v3; // r3
  int v5; // [sp+4h] [bp-1108h]
  _BYTE v8[68]; // [sp+48h] [bp-10C4h] BYREF
  ...
  v27 = 0;
  v26 = 0;
  if ( a2 == -1 || a2 > *(_DWORD *)(a1 + 372) )
    v26 = 0;
  else
    v26 = *(_BYTE *)(*(_DWORD *)(a1 + 528) + a2);
  memset(s, 0, sizeof(s));
  LOBYTE(s[2]) = 0;
  BYTE1(s[2]) = v26;
  HIWORD(s[2]) = 255;
  ptr = malloc(0xCu);
  memset(ptr, 0, 0xCu);
  (*(void (__fastcall **)(int, _DWORD *, int, void *, int *))(a1 + 316))(a1, s, 1, ptr, &v10);
  for ( i = 0; i < v10; ++i )
  {
    if ( *((_WORD *)ptr + 6 * i + 3) == 255 )
    {
      v9 = 0;
      sub_89F90(&v9, *(_DWORD *)ptr);
      v25 += v9;
      V_LOCK();
      sub_89C30((int)v12, *(int *)(a1 + 272));
      logfmt_raw(
        v8,
        0x1000u,
        0,
      ...
      zlog(
        ...
        150,
        "ChipSetting_nonce_counter_KS5_2382",
        34,
        484,
        20,
        v8);
