int __fastcall sub_163998(int a1, unsigned __int8 a2, int a3)
{
  _BYTE v7[68]; // [sp+40h] [bp-1044h] BYREF
  ...
  zlog(
    ...
    150,
    "ChipSetting_io_drive_strenth_KAS_2380",
    37,
    271,
    40,
    v7);
  v11 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 296))(a1, s);
  usleep(0x2710u);
  return v11;
}
