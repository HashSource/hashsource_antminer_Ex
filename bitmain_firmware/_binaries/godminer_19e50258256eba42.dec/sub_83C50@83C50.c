int __fastcall sub_83C50(int a1, __int16 a2, __int16 a3, char a4, _BYTE *a5)
{
  int v5; // r3
  unsigned int v6; // r0
  int v7; // r5
  ...
  if ( !v37 && v40 == v22 )
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( a4 )
      {
        if ( a4 == 1 )
        {
          if ( (sub_7AED8(v41[3 * i]) & 1) != 1 )
          {
            V_LOCK();
            sub_7AAF4((int)v34, *(int *)(a1 + 272));
            v13 = LOBYTE(v41[3 * i + 1]);
            v14 = LOBYTE(v41[3 * i + 2]);
            v15 = sub_7AED8(v41[3 * i]);
            logfmt_raw(
              v21,
              0x1000u,
              0,
      ...
      {
        v36 = 2;
        v6 = sub_7AED8(v41[3 * i]);
        if ( (v36 & v6) >> 1 != 1 )
        {
          V_LOCK();
          sub_7AAF4((int)v30, *(int *)(a1 + 272));
          v10 = LOBYTE(v41[3 * i + 1]);
          v11 = LOBYTE(v41[3 * i + 2]);
          v12 = sub_7AED8(v41[3 * i]);
          logfmt_raw(
            v21,
            0x1000u,
            0,
        ...
        V_LOCK();
        sub_7AAF4((int)v28, *(int *)(a1 + 272));
        v7 = LOBYTE(v41[3 * i + 1]);
        v8 = LOBYTE(v41[3 * i + 2]);
        v9 = sub_7AED8(v41[3 * i]);
        logfmt_raw(
          v21,
          0x1000u,
          0,
