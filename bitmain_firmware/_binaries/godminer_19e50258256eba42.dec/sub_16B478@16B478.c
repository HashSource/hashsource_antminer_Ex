int __fastcall sub_16B478(int a1, __int16 a2, __int16 a3, char a4, _BYTE *a5)
{
  int v5; // r3
  unsigned int v6; // r0
  int v7; // r5
  ...
  v40 = *(_DWORD *)(a1 + 464);
  if ( a2 == 255 )
    v40 = 45 * *(_DWORD *)(a1 + 464);
  V_LOCK();
  sub_1622D8((int)v24, *(int *)(a1 + 272));
  logfmt_raw(
    v21,
    0x1000u,
    0,
    ...
    v25,
    "%s core_num %d",
    "ChipSetting_check_2282_dag_reg_KAS_2380",
    v40);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  if ( !v37 && v40 == v22 )
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( a4 )
      {
        if ( a4 == 1 )
        {
          if ( (sub_162700(v41[3 * i]) & 1) != 1 )
          {
            V_LOCK();
            sub_1622D8((int)v34, *(int *)(a1 + 272));
            v13 = LOBYTE(v41[3 * i + 1]);
            v14 = LOBYTE(v41[3 * i + 2]);
            v15 = sub_162700(v41[3 * i]);
            logfmt_raw(
              v21,
              0x1000u,
              0,
      ...
      {
        v36 = 2;
        v6 = sub_162700(v41[3 * i]);
        if ( (v36 & v6) >> 1 != 1 )
        {
          V_LOCK();
          sub_1622D8((int)v30, *(int *)(a1 + 272));
          v10 = LOBYTE(v41[3 * i + 1]);
          v11 = LOBYTE(v41[3 * i + 2]);
          v12 = sub_162700(v41[3 * i]);
          logfmt_raw(
            v21,
            0x1000u,
            0,
        ...
        V_LOCK();
        sub_1622D8((int)v28, *(int *)(a1 + 272));
        v7 = LOBYTE(v41[3 * i + 1]);
        v8 = LOBYTE(v41[3 * i + 2]);
        v9 = sub_162700(v41[3 * i]);
        logfmt_raw(
          v21,
          0x1000u,
          0,
