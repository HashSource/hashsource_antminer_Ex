_BYTE *__fastcall sub_28458(int a1, _BYTE *a2, __int64 a3)
{
  bool v4; // cc
  bool v5; // zf
  char v6; // r4
  ...
  *(_DWORD *)(a1 + 64) += a3;
  ...
  v4 = (unsigned int)a3 > 0xE;
  if ( (unsigned int)a3 <= 0xE )
    v4 = HIDWORD(a3) > 0x400;
  if ( !v4 )
  {
    *a2 = (4 * (BYTE4(a3) - 1)) & 0xC | (16 * (a3 + 1));
    result = a2 + 2;
    a2[1] = (unsigned int)(HIDWORD(a3) - 1) >> 2;
    ++*(_DWORD *)(a1 + 92);
    goto LABEL_16;
  ...
  if ( v5 )
  {
    if ( *(_DWORD *)(a1 + 76) > 3u )
    {
      *a2 = (4 * (BYTE4(a3) - 1)) & 0xC;
      result = a2 + 2;
      a2[1] = (unsigned int)(HIDWORD(a3) - 1025) >> 2;
      ++*(_DWORD *)(a1 + 88);
      goto LABEL_16;
    }
    v10 = a2 + 1;
