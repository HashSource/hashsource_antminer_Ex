    ...
    do
    {
      ...
      while ( v21 != v23 )
      {
        if ( v24 == (char **)&unk_30558 || (v25 = v24[14], v24 += 14, !v25) )
        {
          ...
          _assert_fail(
            "c != NULL",
            "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/lzo-2."
            "10/lzotest/lzotest.c",
            0x7B2u,
            "main");
        }
        v23 = (int)v24[1];
  ...
  while ( 2 )
  {
    ...
    for ( i = 21; v29 != i; i = (int)v30[1] )
    {
      ...
      _assert_fail(
        ...
        "/workspace/jenkins/jenkins/workspace/Antminer_E9-Pro_release/build/rootfs/buildroot/tmp/release/build/lzo-2.10/l"
        "zotest/lzotest.c",
        0x7E1u,
        "main");
    }
